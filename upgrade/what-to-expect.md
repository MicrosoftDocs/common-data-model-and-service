...
| CreatedBy        | CreatedOnBehalfBy                | **CreatedOnBehalfBy** is set to the value from the previous release of CDS. **CreatedBy** will reflect the system account used to run the upgrade process. If the user from CDS 1.0 cannot be synced, it will be replaced by Account used to run the upgrade. |
