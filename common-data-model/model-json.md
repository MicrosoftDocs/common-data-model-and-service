...
The metadata file (or model.json) in a Common Data Model (CDM) folder describes the data in the folder, metadata and location, as well as how the file was generated and by which data producer.
