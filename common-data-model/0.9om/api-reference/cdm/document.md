...
```
*CdmDocumentDefinition extends CdmObjectSimple in TypeScript.*
...
|**FetchObjectDefinition\<T>([ResolveOptions](../utilities/resolveoptions.md))**<br/><br/>*Only in C# and TypeScript.*|See [CdmObject.FetchObjectDefinition\<T>(...)](cdmobject.md#methods).|T|
