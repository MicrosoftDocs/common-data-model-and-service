...
|**Insert(int, [CdmArgumentDefinition](argument.md))**<br/>*index*: The index to insert the argument at.<br/>*arg*: The argument to add to the collection.|Inserts the argument into the collection at the specified index.|void|
