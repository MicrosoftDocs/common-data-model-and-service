...
|**ADLSAdapter(string, string, TokenProvider)**<br/>*hostname*: The hostname of ADLS.<br/>*root*: The root path of the schema documents.<br/>*tokenProvider*: The user-defined token provider.|Initializes a new instance of the [ADLSAdapter](adlsadapter.md) class with a user-defined class implementing the [TokenProvider](../utilities/tokenprovider.md) interface.|
