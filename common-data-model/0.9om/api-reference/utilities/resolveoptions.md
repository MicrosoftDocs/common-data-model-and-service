...
|ResolvedAttributeLimit|int?|The maximum number of resolved attributes allowed for an entity. The default value is 4000. If this limit is exceeded, then resolution will fail. If you wish to get rid of this limit, set this resolve option to null.
