---
title: CFMPurchAgreementPaymentOrderEntity in RCashFlowManagement - Common Data Model | Microsoft Docs
...
# Payment order requisites for purchase agreements in RCashFlowManagement(CFMPurchAgreementPaymentOrderEntity)
