---
title: MainAccountTotalAccountIntervalEntity in GeneralLedger - Common Data Model | Microsoft Docs
...
# Main account totaling account intervals in GeneralLedger(MainAccountTotalAccountIntervalEntity)
