---
title: ExchangeRateCurrencyPairEntity in Currency - Common Data Model | Microsoft Docs
...
# Exchange rate currency pair in Currency(ExchangeRateCurrencyPairEntity)
