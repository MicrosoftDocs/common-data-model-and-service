---
title: WHSOutboundLoadPackingStructureLineEntity in WMS - Common Data Model | Microsoft Docs
...
# Outbound load packing structure lines in WMS(WHSOutboundLoadPackingStructureLineEntity)
...
**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Outbound load packing structure lines</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
