---
title: SalesAgreementClassificationEntity in SalesAndMarketing - Common Data Model | Microsoft Docs
...
# Sales agreement classification in SalesAndMarketing(SalesAgreementClassificationEntity)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Entities/SupplyChain/SalesAndMarketing/SalesAgreementClassificationEntity.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[ClassificationDescription](#ClassificationDescription)||<a href="SalesAgreementClassificationEntity.md" target="_blank">SalesAndMarketing/SalesAgreementClassificationEntity</a>|
|[ClassificationName](#ClassificationName)||<a href="SalesAgreementClassificationEntity.md" target="_blank">SalesAndMarketing/SalesAgreementClassificationEntity</a>|
|[BackingTable_AgreementClassificationRelationshipId](#BackingTable_AgreementClassificationRelationshipId)||<a href="SalesAgreementClassificationEntity.md" target="_blank">SalesAndMarketing/SalesAgreementClassificationEntity</a>|

### <a href=#ClassificationDescription name="ClassificationDescription">ClassificationDescription</a>

First included in: SalesAndMarketing/SalesAgreementClassificationEntity (this entity)  
