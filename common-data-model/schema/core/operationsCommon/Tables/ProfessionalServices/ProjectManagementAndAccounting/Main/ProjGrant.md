---
title: ProjGrant in Main - Common Data Model | Microsoft Docs
...
# Grant in Main(ProjGrant)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/ProfessionalServices/ProjectManagementAndAccounting/Main/ProjGrant.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[ProjGrant/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Grant</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="ProjGrant.md" target="_blank">Main/ProjGrant</a>|
|[ActualAwardDate](#ActualAwardDate)||<a href="ProjGrant.md" target="_blank">Main/ProjGrant</a>|
|[ActualExpirationDate](#ActualExpirationDate)||<a href="ProjGrant.md" target="_blank">Main/ProjGrant</a>|
|[ActualStartDate](#ActualStartDate)||<a href="ProjGrant.md" target="_blank">Main/ProjGrant</a>|
|[ApplicationDueDate](#ApplicationDueDate)||<a href="ProjGrant.md" target="_blank">Main/ProjGrant</a>|
|[ApplicationSubmittedDate](#ApplicationSubmittedDate)||<a href="ProjGrant.md" target="_blank">Main/ProjGrant</a>|
|[AwardedAmount](#AwardedAmount)||<a href="ProjGrant.md" target="_blank">Main/ProjGrant</a>|
|[BoardApprovalDate](#BoardApprovalDate)||<a href="ProjGrant.md" target="_blank">Main/ProjGrant</a>|
|[CFDAId](#CFDAId)||<a href="ProjGrant.md" target="_blank">Main/ProjGrant</a>|
|[CustAccount](#CustAccount)||<a href="ProjGrant.md" target="_blank">Main/ProjGrant</a>|
|[EstimatedAwardDate](#EstimatedAwardDate)||<a href="ProjGrant.md" target="_blank">Main/ProjGrant</a>|
|[FederalMandate](#FederalMandate)||<a href="ProjGrant.md" target="_blank">Main/ProjGrant</a>|
|[GrantApplicationId](#GrantApplicationId)||<a href="ProjGrant.md" target="_blank">Main/ProjGrant</a>|
|[GrantDescription](#GrantDescription)||<a href="ProjGrant.md" target="_blank">Main/ProjGrant</a>|
|[GrantId](#GrantId)||<a href="ProjGrant.md" target="_blank">Main/ProjGrant</a>|
|[GrantManagerWorker](#GrantManagerWorker)||<a href="ProjGrant.md" target="_blank">Main/ProjGrant</a>|
|[GrantMatchingComments](#GrantMatchingComments)||<a href="ProjGrant.md" target="_blank">Main/ProjGrant</a>|
|[GrantName](#GrantName)||<a href="ProjGrant.md" target="_blank">Main/ProjGrant</a>|
|[GrantParentId](#GrantParentId)||<a href="ProjGrant.md" target="_blank">Main/ProjGrant</a>|
|[GrantPurpose](#GrantPurpose)||<a href="ProjGrant.md" target="_blank">Main/ProjGrant</a>|
|[GrantStatus](#GrantStatus)||<a href="ProjGrant.md" target="_blank">Main/ProjGrant</a>|
|[MatchingAmount](#MatchingAmount)||<a href="ProjGrant.md" target="_blank">Main/ProjGrant</a>|
|[MatchingPercentage](#MatchingPercentage)||<a href="ProjGrant.md" target="_blank">Main/ProjGrant</a>|
|[OrganizationUnitId](#OrganizationUnitId)||<a href="ProjGrant.md" target="_blank">Main/ProjGrant</a>|
|[PassThrough](#PassThrough)||<a href="ProjGrant.md" target="_blank">Main/ProjGrant</a>|
|[ProjGrantMatching](#ProjGrantMatching)||<a href="ProjGrant.md" target="_blank">Main/ProjGrant</a>|
|[ProjGrantorType](#ProjGrantorType)||<a href="ProjGrant.md" target="_blank">Main/ProjGrant</a>|
|[ProjGrantType](#ProjGrantType)||<a href="ProjGrant.md" target="_blank">Main/ProjGrant</a>|
|[ProjLocalTrackingId](#ProjLocalTrackingId)||<a href="ProjGrant.md" target="_blank">Main/ProjGrant</a>|
|[RejectionNotification](#RejectionNotification)||<a href="ProjGrant.md" target="_blank">Main/ProjGrant</a>|
|[RenewalActionDate](#RenewalActionDate)||<a href="ProjGrant.md" target="_blank">Main/ProjGrant</a>|
|[RequestedAmount](#RequestedAmount)||<a href="ProjGrant.md" target="_blank">Main/ProjGrant</a>|
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Grant customer</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>isNullable</td><td>true</td></tr></table>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Grant customer</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
### <a href=#Relationship_ProjGrantMatchingRelationshipId name="Relationship_ProjGrantMatchingRelationshipId">Relationship_ProjGrantMatchingRelationshipId</a>
...
<details>
<summary>List of traits for the Relationship_ProjGrantMatchingRelationshipId attribute are listed below.</summary>
...
**means.identity.entityId**  
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="../Group/ProjGrantMatching.md" target="_blank">/core/operationsCommon/Tables/ProfessionalServices/ProjectManagementAndAccounting/Group/ProjGrantMatching.cdm.json/ProjGrantMatching</a></td><td><a href="../Group/ProjGrantMatching.md#RecId" target="_blank">RecId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
...
### <a href=#Relationship_ProjGrantorTypeRelationshipId name="Relationship_ProjGrantorTypeRelationshipId">Relationship_ProjGrantorTypeRelationshipId</a>
...
<details>
<summary>List of traits for the Relationship_ProjGrantorTypeRelationshipId attribute are listed below.</summary>
...
**means.identity.entityId**  
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="../Group/ProjGrantorType.md" target="_blank">/core/operationsCommon/Tables/ProfessionalServices/ProjectManagementAndAccounting/Group/ProjGrantorType.cdm.json/ProjGrantorType</a></td><td><a href="../Group/ProjGrantorType.md#RecId" target="_blank">RecId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
...
### <a href=#Relationship_ProjGrantTypeRelationshipId name="Relationship_ProjGrantTypeRelationshipId">Relationship_ProjGrantTypeRelationshipId</a>
...
<details>
<summary>List of traits for the Relationship_ProjGrantTypeRelationshipId attribute are listed below.</summary>
