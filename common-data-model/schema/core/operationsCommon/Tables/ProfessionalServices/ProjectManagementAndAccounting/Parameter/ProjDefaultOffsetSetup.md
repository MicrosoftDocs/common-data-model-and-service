---
title: ProjDefaultOffsetSetup in Parameter - Common Data Model | Microsoft Docs
...
# Default offset accounts in Parameter(ProjDefaultOffsetSetup)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/ProfessionalServices/ProjectManagementAndAccounting/Parameter/ProjDefaultOffsetSetup.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[ProjDefaultOffsetSetup/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Default offset accounts</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="ProjDefaultOffsetSetup.md" target="_blank">Parameter/ProjDefaultOffsetSetup</a>|
|[LedgerDimension](#LedgerDimension)||<a href="ProjDefaultOffsetSetup.md" target="_blank">Parameter/ProjDefaultOffsetSetup</a>|
|[ProjCategoryId](#ProjCategoryId)||<a href="ProjDefaultOffsetSetup.md" target="_blank">Parameter/ProjDefaultOffsetSetup</a>|
|[ProjId](#ProjId)||<a href="ProjDefaultOffsetSetup.md" target="_blank">Parameter/ProjDefaultOffsetSetup</a>|
|[ProjOffsetType](#ProjOffsetType)||<a href="ProjDefaultOffsetSetup.md" target="_blank">Parameter/ProjDefaultOffsetSetup</a>|
|[Resource](#Resource)||<a href="ProjDefaultOffsetSetup.md" target="_blank">Parameter/ProjDefaultOffsetSetup</a>|
|[Worker](#Worker)||<a href="ProjDefaultOffsetSetup.md" target="_blank">Parameter/ProjDefaultOffsetSetup</a>|
|[DataAreaId](#DataAreaId)||<a href="ProjDefaultOffsetSetup.md" target="_blank">Parameter/ProjDefaultOffsetSetup</a>|
|[Relationship_LedgerDimensionRelationshipId](#Relationship_LedgerDimensionRelationshipId)||<a href="ProjDefaultOffsetSetup.md" target="_blank">Parameter/ProjDefaultOffsetSetup</a>|
|[Relationship_ProjCategoryRelationshipId](#Relationship_ProjCategoryRelationshipId)||<a href="ProjDefaultOffsetSetup.md" target="_blank">Parameter/ProjDefaultOffsetSetup</a>|
|[Relationship_ProjTableRelationshipId](#Relationship_ProjTableRelationshipId)||<a href="ProjDefaultOffsetSetup.md" target="_blank">Parameter/ProjDefaultOffsetSetup</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="ProjDefaultOffsetSetup.md" target="_blank">Parameter/ProjDefaultOffsetSetup</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Parameter/ProjDefaultOffsetSetup (this entity)  
...
### <a href=#ProjOffsetType name="ProjOffsetType">ProjOffsetType</a>
...
<details>
<summary>List of traits for the ProjOffsetType attribute are listed below.</summary>
