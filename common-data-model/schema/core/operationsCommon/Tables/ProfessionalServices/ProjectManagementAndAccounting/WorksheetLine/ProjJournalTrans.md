---
title: ProjJournalTrans - Common Data Model | Microsoft Docs
...
# Project journal
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/ProfessionalServices/ProjectManagementAndAccounting/WorksheetLine/ProjJournalTrans.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[ProjJournalTrans/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Project journal</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="ProjJournalTrans.md" target="_blank">WorksheetLine/ProjJournalTrans</a>|
|[ActivityNumber](#ActivityNumber)||<a href="ProjJournalTrans.md" target="_blank">WorksheetLine/ProjJournalTrans</a>|
|[CategoryId](#CategoryId)||<a href="ProjJournalTrans.md" target="_blank">WorksheetLine/ProjJournalTrans</a>|
|[CostPrice](#CostPrice)||<a href="ProjJournalTrans.md" target="_blank">WorksheetLine/ProjJournalTrans</a>|
|[CurrencyId](#CurrencyId)||<a href="ProjJournalTrans.md" target="_blank">WorksheetLine/ProjJournalTrans</a>|
|[DefaultDimension](#DefaultDimension)||<a href="ProjJournalTrans.md" target="_blank">WorksheetLine/ProjJournalTrans</a>|
|[FromTime](#FromTime)||<a href="ProjJournalTrans.md" target="_blank">WorksheetLine/ProjJournalTrans</a>|
|[JournalId](#JournalId)||<a href="ProjJournalTrans.md" target="_blank">WorksheetLine/ProjJournalTrans</a>|
|[LineNum](#LineNum)||<a href="ProjJournalTrans.md" target="_blank">WorksheetLine/ProjJournalTrans</a>|
|[LinePropertyId](#LinePropertyId)||<a href="ProjJournalTrans.md" target="_blank">WorksheetLine/ProjJournalTrans</a>|
|[OperationType_MX](#OperationType_MX)||<a href="ProjJournalTrans.md" target="_blank">WorksheetLine/ProjJournalTrans</a>|
|[PackedExtensions](#PackedExtensions)||<a href="ProjJournalTrans.md" target="_blank">WorksheetLine/ProjJournalTrans</a>|
|[PeriodDate](#PeriodDate)||<a href="ProjJournalTrans.md" target="_blank">WorksheetLine/ProjJournalTrans</a>|
|[ProjId](#ProjId)||<a href="ProjJournalTrans.md" target="_blank">WorksheetLine/ProjJournalTrans</a>|
|[ProjPriceGroupID](#ProjPriceGroupID)||<a href="ProjJournalTrans.md" target="_blank">WorksheetLine/ProjJournalTrans</a>|
|[ProjTransDate](#ProjTransDate)||<a href="ProjJournalTrans.md" target="_blank">WorksheetLine/ProjJournalTrans</a>|
|[PSAIndirectComponentGroup](#PSAIndirectComponentGroup)||<a href="ProjJournalTrans.md" target="_blank">WorksheetLine/ProjJournalTrans</a>|
|[PSAPercentCompl](#PSAPercentCompl)||<a href="ProjJournalTrans.md" target="_blank">WorksheetLine/ProjJournalTrans</a>|
|[PSAProjOrigTransId](#PSAProjOrigTransId)||<a href="ProjJournalTrans.md" target="_blank">WorksheetLine/ProjJournalTrans</a>|
|[PSAWrkCtrId](#PSAWrkCtrId)||<a href="ProjJournalTrans.md" target="_blank">WorksheetLine/ProjJournalTrans</a>|
|[Qty](#Qty)||<a href="ProjJournalTrans.md" target="_blank">WorksheetLine/ProjJournalTrans</a>|
|[Resource](#Resource)||<a href="ProjJournalTrans.md" target="_blank">WorksheetLine/ProjJournalTrans</a>|
|[ResourceCategory](#ResourceCategory)||<a href="ProjJournalTrans.md" target="_blank">WorksheetLine/ProjJournalTrans</a>|
|[ReverseDate](#ReverseDate)||<a href="ProjJournalTrans.md" target="_blank">WorksheetLine/ProjJournalTrans</a>|
|[ReverseEntry](#ReverseEntry)||<a href="ProjJournalTrans.md" target="_blank">WorksheetLine/ProjJournalTrans</a>|
|[RevRecId](#RevRecId)||<a href="ProjJournalTrans.md" target="_blank">WorksheetLine/ProjJournalTrans</a>|
|[SalesPrice](#SalesPrice)||<a href="ProjJournalTrans.md" target="_blank">WorksheetLine/ProjJournalTrans</a>|
|[TaxGroupId](#TaxGroupId)||<a href="ProjJournalTrans.md" target="_blank">WorksheetLine/ProjJournalTrans</a>|
|[TaxItemGroupId](#TaxItemGroupId)||<a href="ProjJournalTrans.md" target="_blank">WorksheetLine/ProjJournalTrans</a>|
|[ToTime](#ToTime)||<a href="ProjJournalTrans.md" target="_blank">WorksheetLine/ProjJournalTrans</a>|
|[TransDate](#TransDate)||<a href="ProjJournalTrans.md" target="_blank">WorksheetLine/ProjJournalTrans</a>|
|[TransId](#TransId)||<a href="ProjJournalTrans.md" target="_blank">WorksheetLine/ProjJournalTrans</a>|
|[Txt](#Txt)||<a href="ProjJournalTrans.md" target="_blank">WorksheetLine/ProjJournalTrans</a>|
|[Voucher](#Voucher)||<a href="ProjJournalTrans.md" target="_blank">WorksheetLine/ProjJournalTrans</a>|
|[WebTransaction](#WebTransaction)||<a href="ProjJournalTrans.md" target="_blank">WorksheetLine/ProjJournalTrans</a>|
|[Worker](#Worker)||<a href="ProjJournalTrans.md" target="_blank">WorksheetLine/ProjJournalTrans</a>|
|[FundingSource](#FundingSource)||<a href="ProjJournalTrans.md" target="_blank">WorksheetLine/ProjJournalTrans</a>|
|[EntAssetWorkOrderLine](#EntAssetWorkOrderLine)||<a href="ProjJournalTrans.md" target="_blank">WorksheetLine/ProjJournalTrans</a>|
|[DataAreaId](#DataAreaId)||<a href="ProjJournalTrans.md" target="_blank">WorksheetLine/ProjJournalTrans</a>|
|[Relationship_CurrencyRelationshipId](#Relationship_CurrencyRelationshipId)||<a href="ProjJournalTrans.md" target="_blank">WorksheetLine/ProjJournalTrans</a>|
|[Relationship_DefaultDimensionRelationshipId](#Relationship_DefaultDimensionRelationshipId)||<a href="ProjJournalTrans.md" target="_blank">WorksheetLine/ProjJournalTrans</a>|
|[Relationship_PriceDiscGroupRelationshipId](#Relationship_PriceDiscGroupRelationshipId)||<a href="ProjJournalTrans.md" target="_blank">WorksheetLine/ProjJournalTrans</a>|
|[Relationship_ProjCategoryRelationshipId](#Relationship_ProjCategoryRelationshipId)||<a href="ProjJournalTrans.md" target="_blank">WorksheetLine/ProjJournalTrans</a>|
|[Relationship_ProjJournalTableRelationshipId](#Relationship_ProjJournalTableRelationshipId)||<a href="ProjJournalTrans.md" target="_blank">WorksheetLine/ProjJournalTrans</a>|
|[Relationship_projJournalTxtRelationshipId](#Relationship_projJournalTxtRelationshipId)||<a href="ProjJournalTrans.md" target="_blank">WorksheetLine/ProjJournalTrans</a>|
|[Relationship_ProjLinePropertyRelationshipId](#Relationship_ProjLinePropertyRelationshipId)||<a href="ProjJournalTrans.md" target="_blank">WorksheetLine/ProjJournalTrans</a>|
|[Relationship_ProjRevenueRelationshipId](#Relationship_ProjRevenueRelationshipId)||<a href="ProjJournalTrans.md" target="_blank">WorksheetLine/ProjJournalTrans</a>|
|[Relationship_ProjTableRelationshipId](#Relationship_ProjTableRelationshipId)||<a href="ProjJournalTrans.md" target="_blank">WorksheetLine/ProjJournalTrans</a>|
|[Relationship_PSAIndirectComponentGroupRelationshipId](#Relationship_PSAIndirectComponentGroupRelationshipId)||<a href="ProjJournalTrans.md" target="_blank">WorksheetLine/ProjJournalTrans</a>|
|[Relationship_TaxGroupHeadingRelationshipId](#Relationship_TaxGroupHeadingRelationshipId)||<a href="ProjJournalTrans.md" target="_blank">WorksheetLine/ProjJournalTrans</a>|
|[Relationship_TaxItemGroupHeadingRelationshipId](#Relationship_TaxItemGroupHeadingRelationshipId)||<a href="ProjJournalTrans.md" target="_blank">WorksheetLine/ProjJournalTrans</a>|
|[Relationship_TaxServiceTariffRelationshipId](#Relationship_TaxServiceTariffRelationshipId)||<a href="ProjJournalTrans.md" target="_blank">WorksheetLine/ProjJournalTrans</a>|
|[Relationship_WrkCtrTableRelationshipId](#Relationship_WrkCtrTableRelationshipId)||<a href="ProjJournalTrans.md" target="_blank">WorksheetLine/ProjJournalTrans</a>|
|[Relationship_ResourceTableRelationshipId](#Relationship_ResourceTableRelationshipId)||<a href="ProjJournalTrans.md" target="_blank">WorksheetLine/ProjJournalTrans</a>|
|[Relationship_ProjFundingSourceRelationshipId](#Relationship_ProjFundingSourceRelationshipId)||<a href="ProjJournalTrans.md" target="_blank">WorksheetLine/ProjJournalTrans</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="ProjJournalTrans.md" target="_blank">WorksheetLine/ProjJournalTrans</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: WorksheetLine/ProjJournalTrans (this entity)  
...
### <a href=#ProjPriceGroupID name="ProjPriceGroupID">ProjPriceGroupID</a>
...
<details>
<summary>List of traits for the ProjPriceGroupID attribute are listed below.</summary>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Cost</td></tr><tr><td>dataFormat</td><td>string</td></tr></table>
...
### <a href=#PSAPercentCompl name="PSAPercentCompl">PSAPercentCompl</a>

First included in: WorksheetLine/ProjJournalTrans (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Percentage complete</td></tr><tr><td>dataFormat</td><td>decimal</td></tr></table>

#### Traits

<details>
<summary>List of traits for the PSAPercentCompl attribute are listed below.</summary>

**is.dataFormat.numeric.shaped**  
for setting the exact precision and scale of numeric values  

**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Percentage complete</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Voucher date</td></tr><tr><td>dataFormat</td><td>date</td></tr></table>
...
### <a href=#WebTransaction name="WebTransaction">WebTransaction</a>
...
<details>
<summary>List of traits for the WebTransaction attribute are listed below.</summary>
...
### <a href=#EntAssetWorkOrderLine name="EntAssetWorkOrderLine">EntAssetWorkOrderLine</a>
...
<details>
<summary>List of traits for the EntAssetWorkOrderLine attribute are listed below.</summary>
...
### <a href=#Relationship_ProjRevenueRelationshipId name="Relationship_ProjRevenueRelationshipId">Relationship_ProjRevenueRelationshipId</a>
...
<details>
<summary>List of traits for the Relationship_ProjRevenueRelationshipId attribute are listed below.</summary>
...
**means.identity.entityId**  
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="../Transaction/ProjRevenueTrans.md" target="_blank">/core/operationsCommon/Tables/ProfessionalServices/ProjectManagementAndAccounting/Transaction/ProjRevenueTrans.cdm.json/ProjRevenueTrans</a></td><td><a href="../Transaction/ProjRevenueTrans.md#RecId" target="_blank">RecId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
