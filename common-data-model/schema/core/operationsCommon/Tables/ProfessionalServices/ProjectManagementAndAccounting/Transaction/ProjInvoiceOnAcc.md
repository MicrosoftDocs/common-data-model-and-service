---
title: ProjInvoiceOnAcc in Transaction - Common Data Model | Microsoft Docs
...
# Project invoice lines on-account in Transaction(ProjInvoiceOnAcc)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/ProfessionalServices/ProjectManagementAndAccounting/Transaction/ProjInvoiceOnAcc.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[ProjInvoiceOnAcc/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="ProjInvoiceOnAcc.md" target="_blank">Transaction/ProjInvoiceOnAcc</a>|
|[Amount](#Amount)||<a href="ProjInvoiceOnAcc.md" target="_blank">Transaction/ProjInvoiceOnAcc</a>|
|[AmountMST](#AmountMST)||<a href="ProjInvoiceOnAcc.md" target="_blank">Transaction/ProjInvoiceOnAcc</a>|
|[CurrencyId](#CurrencyId)||<a href="ProjInvoiceOnAcc.md" target="_blank">Transaction/ProjInvoiceOnAcc</a>|
|[DefaultDimension](#DefaultDimension)||<a href="ProjInvoiceOnAcc.md" target="_blank">Transaction/ProjInvoiceOnAcc</a>|
|[EInvoiceAccountCode](#EInvoiceAccountCode)||<a href="ProjInvoiceOnAcc.md" target="_blank">Transaction/ProjInvoiceOnAcc</a>|
|[InvoiceDate](#InvoiceDate)||<a href="ProjInvoiceOnAcc.md" target="_blank">Transaction/ProjInvoiceOnAcc</a>|
|[ProjId](#ProjId)||<a href="ProjInvoiceOnAcc.md" target="_blank">Transaction/ProjInvoiceOnAcc</a>|
|[ProjInvoiceId](#ProjInvoiceId)||<a href="ProjInvoiceOnAcc.md" target="_blank">Transaction/ProjInvoiceOnAcc</a>|
|[PSAContractLineNum](#PSAContractLineNum)||<a href="ProjInvoiceOnAcc.md" target="_blank">Transaction/ProjInvoiceOnAcc</a>|
|[PSAIsOnAccount](#PSAIsOnAccount)||<a href="ProjInvoiceOnAcc.md" target="_blank">Transaction/ProjInvoiceOnAcc</a>|
|[PSARefRecIdBudgetTrans](#PSARefRecIdBudgetTrans)||<a href="ProjInvoiceOnAcc.md" target="_blank">Transaction/ProjInvoiceOnAcc</a>|
|[PSARefTableIdBudgetTrans](#PSARefTableIdBudgetTrans)||<a href="ProjInvoiceOnAcc.md" target="_blank">Transaction/ProjInvoiceOnAcc</a>|
|[Qty](#Qty)||<a href="ProjInvoiceOnAcc.md" target="_blank">Transaction/ProjInvoiceOnAcc</a>|
|[TaxAmount](#TaxAmount)||<a href="ProjInvoiceOnAcc.md" target="_blank">Transaction/ProjInvoiceOnAcc</a>|
|[TaxGroupId](#TaxGroupId)||<a href="ProjInvoiceOnAcc.md" target="_blank">Transaction/ProjInvoiceOnAcc</a>|
|[TaxItemGroupId](#TaxItemGroupId)||<a href="ProjInvoiceOnAcc.md" target="_blank">Transaction/ProjInvoiceOnAcc</a>|
|[TaxWriteCode](#TaxWriteCode)||<a href="ProjInvoiceOnAcc.md" target="_blank">Transaction/ProjInvoiceOnAcc</a>|
|[TransDate](#TransDate)||<a href="ProjInvoiceOnAcc.md" target="_blank">Transaction/ProjInvoiceOnAcc</a>|
|[TransId](#TransId)||<a href="ProjInvoiceOnAcc.md" target="_blank">Transaction/ProjInvoiceOnAcc</a>|
|[Txt](#Txt)||<a href="ProjInvoiceOnAcc.md" target="_blank">Transaction/ProjInvoiceOnAcc</a>|
|[RefInvoiceDate_MY](#RefInvoiceDate_MY)||<a href="ProjInvoiceOnAcc.md" target="_blank">Transaction/ProjInvoiceOnAcc</a>|
|[RefInvoiceId_MY](#RefInvoiceId_MY)||<a href="ProjInvoiceOnAcc.md" target="_blank">Transaction/ProjInvoiceOnAcc</a>|
|[OrderLineReference_NO](#OrderLineReference_NO)||<a href="ProjInvoiceOnAcc.md" target="_blank">Transaction/ProjInvoiceOnAcc</a>|
|[SATProductCode_MX](#SATProductCode_MX)||<a href="ProjInvoiceOnAcc.md" target="_blank">Transaction/ProjInvoiceOnAcc</a>|
|[BookableResourceName](#BookableResourceName)||<a href="ProjInvoiceOnAcc.md" target="_blank">Transaction/ProjInvoiceOnAcc</a>|
|[DataAreaId](#DataAreaId)||<a href="ProjInvoiceOnAcc.md" target="_blank">Transaction/ProjInvoiceOnAcc</a>|
|[Relationship_CurrencyRelationshipId](#Relationship_CurrencyRelationshipId)||<a href="ProjInvoiceOnAcc.md" target="_blank">Transaction/ProjInvoiceOnAcc</a>|
|[Relationship_DefaultDimensionRelationshipId](#Relationship_DefaultDimensionRelationshipId)||<a href="ProjInvoiceOnAcc.md" target="_blank">Transaction/ProjInvoiceOnAcc</a>|
|[Relationship_ProjInvoiceJourRelationshipId](#Relationship_ProjInvoiceJourRelationshipId)||<a href="ProjInvoiceOnAcc.md" target="_blank">Transaction/ProjInvoiceOnAcc</a>|
|[Relationship_projOnAccTransRelationshipId](#Relationship_projOnAccTransRelationshipId)||<a href="ProjInvoiceOnAcc.md" target="_blank">Transaction/ProjInvoiceOnAcc</a>|
|[Relationship_ProjOnAccTrans_RecIdRelationshipId](#Relationship_ProjOnAccTrans_RecIdRelationshipId)||<a href="ProjInvoiceOnAcc.md" target="_blank">Transaction/ProjInvoiceOnAcc</a>|
|[Relationship_ProjTableRelationshipId](#Relationship_ProjTableRelationshipId)||<a href="ProjInvoiceOnAcc.md" target="_blank">Transaction/ProjInvoiceOnAcc</a>|
|[Relationship_PSAContractLineItemsRelationshipId](#Relationship_PSAContractLineItemsRelationshipId)||<a href="ProjInvoiceOnAcc.md" target="_blank">Transaction/ProjInvoiceOnAcc</a>|
|[Relationship_TaxGroupHeadingRelationshipId](#Relationship_TaxGroupHeadingRelationshipId)||<a href="ProjInvoiceOnAcc.md" target="_blank">Transaction/ProjInvoiceOnAcc</a>|
|[Relationship_TaxItemGroupHeadingRelationshipId](#Relationship_TaxItemGroupHeadingRelationshipId)||<a href="ProjInvoiceOnAcc.md" target="_blank">Transaction/ProjInvoiceOnAcc</a>|
|[Relationship_SATProductCode_MXRelationshipId](#Relationship_SATProductCode_MXRelationshipId)||<a href="ProjInvoiceOnAcc.md" target="_blank">Transaction/ProjInvoiceOnAcc</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="ProjInvoiceOnAcc.md" target="_blank">Transaction/ProjInvoiceOnAcc</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Transaction/ProjInvoiceOnAcc (this entity)  
...
### <a href=#Relationship_ProjOnAccTrans_RecIdRelationshipId name="Relationship_ProjOnAccTrans_RecIdRelationshipId">Relationship_ProjOnAccTrans_RecIdRelationshipId</a>
...
<details>
<summary>List of traits for the Relationship_ProjOnAccTrans_RecIdRelationshipId attribute are listed below.</summary>
