---
title: ProjForecastOnAcc in Transaction - Common Data Model | Microsoft Docs
...
# On-account forecast in Transaction(ProjForecastOnAcc)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/ProfessionalServices/ProjectManagementAndAccounting/Transaction/ProjForecastOnAcc.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[ProjForecastOnAcc/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>On-account forecast</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="ProjForecastOnAcc.md" target="_blank">Transaction/ProjForecastOnAcc</a>|
|[CurrencyId](#CurrencyId)||<a href="ProjForecastOnAcc.md" target="_blank">Transaction/ProjForecastOnAcc</a>|
|[DefaultDimension](#DefaultDimension)||<a href="ProjForecastOnAcc.md" target="_blank">Transaction/ProjForecastOnAcc</a>|
|[EliminationDate](#EliminationDate)||<a href="ProjForecastOnAcc.md" target="_blank">Transaction/ProjForecastOnAcc</a>|
|[ExchRate](#ExchRate)||<a href="ProjForecastOnAcc.md" target="_blank">Transaction/ProjForecastOnAcc</a>|
|[InvoiceDate](#InvoiceDate)||<a href="ProjForecastOnAcc.md" target="_blank">Transaction/ProjForecastOnAcc</a>|
|[ModelId](#ModelId)||<a href="ProjForecastOnAcc.md" target="_blank">Transaction/ProjForecastOnAcc</a>|
|[ProjForecastBudgetType](#ProjForecastBudgetType)||<a href="ProjForecastOnAcc.md" target="_blank">Transaction/ProjForecastOnAcc</a>|
|[ProjFundingSource](#ProjFundingSource)||<a href="ProjForecastOnAcc.md" target="_blank">Transaction/ProjForecastOnAcc</a>|
|[ProjId](#ProjId)||<a href="ProjForecastOnAcc.md" target="_blank">Transaction/ProjForecastOnAcc</a>|
|[Qty](#Qty)||<a href="ProjForecastOnAcc.md" target="_blank">Transaction/ProjForecastOnAcc</a>|
|[SalesPaymDate](#SalesPaymDate)||<a href="ProjForecastOnAcc.md" target="_blank">Transaction/ProjForecastOnAcc</a>|
|[SalesPrice](#SalesPrice)||<a href="ProjForecastOnAcc.md" target="_blank">Transaction/ProjForecastOnAcc</a>|
|[TransDate](#TransDate)||<a href="ProjForecastOnAcc.md" target="_blank">Transaction/ProjForecastOnAcc</a>|
|[TransId](#TransId)||<a href="ProjForecastOnAcc.md" target="_blank">Transaction/ProjForecastOnAcc</a>|
|[Txt](#Txt)||<a href="ProjForecastOnAcc.md" target="_blank">Transaction/ProjForecastOnAcc</a>|
|[DataAreaId](#DataAreaId)||<a href="ProjForecastOnAcc.md" target="_blank">Transaction/ProjForecastOnAcc</a>|
|[Relationship_CurrencyRelationshipId](#Relationship_CurrencyRelationshipId)||<a href="ProjForecastOnAcc.md" target="_blank">Transaction/ProjForecastOnAcc</a>|
|[Relationship_DefaultDimensionRelationshipId](#Relationship_DefaultDimensionRelationshipId)||<a href="ProjForecastOnAcc.md" target="_blank">Transaction/ProjForecastOnAcc</a>|
|[Relationship_ForecastModelRelationshipId](#Relationship_ForecastModelRelationshipId)||<a href="ProjForecastOnAcc.md" target="_blank">Transaction/ProjForecastOnAcc</a>|
|[Relationship_FundingSourceRelationshipId](#Relationship_FundingSourceRelationshipId)||<a href="ProjForecastOnAcc.md" target="_blank">Transaction/ProjForecastOnAcc</a>|
|[Relationship_ProjTableRelationshipId](#Relationship_ProjTableRelationshipId)||<a href="ProjForecastOnAcc.md" target="_blank">Transaction/ProjForecastOnAcc</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="ProjForecastOnAcc.md" target="_blank">Transaction/ProjForecastOnAcc</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Transaction/ProjForecastOnAcc (this entity)  
