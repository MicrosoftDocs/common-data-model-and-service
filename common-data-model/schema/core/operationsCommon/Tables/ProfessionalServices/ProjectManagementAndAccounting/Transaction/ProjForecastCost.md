---
title: ProjForecastCost - Common Data Model | Microsoft Docs
...
# Expense forecast
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/ProfessionalServices/ProjectManagementAndAccounting/Transaction/ProjForecastCost.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[ProjForecastCost/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Expense forecast</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="ProjForecastCost.md" target="_blank">Transaction/ProjForecastCost</a>|
|[Active](#Active)||<a href="ProjForecastCost.md" target="_blank">Transaction/ProjForecastCost</a>|
|[ActivityNumber](#ActivityNumber)||<a href="ProjForecastCost.md" target="_blank">Transaction/ProjForecastCost</a>|
|[AllocateMethod](#AllocateMethod)||<a href="ProjForecastCost.md" target="_blank">Transaction/ProjForecastCost</a>|
|[CategoryId](#CategoryId)||<a href="ProjForecastCost.md" target="_blank">Transaction/ProjForecastCost</a>|
|[CostPaymDate](#CostPaymDate)||<a href="ProjForecastCost.md" target="_blank">Transaction/ProjForecastCost</a>|
|[CostPrice](#CostPrice)||<a href="ProjForecastCost.md" target="_blank">Transaction/ProjForecastCost</a>|
|[CovStatus](#CovStatus)||<a href="ProjForecastCost.md" target="_blank">Transaction/ProjForecastCost</a>|
|[CurrencyId](#CurrencyId)||<a href="ProjForecastCost.md" target="_blank">Transaction/ProjForecastCost</a>|
|[DefaultDimension](#DefaultDimension)||<a href="ProjForecastCost.md" target="_blank">Transaction/ProjForecastCost</a>|
|[EliminationDate](#EliminationDate)||<a href="ProjForecastCost.md" target="_blank">Transaction/ProjForecastCost</a>|
|[EndDate](#EndDate)||<a href="ProjForecastCost.md" target="_blank">Transaction/ProjForecastCost</a>|
|[ExchRate](#ExchRate)||<a href="ProjForecastCost.md" target="_blank">Transaction/ProjForecastCost</a>|
|[ExpandId](#ExpandId)||<a href="ProjForecastCost.md" target="_blank">Transaction/ProjForecastCost</a>|
|[Freq](#Freq)||<a href="ProjForecastCost.md" target="_blank">Transaction/ProjForecastCost</a>|
|[FreqCode](#FreqCode)||<a href="ProjForecastCost.md" target="_blank">Transaction/ProjForecastCost</a>|
|[InvoiceDate](#InvoiceDate)||<a href="ProjForecastCost.md" target="_blank">Transaction/ProjForecastCost</a>|
|[LinePropertyId](#LinePropertyId)||<a href="ProjForecastCost.md" target="_blank">Transaction/ProjForecastCost</a>|
|[ModelId](#ModelId)||<a href="ProjForecastCost.md" target="_blank">Transaction/ProjForecastCost</a>|
|[PeriodAllocateId](#PeriodAllocateId)||<a href="ProjForecastCost.md" target="_blank">Transaction/ProjForecastCost</a>|
|[ProjAllocateId](#ProjAllocateId)||<a href="ProjForecastCost.md" target="_blank">Transaction/ProjForecastCost</a>|
|[ProjForecastBudgetType](#ProjForecastBudgetType)||<a href="ProjForecastCost.md" target="_blank">Transaction/ProjForecastCost</a>|
|[ProjFundingSource](#ProjFundingSource)||<a href="ProjForecastCost.md" target="_blank">Transaction/ProjForecastCost</a>|
|[ProjId](#ProjId)||<a href="ProjForecastCost.md" target="_blank">Transaction/ProjForecastCost</a>|
|[Qty](#Qty)||<a href="ProjForecastCost.md" target="_blank">Transaction/ProjForecastCost</a>|
|[Report](#Report)||<a href="ProjForecastCost.md" target="_blank">Transaction/ProjForecastCost</a>|
|[Resource](#Resource)||<a href="ProjForecastCost.md" target="_blank">Transaction/ProjForecastCost</a>|
|[ResourceCategory](#ResourceCategory)||<a href="ProjForecastCost.md" target="_blank">Transaction/ProjForecastCost</a>|
|[SalesPaymDate](#SalesPaymDate)||<a href="ProjForecastCost.md" target="_blank">Transaction/ProjForecastCost</a>|
|[SalesPrice](#SalesPrice)||<a href="ProjForecastCost.md" target="_blank">Transaction/ProjForecastCost</a>|
|[StartDate](#StartDate)||<a href="ProjForecastCost.md" target="_blank">Transaction/ProjForecastCost</a>|
|[Stop](#Stop)||<a href="ProjForecastCost.md" target="_blank">Transaction/ProjForecastCost</a>|
|[TaxGroupId](#TaxGroupId)||<a href="ProjForecastCost.md" target="_blank">Transaction/ProjForecastCost</a>|
|[TransId](#TransId)||<a href="ProjForecastCost.md" target="_blank">Transaction/ProjForecastCost</a>|
|[Txt](#Txt)||<a href="ProjForecastCost.md" target="_blank">Transaction/ProjForecastCost</a>|
|[Worker](#Worker)||<a href="ProjForecastCost.md" target="_blank">Transaction/ProjForecastCost</a>|
|[DataAreaId](#DataAreaId)||<a href="ProjForecastCost.md" target="_blank">Transaction/ProjForecastCost</a>|
|[Relationship_CurrencyRelationshipId](#Relationship_CurrencyRelationshipId)||<a href="ProjForecastCost.md" target="_blank">Transaction/ProjForecastCost</a>|
|[Relationship_DefaultDimensionRelationshipId](#Relationship_DefaultDimensionRelationshipId)||<a href="ProjForecastCost.md" target="_blank">Transaction/ProjForecastCost</a>|
|[Relationship_ForecastModelRelationshipId](#Relationship_ForecastModelRelationshipId)||<a href="ProjForecastCost.md" target="_blank">Transaction/ProjForecastCost</a>|
|[Relationship_FundingSourceRelationshipId](#Relationship_FundingSourceRelationshipId)||<a href="ProjForecastCost.md" target="_blank">Transaction/ProjForecastCost</a>|
|[Relationship_LedgerAllocateKeyRelationshipId](#Relationship_LedgerAllocateKeyRelationshipId)||<a href="ProjForecastCost.md" target="_blank">Transaction/ProjForecastCost</a>|
|[Relationship_ProjAllocateKeyRelationshipId](#Relationship_ProjAllocateKeyRelationshipId)||<a href="ProjForecastCost.md" target="_blank">Transaction/ProjForecastCost</a>|
|[Relationship_ProjCategoryRelationshipId](#Relationship_ProjCategoryRelationshipId)||<a href="ProjForecastCost.md" target="_blank">Transaction/ProjForecastCost</a>|
|[Relationship_ProjLinePropertyRelationshipId](#Relationship_ProjLinePropertyRelationshipId)||<a href="ProjForecastCost.md" target="_blank">Transaction/ProjForecastCost</a>|
|[Relationship_ProjTableRelationshipId](#Relationship_ProjTableRelationshipId)||<a href="ProjForecastCost.md" target="_blank">Transaction/ProjForecastCost</a>|
|[Relationship_TaxGroupHeadingRelationshipId](#Relationship_TaxGroupHeadingRelationshipId)||<a href="ProjForecastCost.md" target="_blank">Transaction/ProjForecastCost</a>|
|[Relationship_ResourceTableRelationshipId](#Relationship_ResourceTableRelationshipId)||<a href="ProjForecastCost.md" target="_blank">Transaction/ProjForecastCost</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="ProjForecastCost.md" target="_blank">Transaction/ProjForecastCost</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Transaction/ProjForecastCost (this entity)  
...
### <a href=#CostPaymDate name="CostPaymDate">CostPaymDate</a>
...
<details>
<summary>List of traits for the CostPaymDate attribute are listed below.</summary>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Quantity</td></tr><tr><td>dataFormat</td><td>int32</td></tr></table>
...
### <a href=#PeriodAllocateId name="PeriodAllocateId">PeriodAllocateId</a>
...
<details>
<summary>List of traits for the PeriodAllocateId attribute are listed below.</summary>
...
### <a href=#ProjAllocateId name="ProjAllocateId">ProjAllocateId</a>
...
<details>
<summary>List of traits for the ProjAllocateId attribute are listed below.</summary>
...
### <a href=#SalesPaymDate name="SalesPaymDate">SalesPaymDate</a>
...
<details>
<summary>List of traits for the SalesPaymDate attribute are listed below.</summary>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Project date</td></tr><tr><td>dataFormat</td><td>date</td></tr></table>
...
**means.measurement.date**  
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Project date</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
