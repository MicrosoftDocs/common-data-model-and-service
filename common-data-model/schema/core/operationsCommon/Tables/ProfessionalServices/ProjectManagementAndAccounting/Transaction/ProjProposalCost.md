---
title: ProjProposalCost in Transaction - Common Data Model | Microsoft Docs
...
# Invoice proposal - expense in Transaction(ProjProposalCost)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/ProfessionalServices/ProjectManagementAndAccounting/Transaction/ProjProposalCost.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[ProjProposalCost/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Invoice proposal - expense</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="ProjProposalCost.md" target="_blank">Transaction/ProjProposalCost</a>|
|[EInvoiceAccountCode](#EInvoiceAccountCode)||<a href="ProjProposalCost.md" target="_blank">Transaction/ProjProposalCost</a>|
|[IncludedTaxPercent_BR](#IncludedTaxPercent_BR)||<a href="ProjProposalCost.md" target="_blank">Transaction/ProjProposalCost</a>|
|[ProposalId](#ProposalId)||<a href="ProjProposalCost.md" target="_blank">Transaction/ProjProposalCost</a>|
|[PSAContractLineNum](#PSAContractLineNum)||<a href="ProjProposalCost.md" target="_blank">Transaction/ProjProposalCost</a>|
|[TaxAmount](#TaxAmount)||<a href="ProjProposalCost.md" target="_blank">Transaction/ProjProposalCost</a>|
|[TaxGroupId](#TaxGroupId)||<a href="ProjProposalCost.md" target="_blank">Transaction/ProjProposalCost</a>|
|[TaxItemGroupId](#TaxItemGroupId)||<a href="ProjProposalCost.md" target="_blank">Transaction/ProjProposalCost</a>|
|[TaxWriteCode](#TaxWriteCode)||<a href="ProjProposalCost.md" target="_blank">Transaction/ProjProposalCost</a>|
|[TransId](#TransId)||<a href="ProjProposalCost.md" target="_blank">Transaction/ProjProposalCost</a>|
|[Txt](#Txt)||<a href="ProjProposalCost.md" target="_blank">Transaction/ProjProposalCost</a>|
|[RefInvoiceDate_MY](#RefInvoiceDate_MY)||<a href="ProjProposalCost.md" target="_blank">Transaction/ProjProposalCost</a>|
|[RefInvoiceId_MY](#RefInvoiceId_MY)||<a href="ProjProposalCost.md" target="_blank">Transaction/ProjProposalCost</a>|
|[OrderLineReference_NO](#OrderLineReference_NO)||<a href="ProjProposalCost.md" target="_blank">Transaction/ProjProposalCost</a>|
|[BookableResourceName](#BookableResourceName)||<a href="ProjProposalCost.md" target="_blank">Transaction/ProjProposalCost</a>|
|[DataAreaId](#DataAreaId)||<a href="ProjProposalCost.md" target="_blank">Transaction/ProjProposalCost</a>|
|[Relationship_ProjCostTransRelationshipId](#Relationship_ProjCostTransRelationshipId)||<a href="ProjProposalCost.md" target="_blank">Transaction/ProjProposalCost</a>|
|[Relationship_ProjProposalJourRelationshipId](#Relationship_ProjProposalJourRelationshipId)||<a href="ProjProposalCost.md" target="_blank">Transaction/ProjProposalCost</a>|
|[Relationship_PSAContractLineItemsRelationshipId](#Relationship_PSAContractLineItemsRelationshipId)||<a href="ProjProposalCost.md" target="_blank">Transaction/ProjProposalCost</a>|
|[Relationship_TaxGroupHeadingRelationshipId](#Relationship_TaxGroupHeadingRelationshipId)||<a href="ProjProposalCost.md" target="_blank">Transaction/ProjProposalCost</a>|
|[Relationship_TaxItemGroupHeadingRelationshipId](#Relationship_TaxItemGroupHeadingRelationshipId)||<a href="ProjProposalCost.md" target="_blank">Transaction/ProjProposalCost</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="ProjProposalCost.md" target="_blank">Transaction/ProjProposalCost</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Transaction/ProjProposalCost (this entity)  
