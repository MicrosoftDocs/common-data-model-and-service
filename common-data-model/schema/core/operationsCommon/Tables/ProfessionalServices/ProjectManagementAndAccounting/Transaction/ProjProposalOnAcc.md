---
title: ProjProposalOnAcc - Common Data Model | Microsoft Docs
...
# Invoice proposal - on-account
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/ProfessionalServices/ProjectManagementAndAccounting/Transaction/ProjProposalOnAcc.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[ProjProposalOnAcc/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Invoice proposal - on-account</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="ProjProposalOnAcc.md" target="_blank">Transaction/ProjProposalOnAcc</a>|
|[EInvoiceAccountCode](#EInvoiceAccountCode)||<a href="ProjProposalOnAcc.md" target="_blank">Transaction/ProjProposalOnAcc</a>|
|[IncludedTaxPercent_BR](#IncludedTaxPercent_BR)||<a href="ProjProposalOnAcc.md" target="_blank">Transaction/ProjProposalOnAcc</a>|
|[ProposalId](#ProposalId)||<a href="ProjProposalOnAcc.md" target="_blank">Transaction/ProjProposalOnAcc</a>|
|[PSAContractLineNum](#PSAContractLineNum)||<a href="ProjProposalOnAcc.md" target="_blank">Transaction/ProjProposalOnAcc</a>|
|[TaxAmount](#TaxAmount)||<a href="ProjProposalOnAcc.md" target="_blank">Transaction/ProjProposalOnAcc</a>|
|[TaxGroupId](#TaxGroupId)||<a href="ProjProposalOnAcc.md" target="_blank">Transaction/ProjProposalOnAcc</a>|
|[TaxItemGroupId](#TaxItemGroupId)||<a href="ProjProposalOnAcc.md" target="_blank">Transaction/ProjProposalOnAcc</a>|
|[TaxWriteCode](#TaxWriteCode)||<a href="ProjProposalOnAcc.md" target="_blank">Transaction/ProjProposalOnAcc</a>|
|[TransId](#TransId)||<a href="ProjProposalOnAcc.md" target="_blank">Transaction/ProjProposalOnAcc</a>|
|[Txt](#Txt)||<a href="ProjProposalOnAcc.md" target="_blank">Transaction/ProjProposalOnAcc</a>|
|[RefInvoiceDate_MY](#RefInvoiceDate_MY)||<a href="ProjProposalOnAcc.md" target="_blank">Transaction/ProjProposalOnAcc</a>|
|[RefInvoiceId_MY](#RefInvoiceId_MY)||<a href="ProjProposalOnAcc.md" target="_blank">Transaction/ProjProposalOnAcc</a>|
|[OrderLineReference_NO](#OrderLineReference_NO)||<a href="ProjProposalOnAcc.md" target="_blank">Transaction/ProjProposalOnAcc</a>|
|[SATProductCode_MX](#SATProductCode_MX)||<a href="ProjProposalOnAcc.md" target="_blank">Transaction/ProjProposalOnAcc</a>|
|[BookableResourceName](#BookableResourceName)||<a href="ProjProposalOnAcc.md" target="_blank">Transaction/ProjProposalOnAcc</a>|
|[DataAreaId](#DataAreaId)||<a href="ProjProposalOnAcc.md" target="_blank">Transaction/ProjProposalOnAcc</a>|
|[Relationship_projOnAccTransRelationshipId](#Relationship_projOnAccTransRelationshipId)||<a href="ProjProposalOnAcc.md" target="_blank">Transaction/ProjProposalOnAcc</a>|
|[Relationship_ProjProposalJourRelationshipId](#Relationship_ProjProposalJourRelationshipId)||<a href="ProjProposalOnAcc.md" target="_blank">Transaction/ProjProposalOnAcc</a>|
|[Relationship_PSAContractLineItemsRelationshipId](#Relationship_PSAContractLineItemsRelationshipId)||<a href="ProjProposalOnAcc.md" target="_blank">Transaction/ProjProposalOnAcc</a>|
|[Relationship_TaxGroupHeadingRelationshipId](#Relationship_TaxGroupHeadingRelationshipId)||<a href="ProjProposalOnAcc.md" target="_blank">Transaction/ProjProposalOnAcc</a>|
|[Relationship_TaxItemGroupHeadingRelationshipId](#Relationship_TaxItemGroupHeadingRelationshipId)||<a href="ProjProposalOnAcc.md" target="_blank">Transaction/ProjProposalOnAcc</a>|
|[Relationship_TaxServiceTariffRelationshipId](#Relationship_TaxServiceTariffRelationshipId)||<a href="ProjProposalOnAcc.md" target="_blank">Transaction/ProjProposalOnAcc</a>|
|[Relationship_SATProductCode_MXRelationshipId](#Relationship_SATProductCode_MXRelationshipId)||<a href="ProjProposalOnAcc.md" target="_blank">Transaction/ProjProposalOnAcc</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="ProjProposalOnAcc.md" target="_blank">Transaction/ProjProposalOnAcc</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Transaction/ProjProposalOnAcc (this entity)  
...
<details>
<summary>List of traits for the IncludedTaxPercent_BR attribute are listed below.</summary>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Original invoice date</td></tr><tr><td>dataFormat</td><td>date</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Original invoice number</td></tr><tr><td>dataFormat</td><td>string</td></tr></table>
