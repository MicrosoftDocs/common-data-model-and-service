---
title: ProjInvoiceEmpl in Transaction - Common Data Model | Microsoft Docs
...
# Project - invoice lines, employee in Transaction(ProjInvoiceEmpl)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/ProfessionalServices/ProjectManagementAndAccounting/Transaction/ProjInvoiceEmpl.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[ProjInvoiceEmpl/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Project - invoice lines, employee</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="ProjInvoiceEmpl.md" target="_blank">Transaction/ProjInvoiceEmpl</a>|
|[ActivityNumber](#ActivityNumber)||<a href="ProjInvoiceEmpl.md" target="_blank">Transaction/ProjInvoiceEmpl</a>|
|[CategoryId](#CategoryId)||<a href="ProjInvoiceEmpl.md" target="_blank">Transaction/ProjInvoiceEmpl</a>|
|[CurrencyId](#CurrencyId)||<a href="ProjInvoiceEmpl.md" target="_blank">Transaction/ProjInvoiceEmpl</a>|
|[DefaultDimension](#DefaultDimension)||<a href="ProjInvoiceEmpl.md" target="_blank">Transaction/ProjInvoiceEmpl</a>|
|[EInvoiceAccountCode](#EInvoiceAccountCode)||<a href="ProjInvoiceEmpl.md" target="_blank">Transaction/ProjInvoiceEmpl</a>|
|[InvoiceDate](#InvoiceDate)||<a href="ProjInvoiceEmpl.md" target="_blank">Transaction/ProjInvoiceEmpl</a>|
|[LineAmount](#LineAmount)||<a href="ProjInvoiceEmpl.md" target="_blank">Transaction/ProjInvoiceEmpl</a>|
|[ProjId](#ProjId)||<a href="ProjInvoiceEmpl.md" target="_blank">Transaction/ProjInvoiceEmpl</a>|
|[ProjInvoiceId](#ProjInvoiceId)||<a href="ProjInvoiceEmpl.md" target="_blank">Transaction/ProjInvoiceEmpl</a>|
|[PSAContractLineNum](#PSAContractLineNum)||<a href="ProjInvoiceEmpl.md" target="_blank">Transaction/ProjInvoiceEmpl</a>|
|[Qty](#Qty)||<a href="ProjInvoiceEmpl.md" target="_blank">Transaction/ProjInvoiceEmpl</a>|
|[Resource](#Resource)||<a href="ProjInvoiceEmpl.md" target="_blank">Transaction/ProjInvoiceEmpl</a>|
|[ResourceCategory](#ResourceCategory)||<a href="ProjInvoiceEmpl.md" target="_blank">Transaction/ProjInvoiceEmpl</a>|
|[TaxAmount](#TaxAmount)||<a href="ProjInvoiceEmpl.md" target="_blank">Transaction/ProjInvoiceEmpl</a>|
|[TaxGroupId](#TaxGroupId)||<a href="ProjInvoiceEmpl.md" target="_blank">Transaction/ProjInvoiceEmpl</a>|
|[TaxItemGroupId](#TaxItemGroupId)||<a href="ProjInvoiceEmpl.md" target="_blank">Transaction/ProjInvoiceEmpl</a>|
|[TaxWriteCode](#TaxWriteCode)||<a href="ProjInvoiceEmpl.md" target="_blank">Transaction/ProjInvoiceEmpl</a>|
|[TransDate](#TransDate)||<a href="ProjInvoiceEmpl.md" target="_blank">Transaction/ProjInvoiceEmpl</a>|
|[TransId](#TransId)||<a href="ProjInvoiceEmpl.md" target="_blank">Transaction/ProjInvoiceEmpl</a>|
|[Txt](#Txt)||<a href="ProjInvoiceEmpl.md" target="_blank">Transaction/ProjInvoiceEmpl</a>|
|[Worker](#Worker)||<a href="ProjInvoiceEmpl.md" target="_blank">Transaction/ProjInvoiceEmpl</a>|
|[WorkerLegalEntity](#WorkerLegalEntity)||<a href="ProjInvoiceEmpl.md" target="_blank">Transaction/ProjInvoiceEmpl</a>|
|[RefInvoiceDate_MY](#RefInvoiceDate_MY)||<a href="ProjInvoiceEmpl.md" target="_blank">Transaction/ProjInvoiceEmpl</a>|
|[RefInvoiceId_MY](#RefInvoiceId_MY)||<a href="ProjInvoiceEmpl.md" target="_blank">Transaction/ProjInvoiceEmpl</a>|
|[OrderLineReference_NO](#OrderLineReference_NO)||<a href="ProjInvoiceEmpl.md" target="_blank">Transaction/ProjInvoiceEmpl</a>|
|[BookableResourceName](#BookableResourceName)||<a href="ProjInvoiceEmpl.md" target="_blank">Transaction/ProjInvoiceEmpl</a>|
|[DataAreaId](#DataAreaId)||<a href="ProjInvoiceEmpl.md" target="_blank">Transaction/ProjInvoiceEmpl</a>|
|[Relationship_CurrencyRelationshipId](#Relationship_CurrencyRelationshipId)||<a href="ProjInvoiceEmpl.md" target="_blank">Transaction/ProjInvoiceEmpl</a>|
|[Relationship_DefaultDimensionRelationshipId](#Relationship_DefaultDimensionRelationshipId)||<a href="ProjInvoiceEmpl.md" target="_blank">Transaction/ProjInvoiceEmpl</a>|
|[Relationship_ProjActivityRelationshipId](#Relationship_ProjActivityRelationshipId)||<a href="ProjInvoiceEmpl.md" target="_blank">Transaction/ProjInvoiceEmpl</a>|
|[Relationship_ProjCategoryRelationshipId](#Relationship_ProjCategoryRelationshipId)||<a href="ProjInvoiceEmpl.md" target="_blank">Transaction/ProjInvoiceEmpl</a>|
|[Relationship_projEmplTransRelationshipId](#Relationship_projEmplTransRelationshipId)||<a href="ProjInvoiceEmpl.md" target="_blank">Transaction/ProjInvoiceEmpl</a>|
|[Relationship_ProjInvoiceJourRelationshipId](#Relationship_ProjInvoiceJourRelationshipId)||<a href="ProjInvoiceEmpl.md" target="_blank">Transaction/ProjInvoiceEmpl</a>|
|[Relationship_ProjProposalEmplRelationshipId](#Relationship_ProjProposalEmplRelationshipId)||<a href="ProjInvoiceEmpl.md" target="_blank">Transaction/ProjInvoiceEmpl</a>|
|[Relationship_ProjTableRelationshipId](#Relationship_ProjTableRelationshipId)||<a href="ProjInvoiceEmpl.md" target="_blank">Transaction/ProjInvoiceEmpl</a>|
|[Relationship_PSAContractLineItemsRelationshipId](#Relationship_PSAContractLineItemsRelationshipId)||<a href="ProjInvoiceEmpl.md" target="_blank">Transaction/ProjInvoiceEmpl</a>|
|[Relationship_ResourceLegalEntityRelationshipId](#Relationship_ResourceLegalEntityRelationshipId)||<a href="ProjInvoiceEmpl.md" target="_blank">Transaction/ProjInvoiceEmpl</a>|
|[Relationship_TaxGroupHeadingRelationshipId](#Relationship_TaxGroupHeadingRelationshipId)||<a href="ProjInvoiceEmpl.md" target="_blank">Transaction/ProjInvoiceEmpl</a>|
|[Relationship_TaxItemGroupHeadingRelationshipId](#Relationship_TaxItemGroupHeadingRelationshipId)||<a href="ProjInvoiceEmpl.md" target="_blank">Transaction/ProjInvoiceEmpl</a>|
|[Relationship_ResourceTableRelationshipId](#Relationship_ResourceTableRelationshipId)||<a href="ProjInvoiceEmpl.md" target="_blank">Transaction/ProjInvoiceEmpl</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="ProjInvoiceEmpl.md" target="_blank">Transaction/ProjInvoiceEmpl</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Transaction/ProjInvoiceEmpl (this entity)  
...
**means.identity.entityId**  
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="ProjProposalEmpl.md" target="_blank">/core/operationsCommon/Tables/ProfessionalServices/ProjectManagementAndAccounting/Transaction/ProjProposalEmpl.cdm.json/ProjProposalEmpl</a></td><td><a href="ProjProposalEmpl.md#RecId" target="_blank">RecId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
...
### <a href=#Relationship_ResourceLegalEntityRelationshipId name="Relationship_ResourceLegalEntityRelationshipId">Relationship_ResourceLegalEntityRelationshipId</a>
...
<details>
<summary>List of traits for the Relationship_ResourceLegalEntityRelationshipId attribute are listed below.</summary>
