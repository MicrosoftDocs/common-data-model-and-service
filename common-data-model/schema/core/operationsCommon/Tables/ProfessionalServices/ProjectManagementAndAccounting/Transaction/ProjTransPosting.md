---
title: ProjTransPosting in Transaction - Common Data Model | Microsoft Docs
...
# Ledger updates in Transaction(ProjTransPosting)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/ProfessionalServices/ProjectManagementAndAccounting/Transaction/ProjTransPosting.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[ProjTransPosting/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Ledger updates</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="ProjTransPosting.md" target="_blank">Transaction/ProjTransPosting</a>|
|[ActivityNumber](#ActivityNumber)||<a href="ProjTransPosting.md" target="_blank">Transaction/ProjTransPosting</a>|
|[AmountMst](#AmountMst)||<a href="ProjTransPosting.md" target="_blank">Transaction/ProjTransPosting</a>|
|[CategoryId](#CategoryId)||<a href="ProjTransPosting.md" target="_blank">Transaction/ProjTransPosting</a>|
|[costSales](#costSales)||<a href="ProjTransPosting.md" target="_blank">Transaction/ProjTransPosting</a>|
|[DefaultDimension](#DefaultDimension)||<a href="ProjTransPosting.md" target="_blank">Transaction/ProjTransPosting</a>|
|[EmplItemId](#EmplItemId)||<a href="ProjTransPosting.md" target="_blank">Transaction/ProjTransPosting</a>|
|[InventTransId](#InventTransId)||<a href="ProjTransPosting.md" target="_blank">Transaction/ProjTransPosting</a>|
|[LedgerDimension](#LedgerDimension)||<a href="ProjTransPosting.md" target="_blank">Transaction/ProjTransPosting</a>|
|[LedgerOrigin](#LedgerOrigin)||<a href="ProjTransPosting.md" target="_blank">Transaction/ProjTransPosting</a>|
|[LedgerTransDate](#LedgerTransDate)||<a href="ProjTransPosting.md" target="_blank">Transaction/ProjTransPosting</a>|
|[PaymentDate](#PaymentDate)||<a href="ProjTransPosting.md" target="_blank">Transaction/ProjTransPosting</a>|
|[PaymentStatus](#PaymentStatus)||<a href="ProjTransPosting.md" target="_blank">Transaction/ProjTransPosting</a>|
|[PostingType](#PostingType)||<a href="ProjTransPosting.md" target="_blank">Transaction/ProjTransPosting</a>|
|[ProjAdjustRefId](#ProjAdjustRefId)||<a href="ProjTransPosting.md" target="_blank">Transaction/ProjTransPosting</a>|
|[ProjFundingSource](#ProjFundingSource)||<a href="ProjTransPosting.md" target="_blank">Transaction/ProjTransPosting</a>|
|[ProjId](#ProjId)||<a href="ProjTransPosting.md" target="_blank">Transaction/ProjTransPosting</a>|
|[ProjTransDate](#ProjTransDate)||<a href="ProjTransPosting.md" target="_blank">Transaction/ProjTransPosting</a>|
|[ProjTransType](#ProjTransType)||<a href="ProjTransPosting.md" target="_blank">Transaction/ProjTransPosting</a>|
|[ProjType](#ProjType)||<a href="ProjTransPosting.md" target="_blank">Transaction/ProjTransPosting</a>|
|[Qty](#Qty)||<a href="ProjTransPosting.md" target="_blank">Transaction/ProjTransPosting</a>|
|[Resource](#Resource)||<a href="ProjTransPosting.md" target="_blank">Transaction/ProjTransPosting</a>|
|[ResourceCategory](#ResourceCategory)||<a href="ProjTransPosting.md" target="_blank">Transaction/ProjTransPosting</a>|
|[SubscriptionId](#SubscriptionId)||<a href="ProjTransPosting.md" target="_blank">Transaction/ProjTransPosting</a>|
|[TransactionOrigin](#TransactionOrigin)||<a href="ProjTransPosting.md" target="_blank">Transaction/ProjTransPosting</a>|
|[TransId](#TransId)||<a href="ProjTransPosting.md" target="_blank">Transaction/ProjTransPosting</a>|
|[Voucher](#Voucher)||<a href="ProjTransPosting.md" target="_blank">Transaction/ProjTransPosting</a>|
|[Worker](#Worker)||<a href="ProjTransPosting.md" target="_blank">Transaction/ProjTransPosting</a>|
|[WorkerLegalEntity](#WorkerLegalEntity)||<a href="ProjTransPosting.md" target="_blank">Transaction/ProjTransPosting</a>|
|[DataAreaId](#DataAreaId)||<a href="ProjTransPosting.md" target="_blank">Transaction/ProjTransPosting</a>|
|[Relationship_DefaultDimensionRelationshipId](#Relationship_DefaultDimensionRelationshipId)||<a href="ProjTransPosting.md" target="_blank">Transaction/ProjTransPosting</a>|
|[Relationship_InventTransOriginRelationshipId](#Relationship_InventTransOriginRelationshipId)||<a href="ProjTransPosting.md" target="_blank">Transaction/ProjTransPosting</a>|
|[Relationship_ItemRelationshipId](#Relationship_ItemRelationshipId)||<a href="ProjTransPosting.md" target="_blank">Transaction/ProjTransPosting</a>|
|[Relationship_LedgerDimensionRelationshipId](#Relationship_LedgerDimensionRelationshipId)||<a href="ProjTransPosting.md" target="_blank">Transaction/ProjTransPosting</a>|
|[Relationship_ProjCategoryRelationshipId](#Relationship_ProjCategoryRelationshipId)||<a href="ProjTransPosting.md" target="_blank">Transaction/ProjTransPosting</a>|
|[Relationship_projControlPeriodTransRelationshipId](#Relationship_projControlPeriodTransRelationshipId)||<a href="ProjTransPosting.md" target="_blank">Transaction/ProjTransPosting</a>|
|[Relationship_ProjCostTransRelationshipId](#Relationship_ProjCostTransRelationshipId)||<a href="ProjTransPosting.md" target="_blank">Transaction/ProjTransPosting</a>|
|[Relationship_ProjEmplTransRelationshipId](#Relationship_ProjEmplTransRelationshipId)||<a href="ProjTransPosting.md" target="_blank">Transaction/ProjTransPosting</a>|
|[Relationship_ProjFundingSourceRelationshipId](#Relationship_ProjFundingSourceRelationshipId)||<a href="ProjTransPosting.md" target="_blank">Transaction/ProjTransPosting</a>|
|[Relationship_projInvoiceCostRelationshipId](#Relationship_projInvoiceCostRelationshipId)||<a href="ProjTransPosting.md" target="_blank">Transaction/ProjTransPosting</a>|
|[Relationship_projInvoiceEmplRelationshipId](#Relationship_projInvoiceEmplRelationshipId)||<a href="ProjTransPosting.md" target="_blank">Transaction/ProjTransPosting</a>|
|[Relationship_projInvoiceItemRelationshipId](#Relationship_projInvoiceItemRelationshipId)||<a href="ProjTransPosting.md" target="_blank">Transaction/ProjTransPosting</a>|
|[Relationship_projInvoiceOnAccRelationshipId](#Relationship_projInvoiceOnAccRelationshipId)||<a href="ProjTransPosting.md" target="_blank">Transaction/ProjTransPosting</a>|
|[Relationship_projInvoiceRevenueRelationshipId](#Relationship_projInvoiceRevenueRelationshipId)||<a href="ProjTransPosting.md" target="_blank">Transaction/ProjTransPosting</a>|
|[Relationship_ProjItemTransRelationshipId](#Relationship_ProjItemTransRelationshipId)||<a href="ProjTransPosting.md" target="_blank">Transaction/ProjTransPosting</a>|
|[Relationship_ProjOnAccTransRelationshipId](#Relationship_ProjOnAccTransRelationshipId)||<a href="ProjTransPosting.md" target="_blank">Transaction/ProjTransPosting</a>|
|[Relationship_ProjRevenueTransRelationshipId](#Relationship_ProjRevenueTransRelationshipId)||<a href="ProjTransPosting.md" target="_blank">Transaction/ProjTransPosting</a>|
|[Relationship_ProjTableRelationshipId](#Relationship_ProjTableRelationshipId)||<a href="ProjTransPosting.md" target="_blank">Transaction/ProjTransPosting</a>|
|[Relationship_SubscriptionRelationshipId](#Relationship_SubscriptionRelationshipId)||<a href="ProjTransPosting.md" target="_blank">Transaction/ProjTransPosting</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="ProjTransPosting.md" target="_blank">Transaction/ProjTransPosting</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Transaction/ProjTransPosting (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Transaction ID</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>isReadOnly</td><td>true</td></tr><tr><td>isNullable</td><td>true</td></tr></table>
...
### <a href=#WorkerLegalEntity name="WorkerLegalEntity">WorkerLegalEntity</a>
...
<details>
<summary>List of traits for the WorkerLegalEntity attribute are listed below.</summary>
...
### <a href=#Relationship_projControlPeriodTransRelationshipId name="Relationship_projControlPeriodTransRelationshipId">Relationship_projControlPeriodTransRelationshipId</a>
...
<details>
<summary>List of traits for the Relationship_projControlPeriodTransRelationshipId attribute are listed below.</summary>
...
**means.identity.entityId**  
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="ProjControlPeriodTrans.md" target="_blank">/core/operationsCommon/Tables/ProfessionalServices/ProjectManagementAndAccounting/Transaction/ProjControlPeriodTrans.cdm.json/ProjControlPeriodTrans</a></td><td><a href="ProjControlPeriodTrans.md#RecId" target="_blank">RecId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
...
### <a href=#Relationship_projInvoiceCostRelationshipId name="Relationship_projInvoiceCostRelationshipId">Relationship_projInvoiceCostRelationshipId</a>
...
<details>
<summary>List of traits for the Relationship_projInvoiceCostRelationshipId attribute are listed below.</summary>
...
**means.identity.entityId**  
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="ProjInvoiceCost.md" target="_blank">/core/operationsCommon/Tables/ProfessionalServices/ProjectManagementAndAccounting/Transaction/ProjInvoiceCost.cdm.json/ProjInvoiceCost</a></td><td><a href="ProjInvoiceCost.md#RecId" target="_blank">RecId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
...
### <a href=#Relationship_projInvoiceEmplRelationshipId name="Relationship_projInvoiceEmplRelationshipId">Relationship_projInvoiceEmplRelationshipId</a>
...
<details>
<summary>List of traits for the Relationship_projInvoiceEmplRelationshipId attribute are listed below.</summary>
...
**means.identity.entityId**  
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="ProjInvoiceEmpl.md" target="_blank">/core/operationsCommon/Tables/ProfessionalServices/ProjectManagementAndAccounting/Transaction/ProjInvoiceEmpl.cdm.json/ProjInvoiceEmpl</a></td><td><a href="ProjInvoiceEmpl.md#RecId" target="_blank">RecId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
...
**means.identity.entityId**  
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="ProjInvoiceItem.md" target="_blank">/core/operationsCommon/Tables/ProfessionalServices/ProjectManagementAndAccounting/Transaction/ProjInvoiceItem.cdm.json/ProjInvoiceItem</a></td><td><a href="ProjInvoiceItem.md#RecId" target="_blank">RecId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
...
### <a href=#Relationship_projInvoiceOnAccRelationshipId name="Relationship_projInvoiceOnAccRelationshipId">Relationship_projInvoiceOnAccRelationshipId</a>
...
<details>
<summary>List of traits for the Relationship_projInvoiceOnAccRelationshipId attribute are listed below.</summary>
...
**means.identity.entityId**  
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="ProjInvoiceOnAcc.md" target="_blank">/core/operationsCommon/Tables/ProfessionalServices/ProjectManagementAndAccounting/Transaction/ProjInvoiceOnAcc.cdm.json/ProjInvoiceOnAcc</a></td><td><a href="ProjInvoiceOnAcc.md#RecId" target="_blank">RecId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
...
### <a href=#Relationship_projInvoiceRevenueRelationshipId name="Relationship_projInvoiceRevenueRelationshipId">Relationship_projInvoiceRevenueRelationshipId</a>
...
<details>
<summary>List of traits for the Relationship_projInvoiceRevenueRelationshipId attribute are listed below.</summary>
...
**means.identity.entityId**  
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="ProjInvoiceRevenue.md" target="_blank">/core/operationsCommon/Tables/ProfessionalServices/ProjectManagementAndAccounting/Transaction/ProjInvoiceRevenue.cdm.json/ProjInvoiceRevenue</a></td><td><a href="ProjInvoiceRevenue.md#RecId" target="_blank">RecId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
...
### <a href=#Relationship_SubscriptionRelationshipId name="Relationship_SubscriptionRelationshipId">Relationship_SubscriptionRelationshipId</a>
...
<details>
<summary>List of traits for the Relationship_SubscriptionRelationshipId attribute are listed below.</summary>
