---
title: ProjForecastEmpl in Transaction - Common Data Model | Microsoft Docs
...
# Hour forecast in Transaction(ProjForecastEmpl)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/ProfessionalServices/ProjectManagementAndAccounting/Transaction/ProjForecastEmpl.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[ProjForecastEmpl/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Hour forecast</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="ProjForecastEmpl.md" target="_blank">Transaction/ProjForecastEmpl</a>|
|[Active](#Active)||<a href="ProjForecastEmpl.md" target="_blank">Transaction/ProjForecastEmpl</a>|
|[ActivityNumber](#ActivityNumber)||<a href="ProjForecastEmpl.md" target="_blank">Transaction/ProjForecastEmpl</a>|
|[CategoryId](#CategoryId)||<a href="ProjForecastEmpl.md" target="_blank">Transaction/ProjForecastEmpl</a>|
|[CostPaymDate](#CostPaymDate)||<a href="ProjForecastEmpl.md" target="_blank">Transaction/ProjForecastEmpl</a>|
|[CostPrice](#CostPrice)||<a href="ProjForecastEmpl.md" target="_blank">Transaction/ProjForecastEmpl</a>|
|[CovStatus](#CovStatus)||<a href="ProjForecastEmpl.md" target="_blank">Transaction/ProjForecastEmpl</a>|
|[CurrencyId](#CurrencyId)||<a href="ProjForecastEmpl.md" target="_blank">Transaction/ProjForecastEmpl</a>|
|[DefaultDimension](#DefaultDimension)||<a href="ProjForecastEmpl.md" target="_blank">Transaction/ProjForecastEmpl</a>|
|[EliminationDate](#EliminationDate)||<a href="ProjForecastEmpl.md" target="_blank">Transaction/ProjForecastEmpl</a>|
|[ExchRate](#ExchRate)||<a href="ProjForecastEmpl.md" target="_blank">Transaction/ProjForecastEmpl</a>|
|[InvoiceDate](#InvoiceDate)||<a href="ProjForecastEmpl.md" target="_blank">Transaction/ProjForecastEmpl</a>|
|[JobId](#JobId)||<a href="ProjForecastEmpl.md" target="_blank">Transaction/ProjForecastEmpl</a>|
|[LineNum](#LineNum)||<a href="ProjForecastEmpl.md" target="_blank">Transaction/ProjForecastEmpl</a>|
|[LinePropertyId](#LinePropertyId)||<a href="ProjForecastEmpl.md" target="_blank">Transaction/ProjForecastEmpl</a>|
|[ModelId](#ModelId)||<a href="ProjForecastEmpl.md" target="_blank">Transaction/ProjForecastEmpl</a>|
|[ProjForecastBudgetType](#ProjForecastBudgetType)||<a href="ProjForecastEmpl.md" target="_blank">Transaction/ProjForecastEmpl</a>|
|[ProjFundingSource](#ProjFundingSource)||<a href="ProjForecastEmpl.md" target="_blank">Transaction/ProjForecastEmpl</a>|
|[ProjId](#ProjId)||<a href="ProjForecastEmpl.md" target="_blank">Transaction/ProjForecastEmpl</a>|
|[Qty](#Qty)||<a href="ProjForecastEmpl.md" target="_blank">Transaction/ProjForecastEmpl</a>|
|[Report](#Report)||<a href="ProjForecastEmpl.md" target="_blank">Transaction/ProjForecastEmpl</a>|
|[SalesPaymDate](#SalesPaymDate)||<a href="ProjForecastEmpl.md" target="_blank">Transaction/ProjForecastEmpl</a>|
|[SalesPrice](#SalesPrice)||<a href="ProjForecastEmpl.md" target="_blank">Transaction/ProjForecastEmpl</a>|
|[SchedCapacity](#SchedCapacity)||<a href="ProjForecastEmpl.md" target="_blank">Transaction/ProjForecastEmpl</a>|
|[SchedFromDate](#SchedFromDate)||<a href="ProjForecastEmpl.md" target="_blank">Transaction/ProjForecastEmpl</a>|
|[SchedFromTime](#SchedFromTime)||<a href="ProjForecastEmpl.md" target="_blank">Transaction/ProjForecastEmpl</a>|
|[SchedLink](#SchedLink)||<a href="ProjForecastEmpl.md" target="_blank">Transaction/ProjForecastEmpl</a>|
|[SchedLinkType](#SchedLinkType)||<a href="ProjForecastEmpl.md" target="_blank">Transaction/ProjForecastEmpl</a>|
|[SchedTimeHours](#SchedTimeHours)||<a href="ProjForecastEmpl.md" target="_blank">Transaction/ProjForecastEmpl</a>|
|[SchedToDate](#SchedToDate)||<a href="ProjForecastEmpl.md" target="_blank">Transaction/ProjForecastEmpl</a>|
|[SchedToTime](#SchedToTime)||<a href="ProjForecastEmpl.md" target="_blank">Transaction/ProjForecastEmpl</a>|
|[SchedWorkTime](#SchedWorkTime)||<a href="ProjForecastEmpl.md" target="_blank">Transaction/ProjForecastEmpl</a>|
|[SchedWrkCtrId](#SchedWrkCtrId)||<a href="ProjForecastEmpl.md" target="_blank">Transaction/ProjForecastEmpl</a>|
|[TaxGroupId](#TaxGroupId)||<a href="ProjForecastEmpl.md" target="_blank">Transaction/ProjForecastEmpl</a>|
|[TransId](#TransId)||<a href="ProjForecastEmpl.md" target="_blank">Transaction/ProjForecastEmpl</a>|
|[Txt](#Txt)||<a href="ProjForecastEmpl.md" target="_blank">Transaction/ProjForecastEmpl</a>|
|[Worker](#Worker)||<a href="ProjForecastEmpl.md" target="_blank">Transaction/ProjForecastEmpl</a>|
|[Resource](#Resource)||<a href="ProjForecastEmpl.md" target="_blank">Transaction/ProjForecastEmpl</a>|
|[ResourceCategory](#ResourceCategory)||<a href="ProjForecastEmpl.md" target="_blank">Transaction/ProjForecastEmpl</a>|
|[ResourceValidationSkipped](#ResourceValidationSkipped)||<a href="ProjForecastEmpl.md" target="_blank">Transaction/ProjForecastEmpl</a>|
|[DataAreaId](#DataAreaId)||<a href="ProjForecastEmpl.md" target="_blank">Transaction/ProjForecastEmpl</a>|
|[Relationship_CurrencyRelationshipId](#Relationship_CurrencyRelationshipId)||<a href="ProjForecastEmpl.md" target="_blank">Transaction/ProjForecastEmpl</a>|
|[Relationship_DefaultDimensionRelationshipId](#Relationship_DefaultDimensionRelationshipId)||<a href="ProjForecastEmpl.md" target="_blank">Transaction/ProjForecastEmpl</a>|
|[Relationship_ForecastModelRelationshipId](#Relationship_ForecastModelRelationshipId)||<a href="ProjForecastEmpl.md" target="_blank">Transaction/ProjForecastEmpl</a>|
|[Relationship_FundingSourceRelationshipId](#Relationship_FundingSourceRelationshipId)||<a href="ProjForecastEmpl.md" target="_blank">Transaction/ProjForecastEmpl</a>|
|[Relationship_ProjActivityRelationshipId](#Relationship_ProjActivityRelationshipId)||<a href="ProjForecastEmpl.md" target="_blank">Transaction/ProjForecastEmpl</a>|
|[Relationship_ProjCategoryRelationshipId](#Relationship_ProjCategoryRelationshipId)||<a href="ProjForecastEmpl.md" target="_blank">Transaction/ProjForecastEmpl</a>|
|[Relationship_ProjLinePropertyRelationshipId](#Relationship_ProjLinePropertyRelationshipId)||<a href="ProjForecastEmpl.md" target="_blank">Transaction/ProjForecastEmpl</a>|
|[Relationship_ProjTableRelationshipId](#Relationship_ProjTableRelationshipId)||<a href="ProjForecastEmpl.md" target="_blank">Transaction/ProjForecastEmpl</a>|
|[Relationship_TaxGroupHeadingRelationshipId](#Relationship_TaxGroupHeadingRelationshipId)||<a href="ProjForecastEmpl.md" target="_blank">Transaction/ProjForecastEmpl</a>|
|[Relationship_WrkCtrTableRelationshipId](#Relationship_WrkCtrTableRelationshipId)||<a href="ProjForecastEmpl.md" target="_blank">Transaction/ProjForecastEmpl</a>|
|[Relationship_ResourceTableRelationshipId](#Relationship_ResourceTableRelationshipId)||<a href="ProjForecastEmpl.md" target="_blank">Transaction/ProjForecastEmpl</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="ProjForecastEmpl.md" target="_blank">Transaction/ProjForecastEmpl</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Transaction/ProjForecastEmpl (this entity)  
...
### <a href=#SchedFromTime name="SchedFromTime">SchedFromTime</a>
...
<details>
<summary>List of traits for the SchedFromTime attribute are listed below.</summary>
...
### <a href=#SchedLink name="SchedLink">SchedLink</a>
...
<details>
<summary>List of traits for the SchedLink attribute are listed below.</summary>
...
### <a href=#SchedLinkType name="SchedLinkType">SchedLinkType</a>
...
<details>
<summary>List of traits for the SchedLinkType attribute are listed below.</summary>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Hours scheduled</td></tr><tr><td>dataFormat</td><td>decimal</td></tr><tr><td>isReadOnly</td><td>true</td></tr><tr><td>isNullable</td><td>true</td></tr></table>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Hours scheduled</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
### <a href=#SchedToTime name="SchedToTime">SchedToTime</a>
...
<details>
<summary>List of traits for the SchedToTime attribute are listed below.</summary>
...
### <a href=#SchedWrkCtrId name="SchedWrkCtrId">SchedWrkCtrId</a>
...
<details>
<summary>List of traits for the SchedWrkCtrId attribute are listed below.</summary>
...
### <a href=#ResourceValidationSkipped name="ResourceValidationSkipped">ResourceValidationSkipped</a>
...
<details>
<summary>List of traits for the ResourceValidationSkipped attribute are listed below.</summary>
