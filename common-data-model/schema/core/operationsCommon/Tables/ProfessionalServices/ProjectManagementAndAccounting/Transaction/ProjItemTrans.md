---
title: ProjItemTrans in Transaction - Common Data Model | Microsoft Docs
...
# Items in Transaction(ProjItemTrans)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/ProfessionalServices/ProjectManagementAndAccounting/Transaction/ProjItemTrans.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[ProjItemTrans/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="ProjItemTrans.md" target="_blank">Transaction/ProjItemTrans</a>|
|[ProjTransId](#ProjTransId)||<a href="ProjItemTrans.md" target="_blank">Transaction/ProjItemTrans</a>|
|[ActivityNumber](#ActivityNumber)||<a href="ProjItemTrans.md" target="_blank">Transaction/ProjItemTrans</a>|
|[AdjRefTransId](#AdjRefTransId)||<a href="ProjItemTrans.md" target="_blank">Transaction/ProjItemTrans</a>|
|[CategoryId](#CategoryId)||<a href="ProjItemTrans.md" target="_blank">Transaction/ProjItemTrans</a>|
|[CurrencyId](#CurrencyId)||<a href="ProjItemTrans.md" target="_blank">Transaction/ProjItemTrans</a>|
|[DefaultDimension](#DefaultDimension)||<a href="ProjItemTrans.md" target="_blank">Transaction/ProjItemTrans</a>|
|[IntrastatFulfillmentDate_HU](#IntrastatFulfillmentDate_HU)||<a href="ProjItemTrans.md" target="_blank">Transaction/ProjItemTrans</a>|
|[InventDimId](#InventDimId)||<a href="ProjItemTrans.md" target="_blank">Transaction/ProjItemTrans</a>|
|[InventTransId](#InventTransId)||<a href="ProjItemTrans.md" target="_blank">Transaction/ProjItemTrans</a>|
|[IsCorrection](#IsCorrection)||<a href="ProjItemTrans.md" target="_blank">Transaction/ProjItemTrans</a>|
|[ItemId](#ItemId)||<a href="ProjItemTrans.md" target="_blank">Transaction/ProjItemTrans</a>|
|[LedgerDimension](#LedgerDimension)||<a href="ProjItemTrans.md" target="_blank">Transaction/ProjItemTrans</a>|
|[LinePropertyId](#LinePropertyId)||<a href="ProjItemTrans.md" target="_blank">Transaction/ProjItemTrans</a>|
|[PackedExtensions](#PackedExtensions)||<a href="ProjItemTrans.md" target="_blank">Transaction/ProjItemTrans</a>|
|[PackingSlipId](#PackingSlipId)||<a href="ProjItemTrans.md" target="_blank">Transaction/ProjItemTrans</a>|
|[ProjAdjustRefId](#ProjAdjustRefId)||<a href="ProjItemTrans.md" target="_blank">Transaction/ProjItemTrans</a>|
|[ProjId](#ProjId)||<a href="ProjItemTrans.md" target="_blank">Transaction/ProjItemTrans</a>|
|[ProjTransIdRef](#ProjTransIdRef)||<a href="ProjItemTrans.md" target="_blank">Transaction/ProjItemTrans</a>|
|[PSAContractLineNum](#PSAContractLineNum)||<a href="ProjItemTrans.md" target="_blank">Transaction/ProjItemTrans</a>|
|[PSAProjOrigTransId](#PSAProjOrigTransId)||<a href="ProjItemTrans.md" target="_blank">Transaction/ProjItemTrans</a>|
|[Qty](#Qty)||<a href="ProjItemTrans.md" target="_blank">Transaction/ProjItemTrans</a>|
|[SalesUnit](#SalesUnit)||<a href="ProjItemTrans.md" target="_blank">Transaction/ProjItemTrans</a>|
|[TaxGroupId](#TaxGroupId)||<a href="ProjItemTrans.md" target="_blank">Transaction/ProjItemTrans</a>|
|[TaxItemGroupId](#TaxItemGroupId)||<a href="ProjItemTrans.md" target="_blank">Transaction/ProjItemTrans</a>|
|[TotalCostAmountCur](#TotalCostAmountCur)||<a href="ProjItemTrans.md" target="_blank">Transaction/ProjItemTrans</a>|
|[TotalSalesAmountCur](#TotalSalesAmountCur)||<a href="ProjItemTrans.md" target="_blank">Transaction/ProjItemTrans</a>|
|[TransactionOrigin](#TransactionOrigin)||<a href="ProjItemTrans.md" target="_blank">Transaction/ProjItemTrans</a>|
|[TransDate](#TransDate)||<a href="ProjItemTrans.md" target="_blank">Transaction/ProjItemTrans</a>|
|[Txt](#Txt)||<a href="ProjItemTrans.md" target="_blank">Transaction/ProjItemTrans</a>|
|[VendInvoiceTransRecId](#VendInvoiceTransRecId)||<a href="ProjItemTrans.md" target="_blank">Transaction/ProjItemTrans</a>|
|[VoucherPackingSlip](#VoucherPackingSlip)||<a href="ProjItemTrans.md" target="_blank">Transaction/ProjItemTrans</a>|
|[SalesQty](#SalesQty)||<a href="ProjItemTrans.md" target="_blank">Transaction/ProjItemTrans</a>|
|[VendorAccount](#VendorAccount)||<a href="ProjItemTrans.md" target="_blank">Transaction/ProjItemTrans</a>|
|[VendorName](#VendorName)||<a href="ProjItemTrans.md" target="_blank">Transaction/ProjItemTrans</a>|
|[BookableResourceName](#BookableResourceName)||<a href="ProjItemTrans.md" target="_blank">Transaction/ProjItemTrans</a>|
|[DataAreaId](#DataAreaId)||<a href="ProjItemTrans.md" target="_blank">Transaction/ProjItemTrans</a>|
|[Relationship_CurrencyRelationshipId](#Relationship_CurrencyRelationshipId)||<a href="ProjItemTrans.md" target="_blank">Transaction/ProjItemTrans</a>|
|[Relationship_DefaultDimensionRelationshipId](#Relationship_DefaultDimensionRelationshipId)||<a href="ProjItemTrans.md" target="_blank">Transaction/ProjItemTrans</a>|
|[Relationship_InventDim_1RelationshipId](#Relationship_InventDim_1RelationshipId)||<a href="ProjItemTrans.md" target="_blank">Transaction/ProjItemTrans</a>|
|[Relationship_InventTableRelationshipId](#Relationship_InventTableRelationshipId)||<a href="ProjItemTrans.md" target="_blank">Transaction/ProjItemTrans</a>|
|[Relationship_InventTransOriginRelationshipId](#Relationship_InventTransOriginRelationshipId)||<a href="ProjItemTrans.md" target="_blank">Transaction/ProjItemTrans</a>|
|[Relationship_LedgerDimensionRelationshipId](#Relationship_LedgerDimensionRelationshipId)||<a href="ProjItemTrans.md" target="_blank">Transaction/ProjItemTrans</a>|
|[Relationship_ProjCategoryRelationshipId](#Relationship_ProjCategoryRelationshipId)||<a href="ProjItemTrans.md" target="_blank">Transaction/ProjItemTrans</a>|
|[Relationship_ProjLinePropertyRelationshipId](#Relationship_ProjLinePropertyRelationshipId)||<a href="ProjItemTrans.md" target="_blank">Transaction/ProjItemTrans</a>|
|[Relationship_ProjTableRelationshipId](#Relationship_ProjTableRelationshipId)||<a href="ProjItemTrans.md" target="_blank">Transaction/ProjItemTrans</a>|
|[Relationship_PSAContractLineItemsRelationshipId](#Relationship_PSAContractLineItemsRelationshipId)||<a href="ProjItemTrans.md" target="_blank">Transaction/ProjItemTrans</a>|
|[Relationship_TaxGroupHeadingRelationshipId](#Relationship_TaxGroupHeadingRelationshipId)||<a href="ProjItemTrans.md" target="_blank">Transaction/ProjItemTrans</a>|
|[Relationship_TaxItemGroupHeadingRelationshipId](#Relationship_TaxItemGroupHeadingRelationshipId)||<a href="ProjItemTrans.md" target="_blank">Transaction/ProjItemTrans</a>|
|[Relationship_TaxServiceTariffRelationshipId](#Relationship_TaxServiceTariffRelationshipId)||<a href="ProjItemTrans.md" target="_blank">Transaction/ProjItemTrans</a>|
|[Relationship_VendInvoiceTransRelationshipId](#Relationship_VendInvoiceTransRelationshipId)||<a href="ProjItemTrans.md" target="_blank">Transaction/ProjItemTrans</a>|
|[Relationship_VendTableRelationshipId](#Relationship_VendTableRelationshipId)||<a href="ProjItemTrans.md" target="_blank">Transaction/ProjItemTrans</a>|
|[Relationship_DirPartyTableRelationshipId](#Relationship_DirPartyTableRelationshipId)||<a href="ProjItemTrans.md" target="_blank">Transaction/ProjItemTrans</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="ProjItemTrans.md" target="_blank">Transaction/ProjItemTrans</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Transaction/ProjItemTrans (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Adjustment reference ID</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>isNullable</td><td>true</td></tr></table>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Adjustment reference ID</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Dimension number</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>isReadOnly</td><td>true</td></tr><tr><td>isNullable</td><td>true</td></tr></table>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Dimension number</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
### <a href=#ProjTransIdRef name="ProjTransIdRef">ProjTransIdRef</a>

First included in: Transaction/ProjItemTrans (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Reference ID</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>isReadOnly</td><td>true</td></tr><tr><td>isNullable</td><td>true</td></tr></table>

#### Traits

<details>
<summary>List of traits for the ProjTransIdRef attribute are listed below.</summary>
...
### <a href=#VendInvoiceTransRecId name="VendInvoiceTransRecId">VendInvoiceTransRecId</a>
...
<details>
<summary>List of traits for the VendInvoiceTransRecId attribute are listed below.</summary>
...
### <a href=#VoucherPackingSlip name="VoucherPackingSlip">VoucherPackingSlip</a>
...
<details>
<summary>List of traits for the VoucherPackingSlip attribute are listed below.</summary>
...
### <a href=#Relationship_InventDim_1RelationshipId name="Relationship_InventDim_1RelationshipId">Relationship_InventDim_1RelationshipId</a>
...
<details>
<summary>List of traits for the Relationship_InventDim_1RelationshipId attribute are listed below.</summary>
