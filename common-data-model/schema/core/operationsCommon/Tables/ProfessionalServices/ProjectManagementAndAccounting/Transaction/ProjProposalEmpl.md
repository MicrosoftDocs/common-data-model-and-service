---
title: ProjProposalEmpl in Transaction - Common Data Model | Microsoft Docs
...
# Invoice proposal - employee in Transaction(ProjProposalEmpl)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/ProfessionalServices/ProjectManagementAndAccounting/Transaction/ProjProposalEmpl.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[ProjProposalEmpl/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="ProjProposalEmpl.md" target="_blank">Transaction/ProjProposalEmpl</a>|
|[EInvoiceAccountCode](#EInvoiceAccountCode)||<a href="ProjProposalEmpl.md" target="_blank">Transaction/ProjProposalEmpl</a>|
|[IncludedTaxPercent_BR](#IncludedTaxPercent_BR)||<a href="ProjProposalEmpl.md" target="_blank">Transaction/ProjProposalEmpl</a>|
|[ProposalId](#ProposalId)||<a href="ProjProposalEmpl.md" target="_blank">Transaction/ProjProposalEmpl</a>|
|[PSAContractLineNum](#PSAContractLineNum)||<a href="ProjProposalEmpl.md" target="_blank">Transaction/ProjProposalEmpl</a>|
|[TaxAmount](#TaxAmount)||<a href="ProjProposalEmpl.md" target="_blank">Transaction/ProjProposalEmpl</a>|
|[TaxGroupId](#TaxGroupId)||<a href="ProjProposalEmpl.md" target="_blank">Transaction/ProjProposalEmpl</a>|
|[TaxItemGroupId](#TaxItemGroupId)||<a href="ProjProposalEmpl.md" target="_blank">Transaction/ProjProposalEmpl</a>|
|[TaxWriteCode](#TaxWriteCode)||<a href="ProjProposalEmpl.md" target="_blank">Transaction/ProjProposalEmpl</a>|
|[TransId](#TransId)||<a href="ProjProposalEmpl.md" target="_blank">Transaction/ProjProposalEmpl</a>|
|[Txt](#Txt)||<a href="ProjProposalEmpl.md" target="_blank">Transaction/ProjProposalEmpl</a>|
|[RefInvoiceDate_MY](#RefInvoiceDate_MY)||<a href="ProjProposalEmpl.md" target="_blank">Transaction/ProjProposalEmpl</a>|
|[RefInvoiceId_MY](#RefInvoiceId_MY)||<a href="ProjProposalEmpl.md" target="_blank">Transaction/ProjProposalEmpl</a>|
|[OrderLineReference_NO](#OrderLineReference_NO)||<a href="ProjProposalEmpl.md" target="_blank">Transaction/ProjProposalEmpl</a>|
|[BookableResourceName](#BookableResourceName)||<a href="ProjProposalEmpl.md" target="_blank">Transaction/ProjProposalEmpl</a>|
|[DataAreaId](#DataAreaId)||<a href="ProjProposalEmpl.md" target="_blank">Transaction/ProjProposalEmpl</a>|
|[Relationship_projEmplTransRelationshipId](#Relationship_projEmplTransRelationshipId)||<a href="ProjProposalEmpl.md" target="_blank">Transaction/ProjProposalEmpl</a>|
|[Relationship_ProjProposalJourRelationshipId](#Relationship_ProjProposalJourRelationshipId)||<a href="ProjProposalEmpl.md" target="_blank">Transaction/ProjProposalEmpl</a>|
|[Relationship_PSAContractLineItemsRelationshipId](#Relationship_PSAContractLineItemsRelationshipId)||<a href="ProjProposalEmpl.md" target="_blank">Transaction/ProjProposalEmpl</a>|
|[Relationship_TaxGroupHeadingRelationshipId](#Relationship_TaxGroupHeadingRelationshipId)||<a href="ProjProposalEmpl.md" target="_blank">Transaction/ProjProposalEmpl</a>|
|[Relationship_TaxItemGroupHeadingRelationshipId](#Relationship_TaxItemGroupHeadingRelationshipId)||<a href="ProjProposalEmpl.md" target="_blank">Transaction/ProjProposalEmpl</a>|
|[Relationship_TaxServiceTariffRelationshipId](#Relationship_TaxServiceTariffRelationshipId)||<a href="ProjProposalEmpl.md" target="_blank">Transaction/ProjProposalEmpl</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="ProjProposalEmpl.md" target="_blank">Transaction/ProjProposalEmpl</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Transaction/ProjProposalEmpl (this entity)  
