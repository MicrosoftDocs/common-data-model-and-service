---
title: PurchRFQCaseLine in WorksheetLine - Common Data Model | Microsoft Docs
...
# Request for quotation case lines in WorksheetLine(PurchRFQCaseLine)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/SupplyChain/ProcurementAndSourcing/WorksheetLine/PurchRFQCaseLine.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[PurchRFQCaseLine/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Request for quotation case lines</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[AccountingDistributionTemplate](#AccountingDistributionTemplate)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[ActivityNumber](#ActivityNumber)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[AddressRefRecId](#AddressRefRecId)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[AddressRefTableId](#AddressRefTableId)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[AssetBookId](#AssetBookId)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[AssetId](#AssetId)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[AssetTransTypePurch](#AssetTransTypePurch)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[CategoryId](#CategoryId)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[ConfirmedDlv](#ConfirmedDlv)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[CurrencyCode](#CurrencyCode)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[DefaultDimension](#DefaultDimension)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[DeliveryDate](#DeliveryDate)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[DeliveryName](#DeliveryName)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[DeliveryPostalAddress](#DeliveryPostalAddress)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[ExpiryDateTime](#ExpiryDateTime)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[ExternalItemId](#ExternalItemId)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[InventDimId](#InventDimId)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[InventRefId](#InventRefId)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[InventRefTransId](#InventRefTransId)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[InventTransId](#InventTransId)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[ItemId](#ItemId)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[ItemName](#ItemName)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[ItemRefType](#ItemRefType)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[LineAmount](#LineAmount)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[LineDisc](#LineDisc)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[LineItemType](#LineItemType)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[LineNum](#LineNum)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[LineNumber](#LineNumber)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[LinePercent](#LinePercent)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[MaximumRetailPrice_IN](#MaximumRetailPrice_IN)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[MultiLnDisc](#MultiLnDisc)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[MultiLnPercent](#MultiLnPercent)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[Name](#Name)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[PdsCWQty](#PdsCWQty)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[PdsCWRemainInventPhysical](#PdsCWRemainInventPhysical)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[PdsCWRemainPurchPhysical](#PdsCWRemainPurchPhysical)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[PriceUnit](#PriceUnit)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[ProjCategoryId](#ProjCategoryId)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[ProjId](#ProjId)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[ProjLinePropertyId](#ProjLinePropertyId)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[ProjSalesCurrencyId](#ProjSalesCurrencyId)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[ProjSalesPrice](#ProjSalesPrice)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[ProjSalesUnitId](#ProjSalesUnitId)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[ProjTaxGroupId](#ProjTaxGroupId)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[ProjTaxItemGroupId](#ProjTaxItemGroupId)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[ProjTransId](#ProjTransId)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[PurchMarkup](#PurchMarkup)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[PurchPrice](#PurchPrice)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[PurchQty](#PurchQty)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[PurchUnit](#PurchUnit)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[QtyOrdered](#QtyOrdered)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[RemainInventPhysical](#RemainInventPhysical)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[RemainPurchPhysical](#RemainPurchPhysical)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[reqLineRefId](#reqLineRefId)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[ReqPlanIdSched](#ReqPlanIdSched)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[ReqPOId](#ReqPOId)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[RFQCaseId](#RFQCaseId)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[RFQType](#RFQType)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[StatusHigh](#StatusHigh)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[StatusLow](#StatusLow)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[ToBeDeleted](#ToBeDeleted)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[DataAreaId](#DataAreaId)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[Relationship_AccountingDistributionTemplateRelationshipId](#Relationship_AccountingDistributionTemplateRelationshipId)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[Relationship_AssetBookTableRelationshipId](#Relationship_AssetBookTableRelationshipId)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[Relationship_AssetTableRelationshipId](#Relationship_AssetTableRelationshipId)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[Relationship_CurrencyRelationshipId](#Relationship_CurrencyRelationshipId)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[Relationship_CurrencyProjSalesRelationshipId](#Relationship_CurrencyProjSalesRelationshipId)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[Relationship_DefaultDimensionRelationshipId](#Relationship_DefaultDimensionRelationshipId)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[Relationship_DeliveryPostalAddressRelationshipId](#Relationship_DeliveryPostalAddressRelationshipId)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[Relationship_EcoResCategory_FKRelationshipId](#Relationship_EcoResCategory_FKRelationshipId)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[Relationship_InventDimRelationshipId](#Relationship_InventDimRelationshipId)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[Relationship_InventTableRelationshipId](#Relationship_InventTableRelationshipId)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[Relationship_InventTransOriginRelationshipId](#Relationship_InventTransOriginRelationshipId)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[Relationship_LineItemTypeCategoryRelationshipId](#Relationship_LineItemTypeCategoryRelationshipId)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[Relationship_LineItemTypeItemRelationshipId](#Relationship_LineItemTypeItemRelationshipId)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[Relationship_ProjCategoryRelationshipId](#Relationship_ProjCategoryRelationshipId)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[Relationship_ProjItemTransRelationshipId](#Relationship_ProjItemTransRelationshipId)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[Relationship_ProjLinePropertyRelationshipId](#Relationship_ProjLinePropertyRelationshipId)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[Relationship_ProjTableRelationshipId](#Relationship_ProjTableRelationshipId)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[Relationship_PurchRFQCaseTableRelationshipId](#Relationship_PurchRFQCaseTableRelationshipId)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[Relationship_ReqPlanSchedRelationshipId](#Relationship_ReqPlanSchedRelationshipId)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[Relationship_TaxGroupHeadingRelationshipId](#Relationship_TaxGroupHeadingRelationshipId)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[Relationship_TaxItemGroupHeadingRelationshipId](#Relationship_TaxItemGroupHeadingRelationshipId)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="PurchRFQCaseLine.md" target="_blank">WorksheetLine/PurchRFQCaseLine</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: WorksheetLine/PurchRFQCaseLine (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>CW inventory remainder</td></tr><tr><td>dataFormat</td><td>decimal</td></tr><tr><td>isNullable</td><td>true</td></tr></table>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>CW inventory remainder</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
### <a href=#PdsCWRemainPurchPhysical name="PdsCWRemainPurchPhysical">PdsCWRemainPurchPhysical</a>

First included in: WorksheetLine/PurchRFQCaseLine (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>CW purchase remainder</td></tr><tr><td>dataFormat</td><td>decimal</td></tr><tr><td>isNullable</td><td>true</td></tr></table>

#### Traits

<details>
<summary>List of traits for the PdsCWRemainPurchPhysical attribute are listed below.</summary>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>CW purchase remainder</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Deliver remainder</td></tr><tr><td>dataFormat</td><td>decimal</td></tr><tr><td>isReadOnly</td><td>true</td></tr><tr><td>isNullable</td><td>true</td></tr></table>
...
### <a href=#reqLineRefId name="reqLineRefId">reqLineRefId</a>
...
<details>
<summary>List of traits for the reqLineRefId attribute are listed below.</summary>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Highest status</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>isReadOnly</td><td>true</td></tr><tr><td>isNullable</td><td>true</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Lowest status</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>isReadOnly</td><td>true</td></tr><tr><td>isNullable</td><td>true</td></tr></table>
...
### <a href=#ToBeDeleted name="ToBeDeleted">ToBeDeleted</a>
...
<details>
<summary>List of traits for the ToBeDeleted attribute are listed below.</summary>
...
### <a href=#Relationship_LineItemTypeCategoryRelationshipId name="Relationship_LineItemTypeCategoryRelationshipId">Relationship_LineItemTypeCategoryRelationshipId</a>
...
<details>
<summary>List of traits for the Relationship_LineItemTypeCategoryRelationshipId attribute are listed below.</summary>
...
### <a href=#Relationship_LineItemTypeItemRelationshipId name="Relationship_LineItemTypeItemRelationshipId">Relationship_LineItemTypeItemRelationshipId</a>
...
<details>
<summary>List of traits for the Relationship_LineItemTypeItemRelationshipId attribute are listed below.</summary>
