---
title: VendReceiptsListJour in Transaction - Common Data Model | Microsoft Docs
...
# Receipts list journal in Transaction(VendReceiptsListJour)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/SupplyChain/ProcurementAndSourcing/Transaction/VendReceiptsListJour.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[VendReceiptsListJour/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Receipts list journal</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="VendReceiptsListJour.md" target="_blank">Transaction/VendReceiptsListJour</a>|
|[VendAccount](#VendAccount)||<a href="VendReceiptsListJour.md" target="_blank">Transaction/VendReceiptsListJour</a>|
|[DeliveryDate](#DeliveryDate)||<a href="VendReceiptsListJour.md" target="_blank">Transaction/VendReceiptsListJour</a>|
|[DeliveryName](#DeliveryName)||<a href="VendReceiptsListJour.md" target="_blank">Transaction/VendReceiptsListJour</a>|
|[DeliveryPostalAddress](#DeliveryPostalAddress)||<a href="VendReceiptsListJour.md" target="_blank">Transaction/VendReceiptsListJour</a>|
|[DlvMode](#DlvMode)||<a href="VendReceiptsListJour.md" target="_blank">Transaction/VendReceiptsListJour</a>|
|[DlvTerm](#DlvTerm)||<a href="VendReceiptsListJour.md" target="_blank">Transaction/VendReceiptsListJour</a>|
|[InterCompanyPosted](#InterCompanyPosted)||<a href="VendReceiptsListJour.md" target="_blank">Transaction/VendReceiptsListJour</a>|
|[InvoiceAccount](#InvoiceAccount)||<a href="VendReceiptsListJour.md" target="_blank">Transaction/VendReceiptsListJour</a>|
|[LanguageId](#LanguageId)||<a href="VendReceiptsListJour.md" target="_blank">Transaction/VendReceiptsListJour</a>|
|[ParmId](#ParmId)||<a href="VendReceiptsListJour.md" target="_blank">Transaction/VendReceiptsListJour</a>|
|[PurchId](#PurchId)||<a href="VendReceiptsListJour.md" target="_blank">Transaction/VendReceiptsListJour</a>|
|[ReceiptsListDate](#ReceiptsListDate)||<a href="VendReceiptsListJour.md" target="_blank">Transaction/VendReceiptsListJour</a>|
|[ReceiptsListId](#ReceiptsListId)||<a href="VendReceiptsListJour.md" target="_blank">Transaction/VendReceiptsListJour</a>|
|[ReqAttention](#ReqAttention)||<a href="VendReceiptsListJour.md" target="_blank">Transaction/VendReceiptsListJour</a>|
|[Requester](#Requester)||<a href="VendReceiptsListJour.md" target="_blank">Transaction/VendReceiptsListJour</a>|
|[DataAreaId](#DataAreaId)||<a href="VendReceiptsListJour.md" target="_blank">Transaction/VendReceiptsListJour</a>|
|[Relationship_DeliveryPostalAddress_FKRelationshipId](#Relationship_DeliveryPostalAddress_FKRelationshipId)||<a href="VendReceiptsListJour.md" target="_blank">Transaction/VendReceiptsListJour</a>|
|[Relationship_DlvModeRelationshipId](#Relationship_DlvModeRelationshipId)||<a href="VendReceiptsListJour.md" target="_blank">Transaction/VendReceiptsListJour</a>|
|[Relationship_DlvTermRelationshipId](#Relationship_DlvTermRelationshipId)||<a href="VendReceiptsListJour.md" target="_blank">Transaction/VendReceiptsListJour</a>|
|[Relationship_InvoiceVendorRelationshipId](#Relationship_InvoiceVendorRelationshipId)||<a href="VendReceiptsListJour.md" target="_blank">Transaction/VendReceiptsListJour</a>|
|[Relationship_LanguageTableRelationshipId](#Relationship_LanguageTableRelationshipId)||<a href="VendReceiptsListJour.md" target="_blank">Transaction/VendReceiptsListJour</a>|
|[Relationship_OrderVendorRelationshipId](#Relationship_OrderVendorRelationshipId)||<a href="VendReceiptsListJour.md" target="_blank">Transaction/VendReceiptsListJour</a>|
|[Relationship_PurchTableRelationshipId](#Relationship_PurchTableRelationshipId)||<a href="VendReceiptsListJour.md" target="_blank">Transaction/VendReceiptsListJour</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="VendReceiptsListJour.md" target="_blank">Transaction/VendReceiptsListJour</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Transaction/VendReceiptsListJour (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Receipts list date</td></tr><tr><td>dataFormat</td><td>date</td></tr><tr><td>isNullable</td><td>true</td></tr></table>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Receipts list date</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
