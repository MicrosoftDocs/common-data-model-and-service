---
title: PurchReApprovalPolicyRuleTable in Main - Common Data Model | Microsoft Docs
...
# Purchase order re-approval policy in Main(PurchReApprovalPolicyRuleTable)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/SupplyChain/ProcurementAndSourcing/Main/PurchReApprovalPolicyRuleTable.cdm.json" target="_blank">GitHub</a>.  
...
**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Policy rules</td></tr><tr><td>en</td><td>Purchase order re-approval policy</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
