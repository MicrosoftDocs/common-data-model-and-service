---
title: PurchReqConsolidationHoldByVendorRule in Main - Common Data Model | Microsoft Docs
...
# Purchase requisition to purchase order consolidation rule in Main(PurchReqConsolidationHoldByVendorRule)
