---
title: CatPunchoutRequest in Worksheet - Common Data Model | Microsoft Docs
...
# Punchout request in Worksheet(CatPunchoutRequest)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/SupplyChain/ProcurementAndSourcing/Worksheet/CatPunchoutRequest.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[CatPunchoutRequest/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="CatPunchoutRequest.md" target="_blank">Worksheet/CatPunchoutRequest</a>|
|[InstanceRelationType](#InstanceRelationType)||<a href="CatPunchoutRequest.md" target="_blank">Worksheet/CatPunchoutRequest</a>|
|[RequestStatus](#RequestStatus)||<a href="CatPunchoutRequest.md" target="_blank">Worksheet/CatPunchoutRequest</a>|
|[PurchReqTable](#PurchReqTable)||<a href="CatPunchoutRequest.md" target="_blank">Worksheet/CatPunchoutRequest</a>|
|[Originator](#Originator)||<a href="CatPunchoutRequest.md" target="_blank">Worksheet/CatPunchoutRequest</a>|
|[Requisitioner](#Requisitioner)||<a href="CatPunchoutRequest.md" target="_blank">Worksheet/CatPunchoutRequest</a>|
|[ExternalCatalog](#ExternalCatalog)||<a href="CatPunchoutRequest.md" target="_blank">Worksheet/CatPunchoutRequest</a>|
|[BuyingLegalEntity](#BuyingLegalEntity)||<a href="CatPunchoutRequest.md" target="_blank">Worksheet/CatPunchoutRequest</a>|
|[ReceivingOperatingUnit](#ReceivingOperatingUnit)||<a href="CatPunchoutRequest.md" target="_blank">Worksheet/CatPunchoutRequest</a>|
|[Relationship_OMOperatingUnitRelationshipId](#Relationship_OMOperatingUnitRelationshipId)||<a href="CatPunchoutRequest.md" target="_blank">Worksheet/CatPunchoutRequest</a>|
|[Relationship_PurchReqTableRelationshipId](#Relationship_PurchReqTableRelationshipId)||<a href="CatPunchoutRequest.md" target="_blank">Worksheet/CatPunchoutRequest</a>|
|[Relationship_CatExternalCatalogRelationshipId](#Relationship_CatExternalCatalogRelationshipId)||<a href="CatPunchoutRequest.md" target="_blank">Worksheet/CatPunchoutRequest</a>|
|[Relationship_CompanyInfoRelationshipId](#Relationship_CompanyInfoRelationshipId)||<a href="CatPunchoutRequest.md" target="_blank">Worksheet/CatPunchoutRequest</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Worksheet/CatPunchoutRequest (this entity)  
