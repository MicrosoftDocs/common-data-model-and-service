---
title: PCTableConstraintColumnDefinition in Main - Common Data Model | Microsoft Docs
...
# Table constraint column in Main(PCTableConstraintColumnDefinition)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/SupplyChain/ProductInformationManagement/Main/PCTableConstraintColumnDefinition.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[PCTableConstraintColumnDefinition/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Table constraint column</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="PCTableConstraintColumnDefinition.md" target="_blank">Main/PCTableConstraintColumnDefinition</a>|
|[AttributeType](#AttributeType)||<a href="PCTableConstraintColumnDefinition.md" target="_blank">Main/PCTableConstraintColumnDefinition</a>|
|[InstanceRelationType](#InstanceRelationType)||<a href="PCTableConstraintColumnDefinition.md" target="_blank">Main/PCTableConstraintColumnDefinition</a>|
|[Name](#Name)||<a href="PCTableConstraintColumnDefinition.md" target="_blank">Main/PCTableConstraintColumnDefinition</a>|
|[TableConstraintDefinition](#TableConstraintDefinition)||<a href="PCTableConstraintColumnDefinition.md" target="_blank">Main/PCTableConstraintColumnDefinition</a>|
|[Relationship_AttributeTypeRelationshipId](#Relationship_AttributeTypeRelationshipId)||<a href="PCTableConstraintColumnDefinition.md" target="_blank">Main/PCTableConstraintColumnDefinition</a>|
|[Relationship_TableConstraintDefinitionRelationshipId](#Relationship_TableConstraintDefinitionRelationshipId)||<a href="PCTableConstraintColumnDefinition.md" target="_blank">Main/PCTableConstraintColumnDefinition</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Main/PCTableConstraintColumnDefinition (this entity)  
