---
title: EcoResProductVariantDimensionValue in Main - Common Data Model | Microsoft Docs
...
# Product variant - dimension values in Main(EcoResProductVariantDimensionValue)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/SupplyChain/ProductInformationManagement/Main/EcoResProductVariantDimensionValue.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[EcoResProductVariantDimensionValue/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Product variant - dimension values</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="EcoResProductVariantDimensionValue.md" target="_blank">Main/EcoResProductVariantDimensionValue</a>|
|[DistinctProductVariant](#DistinctProductVariant)||<a href="EcoResProductVariantDimensionValue.md" target="_blank">Main/EcoResProductVariantDimensionValue</a>|
|[InstanceRelationType](#InstanceRelationType)||<a href="EcoResProductVariantDimensionValue.md" target="_blank">Main/EcoResProductVariantDimensionValue</a>|
|[ProductDimensionAttribute](#ProductDimensionAttribute)||<a href="EcoResProductVariantDimensionValue.md" target="_blank">Main/EcoResProductVariantDimensionValue</a>|
|[RetailWeight](#RetailWeight)||<a href="EcoResProductVariantDimensionValue.md" target="_blank">Main/EcoResProductVariantDimensionValue</a>|
|[RetailDisplayOrder](#RetailDisplayOrder)||<a href="EcoResProductVariantDimensionValue.md" target="_blank">Main/EcoResProductVariantDimensionValue</a>|
|[Relationship_EcoResDistinctProductVariantRelationshipId](#Relationship_EcoResDistinctProductVariantRelationshipId)||<a href="EcoResProductVariantDimensionValue.md" target="_blank">Main/EcoResProductVariantDimensionValue</a>|
|[Relationship_EcoResProductDimensionAttributeRelationshipId](#Relationship_EcoResProductDimensionAttributeRelationshipId)||<a href="EcoResProductVariantDimensionValue.md" target="_blank">Main/EcoResProductVariantDimensionValue</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Main/EcoResProductVariantDimensionValue (this entity)  
