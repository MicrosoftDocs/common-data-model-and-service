---
title: EcoResDateTimeValue in Main - Common Data Model | Microsoft Docs
...
# The value of the DateTime data type for the attributes in Main(EcoResDateTimeValue)
...
**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>The base table for other value tables that each stores values of a different data type</td></tr><tr><td>en</td><td>The value of the DateTime data type for the attributes</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
