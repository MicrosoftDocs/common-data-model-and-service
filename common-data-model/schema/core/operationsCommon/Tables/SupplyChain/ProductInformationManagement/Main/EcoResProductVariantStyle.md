---
title: EcoResProductVariantStyle in Main - Common Data Model | Microsoft Docs
...
# Product variants styles in Main(EcoResProductVariantStyle)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/SupplyChain/ProductInformationManagement/Main/EcoResProductVariantStyle.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[EcoResProductVariantStyle/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Product variant - dimension values</td></tr><tr><td>en</td><td>Product variants styles</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="EcoResProductVariantStyle.md" target="_blank">Main/EcoResProductVariantStyle</a>|
|[DistinctProductVariant](#DistinctProductVariant)||<a href="EcoResProductVariantStyle.md" target="_blank">Main/EcoResProductVariantStyle</a>|
|[InstanceRelationType](#InstanceRelationType)||<a href="EcoResProductVariantStyle.md" target="_blank">Main/EcoResProductVariantStyle</a>|
|[ProductDimensionAttribute](#ProductDimensionAttribute)||<a href="EcoResProductVariantStyle.md" target="_blank">Main/EcoResProductVariantStyle</a>|
|[RetailWeight](#RetailWeight)||<a href="EcoResProductVariantStyle.md" target="_blank">Main/EcoResProductVariantStyle</a>|
|[RetailDisplayOrder](#RetailDisplayOrder)||<a href="EcoResProductVariantStyle.md" target="_blank">Main/EcoResProductVariantStyle</a>|
|[Relationship_EcoResDistinctProductVariantRelationshipId](#Relationship_EcoResDistinctProductVariantRelationshipId)||<a href="EcoResProductVariantStyle.md" target="_blank">Main/EcoResProductVariantStyle</a>|
|[Relationship_EcoResProductDimensionAttributeRelationshipId](#Relationship_EcoResProductDimensionAttributeRelationshipId)||<a href="EcoResProductVariantStyle.md" target="_blank">Main/EcoResProductVariantStyle</a>|
|[Style](#Style)||<a href="EcoResProductVariantStyle.md" target="_blank">Main/EcoResProductVariantStyle</a>|
|[Relationship_EcoResStyleRelationshipId](#Relationship_EcoResStyleRelationshipId)||<a href="EcoResProductVariantStyle.md" target="_blank">Main/EcoResProductVariantStyle</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Main/EcoResProductVariantStyle (this entity)  
