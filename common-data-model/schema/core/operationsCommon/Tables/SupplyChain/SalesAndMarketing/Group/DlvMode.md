---
title: DlvMode in Group - Common Data Model | Microsoft Docs
...
# Mode of delivery in Group(DlvMode)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/SupplyChain/SalesAndMarketing/Group/DlvMode.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[DlvMode/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="DlvMode.md" target="_blank">Group/DlvMode</a>|
|[Code](#Code)||<a href="DlvMode.md" target="_blank">Group/DlvMode</a>|
|[MarkupGroup](#MarkupGroup)||<a href="DlvMode.md" target="_blank">Group/DlvMode</a>|
|[MCRExpedite](#MCRExpedite)||<a href="DlvMode.md" target="_blank">Group/DlvMode</a>|
|[ShipCarrierAccountCode](#ShipCarrierAccountCode)||<a href="DlvMode.md" target="_blank">Group/DlvMode</a>|
|[ShipCarrierDlvType](#ShipCarrierDlvType)||<a href="DlvMode.md" target="_blank">Group/DlvMode</a>|
|[ShipCarrierId](#ShipCarrierId)||<a href="DlvMode.md" target="_blank">Group/DlvMode</a>|
|[ShipCarrierName](#ShipCarrierName)||<a href="DlvMode.md" target="_blank">Group/DlvMode</a>|
|[Transport](#Transport)||<a href="DlvMode.md" target="_blank">Group/DlvMode</a>|
|[Txt](#Txt)||<a href="DlvMode.md" target="_blank">Group/DlvMode</a>|
|[DOMPriority](#DOMPriority)||<a href="DlvMode.md" target="_blank">Group/DlvMode</a>|
...
### <a href=#DOMPriority name="DOMPriority">DOMPriority</a>

First included in: Group/DlvMode (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Priority</td></tr><tr><td>dataFormat</td><td>int64</td></tr><tr><td>isNullable</td><td>true</td></tr></table>

#### Traits

<details>
<summary>List of traits for the DOMPriority attribute are listed below.</summary>
