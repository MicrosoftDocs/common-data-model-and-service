---
title: smmLeadRelTable in Main - Common Data Model | Microsoft Docs
...
# Lead relations table in Main(smmLeadRelTable)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/SupplyChain/SalesAndMarketing/Main/smmLeadRelTable.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[smmLeadRelTable/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Lead relations table</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="smmLeadRelTable.md" target="_blank">Main/smmLeadRelTable</a>|
|[LeadId](#LeadId)||<a href="smmLeadRelTable.md" target="_blank">Main/smmLeadRelTable</a>|
|[RefRecId](#RefRecId)||<a href="smmLeadRelTable.md" target="_blank">Main/smmLeadRelTable</a>|
|[RefTableId](#RefTableId)||<a href="smmLeadRelTable.md" target="_blank">Main/smmLeadRelTable</a>|
|[DataAreaId](#DataAreaId)||<a href="smmLeadRelTable.md" target="_blank">Main/smmLeadRelTable</a>|
|[Relationship_ProjTableRelationshipId](#Relationship_ProjTableRelationshipId)||<a href="smmLeadRelTable.md" target="_blank">Main/smmLeadRelTable</a>|
|[Relationship_smmCampaignTableRelationshipId](#Relationship_smmCampaignTableRelationshipId)||<a href="smmLeadRelTable.md" target="_blank">Main/smmLeadRelTable</a>|
|[Relationship_smmLeadTableRelationshipId](#Relationship_smmLeadTableRelationshipId)||<a href="smmLeadRelTable.md" target="_blank">Main/smmLeadRelTable</a>|
|[Relationship_smmOpportunityTableRelationshipId](#Relationship_smmOpportunityTableRelationshipId)||<a href="smmLeadRelTable.md" target="_blank">Main/smmLeadRelTable</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="smmLeadRelTable.md" target="_blank">Main/smmLeadRelTable</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Main/smmLeadRelTable (this entity)  
