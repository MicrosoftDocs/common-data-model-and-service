---
title: smmCampaignResponsesQuest in Main - Common Data Model | Microsoft Docs
...
# Campaign response quest in Main(smmCampaignResponsesQuest)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/SupplyChain/SalesAndMarketing/Main/smmCampaignResponsesQuest.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[smmCampaignResponsesQuest/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Campaign response quest</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="smmCampaignResponsesQuest.md" target="_blank">Main/smmCampaignResponsesQuest</a>|
|[ContactPersonId](#ContactPersonId)||<a href="smmCampaignResponsesQuest.md" target="_blank">Main/smmCampaignResponsesQuest</a>|
|[kmVirtualNetworkAnswerTableId](#kmVirtualNetworkAnswerTableId)||<a href="smmCampaignResponsesQuest.md" target="_blank">Main/smmCampaignResponsesQuest</a>|
|[Party](#Party)||<a href="smmCampaignResponsesQuest.md" target="_blank">Main/smmCampaignResponsesQuest</a>|
|[DataAreaId](#DataAreaId)||<a href="smmCampaignResponsesQuest.md" target="_blank">Main/smmCampaignResponsesQuest</a>|
|[Relationship_ContactPersonRelationshipId](#Relationship_ContactPersonRelationshipId)||<a href="smmCampaignResponsesQuest.md" target="_blank">Main/smmCampaignResponsesQuest</a>|
|[Relationship_CustTableRelationshipId](#Relationship_CustTableRelationshipId)||<a href="smmCampaignResponsesQuest.md" target="_blank">Main/smmCampaignResponsesQuest</a>|
|[Relationship_DirPartyTable_FKRelationshipId](#Relationship_DirPartyTable_FKRelationshipId)||<a href="smmCampaignResponsesQuest.md" target="_blank">Main/smmCampaignResponsesQuest</a>|
|[Relationship_smmBusRelTableRelationshipId](#Relationship_smmBusRelTableRelationshipId)||<a href="smmCampaignResponsesQuest.md" target="_blank">Main/smmCampaignResponsesQuest</a>|
|[Relationship_VendTableRelationshipId](#Relationship_VendTableRelationshipId)||<a href="smmCampaignResponsesQuest.md" target="_blank">Main/smmCampaignResponsesQuest</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="smmCampaignResponsesQuest.md" target="_blank">Main/smmCampaignResponsesQuest</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Main/smmCampaignResponsesQuest (this entity)  
