---
title: smmResponsibilitiesEmplTable in Main - Common Data Model | Microsoft Docs
...
# Responsibility assignments in Main(smmResponsibilitiesEmplTable)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/SupplyChain/SalesAndMarketing/Main/smmResponsibilitiesEmplTable.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[smmResponsibilitiesEmplTable/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Responsibility assignments</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="smmResponsibilitiesEmplTable.md" target="_blank">Main/smmResponsibilitiesEmplTable</a>|
|[RefRecId](#RefRecId)||<a href="smmResponsibilitiesEmplTable.md" target="_blank">Main/smmResponsibilitiesEmplTable</a>|
|[RefTableId](#RefTableId)||<a href="smmResponsibilitiesEmplTable.md" target="_blank">Main/smmResponsibilitiesEmplTable</a>|
|[ResponsibilityId](#ResponsibilityId)||<a href="smmResponsibilitiesEmplTable.md" target="_blank">Main/smmResponsibilitiesEmplTable</a>|
|[Worker](#Worker)||<a href="smmResponsibilitiesEmplTable.md" target="_blank">Main/smmResponsibilitiesEmplTable</a>|
|[DataAreaId](#DataAreaId)||<a href="smmResponsibilitiesEmplTable.md" target="_blank">Main/smmResponsibilitiesEmplTable</a>|
|[Relationship_CustTableRelationshipId](#Relationship_CustTableRelationshipId)||<a href="smmResponsibilitiesEmplTable.md" target="_blank">Main/smmResponsibilitiesEmplTable</a>|
|[Relationship_smmBusRelTableRelationshipId](#Relationship_smmBusRelTableRelationshipId)||<a href="smmResponsibilitiesEmplTable.md" target="_blank">Main/smmResponsibilitiesEmplTable</a>|
|[Relationship_smmCampaignTableRelationshipId](#Relationship_smmCampaignTableRelationshipId)||<a href="smmResponsibilitiesEmplTable.md" target="_blank">Main/smmResponsibilitiesEmplTable</a>|
|[Relationship_smmLeadTableRelationshipId](#Relationship_smmLeadTableRelationshipId)||<a href="smmResponsibilitiesEmplTable.md" target="_blank">Main/smmResponsibilitiesEmplTable</a>|
|[Relationship_smmOpportunityTableRelationshipId](#Relationship_smmOpportunityTableRelationshipId)||<a href="smmResponsibilitiesEmplTable.md" target="_blank">Main/smmResponsibilitiesEmplTable</a>|
|[Relationship_smmResponsibilityGroupRelationshipId](#Relationship_smmResponsibilityGroupRelationshipId)||<a href="smmResponsibilitiesEmplTable.md" target="_blank">Main/smmResponsibilitiesEmplTable</a>|
|[Relationship_smmSalesUnitRelationshipId](#Relationship_smmSalesUnitRelationshipId)||<a href="smmResponsibilitiesEmplTable.md" target="_blank">Main/smmResponsibilitiesEmplTable</a>|
|[Relationship_smmTMCallListGroupRelationshipId](#Relationship_smmTMCallListGroupRelationshipId)||<a href="smmResponsibilitiesEmplTable.md" target="_blank">Main/smmResponsibilitiesEmplTable</a>|
|[Relationship_VendTableRelationshipId](#Relationship_VendTableRelationshipId)||<a href="smmResponsibilitiesEmplTable.md" target="_blank">Main/smmResponsibilitiesEmplTable</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="smmResponsibilitiesEmplTable.md" target="_blank">Main/smmResponsibilitiesEmplTable</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Main/smmResponsibilitiesEmplTable (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Worker</td></tr><tr><td>dataFormat</td><td>int64</td></tr><tr><td>isNullable</td><td>true</td></tr></table>
...
**means.identity.entityId**  
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="../Group/smmResponsibilityGroup.md" target="_blank">/core/operationsCommon/Tables/SupplyChain/SalesAndMarketing/Group/smmResponsibilityGroup.cdm.json/smmResponsibilityGroup</a></td><td><a href="../Group/smmResponsibilityGroup.md#RecId" target="_blank">RecId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
