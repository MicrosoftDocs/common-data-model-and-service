---
title: smmOpportunityRelTable in Main - Common Data Model | Microsoft Docs
...
# Opportunity relations table in Main(smmOpportunityRelTable)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/SupplyChain/SalesAndMarketing/Main/smmOpportunityRelTable.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[smmOpportunityRelTable/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Opportunity relations table</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="smmOpportunityRelTable.md" target="_blank">Main/smmOpportunityRelTable</a>|
|[OpportunityId](#OpportunityId)||<a href="smmOpportunityRelTable.md" target="_blank">Main/smmOpportunityRelTable</a>|
|[RefRecId](#RefRecId)||<a href="smmOpportunityRelTable.md" target="_blank">Main/smmOpportunityRelTable</a>|
|[RefTableId](#RefTableId)||<a href="smmOpportunityRelTable.md" target="_blank">Main/smmOpportunityRelTable</a>|
|[DataAreaId](#DataAreaId)||<a href="smmOpportunityRelTable.md" target="_blank">Main/smmOpportunityRelTable</a>|
|[Relationship_contactPersonRelationshipId](#Relationship_contactPersonRelationshipId)||<a href="smmOpportunityRelTable.md" target="_blank">Main/smmOpportunityRelTable</a>|
|[Relationship_ProjTableRelationshipId](#Relationship_ProjTableRelationshipId)||<a href="smmOpportunityRelTable.md" target="_blank">Main/smmOpportunityRelTable</a>|
|[Relationship_salesQuotationTableRelationshipId](#Relationship_salesQuotationTableRelationshipId)||<a href="smmOpportunityRelTable.md" target="_blank">Main/smmOpportunityRelTable</a>|
|[Relationship_smmCampaignTableRelationshipId](#Relationship_smmCampaignTableRelationshipId)||<a href="smmOpportunityRelTable.md" target="_blank">Main/smmOpportunityRelTable</a>|
|[Relationship_smmLeadTableRelationshipId](#Relationship_smmLeadTableRelationshipId)||<a href="smmOpportunityRelTable.md" target="_blank">Main/smmOpportunityRelTable</a>|
|[Relationship_smmOpportunityTableRelationshipId](#Relationship_smmOpportunityTableRelationshipId)||<a href="smmOpportunityRelTable.md" target="_blank">Main/smmOpportunityRelTable</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="smmOpportunityRelTable.md" target="_blank">Main/smmOpportunityRelTable</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Main/smmOpportunityRelTable (this entity)  
