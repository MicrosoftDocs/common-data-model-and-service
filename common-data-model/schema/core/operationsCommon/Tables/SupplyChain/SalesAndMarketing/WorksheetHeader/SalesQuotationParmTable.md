---
title: SalesQuotationParmTable in WorksheetHeader - Common Data Model | Microsoft Docs
...
# Quotation - update table in WorksheetHeader(SalesQuotationParmTable)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/SupplyChain/SalesAndMarketing/WorksheetHeader/SalesQuotationParmTable.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[SalesQuotationParmTable/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Quotation - update table</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="SalesQuotationParmTable.md" target="_blank">WorksheetHeader/SalesQuotationParmTable</a>|
|[BatchAdministration](#BatchAdministration)||<a href="SalesQuotationParmTable.md" target="_blank">WorksheetHeader/SalesQuotationParmTable</a>|
|[BatchType](#BatchType)||<a href="SalesQuotationParmTable.md" target="_blank">WorksheetHeader/SalesQuotationParmTable</a>|
|[BusRelAccount](#BusRelAccount)||<a href="SalesQuotationParmTable.md" target="_blank">WorksheetHeader/SalesQuotationParmTable</a>|
|[CurrencyCode](#CurrencyCode)||<a href="SalesQuotationParmTable.md" target="_blank">WorksheetHeader/SalesQuotationParmTable</a>|
|[CustAccount](#CustAccount)||<a href="SalesQuotationParmTable.md" target="_blank">WorksheetHeader/SalesQuotationParmTable</a>|
|[DeliveryName](#DeliveryName)||<a href="SalesQuotationParmTable.md" target="_blank">WorksheetHeader/SalesQuotationParmTable</a>|
|[DeliveryPostalAddress](#DeliveryPostalAddress)||<a href="SalesQuotationParmTable.md" target="_blank">WorksheetHeader/SalesQuotationParmTable</a>|
|[DlvMode](#DlvMode)||<a href="SalesQuotationParmTable.md" target="_blank">WorksheetHeader/SalesQuotationParmTable</a>|
|[FixedDueDate](#FixedDueDate)||<a href="SalesQuotationParmTable.md" target="_blank">WorksheetHeader/SalesQuotationParmTable</a>|
|[InvoiceAccount](#InvoiceAccount)||<a href="SalesQuotationParmTable.md" target="_blank">WorksheetHeader/SalesQuotationParmTable</a>|
|[Log](#Log)||<a href="SalesQuotationParmTable.md" target="_blank">WorksheetHeader/SalesQuotationParmTable</a>|
|[Ordering](#Ordering)||<a href="SalesQuotationParmTable.md" target="_blank">WorksheetHeader/SalesQuotationParmTable</a>|
|[ParmId](#ParmId)||<a href="SalesQuotationParmTable.md" target="_blank">WorksheetHeader/SalesQuotationParmTable</a>|
|[ParmJobStatus](#ParmJobStatus)||<a href="SalesQuotationParmTable.md" target="_blank">WorksheetHeader/SalesQuotationParmTable</a>|
|[ProjId](#ProjId)||<a href="SalesQuotationParmTable.md" target="_blank">WorksheetHeader/SalesQuotationParmTable</a>|
|[ProjInvoiceProjId](#ProjInvoiceProjId)||<a href="SalesQuotationParmTable.md" target="_blank">WorksheetHeader/SalesQuotationParmTable</a>|
|[QuotationExpiryDate](#QuotationExpiryDate)||<a href="SalesQuotationParmTable.md" target="_blank">WorksheetHeader/SalesQuotationParmTable</a>|
|[QuotationId](#QuotationId)||<a href="SalesQuotationParmTable.md" target="_blank">WorksheetHeader/SalesQuotationParmTable</a>|
|[QuotationName](#QuotationName)||<a href="SalesQuotationParmTable.md" target="_blank">WorksheetHeader/SalesQuotationParmTable</a>|
|[SalesIdManual](#SalesIdManual)||<a href="SalesQuotationParmTable.md" target="_blank">WorksheetHeader/SalesQuotationParmTable</a>|
|[TableRefId](#TableRefId)||<a href="SalesQuotationParmTable.md" target="_blank">WorksheetHeader/SalesQuotationParmTable</a>|
|[TaxInformation_IN](#TaxInformation_IN)||<a href="SalesQuotationParmTable.md" target="_blank">WorksheetHeader/SalesQuotationParmTable</a>|
|[Transdate](#Transdate)||<a href="SalesQuotationParmTable.md" target="_blank">WorksheetHeader/SalesQuotationParmTable</a>|
|[DataAreaId](#DataAreaId)||<a href="SalesQuotationParmTable.md" target="_blank">WorksheetHeader/SalesQuotationParmTable</a>|
|[Relationship_CurrencyRelationshipId](#Relationship_CurrencyRelationshipId)||<a href="SalesQuotationParmTable.md" target="_blank">WorksheetHeader/SalesQuotationParmTable</a>|
|[Relationship_CustBankAccountRelationshipId](#Relationship_CustBankAccountRelationshipId)||<a href="SalesQuotationParmTable.md" target="_blank">WorksheetHeader/SalesQuotationParmTable</a>|
|[Relationship_DeliveryPostalAddress_FKRelationshipId](#Relationship_DeliveryPostalAddress_FKRelationshipId)||<a href="SalesQuotationParmTable.md" target="_blank">WorksheetHeader/SalesQuotationParmTable</a>|
|[Relationship_DlvModeRelationshipId](#Relationship_DlvModeRelationshipId)||<a href="SalesQuotationParmTable.md" target="_blank">WorksheetHeader/SalesQuotationParmTable</a>|
|[Relationship_InvoiceCustomerRelationshipId](#Relationship_InvoiceCustomerRelationshipId)||<a href="SalesQuotationParmTable.md" target="_blank">WorksheetHeader/SalesQuotationParmTable</a>|
|[Relationship_OrderCustomerRelationshipId](#Relationship_OrderCustomerRelationshipId)||<a href="SalesQuotationParmTable.md" target="_blank">WorksheetHeader/SalesQuotationParmTable</a>|
|[Relationship_ProjInvoiceTableRelationshipId](#Relationship_ProjInvoiceTableRelationshipId)||<a href="SalesQuotationParmTable.md" target="_blank">WorksheetHeader/SalesQuotationParmTable</a>|
|[Relationship_ProjTableRelationshipId](#Relationship_ProjTableRelationshipId)||<a href="SalesQuotationParmTable.md" target="_blank">WorksheetHeader/SalesQuotationParmTable</a>|
|[Relationship_SalesQuotationParmUpdateRelationshipId](#Relationship_SalesQuotationParmUpdateRelationshipId)||<a href="SalesQuotationParmTable.md" target="_blank">WorksheetHeader/SalesQuotationParmTable</a>|
|[Relationship_SalesQuotationTableRelationshipId](#Relationship_SalesQuotationTableRelationshipId)||<a href="SalesQuotationParmTable.md" target="_blank">WorksheetHeader/SalesQuotationParmTable</a>|
|[Relationship_SalesTableRelationshipId](#Relationship_SalesTableRelationshipId)||<a href="SalesQuotationParmTable.md" target="_blank">WorksheetHeader/SalesQuotationParmTable</a>|
|[Relationship_smmBusRelTableRelationshipId](#Relationship_smmBusRelTableRelationshipId)||<a href="SalesQuotationParmTable.md" target="_blank">WorksheetHeader/SalesQuotationParmTable</a>|
|[Relationship_TaxInformation_INRelationshipId](#Relationship_TaxInformation_INRelationshipId)||<a href="SalesQuotationParmTable.md" target="_blank">WorksheetHeader/SalesQuotationParmTable</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="SalesQuotationParmTable.md" target="_blank">WorksheetHeader/SalesQuotationParmTable</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: WorksheetHeader/SalesQuotationParmTable (this entity)  
...
<details>
<summary>List of traits for the BatchType attribute are listed below.</summary>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Update</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>isReadOnly</td><td>true</td></tr><tr><td>isNullable</td><td>true</td></tr></table>
...
### <a href=#SalesIdManual name="SalesIdManual">SalesIdManual</a>
...
<details>
<summary>List of traits for the SalesIdManual attribute are listed below.</summary>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Date of update</td></tr><tr><td>dataFormat</td><td>date</td></tr><tr><td>isNullable</td><td>true</td></tr></table>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Date of update</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
### <a href=#Relationship_SalesQuotationParmUpdateRelationshipId name="Relationship_SalesQuotationParmUpdateRelationshipId">Relationship_SalesQuotationParmUpdateRelationshipId</a>
...
<details>
<summary>List of traits for the Relationship_SalesQuotationParmUpdateRelationshipId attribute are listed below.</summary>
...
**means.identity.entityId**  
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="../Transaction/SalesQuotationParmUpdate.md" target="_blank">/core/operationsCommon/Tables/SupplyChain/SalesAndMarketing/Transaction/SalesQuotationParmUpdate.cdm.json/SalesQuotationParmUpdate</a></td><td><a href="../Transaction/SalesQuotationParmUpdate.md#RecId" target="_blank">RecId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
