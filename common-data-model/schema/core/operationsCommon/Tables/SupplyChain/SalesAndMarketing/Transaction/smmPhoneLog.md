---
title: smmPhoneLog in Transaction - Common Data Model | Microsoft Docs
...
# Calls in Transaction(smmPhoneLog)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/SupplyChain/SalesAndMarketing/Transaction/smmPhoneLog.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[smmPhoneLog/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Calls</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="smmPhoneLog.md" target="_blank">Transaction/smmPhoneLog</a>|
|[ActivityNumber](#ActivityNumber)||<a href="smmPhoneLog.md" target="_blank">Transaction/smmPhoneLog</a>|
|[CallDate](#CallDate)||<a href="smmPhoneLog.md" target="_blank">Transaction/smmPhoneLog</a>|
|[CallDescription](#CallDescription)||<a href="smmPhoneLog.md" target="_blank">Transaction/smmPhoneLog</a>|
|[CallSubject](#CallSubject)||<a href="smmPhoneLog.md" target="_blank">Transaction/smmPhoneLog</a>|
|[CallType](#CallType)||<a href="smmPhoneLog.md" target="_blank">Transaction/smmPhoneLog</a>|
|[CaseId](#CaseId)||<a href="smmPhoneLog.md" target="_blank">Transaction/smmPhoneLog</a>|
|[ContactPersonId](#ContactPersonId)||<a href="smmPhoneLog.md" target="_blank">Transaction/smmPhoneLog</a>|
|[DurationTime](#DurationTime)||<a href="smmPhoneLog.md" target="_blank">Transaction/smmPhoneLog</a>|
|[EndTime](#EndTime)||<a href="smmPhoneLog.md" target="_blank">Transaction/smmPhoneLog</a>|
|[Party](#Party)||<a href="smmPhoneLog.md" target="_blank">Transaction/smmPhoneLog</a>|
|[PhoneCallId](#PhoneCallId)||<a href="smmPhoneLog.md" target="_blank">Transaction/smmPhoneLog</a>|
|[PhoneNumber](#PhoneNumber)||<a href="smmPhoneLog.md" target="_blank">Transaction/smmPhoneLog</a>|
|[SalesUnitId](#SalesUnitId)||<a href="smmPhoneLog.md" target="_blank">Transaction/smmPhoneLog</a>|
|[StartTime](#StartTime)||<a href="smmPhoneLog.md" target="_blank">Transaction/smmPhoneLog</a>|
|[Worker](#Worker)||<a href="smmPhoneLog.md" target="_blank">Transaction/smmPhoneLog</a>|
|[DataAreaId](#DataAreaId)||<a href="smmPhoneLog.md" target="_blank">Transaction/smmPhoneLog</a>|
|[Relationship_ContactPersonRelationshipId](#Relationship_ContactPersonRelationshipId)||<a href="smmPhoneLog.md" target="_blank">Transaction/smmPhoneLog</a>|
|[Relationship_CustTableRelationshipId](#Relationship_CustTableRelationshipId)||<a href="smmPhoneLog.md" target="_blank">Transaction/smmPhoneLog</a>|
|[Relationship_DirPartyTable_FKRelationshipId](#Relationship_DirPartyTable_FKRelationshipId)||<a href="smmPhoneLog.md" target="_blank">Transaction/smmPhoneLog</a>|
|[Relationship_smmBusRelTableRelationshipId](#Relationship_smmBusRelTableRelationshipId)||<a href="smmPhoneLog.md" target="_blank">Transaction/smmPhoneLog</a>|
|[Relationship_smmSalesUnitRelationshipId](#Relationship_smmSalesUnitRelationshipId)||<a href="smmPhoneLog.md" target="_blank">Transaction/smmPhoneLog</a>|
|[Relationship_smmTMCallListTableRelationshipId](#Relationship_smmTMCallListTableRelationshipId)||<a href="smmPhoneLog.md" target="_blank">Transaction/smmPhoneLog</a>|
|[Relationship_VendTableRelationshipId](#Relationship_VendTableRelationshipId)||<a href="smmPhoneLog.md" target="_blank">Transaction/smmPhoneLog</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="smmPhoneLog.md" target="_blank">Transaction/smmPhoneLog</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Transaction/smmPhoneLog (this entity)  
...
### <a href=#CallDate name="CallDate">CallDate</a>
...
<details>
<summary>List of traits for the CallDate attribute are listed below.</summary>
...
### <a href=#CallDescription name="CallDescription">CallDescription</a>
...
<details>
<summary>List of traits for the CallDescription attribute are listed below.</summary>
...
### <a href=#CallSubject name="CallSubject">CallSubject</a>
...
<details>
<summary>List of traits for the CallSubject attribute are listed below.</summary>
...
### <a href=#CallType name="CallType">CallType</a>
...
<details>
<summary>List of traits for the CallType attribute are listed below.</summary>
...
### <a href=#PhoneCallId name="PhoneCallId">PhoneCallId</a>
...
<details>
<summary>List of traits for the PhoneCallId attribute are listed below.</summary>
...
<details>
<summary>List of traits for the Relationship_smmTMCallListTableRelationshipId attribute are listed below.</summary>
...
**means.identity.entityId**  
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="../Main/smmTMCallListTable.md" target="_blank">/core/operationsCommon/Tables/SupplyChain/SalesAndMarketing/Main/smmTMCallListTable.cdm.json/smmTMCallListTable</a></td><td><a href="../Main/smmTMCallListTable.md#RecId" target="_blank">RecId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
