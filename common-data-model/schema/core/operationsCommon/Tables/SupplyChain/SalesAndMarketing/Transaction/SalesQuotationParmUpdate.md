---
title: SalesQuotationParmUpdate in Transaction - Common Data Model | Microsoft Docs
...
# Quotation - update in Transaction(SalesQuotationParmUpdate)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/SupplyChain/SalesAndMarketing/Transaction/SalesQuotationParmUpdate.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[SalesQuotationParmUpdate/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Quotation - update</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="SalesQuotationParmUpdate.md" target="_blank">Transaction/SalesQuotationParmUpdate</a>|
|[CreditRemaining](#CreditRemaining)||<a href="SalesQuotationParmUpdate.md" target="_blank">Transaction/SalesQuotationParmUpdate</a>|
|[DocumentStatus](#DocumentStatus)||<a href="SalesQuotationParmUpdate.md" target="_blank">Transaction/SalesQuotationParmUpdate</a>|
|[lateSelection](#lateSelection)||<a href="SalesQuotationParmUpdate.md" target="_blank">Transaction/SalesQuotationParmUpdate</a>|
|[lateSelectionQuery](#lateSelectionQuery)||<a href="SalesQuotationParmUpdate.md" target="_blank">Transaction/SalesQuotationParmUpdate</a>|
|[ParmId](#ParmId)||<a href="SalesQuotationParmUpdate.md" target="_blank">Transaction/SalesQuotationParmUpdate</a>|
|[Proforma](#Proforma)||<a href="SalesQuotationParmUpdate.md" target="_blank">Transaction/SalesQuotationParmUpdate</a>|
|[RespiteDate](#RespiteDate)||<a href="SalesQuotationParmUpdate.md" target="_blank">Transaction/SalesQuotationParmUpdate</a>|
|[Storno](#Storno)||<a href="SalesQuotationParmUpdate.md" target="_blank">Transaction/SalesQuotationParmUpdate</a>|
|[SumBy](#SumBy)||<a href="SalesQuotationParmUpdate.md" target="_blank">Transaction/SalesQuotationParmUpdate</a>|
|[DataAreaId](#DataAreaId)||<a href="SalesQuotationParmUpdate.md" target="_blank">Transaction/SalesQuotationParmUpdate</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="SalesQuotationParmUpdate.md" target="_blank">Transaction/SalesQuotationParmUpdate</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Transaction/SalesQuotationParmUpdate (this entity)  
