---
title: SalesLineDelete in WorksheetLine - Common Data Model | Microsoft Docs
...
# Voided sales order lines in WorksheetLine(SalesLineDelete)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/SupplyChain/SalesAndMarketing/WorksheetLine/SalesLineDelete.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[SalesLineDelete/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Voided sales order lines</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="SalesLineDelete.md" target="_blank">WorksheetLine/SalesLineDelete</a>|
|[ActivityNumber](#ActivityNumber)||<a href="SalesLineDelete.md" target="_blank">WorksheetLine/SalesLineDelete</a>|
|[InventDimId](#InventDimId)||<a href="SalesLineDelete.md" target="_blank">WorksheetLine/SalesLineDelete</a>|
|[InventTransId](#InventTransId)||<a href="SalesLineDelete.md" target="_blank">WorksheetLine/SalesLineDelete</a>|
|[ItemId](#ItemId)||<a href="SalesLineDelete.md" target="_blank">WorksheetLine/SalesLineDelete</a>|
|[LineAmount](#LineAmount)||<a href="SalesLineDelete.md" target="_blank">WorksheetLine/SalesLineDelete</a>|
|[LineNum](#LineNum)||<a href="SalesLineDelete.md" target="_blank">WorksheetLine/SalesLineDelete</a>|
|[Name](#Name)||<a href="SalesLineDelete.md" target="_blank">WorksheetLine/SalesLineDelete</a>|
|[ProjCategoryId](#ProjCategoryId)||<a href="SalesLineDelete.md" target="_blank">WorksheetLine/SalesLineDelete</a>|
|[ProjId](#ProjId)||<a href="SalesLineDelete.md" target="_blank">WorksheetLine/SalesLineDelete</a>|
|[SalesCategory](#SalesCategory)||<a href="SalesLineDelete.md" target="_blank">WorksheetLine/SalesLineDelete</a>|
|[SalesId](#SalesId)||<a href="SalesLineDelete.md" target="_blank">WorksheetLine/SalesLineDelete</a>|
|[SalesLine](#SalesLine)||<a href="SalesLineDelete.md" target="_blank">WorksheetLine/SalesLineDelete</a>|
|[SalesLineforeignTradeCategory](#SalesLineforeignTradeCategory)||<a href="SalesLineDelete.md" target="_blank">WorksheetLine/SalesLineDelete</a>|
|[SalesType](#SalesType)||<a href="SalesLineDelete.md" target="_blank">WorksheetLine/SalesLineDelete</a>|
|[DataAreaId](#DataAreaId)||<a href="SalesLineDelete.md" target="_blank">WorksheetLine/SalesLineDelete</a>|
|[Relationship_InventDimRelationshipId](#Relationship_InventDimRelationshipId)||<a href="SalesLineDelete.md" target="_blank">WorksheetLine/SalesLineDelete</a>|
|[Relationship_InventTableRelationshipId](#Relationship_InventTableRelationshipId)||<a href="SalesLineDelete.md" target="_blank">WorksheetLine/SalesLineDelete</a>|
|[Relationship_InventTransOriginRelationshipId](#Relationship_InventTransOriginRelationshipId)||<a href="SalesLineDelete.md" target="_blank">WorksheetLine/SalesLineDelete</a>|
|[Relationship_ProjCategoryRelationshipId](#Relationship_ProjCategoryRelationshipId)||<a href="SalesLineDelete.md" target="_blank">WorksheetLine/SalesLineDelete</a>|
|[Relationship_ProjTableRelationshipId](#Relationship_ProjTableRelationshipId)||<a href="SalesLineDelete.md" target="_blank">WorksheetLine/SalesLineDelete</a>|
|[Relationship_SalesCategoryRelationshipId](#Relationship_SalesCategoryRelationshipId)||<a href="SalesLineDelete.md" target="_blank">WorksheetLine/SalesLineDelete</a>|
|[Relationship_SalesTableDeleteRelationshipId](#Relationship_SalesTableDeleteRelationshipId)||<a href="SalesLineDelete.md" target="_blank">WorksheetLine/SalesLineDelete</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="SalesLineDelete.md" target="_blank">WorksheetLine/SalesLineDelete</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: WorksheetLine/SalesLineDelete (this entity)  
...
### <a href=#SalesLineforeignTradeCategory name="SalesLineforeignTradeCategory">SalesLineforeignTradeCategory</a>
...
<details>
<summary>List of traits for the SalesLineforeignTradeCategory attribute are listed below.</summary>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Type</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>isReadOnly</td><td>true</td></tr><tr><td>isNullable</td><td>true</td></tr></table>
...
### <a href=#Relationship_SalesTableDeleteRelationshipId name="Relationship_SalesTableDeleteRelationshipId">Relationship_SalesTableDeleteRelationshipId</a>
...
<details>
<summary>List of traits for the Relationship_SalesTableDeleteRelationshipId attribute are listed below.</summary>
...
**means.identity.entityId**  
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="../WorksheetHeader/SalesTableDelete.md" target="_blank">/core/operationsCommon/Tables/SupplyChain/SalesAndMarketing/WorksheetHeader/SalesTableDelete.cdm.json/SalesTableDelete</a></td><td><a href="../WorksheetHeader/SalesTableDelete.md#RecId" target="_blank">RecId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
