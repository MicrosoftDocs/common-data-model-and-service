---
title: TMSTransportationTender in Main - Common Data Model | Microsoft Docs
...
# Transportation tenders in Main(TMSTransportationTender)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/SupplyChain/Transportation/Main/TMSTransportationTender.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[TMSTransportationTender/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="TMSTransportationTender.md" target="_blank">Main/TMSTransportationTender</a>|
|[CarrierCode](#CarrierCode)||<a href="TMSTransportationTender.md" target="_blank">Main/TMSTransportationTender</a>|
|[CarrierServiceCode](#CarrierServiceCode)||<a href="TMSTransportationTender.md" target="_blank">Main/TMSTransportationTender</a>|
|[ConfirmedPickupDateTime](#ConfirmedPickupDateTime)||<a href="TMSTransportationTender.md" target="_blank">Main/TMSTransportationTender</a>|
|[ConfirmedRate](#ConfirmedRate)||<a href="TMSTransportationTender.md" target="_blank">Main/TMSTransportationTender</a>|
|[CurrencyCode](#CurrencyCode)||<a href="TMSTransportationTender.md" target="_blank">Main/TMSTransportationTender</a>|
|[DestinationLocation](#DestinationLocation)||<a href="TMSTransportationTender.md" target="_blank">Main/TMSTransportationTender</a>|
|[EquipmentCode](#EquipmentCode)||<a href="TMSTransportationTender.md" target="_blank">Main/TMSTransportationTender</a>|
|[LoadId](#LoadId)||<a href="TMSTransportationTender.md" target="_blank">Main/TMSTransportationTender</a>|
|[Miles](#Miles)||<a href="TMSTransportationTender.md" target="_blank">Main/TMSTransportationTender</a>|
|[OriginLocation](#OriginLocation)||<a href="TMSTransportationTender.md" target="_blank">Main/TMSTransportationTender</a>|
|[RefId](#RefId)||<a href="TMSTransportationTender.md" target="_blank">Main/TMSTransportationTender</a>|
|[RequestedPickupDateTime](#RequestedPickupDateTime)||<a href="TMSTransportationTender.md" target="_blank">Main/TMSTransportationTender</a>|
|[RequestedRate](#RequestedRate)||<a href="TMSTransportationTender.md" target="_blank">Main/TMSTransportationTender</a>|
|[Sequence](#Sequence)||<a href="TMSTransportationTender.md" target="_blank">Main/TMSTransportationTender</a>|
|[TenderRefType](#TenderRefType)||<a href="TMSTransportationTender.md" target="_blank">Main/TMSTransportationTender</a>|
|[TenderStatus](#TenderStatus)||<a href="TMSTransportationTender.md" target="_blank">Main/TMSTransportationTender</a>|
|[TransportationOrderNum](#TransportationOrderNum)||<a href="TMSTransportationTender.md" target="_blank">Main/TMSTransportationTender</a>|
|[Weight](#Weight)||<a href="TMSTransportationTender.md" target="_blank">Main/TMSTransportationTender</a>|
|[DataAreaId](#DataAreaId)||<a href="TMSTransportationTender.md" target="_blank">Main/TMSTransportationTender</a>|
|[Relationship_CurrencyRelationshipId](#Relationship_CurrencyRelationshipId)||<a href="TMSTransportationTender.md" target="_blank">Main/TMSTransportationTender</a>|
|[Relationship_LogisticsLocationDestinationRelationshipId](#Relationship_LogisticsLocationDestinationRelationshipId)||<a href="TMSTransportationTender.md" target="_blank">Main/TMSTransportationTender</a>|
|[Relationship_LogisticsLocationOriginRelationshipId](#Relationship_LogisticsLocationOriginRelationshipId)||<a href="TMSTransportationTender.md" target="_blank">Main/TMSTransportationTender</a>|
|[Relationship_TMSCarrierRelationshipId](#Relationship_TMSCarrierRelationshipId)||<a href="TMSTransportationTender.md" target="_blank">Main/TMSTransportationTender</a>|
|[Relationship_TMSCarrierServiceRelationshipId](#Relationship_TMSCarrierServiceRelationshipId)||<a href="TMSTransportationTender.md" target="_blank">Main/TMSTransportationTender</a>|
|[Relationship_TMSEquipmentRelationshipId](#Relationship_TMSEquipmentRelationshipId)||<a href="TMSTransportationTender.md" target="_blank">Main/TMSTransportationTender</a>|
|[Relationship_TMSRouteRelationshipId](#Relationship_TMSRouteRelationshipId)||<a href="TMSTransportationTender.md" target="_blank">Main/TMSTransportationTender</a>|
|[Relationship_TMSRouteSegmentRelationshipId](#Relationship_TMSRouteSegmentRelationshipId)||<a href="TMSTransportationTender.md" target="_blank">Main/TMSTransportationTender</a>|
|[Relationship_TMSRouteSegmentLoadRelationshipId](#Relationship_TMSRouteSegmentLoadRelationshipId)||<a href="TMSTransportationTender.md" target="_blank">Main/TMSTransportationTender</a>|
|[Relationship_WHSLoadTableRelationshipId](#Relationship_WHSLoadTableRelationshipId)||<a href="TMSTransportationTender.md" target="_blank">Main/TMSTransportationTender</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="TMSTransportationTender.md" target="_blank">Main/TMSTransportationTender</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Main/TMSTransportationTender (this entity)  
...
### <a href=#TenderRefType name="TenderRefType">TenderRefType</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Transportation tender</td></tr><tr><td>dataFormat</td><td>string</td></tr></table>
...
**is.dataFormat.array**  
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Transportation tender</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**means.identity.entityId**  
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="../Group/TMSEquipment.md" target="_blank">/core/operationsCommon/Tables/SupplyChain/Transportation/Group/TMSEquipment.cdm.json/TMSEquipment</a></td><td><a href="../Group/TMSEquipment.md#RecId" target="_blank">RecId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
...
**means.identity.entityId**  
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="TMSRoute.md" target="_blank">/core/operationsCommon/Tables/SupplyChain/Transportation/Main/TMSRoute.cdm.json/TMSRoute</a></td><td><a href="TMSRoute.md#RecId" target="_blank">RecId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
...
**means.identity.entityId**  
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="../../Inventory/WorksheetHeader/WHSLoadTable.md" target="_blank">/core/operationsCommon/Tables/SupplyChain/Inventory/WorksheetHeader/WHSLoadTable.cdm.json/WHSLoadTable</a></td><td><a href="../../Inventory/WorksheetHeader/WHSLoadTable.md#RecId" target="_blank">RecId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
