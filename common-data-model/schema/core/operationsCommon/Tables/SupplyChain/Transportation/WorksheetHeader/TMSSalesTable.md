---
title: TMSSalesTable in WorksheetHeader - Common Data Model | Microsoft Docs
...
# Sales Table Additional Fields in WorksheetHeader(TMSSalesTable)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/SupplyChain/Transportation/WorksheetHeader/TMSSalesTable.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[TMSSalesTable/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Sales Table Additional Fields</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="TMSSalesTable.md" target="_blank">WorksheetHeader/TMSSalesTable</a>|
|[CarrierCode](#CarrierCode)||<a href="TMSSalesTable.md" target="_blank">WorksheetHeader/TMSSalesTable</a>|
|[BrokerCode](#BrokerCode)||<a href="TMSSalesTable.md" target="_blank">WorksheetHeader/TMSSalesTable</a>|
|[CarrierGroupCode](#CarrierGroupCode)||<a href="TMSSalesTable.md" target="_blank">WorksheetHeader/TMSSalesTable</a>|
|[CarrierServiceCode](#CarrierServiceCode)||<a href="TMSSalesTable.md" target="_blank">WorksheetHeader/TMSSalesTable</a>|
|[ModeCode](#ModeCode)||<a href="TMSSalesTable.md" target="_blank">WorksheetHeader/TMSSalesTable</a>|
|[RouteConfigCode](#RouteConfigCode)||<a href="TMSSalesTable.md" target="_blank">WorksheetHeader/TMSSalesTable</a>|
|[SalesId](#SalesId)||<a href="TMSSalesTable.md" target="_blank">WorksheetHeader/TMSSalesTable</a>|
|[TransportationTemplateId](#TransportationTemplateId)||<a href="TMSSalesTable.md" target="_blank">WorksheetHeader/TMSSalesTable</a>|
|[CarrierCustomerAccountNumber](#CarrierCustomerAccountNumber)||<a href="TMSSalesTable.md" target="_blank">WorksheetHeader/TMSSalesTable</a>|
|[DataAreaId](#DataAreaId)||<a href="TMSSalesTable.md" target="_blank">WorksheetHeader/TMSSalesTable</a>|
|[Relationship_SalesTableRelationshipId](#Relationship_SalesTableRelationshipId)||<a href="TMSSalesTable.md" target="_blank">WorksheetHeader/TMSSalesTable</a>|
|[Relationship_TMSBrokerRelationshipId](#Relationship_TMSBrokerRelationshipId)||<a href="TMSSalesTable.md" target="_blank">WorksheetHeader/TMSSalesTable</a>|
|[Relationship_TMSCarrierRelationshipId](#Relationship_TMSCarrierRelationshipId)||<a href="TMSSalesTable.md" target="_blank">WorksheetHeader/TMSSalesTable</a>|
|[Relationship_TMSCarrierGroupRelationshipId](#Relationship_TMSCarrierGroupRelationshipId)||<a href="TMSSalesTable.md" target="_blank">WorksheetHeader/TMSSalesTable</a>|
|[Relationship_TMSCarrierServiceRelationshipId](#Relationship_TMSCarrierServiceRelationshipId)||<a href="TMSSalesTable.md" target="_blank">WorksheetHeader/TMSSalesTable</a>|
|[Relationship_TMSModeRelationshipId](#Relationship_TMSModeRelationshipId)||<a href="TMSSalesTable.md" target="_blank">WorksheetHeader/TMSSalesTable</a>|
|[Relationship_TMSRouteConfigRelationshipId](#Relationship_TMSRouteConfigRelationshipId)||<a href="TMSSalesTable.md" target="_blank">WorksheetHeader/TMSSalesTable</a>|
|[Relationship_TMSTransportationTemplateIdRelationshipId](#Relationship_TMSTransportationTemplateIdRelationshipId)||<a href="TMSSalesTable.md" target="_blank">WorksheetHeader/TMSSalesTable</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="TMSSalesTable.md" target="_blank">WorksheetHeader/TMSSalesTable</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: WorksheetHeader/TMSSalesTable (this entity)  
...
### <a href=#Relationship_TMSTransportationTemplateIdRelationshipId name="Relationship_TMSTransportationTemplateIdRelationshipId">Relationship_TMSTransportationTemplateIdRelationshipId</a>
...
<details>
<summary>List of traits for the Relationship_TMSTransportationTemplateIdRelationshipId attribute are listed below.</summary>
...
**means.identity.entityId**  
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="../Main/TMSTransportationTemplate.md" target="_blank">/core/operationsCommon/Tables/SupplyChain/Transportation/Main/TMSTransportationTemplate.cdm.json/TMSTransportationTemplate</a></td><td><a href="../Main/TMSTransportationTemplate.md#RecId" target="_blank">RecId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
