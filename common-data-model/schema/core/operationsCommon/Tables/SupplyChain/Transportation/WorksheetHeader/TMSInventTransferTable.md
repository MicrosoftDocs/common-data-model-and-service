---
title: TMSInventTransferTable in WorksheetHeader - Common Data Model | Microsoft Docs
...
# Invent Transfer Additional Fields in WorksheetHeader(TMSInventTransferTable)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/SupplyChain/Transportation/WorksheetHeader/TMSInventTransferTable.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[TMSInventTransferTable/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="TMSInventTransferTable.md" target="_blank">WorksheetHeader/TMSInventTransferTable</a>|
|[CarrierCode](#CarrierCode)||<a href="TMSInventTransferTable.md" target="_blank">WorksheetHeader/TMSInventTransferTable</a>|
|[CarrierGroupCode](#CarrierGroupCode)||<a href="TMSInventTransferTable.md" target="_blank">WorksheetHeader/TMSInventTransferTable</a>|
|[CarrierServiceCode](#CarrierServiceCode)||<a href="TMSInventTransferTable.md" target="_blank">WorksheetHeader/TMSInventTransferTable</a>|
|[ModeCode](#ModeCode)||<a href="TMSInventTransferTable.md" target="_blank">WorksheetHeader/TMSInventTransferTable</a>|
|[TransferId](#TransferId)||<a href="TMSInventTransferTable.md" target="_blank">WorksheetHeader/TMSInventTransferTable</a>|
|[DataAreaId](#DataAreaId)||<a href="TMSInventTransferTable.md" target="_blank">WorksheetHeader/TMSInventTransferTable</a>|
|[Relationship_InventTransferTableRelationshipId](#Relationship_InventTransferTableRelationshipId)||<a href="TMSInventTransferTable.md" target="_blank">WorksheetHeader/TMSInventTransferTable</a>|
|[Relationship_TMSCarrierRelationshipId](#Relationship_TMSCarrierRelationshipId)||<a href="TMSInventTransferTable.md" target="_blank">WorksheetHeader/TMSInventTransferTable</a>|
|[Relationship_TMSCarrierGroupRelationshipId](#Relationship_TMSCarrierGroupRelationshipId)||<a href="TMSInventTransferTable.md" target="_blank">WorksheetHeader/TMSInventTransferTable</a>|
|[Relationship_TMSCarrierServiceRelationshipId](#Relationship_TMSCarrierServiceRelationshipId)||<a href="TMSInventTransferTable.md" target="_blank">WorksheetHeader/TMSInventTransferTable</a>|
|[Relationship_TMSModeRelationshipId](#Relationship_TMSModeRelationshipId)||<a href="TMSInventTransferTable.md" target="_blank">WorksheetHeader/TMSInventTransferTable</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="TMSInventTransferTable.md" target="_blank">WorksheetHeader/TMSInventTransferTable</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: WorksheetHeader/TMSInventTransferTable (this entity)  
