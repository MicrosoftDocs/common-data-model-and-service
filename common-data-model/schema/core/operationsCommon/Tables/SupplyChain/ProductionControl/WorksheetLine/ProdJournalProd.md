---
title: ProdJournalProd in WorksheetLine - Common Data Model | Microsoft Docs
...
# Production journal transactions in WorksheetLine(ProdJournalProd)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/SupplyChain/ProductionControl/WorksheetLine/ProdJournalProd.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[ProdJournalProd/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="ProdJournalProd.md" target="_blank">WorksheetLine/ProdJournalProd</a>|
|[ErrorCause](#ErrorCause)||<a href="ProdJournalProd.md" target="_blank">WorksheetLine/ProdJournalProd</a>|
|[InventDimId](#InventDimId)||<a href="ProdJournalProd.md" target="_blank">WorksheetLine/ProdJournalProd</a>|
|[InventReturnFlag](#InventReturnFlag)||<a href="ProdJournalProd.md" target="_blank">WorksheetLine/ProdJournalProd</a>|
|[InventTransChildRefId](#InventTransChildRefId)||<a href="ProdJournalProd.md" target="_blank">WorksheetLine/ProdJournalProd</a>|
|[InventTransChildType](#InventTransChildType)||<a href="ProdJournalProd.md" target="_blank">WorksheetLine/ProdJournalProd</a>|
|[InventTransId](#InventTransId)||<a href="ProdJournalProd.md" target="_blank">WorksheetLine/ProdJournalProd</a>|
|[ItemId](#ItemId)||<a href="ProdJournalProd.md" target="_blank">WorksheetLine/ProdJournalProd</a>|
|[JournalId](#JournalId)||<a href="ProdJournalProd.md" target="_blank">WorksheetLine/ProdJournalProd</a>|
|[LineNum](#LineNum)||<a href="ProdJournalProd.md" target="_blank">WorksheetLine/ProdJournalProd</a>|
|[PDSBaseValue](#PDSBaseValue)||<a href="ProdJournalProd.md" target="_blank">WorksheetLine/ProdJournalProd</a>|
|[PdsCWBatchErr](#PdsCWBatchErr)||<a href="ProdJournalProd.md" target="_blank">WorksheetLine/ProdJournalProd</a>|
|[PdsCWBatchGood](#PdsCWBatchGood)||<a href="ProdJournalProd.md" target="_blank">WorksheetLine/ProdJournalProd</a>|
|[PmfAcceptError](#PmfAcceptError)||<a href="ProdJournalProd.md" target="_blank">WorksheetLine/ProdJournalProd</a>|
|[PmfProductType](#PmfProductType)||<a href="ProdJournalProd.md" target="_blank">WorksheetLine/ProdJournalProd</a>|
|[ProdFinished](#ProdFinished)||<a href="ProdJournalProd.md" target="_blank">WorksheetLine/ProdJournalProd</a>|
|[ProdId](#ProdId)||<a href="ProdJournalProd.md" target="_blank">WorksheetLine/ProdJournalProd</a>|
|[ProdPickList](#ProdPickList)||<a href="ProdJournalProd.md" target="_blank">WorksheetLine/ProdJournalProd</a>|
|[ProdPickListJournalId](#ProdPickListJournalId)||<a href="ProdJournalProd.md" target="_blank">WorksheetLine/ProdJournalProd</a>|
|[QtyError](#QtyError)||<a href="ProdJournalProd.md" target="_blank">WorksheetLine/ProdJournalProd</a>|
|[QtyGood](#QtyGood)||<a href="ProdJournalProd.md" target="_blank">WorksheetLine/ProdJournalProd</a>|
|[ReleaseKindId_RU](#ReleaseKindId_RU)||<a href="ProdJournalProd.md" target="_blank">WorksheetLine/ProdJournalProd</a>|
|[StornoPhysical_RU](#StornoPhysical_RU)||<a href="ProdJournalProd.md" target="_blank">WorksheetLine/ProdJournalProd</a>|
|[TransDate](#TransDate)||<a href="ProdJournalProd.md" target="_blank">WorksheetLine/ProdJournalProd</a>|
|[Voucher](#Voucher)||<a href="ProdJournalProd.md" target="_blank">WorksheetLine/ProdJournalProd</a>|
|[DataAreaId](#DataAreaId)||<a href="ProdJournalProd.md" target="_blank">WorksheetLine/ProdJournalProd</a>|
|[Relationship_InventDimRelationshipId](#Relationship_InventDimRelationshipId)||<a href="ProdJournalProd.md" target="_blank">WorksheetLine/ProdJournalProd</a>|
|[Relationship_InventTableRelationshipId](#Relationship_InventTableRelationshipId)||<a href="ProdJournalProd.md" target="_blank">WorksheetLine/ProdJournalProd</a>|
|[Relationship_InventTransOriginRelationshipId](#Relationship_InventTransOriginRelationshipId)||<a href="ProdJournalProd.md" target="_blank">WorksheetLine/ProdJournalProd</a>|
|[Relationship_JournalErrorRelationshipId](#Relationship_JournalErrorRelationshipId)||<a href="ProdJournalProd.md" target="_blank">WorksheetLine/ProdJournalProd</a>|
|[Relationship_PickingProdJournalTableRelationshipId](#Relationship_PickingProdJournalTableRelationshipId)||<a href="ProdJournalProd.md" target="_blank">WorksheetLine/ProdJournalProd</a>|
|[Relationship_ProdJournalTableRelationshipId](#Relationship_ProdJournalTableRelationshipId)||<a href="ProdJournalProd.md" target="_blank">WorksheetLine/ProdJournalProd</a>|
|[Relationship_ProdReleaseKindTable_RURelationshipId](#Relationship_ProdReleaseKindTable_RURelationshipId)||<a href="ProdJournalProd.md" target="_blank">WorksheetLine/ProdJournalProd</a>|
|[Relationship_ProdTableRelationshipId](#Relationship_ProdTableRelationshipId)||<a href="ProdJournalProd.md" target="_blank">WorksheetLine/ProdJournalProd</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="ProdJournalProd.md" target="_blank">WorksheetLine/ProdJournalProd</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: WorksheetLine/ProdJournalProd (this entity)  
...
### <a href=#InventTransChildRefId name="InventTransChildRefId">InventTransChildRefId</a>
...
<details>
<summary>List of traits for the InventTransChildRefId attribute are listed below.</summary>
...
### <a href=#InventTransChildType name="InventTransChildType">InventTransChildType</a>
...
<details>
<summary>List of traits for the InventTransChildType attribute are listed below.</summary>
...
### <a href=#PmfAcceptError name="PmfAcceptError">PmfAcceptError</a>
...
<details>
<summary>List of traits for the PmfAcceptError attribute are listed below.</summary>
...
### <a href=#ProdFinished name="ProdFinished">ProdFinished</a>
...
<details>
<summary>List of traits for the ProdFinished attribute are listed below.</summary>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>BOM consumption</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>isNullable</td><td>true</td></tr></table>
