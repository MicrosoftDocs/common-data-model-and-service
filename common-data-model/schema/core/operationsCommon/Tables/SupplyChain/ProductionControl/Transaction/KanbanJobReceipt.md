---
title: KanbanJobReceipt in Transaction - Common Data Model | Microsoft Docs
...
# Kanban job receipt in Transaction(KanbanJobReceipt)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/SupplyChain/ProductionControl/Transaction/KanbanJobReceipt.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[KanbanJobReceipt/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Kanban job receipt</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="KanbanJobReceipt.md" target="_blank">Transaction/KanbanJobReceipt</a>|
|[InventRefId](#InventRefId)||<a href="KanbanJobReceipt.md" target="_blank">Transaction/KanbanJobReceipt</a>|
|[InventRefTransId](#InventRefTransId)||<a href="KanbanJobReceipt.md" target="_blank">Transaction/KanbanJobReceipt</a>|
|[InventRefType](#InventRefType)||<a href="KanbanJobReceipt.md" target="_blank">Transaction/KanbanJobReceipt</a>|
|[KanbanJob](#KanbanJob)||<a href="KanbanJobReceipt.md" target="_blank">Transaction/KanbanJobReceipt</a>|
|[SourceDocumentLine](#SourceDocumentLine)||<a href="KanbanJobReceipt.md" target="_blank">Transaction/KanbanJobReceipt</a>|
|[Relationship_KanbanJobRelationshipId](#Relationship_KanbanJobRelationshipId)||<a href="KanbanJobReceipt.md" target="_blank">Transaction/KanbanJobReceipt</a>|
|[Relationship_SourceDocumentLineRelationshipId](#Relationship_SourceDocumentLineRelationshipId)||<a href="KanbanJobReceipt.md" target="_blank">Transaction/KanbanJobReceipt</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Transaction/KanbanJobReceipt (this entity)  
