---
title: JmgTermRegArchive in Transaction - Common Data Model | Microsoft Docs
...
# Raw registrations archive in Transaction(JmgTermRegArchive)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/SupplyChain/ProductionControl/Transaction/JmgTermRegArchive.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[JmgTermRegArchive/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Raw registrations archive</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="JmgTermRegArchive.md" target="_blank">Transaction/JmgTermRegArchive</a>|
|[AutoStamp](#AutoStamp)||<a href="JmgTermRegArchive.md" target="_blank">Transaction/JmgTermRegArchive</a>|
|[CostCategory](#CostCategory)||<a href="JmgTermRegArchive.md" target="_blank">Transaction/JmgTermRegArchive</a>|
|[Description](#Description)||<a href="JmgTermRegArchive.md" target="_blank">Transaction/JmgTermRegArchive</a>|
|[Error](#Error)||<a href="JmgTermRegArchive.md" target="_blank">Transaction/JmgTermRegArchive</a>|
|[ErrorSpecification](#ErrorSpecification)||<a href="JmgTermRegArchive.md" target="_blank">Transaction/JmgTermRegArchive</a>|
|[ErrorTxt](#ErrorTxt)||<a href="JmgTermRegArchive.md" target="_blank">Transaction/JmgTermRegArchive</a>|
|[FinishedCode](#FinishedCode)||<a href="JmgTermRegArchive.md" target="_blank">Transaction/JmgTermRegArchive</a>|
|[GoodItems](#GoodItems)||<a href="JmgTermRegArchive.md" target="_blank">Transaction/JmgTermRegArchive</a>|
|[JobActive](#JobActive)||<a href="JmgTermRegArchive.md" target="_blank">Transaction/JmgTermRegArchive</a>|
|[JobId](#JobId)||<a href="JmgTermRegArchive.md" target="_blank">Transaction/JmgTermRegArchive</a>|
|[JobIdAbs](#JobIdAbs)||<a href="JmgTermRegArchive.md" target="_blank">Transaction/JmgTermRegArchive</a>|
|[MatchRecIdStartStop](#MatchRecIdStartStop)||<a href="JmgTermRegArchive.md" target="_blank">Transaction/JmgTermRegArchive</a>|
|[OnCallActivity](#OnCallActivity)||<a href="JmgTermRegArchive.md" target="_blank">Transaction/JmgTermRegArchive</a>|
|[PdsCWGoodItems](#PdsCWGoodItems)||<a href="JmgTermRegArchive.md" target="_blank">Transaction/JmgTermRegArchive</a>|
|[PdsCWScrapItems](#PdsCWScrapItems)||<a href="JmgTermRegArchive.md" target="_blank">Transaction/JmgTermRegArchive</a>|
|[PdsCWStartItems](#PdsCWStartItems)||<a href="JmgTermRegArchive.md" target="_blank">Transaction/JmgTermRegArchive</a>|
|[ProfileDate](#ProfileDate)||<a href="JmgTermRegArchive.md" target="_blank">Transaction/JmgTermRegArchive</a>|
|[RegDateTime](#RegDateTime)||<a href="JmgTermRegArchive.md" target="_blank">Transaction/JmgTermRegArchive</a>|
|[RegType](#RegType)||<a href="JmgTermRegArchive.md" target="_blank">Transaction/JmgTermRegArchive</a>|
|[ResNo](#ResNo)||<a href="JmgTermRegArchive.md" target="_blank">Transaction/JmgTermRegArchive</a>|
|[ScrapCause](#ScrapCause)||<a href="JmgTermRegArchive.md" target="_blank">Transaction/JmgTermRegArchive</a>|
|[ScrapItems](#ScrapItems)||<a href="JmgTermRegArchive.md" target="_blank">Transaction/JmgTermRegArchive</a>|
|[StartItems](#StartItems)||<a href="JmgTermRegArchive.md" target="_blank">Transaction/JmgTermRegArchive</a>|
|[SysMrpUpdateRequest](#SysMrpUpdateRequest)||<a href="JmgTermRegArchive.md" target="_blank">Transaction/JmgTermRegArchive</a>|
|[TerminalId](#TerminalId)||<a href="JmgTermRegArchive.md" target="_blank">Transaction/JmgTermRegArchive</a>|
|[TermRegRecId](#TermRegRecId)||<a href="JmgTermRegArchive.md" target="_blank">Transaction/JmgTermRegArchive</a>|
|[TmpGoodItems](#TmpGoodItems)||<a href="JmgTermRegArchive.md" target="_blank">Transaction/JmgTermRegArchive</a>|
|[TmpScrapItems](#TmpScrapItems)||<a href="JmgTermRegArchive.md" target="_blank">Transaction/JmgTermRegArchive</a>|
|[TmpStartItems](#TmpStartItems)||<a href="JmgTermRegArchive.md" target="_blank">Transaction/JmgTermRegArchive</a>|
|[Worker](#Worker)||<a href="JmgTermRegArchive.md" target="_blank">Transaction/JmgTermRegArchive</a>|
|[WorkerPilot](#WorkerPilot)||<a href="JmgTermRegArchive.md" target="_blank">Transaction/JmgTermRegArchive</a>|
|[DataAreaId](#DataAreaId)||<a href="JmgTermRegArchive.md" target="_blank">Transaction/JmgTermRegArchive</a>|
|[Relationship_OnCallJmgIpcActivityRelationshipId](#Relationship_OnCallJmgIpcActivityRelationshipId)||<a href="JmgTermRegArchive.md" target="_blank">Transaction/JmgTermRegArchive</a>|
|[Relationship_ProjCategoryRelationshipId](#Relationship_ProjCategoryRelationshipId)||<a href="JmgTermRegArchive.md" target="_blank">Transaction/JmgTermRegArchive</a>|
|[Relationship_ResourceWrkCtrTableRelationshipId](#Relationship_ResourceWrkCtrTableRelationshipId)||<a href="JmgTermRegArchive.md" target="_blank">Transaction/JmgTermRegArchive</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="JmgTermRegArchive.md" target="_blank">Transaction/JmgTermRegArchive</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Transaction/JmgTermRegArchive (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Good quantity</td></tr><tr><td>dataFormat</td><td>decimal</td></tr><tr><td>isNullable</td><td>true</td></tr></table>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Good quantity</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Job</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>isNullable</td><td>true</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Absence job</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>isNullable</td><td>true</td></tr></table>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Absence job</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
### <a href=#ScrapCause name="ScrapCause">ScrapCause</a>
...
<details>
<summary>List of traits for the ScrapCause attribute are listed below.</summary>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Scrap quantity</td></tr><tr><td>dataFormat</td><td>decimal</td></tr><tr><td>isNullable</td><td>true</td></tr></table>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Scrap quantity</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
### <a href=#TermRegRecId name="TermRegRecId">TermRegRecId</a>

First included in: Transaction/JmgTermRegArchive (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Record ID</td></tr><tr><td>dataFormat</td><td>int64</td></tr><tr><td>isNullable</td><td>true</td></tr></table>

#### Traits

<details>
<summary>List of traits for the TermRegRecId attribute are listed below.</summary>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Record ID</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
