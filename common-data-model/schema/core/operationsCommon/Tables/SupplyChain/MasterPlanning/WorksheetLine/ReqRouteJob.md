---
title: ReqRouteJob in WorksheetLine - Common Data Model | Microsoft Docs
...
# Requirement job in WorksheetLine(ReqRouteJob)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/SupplyChain/MasterPlanning/WorksheetLine/ReqRouteJob.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[ReqRouteJob/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Requirement job</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="ReqRouteJob.md" target="_blank">WorksheetLine/ReqRouteJob</a>|
|[CalcTimeHours](#CalcTimeHours)||<a href="ReqRouteJob.md" target="_blank">WorksheetLine/ReqRouteJob</a>|
|[FromDate](#FromDate)||<a href="ReqRouteJob.md" target="_blank">WorksheetLine/ReqRouteJob</a>|
|[FromTime](#FromTime)||<a href="ReqRouteJob.md" target="_blank">WorksheetLine/ReqRouteJob</a>|
|[JobControl](#JobControl)||<a href="ReqRouteJob.md" target="_blank">WorksheetLine/ReqRouteJob</a>|
|[JobType](#JobType)||<a href="ReqRouteJob.md" target="_blank">WorksheetLine/ReqRouteJob</a>|
|[Link](#Link)||<a href="ReqRouteJob.md" target="_blank">WorksheetLine/ReqRouteJob</a>|
|[LinkType](#LinkType)||<a href="ReqRouteJob.md" target="_blank">WorksheetLine/ReqRouteJob</a>|
|[NumPrimary](#NumPrimary)||<a href="ReqRouteJob.md" target="_blank">WorksheetLine/ReqRouteJob</a>|
|[NumSecondary](#NumSecondary)||<a href="ReqRouteJob.md" target="_blank">WorksheetLine/ReqRouteJob</a>|
|[NumType](#NumType)||<a href="ReqRouteJob.md" target="_blank">WorksheetLine/ReqRouteJob</a>|
|[OprNum](#OprNum)||<a href="ReqRouteJob.md" target="_blank">WorksheetLine/ReqRouteJob</a>|
|[OprPriority](#OprPriority)||<a href="ReqRouteJob.md" target="_blank">WorksheetLine/ReqRouteJob</a>|
|[PlanVersion](#PlanVersion)||<a href="ReqRouteJob.md" target="_blank">WorksheetLine/ReqRouteJob</a>|
|[PropertyId](#PropertyId)||<a href="ReqRouteJob.md" target="_blank">WorksheetLine/ReqRouteJob</a>|
|[ReqPOId](#ReqPOId)||<a href="ReqRouteJob.md" target="_blank">WorksheetLine/ReqRouteJob</a>|
|[SchedCancelled](#SchedCancelled)||<a href="ReqRouteJob.md" target="_blank">WorksheetLine/ReqRouteJob</a>|
|[SchedTimeHours](#SchedTimeHours)||<a href="ReqRouteJob.md" target="_blank">WorksheetLine/ReqRouteJob</a>|
|[ToDate](#ToDate)||<a href="ReqRouteJob.md" target="_blank">WorksheetLine/ReqRouteJob</a>|
|[ToTime](#ToTime)||<a href="ReqRouteJob.md" target="_blank">WorksheetLine/ReqRouteJob</a>|
|[WrkCtrId](#WrkCtrId)||<a href="ReqRouteJob.md" target="_blank">WorksheetLine/ReqRouteJob</a>|
|[DataAreaId](#DataAreaId)||<a href="ReqRouteJob.md" target="_blank">WorksheetLine/ReqRouteJob</a>|
|[Relationship_ReqPlanVersionRelationshipId](#Relationship_ReqPlanVersionRelationshipId)||<a href="ReqRouteJob.md" target="_blank">WorksheetLine/ReqRouteJob</a>|
|[Relationship_ReqRouteRelationshipId](#Relationship_ReqRouteRelationshipId)||<a href="ReqRouteJob.md" target="_blank">WorksheetLine/ReqRouteJob</a>|
|[Relationship_ReqTransRelationshipId](#Relationship_ReqTransRelationshipId)||<a href="ReqRouteJob.md" target="_blank">WorksheetLine/ReqRouteJob</a>|
|[Relationship_ResourceWrkCtrTableRelationshipId](#Relationship_ResourceWrkCtrTableRelationshipId)||<a href="ReqRouteJob.md" target="_blank">WorksheetLine/ReqRouteJob</a>|
|[Relationship_WrkCtrPropertyRelationshipId](#Relationship_WrkCtrPropertyRelationshipId)||<a href="ReqRouteJob.md" target="_blank">WorksheetLine/ReqRouteJob</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="ReqRouteJob.md" target="_blank">WorksheetLine/ReqRouteJob</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: WorksheetLine/ReqRouteJob (this entity)  
