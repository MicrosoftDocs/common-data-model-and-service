---
title: WHSQualityOrderInventory in Transaction - Common Data Model | Microsoft Docs
...
# Quality order inventory in Transaction(WHSQualityOrderInventory)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/SupplyChain/Inventory/Transaction/WHSQualityOrderInventory.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[WHSQualityOrderInventory/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="WHSQualityOrderInventory.md" target="_blank">Transaction/WHSQualityOrderInventory</a>|
|[InventDimId](#InventDimId)||<a href="WHSQualityOrderInventory.md" target="_blank">Transaction/WHSQualityOrderInventory</a>|
|[InventHandlingQty](#InventHandlingQty)||<a href="WHSQualityOrderInventory.md" target="_blank">Transaction/WHSQualityOrderInventory</a>|
|[WorkId](#WorkId)||<a href="WHSQualityOrderInventory.md" target="_blank">Transaction/WHSQualityOrderInventory</a>|
|[QualityOrderId](#QualityOrderId)||<a href="WHSQualityOrderInventory.md" target="_blank">Transaction/WHSQualityOrderInventory</a>|
|[DataAreaId](#DataAreaId)||<a href="WHSQualityOrderInventory.md" target="_blank">Transaction/WHSQualityOrderInventory</a>|
|[Relationship_InventDimRelationshipId](#Relationship_InventDimRelationshipId)||<a href="WHSQualityOrderInventory.md" target="_blank">Transaction/WHSQualityOrderInventory</a>|
|[Relationship_InventQualityOrderTableRelationshipId](#Relationship_InventQualityOrderTableRelationshipId)||<a href="WHSQualityOrderInventory.md" target="_blank">Transaction/WHSQualityOrderInventory</a>|
|[Relationship_WHSWorkTableRelationshipId](#Relationship_WHSWorkTableRelationshipId)||<a href="WHSQualityOrderInventory.md" target="_blank">Transaction/WHSQualityOrderInventory</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="WHSQualityOrderInventory.md" target="_blank">Transaction/WHSQualityOrderInventory</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Transaction/WHSQualityOrderInventory (this entity)  
