---
title: InventJournalTrans in WorksheetLine - Common Data Model | Microsoft Docs
...
# Inventory journal lines in WorksheetLine(InventJournalTrans)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/SupplyChain/Inventory/WorksheetLine/InventJournalTrans.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[InventJournalTrans/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Inventory journal lines</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[ActivityNumber](#ActivityNumber)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[AssetBookId](#AssetBookId)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[AssetId](#AssetId)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[AssetTransType](#AssetTransType)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[BOMLine](#BOMLine)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[CostAmount](#CostAmount)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[CostMarkup](#CostMarkup)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[CostPrice](#CostPrice)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[Counted](#Counted)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[DefaultDimension](#DefaultDimension)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[DSA_IN](#DSA_IN)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[ExciseRecordType_IN](#ExciseRecordType_IN)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[ExciseTariffCodes_IN](#ExciseTariffCodes_IN)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[ExciseType_IN](#ExciseType_IN)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[IntrastatFulfillmentDate_HU](#IntrastatFulfillmentDate_HU)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[InventDimId](#InventDimId)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[InventOnHand](#InventOnHand)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[InventRefId](#InventRefId)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[InventRefTransId](#InventRefTransId)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[InventRefType](#InventRefType)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[InventTransId](#InventTransId)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[InventTransIdFather](#InventTransIdFather)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[InventTransIdReturn](#InventTransIdReturn)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[ItemId](#ItemId)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[JournalId](#JournalId)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[JournalType](#JournalType)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[LedgerDimension](#LedgerDimension)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[LineNum](#LineNum)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[PackedExtensions](#PackedExtensions)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[PdsCopyBatchAttrib](#PdsCopyBatchAttrib)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[PdsCWInventOnHand](#PdsCWInventOnHand)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[PdsCWInventQtyCounted](#PdsCWInventQtyCounted)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[PdsCWQty](#PdsCWQty)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[PostalAddress_IN](#PostalAddress_IN)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[PriceUnit](#PriceUnit)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[ProfitSet](#ProfitSet)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[ProjCategoryId](#ProjCategoryId)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[ProjId](#ProjId)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[ProjLinePropertyId](#ProjLinePropertyId)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[ProjSalesCurrencyId](#ProjSalesCurrencyId)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[ProjSalesPrice](#ProjSalesPrice)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[ProjTaxGroupId](#ProjTaxGroupId)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[ProjTaxItemGroupId](#ProjTaxItemGroupId)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[ProjTransId](#ProjTransId)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[ProjUnitID](#ProjUnitID)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[Qty](#Qty)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[ReasonRefRecId](#ReasonRefRecId)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[ReleaseDate](#ReleaseDate)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[ReqPOId](#ReqPOId)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[RetailInfocodeIdEx2](#RetailInfocodeIdEx2)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[RetailInformationSubcodeIdEx2](#RetailInformationSubcodeIdEx2)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[SalesAmount](#SalesAmount)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[ScrapTypeId_RU](#ScrapTypeId_RU)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[Storno_RU](#Storno_RU)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[ToInventDimId](#ToInventDimId)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[ToInventTransId](#ToInventTransId)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[TransDate](#TransDate)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[Voucher](#Voucher)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[WarehouseLocation_IN](#WarehouseLocation_IN)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[Worker](#Worker)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[CountingReasonCode](#CountingReasonCode)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[Unit](#Unit)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[UnitQty](#UnitQty)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[EntAssetWorkOrderLine](#EntAssetWorkOrderLine)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[DataAreaId](#DataAreaId)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[Relationship_AssetBookRelationshipId](#Relationship_AssetBookRelationshipId)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[Relationship_AssetBookTableRelationshipId](#Relationship_AssetBookTableRelationshipId)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[Relationship_AssetTableRelationshipId](#Relationship_AssetTableRelationshipId)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[Relationship_CurrencyRelationshipId](#Relationship_CurrencyRelationshipId)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[Relationship_DefaultDimensionRelationshipId](#Relationship_DefaultDimensionRelationshipId)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[Relationship_InventDimRelationshipId](#Relationship_InventDimRelationshipId)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[Relationship_InventJournalTableRelationshipId](#Relationship_InventJournalTableRelationshipId)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[Relationship_InventLocationRelationshipId](#Relationship_InventLocationRelationshipId)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[Relationship_InventRepJournalTrans_RURelationshipId](#Relationship_InventRepJournalTrans_RURelationshipId)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[Relationship_InventTableRelationshipId](#Relationship_InventTableRelationshipId)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[Relationship_InventTransOriginRelationshipId](#Relationship_InventTransOriginRelationshipId)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[Relationship_JournalErrorRelationshipId](#Relationship_JournalErrorRelationshipId)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[Relationship_LedgerDimensionRelationshipId](#Relationship_LedgerDimensionRelationshipId)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[Relationship_ParentInventTransOriginRelationshipId](#Relationship_ParentInventTransOriginRelationshipId)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[Relationship_PostalAddressRelationshipId](#Relationship_PostalAddressRelationshipId)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[Relationship_ProjCategoryRelationshipId](#Relationship_ProjCategoryRelationshipId)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[Relationship_ProjectTaxGroupRelationshipId](#Relationship_ProjectTaxGroupRelationshipId)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[Relationship_ProjectTaxItemGroupRelationshipId](#Relationship_ProjectTaxItemGroupRelationshipId)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[Relationship_ProjItemTransRelationshipId](#Relationship_ProjItemTransRelationshipId)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[Relationship_ProjLinePropertyRelationshipId](#Relationship_ProjLinePropertyRelationshipId)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[Relationship_ProjTableRelationshipId](#Relationship_ProjTableRelationshipId)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[Relationship_ReasonTableRefRelationshipId](#Relationship_ReasonTableRefRelationshipId)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[Relationship_ReturnInventTransOriginRelationshipId](#Relationship_ReturnInventTransOriginRelationshipId)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[Relationship_ScrapTypeId_RURelationshipId](#Relationship_ScrapTypeId_RURelationshipId)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[Relationship_TaxServiceTariffRelationshipId](#Relationship_TaxServiceTariffRelationshipId)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[Relationship_ToInventDimRelationshipId](#Relationship_ToInventDimRelationshipId)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[Relationship_ToInventTransOriginRelationshipId](#Relationship_ToInventTransOriginRelationshipId)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[Relationship_InventCountingReasonCodeRelationshipId](#Relationship_InventCountingReasonCodeRelationshipId)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="InventJournalTrans.md" target="_blank">WorksheetLine/InventJournalTrans</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: WorksheetLine/InventJournalTrans (this entity)  
...
<details>
<summary>List of traits for the AssetTransType attribute are listed below.</summary>
...
### <a href=#InventOnHand name="InventOnHand">InventOnHand</a>
...
<details>
<summary>List of traits for the InventOnHand attribute are listed below.</summary>
...
### <a href=#InventTransIdFather name="InventTransIdFather">InventTransIdFather</a>

First included in: WorksheetLine/InventJournalTrans (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Finished item lot</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>isNullable</td><td>true</td></tr></table>

#### Traits

<details>
<summary>List of traits for the InventTransIdFather attribute are listed below.</summary>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Finished item lot</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.dataFormat.character**  
**is.dataFormat.array**  
</details>

### <a href=#InventTransIdReturn name="InventTransIdReturn">InventTransIdReturn</a>
...
<details>
<summary>List of traits for the InventTransIdReturn attribute are listed below.</summary>
...
### <a href=#PdsCopyBatchAttrib name="PdsCopyBatchAttrib">PdsCopyBatchAttrib</a>
...
<details>
<summary>List of traits for the PdsCopyBatchAttrib attribute are listed below.</summary>
...
### <a href=#PdsCWInventOnHand name="PdsCWInventOnHand">PdsCWInventOnHand</a>
...
<details>
<summary>List of traits for the PdsCWInventOnHand attribute are listed below.</summary>
...
### <a href=#PdsCWInventQtyCounted name="PdsCWInventQtyCounted">PdsCWInventQtyCounted</a>
...
<details>
<summary>List of traits for the PdsCWInventQtyCounted attribute are listed below.</summary>
...
### <a href=#ProjUnitID name="ProjUnitID">ProjUnitID</a>
...
<details>
<summary>List of traits for the ProjUnitID attribute are listed below.</summary>
...
### <a href=#ScrapTypeId_RU name="ScrapTypeId_RU">ScrapTypeId_RU</a>

First included in: WorksheetLine/InventJournalTrans (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Scrap type</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>isNullable</td><td>true</td></tr></table>

#### Traits

<details>
<summary>List of traits for the ScrapTypeId_RU attribute are listed below.</summary>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Scrap type</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
### <a href=#ToInventDimId name="ToInventDimId">ToInventDimId</a>

First included in: WorksheetLine/InventJournalTrans (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>To dimension No.</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>isReadOnly</td><td>true</td></tr><tr><td>isNullable</td><td>true</td></tr></table>

#### Traits

<details>
<summary>List of traits for the ToInventDimId attribute are listed below.</summary>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>To dimension No.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.dataFormat.character**  
**is.dataFormat.array**  
</details>

### <a href=#ToInventTransId name="ToInventTransId">ToInventTransId</a>
...
<details>
<summary>List of traits for the ToInventTransId attribute are listed below.</summary>
...
### <a href=#Relationship_InventRepJournalTrans_RURelationshipId name="Relationship_InventRepJournalTrans_RURelationshipId">Relationship_InventRepJournalTrans_RURelationshipId</a>
...
<details>
<summary>List of traits for the Relationship_InventRepJournalTrans_RURelationshipId attribute are listed below.</summary>
...
**means.identity.entityId**  
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="../Transaction/InventJournalReportTable_RU.md" target="_blank">/core/operationsCommon/Tables/SupplyChain/Inventory/Transaction/InventJournalReportTable_RU.cdm.json/InventJournalReportTable_RU</a></td><td><a href="../Transaction/InventJournalReportTable_RU.md#RecId" target="_blank">RecId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
...
### <a href=#Relationship_ParentInventTransOriginRelationshipId name="Relationship_ParentInventTransOriginRelationshipId">Relationship_ParentInventTransOriginRelationshipId</a>
...
<details>
<summary>List of traits for the Relationship_ParentInventTransOriginRelationshipId attribute are listed below.</summary>
...
### <a href=#Relationship_ProjectTaxGroupRelationshipId name="Relationship_ProjectTaxGroupRelationshipId">Relationship_ProjectTaxGroupRelationshipId</a>
...
<details>
<summary>List of traits for the Relationship_ProjectTaxGroupRelationshipId attribute are listed below.</summary>
...
### <a href=#Relationship_ProjectTaxItemGroupRelationshipId name="Relationship_ProjectTaxItemGroupRelationshipId">Relationship_ProjectTaxItemGroupRelationshipId</a>
...
<details>
<summary>List of traits for the Relationship_ProjectTaxItemGroupRelationshipId attribute are listed below.</summary>
...
### <a href=#Relationship_ScrapTypeId_RURelationshipId name="Relationship_ScrapTypeId_RURelationshipId">Relationship_ScrapTypeId_RURelationshipId</a>
...
<details>
<summary>List of traits for the Relationship_ScrapTypeId_RURelationshipId attribute are listed below.</summary>
...
### <a href=#Relationship_ToInventDimRelationshipId name="Relationship_ToInventDimRelationshipId">Relationship_ToInventDimRelationshipId</a>
...
<details>
<summary>List of traits for the Relationship_ToInventDimRelationshipId attribute are listed below.</summary>
...
### <a href=#Relationship_ToInventTransOriginRelationshipId name="Relationship_ToInventTransOriginRelationshipId">Relationship_ToInventTransOriginRelationshipId</a>
...
<details>
<summary>List of traits for the Relationship_ToInventTransOriginRelationshipId attribute are listed below.</summary>
...
**means.identity.entityId**  
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="../Main/InventCountingReasonCode.md" target="_blank">/core/operationsCommon/Tables/SupplyChain/Inventory/Main/InventCountingReasonCode.cdm.json/InventCountingReasonCode</a></td><td><a href="../Main/InventCountingReasonCode.md#RecId" target="_blank">RecId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
