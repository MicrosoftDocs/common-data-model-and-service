---
title: WHSLoadLine in WorksheetLine - Common Data Model | Microsoft Docs
...
# Load details in WorksheetLine(WHSLoadLine)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/SupplyChain/Inventory/WorksheetLine/WHSLoadLine.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[WHSLoadLine/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Load details</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="WHSLoadLine.md" target="_blank">WorksheetLine/WHSLoadLine</a>|
|[Invalid](#Invalid)||<a href="WHSLoadLine.md" target="_blank">WorksheetLine/WHSLoadLine</a>|
|[InventDimId](#InventDimId)||<a href="WHSLoadLine.md" target="_blank">WorksheetLine/WHSLoadLine</a>|
|[InventQty](#InventQty)||<a href="WHSLoadLine.md" target="_blank">WorksheetLine/WHSLoadLine</a>|
|[InventTransId](#InventTransId)||<a href="WHSLoadLine.md" target="_blank">WorksheetLine/WHSLoadLine</a>|
|[InventTransType](#InventTransType)||<a href="WHSLoadLine.md" target="_blank">WorksheetLine/WHSLoadLine</a>|
|[ItemId](#ItemId)||<a href="WHSLoadLine.md" target="_blank">WorksheetLine/WHSLoadLine</a>|
|[LoadClosedUTCDateTime](#LoadClosedUTCDateTime)||<a href="WHSLoadLine.md" target="_blank">WorksheetLine/WHSLoadLine</a>|
|[LoadDirection](#LoadDirection)||<a href="WHSLoadLine.md" target="_blank">WorksheetLine/WHSLoadLine</a>|
|[LoadId](#LoadId)||<a href="WHSLoadLine.md" target="_blank">WorksheetLine/WHSLoadLine</a>|
|[LoadInProcessUTCDateTime](#LoadInProcessUTCDateTime)||<a href="WHSLoadLine.md" target="_blank">WorksheetLine/WHSLoadLine</a>|
|[LoadOpenUTCDateTime](#LoadOpenUTCDateTime)||<a href="WHSLoadLine.md" target="_blank">WorksheetLine/WHSLoadLine</a>|
|[LoadReadyToShipUTCDateTime](#LoadReadyToShipUTCDateTime)||<a href="WHSLoadLine.md" target="_blank">WorksheetLine/WHSLoadLine</a>|
|[OrderNum](#OrderNum)||<a href="WHSLoadLine.md" target="_blank">WorksheetLine/WHSLoadLine</a>|
|[OverDeliveryPct](#OverDeliveryPct)||<a href="WHSLoadLine.md" target="_blank">WorksheetLine/WHSLoadLine</a>|
|[PackingQty](#PackingQty)||<a href="WHSLoadLine.md" target="_blank">WorksheetLine/WHSLoadLine</a>|
|[ParentInventTransType](#ParentInventTransType)||<a href="WHSLoadLine.md" target="_blank">WorksheetLine/WHSLoadLine</a>|
|[ParentOrderNum](#ParentOrderNum)||<a href="WHSLoadLine.md" target="_blank">WorksheetLine/WHSLoadLine</a>|
|[PickedQty](#PickedQty)||<a href="WHSLoadLine.md" target="_blank">WorksheetLine/WHSLoadLine</a>|
|[Qty](#Qty)||<a href="WHSLoadLine.md" target="_blank">WorksheetLine/WHSLoadLine</a>|
|[QtyLeftToStructure](#QtyLeftToStructure)||<a href="WHSLoadLine.md" target="_blank">WorksheetLine/WHSLoadLine</a>|
|[ReleaseToWarehouseId](#ReleaseToWarehouseId)||<a href="WHSLoadLine.md" target="_blank">WorksheetLine/WHSLoadLine</a>|
|[ShipmentId](#ShipmentId)||<a href="WHSLoadLine.md" target="_blank">WorksheetLine/WHSLoadLine</a>|
|[TransportRequest](#TransportRequest)||<a href="WHSLoadLine.md" target="_blank">WorksheetLine/WHSLoadLine</a>|
|[UnderDeliveryPct](#UnderDeliveryPct)||<a href="WHSLoadLine.md" target="_blank">WorksheetLine/WHSLoadLine</a>|
|[UOM](#UOM)||<a href="WHSLoadLine.md" target="_blank">WorksheetLine/WHSLoadLine</a>|
|[WorkCreatedQty](#WorkCreatedQty)||<a href="WHSLoadLine.md" target="_blank">WorksheetLine/WHSLoadLine</a>|
|[VolumeQty_BR](#VolumeQty_BR)||<a href="WHSLoadLine.md" target="_blank">WorksheetLine/WHSLoadLine</a>|
|[VolumeType_BR](#VolumeType_BR)||<a href="WHSLoadLine.md" target="_blank">WorksheetLine/WHSLoadLine</a>|
|[PickedWeight](#PickedWeight)||<a href="WHSLoadLine.md" target="_blank">WorksheetLine/WHSLoadLine</a>|
|[CrossDockEvaluatedQuantity](#CrossDockEvaluatedQuantity)||<a href="WHSLoadLine.md" target="_blank">WorksheetLine/WHSLoadLine</a>|
|[CrossDockQuantity](#CrossDockQuantity)||<a href="WHSLoadLine.md" target="_blank">WorksheetLine/WHSLoadLine</a>|
|[CrossDockReservedPhysical](#CrossDockReservedPhysical)||<a href="WHSLoadLine.md" target="_blank">WorksheetLine/WHSLoadLine</a>|
|[ShipConsolidationPolicy](#ShipConsolidationPolicy)||<a href="WHSLoadLine.md" target="_blank">WorksheetLine/WHSLoadLine</a>|
|[DataAreaId](#DataAreaId)||<a href="WHSLoadLine.md" target="_blank">WorksheetLine/WHSLoadLine</a>|
|[Relationship_InventDimRelationshipId](#Relationship_InventDimRelationshipId)||<a href="WHSLoadLine.md" target="_blank">WorksheetLine/WHSLoadLine</a>|
|[Relationship_InventTableRelationshipId](#Relationship_InventTableRelationshipId)||<a href="WHSLoadLine.md" target="_blank">WorksheetLine/WHSLoadLine</a>|
|[Relationship_InventTransferLineRelationshipId](#Relationship_InventTransferLineRelationshipId)||<a href="WHSLoadLine.md" target="_blank">WorksheetLine/WHSLoadLine</a>|
|[Relationship_InventTransferTableRelationshipId](#Relationship_InventTransferTableRelationshipId)||<a href="WHSLoadLine.md" target="_blank">WorksheetLine/WHSLoadLine</a>|
|[Relationship_InventTransOriginRelationshipId](#Relationship_InventTransOriginRelationshipId)||<a href="WHSLoadLine.md" target="_blank">WorksheetLine/WHSLoadLine</a>|
|[Relationship_PurchLineRelationshipId](#Relationship_PurchLineRelationshipId)||<a href="WHSLoadLine.md" target="_blank">WorksheetLine/WHSLoadLine</a>|
|[Relationship_PurchTableRelationshipId](#Relationship_PurchTableRelationshipId)||<a href="WHSLoadLine.md" target="_blank">WorksheetLine/WHSLoadLine</a>|
|[Relationship_SalesLineRelationshipId](#Relationship_SalesLineRelationshipId)||<a href="WHSLoadLine.md" target="_blank">WorksheetLine/WHSLoadLine</a>|
|[Relationship_SalesTableRelationshipId](#Relationship_SalesTableRelationshipId)||<a href="WHSLoadLine.md" target="_blank">WorksheetLine/WHSLoadLine</a>|
|[Relationship_TMSTransportRequestTableRelationshipId](#Relationship_TMSTransportRequestTableRelationshipId)||<a href="WHSLoadLine.md" target="_blank">WorksheetLine/WHSLoadLine</a>|
|[Relationship_WHSInventTableRelationshipId](#Relationship_WHSInventTableRelationshipId)||<a href="WHSLoadLine.md" target="_blank">WorksheetLine/WHSLoadLine</a>|
|[Relationship_WHSLoadTableRelationshipId](#Relationship_WHSLoadTableRelationshipId)||<a href="WHSLoadLine.md" target="_blank">WorksheetLine/WHSLoadLine</a>|
|[Relationship_WHSShipConsolidationPolicyRelationshipId](#Relationship_WHSShipConsolidationPolicyRelationshipId)||<a href="WHSLoadLine.md" target="_blank">WorksheetLine/WHSLoadLine</a>|
|[Relationship_WHSShipmentTableRelationshipId](#Relationship_WHSShipmentTableRelationshipId)||<a href="WHSLoadLine.md" target="_blank">WorksheetLine/WHSLoadLine</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="WHSLoadLine.md" target="_blank">WorksheetLine/WHSLoadLine</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: WorksheetLine/WHSLoadLine (this entity)  
...
### <a href=#ParentInventTransType name="ParentInventTransType">ParentInventTransType</a>
...
<details>
<summary>List of traits for the ParentInventTransType attribute are listed below.</summary>
...
### <a href=#ParentOrderNum name="ParentOrderNum">ParentOrderNum</a>
...
<details>
<summary>List of traits for the ParentOrderNum attribute are listed below.</summary>
...
### <a href=#PickedQty name="PickedQty">PickedQty</a>
...
<details>
<summary>List of traits for the PickedQty attribute are listed below.</summary>
...
### <a href=#TransportRequest name="TransportRequest">TransportRequest</a>
...
<details>
<summary>List of traits for the TransportRequest attribute are listed below.</summary>
...
### <a href=#PickedWeight name="PickedWeight">PickedWeight</a>
...
<details>
<summary>List of traits for the PickedWeight attribute are listed below.</summary>
...
### <a href=#CrossDockEvaluatedQuantity name="CrossDockEvaluatedQuantity">CrossDockEvaluatedQuantity</a>
...
<details>
<summary>List of traits for the CrossDockEvaluatedQuantity attribute are listed below.</summary>
...
<details>
<summary>List of traits for the CrossDockQuantity attribute are listed below.</summary>
...
### <a href=#CrossDockReservedPhysical name="CrossDockReservedPhysical">CrossDockReservedPhysical</a>
...
<details>
<summary>List of traits for the CrossDockReservedPhysical attribute are listed below.</summary>
...
**means.identity.entityId**  
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="InventTransferLine.md" target="_blank">/core/operationsCommon/Tables/SupplyChain/Inventory/WorksheetLine/InventTransferLine.cdm.json/InventTransferLine</a></td><td><a href="InventTransferLine.md#RecId" target="_blank">RecId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
...
### <a href=#Relationship_TMSTransportRequestTableRelationshipId name="Relationship_TMSTransportRequestTableRelationshipId">Relationship_TMSTransportRequestTableRelationshipId</a>
...
<details>
<summary>List of traits for the Relationship_TMSTransportRequestTableRelationshipId attribute are listed below.</summary>
...
**means.identity.entityId**  
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="../../Transportation/WorksheetHeader/TMSTransportRequestTable.md" target="_blank">/core/operationsCommon/Tables/SupplyChain/Transportation/WorksheetHeader/TMSTransportRequestTable.cdm.json/TMSTransportRequestTable</a></td><td><a href="../../Transportation/WorksheetHeader/TMSTransportRequestTable.md#RecId" target="_blank">RecId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
