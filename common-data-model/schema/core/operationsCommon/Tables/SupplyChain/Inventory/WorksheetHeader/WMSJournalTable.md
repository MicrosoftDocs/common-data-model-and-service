---
title: WMSJournalTable in WorksheetHeader - Common Data Model | Microsoft Docs
...
# Location journal table in WorksheetHeader(WMSJournalTable)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/SupplyChain/Inventory/WorksheetHeader/WMSJournalTable.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[WMSJournalTable/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="WMSJournalTable.md" target="_blank">WorksheetHeader/WMSJournalTable</a>|
|[blockUserGroupId](#blockUserGroupId)||<a href="WMSJournalTable.md" target="_blank">WorksheetHeader/WMSJournalTable</a>|
|[blockUserId](#blockUserId)||<a href="WMSJournalTable.md" target="_blank">WorksheetHeader/WMSJournalTable</a>|
|[checkPickingLocation](#checkPickingLocation)||<a href="WMSJournalTable.md" target="_blank">WorksheetHeader/WMSJournalTable</a>|
|[createQuarantineOrder](#createQuarantineOrder)||<a href="WMSJournalTable.md" target="_blank">WorksheetHeader/WMSJournalTable</a>|
|[deletePostedLines](#deletePostedLines)||<a href="WMSJournalTable.md" target="_blank">WorksheetHeader/WMSJournalTable</a>|
|[description](#description)||<a href="WMSJournalTable.md" target="_blank">WorksheetHeader/WMSJournalTable</a>|
|[inventDimId](#inventDimId)||<a href="WMSJournalTable.md" target="_blank">WorksheetHeader/WMSJournalTable</a>|
|[inventTransRefId](#inventTransRefId)||<a href="WMSJournalTable.md" target="_blank">WorksheetHeader/WMSJournalTable</a>|
|[inventTransType](#inventTransType)||<a href="WMSJournalTable.md" target="_blank">WorksheetHeader/WMSJournalTable</a>|
|[journalId](#journalId)||<a href="WMSJournalTable.md" target="_blank">WorksheetHeader/WMSJournalTable</a>|
|[journalIdOriginal](#journalIdOriginal)||<a href="WMSJournalTable.md" target="_blank">WorksheetHeader/WMSJournalTable</a>|
|[journalNameId](#journalNameId)||<a href="WMSJournalTable.md" target="_blank">WorksheetHeader/WMSJournalTable</a>|
|[journalType](#journalType)||<a href="WMSJournalTable.md" target="_blank">WorksheetHeader/WMSJournalTable</a>|
|[numOfLines](#numOfLines)||<a href="WMSJournalTable.md" target="_blank">WorksheetHeader/WMSJournalTable</a>|
|[packingSlip](#packingSlip)||<a href="WMSJournalTable.md" target="_blank">WorksheetHeader/WMSJournalTable</a>|
|[posted](#posted)||<a href="WMSJournalTable.md" target="_blank">WorksheetHeader/WMSJournalTable</a>|
|[postedDateTime](#postedDateTime)||<a href="WMSJournalTable.md" target="_blank">WorksheetHeader/WMSJournalTable</a>|
|[postedUserId](#postedUserId)||<a href="WMSJournalTable.md" target="_blank">WorksheetHeader/WMSJournalTable</a>|
|[ReturnDispositionCodeId](#ReturnDispositionCodeId)||<a href="WMSJournalTable.md" target="_blank">WorksheetHeader/WMSJournalTable</a>|
|[ReturnItemNum](#ReturnItemNum)||<a href="WMSJournalTable.md" target="_blank">WorksheetHeader/WMSJournalTable</a>|
|[sessionId](#sessionId)||<a href="WMSJournalTable.md" target="_blank">WorksheetHeader/WMSJournalTable</a>|
|[sessionLoginDateTime](#sessionLoginDateTime)||<a href="WMSJournalTable.md" target="_blank">WorksheetHeader/WMSJournalTable</a>|
|[systemBlocked](#systemBlocked)||<a href="WMSJournalTable.md" target="_blank">WorksheetHeader/WMSJournalTable</a>|
|[vendAccount](#vendAccount)||<a href="WMSJournalTable.md" target="_blank">WorksheetHeader/WMSJournalTable</a>|
|[DataAreaId](#DataAreaId)||<a href="WMSJournalTable.md" target="_blank">WorksheetHeader/WMSJournalTable</a>|
|[Relationship_BlockingUserGroupRelationshipId](#Relationship_BlockingUserGroupRelationshipId)||<a href="WMSJournalTable.md" target="_blank">WorksheetHeader/WMSJournalTable</a>|
|[Relationship_CustTableRelationshipId](#Relationship_CustTableRelationshipId)||<a href="WMSJournalTable.md" target="_blank">WorksheetHeader/WMSJournalTable</a>|
|[Relationship_InventBOMRelationshipId](#Relationship_InventBOMRelationshipId)||<a href="WMSJournalTable.md" target="_blank">WorksheetHeader/WMSJournalTable</a>|
|[Relationship_InventCountRelationshipId](#Relationship_InventCountRelationshipId)||<a href="WMSJournalTable.md" target="_blank">WorksheetHeader/WMSJournalTable</a>|
|[Relationship_InventDimRelationshipId](#Relationship_InventDimRelationshipId)||<a href="WMSJournalTable.md" target="_blank">WorksheetHeader/WMSJournalTable</a>|
|[Relationship_InventLossProfitRelationshipId](#Relationship_InventLossProfitRelationshipId)||<a href="WMSJournalTable.md" target="_blank">WorksheetHeader/WMSJournalTable</a>|
|[Relationship_InventMovementRelationshipId](#Relationship_InventMovementRelationshipId)||<a href="WMSJournalTable.md" target="_blank">WorksheetHeader/WMSJournalTable</a>|
|[Relationship_InventQuarantineOrderRelationshipId](#Relationship_InventQuarantineOrderRelationshipId)||<a href="WMSJournalTable.md" target="_blank">WorksheetHeader/WMSJournalTable</a>|
|[Relationship_InventTransferRelationshipId](#Relationship_InventTransferRelationshipId)||<a href="WMSJournalTable.md" target="_blank">WorksheetHeader/WMSJournalTable</a>|
|[Relationship_ProductionRelationshipId](#Relationship_ProductionRelationshipId)||<a href="WMSJournalTable.md" target="_blank">WorksheetHeader/WMSJournalTable</a>|
|[Relationship_PurchRelationshipId](#Relationship_PurchRelationshipId)||<a href="WMSJournalTable.md" target="_blank">WorksheetHeader/WMSJournalTable</a>|
|[Relationship_ReturnDispositionCodeRelationshipId](#Relationship_ReturnDispositionCodeRelationshipId)||<a href="WMSJournalTable.md" target="_blank">WorksheetHeader/WMSJournalTable</a>|
|[Relationship_SalesOrderRelationshipId](#Relationship_SalesOrderRelationshipId)||<a href="WMSJournalTable.md" target="_blank">WorksheetHeader/WMSJournalTable</a>|
|[Relationship_VendTableRelationshipId](#Relationship_VendTableRelationshipId)||<a href="WMSJournalTable.md" target="_blank">WorksheetHeader/WMSJournalTable</a>|
|[Relationship_WMSJournalNameRelationshipId](#Relationship_WMSJournalNameRelationshipId)||<a href="WMSJournalTable.md" target="_blank">WorksheetHeader/WMSJournalTable</a>|
|[Relationship_ConsignmentReplenishmentVendorRelationshipId](#Relationship_ConsignmentReplenishmentVendorRelationshipId)||<a href="WMSJournalTable.md" target="_blank">WorksheetHeader/WMSJournalTable</a>|
|[Relationship_ConsignmentReplenishmentOrderRelationshipId](#Relationship_ConsignmentReplenishmentOrderRelationshipId)||<a href="WMSJournalTable.md" target="_blank">WorksheetHeader/WMSJournalTable</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="WMSJournalTable.md" target="_blank">WorksheetHeader/WMSJournalTable</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: WorksheetHeader/WMSJournalTable (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Packing slip</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>isNullable</td><td>true</td></tr></table>
