---
title: WHSShipmentTable in WorksheetHeader - Common Data Model | Microsoft Docs
...
# Shipments in WorksheetHeader(WHSShipmentTable)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/SupplyChain/Inventory/WorksheetHeader/WHSShipmentTable.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[WHSShipmentTable/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Shipments</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="WHSShipmentTable.md" target="_blank">WorksheetHeader/WHSShipmentTable</a>|
|[CarrierCode](#CarrierCode)||<a href="WHSShipmentTable.md" target="_blank">WorksheetHeader/WHSShipmentTable</a>|
|[AccountNum](#AccountNum)||<a href="WHSShipmentTable.md" target="_blank">WorksheetHeader/WHSShipmentTable</a>|
|[Address](#Address)||<a href="WHSShipmentTable.md" target="_blank">WorksheetHeader/WHSShipmentTable</a>|
|[BillOfLadingId](#BillOfLadingId)||<a href="WHSShipmentTable.md" target="_blank">WorksheetHeader/WHSShipmentTable</a>|
|[BrokerCode](#BrokerCode)||<a href="WHSShipmentTable.md" target="_blank">WorksheetHeader/WHSShipmentTable</a>|
|[CarrierGroupCode](#CarrierGroupCode)||<a href="WHSShipmentTable.md" target="_blank">WorksheetHeader/WHSShipmentTable</a>|
|[CarrierServiceCode](#CarrierServiceCode)||<a href="WHSShipmentTable.md" target="_blank">WorksheetHeader/WHSShipmentTable</a>|
|[CountryRegionISOCode](#CountryRegionISOCode)||<a href="WHSShipmentTable.md" target="_blank">WorksheetHeader/WHSShipmentTable</a>|
|[CustomerRef](#CustomerRef)||<a href="WHSShipmentTable.md" target="_blank">WorksheetHeader/WHSShipmentTable</a>|
|[CustomerReq](#CustomerReq)||<a href="WHSShipmentTable.md" target="_blank">WorksheetHeader/WHSShipmentTable</a>|
|[DeliveryName](#DeliveryName)||<a href="WHSShipmentTable.md" target="_blank">WorksheetHeader/WHSShipmentTable</a>|
|[DeliveryPostalAddress](#DeliveryPostalAddress)||<a href="WHSShipmentTable.md" target="_blank">WorksheetHeader/WHSShipmentTable</a>|
|[DlvTermId](#DlvTermId)||<a href="WHSShipmentTable.md" target="_blank">WorksheetHeader/WHSShipmentTable</a>|
|[DropOffUTCDateTime](#DropOffUTCDateTime)||<a href="WHSShipmentTable.md" target="_blank">WorksheetHeader/WHSShipmentTable</a>|
|[FreightTermCode](#FreightTermCode)||<a href="WHSShipmentTable.md" target="_blank">WorksheetHeader/WHSShipmentTable</a>|
|[InventLocationId](#InventLocationId)||<a href="WHSShipmentTable.md" target="_blank">WorksheetHeader/WHSShipmentTable</a>|
|[InventSiteId](#InventSiteId)||<a href="WHSShipmentTable.md" target="_blank">WorksheetHeader/WHSShipmentTable</a>|
|[LoadDirection](#LoadDirection)||<a href="WHSShipmentTable.md" target="_blank">WorksheetHeader/WHSShipmentTable</a>|
|[LoadId](#LoadId)||<a href="WHSShipmentTable.md" target="_blank">WorksheetHeader/WHSShipmentTable</a>|
|[ModeCode](#ModeCode)||<a href="WHSShipmentTable.md" target="_blank">WorksheetHeader/WHSShipmentTable</a>|
|[OrderNum](#OrderNum)||<a href="WHSShipmentTable.md" target="_blank">WorksheetHeader/WHSShipmentTable</a>|
|[ProNum](#ProNum)||<a href="WHSShipmentTable.md" target="_blank">WorksheetHeader/WHSShipmentTable</a>|
|[Reference](#Reference)||<a href="WHSShipmentTable.md" target="_blank">WorksheetHeader/WHSShipmentTable</a>|
|[RouteCode](#RouteCode)||<a href="WHSShipmentTable.md" target="_blank">WorksheetHeader/WHSShipmentTable</a>|
|[SCAC](#SCAC)||<a href="WHSShipmentTable.md" target="_blank">WorksheetHeader/WHSShipmentTable</a>|
|[ShipCarrierAccount](#ShipCarrierAccount)||<a href="WHSShipmentTable.md" target="_blank">WorksheetHeader/WHSShipmentTable</a>|
|[ShipConfirmUTCDateTime](#ShipConfirmUTCDateTime)||<a href="WHSShipmentTable.md" target="_blank">WorksheetHeader/WHSShipmentTable</a>|
|[ShipmentArrivalUTCDateTime](#ShipmentArrivalUTCDateTime)||<a href="WHSShipmentTable.md" target="_blank">WorksheetHeader/WHSShipmentTable</a>|
|[ShipmentId](#ShipmentId)||<a href="WHSShipmentTable.md" target="_blank">WorksheetHeader/WHSShipmentTable</a>|
|[ShipmentStatus](#ShipmentStatus)||<a href="WHSShipmentTable.md" target="_blank">WorksheetHeader/WHSShipmentTable</a>|
|[StopNum](#StopNum)||<a href="WHSShipmentTable.md" target="_blank">WorksheetHeader/WHSShipmentTable</a>|
|[WaveId](#WaveId)||<a href="WHSShipmentTable.md" target="_blank">WorksheetHeader/WHSShipmentTable</a>|
|[WayBill](#WayBill)||<a href="WHSShipmentTable.md" target="_blank">WorksheetHeader/WHSShipmentTable</a>|
|[WorkTransType](#WorkTransType)||<a href="WHSShipmentTable.md" target="_blank">WorksheetHeader/WHSShipmentTable</a>|
|[ManifestedWeight](#ManifestedWeight)||<a href="WHSShipmentTable.md" target="_blank">WorksheetHeader/WHSShipmentTable</a>|
|[ManifestedWeightUOM](#ManifestedWeightUOM)||<a href="WHSShipmentTable.md" target="_blank">WorksheetHeader/WHSShipmentTable</a>|
|[WaveLabelsPrintedDateTime](#WaveLabelsPrintedDateTime)||<a href="WHSShipmentTable.md" target="_blank">WorksheetHeader/WHSShipmentTable</a>|
|[WaveLabelsPrintedBy](#WaveLabelsPrintedBy)||<a href="WHSShipmentTable.md" target="_blank">WorksheetHeader/WHSShipmentTable</a>|
|[WaveLabelsPrinted](#WaveLabelsPrinted)||<a href="WHSShipmentTable.md" target="_blank">WorksheetHeader/WHSShipmentTable</a>|
|[ShipConsolidationPolicy](#ShipConsolidationPolicy)||<a href="WHSShipmentTable.md" target="_blank">WorksheetHeader/WHSShipmentTable</a>|
|[HMIMMultimodalDGId](#HMIMMultimodalDGId)||<a href="WHSShipmentTable.md" target="_blank">WorksheetHeader/WHSShipmentTable</a>|
|[HMIMCarrOfMerchByRoadId](#HMIMCarrOfMerchByRoadId)||<a href="WHSShipmentTable.md" target="_blank">WorksheetHeader/WHSShipmentTable</a>|
|[HMIMAirWaybillNum](#HMIMAirWaybillNum)||<a href="WHSShipmentTable.md" target="_blank">WorksheetHeader/WHSShipmentTable</a>|
|[DataAreaId](#DataAreaId)||<a href="WHSShipmentTable.md" target="_blank">WorksheetHeader/WHSShipmentTable</a>|
|[Relationship_DlvTermRelationshipId](#Relationship_DlvTermRelationshipId)||<a href="WHSShipmentTable.md" target="_blank">WorksheetHeader/WHSShipmentTable</a>|
|[Relationship_InventLocationRelationshipId](#Relationship_InventLocationRelationshipId)||<a href="WHSShipmentTable.md" target="_blank">WorksheetHeader/WHSShipmentTable</a>|
|[Relationship_InventSiteRelationshipId](#Relationship_InventSiteRelationshipId)||<a href="WHSShipmentTable.md" target="_blank">WorksheetHeader/WHSShipmentTable</a>|
|[Relationship_LogisticsPostalAddressRelationshipId](#Relationship_LogisticsPostalAddressRelationshipId)||<a href="WHSShipmentTable.md" target="_blank">WorksheetHeader/WHSShipmentTable</a>|
|[Relationship_PurchTableRelationshipId](#Relationship_PurchTableRelationshipId)||<a href="WHSShipmentTable.md" target="_blank">WorksheetHeader/WHSShipmentTable</a>|
|[Relationship_SalesTableRelationshipId](#Relationship_SalesTableRelationshipId)||<a href="WHSShipmentTable.md" target="_blank">WorksheetHeader/WHSShipmentTable</a>|
|[Relationship_TMSBrokerRelationshipId](#Relationship_TMSBrokerRelationshipId)||<a href="WHSShipmentTable.md" target="_blank">WorksheetHeader/WHSShipmentTable</a>|
|[Relationship_TMSCarrierRelationshipId](#Relationship_TMSCarrierRelationshipId)||<a href="WHSShipmentTable.md" target="_blank">WorksheetHeader/WHSShipmentTable</a>|
|[Relationship_TMSCarrierGroupRelationshipId](#Relationship_TMSCarrierGroupRelationshipId)||<a href="WHSShipmentTable.md" target="_blank">WorksheetHeader/WHSShipmentTable</a>|
|[Relationship_TMSModeRelationshipId](#Relationship_TMSModeRelationshipId)||<a href="WHSShipmentTable.md" target="_blank">WorksheetHeader/WHSShipmentTable</a>|
|[Relationship_TMSRouteRelationshipId](#Relationship_TMSRouteRelationshipId)||<a href="WHSShipmentTable.md" target="_blank">WorksheetHeader/WHSShipmentTable</a>|
|[Relationship_TransferRelationshipId](#Relationship_TransferRelationshipId)||<a href="WHSShipmentTable.md" target="_blank">WorksheetHeader/WHSShipmentTable</a>|
|[Relationship_WHSLoadTableRelationshipId](#Relationship_WHSLoadTableRelationshipId)||<a href="WHSShipmentTable.md" target="_blank">WorksheetHeader/WHSShipmentTable</a>|
|[Relationship_WHSShipConsolidationPolicyRelationshipId](#Relationship_WHSShipConsolidationPolicyRelationshipId)||<a href="WHSShipmentTable.md" target="_blank">WorksheetHeader/WHSShipmentTable</a>|
|[Relationship_WHSWaveTableRelationshipId](#Relationship_WHSWaveTableRelationshipId)||<a href="WHSShipmentTable.md" target="_blank">WorksheetHeader/WHSShipmentTable</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="WHSShipmentTable.md" target="_blank">WorksheetHeader/WHSShipmentTable</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: WorksheetHeader/WHSShipmentTable (this entity)  
...
### <a href=#CustomerReq name="CustomerReq">CustomerReq</a>
...
<details>
<summary>List of traits for the CustomerReq attribute are listed below.</summary>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Delivery recipient</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>isReadOnly</td><td>true</td></tr></table>
...
### <a href=#DropOffUTCDateTime name="DropOffUTCDateTime">DropOffUTCDateTime</a>
...
<details>
<summary>List of traits for the DropOffUTCDateTime attribute are listed below.</summary>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Mode of delivery</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>isNullable</td><td>true</td></tr></table>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Mode of delivery</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
### <a href=#ShipConfirmUTCDateTime name="ShipConfirmUTCDateTime">ShipConfirmUTCDateTime</a>
...
<details>
<summary>List of traits for the ShipConfirmUTCDateTime attribute are listed below.</summary>
...
### <a href=#ShipmentArrivalUTCDateTime name="ShipmentArrivalUTCDateTime">ShipmentArrivalUTCDateTime</a>
...
<details>
<summary>List of traits for the ShipmentArrivalUTCDateTime attribute are listed below.</summary>
...
### <a href=#StopNum name="StopNum">StopNum</a>
...
<details>
<summary>List of traits for the StopNum attribute are listed below.</summary>
...
### <a href=#WayBill name="WayBill">WayBill</a>
...
<details>
<summary>List of traits for the WayBill attribute are listed below.</summary>
...
### <a href=#ManifestedWeight name="ManifestedWeight">ManifestedWeight</a>

First included in: WorksheetHeader/WHSShipmentTable (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Manifested weight</td></tr><tr><td>dataFormat</td><td>decimal</td></tr><tr><td>isReadOnly</td><td>true</td></tr><tr><td>isNullable</td><td>true</td></tr></table>

#### Traits

<details>
<summary>List of traits for the ManifestedWeight attribute are listed below.</summary>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Manifested weight</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
### <a href=#ManifestedWeightUOM name="ManifestedWeightUOM">ManifestedWeightUOM</a>
...
<details>
<summary>List of traits for the ManifestedWeightUOM attribute are listed below.</summary>
...
### <a href=#WaveLabelsPrintedDateTime name="WaveLabelsPrintedDateTime">WaveLabelsPrintedDateTime</a>
...
<details>
<summary>List of traits for the WaveLabelsPrintedDateTime attribute are listed below.</summary>
...
### <a href=#WaveLabelsPrintedBy name="WaveLabelsPrintedBy">WaveLabelsPrintedBy</a>

First included in: WorksheetHeader/WHSShipmentTable (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Printed by</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>isNullable</td><td>true</td></tr></table>

#### Traits

<details>
<summary>List of traits for the WaveLabelsPrintedBy attribute are listed below.</summary>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Printed by</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.dataFormat.character**  
**is.dataFormat.array**  
</details>

### <a href=#WaveLabelsPrinted name="WaveLabelsPrinted">WaveLabelsPrinted</a>
...
<details>
<summary>List of traits for the WaveLabelsPrinted attribute are listed below.</summary>
...
### <a href=#HMIMMultimodalDGId name="HMIMMultimodalDGId">HMIMMultimodalDGId</a>
...
<details>
<summary>List of traits for the HMIMMultimodalDGId attribute are listed below.</summary>
...
### <a href=#HMIMCarrOfMerchByRoadId name="HMIMCarrOfMerchByRoadId">HMIMCarrOfMerchByRoadId</a>
...
<details>
<summary>List of traits for the HMIMCarrOfMerchByRoadId attribute are listed below.</summary>
...
### <a href=#HMIMAirWaybillNum name="HMIMAirWaybillNum">HMIMAirWaybillNum</a>
...
<details>
<summary>List of traits for the HMIMAirWaybillNum attribute are listed below.</summary>
...
### <a href=#Relationship_TransferRelationshipId name="Relationship_TransferRelationshipId">Relationship_TransferRelationshipId</a>
...
<details>
<summary>List of traits for the Relationship_TransferRelationshipId attribute are listed below.</summary>
...
**means.identity.entityId**  
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="../Main/WHSShipConsolidationPolicy.md" target="_blank">/core/operationsCommon/Tables/SupplyChain/Inventory/Main/WHSShipConsolidationPolicy.cdm.json/WHSShipConsolidationPolicy</a></td><td><a href="../Main/WHSShipConsolidationPolicy.md#RecId" target="_blank">RecId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
