---
title: JournalizingDefinitionPayablesTrans in Group - Common Data Model | Microsoft Docs
...
# Journalizing definition accounts payable in Group(JournalizingDefinitionPayablesTrans)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/Finance/AccountingFoundation/Group/JournalizingDefinitionPayablesTrans.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[JournalizingDefinitionPayablesTrans/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Journalizing definition accounts payable</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="JournalizingDefinitionPayablesTrans.md" target="_blank">Group/JournalizingDefinitionPayablesTrans</a>|
|[AccountsPayableTransactionType](#AccountsPayableTransactionType)||<a href="JournalizingDefinitionPayablesTrans.md" target="_blank">Group/JournalizingDefinitionPayablesTrans</a>|
|[EcoResCategory](#EcoResCategory)||<a href="JournalizingDefinitionPayablesTrans.md" target="_blank">Group/JournalizingDefinitionPayablesTrans</a>|
|[ItemCode](#ItemCode)||<a href="JournalizingDefinitionPayablesTrans.md" target="_blank">Group/JournalizingDefinitionPayablesTrans</a>|
|[ItemGroupId](#ItemGroupId)||<a href="JournalizingDefinitionPayablesTrans.md" target="_blank">Group/JournalizingDefinitionPayablesTrans</a>|
|[ItemId](#ItemId)||<a href="JournalizingDefinitionPayablesTrans.md" target="_blank">Group/JournalizingDefinitionPayablesTrans</a>|
|[JournalizingDefinition](#JournalizingDefinition)||<a href="JournalizingDefinitionPayablesTrans.md" target="_blank">Group/JournalizingDefinitionPayablesTrans</a>|
|[VendAccount](#VendAccount)||<a href="JournalizingDefinitionPayablesTrans.md" target="_blank">Group/JournalizingDefinitionPayablesTrans</a>|
|[VendAccountCode](#VendAccountCode)||<a href="JournalizingDefinitionPayablesTrans.md" target="_blank">Group/JournalizingDefinitionPayablesTrans</a>|
|[VendGroup](#VendGroup)||<a href="JournalizingDefinitionPayablesTrans.md" target="_blank">Group/JournalizingDefinitionPayablesTrans</a>|
|[DataAreaId](#DataAreaId)||<a href="JournalizingDefinitionPayablesTrans.md" target="_blank">Group/JournalizingDefinitionPayablesTrans</a>|
|[Relationship_EcoResCategoryRelationshipId](#Relationship_EcoResCategoryRelationshipId)||<a href="JournalizingDefinitionPayablesTrans.md" target="_blank">Group/JournalizingDefinitionPayablesTrans</a>|
|[Relationship_InventItemGroupRelationshipId](#Relationship_InventItemGroupRelationshipId)||<a href="JournalizingDefinitionPayablesTrans.md" target="_blank">Group/JournalizingDefinitionPayablesTrans</a>|
|[Relationship_InventTableRelationshipId](#Relationship_InventTableRelationshipId)||<a href="JournalizingDefinitionPayablesTrans.md" target="_blank">Group/JournalizingDefinitionPayablesTrans</a>|
|[Relationship_JournalizingDefinitionRelationshipId](#Relationship_JournalizingDefinitionRelationshipId)||<a href="JournalizingDefinitionPayablesTrans.md" target="_blank">Group/JournalizingDefinitionPayablesTrans</a>|
|[Relationship_VendGroupRelationshipId](#Relationship_VendGroupRelationshipId)||<a href="JournalizingDefinitionPayablesTrans.md" target="_blank">Group/JournalizingDefinitionPayablesTrans</a>|
|[Relationship_VendTableRelationshipId](#Relationship_VendTableRelationshipId)||<a href="JournalizingDefinitionPayablesTrans.md" target="_blank">Group/JournalizingDefinitionPayablesTrans</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="JournalizingDefinitionPayablesTrans.md" target="_blank">Group/JournalizingDefinitionPayablesTrans</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Group/JournalizingDefinitionPayablesTrans (this entity)  
