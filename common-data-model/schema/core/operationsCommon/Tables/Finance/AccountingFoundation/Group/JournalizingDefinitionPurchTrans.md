---
title: JournalizingDefinitionPurchTrans in Group - Common Data Model | Microsoft Docs
...
# Purchasing transaction journalizing definition in Group(JournalizingDefinitionPurchTrans)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/Finance/AccountingFoundation/Group/JournalizingDefinitionPurchTrans.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[JournalizingDefinitionPurchTrans/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Purchasing transaction journalizing definition</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="JournalizingDefinitionPurchTrans.md" target="_blank">Group/JournalizingDefinitionPurchTrans</a>|
|[EcoResCategory](#EcoResCategory)||<a href="JournalizingDefinitionPurchTrans.md" target="_blank">Group/JournalizingDefinitionPurchTrans</a>|
|[ItemCode](#ItemCode)||<a href="JournalizingDefinitionPurchTrans.md" target="_blank">Group/JournalizingDefinitionPurchTrans</a>|
|[ItemGroupId](#ItemGroupId)||<a href="JournalizingDefinitionPurchTrans.md" target="_blank">Group/JournalizingDefinitionPurchTrans</a>|
|[ItemId](#ItemId)||<a href="JournalizingDefinitionPurchTrans.md" target="_blank">Group/JournalizingDefinitionPurchTrans</a>|
|[JournalizingDefinition](#JournalizingDefinition)||<a href="JournalizingDefinitionPurchTrans.md" target="_blank">Group/JournalizingDefinitionPurchTrans</a>|
|[PurchasingTransactionType](#PurchasingTransactionType)||<a href="JournalizingDefinitionPurchTrans.md" target="_blank">Group/JournalizingDefinitionPurchTrans</a>|
|[VendAccount](#VendAccount)||<a href="JournalizingDefinitionPurchTrans.md" target="_blank">Group/JournalizingDefinitionPurchTrans</a>|
|[VendAccountCode](#VendAccountCode)||<a href="JournalizingDefinitionPurchTrans.md" target="_blank">Group/JournalizingDefinitionPurchTrans</a>|
|[VendGroup](#VendGroup)||<a href="JournalizingDefinitionPurchTrans.md" target="_blank">Group/JournalizingDefinitionPurchTrans</a>|
|[DataAreaId](#DataAreaId)||<a href="JournalizingDefinitionPurchTrans.md" target="_blank">Group/JournalizingDefinitionPurchTrans</a>|
|[Relationship_EcoResCategoryRelationshipId](#Relationship_EcoResCategoryRelationshipId)||<a href="JournalizingDefinitionPurchTrans.md" target="_blank">Group/JournalizingDefinitionPurchTrans</a>|
|[Relationship_InventItemGroupRelationshipId](#Relationship_InventItemGroupRelationshipId)||<a href="JournalizingDefinitionPurchTrans.md" target="_blank">Group/JournalizingDefinitionPurchTrans</a>|
|[Relationship_InventTableRelationshipId](#Relationship_InventTableRelationshipId)||<a href="JournalizingDefinitionPurchTrans.md" target="_blank">Group/JournalizingDefinitionPurchTrans</a>|
|[Relationship_JournalizingDefinitionRelationshipId](#Relationship_JournalizingDefinitionRelationshipId)||<a href="JournalizingDefinitionPurchTrans.md" target="_blank">Group/JournalizingDefinitionPurchTrans</a>|
|[Relationship_VendGroupRelationshipId](#Relationship_VendGroupRelationshipId)||<a href="JournalizingDefinitionPurchTrans.md" target="_blank">Group/JournalizingDefinitionPurchTrans</a>|
|[Relationship_VendTableRelationshipId](#Relationship_VendTableRelationshipId)||<a href="JournalizingDefinitionPurchTrans.md" target="_blank">Group/JournalizingDefinitionPurchTrans</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="JournalizingDefinitionPurchTrans.md" target="_blank">Group/JournalizingDefinitionPurchTrans</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Group/JournalizingDefinitionPurchTrans (this entity)  
...
<details>
<summary>List of traits for the EcoResCategory attribute are listed below.</summary>
...
### <a href=#VendAccountCode name="VendAccountCode">VendAccountCode</a>
...
<details>
<summary>List of traits for the VendAccountCode attribute are listed below.</summary>
