---
title: BudgetAllowTransferRule in Group - Common Data Model | Microsoft Docs
...
# Budget transfer rules in Group(BudgetAllowTransferRule)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/Finance/Budget/Group/BudgetAllowTransferRule.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[BudgetAllowTransferRule/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Budget transfer rules</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="BudgetAllowTransferRule.md" target="_blank">Group/BudgetAllowTransferRule</a>|
|[Description](#Description)||<a href="BudgetAllowTransferRule.md" target="_blank">Group/BudgetAllowTransferRule</a>|
|[DimensionHierarchyAccountStructure](#DimensionHierarchyAccountStructure)||<a href="BudgetAllowTransferRule.md" target="_blank">Group/BudgetAllowTransferRule</a>|
|[Name](#Name)||<a href="BudgetAllowTransferRule.md" target="_blank">Group/BudgetAllowTransferRule</a>|
|[PrimaryLedger](#PrimaryLedger)||<a href="BudgetAllowTransferRule.md" target="_blank">Group/BudgetAllowTransferRule</a>|
|[Relationship_DimensionHierarchyRelationshipId](#Relationship_DimensionHierarchyRelationshipId)||<a href="BudgetAllowTransferRule.md" target="_blank">Group/BudgetAllowTransferRule</a>|
|[Relationship_LedgerRelationshipId](#Relationship_LedgerRelationshipId)||<a href="BudgetAllowTransferRule.md" target="_blank">Group/BudgetAllowTransferRule</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Group/BudgetAllowTransferRule (this entity)  
