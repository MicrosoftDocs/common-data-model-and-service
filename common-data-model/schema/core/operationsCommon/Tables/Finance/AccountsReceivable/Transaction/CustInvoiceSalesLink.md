---
title: CustInvoiceSalesLink in Transaction - Common Data Model | Microsoft Docs
...
# Customer invoice - sales order relation table in Transaction(CustInvoiceSalesLink)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/Finance/AccountsReceivable/Transaction/CustInvoiceSalesLink.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[CustInvoiceSalesLink/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Customer invoice - sales order relation table</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="CustInvoiceSalesLink.md" target="_blank">Transaction/CustInvoiceSalesLink</a>|
|[salesId](#salesId)||<a href="CustInvoiceSalesLink.md" target="_blank">Transaction/CustInvoiceSalesLink</a>|
|[CustomerRef](#CustomerRef)||<a href="CustInvoiceSalesLink.md" target="_blank">Transaction/CustInvoiceSalesLink</a>|
|[deliveryName](#deliveryName)||<a href="CustInvoiceSalesLink.md" target="_blank">Transaction/CustInvoiceSalesLink</a>|
|[DeliveryPostalAddress](#DeliveryPostalAddress)||<a href="CustInvoiceSalesLink.md" target="_blank">Transaction/CustInvoiceSalesLink</a>|
|[FiscalEstablishment_BR](#FiscalEstablishment_BR)||<a href="CustInvoiceSalesLink.md" target="_blank">Transaction/CustInvoiceSalesLink</a>|
|[invoiceAccount](#invoiceAccount)||<a href="CustInvoiceSalesLink.md" target="_blank">Transaction/CustInvoiceSalesLink</a>|
|[invoiceDate](#invoiceDate)||<a href="CustInvoiceSalesLink.md" target="_blank">Transaction/CustInvoiceSalesLink</a>|
|[invoiceId](#invoiceId)||<a href="CustInvoiceSalesLink.md" target="_blank">Transaction/CustInvoiceSalesLink</a>|
|[InvoicePostalAddress](#InvoicePostalAddress)||<a href="CustInvoiceSalesLink.md" target="_blank">Transaction/CustInvoiceSalesLink</a>|
|[invoicingName](#invoicingName)||<a href="CustInvoiceSalesLink.md" target="_blank">Transaction/CustInvoiceSalesLink</a>|
|[orderAccount](#orderAccount)||<a href="CustInvoiceSalesLink.md" target="_blank">Transaction/CustInvoiceSalesLink</a>|
|[origSalesId](#origSalesId)||<a href="CustInvoiceSalesLink.md" target="_blank">Transaction/CustInvoiceSalesLink</a>|
|[parmId](#parmId)||<a href="CustInvoiceSalesLink.md" target="_blank">Transaction/CustInvoiceSalesLink</a>|
|[PurchaseOrder](#PurchaseOrder)||<a href="CustInvoiceSalesLink.md" target="_blank">Transaction/CustInvoiceSalesLink</a>|
|[DataAreaId](#DataAreaId)||<a href="CustInvoiceSalesLink.md" target="_blank">Transaction/CustInvoiceSalesLink</a>|
|[Relationship_CustInvoiceJourRelationshipId](#Relationship_CustInvoiceJourRelationshipId)||<a href="CustInvoiceSalesLink.md" target="_blank">Transaction/CustInvoiceSalesLink</a>|
|[Relationship_CustTableRelationshipId](#Relationship_CustTableRelationshipId)||<a href="CustInvoiceSalesLink.md" target="_blank">Transaction/CustInvoiceSalesLink</a>|
|[Relationship_CustTable_orderAccountRelationshipId](#Relationship_CustTable_orderAccountRelationshipId)||<a href="CustInvoiceSalesLink.md" target="_blank">Transaction/CustInvoiceSalesLink</a>|
|[Relationship_DeliveryPostalAddress_FKRelationshipId](#Relationship_DeliveryPostalAddress_FKRelationshipId)||<a href="CustInvoiceSalesLink.md" target="_blank">Transaction/CustInvoiceSalesLink</a>|
|[Relationship_FiscalEstablishment_BRRelationshipId](#Relationship_FiscalEstablishment_BRRelationshipId)||<a href="CustInvoiceSalesLink.md" target="_blank">Transaction/CustInvoiceSalesLink</a>|
|[Relationship_InvoicePostalAddress_FKRelationshipId](#Relationship_InvoicePostalAddress_FKRelationshipId)||<a href="CustInvoiceSalesLink.md" target="_blank">Transaction/CustInvoiceSalesLink</a>|
|[Relationship_salesTableRelationshipId](#Relationship_salesTableRelationshipId)||<a href="CustInvoiceSalesLink.md" target="_blank">Transaction/CustInvoiceSalesLink</a>|
|[Relationship_SalesTable_salesIdRelationshipId](#Relationship_SalesTable_salesIdRelationshipId)||<a href="CustInvoiceSalesLink.md" target="_blank">Transaction/CustInvoiceSalesLink</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="CustInvoiceSalesLink.md" target="_blank">Transaction/CustInvoiceSalesLink</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Transaction/CustInvoiceSalesLink (this entity)  
