---
title: CustomsVendBOETrans_IN in Transaction - Common Data Model | Microsoft Docs
...
# Bill of entry lines in Transaction(CustomsVendBOETrans_IN)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/Finance/AccountsReceivable/Transaction/CustomsVendBOETrans_IN.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[CustomsVendBOETrans_IN/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="CustomsVendBOETrans_IN.md" target="_blank">Transaction/CustomsVendBOETrans_IN</a>|
|[BillOfEntryDate](#BillOfEntryDate)||<a href="CustomsVendBOETrans_IN.md" target="_blank">Transaction/CustomsVendBOETrans_IN</a>|
|[BillOfEntryQty](#BillOfEntryQty)||<a href="CustomsVendBOETrans_IN.md" target="_blank">Transaction/CustomsVendBOETrans_IN</a>|
|[CurrencyCode](#CurrencyCode)||<a href="CustomsVendBOETrans_IN.md" target="_blank">Transaction/CustomsVendBOETrans_IN</a>|
|[CustomsBillOfEntryJournal_IN](#CustomsBillOfEntryJournal_IN)||<a href="CustomsVendBOETrans_IN.md" target="_blank">Transaction/CustomsVendBOETrans_IN</a>|
|[CustomsBillOfEntryNumberTable](#CustomsBillOfEntryNumberTable)||<a href="CustomsVendBOETrans_IN.md" target="_blank">Transaction/CustomsVendBOETrans_IN</a>|
|[CustomsImportInvoiceNumberTable](#CustomsImportInvoiceNumberTable)||<a href="CustomsVendBOETrans_IN.md" target="_blank">Transaction/CustomsVendBOETrans_IN</a>|
|[InventDimId](#InventDimId)||<a href="CustomsVendBOETrans_IN.md" target="_blank">Transaction/CustomsVendBOETrans_IN</a>|
|[InventTransId](#InventTransId)||<a href="CustomsVendBOETrans_IN.md" target="_blank">Transaction/CustomsVendBOETrans_IN</a>|
|[ItemId](#ItemId)||<a href="CustomsVendBOETrans_IN.md" target="_blank">Transaction/CustomsVendBOETrans_IN</a>|
|[OrigPurchId](#OrigPurchId)||<a href="CustomsVendBOETrans_IN.md" target="_blank">Transaction/CustomsVendBOETrans_IN</a>|
|[PurchId](#PurchId)||<a href="CustomsVendBOETrans_IN.md" target="_blank">Transaction/CustomsVendBOETrans_IN</a>|
|[PurchInternalBOEId](#PurchInternalBOEId)||<a href="CustomsVendBOETrans_IN.md" target="_blank">Transaction/CustomsVendBOETrans_IN</a>|
|[PurchLineRecId](#PurchLineRecId)||<a href="CustomsVendBOETrans_IN.md" target="_blank">Transaction/CustomsVendBOETrans_IN</a>|
|[ReasonTableRef](#ReasonTableRef)||<a href="CustomsVendBOETrans_IN.md" target="_blank">Transaction/CustomsVendBOETrans_IN</a>|
|[ReceiveQty](#ReceiveQty)||<a href="CustomsVendBOETrans_IN.md" target="_blank">Transaction/CustomsVendBOETrans_IN</a>|
|[RemainingQty](#RemainingQty)||<a href="CustomsVendBOETrans_IN.md" target="_blank">Transaction/CustomsVendBOETrans_IN</a>|
|[Status](#Status)||<a href="CustomsVendBOETrans_IN.md" target="_blank">Transaction/CustomsVendBOETrans_IN</a>|
|[TaxGroup](#TaxGroup)||<a href="CustomsVendBOETrans_IN.md" target="_blank">Transaction/CustomsVendBOETrans_IN</a>|
|[TaxItemGroup](#TaxItemGroup)||<a href="CustomsVendBOETrans_IN.md" target="_blank">Transaction/CustomsVendBOETrans_IN</a>|
|[AssessableValue](#AssessableValue)||<a href="CustomsVendBOETrans_IN.md" target="_blank">Transaction/CustomsVendBOETrans_IN</a>|
|[AssessableValueAccountingCurrency](#AssessableValueAccountingCurrency)||<a href="CustomsVendBOETrans_IN.md" target="_blank">Transaction/CustomsVendBOETrans_IN</a>|
|[DataAreaId](#DataAreaId)||<a href="CustomsVendBOETrans_IN.md" target="_blank">Transaction/CustomsVendBOETrans_IN</a>|
|[Relationship_CurrencyRelationshipId](#Relationship_CurrencyRelationshipId)||<a href="CustomsVendBOETrans_IN.md" target="_blank">Transaction/CustomsVendBOETrans_IN</a>|
|[Relationship_CustomsBillOfEntryNumberTableRelationshipId](#Relationship_CustomsBillOfEntryNumberTableRelationshipId)||<a href="CustomsVendBOETrans_IN.md" target="_blank">Transaction/CustomsVendBOETrans_IN</a>|
|[Relationship_CustomsImportInvoiceNumberTableRelationshipId](#Relationship_CustomsImportInvoiceNumberTableRelationshipId)||<a href="CustomsVendBOETrans_IN.md" target="_blank">Transaction/CustomsVendBOETrans_IN</a>|
|[Relationship_CustomsVendBOEJour_INRelationshipId](#Relationship_CustomsVendBOEJour_INRelationshipId)||<a href="CustomsVendBOETrans_IN.md" target="_blank">Transaction/CustomsVendBOETrans_IN</a>|
|[Relationship_InventDimRelationshipId](#Relationship_InventDimRelationshipId)||<a href="CustomsVendBOETrans_IN.md" target="_blank">Transaction/CustomsVendBOETrans_IN</a>|
|[Relationship_InventTableRelationshipId](#Relationship_InventTableRelationshipId)||<a href="CustomsVendBOETrans_IN.md" target="_blank">Transaction/CustomsVendBOETrans_IN</a>|
|[Relationship_InventTransOriginRelationshipId](#Relationship_InventTransOriginRelationshipId)||<a href="CustomsVendBOETrans_IN.md" target="_blank">Transaction/CustomsVendBOETrans_IN</a>|
|[Relationship_PurchLineRelationshipId](#Relationship_PurchLineRelationshipId)||<a href="CustomsVendBOETrans_IN.md" target="_blank">Transaction/CustomsVendBOETrans_IN</a>|
|[Relationship_PurchTable_OrigPurchIdRelationshipId](#Relationship_PurchTable_OrigPurchIdRelationshipId)||<a href="CustomsVendBOETrans_IN.md" target="_blank">Transaction/CustomsVendBOETrans_IN</a>|
|[Relationship_PurchTable_PurchIDRelationshipId](#Relationship_PurchTable_PurchIDRelationshipId)||<a href="CustomsVendBOETrans_IN.md" target="_blank">Transaction/CustomsVendBOETrans_IN</a>|
|[Relationship_ReasonTableRefRelationshipId](#Relationship_ReasonTableRefRelationshipId)||<a href="CustomsVendBOETrans_IN.md" target="_blank">Transaction/CustomsVendBOETrans_IN</a>|
|[Relationship_TaxGroupHeadingRelationshipId](#Relationship_TaxGroupHeadingRelationshipId)||<a href="CustomsVendBOETrans_IN.md" target="_blank">Transaction/CustomsVendBOETrans_IN</a>|
|[Relationship_TaxItemGroupHeadingRelationshipId](#Relationship_TaxItemGroupHeadingRelationshipId)||<a href="CustomsVendBOETrans_IN.md" target="_blank">Transaction/CustomsVendBOETrans_IN</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="CustomsVendBOETrans_IN.md" target="_blank">Transaction/CustomsVendBOETrans_IN</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Transaction/CustomsVendBOETrans_IN (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Bill of entry quantity</td></tr><tr><td>dataFormat</td><td>decimal</td></tr><tr><td>isNullable</td><td>true</td></tr></table>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Bill of entry quantity</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
### <a href=#CustomsBillOfEntryJournal_IN name="CustomsBillOfEntryJournal_IN">CustomsBillOfEntryJournal_IN</a>
...
<details>
<summary>List of traits for the CustomsBillOfEntryJournal_IN attribute are listed below.</summary>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Bill of entry number</td></tr><tr><td>dataFormat</td><td>int64</td></tr><tr><td>isNullable</td><td>true</td></tr></table>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Bill of entry number</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
### <a href=#Relationship_CustomsVendBOEJour_INRelationshipId name="Relationship_CustomsVendBOEJour_INRelationshipId">Relationship_CustomsVendBOEJour_INRelationshipId</a>
...
<details>
<summary>List of traits for the Relationship_CustomsVendBOEJour_INRelationshipId attribute are listed below.</summary>
...
**means.identity.entityId**  
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="CustomsVendBOEJour_IN.md" target="_blank">/core/operationsCommon/Tables/Finance/AccountsReceivable/Transaction/CustomsVendBOEJour_IN.cdm.json/CustomsVendBOEJour_IN</a></td><td><a href="CustomsVendBOEJour_IN.md#RecId" target="_blank">RecId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
