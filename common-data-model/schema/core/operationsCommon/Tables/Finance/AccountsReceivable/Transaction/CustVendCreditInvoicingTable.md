---
title: CustVendCreditInvoicingTable in Transaction - Common Data Model | Microsoft Docs
...
# Credit invoicing header in Transaction(CustVendCreditInvoicingTable)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/Finance/AccountsReceivable/Transaction/CustVendCreditInvoicingTable.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[CustVendCreditInvoicingTable/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Credit invoicing header</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="CustVendCreditInvoicingTable.md" target="_blank">Transaction/CustVendCreditInvoicingTable</a>|
|[AccountType](#AccountType)||<a href="CustVendCreditInvoicingTable.md" target="_blank">Transaction/CustVendCreditInvoicingTable</a>|
|[CustVendCorrectedInvoiceId](#CustVendCorrectedInvoiceId)||<a href="CustVendCreditInvoicingTable.md" target="_blank">Transaction/CustVendCreditInvoicingTable</a>|
|[CustVendCorrectiveReason](#CustVendCorrectiveReason)||<a href="CustVendCreditInvoicingTable.md" target="_blank">Transaction/CustVendCreditInvoicingTable</a>|
|[CustVendInvoiceAccount](#CustVendInvoiceAccount)||<a href="CustVendCreditInvoicingTable.md" target="_blank">Transaction/CustVendCreditInvoicingTable</a>|
|[RefRecId](#RefRecId)||<a href="CustVendCreditInvoicingTable.md" target="_blank">Transaction/CustVendCreditInvoicingTable</a>|
|[RefTableId](#RefTableId)||<a href="CustVendCreditInvoicingTable.md" target="_blank">Transaction/CustVendCreditInvoicingTable</a>|
|[CustVendCorrectedInvoiceDate](#CustVendCorrectedInvoiceDate)||<a href="CustVendCreditInvoicingTable.md" target="_blank">Transaction/CustVendCreditInvoicingTable</a>|
|[CustVendCorrectedInvoicesInfo](#CustVendCorrectedInvoicesInfo)||<a href="CustVendCreditInvoicingTable.md" target="_blank">Transaction/CustVendCreditInvoicingTable</a>|
|[IsSalesPurchCopying](#IsSalesPurchCopying)||<a href="CustVendCreditInvoicingTable.md" target="_blank">Transaction/CustVendCreditInvoicingTable</a>|
|[ReasonRefRecID](#ReasonRefRecID)||<a href="CustVendCreditInvoicingTable.md" target="_blank">Transaction/CustVendCreditInvoicingTable</a>|
|[CustVendCorrectiveReasonCode](#CustVendCorrectiveReasonCode)||<a href="CustVendCreditInvoicingTable.md" target="_blank">Transaction/CustVendCreditInvoicingTable</a>|
|[CustVendCorrectiveReasonMethod](#CustVendCorrectiveReasonMethod)||<a href="CustVendCreditInvoicingTable.md" target="_blank">Transaction/CustVendCreditInvoicingTable</a>|
|[DataAreaId](#DataAreaId)||<a href="CustVendCreditInvoicingTable.md" target="_blank">Transaction/CustVendCreditInvoicingTable</a>|
|[Relationship_CustInvoiceTableRelationshipId](#Relationship_CustInvoiceTableRelationshipId)||<a href="CustVendCreditInvoicingTable.md" target="_blank">Transaction/CustVendCreditInvoicingTable</a>|
|[Relationship_LedgerJournalTransRelationshipId](#Relationship_LedgerJournalTransRelationshipId)||<a href="CustVendCreditInvoicingTable.md" target="_blank">Transaction/CustVendCreditInvoicingTable</a>|
|[Relationship_PurchTableRelationshipId](#Relationship_PurchTableRelationshipId)||<a href="CustVendCreditInvoicingTable.md" target="_blank">Transaction/CustVendCreditInvoicingTable</a>|
|[Relationship_SalesTableRelationshipId](#Relationship_SalesTableRelationshipId)||<a href="CustVendCreditInvoicingTable.md" target="_blank">Transaction/CustVendCreditInvoicingTable</a>|
|[Relationship_ReasonTableRefRelationshipId](#Relationship_ReasonTableRefRelationshipId)||<a href="CustVendCreditInvoicingTable.md" target="_blank">Transaction/CustVendCreditInvoicingTable</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="CustVendCreditInvoicingTable.md" target="_blank">Transaction/CustVendCreditInvoicingTable</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Transaction/CustVendCreditInvoicingTable (this entity)  
