---
title: CustEntryCertificateJour_W in Transaction - Common Data Model | Microsoft Docs
...
# Entry certificate journal in Transaction(CustEntryCertificateJour_W)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/Finance/AccountsReceivable/Transaction/CustEntryCertificateJour_W.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[CustEntryCertificateJour_W/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="CustEntryCertificateJour_W.md" target="_blank">Transaction/CustEntryCertificateJour_W</a>|
|[CustAccount](#CustAccount)||<a href="CustEntryCertificateJour_W.md" target="_blank">Transaction/CustEntryCertificateJour_W</a>|
|[DeliveryPostalAddress](#DeliveryPostalAddress)||<a href="CustEntryCertificateJour_W.md" target="_blank">Transaction/CustEntryCertificateJour_W</a>|
|[Description](#Description)||<a href="CustEntryCertificateJour_W.md" target="_blank">Transaction/CustEntryCertificateJour_W</a>|
|[EntryCertificateId](#EntryCertificateId)||<a href="CustEntryCertificateJour_W.md" target="_blank">Transaction/CustEntryCertificateJour_W</a>|
|[InvoiceId](#InvoiceId)||<a href="CustEntryCertificateJour_W.md" target="_blank">Transaction/CustEntryCertificateJour_W</a>|
|[IsThirdParty](#IsThirdParty)||<a href="CustEntryCertificateJour_W.md" target="_blank">Transaction/CustEntryCertificateJour_W</a>|
|[LanguageId](#LanguageId)||<a href="CustEntryCertificateJour_W.md" target="_blank">Transaction/CustEntryCertificateJour_W</a>|
|[PackingSlipId](#PackingSlipId)||<a href="CustEntryCertificateJour_W.md" target="_blank">Transaction/CustEntryCertificateJour_W</a>|
|[SalesId](#SalesId)||<a href="CustEntryCertificateJour_W.md" target="_blank">Transaction/CustEntryCertificateJour_W</a>|
|[SourceRefRecId](#SourceRefRecId)||<a href="CustEntryCertificateJour_W.md" target="_blank">Transaction/CustEntryCertificateJour_W</a>|
|[SourceRefTableId](#SourceRefTableId)||<a href="CustEntryCertificateJour_W.md" target="_blank">Transaction/CustEntryCertificateJour_W</a>|
|[Status](#Status)||<a href="CustEntryCertificateJour_W.md" target="_blank">Transaction/CustEntryCertificateJour_W</a>|
|[DataAreaId](#DataAreaId)||<a href="CustEntryCertificateJour_W.md" target="_blank">Transaction/CustEntryCertificateJour_W</a>|
|[Relationship_CustInvoiceJourRelationshipId](#Relationship_CustInvoiceJourRelationshipId)||<a href="CustEntryCertificateJour_W.md" target="_blank">Transaction/CustEntryCertificateJour_W</a>|
|[Relationship_CustPackingSlipJourRelationshipId](#Relationship_CustPackingSlipJourRelationshipId)||<a href="CustEntryCertificateJour_W.md" target="_blank">Transaction/CustEntryCertificateJour_W</a>|
|[Relationship_CustTableRelationshipId](#Relationship_CustTableRelationshipId)||<a href="CustEntryCertificateJour_W.md" target="_blank">Transaction/CustEntryCertificateJour_W</a>|
|[Relationship_DeliveryPostalAddress_FKRelationshipId](#Relationship_DeliveryPostalAddress_FKRelationshipId)||<a href="CustEntryCertificateJour_W.md" target="_blank">Transaction/CustEntryCertificateJour_W</a>|
|[Relationship_LanguageTableRelationshipId](#Relationship_LanguageTableRelationshipId)||<a href="CustEntryCertificateJour_W.md" target="_blank">Transaction/CustEntryCertificateJour_W</a>|
|[Relationship_SalesTableRelationshipId](#Relationship_SalesTableRelationshipId)||<a href="CustEntryCertificateJour_W.md" target="_blank">Transaction/CustEntryCertificateJour_W</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="CustEntryCertificateJour_W.md" target="_blank">Transaction/CustEntryCertificateJour_W</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Transaction/CustEntryCertificateJour_W (this entity)  
...
### <a href=#EntryCertificateId name="EntryCertificateId">EntryCertificateId</a>
...
<details>
<summary>List of traits for the EntryCertificateId attribute are listed below.</summary>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Invoice</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>isReadOnly</td><td>true</td></tr><tr><td>isNullable</td><td>true</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Packing slip</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>isReadOnly</td><td>true</td></tr><tr><td>isNullable</td><td>true</td></tr></table>
