---
title: CustVendCreditInvoicingLine in Transaction - Common Data Model | Microsoft Docs
...
# Credit invoicing lines in Transaction(CustVendCreditInvoicingLine)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/Finance/AccountsReceivable/Transaction/CustVendCreditInvoicingLine.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[CustVendCreditInvoicingLine/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Credit invoicing lines</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="CustVendCreditInvoicingLine.md" target="_blank">Transaction/CustVendCreditInvoicingLine</a>|
|[AccountType](#AccountType)||<a href="CustVendCreditInvoicingLine.md" target="_blank">Transaction/CustVendCreditInvoicingLine</a>|
|[CustVendCorrectiveReason](#CustVendCorrectiveReason)||<a href="CustVendCreditInvoicingLine.md" target="_blank">Transaction/CustVendCreditInvoicingLine</a>|
|[CustVendInvoiceAccount](#CustVendInvoiceAccount)||<a href="CustVendCreditInvoicingLine.md" target="_blank">Transaction/CustVendCreditInvoicingLine</a>|
|[RefRecId](#RefRecId)||<a href="CustVendCreditInvoicingLine.md" target="_blank">Transaction/CustVendCreditInvoicingLine</a>|
|[RefTableId](#RefTableId)||<a href="CustVendCreditInvoicingLine.md" target="_blank">Transaction/CustVendCreditInvoicingLine</a>|
|[CustVendCorrectiveReasonCode](#CustVendCorrectiveReasonCode)||<a href="CustVendCreditInvoicingLine.md" target="_blank">Transaction/CustVendCreditInvoicingLine</a>|
|[CustVendCorrectiveReasonMethod](#CustVendCorrectiveReasonMethod)||<a href="CustVendCreditInvoicingLine.md" target="_blank">Transaction/CustVendCreditInvoicingLine</a>|
|[DataAreaId](#DataAreaId)||<a href="CustVendCreditInvoicingLine.md" target="_blank">Transaction/CustVendCreditInvoicingLine</a>|
|[Relationship_CustInvoiceLineRelationshipId](#Relationship_CustInvoiceLineRelationshipId)||<a href="CustVendCreditInvoicingLine.md" target="_blank">Transaction/CustVendCreditInvoicingLine</a>|
|[Relationship_PurchLineRelationshipId](#Relationship_PurchLineRelationshipId)||<a href="CustVendCreditInvoicingLine.md" target="_blank">Transaction/CustVendCreditInvoicingLine</a>|
|[Relationship_SalesLineRelationshipId](#Relationship_SalesLineRelationshipId)||<a href="CustVendCreditInvoicingLine.md" target="_blank">Transaction/CustVendCreditInvoicingLine</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="CustVendCreditInvoicingLine.md" target="_blank">Transaction/CustVendCreditInvoicingLine</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Transaction/CustVendCreditInvoicingLine (this entity)  
