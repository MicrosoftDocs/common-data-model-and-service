---
title: AssetDocumentLedgerAccounts_JP in Group - Common Data Model | Microsoft Docs
...
# Fixed asset ledger accounts in Group(AssetDocumentLedgerAccounts_JP)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/Finance/FixedAssets/Group/AssetDocumentLedgerAccounts_JP.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[AssetDocumentLedgerAccounts_JP/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="AssetDocumentLedgerAccounts_JP.md" target="_blank">Group/AssetDocumentLedgerAccounts_JP</a>|
|[AccountCode](#AccountCode)||<a href="AssetDocumentLedgerAccounts_JP.md" target="_blank">Group/AssetDocumentLedgerAccounts_JP</a>|
|[AccountRelation](#AccountRelation)||<a href="AssetDocumentLedgerAccounts_JP.md" target="_blank">Group/AssetDocumentLedgerAccounts_JP</a>|
|[BookId](#BookId)||<a href="AssetDocumentLedgerAccounts_JP.md" target="_blank">Group/AssetDocumentLedgerAccounts_JP</a>|
|[LedgerDimension](#LedgerDimension)||<a href="AssetDocumentLedgerAccounts_JP.md" target="_blank">Group/AssetDocumentLedgerAccounts_JP</a>|
|[OffsetLedgerDimension](#OffsetLedgerDimension)||<a href="AssetDocumentLedgerAccounts_JP.md" target="_blank">Group/AssetDocumentLedgerAccounts_JP</a>|
|[PostingProfile](#PostingProfile)||<a href="AssetDocumentLedgerAccounts_JP.md" target="_blank">Group/AssetDocumentLedgerAccounts_JP</a>|
|[TransType](#TransType)||<a href="AssetDocumentLedgerAccounts_JP.md" target="_blank">Group/AssetDocumentLedgerAccounts_JP</a>|
|[DataAreaId](#DataAreaId)||<a href="AssetDocumentLedgerAccounts_JP.md" target="_blank">Group/AssetDocumentLedgerAccounts_JP</a>|
|[Relationship_AssetBookTableRelationshipId](#Relationship_AssetBookTableRelationshipId)||<a href="AssetDocumentLedgerAccounts_JP.md" target="_blank">Group/AssetDocumentLedgerAccounts_JP</a>|
|[Relationship_AssetGroupRelationshipId](#Relationship_AssetGroupRelationshipId)||<a href="AssetDocumentLedgerAccounts_JP.md" target="_blank">Group/AssetDocumentLedgerAccounts_JP</a>|
|[Relationship_AssetLedgerRelationshipId](#Relationship_AssetLedgerRelationshipId)||<a href="AssetDocumentLedgerAccounts_JP.md" target="_blank">Group/AssetDocumentLedgerAccounts_JP</a>|
|[Relationship_AssetTableRelationshipId](#Relationship_AssetTableRelationshipId)||<a href="AssetDocumentLedgerAccounts_JP.md" target="_blank">Group/AssetDocumentLedgerAccounts_JP</a>|
|[Relationship_LedgerDimensionRelationshipId](#Relationship_LedgerDimensionRelationshipId)||<a href="AssetDocumentLedgerAccounts_JP.md" target="_blank">Group/AssetDocumentLedgerAccounts_JP</a>|
|[Relationship_OffsetLedgerDimensionRelationshipId](#Relationship_OffsetLedgerDimensionRelationshipId)||<a href="AssetDocumentLedgerAccounts_JP.md" target="_blank">Group/AssetDocumentLedgerAccounts_JP</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="AssetDocumentLedgerAccounts_JP.md" target="_blank">Group/AssetDocumentLedgerAccounts_JP</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Group/AssetDocumentLedgerAccounts_JP (this entity)  
