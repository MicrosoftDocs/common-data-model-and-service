---
title: PurchParmLine_Asset in WorksheetLine - Common Data Model | Microsoft Docs
...
# Purchase order line - asset information in WorksheetLine(PurchParmLine_Asset)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/Finance/FixedAssets/WorksheetLine/PurchParmLine_Asset.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[PurchParmLine_Asset/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="PurchParmLine_Asset.md" target="_blank">WorksheetLine/PurchParmLine_Asset</a>|
|[AssetAcquired](#AssetAcquired)||<a href="PurchParmLine_Asset.md" target="_blank">WorksheetLine/PurchParmLine_Asset</a>|
|[AssetBookId](#AssetBookId)||<a href="PurchParmLine_Asset.md" target="_blank">WorksheetLine/PurchParmLine_Asset</a>|
|[AssetGroup](#AssetGroup)||<a href="PurchParmLine_Asset.md" target="_blank">WorksheetLine/PurchParmLine_Asset</a>|
|[AssetId](#AssetId)||<a href="PurchParmLine_Asset.md" target="_blank">WorksheetLine/PurchParmLine_Asset</a>|
|[AssetTransTypePurch](#AssetTransTypePurch)||<a href="PurchParmLine_Asset.md" target="_blank">WorksheetLine/PurchParmLine_Asset</a>|
|[CreateFixedAsset](#CreateFixedAsset)||<a href="PurchParmLine_Asset.md" target="_blank">WorksheetLine/PurchParmLine_Asset</a>|
|[PurchParmLineRecId](#PurchParmLineRecId)||<a href="PurchParmLine_Asset.md" target="_blank">WorksheetLine/PurchParmLine_Asset</a>|
|[DataAreaId](#DataAreaId)||<a href="PurchParmLine_Asset.md" target="_blank">WorksheetLine/PurchParmLine_Asset</a>|
|[Relationship_AssetBookRelationshipId](#Relationship_AssetBookRelationshipId)||<a href="PurchParmLine_Asset.md" target="_blank">WorksheetLine/PurchParmLine_Asset</a>|
|[Relationship_AssetBookTableRelationshipId](#Relationship_AssetBookTableRelationshipId)||<a href="PurchParmLine_Asset.md" target="_blank">WorksheetLine/PurchParmLine_Asset</a>|
|[Relationship_AssetGroupRelationshipId](#Relationship_AssetGroupRelationshipId)||<a href="PurchParmLine_Asset.md" target="_blank">WorksheetLine/PurchParmLine_Asset</a>|
|[Relationship_AssetTableRelationshipId](#Relationship_AssetTableRelationshipId)||<a href="PurchParmLine_Asset.md" target="_blank">WorksheetLine/PurchParmLine_Asset</a>|
|[Relationship_PurchParmLineRelationshipId](#Relationship_PurchParmLineRelationshipId)||<a href="PurchParmLine_Asset.md" target="_blank">WorksheetLine/PurchParmLine_Asset</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="PurchParmLine_Asset.md" target="_blank">WorksheetLine/PurchParmLine_Asset</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: WorksheetLine/PurchParmLine_Asset (this entity)  
...
### <a href=#PurchParmLineRecId name="PurchParmLineRecId">PurchParmLineRecId</a>
...
<details>
<summary>List of traits for the PurchParmLineRecId attribute are listed below.</summary>
...
**means.identity.entityId**  
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="../../../SupplyChain/ProcurementAndSourcing/WorksheetLine/PurchParmLine.md" target="_blank">/core/operationsCommon/Tables/SupplyChain/ProcurementAndSourcing/WorksheetLine/PurchParmLine.cdm.json/PurchParmLine</a></td><td><a href="../../../SupplyChain/ProcurementAndSourcing/WorksheetLine/PurchParmLine.md#RecId" target="_blank">RecId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
