---
title: VendInvoiceInfoSubMarkupMatchingTrans in TransactionHeader - Common Data Model | Microsoft Docs
...
# Vendor invoice expected purchase order charges in TransactionHeader(VendInvoiceInfoSubMarkupMatchingTrans)
