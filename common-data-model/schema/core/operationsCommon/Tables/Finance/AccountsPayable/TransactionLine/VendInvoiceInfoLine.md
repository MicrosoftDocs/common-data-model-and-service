---
title: VendInvoiceInfoLine in TransactionLine - Common Data Model | Microsoft Docs
...
# Vendor invoice lines in TransactionLine(VendInvoiceInfoLine)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/Finance/AccountsPayable/TransactionLine/VendInvoiceInfoLine.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[VendInvoiceInfoLine/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Vendor invoice lines</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[OrderAccount](#OrderAccount)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[AccountingDistributionTemplate](#AccountingDistributionTemplate)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[AdvanceApplicationId](#AdvanceApplicationId)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[AddressRefRecId](#AddressRefRecId)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[AddressRefTableId](#AddressRefTableId)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[AgreementLine_PSN](#AgreementLine_PSN)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[changedManually](#changedManually)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[closed](#closed)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[CountyOrigDest](#CountyOrigDest)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[currencyCode](#currencyCode)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[DefaultDimension](#DefaultDimension)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[DeliveryName](#DeliveryName)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[DeliveryPostalAddress](#DeliveryPostalAddress)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[Description](#Description)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[DocumentOrigin](#DocumentOrigin)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[InventDimId](#InventDimId)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[InventNow](#InventNow)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[InventTransId](#InventTransId)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[InvoiceAccount](#InvoiceAccount)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[ItemId](#ItemId)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[LineAmount](#LineAmount)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[LineDisc](#LineDisc)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[LineNum](#LineNum)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[LinePercent](#LinePercent)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[LineType](#LineType)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[MultiLnDisc](#MultiLnDisc)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[MultiLnPercent](#MultiLnPercent)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[Ordering](#Ordering)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[OrigPurchId](#OrigPurchId)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[PackedExtensions](#PackedExtensions)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[ParmId](#ParmId)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[PayrollLedgerDimension](#PayrollLedgerDimension)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[PDSCalculatedUnitPrice](#PDSCalculatedUnitPrice)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[PDSCalculationId](#PDSCalculationId)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[PdsCWReceiveNow](#PdsCWReceiveNow)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[PdsCWRemainAfter](#PdsCWRemainAfter)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[PdsCWRemainBefore](#PdsCWRemainBefore)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[Port](#Port)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[PriceUnit](#PriceUnit)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[ProcurementCategory](#ProcurementCategory)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[PSAIsFinal](#PSAIsFinal)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[PSAReleaseAmount](#PSAReleaseAmount)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[PSAReleasePercent](#PSAReleasePercent)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[PSARetainageAmount](#PSARetainageAmount)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[PSARetainageBalance](#PSARetainageBalance)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[PSARetainagePercent](#PSARetainagePercent)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[PurchaseLineLineNumber](#PurchaseLineLineNumber)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[PurchCommitmentLine_PSN](#PurchCommitmentLine_PSN)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[PurchLineRecId](#PurchLineRecId)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[PurchMarkup](#PurchMarkup)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[PurchPrice](#PurchPrice)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[PurchUnit](#PurchUnit)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[ReasonTableRef](#ReasonTableRef)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[ReceiveNow](#ReceiveNow)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[RemainAfter](#RemainAfter)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[RemainAfterInvent](#RemainAfterInvent)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[RemainBefore](#RemainBefore)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[RemainBeforeInvent](#RemainBeforeInvent)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[RemainBeforeInventPhysical](#RemainBeforeInventPhysical)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[RequestStatus](#RequestStatus)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[SourceDocumentLine](#SourceDocumentLine)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[StatProcId](#StatProcId)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[TableRefId](#TableRefId)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[Tax1099Amount](#Tax1099Amount)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[Tax1099BoxDetail](#Tax1099BoxDetail)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[Tax1099Fields](#Tax1099Fields)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[Tax1099State](#Tax1099State)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[Tax1099StateAmount](#Tax1099StateAmount)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[TaxGroup](#TaxGroup)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[TaxItemGroup](#TaxItemGroup)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[TaxWithholdGroup](#TaxWithholdGroup)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[TaxWithholdItemGroupHeadingId](#TaxWithholdItemGroupHeadingId)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[TransactionCode](#TransactionCode)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[Transport](#Transport)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[VendDirective_PSN](#VendDirective_PSN)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[IntrastatCommodity](#IntrastatCommodity)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[OrigCountryRegionId](#OrigCountryRegionId)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[OrigStateId](#OrigStateId)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[InvoiceLineNum](#InvoiceLineNum)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[BudgetReservationLine_PSN](#BudgetReservationLine_PSN)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[DataAreaId](#DataAreaId)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[Relationship_AccountingDistributionTemplateRelationshipId](#Relationship_AccountingDistributionTemplateRelationshipId)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[Relationship_AgreementLineRelationshipId](#Relationship_AgreementLineRelationshipId)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[Relationship_CountyOrigDestRelationshipId](#Relationship_CountyOrigDestRelationshipId)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[Relationship_CurrencyRelationshipId](#Relationship_CurrencyRelationshipId)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[Relationship_DefaultDimensionRelationshipId](#Relationship_DefaultDimensionRelationshipId)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[Relationship_DeliveryPostalAddress_FKRelationshipId](#Relationship_DeliveryPostalAddress_FKRelationshipId)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[Relationship_IntrastatPortRelationshipId](#Relationship_IntrastatPortRelationshipId)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[Relationship_IntrastatStatProcRelationshipId](#Relationship_IntrastatStatProcRelationshipId)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[Relationship_IntrastatTransactionCodeRelationshipId](#Relationship_IntrastatTransactionCodeRelationshipId)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[Relationship_IntrastatTransportModeRelationshipId](#Relationship_IntrastatTransportModeRelationshipId)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[Relationship_InventDim_InventDimIdRelationshipId](#Relationship_InventDim_InventDimIdRelationshipId)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[Relationship_InventTableRelationshipId](#Relationship_InventTableRelationshipId)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[Relationship_InventTransOriginRelationshipId](#Relationship_InventTransOriginRelationshipId)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[Relationship_PayrollLedgerDimensionRelationshipId](#Relationship_PayrollLedgerDimensionRelationshipId)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[Relationship_ProcurementCategoryRelationshipId](#Relationship_ProcurementCategoryRelationshipId)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[Relationship_PurchCommitmentLine_PSNRelationshipId](#Relationship_PurchCommitmentLine_PSNRelationshipId)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[Relationship_PurchLineRelationshipId](#Relationship_PurchLineRelationshipId)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[Relationship_PurchTableRelationshipId](#Relationship_PurchTableRelationshipId)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[Relationship_ReasonTableRefRelationshipId](#Relationship_ReasonTableRefRelationshipId)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[Relationship_SourceDocumentLineRelationshipId](#Relationship_SourceDocumentLineRelationshipId)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[Relationship_Tax1099BoxDetailRelationshipId](#Relationship_Tax1099BoxDetailRelationshipId)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[Relationship_Tax1099FieldsRelationshipId](#Relationship_Tax1099FieldsRelationshipId)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[Relationship_Tax1099StateRelationshipId](#Relationship_Tax1099StateRelationshipId)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[Relationship_TaxGroupHeadingRelationshipId](#Relationship_TaxGroupHeadingRelationshipId)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[Relationship_TaxItemGroupHeadingRelationshipId](#Relationship_TaxItemGroupHeadingRelationshipId)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[Relationship_TaxWithholdGroupHeadingRelationshipId](#Relationship_TaxWithholdGroupHeadingRelationshipId)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[Relationship_TaxWithholdItemGroupHeadingRelationshipId](#Relationship_TaxWithholdItemGroupHeadingRelationshipId)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[Relationship_VendDirective_PSNRelationshipId](#Relationship_VendDirective_PSNRelationshipId)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[Relationship_VendInvoiceInfoSubTableRelationshipId](#Relationship_VendInvoiceInfoSubTableRelationshipId)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[Relationship_VendInvoiceInfoTableRelationshipId](#Relationship_VendInvoiceInfoTableRelationshipId)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[Relationship_VendInvoiceJourAdvanceApplicationIdRelationshipId](#Relationship_VendInvoiceJourAdvanceApplicationIdRelationshipId)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[Relationship_VendTable_InvoiceAccountRelationshipId](#Relationship_VendTable_InvoiceAccountRelationshipId)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[Relationship_VendTable_OrderAccountRelationshipId](#Relationship_VendTable_OrderAccountRelationshipId)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[Relationship_OrigCountryRegionRelationshipId](#Relationship_OrigCountryRegionRelationshipId)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[Relationship_OrigStateRelationshipId](#Relationship_OrigStateRelationshipId)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[Relationship_IntrastatCommodityRelationshipId](#Relationship_IntrastatCommodityRelationshipId)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[Relationship_BudgetReservationLine_PSNRelationshipId](#Relationship_BudgetReservationLine_PSNRelationshipId)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="VendInvoiceInfoLine.md" target="_blank">TransactionLine/VendInvoiceInfoLine</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: TransactionLine/VendInvoiceInfoLine (this entity)  
...
### <a href=#PayrollLedgerDimension name="PayrollLedgerDimension">PayrollLedgerDimension</a>
...
<details>
<summary>List of traits for the PayrollLedgerDimension attribute are listed below.</summary>
...
### <a href=#PDSCalculatedUnitPrice name="PDSCalculatedUnitPrice">PDSCalculatedUnitPrice</a>
...
<details>
<summary>List of traits for the PDSCalculatedUnitPrice attribute are listed below.</summary>
...
### <a href=#PdsCWRemainAfter name="PdsCWRemainAfter">PdsCWRemainAfter</a>

First included in: TransactionLine/VendInvoiceInfoLine (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>CW delivery remainder</td></tr><tr><td>dataFormat</td><td>decimal</td></tr><tr><td>isNullable</td><td>true</td></tr></table>

#### Traits

<details>
<summary>List of traits for the PdsCWRemainAfter attribute are listed below.</summary>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>CW delivery remainder</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
### <a href=#PSAIsFinal name="PSAIsFinal">PSAIsFinal</a>

First included in: TransactionLine/VendInvoiceInfoLine (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Release all retained amount</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>isNullable</td><td>true</td></tr></table>

#### Traits

<details>
<summary>List of traits for the PSAIsFinal attribute are listed below.</summary>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Release all retained amount</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
### <a href=#PSAReleasePercent name="PSAReleasePercent">PSAReleasePercent</a>
...
<details>
<summary>List of traits for the PSAReleasePercent attribute are listed below.</summary>
...
### <a href=#PSARetainageBalance name="PSARetainageBalance">PSARetainageBalance</a>

First included in: TransactionLine/VendInvoiceInfoLine (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Total retained amount</td></tr><tr><td>dataFormat</td><td>decimal</td></tr><tr><td>isReadOnly</td><td>true</td></tr><tr><td>isNullable</td><td>true</td></tr></table>

#### Traits

<details>
<summary>List of traits for the PSARetainageBalance attribute are listed below.</summary>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Total retained amount</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
### <a href=#PSARetainagePercent name="PSARetainagePercent">PSARetainagePercent</a>
...
<details>
<summary>List of traits for the PSARetainagePercent attribute are listed below.</summary>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Vendor invoice line review status</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>isNullable</td><td>true</td></tr></table>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Vendor invoice line review status</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
### <a href=#Tax1099BoxDetail name="Tax1099BoxDetail">Tax1099BoxDetail</a>
...
<details>
<summary>List of traits for the Tax1099BoxDetail attribute are listed below.</summary>
...
### <a href=#Relationship_PayrollLedgerDimensionRelationshipId name="Relationship_PayrollLedgerDimensionRelationshipId">Relationship_PayrollLedgerDimensionRelationshipId</a>
...
<details>
<summary>List of traits for the Relationship_PayrollLedgerDimensionRelationshipId attribute are listed below.</summary>
...
**means.identity.entityId**  
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="VendInvoiceInfoSubTable.md" target="_blank">/core/operationsCommon/Tables/Finance/AccountsPayable/TransactionLine/VendInvoiceInfoSubTable.cdm.json/VendInvoiceInfoSubTable</a></td><td><a href="VendInvoiceInfoSubTable.md#RecId" target="_blank">RecId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
...
### <a href=#Relationship_VendInvoiceJourAdvanceApplicationIdRelationshipId name="Relationship_VendInvoiceJourAdvanceApplicationIdRelationshipId">Relationship_VendInvoiceJourAdvanceApplicationIdRelationshipId</a>
...
<details>
<summary>List of traits for the Relationship_VendInvoiceJourAdvanceApplicationIdRelationshipId attribute are listed below.</summary>
