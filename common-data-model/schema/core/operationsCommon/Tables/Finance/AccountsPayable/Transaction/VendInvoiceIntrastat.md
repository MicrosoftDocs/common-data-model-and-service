---
title: VendInvoiceIntrastat in Transaction - Common Data Model | Microsoft Docs
...
# Intrastat information of vendor invoices in Transaction(VendInvoiceIntrastat)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/Finance/AccountsPayable/Transaction/VendInvoiceIntrastat.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[VendInvoiceIntrastat/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Intrastat information of vendor invoices</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="VendInvoiceIntrastat.md" target="_blank">Transaction/VendInvoiceIntrastat</a>|
|[CountyOrigDest](#CountyOrigDest)||<a href="VendInvoiceIntrastat.md" target="_blank">Transaction/VendInvoiceIntrastat</a>|
|[IntrastatCommodity](#IntrastatCommodity)||<a href="VendInvoiceIntrastat.md" target="_blank">Transaction/VendInvoiceIntrastat</a>|
|[IntraUnit](#IntraUnit)||<a href="VendInvoiceIntrastat.md" target="_blank">Transaction/VendInvoiceIntrastat</a>|
|[NGPCodesTable_FR](#NGPCodesTable_FR)||<a href="VendInvoiceIntrastat.md" target="_blank">Transaction/VendInvoiceIntrastat</a>|
|[OrigCountryRegionId](#OrigCountryRegionId)||<a href="VendInvoiceIntrastat.md" target="_blank">Transaction/VendInvoiceIntrastat</a>|
|[OrigStateId](#OrigStateId)||<a href="VendInvoiceIntrastat.md" target="_blank">Transaction/VendInvoiceIntrastat</a>|
|[Port](#Port)||<a href="VendInvoiceIntrastat.md" target="_blank">Transaction/VendInvoiceIntrastat</a>|
|[StatisticsFactor](#StatisticsFactor)||<a href="VendInvoiceIntrastat.md" target="_blank">Transaction/VendInvoiceIntrastat</a>|
|[StatProcId](#StatProcId)||<a href="VendInvoiceIntrastat.md" target="_blank">Transaction/VendInvoiceIntrastat</a>|
|[TransactionCode](#TransactionCode)||<a href="VendInvoiceIntrastat.md" target="_blank">Transaction/VendInvoiceIntrastat</a>|
|[TransDate](#TransDate)||<a href="VendInvoiceIntrastat.md" target="_blank">Transaction/VendInvoiceIntrastat</a>|
|[Transport](#Transport)||<a href="VendInvoiceIntrastat.md" target="_blank">Transaction/VendInvoiceIntrastat</a>|
|[VendInvoiceJour](#VendInvoiceJour)||<a href="VendInvoiceIntrastat.md" target="_blank">Transaction/VendInvoiceIntrastat</a>|
|[Voucher](#Voucher)||<a href="VendInvoiceIntrastat.md" target="_blank">Transaction/VendInvoiceIntrastat</a>|
|[Intracode](#Intracode)||<a href="VendInvoiceIntrastat.md" target="_blank">Transaction/VendInvoiceIntrastat</a>|
|[DataAreaId](#DataAreaId)||<a href="VendInvoiceIntrastat.md" target="_blank">Transaction/VendInvoiceIntrastat</a>|
|[Relationship_AddressCounty_FKRelationshipId](#Relationship_AddressCounty_FKRelationshipId)||<a href="VendInvoiceIntrastat.md" target="_blank">Transaction/VendInvoiceIntrastat</a>|
|[Relationship_AddressState_FKRelationshipId](#Relationship_AddressState_FKRelationshipId)||<a href="VendInvoiceIntrastat.md" target="_blank">Transaction/VendInvoiceIntrastat</a>|
|[Relationship_IntrastatCommodityRelationshipId](#Relationship_IntrastatCommodityRelationshipId)||<a href="VendInvoiceIntrastat.md" target="_blank">Transaction/VendInvoiceIntrastat</a>|
|[Relationship_IntrastatPortRelationshipId](#Relationship_IntrastatPortRelationshipId)||<a href="VendInvoiceIntrastat.md" target="_blank">Transaction/VendInvoiceIntrastat</a>|
|[Relationship_IntrastatStatProcRelationshipId](#Relationship_IntrastatStatProcRelationshipId)||<a href="VendInvoiceIntrastat.md" target="_blank">Transaction/VendInvoiceIntrastat</a>|
|[Relationship_IntrastatTransactionCodeRelationshipId](#Relationship_IntrastatTransactionCodeRelationshipId)||<a href="VendInvoiceIntrastat.md" target="_blank">Transaction/VendInvoiceIntrastat</a>|
|[Relationship_IntrastatTransportModeRelationshipId](#Relationship_IntrastatTransportModeRelationshipId)||<a href="VendInvoiceIntrastat.md" target="_blank">Transaction/VendInvoiceIntrastat</a>|
|[Relationship_LedgerJournalTransRelationshipId](#Relationship_LedgerJournalTransRelationshipId)||<a href="VendInvoiceIntrastat.md" target="_blank">Transaction/VendInvoiceIntrastat</a>|
|[Relationship_LogisticsAddressCountryRegionRelationshipId](#Relationship_LogisticsAddressCountryRegionRelationshipId)||<a href="VendInvoiceIntrastat.md" target="_blank">Transaction/VendInvoiceIntrastat</a>|
|[Relationship_NGPCodesTable_FRRelationshipId](#Relationship_NGPCodesTable_FRRelationshipId)||<a href="VendInvoiceIntrastat.md" target="_blank">Transaction/VendInvoiceIntrastat</a>|
|[Relationship_VendinvoiceJour_FKRelationshipId](#Relationship_VendinvoiceJour_FKRelationshipId)||<a href="VendInvoiceIntrastat.md" target="_blank">Transaction/VendInvoiceIntrastat</a>|
|[Relationship_VendTransRelationshipId](#Relationship_VendTransRelationshipId)||<a href="VendInvoiceIntrastat.md" target="_blank">Transaction/VendInvoiceIntrastat</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="VendInvoiceIntrastat.md" target="_blank">Transaction/VendInvoiceIntrastat</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Transaction/VendInvoiceIntrastat (this entity)  
...
### <a href=#IntraUnit name="IntraUnit">IntraUnit</a>
...
<details>
<summary>List of traits for the IntraUnit attribute are listed below.</summary>
...
### <a href=#Relationship_AddressCounty_FKRelationshipId name="Relationship_AddressCounty_FKRelationshipId">Relationship_AddressCounty_FKRelationshipId</a>
...
<details>
<summary>List of traits for the Relationship_AddressCounty_FKRelationshipId attribute are listed below.</summary>
...
### <a href=#Relationship_AddressState_FKRelationshipId name="Relationship_AddressState_FKRelationshipId">Relationship_AddressState_FKRelationshipId</a>
...
<details>
<summary>List of traits for the Relationship_AddressState_FKRelationshipId attribute are listed below.</summary>
...
### <a href=#Relationship_VendinvoiceJour_FKRelationshipId name="Relationship_VendinvoiceJour_FKRelationshipId">Relationship_VendinvoiceJour_FKRelationshipId</a>
...
<details>
<summary>List of traits for the Relationship_VendinvoiceJour_FKRelationshipId attribute are listed below.</summary>
