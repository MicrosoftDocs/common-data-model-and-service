---
title: PurchTableHistory_RU in Transaction - Common Data Model | Microsoft Docs
...
# Purchase order history in Transaction(PurchTableHistory_RU)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/Finance/AccountsPayable/Transaction/PurchTableHistory_RU.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[PurchTableHistory_RU/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Purchase order history</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="PurchTableHistory_RU.md" target="_blank">Transaction/PurchTableHistory_RU</a>|
|[AgreementHeaderExt_RU](#AgreementHeaderExt_RU)||<a href="PurchTableHistory_RU.md" target="_blank">Transaction/PurchTableHistory_RU</a>|
|[ConsigneeAccount_RU](#ConsigneeAccount_RU)||<a href="PurchTableHistory_RU.md" target="_blank">Transaction/PurchTableHistory_RU</a>|
|[ConsignorAccount_RU](#ConsignorAccount_RU)||<a href="PurchTableHistory_RU.md" target="_blank">Transaction/PurchTableHistory_RU</a>|
|[InventProfileId_RU](#InventProfileId_RU)||<a href="PurchTableHistory_RU.md" target="_blank">Transaction/PurchTableHistory_RU</a>|
|[InventProfileType_RU](#InventProfileType_RU)||<a href="PurchTableHistory_RU.md" target="_blank">Transaction/PurchTableHistory_RU</a>|
|[PriceAgreementDate_RU](#PriceAgreementDate_RU)||<a href="PurchTableHistory_RU.md" target="_blank">Transaction/PurchTableHistory_RU</a>|
|[PurchTableHistory](#PurchTableHistory)||<a href="PurchTableHistory_RU.md" target="_blank">Transaction/PurchTableHistory_RU</a>|
|[VATChargeSource_RU](#VATChargeSource_RU)||<a href="PurchTableHistory_RU.md" target="_blank">Transaction/PurchTableHistory_RU</a>|
|[VATOperationCode_RU](#VATOperationCode_RU)||<a href="PurchTableHistory_RU.md" target="_blank">Transaction/PurchTableHistory_RU</a>|
|[DataAreaId](#DataAreaId)||<a href="PurchTableHistory_RU.md" target="_blank">Transaction/PurchTableHistory_RU</a>|
|[Relationship_AgreementHeaderExt_RURelationshipId](#Relationship_AgreementHeaderExt_RURelationshipId)||<a href="PurchTableHistory_RU.md" target="_blank">Transaction/PurchTableHistory_RU</a>|
|[Relationship_CustTableRelationshipId](#Relationship_CustTableRelationshipId)||<a href="PurchTableHistory_RU.md" target="_blank">Transaction/PurchTableHistory_RU</a>|
|[Relationship_InventProfile_RURelationshipId](#Relationship_InventProfile_RURelationshipId)||<a href="PurchTableHistory_RU.md" target="_blank">Transaction/PurchTableHistory_RU</a>|
|[Relationship_PurchTableHistoryRelationshipId](#Relationship_PurchTableHistoryRelationshipId)||<a href="PurchTableHistory_RU.md" target="_blank">Transaction/PurchTableHistory_RU</a>|
|[Relationship_VATOperationCodeTable_RURelationshipId](#Relationship_VATOperationCodeTable_RURelationshipId)||<a href="PurchTableHistory_RU.md" target="_blank">Transaction/PurchTableHistory_RU</a>|
|[Relationship_VendTableRelationshipId](#Relationship_VendTableRelationshipId)||<a href="PurchTableHistory_RU.md" target="_blank">Transaction/PurchTableHistory_RU</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="PurchTableHistory_RU.md" target="_blank">Transaction/PurchTableHistory_RU</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Transaction/PurchTableHistory_RU (this entity)  
...
**means.identity.entityId**  
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="../../../SupplyChain/ProcurementAndSourcing/Transaction/PurchTableHistory.md" target="_blank">/core/operationsCommon/Tables/SupplyChain/ProcurementAndSourcing/Transaction/PurchTableHistory.cdm.json/PurchTableHistory</a></td><td><a href="../../../SupplyChain/ProcurementAndSourcing/Transaction/PurchTableHistory.md#RecId" target="_blank">RecId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
