---
title: PurchTable_RU in WorksheetHeader - Common Data Model | Microsoft Docs
...
# Purchase orders information for Russia in WorksheetHeader(PurchTable_RU)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/Finance/AccountsPayable/WorksheetHeader/PurchTable_RU.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[PurchTable_RU/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Purchase orders information for Russia</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="PurchTable_RU.md" target="_blank">WorksheetHeader/PurchTable_RU</a>|
|[AgreementHeaderExt_RU](#AgreementHeaderExt_RU)||<a href="PurchTable_RU.md" target="_blank">WorksheetHeader/PurchTable_RU</a>|
|[ConsigneeAccount_RU](#ConsigneeAccount_RU)||<a href="PurchTable_RU.md" target="_blank">WorksheetHeader/PurchTable_RU</a>|
|[ConsignorAccount_RU](#ConsignorAccount_RU)||<a href="PurchTable_RU.md" target="_blank">WorksheetHeader/PurchTable_RU</a>|
|[InventProfileId_RU](#InventProfileId_RU)||<a href="PurchTable_RU.md" target="_blank">WorksheetHeader/PurchTable_RU</a>|
|[InventProfileType_RU](#InventProfileType_RU)||<a href="PurchTable_RU.md" target="_blank">WorksheetHeader/PurchTable_RU</a>|
|[PriceAgreementDate_RU](#PriceAgreementDate_RU)||<a href="PurchTable_RU.md" target="_blank">WorksheetHeader/PurchTable_RU</a>|
|[PurchTable](#PurchTable)||<a href="PurchTable_RU.md" target="_blank">WorksheetHeader/PurchTable_RU</a>|
|[VATChargeSource_RU](#VATChargeSource_RU)||<a href="PurchTable_RU.md" target="_blank">WorksheetHeader/PurchTable_RU</a>|
|[VATOperationCode_RU](#VATOperationCode_RU)||<a href="PurchTable_RU.md" target="_blank">WorksheetHeader/PurchTable_RU</a>|
|[DataAreaId](#DataAreaId)||<a href="PurchTable_RU.md" target="_blank">WorksheetHeader/PurchTable_RU</a>|
|[Relationship_AgreementHeaderExt_RURelationshipId](#Relationship_AgreementHeaderExt_RURelationshipId)||<a href="PurchTable_RU.md" target="_blank">WorksheetHeader/PurchTable_RU</a>|
|[Relationship_InventProfile_RURelationshipId](#Relationship_InventProfile_RURelationshipId)||<a href="PurchTable_RU.md" target="_blank">WorksheetHeader/PurchTable_RU</a>|
|[Relationship_PurchTableRelationshipId](#Relationship_PurchTableRelationshipId)||<a href="PurchTable_RU.md" target="_blank">WorksheetHeader/PurchTable_RU</a>|
|[Relationship_VATOperationCodeTable_RURelationshipId](#Relationship_VATOperationCodeTable_RURelationshipId)||<a href="PurchTable_RU.md" target="_blank">WorksheetHeader/PurchTable_RU</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="PurchTable_RU.md" target="_blank">WorksheetHeader/PurchTable_RU</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: WorksheetHeader/PurchTable_RU (this entity)  
