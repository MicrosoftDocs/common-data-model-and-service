---
title: DimensionAttrValueLedgerOverride in Main - Common Data Model | Microsoft Docs
...
# Dimension code ledger override in Main(DimensionAttrValueLedgerOverride)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/Finance/FinancialDimensions/Main/DimensionAttrValueLedgerOverride.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[DimensionAttrValueLedgerOverride/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Dimension code ledger override</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="DimensionAttrValueLedgerOverride.md" target="_blank">Main/DimensionAttrValueLedgerOverride</a>|
|[ActiveFrom](#ActiveFrom)||<a href="DimensionAttrValueLedgerOverride.md" target="_blank">Main/DimensionAttrValueLedgerOverride</a>|
|[ActiveTo](#ActiveTo)||<a href="DimensionAttrValueLedgerOverride.md" target="_blank">Main/DimensionAttrValueLedgerOverride</a>|
|[DimensionAttributeValue](#DimensionAttributeValue)||<a href="DimensionAttrValueLedgerOverride.md" target="_blank">Main/DimensionAttrValueLedgerOverride</a>|
|[IsDateRangeOverriddenByUser](#IsDateRangeOverriddenByUser)||<a href="DimensionAttrValueLedgerOverride.md" target="_blank">Main/DimensionAttrValueLedgerOverride</a>|
|[IsOwnerOverriddenByUser](#IsOwnerOverriddenByUser)||<a href="DimensionAttrValueLedgerOverride.md" target="_blank">Main/DimensionAttrValueLedgerOverride</a>|
|[IsSuspended](#IsSuspended)||<a href="DimensionAttrValueLedgerOverride.md" target="_blank">Main/DimensionAttrValueLedgerOverride</a>|
|[IsSuspendedOverriddenByUser](#IsSuspendedOverriddenByUser)||<a href="DimensionAttrValueLedgerOverride.md" target="_blank">Main/DimensionAttrValueLedgerOverride</a>|
|[Ledger](#Ledger)||<a href="DimensionAttrValueLedgerOverride.md" target="_blank">Main/DimensionAttrValueLedgerOverride</a>|
|[Owner](#Owner)||<a href="DimensionAttrValueLedgerOverride.md" target="_blank">Main/DimensionAttrValueLedgerOverride</a>|
|[Relationship_DimensionAttributeValueRelationshipId](#Relationship_DimensionAttributeValueRelationshipId)||<a href="DimensionAttrValueLedgerOverride.md" target="_blank">Main/DimensionAttrValueLedgerOverride</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Main/DimensionAttrValueLedgerOverride (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Dimension value</td></tr><tr><td>dataFormat</td><td>int64</td></tr><tr><td>isNullable</td><td>true</td></tr></table>
