---
title: DimensionAttributeValueTotallingCriteria in Main - Common Data Model | Microsoft Docs
...
# From value in Main(DimensionAttributeValueTotallingCriteria)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/Finance/FinancialDimensions/Main/DimensionAttributeValueTotallingCriteria.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[DimensionAttributeValueTotallingCriteria/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="DimensionAttributeValueTotallingCriteria.md" target="_blank">Main/DimensionAttributeValueTotallingCriteria</a>|
|[DimensionAttributeValue](#DimensionAttributeValue)||<a href="DimensionAttributeValueTotallingCriteria.md" target="_blank">Main/DimensionAttributeValueTotallingCriteria</a>|
|[FromValue](#FromValue)||<a href="DimensionAttributeValueTotallingCriteria.md" target="_blank">Main/DimensionAttributeValueTotallingCriteria</a>|
|[InvertTotalSign](#InvertTotalSign)||<a href="DimensionAttributeValueTotallingCriteria.md" target="_blank">Main/DimensionAttributeValueTotallingCriteria</a>|
|[ToValue](#ToValue)||<a href="DimensionAttributeValueTotallingCriteria.md" target="_blank">Main/DimensionAttributeValueTotallingCriteria</a>|
|[Relationship_DimensionAttributeValueRelationshipId](#Relationship_DimensionAttributeValueRelationshipId)||<a href="DimensionAttributeValueTotallingCriteria.md" target="_blank">Main/DimensionAttributeValueTotallingCriteria</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Main/DimensionAttributeValueTotallingCriteria (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>From value</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>isNullable</td><td>true</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>To value</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>isNullable</td><td>true</td></tr></table>
