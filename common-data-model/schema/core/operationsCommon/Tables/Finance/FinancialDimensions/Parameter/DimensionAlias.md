---
title: DimensionAlias in Parameter - Common Data Model | Microsoft Docs
...
# Ledger account alias in Parameter(DimensionAlias)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/Finance/FinancialDimensions/Parameter/DimensionAlias.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[DimensionAlias/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="DimensionAlias.md" target="_blank">Parameter/DimensionAlias</a>|
|[AliasType](#AliasType)||<a href="DimensionAlias.md" target="_blank">Parameter/DimensionAlias</a>|
|[DimensionAttribute](#DimensionAttribute)||<a href="DimensionAlias.md" target="_blank">Parameter/DimensionAlias</a>|
|[DimensionAttributeValueCombination](#DimensionAttributeValueCombination)||<a href="DimensionAlias.md" target="_blank">Parameter/DimensionAlias</a>|
|[LegalEntity](#LegalEntity)||<a href="DimensionAlias.md" target="_blank">Parameter/DimensionAlias</a>|
|[Name](#Name)||<a href="DimensionAlias.md" target="_blank">Parameter/DimensionAlias</a>|
|[UserGroupInfo](#UserGroupInfo)||<a href="DimensionAlias.md" target="_blank">Parameter/DimensionAlias</a>|
|[UserInfo](#UserInfo)||<a href="DimensionAlias.md" target="_blank">Parameter/DimensionAlias</a>|
|[Relationship_CompanyInfoRelationshipId](#Relationship_CompanyInfoRelationshipId)||<a href="DimensionAlias.md" target="_blank">Parameter/DimensionAlias</a>|
|[Relationship_DimensionAttributeRelationshipId](#Relationship_DimensionAttributeRelationshipId)||<a href="DimensionAlias.md" target="_blank">Parameter/DimensionAlias</a>|
|[Relationship_DimensionAttributeValueCombinationRelationshipId](#Relationship_DimensionAttributeValueCombinationRelationshipId)||<a href="DimensionAlias.md" target="_blank">Parameter/DimensionAlias</a>|
|[Relationship_UserGroupRelationshipId](#Relationship_UserGroupRelationshipId)||<a href="DimensionAlias.md" target="_blank">Parameter/DimensionAlias</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Parameter/DimensionAlias (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Initial focus</td></tr><tr><td>dataFormat</td><td>int64</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Ledger account alias definition</td></tr><tr><td>dataFormat</td><td>int64</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Company</td></tr><tr><td>dataFormat</td><td>int64</td></tr></table>
