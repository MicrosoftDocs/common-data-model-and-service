---
title: DimensionHierarchyLevel in Group - Common Data Model | Microsoft Docs
...
# Dimension set level in Group(DimensionHierarchyLevel)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/Finance/FinancialDimensions/Group/DimensionHierarchyLevel.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[DimensionHierarchyLevel/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="DimensionHierarchyLevel.md" target="_blank">Group/DimensionHierarchyLevel</a>|
|[DimensionAttribute](#DimensionAttribute)||<a href="DimensionHierarchyLevel.md" target="_blank">Group/DimensionHierarchyLevel</a>|
|[DimensionHierarchy](#DimensionHierarchy)||<a href="DimensionHierarchyLevel.md" target="_blank">Group/DimensionHierarchyLevel</a>|
|[Level](#Level)||<a href="DimensionHierarchyLevel.md" target="_blank">Group/DimensionHierarchyLevel</a>|
|[TemporaryDimensionHierarchyLevel](#TemporaryDimensionHierarchyLevel)||<a href="DimensionHierarchyLevel.md" target="_blank">Group/DimensionHierarchyLevel</a>|
|[Relationship_DimensionAttributeRelationshipId](#Relationship_DimensionAttributeRelationshipId)||<a href="DimensionHierarchyLevel.md" target="_blank">Group/DimensionHierarchyLevel</a>|
|[Relationship_DimensionHierarchyRelationshipId](#Relationship_DimensionHierarchyRelationshipId)||<a href="DimensionHierarchyLevel.md" target="_blank">Group/DimensionHierarchyLevel</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Group/DimensionHierarchyLevel (this entity)  
...
### <a href=#TemporaryDimensionHierarchyLevel name="TemporaryDimensionHierarchyLevel">TemporaryDimensionHierarchyLevel</a>
...
<details>
<summary>List of traits for the TemporaryDimensionHierarchyLevel attribute are listed below.</summary>
