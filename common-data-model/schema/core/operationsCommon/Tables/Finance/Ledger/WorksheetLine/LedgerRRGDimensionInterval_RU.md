---
title: LedgerRRGDimensionInterval_RU in WorksheetLine - Common Data Model | Microsoft Docs
...
# Dimensions intervals for reports in WorksheetLine(LedgerRRGDimensionInterval_RU)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/Finance/Ledger/WorksheetLine/LedgerRRGDimensionInterval_RU.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[LedgerRRGDimensionInterval_RU/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Dimensions intervals for reports</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="LedgerRRGDimensionInterval_RU.md" target="_blank">WorksheetLine/LedgerRRGDimensionInterval_RU</a>|
|[DimensionAttribute](#DimensionAttribute)||<a href="LedgerRRGDimensionInterval_RU.md" target="_blank">WorksheetLine/LedgerRRGDimensionInterval_RU</a>|
|[DimensionFromValue](#DimensionFromValue)||<a href="LedgerRRGDimensionInterval_RU.md" target="_blank">WorksheetLine/LedgerRRGDimensionInterval_RU</a>|
|[DimensionToValue](#DimensionToValue)||<a href="LedgerRRGDimensionInterval_RU.md" target="_blank">WorksheetLine/LedgerRRGDimensionInterval_RU</a>|
|[DimRecID](#DimRecID)||<a href="LedgerRRGDimensionInterval_RU.md" target="_blank">WorksheetLine/LedgerRRGDimensionInterval_RU</a>|
|[DimTableID](#DimTableID)||<a href="LedgerRRGDimensionInterval_RU.md" target="_blank">WorksheetLine/LedgerRRGDimensionInterval_RU</a>|
|[DataAreaId](#DataAreaId)||<a href="LedgerRRGDimensionInterval_RU.md" target="_blank">WorksheetLine/LedgerRRGDimensionInterval_RU</a>|
|[Relationship_DimensionAttributeRelationshipId](#Relationship_DimensionAttributeRelationshipId)||<a href="LedgerRRGDimensionInterval_RU.md" target="_blank">WorksheetLine/LedgerRRGDimensionInterval_RU</a>|
|[Relationship_LedgerRRGCellTableRelationshipId](#Relationship_LedgerRRGCellTableRelationshipId)||<a href="LedgerRRGDimensionInterval_RU.md" target="_blank">WorksheetLine/LedgerRRGDimensionInterval_RU</a>|
|[Relationship_LedgerRRGEQueries_WRelationshipId](#Relationship_LedgerRRGEQueries_WRelationshipId)||<a href="LedgerRRGDimensionInterval_RU.md" target="_blank">WorksheetLine/LedgerRRGDimensionInterval_RU</a>|
|[Relationship_LedgerRRGOperationTableRelationshipId](#Relationship_LedgerRRGOperationTableRelationshipId)||<a href="LedgerRRGDimensionInterval_RU.md" target="_blank">WorksheetLine/LedgerRRGDimensionInterval_RU</a>|
|[Relationship_LedgerRRGReportTableRelationshipId](#Relationship_LedgerRRGReportTableRelationshipId)||<a href="LedgerRRGDimensionInterval_RU.md" target="_blank">WorksheetLine/LedgerRRGDimensionInterval_RU</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="LedgerRRGDimensionInterval_RU.md" target="_blank">WorksheetLine/LedgerRRGDimensionInterval_RU</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: WorksheetLine/LedgerRRGDimensionInterval_RU (this entity)  
