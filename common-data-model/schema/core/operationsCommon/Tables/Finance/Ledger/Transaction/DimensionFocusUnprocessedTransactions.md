---
title: DimensionFocusUnprocessedTransactions in Transaction - Common Data Model | Microsoft Docs
...
# Dimension set unprocessed transactions in Transaction(DimensionFocusUnprocessedTransactions)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/Finance/Ledger/Transaction/DimensionFocusUnprocessedTransactions.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[DimensionFocusUnprocessedTransactions/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="DimensionFocusUnprocessedTransactions.md" target="_blank">Transaction/DimensionFocusUnprocessedTransactions</a>|
|[FocusDimensionHierarchy](#FocusDimensionHierarchy)||<a href="DimensionFocusUnprocessedTransactions.md" target="_blank">Transaction/DimensionFocusUnprocessedTransactions</a>|
|[GeneralJournalEntry](#GeneralJournalEntry)||<a href="DimensionFocusUnprocessedTransactions.md" target="_blank">Transaction/DimensionFocusUnprocessedTransactions</a>|
|[State](#State)||<a href="DimensionFocusUnprocessedTransactions.md" target="_blank">Transaction/DimensionFocusUnprocessedTransactions</a>|
|[Relationship_FocusDimensionHierarchyRelationshipId](#Relationship_FocusDimensionHierarchyRelationshipId)||<a href="DimensionFocusUnprocessedTransactions.md" target="_blank">Transaction/DimensionFocusUnprocessedTransactions</a>|
|[Relationship_GeneralJournalEntryRelationshipId](#Relationship_GeneralJournalEntryRelationshipId)||<a href="DimensionFocusUnprocessedTransactions.md" target="_blank">Transaction/DimensionFocusUnprocessedTransactions</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Transaction/DimensionFocusUnprocessedTransactions (this entity)  
