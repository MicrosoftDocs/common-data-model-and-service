---
title: DimensionFocusBalanceSim_IT in Transaction - Common Data Model | Microsoft Docs
...
# Dimension set balance in Transaction(DimensionFocusBalanceSim_IT)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/Finance/Ledger/Transaction/DimensionFocusBalanceSim_IT.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[DimensionFocusBalanceSim_IT/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="DimensionFocusBalanceSim_IT.md" target="_blank">Transaction/DimensionFocusBalanceSim_IT</a>|
|[AccountingDate](#AccountingDate)||<a href="DimensionFocusBalanceSim_IT.md" target="_blank">Transaction/DimensionFocusBalanceSim_IT</a>|
|[CreditAccountingCurrencyAmount](#CreditAccountingCurrencyAmount)||<a href="DimensionFocusBalanceSim_IT.md" target="_blank">Transaction/DimensionFocusBalanceSim_IT</a>|
|[CreditReportingCurrencyAmount](#CreditReportingCurrencyAmount)||<a href="DimensionFocusBalanceSim_IT.md" target="_blank">Transaction/DimensionFocusBalanceSim_IT</a>|
|[DebitAccountingCurrencyAmount](#DebitAccountingCurrencyAmount)||<a href="DimensionFocusBalanceSim_IT.md" target="_blank">Transaction/DimensionFocusBalanceSim_IT</a>|
|[DebitReportingCurrencyAmount](#DebitReportingCurrencyAmount)||<a href="DimensionFocusBalanceSim_IT.md" target="_blank">Transaction/DimensionFocusBalanceSim_IT</a>|
|[FiscalCalendarPeriodType](#FiscalCalendarPeriodType)||<a href="DimensionFocusBalanceSim_IT.md" target="_blank">Transaction/DimensionFocusBalanceSim_IT</a>|
|[FocusDimensionHierarchy](#FocusDimensionHierarchy)||<a href="DimensionFocusBalanceSim_IT.md" target="_blank">Transaction/DimensionFocusBalanceSim_IT</a>|
|[FocusLedgerDimension](#FocusLedgerDimension)||<a href="DimensionFocusBalanceSim_IT.md" target="_blank">Transaction/DimensionFocusBalanceSim_IT</a>|
|[IsSystemGeneratedUltimo](#IsSystemGeneratedUltimo)||<a href="DimensionFocusBalanceSim_IT.md" target="_blank">Transaction/DimensionFocusBalanceSim_IT</a>|
|[Ledger](#Ledger)||<a href="DimensionFocusBalanceSim_IT.md" target="_blank">Transaction/DimensionFocusBalanceSim_IT</a>|
|[PostingLayer](#PostingLayer)||<a href="DimensionFocusBalanceSim_IT.md" target="_blank">Transaction/DimensionFocusBalanceSim_IT</a>|
|[Quantity](#Quantity)||<a href="DimensionFocusBalanceSim_IT.md" target="_blank">Transaction/DimensionFocusBalanceSim_IT</a>|
|[SimulationJournalNameId](#SimulationJournalNameId)||<a href="DimensionFocusBalanceSim_IT.md" target="_blank">Transaction/DimensionFocusBalanceSim_IT</a>|
|[Relationship_FocusDimensionHierarchyRelationshipId](#Relationship_FocusDimensionHierarchyRelationshipId)||<a href="DimensionFocusBalanceSim_IT.md" target="_blank">Transaction/DimensionFocusBalanceSim_IT</a>|
|[Relationship_LedgerRelationshipId](#Relationship_LedgerRelationshipId)||<a href="DimensionFocusBalanceSim_IT.md" target="_blank">Transaction/DimensionFocusBalanceSim_IT</a>|
|[Relationship_LedgerDimensionRelationshipId](#Relationship_LedgerDimensionRelationshipId)||<a href="DimensionFocusBalanceSim_IT.md" target="_blank">Transaction/DimensionFocusBalanceSim_IT</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Transaction/DimensionFocusBalanceSim_IT (this entity)  
