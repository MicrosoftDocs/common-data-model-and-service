---
title: InflationAdjJournal_MX in Transaction - Common Data Model | Microsoft Docs
...
# The InflationAdjJournal_MX table is used to track Inflation adjustment journal records in Transaction(InflationAdjJournal_MX)
