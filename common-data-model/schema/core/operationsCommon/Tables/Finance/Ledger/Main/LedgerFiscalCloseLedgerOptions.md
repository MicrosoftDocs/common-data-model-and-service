---
title: LedgerFiscalCloseLedgerOptions in Main - Common Data Model | Microsoft Docs
...
# Fiscal close ledger options in Main(LedgerFiscalCloseLedgerOptions)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/Finance/Ledger/Main/LedgerFiscalCloseLedgerOptions.cdm.json" target="_blank">GitHub</a>.  
