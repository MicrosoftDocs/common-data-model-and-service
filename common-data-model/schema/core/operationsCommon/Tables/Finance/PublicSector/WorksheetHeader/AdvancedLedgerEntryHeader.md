---
title: AdvancedLedgerEntryHeader - Common Data Model | Microsoft Docs
...
# AdvancedLedgerEntryHeader
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/Finance/PublicSector/WorksheetHeader/AdvancedLedgerEntryHeader.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[AdvancedLedgerEntryHeader/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="AdvancedLedgerEntryHeader.md" target="_blank">WorksheetHeader/AdvancedLedgerEntryHeader</a>|
|[AccountingDate](#AccountingDate)||<a href="AdvancedLedgerEntryHeader.md" target="_blank">WorksheetHeader/AdvancedLedgerEntryHeader</a>|
|[AccountingDistributionTemplate](#AccountingDistributionTemplate)||<a href="AdvancedLedgerEntryHeader.md" target="_blank">WorksheetHeader/AdvancedLedgerEntryHeader</a>|
|[DefaultDimension](#DefaultDimension)||<a href="AdvancedLedgerEntryHeader.md" target="_blank">WorksheetHeader/AdvancedLedgerEntryHeader</a>|
|[FiscalCalendarPeriod](#FiscalCalendarPeriod)||<a href="AdvancedLedgerEntryHeader.md" target="_blank">WorksheetHeader/AdvancedLedgerEntryHeader</a>|
|[JournalizingDefinition](#JournalizingDefinition)||<a href="AdvancedLedgerEntryHeader.md" target="_blank">WorksheetHeader/AdvancedLedgerEntryHeader</a>|
|[LedgerVoucher](#LedgerVoucher)||<a href="AdvancedLedgerEntryHeader.md" target="_blank">WorksheetHeader/AdvancedLedgerEntryHeader</a>|
|[ReasonTableRef](#ReasonTableRef)||<a href="AdvancedLedgerEntryHeader.md" target="_blank">WorksheetHeader/AdvancedLedgerEntryHeader</a>|
|[ReverseDate](#ReverseDate)||<a href="AdvancedLedgerEntryHeader.md" target="_blank">WorksheetHeader/AdvancedLedgerEntryHeader</a>|
|[ReverseEntry](#ReverseEntry)||<a href="AdvancedLedgerEntryHeader.md" target="_blank">WorksheetHeader/AdvancedLedgerEntryHeader</a>|
|[SourceDocumentHeader](#SourceDocumentHeader)||<a href="AdvancedLedgerEntryHeader.md" target="_blank">WorksheetHeader/AdvancedLedgerEntryHeader</a>|
|[TransactionCurrency](#TransactionCurrency)||<a href="AdvancedLedgerEntryHeader.md" target="_blank">WorksheetHeader/AdvancedLedgerEntryHeader</a>|
|[TransactionNumber](#TransactionNumber)||<a href="AdvancedLedgerEntryHeader.md" target="_blank">WorksheetHeader/AdvancedLedgerEntryHeader</a>|
|[TransactionStatus](#TransactionStatus)||<a href="AdvancedLedgerEntryHeader.md" target="_blank">WorksheetHeader/AdvancedLedgerEntryHeader</a>|
|[TransactionText](#TransactionText)||<a href="AdvancedLedgerEntryHeader.md" target="_blank">WorksheetHeader/AdvancedLedgerEntryHeader</a>|
|[WorkflowApprovalState](#WorkflowApprovalState)||<a href="AdvancedLedgerEntryHeader.md" target="_blank">WorksheetHeader/AdvancedLedgerEntryHeader</a>|
|[WorkFlowStatus](#WorkFlowStatus)||<a href="AdvancedLedgerEntryHeader.md" target="_blank">WorksheetHeader/AdvancedLedgerEntryHeader</a>|
|[PSNIsCorrection](#PSNIsCorrection)||<a href="AdvancedLedgerEntryHeader.md" target="_blank">WorksheetHeader/AdvancedLedgerEntryHeader</a>|
|[PSNDoUpdateBank](#PSNDoUpdateBank)||<a href="AdvancedLedgerEntryHeader.md" target="_blank">WorksheetHeader/AdvancedLedgerEntryHeader</a>|
|[PSNBankTransactionType](#PSNBankTransactionType)||<a href="AdvancedLedgerEntryHeader.md" target="_blank">WorksheetHeader/AdvancedLedgerEntryHeader</a>|
|[DataAreaId](#DataAreaId)||<a href="AdvancedLedgerEntryHeader.md" target="_blank">WorksheetHeader/AdvancedLedgerEntryHeader</a>|
|[Relationship_AccountingDistributionTemplateRelationshipId](#Relationship_AccountingDistributionTemplateRelationshipId)||<a href="AdvancedLedgerEntryHeader.md" target="_blank">WorksheetHeader/AdvancedLedgerEntryHeader</a>|
|[Relationship_CurrencyRelationshipId](#Relationship_CurrencyRelationshipId)||<a href="AdvancedLedgerEntryHeader.md" target="_blank">WorksheetHeader/AdvancedLedgerEntryHeader</a>|
|[Relationship_DefaultDimensionRelationshipId](#Relationship_DefaultDimensionRelationshipId)||<a href="AdvancedLedgerEntryHeader.md" target="_blank">WorksheetHeader/AdvancedLedgerEntryHeader</a>|
|[Relationship_FiscalCalendarPeriodRelationshipId](#Relationship_FiscalCalendarPeriodRelationshipId)||<a href="AdvancedLedgerEntryHeader.md" target="_blank">WorksheetHeader/AdvancedLedgerEntryHeader</a>|
|[Relationship_JournalizingDefinitionRelationshipId](#Relationship_JournalizingDefinitionRelationshipId)||<a href="AdvancedLedgerEntryHeader.md" target="_blank">WorksheetHeader/AdvancedLedgerEntryHeader</a>|
|[Relationship_ReasonTableRefRelationshipId](#Relationship_ReasonTableRefRelationshipId)||<a href="AdvancedLedgerEntryHeader.md" target="_blank">WorksheetHeader/AdvancedLedgerEntryHeader</a>|
|[Relationship_SourceDocumentHeaderRelationshipId](#Relationship_SourceDocumentHeaderRelationshipId)||<a href="AdvancedLedgerEntryHeader.md" target="_blank">WorksheetHeader/AdvancedLedgerEntryHeader</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="AdvancedLedgerEntryHeader.md" target="_blank">WorksheetHeader/AdvancedLedgerEntryHeader</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: WorksheetHeader/AdvancedLedgerEntryHeader (this entity)  
