---
title: NoSaleFiscalDocumentTransaction_BR in Transaction - Common Data Model | Microsoft Docs
...
# No-sales fiscal document in Transaction(NoSaleFiscalDocumentTransaction_BR)
...
**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>No-sales fiscal document</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
