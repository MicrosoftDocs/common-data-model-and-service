---
title: FBGeneralAdjustmentCodeLedger_BR in Miscellaneous - Common Data Model | Microsoft Docs
...
# General adjustment codes posting in Miscellaneous(FBGeneralAdjustmentCodeLedger_BR)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/Finance/FiscalBooksBrazil/Miscellaneous/FBGeneralAdjustmentCodeLedger_BR.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[FBGeneralAdjustmentCodeLedger_BR/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>General adjustment codes posting</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="FBGeneralAdjustmentCodeLedger_BR.md" target="_blank">Miscellaneous/FBGeneralAdjustmentCodeLedger_BR</a>|
|[Company](#Company)||<a href="FBGeneralAdjustmentCodeLedger_BR.md" target="_blank">Miscellaneous/FBGeneralAdjustmentCodeLedger_BR</a>|
|[FBGeneralAdjustmentCode_BR](#FBGeneralAdjustmentCode_BR)||<a href="FBGeneralAdjustmentCodeLedger_BR.md" target="_blank">Miscellaneous/FBGeneralAdjustmentCodeLedger_BR</a>|
|[LedgerDimension](#LedgerDimension)||<a href="FBGeneralAdjustmentCodeLedger_BR.md" target="_blank">Miscellaneous/FBGeneralAdjustmentCodeLedger_BR</a>|
|[TaxCode](#TaxCode)||<a href="FBGeneralAdjustmentCodeLedger_BR.md" target="_blank">Miscellaneous/FBGeneralAdjustmentCodeLedger_BR</a>|
|[Relationship_FBGeneralAdjustmentCode_BRRelationshipId](#Relationship_FBGeneralAdjustmentCode_BRRelationshipId)||<a href="FBGeneralAdjustmentCodeLedger_BR.md" target="_blank">Miscellaneous/FBGeneralAdjustmentCodeLedger_BR</a>|
|[Relationship_LedgerDimensionRelationshipId](#Relationship_LedgerDimensionRelationshipId)||<a href="FBGeneralAdjustmentCodeLedger_BR.md" target="_blank">Miscellaneous/FBGeneralAdjustmentCodeLedger_BR</a>|
|[Relationship_TaxTableRelationshipId](#Relationship_TaxTableRelationshipId)||<a href="FBGeneralAdjustmentCodeLedger_BR.md" target="_blank">Miscellaneous/FBGeneralAdjustmentCodeLedger_BR</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Miscellaneous/FBGeneralAdjustmentCodeLedger_BR (this entity)  
