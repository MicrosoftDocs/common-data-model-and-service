---
title: VendPaymSched - Common Data Model | Microsoft Docs
...
# Vendor payment schedule
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/Finance/Bank/Transaction/VendPaymSched.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[VendPaymSched/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="VendPaymSched.md" target="_blank">Transaction/VendPaymSched</a>|
|[AmountCur](#AmountCur)||<a href="VendPaymSched.md" target="_blank">Transaction/VendPaymSched</a>|
|[Description](#Description)||<a href="VendPaymSched.md" target="_blank">Transaction/VendPaymSched</a>|
|[ExtRecId](#ExtRecId)||<a href="VendPaymSched.md" target="_blank">Transaction/VendPaymSched</a>|
|[ExtTableId](#ExtTableId)||<a href="VendPaymSched.md" target="_blank">Transaction/VendPaymSched</a>|
|[IsDeleted](#IsDeleted)||<a href="VendPaymSched.md" target="_blank">Transaction/VendPaymSched</a>|
|[IsModified](#IsModified)||<a href="VendPaymSched.md" target="_blank">Transaction/VendPaymSched</a>|
|[LowestAmount](#LowestAmount)||<a href="VendPaymSched.md" target="_blank">Transaction/VendPaymSched</a>|
|[Name](#Name)||<a href="VendPaymSched.md" target="_blank">Transaction/VendPaymSched</a>|
|[Notes](#Notes)||<a href="VendPaymSched.md" target="_blank">Transaction/VendPaymSched</a>|
|[NumOfPayment](#NumOfPayment)||<a href="VendPaymSched.md" target="_blank">Transaction/VendPaymSched</a>|
|[PaymSchedBy](#PaymSchedBy)||<a href="VendPaymSched.md" target="_blank">Transaction/VendPaymSched</a>|
|[PeriodUnit](#PeriodUnit)||<a href="VendPaymSched.md" target="_blank">Transaction/VendPaymSched</a>|
|[QtyUnit](#QtyUnit)||<a href="VendPaymSched.md" target="_blank">Transaction/VendPaymSched</a>|
|[TaxDistribution](#TaxDistribution)||<a href="VendPaymSched.md" target="_blank">Transaction/VendPaymSched</a>|
|[PaymentType_ES](#PaymentType_ES)||<a href="VendPaymSched.md" target="_blank">Transaction/VendPaymSched</a>|
|[CopyPreciselyToInvoice](#CopyPreciselyToInvoice)||<a href="VendPaymSched.md" target="_blank">Transaction/VendPaymSched</a>|
|[DataAreaId](#DataAreaId)||<a href="VendPaymSched.md" target="_blank">Transaction/VendPaymSched</a>|
|[Relationship_BankPromissoryNoteTableRelationshipId](#Relationship_BankPromissoryNoteTableRelationshipId)||<a href="VendPaymSched.md" target="_blank">Transaction/VendPaymSched</a>|
|[Relationship_PaymSchedRelationshipId](#Relationship_PaymSchedRelationshipId)||<a href="VendPaymSched.md" target="_blank">Transaction/VendPaymSched</a>|
|[Relationship_PurchComplementaryInvoiceRelationshipId](#Relationship_PurchComplementaryInvoiceRelationshipId)||<a href="VendPaymSched.md" target="_blank">Transaction/VendPaymSched</a>|
|[Relationship_PurchParmTableRelationshipId](#Relationship_PurchParmTableRelationshipId)||<a href="VendPaymSched.md" target="_blank">Transaction/VendPaymSched</a>|
|[Relationship_PurchTableRelationshipId](#Relationship_PurchTableRelationshipId)||<a href="VendPaymSched.md" target="_blank">Transaction/VendPaymSched</a>|
|[Relationship_VendInvoiceInfoTableRelationshipId](#Relationship_VendInvoiceInfoTableRelationshipId)||<a href="VendPaymSched.md" target="_blank">Transaction/VendPaymSched</a>|
|[Relationship_VendInvoiceJourRelationshipId](#Relationship_VendInvoiceJourRelationshipId)||<a href="VendPaymSched.md" target="_blank">Transaction/VendPaymSched</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="VendPaymSched.md" target="_blank">Transaction/VendPaymSched</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Transaction/VendPaymSched (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Minimum</td></tr><tr><td>dataFormat</td><td>decimal</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Number of payments</td></tr><tr><td>dataFormat</td><td>int32</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Payment per</td></tr><tr><td>dataFormat</td><td>int32</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Copy payment schedule to invoice</td></tr><tr><td>dataFormat</td><td>int32</td></tr></table>
...
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="VendPromissoryNoteJour.md" target="_blank">/core/operationsCommon/Tables/Finance/Bank/Transaction/VendPromissoryNoteJour.cdm.json/VendPromissoryNoteJour</a></td><td><a href="VendPromissoryNoteJour.md#RecId" target="_blank">RecId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
...
### <a href=#Relationship_PurchComplementaryInvoiceRelationshipId name="Relationship_PurchComplementaryInvoiceRelationshipId">Relationship_PurchComplementaryInvoiceRelationshipId</a>
...
<details>
<summary>List of traits for the Relationship_PurchComplementaryInvoiceRelationshipId attribute are listed below.</summary>
