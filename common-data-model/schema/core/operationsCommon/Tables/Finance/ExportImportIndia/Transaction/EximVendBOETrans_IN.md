---
title: EximVendBOETrans_IN in Transaction - Common Data Model | Microsoft Docs
...
# Bill of entry lines in Transaction(EximVendBOETrans_IN)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/Finance/ExportImportIndia/Transaction/EximVendBOETrans_IN.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[EximVendBOETrans_IN/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="EximVendBOETrans_IN.md" target="_blank">Transaction/EximVendBOETrans_IN</a>|
|[AssessableValue](#AssessableValue)||<a href="EximVendBOETrans_IN.md" target="_blank">Transaction/EximVendBOETrans_IN</a>|
|[CustomsVendBOETransRecId](#CustomsVendBOETransRecId)||<a href="EximVendBOETrans_IN.md" target="_blank">Transaction/EximVendBOETrans_IN</a>|
|[EximIncentiveSchemeGroup](#EximIncentiveSchemeGroup)||<a href="EximVendBOETrans_IN.md" target="_blank">Transaction/EximVendBOETrans_IN</a>|
|[EximPorts](#EximPorts)||<a href="EximVendBOETrans_IN.md" target="_blank">Transaction/EximVendBOETrans_IN</a>|
|[EximProductGroupTable](#EximProductGroupTable)||<a href="EximVendBOETrans_IN.md" target="_blank">Transaction/EximVendBOETrans_IN</a>|
|[AssessableValueAccountingCurrency](#AssessableValueAccountingCurrency)||<a href="EximVendBOETrans_IN.md" target="_blank">Transaction/EximVendBOETrans_IN</a>|
|[DataAreaId](#DataAreaId)||<a href="EximVendBOETrans_IN.md" target="_blank">Transaction/EximVendBOETrans_IN</a>|
|[Relationship_CustomsVendBOETransRelationshipId](#Relationship_CustomsVendBOETransRelationshipId)||<a href="EximVendBOETrans_IN.md" target="_blank">Transaction/EximVendBOETrans_IN</a>|
|[Relationship_EximIncentiveSchemeGroupRelationshipId](#Relationship_EximIncentiveSchemeGroupRelationshipId)||<a href="EximVendBOETrans_IN.md" target="_blank">Transaction/EximVendBOETrans_IN</a>|
|[Relationship_EximPortsRelationshipId](#Relationship_EximPortsRelationshipId)||<a href="EximVendBOETrans_IN.md" target="_blank">Transaction/EximVendBOETrans_IN</a>|
|[Relationship_EximProductGroupTableRelationshipId](#Relationship_EximProductGroupTableRelationshipId)||<a href="EximVendBOETrans_IN.md" target="_blank">Transaction/EximVendBOETrans_IN</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="EximVendBOETrans_IN.md" target="_blank">Transaction/EximVendBOETrans_IN</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Transaction/EximVendBOETrans_IN (this entity)  
