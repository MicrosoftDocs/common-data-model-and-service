---
title: TradeBLWIJournalPurposeCodes in Transaction - Common Data Model | Microsoft Docs
...
# Journals linked with BLWI codes in Transaction(TradeBLWIJournalPurposeCodes)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/Finance/APARShared/Transaction/TradeBLWIJournalPurposeCodes.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[TradeBLWIJournalPurposeCodes/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Journals linked with BLWI codes</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="TradeBLWIJournalPurposeCodes.md" target="_blank">Transaction/TradeBLWIJournalPurposeCodes</a>|
|[PurposeCode](#PurposeCode)||<a href="TradeBLWIJournalPurposeCodes.md" target="_blank">Transaction/TradeBLWIJournalPurposeCodes</a>|
|[RefRecId](#RefRecId)||<a href="TradeBLWIJournalPurposeCodes.md" target="_blank">Transaction/TradeBLWIJournalPurposeCodes</a>|
|[TypeOfForm](#TypeOfForm)||<a href="TradeBLWIJournalPurposeCodes.md" target="_blank">Transaction/TradeBLWIJournalPurposeCodes</a>|
|[DataAreaId](#DataAreaId)||<a href="TradeBLWIJournalPurposeCodes.md" target="_blank">Transaction/TradeBLWIJournalPurposeCodes</a>|
|[Relationship_BankCentralBankPurposeRelationshipId](#Relationship_BankCentralBankPurposeRelationshipId)||<a href="TradeBLWIJournalPurposeCodes.md" target="_blank">Transaction/TradeBLWIJournalPurposeCodes</a>|
|[Relationship_CustFreeInvoiceRelationshipId](#Relationship_CustFreeInvoiceRelationshipId)||<a href="TradeBLWIJournalPurposeCodes.md" target="_blank">Transaction/TradeBLWIJournalPurposeCodes</a>|
|[Relationship_CustInvoiceJourRelationshipId](#Relationship_CustInvoiceJourRelationshipId)||<a href="TradeBLWIJournalPurposeCodes.md" target="_blank">Transaction/TradeBLWIJournalPurposeCodes</a>|
|[Relationship_CustTransRelationshipId](#Relationship_CustTransRelationshipId)||<a href="TradeBLWIJournalPurposeCodes.md" target="_blank">Transaction/TradeBLWIJournalPurposeCodes</a>|
|[Relationship_InvoiceRegisterRelationshipId](#Relationship_InvoiceRegisterRelationshipId)||<a href="TradeBLWIJournalPurposeCodes.md" target="_blank">Transaction/TradeBLWIJournalPurposeCodes</a>|
|[Relationship_LedgerJournalTransRelationshipId](#Relationship_LedgerJournalTransRelationshipId)||<a href="TradeBLWIJournalPurposeCodes.md" target="_blank">Transaction/TradeBLWIJournalPurposeCodes</a>|
|[Relationship_ProjInvoiceJourRelationshipId](#Relationship_ProjInvoiceJourRelationshipId)||<a href="TradeBLWIJournalPurposeCodes.md" target="_blank">Transaction/TradeBLWIJournalPurposeCodes</a>|
|[Relationship_ProjInvoiceTableRelationshipId](#Relationship_ProjInvoiceTableRelationshipId)||<a href="TradeBLWIJournalPurposeCodes.md" target="_blank">Transaction/TradeBLWIJournalPurposeCodes</a>|
|[Relationship_PurchTableRelationshipId](#Relationship_PurchTableRelationshipId)||<a href="TradeBLWIJournalPurposeCodes.md" target="_blank">Transaction/TradeBLWIJournalPurposeCodes</a>|
|[Relationship_SalesTableRelationshipId](#Relationship_SalesTableRelationshipId)||<a href="TradeBLWIJournalPurposeCodes.md" target="_blank">Transaction/TradeBLWIJournalPurposeCodes</a>|
|[Relationship_VendInvoiceJourRelationshipId](#Relationship_VendInvoiceJourRelationshipId)||<a href="TradeBLWIJournalPurposeCodes.md" target="_blank">Transaction/TradeBLWIJournalPurposeCodes</a>|
|[Relationship_VendTransRelationshipId](#Relationship_VendTransRelationshipId)||<a href="TradeBLWIJournalPurposeCodes.md" target="_blank">Transaction/TradeBLWIJournalPurposeCodes</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="TradeBLWIJournalPurposeCodes.md" target="_blank">Transaction/TradeBLWIJournalPurposeCodes</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Transaction/TradeBLWIJournalPurposeCodes (this entity)  
...
### <a href=#TypeOfForm name="TypeOfForm">TypeOfForm</a>
...
<details>
<summary>List of traits for the TypeOfForm attribute are listed below.</summary>
...
### <a href=#Relationship_CustFreeInvoiceRelationshipId name="Relationship_CustFreeInvoiceRelationshipId">Relationship_CustFreeInvoiceRelationshipId</a>
...
<details>
<summary>List of traits for the Relationship_CustFreeInvoiceRelationshipId attribute are listed below.</summary>
...
### <a href=#Relationship_InvoiceRegisterRelationshipId name="Relationship_InvoiceRegisterRelationshipId">Relationship_InvoiceRegisterRelationshipId</a>
...
<details>
<summary>List of traits for the Relationship_InvoiceRegisterRelationshipId attribute are listed below.</summary>
