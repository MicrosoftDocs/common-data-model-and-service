---
title: ExciseDSARegister_IN in Transaction - Common Data Model | Microsoft Docs
...
# Excise register balance in Transaction(ExciseDSARegister_IN)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/Finance/APARShared/Transaction/ExciseDSARegister_IN.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[ExciseDSARegister_IN/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="ExciseDSARegister_IN.md" target="_blank">Transaction/ExciseDSARegister_IN</a>|
|[ApplyExciseBalQty](#ApplyExciseBalQty)||<a href="ExciseDSARegister_IN.md" target="_blank">Transaction/ExciseDSARegister_IN</a>|
|[CustPackingSlipJour](#CustPackingSlipJour)||<a href="ExciseDSARegister_IN.md" target="_blank">Transaction/ExciseDSARegister_IN</a>|
|[DSADate](#DSADate)||<a href="ExciseDSARegister_IN.md" target="_blank">Transaction/ExciseDSARegister_IN</a>|
|[ExciseRecordType](#ExciseRecordType)||<a href="ExciseDSARegister_IN.md" target="_blank">Transaction/ExciseDSARegister_IN</a>|
|[InventTransId](#InventTransId)||<a href="ExciseDSARegister_IN.md" target="_blank">Transaction/ExciseDSARegister_IN</a>|
|[IsDestructiveQty](#IsDestructiveQty)||<a href="ExciseDSARegister_IN.md" target="_blank">Transaction/ExciseDSARegister_IN</a>|
|[IssueQty](#IssueQty)||<a href="ExciseDSARegister_IN.md" target="_blank">Transaction/ExciseDSARegister_IN</a>|
|[Item](#Item)||<a href="ExciseDSARegister_IN.md" target="_blank">Transaction/ExciseDSARegister_IN</a>|
|[ManufacturedQty](#ManufacturedQty)||<a href="ExciseDSARegister_IN.md" target="_blank">Transaction/ExciseDSARegister_IN</a>|
|[NumberSequence](#NumberSequence)||<a href="ExciseDSARegister_IN.md" target="_blank">Transaction/ExciseDSARegister_IN</a>|
|[PackingSlipVersion](#PackingSlipVersion)||<a href="ExciseDSARegister_IN.md" target="_blank">Transaction/ExciseDSARegister_IN</a>|
|[PostedDocumentLineRecId](#PostedDocumentLineRecId)||<a href="ExciseDSARegister_IN.md" target="_blank">Transaction/ExciseDSARegister_IN</a>|
|[PostedDocumentLineTableId](#PostedDocumentLineTableId)||<a href="ExciseDSARegister_IN.md" target="_blank">Transaction/ExciseDSARegister_IN</a>|
|[ReceiptQty](#ReceiptQty)||<a href="ExciseDSARegister_IN.md" target="_blank">Transaction/ExciseDSARegister_IN</a>|
|[RefRecId](#RefRecId)||<a href="ExciseDSARegister_IN.md" target="_blank">Transaction/ExciseDSARegister_IN</a>|
|[RefTableId](#RefTableId)||<a href="ExciseDSARegister_IN.md" target="_blank">Transaction/ExciseDSARegister_IN</a>|
|[TaxAmount](#TaxAmount)||<a href="ExciseDSARegister_IN.md" target="_blank">Transaction/ExciseDSARegister_IN</a>|
|[TaxCode](#TaxCode)||<a href="ExciseDSARegister_IN.md" target="_blank">Transaction/ExciseDSARegister_IN</a>|
|[TaxComponentTable](#TaxComponentTable)||<a href="ExciseDSARegister_IN.md" target="_blank">Transaction/ExciseDSARegister_IN</a>|
|[TaxRegistrationNumberTable](#TaxRegistrationNumberTable)||<a href="ExciseDSARegister_IN.md" target="_blank">Transaction/ExciseDSARegister_IN</a>|
|[TaxTrans_IN](#TaxTrans_IN)||<a href="ExciseDSARegister_IN.md" target="_blank">Transaction/ExciseDSARegister_IN</a>|
|[TransRecId](#TransRecId)||<a href="ExciseDSARegister_IN.md" target="_blank">Transaction/ExciseDSARegister_IN</a>|
|[DataAreaId](#DataAreaId)||<a href="ExciseDSARegister_IN.md" target="_blank">Transaction/ExciseDSARegister_IN</a>|
|[Relationship_CustPackingSlipJourRelationshipId](#Relationship_CustPackingSlipJourRelationshipId)||<a href="ExciseDSARegister_IN.md" target="_blank">Transaction/ExciseDSARegister_IN</a>|
|[Relationship_InventTableRelationshipId](#Relationship_InventTableRelationshipId)||<a href="ExciseDSARegister_IN.md" target="_blank">Transaction/ExciseDSARegister_IN</a>|
|[Relationship_TaxComponentTableRelationshipId](#Relationship_TaxComponentTableRelationshipId)||<a href="ExciseDSARegister_IN.md" target="_blank">Transaction/ExciseDSARegister_IN</a>|
|[Relationship_TaxRegistrationNumberTableRelationshipId](#Relationship_TaxRegistrationNumberTableRelationshipId)||<a href="ExciseDSARegister_IN.md" target="_blank">Transaction/ExciseDSARegister_IN</a>|
|[Relationship_TaxTableRelationshipId](#Relationship_TaxTableRelationshipId)||<a href="ExciseDSARegister_IN.md" target="_blank">Transaction/ExciseDSARegister_IN</a>|
|[Relationship_TaxTransRelationshipId](#Relationship_TaxTransRelationshipId)||<a href="ExciseDSARegister_IN.md" target="_blank">Transaction/ExciseDSARegister_IN</a>|
|[Relationship_TaxTrans_INRelationshipId](#Relationship_TaxTrans_INRelationshipId)||<a href="ExciseDSARegister_IN.md" target="_blank">Transaction/ExciseDSARegister_IN</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="ExciseDSARegister_IN.md" target="_blank">Transaction/ExciseDSARegister_IN</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Transaction/ExciseDSARegister_IN (this entity)  
...
### <a href=#DSADate name="DSADate">DSADate</a>
...
<details>
<summary>List of traits for the DSADate attribute are listed below.</summary>
...
### <a href=#ManufacturedQty name="ManufacturedQty">ManufacturedQty</a>

First included in: Transaction/ExciseDSARegister_IN (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Manufactured quantity</td></tr><tr><td>dataFormat</td><td>decimal</td></tr><tr><td>isNullable</td><td>true</td></tr></table>

#### Traits

<details>
<summary>List of traits for the ManufacturedQty attribute are listed below.</summary>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Manufactured quantity</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>RG23D ID</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>isNullable</td><td>true</td></tr></table>
