---
title: ExciseRG23ARegister_IN in Transaction - Common Data Model | Microsoft Docs
...
# Excise register balance in Transaction(ExciseRG23ARegister_IN)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/Finance/APARShared/Transaction/ExciseRG23ARegister_IN.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[ExciseRG23ARegister_IN/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="ExciseRG23ARegister_IN.md" target="_blank">Transaction/ExciseRG23ARegister_IN</a>|
|[CustVendPackingSlipJour](#CustVendPackingSlipJour)||<a href="ExciseRG23ARegister_IN.md" target="_blank">Transaction/ExciseRG23ARegister_IN</a>|
|[ExciseRecordType](#ExciseRecordType)||<a href="ExciseRG23ARegister_IN.md" target="_blank">Transaction/ExciseRG23ARegister_IN</a>|
|[InventTransId](#InventTransId)||<a href="ExciseRG23ARegister_IN.md" target="_blank">Transaction/ExciseRG23ARegister_IN</a>|
|[IsDestructiveQty](#IsDestructiveQty)||<a href="ExciseRG23ARegister_IN.md" target="_blank">Transaction/ExciseRG23ARegister_IN</a>|
|[Item](#Item)||<a href="ExciseRG23ARegister_IN.md" target="_blank">Transaction/ExciseRG23ARegister_IN</a>|
|[NumberSequence](#NumberSequence)||<a href="ExciseRG23ARegister_IN.md" target="_blank">Transaction/ExciseRG23ARegister_IN</a>|
|[PackingSlipVersion](#PackingSlipVersion)||<a href="ExciseRG23ARegister_IN.md" target="_blank">Transaction/ExciseRG23ARegister_IN</a>|
|[PostedDocumentLineRecId](#PostedDocumentLineRecId)||<a href="ExciseRG23ARegister_IN.md" target="_blank">Transaction/ExciseRG23ARegister_IN</a>|
|[PostedDocumentLineTableId](#PostedDocumentLineTableId)||<a href="ExciseRG23ARegister_IN.md" target="_blank">Transaction/ExciseRG23ARegister_IN</a>|
|[Qty](#Qty)||<a href="ExciseRG23ARegister_IN.md" target="_blank">Transaction/ExciseRG23ARegister_IN</a>|
|[ReceiptQty](#ReceiptQty)||<a href="ExciseRG23ARegister_IN.md" target="_blank">Transaction/ExciseRG23ARegister_IN</a>|
|[RefRecID](#RefRecID)||<a href="ExciseRG23ARegister_IN.md" target="_blank">Transaction/ExciseRG23ARegister_IN</a>|
|[RefTableId](#RefTableId)||<a href="ExciseRG23ARegister_IN.md" target="_blank">Transaction/ExciseRG23ARegister_IN</a>|
|[RG23ADeferredBal](#RG23ADeferredBal)||<a href="ExciseRG23ARegister_IN.md" target="_blank">Transaction/ExciseRG23ARegister_IN</a>|
|[RG23APayable](#RG23APayable)||<a href="ExciseRG23ARegister_IN.md" target="_blank">Transaction/ExciseRG23ARegister_IN</a>|
|[RG23ARecoverable](#RG23ARecoverable)||<a href="ExciseRG23ARegister_IN.md" target="_blank">Transaction/ExciseRG23ARegister_IN</a>|
|[RGDate](#RGDate)||<a href="ExciseRG23ARegister_IN.md" target="_blank">Transaction/ExciseRG23ARegister_IN</a>|
|[TaxCode](#TaxCode)||<a href="ExciseRG23ARegister_IN.md" target="_blank">Transaction/ExciseRG23ARegister_IN</a>|
|[TaxComponentTable](#TaxComponentTable)||<a href="ExciseRG23ARegister_IN.md" target="_blank">Transaction/ExciseRG23ARegister_IN</a>|
|[TaxRegistrationNumberTable](#TaxRegistrationNumberTable)||<a href="ExciseRG23ARegister_IN.md" target="_blank">Transaction/ExciseRG23ARegister_IN</a>|
|[TaxTrans_IN](#TaxTrans_IN)||<a href="ExciseRG23ARegister_IN.md" target="_blank">Transaction/ExciseRG23ARegister_IN</a>|
|[TransRecId](#TransRecId)||<a href="ExciseRG23ARegister_IN.md" target="_blank">Transaction/ExciseRG23ARegister_IN</a>|
|[DataAreaId](#DataAreaId)||<a href="ExciseRG23ARegister_IN.md" target="_blank">Transaction/ExciseRG23ARegister_IN</a>|
|[Relationship_InventTableRelationshipId](#Relationship_InventTableRelationshipId)||<a href="ExciseRG23ARegister_IN.md" target="_blank">Transaction/ExciseRG23ARegister_IN</a>|
|[Relationship_TaxComponentTableRelationshipId](#Relationship_TaxComponentTableRelationshipId)||<a href="ExciseRG23ARegister_IN.md" target="_blank">Transaction/ExciseRG23ARegister_IN</a>|
|[Relationship_TaxRegistrationNumberTableRelationshipId](#Relationship_TaxRegistrationNumberTableRelationshipId)||<a href="ExciseRG23ARegister_IN.md" target="_blank">Transaction/ExciseRG23ARegister_IN</a>|
|[Relationship_TaxTableRelationshipId](#Relationship_TaxTableRelationshipId)||<a href="ExciseRG23ARegister_IN.md" target="_blank">Transaction/ExciseRG23ARegister_IN</a>|
|[Relationship_TaxTransRelationshipId](#Relationship_TaxTransRelationshipId)||<a href="ExciseRG23ARegister_IN.md" target="_blank">Transaction/ExciseRG23ARegister_IN</a>|
|[Relationship_TaxTrans_INRelationshipId](#Relationship_TaxTrans_INRelationshipId)||<a href="ExciseRG23ARegister_IN.md" target="_blank">Transaction/ExciseRG23ARegister_IN</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="ExciseRG23ARegister_IN.md" target="_blank">Transaction/ExciseRG23ARegister_IN</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Transaction/ExciseRG23ARegister_IN (this entity)  
...
### <a href=#RG23ADeferredBal name="RG23ADeferredBal">RG23ADeferredBal</a>

First included in: Transaction/ExciseRG23ARegister_IN (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>RG23A deferred balance</td></tr><tr><td>dataFormat</td><td>decimal</td></tr><tr><td>isNullable</td><td>true</td></tr></table>

#### Traits

<details>
<summary>List of traits for the RG23ADeferredBal attribute are listed below.</summary>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>RG23A deferred balance</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
