---
title: DIOTAddlInfoForNoVendorProj_MX in Transaction - Common Data Model | Microsoft Docs
...
# DIOT additional information for no vendor in Transaction(DIOTAddlInfoForNoVendorProj_MX)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/Finance/APARShared/Transaction/DIOTAddlInfoForNoVendorProj_MX.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[DIOTAddlInfoForNoVendorProj_MX/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="DIOTAddlInfoForNoVendorProj_MX.md" target="_blank">Transaction/DIOTAddlInfoForNoVendorProj_MX</a>|
|[Curp](#Curp)||<a href="DIOTAddlInfoForNoVendorProj_MX.md" target="_blank">Transaction/DIOTAddlInfoForNoVendorProj_MX</a>|
|[DiotCountryCode](#DiotCountryCode)||<a href="DIOTAddlInfoForNoVendorProj_MX.md" target="_blank">Transaction/DIOTAddlInfoForNoVendorProj_MX</a>|
|[ForeignTaxRegistration](#ForeignTaxRegistration)||<a href="DIOTAddlInfoForNoVendorProj_MX.md" target="_blank">Transaction/DIOTAddlInfoForNoVendorProj_MX</a>|
|[InstanceRelationType](#InstanceRelationType)||<a href="DIOTAddlInfoForNoVendorProj_MX.md" target="_blank">Transaction/DIOTAddlInfoForNoVendorProj_MX</a>|
|[Name](#Name)||<a href="DIOTAddlInfoForNoVendorProj_MX.md" target="_blank">Transaction/DIOTAddlInfoForNoVendorProj_MX</a>|
|[Nationality](#Nationality)||<a href="DIOTAddlInfoForNoVendorProj_MX.md" target="_blank">Transaction/DIOTAddlInfoForNoVendorProj_MX</a>|
|[Rfc](#Rfc)||<a href="DIOTAddlInfoForNoVendorProj_MX.md" target="_blank">Transaction/DIOTAddlInfoForNoVendorProj_MX</a>|
|[VendorType](#VendorType)||<a href="DIOTAddlInfoForNoVendorProj_MX.md" target="_blank">Transaction/DIOTAddlInfoForNoVendorProj_MX</a>|
|[DataAreaId](#DataAreaId)||<a href="DIOTAddlInfoForNoVendorProj_MX.md" target="_blank">Transaction/DIOTAddlInfoForNoVendorProj_MX</a>|
|[Relationship_LogisticsAddressCountryRegionRelationshipId](#Relationship_LogisticsAddressCountryRegionRelationshipId)||<a href="DIOTAddlInfoForNoVendorProj_MX.md" target="_blank">Transaction/DIOTAddlInfoForNoVendorProj_MX</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="DIOTAddlInfoForNoVendorProj_MX.md" target="_blank">Transaction/DIOTAddlInfoForNoVendorProj_MX</a>|
|[ProjJournalTrans](#ProjJournalTrans)||<a href="DIOTAddlInfoForNoVendorProj_MX.md" target="_blank">Transaction/DIOTAddlInfoForNoVendorProj_MX</a>|
|[Relationship_ProjJournalTransRelationshipId](#Relationship_ProjJournalTransRelationshipId)||<a href="DIOTAddlInfoForNoVendorProj_MX.md" target="_blank">Transaction/DIOTAddlInfoForNoVendorProj_MX</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Transaction/DIOTAddlInfoForNoVendorProj_MX (this entity)  
