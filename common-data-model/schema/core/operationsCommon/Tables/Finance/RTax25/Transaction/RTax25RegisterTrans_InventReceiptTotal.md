---
title: RTax25RegisterTrans_InventReceiptTotal in Transaction - Common Data Model | Microsoft Docs
...
# Tax register line in Transaction(RTax25RegisterTrans_InventReceiptTotal)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/Finance/RTax25/Transaction/RTax25RegisterTrans_InventReceiptTotal.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[RTax25RegisterTrans_InventReceiptTotal/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="RTax25RegisterTrans_InventReceiptTotal.md" target="_blank">Transaction/RTax25RegisterTrans_InventReceiptTotal</a>|
|[BlockType](#BlockType)||<a href="RTax25RegisterTrans_InventReceiptTotal.md" target="_blank">Transaction/RTax25RegisterTrans_InventReceiptTotal</a>|
|[Corrected](#Corrected)||<a href="RTax25RegisterTrans_InventReceiptTotal.md" target="_blank">Transaction/RTax25RegisterTrans_InventReceiptTotal</a>|
|[Expense](#Expense)||<a href="RTax25RegisterTrans_InventReceiptTotal.md" target="_blank">Transaction/RTax25RegisterTrans_InventReceiptTotal</a>|
|[IssuedValue](#IssuedValue)||<a href="RTax25RegisterTrans_InventReceiptTotal.md" target="_blank">Transaction/RTax25RegisterTrans_InventReceiptTotal</a>|
|[JournalTransRefRecId](#JournalTransRefRecId)||<a href="RTax25RegisterTrans_InventReceiptTotal.md" target="_blank">Transaction/RTax25RegisterTrans_InventReceiptTotal</a>|
|[LineDescription](#LineDescription)||<a href="RTax25RegisterTrans_InventReceiptTotal.md" target="_blank">Transaction/RTax25RegisterTrans_InventReceiptTotal</a>|
|[LineNumber](#LineNumber)||<a href="RTax25RegisterTrans_InventReceiptTotal.md" target="_blank">Transaction/RTax25RegisterTrans_InventReceiptTotal</a>|
|[ManualInput](#ManualInput)||<a href="RTax25RegisterTrans_InventReceiptTotal.md" target="_blank">Transaction/RTax25RegisterTrans_InventReceiptTotal</a>|
|[ProfitAmount](#ProfitAmount)||<a href="RTax25RegisterTrans_InventReceiptTotal.md" target="_blank">Transaction/RTax25RegisterTrans_InventReceiptTotal</a>|
|[ReceiptValue](#ReceiptValue)||<a href="RTax25RegisterTrans_InventReceiptTotal.md" target="_blank">Transaction/RTax25RegisterTrans_InventReceiptTotal</a>|
|[RefRecId](#RefRecId)||<a href="RTax25RegisterTrans_InventReceiptTotal.md" target="_blank">Transaction/RTax25RegisterTrans_InventReceiptTotal</a>|
|[RefTableId](#RefTableId)||<a href="RTax25RegisterTrans_InventReceiptTotal.md" target="_blank">Transaction/RTax25RegisterTrans_InventReceiptTotal</a>|
|[RTax25ProfitTable](#RTax25ProfitTable)||<a href="RTax25RegisterTrans_InventReceiptTotal.md" target="_blank">Transaction/RTax25RegisterTrans_InventReceiptTotal</a>|
|[DataAreaId](#DataAreaId)||<a href="RTax25RegisterTrans_InventReceiptTotal.md" target="_blank">Transaction/RTax25RegisterTrans_InventReceiptTotal</a>|
|[Relationship_InventTransRelationshipId](#Relationship_InventTransRelationshipId)||<a href="RTax25RegisterTrans_InventReceiptTotal.md" target="_blank">Transaction/RTax25RegisterTrans_InventReceiptTotal</a>|
|[Relationship_RTax25ProfitTableRelationshipId](#Relationship_RTax25ProfitTableRelationshipId)||<a href="RTax25RegisterTrans_InventReceiptTotal.md" target="_blank">Transaction/RTax25RegisterTrans_InventReceiptTotal</a>|
|[Relationship_RTax25RegisterJournalTransRecIdRelationshipId](#Relationship_RTax25RegisterJournalTransRecIdRelationshipId)||<a href="RTax25RegisterTrans_InventReceiptTotal.md" target="_blank">Transaction/RTax25RegisterTrans_InventReceiptTotal</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="RTax25RegisterTrans_InventReceiptTotal.md" target="_blank">Transaction/RTax25RegisterTrans_InventReceiptTotal</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Transaction/RTax25RegisterTrans_InventReceiptTotal (this entity)  
...
### <a href=#Expense name="Expense">Expense</a>
...
<details>
<summary>List of traits for the Expense attribute are listed below.</summary>
...
### <a href=#IssuedValue name="IssuedValue">IssuedValue</a>
...
<details>
<summary>List of traits for the IssuedValue attribute are listed below.</summary>
...
### <a href=#ReceiptValue name="ReceiptValue">ReceiptValue</a>
...
<details>
<summary>List of traits for the ReceiptValue attribute are listed below.</summary>
