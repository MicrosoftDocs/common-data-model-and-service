---
title: RTax25RegisterTrans_DebtDebitInventory in Transaction - Common Data Model | Microsoft Docs
...
# Tax register line in Transaction(RTax25RegisterTrans_DebtDebitInventory)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/Finance/RTax25/Transaction/RTax25RegisterTrans_DebtDebitInventory.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[RTax25RegisterTrans_DebtDebitInventory/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="RTax25RegisterTrans_DebtDebitInventory.md" target="_blank">Transaction/RTax25RegisterTrans_DebtDebitInventory</a>|
|[AccountingObject](#AccountingObject)||<a href="RTax25RegisterTrans_DebtDebitInventory.md" target="_blank">Transaction/RTax25RegisterTrans_DebtDebitInventory</a>|
|[BlockType](#BlockType)||<a href="RTax25RegisterTrans_DebtDebitInventory.md" target="_blank">Transaction/RTax25RegisterTrans_DebtDebitInventory</a>|
|[Corrected](#Corrected)||<a href="RTax25RegisterTrans_DebtDebitInventory.md" target="_blank">Transaction/RTax25RegisterTrans_DebtDebitInventory</a>|
|[DeadLine](#DeadLine)||<a href="RTax25RegisterTrans_DebtDebitInventory.md" target="_blank">Transaction/RTax25RegisterTrans_DebtDebitInventory</a>|
|[Debt0_45](#Debt0_45)||<a href="RTax25RegisterTrans_DebtDebitInventory.md" target="_blank">Transaction/RTax25RegisterTrans_DebtDebitInventory</a>|
|[Debt45_90](#Debt45_90)||<a href="RTax25RegisterTrans_DebtDebitInventory.md" target="_blank">Transaction/RTax25RegisterTrans_DebtDebitInventory</a>|
|[Debt90_240](#Debt90_240)||<a href="RTax25RegisterTrans_DebtDebitInventory.md" target="_blank">Transaction/RTax25RegisterTrans_DebtDebitInventory</a>|
|[Hopeless](#Hopeless)||<a href="RTax25RegisterTrans_DebtDebitInventory.md" target="_blank">Transaction/RTax25RegisterTrans_DebtDebitInventory</a>|
|[JournalTransRefRecId](#JournalTransRefRecId)||<a href="RTax25RegisterTrans_DebtDebitInventory.md" target="_blank">Transaction/RTax25RegisterTrans_DebtDebitInventory</a>|
|[LineDescription](#LineDescription)||<a href="RTax25RegisterTrans_DebtDebitInventory.md" target="_blank">Transaction/RTax25RegisterTrans_DebtDebitInventory</a>|
|[LineNumber](#LineNumber)||<a href="RTax25RegisterTrans_DebtDebitInventory.md" target="_blank">Transaction/RTax25RegisterTrans_DebtDebitInventory</a>|
|[ManualInput](#ManualInput)||<a href="RTax25RegisterTrans_DebtDebitInventory.md" target="_blank">Transaction/RTax25RegisterTrans_DebtDebitInventory</a>|
|[NonConfirmedDebt](#NonConfirmedDebt)||<a href="RTax25RegisterTrans_DebtDebitInventory.md" target="_blank">Transaction/RTax25RegisterTrans_DebtDebitInventory</a>|
|[ProfitAmount](#ProfitAmount)||<a href="RTax25RegisterTrans_DebtDebitInventory.md" target="_blank">Transaction/RTax25RegisterTrans_DebtDebitInventory</a>|
|[RefRecId](#RefRecId)||<a href="RTax25RegisterTrans_DebtDebitInventory.md" target="_blank">Transaction/RTax25RegisterTrans_DebtDebitInventory</a>|
|[RefTableId](#RefTableId)||<a href="RTax25RegisterTrans_DebtDebitInventory.md" target="_blank">Transaction/RTax25RegisterTrans_DebtDebitInventory</a>|
|[RTax25ProfitTable](#RTax25ProfitTable)||<a href="RTax25RegisterTrans_DebtDebitInventory.md" target="_blank">Transaction/RTax25RegisterTrans_DebtDebitInventory</a>|
|[TransactionDate](#TransactionDate)||<a href="RTax25RegisterTrans_DebtDebitInventory.md" target="_blank">Transaction/RTax25RegisterTrans_DebtDebitInventory</a>|
|[DebtReserved](#DebtReserved)||<a href="RTax25RegisterTrans_DebtDebitInventory.md" target="_blank">Transaction/RTax25RegisterTrans_DebtDebitInventory</a>|
|[ExcludeReserveCalc](#ExcludeReserveCalc)||<a href="RTax25RegisterTrans_DebtDebitInventory.md" target="_blank">Transaction/RTax25RegisterTrans_DebtDebitInventory</a>|
|[DataAreaId](#DataAreaId)||<a href="RTax25RegisterTrans_DebtDebitInventory.md" target="_blank">Transaction/RTax25RegisterTrans_DebtDebitInventory</a>|
|[Relationship_CustTransRelationshipId](#Relationship_CustTransRelationshipId)||<a href="RTax25RegisterTrans_DebtDebitInventory.md" target="_blank">Transaction/RTax25RegisterTrans_DebtDebitInventory</a>|
|[Relationship_RTax25ProfitTableRelationshipId](#Relationship_RTax25ProfitTableRelationshipId)||<a href="RTax25RegisterTrans_DebtDebitInventory.md" target="_blank">Transaction/RTax25RegisterTrans_DebtDebitInventory</a>|
|[Relationship_RTax25RegisterJournalTransRecIdRelationshipId](#Relationship_RTax25RegisterJournalTransRecIdRelationshipId)||<a href="RTax25RegisterTrans_DebtDebitInventory.md" target="_blank">Transaction/RTax25RegisterTrans_DebtDebitInventory</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="RTax25RegisterTrans_DebtDebitInventory.md" target="_blank">Transaction/RTax25RegisterTrans_DebtDebitInventory</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Transaction/RTax25RegisterTrans_DebtDebitInventory (this entity)  
