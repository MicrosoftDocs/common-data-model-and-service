---
title: RTax25RegisterTrans_NotInfluenceIncome - Common Data Model | Microsoft Docs
...
# Tax register line
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/Finance/RTax25/Transaction/RTax25RegisterTrans_NotInfluenceIncome.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[RTax25RegisterTrans_NotInfluenceIncome/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="RTax25RegisterTrans_NotInfluenceIncome.md" target="_blank">Transaction/RTax25RegisterTrans_NotInfluenceIncome</a>|
|[AccountObject](#AccountObject)||<a href="RTax25RegisterTrans_NotInfluenceIncome.md" target="_blank">Transaction/RTax25RegisterTrans_NotInfluenceIncome</a>|
|[BlockType](#BlockType)||<a href="RTax25RegisterTrans_NotInfluenceIncome.md" target="_blank">Transaction/RTax25RegisterTrans_NotInfluenceIncome</a>|
|[Corrected](#Corrected)||<a href="RTax25RegisterTrans_NotInfluenceIncome.md" target="_blank">Transaction/RTax25RegisterTrans_NotInfluenceIncome</a>|
|[CTAAmount](#CTAAmount)||<a href="RTax25RegisterTrans_NotInfluenceIncome.md" target="_blank">Transaction/RTax25RegisterTrans_NotInfluenceIncome</a>|
|[CTLAmount](#CTLAmount)||<a href="RTax25RegisterTrans_NotInfluenceIncome.md" target="_blank">Transaction/RTax25RegisterTrans_NotInfluenceIncome</a>|
|[ExpenseIncomeType](#ExpenseIncomeType)||<a href="RTax25RegisterTrans_NotInfluenceIncome.md" target="_blank">Transaction/RTax25RegisterTrans_NotInfluenceIncome</a>|
|[IncomeAmount](#IncomeAmount)||<a href="RTax25RegisterTrans_NotInfluenceIncome.md" target="_blank">Transaction/RTax25RegisterTrans_NotInfluenceIncome</a>|
|[IssueAmount](#IssueAmount)||<a href="RTax25RegisterTrans_NotInfluenceIncome.md" target="_blank">Transaction/RTax25RegisterTrans_NotInfluenceIncome</a>|
|[JournalTransRefRecId](#JournalTransRefRecId)||<a href="RTax25RegisterTrans_NotInfluenceIncome.md" target="_blank">Transaction/RTax25RegisterTrans_NotInfluenceIncome</a>|
|[LineDescription](#LineDescription)||<a href="RTax25RegisterTrans_NotInfluenceIncome.md" target="_blank">Transaction/RTax25RegisterTrans_NotInfluenceIncome</a>|
|[LineNumber](#LineNumber)||<a href="RTax25RegisterTrans_NotInfluenceIncome.md" target="_blank">Transaction/RTax25RegisterTrans_NotInfluenceIncome</a>|
|[ManualInput](#ManualInput)||<a href="RTax25RegisterTrans_NotInfluenceIncome.md" target="_blank">Transaction/RTax25RegisterTrans_NotInfluenceIncome</a>|
|[ProfitAmount](#ProfitAmount)||<a href="RTax25RegisterTrans_NotInfluenceIncome.md" target="_blank">Transaction/RTax25RegisterTrans_NotInfluenceIncome</a>|
|[RefRecId](#RefRecId)||<a href="RTax25RegisterTrans_NotInfluenceIncome.md" target="_blank">Transaction/RTax25RegisterTrans_NotInfluenceIncome</a>|
|[RefTableId](#RefTableId)||<a href="RTax25RegisterTrans_NotInfluenceIncome.md" target="_blank">Transaction/RTax25RegisterTrans_NotInfluenceIncome</a>|
|[RTax25ProfitTable](#RTax25ProfitTable)||<a href="RTax25RegisterTrans_NotInfluenceIncome.md" target="_blank">Transaction/RTax25RegisterTrans_NotInfluenceIncome</a>|
|[TransactionDate](#TransactionDate)||<a href="RTax25RegisterTrans_NotInfluenceIncome.md" target="_blank">Transaction/RTax25RegisterTrans_NotInfluenceIncome</a>|
|[DataAreaId](#DataAreaId)||<a href="RTax25RegisterTrans_NotInfluenceIncome.md" target="_blank">Transaction/RTax25RegisterTrans_NotInfluenceIncome</a>|
|[Relationship_LedgerJournalTransRelationshipId](#Relationship_LedgerJournalTransRelationshipId)||<a href="RTax25RegisterTrans_NotInfluenceIncome.md" target="_blank">Transaction/RTax25RegisterTrans_NotInfluenceIncome</a>|
|[Relationship_RTax25ProfitTableRelationshipId](#Relationship_RTax25ProfitTableRelationshipId)||<a href="RTax25RegisterTrans_NotInfluenceIncome.md" target="_blank">Transaction/RTax25RegisterTrans_NotInfluenceIncome</a>|
|[Relationship_RTax25RegisterJournalTransRecIdRelationshipId](#Relationship_RTax25RegisterJournalTransRecIdRelationshipId)||<a href="RTax25RegisterTrans_NotInfluenceIncome.md" target="_blank">Transaction/RTax25RegisterTrans_NotInfluenceIncome</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="RTax25RegisterTrans_NotInfluenceIncome.md" target="_blank">Transaction/RTax25RegisterTrans_NotInfluenceIncome</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Transaction/RTax25RegisterTrans_NotInfluenceIncome (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>The naming of object of the account</td></tr><tr><td>dataFormat</td><td>string</td></tr></table>

#### Traits

<details>
<summary>List of traits for the AccountObject attribute are listed below.</summary>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>CTA amount</td></tr><tr><td>dataFormat</td><td>decimal</td></tr></table>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>CTA amount</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>CTL amount</td></tr><tr><td>dataFormat</td><td>decimal</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Income amount</td></tr><tr><td>dataFormat</td><td>decimal</td></tr></table>
...
### <a href=#IssueAmount name="IssueAmount">IssueAmount</a>

First included in: Transaction/RTax25RegisterTrans_NotInfluenceIncome (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Issue amount</td></tr><tr><td>dataFormat</td><td>decimal</td></tr></table>

#### Traits

<details>
<summary>List of traits for the IssueAmount attribute are listed below.</summary>

**is.dataFormat.numeric.shaped**  
for setting the exact precision and scale of numeric values  

**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Issue amount</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
