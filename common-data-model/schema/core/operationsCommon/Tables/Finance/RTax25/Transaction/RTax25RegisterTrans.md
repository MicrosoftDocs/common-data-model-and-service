---
title: RTax25RegisterTrans in Transaction - Common Data Model | Microsoft Docs
...
# Tax register line in Transaction(RTax25RegisterTrans)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/Finance/RTax25/Transaction/RTax25RegisterTrans.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[RTax25RegisterTrans/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="RTax25RegisterTrans.md" target="_blank">Transaction/RTax25RegisterTrans</a>|
|[AssessedTaxRegisterType](#AssessedTaxRegisterType)||<a href="RTax25RegisterTrans.md" target="_blank">Transaction/RTax25RegisterTrans</a>|
|[BlockFieldNum](#BlockFieldNum)||<a href="RTax25RegisterTrans.md" target="_blank">Transaction/RTax25RegisterTrans</a>|
|[BlockType](#BlockType)||<a href="RTax25RegisterTrans.md" target="_blank">Transaction/RTax25RegisterTrans</a>|
|[Corrected](#Corrected)||<a href="RTax25RegisterTrans.md" target="_blank">Transaction/RTax25RegisterTrans</a>|
|[FiscalYear](#FiscalYear)||<a href="RTax25RegisterTrans.md" target="_blank">Transaction/RTax25RegisterTrans</a>|
|[JournalNum](#JournalNum)||<a href="RTax25RegisterTrans.md" target="_blank">Transaction/RTax25RegisterTrans</a>|
|[LineDescription](#LineDescription)||<a href="RTax25RegisterTrans.md" target="_blank">Transaction/RTax25RegisterTrans</a>|
|[LineNumber](#LineNumber)||<a href="RTax25RegisterTrans.md" target="_blank">Transaction/RTax25RegisterTrans</a>|
|[ManualInput](#ManualInput)||<a href="RTax25RegisterTrans.md" target="_blank">Transaction/RTax25RegisterTrans</a>|
|[PeriodNum](#PeriodNum)||<a href="RTax25RegisterTrans.md" target="_blank">Transaction/RTax25RegisterTrans</a>|
|[PeriodType](#PeriodType)||<a href="RTax25RegisterTrans.md" target="_blank">Transaction/RTax25RegisterTrans</a>|
|[ProfitAmount](#ProfitAmount)||<a href="RTax25RegisterTrans.md" target="_blank">Transaction/RTax25RegisterTrans</a>|
|[RefRecId](#RefRecId)||<a href="RTax25RegisterTrans.md" target="_blank">Transaction/RTax25RegisterTrans</a>|
|[RefTableId](#RefTableId)||<a href="RTax25RegisterTrans.md" target="_blank">Transaction/RTax25RegisterTrans</a>|
|[RegisterId](#RegisterId)||<a href="RTax25RegisterTrans.md" target="_blank">Transaction/RTax25RegisterTrans</a>|
|[RegisterJournalType](#RegisterJournalType)||<a href="RTax25RegisterTrans.md" target="_blank">Transaction/RTax25RegisterTrans</a>|
|[RegisterValues](#RegisterValues)||<a href="RTax25RegisterTrans.md" target="_blank">Transaction/RTax25RegisterTrans</a>|
|[RTax25ProfitTable](#RTax25ProfitTable)||<a href="RTax25RegisterTrans.md" target="_blank">Transaction/RTax25RegisterTrans</a>|
|[DataAreaId](#DataAreaId)||<a href="RTax25RegisterTrans.md" target="_blank">Transaction/RTax25RegisterTrans</a>|
|[Relationship_CustTransRelationshipId](#Relationship_CustTransRelationshipId)||<a href="RTax25RegisterTrans.md" target="_blank">Transaction/RTax25RegisterTrans</a>|
|[Relationship_RAssetTableRelationshipId](#Relationship_RAssetTableRelationshipId)||<a href="RTax25RegisterTrans.md" target="_blank">Transaction/RTax25RegisterTrans</a>|
|[Relationship_RTax25ProfitTableRelationshipId](#Relationship_RTax25ProfitTableRelationshipId)||<a href="RTax25RegisterTrans.md" target="_blank">Transaction/RTax25RegisterTrans</a>|
|[Relationship_RTax25RegisterJournalTableJournalRelationshipId](#Relationship_RTax25RegisterJournalTableJournalRelationshipId)||<a href="RTax25RegisterTrans.md" target="_blank">Transaction/RTax25RegisterTrans</a>|
|[Relationship_RTax25RegisterJournalTablePeriodRelationshipId](#Relationship_RTax25RegisterJournalTablePeriodRelationshipId)||<a href="RTax25RegisterTrans.md" target="_blank">Transaction/RTax25RegisterTrans</a>|
|[Relationship_RTax25RegisterJournalTransRelationshipId](#Relationship_RTax25RegisterJournalTransRelationshipId)||<a href="RTax25RegisterTrans.md" target="_blank">Transaction/RTax25RegisterTrans</a>|
|[Relationship_RTax25RegisterTableRelationshipId](#Relationship_RTax25RegisterTableRelationshipId)||<a href="RTax25RegisterTrans.md" target="_blank">Transaction/RTax25RegisterTrans</a>|
|[Relationship_VendTransRelationshipId](#Relationship_VendTransRelationshipId)||<a href="RTax25RegisterTrans.md" target="_blank">Transaction/RTax25RegisterTrans</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="RTax25RegisterTrans.md" target="_blank">Transaction/RTax25RegisterTrans</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Transaction/RTax25RegisterTrans (this entity)  
...
<details>
<summary>List of traits for the AssessedTaxRegisterType attribute are listed below.</summary>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Section field</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>isNullable</td><td>true</td></tr></table>

#### Traits

<details>
<summary>List of traits for the BlockFieldNum attribute are listed below.</summary>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Section field</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<details>
<summary>List of traits for the RegisterId attribute are listed below.</summary>
...
### <a href=#RegisterValues name="RegisterValues">RegisterValues</a>
...
<details>
<summary>List of traits for the RegisterValues attribute are listed below.</summary>
...
<details>
<summary>List of traits for the Relationship_RTax25RegisterJournalTableJournalRelationshipId attribute are listed below.</summary>
...
**means.identity.entityId**  
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="../WorksheetHeader/RTax25RegisterJournalTable.md" target="_blank">/core/operationsCommon/Tables/Finance/RTax25/WorksheetHeader/RTax25RegisterJournalTable.cdm.json/RTax25RegisterJournalTable</a></td><td><a href="../WorksheetHeader/RTax25RegisterJournalTable.md#RecId" target="_blank">RecId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
...
<details>
<summary>List of traits for the Relationship_RTax25RegisterJournalTablePeriodRelationshipId attribute are listed below.</summary>
...
<details>
<summary>List of traits for the Relationship_RTax25RegisterJournalTransRelationshipId attribute are listed below.</summary>
...
**means.identity.entityId**  
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="../Main/RTax25RegisterTable.md" target="_blank">/core/operationsCommon/Tables/Finance/RTax25/Main/RTax25RegisterTable.cdm.json/RTax25RegisterTable</a></td><td><a href="../Main/RTax25RegisterTable.md#RecId" target="_blank">RecId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
