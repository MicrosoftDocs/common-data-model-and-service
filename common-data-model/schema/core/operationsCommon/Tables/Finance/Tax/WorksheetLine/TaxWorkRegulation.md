---
title: TaxWorkRegulation - Common Data Model | Microsoft Docs
...
# Adjusted sales tax amounts
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/Finance/Tax/WorksheetLine/TaxWorkRegulation.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[TaxWorkRegulation/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Adjusted sales tax amounts</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="TaxWorkRegulation.md" target="_blank">WorksheetLine/TaxWorkRegulation</a>|
|[HeadingRecId](#HeadingRecId)||<a href="TaxWorkRegulation.md" target="_blank">WorksheetLine/TaxWorkRegulation</a>|
|[HeadingTableId](#HeadingTableId)||<a href="TaxWorkRegulation.md" target="_blank">WorksheetLine/TaxWorkRegulation</a>|
|[ManualInsertedTax](#ManualInsertedTax)||<a href="TaxWorkRegulation.md" target="_blank">WorksheetLine/TaxWorkRegulation</a>|
|[SourceBaseAmountCurRegulated](#SourceBaseAmountCurRegulated)||<a href="TaxWorkRegulation.md" target="_blank">WorksheetLine/TaxWorkRegulation</a>|
|[SourceBaseAmountRegulated_W](#SourceBaseAmountRegulated_W)||<a href="TaxWorkRegulation.md" target="_blank">WorksheetLine/TaxWorkRegulation</a>|
|[SourceRegulateAmount_W](#SourceRegulateAmount_W)||<a href="TaxWorkRegulation.md" target="_blank">WorksheetLine/TaxWorkRegulation</a>|
|[TaxationCodeAdj_BR](#TaxationCodeAdj_BR)||<a href="TaxWorkRegulation.md" target="_blank">WorksheetLine/TaxWorkRegulation</a>|
|[TaxCode](#TaxCode)||<a href="TaxWorkRegulation.md" target="_blank">WorksheetLine/TaxWorkRegulation</a>|
|[TaxDirection](#TaxDirection)||<a href="TaxWorkRegulation.md" target="_blank">WorksheetLine/TaxWorkRegulation</a>|
|[TaxRegulationAmountCur](#TaxRegulationAmountCur)||<a href="TaxWorkRegulation.md" target="_blank">WorksheetLine/TaxWorkRegulation</a>|
|[TaxRegulationAmountCustoms_IN](#TaxRegulationAmountCustoms_IN)||<a href="TaxWorkRegulation.md" target="_blank">WorksheetLine/TaxWorkRegulation</a>|
|[DistributedTax](#DistributedTax)||<a href="TaxWorkRegulation.md" target="_blank">WorksheetLine/TaxWorkRegulation</a>|
|[ActualTaxRegulationAmountCur](#ActualTaxRegulationAmountCur)||<a href="TaxWorkRegulation.md" target="_blank">WorksheetLine/TaxWorkRegulation</a>|
|[IsCreatedFromUIInDetailedMode](#IsCreatedFromUIInDetailedMode)||<a href="TaxWorkRegulation.md" target="_blank">WorksheetLine/TaxWorkRegulation</a>|
|[DataAreaId](#DataAreaId)||<a href="TaxWorkRegulation.md" target="_blank">WorksheetLine/TaxWorkRegulation</a>|
|[Relationship_CustInvoiceJourRelationshipId](#Relationship_CustInvoiceJourRelationshipId)||<a href="TaxWorkRegulation.md" target="_blank">WorksheetLine/TaxWorkRegulation</a>|
|[Relationship_CustInvoiceTableRelationshipId](#Relationship_CustInvoiceTableRelationshipId)||<a href="TaxWorkRegulation.md" target="_blank">WorksheetLine/TaxWorkRegulation</a>|
|[Relationship_InventTransferJour_INRelationshipId](#Relationship_InventTransferJour_INRelationshipId)||<a href="TaxWorkRegulation.md" target="_blank">WorksheetLine/TaxWorkRegulation</a>|
|[Relationship_InventTransferTable_INRelationshipId](#Relationship_InventTransferTable_INRelationshipId)||<a href="TaxWorkRegulation.md" target="_blank">WorksheetLine/TaxWorkRegulation</a>|
|[Relationship_LedgerJournalTransRelationshipId](#Relationship_LedgerJournalTransRelationshipId)||<a href="TaxWorkRegulation.md" target="_blank">WorksheetLine/TaxWorkRegulation</a>|
|[Relationship_MarkupTransRelationshipId](#Relationship_MarkupTransRelationshipId)||<a href="TaxWorkRegulation.md" target="_blank">WorksheetLine/TaxWorkRegulation</a>|
|[Relationship_ProjProposalJourRelationshipId](#Relationship_ProjProposalJourRelationshipId)||<a href="TaxWorkRegulation.md" target="_blank">WorksheetLine/TaxWorkRegulation</a>|
|[Relationship_PurchParmTableRelationshipId](#Relationship_PurchParmTableRelationshipId)||<a href="TaxWorkRegulation.md" target="_blank">WorksheetLine/TaxWorkRegulation</a>|
|[Relationship_PurchTableRelationshipId](#Relationship_PurchTableRelationshipId)||<a href="TaxWorkRegulation.md" target="_blank">WorksheetLine/TaxWorkRegulation</a>|
|[Relationship_SalesLineRelationshipId](#Relationship_SalesLineRelationshipId)||<a href="TaxWorkRegulation.md" target="_blank">WorksheetLine/TaxWorkRegulation</a>|
|[Relationship_SalesQuotationTableRelationshipId](#Relationship_SalesQuotationTableRelationshipId)||<a href="TaxWorkRegulation.md" target="_blank">WorksheetLine/TaxWorkRegulation</a>|
|[Relationship_SalesTableRelationshipId](#Relationship_SalesTableRelationshipId)||<a href="TaxWorkRegulation.md" target="_blank">WorksheetLine/TaxWorkRegulation</a>|
|[Relationship_TaxTableRelationshipId](#Relationship_TaxTableRelationshipId)||<a href="TaxWorkRegulation.md" target="_blank">WorksheetLine/TaxWorkRegulation</a>|
|[Relationship_VendInvoiceInfoLineRelationshipId](#Relationship_VendInvoiceInfoLineRelationshipId)||<a href="TaxWorkRegulation.md" target="_blank">WorksheetLine/TaxWorkRegulation</a>|
|[Relationship_VendInvoiceInfoTableRelationshipId](#Relationship_VendInvoiceInfoTableRelationshipId)||<a href="TaxWorkRegulation.md" target="_blank">WorksheetLine/TaxWorkRegulation</a>|
|[Relationship_VendInvoiceJourRelationshipId](#Relationship_VendInvoiceJourRelationshipId)||<a href="TaxWorkRegulation.md" target="_blank">WorksheetLine/TaxWorkRegulation</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="TaxWorkRegulation.md" target="_blank">WorksheetLine/TaxWorkRegulation</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: WorksheetLine/TaxWorkRegulation (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Main record ID</td></tr><tr><td>dataFormat</td><td>int64</td></tr></table>
...
**is.dataFormat.big**  
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Main record ID</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Manually created sales tax</td></tr><tr><td>dataFormat</td><td>int32</td></tr></table>
...
### <a href=#SourceBaseAmountRegulated_W name="SourceBaseAmountRegulated_W">SourceBaseAmountRegulated_W</a>

First included in: WorksheetLine/TaxWorkRegulation (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Adjusted amount origin (VAT exchange rate)</td></tr><tr><td>dataFormat</td><td>decimal</td></tr></table>

#### Traits

<details>
<summary>List of traits for the SourceBaseAmountRegulated_W attribute are listed below.</summary>
...
### <a href=#SourceRegulateAmount_W name="SourceRegulateAmount_W">SourceRegulateAmount_W</a>

First included in: WorksheetLine/TaxWorkRegulation (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Adjusted sales tax amount (VAT exchange rate)</td></tr><tr><td>dataFormat</td><td>decimal</td></tr></table>

#### Traits

<details>
<summary>List of traits for the SourceRegulateAmount_W attribute are listed below.</summary>
...
### <a href=#TaxRegulationAmountCur name="TaxRegulationAmountCur">TaxRegulationAmountCur</a>
...
<details>
<summary>List of traits for the TaxRegulationAmountCur attribute are listed below.</summary>
...
### <a href=#TaxRegulationAmountCustoms_IN name="TaxRegulationAmountCustoms_IN">TaxRegulationAmountCustoms_IN</a>
...
<details>
<summary>List of traits for the TaxRegulationAmountCustoms_IN attribute are listed below.</summary>
...
### <a href=#DistributedTax name="DistributedTax">DistributedTax</a>

First included in: WorksheetLine/TaxWorkRegulation (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Distributed</td></tr><tr><td>dataFormat</td><td>int32</td></tr></table>

#### Traits

<details>
<summary>List of traits for the DistributedTax attribute are listed below.</summary>

**is.dataFormat.integer**  
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Distributed</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.dataFormat.integer**  
</details>

### <a href=#ActualTaxRegulationAmountCur name="ActualTaxRegulationAmountCur">ActualTaxRegulationAmountCur</a>
...
<details>
<summary>List of traits for the ActualTaxRegulationAmountCur attribute are listed below.</summary>
...
### <a href=#IsCreatedFromUIInDetailedMode name="IsCreatedFromUIInDetailedMode">IsCreatedFromUIInDetailedMode</a>
...
<details>
<summary>List of traits for the IsCreatedFromUIInDetailedMode attribute are listed below.</summary>
...
### <a href=#Relationship_InventTransferJour_INRelationshipId name="Relationship_InventTransferJour_INRelationshipId">Relationship_InventTransferJour_INRelationshipId</a>
...
<details>
<summary>List of traits for the Relationship_InventTransferJour_INRelationshipId attribute are listed below.</summary>
...
### <a href=#Relationship_InventTransferTable_INRelationshipId name="Relationship_InventTransferTable_INRelationshipId">Relationship_InventTransferTable_INRelationshipId</a>
...
<details>
<summary>List of traits for the Relationship_InventTransferTable_INRelationshipId attribute are listed below.</summary>
...
**means.identity.entityId**  
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="../../AccountsPayable/TransactionHeader/VendInvoiceInfoTable.md" target="_blank">/core/operationsCommon/Tables/Finance/AccountsPayable/TransactionHeader/VendInvoiceInfoTable.cdm.json/VendInvoiceInfoTable</a></td><td><a href="../../AccountsPayable/TransactionHeader/VendInvoiceInfoTable.md#RecId" target="_blank">RecId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
