---
title: TaxWithholdWorkRegulation_IN in WorksheetLine - Common Data Model | Microsoft Docs
...
# Adjusted withholding tax amounts in WorksheetLine(TaxWithholdWorkRegulation_IN)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/Finance/Tax/WorksheetLine/TaxWithholdWorkRegulation_IN.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[TaxWithholdWorkRegulation_IN/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Adjusted withholding tax amounts</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="TaxWithholdWorkRegulation_IN.md" target="_blank">WorksheetLine/TaxWithholdWorkRegulation_IN</a>|
|[AccountNumber](#AccountNumber)||<a href="TaxWithholdWorkRegulation_IN.md" target="_blank">WorksheetLine/TaxWithholdWorkRegulation_IN</a>|
|[AdjustedAmountOrigin](#AdjustedAmountOrigin)||<a href="TaxWithholdWorkRegulation_IN.md" target="_blank">WorksheetLine/TaxWithholdWorkRegulation_IN</a>|
|[AdjustedTaxWithholdAmount](#AdjustedTaxWithholdAmount)||<a href="TaxWithholdWorkRegulation_IN.md" target="_blank">WorksheetLine/TaxWithholdWorkRegulation_IN</a>|
|[CompanyAccount](#CompanyAccount)||<a href="TaxWithholdWorkRegulation_IN.md" target="_blank">WorksheetLine/TaxWithholdWorkRegulation_IN</a>|
|[CPOrigInvoiceRefRecId](#CPOrigInvoiceRefRecId)||<a href="TaxWithholdWorkRegulation_IN.md" target="_blank">WorksheetLine/TaxWithholdWorkRegulation_IN</a>|
|[SourceRecId](#SourceRecId)||<a href="TaxWithholdWorkRegulation_IN.md" target="_blank">WorksheetLine/TaxWithholdWorkRegulation_IN</a>|
|[SourceTableId](#SourceTableId)||<a href="TaxWithholdWorkRegulation_IN.md" target="_blank">WorksheetLine/TaxWithholdWorkRegulation_IN</a>|
|[TaxWithholdCode](#TaxWithholdCode)||<a href="TaxWithholdWorkRegulation_IN.md" target="_blank">WorksheetLine/TaxWithholdWorkRegulation_IN</a>|
|[DataAreaId](#DataAreaId)||<a href="TaxWithholdWorkRegulation_IN.md" target="_blank">WorksheetLine/TaxWithholdWorkRegulation_IN</a>|
|[Relationship_CPOrigCustTransRelationshipId](#Relationship_CPOrigCustTransRelationshipId)||<a href="TaxWithholdWorkRegulation_IN.md" target="_blank">WorksheetLine/TaxWithholdWorkRegulation_IN</a>|
|[Relationship_CPOrigVendTransRelationshipId](#Relationship_CPOrigVendTransRelationshipId)||<a href="TaxWithholdWorkRegulation_IN.md" target="_blank">WorksheetLine/TaxWithholdWorkRegulation_IN</a>|
|[Relationship_CustInvoiceLineRelationshipId](#Relationship_CustInvoiceLineRelationshipId)||<a href="TaxWithholdWorkRegulation_IN.md" target="_blank">WorksheetLine/TaxWithholdWorkRegulation_IN</a>|
|[Relationship_LedgerJournalTransRelationshipId](#Relationship_LedgerJournalTransRelationshipId)||<a href="TaxWithholdWorkRegulation_IN.md" target="_blank">WorksheetLine/TaxWithholdWorkRegulation_IN</a>|
|[Relationship_PurchLineRelationshipId](#Relationship_PurchLineRelationshipId)||<a href="TaxWithholdWorkRegulation_IN.md" target="_blank">WorksheetLine/TaxWithholdWorkRegulation_IN</a>|
|[Relationship_SalesLineRelationshipId](#Relationship_SalesLineRelationshipId)||<a href="TaxWithholdWorkRegulation_IN.md" target="_blank">WorksheetLine/TaxWithholdWorkRegulation_IN</a>|
|[Relationship_TaxWithholdTableRelationshipId](#Relationship_TaxWithholdTableRelationshipId)||<a href="TaxWithholdWorkRegulation_IN.md" target="_blank">WorksheetLine/TaxWithholdWorkRegulation_IN</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="TaxWithholdWorkRegulation_IN.md" target="_blank">WorksheetLine/TaxWithholdWorkRegulation_IN</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: WorksheetLine/TaxWithholdWorkRegulation_IN (this entity)  
...
### <a href=#AdjustedAmountOrigin name="AdjustedAmountOrigin">AdjustedAmountOrigin</a>
...
<details>
<summary>List of traits for the AdjustedAmountOrigin attribute are listed below.</summary>
...
### <a href=#AdjustedTaxWithholdAmount name="AdjustedTaxWithholdAmount">AdjustedTaxWithholdAmount</a>
...
<details>
<summary>List of traits for the AdjustedTaxWithholdAmount attribute are listed below.</summary>
