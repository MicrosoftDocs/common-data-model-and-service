---
title: EcoResCategoryTax in Main - Common Data Model | Microsoft Docs
...
# Category tax information in Main(EcoResCategoryTax)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/Finance/Tax/Main/EcoResCategoryTax.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[EcoResCategoryTax/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Category tax information</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="EcoResCategoryTax.md" target="_blank">Main/EcoResCategoryTax</a>|
|[EcoResCategory](#EcoResCategory)||<a href="EcoResCategoryTax.md" target="_blank">Main/EcoResCategoryTax</a>|
|[HSNCodeTable_IN](#HSNCodeTable_IN)||<a href="EcoResCategoryTax.md" target="_blank">Main/EcoResCategoryTax</a>|
|[ServiceAccountingCodeTable_IN](#ServiceAccountingCodeTable_IN)||<a href="EcoResCategoryTax.md" target="_blank">Main/EcoResCategoryTax</a>|
|[Exempt_IN](#Exempt_IN)||<a href="EcoResCategoryTax.md" target="_blank">Main/EcoResCategoryTax</a>|
|[NonGST_IN](#NonGST_IN)||<a href="EcoResCategoryTax.md" target="_blank">Main/EcoResCategoryTax</a>|
|[TaxRateType](#TaxRateType)||<a href="EcoResCategoryTax.md" target="_blank">Main/EcoResCategoryTax</a>|
|[DataAreaId](#DataAreaId)||<a href="EcoResCategoryTax.md" target="_blank">Main/EcoResCategoryTax</a>|
|[Relationship_EcoResCategoryRelationshipId](#Relationship_EcoResCategoryRelationshipId)||<a href="EcoResCategoryTax.md" target="_blank">Main/EcoResCategoryTax</a>|
|[Relationship_HSNCodeTable_INRelationshipId](#Relationship_HSNCodeTable_INRelationshipId)||<a href="EcoResCategoryTax.md" target="_blank">Main/EcoResCategoryTax</a>|
|[Relationship_ServiceAccountingCodeTable_INRelationshipId](#Relationship_ServiceAccountingCodeTable_INRelationshipId)||<a href="EcoResCategoryTax.md" target="_blank">Main/EcoResCategoryTax</a>|
|[Relationship_TaxRateTypeRelationshipId](#Relationship_TaxRateTypeRelationshipId)||<a href="EcoResCategoryTax.md" target="_blank">Main/EcoResCategoryTax</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="EcoResCategoryTax.md" target="_blank">Main/EcoResCategoryTax</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Main/EcoResCategoryTax (this entity)  
...
**means.identity.entityId**  
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="HSNCodeTable_IN.md" target="_blank">/core/operationsCommon/Tables/Finance/Tax/Main/HSNCodeTable_IN.cdm.json/HSNCodeTable_IN</a></td><td><a href="HSNCodeTable_IN.md#RecId" target="_blank">RecId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
...
**means.identity.entityId**  
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="TaxRateType.md" target="_blank">/core/operationsCommon/Tables/Finance/Tax/Main/TaxRateType.cdm.json/TaxRateType</a></td><td><a href="TaxRateType.md#RecId" target="_blank">RecId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
