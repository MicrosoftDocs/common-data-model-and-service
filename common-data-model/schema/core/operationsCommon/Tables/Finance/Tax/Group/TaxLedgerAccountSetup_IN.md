---
title: TaxLedgerAccountSetup_IN in Group - Common Data Model | Microsoft Docs
...
# Tax ledger posting group setup in Group(TaxLedgerAccountSetup_IN)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/Finance/Tax/Group/TaxLedgerAccountSetup_IN.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[TaxLedgerAccountSetup_IN/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Tax ledger posting group setup</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="TaxLedgerAccountSetup_IN.md" target="_blank">Group/TaxLedgerAccountSetup_IN</a>|
|[AccountCode](#AccountCode)||<a href="TaxLedgerAccountSetup_IN.md" target="_blank">Group/TaxLedgerAccountSetup_IN</a>|
|[TaxLedgerAccountGroup](#TaxLedgerAccountGroup)||<a href="TaxLedgerAccountSetup_IN.md" target="_blank">Group/TaxLedgerAccountSetup_IN</a>|
|[TaxRegistrationNumberTable](#TaxRegistrationNumberTable)||<a href="TaxLedgerAccountSetup_IN.md" target="_blank">Group/TaxLedgerAccountSetup_IN</a>|
|[DataAreaId](#DataAreaId)||<a href="TaxLedgerAccountSetup_IN.md" target="_blank">Group/TaxLedgerAccountSetup_IN</a>|
|[Relationship_TaxLedgerAccountGroupRelationshipId](#Relationship_TaxLedgerAccountGroupRelationshipId)||<a href="TaxLedgerAccountSetup_IN.md" target="_blank">Group/TaxLedgerAccountSetup_IN</a>|
|[Relationship_TaxRegistrationNumberTableRelationshipId](#Relationship_TaxRegistrationNumberTableRelationshipId)||<a href="TaxLedgerAccountSetup_IN.md" target="_blank">Group/TaxLedgerAccountSetup_IN</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="TaxLedgerAccountSetup_IN.md" target="_blank">Group/TaxLedgerAccountSetup_IN</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Group/TaxLedgerAccountSetup_IN (this entity)  
