---
title: TaxesMatrix_BR in Group - Common Data Model | Microsoft Docs
...
# Taxes matrix in Group(TaxesMatrix_BR)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/Finance/Tax/Group/TaxesMatrix_BR.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[TaxesMatrix_BR/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="TaxesMatrix_BR.md" target="_blank">Group/TaxesMatrix_BR</a>|
|[AccountCode](#AccountCode)||<a href="TaxesMatrix_BR.md" target="_blank">Group/TaxesMatrix_BR</a>|
|[AccountRelation](#AccountRelation)||<a href="TaxesMatrix_BR.md" target="_blank">Group/TaxesMatrix_BR</a>|
|[CFOPGroup_BR](#CFOPGroup_BR)||<a href="TaxesMatrix_BR.md" target="_blank">Group/TaxesMatrix_BR</a>|
|[CustVendType](#CustVendType)||<a href="TaxesMatrix_BR.md" target="_blank">Group/TaxesMatrix_BR</a>|
|[FiscalEstablishmentGroup_BR](#FiscalEstablishmentGroup_BR)||<a href="TaxesMatrix_BR.md" target="_blank">Group/TaxesMatrix_BR</a>|
|[FreeTextInvoice](#FreeTextInvoice)||<a href="TaxesMatrix_BR.md" target="_blank">Group/TaxesMatrix_BR</a>|
|[ItemCode](#ItemCode)||<a href="TaxesMatrix_BR.md" target="_blank">Group/TaxesMatrix_BR</a>|
|[ItemRelation](#ItemRelation)||<a href="TaxesMatrix_BR.md" target="_blank">Group/TaxesMatrix_BR</a>|
|[ServiceItems](#ServiceItems)||<a href="TaxesMatrix_BR.md" target="_blank">Group/TaxesMatrix_BR</a>|
|[TaxGroup](#TaxGroup)||<a href="TaxesMatrix_BR.md" target="_blank">Group/TaxesMatrix_BR</a>|
|[TaxItemGroup](#TaxItemGroup)||<a href="TaxesMatrix_BR.md" target="_blank">Group/TaxesMatrix_BR</a>|
|[DataAreaId](#DataAreaId)||<a href="TaxesMatrix_BR.md" target="_blank">Group/TaxesMatrix_BR</a>|
|[Relationship_CFOPGroupRelationshipId](#Relationship_CFOPGroupRelationshipId)||<a href="TaxesMatrix_BR.md" target="_blank">Group/TaxesMatrix_BR</a>|
|[Relationship_CustGroupRelationshipId](#Relationship_CustGroupRelationshipId)||<a href="TaxesMatrix_BR.md" target="_blank">Group/TaxesMatrix_BR</a>|
|[Relationship_CustTableRelationshipId](#Relationship_CustTableRelationshipId)||<a href="TaxesMatrix_BR.md" target="_blank">Group/TaxesMatrix_BR</a>|
|[Relationship_FiscalEstablishment_BRRelationshipId](#Relationship_FiscalEstablishment_BRRelationshipId)||<a href="TaxesMatrix_BR.md" target="_blank">Group/TaxesMatrix_BR</a>|
|[Relationship_FiscalEstablishmentGroupRelationshipId](#Relationship_FiscalEstablishmentGroupRelationshipId)||<a href="TaxesMatrix_BR.md" target="_blank">Group/TaxesMatrix_BR</a>|
|[Relationship_FiscalEstablishmentGroup_BRRelationshipId](#Relationship_FiscalEstablishmentGroup_BRRelationshipId)||<a href="TaxesMatrix_BR.md" target="_blank">Group/TaxesMatrix_BR</a>|
|[Relationship_InventItemGroupRelationshipId](#Relationship_InventItemGroupRelationshipId)||<a href="TaxesMatrix_BR.md" target="_blank">Group/TaxesMatrix_BR</a>|
|[Relationship_InventTableRelationshipId](#Relationship_InventTableRelationshipId)||<a href="TaxesMatrix_BR.md" target="_blank">Group/TaxesMatrix_BR</a>|
|[Relationship_TaxGroupHeadingRelationshipId](#Relationship_TaxGroupHeadingRelationshipId)||<a href="TaxesMatrix_BR.md" target="_blank">Group/TaxesMatrix_BR</a>|
|[Relationship_TaxItemGroupHeadingRelationshipId](#Relationship_TaxItemGroupHeadingRelationshipId)||<a href="TaxesMatrix_BR.md" target="_blank">Group/TaxesMatrix_BR</a>|
|[Relationship_VendGroupRelationshipId](#Relationship_VendGroupRelationshipId)||<a href="TaxesMatrix_BR.md" target="_blank">Group/TaxesMatrix_BR</a>|
|[Relationship_VendTableRelationshipId](#Relationship_VendTableRelationshipId)||<a href="TaxesMatrix_BR.md" target="_blank">Group/TaxesMatrix_BR</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="TaxesMatrix_BR.md" target="_blank">Group/TaxesMatrix_BR</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Group/TaxesMatrix_BR (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>CFOP group</td></tr><tr><td>dataFormat</td><td>int64</td></tr><tr><td>isNullable</td><td>true</td></tr></table>
...
### <a href=#FreeTextInvoice name="FreeTextInvoice">FreeTextInvoice</a>
...
<details>
<summary>List of traits for the FreeTextInvoice attribute are listed below.</summary>
...
### <a href=#ServiceItems name="ServiceItems">ServiceItems</a>

First included in: Group/TaxesMatrix_BR (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Service items</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>isNullable</td><td>true</td></tr></table>

#### Traits

<details>
<summary>List of traits for the ServiceItems attribute are listed below.</summary>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Service items</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
### <a href=#Relationship_FiscalEstablishmentGroup_BRRelationshipId name="Relationship_FiscalEstablishmentGroup_BRRelationshipId">Relationship_FiscalEstablishmentGroup_BRRelationshipId</a>
...
<details>
<summary>List of traits for the Relationship_FiscalEstablishmentGroup_BRRelationshipId attribute are listed below.</summary>
...
**means.identity.entityId**  
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="TaxItemGroupHeading.md" target="_blank">/core/operationsCommon/Tables/Finance/Tax/Group/TaxItemGroupHeading.cdm.json/TaxItemGroupHeading</a></td><td><a href="TaxItemGroupHeading.md#RecId" target="_blank">RecId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
