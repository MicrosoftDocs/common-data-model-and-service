...
# Electronic OB declaration details in Transaction(TaxTurnOverLine_NL)
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[TaxTurnOverLine_NL/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Electronic OB declaration details</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="TaxTurnOverLine_NL.md" target="_blank">Transaction/TaxTurnOverLine_NL</a>|
|[Amount](#Amount)||<a href="TaxTurnOverLine_NL.md" target="_blank">Transaction/TaxTurnOverLine_NL</a>|
|[TaxReportCollection](#TaxReportCollection)||<a href="TaxTurnOverLine_NL.md" target="_blank">Transaction/TaxTurnOverLine_NL</a>|
|[TaxTurnOverTable_NL](#TaxTurnOverTable_NL)||<a href="TaxTurnOverLine_NL.md" target="_blank">Transaction/TaxTurnOverLine_NL</a>|
|[DataAreaId](#DataAreaId)||<a href="TaxTurnOverLine_NL.md" target="_blank">Transaction/TaxTurnOverLine_NL</a>|
|[Relationship_TaxReportCollectionRelationshipId](#Relationship_TaxReportCollectionRelationshipId)||<a href="TaxTurnOverLine_NL.md" target="_blank">Transaction/TaxTurnOverLine_NL</a>|
|[Relationship_TaxTurnOverTable_NLRelationshipId](#Relationship_TaxTurnOverTable_NLRelationshipId)||<a href="TaxTurnOverLine_NL.md" target="_blank">Transaction/TaxTurnOverLine_NL</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="TaxTurnOverLine_NL.md" target="_blank">Transaction/TaxTurnOverLine_NL</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Transaction/TaxTurnOverLine_NL (this entity)  
