---
title: HRPDefaultLimitCompensationRule in Main - Common Data Model | Microsoft Docs
...
# Default signing limit compensation rule in Main(HRPDefaultLimitCompensationRule)
