---
title: HcmEmploymentContractor in Group - Common Data Model | Microsoft Docs
...
# Employment contractor in Group(HcmEmploymentContractor)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/HumanResources/HumanResource/Group/HcmEmploymentContractor.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[HcmEmploymentContractor/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="HcmEmploymentContractor.md" target="_blank">Group/HcmEmploymentContractor</a>|
|[Employment](#Employment)||<a href="HcmEmploymentContractor.md" target="_blank">Group/HcmEmploymentContractor</a>|
|[PurchID](#PurchID)||<a href="HcmEmploymentContractor.md" target="_blank">Group/HcmEmploymentContractor</a>|
|[PurchReqTable](#PurchReqTable)||<a href="HcmEmploymentContractor.md" target="_blank">Group/HcmEmploymentContractor</a>|
|[ValidFrom](#ValidFrom)||<a href="HcmEmploymentContractor.md" target="_blank">Group/HcmEmploymentContractor</a>|
|[ValidTo](#ValidTo)||<a href="HcmEmploymentContractor.md" target="_blank">Group/HcmEmploymentContractor</a>|
|[VendorDataAreaID](#VendorDataAreaID)||<a href="HcmEmploymentContractor.md" target="_blank">Group/HcmEmploymentContractor</a>|
|[VendorID](#VendorID)||<a href="HcmEmploymentContractor.md" target="_blank">Group/HcmEmploymentContractor</a>|
|[Relationship_PurchReq_FKRelationshipId](#Relationship_PurchReq_FKRelationshipId)||<a href="HcmEmploymentContractor.md" target="_blank">Group/HcmEmploymentContractor</a>|
|[Relationship_PurchTableRelationshipId](#Relationship_PurchTableRelationshipId)||<a href="HcmEmploymentContractor.md" target="_blank">Group/HcmEmploymentContractor</a>|
|[Relationship_VendTable_FKRelationshipId](#Relationship_VendTable_FKRelationshipId)||<a href="HcmEmploymentContractor.md" target="_blank">Group/HcmEmploymentContractor</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Group/HcmEmploymentContractor (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>ID</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>isNullable</td><td>true</td></tr></table>
...
### <a href=#Relationship_PurchReq_FKRelationshipId name="Relationship_PurchReq_FKRelationshipId">Relationship_PurchReq_FKRelationshipId</a>
...
<details>
<summary>List of traits for the Relationship_PurchReq_FKRelationshipId attribute are listed below.</summary>
