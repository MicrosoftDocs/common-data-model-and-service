---
title: PayrollPayStatementTaxLine in WorksheetLine - Common Data Model | Microsoft Docs
...
# Pay statement tax lines in WorksheetLine(PayrollPayStatementTaxLine)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/HumanResources/Payroll/WorksheetLine/PayrollPayStatementTaxLine.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[PayrollPayStatementTaxLine/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Pay statement lines</td></tr><tr><td>en</td><td>Pay statement tax lines</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="PayrollPayStatementTaxLine.md" target="_blank">WorksheetLine/PayrollPayStatementTaxLine</a>|
|[AccountingCurrencyAmount](#AccountingCurrencyAmount)||<a href="PayrollPayStatementTaxLine.md" target="_blank">WorksheetLine/PayrollPayStatementTaxLine</a>|
|[AccountingDate](#AccountingDate)||<a href="PayrollPayStatementTaxLine.md" target="_blank">WorksheetLine/PayrollPayStatementTaxLine</a>|
|[AccountingDistributionTemplate](#AccountingDistributionTemplate)||<a href="PayrollPayStatementTaxLine.md" target="_blank">WorksheetLine/PayrollPayStatementTaxLine</a>|
|[InstanceRelationType](#InstanceRelationType)||<a href="PayrollPayStatementTaxLine.md" target="_blank">WorksheetLine/PayrollPayStatementTaxLine</a>|
|[IsEmployer](#IsEmployer)||<a href="PayrollPayStatementTaxLine.md" target="_blank">WorksheetLine/PayrollPayStatementTaxLine</a>|
|[IsLineLocked](#IsLineLocked)||<a href="PayrollPayStatementTaxLine.md" target="_blank">WorksheetLine/PayrollPayStatementTaxLine</a>|
|[IsMarkedForRemoval](#IsMarkedForRemoval)||<a href="PayrollPayStatementTaxLine.md" target="_blank">WorksheetLine/PayrollPayStatementTaxLine</a>|
|[IsPayStatementLineOverridden](#IsPayStatementLineOverridden)||<a href="PayrollPayStatementTaxLine.md" target="_blank">WorksheetLine/PayrollPayStatementTaxLine</a>|
|[PayStatement](#PayStatement)||<a href="PayrollPayStatementTaxLine.md" target="_blank">WorksheetLine/PayrollPayStatementTaxLine</a>|
|[Position](#Position)||<a href="PayrollPayStatementTaxLine.md" target="_blank">WorksheetLine/PayrollPayStatementTaxLine</a>|
|[ReversedPayStatementLine](#ReversedPayStatementLine)||<a href="PayrollPayStatementTaxLine.md" target="_blank">WorksheetLine/PayrollPayStatementTaxLine</a>|
|[Source](#Source)||<a href="PayrollPayStatementTaxLine.md" target="_blank">WorksheetLine/PayrollPayStatementTaxLine</a>|
|[SourceDocumentLine](#SourceDocumentLine)||<a href="PayrollPayStatementTaxLine.md" target="_blank">WorksheetLine/PayrollPayStatementTaxLine</a>|
|[VendTrans](#VendTrans)||<a href="PayrollPayStatementTaxLine.md" target="_blank">WorksheetLine/PayrollPayStatementTaxLine</a>|
|[LineNum](#LineNum)||<a href="PayrollPayStatementTaxLine.md" target="_blank">WorksheetLine/PayrollPayStatementTaxLine</a>|
|[DataAreaId](#DataAreaId)||<a href="PayrollPayStatementTaxLine.md" target="_blank">WorksheetLine/PayrollPayStatementTaxLine</a>|
|[Relationship_AccountingDistributionTemplate_FKRelationshipId](#Relationship_AccountingDistributionTemplate_FKRelationshipId)||<a href="PayrollPayStatementTaxLine.md" target="_blank">WorksheetLine/PayrollPayStatementTaxLine</a>|
|[Relationship_PayStatement_FKRelationshipId](#Relationship_PayStatement_FKRelationshipId)||<a href="PayrollPayStatementTaxLine.md" target="_blank">WorksheetLine/PayrollPayStatementTaxLine</a>|
|[Relationship_SourceDocumentLine_FKRelationshipId](#Relationship_SourceDocumentLine_FKRelationshipId)||<a href="PayrollPayStatementTaxLine.md" target="_blank">WorksheetLine/PayrollPayStatementTaxLine</a>|
|[Relationship_VendTrans_FKRelationshipId](#Relationship_VendTrans_FKRelationshipId)||<a href="PayrollPayStatementTaxLine.md" target="_blank">WorksheetLine/PayrollPayStatementTaxLine</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="PayrollPayStatementTaxLine.md" target="_blank">WorksheetLine/PayrollPayStatementTaxLine</a>|
|[PoliticalSubDivisionId](#PoliticalSubDivisionId)||<a href="PayrollPayStatementTaxLine.md" target="_blank">WorksheetLine/PayrollPayStatementTaxLine</a>|
|[TaxCode](#TaxCode)||<a href="PayrollPayStatementTaxLine.md" target="_blank">WorksheetLine/PayrollPayStatementTaxLine</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: WorksheetLine/PayrollPayStatementTaxLine (this entity)  
