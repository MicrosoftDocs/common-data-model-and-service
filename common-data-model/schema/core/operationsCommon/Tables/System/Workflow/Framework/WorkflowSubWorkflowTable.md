---
title: WorkflowSubWorkflowTable in Framework - Common Data Model | Microsoft Docs
...
# Subworkflows in Framework(WorkflowSubWorkflowTable)
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Subworkflow</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>isNullable</td><td>true</td></tr></table>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Subworkflow</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
