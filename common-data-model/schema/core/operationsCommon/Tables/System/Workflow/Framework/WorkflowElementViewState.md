---
title: WorkflowElementViewState in Framework - Common Data Model | Microsoft Docs
...
# Workflow element layout in Framework(WorkflowElementViewState)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/System/Workflow/Framework/WorkflowElementViewState.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[WorkflowElementViewState/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Workflow element layout</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="WorkflowElementViewState.md" target="_blank">Framework/WorkflowElementViewState</a>|
|[WorkflowElementTable](#WorkflowElementTable)||<a href="WorkflowElementViewState.md" target="_blank">Framework/WorkflowElementViewState</a>|
|[WorkflowParallelBranchTable](#WorkflowParallelBranchTable)||<a href="WorkflowElementViewState.md" target="_blank">Framework/WorkflowElementViewState</a>|
|[WorkflowSubWorkflow](#WorkflowSubWorkflow)||<a href="WorkflowElementViewState.md" target="_blank">Framework/WorkflowElementViewState</a>|
|[XML](#XML)||<a href="WorkflowElementViewState.md" target="_blank">Framework/WorkflowElementViewState</a>|
|[Relationship_WorkflowElementTableRelationshipId](#Relationship_WorkflowElementTableRelationshipId)||<a href="WorkflowElementViewState.md" target="_blank">Framework/WorkflowElementViewState</a>|
|[Relationship_WorkflowParallelBranchTableRelationshipId](#Relationship_WorkflowParallelBranchTableRelationshipId)||<a href="WorkflowElementViewState.md" target="_blank">Framework/WorkflowElementViewState</a>|
|[Relationship_WorkflowSubWorkflowRelationshipId](#Relationship_WorkflowSubWorkflowRelationshipId)||<a href="WorkflowElementViewState.md" target="_blank">Framework/WorkflowElementViewState</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Framework/WorkflowElementViewState (this entity)  
