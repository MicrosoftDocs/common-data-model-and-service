---
title: SysPolicyRuleType - Common Data Model | Microsoft Docs
...
# Policy rule type:
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/System/Workflow/Reference/SysPolicyRuleType.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[SysPolicyRuleType/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="SysPolicyRuleType.md" target="_blank">Reference/SysPolicyRuleType</a>|
|[Description](#Description)||<a href="SysPolicyRuleType.md" target="_blank">Reference/SysPolicyRuleType</a>|
|[IncludeParentRules](#IncludeParentRules)||<a href="SysPolicyRuleType.md" target="_blank">Reference/SysPolicyRuleType</a>|
|[InstanceRelationType](#InstanceRelationType)||<a href="SysPolicyRuleType.md" target="_blank">Reference/SysPolicyRuleType</a>|
|[IsPrecedenceSupported](#IsPrecedenceSupported)||<a href="SysPolicyRuleType.md" target="_blank">Reference/SysPolicyRuleType</a>|
|[Name](#Name)||<a href="SysPolicyRuleType.md" target="_blank">Reference/SysPolicyRuleType</a>|
|[PolicyType](#PolicyType)||<a href="SysPolicyRuleType.md" target="_blank">Reference/SysPolicyRuleType</a>|
|[RuleFormName](#RuleFormName)||<a href="SysPolicyRuleType.md" target="_blank">Reference/SysPolicyRuleType</a>|
|[Relationship_PolicyTypeRelationshipId](#Relationship_PolicyTypeRelationshipId)||<a href="SysPolicyRuleType.md" target="_blank">Reference/SysPolicyRuleType</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Reference/SysPolicyRuleType (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Precedence supported?</td></tr><tr><td>dataFormat</td><td>int32</td></tr></table>
