---
title: RetailCustInvoiceJourTable in Transaction - Common Data Model | Microsoft Docs
...
# Retail customer invoice journal  in Transaction(RetailCustInvoiceJourTable)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/Commerce/CommerceCustomers/Transaction/RetailCustInvoiceJourTable.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[RetailCustInvoiceJourTable/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Retail customer invoice journal </td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="RetailCustInvoiceJourTable.md" target="_blank">Transaction/RetailCustInvoiceJourTable</a>|
|[CustInvoiceJour](#CustInvoiceJour)||<a href="RetailCustInvoiceJourTable.md" target="_blank">Transaction/RetailCustInvoiceJourTable</a>|
|[OMInternalOrganization](#OMInternalOrganization)||<a href="RetailCustInvoiceJourTable.md" target="_blank">Transaction/RetailCustInvoiceJourTable</a>|
|[RetailChannel](#RetailChannel)||<a href="RetailCustInvoiceJourTable.md" target="_blank">Transaction/RetailCustInvoiceJourTable</a>|
|[RetailHourOfDay](#RetailHourOfDay)||<a href="RetailCustInvoiceJourTable.md" target="_blank">Transaction/RetailCustInvoiceJourTable</a>|
|[RetailStatementId](#RetailStatementId)||<a href="RetailCustInvoiceJourTable.md" target="_blank">Transaction/RetailCustInvoiceJourTable</a>|
|[RetailStoreId](#RetailStoreId)||<a href="RetailCustInvoiceJourTable.md" target="_blank">Transaction/RetailCustInvoiceJourTable</a>|
|[RetailTerminalId](#RetailTerminalId)||<a href="RetailCustInvoiceJourTable.md" target="_blank">Transaction/RetailCustInvoiceJourTable</a>|
|[DataAreaId](#DataAreaId)||<a href="RetailCustInvoiceJourTable.md" target="_blank">Transaction/RetailCustInvoiceJourTable</a>|
|[Relationship_CustInvoiceJourRelationshipId](#Relationship_CustInvoiceJourRelationshipId)||<a href="RetailCustInvoiceJourTable.md" target="_blank">Transaction/RetailCustInvoiceJourTable</a>|
|[Relationship_OMInternalOrganizationRelationshipId](#Relationship_OMInternalOrganizationRelationshipId)||<a href="RetailCustInvoiceJourTable.md" target="_blank">Transaction/RetailCustInvoiceJourTable</a>|
|[Relationship_RetailChannelRelationshipId](#Relationship_RetailChannelRelationshipId)||<a href="RetailCustInvoiceJourTable.md" target="_blank">Transaction/RetailCustInvoiceJourTable</a>|
|[Relationship_RetailHourOfDayRelationshipId](#Relationship_RetailHourOfDayRelationshipId)||<a href="RetailCustInvoiceJourTable.md" target="_blank">Transaction/RetailCustInvoiceJourTable</a>|
|[Relationship_RetailStatementTableRelationshipId](#Relationship_RetailStatementTableRelationshipId)||<a href="RetailCustInvoiceJourTable.md" target="_blank">Transaction/RetailCustInvoiceJourTable</a>|
|[Relationship_RetailStoreTableRelationshipId](#Relationship_RetailStoreTableRelationshipId)||<a href="RetailCustInvoiceJourTable.md" target="_blank">Transaction/RetailCustInvoiceJourTable</a>|
|[Relationship_RetailTerminalTableRelationshipId](#Relationship_RetailTerminalTableRelationshipId)||<a href="RetailCustInvoiceJourTable.md" target="_blank">Transaction/RetailCustInvoiceJourTable</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="RetailCustInvoiceJourTable.md" target="_blank">Transaction/RetailCustInvoiceJourTable</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Transaction/RetailCustInvoiceJourTable (this entity)  
...
<details>
<summary>List of traits for the RetailChannel attribute are listed below.</summary>
...
<details>
<summary>List of traits for the RetailHourOfDay attribute are listed below.</summary>
...
### <a href=#Relationship_RetailHourOfDayRelationshipId name="Relationship_RetailHourOfDayRelationshipId">Relationship_RetailHourOfDayRelationshipId</a>
...
<details>
<summary>List of traits for the Relationship_RetailHourOfDayRelationshipId attribute are listed below.</summary>
...
**means.identity.entityId**  
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="../../TransactionsAndOrders/Miscellaneous/RetailHour.md" target="_blank">/core/operationsCommon/Tables/Commerce/TransactionsAndOrders/Miscellaneous/RetailHour.cdm.json/RetailHour</a></td><td><a href="../../TransactionsAndOrders/Miscellaneous/RetailHour.md#RecId" target="_blank">RecId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
...
**means.identity.entityId**  
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="../../TransactionsAndOrders/WorksheetHeader/RetailStatementTable.md" target="_blank">/core/operationsCommon/Tables/Commerce/TransactionsAndOrders/WorksheetHeader/RetailStatementTable.cdm.json/RetailStatementTable</a></td><td><a href="../../TransactionsAndOrders/WorksheetHeader/RetailStatementTable.md#RecId" target="_blank">RecId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
