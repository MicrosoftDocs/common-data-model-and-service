---
title: RetailStoreHardwareStationTable - Common Data Model | Microsoft Docs
...
# RetailStoreHardwareStationTable

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/Commerce/Retail/Miscellaneous/RetailStoreHardwareStationTable.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[RetailStoreHardwareStationTable/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="RetailStoreHardwareStationTable.md" target="_blank">Miscellaneous/RetailStoreHardwareStationTable</a>|
|[HardwareStationId](#HardwareStationId)||<a href="RetailStoreHardwareStationTable.md" target="_blank">Miscellaneous/RetailStoreHardwareStationTable</a>|
|[HostName](#HostName)||<a href="RetailStoreHardwareStationTable.md" target="_blank">Miscellaneous/RetailStoreHardwareStationTable</a>|
|[EftTerminalId](#EftTerminalId)||<a href="RetailStoreHardwareStationTable.md" target="_blank">Miscellaneous/RetailStoreHardwareStationTable</a>|
|[Store](#Store)||<a href="RetailStoreHardwareStationTable.md" target="_blank">Miscellaneous/RetailStoreHardwareStationTable</a>|
|[Description](#Description)||<a href="RetailStoreHardwareStationTable.md" target="_blank">Miscellaneous/RetailStoreHardwareStationTable</a>|
|[HardwareProfileId](#HardwareProfileId)||<a href="RetailStoreHardwareStationTable.md" target="_blank">Miscellaneous/RetailStoreHardwareStationTable</a>|
|[HardwareStationType](#HardwareStationType)||<a href="RetailStoreHardwareStationTable.md" target="_blank">Miscellaneous/RetailStoreHardwareStationTable</a>|
|[SelfServicePackage](#SelfServicePackage)||<a href="RetailStoreHardwareStationTable.md" target="_blank">Miscellaneous/RetailStoreHardwareStationTable</a>|
|[Port](#Port)||<a href="RetailStoreHardwareStationTable.md" target="_blank">Miscellaneous/RetailStoreHardwareStationTable</a>|
|[CertificateThumbprint](#CertificateThumbprint)||<a href="RetailStoreHardwareStationTable.md" target="_blank">Miscellaneous/RetailStoreHardwareStationTable</a>|
|[MergedSelfServicePackageReference](#MergedSelfServicePackageReference)||<a href="RetailStoreHardwareStationTable.md" target="_blank">Miscellaneous/RetailStoreHardwareStationTable</a>|
|[Relationship_RetailStoreTableRelationshipId](#Relationship_RetailStoreTableRelationshipId)||<a href="RetailStoreHardwareStationTable.md" target="_blank">Miscellaneous/RetailStoreHardwareStationTable</a>|
|[Relationship_SelfServicePackageRelationshipId](#Relationship_SelfServicePackageRelationshipId)||<a href="RetailStoreHardwareStationTable.md" target="_blank">Miscellaneous/RetailStoreHardwareStationTable</a>|
|[Relationship_RetailHardwareProfileRelationshipId](#Relationship_RetailHardwareProfileRelationshipId)||<a href="RetailStoreHardwareStationTable.md" target="_blank">Miscellaneous/RetailStoreHardwareStationTable</a>|
|[Relationship_RetailSelfServiceMergedPackagesRelationshipId](#Relationship_RetailSelfServiceMergedPackagesRelationshipId)||<a href="RetailStoreHardwareStationTable.md" target="_blank">Miscellaneous/RetailStoreHardwareStationTable</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Miscellaneous/RetailStoreHardwareStationTable (this entity)  
...
### <a href=#Relationship_SelfServicePackageRelationshipId name="Relationship_SelfServicePackageRelationshipId">Relationship_SelfServicePackageRelationshipId</a>
...
<details>
<summary>List of traits for the Relationship_SelfServicePackageRelationshipId attribute are listed below.</summary>
