---
title: RetailWarrantyTransactionStatus - Common Data Model | Microsoft Docs
...
# RetailWarrantyTransactionStatus

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/Commerce/Retail/Worksheet/RetailWarrantyTransactionStatus.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[RetailWarrantyTransactionStatus/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="RetailWarrantyTransactionStatus.md" target="_blank">Worksheet/RetailWarrantyTransactionStatus</a>|
|[WarrantyChannel](#WarrantyChannel)||<a href="RetailWarrantyTransactionStatus.md" target="_blank">Worksheet/RetailWarrantyTransactionStatus</a>|
|[WarrantyStore](#WarrantyStore)||<a href="RetailWarrantyTransactionStatus.md" target="_blank">Worksheet/RetailWarrantyTransactionStatus</a>|
|[WarrantyTerminalId](#WarrantyTerminalId)||<a href="RetailWarrantyTransactionStatus.md" target="_blank">Worksheet/RetailWarrantyTransactionStatus</a>|
|[WarrantyTransactionId](#WarrantyTransactionId)||<a href="RetailWarrantyTransactionStatus.md" target="_blank">Worksheet/RetailWarrantyTransactionStatus</a>|
|[ProcessingStatus](#ProcessingStatus)||<a href="RetailWarrantyTransactionStatus.md" target="_blank">Worksheet/RetailWarrantyTransactionStatus</a>|
|[LastTransactionDateTime](#LastTransactionDateTime)||<a href="RetailWarrantyTransactionStatus.md" target="_blank">Worksheet/RetailWarrantyTransactionStatus</a>|
|[DataAreaId](#DataAreaId)||<a href="RetailWarrantyTransactionStatus.md" target="_blank">Worksheet/RetailWarrantyTransactionStatus</a>|
|[Relationship_RetailChannelTableRelationshipId](#Relationship_RetailChannelTableRelationshipId)||<a href="RetailWarrantyTransactionStatus.md" target="_blank">Worksheet/RetailWarrantyTransactionStatus</a>|
|[Relationship_RetailStoreTableRelationshipId](#Relationship_RetailStoreTableRelationshipId)||<a href="RetailWarrantyTransactionStatus.md" target="_blank">Worksheet/RetailWarrantyTransactionStatus</a>|
|[Relationship_RetailTerminalTableRelationshipId](#Relationship_RetailTerminalTableRelationshipId)||<a href="RetailWarrantyTransactionStatus.md" target="_blank">Worksheet/RetailWarrantyTransactionStatus</a>|
|[Relationship_RetailTransactionTableRelationshipId](#Relationship_RetailTransactionTableRelationshipId)||<a href="RetailWarrantyTransactionStatus.md" target="_blank">Worksheet/RetailWarrantyTransactionStatus</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="RetailWarrantyTransactionStatus.md" target="_blank">Worksheet/RetailWarrantyTransactionStatus</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Worksheet/RetailWarrantyTransactionStatus (this entity)  
