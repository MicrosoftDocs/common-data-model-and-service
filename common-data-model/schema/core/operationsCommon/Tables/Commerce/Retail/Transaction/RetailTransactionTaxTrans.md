---
title: RetailTransactionTaxTrans - Common Data Model | Microsoft Docs
...
# RetailTransactionTaxTrans
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/Commerce/Retail/Transaction/RetailTransactionTaxTrans.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[RetailTransactionTaxTrans/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="RetailTransactionTaxTrans.md" target="_blank">Transaction/RetailTransactionTaxTrans</a>|
|[Amount](#Amount)||<a href="RetailTransactionTaxTrans.md" target="_blank">Transaction/RetailTransactionTaxTrans</a>|
|[Channel](#Channel)||<a href="RetailTransactionTaxTrans.md" target="_blank">Transaction/RetailTransactionTaxTrans</a>|
|[IsIncludedInPrice](#IsIncludedInPrice)||<a href="RetailTransactionTaxTrans.md" target="_blank">Transaction/RetailTransactionTaxTrans</a>|
|[Origin](#Origin)||<a href="RetailTransactionTaxTrans.md" target="_blank">Transaction/RetailTransactionTaxTrans</a>|
|[replicationCounterFromOrigin](#replicationCounterFromOrigin)||<a href="RetailTransactionTaxTrans.md" target="_blank">Transaction/RetailTransactionTaxTrans</a>|
|[SaleLineNum](#SaleLineNum)||<a href="RetailTransactionTaxTrans.md" target="_blank">Transaction/RetailTransactionTaxTrans</a>|
|[StoreId](#StoreId)||<a href="RetailTransactionTaxTrans.md" target="_blank">Transaction/RetailTransactionTaxTrans</a>|
|[TaxCode](#TaxCode)||<a href="RetailTransactionTaxTrans.md" target="_blank">Transaction/RetailTransactionTaxTrans</a>|
|[TerminalId](#TerminalId)||<a href="RetailTransactionTaxTrans.md" target="_blank">Transaction/RetailTransactionTaxTrans</a>|
|[TransactionId](#TransactionId)||<a href="RetailTransactionTaxTrans.md" target="_blank">Transaction/RetailTransactionTaxTrans</a>|
|[TaxBaseAmount](#TaxBaseAmount)||<a href="RetailTransactionTaxTrans.md" target="_blank">Transaction/RetailTransactionTaxTrans</a>|
|[TaxPercentage](#TaxPercentage)||<a href="RetailTransactionTaxTrans.md" target="_blank">Transaction/RetailTransactionTaxTrans</a>|
|[IsExempt](#IsExempt)||<a href="RetailTransactionTaxTrans.md" target="_blank">Transaction/RetailTransactionTaxTrans</a>|
|[DataAreaId](#DataAreaId)||<a href="RetailTransactionTaxTrans.md" target="_blank">Transaction/RetailTransactionTaxTrans</a>|
|[Relationship_RetailChannelTableRelationshipId](#Relationship_RetailChannelTableRelationshipId)||<a href="RetailTransactionTaxTrans.md" target="_blank">Transaction/RetailTransactionTaxTrans</a>|
|[Relationship_RetailStoreTableRelationshipId](#Relationship_RetailStoreTableRelationshipId)||<a href="RetailTransactionTaxTrans.md" target="_blank">Transaction/RetailTransactionTaxTrans</a>|
|[Relationship_RetailTerminalTableRelationshipId](#Relationship_RetailTerminalTableRelationshipId)||<a href="RetailTransactionTaxTrans.md" target="_blank">Transaction/RetailTransactionTaxTrans</a>|
|[Relationship_RetailTransactionTableRelationshipId](#Relationship_RetailTransactionTableRelationshipId)||<a href="RetailTransactionTaxTrans.md" target="_blank">Transaction/RetailTransactionTaxTrans</a>|
|[Relationship_TaxTableRelationshipId](#Relationship_TaxTableRelationshipId)||<a href="RetailTransactionTaxTrans.md" target="_blank">Transaction/RetailTransactionTaxTrans</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="RetailTransactionTaxTrans.md" target="_blank">Transaction/RetailTransactionTaxTrans</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Transaction/RetailTransactionTaxTrans (this entity)  
