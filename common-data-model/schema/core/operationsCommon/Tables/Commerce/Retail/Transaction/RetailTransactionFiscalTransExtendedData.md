---
title: RetailTransactionFiscalTransExtendedData - Common Data Model | Microsoft Docs
...
# RetailTransactionFiscalTransExtendedData
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/Commerce/Retail/Transaction/RetailTransactionFiscalTransExtendedData.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[RetailTransactionFiscalTransExtendedData/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="RetailTransactionFiscalTransExtendedData.md" target="_blank">Transaction/RetailTransactionFiscalTransExtendedData</a>|
|[DataKey](#DataKey)||<a href="RetailTransactionFiscalTransExtendedData.md" target="_blank">Transaction/RetailTransactionFiscalTransExtendedData</a>|
|[DataValue](#DataValue)||<a href="RetailTransactionFiscalTransExtendedData.md" target="_blank">Transaction/RetailTransactionFiscalTransExtendedData</a>|
|[Channel](#Channel)||<a href="RetailTransactionFiscalTransExtendedData.md" target="_blank">Transaction/RetailTransactionFiscalTransExtendedData</a>|
|[Store](#Store)||<a href="RetailTransactionFiscalTransExtendedData.md" target="_blank">Transaction/RetailTransactionFiscalTransExtendedData</a>|
|[Terminal](#Terminal)||<a href="RetailTransactionFiscalTransExtendedData.md" target="_blank">Transaction/RetailTransactionFiscalTransExtendedData</a>|
|[TransactionId](#TransactionId)||<a href="RetailTransactionFiscalTransExtendedData.md" target="_blank">Transaction/RetailTransactionFiscalTransExtendedData</a>|
|[FiscalTransLineNum](#FiscalTransLineNum)||<a href="RetailTransactionFiscalTransExtendedData.md" target="_blank">Transaction/RetailTransactionFiscalTransExtendedData</a>|
|[FiscalTransRecordGuid](#FiscalTransRecordGuid)||<a href="RetailTransactionFiscalTransExtendedData.md" target="_blank">Transaction/RetailTransactionFiscalTransExtendedData</a>|
|[ReplicationCounterFromOrigin](#ReplicationCounterFromOrigin)||<a href="RetailTransactionFiscalTransExtendedData.md" target="_blank">Transaction/RetailTransactionFiscalTransExtendedData</a>|
|[DataAreaId](#DataAreaId)||<a href="RetailTransactionFiscalTransExtendedData.md" target="_blank">Transaction/RetailTransactionFiscalTransExtendedData</a>|
|[Relationship_RetailTransactionFiscalTransRelationshipId](#Relationship_RetailTransactionFiscalTransRelationshipId)||<a href="RetailTransactionFiscalTransExtendedData.md" target="_blank">Transaction/RetailTransactionFiscalTransExtendedData</a>|
|[Relationship_RetailStoreTableRelationshipId](#Relationship_RetailStoreTableRelationshipId)||<a href="RetailTransactionFiscalTransExtendedData.md" target="_blank">Transaction/RetailTransactionFiscalTransExtendedData</a>|
|[Relationship_RetailChannelTableRelationshipId](#Relationship_RetailChannelTableRelationshipId)||<a href="RetailTransactionFiscalTransExtendedData.md" target="_blank">Transaction/RetailTransactionFiscalTransExtendedData</a>|
|[Relationship_RetailTransactionTableRelationshipId](#Relationship_RetailTransactionTableRelationshipId)||<a href="RetailTransactionFiscalTransExtendedData.md" target="_blank">Transaction/RetailTransactionFiscalTransExtendedData</a>|
|[Relationship_RetailTerminalTableRelationshipId](#Relationship_RetailTerminalTableRelationshipId)||<a href="RetailTransactionFiscalTransExtendedData.md" target="_blank">Transaction/RetailTransactionFiscalTransExtendedData</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="RetailTransactionFiscalTransExtendedData.md" target="_blank">Transaction/RetailTransactionFiscalTransExtendedData</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Transaction/RetailTransactionFiscalTransExtendedData (this entity)  
...
<details>
<summary>List of traits for the DataKey attribute are listed below.</summary>
...
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="RetailTransactionFiscalTrans.md" target="_blank">/core/operationsCommon/Tables/Commerce/Retail/Transaction/RetailTransactionFiscalTrans.cdm.json/RetailTransactionFiscalTrans</a></td><td><a href="RetailTransactionFiscalTrans.md#RecId" target="_blank">RecId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
