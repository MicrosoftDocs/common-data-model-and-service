---
title: RetailImportTable - Common Data Model | Microsoft Docs
...
# RetailImportTable
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/Commerce/Retail/Transaction/RetailImportTable.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[RetailImportTable/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="RetailImportTable.md" target="_blank">Transaction/RetailImportTable</a>|
|[Filename](#Filename)||<a href="RetailImportTable.md" target="_blank">Transaction/RetailImportTable</a>|
|[fileType](#fileType)||<a href="RetailImportTable.md" target="_blank">Transaction/RetailImportTable</a>|
|[importedFileId](#importedFileId)||<a href="RetailImportTable.md" target="_blank">Transaction/RetailImportTable</a>|
|[JournalId](#JournalId)||<a href="RetailImportTable.md" target="_blank">Transaction/RetailImportTable</a>|
|[PurchId](#PurchId)||<a href="RetailImportTable.md" target="_blank">Transaction/RetailImportTable</a>|
|[statusInItemImportJournal](#statusInItemImportJournal)||<a href="RetailImportTable.md" target="_blank">Transaction/RetailImportTable</a>|
|[statusInPurchaseOrder](#statusInPurchaseOrder)||<a href="RetailImportTable.md" target="_blank">Transaction/RetailImportTable</a>|
|[VendAccount](#VendAccount)||<a href="RetailImportTable.md" target="_blank">Transaction/RetailImportTable</a>|
|[DataAreaId](#DataAreaId)||<a href="RetailImportTable.md" target="_blank">Transaction/RetailImportTable</a>|
|[Relationship_PurchTableRelationshipId](#Relationship_PurchTableRelationshipId)||<a href="RetailImportTable.md" target="_blank">Transaction/RetailImportTable</a>|
|[Relationship_RetailImportJournalTableRelationshipId](#Relationship_RetailImportJournalTableRelationshipId)||<a href="RetailImportTable.md" target="_blank">Transaction/RetailImportTable</a>|
|[Relationship_VendTableRelationshipId](#Relationship_VendTableRelationshipId)||<a href="RetailImportTable.md" target="_blank">Transaction/RetailImportTable</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="RetailImportTable.md" target="_blank">Transaction/RetailImportTable</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Transaction/RetailImportTable (this entity)  
