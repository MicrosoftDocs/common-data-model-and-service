---
title: RetailSalesQuotationAffiliation - Common Data Model | Microsoft Docs
...
# RetailSalesQuotationAffiliation

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/Commerce/Retail/WorksheetLine/RetailSalesQuotationAffiliation.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[RetailSalesQuotationAffiliation/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="RetailSalesQuotationAffiliation.md" target="_blank">WorksheetLine/RetailSalesQuotationAffiliation</a>|
|[Affiliation](#Affiliation)||<a href="RetailSalesQuotationAffiliation.md" target="_blank">WorksheetLine/RetailSalesQuotationAffiliation</a>|
|[LoyaltyTier](#LoyaltyTier)||<a href="RetailSalesQuotationAffiliation.md" target="_blank">WorksheetLine/RetailSalesQuotationAffiliation</a>|
|[QuotationId](#QuotationId)||<a href="RetailSalesQuotationAffiliation.md" target="_blank">WorksheetLine/RetailSalesQuotationAffiliation</a>|
|[DataAreaId](#DataAreaId)||<a href="RetailSalesQuotationAffiliation.md" target="_blank">WorksheetLine/RetailSalesQuotationAffiliation</a>|
|[Relationship_RetailAffiliationRelationshipId](#Relationship_RetailAffiliationRelationshipId)||<a href="RetailSalesQuotationAffiliation.md" target="_blank">WorksheetLine/RetailSalesQuotationAffiliation</a>|
|[Relationship_RetailLoyaltyTierRelationshipId](#Relationship_RetailLoyaltyTierRelationshipId)||<a href="RetailSalesQuotationAffiliation.md" target="_blank">WorksheetLine/RetailSalesQuotationAffiliation</a>|
|[Relationship_SalesQuotationTableRelationshipId](#Relationship_SalesQuotationTableRelationshipId)||<a href="RetailSalesQuotationAffiliation.md" target="_blank">WorksheetLine/RetailSalesQuotationAffiliation</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="RetailSalesQuotationAffiliation.md" target="_blank">WorksheetLine/RetailSalesQuotationAffiliation</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: WorksheetLine/RetailSalesQuotationAffiliation (this entity)  
