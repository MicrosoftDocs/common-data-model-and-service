---
title: RetailGiftCardPayment_RU in Transaction - Common Data Model | Microsoft Docs
...
# Prepayments for gift cards in Transaction(RetailGiftCardPayment_RU)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/Commerce/Payments/Transaction/RetailGiftCardPayment_RU.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[RetailGiftCardPayment_RU/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Prepayments for gift cards</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="RetailGiftCardPayment_RU.md" target="_blank">Transaction/RetailGiftCardPayment_RU</a>|
|[Channel](#Channel)||<a href="RetailGiftCardPayment_RU.md" target="_blank">Transaction/RetailGiftCardPayment_RU</a>|
|[CustTrans](#CustTrans)||<a href="RetailGiftCardPayment_RU.md" target="_blank">Transaction/RetailGiftCardPayment_RU</a>|
|[GiftCardId](#GiftCardId)||<a href="RetailGiftCardPayment_RU.md" target="_blank">Transaction/RetailGiftCardPayment_RU</a>|
|[LedgerJournalTrans](#LedgerJournalTrans)||<a href="RetailGiftCardPayment_RU.md" target="_blank">Transaction/RetailGiftCardPayment_RU</a>|
|[Prepayment](#Prepayment)||<a href="RetailGiftCardPayment_RU.md" target="_blank">Transaction/RetailGiftCardPayment_RU</a>|
|[Store](#Store)||<a href="RetailGiftCardPayment_RU.md" target="_blank">Transaction/RetailGiftCardPayment_RU</a>|
|[TerminalId](#TerminalId)||<a href="RetailGiftCardPayment_RU.md" target="_blank">Transaction/RetailGiftCardPayment_RU</a>|
|[TransactionId](#TransactionId)||<a href="RetailGiftCardPayment_RU.md" target="_blank">Transaction/RetailGiftCardPayment_RU</a>|
|[TransDate](#TransDate)||<a href="RetailGiftCardPayment_RU.md" target="_blank">Transaction/RetailGiftCardPayment_RU</a>|
|[Voucher](#Voucher)||<a href="RetailGiftCardPayment_RU.md" target="_blank">Transaction/RetailGiftCardPayment_RU</a>|
|[DataAreaId](#DataAreaId)||<a href="RetailGiftCardPayment_RU.md" target="_blank">Transaction/RetailGiftCardPayment_RU</a>|
|[Relationship_CustTransRelationshipId](#Relationship_CustTransRelationshipId)||<a href="RetailGiftCardPayment_RU.md" target="_blank">Transaction/RetailGiftCardPayment_RU</a>|
|[Relationship_LedgerJournalTransRelationshipId](#Relationship_LedgerJournalTransRelationshipId)||<a href="RetailGiftCardPayment_RU.md" target="_blank">Transaction/RetailGiftCardPayment_RU</a>|
|[Relationship_RetailGiftCardTableRelationshipId](#Relationship_RetailGiftCardTableRelationshipId)||<a href="RetailGiftCardPayment_RU.md" target="_blank">Transaction/RetailGiftCardPayment_RU</a>|
|[Relationship_RetailStoreTableRelationshipId](#Relationship_RetailStoreTableRelationshipId)||<a href="RetailGiftCardPayment_RU.md" target="_blank">Transaction/RetailGiftCardPayment_RU</a>|
|[Relationship_RetailTerminalTableRelationshipId](#Relationship_RetailTerminalTableRelationshipId)||<a href="RetailGiftCardPayment_RU.md" target="_blank">Transaction/RetailGiftCardPayment_RU</a>|
|[Relationship_RetailTransactionTableRelationshipId](#Relationship_RetailTransactionTableRelationshipId)||<a href="RetailGiftCardPayment_RU.md" target="_blank">Transaction/RetailGiftCardPayment_RU</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="RetailGiftCardPayment_RU.md" target="_blank">Transaction/RetailGiftCardPayment_RU</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Transaction/RetailGiftCardPayment_RU (this entity)  
