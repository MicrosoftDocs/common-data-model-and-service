---
title: RetailDataEntryTrans in Transaction - Common Data Model | Microsoft Docs
...
# Data entry transaction in Transaction(RetailDataEntryTrans)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/Commerce/CommerceEmployees/Transaction/RetailDataEntryTrans.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[RetailDataEntryTrans/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Data entry transaction</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="RetailDataEntryTrans.md" target="_blank">Transaction/RetailDataEntryTrans</a>|
|[reservedByTerminalId](#reservedByTerminalId)||<a href="RetailDataEntryTrans.md" target="_blank">Transaction/RetailDataEntryTrans</a>|
|[createdInStoreId](#createdInStoreId)||<a href="RetailDataEntryTrans.md" target="_blank">Transaction/RetailDataEntryTrans</a>|
|[amount](#amount)||<a href="RetailDataEntryTrans.md" target="_blank">Transaction/RetailDataEntryTrans</a>|
|[applied](#applied)||<a href="RetailDataEntryTrans.md" target="_blank">Transaction/RetailDataEntryTrans</a>|
|[appliedAmount](#appliedAmount)||<a href="RetailDataEntryTrans.md" target="_blank">Transaction/RetailDataEntryTrans</a>|
|[appliedByLineNum](#appliedByLineNum)||<a href="RetailDataEntryTrans.md" target="_blank">Transaction/RetailDataEntryTrans</a>|
|[appliedByReceiptId](#appliedByReceiptId)||<a href="RetailDataEntryTrans.md" target="_blank">Transaction/RetailDataEntryTrans</a>|
|[appliedByStaffId](#appliedByStaffId)||<a href="RetailDataEntryTrans.md" target="_blank">Transaction/RetailDataEntryTrans</a>|
|[appliedByTerminalId](#appliedByTerminalId)||<a href="RetailDataEntryTrans.md" target="_blank">Transaction/RetailDataEntryTrans</a>|
|[appliedDate](#appliedDate)||<a href="RetailDataEntryTrans.md" target="_blank">Transaction/RetailDataEntryTrans</a>|
|[appliedInStoreId](#appliedInStoreId)||<a href="RetailDataEntryTrans.md" target="_blank">Transaction/RetailDataEntryTrans</a>|
|[appliedTime](#appliedTime)||<a href="RetailDataEntryTrans.md" target="_blank">Transaction/RetailDataEntryTrans</a>|
|[createdByLineNum](#createdByLineNum)||<a href="RetailDataEntryTrans.md" target="_blank">Transaction/RetailDataEntryTrans</a>|
|[createdByReceipId](#createdByReceipId)||<a href="RetailDataEntryTrans.md" target="_blank">Transaction/RetailDataEntryTrans</a>|
|[createdByStaffId](#createdByStaffId)||<a href="RetailDataEntryTrans.md" target="_blank">Transaction/RetailDataEntryTrans</a>|
|[createdByTerminalId](#createdByTerminalId)||<a href="RetailDataEntryTrans.md" target="_blank">Transaction/RetailDataEntryTrans</a>|
|[entryId](#entryId)||<a href="RetailDataEntryTrans.md" target="_blank">Transaction/RetailDataEntryTrans</a>|
|[entryTypeId](#entryTypeId)||<a href="RetailDataEntryTrans.md" target="_blank">Transaction/RetailDataEntryTrans</a>|
|[replicationCounter](#replicationCounter)||<a href="RetailDataEntryTrans.md" target="_blank">Transaction/RetailDataEntryTrans</a>|
|[transDate](#transDate)||<a href="RetailDataEntryTrans.md" target="_blank">Transaction/RetailDataEntryTrans</a>|
|[transTime](#transTime)||<a href="RetailDataEntryTrans.md" target="_blank">Transaction/RetailDataEntryTrans</a>|
|[DataAreaId](#DataAreaId)||<a href="RetailDataEntryTrans.md" target="_blank">Transaction/RetailDataEntryTrans</a>|
|[Relationship_RetailDataEntryTypeTableRelationshipId](#Relationship_RetailDataEntryTypeTableRelationshipId)||<a href="RetailDataEntryTrans.md" target="_blank">Transaction/RetailDataEntryTrans</a>|
|[Relationship_RetailStoreTableRelationshipId](#Relationship_RetailStoreTableRelationshipId)||<a href="RetailDataEntryTrans.md" target="_blank">Transaction/RetailDataEntryTrans</a>|
|[Relationship_RetailStoreTable1RelationshipId](#Relationship_RetailStoreTable1RelationshipId)||<a href="RetailDataEntryTrans.md" target="_blank">Transaction/RetailDataEntryTrans</a>|
|[Relationship_RetailTerminalTableRelationshipId](#Relationship_RetailTerminalTableRelationshipId)||<a href="RetailDataEntryTrans.md" target="_blank">Transaction/RetailDataEntryTrans</a>|
|[Relationship_RetailTerminalTable1RelationshipId](#Relationship_RetailTerminalTable1RelationshipId)||<a href="RetailDataEntryTrans.md" target="_blank">Transaction/RetailDataEntryTrans</a>|
|[Relationship_RetailTerminalTable2RelationshipId](#Relationship_RetailTerminalTable2RelationshipId)||<a href="RetailDataEntryTrans.md" target="_blank">Transaction/RetailDataEntryTrans</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="RetailDataEntryTrans.md" target="_blank">Transaction/RetailDataEntryTrans</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Transaction/RetailDataEntryTrans (this entity)  
...
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="../Parameter/RetailDataEntryTypeTable.md" target="_blank">/core/operationsCommon/Tables/Commerce/CommerceEmployees/Parameter/RetailDataEntryTypeTable.cdm.json/RetailDataEntryTypeTable</a></td><td><a href="../Parameter/RetailDataEntryTypeTable.md#RecId" target="_blank">RecId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
