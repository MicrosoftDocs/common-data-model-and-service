---
title: RetailPubRetailChannelCategoryAttribute in Miscellaneous - Common Data Model | Microsoft Docs
...
# Channel category attribute in Miscellaneous(RetailPubRetailChannelCategoryAttribute)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/Commerce/Merchandising/Miscellaneous/RetailPubRetailChannelCategoryAttribute.cdm.json" target="_blank">GitHub</a>.  
...
|[Relationship_RetailChannelCategoryAttributeRelationshipId](#Relationship_RetailChannelCategoryAttributeRelationshipId)||<a href="RetailPubRetailChannelCategoryAttribute.md" target="_blank">Miscellaneous/RetailPubRetailChannelCategoryAttribute</a>|
...
### <a href=#Relationship_RetailChannelCategoryAttributeRelationshipId name="Relationship_RetailChannelCategoryAttributeRelationshipId">Relationship_RetailChannelCategoryAttributeRelationshipId</a>
...
<details>
<summary>List of traits for the Relationship_RetailChannelCategoryAttributeRelationshipId attribute are listed below.</summary>
...
**means.identity.entityId**  
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="../../ChannelManagement/Miscellaneous/RetailChannelCategoryAttribute.md" target="_blank">/core/operationsCommon/Tables/Commerce/ChannelManagement/Miscellaneous/RetailChannelCategoryAttribute.cdm.json/RetailChannelCategoryAttribute</a></td><td><a href="../../ChannelManagement/Miscellaneous/RetailChannelCategoryAttribute.md#RecId" target="_blank">RecId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
