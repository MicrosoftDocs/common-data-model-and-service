---
title: RetailTransactionAddressTrans in Miscellaneous - Common Data Model | Microsoft Docs
...
# Retail Transaction Address in Miscellaneous(RetailTransactionAddressTrans)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/Commerce/TransactionsAndOrders/Miscellaneous/RetailTransactionAddressTrans.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[RetailTransactionAddressTrans/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Retail Transaction Address</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="RetailTransactionAddressTrans.md" target="_blank">Miscellaneous/RetailTransactionAddressTrans</a>|
|[AttentionToAddressLine](#AttentionToAddressLine)||<a href="RetailTransactionAddressTrans.md" target="_blank">Miscellaneous/RetailTransactionAddressTrans</a>|
|[Channel](#Channel)||<a href="RetailTransactionAddressTrans.md" target="_blank">Miscellaneous/RetailTransactionAddressTrans</a>|
|[City](#City)||<a href="RetailTransactionAddressTrans.md" target="_blank">Miscellaneous/RetailTransactionAddressTrans</a>|
|[CountryRegionId](#CountryRegionId)||<a href="RetailTransactionAddressTrans.md" target="_blank">Miscellaneous/RetailTransactionAddressTrans</a>|
|[County](#County)||<a href="RetailTransactionAddressTrans.md" target="_blank">Miscellaneous/RetailTransactionAddressTrans</a>|
|[DeliveryName](#DeliveryName)||<a href="RetailTransactionAddressTrans.md" target="_blank">Miscellaneous/RetailTransactionAddressTrans</a>|
|[DistrictName](#DistrictName)||<a href="RetailTransactionAddressTrans.md" target="_blank">Miscellaneous/RetailTransactionAddressTrans</a>|
|[Email](#Email)||<a href="RetailTransactionAddressTrans.md" target="_blank">Miscellaneous/RetailTransactionAddressTrans</a>|
|[EmailContent](#EmailContent)||<a href="RetailTransactionAddressTrans.md" target="_blank">Miscellaneous/RetailTransactionAddressTrans</a>|
|[Origin](#Origin)||<a href="RetailTransactionAddressTrans.md" target="_blank">Miscellaneous/RetailTransactionAddressTrans</a>|
|[Phone](#Phone)||<a href="RetailTransactionAddressTrans.md" target="_blank">Miscellaneous/RetailTransactionAddressTrans</a>|
|[ReplicationCounterFromOrigin](#ReplicationCounterFromOrigin)||<a href="RetailTransactionAddressTrans.md" target="_blank">Miscellaneous/RetailTransactionAddressTrans</a>|
|[SaleLineNum](#SaleLineNum)||<a href="RetailTransactionAddressTrans.md" target="_blank">Miscellaneous/RetailTransactionAddressTrans</a>|
|[SalesName](#SalesName)||<a href="RetailTransactionAddressTrans.md" target="_blank">Miscellaneous/RetailTransactionAddressTrans</a>|
|[State](#State)||<a href="RetailTransactionAddressTrans.md" target="_blank">Miscellaneous/RetailTransactionAddressTrans</a>|
|[store](#store)||<a href="RetailTransactionAddressTrans.md" target="_blank">Miscellaneous/RetailTransactionAddressTrans</a>|
|[Street](#Street)||<a href="RetailTransactionAddressTrans.md" target="_blank">Miscellaneous/RetailTransactionAddressTrans</a>|
|[StreetNumber](#StreetNumber)||<a href="RetailTransactionAddressTrans.md" target="_blank">Miscellaneous/RetailTransactionAddressTrans</a>|
|[terminal](#terminal)||<a href="RetailTransactionAddressTrans.md" target="_blank">Miscellaneous/RetailTransactionAddressTrans</a>|
|[transactionId](#transactionId)||<a href="RetailTransactionAddressTrans.md" target="_blank">Miscellaneous/RetailTransactionAddressTrans</a>|
|[ZipCode](#ZipCode)||<a href="RetailTransactionAddressTrans.md" target="_blank">Miscellaneous/RetailTransactionAddressTrans</a>|
|[DataAreaId](#DataAreaId)||<a href="RetailTransactionAddressTrans.md" target="_blank">Miscellaneous/RetailTransactionAddressTrans</a>|
|[Relationship_LogisticsAddressCountryRegionRelationshipId](#Relationship_LogisticsAddressCountryRegionRelationshipId)||<a href="RetailTransactionAddressTrans.md" target="_blank">Miscellaneous/RetailTransactionAddressTrans</a>|
|[Relationship_RetailChannelTableRelationshipId](#Relationship_RetailChannelTableRelationshipId)||<a href="RetailTransactionAddressTrans.md" target="_blank">Miscellaneous/RetailTransactionAddressTrans</a>|
|[Relationship_RetailStoreTableRelationshipId](#Relationship_RetailStoreTableRelationshipId)||<a href="RetailTransactionAddressTrans.md" target="_blank">Miscellaneous/RetailTransactionAddressTrans</a>|
|[Relationship_RetailTerminalTableRelationshipId](#Relationship_RetailTerminalTableRelationshipId)||<a href="RetailTransactionAddressTrans.md" target="_blank">Miscellaneous/RetailTransactionAddressTrans</a>|
|[Relationship_RetailTransactionSalesTransRelationshipId](#Relationship_RetailTransactionSalesTransRelationshipId)||<a href="RetailTransactionAddressTrans.md" target="_blank">Miscellaneous/RetailTransactionAddressTrans</a>|
|[Relationship_RetailTransactionTableRelationshipId](#Relationship_RetailTransactionTableRelationshipId)||<a href="RetailTransactionAddressTrans.md" target="_blank">Miscellaneous/RetailTransactionAddressTrans</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="RetailTransactionAddressTrans.md" target="_blank">Miscellaneous/RetailTransactionAddressTrans</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Miscellaneous/RetailTransactionAddressTrans (this entity)  
...
### <a href=#EmailContent name="EmailContent">EmailContent</a>
...
<details>
<summary>List of traits for the EmailContent attribute are listed below.</summary>
