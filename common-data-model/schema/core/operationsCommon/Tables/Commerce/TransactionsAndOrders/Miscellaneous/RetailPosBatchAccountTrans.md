---
title: RetailPosBatchAccountTrans in Miscellaneous - Common Data Model | Microsoft Docs
...
# Shift account transactions in Miscellaneous(RetailPosBatchAccountTrans)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/Commerce/TransactionsAndOrders/Miscellaneous/RetailPosBatchAccountTrans.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[RetailPosBatchAccountTrans/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Shift account transactions</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="RetailPosBatchAccountTrans.md" target="_blank">Miscellaneous/RetailPosBatchAccountTrans</a>|
|[AccountNum](#AccountNum)||<a href="RetailPosBatchAccountTrans.md" target="_blank">Miscellaneous/RetailPosBatchAccountTrans</a>|
|[AccountType](#AccountType)||<a href="RetailPosBatchAccountTrans.md" target="_blank">Miscellaneous/RetailPosBatchAccountTrans</a>|
|[Amount](#Amount)||<a href="RetailPosBatchAccountTrans.md" target="_blank">Miscellaneous/RetailPosBatchAccountTrans</a>|
|[BatchID](#BatchID)||<a href="RetailPosBatchAccountTrans.md" target="_blank">Miscellaneous/RetailPosBatchAccountTrans</a>|
|[Channel](#Channel)||<a href="RetailPosBatchAccountTrans.md" target="_blank">Miscellaneous/RetailPosBatchAccountTrans</a>|
|[Origin](#Origin)||<a href="RetailPosBatchAccountTrans.md" target="_blank">Miscellaneous/RetailPosBatchAccountTrans</a>|
|[ReplicationCounter](#ReplicationCounter)||<a href="RetailPosBatchAccountTrans.md" target="_blank">Miscellaneous/RetailPosBatchAccountTrans</a>|
|[StoreId](#StoreId)||<a href="RetailPosBatchAccountTrans.md" target="_blank">Miscellaneous/RetailPosBatchAccountTrans</a>|
|[TerminalId](#TerminalId)||<a href="RetailPosBatchAccountTrans.md" target="_blank">Miscellaneous/RetailPosBatchAccountTrans</a>|
|[DataAreaId](#DataAreaId)||<a href="RetailPosBatchAccountTrans.md" target="_blank">Miscellaneous/RetailPosBatchAccountTrans</a>|
|[Relationship_RetailChannelTableRelationshipId](#Relationship_RetailChannelTableRelationshipId)||<a href="RetailPosBatchAccountTrans.md" target="_blank">Miscellaneous/RetailPosBatchAccountTrans</a>|
|[Relationship_RetailIncomeExpenseAccountTableRelationshipId](#Relationship_RetailIncomeExpenseAccountTableRelationshipId)||<a href="RetailPosBatchAccountTrans.md" target="_blank">Miscellaneous/RetailPosBatchAccountTrans</a>|
|[Relationship_RetailPosBatchTableRelationshipId](#Relationship_RetailPosBatchTableRelationshipId)||<a href="RetailPosBatchAccountTrans.md" target="_blank">Miscellaneous/RetailPosBatchAccountTrans</a>|
|[Relationship_RetailStoreTableRelationshipId](#Relationship_RetailStoreTableRelationshipId)||<a href="RetailPosBatchAccountTrans.md" target="_blank">Miscellaneous/RetailPosBatchAccountTrans</a>|
|[Relationship_RetailTerminalTableRelationshipId](#Relationship_RetailTerminalTableRelationshipId)||<a href="RetailPosBatchAccountTrans.md" target="_blank">Miscellaneous/RetailPosBatchAccountTrans</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="RetailPosBatchAccountTrans.md" target="_blank">Miscellaneous/RetailPosBatchAccountTrans</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Miscellaneous/RetailPosBatchAccountTrans (this entity)  
