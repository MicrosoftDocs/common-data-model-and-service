---
title: RetailTransactionAttributeTrans in Miscellaneous - Common Data Model | Microsoft Docs
...
# Sales order attributes in Miscellaneous(RetailTransactionAttributeTrans)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/Commerce/TransactionsAndOrders/Miscellaneous/RetailTransactionAttributeTrans.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[RetailTransactionAttributeTrans/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Sales order attributes</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="RetailTransactionAttributeTrans.md" target="_blank">Miscellaneous/RetailTransactionAttributeTrans</a>|
|[Channel](#Channel)||<a href="RetailTransactionAttributeTrans.md" target="_blank">Miscellaneous/RetailTransactionAttributeTrans</a>|
|[Name](#Name)||<a href="RetailTransactionAttributeTrans.md" target="_blank">Miscellaneous/RetailTransactionAttributeTrans</a>|
|[Origin](#Origin)||<a href="RetailTransactionAttributeTrans.md" target="_blank">Miscellaneous/RetailTransactionAttributeTrans</a>|
|[replicationCounterFromOrigin](#replicationCounterFromOrigin)||<a href="RetailTransactionAttributeTrans.md" target="_blank">Miscellaneous/RetailTransactionAttributeTrans</a>|
|[store](#store)||<a href="RetailTransactionAttributeTrans.md" target="_blank">Miscellaneous/RetailTransactionAttributeTrans</a>|
|[terminal](#terminal)||<a href="RetailTransactionAttributeTrans.md" target="_blank">Miscellaneous/RetailTransactionAttributeTrans</a>|
|[TextValue](#TextValue)||<a href="RetailTransactionAttributeTrans.md" target="_blank">Miscellaneous/RetailTransactionAttributeTrans</a>|
|[transactionId](#transactionId)||<a href="RetailTransactionAttributeTrans.md" target="_blank">Miscellaneous/RetailTransactionAttributeTrans</a>|
|[HeaderOrLineNum](#HeaderOrLineNum)||<a href="RetailTransactionAttributeTrans.md" target="_blank">Miscellaneous/RetailTransactionAttributeTrans</a>|
|[DataAreaId](#DataAreaId)||<a href="RetailTransactionAttributeTrans.md" target="_blank">Miscellaneous/RetailTransactionAttributeTrans</a>|
|[Relationship_RetailChannelTableRelationshipId](#Relationship_RetailChannelTableRelationshipId)||<a href="RetailTransactionAttributeTrans.md" target="_blank">Miscellaneous/RetailTransactionAttributeTrans</a>|
|[Relationship_RetailStoreTableRelationshipId](#Relationship_RetailStoreTableRelationshipId)||<a href="RetailTransactionAttributeTrans.md" target="_blank">Miscellaneous/RetailTransactionAttributeTrans</a>|
|[Relationship_RetailTerminalTableRelationshipId](#Relationship_RetailTerminalTableRelationshipId)||<a href="RetailTransactionAttributeTrans.md" target="_blank">Miscellaneous/RetailTransactionAttributeTrans</a>|
|[Relationship_RetailTransactionTableRelationshipId](#Relationship_RetailTransactionTableRelationshipId)||<a href="RetailTransactionAttributeTrans.md" target="_blank">Miscellaneous/RetailTransactionAttributeTrans</a>|
|[Relationship_RetailTransactionSalesTransRelationshipId](#Relationship_RetailTransactionSalesTransRelationshipId)||<a href="RetailTransactionAttributeTrans.md" target="_blank">Miscellaneous/RetailTransactionAttributeTrans</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="RetailTransactionAttributeTrans.md" target="_blank">Miscellaneous/RetailTransactionAttributeTrans</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Miscellaneous/RetailTransactionAttributeTrans (this entity)  
...
### <a href=#HeaderOrLineNum name="HeaderOrLineNum">HeaderOrLineNum</a>
...
<details>
<summary>List of traits for the HeaderOrLineNum attribute are listed below.</summary>
...
**means.identity.entityId**  
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="../Transaction/RetailTransactionSalesTrans.md" target="_blank">/core/operationsCommon/Tables/Commerce/TransactionsAndOrders/Transaction/RetailTransactionSalesTrans.cdm.json/RetailTransactionSalesTrans</a></td><td><a href="../Transaction/RetailTransactionSalesTrans.md#RecId" target="_blank">RecId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
