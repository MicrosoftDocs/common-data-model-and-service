---
title: RetailTransactionTableEx5 in Transaction - Common Data Model | Microsoft Docs
...
# Transaction table in Transaction(RetailTransactionTableEx5)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/Commerce/TransactionsAndOrders/Transaction/RetailTransactionTableEx5.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[RetailTransactionTableEx5/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="RetailTransactionTableEx5.md" target="_blank">Transaction/RetailTransactionTableEx5</a>|
|[byteLength](#byteLength)||<a href="RetailTransactionTableEx5.md" target="_blank">Transaction/RetailTransactionTableEx5</a>|
|[storeId](#storeId)||<a href="RetailTransactionTableEx5.md" target="_blank">Transaction/RetailTransactionTableEx5</a>|
|[terminalId](#terminalId)||<a href="RetailTransactionTableEx5.md" target="_blank">Transaction/RetailTransactionTableEx5</a>|
|[transactionData](#transactionData)||<a href="RetailTransactionTableEx5.md" target="_blank">Transaction/RetailTransactionTableEx5</a>|
|[transactionId](#transactionId)||<a href="RetailTransactionTableEx5.md" target="_blank">Transaction/RetailTransactionTableEx5</a>|
|[DataAreaId](#DataAreaId)||<a href="RetailTransactionTableEx5.md" target="_blank">Transaction/RetailTransactionTableEx5</a>|
|[Relationship_RetailStoreTableRelationshipId](#Relationship_RetailStoreTableRelationshipId)||<a href="RetailTransactionTableEx5.md" target="_blank">Transaction/RetailTransactionTableEx5</a>|
|[Relationship_RetailTerminalTableRelationshipId](#Relationship_RetailTerminalTableRelationshipId)||<a href="RetailTransactionTableEx5.md" target="_blank">Transaction/RetailTransactionTableEx5</a>|
|[Relationship_RetailTransactionTableRelationshipId](#Relationship_RetailTransactionTableRelationshipId)||<a href="RetailTransactionTableEx5.md" target="_blank">Transaction/RetailTransactionTableEx5</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="RetailTransactionTableEx5.md" target="_blank">Transaction/RetailTransactionTableEx5</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Transaction/RetailTransactionTableEx5 (this entity)  
