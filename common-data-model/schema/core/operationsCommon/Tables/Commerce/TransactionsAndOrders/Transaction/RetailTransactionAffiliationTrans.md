---
title: RetailTransactionAffiliationTrans in Transaction - Common Data Model | Microsoft Docs
...
# Affiliations for transactions in Transaction(RetailTransactionAffiliationTrans)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/Commerce/TransactionsAndOrders/Transaction/RetailTransactionAffiliationTrans.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[RetailTransactionAffiliationTrans/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="RetailTransactionAffiliationTrans.md" target="_blank">Transaction/RetailTransactionAffiliationTrans</a>|
|[Affiliation](#Affiliation)||<a href="RetailTransactionAffiliationTrans.md" target="_blank">Transaction/RetailTransactionAffiliationTrans</a>|
|[Channel](#Channel)||<a href="RetailTransactionAffiliationTrans.md" target="_blank">Transaction/RetailTransactionAffiliationTrans</a>|
|[LoyaltyTier](#LoyaltyTier)||<a href="RetailTransactionAffiliationTrans.md" target="_blank">Transaction/RetailTransactionAffiliationTrans</a>|
|[ReceiptId](#ReceiptId)||<a href="RetailTransactionAffiliationTrans.md" target="_blank">Transaction/RetailTransactionAffiliationTrans</a>|
|[replicationCounterFromOrigin](#replicationCounterFromOrigin)||<a href="RetailTransactionAffiliationTrans.md" target="_blank">Transaction/RetailTransactionAffiliationTrans</a>|
|[StaffId](#StaffId)||<a href="RetailTransactionAffiliationTrans.md" target="_blank">Transaction/RetailTransactionAffiliationTrans</a>|
|[StoreId](#StoreId)||<a href="RetailTransactionAffiliationTrans.md" target="_blank">Transaction/RetailTransactionAffiliationTrans</a>|
|[TerminalId](#TerminalId)||<a href="RetailTransactionAffiliationTrans.md" target="_blank">Transaction/RetailTransactionAffiliationTrans</a>|
|[TransactionId](#TransactionId)||<a href="RetailTransactionAffiliationTrans.md" target="_blank">Transaction/RetailTransactionAffiliationTrans</a>|
|[DataAreaId](#DataAreaId)||<a href="RetailTransactionAffiliationTrans.md" target="_blank">Transaction/RetailTransactionAffiliationTrans</a>|
|[Relationship_RetailAffiliationRelationshipId](#Relationship_RetailAffiliationRelationshipId)||<a href="RetailTransactionAffiliationTrans.md" target="_blank">Transaction/RetailTransactionAffiliationTrans</a>|
|[Relationship_RetailChannelTableRelationshipId](#Relationship_RetailChannelTableRelationshipId)||<a href="RetailTransactionAffiliationTrans.md" target="_blank">Transaction/RetailTransactionAffiliationTrans</a>|
|[Relationship_RetailLoyaltyTierRelationshipId](#Relationship_RetailLoyaltyTierRelationshipId)||<a href="RetailTransactionAffiliationTrans.md" target="_blank">Transaction/RetailTransactionAffiliationTrans</a>|
|[Relationship_RetailStoreTableRelationshipId](#Relationship_RetailStoreTableRelationshipId)||<a href="RetailTransactionAffiliationTrans.md" target="_blank">Transaction/RetailTransactionAffiliationTrans</a>|
|[Relationship_RetailTerminalTableRelationshipId](#Relationship_RetailTerminalTableRelationshipId)||<a href="RetailTransactionAffiliationTrans.md" target="_blank">Transaction/RetailTransactionAffiliationTrans</a>|
|[Relationship_RetailTransactionTableRelationshipId](#Relationship_RetailTransactionTableRelationshipId)||<a href="RetailTransactionAffiliationTrans.md" target="_blank">Transaction/RetailTransactionAffiliationTrans</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="RetailTransactionAffiliationTrans.md" target="_blank">Transaction/RetailTransactionAffiliationTrans</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Transaction/RetailTransactionAffiliationTrans (this entity)  
