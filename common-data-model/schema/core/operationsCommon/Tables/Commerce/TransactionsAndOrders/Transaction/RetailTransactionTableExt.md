---
title: RetailTransactionTableExt in Transaction - Common Data Model | Microsoft Docs
...
# Transactions in Transaction(RetailTransactionTableExt)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/Commerce/TransactionsAndOrders/Transaction/RetailTransactionTableExt.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[RetailTransactionTableExt/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="RetailTransactionTableExt.md" target="_blank">Transaction/RetailTransactionTableExt</a>|
|[Channel](#Channel)||<a href="RetailTransactionTableExt.md" target="_blank">Transaction/RetailTransactionTableExt</a>|
|[DiscAmountExclPrepayment](#DiscAmountExclPrepayment)||<a href="RetailTransactionTableExt.md" target="_blank">Transaction/RetailTransactionTableExt</a>|
|[NetAmountExclPrepayment](#NetAmountExclPrepayment)||<a href="RetailTransactionTableExt.md" target="_blank">Transaction/RetailTransactionTableExt</a>|
|[Store](#Store)||<a href="RetailTransactionTableExt.md" target="_blank">Transaction/RetailTransactionTableExt</a>|
|[TaxAmountExclPrepayment](#TaxAmountExclPrepayment)||<a href="RetailTransactionTableExt.md" target="_blank">Transaction/RetailTransactionTableExt</a>|
|[Terminal](#Terminal)||<a href="RetailTransactionTableExt.md" target="_blank">Transaction/RetailTransactionTableExt</a>|
|[TransactionId](#TransactionId)||<a href="RetailTransactionTableExt.md" target="_blank">Transaction/RetailTransactionTableExt</a>|
|[DataAreaId](#DataAreaId)||<a href="RetailTransactionTableExt.md" target="_blank">Transaction/RetailTransactionTableExt</a>|
|[Relationship_RetailChannelTableRelationshipId](#Relationship_RetailChannelTableRelationshipId)||<a href="RetailTransactionTableExt.md" target="_blank">Transaction/RetailTransactionTableExt</a>|
|[Relationship_RetailStoreTableRelationshipId](#Relationship_RetailStoreTableRelationshipId)||<a href="RetailTransactionTableExt.md" target="_blank">Transaction/RetailTransactionTableExt</a>|
|[Relationship_RetailTerminalTableRelationshipId](#Relationship_RetailTerminalTableRelationshipId)||<a href="RetailTransactionTableExt.md" target="_blank">Transaction/RetailTransactionTableExt</a>|
|[Relationship_RetailTransactionTableRelationshipId](#Relationship_RetailTransactionTableRelationshipId)||<a href="RetailTransactionTableExt.md" target="_blank">Transaction/RetailTransactionTableExt</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="RetailTransactionTableExt.md" target="_blank">Transaction/RetailTransactionTableExt</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Transaction/RetailTransactionTableExt (this entity)  
...
### <a href=#DiscAmountExclPrepayment name="DiscAmountExclPrepayment">DiscAmountExclPrepayment</a>
...
<details>
<summary>List of traits for the DiscAmountExclPrepayment attribute are listed below.</summary>
...
### <a href=#NetAmountExclPrepayment name="NetAmountExclPrepayment">NetAmountExclPrepayment</a>
...
<details>
<summary>List of traits for the NetAmountExclPrepayment attribute are listed below.</summary>
...
### <a href=#TaxAmountExclPrepayment name="TaxAmountExclPrepayment">TaxAmountExclPrepayment</a>
...
<details>
<summary>List of traits for the TaxAmountExclPrepayment attribute are listed below.</summary>
