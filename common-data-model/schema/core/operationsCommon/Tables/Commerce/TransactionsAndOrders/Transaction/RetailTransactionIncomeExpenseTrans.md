---
title: RetailTransactionIncomeExpenseTrans in Transaction - Common Data Model | Microsoft Docs
...
# Income/Expense transaction in Transaction(RetailTransactionIncomeExpenseTrans)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/Commerce/TransactionsAndOrders/Transaction/RetailTransactionIncomeExpenseTrans.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[RetailTransactionIncomeExpenseTrans/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Income/Expense transaction</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="RetailTransactionIncomeExpenseTrans.md" target="_blank">Transaction/RetailTransactionIncomeExpenseTrans</a>|
|[accountType](#accountType)||<a href="RetailTransactionIncomeExpenseTrans.md" target="_blank">Transaction/RetailTransactionIncomeExpenseTrans</a>|
|[amount](#amount)||<a href="RetailTransactionIncomeExpenseTrans.md" target="_blank">Transaction/RetailTransactionIncomeExpenseTrans</a>|
|[businessDate](#businessDate)||<a href="RetailTransactionIncomeExpenseTrans.md" target="_blank">Transaction/RetailTransactionIncomeExpenseTrans</a>|
|[Channel](#Channel)||<a href="RetailTransactionIncomeExpenseTrans.md" target="_blank">Transaction/RetailTransactionIncomeExpenseTrans</a>|
|[counter](#counter)||<a href="RetailTransactionIncomeExpenseTrans.md" target="_blank">Transaction/RetailTransactionIncomeExpenseTrans</a>|
|[incomeExepenseAccount](#incomeExepenseAccount)||<a href="RetailTransactionIncomeExpenseTrans.md" target="_blank">Transaction/RetailTransactionIncomeExpenseTrans</a>|
|[lineNum](#lineNum)||<a href="RetailTransactionIncomeExpenseTrans.md" target="_blank">Transaction/RetailTransactionIncomeExpenseTrans</a>|
|[Origin](#Origin)||<a href="RetailTransactionIncomeExpenseTrans.md" target="_blank">Transaction/RetailTransactionIncomeExpenseTrans</a>|
|[receiptId](#receiptId)||<a href="RetailTransactionIncomeExpenseTrans.md" target="_blank">Transaction/RetailTransactionIncomeExpenseTrans</a>|
|[replicated](#replicated)||<a href="RetailTransactionIncomeExpenseTrans.md" target="_blank">Transaction/RetailTransactionIncomeExpenseTrans</a>|
|[replicationCounterFromOrigin](#replicationCounterFromOrigin)||<a href="RetailTransactionIncomeExpenseTrans.md" target="_blank">Transaction/RetailTransactionIncomeExpenseTrans</a>|
|[shift](#shift)||<a href="RetailTransactionIncomeExpenseTrans.md" target="_blank">Transaction/RetailTransactionIncomeExpenseTrans</a>|
|[shiftDate](#shiftDate)||<a href="RetailTransactionIncomeExpenseTrans.md" target="_blank">Transaction/RetailTransactionIncomeExpenseTrans</a>|
|[staff](#staff)||<a href="RetailTransactionIncomeExpenseTrans.md" target="_blank">Transaction/RetailTransactionIncomeExpenseTrans</a>|
|[statementCode](#statementCode)||<a href="RetailTransactionIncomeExpenseTrans.md" target="_blank">Transaction/RetailTransactionIncomeExpenseTrans</a>|
|[statementId](#statementId)||<a href="RetailTransactionIncomeExpenseTrans.md" target="_blank">Transaction/RetailTransactionIncomeExpenseTrans</a>|
|[store](#store)||<a href="RetailTransactionIncomeExpenseTrans.md" target="_blank">Transaction/RetailTransactionIncomeExpenseTrans</a>|
|[terminal](#terminal)||<a href="RetailTransactionIncomeExpenseTrans.md" target="_blank">Transaction/RetailTransactionIncomeExpenseTrans</a>|
|[transactionId](#transactionId)||<a href="RetailTransactionIncomeExpenseTrans.md" target="_blank">Transaction/RetailTransactionIncomeExpenseTrans</a>|
|[transactionStatus](#transactionStatus)||<a href="RetailTransactionIncomeExpenseTrans.md" target="_blank">Transaction/RetailTransactionIncomeExpenseTrans</a>|
|[transDate](#transDate)||<a href="RetailTransactionIncomeExpenseTrans.md" target="_blank">Transaction/RetailTransactionIncomeExpenseTrans</a>|
|[transTime](#transTime)||<a href="RetailTransactionIncomeExpenseTrans.md" target="_blank">Transaction/RetailTransactionIncomeExpenseTrans</a>|
|[DataAreaId](#DataAreaId)||<a href="RetailTransactionIncomeExpenseTrans.md" target="_blank">Transaction/RetailTransactionIncomeExpenseTrans</a>|
|[Relationship_RetailChannelTableRelationshipId](#Relationship_RetailChannelTableRelationshipId)||<a href="RetailTransactionIncomeExpenseTrans.md" target="_blank">Transaction/RetailTransactionIncomeExpenseTrans</a>|
|[Relationship_RetailIncomeExpenseAccountTableRelationshipId](#Relationship_RetailIncomeExpenseAccountTableRelationshipId)||<a href="RetailTransactionIncomeExpenseTrans.md" target="_blank">Transaction/RetailTransactionIncomeExpenseTrans</a>|
|[Relationship_RetailStatementTableRelationshipId](#Relationship_RetailStatementTableRelationshipId)||<a href="RetailTransactionIncomeExpenseTrans.md" target="_blank">Transaction/RetailTransactionIncomeExpenseTrans</a>|
|[Relationship_RetailStoreTableRelationshipId](#Relationship_RetailStoreTableRelationshipId)||<a href="RetailTransactionIncomeExpenseTrans.md" target="_blank">Transaction/RetailTransactionIncomeExpenseTrans</a>|
|[Relationship_RetailStoreWorkShiftTableRelationshipId](#Relationship_RetailStoreWorkShiftTableRelationshipId)||<a href="RetailTransactionIncomeExpenseTrans.md" target="_blank">Transaction/RetailTransactionIncomeExpenseTrans</a>|
|[Relationship_RetailTerminalTableRelationshipId](#Relationship_RetailTerminalTableRelationshipId)||<a href="RetailTransactionIncomeExpenseTrans.md" target="_blank">Transaction/RetailTransactionIncomeExpenseTrans</a>|
|[Relationship_RetailTransactionTableRelationshipId](#Relationship_RetailTransactionTableRelationshipId)||<a href="RetailTransactionIncomeExpenseTrans.md" target="_blank">Transaction/RetailTransactionIncomeExpenseTrans</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="RetailTransactionIncomeExpenseTrans.md" target="_blank">Transaction/RetailTransactionIncomeExpenseTrans</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Transaction/RetailTransactionIncomeExpenseTrans (this entity)  
...
### <a href=#incomeExepenseAccount name="incomeExepenseAccount">incomeExepenseAccount</a>
...
<details>
<summary>List of traits for the incomeExepenseAccount attribute are listed below.</summary>
...
**means.identity.entityId**  
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="../Main/RetailIncomeExpenseAccountTable.md" target="_blank">/core/operationsCommon/Tables/Commerce/TransactionsAndOrders/Main/RetailIncomeExpenseAccountTable.cdm.json/RetailIncomeExpenseAccountTable</a></td><td><a href="../Main/RetailIncomeExpenseAccountTable.md#RecId" target="_blank">RecId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
