---
title: RetailTransactionTenderDeclarationTrans in Transaction - Common Data Model | Microsoft Docs
...
# Tender declaration transaction in Transaction(RetailTransactionTenderDeclarationTrans)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/Commerce/TransactionsAndOrders/Transaction/RetailTransactionTenderDeclarationTrans.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[RetailTransactionTenderDeclarationTrans/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Tender declaration transaction</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="RetailTransactionTenderDeclarationTrans.md" target="_blank">Transaction/RetailTransactionTenderDeclarationTrans</a>|
|[POSCurrency](#POSCurrency)||<a href="RetailTransactionTenderDeclarationTrans.md" target="_blank">Transaction/RetailTransactionTenderDeclarationTrans</a>|
|[amountCur](#amountCur)||<a href="RetailTransactionTenderDeclarationTrans.md" target="_blank">Transaction/RetailTransactionTenderDeclarationTrans</a>|
|[amountMST](#amountMST)||<a href="RetailTransactionTenderDeclarationTrans.md" target="_blank">Transaction/RetailTransactionTenderDeclarationTrans</a>|
|[amountTendered](#amountTendered)||<a href="RetailTransactionTenderDeclarationTrans.md" target="_blank">Transaction/RetailTransactionTenderDeclarationTrans</a>|
|[businessDate](#businessDate)||<a href="RetailTransactionTenderDeclarationTrans.md" target="_blank">Transaction/RetailTransactionTenderDeclarationTrans</a>|
|[cardId](#cardId)||<a href="RetailTransactionTenderDeclarationTrans.md" target="_blank">Transaction/RetailTransactionTenderDeclarationTrans</a>|
|[Channel](#Channel)||<a href="RetailTransactionTenderDeclarationTrans.md" target="_blank">Transaction/RetailTransactionTenderDeclarationTrans</a>|
|[currency](#currency)||<a href="RetailTransactionTenderDeclarationTrans.md" target="_blank">Transaction/RetailTransactionTenderDeclarationTrans</a>|
|[exchRate](#exchRate)||<a href="RetailTransactionTenderDeclarationTrans.md" target="_blank">Transaction/RetailTransactionTenderDeclarationTrans</a>|
|[exchRateMST](#exchRateMST)||<a href="RetailTransactionTenderDeclarationTrans.md" target="_blank">Transaction/RetailTransactionTenderDeclarationTrans</a>|
|[lineNum](#lineNum)||<a href="RetailTransactionTenderDeclarationTrans.md" target="_blank">Transaction/RetailTransactionTenderDeclarationTrans</a>|
|[Origin](#Origin)||<a href="RetailTransactionTenderDeclarationTrans.md" target="_blank">Transaction/RetailTransactionTenderDeclarationTrans</a>|
|[qty](#qty)||<a href="RetailTransactionTenderDeclarationTrans.md" target="_blank">Transaction/RetailTransactionTenderDeclarationTrans</a>|
|[receiptId](#receiptId)||<a href="RetailTransactionTenderDeclarationTrans.md" target="_blank">Transaction/RetailTransactionTenderDeclarationTrans</a>|
|[replicated](#replicated)||<a href="RetailTransactionTenderDeclarationTrans.md" target="_blank">Transaction/RetailTransactionTenderDeclarationTrans</a>|
|[replicationCounterFromOrigin](#replicationCounterFromOrigin)||<a href="RetailTransactionTenderDeclarationTrans.md" target="_blank">Transaction/RetailTransactionTenderDeclarationTrans</a>|
|[shift](#shift)||<a href="RetailTransactionTenderDeclarationTrans.md" target="_blank">Transaction/RetailTransactionTenderDeclarationTrans</a>|
|[shiftDate](#shiftDate)||<a href="RetailTransactionTenderDeclarationTrans.md" target="_blank">Transaction/RetailTransactionTenderDeclarationTrans</a>|
|[staff](#staff)||<a href="RetailTransactionTenderDeclarationTrans.md" target="_blank">Transaction/RetailTransactionTenderDeclarationTrans</a>|
|[statementCode](#statementCode)||<a href="RetailTransactionTenderDeclarationTrans.md" target="_blank">Transaction/RetailTransactionTenderDeclarationTrans</a>|
|[statementId](#statementId)||<a href="RetailTransactionTenderDeclarationTrans.md" target="_blank">Transaction/RetailTransactionTenderDeclarationTrans</a>|
|[store](#store)||<a href="RetailTransactionTenderDeclarationTrans.md" target="_blank">Transaction/RetailTransactionTenderDeclarationTrans</a>|
|[tenderType](#tenderType)||<a href="RetailTransactionTenderDeclarationTrans.md" target="_blank">Transaction/RetailTransactionTenderDeclarationTrans</a>|
|[terminal](#terminal)||<a href="RetailTransactionTenderDeclarationTrans.md" target="_blank">Transaction/RetailTransactionTenderDeclarationTrans</a>|
|[transactionId](#transactionId)||<a href="RetailTransactionTenderDeclarationTrans.md" target="_blank">Transaction/RetailTransactionTenderDeclarationTrans</a>|
|[transactionStatus](#transactionStatus)||<a href="RetailTransactionTenderDeclarationTrans.md" target="_blank">Transaction/RetailTransactionTenderDeclarationTrans</a>|
|[transDate](#transDate)||<a href="RetailTransactionTenderDeclarationTrans.md" target="_blank">Transaction/RetailTransactionTenderDeclarationTrans</a>|
|[transTime](#transTime)||<a href="RetailTransactionTenderDeclarationTrans.md" target="_blank">Transaction/RetailTransactionTenderDeclarationTrans</a>|
|[DataAreaId](#DataAreaId)||<a href="RetailTransactionTenderDeclarationTrans.md" target="_blank">Transaction/RetailTransactionTenderDeclarationTrans</a>|
|[Relationship_CurrencyRelationshipId](#Relationship_CurrencyRelationshipId)||<a href="RetailTransactionTenderDeclarationTrans.md" target="_blank">Transaction/RetailTransactionTenderDeclarationTrans</a>|
|[Relationship_Currency1RelationshipId](#Relationship_Currency1RelationshipId)||<a href="RetailTransactionTenderDeclarationTrans.md" target="_blank">Transaction/RetailTransactionTenderDeclarationTrans</a>|
|[Relationship_RetailChannelTableRelationshipId](#Relationship_RetailChannelTableRelationshipId)||<a href="RetailTransactionTenderDeclarationTrans.md" target="_blank">Transaction/RetailTransactionTenderDeclarationTrans</a>|
|[Relationship_RetailStatementLineRelationshipId](#Relationship_RetailStatementLineRelationshipId)||<a href="RetailTransactionTenderDeclarationTrans.md" target="_blank">Transaction/RetailTransactionTenderDeclarationTrans</a>|
|[Relationship_RetailStatementTableRelationshipId](#Relationship_RetailStatementTableRelationshipId)||<a href="RetailTransactionTenderDeclarationTrans.md" target="_blank">Transaction/RetailTransactionTenderDeclarationTrans</a>|
|[Relationship_RetailStatementTransRelationshipId](#Relationship_RetailStatementTransRelationshipId)||<a href="RetailTransactionTenderDeclarationTrans.md" target="_blank">Transaction/RetailTransactionTenderDeclarationTrans</a>|
|[Relationship_RetailStoreTableRelationshipId](#Relationship_RetailStoreTableRelationshipId)||<a href="RetailTransactionTenderDeclarationTrans.md" target="_blank">Transaction/RetailTransactionTenderDeclarationTrans</a>|
|[Relationship_RetailStoreWorkShiftTableRelationshipId](#Relationship_RetailStoreWorkShiftTableRelationshipId)||<a href="RetailTransactionTenderDeclarationTrans.md" target="_blank">Transaction/RetailTransactionTenderDeclarationTrans</a>|
|[Relationship_RetailTenderTypeCardTableRelationshipId](#Relationship_RetailTenderTypeCardTableRelationshipId)||<a href="RetailTransactionTenderDeclarationTrans.md" target="_blank">Transaction/RetailTransactionTenderDeclarationTrans</a>|
|[Relationship_RetailTenderTypeTableRelationshipId](#Relationship_RetailTenderTypeTableRelationshipId)||<a href="RetailTransactionTenderDeclarationTrans.md" target="_blank">Transaction/RetailTransactionTenderDeclarationTrans</a>|
|[Relationship_RetailTerminalTableRelationshipId](#Relationship_RetailTerminalTableRelationshipId)||<a href="RetailTransactionTenderDeclarationTrans.md" target="_blank">Transaction/RetailTransactionTenderDeclarationTrans</a>|
|[Relationship_RetailTransactionBankedTenderTransRelationshipId](#Relationship_RetailTransactionBankedTenderTransRelationshipId)||<a href="RetailTransactionTenderDeclarationTrans.md" target="_blank">Transaction/RetailTransactionTenderDeclarationTrans</a>|
|[Relationship_RetailTransactionTableRelationshipId](#Relationship_RetailTransactionTableRelationshipId)||<a href="RetailTransactionTenderDeclarationTrans.md" target="_blank">Transaction/RetailTransactionTenderDeclarationTrans</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="RetailTransactionTenderDeclarationTrans.md" target="_blank">Transaction/RetailTransactionTenderDeclarationTrans</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Transaction/RetailTransactionTenderDeclarationTrans (this entity)  
...
### <a href=#POSCurrency name="POSCurrency">POSCurrency</a>

First included in: Transaction/RetailTransactionTenderDeclarationTrans (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>POS currency</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>isNullable</td><td>true</td></tr></table>

#### Traits

<details>
<summary>List of traits for the POSCurrency attribute are listed below.</summary>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>POS currency</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
### <a href=#Relationship_Currency1RelationshipId name="Relationship_Currency1RelationshipId">Relationship_Currency1RelationshipId</a>
...
<details>
<summary>List of traits for the Relationship_Currency1RelationshipId attribute are listed below.</summary>
...
### <a href=#Relationship_RetailTransactionBankedTenderTransRelationshipId name="Relationship_RetailTransactionBankedTenderTransRelationshipId">Relationship_RetailTransactionBankedTenderTransRelationshipId</a>
...
<details>
<summary>List of traits for the Relationship_RetailTransactionBankedTenderTransRelationshipId attribute are listed below.</summary>
...
**means.identity.entityId**  
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="RetailTransactionBankedTenderTrans.md" target="_blank">/core/operationsCommon/Tables/Commerce/TransactionsAndOrders/Transaction/RetailTransactionBankedTenderTrans.cdm.json/RetailTransactionBankedTenderTrans</a></td><td><a href="RetailTransactionBankedTenderTrans.md#RecId" target="_blank">RecId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
