---
title: RetailTransactionKitsDisassemblyTrans in Transaction - Common Data Model | Microsoft Docs
...
# Kit disassembly transactions in Transaction(RetailTransactionKitsDisassemblyTrans)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/Commerce/TransactionsAndOrders/Transaction/RetailTransactionKitsDisassemblyTrans.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[RetailTransactionKitsDisassemblyTrans/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Kit disassembly transactions</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="RetailTransactionKitsDisassemblyTrans.md" target="_blank">Transaction/RetailTransactionKitsDisassemblyTrans</a>|
|[Channel](#Channel)||<a href="RetailTransactionKitsDisassemblyTrans.md" target="_blank">Transaction/RetailTransactionKitsDisassemblyTrans</a>|
|[ItemId](#ItemId)||<a href="RetailTransactionKitsDisassemblyTrans.md" target="_blank">Transaction/RetailTransactionKitsDisassemblyTrans</a>|
|[LineNum](#LineNum)||<a href="RetailTransactionKitsDisassemblyTrans.md" target="_blank">Transaction/RetailTransactionKitsDisassemblyTrans</a>|
|[Origin](#Origin)||<a href="RetailTransactionKitsDisassemblyTrans.md" target="_blank">Transaction/RetailTransactionKitsDisassemblyTrans</a>|
|[Qty](#Qty)||<a href="RetailTransactionKitsDisassemblyTrans.md" target="_blank">Transaction/RetailTransactionKitsDisassemblyTrans</a>|
|[ReplicationCounter](#ReplicationCounter)||<a href="RetailTransactionKitsDisassemblyTrans.md" target="_blank">Transaction/RetailTransactionKitsDisassemblyTrans</a>|
|[StoreId](#StoreId)||<a href="RetailTransactionKitsDisassemblyTrans.md" target="_blank">Transaction/RetailTransactionKitsDisassemblyTrans</a>|
|[TerminalId](#TerminalId)||<a href="RetailTransactionKitsDisassemblyTrans.md" target="_blank">Transaction/RetailTransactionKitsDisassemblyTrans</a>|
|[TransactionId](#TransactionId)||<a href="RetailTransactionKitsDisassemblyTrans.md" target="_blank">Transaction/RetailTransactionKitsDisassemblyTrans</a>|
|[TransactionStatus](#TransactionStatus)||<a href="RetailTransactionKitsDisassemblyTrans.md" target="_blank">Transaction/RetailTransactionKitsDisassemblyTrans</a>|
|[VariantId](#VariantId)||<a href="RetailTransactionKitsDisassemblyTrans.md" target="_blank">Transaction/RetailTransactionKitsDisassemblyTrans</a>|
|[DataAreaId](#DataAreaId)||<a href="RetailTransactionKitsDisassemblyTrans.md" target="_blank">Transaction/RetailTransactionKitsDisassemblyTrans</a>|
|[Relationship_InventTableRelationshipId](#Relationship_InventTableRelationshipId)||<a href="RetailTransactionKitsDisassemblyTrans.md" target="_blank">Transaction/RetailTransactionKitsDisassemblyTrans</a>|
|[Relationship_RetailChannelTableRelationshipId](#Relationship_RetailChannelTableRelationshipId)||<a href="RetailTransactionKitsDisassemblyTrans.md" target="_blank">Transaction/RetailTransactionKitsDisassemblyTrans</a>|
|[Relationship_RetailStoreTableRelationshipId](#Relationship_RetailStoreTableRelationshipId)||<a href="RetailTransactionKitsDisassemblyTrans.md" target="_blank">Transaction/RetailTransactionKitsDisassemblyTrans</a>|
|[Relationship_RetailTerminalTableRelationshipId](#Relationship_RetailTerminalTableRelationshipId)||<a href="RetailTransactionKitsDisassemblyTrans.md" target="_blank">Transaction/RetailTransactionKitsDisassemblyTrans</a>|
|[Relationship_RetailTransactionTableRelationshipId](#Relationship_RetailTransactionTableRelationshipId)||<a href="RetailTransactionKitsDisassemblyTrans.md" target="_blank">Transaction/RetailTransactionKitsDisassemblyTrans</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="RetailTransactionKitsDisassemblyTrans.md" target="_blank">Transaction/RetailTransactionKitsDisassemblyTrans</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Transaction/RetailTransactionKitsDisassemblyTrans (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Transaction status</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>isNullable</td><td>true</td></tr></table>
