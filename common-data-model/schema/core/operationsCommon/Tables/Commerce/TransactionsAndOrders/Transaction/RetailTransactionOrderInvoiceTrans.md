---
title: RetailTransactionOrderInvoiceTrans in Transaction - Common Data Model | Microsoft Docs
...
# Transaction order invoice transaction in Transaction(RetailTransactionOrderInvoiceTrans)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/Commerce/TransactionsAndOrders/Transaction/RetailTransactionOrderInvoiceTrans.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[RetailTransactionOrderInvoiceTrans/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Transaction order invoice transaction</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="RetailTransactionOrderInvoiceTrans.md" target="_blank">Transaction/RetailTransactionOrderInvoiceTrans</a>|
|[amountCur](#amountCur)||<a href="RetailTransactionOrderInvoiceTrans.md" target="_blank">Transaction/RetailTransactionOrderInvoiceTrans</a>|
|[Channel](#Channel)||<a href="RetailTransactionOrderInvoiceTrans.md" target="_blank">Transaction/RetailTransactionOrderInvoiceTrans</a>|
|[invoiceId](#invoiceId)||<a href="RetailTransactionOrderInvoiceTrans.md" target="_blank">Transaction/RetailTransactionOrderInvoiceTrans</a>|
|[lineNum](#lineNum)||<a href="RetailTransactionOrderInvoiceTrans.md" target="_blank">Transaction/RetailTransactionOrderInvoiceTrans</a>|
|[Origin](#Origin)||<a href="RetailTransactionOrderInvoiceTrans.md" target="_blank">Transaction/RetailTransactionOrderInvoiceTrans</a>|
|[replicationCounterFromOrigin](#replicationCounterFromOrigin)||<a href="RetailTransactionOrderInvoiceTrans.md" target="_blank">Transaction/RetailTransactionOrderInvoiceTrans</a>|
|[salesId](#salesId)||<a href="RetailTransactionOrderInvoiceTrans.md" target="_blank">Transaction/RetailTransactionOrderInvoiceTrans</a>|
|[salesOrderInvoiceType](#salesOrderInvoiceType)||<a href="RetailTransactionOrderInvoiceTrans.md" target="_blank">Transaction/RetailTransactionOrderInvoiceTrans</a>|
|[statementId](#statementId)||<a href="RetailTransactionOrderInvoiceTrans.md" target="_blank">Transaction/RetailTransactionOrderInvoiceTrans</a>|
|[storeId](#storeId)||<a href="RetailTransactionOrderInvoiceTrans.md" target="_blank">Transaction/RetailTransactionOrderInvoiceTrans</a>|
|[terminalId](#terminalId)||<a href="RetailTransactionOrderInvoiceTrans.md" target="_blank">Transaction/RetailTransactionOrderInvoiceTrans</a>|
|[transactionId](#transactionId)||<a href="RetailTransactionOrderInvoiceTrans.md" target="_blank">Transaction/RetailTransactionOrderInvoiceTrans</a>|
|[transactionStatus](#transactionStatus)||<a href="RetailTransactionOrderInvoiceTrans.md" target="_blank">Transaction/RetailTransactionOrderInvoiceTrans</a>|
|[DataAreaId](#DataAreaId)||<a href="RetailTransactionOrderInvoiceTrans.md" target="_blank">Transaction/RetailTransactionOrderInvoiceTrans</a>|
|[Relationship_RetailChannelTableRelationshipId](#Relationship_RetailChannelTableRelationshipId)||<a href="RetailTransactionOrderInvoiceTrans.md" target="_blank">Transaction/RetailTransactionOrderInvoiceTrans</a>|
|[Relationship_RetailStatementTableRelationshipId](#Relationship_RetailStatementTableRelationshipId)||<a href="RetailTransactionOrderInvoiceTrans.md" target="_blank">Transaction/RetailTransactionOrderInvoiceTrans</a>|
|[Relationship_RetailStoreTableRelationshipId](#Relationship_RetailStoreTableRelationshipId)||<a href="RetailTransactionOrderInvoiceTrans.md" target="_blank">Transaction/RetailTransactionOrderInvoiceTrans</a>|
|[Relationship_RetailTerminalTableRelationshipId](#Relationship_RetailTerminalTableRelationshipId)||<a href="RetailTransactionOrderInvoiceTrans.md" target="_blank">Transaction/RetailTransactionOrderInvoiceTrans</a>|
|[Relationship_RetailTransactionTableRelationshipId](#Relationship_RetailTransactionTableRelationshipId)||<a href="RetailTransactionOrderInvoiceTrans.md" target="_blank">Transaction/RetailTransactionOrderInvoiceTrans</a>|
|[Relationship_SalesTableRelationshipId](#Relationship_SalesTableRelationshipId)||<a href="RetailTransactionOrderInvoiceTrans.md" target="_blank">Transaction/RetailTransactionOrderInvoiceTrans</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="RetailTransactionOrderInvoiceTrans.md" target="_blank">Transaction/RetailTransactionOrderInvoiceTrans</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Transaction/RetailTransactionOrderInvoiceTrans (this entity)  
...
### <a href=#salesOrderInvoiceType name="salesOrderInvoiceType">salesOrderInvoiceType</a>
...
<details>
<summary>List of traits for the salesOrderInvoiceType attribute are listed below.</summary>
