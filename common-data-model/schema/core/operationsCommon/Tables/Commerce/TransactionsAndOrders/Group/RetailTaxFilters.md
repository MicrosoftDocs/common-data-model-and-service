---
title: RetailTaxFilters in Group - Common Data Model | Microsoft Docs
...
# Destination based tax configurations table in Group(RetailTaxFilters)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/Commerce/TransactionsAndOrders/Group/RetailTaxFilters.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[RetailTaxFilters/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Destination based tax configurations table</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="RetailTaxFilters.md" target="_blank">Group/RetailTaxFilters</a>|
|[City](#City)||<a href="RetailTaxFilters.md" target="_blank">Group/RetailTaxFilters</a>|
|[CountryRegionId](#CountryRegionId)||<a href="RetailTaxFilters.md" target="_blank">Group/RetailTaxFilters</a>|
|[CountyId](#CountyId)||<a href="RetailTaxFilters.md" target="_blank">Group/RetailTaxFilters</a>|
|[District](#District)||<a href="RetailTaxFilters.md" target="_blank">Group/RetailTaxFilters</a>|
|[StateId](#StateId)||<a href="RetailTaxFilters.md" target="_blank">Group/RetailTaxFilters</a>|
|[TaxGroupHeading](#TaxGroupHeading)||<a href="RetailTaxFilters.md" target="_blank">Group/RetailTaxFilters</a>|
|[Zipcode](#Zipcode)||<a href="RetailTaxFilters.md" target="_blank">Group/RetailTaxFilters</a>|
|[DataAreaId](#DataAreaId)||<a href="RetailTaxFilters.md" target="_blank">Group/RetailTaxFilters</a>|
|[Relationship_CityRelationshipId](#Relationship_CityRelationshipId)||<a href="RetailTaxFilters.md" target="_blank">Group/RetailTaxFilters</a>|
|[Relationship_CountryRegionRelationshipId](#Relationship_CountryRegionRelationshipId)||<a href="RetailTaxFilters.md" target="_blank">Group/RetailTaxFilters</a>|
|[Relationship_CountyRelationshipId](#Relationship_CountyRelationshipId)||<a href="RetailTaxFilters.md" target="_blank">Group/RetailTaxFilters</a>|
|[Relationship_DistrictRelationshipId](#Relationship_DistrictRelationshipId)||<a href="RetailTaxFilters.md" target="_blank">Group/RetailTaxFilters</a>|
|[Relationship_StateRelationshipId](#Relationship_StateRelationshipId)||<a href="RetailTaxFilters.md" target="_blank">Group/RetailTaxFilters</a>|
|[Relationship_TaxGroupHeadingRelationshipId](#Relationship_TaxGroupHeadingRelationshipId)||<a href="RetailTaxFilters.md" target="_blank">Group/RetailTaxFilters</a>|
|[Relationship_ZipcodeRelationshipId](#Relationship_ZipcodeRelationshipId)||<a href="RetailTaxFilters.md" target="_blank">Group/RetailTaxFilters</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="RetailTaxFilters.md" target="_blank">Group/RetailTaxFilters</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Group/RetailTaxFilters (this entity)  
...
### <a href=#TaxGroupHeading name="TaxGroupHeading">TaxGroupHeading</a>
...
<details>
<summary>List of traits for the TaxGroupHeading attribute are listed below.</summary>
...
**means.identity.entityId**  
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="../../../Common/GAB/Group/LogisticsAddressDistrict.md" target="_blank">/core/operationsCommon/Tables/Common/GAB/Group/LogisticsAddressDistrict.cdm.json/LogisticsAddressDistrict</a></td><td><a href="../../../Common/GAB/Group/LogisticsAddressDistrict.md#RecId" target="_blank">RecId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
