---
title: RetailInfocodeCategorySpecific in Main - Common Data Model | Microsoft Docs
...
# Info code table assignments in Main(RetailInfocodeCategorySpecific)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/Commerce/TransactionsAndOrders/Main/RetailInfocodeCategorySpecific.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[RetailInfocodeCategorySpecific/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="RetailInfocodeCategorySpecific.md" target="_blank">Main/RetailInfocodeCategorySpecific</a>|
|[CategoryHierarchy](#CategoryHierarchy)||<a href="RetailInfocodeCategorySpecific.md" target="_blank">Main/RetailInfocodeCategorySpecific</a>|
|[CategoryName](#CategoryName)||<a href="RetailInfocodeCategorySpecific.md" target="_blank">Main/RetailInfocodeCategorySpecific</a>|
|[infocodeId](#infocodeId)||<a href="RetailInfocodeCategorySpecific.md" target="_blank">Main/RetailInfocodeCategorySpecific</a>|
|[inputRequired](#inputRequired)||<a href="RetailInfocodeCategorySpecific.md" target="_blank">Main/RetailInfocodeCategorySpecific</a>|
|[sequence](#sequence)||<a href="RetailInfocodeCategorySpecific.md" target="_blank">Main/RetailInfocodeCategorySpecific</a>|
|[whenRequired](#whenRequired)||<a href="RetailInfocodeCategorySpecific.md" target="_blank">Main/RetailInfocodeCategorySpecific</a>|
|[DataAreaId](#DataAreaId)||<a href="RetailInfocodeCategorySpecific.md" target="_blank">Main/RetailInfocodeCategorySpecific</a>|
|[Relationship_EcoResCategoryRelationshipId](#Relationship_EcoResCategoryRelationshipId)||<a href="RetailInfocodeCategorySpecific.md" target="_blank">Main/RetailInfocodeCategorySpecific</a>|
|[Relationship_RetailInfocodeTableRelationshipId](#Relationship_RetailInfocodeTableRelationshipId)||<a href="RetailInfocodeCategorySpecific.md" target="_blank">Main/RetailInfocodeCategorySpecific</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="RetailInfocodeCategorySpecific.md" target="_blank">Main/RetailInfocodeCategorySpecific</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Main/RetailInfocodeCategorySpecific (this entity)  
