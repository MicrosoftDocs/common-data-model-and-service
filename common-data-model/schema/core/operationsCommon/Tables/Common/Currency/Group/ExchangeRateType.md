---
title: ExchangeRateType in Group - Common Data Model | Microsoft Docs
...
# Exchange rate type in Group(ExchangeRateType)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/operationsCommon/Tables/Common/Currency/Group/ExchangeRateType.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[ExchangeRateType/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="ExchangeRateType.md" target="_blank">Group/ExchangeRateType</a>|
|[Description](#Description)||<a href="ExchangeRateType.md" target="_blank">Group/ExchangeRateType</a>|
|[Name](#Name)||<a href="ExchangeRateType.md" target="_blank">Group/ExchangeRateType</a>|
|[CalendarId](#CalendarId)||<a href="ExchangeRateType.md" target="_blank">Group/ExchangeRateType</a>|
|[Relationship_WorkCalendarTableRelationshipId](#Relationship_WorkCalendarTableRelationshipId)||<a href="ExchangeRateType.md" target="_blank">Group/ExchangeRateType</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Group/ExchangeRateType (this entity)  
