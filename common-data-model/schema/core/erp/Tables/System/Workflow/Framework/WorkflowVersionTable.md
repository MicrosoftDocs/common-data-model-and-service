---
title: WorkflowVersionTable - Common Data Model | Microsoft Docs
...
# WorkflowVersionTable
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/erp/Tables/System/Workflow/Framework/WorkflowVersionTable.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[WorkflowVersionTable/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="WorkflowVersionTable.md" target="_blank">Framework/WorkflowVersionTable</a>|
|[ActivationConditionId](#ActivationConditionId)||<a href="WorkflowVersionTable.md" target="_blank">Framework/WorkflowVersionTable</a>|
|[ActivationConditionType](#ActivationConditionType)||<a href="WorkflowVersionTable.md" target="_blank">Framework/WorkflowVersionTable</a>|
|[ConfigurationId](#ConfigurationId)||<a href="WorkflowVersionTable.md" target="_blank">Framework/WorkflowVersionTable</a>|
|[Enabled](#Enabled)||<a href="WorkflowVersionTable.md" target="_blank">Framework/WorkflowVersionTable</a>|
|[Owner](#Owner)||<a href="WorkflowVersionTable.md" target="_blank">Framework/WorkflowVersionTable</a>|
|[Valid](#Valid)||<a href="WorkflowVersionTable.md" target="_blank">Framework/WorkflowVersionTable</a>|
|[VersionIdBuild](#VersionIdBuild)||<a href="WorkflowVersionTable.md" target="_blank">Framework/WorkflowVersionTable</a>|
|[VersionIdMajor](#VersionIdMajor)||<a href="WorkflowVersionTable.md" target="_blank">Framework/WorkflowVersionTable</a>|
|[VersionIdMinor](#VersionIdMinor)||<a href="WorkflowVersionTable.md" target="_blank">Framework/WorkflowVersionTable</a>|
|[VersionIdRevision](#VersionIdRevision)||<a href="WorkflowVersionTable.md" target="_blank">Framework/WorkflowVersionTable</a>|
|[WorkflowTable](#WorkflowTable)||<a href="WorkflowVersionTable.md" target="_blank">Framework/WorkflowVersionTable</a>|
|[WorkItemEmailId](#WorkItemEmailId)||<a href="WorkflowVersionTable.md" target="_blank">Framework/WorkflowVersionTable</a>|
|[Relationship_ExpressionTableRelationshipId](#Relationship_ExpressionTableRelationshipId)||<a href="WorkflowVersionTable.md" target="_blank">Framework/WorkflowVersionTable</a>|
|[Relationship_WorkflowTableRelationshipId](#Relationship_WorkflowTableRelationshipId)||<a href="WorkflowVersionTable.md" target="_blank">Framework/WorkflowVersionTable</a>|
