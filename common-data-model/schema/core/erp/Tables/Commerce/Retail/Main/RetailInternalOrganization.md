---
title: RetailInternalOrganization - Common Data Model | Microsoft Docs
...
# RetailInternalOrganization
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/erp/Tables/Commerce/Retail/Main/RetailInternalOrganization.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[RetailInternalOrganization/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="RetailInternalOrganization.md" target="_blank">Main/RetailInternalOrganization</a>|
|[CategoryHierarchy](#CategoryHierarchy)||<a href="RetailInternalOrganization.md" target="_blank">Main/RetailInternalOrganization</a>|
|[InheritEnabled](#InheritEnabled)||<a href="RetailInternalOrganization.md" target="_blank">Main/RetailInternalOrganization</a>|
|[InternalOrganization](#InternalOrganization)||<a href="RetailInternalOrganization.md" target="_blank">Main/RetailInternalOrganization</a>|
|[LastModifiedDateTime](#LastModifiedDateTime)||<a href="RetailInternalOrganization.md" target="_blank">Main/RetailInternalOrganization</a>|
|[Relationship_EcoResCategoryHierarchyRelationshipId](#Relationship_EcoResCategoryHierarchyRelationshipId)||<a href="RetailInternalOrganization.md" target="_blank">Main/RetailInternalOrganization</a>|
|[Relationship_OMInternalOrganizationRelationshipId](#Relationship_OMInternalOrganizationRelationshipId)||<a href="RetailInternalOrganization.md" target="_blank">Main/RetailInternalOrganization</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Main/RetailInternalOrganization (this entity)  
...
### <a href=#InheritEnabled name="InheritEnabled">InheritEnabled</a>
...
<details>
<summary>List of traits for the InheritEnabled attribute are listed below.</summary>
