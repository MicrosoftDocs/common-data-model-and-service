---
title: RetailTransactionFiscalTrans - Common Data Model | Microsoft Docs
...
# RetailTransactionFiscalTrans
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/erp/Tables/Commerce/Retail/Transaction/RetailTransactionFiscalTrans.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[RetailTransactionFiscalTrans/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="RetailTransactionFiscalTrans.md" target="_blank">Transaction/RetailTransactionFiscalTrans</a>|
|[Channel](#Channel)||<a href="RetailTransactionFiscalTrans.md" target="_blank">Transaction/RetailTransactionFiscalTrans</a>|
|[ControlCode](#ControlCode)||<a href="RetailTransactionFiscalTrans.md" target="_blank">Transaction/RetailTransactionFiscalTrans</a>|
|[LineNum](#LineNum)||<a href="RetailTransactionFiscalTrans.md" target="_blank">Transaction/RetailTransactionFiscalTrans</a>|
|[Origin](#Origin)||<a href="RetailTransactionFiscalTrans.md" target="_blank">Transaction/RetailTransactionFiscalTrans</a>|
|[ReceiptCopy](#ReceiptCopy)||<a href="RetailTransactionFiscalTrans.md" target="_blank">Transaction/RetailTransactionFiscalTrans</a>|
|[RegisterId](#RegisterId)||<a href="RetailTransactionFiscalTrans.md" target="_blank">Transaction/RetailTransactionFiscalTrans</a>|
|[ReplicationCounterFromOrigin](#ReplicationCounterFromOrigin)||<a href="RetailTransactionFiscalTrans.md" target="_blank">Transaction/RetailTransactionFiscalTrans</a>|
|[Store](#Store)||<a href="RetailTransactionFiscalTrans.md" target="_blank">Transaction/RetailTransactionFiscalTrans</a>|
|[Terminal](#Terminal)||<a href="RetailTransactionFiscalTrans.md" target="_blank">Transaction/RetailTransactionFiscalTrans</a>|
|[TransactionId](#TransactionId)||<a href="RetailTransactionFiscalTrans.md" target="_blank">Transaction/RetailTransactionFiscalTrans</a>|
|[TransDate](#TransDate)||<a href="RetailTransactionFiscalTrans.md" target="_blank">Transaction/RetailTransactionFiscalTrans</a>|
|[TransTime](#TransTime)||<a href="RetailTransactionFiscalTrans.md" target="_blank">Transaction/RetailTransactionFiscalTrans</a>|
|[RegisterResponse](#RegisterResponse)||<a href="RetailTransactionFiscalTrans.md" target="_blank">Transaction/RetailTransactionFiscalTrans</a>|
|[StaffId](#StaffId)||<a href="RetailTransactionFiscalTrans.md" target="_blank">Transaction/RetailTransactionFiscalTrans</a>|
|[RecordGuid](#RecordGuid)||<a href="RetailTransactionFiscalTrans.md" target="_blank">Transaction/RetailTransactionFiscalTrans</a>|
|[RegisterStore](#RegisterStore)||<a href="RetailTransactionFiscalTrans.md" target="_blank">Transaction/RetailTransactionFiscalTrans</a>|
|[RegisterTerminal](#RegisterTerminal)||<a href="RetailTransactionFiscalTrans.md" target="_blank">Transaction/RetailTransactionFiscalTrans</a>|
|[RegistrationStatus](#RegistrationStatus)||<a href="RetailTransactionFiscalTrans.md" target="_blank">Transaction/RetailTransactionFiscalTrans</a>|
|[RegistrationProcessId](#RegistrationProcessId)||<a href="RetailTransactionFiscalTrans.md" target="_blank">Transaction/RetailTransactionFiscalTrans</a>|
|[ConnectorGroup](#ConnectorGroup)||<a href="RetailTransactionFiscalTrans.md" target="_blank">Transaction/RetailTransactionFiscalTrans</a>|
|[ConnectorName](#ConnectorName)||<a href="RetailTransactionFiscalTrans.md" target="_blank">Transaction/RetailTransactionFiscalTrans</a>|
|[ConnectorFunctionalityProfileId](#ConnectorFunctionalityProfileId)||<a href="RetailTransactionFiscalTrans.md" target="_blank">Transaction/RetailTransactionFiscalTrans</a>|
|[RegisterInfo](#RegisterInfo)||<a href="RetailTransactionFiscalTrans.md" target="_blank">Transaction/RetailTransactionFiscalTrans</a>|
|[DocumentNumber](#DocumentNumber)||<a href="RetailTransactionFiscalTrans.md" target="_blank">Transaction/RetailTransactionFiscalTrans</a>|
|[RegistrationType](#RegistrationType)||<a href="RetailTransactionFiscalTrans.md" target="_blank">Transaction/RetailTransactionFiscalTrans</a>|
|[ServiceName](#ServiceName)||<a href="RetailTransactionFiscalTrans.md" target="_blank">Transaction/RetailTransactionFiscalTrans</a>|
|[CountryRegionId](#CountryRegionId)||<a href="RetailTransactionFiscalTrans.md" target="_blank">Transaction/RetailTransactionFiscalTrans</a>|
|[DataAreaId](#DataAreaId)||<a href="RetailTransactionFiscalTrans.md" target="_blank">Transaction/RetailTransactionFiscalTrans</a>|
|[Relationship_RetailStoreTableRelationshipId](#Relationship_RetailStoreTableRelationshipId)||<a href="RetailTransactionFiscalTrans.md" target="_blank">Transaction/RetailTransactionFiscalTrans</a>|
|[Relationship_RetailTerminalTableRelationshipId](#Relationship_RetailTerminalTableRelationshipId)||<a href="RetailTransactionFiscalTrans.md" target="_blank">Transaction/RetailTransactionFiscalTrans</a>|
|[Relationship_RetailTransactionTableRelationshipId](#Relationship_RetailTransactionTableRelationshipId)||<a href="RetailTransactionFiscalTrans.md" target="_blank">Transaction/RetailTransactionFiscalTrans</a>|
|[Relationship_RetailChannelTableRelationshipId](#Relationship_RetailChannelTableRelationshipId)||<a href="RetailTransactionFiscalTrans.md" target="_blank">Transaction/RetailTransactionFiscalTrans</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="RetailTransactionFiscalTrans.md" target="_blank">Transaction/RetailTransactionFiscalTrans</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Transaction/RetailTransactionFiscalTrans (this entity)  
...
### <a href=#ControlCode name="ControlCode">ControlCode</a>
...
<details>
<summary>List of traits for the ControlCode attribute are listed below.</summary>
