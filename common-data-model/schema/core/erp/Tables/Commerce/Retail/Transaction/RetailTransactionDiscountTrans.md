---
title: RetailTransactionDiscountTrans - Common Data Model | Microsoft Docs
...
# RetailTransactionDiscountTrans
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/erp/Tables/Commerce/Retail/Transaction/RetailTransactionDiscountTrans.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[RetailTransactionDiscountTrans/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="RetailTransactionDiscountTrans.md" target="_blank">Transaction/RetailTransactionDiscountTrans</a>|
|[Amount](#Amount)||<a href="RetailTransactionDiscountTrans.md" target="_blank">Transaction/RetailTransactionDiscountTrans</a>|
|[Channel](#Channel)||<a href="RetailTransactionDiscountTrans.md" target="_blank">Transaction/RetailTransactionDiscountTrans</a>|
|[CustomerDiscountType](#CustomerDiscountType)||<a href="RetailTransactionDiscountTrans.md" target="_blank">Transaction/RetailTransactionDiscountTrans</a>|
|[DealPrice](#DealPrice)||<a href="RetailTransactionDiscountTrans.md" target="_blank">Transaction/RetailTransactionDiscountTrans</a>|
|[DiscountAmount](#DiscountAmount)||<a href="RetailTransactionDiscountTrans.md" target="_blank">Transaction/RetailTransactionDiscountTrans</a>|
|[DiscountCost](#DiscountCost)||<a href="RetailTransactionDiscountTrans.md" target="_blank">Transaction/RetailTransactionDiscountTrans</a>|
|[DiscountCode](#DiscountCode)||<a href="RetailTransactionDiscountTrans.md" target="_blank">Transaction/RetailTransactionDiscountTrans</a>|
|[DiscountOriginType](#DiscountOriginType)||<a href="RetailTransactionDiscountTrans.md" target="_blank">Transaction/RetailTransactionDiscountTrans</a>|
|[LineNum](#LineNum)||<a href="RetailTransactionDiscountTrans.md" target="_blank">Transaction/RetailTransactionDiscountTrans</a>|
|[ManualDiscountType](#ManualDiscountType)||<a href="RetailTransactionDiscountTrans.md" target="_blank">Transaction/RetailTransactionDiscountTrans</a>|
|[Origin](#Origin)||<a href="RetailTransactionDiscountTrans.md" target="_blank">Transaction/RetailTransactionDiscountTrans</a>|
|[Percentage](#Percentage)||<a href="RetailTransactionDiscountTrans.md" target="_blank">Transaction/RetailTransactionDiscountTrans</a>|
|[PeriodicDiscountOfferId](#PeriodicDiscountOfferId)||<a href="RetailTransactionDiscountTrans.md" target="_blank">Transaction/RetailTransactionDiscountTrans</a>|
|[ReplicationCounterFromOrigin](#ReplicationCounterFromOrigin)||<a href="RetailTransactionDiscountTrans.md" target="_blank">Transaction/RetailTransactionDiscountTrans</a>|
|[SaleLineNum](#SaleLineNum)||<a href="RetailTransactionDiscountTrans.md" target="_blank">Transaction/RetailTransactionDiscountTrans</a>|
|[StoreId](#StoreId)||<a href="RetailTransactionDiscountTrans.md" target="_blank">Transaction/RetailTransactionDiscountTrans</a>|
|[TerminalId](#TerminalId)||<a href="RetailTransactionDiscountTrans.md" target="_blank">Transaction/RetailTransactionDiscountTrans</a>|
|[TransactionId](#TransactionId)||<a href="RetailTransactionDiscountTrans.md" target="_blank">Transaction/RetailTransactionDiscountTrans</a>|
|[BundleId](#BundleId)||<a href="RetailTransactionDiscountTrans.md" target="_blank">Transaction/RetailTransactionDiscountTrans</a>|
|[DataAreaId](#DataAreaId)||<a href="RetailTransactionDiscountTrans.md" target="_blank">Transaction/RetailTransactionDiscountTrans</a>|
|[Relationship_RetailChannelTableRelationshipId](#Relationship_RetailChannelTableRelationshipId)||<a href="RetailTransactionDiscountTrans.md" target="_blank">Transaction/RetailTransactionDiscountTrans</a>|
|[Relationship_RetailPeriodicDiscountRelationshipId](#Relationship_RetailPeriodicDiscountRelationshipId)||<a href="RetailTransactionDiscountTrans.md" target="_blank">Transaction/RetailTransactionDiscountTrans</a>|
|[Relationship_RetailStoreTableRelationshipId](#Relationship_RetailStoreTableRelationshipId)||<a href="RetailTransactionDiscountTrans.md" target="_blank">Transaction/RetailTransactionDiscountTrans</a>|
|[Relationship_RetailTerminalTableRelationshipId](#Relationship_RetailTerminalTableRelationshipId)||<a href="RetailTransactionDiscountTrans.md" target="_blank">Transaction/RetailTransactionDiscountTrans</a>|
|[Relationship_RetailTransactionSalesTransRelationshipId](#Relationship_RetailTransactionSalesTransRelationshipId)||<a href="RetailTransactionDiscountTrans.md" target="_blank">Transaction/RetailTransactionDiscountTrans</a>|
|[Relationship_RetailTransactionTableRelationshipId](#Relationship_RetailTransactionTableRelationshipId)||<a href="RetailTransactionDiscountTrans.md" target="_blank">Transaction/RetailTransactionDiscountTrans</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="RetailTransactionDiscountTrans.md" target="_blank">Transaction/RetailTransactionDiscountTrans</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Transaction/RetailTransactionDiscountTrans (this entity)  
