---
title: RetailTransactionTaxTransGTE - Common Data Model | Microsoft Docs
...
# RetailTransactionTaxTransGTE
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/erp/Tables/Commerce/Retail/Transaction/RetailTransactionTaxTransGTE.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[RetailTransactionTaxTransGTE/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="RetailTransactionTaxTransGTE.md" target="_blank">Transaction/RetailTransactionTaxTransGTE</a>|
|[Channel](#Channel)||<a href="RetailTransactionTaxTransGTE.md" target="_blank">Transaction/RetailTransactionTaxTransGTE</a>|
|[IsIncludedInPrice](#IsIncludedInPrice)||<a href="RetailTransactionTaxTransGTE.md" target="_blank">Transaction/RetailTransactionTaxTransGTE</a>|
|[Origin](#Origin)||<a href="RetailTransactionTaxTransGTE.md" target="_blank">Transaction/RetailTransactionTaxTransGTE</a>|
|[replicationCounterFromOrigin](#replicationCounterFromOrigin)||<a href="RetailTransactionTaxTransGTE.md" target="_blank">Transaction/RetailTransactionTaxTransGTE</a>|
|[SaleLineNum](#SaleLineNum)||<a href="RetailTransactionTaxTransGTE.md" target="_blank">Transaction/RetailTransactionTaxTransGTE</a>|
|[StoreId](#StoreId)||<a href="RetailTransactionTaxTransGTE.md" target="_blank">Transaction/RetailTransactionTaxTransGTE</a>|
|[TaxAmount](#TaxAmount)||<a href="RetailTransactionTaxTransGTE.md" target="_blank">Transaction/RetailTransactionTaxTransGTE</a>|
|[TaxBasis](#TaxBasis)||<a href="RetailTransactionTaxTransGTE.md" target="_blank">Transaction/RetailTransactionTaxTransGTE</a>|
|[TaxComponent](#TaxComponent)||<a href="RetailTransactionTaxTransGTE.md" target="_blank">Transaction/RetailTransactionTaxTransGTE</a>|
|[TaxPercentage](#TaxPercentage)||<a href="RetailTransactionTaxTransGTE.md" target="_blank">Transaction/RetailTransactionTaxTransGTE</a>|
|[TerminalId](#TerminalId)||<a href="RetailTransactionTaxTransGTE.md" target="_blank">Transaction/RetailTransactionTaxTransGTE</a>|
|[TransactionId](#TransactionId)||<a href="RetailTransactionTaxTransGTE.md" target="_blank">Transaction/RetailTransactionTaxTransGTE</a>|
|[DataAreaId](#DataAreaId)||<a href="RetailTransactionTaxTransGTE.md" target="_blank">Transaction/RetailTransactionTaxTransGTE</a>|
|[Relationship_RetailChannelTableRelationshipId](#Relationship_RetailChannelTableRelationshipId)||<a href="RetailTransactionTaxTransGTE.md" target="_blank">Transaction/RetailTransactionTaxTransGTE</a>|
|[Relationship_RetailStoreTableRelationshipId](#Relationship_RetailStoreTableRelationshipId)||<a href="RetailTransactionTaxTransGTE.md" target="_blank">Transaction/RetailTransactionTaxTransGTE</a>|
|[Relationship_RetailTerminalTableRelationshipId](#Relationship_RetailTerminalTableRelationshipId)||<a href="RetailTransactionTaxTransGTE.md" target="_blank">Transaction/RetailTransactionTaxTransGTE</a>|
|[Relationship_RetailTransactionTableRelationshipId](#Relationship_RetailTransactionTableRelationshipId)||<a href="RetailTransactionTaxTransGTE.md" target="_blank">Transaction/RetailTransactionTaxTransGTE</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="RetailTransactionTaxTransGTE.md" target="_blank">Transaction/RetailTransactionTaxTransGTE</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Transaction/RetailTransactionTaxTransGTE (this entity)  
