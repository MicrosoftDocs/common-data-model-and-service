---
title: InventTransOriginPurchLine - Common Data Model | Microsoft Docs
...
# InventTransOriginPurchLine
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/erp/Tables/SupplyChain/Inventory/Transaction/InventTransOriginPurchLine.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[InventTransOriginPurchLine/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="InventTransOriginPurchLine.md" target="_blank">Transaction/InventTransOriginPurchLine</a>|
|[InventTransOrigin](#InventTransOrigin)||<a href="InventTransOriginPurchLine.md" target="_blank">Transaction/InventTransOriginPurchLine</a>|
|[PurchLineDataAreaId](#PurchLineDataAreaId)||<a href="InventTransOriginPurchLine.md" target="_blank">Transaction/InventTransOriginPurchLine</a>|
|[PurchLineInventTransId](#PurchLineInventTransId)||<a href="InventTransOriginPurchLine.md" target="_blank">Transaction/InventTransOriginPurchLine</a>|
|[Relationship_InventTransOriginRelationshipId](#Relationship_InventTransOriginRelationshipId)||<a href="InventTransOriginPurchLine.md" target="_blank">Transaction/InventTransOriginPurchLine</a>|
|[Relationship_PurchLineRelationshipId](#Relationship_PurchLineRelationshipId)||<a href="InventTransOriginPurchLine.md" target="_blank">Transaction/InventTransOriginPurchLine</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Transaction/InventTransOriginPurchLine (this entity)  
