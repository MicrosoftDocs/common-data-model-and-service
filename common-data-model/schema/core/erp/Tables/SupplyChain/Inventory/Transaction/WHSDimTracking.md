---
title: WHSDimTracking - Common Data Model | Microsoft Docs
...
# WHSDimTracking
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/erp/Tables/SupplyChain/Inventory/Transaction/WHSDimTracking.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[WHSDimTracking/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="WHSDimTracking.md" target="_blank">Transaction/WHSDimTracking</a>|
|[InventDimId](#InventDimId)||<a href="WHSDimTracking.md" target="_blank">Transaction/WHSDimTracking</a>|
|[InventTransIdParent](#InventTransIdParent)||<a href="WHSDimTracking.md" target="_blank">Transaction/WHSDimTracking</a>|
|[LineNum](#LineNum)||<a href="WHSDimTracking.md" target="_blank">Transaction/WHSDimTracking</a>|
|[Processed](#Processed)||<a href="WHSDimTracking.md" target="_blank">Transaction/WHSDimTracking</a>|
|[Qty](#Qty)||<a href="WHSDimTracking.md" target="_blank">Transaction/WHSDimTracking</a>|
|[WorkId](#WorkId)||<a href="WHSDimTracking.md" target="_blank">Transaction/WHSDimTracking</a>|
|[CapturedWeight](#CapturedWeight)||<a href="WHSDimTracking.md" target="_blank">Transaction/WHSDimTracking</a>|
|[DataAreaId](#DataAreaId)||<a href="WHSDimTracking.md" target="_blank">Transaction/WHSDimTracking</a>|
|[Relationship_InventDimRelationshipId](#Relationship_InventDimRelationshipId)||<a href="WHSDimTracking.md" target="_blank">Transaction/WHSDimTracking</a>|
|[Relationship_InventTransOriginRelationshipId](#Relationship_InventTransOriginRelationshipId)||<a href="WHSDimTracking.md" target="_blank">Transaction/WHSDimTracking</a>|
|[Relationship_WHSWorkLineRelationshipId](#Relationship_WHSWorkLineRelationshipId)||<a href="WHSDimTracking.md" target="_blank">Transaction/WHSDimTracking</a>|
|[Relationship_WHSWorkTableRelationshipId](#Relationship_WHSWorkTableRelationshipId)||<a href="WHSDimTracking.md" target="_blank">Transaction/WHSDimTracking</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="WHSDimTracking.md" target="_blank">Transaction/WHSDimTracking</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Transaction/WHSDimTracking (this entity)  
