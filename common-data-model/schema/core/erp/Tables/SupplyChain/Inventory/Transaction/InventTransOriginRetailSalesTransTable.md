---
title: InventTransOriginRetailSalesTransTable - Common Data Model | Microsoft Docs
...
# InventTransOriginRetailSalesTransTable

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/erp/Tables/SupplyChain/Inventory/Transaction/InventTransOriginRetailSalesTransTable.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[InventTransOriginRetailSalesTransTable/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="InventTransOriginRetailSalesTransTable.md" target="_blank">Transaction/InventTransOriginRetailSalesTransTable</a>|
|[InventTransOrigin](#InventTransOrigin)||<a href="InventTransOriginRetailSalesTransTable.md" target="_blank">Transaction/InventTransOriginRetailSalesTransTable</a>|
...
### <a href=#SalesTransInventTransId name="SalesTransInventTransId">SalesTransInventTransId</a>
...
<details>
<summary>List of traits for the SalesTransInventTransId attribute are listed below.</summary>
...
### <a href=#SalesTransTableDataAreaId name="SalesTransTableDataAreaId">SalesTransTableDataAreaId</a>
...
<details>
<summary>List of traits for the SalesTransTableDataAreaId attribute are listed below.</summary>
...
**means.identity.entityId**  
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="../../../Commerce/Retail/Transaction/RetailTransactionSalesTrans.md" target="_blank">/core/erp/Tables/Commerce/Retail/Transaction/RetailTransactionSalesTrans.cdm.json/RetailTransactionSalesTrans</a></td><td><a href="../../../Commerce/Retail/Transaction/RetailTransactionSalesTrans.md#RecId" target="_blank">RecId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
