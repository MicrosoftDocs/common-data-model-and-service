---
title: InventTransPosting - Common Data Model | Microsoft Docs
...
# InventTransPosting
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/erp/Tables/SupplyChain/Inventory/Transaction/InventTransPosting.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[InventTransPosting/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="InventTransPosting.md" target="_blank">Transaction/InventTransPosting</a>|
|[DefaultDimension](#DefaultDimension)||<a href="InventTransPosting.md" target="_blank">Transaction/InventTransPosting</a>|
|[InventTransOrigin](#InventTransOrigin)||<a href="InventTransPosting.md" target="_blank">Transaction/InventTransPosting</a>|
|[InventTransPostingType](#InventTransPostingType)||<a href="InventTransPosting.md" target="_blank">Transaction/InventTransPosting</a>|
|[IsPosted](#IsPosted)||<a href="InventTransPosting.md" target="_blank">Transaction/InventTransPosting</a>|
|[ItemId](#ItemId)||<a href="InventTransPosting.md" target="_blank">Transaction/InventTransPosting</a>|
|[LedgerDimension](#LedgerDimension)||<a href="InventTransPosting.md" target="_blank">Transaction/InventTransPosting</a>|
|[OffsetLedgerDimension](#OffsetLedgerDimension)||<a href="InventTransPosting.md" target="_blank">Transaction/InventTransPosting</a>|
|[PostingType](#PostingType)||<a href="InventTransPosting.md" target="_blank">Transaction/InventTransPosting</a>|
|[PostingTypeOffset](#PostingTypeOffset)||<a href="InventTransPosting.md" target="_blank">Transaction/InventTransPosting</a>|
|[ProjId](#ProjId)||<a href="InventTransPosting.md" target="_blank">Transaction/InventTransPosting</a>|
|[TransBeginTime](#TransBeginTime)||<a href="InventTransPosting.md" target="_blank">Transaction/InventTransPosting</a>|
|[TransDate](#TransDate)||<a href="InventTransPosting.md" target="_blank">Transaction/InventTransPosting</a>|
|[Voucher](#Voucher)||<a href="InventTransPosting.md" target="_blank">Transaction/InventTransPosting</a>|
|[DataAreaId](#DataAreaId)||<a href="InventTransPosting.md" target="_blank">Transaction/InventTransPosting</a>|
|[Relationship_DefaultDimensionRelationshipId](#Relationship_DefaultDimensionRelationshipId)||<a href="InventTransPosting.md" target="_blank">Transaction/InventTransPosting</a>|
|[Relationship_InventTableRelationshipId](#Relationship_InventTableRelationshipId)||<a href="InventTransPosting.md" target="_blank">Transaction/InventTransPosting</a>|
|[Relationship_InventTransOriginRelationshipId](#Relationship_InventTransOriginRelationshipId)||<a href="InventTransPosting.md" target="_blank">Transaction/InventTransPosting</a>|
|[Relationship_LedgerDimensionRelationshipId](#Relationship_LedgerDimensionRelationshipId)||<a href="InventTransPosting.md" target="_blank">Transaction/InventTransPosting</a>|
|[Relationship_OffsetLedgerDimensionRelationshipId](#Relationship_OffsetLedgerDimensionRelationshipId)||<a href="InventTransPosting.md" target="_blank">Transaction/InventTransPosting</a>|
|[Relationship_ProjTableRelationshipId](#Relationship_ProjTableRelationshipId)||<a href="InventTransPosting.md" target="_blank">Transaction/InventTransPosting</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="InventTransPosting.md" target="_blank">Transaction/InventTransPosting</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Transaction/InventTransPosting (this entity)  
...
### <a href=#InventTransPostingType name="InventTransPostingType">InventTransPostingType</a>
...
<details>
<summary>List of traits for the InventTransPostingType attribute are listed below.</summary>
...
### <a href=#PostingTypeOffset name="PostingTypeOffset">PostingTypeOffset</a>
...
<details>
<summary>List of traits for the PostingTypeOffset attribute are listed below.</summary>
...
<details>
<summary>List of traits for the TransBeginTime attribute are listed below.</summary>
