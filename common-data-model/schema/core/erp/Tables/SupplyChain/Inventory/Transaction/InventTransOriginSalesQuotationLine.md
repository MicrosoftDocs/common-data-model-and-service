---
title: InventTransOriginSalesQuotationLine - Common Data Model | Microsoft Docs
...
# InventTransOriginSalesQuotationLine
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/erp/Tables/SupplyChain/Inventory/Transaction/InventTransOriginSalesQuotationLine.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[InventTransOriginSalesQuotationLine/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="InventTransOriginSalesQuotationLine.md" target="_blank">Transaction/InventTransOriginSalesQuotationLine</a>|
|[InventTransOrigin](#InventTransOrigin)||<a href="InventTransOriginSalesQuotationLine.md" target="_blank">Transaction/InventTransOriginSalesQuotationLine</a>|
|[SalesQuotationLineDataAreaId](#SalesQuotationLineDataAreaId)||<a href="InventTransOriginSalesQuotationLine.md" target="_blank">Transaction/InventTransOriginSalesQuotationLine</a>|
|[SalesQuotationLineInventTransId](#SalesQuotationLineInventTransId)||<a href="InventTransOriginSalesQuotationLine.md" target="_blank">Transaction/InventTransOriginSalesQuotationLine</a>|
|[Relationship_InventTransOriginRelationshipId](#Relationship_InventTransOriginRelationshipId)||<a href="InventTransOriginSalesQuotationLine.md" target="_blank">Transaction/InventTransOriginSalesQuotationLine</a>|
|[Relationship_SalesQuotationLineRelationshipId](#Relationship_SalesQuotationLineRelationshipId)||<a href="InventTransOriginSalesQuotationLine.md" target="_blank">Transaction/InventTransOriginSalesQuotationLine</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Transaction/InventTransOriginSalesQuotationLine (this entity)  
