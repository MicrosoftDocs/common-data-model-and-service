---
title: CostObjectWithLowestTurnDataSetTable - Common Data Model | Microsoft Docs
...
# CostObjectWithLowestTurnDataSetTable

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/erp/Tables/SupplyChain/Inventory/Miscellaneous/CostObjectWithLowestTurnDataSetTable.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[CostObjectWithLowestTurnDataSetTable/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="CostObjectWithLowestTurnDataSetTable.md" target="_blank">Miscellaneous/CostObjectWithLowestTurnDataSetTable</a>|
...
|[EndingBalance](#EndingBalance)||<a href="CostObjectWithLowestTurnDataSetTable.md" target="_blank">Miscellaneous/CostObjectWithLowestTurnDataSetTable</a>|
|[InventoryTurn](#InventoryTurn)||<a href="CostObjectWithLowestTurnDataSetTable.md" target="_blank">Miscellaneous/CostObjectWithLowestTurnDataSetTable</a>|
|[SysDataCacheContextId](#SysDataCacheContextId)||<a href="CostObjectWithLowestTurnDataSetTable.md" target="_blank">Miscellaneous/CostObjectWithLowestTurnDataSetTable</a>|
|[DataAreaId](#DataAreaId)||<a href="CostObjectWithLowestTurnDataSetTable.md" target="_blank">Miscellaneous/CostObjectWithLowestTurnDataSetTable</a>|
|[Relationship_InventTableRelationshipId](#Relationship_InventTableRelationshipId)||<a href="CostObjectWithLowestTurnDataSetTable.md" target="_blank">Miscellaneous/CostObjectWithLowestTurnDataSetTable</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="CostObjectWithLowestTurnDataSetTable.md" target="_blank">Miscellaneous/CostObjectWithLowestTurnDataSetTable</a>|
...
### <a href=#InventoryTurn name="InventoryTurn">InventoryTurn</a>
...
<details>
<summary>List of traits for the InventoryTurn attribute are listed below.</summary>
