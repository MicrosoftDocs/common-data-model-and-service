---
title: ForecastPurch - Common Data Model | Microsoft Docs
...
# ForecastPurch
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/erp/Tables/SupplyChain/MasterPlanning/WorksheetLine/ForecastPurch.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[ForecastPurch/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="ForecastPurch.md" target="_blank">WorksheetLine/ForecastPurch</a>|
|[Active](#Active)||<a href="ForecastPurch.md" target="_blank">WorksheetLine/ForecastPurch</a>|
|[AllocateMethod](#AllocateMethod)||<a href="ForecastPurch.md" target="_blank">WorksheetLine/ForecastPurch</a>|
|[Amount](#Amount)||<a href="ForecastPurch.md" target="_blank">WorksheetLine/ForecastPurch</a>|
|[Comment](#Comment)||<a href="ForecastPurch.md" target="_blank">WorksheetLine/ForecastPurch</a>|
|[Cov](#Cov)||<a href="ForecastPurch.md" target="_blank">WorksheetLine/ForecastPurch</a>|
|[CovStatus](#CovStatus)||<a href="ForecastPurch.md" target="_blank">WorksheetLine/ForecastPurch</a>|
|[Currency](#Currency)||<a href="ForecastPurch.md" target="_blank">WorksheetLine/ForecastPurch</a>|
|[DefaultDimension](#DefaultDimension)||<a href="ForecastPurch.md" target="_blank">WorksheetLine/ForecastPurch</a>|
|[DiscAmount](#DiscAmount)||<a href="ForecastPurch.md" target="_blank">WorksheetLine/ForecastPurch</a>|
|[DiscPercent](#DiscPercent)||<a href="ForecastPurch.md" target="_blank">WorksheetLine/ForecastPurch</a>|
|[EndDate](#EndDate)||<a href="ForecastPurch.md" target="_blank">WorksheetLine/ForecastPurch</a>|
|[ExpandId](#ExpandId)||<a href="ForecastPurch.md" target="_blank">WorksheetLine/ForecastPurch</a>|
|[Freq](#Freq)||<a href="ForecastPurch.md" target="_blank">WorksheetLine/ForecastPurch</a>|
|[FreqCode](#FreqCode)||<a href="ForecastPurch.md" target="_blank">WorksheetLine/ForecastPurch</a>|
|[InventDimId](#InventDimId)||<a href="ForecastPurch.md" target="_blank">WorksheetLine/ForecastPurch</a>|
|[InventQty](#InventQty)||<a href="ForecastPurch.md" target="_blank">WorksheetLine/ForecastPurch</a>|
|[ItemAllocateId](#ItemAllocateId)||<a href="ForecastPurch.md" target="_blank">WorksheetLine/ForecastPurch</a>|
|[ItemBOMId](#ItemBOMId)||<a href="ForecastPurch.md" target="_blank">WorksheetLine/ForecastPurch</a>|
|[ItemGroupId](#ItemGroupId)||<a href="ForecastPurch.md" target="_blank">WorksheetLine/ForecastPurch</a>|
|[ItemId](#ItemId)||<a href="ForecastPurch.md" target="_blank">WorksheetLine/ForecastPurch</a>|
|[ItemRouteId](#ItemRouteId)||<a href="ForecastPurch.md" target="_blank">WorksheetLine/ForecastPurch</a>|
|[KeyId](#KeyId)||<a href="ForecastPurch.md" target="_blank">WorksheetLine/ForecastPurch</a>|
|[ModelId](#ModelId)||<a href="ForecastPurch.md" target="_blank">WorksheetLine/ForecastPurch</a>|
|[PdsCWQty](#PdsCWQty)||<a href="ForecastPurch.md" target="_blank">WorksheetLine/ForecastPurch</a>|
|[PdsCWUnitId](#PdsCWUnitId)||<a href="ForecastPurch.md" target="_blank">WorksheetLine/ForecastPurch</a>|
|[PriceUnit](#PriceUnit)||<a href="ForecastPurch.md" target="_blank">WorksheetLine/ForecastPurch</a>|
|[PurchMarkup](#PurchMarkup)||<a href="ForecastPurch.md" target="_blank">WorksheetLine/ForecastPurch</a>|
|[PurchPrice](#PurchPrice)||<a href="ForecastPurch.md" target="_blank">WorksheetLine/ForecastPurch</a>|
|[PurchQty](#PurchQty)||<a href="ForecastPurch.md" target="_blank">WorksheetLine/ForecastPurch</a>|
|[PurchUnitId](#PurchUnitId)||<a href="ForecastPurch.md" target="_blank">WorksheetLine/ForecastPurch</a>|
|[Report](#Report)||<a href="ForecastPurch.md" target="_blank">WorksheetLine/ForecastPurch</a>|
|[StartDate](#StartDate)||<a href="ForecastPurch.md" target="_blank">WorksheetLine/ForecastPurch</a>|
|[TaxGroupId](#TaxGroupId)||<a href="ForecastPurch.md" target="_blank">WorksheetLine/ForecastPurch</a>|
|[TaxItemGroupId](#TaxItemGroupId)||<a href="ForecastPurch.md" target="_blank">WorksheetLine/ForecastPurch</a>|
|[VendAccountId](#VendAccountId)||<a href="ForecastPurch.md" target="_blank">WorksheetLine/ForecastPurch</a>|
|[VendGroupId](#VendGroupId)||<a href="ForecastPurch.md" target="_blank">WorksheetLine/ForecastPurch</a>|
|[DataAreaId](#DataAreaId)||<a href="ForecastPurch.md" target="_blank">WorksheetLine/ForecastPurch</a>|
|[Relationship_CurrencyRelationshipId](#Relationship_CurrencyRelationshipId)||<a href="ForecastPurch.md" target="_blank">WorksheetLine/ForecastPurch</a>|
|[Relationship_DefaultDimensionRelationshipId](#Relationship_DefaultDimensionRelationshipId)||<a href="ForecastPurch.md" target="_blank">WorksheetLine/ForecastPurch</a>|
|[Relationship_ForecastItemAllocationRelationshipId](#Relationship_ForecastItemAllocationRelationshipId)||<a href="ForecastPurch.md" target="_blank">WorksheetLine/ForecastPurch</a>|
|[Relationship_ForecastModelRelationshipId](#Relationship_ForecastModelRelationshipId)||<a href="ForecastPurch.md" target="_blank">WorksheetLine/ForecastPurch</a>|
|[Relationship_InventDimRelationshipId](#Relationship_InventDimRelationshipId)||<a href="ForecastPurch.md" target="_blank">WorksheetLine/ForecastPurch</a>|
|[Relationship_InventItemGroupRelationshipId](#Relationship_InventItemGroupRelationshipId)||<a href="ForecastPurch.md" target="_blank">WorksheetLine/ForecastPurch</a>|
|[Relationship_InventTableRelationshipId](#Relationship_InventTableRelationshipId)||<a href="ForecastPurch.md" target="_blank">WorksheetLine/ForecastPurch</a>|
|[Relationship_LedgerAllocateKeyRelationshipId](#Relationship_LedgerAllocateKeyRelationshipId)||<a href="ForecastPurch.md" target="_blank">WorksheetLine/ForecastPurch</a>|
|[Relationship_RouteTableRelationshipId](#Relationship_RouteTableRelationshipId)||<a href="ForecastPurch.md" target="_blank">WorksheetLine/ForecastPurch</a>|
|[Relationship_SubBOMTableRelationshipId](#Relationship_SubBOMTableRelationshipId)||<a href="ForecastPurch.md" target="_blank">WorksheetLine/ForecastPurch</a>|
|[Relationship_TaxGroupHeadingRelationshipId](#Relationship_TaxGroupHeadingRelationshipId)||<a href="ForecastPurch.md" target="_blank">WorksheetLine/ForecastPurch</a>|
|[Relationship_TaxItemGroupHeadingRelationshipId](#Relationship_TaxItemGroupHeadingRelationshipId)||<a href="ForecastPurch.md" target="_blank">WorksheetLine/ForecastPurch</a>|
|[Relationship_VendGroupRelationshipId](#Relationship_VendGroupRelationshipId)||<a href="ForecastPurch.md" target="_blank">WorksheetLine/ForecastPurch</a>|
|[Relationship_VendTableRelationshipId](#Relationship_VendTableRelationshipId)||<a href="ForecastPurch.md" target="_blank">WorksheetLine/ForecastPurch</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="ForecastPurch.md" target="_blank">WorksheetLine/ForecastPurch</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: WorksheetLine/ForecastPurch (this entity)  
...
### <a href=#PurchUnitId name="PurchUnitId">PurchUnitId</a>
...
<details>
<summary>List of traits for the PurchUnitId attribute are listed below.</summary>
...
**means.identity.entityId**  
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="../Group/ForecastItemAllocation.md" target="_blank">/core/erp/Tables/SupplyChain/MasterPlanning/Group/ForecastItemAllocation.cdm.json/ForecastItemAllocation</a></td><td><a href="../Group/ForecastItemAllocation.md#RecId" target="_blank">RecId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
