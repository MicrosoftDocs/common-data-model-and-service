---
title: CatProcureCatalogTranslation - Common Data Model | Microsoft Docs
...
# CatProcureCatalogTranslation

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/erp/Tables/SupplyChain/ProcurementAndSourcing/Main/CatProcureCatalogTranslation.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[CatProcureCatalogTranslation/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="CatProcureCatalogTranslation.md" target="_blank">Main/CatProcureCatalogTranslation</a>|
|[Catalog](#Catalog)||<a href="CatProcureCatalogTranslation.md" target="_blank">Main/CatProcureCatalogTranslation</a>|
|[LanguageId](#LanguageId)||<a href="CatProcureCatalogTranslation.md" target="_blank">Main/CatProcureCatalogTranslation</a>|
|[WelcomeText](#WelcomeText)||<a href="CatProcureCatalogTranslation.md" target="_blank">Main/CatProcureCatalogTranslation</a>|
|[Relationship_CatProcureCatalogTableRelationshipId](#Relationship_CatProcureCatalogTableRelationshipId)||<a href="CatProcureCatalogTranslation.md" target="_blank">Main/CatProcureCatalogTranslation</a>|
|[Relationship_LanguageTableRelationshipId](#Relationship_LanguageTableRelationshipId)||<a href="CatProcureCatalogTranslation.md" target="_blank">Main/CatProcureCatalogTranslation</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Main/CatProcureCatalogTranslation (this entity)  
