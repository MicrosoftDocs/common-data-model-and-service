---
title: CatCatalogPolicyRule - Common Data Model | Microsoft Docs
...
# CatCatalogPolicyRule

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/erp/Tables/SupplyChain/ProcurementAndSourcing/Main/CatCatalogPolicyRule.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[CatCatalogPolicyRule/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="CatCatalogPolicyRule.md" target="_blank">Main/CatCatalogPolicyRule</a>|
|[InstanceRelationType](#InstanceRelationType)||<a href="CatCatalogPolicyRule.md" target="_blank">Main/CatCatalogPolicyRule</a>|
|[IsInherited](#IsInherited)||<a href="CatCatalogPolicyRule.md" target="_blank">Main/CatCatalogPolicyRule</a>|
|[Policy](#Policy)||<a href="CatCatalogPolicyRule.md" target="_blank">Main/CatCatalogPolicyRule</a>|
|[PolicyRuleType](#PolicyRuleType)||<a href="CatCatalogPolicyRule.md" target="_blank">Main/CatCatalogPolicyRule</a>|
|[ValidFrom](#ValidFrom)||<a href="CatCatalogPolicyRule.md" target="_blank">Main/CatCatalogPolicyRule</a>|
|[ValidTo](#ValidTo)||<a href="CatCatalogPolicyRule.md" target="_blank">Main/CatCatalogPolicyRule</a>|
|[Relationship_PolicyRelationshipId](#Relationship_PolicyRelationshipId)||<a href="CatCatalogPolicyRule.md" target="_blank">Main/CatCatalogPolicyRule</a>|
|[Relationship_PolicyRulesRelationshipId](#Relationship_PolicyRulesRelationshipId)||<a href="CatCatalogPolicyRule.md" target="_blank">Main/CatCatalogPolicyRule</a>|
|[Catalog](#Catalog)||<a href="CatCatalogPolicyRule.md" target="_blank">Main/CatCatalogPolicyRule</a>|
|[Relationship_CatProcureCatalogTableRelationshipId](#Relationship_CatProcureCatalogTableRelationshipId)||<a href="CatCatalogPolicyRule.md" target="_blank">Main/CatCatalogPolicyRule</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Main/CatCatalogPolicyRule (this entity)  
