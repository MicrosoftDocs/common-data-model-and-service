---
title: PurchReqLineVendorSuggestion - Common Data Model | Microsoft Docs
...
# PurchReqLineVendorSuggestion
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/erp/Tables/SupplyChain/ProcurementAndSourcing/WorksheetLine/PurchReqLineVendorSuggestion.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[PurchReqLineVendorSuggestion/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="PurchReqLineVendorSuggestion.md" target="_blank">WorksheetLine/PurchReqLineVendorSuggestion</a>|
|[IsModified](#IsModified)||<a href="PurchReqLineVendorSuggestion.md" target="_blank">WorksheetLine/PurchReqLineVendorSuggestion</a>|
|[PurchReqLine](#PurchReqLine)||<a href="PurchReqLineVendorSuggestion.md" target="_blank">WorksheetLine/PurchReqLineVendorSuggestion</a>|
|[VendAccount](#VendAccount)||<a href="PurchReqLineVendorSuggestion.md" target="_blank">WorksheetLine/PurchReqLineVendorSuggestion</a>|
|[VendAccountDataArea](#VendAccountDataArea)||<a href="PurchReqLineVendorSuggestion.md" target="_blank">WorksheetLine/PurchReqLineVendorSuggestion</a>|
|[Relationship_PurchReqLineRelationshipId](#Relationship_PurchReqLineRelationshipId)||<a href="PurchReqLineVendorSuggestion.md" target="_blank">WorksheetLine/PurchReqLineVendorSuggestion</a>|
|[Relationship_VendAccountRelationshipId](#Relationship_VendAccountRelationshipId)||<a href="PurchReqLineVendorSuggestion.md" target="_blank">WorksheetLine/PurchReqLineVendorSuggestion</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: WorksheetLine/PurchReqLineVendorSuggestion (this entity)  
