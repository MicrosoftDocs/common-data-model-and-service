---
title: PurchReqTableHistory - Common Data Model | Microsoft Docs
...
# PurchReqTableHistory
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/erp/Tables/SupplyChain/ProcurementAndSourcing/TransactionHeader/PurchReqTableHistory.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[PurchReqTableHistory/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="PurchReqTableHistory.md" target="_blank">TransactionHeader/PurchReqTableHistory</a>|
|[BusinessJustification](#BusinessJustification)||<a href="PurchReqTableHistory.md" target="_blank">TransactionHeader/PurchReqTableHistory</a>|
|[Originator](#Originator)||<a href="PurchReqTableHistory.md" target="_blank">TransactionHeader/PurchReqTableHistory</a>|
|[ProjId](#ProjId)||<a href="PurchReqTableHistory.md" target="_blank">TransactionHeader/PurchReqTableHistory</a>|
|[ProjIdDataArea](#ProjIdDataArea)||<a href="PurchReqTableHistory.md" target="_blank">TransactionHeader/PurchReqTableHistory</a>|
|[PurchReqId](#PurchReqId)||<a href="PurchReqTableHistory.md" target="_blank">TransactionHeader/PurchReqTableHistory</a>|
|[PurchReqName](#PurchReqName)||<a href="PurchReqTableHistory.md" target="_blank">TransactionHeader/PurchReqTableHistory</a>|
|[PurchReqTable](#PurchReqTable)||<a href="PurchReqTableHistory.md" target="_blank">TransactionHeader/PurchReqTableHistory</a>|
|[PurchReqType](#PurchReqType)||<a href="PurchReqTableHistory.md" target="_blank">TransactionHeader/PurchReqTableHistory</a>|
|[RequiredDate](#RequiredDate)||<a href="PurchReqTableHistory.md" target="_blank">TransactionHeader/PurchReqTableHistory</a>|
|[SourceDocumentHeader](#SourceDocumentHeader)||<a href="PurchReqTableHistory.md" target="_blank">TransactionHeader/PurchReqTableHistory</a>|
|[State](#State)||<a href="PurchReqTableHistory.md" target="_blank">TransactionHeader/PurchReqTableHistory</a>|
|[Status](#Status)||<a href="PurchReqTableHistory.md" target="_blank">TransactionHeader/PurchReqTableHistory</a>|
|[SubmittedBy](#SubmittedBy)||<a href="PurchReqTableHistory.md" target="_blank">TransactionHeader/PurchReqTableHistory</a>|
|[SubmittedDateTime](#SubmittedDateTime)||<a href="PurchReqTableHistory.md" target="_blank">TransactionHeader/PurchReqTableHistory</a>|
|[TransDate](#TransDate)||<a href="PurchReqTableHistory.md" target="_blank">TransactionHeader/PurchReqTableHistory</a>|
|[ValidFrom](#ValidFrom)||<a href="PurchReqTableHistory.md" target="_blank">TransactionHeader/PurchReqTableHistory</a>|
|[ValidTo](#ValidTo)||<a href="PurchReqTableHistory.md" target="_blank">TransactionHeader/PurchReqTableHistory</a>|
|[Relationship_ProjTableRelationshipId](#Relationship_ProjTableRelationshipId)||<a href="PurchReqTableHistory.md" target="_blank">TransactionHeader/PurchReqTableHistory</a>|
|[Relationship_PurchReqBusinessJustificationCodesRelationshipId](#Relationship_PurchReqBusinessJustificationCodesRelationshipId)||<a href="PurchReqTableHistory.md" target="_blank">TransactionHeader/PurchReqTableHistory</a>|
|[Relationship_PurchReqTableRelationshipId](#Relationship_PurchReqTableRelationshipId)||<a href="PurchReqTableHistory.md" target="_blank">TransactionHeader/PurchReqTableHistory</a>|
|[Relationship_SourceDocumentHeaderRelationshipId](#Relationship_SourceDocumentHeaderRelationshipId)||<a href="PurchReqTableHistory.md" target="_blank">TransactionHeader/PurchReqTableHistory</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: TransactionHeader/PurchReqTableHistory (this entity)  
