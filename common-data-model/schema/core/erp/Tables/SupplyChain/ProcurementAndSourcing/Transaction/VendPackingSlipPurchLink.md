---
title: VendPackingSlipPurchLink - Common Data Model | Microsoft Docs
...
# VendPackingSlipPurchLink
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/erp/Tables/SupplyChain/ProcurementAndSourcing/Transaction/VendPackingSlipPurchLink.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[VendPackingSlipPurchLink/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="VendPackingSlipPurchLink.md" target="_blank">Transaction/VendPackingSlipPurchLink</a>|
|[deliveryDate](#deliveryDate)||<a href="VendPackingSlipPurchLink.md" target="_blank">Transaction/VendPackingSlipPurchLink</a>|
|[invoiceAccount](#invoiceAccount)||<a href="VendPackingSlipPurchLink.md" target="_blank">Transaction/VendPackingSlipPurchLink</a>|
|[orderAccount](#orderAccount)||<a href="VendPackingSlipPurchLink.md" target="_blank">Transaction/VendPackingSlipPurchLink</a>|
|[origPurchId](#origPurchId)||<a href="VendPackingSlipPurchLink.md" target="_blank">Transaction/VendPackingSlipPurchLink</a>|
|[packingSlipId](#packingSlipId)||<a href="VendPackingSlipPurchLink.md" target="_blank">Transaction/VendPackingSlipPurchLink</a>|
|[VendPackingSlipJour](#VendPackingSlipJour)||<a href="VendPackingSlipPurchLink.md" target="_blank">Transaction/VendPackingSlipPurchLink</a>|
|[DataAreaId](#DataAreaId)||<a href="VendPackingSlipPurchLink.md" target="_blank">Transaction/VendPackingSlipPurchLink</a>|
|[Relationship_InvoiceVendorRelationshipId](#Relationship_InvoiceVendorRelationshipId)||<a href="VendPackingSlipPurchLink.md" target="_blank">Transaction/VendPackingSlipPurchLink</a>|
|[Relationship_OrderVendorRelationshipId](#Relationship_OrderVendorRelationshipId)||<a href="VendPackingSlipPurchLink.md" target="_blank">Transaction/VendPackingSlipPurchLink</a>|
|[Relationship_PurchTableRelationshipId](#Relationship_PurchTableRelationshipId)||<a href="VendPackingSlipPurchLink.md" target="_blank">Transaction/VendPackingSlipPurchLink</a>|
|[Relationship_vendPackingSlipJourRelationshipId](#Relationship_vendPackingSlipJourRelationshipId)||<a href="VendPackingSlipPurchLink.md" target="_blank">Transaction/VendPackingSlipPurchLink</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="VendPackingSlipPurchLink.md" target="_blank">Transaction/VendPackingSlipPurchLink</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Transaction/VendPackingSlipPurchLink (this entity)  
