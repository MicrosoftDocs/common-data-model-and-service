...
# PdsMRCParameters
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/erp/Tables/SupplyChain/ProductInformationManagement/Parameter/PdsMRCParameters.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[PdsMRCParameters/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="PdsMRCParameters.md" target="_blank">Parameter/PdsMRCParameters</a>|
...
<details>
<summary>List of traits for the AlertOnAdviseIntervalPurchase attribute are listed below.</summary>
...
<details>
<summary>List of traits for the AlertOnAdviseIntervalSales attribute are listed below.</summary>
...
<details>
<summary>List of traits for the AlertOnExpiryPurchase attribute are listed below.</summary>

**is.dataFormat.integer**  
**is.dataFormat.integer**  
</details>

### <a href=#AlertOnExpirySales name="AlertOnExpirySales">AlertOnExpirySales</a>
...
<details>
<summary>List of traits for the AlertOnExpirySales attribute are listed below.</summary>
...
<details>
<summary>List of traits for the EffectiveDayType attribute are listed below.</summary>
...
<details>
<summary>List of traits for the EventRuleIds attribute are listed below.</summary>
...
<details>
<summary>List of traits for the MSDSAdminId attribute are listed below.</summary>
...
<details>
<summary>List of traits for the MSDSAdviseInterval attribute are listed below.</summary>
...
<details>
<summary>List of traits for the MSDSInterval attribute are listed below.</summary>
...
<details>
<summary>List of traits for the PostingError attribute are listed below.</summary>
...
<details>
<summary>List of traits for the PrintMSDSOnPack attribute are listed below.</summary>
...
<details>
<summary>List of traits for the RegulationWarningOnPack attribute are listed below.</summary>
...
<details>
<summary>List of traits for the RegulationWarningOnPurchase attribute are listed below.</summary>
...
<details>
<summary>List of traits for the RegulationWarningOnSales attribute are listed below.</summary>
...
<details>
<summary>List of traits for the RequireReason attribute are listed below.</summary>
