---
title: ProdParmSplit - Common Data Model | Microsoft Docs
...
# ProdParmSplit
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/erp/Tables/SupplyChain/ProductionControl/Worksheet/ProdParmSplit.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[ProdParmSplit/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="ProdParmSplit.md" target="_blank">Worksheet/ProdParmSplit</a>|
|[ActivityNumber](#ActivityNumber)||<a href="ProdParmSplit.md" target="_blank">Worksheet/ProdParmSplit</a>|
|[AutoUpdate](#AutoUpdate)||<a href="ProdParmSplit.md" target="_blank">Worksheet/ProdParmSplit</a>|
|[DlvDate](#DlvDate)||<a href="ProdParmSplit.md" target="_blank">Worksheet/ProdParmSplit</a>|
|[DlvTime](#DlvTime)||<a href="ProdParmSplit.md" target="_blank">Worksheet/ProdParmSplit</a>|
|[ExecutedDateTime](#ExecutedDateTime)||<a href="ProdParmSplit.md" target="_blank">Worksheet/ProdParmSplit</a>|
|[IsProject](#IsProject)||<a href="ProdParmSplit.md" target="_blank">Worksheet/ProdParmSplit</a>|
|[JobStatus](#JobStatus)||<a href="ProdParmSplit.md" target="_blank">Worksheet/ProdParmSplit</a>|
|[LineNum](#LineNum)||<a href="ProdParmSplit.md" target="_blank">Worksheet/ProdParmSplit</a>|
|[ParmId](#ParmId)||<a href="ProdParmSplit.md" target="_blank">Worksheet/ProdParmSplit</a>|
|[PdsCWQtySplit](#PdsCWQtySplit)||<a href="ProdParmSplit.md" target="_blank">Worksheet/ProdParmSplit</a>|
|[ProdId](#ProdId)||<a href="ProdParmSplit.md" target="_blank">Worksheet/ProdParmSplit</a>|
|[ProjCategoryId](#ProjCategoryId)||<a href="ProdParmSplit.md" target="_blank">Worksheet/ProdParmSplit</a>|
|[ProjCostAmount](#ProjCostAmount)||<a href="ProdParmSplit.md" target="_blank">Worksheet/ProdParmSplit</a>|
|[ProjCostPrice](#ProjCostPrice)||<a href="ProdParmSplit.md" target="_blank">Worksheet/ProdParmSplit</a>|
|[ProjId](#ProjId)||<a href="ProdParmSplit.md" target="_blank">Worksheet/ProdParmSplit</a>|
|[ProjLinePropertyId](#ProjLinePropertyId)||<a href="ProdParmSplit.md" target="_blank">Worksheet/ProdParmSplit</a>|
|[ProjLinkedToOrder](#ProjLinkedToOrder)||<a href="ProdParmSplit.md" target="_blank">Worksheet/ProdParmSplit</a>|
|[ProjPostingType](#ProjPostingType)||<a href="ProdParmSplit.md" target="_blank">Worksheet/ProdParmSplit</a>|
|[ProjSalesCurrencyId](#ProjSalesCurrencyId)||<a href="ProdParmSplit.md" target="_blank">Worksheet/ProdParmSplit</a>|
|[ProjSalesPrice](#ProjSalesPrice)||<a href="ProdParmSplit.md" target="_blank">Worksheet/ProdParmSplit</a>|
|[ProjSalesUnitId](#ProjSalesUnitId)||<a href="ProdParmSplit.md" target="_blank">Worksheet/ProdParmSplit</a>|
|[ProjTaxGroupId](#ProjTaxGroupId)||<a href="ProdParmSplit.md" target="_blank">Worksheet/ProdParmSplit</a>|
|[ProjTaxItemGroupId](#ProjTaxItemGroupId)||<a href="ProdParmSplit.md" target="_blank">Worksheet/ProdParmSplit</a>|
|[QtySplit](#QtySplit)||<a href="ProdParmSplit.md" target="_blank">Worksheet/ProdParmSplit</a>|
|[DataAreaId](#DataAreaId)||<a href="ProdParmSplit.md" target="_blank">Worksheet/ProdParmSplit</a>|
|[Relationship_ProdTableRelationshipId](#Relationship_ProdTableRelationshipId)||<a href="ProdParmSplit.md" target="_blank">Worksheet/ProdParmSplit</a>|
|[Relationship_ProjCategoryRelationshipId](#Relationship_ProjCategoryRelationshipId)||<a href="ProdParmSplit.md" target="_blank">Worksheet/ProdParmSplit</a>|
|[Relationship_ProjectSalesCurrencyRelationshipId](#Relationship_ProjectSalesCurrencyRelationshipId)||<a href="ProdParmSplit.md" target="_blank">Worksheet/ProdParmSplit</a>|
|[Relationship_ProjectTaxGroupHeadingRelationshipId](#Relationship_ProjectTaxGroupHeadingRelationshipId)||<a href="ProdParmSplit.md" target="_blank">Worksheet/ProdParmSplit</a>|
|[Relationship_ProjectTaxItemGroupHeadingRelationshipId](#Relationship_ProjectTaxItemGroupHeadingRelationshipId)||<a href="ProdParmSplit.md" target="_blank">Worksheet/ProdParmSplit</a>|
|[Relationship_ProjLinePropertyRelationshipId](#Relationship_ProjLinePropertyRelationshipId)||<a href="ProdParmSplit.md" target="_blank">Worksheet/ProdParmSplit</a>|
|[Relationship_ProjTableRelationshipId](#Relationship_ProjTableRelationshipId)||<a href="ProdParmSplit.md" target="_blank">Worksheet/ProdParmSplit</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="ProdParmSplit.md" target="_blank">Worksheet/ProdParmSplit</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Worksheet/ProdParmSplit (this entity)  
...
### <a href=#DlvTime name="DlvTime">DlvTime</a>
...
<details>
<summary>List of traits for the DlvTime attribute are listed below.</summary>
...
### <a href=#IsProject name="IsProject">IsProject</a>
...
<details>
<summary>List of traits for the IsProject attribute are listed below.</summary>
...
### <a href=#PdsCWQtySplit name="PdsCWQtySplit">PdsCWQtySplit</a>
...
<details>
<summary>List of traits for the PdsCWQtySplit attribute are listed below.</summary>
...
### <a href=#ProjLinkedToOrder name="ProjLinkedToOrder">ProjLinkedToOrder</a>
...
<details>
<summary>List of traits for the ProjLinkedToOrder attribute are listed below.</summary>

**is.dataFormat.integer**  
**is.dataFormat.integer**  
</details>

### <a href=#ProjPostingType name="ProjPostingType">ProjPostingType</a>
...
<details>
<summary>List of traits for the ProjPostingType attribute are listed below.</summary>
...
### <a href=#QtySplit name="QtySplit">QtySplit</a>
...
<details>
<summary>List of traits for the QtySplit attribute are listed below.</summary>
