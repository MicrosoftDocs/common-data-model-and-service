---
title: KanbanJobIssue - Common Data Model | Microsoft Docs
...
# KanbanJobIssue
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/erp/Tables/SupplyChain/ProductionControl/Transaction/KanbanJobIssue.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[KanbanJobIssue/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="KanbanJobIssue.md" target="_blank">Transaction/KanbanJobIssue</a>|
|[InventRefId](#InventRefId)||<a href="KanbanJobIssue.md" target="_blank">Transaction/KanbanJobIssue</a>|
|[InventRefTransId](#InventRefTransId)||<a href="KanbanJobIssue.md" target="_blank">Transaction/KanbanJobIssue</a>|
|[InventRefType](#InventRefType)||<a href="KanbanJobIssue.md" target="_blank">Transaction/KanbanJobIssue</a>|
|[KanbanJob](#KanbanJob)||<a href="KanbanJobIssue.md" target="_blank">Transaction/KanbanJobIssue</a>|
|[SourceDocumentLine](#SourceDocumentLine)||<a href="KanbanJobIssue.md" target="_blank">Transaction/KanbanJobIssue</a>|
|[Relationship_KanbanJobRelationshipId](#Relationship_KanbanJobRelationshipId)||<a href="KanbanJobIssue.md" target="_blank">Transaction/KanbanJobIssue</a>|
|[Relationship_SourceDocumentLineRelationshipId](#Relationship_SourceDocumentLineRelationshipId)||<a href="KanbanJobIssue.md" target="_blank">Transaction/KanbanJobIssue</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Transaction/KanbanJobIssue (this entity)  
