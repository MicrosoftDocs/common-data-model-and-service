---
title: SalesBasket - Common Data Model | Microsoft Docs
...
# SalesBasket
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/erp/Tables/SupplyChain/SalesAndMarketing/WorksheetHeader/SalesBasket.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[SalesBasket/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="SalesBasket.md" target="_blank">WorksheetHeader/SalesBasket</a>|
|[PriceGroupId](#PriceGroupId)||<a href="SalesBasket.md" target="_blank">WorksheetHeader/SalesBasket</a>|
|[ContactPersonId](#ContactPersonId)||<a href="SalesBasket.md" target="_blank">WorksheetHeader/SalesBasket</a>|
|[CurrencyCode](#CurrencyCode)||<a href="SalesBasket.md" target="_blank">WorksheetHeader/SalesBasket</a>|
|[CustAccount](#CustAccount)||<a href="SalesBasket.md" target="_blank">WorksheetHeader/SalesBasket</a>|
|[CustomerRef](#CustomerRef)||<a href="SalesBasket.md" target="_blank">WorksheetHeader/SalesBasket</a>|
|[DeliveryDate](#DeliveryDate)||<a href="SalesBasket.md" target="_blank">WorksheetHeader/SalesBasket</a>|
|[DeliveryLocation](#DeliveryLocation)||<a href="SalesBasket.md" target="_blank">WorksheetHeader/SalesBasket</a>|
|[DeliveryName](#DeliveryName)||<a href="SalesBasket.md" target="_blank">WorksheetHeader/SalesBasket</a>|
|[DiscPercent](#DiscPercent)||<a href="SalesBasket.md" target="_blank">WorksheetHeader/SalesBasket</a>|
|[ECPCustSignUpId](#ECPCustSignUpId)||<a href="SalesBasket.md" target="_blank">WorksheetHeader/SalesBasket</a>|
|[EndDisc](#EndDisc)||<a href="SalesBasket.md" target="_blank">WorksheetHeader/SalesBasket</a>|
|[Guest](#Guest)||<a href="SalesBasket.md" target="_blank">WorksheetHeader/SalesBasket</a>|
|[InclTax](#InclTax)||<a href="SalesBasket.md" target="_blank">WorksheetHeader/SalesBasket</a>|
|[InternalExternal](#InternalExternal)||<a href="SalesBasket.md" target="_blank">WorksheetHeader/SalesBasket</a>|
|[InventLocationId](#InventLocationId)||<a href="SalesBasket.md" target="_blank">WorksheetHeader/SalesBasket</a>|
|[InventSiteId](#InventSiteId)||<a href="SalesBasket.md" target="_blank">WorksheetHeader/SalesBasket</a>|
|[LineDisc](#LineDisc)||<a href="SalesBasket.md" target="_blank">WorksheetHeader/SalesBasket</a>|
|[ManualEntryChangepolicy](#ManualEntryChangepolicy)||<a href="SalesBasket.md" target="_blank">WorksheetHeader/SalesBasket</a>|
|[MultiLineDisc](#MultiLineDisc)||<a href="SalesBasket.md" target="_blank">WorksheetHeader/SalesBasket</a>|
|[PriceCalc](#PriceCalc)||<a href="SalesBasket.md" target="_blank">WorksheetHeader/SalesBasket</a>|
|[PurchOrderFormNum](#PurchOrderFormNum)||<a href="SalesBasket.md" target="_blank">WorksheetHeader/SalesBasket</a>|
|[SalesBasketId](#SalesBasketId)||<a href="SalesBasket.md" target="_blank">WorksheetHeader/SalesBasket</a>|
|[SalesType](#SalesType)||<a href="SalesBasket.md" target="_blank">WorksheetHeader/SalesBasket</a>|
|[SessionId](#SessionId)||<a href="SalesBasket.md" target="_blank">WorksheetHeader/SalesBasket</a>|
|[SystemEntryChangePolicy](#SystemEntryChangePolicy)||<a href="SalesBasket.md" target="_blank">WorksheetHeader/SalesBasket</a>|
|[SystemEntrySource](#SystemEntrySource)||<a href="SalesBasket.md" target="_blank">WorksheetHeader/SalesBasket</a>|
|[Touch](#Touch)||<a href="SalesBasket.md" target="_blank">WorksheetHeader/SalesBasket</a>|
|[DataAreaId](#DataAreaId)||<a href="SalesBasket.md" target="_blank">WorksheetHeader/SalesBasket</a>|
|[Relationship_ContactPersonRelationshipId](#Relationship_ContactPersonRelationshipId)||<a href="SalesBasket.md" target="_blank">WorksheetHeader/SalesBasket</a>|
|[Relationship_CurrencyRelationshipId](#Relationship_CurrencyRelationshipId)||<a href="SalesBasket.md" target="_blank">WorksheetHeader/SalesBasket</a>|
|[Relationship_CustLineDiscountGroupRelationshipId](#Relationship_CustLineDiscountGroupRelationshipId)||<a href="SalesBasket.md" target="_blank">WorksheetHeader/SalesBasket</a>|
|[Relationship_CustMultiLineDiscountGroupRelationshipId](#Relationship_CustMultiLineDiscountGroupRelationshipId)||<a href="SalesBasket.md" target="_blank">WorksheetHeader/SalesBasket</a>|
|[Relationship_CustPriceGroupRelationshipId](#Relationship_CustPriceGroupRelationshipId)||<a href="SalesBasket.md" target="_blank">WorksheetHeader/SalesBasket</a>|
|[Relationship_CustTableRelationshipId](#Relationship_CustTableRelationshipId)||<a href="SalesBasket.md" target="_blank">WorksheetHeader/SalesBasket</a>|
|[Relationship_CustTotalDiscountGroupRelationshipId](#Relationship_CustTotalDiscountGroupRelationshipId)||<a href="SalesBasket.md" target="_blank">WorksheetHeader/SalesBasket</a>|
|[Relationship_CustTransOpenRelationshipId](#Relationship_CustTransOpenRelationshipId)||<a href="SalesBasket.md" target="_blank">WorksheetHeader/SalesBasket</a>|
|[Relationship_DeliveryLocation_FKRelationshipId](#Relationship_DeliveryLocation_FKRelationshipId)||<a href="SalesBasket.md" target="_blank">WorksheetHeader/SalesBasket</a>|
|[Relationship_InventLocationRelationshipId](#Relationship_InventLocationRelationshipId)||<a href="SalesBasket.md" target="_blank">WorksheetHeader/SalesBasket</a>|
|[Relationship_InventSiteRelationshipId](#Relationship_InventSiteRelationshipId)||<a href="SalesBasket.md" target="_blank">WorksheetHeader/SalesBasket</a>|
|[Relationship_PriceDiscChangePolicyRecId1RelationshipId](#Relationship_PriceDiscChangePolicyRecId1RelationshipId)||<a href="SalesBasket.md" target="_blank">WorksheetHeader/SalesBasket</a>|
|[Relationship_PriceDiscChangePolicyRecId2RelationshipId](#Relationship_PriceDiscChangePolicyRecId2RelationshipId)||<a href="SalesBasket.md" target="_blank">WorksheetHeader/SalesBasket</a>|
|[Relationship_SalesTableRelationshipId](#Relationship_SalesTableRelationshipId)||<a href="SalesBasket.md" target="_blank">WorksheetHeader/SalesBasket</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="SalesBasket.md" target="_blank">WorksheetHeader/SalesBasket</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: WorksheetHeader/SalesBasket (this entity)  
...
### <a href=#ECPCustSignUpId name="ECPCustSignUpId">ECPCustSignUpId</a>
...
<details>
<summary>List of traits for the ECPCustSignUpId attribute are listed below.</summary>
...
<details>
<summary>List of traits for the Guest attribute are listed below.</summary>
...
### <a href=#InternalExternal name="InternalExternal">InternalExternal</a>
...
<details>
<summary>List of traits for the InternalExternal attribute are listed below.</summary>
...
### <a href=#PriceCalc name="PriceCalc">PriceCalc</a>
...
<details>
<summary>List of traits for the PriceCalc attribute are listed below.</summary>
...
### <a href=#Touch name="Touch">Touch</a>
...
<details>
<summary>List of traits for the Touch attribute are listed below.</summary>
...
**means.identity.entityId**  
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="SalesTable.md" target="_blank">/core/erp/Tables/SupplyChain/SalesAndMarketing/WorksheetHeader/SalesTable.cdm.json/SalesTable</a></td><td><a href="SalesTable.md#RecId" target="_blank">RecId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
