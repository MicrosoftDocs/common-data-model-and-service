...
# CustConfirmTrans
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/erp/Tables/SupplyChain/SalesAndMarketing/Transaction/CustConfirmTrans.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[CustConfirmTrans/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="CustConfirmTrans.md" target="_blank">Transaction/CustConfirmTrans</a>|
|[ConfirmDate](#ConfirmDate)||<a href="CustConfirmTrans.md" target="_blank">Transaction/CustConfirmTrans</a>|
|[ConfirmId](#ConfirmId)||<a href="CustConfirmTrans.md" target="_blank">Transaction/CustConfirmTrans</a>|
|[CurrencyCode](#CurrencyCode)||<a href="CustConfirmTrans.md" target="_blank">Transaction/CustConfirmTrans</a>|
|[DefaultDimension](#DefaultDimension)||<a href="CustConfirmTrans.md" target="_blank">Transaction/CustConfirmTrans</a>|
|[DiscAmount](#DiscAmount)||<a href="CustConfirmTrans.md" target="_blank">Transaction/CustConfirmTrans</a>|
|[DiscPercent](#DiscPercent)||<a href="CustConfirmTrans.md" target="_blank">Transaction/CustConfirmTrans</a>|
|[DlvDate](#DlvDate)||<a href="CustConfirmTrans.md" target="_blank">Transaction/CustConfirmTrans</a>|
|[DlvTerm](#DlvTerm)||<a href="CustConfirmTrans.md" target="_blank">Transaction/CustConfirmTrans</a>|
|[ExternalItemId](#ExternalItemId)||<a href="CustConfirmTrans.md" target="_blank">Transaction/CustConfirmTrans</a>|
|[InventDimId](#InventDimId)||<a href="CustConfirmTrans.md" target="_blank">Transaction/CustConfirmTrans</a>|
|[InventQty](#InventQty)||<a href="CustConfirmTrans.md" target="_blank">Transaction/CustConfirmTrans</a>|
|[InventTransId](#InventTransId)||<a href="CustConfirmTrans.md" target="_blank">Transaction/CustConfirmTrans</a>|
|[ItemId](#ItemId)||<a href="CustConfirmTrans.md" target="_blank">Transaction/CustConfirmTrans</a>|
|[LineAmount](#LineAmount)||<a href="CustConfirmTrans.md" target="_blank">Transaction/CustConfirmTrans</a>|
|[LineAmountTax](#LineAmountTax)||<a href="CustConfirmTrans.md" target="_blank">Transaction/CustConfirmTrans</a>|
|[LineDisc](#LineDisc)||<a href="CustConfirmTrans.md" target="_blank">Transaction/CustConfirmTrans</a>|
|[LineHeader](#LineHeader)||<a href="CustConfirmTrans.md" target="_blank">Transaction/CustConfirmTrans</a>|
|[LineNum](#LineNum)||<a href="CustConfirmTrans.md" target="_blank">Transaction/CustConfirmTrans</a>|
|[LinePercent](#LinePercent)||<a href="CustConfirmTrans.md" target="_blank">Transaction/CustConfirmTrans</a>|
|[MultiLnDisc](#MultiLnDisc)||<a href="CustConfirmTrans.md" target="_blank">Transaction/CustConfirmTrans</a>|
|[MultiLnPercent](#MultiLnPercent)||<a href="CustConfirmTrans.md" target="_blank">Transaction/CustConfirmTrans</a>|
|[Name](#Name)||<a href="CustConfirmTrans.md" target="_blank">Transaction/CustConfirmTrans</a>|
|[OrigSalesId](#OrigSalesId)||<a href="CustConfirmTrans.md" target="_blank">Transaction/CustConfirmTrans</a>|
|[PdsCWQty](#PdsCWQty)||<a href="CustConfirmTrans.md" target="_blank">Transaction/CustConfirmTrans</a>|
|[PriceUnit](#PriceUnit)||<a href="CustConfirmTrans.md" target="_blank">Transaction/CustConfirmTrans</a>|
|[Qty](#Qty)||<a href="CustConfirmTrans.md" target="_blank">Transaction/CustConfirmTrans</a>|
|[SalesCategory](#SalesCategory)||<a href="CustConfirmTrans.md" target="_blank">Transaction/CustConfirmTrans</a>|
|[SalesGroup](#SalesGroup)||<a href="CustConfirmTrans.md" target="_blank">Transaction/CustConfirmTrans</a>|
|[SalesId](#SalesId)||<a href="CustConfirmTrans.md" target="_blank">Transaction/CustConfirmTrans</a>|
|[SalesMarkup](#SalesMarkup)||<a href="CustConfirmTrans.md" target="_blank">Transaction/CustConfirmTrans</a>|
|[SalesPrice](#SalesPrice)||<a href="CustConfirmTrans.md" target="_blank">Transaction/CustConfirmTrans</a>|
|[SalesUnit](#SalesUnit)||<a href="CustConfirmTrans.md" target="_blank">Transaction/CustConfirmTrans</a>|
|[StockedProduct](#StockedProduct)||<a href="CustConfirmTrans.md" target="_blank">Transaction/CustConfirmTrans</a>|
|[TaxAmount](#TaxAmount)||<a href="CustConfirmTrans.md" target="_blank">Transaction/CustConfirmTrans</a>|
|[TaxGroup](#TaxGroup)||<a href="CustConfirmTrans.md" target="_blank">Transaction/CustConfirmTrans</a>|
|[TaxItemGroup](#TaxItemGroup)||<a href="CustConfirmTrans.md" target="_blank">Transaction/CustConfirmTrans</a>|
|[TaxWriteCode](#TaxWriteCode)||<a href="CustConfirmTrans.md" target="_blank">Transaction/CustConfirmTrans</a>|
|[DataAreaId](#DataAreaId)||<a href="CustConfirmTrans.md" target="_blank">Transaction/CustConfirmTrans</a>|
|[Relationship_CommissionSalesGroupRelationshipId](#Relationship_CommissionSalesGroupRelationshipId)||<a href="CustConfirmTrans.md" target="_blank">Transaction/CustConfirmTrans</a>|
|[Relationship_CurrencyRelationshipId](#Relationship_CurrencyRelationshipId)||<a href="CustConfirmTrans.md" target="_blank">Transaction/CustConfirmTrans</a>|
|[Relationship_CustConfirmJourRelationshipId](#Relationship_CustConfirmJourRelationshipId)||<a href="CustConfirmTrans.md" target="_blank">Transaction/CustConfirmTrans</a>|
|[Relationship_DefaultDimensionRelationshipId](#Relationship_DefaultDimensionRelationshipId)||<a href="CustConfirmTrans.md" target="_blank">Transaction/CustConfirmTrans</a>|
|[Relationship_DlvTermRelationshipId](#Relationship_DlvTermRelationshipId)||<a href="CustConfirmTrans.md" target="_blank">Transaction/CustConfirmTrans</a>|
|[Relationship_InventDimRelationshipId](#Relationship_InventDimRelationshipId)||<a href="CustConfirmTrans.md" target="_blank">Transaction/CustConfirmTrans</a>|
|[Relationship_InventTableRelationshipId](#Relationship_InventTableRelationshipId)||<a href="CustConfirmTrans.md" target="_blank">Transaction/CustConfirmTrans</a>|
|[Relationship_InventTransOriginRelationshipId](#Relationship_InventTransOriginRelationshipId)||<a href="CustConfirmTrans.md" target="_blank">Transaction/CustConfirmTrans</a>|
|[Relationship_OriginSalesTableRelationshipId](#Relationship_OriginSalesTableRelationshipId)||<a href="CustConfirmTrans.md" target="_blank">Transaction/CustConfirmTrans</a>|
|[Relationship_RenameSalesTableRelationshipId](#Relationship_RenameSalesTableRelationshipId)||<a href="CustConfirmTrans.md" target="_blank">Transaction/CustConfirmTrans</a>|
|[Relationship_SalesCategoryRelationshipId](#Relationship_SalesCategoryRelationshipId)||<a href="CustConfirmTrans.md" target="_blank">Transaction/CustConfirmTrans</a>|
|[Relationship_TaxGroupHeadingRelationshipId](#Relationship_TaxGroupHeadingRelationshipId)||<a href="CustConfirmTrans.md" target="_blank">Transaction/CustConfirmTrans</a>|
|[Relationship_TaxItemGroupHeadingRelationshipId](#Relationship_TaxItemGroupHeadingRelationshipId)||<a href="CustConfirmTrans.md" target="_blank">Transaction/CustConfirmTrans</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="CustConfirmTrans.md" target="_blank">Transaction/CustConfirmTrans</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Transaction/CustConfirmTrans (this entity)  
...
### <a href=#ConfirmId name="ConfirmId">ConfirmId</a>
...
<details>
<summary>List of traits for the ConfirmId attribute are listed below.</summary>
...
**means.identity.entityId**  
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="CustConfirmJour.md" target="_blank">/core/erp/Tables/SupplyChain/SalesAndMarketing/Transaction/CustConfirmJour.cdm.json/CustConfirmJour</a></td><td><a href="CustConfirmJour.md#RecId" target="_blank">RecId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
