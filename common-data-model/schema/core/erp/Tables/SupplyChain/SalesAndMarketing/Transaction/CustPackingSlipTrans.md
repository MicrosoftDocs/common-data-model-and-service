---
title: CustPackingSlipTrans - Common Data Model | Microsoft Docs
...
# CustPackingSlipTrans
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/erp/Tables/SupplyChain/SalesAndMarketing/Transaction/CustPackingSlipTrans.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[CustPackingSlipTrans/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[AmountCur](#AmountCur)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[CountryRegionOfShipment](#CountryRegionOfShipment)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[CurrencyCode](#CurrencyCode)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[DefaultDimension](#DefaultDimension)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[DeliveryDate](#DeliveryDate)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[DeliveryPostalAddress](#DeliveryPostalAddress)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[DeliveryType](#DeliveryType)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[DlvTerm](#DlvTerm)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[ExternalItemId](#ExternalItemId)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[FullyMatched](#FullyMatched)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[InterCompanyInventTransId](#InterCompanyInventTransId)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[IntrastatDispatchId](#IntrastatDispatchId)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[IntrastatFulfillmentDate_HU](#IntrastatFulfillmentDate_HU)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[InventDimId](#InventDimId)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[inventQty](#inventQty)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[InventRefId](#InventRefId)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[InventRefTransId](#InventRefTransId)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[InventRefType](#InventRefType)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[InventTransId](#InventTransId)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[InvoiceTransRefRecId](#InvoiceTransRefRecId)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[IntrastatCommodity](#IntrastatCommodity)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[ItemId](#ItemId)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[LineHeader](#LineHeader)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[LineNum](#LineNum)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[Name](#Name)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[NGPCodesTable_FR](#NGPCodesTable_FR)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[NumberSequenceGroup](#NumberSequenceGroup)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[Ordered](#Ordered)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[OrigCountryRegionId](#OrigCountryRegionId)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[OrigSalesId](#OrigSalesId)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[OrigStateId](#OrigStateId)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[PackedExtensions](#PackedExtensions)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[PackingSlipId](#PackingSlipId)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[PdsCWQty](#PdsCWQty)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[PdsCWRemain](#PdsCWRemain)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[Port](#Port)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[PriceUnit](#PriceUnit)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[Qty](#Qty)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[Remain](#Remain)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[RemainInvent](#RemainInvent)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[SalesCategory](#SalesCategory)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[SalesGroup](#SalesGroup)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[SalesId](#SalesId)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[SalesLineShippingDateConfirmed](#SalesLineShippingDateConfirmed)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[SalesLineShippingDateRequested](#SalesLineShippingDateRequested)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[SalesUnit](#SalesUnit)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[Scrap](#Scrap)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[SourceDocumentLine](#SourceDocumentLine)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[StatisticValue_LT](#StatisticValue_LT)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[StatProcId](#StatProcId)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[StatValueMST](#StatValueMST)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[StockedProduct](#StockedProduct)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[TransactionCode](#TransactionCode)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[Transport](#Transport)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[ValueMST](#ValueMST)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[Weight](#Weight)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[ItemCodeId](#ItemCodeId)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[ParmLine](#ParmLine)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[DataAreaId](#DataAreaId)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[Relationship_CommissionSalesGroupRelationshipId](#Relationship_CommissionSalesGroupRelationshipId)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[Relationship_CurrencyRelationshipId](#Relationship_CurrencyRelationshipId)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[Relationship_CustInvoiceTransRelationshipId](#Relationship_CustInvoiceTransRelationshipId)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[Relationship_CustPckSlpJourRelationshipId](#Relationship_CustPckSlpJourRelationshipId)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[Relationship_DefaultDimensionRelationshipId](#Relationship_DefaultDimensionRelationshipId)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[Relationship_DeliveryPostalAddress_FKRelationshipId](#Relationship_DeliveryPostalAddress_FKRelationshipId)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[Relationship_DlvTermRelationshipId](#Relationship_DlvTermRelationshipId)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[Relationship_IntrastatCommodityRelationshipId](#Relationship_IntrastatCommodityRelationshipId)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[Relationship_IntrastatPortRelationshipId](#Relationship_IntrastatPortRelationshipId)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[Relationship_IntrastatStatProcRelationshipId](#Relationship_IntrastatStatProcRelationshipId)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[Relationship_IntrastatTransactionCodeRelationshipId](#Relationship_IntrastatTransactionCodeRelationshipId)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[Relationship_IntrastatTransportModeRelationshipId](#Relationship_IntrastatTransportModeRelationshipId)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[Relationship_InventDimRelationshipId](#Relationship_InventDimRelationshipId)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[Relationship_InventTableRelationshipId](#Relationship_InventTableRelationshipId)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[Relationship_InventTRansOriginRelationshipId](#Relationship_InventTRansOriginRelationshipId)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[Relationship_NGPCodesTable_FRRelationshipId](#Relationship_NGPCodesTable_FRRelationshipId)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[Relationship_NumberSequenceGroupRelationshipId](#Relationship_NumberSequenceGroupRelationshipId)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[Relationship_OriginCountryRegionRelationshipId](#Relationship_OriginCountryRegionRelationshipId)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[Relationship_OriginSalesTableRelationshipId](#Relationship_OriginSalesTableRelationshipId)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[Relationship_RenameSalesTableRelationshipId](#Relationship_RenameSalesTableRelationshipId)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[Relationship_SalesCategoryRelationshipId](#Relationship_SalesCategoryRelationshipId)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[Relationship_ShipmentCountryRegionRelationshipId](#Relationship_ShipmentCountryRegionRelationshipId)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[Relationship_SourceDocumentLineRelationshipId](#Relationship_SourceDocumentLineRelationshipId)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[Relationship_SalesParmLineRelationshipId](#Relationship_SalesParmLineRelationshipId)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="CustPackingSlipTrans.md" target="_blank">Transaction/CustPackingSlipTrans</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Transaction/CustPackingSlipTrans (this entity)  
...
### <a href=#SalesLineShippingDateConfirmed name="SalesLineShippingDateConfirmed">SalesLineShippingDateConfirmed</a>
...
<details>
<summary>List of traits for the SalesLineShippingDateConfirmed attribute are listed below.</summary>
...
### <a href=#StatValueMST name="StatValueMST">StatValueMST</a>
...
<details>
<summary>List of traits for the StatValueMST attribute are listed below.</summary>
...
### <a href=#ParmLine name="ParmLine">ParmLine</a>
...
<details>
<summary>List of traits for the ParmLine attribute are listed below.</summary>
...
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="../Group/CommissionSalesGroup.md" target="_blank">/core/erp/Tables/SupplyChain/SalesAndMarketing/Group/CommissionSalesGroup.cdm.json/CommissionSalesGroup</a></td><td><a href="../Group/CommissionSalesGroup.md#RecId" target="_blank">RecId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
...
### <a href=#Relationship_CustPckSlpJourRelationshipId name="Relationship_CustPckSlpJourRelationshipId">Relationship_CustPckSlpJourRelationshipId</a>
...
<details>
<summary>List of traits for the Relationship_CustPckSlpJourRelationshipId attribute are listed below.</summary>
...
**means.identity.entityId**  
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="CustPackingSlipJour.md" target="_blank">/core/erp/Tables/SupplyChain/SalesAndMarketing/Transaction/CustPackingSlipJour.cdm.json/CustPackingSlipJour</a></td><td><a href="CustPackingSlipJour.md#RecId" target="_blank">RecId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
...
**means.identity.entityId**  
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="../Group/DlvTerm.md" target="_blank">/core/erp/Tables/SupplyChain/SalesAndMarketing/Group/DlvTerm.cdm.json/DlvTerm</a></td><td><a href="../Group/DlvTerm.md#RecId" target="_blank">RecId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
...
### <a href=#Relationship_ShipmentCountryRegionRelationshipId name="Relationship_ShipmentCountryRegionRelationshipId">Relationship_ShipmentCountryRegionRelationshipId</a>
...
<details>
<summary>List of traits for the Relationship_ShipmentCountryRegionRelationshipId attribute are listed below.</summary>
...
### <a href=#Relationship_SalesParmLineRelationshipId name="Relationship_SalesParmLineRelationshipId">Relationship_SalesParmLineRelationshipId</a>
...
<details>
<summary>List of traits for the Relationship_SalesParmLineRelationshipId attribute are listed below.</summary>
...
**means.identity.entityId**  
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="../WorksheetLine/SalesParmLine.md" target="_blank">/core/erp/Tables/SupplyChain/SalesAndMarketing/WorksheetLine/SalesParmLine.cdm.json/SalesParmLine</a></td><td><a href="../WorksheetLine/SalesParmLine.md#RecId" target="_blank">RecId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
