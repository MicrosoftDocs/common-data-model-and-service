---
title: ProdRouteProj - Common Data Model | Microsoft Docs
...
# ProdRouteProj
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/erp/Tables/ProfessionalServices/ProjectManagementAndAccounting/WorksheetLine/ProdRouteProj.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[ProdRouteProj/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="ProdRouteProj.md" target="_blank">WorksheetLine/ProdRouteProj</a>|
|[ActivityNumber](#ActivityNumber)||<a href="ProdRouteProj.md" target="_blank">WorksheetLine/ProdRouteProj</a>|
|[CalcType](#CalcType)||<a href="ProdRouteProj.md" target="_blank">WorksheetLine/ProdRouteProj</a>|
|[OprNum](#OprNum)||<a href="ProdRouteProj.md" target="_blank">WorksheetLine/ProdRouteProj</a>|
|[OprPriority](#OprPriority)||<a href="ProdRouteProj.md" target="_blank">WorksheetLine/ProdRouteProj</a>|
|[PeriodDate](#PeriodDate)||<a href="ProdRouteProj.md" target="_blank">WorksheetLine/ProdRouteProj</a>|
|[ProdId](#ProdId)||<a href="ProdRouteProj.md" target="_blank">WorksheetLine/ProdRouteProj</a>|
|[ProjCostPrice](#ProjCostPrice)||<a href="ProdRouteProj.md" target="_blank">WorksheetLine/ProdRouteProj</a>|
|[ProjId](#ProjId)||<a href="ProdRouteProj.md" target="_blank">WorksheetLine/ProdRouteProj</a>|
|[ProjLinePropertyId](#ProjLinePropertyId)||<a href="ProdRouteProj.md" target="_blank">WorksheetLine/ProdRouteProj</a>|
|[ProjSalesCurrencyId](#ProjSalesCurrencyId)||<a href="ProdRouteProj.md" target="_blank">WorksheetLine/ProdRouteProj</a>|
|[ProjSalesPrice](#ProjSalesPrice)||<a href="ProdRouteProj.md" target="_blank">WorksheetLine/ProdRouteProj</a>|
|[ProjTaxGroupId](#ProjTaxGroupId)||<a href="ProdRouteProj.md" target="_blank">WorksheetLine/ProdRouteProj</a>|
|[ProjTaxItemGroupId](#ProjTaxItemGroupId)||<a href="ProdRouteProj.md" target="_blank">WorksheetLine/ProdRouteProj</a>|
|[ProjTransDate](#ProjTransDate)||<a href="ProdRouteProj.md" target="_blank">WorksheetLine/ProdRouteProj</a>|
|[ProjTransId](#ProjTransId)||<a href="ProdRouteProj.md" target="_blank">WorksheetLine/ProdRouteProj</a>|
|[Txt](#Txt)||<a href="ProdRouteProj.md" target="_blank">WorksheetLine/ProdRouteProj</a>|
|[DataAreaId](#DataAreaId)||<a href="ProdRouteProj.md" target="_blank">WorksheetLine/ProdRouteProj</a>|
|[Relationship_ProdTableRelationshipId](#Relationship_ProdTableRelationshipId)||<a href="ProdRouteProj.md" target="_blank">WorksheetLine/ProdRouteProj</a>|
|[Relationship_ProjectSalesCurrencyRelationshipId](#Relationship_ProjectSalesCurrencyRelationshipId)||<a href="ProdRouteProj.md" target="_blank">WorksheetLine/ProdRouteProj</a>|
|[Relationship_ProjectTaxGroupHeadingRelationshipId](#Relationship_ProjectTaxGroupHeadingRelationshipId)||<a href="ProdRouteProj.md" target="_blank">WorksheetLine/ProdRouteProj</a>|
|[Relationship_ProjectTaxItemGroupHeadingRelationshipId](#Relationship_ProjectTaxItemGroupHeadingRelationshipId)||<a href="ProdRouteProj.md" target="_blank">WorksheetLine/ProdRouteProj</a>|
|[Relationship_ProjEmplTransRelationshipId](#Relationship_ProjEmplTransRelationshipId)||<a href="ProdRouteProj.md" target="_blank">WorksheetLine/ProdRouteProj</a>|
|[Relationship_ProjLinePropertyRelationshipId](#Relationship_ProjLinePropertyRelationshipId)||<a href="ProdRouteProj.md" target="_blank">WorksheetLine/ProdRouteProj</a>|
|[Relationship_ProjTableRelationshipId](#Relationship_ProjTableRelationshipId)||<a href="ProdRouteProj.md" target="_blank">WorksheetLine/ProdRouteProj</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="ProdRouteProj.md" target="_blank">WorksheetLine/ProdRouteProj</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: WorksheetLine/ProdRouteProj (this entity)  
...
**means.identity.entityId**  
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="../Transaction/ProjEmplTrans.md" target="_blank">/core/erp/Tables/ProfessionalServices/ProjectManagementAndAccounting/Transaction/ProjEmplTrans.cdm.json/ProjEmplTrans</a></td><td><a href="../Transaction/ProjEmplTrans.md#RecId" target="_blank">RecId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
