---
title: ProjForecastRevenue - Common Data Model | Microsoft Docs
...
# ProjForecastRevenue
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/erp/Tables/ProfessionalServices/ProjectManagementAndAccounting/Transaction/ProjForecastRevenue.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[ProjForecastRevenue/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="ProjForecastRevenue.md" target="_blank">Transaction/ProjForecastRevenue</a>|
|[Active](#Active)||<a href="ProjForecastRevenue.md" target="_blank">Transaction/ProjForecastRevenue</a>|
|[ActivityNumber](#ActivityNumber)||<a href="ProjForecastRevenue.md" target="_blank">Transaction/ProjForecastRevenue</a>|
|[AllocateMethod](#AllocateMethod)||<a href="ProjForecastRevenue.md" target="_blank">Transaction/ProjForecastRevenue</a>|
|[CategoryId](#CategoryId)||<a href="ProjForecastRevenue.md" target="_blank">Transaction/ProjForecastRevenue</a>|
|[CovStatus](#CovStatus)||<a href="ProjForecastRevenue.md" target="_blank">Transaction/ProjForecastRevenue</a>|
|[CurrencyId](#CurrencyId)||<a href="ProjForecastRevenue.md" target="_blank">Transaction/ProjForecastRevenue</a>|
|[DefaultDimension](#DefaultDimension)||<a href="ProjForecastRevenue.md" target="_blank">Transaction/ProjForecastRevenue</a>|
|[EliminationDate](#EliminationDate)||<a href="ProjForecastRevenue.md" target="_blank">Transaction/ProjForecastRevenue</a>|
|[EndDate](#EndDate)||<a href="ProjForecastRevenue.md" target="_blank">Transaction/ProjForecastRevenue</a>|
|[ExchRate](#ExchRate)||<a href="ProjForecastRevenue.md" target="_blank">Transaction/ProjForecastRevenue</a>|
|[ExpandId](#ExpandId)||<a href="ProjForecastRevenue.md" target="_blank">Transaction/ProjForecastRevenue</a>|
|[Freq](#Freq)||<a href="ProjForecastRevenue.md" target="_blank">Transaction/ProjForecastRevenue</a>|
|[FreqCode](#FreqCode)||<a href="ProjForecastRevenue.md" target="_blank">Transaction/ProjForecastRevenue</a>|
|[InvoiceDate](#InvoiceDate)||<a href="ProjForecastRevenue.md" target="_blank">Transaction/ProjForecastRevenue</a>|
|[LinePropertyId](#LinePropertyId)||<a href="ProjForecastRevenue.md" target="_blank">Transaction/ProjForecastRevenue</a>|
|[ModelId](#ModelId)||<a href="ProjForecastRevenue.md" target="_blank">Transaction/ProjForecastRevenue</a>|
|[PeriodAllocateId](#PeriodAllocateId)||<a href="ProjForecastRevenue.md" target="_blank">Transaction/ProjForecastRevenue</a>|
|[ProjForecastBudgetType](#ProjForecastBudgetType)||<a href="ProjForecastRevenue.md" target="_blank">Transaction/ProjForecastRevenue</a>|
|[ProjFundingSource](#ProjFundingSource)||<a href="ProjForecastRevenue.md" target="_blank">Transaction/ProjForecastRevenue</a>|
|[ProjId](#ProjId)||<a href="ProjForecastRevenue.md" target="_blank">Transaction/ProjForecastRevenue</a>|
|[Qty](#Qty)||<a href="ProjForecastRevenue.md" target="_blank">Transaction/ProjForecastRevenue</a>|
|[Report](#Report)||<a href="ProjForecastRevenue.md" target="_blank">Transaction/ProjForecastRevenue</a>|
|[Resource](#Resource)||<a href="ProjForecastRevenue.md" target="_blank">Transaction/ProjForecastRevenue</a>|
|[ResourceCategory](#ResourceCategory)||<a href="ProjForecastRevenue.md" target="_blank">Transaction/ProjForecastRevenue</a>|
|[SalesPaymDate](#SalesPaymDate)||<a href="ProjForecastRevenue.md" target="_blank">Transaction/ProjForecastRevenue</a>|
|[SalesPrice](#SalesPrice)||<a href="ProjForecastRevenue.md" target="_blank">Transaction/ProjForecastRevenue</a>|
|[StartDate](#StartDate)||<a href="ProjForecastRevenue.md" target="_blank">Transaction/ProjForecastRevenue</a>|
|[Stop](#Stop)||<a href="ProjForecastRevenue.md" target="_blank">Transaction/ProjForecastRevenue</a>|
|[TaxGroupId](#TaxGroupId)||<a href="ProjForecastRevenue.md" target="_blank">Transaction/ProjForecastRevenue</a>|
|[TransId](#TransId)||<a href="ProjForecastRevenue.md" target="_blank">Transaction/ProjForecastRevenue</a>|
|[Txt](#Txt)||<a href="ProjForecastRevenue.md" target="_blank">Transaction/ProjForecastRevenue</a>|
|[Worker](#Worker)||<a href="ProjForecastRevenue.md" target="_blank">Transaction/ProjForecastRevenue</a>|
|[DataAreaId](#DataAreaId)||<a href="ProjForecastRevenue.md" target="_blank">Transaction/ProjForecastRevenue</a>|
|[Relationship_CurrencyRelationshipId](#Relationship_CurrencyRelationshipId)||<a href="ProjForecastRevenue.md" target="_blank">Transaction/ProjForecastRevenue</a>|
|[Relationship_DefaultDimensionRelationshipId](#Relationship_DefaultDimensionRelationshipId)||<a href="ProjForecastRevenue.md" target="_blank">Transaction/ProjForecastRevenue</a>|
|[Relationship_ForecastModelRelationshipId](#Relationship_ForecastModelRelationshipId)||<a href="ProjForecastRevenue.md" target="_blank">Transaction/ProjForecastRevenue</a>|
|[Relationship_FundingSourceRelationshipId](#Relationship_FundingSourceRelationshipId)||<a href="ProjForecastRevenue.md" target="_blank">Transaction/ProjForecastRevenue</a>|
|[Relationship_LedgerAllocateKeyRelationshipId](#Relationship_LedgerAllocateKeyRelationshipId)||<a href="ProjForecastRevenue.md" target="_blank">Transaction/ProjForecastRevenue</a>|
|[Relationship_ProjCategoryRelationshipId](#Relationship_ProjCategoryRelationshipId)||<a href="ProjForecastRevenue.md" target="_blank">Transaction/ProjForecastRevenue</a>|
|[Relationship_ProjLinePropertyRelationshipId](#Relationship_ProjLinePropertyRelationshipId)||<a href="ProjForecastRevenue.md" target="_blank">Transaction/ProjForecastRevenue</a>|
|[Relationship_ProjTableRelationshipId](#Relationship_ProjTableRelationshipId)||<a href="ProjForecastRevenue.md" target="_blank">Transaction/ProjForecastRevenue</a>|
|[Relationship_TaxGroupHeadingRelationshipId](#Relationship_TaxGroupHeadingRelationshipId)||<a href="ProjForecastRevenue.md" target="_blank">Transaction/ProjForecastRevenue</a>|
|[Relationship_ResourceTableRelationshipId](#Relationship_ResourceTableRelationshipId)||<a href="ProjForecastRevenue.md" target="_blank">Transaction/ProjForecastRevenue</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="ProjForecastRevenue.md" target="_blank">Transaction/ProjForecastRevenue</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Transaction/ProjForecastRevenue (this entity)  
