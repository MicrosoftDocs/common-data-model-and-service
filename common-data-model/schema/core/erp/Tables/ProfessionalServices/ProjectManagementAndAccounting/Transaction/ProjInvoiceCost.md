---
title: ProjInvoiceCost - Common Data Model | Microsoft Docs
...
# ProjInvoiceCost
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/erp/Tables/ProfessionalServices/ProjectManagementAndAccounting/Transaction/ProjInvoiceCost.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[ProjInvoiceCost/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="ProjInvoiceCost.md" target="_blank">Transaction/ProjInvoiceCost</a>|
|[ActivityNumber](#ActivityNumber)||<a href="ProjInvoiceCost.md" target="_blank">Transaction/ProjInvoiceCost</a>|
|[CategoryId](#CategoryId)||<a href="ProjInvoiceCost.md" target="_blank">Transaction/ProjInvoiceCost</a>|
|[CurrencyId](#CurrencyId)||<a href="ProjInvoiceCost.md" target="_blank">Transaction/ProjInvoiceCost</a>|
|[DefaultDimension](#DefaultDimension)||<a href="ProjInvoiceCost.md" target="_blank">Transaction/ProjInvoiceCost</a>|
|[EInvoiceAccountCode](#EInvoiceAccountCode)||<a href="ProjInvoiceCost.md" target="_blank">Transaction/ProjInvoiceCost</a>|
|[InvoiceDate](#InvoiceDate)||<a href="ProjInvoiceCost.md" target="_blank">Transaction/ProjInvoiceCost</a>|
|[LineAmount](#LineAmount)||<a href="ProjInvoiceCost.md" target="_blank">Transaction/ProjInvoiceCost</a>|
|[ProjId](#ProjId)||<a href="ProjInvoiceCost.md" target="_blank">Transaction/ProjInvoiceCost</a>|
|[ProjInvoiceId](#ProjInvoiceId)||<a href="ProjInvoiceCost.md" target="_blank">Transaction/ProjInvoiceCost</a>|
|[PSAContractLineNum](#PSAContractLineNum)||<a href="ProjInvoiceCost.md" target="_blank">Transaction/ProjInvoiceCost</a>|
|[Qty](#Qty)||<a href="ProjInvoiceCost.md" target="_blank">Transaction/ProjInvoiceCost</a>|
|[Resource](#Resource)||<a href="ProjInvoiceCost.md" target="_blank">Transaction/ProjInvoiceCost</a>|
|[ResourceCategory](#ResourceCategory)||<a href="ProjInvoiceCost.md" target="_blank">Transaction/ProjInvoiceCost</a>|
|[TaxAmount](#TaxAmount)||<a href="ProjInvoiceCost.md" target="_blank">Transaction/ProjInvoiceCost</a>|
|[TaxGroupId](#TaxGroupId)||<a href="ProjInvoiceCost.md" target="_blank">Transaction/ProjInvoiceCost</a>|
|[TaxItemGroupId](#TaxItemGroupId)||<a href="ProjInvoiceCost.md" target="_blank">Transaction/ProjInvoiceCost</a>|
|[TaxWriteCode](#TaxWriteCode)||<a href="ProjInvoiceCost.md" target="_blank">Transaction/ProjInvoiceCost</a>|
|[TransDate](#TransDate)||<a href="ProjInvoiceCost.md" target="_blank">Transaction/ProjInvoiceCost</a>|
|[TransId](#TransId)||<a href="ProjInvoiceCost.md" target="_blank">Transaction/ProjInvoiceCost</a>|
|[Txt](#Txt)||<a href="ProjInvoiceCost.md" target="_blank">Transaction/ProjInvoiceCost</a>|
|[Worker](#Worker)||<a href="ProjInvoiceCost.md" target="_blank">Transaction/ProjInvoiceCost</a>|
|[WorkerLegalEntity](#WorkerLegalEntity)||<a href="ProjInvoiceCost.md" target="_blank">Transaction/ProjInvoiceCost</a>|
|[RefInvoiceDate_MY](#RefInvoiceDate_MY)||<a href="ProjInvoiceCost.md" target="_blank">Transaction/ProjInvoiceCost</a>|
|[RefInvoiceId_MY](#RefInvoiceId_MY)||<a href="ProjInvoiceCost.md" target="_blank">Transaction/ProjInvoiceCost</a>|
|[OrderLineReference_NO](#OrderLineReference_NO)||<a href="ProjInvoiceCost.md" target="_blank">Transaction/ProjInvoiceCost</a>|
|[BookableResourceName](#BookableResourceName)||<a href="ProjInvoiceCost.md" target="_blank">Transaction/ProjInvoiceCost</a>|
|[DataAreaId](#DataAreaId)||<a href="ProjInvoiceCost.md" target="_blank">Transaction/ProjInvoiceCost</a>|
|[Relationship_CurrencyRelationshipId](#Relationship_CurrencyRelationshipId)||<a href="ProjInvoiceCost.md" target="_blank">Transaction/ProjInvoiceCost</a>|
|[Relationship_DefaultDimensionRelationshipId](#Relationship_DefaultDimensionRelationshipId)||<a href="ProjInvoiceCost.md" target="_blank">Transaction/ProjInvoiceCost</a>|
|[Relationship_ProjCategoryRelationshipId](#Relationship_ProjCategoryRelationshipId)||<a href="ProjInvoiceCost.md" target="_blank">Transaction/ProjInvoiceCost</a>|
|[Relationship_projCostTransRelationshipId](#Relationship_projCostTransRelationshipId)||<a href="ProjInvoiceCost.md" target="_blank">Transaction/ProjInvoiceCost</a>|
|[Relationship_ProjInvoiceJourRelationshipId](#Relationship_ProjInvoiceJourRelationshipId)||<a href="ProjInvoiceCost.md" target="_blank">Transaction/ProjInvoiceCost</a>|
|[Relationship_projProposalCostRelationshipId](#Relationship_projProposalCostRelationshipId)||<a href="ProjInvoiceCost.md" target="_blank">Transaction/ProjInvoiceCost</a>|
|[Relationship_ProjTableRelationshipId](#Relationship_ProjTableRelationshipId)||<a href="ProjInvoiceCost.md" target="_blank">Transaction/ProjInvoiceCost</a>|
|[Relationship_PSAContractLineItemsRelationshipId](#Relationship_PSAContractLineItemsRelationshipId)||<a href="ProjInvoiceCost.md" target="_blank">Transaction/ProjInvoiceCost</a>|
|[Relationship_TaxGroupHeadingRelationshipId](#Relationship_TaxGroupHeadingRelationshipId)||<a href="ProjInvoiceCost.md" target="_blank">Transaction/ProjInvoiceCost</a>|
|[Relationship_TaxItemGroupHeadingRelationshipId](#Relationship_TaxItemGroupHeadingRelationshipId)||<a href="ProjInvoiceCost.md" target="_blank">Transaction/ProjInvoiceCost</a>|
|[Relationship_ResourceTableRelationshipId](#Relationship_ResourceTableRelationshipId)||<a href="ProjInvoiceCost.md" target="_blank">Transaction/ProjInvoiceCost</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="ProjInvoiceCost.md" target="_blank">Transaction/ProjInvoiceCost</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Transaction/ProjInvoiceCost (this entity)  
...
### <a href=#Relationship_projProposalCostRelationshipId name="Relationship_projProposalCostRelationshipId">Relationship_projProposalCostRelationshipId</a>
...
<details>
<summary>List of traits for the Relationship_projProposalCostRelationshipId attribute are listed below.</summary>
...
**means.identity.entityId**  
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="ProjProposalCost.md" target="_blank">/core/erp/Tables/ProfessionalServices/ProjectManagementAndAccounting/Transaction/ProjProposalCost.cdm.json/ProjProposalCost</a></td><td><a href="ProjProposalCost.md#RecId" target="_blank">RecId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
