---
title: ProjItemTransSale - Common Data Model | Microsoft Docs
...
# ProjItemTransSale
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/erp/Tables/ProfessionalServices/ProjectManagementAndAccounting/Transaction/ProjItemTransSale.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[ProjItemTransSale/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="ProjItemTransSale.md" target="_blank">Transaction/ProjItemTransSale</a>|
|[ControlId](#ControlId)||<a href="ProjItemTransSale.md" target="_blank">Transaction/ProjItemTransSale</a>|
|[ControlVersion](#ControlVersion)||<a href="ProjItemTransSale.md" target="_blank">Transaction/ProjItemTransSale</a>|
|[DefaultDimension](#DefaultDimension)||<a href="ProjItemTransSale.md" target="_blank">Transaction/ProjItemTransSale</a>|
|[FundingSource](#FundingSource)||<a href="ProjItemTransSale.md" target="_blank">Transaction/ProjItemTransSale</a>|
|[LedgerSalesAmount](#LedgerSalesAmount)||<a href="ProjItemTransSale.md" target="_blank">Transaction/ProjItemTransSale</a>|
|[LedgerSalesPosted](#LedgerSalesPosted)||<a href="ProjItemTransSale.md" target="_blank">Transaction/ProjItemTransSale</a>|
|[LedgerTransdate](#LedgerTransdate)||<a href="ProjItemTransSale.md" target="_blank">Transaction/ProjItemTransSale</a>|
|[LineAmount](#LineAmount)||<a href="ProjItemTransSale.md" target="_blank">Transaction/ProjItemTransSale</a>|
|[ProjProposalId_IN](#ProjProposalId_IN)||<a href="ProjItemTransSale.md" target="_blank">Transaction/ProjItemTransSale</a>|
|[ProjTransId](#ProjTransId)||<a href="ProjItemTransSale.md" target="_blank">Transaction/ProjItemTransSale</a>|
|[SalesPrice](#SalesPrice)||<a href="ProjItemTransSale.md" target="_blank">Transaction/ProjItemTransSale</a>|
|[TaxAsPerOriginalInvoice_IN](#TaxAsPerOriginalInvoice_IN)||<a href="ProjItemTransSale.md" target="_blank">Transaction/ProjItemTransSale</a>|
|[TransStatus](#TransStatus)||<a href="ProjItemTransSale.md" target="_blank">Transaction/ProjItemTransSale</a>|
|[WIPPeriod](#WIPPeriod)||<a href="ProjItemTransSale.md" target="_blank">Transaction/ProjItemTransSale</a>|
|[WIPType](#WIPType)||<a href="ProjItemTransSale.md" target="_blank">Transaction/ProjItemTransSale</a>|
|[DataAreaId](#DataAreaId)||<a href="ProjItemTransSale.md" target="_blank">Transaction/ProjItemTransSale</a>|
|[Relationship_DefaultDimensionRelationshipId](#Relationship_DefaultDimensionRelationshipId)||<a href="ProjItemTransSale.md" target="_blank">Transaction/ProjItemTransSale</a>|
|[Relationship_FundingSourceRelationshipId](#Relationship_FundingSourceRelationshipId)||<a href="ProjItemTransSale.md" target="_blank">Transaction/ProjItemTransSale</a>|
|[Relationship_ProjControlRelationshipId](#Relationship_ProjControlRelationshipId)||<a href="ProjItemTransSale.md" target="_blank">Transaction/ProjItemTransSale</a>|
|[Relationship_ProjItemTransRelationshipId](#Relationship_ProjItemTransRelationshipId)||<a href="ProjItemTransSale.md" target="_blank">Transaction/ProjItemTransSale</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="ProjItemTransSale.md" target="_blank">Transaction/ProjItemTransSale</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Transaction/ProjItemTransSale (this entity)  
