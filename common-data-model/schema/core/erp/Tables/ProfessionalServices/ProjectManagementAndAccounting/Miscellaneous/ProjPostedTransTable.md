---
title: ProjPostedTransTable - Common Data Model | Microsoft Docs
...
# ProjPostedTransTable

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/erp/Tables/ProfessionalServices/ProjectManagementAndAccounting/Miscellaneous/ProjPostedTransTable.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[ProjPostedTransTable/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="ProjPostedTransTable.md" target="_blank">Miscellaneous/ProjPostedTransTable</a>|
|[TransDate](#TransDate)||<a href="ProjPostedTransTable.md" target="_blank">Miscellaneous/ProjPostedTransTable</a>|
|[ActivityNumber](#ActivityNumber)||<a href="ProjPostedTransTable.md" target="_blank">Miscellaneous/ProjPostedTransTable</a>|
|[CategoryId](#CategoryId)||<a href="ProjPostedTransTable.md" target="_blank">Miscellaneous/ProjPostedTransTable</a>|
|[ProjId](#ProjId)||<a href="ProjPostedTransTable.md" target="_blank">Miscellaneous/ProjPostedTransTable</a>|
|[ItemId](#ItemId)||<a href="ProjPostedTransTable.md" target="_blank">Miscellaneous/ProjPostedTransTable</a>|
|[Qty](#Qty)||<a href="ProjPostedTransTable.md" target="_blank">Miscellaneous/ProjPostedTransTable</a>|
|[TransId](#TransId)||<a href="ProjPostedTransTable.md" target="_blank">Miscellaneous/ProjPostedTransTable</a>|
|[CurrencyId](#CurrencyId)||<a href="ProjPostedTransTable.md" target="_blank">Miscellaneous/ProjPostedTransTable</a>|
|[LinePropertyId](#LinePropertyId)||<a href="ProjPostedTransTable.md" target="_blank">Miscellaneous/ProjPostedTransTable</a>|
|[InventTransId](#InventTransId)||<a href="ProjPostedTransTable.md" target="_blank">Miscellaneous/ProjPostedTransTable</a>|
|[TransactionOrigin](#TransactionOrigin)||<a href="ProjPostedTransTable.md" target="_blank">Miscellaneous/ProjPostedTransTable</a>|
|[TotalCostAmountCur](#TotalCostAmountCur)||<a href="ProjPostedTransTable.md" target="_blank">Miscellaneous/ProjPostedTransTable</a>|
|[TotalSalesAmountCur](#TotalSalesAmountCur)||<a href="ProjPostedTransTable.md" target="_blank">Miscellaneous/ProjPostedTransTable</a>|
|[ProjTransType](#ProjTransType)||<a href="ProjPostedTransTable.md" target="_blank">Miscellaneous/ProjPostedTransTable</a>|
|[PSAIndirectComponentGroup](#PSAIndirectComponentGroup)||<a href="ProjPostedTransTable.md" target="_blank">Miscellaneous/ProjPostedTransTable</a>|
|[CurrencyIdCost](#CurrencyIdCost)||<a href="ProjPostedTransTable.md" target="_blank">Miscellaneous/ProjPostedTransTable</a>|
|[Txt](#Txt)||<a href="ProjPostedTransTable.md" target="_blank">Miscellaneous/ProjPostedTransTable</a>|
|[AdjRefTransId](#AdjRefTransId)||<a href="ProjPostedTransTable.md" target="_blank">Miscellaneous/ProjPostedTransTable</a>|
|[DefaultDimension](#DefaultDimension)||<a href="ProjPostedTransTable.md" target="_blank">Miscellaneous/ProjPostedTransTable</a>|
|[PSAContractLineNum](#PSAContractLineNum)||<a href="ProjPostedTransTable.md" target="_blank">Miscellaneous/ProjPostedTransTable</a>|
|[ResourceCategory](#ResourceCategory)||<a href="ProjPostedTransTable.md" target="_blank">Miscellaneous/ProjPostedTransTable</a>|
|[TaxGroupId](#TaxGroupId)||<a href="ProjPostedTransTable.md" target="_blank">Miscellaneous/ProjPostedTransTable</a>|
|[TaxItemGroupId](#TaxItemGroupId)||<a href="ProjPostedTransTable.md" target="_blank">Miscellaneous/ProjPostedTransTable</a>|
|[TransIdRef](#TransIdRef)||<a href="ProjPostedTransTable.md" target="_blank">Miscellaneous/ProjPostedTransTable</a>|
|[InventDimId](#InventDimId)||<a href="ProjPostedTransTable.md" target="_blank">Miscellaneous/ProjPostedTransTable</a>|
|[Price](#Price)||<a href="ProjPostedTransTable.md" target="_blank">Miscellaneous/ProjPostedTransTable</a>|
|[IsCorrection](#IsCorrection)||<a href="ProjPostedTransTable.md" target="_blank">Miscellaneous/ProjPostedTransTable</a>|
|[Resource](#Resource)||<a href="ProjPostedTransTable.md" target="_blank">Miscellaneous/ProjPostedTransTable</a>|
|[ResourceName](#ResourceName)||<a href="ProjPostedTransTable.md" target="_blank">Miscellaneous/ProjPostedTransTable</a>|
|[IsSplitTransaction](#IsSplitTransaction)||<a href="ProjPostedTransTable.md" target="_blank">Miscellaneous/ProjPostedTransTable</a>|
|[VendorAccount](#VendorAccount)||<a href="ProjPostedTransTable.md" target="_blank">Miscellaneous/ProjPostedTransTable</a>|
|[VendorName](#VendorName)||<a href="ProjPostedTransTable.md" target="_blank">Miscellaneous/ProjPostedTransTable</a>|
|[DataAreaId](#DataAreaId)||<a href="ProjPostedTransTable.md" target="_blank">Miscellaneous/ProjPostedTransTable</a>|
|[Relationship_CurrencyRelationshipId](#Relationship_CurrencyRelationshipId)||<a href="ProjPostedTransTable.md" target="_blank">Miscellaneous/ProjPostedTransTable</a>|
|[Relationship_DefaultDimensionRelationshipId](#Relationship_DefaultDimensionRelationshipId)||<a href="ProjPostedTransTable.md" target="_blank">Miscellaneous/ProjPostedTransTable</a>|
|[Relationship_ProjCategoryRelationshipId](#Relationship_ProjCategoryRelationshipId)||<a href="ProjPostedTransTable.md" target="_blank">Miscellaneous/ProjPostedTransTable</a>|
|[Relationship_ProjLinePropertyRelationshipId](#Relationship_ProjLinePropertyRelationshipId)||<a href="ProjPostedTransTable.md" target="_blank">Miscellaneous/ProjPostedTransTable</a>|
|[Relationship_ProjTableRelationshipId](#Relationship_ProjTableRelationshipId)||<a href="ProjPostedTransTable.md" target="_blank">Miscellaneous/ProjPostedTransTable</a>|
|[Relationship_PSAContractLineItemsRelationshipId](#Relationship_PSAContractLineItemsRelationshipId)||<a href="ProjPostedTransTable.md" target="_blank">Miscellaneous/ProjPostedTransTable</a>|
|[Relationship_PSAIndirectComponentGroupCostRelationshipId](#Relationship_PSAIndirectComponentGroupCostRelationshipId)||<a href="ProjPostedTransTable.md" target="_blank">Miscellaneous/ProjPostedTransTable</a>|
|[Relationship_TaxGroupHeadingRelationshipId](#Relationship_TaxGroupHeadingRelationshipId)||<a href="ProjPostedTransTable.md" target="_blank">Miscellaneous/ProjPostedTransTable</a>|
|[Relationship_TaxItemGroupHeadingRelationshipId](#Relationship_TaxItemGroupHeadingRelationshipId)||<a href="ProjPostedTransTable.md" target="_blank">Miscellaneous/ProjPostedTransTable</a>|
|[Relationship_ResourceTableRelationshipId](#Relationship_ResourceTableRelationshipId)||<a href="ProjPostedTransTable.md" target="_blank">Miscellaneous/ProjPostedTransTable</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="ProjPostedTransTable.md" target="_blank">Miscellaneous/ProjPostedTransTable</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Miscellaneous/ProjPostedTransTable (this entity)  
...
### <a href=#AdjRefTransId name="AdjRefTransId">AdjRefTransId</a>
...
<details>
<summary>List of traits for the AdjRefTransId attribute are listed below.</summary>
...
<details>
<summary>List of traits for the PSAContractLineNum attribute are listed below.</summary>
...
### <a href=#TransIdRef name="TransIdRef">TransIdRef</a>
...
<details>
<summary>List of traits for the TransIdRef attribute are listed below.</summary>
...
### <a href=#IsSplitTransaction name="IsSplitTransaction">IsSplitTransaction</a>
...
<details>
<summary>List of traits for the IsSplitTransaction attribute are listed below.</summary>
...
**means.identity.entityId**  
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="PSAContractLineItems.md" target="_blank">/core/erp/Tables/ProfessionalServices/ProjectManagementAndAccounting/Miscellaneous/PSAContractLineItems.cdm.json/PSAContractLineItems</a></td><td><a href="PSAContractLineItems.md#RecId" target="_blank">RecId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
...
### <a href=#Relationship_PSAIndirectComponentGroupCostRelationshipId name="Relationship_PSAIndirectComponentGroupCostRelationshipId">Relationship_PSAIndirectComponentGroupCostRelationshipId</a>
...
<details>
<summary>List of traits for the Relationship_PSAIndirectComponentGroupCostRelationshipId attribute are listed below.</summary>
...
**means.identity.entityId**  
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="ResResourceIdentifier.md" target="_blank">/core/erp/Tables/ProfessionalServices/ProjectManagementAndAccounting/Miscellaneous/ResResourceIdentifier.cdm.json/ResResourceIdentifier</a></td><td><a href="ResResourceIdentifier.md#RecId" target="_blank">RecId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
