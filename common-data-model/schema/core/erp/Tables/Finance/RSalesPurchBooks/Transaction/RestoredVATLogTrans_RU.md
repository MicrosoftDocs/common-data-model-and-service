---
title: RestoredVATLogTrans_RU - Common Data Model | Microsoft Docs
...
# RestoredVATLogTrans_RU
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/erp/Tables/Finance/RSalesPurchBooks/Transaction/RestoredVATLogTrans_RU.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[RestoredVATLogTrans_RU/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="RestoredVATLogTrans_RU.md" target="_blank">Transaction/RestoredVATLogTrans_RU</a>|
|[AccountName](#AccountName)||<a href="RestoredVATLogTrans_RU.md" target="_blank">Transaction/RestoredVATLogTrans_RU</a>|
|[AccountNum](#AccountNum)||<a href="RestoredVATLogTrans_RU.md" target="_blank">Transaction/RestoredVATLogTrans_RU</a>|
|[DeliveryDate](#DeliveryDate)||<a href="RestoredVATLogTrans_RU.md" target="_blank">Transaction/RestoredVATLogTrans_RU</a>|
|[FacturedAmounts](#FacturedAmounts)||<a href="RestoredVATLogTrans_RU.md" target="_blank">Transaction/RestoredVATLogTrans_RU</a>|
|[FactureDate](#FactureDate)||<a href="RestoredVATLogTrans_RU.md" target="_blank">Transaction/RestoredVATLogTrans_RU</a>|
|[FactureExternalId](#FactureExternalId)||<a href="RestoredVATLogTrans_RU.md" target="_blank">Transaction/RestoredVATLogTrans_RU</a>|
|[FactureId](#FactureId)||<a href="RestoredVATLogTrans_RU.md" target="_blank">Transaction/RestoredVATLogTrans_RU</a>|
|[FactureModule](#FactureModule)||<a href="RestoredVATLogTrans_RU.md" target="_blank">Transaction/RestoredVATLogTrans_RU</a>|
|[Include](#Include)||<a href="RestoredVATLogTrans_RU.md" target="_blank">Transaction/RestoredVATLogTrans_RU</a>|
|[InvoiceRecId](#InvoiceRecId)||<a href="RestoredVATLogTrans_RU.md" target="_blank">Transaction/RestoredVATLogTrans_RU</a>|
|[ProcessLogTransRecId](#ProcessLogTransRecId)||<a href="RestoredVATLogTrans_RU.md" target="_blank">Transaction/RestoredVATLogTrans_RU</a>|
|[TaxReducedAsset](#TaxReducedAsset)||<a href="RestoredVATLogTrans_RU.md" target="_blank">Transaction/RestoredVATLogTrans_RU</a>|
|[TaxReducedDirect](#TaxReducedDirect)||<a href="RestoredVATLogTrans_RU.md" target="_blank">Transaction/RestoredVATLogTrans_RU</a>|
|[TaxReducedIndirect](#TaxReducedIndirect)||<a href="RestoredVATLogTrans_RU.md" target="_blank">Transaction/RestoredVATLogTrans_RU</a>|
|[TaxStandardAsset](#TaxStandardAsset)||<a href="RestoredVATLogTrans_RU.md" target="_blank">Transaction/RestoredVATLogTrans_RU</a>|
|[TaxStandardDirect](#TaxStandardDirect)||<a href="RestoredVATLogTrans_RU.md" target="_blank">Transaction/RestoredVATLogTrans_RU</a>|
|[TaxStandardIndirect](#TaxStandardIndirect)||<a href="RestoredVATLogTrans_RU.md" target="_blank">Transaction/RestoredVATLogTrans_RU</a>|
|[TransDate](#TransDate)||<a href="RestoredVATLogTrans_RU.md" target="_blank">Transaction/RestoredVATLogTrans_RU</a>|
|[DataAreaId](#DataAreaId)||<a href="RestoredVATLogTrans_RU.md" target="_blank">Transaction/RestoredVATLogTrans_RU</a>|
|[Relationship_FactureJourRelationshipId](#Relationship_FactureJourRelationshipId)||<a href="RestoredVATLogTrans_RU.md" target="_blank">Transaction/RestoredVATLogTrans_RU</a>|
|[Relationship_LogTableRelationshipId](#Relationship_LogTableRelationshipId)||<a href="RestoredVATLogTrans_RU.md" target="_blank">Transaction/RestoredVATLogTrans_RU</a>|
|[Relationship_PurchBookVATProcessLogTransRelationshipId](#Relationship_PurchBookVATProcessLogTransRelationshipId)||<a href="RestoredVATLogTrans_RU.md" target="_blank">Transaction/RestoredVATLogTrans_RU</a>|
|[Relationship_VendInvoiceTransRelationshipId](#Relationship_VendInvoiceTransRelationshipId)||<a href="RestoredVATLogTrans_RU.md" target="_blank">Transaction/RestoredVATLogTrans_RU</a>|
|[Relationship_VendTableRelationshipId](#Relationship_VendTableRelationshipId)||<a href="RestoredVATLogTrans_RU.md" target="_blank">Transaction/RestoredVATLogTrans_RU</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="RestoredVATLogTrans_RU.md" target="_blank">Transaction/RestoredVATLogTrans_RU</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Transaction/RestoredVATLogTrans_RU (this entity)  
