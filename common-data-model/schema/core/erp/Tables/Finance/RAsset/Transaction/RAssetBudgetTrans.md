---
title: RAssetBudgetTrans - Common Data Model | Microsoft Docs
...
# RAssetBudgetTrans
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/erp/Tables/Finance/RAsset/Transaction/RAssetBudgetTrans.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[RAssetBudgetTrans/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="RAssetBudgetTrans.md" target="_blank">Transaction/RAssetBudgetTrans</a>|
|[AmountCur](#AmountCur)||<a href="RAssetBudgetTrans.md" target="_blank">Transaction/RAssetBudgetTrans</a>|
|[AssetBudgetPostingStatus](#AssetBudgetPostingStatus)||<a href="RAssetBudgetTrans.md" target="_blank">Transaction/RAssetBudgetTrans</a>|
|[AssetDeprPeriod](#AssetDeprPeriod)||<a href="RAssetBudgetTrans.md" target="_blank">Transaction/RAssetBudgetTrans</a>|
|[AssetId](#AssetId)||<a href="RAssetBudgetTrans.md" target="_blank">Transaction/RAssetBudgetTrans</a>|
|[AssetStandardId](#AssetStandardId)||<a href="RAssetBudgetTrans.md" target="_blank">Transaction/RAssetBudgetTrans</a>|
|[AssetTransType](#AssetTransType)||<a href="RAssetBudgetTrans.md" target="_blank">Transaction/RAssetBudgetTrans</a>|
|[BudgetModel](#BudgetModel)||<a href="RAssetBudgetTrans.md" target="_blank">Transaction/RAssetBudgetTrans</a>|
|[CurrencyCode](#CurrencyCode)||<a href="RAssetBudgetTrans.md" target="_blank">Transaction/RAssetBudgetTrans</a>|
|[LedgerDimension](#LedgerDimension)||<a href="RAssetBudgetTrans.md" target="_blank">Transaction/RAssetBudgetTrans</a>|
|[OffsetLedgerDimension](#OffsetLedgerDimension)||<a href="RAssetBudgetTrans.md" target="_blank">Transaction/RAssetBudgetTrans</a>|
|[TransDate](#TransDate)||<a href="RAssetBudgetTrans.md" target="_blank">Transaction/RAssetBudgetTrans</a>|
|[Txt](#Txt)||<a href="RAssetBudgetTrans.md" target="_blank">Transaction/RAssetBudgetTrans</a>|
|[DataAreaId](#DataAreaId)||<a href="RAssetBudgetTrans.md" target="_blank">Transaction/RAssetBudgetTrans</a>|
|[Relationship_BudgetModelRelationshipId](#Relationship_BudgetModelRelationshipId)||<a href="RAssetBudgetTrans.md" target="_blank">Transaction/RAssetBudgetTrans</a>|
|[Relationship_CurrencyRelationshipId](#Relationship_CurrencyRelationshipId)||<a href="RAssetBudgetTrans.md" target="_blank">Transaction/RAssetBudgetTrans</a>|
|[Relationship_LedgerDimensionRelationshipId](#Relationship_LedgerDimensionRelationshipId)||<a href="RAssetBudgetTrans.md" target="_blank">Transaction/RAssetBudgetTrans</a>|
|[Relationship_OffsetLedgerDimensionRelationshipId](#Relationship_OffsetLedgerDimensionRelationshipId)||<a href="RAssetBudgetTrans.md" target="_blank">Transaction/RAssetBudgetTrans</a>|
|[Relationship_RAssetStandardsRelationshipId](#Relationship_RAssetStandardsRelationshipId)||<a href="RAssetBudgetTrans.md" target="_blank">Transaction/RAssetBudgetTrans</a>|
|[Relationship_RAssetStandardTableRelationshipId](#Relationship_RAssetStandardTableRelationshipId)||<a href="RAssetBudgetTrans.md" target="_blank">Transaction/RAssetBudgetTrans</a>|
|[Relationship_RAssetTableRelationshipId](#Relationship_RAssetTableRelationshipId)||<a href="RAssetBudgetTrans.md" target="_blank">Transaction/RAssetBudgetTrans</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="RAssetBudgetTrans.md" target="_blank">Transaction/RAssetBudgetTrans</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Transaction/RAssetBudgetTrans (this entity)  
...
### <a href=#AssetBudgetPostingStatus name="AssetBudgetPostingStatus">AssetBudgetPostingStatus</a>
...
<details>
<summary>List of traits for the AssetBudgetPostingStatus attribute are listed below.</summary>
