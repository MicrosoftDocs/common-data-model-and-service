---
title: VendInvoicePackingSlip_IN - Common Data Model | Microsoft Docs
...
# VendInvoicePackingSlip_IN
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/erp/Tables/Finance/AccountsPayable/Miscellaneous/VendInvoicePackingSlip_IN.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[VendInvoicePackingSlip_IN/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="VendInvoicePackingSlip_IN.md" target="_blank">Miscellaneous/VendInvoicePackingSlip_IN</a>|
|[InvoiceDate](#InvoiceDate)||<a href="VendInvoicePackingSlip_IN.md" target="_blank">Miscellaneous/VendInvoicePackingSlip_IN</a>|
|[InvoiceId](#InvoiceId)||<a href="VendInvoicePackingSlip_IN.md" target="_blank">Miscellaneous/VendInvoicePackingSlip_IN</a>|
|[PackingSlipId](#PackingSlipId)||<a href="VendInvoicePackingSlip_IN.md" target="_blank">Miscellaneous/VendInvoicePackingSlip_IN</a>|
|[PurchId](#PurchId)||<a href="VendInvoicePackingSlip_IN.md" target="_blank">Miscellaneous/VendInvoicePackingSlip_IN</a>|
|[DataAreaId](#DataAreaId)||<a href="VendInvoicePackingSlip_IN.md" target="_blank">Miscellaneous/VendInvoicePackingSlip_IN</a>|
|[Relationship_PurchTableRelationshipId](#Relationship_PurchTableRelationshipId)||<a href="VendInvoicePackingSlip_IN.md" target="_blank">Miscellaneous/VendInvoicePackingSlip_IN</a>|
|[Relationship_VendInvoiceJourRelationshipId](#Relationship_VendInvoiceJourRelationshipId)||<a href="VendInvoicePackingSlip_IN.md" target="_blank">Miscellaneous/VendInvoicePackingSlip_IN</a>|
|[Relationship_VendPackingSlipJourRelationshipId](#Relationship_VendPackingSlipJourRelationshipId)||<a href="VendInvoicePackingSlip_IN.md" target="_blank">Miscellaneous/VendInvoicePackingSlip_IN</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="VendInvoicePackingSlip_IN.md" target="_blank">Miscellaneous/VendInvoicePackingSlip_IN</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Miscellaneous/VendInvoicePackingSlip_IN (this entity)  
