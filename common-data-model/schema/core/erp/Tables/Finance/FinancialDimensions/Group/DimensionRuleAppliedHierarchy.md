---
title: DimensionRuleAppliedHierarchy - Common Data Model | Microsoft Docs
...
# DimensionRuleAppliedHierarchy
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/erp/Tables/Finance/FinancialDimensions/Group/DimensionRuleAppliedHierarchy.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[DimensionRuleAppliedHierarchy/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="DimensionRuleAppliedHierarchy.md" target="_blank">Group/DimensionRuleAppliedHierarchy</a>|
|[DimensionHierarchy](#DimensionHierarchy)||<a href="DimensionRuleAppliedHierarchy.md" target="_blank">Group/DimensionRuleAppliedHierarchy</a>|
|[DimensionRule](#DimensionRule)||<a href="DimensionRuleAppliedHierarchy.md" target="_blank">Group/DimensionRuleAppliedHierarchy</a>|
|[Relationship_DimensionHierarchyRelationshipId](#Relationship_DimensionHierarchyRelationshipId)||<a href="DimensionRuleAppliedHierarchy.md" target="_blank">Group/DimensionRuleAppliedHierarchy</a>|
|[Relationship_DimensionRuleRelationshipId](#Relationship_DimensionRuleRelationshipId)||<a href="DimensionRuleAppliedHierarchy.md" target="_blank">Group/DimensionRuleAppliedHierarchy</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Group/DimensionRuleAppliedHierarchy (this entity)  
