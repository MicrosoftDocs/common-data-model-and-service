---
title: FiscalEstablishmentVendInvoiceJour_BR - Common Data Model | Microsoft Docs
...
# FiscalEstablishmentVendInvoiceJour_BR
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/erp/Tables/Finance/FiscalBooksBrazil/Miscellaneous/FiscalEstablishmentVendInvoiceJour_BR.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[FiscalEstablishmentVendInvoiceJour_BR/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="FiscalEstablishmentVendInvoiceJour_BR.md" target="_blank">Miscellaneous/FiscalEstablishmentVendInvoiceJour_BR</a>|
|[FiscalEstablishment_BR](#FiscalEstablishment_BR)||<a href="FiscalEstablishmentVendInvoiceJour_BR.md" target="_blank">Miscellaneous/FiscalEstablishmentVendInvoiceJour_BR</a>|
|[VendInvoiceJour](#VendInvoiceJour)||<a href="FiscalEstablishmentVendInvoiceJour_BR.md" target="_blank">Miscellaneous/FiscalEstablishmentVendInvoiceJour_BR</a>|
|[VendTrans](#VendTrans)||<a href="FiscalEstablishmentVendInvoiceJour_BR.md" target="_blank">Miscellaneous/FiscalEstablishmentVendInvoiceJour_BR</a>|
|[DataAreaId](#DataAreaId)||<a href="FiscalEstablishmentVendInvoiceJour_BR.md" target="_blank">Miscellaneous/FiscalEstablishmentVendInvoiceJour_BR</a>|
|[Relationship_FiscalEstablishment_BRRelationshipId](#Relationship_FiscalEstablishment_BRRelationshipId)||<a href="FiscalEstablishmentVendInvoiceJour_BR.md" target="_blank">Miscellaneous/FiscalEstablishmentVendInvoiceJour_BR</a>|
|[Relationship_VendInvoiceJourRelationshipId](#Relationship_VendInvoiceJourRelationshipId)||<a href="FiscalEstablishmentVendInvoiceJour_BR.md" target="_blank">Miscellaneous/FiscalEstablishmentVendInvoiceJour_BR</a>|
|[Relationship_VendTransRelationshipId](#Relationship_VendTransRelationshipId)||<a href="FiscalEstablishmentVendInvoiceJour_BR.md" target="_blank">Miscellaneous/FiscalEstablishmentVendInvoiceJour_BR</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="FiscalEstablishmentVendInvoiceJour_BR.md" target="_blank">Miscellaneous/FiscalEstablishmentVendInvoiceJour_BR</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Miscellaneous/FiscalEstablishmentVendInvoiceJour_BR (this entity)  
