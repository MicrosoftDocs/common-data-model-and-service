---
title: CustInvoiceJour - Common Data Model | Microsoft Docs
...
# CustInvoiceJour
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/erp/Tables/Finance/AccountsReceivable/Transaction/CustInvoiceJour.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[CustInvoiceJour/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[OrderAccount](#OrderAccount)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[InvoiceId](#InvoiceId)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[Backorder](#Backorder)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[BankLCExportLine](#BankLCExportLine)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[BillOfLadingId](#BillOfLadingId)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[CashDisc](#CashDisc)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[CashDiscBaseDate](#CashDiscBaseDate)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[CashDiscCode](#CashDiscCode)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[CashDiscDate](#CashDiscDate)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[CashDiscPercent](#CashDiscPercent)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[ContactPersonId](#ContactPersonId)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[CovStatus](#CovStatus)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[CurrencyCode](#CurrencyCode)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[CustGroup](#CustGroup)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[CustomerRef](#CustomerRef)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[DefaultDimension](#DefaultDimension)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[DeliveryName](#DeliveryName)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[DeliveryPostalAddress](#DeliveryPostalAddress)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[DirectDebitMandate](#DirectDebitMandate)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[DlvMode](#DlvMode)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[DlvTerm](#DlvTerm)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[DocumentDate](#DocumentDate)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[DocumentNum](#DocumentNum)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[DueDate](#DueDate)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[EInvoiceAccountCode](#EInvoiceAccountCode)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[EInvoiceLineSpecific](#EInvoiceLineSpecific)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[EndDisc](#EndDisc)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[EndDiscMST](#EndDiscMST)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[EnterpriseNumber](#EnterpriseNumber)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[EUSalesList](#EUSalesList)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[ExchRate](#ExchRate)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[ExchRateSecondary](#ExchRateSecondary)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[FixedDueDate](#FixedDueDate)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[GiroType](#GiroType)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[InclTax](#InclTax)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[InterCompanyCompanyId](#InterCompanyCompanyId)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[InterCompanyPosted](#InterCompanyPosted)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[InterCompanyPurchId](#InterCompanyPurchId)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[IntrastatDispatch](#IntrastatDispatch)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[IntrastatFulfillmentDate_HU](#IntrastatFulfillmentDate_HU)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[inventLocationId](#inventLocationId)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[InvoiceAccount](#InvoiceAccount)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[InvoiceAmount](#InvoiceAmount)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[InvoiceAmountMST](#InvoiceAmountMST)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[InvoiceDate](#InvoiceDate)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[InvoicePostalAddress](#InvoicePostalAddress)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[InvoiceRoundOff](#InvoiceRoundOff)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[InvoiceRoundOffMST](#InvoiceRoundOffMST)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[InvoicingName](#InvoicingName)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[IsCorrection](#IsCorrection)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[LanguageId](#LanguageId)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[LedgerVoucher](#LedgerVoucher)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[Listcode](#Listcode)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[Log](#Log)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[MCRDueAmount](#MCRDueAmount)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[MCREmail](#MCREmail)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[MCRPaymAmount](#MCRPaymAmount)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[numberSequenceGroup](#numberSequenceGroup)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[OLAPCostValue](#OLAPCostValue)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[OnAccountAmount](#OnAccountAmount)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[OneTimeCustomer](#OneTimeCustomer)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[PackedExtensions](#PackedExtensions)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[ParmId](#ParmId)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[PaymDayId](#PaymDayId)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[Payment](#Payment)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[PaymentSched](#PaymentSched)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[PaymId](#PaymId)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[PostingProfile](#PostingProfile)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[Prepayment](#Prepayment)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[PrintedOriginals](#PrintedOriginals)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[PrintMgmtSiteId](#PrintMgmtSiteId)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[Proforma](#Proforma)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[PurchaseOrder](#PurchaseOrder)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[Qty](#Qty)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[RCSalesList_UK](#RCSalesList_UK)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[ReasonTableRef](#ReasonTableRef)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[ReceiptDateConfirmed_ES](#ReceiptDateConfirmed_ES)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[RefNum](#RefNum)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[ReturnItemNum](#ReturnItemNum)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[ReturnReasonCodeId](#ReturnReasonCodeId)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[ReturnStatus](#ReturnStatus)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[ReverseChargeAmount](#ReverseChargeAmount)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[ReversedRecId](#ReversedRecId)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[SalesBalance](#SalesBalance)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[SalesBalanceMST](#SalesBalanceMST)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[SalesId](#SalesId)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[SalesOriginId](#SalesOriginId)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[SalesType](#SalesType)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[ShipCarrierBlindShipment](#ShipCarrierBlindShipment)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[SourceDocumentHeader](#SourceDocumentHeader)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[SourceDocumentLine](#SourceDocumentLine)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[SumLineDisc](#SumLineDisc)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[SumLineDiscMST](#SumLineDiscMST)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[SumMarkup](#SumMarkup)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[SumMarkupMST](#SumMarkupMST)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[SumTax](#SumTax)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[SumTaxMST](#SumTaxMST)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[TaxGroup](#TaxGroup)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[TaxInvoiceSalesId](#TaxInvoiceSalesId)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[TaxItemGroup](#TaxItemGroup)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[TaxPrintOnInvoice](#TaxPrintOnInvoice)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[TaxSpecifyByLine](#TaxSpecifyByLine)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[TransportationDocument](#TransportationDocument)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[Triangulation](#Triangulation)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[Updated](#Updated)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[VATNum](#VATNum)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[Volume](#Volume)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[Weight](#Weight)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[WorkerSalesTaker](#WorkerSalesTaker)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[SentElectronically](#SentElectronically)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[ReverseCharge_UK](#ReverseCharge_UK)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[ProvisionalAssessment_IN](#ProvisionalAssessment_IN)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[IntentLetterFromDate_IT](#IntentLetterFromDate_IT)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[IntentLetterId_IT](#IntentLetterId_IT)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[IntentLetterInternalId_IT](#IntentLetterInternalId_IT)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[IntentLetterToDate_IT](#IntentLetterToDate_IT)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[CommissionType_IT](#CommissionType_IT)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[DataAreaId](#DataAreaId)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[Relationship_BankLCExportLineRelationshipId](#Relationship_BankLCExportLineRelationshipId)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[Relationship_CashDiscRelationshipId](#Relationship_CashDiscRelationshipId)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[Relationship_ContactPersonRelationshipId](#Relationship_ContactPersonRelationshipId)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[Relationship_CurrencyRelationshipId](#Relationship_CurrencyRelationshipId)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[Relationship_CustDirectDebitMandateRelationshipId](#Relationship_CustDirectDebitMandateRelationshipId)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[Relationship_CustGroupRelationshipId](#Relationship_CustGroupRelationshipId)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[Relationship_CustInvoiceTableRelationshipId](#Relationship_CustInvoiceTableRelationshipId)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[Relationship_CustLedgerRelationshipId](#Relationship_CustLedgerRelationshipId)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[Relationship_CustTableRelationshipId](#Relationship_CustTableRelationshipId)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[Relationship_CustTable_CustInvoiceJour_InvoiceAccountRelationshipId](#Relationship_CustTable_CustInvoiceJour_InvoiceAccountRelationshipId)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[Relationship_DefaultDimensionRelationshipId](#Relationship_DefaultDimensionRelationshipId)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[Relationship_DeliveryPostalAddress_FKRelationshipId](#Relationship_DeliveryPostalAddress_FKRelationshipId)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[Relationship_DlvModeRelationshipId](#Relationship_DlvModeRelationshipId)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[Relationship_DlvTermRelationshipId](#Relationship_DlvTermRelationshipId)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[Relationship_InventLocationRelationshipId](#Relationship_InventLocationRelationshipId)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[Relationship_InventSiteRelationshipId](#Relationship_InventSiteRelationshipId)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[Relationship_InvoicePostalAddress_FKRelationshipId](#Relationship_InvoicePostalAddress_FKRelationshipId)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[Relationship_LanguageTableRelationshipId](#Relationship_LanguageTableRelationshipId)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[Relationship_NumberSequenceGroupRelationshipId](#Relationship_NumberSequenceGroupRelationshipId)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[Relationship_PaymDayRelationshipId](#Relationship_PaymDayRelationshipId)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[Relationship_PaymentSchedRelationshipId](#Relationship_PaymentSchedRelationshipId)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[Relationship_PaymTermRelationshipId](#Relationship_PaymTermRelationshipId)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[Relationship_ReasonTableRefRelationshipId](#Relationship_ReasonTableRefRelationshipId)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[Relationship_ReturnReasonCodeRelationshipId](#Relationship_ReturnReasonCodeRelationshipId)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[Relationship_SalesOriginRelationshipId](#Relationship_SalesOriginRelationshipId)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[Relationship_SalesTableRelationshipId](#Relationship_SalesTableRelationshipId)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[Relationship_SourceDocumentHeaderRelationshipId](#Relationship_SourceDocumentHeaderRelationshipId)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[Relationship_SourceDocumentLineRelationshipId](#Relationship_SourceDocumentLineRelationshipId)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[Relationship_TaxGroupHeadingRelationshipId](#Relationship_TaxGroupHeadingRelationshipId)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[Relationship_TaxItemGroupHeadingRelationshipId](#Relationship_TaxItemGroupHeadingRelationshipId)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[Relationship_TransportationDocumentRelationshipId](#Relationship_TransportationDocumentRelationshipId)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[Relationship_WMSBillOfLadingRelationshipId](#Relationship_WMSBillOfLadingRelationshipId)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[Relationship_CustIntentLetter_ITRelationshipId](#Relationship_CustIntentLetter_ITRelationshipId)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="CustInvoiceJour.md" target="_blank">Transaction/CustInvoiceJour</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Transaction/CustInvoiceJour (this entity)  
...
### <a href=#Backorder name="Backorder">Backorder</a>
...
<details>
<summary>List of traits for the Backorder attribute are listed below.</summary>
...
### <a href=#MCRDueAmount name="MCRDueAmount">MCRDueAmount</a>
...
<details>
<summary>List of traits for the MCRDueAmount attribute are listed below.</summary>
...
### <a href=#MCREmail name="MCREmail">MCREmail</a>
...
<details>
<summary>List of traits for the MCREmail attribute are listed below.</summary>
...
### <a href=#MCRPaymAmount name="MCRPaymAmount">MCRPaymAmount</a>
...
<details>
<summary>List of traits for the MCRPaymAmount attribute are listed below.</summary>
...
### <a href=#PrintedOriginals name="PrintedOriginals">PrintedOriginals</a>
...
<details>
<summary>List of traits for the PrintedOriginals attribute are listed below.</summary>
...
### <a href=#RCSalesList_UK name="RCSalesList_UK">RCSalesList_UK</a>
...
<details>
<summary>List of traits for the RCSalesList_UK attribute are listed below.</summary>
...
### <a href=#ReceiptDateConfirmed_ES name="ReceiptDateConfirmed_ES">ReceiptDateConfirmed_ES</a>
...
<details>
<summary>List of traits for the ReceiptDateConfirmed_ES attribute are listed below.</summary>
...
### <a href=#SentElectronically name="SentElectronically">SentElectronically</a>
...
<details>
<summary>List of traits for the SentElectronically attribute are listed below.</summary>
...
### <a href=#IntentLetterFromDate_IT name="IntentLetterFromDate_IT">IntentLetterFromDate_IT</a>
...
<details>
<summary>List of traits for the IntentLetterFromDate_IT attribute are listed below.</summary>
...
### <a href=#IntentLetterInternalId_IT name="IntentLetterInternalId_IT">IntentLetterInternalId_IT</a>
...
<details>
<summary>List of traits for the IntentLetterInternalId_IT attribute are listed below.</summary>
...
### <a href=#IntentLetterToDate_IT name="IntentLetterToDate_IT">IntentLetterToDate_IT</a>
...
<details>
<summary>List of traits for the IntentLetterToDate_IT attribute are listed below.</summary>
...
### <a href=#Relationship_CustTable_CustInvoiceJour_InvoiceAccountRelationshipId name="Relationship_CustTable_CustInvoiceJour_InvoiceAccountRelationshipId">Relationship_CustTable_CustInvoiceJour_InvoiceAccountRelationshipId</a>
...
<details>
<summary>List of traits for the Relationship_CustTable_CustInvoiceJour_InvoiceAccountRelationshipId attribute are listed below.</summary>
...
**means.identity.entityId**  
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="../../../SupplyChain/SalesAndMarketing/Group/SalesOrigin.md" target="_blank">/core/erp/Tables/SupplyChain/SalesAndMarketing/Group/SalesOrigin.cdm.json/SalesOrigin</a></td><td><a href="../../../SupplyChain/SalesAndMarketing/Group/SalesOrigin.md#RecId" target="_blank">RecId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
...
**means.identity.entityId**  
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="../WorksheetHeader/TransportationDocument.md" target="_blank">/core/erp/Tables/Finance/AccountsReceivable/WorksheetHeader/TransportationDocument.cdm.json/TransportationDocument</a></td><td><a href="../WorksheetHeader/TransportationDocument.md#RecId" target="_blank">RecId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
