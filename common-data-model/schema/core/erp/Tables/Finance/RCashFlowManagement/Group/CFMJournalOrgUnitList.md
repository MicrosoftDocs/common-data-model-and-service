---
title: CFMJournalOrgUnitList - Common Data Model | Microsoft Docs
...
# CFMJournalOrgUnitList

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/erp/Tables/Finance/RCashFlowManagement/Group/CFMJournalOrgUnitList.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[CFMJournalOrgUnitList/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="CFMJournalOrgUnitList.md" target="_blank">Group/CFMJournalOrgUnitList</a>|
|[DataArea](#DataArea)||<a href="CFMJournalOrgUnitList.md" target="_blank">Group/CFMJournalOrgUnitList</a>|
|[SetupSourceType](#SetupSourceType)||<a href="CFMJournalOrgUnitList.md" target="_blank">Group/CFMJournalOrgUnitList</a>|
|[SourceRecId](#SourceRecId)||<a href="CFMJournalOrgUnitList.md" target="_blank">Group/CFMJournalOrgUnitList</a>|
|[Relationship_CFMJournalNameRelationshipId](#Relationship_CFMJournalNameRelationshipId)||<a href="CFMJournalOrgUnitList.md" target="_blank">Group/CFMJournalOrgUnitList</a>|
|[Relationship_CFMJournalTableRelationshipId](#Relationship_CFMJournalTableRelationshipId)||<a href="CFMJournalOrgUnitList.md" target="_blank">Group/CFMJournalOrgUnitList</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Group/CFMJournalOrgUnitList (this entity)  
