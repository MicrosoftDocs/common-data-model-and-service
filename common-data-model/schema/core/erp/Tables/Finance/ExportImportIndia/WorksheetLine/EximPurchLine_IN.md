---
title: EximPurchLine_IN - Common Data Model | Microsoft Docs
...
# EximPurchLine_IN
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/erp/Tables/Finance/ExportImportIndia/WorksheetLine/EximPurchLine_IN.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[EximPurchLine_IN/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="EximPurchLine_IN.md" target="_blank">WorksheetLine/EximPurchLine_IN</a>|
|[ApplyDEPB](#ApplyDEPB)||<a href="EximPurchLine_IN.md" target="_blank">WorksheetLine/EximPurchLine_IN</a>|
|[EximIncentiveSchemeGroup](#EximIncentiveSchemeGroup)||<a href="EximPurchLine_IN.md" target="_blank">WorksheetLine/EximPurchLine_IN</a>|
|[EximPorts](#EximPorts)||<a href="EximPurchLine_IN.md" target="_blank">WorksheetLine/EximPurchLine_IN</a>|
|[EximProductGroupTable](#EximProductGroupTable)||<a href="EximPurchLine_IN.md" target="_blank">WorksheetLine/EximPurchLine_IN</a>|
|[PurchLineRecId](#PurchLineRecId)||<a href="EximPurchLine_IN.md" target="_blank">WorksheetLine/EximPurchLine_IN</a>|
|[DataAreaId](#DataAreaId)||<a href="EximPurchLine_IN.md" target="_blank">WorksheetLine/EximPurchLine_IN</a>|
|[Relationship_EximIncentiveSchemeGroupRelationshipId](#Relationship_EximIncentiveSchemeGroupRelationshipId)||<a href="EximPurchLine_IN.md" target="_blank">WorksheetLine/EximPurchLine_IN</a>|
|[Relationship_EximPortsRelationshipId](#Relationship_EximPortsRelationshipId)||<a href="EximPurchLine_IN.md" target="_blank">WorksheetLine/EximPurchLine_IN</a>|
|[Relationship_EximProductGroupTableRelationshipId](#Relationship_EximProductGroupTableRelationshipId)||<a href="EximPurchLine_IN.md" target="_blank">WorksheetLine/EximPurchLine_IN</a>|
|[Relationship_PurchLineRelationshipId](#Relationship_PurchLineRelationshipId)||<a href="EximPurchLine_IN.md" target="_blank">WorksheetLine/EximPurchLine_IN</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="EximPurchLine_IN.md" target="_blank">WorksheetLine/EximPurchLine_IN</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: WorksheetLine/EximPurchLine_IN (this entity)  
