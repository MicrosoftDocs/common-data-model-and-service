---
title: PaymCalendarCountryRegion - Common Data Model | Microsoft Docs
...
# PaymCalendarCountryRegion
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/erp/Tables/Finance/Bank/Reference/PaymCalendarCountryRegion.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[PaymCalendarCountryRegion/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="PaymCalendarCountryRegion.md" target="_blank">Reference/PaymCalendarCountryRegion</a>|
|[CountryRegion](#CountryRegion)||<a href="PaymCalendarCountryRegion.md" target="_blank">Reference/PaymCalendarCountryRegion</a>|
|[PaymCalendar](#PaymCalendar)||<a href="PaymCalendarCountryRegion.md" target="_blank">Reference/PaymCalendarCountryRegion</a>|
|[Relationship_CountryRegionRelationshipId](#Relationship_CountryRegionRelationshipId)||<a href="PaymCalendarCountryRegion.md" target="_blank">Reference/PaymCalendarCountryRegion</a>|
|[Relationship_PaymCalendarRelationshipId](#Relationship_PaymCalendarRelationshipId)||<a href="PaymCalendarCountryRegion.md" target="_blank">Reference/PaymCalendarCountryRegion</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Reference/PaymCalendarCountryRegion (this entity)  
