---
title: BankRemittanceFilesCust - Common Data Model | Microsoft Docs
...
# BankRemittanceFilesCust
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/erp/Tables/Finance/Bank/Transaction/BankRemittanceFilesCust.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[BankRemittanceFilesCust/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="BankRemittanceFilesCust.md" target="_blank">Transaction/BankRemittanceFilesCust</a>|
|[AmountMst](#AmountMst)||<a href="BankRemittanceFilesCust.md" target="_blank">Transaction/BankRemittanceFilesCust</a>|
|[BankAccountId](#BankAccountId)||<a href="BankRemittanceFilesCust.md" target="_blank">Transaction/BankRemittanceFilesCust</a>|
|[Closed](#Closed)||<a href="BankRemittanceFilesCust.md" target="_blank">Transaction/BankRemittanceFilesCust</a>|
|[FileId](#FileId)||<a href="BankRemittanceFilesCust.md" target="_blank">Transaction/BankRemittanceFilesCust</a>|
|[FileName](#FileName)||<a href="BankRemittanceFilesCust.md" target="_blank">Transaction/BankRemittanceFilesCust</a>|
|[JournalId](#JournalId)||<a href="BankRemittanceFilesCust.md" target="_blank">Transaction/BankRemittanceFilesCust</a>|
|[PaymMode](#PaymMode)||<a href="BankRemittanceFilesCust.md" target="_blank">Transaction/BankRemittanceFilesCust</a>|
|[Posted](#Posted)||<a href="BankRemittanceFilesCust.md" target="_blank">Transaction/BankRemittanceFilesCust</a>|
|[Printed](#Printed)||<a href="BankRemittanceFilesCust.md" target="_blank">Transaction/BankRemittanceFilesCust</a>|
|[PrintingDate](#PrintingDate)||<a href="BankRemittanceFilesCust.md" target="_blank">Transaction/BankRemittanceFilesCust</a>|
|[Received](#Received)||<a href="BankRemittanceFilesCust.md" target="_blank">Transaction/BankRemittanceFilesCust</a>|
|[Sent](#Sent)||<a href="BankRemittanceFilesCust.md" target="_blank">Transaction/BankRemittanceFilesCust</a>|
|[SentDate](#SentDate)||<a href="BankRemittanceFilesCust.md" target="_blank">Transaction/BankRemittanceFilesCust</a>|
|[ERFormatMappingID](#ERFormatMappingID)||<a href="BankRemittanceFilesCust.md" target="_blank">Transaction/BankRemittanceFilesCust</a>|
|[DataAreaId](#DataAreaId)||<a href="BankRemittanceFilesCust.md" target="_blank">Transaction/BankRemittanceFilesCust</a>|
|[Relationship_BankAccountTableRelationshipId](#Relationship_BankAccountTableRelationshipId)||<a href="BankRemittanceFilesCust.md" target="_blank">Transaction/BankRemittanceFilesCust</a>|
|[Relationship_CustPaymModeTableRelationshipId](#Relationship_CustPaymModeTableRelationshipId)||<a href="BankRemittanceFilesCust.md" target="_blank">Transaction/BankRemittanceFilesCust</a>|
|[Relationship_LedgerJournalTableRelationshipId](#Relationship_LedgerJournalTableRelationshipId)||<a href="BankRemittanceFilesCust.md" target="_blank">Transaction/BankRemittanceFilesCust</a>|
|[Relationship_CompanyRelationshipId](#Relationship_CompanyRelationshipId)||<a href="BankRemittanceFilesCust.md" target="_blank">Transaction/BankRemittanceFilesCust</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Transaction/BankRemittanceFilesCust (this entity)  
