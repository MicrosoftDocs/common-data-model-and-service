---
title: TaxWithholdTable - Common Data Model | Microsoft Docs
...
# TaxWithholdTable
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/erp/Tables/Finance/Tax/Main/TaxWithholdTable.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[TaxWithholdTable/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|[TaxWithholdServiceType](#TaxWithholdServiceType)||<a href="TaxWithholdTable.md" target="_blank">Main/TaxWithholdTable</a>|
...
<details>
<summary>List of traits for the ApplyThreshold_IN attribute are listed below.</summary>
...
<details>
<summary>List of traits for the TaxIncomingLedgerDimension_BR attribute are listed below.</summary>
...
<details>
<summary>List of traits for the TaxWithhold770Form attribute are listed below.</summary>
...
<details>
<summary>List of traits for the TaxWithholdBaseType attribute are listed below.</summary>
...
<details>
<summary>List of traits for the TaxWithholdComponent_IN attribute are listed below.</summary>
...
<details>
<summary>List of traits for the TaxWithholdLedgerAccountGroup_TH attribute are listed below.</summary>
...
<details>
<summary>List of traits for the TaxWithholdName attribute are listed below.</summary>
...
<details>
<summary>List of traits for the TaxWithholdReasonCode attribute are listed below.</summary>
...
### <a href=#TaxWithholdRecipient name="TaxWithholdRecipient">TaxWithholdRecipient</a>
...
<details>
<summary>List of traits for the TaxWithholdRecipient attribute are listed below.</summary>
...
<details>
<summary>List of traits for the TaxWithholdRoundOff attribute are listed below.</summary>
...
<details>
<summary>List of traits for the TaxWithholdRoundOffType attribute are listed below.</summary>
...
<details>
<summary>List of traits for the TaxWithholdServiceType attribute are listed below.</summary>
...
<details>
<summary>List of traits for the TaxWithholdSettlementPeriod_IN attribute are listed below.</summary>
...
<details>
<summary>List of traits for the TaxWithholdSource attribute are listed below.</summary>
...
<details>
<summary>List of traits for the TaxWithholdType_BR attribute are listed below.</summary>
...
<details>
<summary>List of traits for the TaxCalcMethod_JP attribute are listed below.</summary>
...
<details>
<summary>List of traits for the RevenueTypology_IT attribute are listed below.</summary>
...
<details>
<summary>List of traits for the CodeRevenueTypology_IT attribute are listed below.</summary>
...
<details>
<summary>List of traits for the Relationship_DimensionAttributeAccountIncoming_INRelationshipId attribute are listed below.</summary>
...
<details>
<summary>List of traits for the Relationship_TaxIncomingLedgerDimension_BRRelationshipId attribute are listed below.</summary>
...
<details>
<summary>List of traits for the Relationship_TaxWithholdComponentTable_INRelationshipId attribute are listed below.</summary>
...
**means.identity.entityId**  
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="TaxWithholdComponentTable_IN.md" target="_blank">/core/erp/Tables/Finance/Tax/Main/TaxWithholdComponentTable_IN.cdm.json/TaxWithholdComponentTable_IN</a></td><td><a href="TaxWithholdComponentTable_IN.md#RecId" target="_blank">RecId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
...
<details>
<summary>List of traits for the Relationship_TaxWithholdHead_INRelationshipId attribute are listed below.</summary>
...
<details>
<summary>List of traits for the Relationship_TaxWithholdLedgerAccountGroup_THRelationshipId attribute are listed below.</summary>
...
**means.identity.entityId**  
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="../Group/TaxWithholdLedgerAccountGroup_TH.md" target="_blank">/core/erp/Tables/Finance/Tax/Group/TaxWithholdLedgerAccountGroup_TH.cdm.json/TaxWithholdLedgerAccountGroup_TH</a></td><td><a href="../Group/TaxWithholdLedgerAccountGroup_TH.md#RecId" target="_blank">RecId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
