---
title: BudgetPrimaryLedgerDimensionAttribute - Common Data Model | Microsoft Docs
...
# BudgetPrimaryLedgerDimensionAttribute
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/erp/Tables/Finance/Budget/Group/BudgetPrimaryLedgerDimensionAttribute.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[BudgetPrimaryLedgerDimensionAttribute/(resolvedAttributes)/RecId](#RecId)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[RecId](#RecId)||<a href="BudgetPrimaryLedgerDimensionAttribute.md" target="_blank">Group/BudgetPrimaryLedgerDimensionAttribute</a>|
|[DimensionAttribute](#DimensionAttribute)||<a href="BudgetPrimaryLedgerDimensionAttribute.md" target="_blank">Group/BudgetPrimaryLedgerDimensionAttribute</a>|
|[PrimaryLedger](#PrimaryLedger)||<a href="BudgetPrimaryLedgerDimensionAttribute.md" target="_blank">Group/BudgetPrimaryLedgerDimensionAttribute</a>|
|[Relationship_DimensionAttributeRelationshipId](#Relationship_DimensionAttributeRelationshipId)||<a href="BudgetPrimaryLedgerDimensionAttribute.md" target="_blank">Group/BudgetPrimaryLedgerDimensionAttribute</a>|
|[Relationship_PrimaryLedgerRelationshipId](#Relationship_PrimaryLedgerRelationshipId)||<a href="BudgetPrimaryLedgerDimensionAttribute.md" target="_blank">Group/BudgetPrimaryLedgerDimensionAttribute</a>|

### <a href=#RecId name="RecId">RecId</a>

First included in: Group/BudgetPrimaryLedgerDimensionAttribute (this entity)  
