...
- **is.identifiedBy**  
  ...
  ```
  "BookableResourceBooking/hasAttributes/bookableResourceBookingId"
  ```
...
- **means.entityState**  
  ...
  ```
  "BookableResourceBooking/hasAttributes/stateCode"
  ```
