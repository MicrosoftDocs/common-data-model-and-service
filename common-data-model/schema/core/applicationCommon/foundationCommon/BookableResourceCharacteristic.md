...
- **is.identifiedBy**  
  ...
  ```
  "BookableResourceCharacteristic/hasAttributes/bookableResourceCharacteristicId"
  ```
...
- **means.entityState**  
  ...
  ```
  "BookableResourceCharacteristic/hasAttributes/stateCode"
  ```
