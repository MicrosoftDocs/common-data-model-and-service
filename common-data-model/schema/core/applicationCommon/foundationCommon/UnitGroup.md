...
- **is.identifiedBy**  
  ...
  ```
  "UnitGroup/hasAttributes/uoMScheduleId"
  ```
...
- **means.entityState**  
  ...
  ```
  "UnitGroup/hasAttributes/stateCode"
  ```


- **is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/applicationCommon/foundationCommon/<br>UnitGroup.cdm.json/UnitGroup/hasAttributes/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>
