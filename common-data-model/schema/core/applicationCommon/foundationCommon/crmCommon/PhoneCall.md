...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="PhoneCall.md" target="_blank">crmCommon/PhoneCall</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="PhoneCall.md" target="_blank">crmCommon/PhoneCall</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="PhoneCall.md" target="_blank">crmCommon/PhoneCall</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="PhoneCall.md" target="_blank">crmCommon/PhoneCall</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="PhoneCall.md" target="_blank">crmCommon/PhoneCall</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="PhoneCall.md" target="_blank">crmCommon/PhoneCall</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="PhoneCall.md" target="_blank">crmCommon/PhoneCall</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="PhoneCall.md" target="_blank">crmCommon/PhoneCall</a>|
|[ownerId](#ownerId)|Owner Id|<a href="PhoneCall.md" target="_blank">crmCommon/PhoneCall</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="PhoneCall.md" target="_blank">crmCommon/PhoneCall</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="PhoneCall.md" target="_blank">crmCommon/PhoneCall</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="PhoneCall.md" target="_blank">crmCommon/PhoneCall</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="PhoneCall.md" target="_blank">crmCommon/PhoneCall</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="PhoneCall.md" target="_blank">crmCommon/PhoneCall</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="PhoneCall.md" target="_blank">crmCommon/PhoneCall</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="PhoneCall.md" target="_blank">crmCommon/PhoneCall</a>|
|[activityId](#activityId)|Unique identifier of the activity.|<a href="PhoneCall.md" target="_blank">crmCommon/PhoneCall</a>|
|[activityTypeCode](#activityTypeCode)|Type of activity.|<a href="PhoneCall.md" target="_blank">crmCommon/PhoneCall</a>|
|[isBilled](#isBilled)|Information regarding whether the fax activity was billed as part of resolving a case.|<a href="PhoneCall.md" target="_blank">crmCommon/PhoneCall</a>|
|[isRegularActivity](#isRegularActivity)|Information regarding whether the activity is a regular activity type or event type.|<a href="PhoneCall.md" target="_blank">crmCommon/PhoneCall</a>|
|[isWorkflowCreated](#isWorkflowCreated)|Information regarding whether the activity was created from a workflow rule.|<a href="PhoneCall.md" target="_blank">crmCommon/PhoneCall</a>|
|[priorityCode](#priorityCode)|Priority of the activity.|<a href="PhoneCall.md" target="_blank">crmCommon/PhoneCall</a>|
|[priorityCode_display](#priorityCode_display)||<a href="PhoneCall.md" target="_blank">crmCommon/PhoneCall</a>|
|[regardingObjectId](#regardingObjectId)|Unique identifier of the object with which the activity is associated.|<a href="PhoneCall.md" target="_blank">crmCommon/PhoneCall</a>|
|[regardingObjectTypeCode](#regardingObjectTypeCode)|The name of the entity linked by regardingObjectId|<a href="PhoneCall.md" target="_blank">crmCommon/PhoneCall</a>|
|[scheduledEnd](#scheduledEnd)|Scheduled end time of the activity.|<a href="PhoneCall.md" target="_blank">crmCommon/PhoneCall</a>|
|[scheduledStart](#scheduledStart)|Scheduled start time of the activity.|<a href="PhoneCall.md" target="_blank">crmCommon/PhoneCall</a>|
|[sortDate](#sortDate)|Shows the date and time by which the activities are sorted.|<a href="PhoneCall.md" target="_blank">crmCommon/PhoneCall</a>|
|[subject](#subject)|Subject associated with the activity.|<a href="PhoneCall.md" target="_blank">crmCommon/PhoneCall</a>|
|[scheduledDurationMinutes](#scheduledDurationMinutes)|Scheduled duration of the activity, specified in minutes.|<a href="PhoneCall.md" target="_blank">crmCommon/PhoneCall</a>|
|[actualDurationMinutes](#actualDurationMinutes)|Actual duration of the activity in minutes.|<a href="PhoneCall.md" target="_blank">crmCommon/PhoneCall</a>|
|[actualEnd](#actualEnd)|Actual end time of the activity.|<a href="PhoneCall.md" target="_blank">crmCommon/PhoneCall</a>|
|[actualStart](#actualStart)|Actual start time of the activity.|<a href="PhoneCall.md" target="_blank">crmCommon/PhoneCall</a>|
|[category](#category)|Type a category to identify the activity type, such as lead outreach, customer follow-up, or service alert, to tie the eactivity to a business group or function.|<a href="PhoneCall.md" target="_blank">crmCommon/PhoneCall</a>|
|[subcategory](#subcategory)|Type a subcategory to identify the activity type and relate the activity to a specific product, sales region, business group, or other function.|<a href="PhoneCall.md" target="_blank">crmCommon/PhoneCall</a>|
|[activityAdditionalParams](#activityAdditionalParams)|Additional information provided by the external application as JSON. For internal use only.|<a href="PhoneCall.md" target="_blank">crmCommon/PhoneCall</a>|
|[to](#to)|Enter the account, contact, lead, or user recipients for the letter.|<a href="PhoneCall.md" target="_blank">crmCommon/PhoneCall</a>|
|[from](#from)|Enter the account, contact, lead, or user who made the phone call.|<a href="PhoneCall.md" target="_blank">crmCommon/PhoneCall</a>|
|[leftVoiceMail](#leftVoiceMail)|Left the voice mail|<a href="PhoneCall.md" target="_blank">crmCommon/PhoneCall</a>|
|[directionCode](#directionCode)|Select the direction of the activity as incoming or outbound.|<a href="PhoneCall.md" target="_blank">crmCommon/PhoneCall</a>|
|[phoneNumber](#phoneNumber)|Type the phone number.|<a href="PhoneCall.md" target="_blank">crmCommon/PhoneCall</a>|
|[description](#description)|Additional information to describe the phone call, such as the primary message or the products and services discussed.|<a href="PhoneCall.md" target="_blank">crmCommon/PhoneCall</a>|
|[stateCode](#stateCode)|Shows whether the phone call is open, completed, or canceled. Completed and canceled phone calls are read-only and can't be edited.|<a href="PhoneCall.md" target="_blank">crmCommon/PhoneCall</a>|
|[stateCode_display](#stateCode_display)||<a href="PhoneCall.md" target="_blank">crmCommon/PhoneCall</a>|
|[statusCode](#statusCode)|Select the phone call's status.|<a href="PhoneCall.md" target="_blank">crmCommon/PhoneCall</a>|
|[statusCode_display](#statusCode_display)||<a href="PhoneCall.md" target="_blank">crmCommon/PhoneCall</a>|
|[transactionCurrencyId](#transactionCurrencyId)|Choose the local currency for the record to make sure budgets are reported in the correct currency.|<a href="PhoneCall.md" target="_blank">crmCommon/PhoneCall</a>|
|[exchangeRate](#exchangeRate)|Shows the conversion rate of the record's currency. The exchange rate is used to convert all money fields in the record from the local currency to the system's default currency.|<a href="PhoneCall.md" target="_blank">crmCommon/PhoneCall</a>|
|[processId](#processId)|Shows the ID of the process.|<a href="PhoneCall.md" target="_blank">crmCommon/PhoneCall</a>|
|[stageId](#stageId)|Shows the ID of the stage.|<a href="PhoneCall.md" target="_blank">crmCommon/PhoneCall</a>|
|[traversedPath](#traversedPath)|For internal use only.|<a href="PhoneCall.md" target="_blank">crmCommon/PhoneCall</a>|
|[SLAInvokedId](#SLAInvokedId)|Last SLA that was applied to this Phone Call. This field is for internal use only.|<a href="PhoneCall.md" target="_blank">crmCommon/PhoneCall</a>|
|[onHoldTime](#onHoldTime)|Shows how long, in minutes, that the record was on hold.|<a href="PhoneCall.md" target="_blank">crmCommon/PhoneCall</a>|
|[lastOnHoldTime](#lastOnHoldTime)|Contains the date and time stamp of the last on hold time.|<a href="PhoneCall.md" target="_blank">crmCommon/PhoneCall</a>|
|[SLAId](#SLAId)|Choose the service level agreement (SLA) that you want to apply to the Phone Call record.|<a href="PhoneCall.md" target="_blank">crmCommon/PhoneCall</a>|
