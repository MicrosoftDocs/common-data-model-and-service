...
- **is.identifiedBy**  
  ...
  ```
  "TestScore/hasAttributes/testScoreId"
  ```
...
- **means.entityState**  
  ...
  ```
  "TestScore/hasAttributes/stateCode"
  ```
