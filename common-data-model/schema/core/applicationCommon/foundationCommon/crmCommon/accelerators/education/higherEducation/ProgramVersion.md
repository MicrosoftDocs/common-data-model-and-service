...
- **is.identifiedBy**  
  ...
  ```
  "ProgramVersion/hasAttributes/programVersionId"
  ```
...
- **means.entityState**  
  ...
  ```
  "ProgramVersion/hasAttributes/stateCode"
  ```
