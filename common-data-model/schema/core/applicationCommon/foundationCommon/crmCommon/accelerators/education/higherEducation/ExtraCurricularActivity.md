...
- **is.identifiedBy**  
  ...
  ```
  "ExtraCurricularActivity/hasAttributes/extracurricularActivitiesId"
  ```
...
- **means.entityState**  
  ...
  ```
  "ExtraCurricularActivity/hasAttributes/stateCode"
  ```
