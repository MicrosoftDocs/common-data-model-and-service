...
- **is.identifiedBy**  
  ...
  ```
  "RegistrationStatus/hasAttributes/registrationStatusId"
  ```
...
- **means.entityState**  
  ...
  ```
  "RegistrationStatus/hasAttributes/stateCode"
  ```
