...
- **is.identifiedBy**  
  ...
  ```
  "CourseSection/hasAttributes/courseSectionId"
  ```
...
- **means.entityState**  
  ...
  ```
  "CourseSection/hasAttributes/stateCode"
  ```
