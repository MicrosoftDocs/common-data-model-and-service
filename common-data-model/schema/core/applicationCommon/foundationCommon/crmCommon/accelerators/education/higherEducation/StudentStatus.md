...
<a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/education/higherEducation/StudentStatus.cdm.json" target="_blank">Entity definition</a> on GitHub.  

## Instances

higherEducation/StudentStatus  

## Traits for Student Status
...
- **is.identifiedBy**  
  ...
  ```
  "StudentStatus_/hasAttributes/studentStatusId"
  ```
...
- **means.entityState**  
  ...
  ```
  "StudentStatus_/hasAttributes/stateCode"
  ```
