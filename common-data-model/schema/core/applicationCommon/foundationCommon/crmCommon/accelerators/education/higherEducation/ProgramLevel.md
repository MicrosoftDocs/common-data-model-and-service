...
<a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/education/higherEducation/ProgramLevel.cdm.json" target="_blank">Entity definition</a> on GitHub.  

## Instances

higherEducation/ProgramLevel  

## Traits for Program Level
...
- **is.identifiedBy**  
  ...
  ```
  "ProgramLevel_/hasAttributes/programLevelId"
  ```
...
- **means.entityState**  
  ...
  ```
  "ProgramLevel_/hasAttributes/stateCode"
  ```
