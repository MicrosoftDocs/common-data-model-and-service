...
Latest version (0.8.1)of the json entity definition is available on GitHub (<a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/education/higherEducation/ProgramLevel.cdm.json" target="_blank">Link on GitHub</a>).  

### Instances

higherEducation/ProgramLevel  

## Attributes - Summary

|Name|Description|First Included in Instance|
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|[higherEducation/ProgramLevel](ProgramLevel.md)|
|[createdBy](#createdBy)|Shows who created the record.|[higherEducation/ProgramLevel](ProgramLevel.md)|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|[higherEducation/ProgramLevel](ProgramLevel.md)|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|[higherEducation/ProgramLevel](ProgramLevel.md)|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|[higherEducation/ProgramLevel](ProgramLevel.md)|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|[higherEducation/ProgramLevel](ProgramLevel.md)|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|[higherEducation/ProgramLevel](ProgramLevel.md)|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|[higherEducation/ProgramLevel](ProgramLevel.md)|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|[higherEducation/ProgramLevel](ProgramLevel.md)|
|[ownerId](#ownerId)|Owner Id|[higherEducation/ProgramLevel](ProgramLevel.md)|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|[higherEducation/ProgramLevel](ProgramLevel.md)|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|[higherEducation/ProgramLevel](ProgramLevel.md)|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|[higherEducation/ProgramLevel](ProgramLevel.md)|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|[higherEducation/ProgramLevel](ProgramLevel.md)|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|[higherEducation/ProgramLevel](ProgramLevel.md)|
|[versionNumber](#versionNumber)|Version Number|[higherEducation/ProgramLevel](ProgramLevel.md)|
|[programLevelId](#programLevelId)|Unique identifier for entity instances|[higherEducation/ProgramLevel](ProgramLevel.md)|
|[stateCode](#stateCode)|Status of the Program Level|[higherEducation/ProgramLevel](ProgramLevel.md)|
|[stateCode_display](#stateCode_display)||[higherEducation/ProgramLevel](ProgramLevel.md)|
|[statusCode](#statusCode)|Reason for the status of the Program Level|[higherEducation/ProgramLevel](ProgramLevel.md)|
|[statusCode_display](#statusCode_display)||[higherEducation/ProgramLevel](ProgramLevel.md)|
|[name](#name)|Program Level Name|[higherEducation/ProgramLevel](ProgramLevel.md)|
|[code](#code)|Program Level Code|[higherEducation/ProgramLevel](ProgramLevel.md)|
|[externalIdentifier](#externalIdentifier)|External Identifier|[higherEducation/ProgramLevel](ProgramLevel.md)|
|[externalSourceSystem](#externalSourceSystem)|External Source System|[higherEducation/ProgramLevel](ProgramLevel.md)|
|[externalSourceSystem_display](#externalSourceSystem_display)||[higherEducation/ProgramLevel](ProgramLevel.md)|

### Traits

<details>
<summary>List of traits for the Program Level entity are listed below.</summary>

- **is.CDM.entityVersion**  
  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>versionNumber</td><td>0.8.1</td><td>string</td><td>semantic version number of the entity</td></tr></table>

- **is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json/<br>cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json/<br>cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json/<br>cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json/<br>cdsVersionTracking</td></tr><tr><td>/core/applicationCommon/foundationCommon/<br>crmCommon/accelerators/education/higherEducation/ProgramLevel.cdm.json/ProgramLevel/hasAttributes/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

- **is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>"ProgramLevel_/hasAttributes/programLevelId"</td><td>attribute</td><td></td></tr></table>Definition:  
  ```
  "ProgramLevel/hasAttributes/programLevelId"
  ```


- **means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>"ProgramLevel_/hasAttributes/stateCode"</td><td>attribute</td><td></td></tr></table>Definition:  
  ```
  "ProgramLevel/hasAttributes/stateCode"
  ```


- **is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Program Level</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

- **is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Collection of all Program Levels offered by the institution</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

- **is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>mshied_programlevel</td><td>string</td><td></td></tr></table>
...
First included in: /core/applicationCommon/foundationCommon/crmCommon/accelerators/education/higherEducation/ProgramLevel.cdm.json/ProgramLevel  
...
- **is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>mshied_programlevelid</td><td>string</td><td></td></tr></table>
...
- **is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the Program Level</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
- **is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the Program Level</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Program Level Name</td></tr><tr><td>description</td><td>Program Level Name</td></tr><tr><td>dataFormat</td><td>String</td></tr><tr><td>maximumLength</td><td>100</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>mshied_name</td></tr></table>
...
- **is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Program Level Name</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Code</td></tr><tr><td>description</td><td>Program Level Code</td></tr><tr><td>dataFormat</td><td>String</td></tr><tr><td>maximumLength</td><td>20</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>mshied_code</td></tr></table>
...
- **is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Program Level Code</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
