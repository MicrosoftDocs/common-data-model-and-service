...
Generic activity representing work needed to be done.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/education/higherEducation/Task.cdm.json" target="_blank">GitHub</a>.  

## Instances

Instances of this entity are listed below.  

- [/Task.cdm.json/Task](../../../../../Task.md "/core/applicationCommon/Task.cdm.json/Task")  
- /crmCommon/accelerators/education/higherEducation/Task  
...
- [/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/Task](../../healthCare/electronicMedicalRecords/Task.md "/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/Task.cdm.json/Task")  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/activityCommon</td></tr><tr><td>/core/applicationCommon/Task.cdm.json/Task<br>/hasAttributes/attributesAddedAtThisScope</td></tr><tr><td>/core/applicationCommon/foundationCommon<br>/crmCommon/service/Task.cdm.json/Task<br>/hasAttributes/attributesAddedAtThisScope</td></tr><tr><td>/core/applicationCommon/foundationCommon<br>/crmCommon/solutions/marketing/Task.cdm.json/Task<br>/hasAttributes/attributesAddedAtThisScope</td></tr><tr><td>/core/applicationCommon/foundationCommon<br>/crmCommon/accelerators/education/higherEducation<br>/Task.cdm.json/Task/hasAttributes<br>/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.ordered**  
  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[Task/(resolvedAttributes)/sortDate](#sortDate)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[Task/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="Task.md" target="_blank">higherEducation/Task</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="Task.md" target="_blank">higherEducation/Task</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="Task.md" target="_blank">higherEducation/Task</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="Task.md" target="_blank">higherEducation/Task</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="Task.md" target="_blank">higherEducation/Task</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="Task.md" target="_blank">higherEducation/Task</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="Task.md" target="_blank">higherEducation/Task</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="Task.md" target="_blank">higherEducation/Task</a>|
|[ownerId](#ownerId)|Owner Id|<a href="Task.md" target="_blank">higherEducation/Task</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="Task.md" target="_blank">higherEducation/Task</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="Task.md" target="_blank">higherEducation/Task</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="Task.md" target="_blank">higherEducation/Task</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="Task.md" target="_blank">higherEducation/Task</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="Task.md" target="_blank">higherEducation/Task</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="Task.md" target="_blank">higherEducation/Task</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="Task.md" target="_blank">higherEducation/Task</a>|
|[activityId](#activityId)|Unique identifier of the activity.|<a href="Task.md" target="_blank">higherEducation/Task</a>|
|[activityTypeCode](#activityTypeCode)|Type of activity.|<a href="Task.md" target="_blank">higherEducation/Task</a>|
|[isBilled](#isBilled)|Information regarding whether the fax activity was billed as part of resolving a case.|<a href="Task.md" target="_blank">higherEducation/Task</a>|
|[isRegularActivity](#isRegularActivity)|Information regarding whether the activity is a regular activity type or event type.|<a href="Task.md" target="_blank">higherEducation/Task</a>|
|[isWorkflowCreated](#isWorkflowCreated)|Information regarding whether the activity was created from a workflow rule.|<a href="Task.md" target="_blank">higherEducation/Task</a>|
|[priorityCode](#priorityCode)|Priority of the activity.|<a href="Task.md" target="_blank">higherEducation/Task</a>|
|[priorityCode_display](#priorityCode_display)||<a href="Task.md" target="_blank">higherEducation/Task</a>|
|[regardingObjectId](#regardingObjectId)|Unique identifier of the object with which the activity is associated.|<a href="Task.md" target="_blank">higherEducation/Task</a>|
|[regardingObjectTypeCode](#regardingObjectTypeCode)|The name of the entity linked by regardingObjectId|<a href="Task.md" target="_blank">higherEducation/Task</a>|
|[scheduledEnd](#scheduledEnd)|Scheduled end time of the activity.|<a href="Task.md" target="_blank">higherEducation/Task</a>|
|[scheduledStart](#scheduledStart)|Scheduled start time of the activity.|<a href="Task.md" target="_blank">higherEducation/Task</a>|
|[sortDate](#sortDate)|Shows the date and time by which the activities are sorted.|<a href="Task.md" target="_blank">higherEducation/Task</a>|
|[subject](#subject)|Subject associated with the activity.|<a href="Task.md" target="_blank">higherEducation/Task</a>|
|[scheduledDurationMinutes](#scheduledDurationMinutes)|Scheduled duration of the activity, specified in minutes.|<a href="Task.md" target="_blank">higherEducation/Task</a>|
|[actualDurationMinutes](#actualDurationMinutes)|Actual duration of the activity in minutes.|<a href="Task.md" target="_blank">higherEducation/Task</a>|
|[actualEnd](#actualEnd)|Actual end time of the activity.|<a href="Task.md" target="_blank">higherEducation/Task</a>|
|[actualStart](#actualStart)|Actual start time of the activity.|<a href="Task.md" target="_blank">higherEducation/Task</a>|
|[category](#category)|Type a category to identify the activity type, such as lead outreach, customer follow-up, or service alert, to tie the eactivity to a business group or function.|<a href="Task.md" target="_blank">higherEducation/Task</a>|
|[subcategory](#subcategory)|Type a subcategory to identify the activity type and relate the activity to a specific product, sales region, business group, or other function.|<a href="Task.md" target="_blank">higherEducation/Task</a>|
|[activityAdditionalParams](#activityAdditionalParams)|Additional information provided by the external application as JSON. For internal use only.|<a href="Task.md" target="_blank">higherEducation/Task</a>|
|[stateCode](#stateCode)|Shows whether the task is open, completed, or canceled. Completed and canceled tasks are read-only and can't be edited.|<a href="Task.md" target="_blank">higherEducation/Task</a>|
|[stateCode_display](#stateCode_display)||<a href="Task.md" target="_blank">higherEducation/Task</a>|
|[description](#description)|Type additional information to describe the task.|<a href="Task.md" target="_blank">higherEducation/Task</a>|
|[percentComplete](#percentComplete)|Type the percentage complete value for the task to track tasks to completion.|<a href="Task.md" target="_blank">higherEducation/Task</a>|
|[statusCode](#statusCode)|Select the task's status.|<a href="Task.md" target="_blank">higherEducation/Task</a>|
|[statusCode_display](#statusCode_display)||<a href="Task.md" target="_blank">higherEducation/Task</a>|
|[transactionCurrencyId](#transactionCurrencyId)|Choose the local currency for the record to make sure budgets are reported in the correct currency.|<a href="Task.md" target="_blank">higherEducation/Task</a>|
|[exchangeRate](#exchangeRate)|Shows the conversion rate of the record's currency. The exchange rate is used to convert all money fields in the record from the local currency to the system's default currency.|<a href="Task.md" target="_blank">higherEducation/Task</a>|
|[processId](#processId)|Shows the ID of the process.|<a href="Task.md" target="_blank">higherEducation/Task</a>|
|[stageId](#stageId)|Shows the ID of the stage.|<a href="Task.md" target="_blank">higherEducation/Task</a>|
|[traversedPath](#traversedPath)|For internal use only.|<a href="Task.md" target="_blank">higherEducation/Task</a>|
|[crmTaskAssignedUniqueId](#crmTaskAssignedUniqueId)|Assigned Task Unique Id|<a href="Task.md" target="_blank">higherEducation/Task</a>|
|[SLAId](#SLAId)|Choose the service level agreement (SLA) that you want to apply to the Task record.|<a href="Task.md" target="_blank">higherEducation/Task</a>|
|[SLAInvokedId](#SLAInvokedId)|Last SLA that was applied to this Task. This field is for internal use only.|<a href="Task.md" target="_blank">higherEducation/Task</a>|
|[onHoldTime](#onHoldTime)|Shows how long, in minutes, that the record was on hold.|<a href="Task.md" target="_blank">higherEducation/Task</a>|
|[lastOnHoldTime](#lastOnHoldTime)|Contains the date and time stamp of the last on hold time.|<a href="Task.md" target="_blank">higherEducation/Task</a>|
|[serviceId](#serviceId)|Choose the service that is associated with this activity.|<a href="Task.md" target="_blank">higherEducation/Task</a>|
|[customerJourneyIteration](#customerJourneyIteration)|Customer journey iteration|<a href="Task.md" target="_blank">higherEducation/Task</a>|
|[extensionStatus](#extensionStatus)||<a href="Task.md" target="_blank">higherEducation/Task</a>|
|[extensionStatus_display](#extensionStatus_display)||<a href="Task.md" target="_blank">higherEducation/Task</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: higherEducation/Task (this entity)  
...
**means.identity.entityId**  
**is.identifiedBy**  
names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[Task/(resolvedAttributes)/activityId](#activityId)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Shows whether the task is open, completed, or canceled. Completed and canceled tasks are read-only and can't be edited.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Description</td></tr><tr><td>description</td><td>Type additional information to describe the task.</td></tr><tr><td>dataFormat</td><td>7</td></tr><tr><td>maximumLength</td><td>2000</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>description</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Percent Complete</td></tr><tr><td>description</td><td>Type the percentage complete value for the task to track tasks to completion.</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>maximumValue</td><td>100</td></tr><tr><td>minimumValue</td><td>0</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>percentcomplete</td></tr></table>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Percent Complete</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Type the percentage complete value for the task to track tasks to completion.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.nullable**  
The attribute value may be set to NULL.  

**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"percentcomplete"</td><td>string</td><td></td></tr></table>
...
**is.dataFormat.integer**  
**does.haveDefault**  
An attribute has a default value  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>default</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Not Started</td><td>2</td><td>0</td></tr><tr><td>en</td><td>In Progress</td><td>3</td><td>0</td></tr><tr><td>en</td><td>Waiting on someone else</td><td>4</td><td>0</td></tr><tr><td>en</td><td>Completed</td><td>5</td><td>1</td></tr><tr><td>en</td><td>Canceled</td><td>6</td><td>2</td></tr><tr><td>en</td><td>Deferred</td><td>7</td><td>0</td></tr></table></td><td>any</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Assigned Task Unique Id</td></tr><tr><td>description</td><td>Assigned Task Unique Id</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>crmtaskassigneduniqueid</td></tr></table>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Assigned Task Unique Id</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"crmtaskassigneduniqueid"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>SLA</td></tr><tr><td>description</td><td>Choose the service level agreement (SLA) that you want to apply to the Task record.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>slaid</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Choose the service level agreement (SLA) that you want to apply to the Task record.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Last SLA applied</td></tr><tr><td>description</td><td>Last SLA that was applied to this Task. This field is for internal use only.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>slainvokedid</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Last SLA that was applied to this Task. This field is for internal use only.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Service</td></tr><tr><td>description</td><td>Choose the service that is associated with this activity.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>serviceid</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Choose the service that is associated with this activity.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
### <a href=#extensionStatus name="extensionStatus">extensionStatus</a>

First included in: higherEducation/Task (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Extension Status</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>mshied_extensionstatus</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr></tr><tr></tr><tr></tr><tr></tr><tr></tr></table></td></tr></table>

#### Traits

<details>
<summary>List of traits for the extensionStatus attribute are listed below.</summary>

**is.dataFormat.integer**  
**does.haveDefault**  
An attribute has a default value  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>default</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Not requested</td><td>494280000</td></tr><tr><td>en</td><td>Requested</td><td>494280001</td></tr><tr><td>en</td><td>Denied</td><td>494280002</td></tr><tr><td>en</td><td>Approved</td><td>494280003</td></tr></table></td><td>any</td><td></td></tr></table>

**is.constrainedList**  
the values of an attribute are taken from or looked up from a fixed list of possibilities  

**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"mshied_extensionstatus"</td><td>string</td><td></td></tr></table>

**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Extension Status</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
### <a href=#extensionStatus_display name="extensionStatus_display">extensionStatus_display</a>
...
<details>
<summary>List of traits for the extensionStatus_display attribute are listed below.</summary>
...
**is.readOnly**  
**is.addedInSupportOf**  
<table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>inSupportOf</td><td>"extensionStatus"</td><td>attributeName</td><td>output parameter naming the attribute that is being supported</td></tr></table>
