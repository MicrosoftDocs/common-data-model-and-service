---
title: ScholarshipApplicationBusinessProcessFlow - Common Data Model | Microsoft Docs
description: Base entity for process Scholarship Application Business Process Flow
author: nenad1002
...
# Scholarship Application Business Process Flow

Base entity for process Scholarship Application Business Process Flow  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/education/higherEducation/ScholarshipApplicationBusinessProcessFlow.cdm.json" target="_blank">GitHub</a>.  

## Instances

Instances of this entity are listed below.  

- /crmCommon/accelerators/education/higherEducation/ScholarshipApplicationBusinessProcessFlow  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[ScholarshipApplicationBusinessProcessFlow/(resolvedAttributes)/businessProcessFlowInstanceId](#businessProcessFlowInstanceId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[ScholarshipApplicationBusinessProcessFlow/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>

**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/applicationCommon/foundationCommon<br>/crmCommon/accelerators/education/higherEducation<br>/ScholarshipApplicationBusinessProcessFlow.cdm.json<br>/ScholarshipApplicationBusinessProcessFlow<br>/hasAttributes/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Scholarship Application Business Process Flow</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Base entity for process Scholarship Application Business Process Flow</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"mshied_scholarshipapplicationbusinessprocessflow"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[businessProcessFlowInstanceId](#businessProcessFlowInstanceId)|Unique identifier for entity instances|<a href="ScholarshipApplicationBusinessProcessFlow.md" target="_blank">higherEducation/ScholarshipApplicationBusinessProcessFlow</a>|
|[activeStageStartedOn](#activeStageStartedOn)|Date and time when current active stage is started|<a href="ScholarshipApplicationBusinessProcessFlow.md" target="_blank">higherEducation/ScholarshipApplicationBusinessProcessFlow</a>|
|[bpf_Duration](#bpf_Duration)|Duration of Business Process Flow|<a href="ScholarshipApplicationBusinessProcessFlow.md" target="_blank">higherEducation/ScholarshipApplicationBusinessProcessFlow</a>|
|[mshied_ScholarshipapplicantId](#mshied_ScholarshipapplicantId)||<a href="ScholarshipApplicationBusinessProcessFlow.md" target="_blank">higherEducation/ScholarshipApplicationBusinessProcessFlow</a>|
|[name](#name)|Description|<a href="ScholarshipApplicationBusinessProcessFlow.md" target="_blank">higherEducation/ScholarshipApplicationBusinessProcessFlow</a>|
|[completedOn](#completedOn)|Date and time when Business Process Flow instance is completed.|<a href="ScholarshipApplicationBusinessProcessFlow.md" target="_blank">higherEducation/ScholarshipApplicationBusinessProcessFlow</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="ScholarshipApplicationBusinessProcessFlow.md" target="_blank">higherEducation/ScholarshipApplicationBusinessProcessFlow</a>|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="ScholarshipApplicationBusinessProcessFlow.md" target="_blank">higherEducation/ScholarshipApplicationBusinessProcessFlow</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="ScholarshipApplicationBusinessProcessFlow.md" target="_blank">higherEducation/ScholarshipApplicationBusinessProcessFlow</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="ScholarshipApplicationBusinessProcessFlow.md" target="_blank">higherEducation/ScholarshipApplicationBusinessProcessFlow</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="ScholarshipApplicationBusinessProcessFlow.md" target="_blank">higherEducation/ScholarshipApplicationBusinessProcessFlow</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="ScholarshipApplicationBusinessProcessFlow.md" target="_blank">higherEducation/ScholarshipApplicationBusinessProcessFlow</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="ScholarshipApplicationBusinessProcessFlow.md" target="_blank">higherEducation/ScholarshipApplicationBusinessProcessFlow</a>|
|[organizationId](#organizationId)|Unique identifier for the organization|<a href="ScholarshipApplicationBusinessProcessFlow.md" target="_blank">higherEducation/ScholarshipApplicationBusinessProcessFlow</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="ScholarshipApplicationBusinessProcessFlow.md" target="_blank">higherEducation/ScholarshipApplicationBusinessProcessFlow</a>|
|[stateCode](#stateCode)|Status of the Scholarship Application Business Process Flow|<a href="ScholarshipApplicationBusinessProcessFlow.md" target="_blank">higherEducation/ScholarshipApplicationBusinessProcessFlow</a>|
|[stateCode_display](#stateCode_display)||<a href="ScholarshipApplicationBusinessProcessFlow.md" target="_blank">higherEducation/ScholarshipApplicationBusinessProcessFlow</a>|
|[statusCode](#statusCode)|Reason for the status of the Scholarship Application Business Process Flow|<a href="ScholarshipApplicationBusinessProcessFlow.md" target="_blank">higherEducation/ScholarshipApplicationBusinessProcessFlow</a>|
|[statusCode_display](#statusCode_display)||<a href="ScholarshipApplicationBusinessProcessFlow.md" target="_blank">higherEducation/ScholarshipApplicationBusinessProcessFlow</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="ScholarshipApplicationBusinessProcessFlow.md" target="_blank">higherEducation/ScholarshipApplicationBusinessProcessFlow</a>|
|[traversedPath](#traversedPath)|Comma delimited string of process stage ids that represent visited stages of the Business Process Flow instance.|<a href="ScholarshipApplicationBusinessProcessFlow.md" target="_blank">higherEducation/ScholarshipApplicationBusinessProcessFlow</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="ScholarshipApplicationBusinessProcessFlow.md" target="_blank">higherEducation/ScholarshipApplicationBusinessProcessFlow</a>|

### <a href=#businessProcessFlowInstanceId name="businessProcessFlowInstanceId">businessProcessFlowInstanceId</a>

Unique identifier for entity instances  
First included in: higherEducation/ScholarshipApplicationBusinessProcessFlow (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Scholarship Application Business Process Flow</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>businessprocessflowinstanceid</td></tr></table>
...
### <a href=#mshied_ScholarshipapplicantId name="mshied_ScholarshipapplicantId">mshied_ScholarshipapplicantId</a>

First included in: higherEducation/ScholarshipApplicationBusinessProcessFlow (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Mshied_Scholarshipapplicant</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>bpf_mshied_scholarshipapplicantid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the mshied_ScholarshipapplicantId attribute are listed below.</summary>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Mshied_Scholarshipapplicant</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="ScholarshipApplicant.md" target="_blank">/core/applicationCommon/foundationCommon/crmCommon/accelerators/education/higherEducation/ScholarshipApplicant.cdm.json/ScholarshipApplicant</a></td><td><a href="ScholarshipApplicant.md#scholarshipApplicantId" target="_blank">scholarshipApplicantId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>

**is.nullable**  
The attribute value may be set to NULL.  

**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"bpf_mshied_scholarshipapplicantid"</td><td>string</td><td></td></tr></table>
...
Status of the Scholarship Application Business Process Flow  
First included in: higherEducation/ScholarshipApplicationBusinessProcessFlow (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Scholarship Application Business Process Flow</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the Scholarship Application Business Process Flow</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the Scholarship Application Business Process Flow</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
