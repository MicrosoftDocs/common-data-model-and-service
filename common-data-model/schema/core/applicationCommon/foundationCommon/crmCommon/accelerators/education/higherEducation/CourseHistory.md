...
- **is.identifiedBy**  
  ...
  ```
  "CourseHistory/hasAttributes/courseHistoryId"
  ```
...
- **means.entityState**  
  ...
  ```
  "CourseHistory/hasAttributes/stateCode"
  ```
