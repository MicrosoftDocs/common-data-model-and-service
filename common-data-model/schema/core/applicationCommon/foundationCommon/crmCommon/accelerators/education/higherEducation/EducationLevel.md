...
- **is.identifiedBy**  
  ...
  ```
  "EducationLevel/hasAttributes/educationLevelId"
  ```
...
- **means.entityState**  
  ...
  ```
  "EducationLevel/hasAttributes/stateCode"
  ```
