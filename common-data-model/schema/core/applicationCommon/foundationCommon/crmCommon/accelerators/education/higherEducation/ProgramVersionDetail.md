...
<a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/education/higherEducation/ProgramVersionDetail.cdm.json" target="_blank">Entity definition</a> on GitHub.  

## Instances

higherEducation/ProgramVersionDetail  

## Traits for Program Version Detail

- **is.CDM.entityVersion**  
  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>versionNumber</td><td>0.8.1</td><td>string</td><td>semantic version number of the entity</td></tr></table>

- **is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json/cdsVersionTracking</td></tr><tr><td>/core/applicationCommon/foundationCommon/crmCommon/accelerators/education/higherEducation/ProgramVersionDetail.cdm.json/ProgramVersionDetail/hasAttributes/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

- **is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>"ProgramVersionDetail_/hasAttributes/programVersionDetailId"</td><td>attribute</td><td></td></tr></table>Definition:  
  ```
  "ProgramVersionDetail_/hasAttributes/programVersionDetailId"
  ```


- **means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>"ProgramVersionDetail_/hasAttributes/stateCode"</td><td>attribute</td><td></td></tr></table>Definition:  
  ```
  "ProgramVersionDetail_/hasAttributes/stateCode"
  ```


- **is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Program Version Detail</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

- **is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>The master list of program versions start dates defined by the institution.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

- **is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>mshied_programversiondetail</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|[higherEducation/ProgramVersionDetail](ProgramVersionDetail.md)|
|[createdBy](#createdBy)|Shows who created the record.|[higherEducation/ProgramVersionDetail](ProgramVersionDetail.md)|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|[higherEducation/ProgramVersionDetail](ProgramVersionDetail.md)|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|[higherEducation/ProgramVersionDetail](ProgramVersionDetail.md)|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|[higherEducation/ProgramVersionDetail](ProgramVersionDetail.md)|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|[higherEducation/ProgramVersionDetail](ProgramVersionDetail.md)|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|[higherEducation/ProgramVersionDetail](ProgramVersionDetail.md)|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|[higherEducation/ProgramVersionDetail](ProgramVersionDetail.md)|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|[higherEducation/ProgramVersionDetail](ProgramVersionDetail.md)|
|[ownerId](#ownerId)|Owner Id|[higherEducation/ProgramVersionDetail](ProgramVersionDetail.md)|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|[higherEducation/ProgramVersionDetail](ProgramVersionDetail.md)|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|[higherEducation/ProgramVersionDetail](ProgramVersionDetail.md)|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|[higherEducation/ProgramVersionDetail](ProgramVersionDetail.md)|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|[higherEducation/ProgramVersionDetail](ProgramVersionDetail.md)|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|[higherEducation/ProgramVersionDetail](ProgramVersionDetail.md)|
|[versionNumber](#versionNumber)|Version Number|[higherEducation/ProgramVersionDetail](ProgramVersionDetail.md)|
|[programVersionDetailId](#programVersionDetailId)|Unique identifier for entity instances|[higherEducation/ProgramVersionDetail](ProgramVersionDetail.md)|
|[stateCode](#stateCode)|Status of the Program Version Detail|[higherEducation/ProgramVersionDetail](ProgramVersionDetail.md)|
|[stateCode_display](#stateCode_display)||[higherEducation/ProgramVersionDetail](ProgramVersionDetail.md)|
|[statusCode](#statusCode)|Reason for the status of the Program Version Detail|[higherEducation/ProgramVersionDetail](ProgramVersionDetail.md)|
|[statusCode_display](#statusCode_display)||[higherEducation/ProgramVersionDetail](ProgramVersionDetail.md)|
|[name](#name)|Program Version Start Date Code|[higherEducation/ProgramVersionDetail](ProgramVersionDetail.md)|
|[code](#code)|Registration code.|[higherEducation/ProgramVersionDetail](ProgramVersionDetail.md)|
|[expectedGraduationDate](#expectedGraduationDate)|The expected graduation date for the program version start date instance.|[higherEducation/ProgramVersionDetail](ProgramVersionDetail.md)|
|[externalIdentifier](#externalIdentifier)|External Identifier|[higherEducation/ProgramVersionDetail](ProgramVersionDetail.md)|
|[externalSourceSystem](#externalSourceSystem)|External Source System|[higherEducation/ProgramVersionDetail](ProgramVersionDetail.md)|
|[externalSourceSystem_display](#externalSourceSystem_display)||[higherEducation/ProgramVersionDetail](ProgramVersionDetail.md)|
|[midpointDate](#midpointDate)|Midpoint Date|[higherEducation/ProgramVersionDetail](ProgramVersionDetail.md)|
|[mustGraduateBefore](#mustGraduateBefore)|Must Graduate Before|[higherEducation/ProgramVersionDetail](ProgramVersionDetail.md)|
...
<details>
<summary>List of traits for the programVersionDetailId attribute are listed below.</summary>
...
- **is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>mshied_programversiondetailid</td><td>string</td><td></td></tr></table>
...
- **is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the Program Version Detail</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
- **is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the Program Version Detail</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
- **is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Program Version Detail Name</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

- **is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Program Version Start Date Code</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
- **is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Registration code.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<details>
<summary>List of traits for the expectedGraduationDate attribute are listed below.</summary>
...
- **is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Expected Graduation Date</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

- **is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>The expected graduation date for the program version start date instance.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

- **is.nullable**  
The attribute value may be set to NULL.  

- **is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>mshied_expectedgraduationdate</td><td>string</td><td></td></tr></table>
...
<details>
<summary>List of traits for the midpointDate attribute are listed below.</summary>
...
- **is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>mshied_midpointdate</td><td>string</td><td></td></tr></table>
...
<details>
<summary>List of traits for the mustGraduateBefore attribute are listed below.</summary>
...
- **is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Must Graduate Before</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
- **is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>mshied_mustgraduatebefore</td><td>string</td><td></td></tr></table>
...
- **is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Program Version</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

- **is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Lookup to the program version.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

- **is.nullable**  
The attribute value may be set to NULL.  

- **is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>mshied_programversionid</td><td>string</td><td></td></tr></table>
...
- **is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="ProgramVersion.md" target="_blank">/core/applicationCommon/foundationCommon/crmCommon/accelerators/education/higherEducation/ProgramVersion.cdm.json/ProgramVersion</a></td><td><a href="ProgramVersion.md#programVersionId" target="_blank">programVersionId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
