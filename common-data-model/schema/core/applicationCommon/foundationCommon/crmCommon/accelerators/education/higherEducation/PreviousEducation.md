...
- **is.identifiedBy**  
  ...
  ```
  "PreviousEducation/hasAttributes/previousEducationId"
  ```
...
- **means.entityState**  
  ...
  ```
  "PreviousEducation/hasAttributes/stateCode"
  ```
