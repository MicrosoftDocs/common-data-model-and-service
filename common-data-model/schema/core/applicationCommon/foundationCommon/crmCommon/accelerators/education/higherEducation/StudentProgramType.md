...
- **is.identifiedBy**  
  ...
  ```
  "StudentProgramType/hasAttributes/studentProgramTypeId"
  ```
...
- **means.entityState**  
  ...
  ```
  "StudentProgramType/hasAttributes/stateCode"
  ```
