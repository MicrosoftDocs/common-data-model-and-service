...
- **is.identifiedBy**  
  ...
  ```
  "AreaOfStudy/hasAttributes/areaOfStudyId"
  ```
...
- **means.entityState**  
  ...
  ```
  "AreaOfStudy/hasAttributes/stateCode"
  ```
