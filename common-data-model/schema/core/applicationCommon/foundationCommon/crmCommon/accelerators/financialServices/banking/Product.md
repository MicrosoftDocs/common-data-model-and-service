...
- /crmCommon/accelerators/financialServices/banking/Product  
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Information about products and their pricing information.</td></tr><tr><td>en</td><td>The products of the bank that the prospect or referral is interested in.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[productId](#productId)|Unique identifier of the product.|<a href="Product.md" target="_blank">banking/Product</a>|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="Product.md" target="_blank">banking/Product</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the product.|<a href="Product.md" target="_blank">banking/Product</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="Product.md" target="_blank">banking/Product</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who last modified the product.|<a href="Product.md" target="_blank">banking/Product</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the product.|<a href="Product.md" target="_blank">banking/Product</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who last modified the product.|<a href="Product.md" target="_blank">banking/Product</a>|
|[organizationId](#organizationId)|Unique identifier for the organization|<a href="Product.md" target="_blank">banking/Product</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="Product.md" target="_blank">banking/Product</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="Product.md" target="_blank">banking/Product</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="Product.md" target="_blank">banking/Product</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="Product.md" target="_blank">banking/Product</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="Product.md" target="_blank">banking/Product</a>|
|[name](#name)|Name of the product.|<a href="Product.md" target="_blank">banking/Product</a>|
|[processId](#processId)|Contains the id of the process associated with the entity.|<a href="Product.md" target="_blank">banking/Product</a>|
|[stageId](#stageId)|Contains the id of the stage where the entity is located.|<a href="Product.md" target="_blank">banking/Product</a>|
|[traversedPath](#traversedPath)|A comma separated list of string values representing the unique identifiers of stages in a Business Process Flow Instance in the order that they occur.|<a href="Product.md" target="_blank">banking/Product</a>|
|[vendorID](#vendorID)|Unique identifier of vendor supplying the product.|<a href="Product.md" target="_blank">banking/Product</a>|
|[validFromDate](#validFromDate)|Date from which this product is valid.|<a href="Product.md" target="_blank">banking/Product</a>|
|[validToDate](#validToDate)|Date to which this product is valid.|<a href="Product.md" target="_blank">banking/Product</a>|
|[currentCost](#currentCost)|Current cost for the product item. Used in price calculations.|<a href="Product.md" target="_blank">banking/Product</a>|
|[transactionCurrencyId](#transactionCurrencyId)|Unique identifier of the currency associated with the product.|<a href="Product.md" target="_blank">banking/Product</a>|
|[exchangeRate](#exchangeRate)|Exchange rate for the currency associated with the product with respect to the base currency.|<a href="Product.md" target="_blank">banking/Product</a>|
|[currentCostBase](#currentCostBase)|Value of the Current Cost in base currency.|<a href="Product.md" target="_blank">banking/Product</a>|
|[defaultUoMId](#defaultUoMId)|Default unit for the product.|<a href="Product.md" target="_blank">banking/Product</a>|
|[defaultUoMScheduleId](#defaultUoMScheduleId)|Default unit group for the product.|<a href="Product.md" target="_blank">banking/Product</a>|
|[description](#description)|Description of the product.|<a href="Product.md" target="_blank">banking/Product</a>|
|[isKit](#isKit)|Information that specifies whether the product is a kit.|<a href="Product.md" target="_blank">banking/Product</a>|
|[isStockItem](#isStockItem)|Information about whether the product is a stock item.|<a href="Product.md" target="_blank">banking/Product</a>|
|[parentProductId](#parentProductId)|Specifies the parent product family hierarchy.|<a href="Product.md" target="_blank">banking/Product</a>|
|[price](#price)|List price of the product.|<a href="Product.md" target="_blank">banking/Product</a>|
|[priceBase](#priceBase)|Value of the List Price in base currency.|<a href="Product.md" target="_blank">banking/Product</a>|
|[productStructure](#productStructure)|Product Structure.|<a href="Product.md" target="_blank">banking/Product</a>|
|[productStructure_display](#productStructure_display)||<a href="Product.md" target="_blank">banking/Product</a>|
|[productNumber](#productNumber)|User-defined product ID.|<a href="Product.md" target="_blank">banking/Product</a>|
|[productTypeCode](#productTypeCode)|Type of product.|<a href="Product.md" target="_blank">banking/Product</a>|
|[productTypeCode_display](#productTypeCode_display)||<a href="Product.md" target="_blank">banking/Product</a>|
|[productUrl](#productUrl)|URL for the Website associated with the product.|<a href="Product.md" target="_blank">banking/Product</a>|
|[quantityDecimal](#quantityDecimal)|Number of decimal places that can be used in monetary amounts for the product.|<a href="Product.md" target="_blank">banking/Product</a>|
|[quantityOnHand](#quantityOnHand)|Quantity of the product in stock.|<a href="Product.md" target="_blank">banking/Product</a>|
|[size](#size)|Product size.|<a href="Product.md" target="_blank">banking/Product</a>|
|[standardCost](#standardCost)|Standard cost of the product.|<a href="Product.md" target="_blank">banking/Product</a>|
|[standardCostBase](#standardCostBase)|Value of the Standard Cost in base currency.|<a href="Product.md" target="_blank">banking/Product</a>|
|[stateCode](#stateCode)|Status of the product.|<a href="Product.md" target="_blank">banking/Product</a>|
|[stateCode_display](#stateCode_display)||<a href="Product.md" target="_blank">banking/Product</a>|
|[statusCode](#statusCode)|Reason for the status of the product.|<a href="Product.md" target="_blank">banking/Product</a>|
|[statusCode_display](#statusCode_display)||<a href="Product.md" target="_blank">banking/Product</a>|
|[stockVolume](#stockVolume)|Stock volume of the product.|<a href="Product.md" target="_blank">banking/Product</a>|
|[stockWeight](#stockWeight)|Stock weight of the product.|<a href="Product.md" target="_blank">banking/Product</a>|
|[supplierName](#supplierName)|Name of the product's supplier.|<a href="Product.md" target="_blank">banking/Product</a>|
|[vendorName](#vendorName)|Name of the product vendor.|<a href="Product.md" target="_blank">banking/Product</a>|
|[vendorPartNumber](#vendorPartNumber)|Unique part identifier in vendor catalog of this product.|<a href="Product.md" target="_blank">banking/Product</a>|
|[hierarchyPath](#hierarchyPath)|Hierarchy path of the product.|<a href="Product.md" target="_blank">banking/Product</a>|
|[priceLevelId](#priceLevelId)|Select the default price list for the product.|<a href="Product.md" target="_blank">banking/Product</a>|
|[subjectId](#subjectId)|Select a category for the product.|<a href="Product.md" target="_blank">banking/Product</a>|
|[entityImageId](#entityImageId)||<a href="Product.md" target="_blank">banking/Product</a>|
|[createdByExternalParty](#createdByExternalParty)|Shows the external party who created the record.|<a href="Product.md" target="_blank">banking/Product</a>|
|[modifiedByExternalParty](#modifiedByExternalParty)|Shows the external party who modified the record.|<a href="Product.md" target="_blank">banking/Product</a>|
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Entity Image</td></tr><tr><td>description</td><td>Shows the default image for the record.</td></tr><tr><td>dataFormat</td><td>10</td></tr><tr><td>maximumLength</td><td>9437328</td></tr><tr><td>sourceName</td><td>entityimage</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Shows the default image for the record.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
