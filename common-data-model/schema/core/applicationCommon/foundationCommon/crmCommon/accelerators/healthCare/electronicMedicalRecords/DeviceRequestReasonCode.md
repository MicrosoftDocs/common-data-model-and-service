...
Reason or justification for the use of this device.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/DeviceRequestReasonCode.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="DeviceRequestReasonCode.md" target="_blank">electronicMedicalRecords/DeviceRequestReasonCode</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="DeviceRequestReasonCode.md" target="_blank">electronicMedicalRecords/DeviceRequestReasonCode</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="DeviceRequestReasonCode.md" target="_blank">electronicMedicalRecords/DeviceRequestReasonCode</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="DeviceRequestReasonCode.md" target="_blank">electronicMedicalRecords/DeviceRequestReasonCode</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="DeviceRequestReasonCode.md" target="_blank">electronicMedicalRecords/DeviceRequestReasonCode</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="DeviceRequestReasonCode.md" target="_blank">electronicMedicalRecords/DeviceRequestReasonCode</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="DeviceRequestReasonCode.md" target="_blank">electronicMedicalRecords/DeviceRequestReasonCode</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="DeviceRequestReasonCode.md" target="_blank">electronicMedicalRecords/DeviceRequestReasonCode</a>|
|[ownerId](#ownerId)|Owner Id|<a href="DeviceRequestReasonCode.md" target="_blank">electronicMedicalRecords/DeviceRequestReasonCode</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="DeviceRequestReasonCode.md" target="_blank">electronicMedicalRecords/DeviceRequestReasonCode</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="DeviceRequestReasonCode.md" target="_blank">electronicMedicalRecords/DeviceRequestReasonCode</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="DeviceRequestReasonCode.md" target="_blank">electronicMedicalRecords/DeviceRequestReasonCode</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="DeviceRequestReasonCode.md" target="_blank">electronicMedicalRecords/DeviceRequestReasonCode</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="DeviceRequestReasonCode.md" target="_blank">electronicMedicalRecords/DeviceRequestReasonCode</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="DeviceRequestReasonCode.md" target="_blank">electronicMedicalRecords/DeviceRequestReasonCode</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="DeviceRequestReasonCode.md" target="_blank">electronicMedicalRecords/DeviceRequestReasonCode</a>|
|[deviceRequestId](#deviceRequestId)|Identifier for Device Request|<a href="DeviceRequestReasonCode.md" target="_blank">electronicMedicalRecords/DeviceRequestReasonCode</a>|
|[deviceRequestReasonCodeId](#deviceRequestReasonCodeId)|Unique identifier for entity instances|<a href="DeviceRequestReasonCode.md" target="_blank">electronicMedicalRecords/DeviceRequestReasonCode</a>|
|[name](#name)|The name of the custom entity.|<a href="DeviceRequestReasonCode.md" target="_blank">electronicMedicalRecords/DeviceRequestReasonCode</a>|
|[reasonCodeId](#reasonCodeId)|Reason or justification for the use of this device.|<a href="DeviceRequestReasonCode.md" target="_blank">electronicMedicalRecords/DeviceRequestReasonCode</a>|
|[stateCode](#stateCode)|Status of the Device Request Reason Code|<a href="DeviceRequestReasonCode.md" target="_blank">electronicMedicalRecords/DeviceRequestReasonCode</a>|
|[stateCode_display](#stateCode_display)||<a href="DeviceRequestReasonCode.md" target="_blank">electronicMedicalRecords/DeviceRequestReasonCode</a>|
|[statusCode](#statusCode)|Reason for the status of the Device Request Reason Code|<a href="DeviceRequestReasonCode.md" target="_blank">electronicMedicalRecords/DeviceRequestReasonCode</a>|
|[statusCode_display](#statusCode_display)||<a href="DeviceRequestReasonCode.md" target="_blank">electronicMedicalRecords/DeviceRequestReasonCode</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/DeviceRequestReasonCode (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Device Request Reason Code</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_devicerequestreasoncodeid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Reason Code</td></tr><tr><td>description</td><td>Reason or justification for the use of this device.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_reasoncode</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Device Request Reason Code</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
