...
Additional instruction such as "Swallow with plenty of water" which may or may not be coded.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/DosageAddInstruction.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="DosageAddInstruction.md" target="_blank">electronicMedicalRecords/DosageAddInstruction</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="DosageAddInstruction.md" target="_blank">electronicMedicalRecords/DosageAddInstruction</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="DosageAddInstruction.md" target="_blank">electronicMedicalRecords/DosageAddInstruction</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="DosageAddInstruction.md" target="_blank">electronicMedicalRecords/DosageAddInstruction</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="DosageAddInstruction.md" target="_blank">electronicMedicalRecords/DosageAddInstruction</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="DosageAddInstruction.md" target="_blank">electronicMedicalRecords/DosageAddInstruction</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="DosageAddInstruction.md" target="_blank">electronicMedicalRecords/DosageAddInstruction</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="DosageAddInstruction.md" target="_blank">electronicMedicalRecords/DosageAddInstruction</a>|
|[ownerId](#ownerId)|Owner Id|<a href="DosageAddInstruction.md" target="_blank">electronicMedicalRecords/DosageAddInstruction</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="DosageAddInstruction.md" target="_blank">electronicMedicalRecords/DosageAddInstruction</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="DosageAddInstruction.md" target="_blank">electronicMedicalRecords/DosageAddInstruction</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="DosageAddInstruction.md" target="_blank">electronicMedicalRecords/DosageAddInstruction</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="DosageAddInstruction.md" target="_blank">electronicMedicalRecords/DosageAddInstruction</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="DosageAddInstruction.md" target="_blank">electronicMedicalRecords/DosageAddInstruction</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="DosageAddInstruction.md" target="_blank">electronicMedicalRecords/DosageAddInstruction</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="DosageAddInstruction.md" target="_blank">electronicMedicalRecords/DosageAddInstruction</a>|
|[dosageId](#dosageId)|The identifier for Dosage.|<a href="DosageAddInstruction.md" target="_blank">electronicMedicalRecords/DosageAddInstruction</a>|
|[dosageAddInstructionId](#dosageAddInstructionId)|Unique identifier for entity instances|<a href="DosageAddInstruction.md" target="_blank">electronicMedicalRecords/DosageAddInstruction</a>|
|[dosageAdditionalInstructionId](#dosageAdditionalInstructionId)|Supplemental instructions to the patient on how to take the medication or warnings for the patient about the medication.|<a href="DosageAddInstruction.md" target="_blank">electronicMedicalRecords/DosageAddInstruction</a>|
|[name](#name)|The name of the custom entity.|<a href="DosageAddInstruction.md" target="_blank">electronicMedicalRecords/DosageAddInstruction</a>|
|[stateCode](#stateCode)|Status of the Dosage Add Instruction|<a href="DosageAddInstruction.md" target="_blank">electronicMedicalRecords/DosageAddInstruction</a>|
|[stateCode_display](#stateCode_display)||<a href="DosageAddInstruction.md" target="_blank">electronicMedicalRecords/DosageAddInstruction</a>|
|[statusCode](#statusCode)|Reason for the status of the Dosage Add Instruction|<a href="DosageAddInstruction.md" target="_blank">electronicMedicalRecords/DosageAddInstruction</a>|
|[statusCode_display](#statusCode_display)||<a href="DosageAddInstruction.md" target="_blank">electronicMedicalRecords/DosageAddInstruction</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/DosageAddInstruction (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Dosage</td></tr><tr><td>description</td><td>The identifier for Dosage.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_dosage</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Dosage Add Instruction</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_dosageaddinstructionid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Additional Instruction</td></tr><tr><td>description</td><td>Supplemental instructions to the patient on how to take the medication or warnings for the patient about the medication.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_dosageadditionalinstruction</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Dosage Add Instruction</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Dosage Add Instruction</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
