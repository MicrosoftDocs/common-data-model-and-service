...
- **is.identifiedBy**  
  ...
  ```
  "Condition/hasAttributes/conditionId"
  ```
...
- **means.entityState**  
  ...
  ```
  "Condition/hasAttributes/stateCode"
  ```
