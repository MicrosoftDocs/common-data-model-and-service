---
title: TaskPerformerType - Common Data Model | Microsoft Docs
...
The type of participant that can execute the task.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/TaskPerformerType.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="TaskPerformerType.md" target="_blank">electronicMedicalRecords/TaskPerformerType</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="TaskPerformerType.md" target="_blank">electronicMedicalRecords/TaskPerformerType</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="TaskPerformerType.md" target="_blank">electronicMedicalRecords/TaskPerformerType</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="TaskPerformerType.md" target="_blank">electronicMedicalRecords/TaskPerformerType</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="TaskPerformerType.md" target="_blank">electronicMedicalRecords/TaskPerformerType</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="TaskPerformerType.md" target="_blank">electronicMedicalRecords/TaskPerformerType</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="TaskPerformerType.md" target="_blank">electronicMedicalRecords/TaskPerformerType</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="TaskPerformerType.md" target="_blank">electronicMedicalRecords/TaskPerformerType</a>|
|[ownerId](#ownerId)|Owner Id|<a href="TaskPerformerType.md" target="_blank">electronicMedicalRecords/TaskPerformerType</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="TaskPerformerType.md" target="_blank">electronicMedicalRecords/TaskPerformerType</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="TaskPerformerType.md" target="_blank">electronicMedicalRecords/TaskPerformerType</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="TaskPerformerType.md" target="_blank">electronicMedicalRecords/TaskPerformerType</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="TaskPerformerType.md" target="_blank">electronicMedicalRecords/TaskPerformerType</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="TaskPerformerType.md" target="_blank">electronicMedicalRecords/TaskPerformerType</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="TaskPerformerType.md" target="_blank">electronicMedicalRecords/TaskPerformerType</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="TaskPerformerType.md" target="_blank">electronicMedicalRecords/TaskPerformerType</a>|
|[name](#name)|The name of the custom entity.|<a href="TaskPerformerType.md" target="_blank">electronicMedicalRecords/TaskPerformerType</a>|
|[performerTypeId](#performerTypeId)|The type of participant that can execute the task.|<a href="TaskPerformerType.md" target="_blank">electronicMedicalRecords/TaskPerformerType</a>|
|[taskId](#taskId)|Unique identifier for Task.|<a href="TaskPerformerType.md" target="_blank">electronicMedicalRecords/TaskPerformerType</a>|
|[taskPerformerTypeId](#taskPerformerTypeId)|Unique identifier for entity instances|<a href="TaskPerformerType.md" target="_blank">electronicMedicalRecords/TaskPerformerType</a>|
|[stateCode](#stateCode)|Status of the Task Performer Type|<a href="TaskPerformerType.md" target="_blank">electronicMedicalRecords/TaskPerformerType</a>|
|[stateCode_display](#stateCode_display)||<a href="TaskPerformerType.md" target="_blank">electronicMedicalRecords/TaskPerformerType</a>|
|[statusCode](#statusCode)|Reason for the status of the Task Performer Type|<a href="TaskPerformerType.md" target="_blank">electronicMedicalRecords/TaskPerformerType</a>|
|[statusCode_display](#statusCode_display)||<a href="TaskPerformerType.md" target="_blank">electronicMedicalRecords/TaskPerformerType</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/TaskPerformerType (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Performer Type</td></tr><tr><td>description</td><td>The type of participant that can execute the task.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_performertype</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Task</td></tr><tr><td>description</td><td>Unique identifier for Task.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_task</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Task Performer Type</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_taskperformertypeid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Task Performer Type</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Task Performer Type</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
