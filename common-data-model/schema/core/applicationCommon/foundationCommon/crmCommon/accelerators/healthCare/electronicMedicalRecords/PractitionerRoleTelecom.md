...
Contact details that are specific to the role/location/service.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/PractitionerRoleTelecom.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="PractitionerRoleTelecom.md" target="_blank">electronicMedicalRecords/PractitionerRoleTelecom</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="PractitionerRoleTelecom.md" target="_blank">electronicMedicalRecords/PractitionerRoleTelecom</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="PractitionerRoleTelecom.md" target="_blank">electronicMedicalRecords/PractitionerRoleTelecom</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="PractitionerRoleTelecom.md" target="_blank">electronicMedicalRecords/PractitionerRoleTelecom</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="PractitionerRoleTelecom.md" target="_blank">electronicMedicalRecords/PractitionerRoleTelecom</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="PractitionerRoleTelecom.md" target="_blank">electronicMedicalRecords/PractitionerRoleTelecom</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="PractitionerRoleTelecom.md" target="_blank">electronicMedicalRecords/PractitionerRoleTelecom</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="PractitionerRoleTelecom.md" target="_blank">electronicMedicalRecords/PractitionerRoleTelecom</a>|
|[ownerId](#ownerId)|Owner Id|<a href="PractitionerRoleTelecom.md" target="_blank">electronicMedicalRecords/PractitionerRoleTelecom</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="PractitionerRoleTelecom.md" target="_blank">electronicMedicalRecords/PractitionerRoleTelecom</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="PractitionerRoleTelecom.md" target="_blank">electronicMedicalRecords/PractitionerRoleTelecom</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="PractitionerRoleTelecom.md" target="_blank">electronicMedicalRecords/PractitionerRoleTelecom</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="PractitionerRoleTelecom.md" target="_blank">electronicMedicalRecords/PractitionerRoleTelecom</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="PractitionerRoleTelecom.md" target="_blank">electronicMedicalRecords/PractitionerRoleTelecom</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="PractitionerRoleTelecom.md" target="_blank">electronicMedicalRecords/PractitionerRoleTelecom</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="PractitionerRoleTelecom.md" target="_blank">electronicMedicalRecords/PractitionerRoleTelecom</a>|
|[name](#name)|The name of the custom entity.|<a href="PractitionerRoleTelecom.md" target="_blank">electronicMedicalRecords/PractitionerRoleTelecom</a>|
|[periodEndDatetime](#periodEndDatetime)|The end of the period. If the end of the period is missing, it means that the period is ongoing.|<a href="PractitionerRoleTelecom.md" target="_blank">electronicMedicalRecords/PractitionerRoleTelecom</a>|
|[periodStartDatetime](#periodStartDatetime)|The start of the period. The boundary is inclusive.|<a href="PractitionerRoleTelecom.md" target="_blank">electronicMedicalRecords/PractitionerRoleTelecom</a>|
|[practitionerRoleId](#practitionerRoleId)|Unique identifier for Practitioner Role|<a href="PractitionerRoleTelecom.md" target="_blank">electronicMedicalRecords/PractitionerRoleTelecom</a>|
|[practitionerRoleTelecomId](#practitionerRoleTelecomId)|Unique identifier for entity instances|<a href="PractitionerRoleTelecom.md" target="_blank">electronicMedicalRecords/PractitionerRoleTelecom</a>|
|[rank](#rank)|Specifies a preferred order in which to use a set of contacts. Contacts are ranked with lower values coming before higher values.|<a href="PractitionerRoleTelecom.md" target="_blank">electronicMedicalRecords/PractitionerRoleTelecom</a>|
|[system](#system)|Telecommunications form for contact point - what communications system is required to make use of the contact.|<a href="PractitionerRoleTelecom.md" target="_blank">electronicMedicalRecords/PractitionerRoleTelecom</a>|
|[system_display](#system_display)||<a href="PractitionerRoleTelecom.md" target="_blank">electronicMedicalRecords/PractitionerRoleTelecom</a>|
|[use](#use)|Identifies the purpose for the contact point.|<a href="PractitionerRoleTelecom.md" target="_blank">electronicMedicalRecords/PractitionerRoleTelecom</a>|
|[use_display](#use_display)||<a href="PractitionerRoleTelecom.md" target="_blank">electronicMedicalRecords/PractitionerRoleTelecom</a>|
|[value](#value)|The actual contact point details, in a form that is meaningful to the designated communication system (i.e. phone number or email address).|<a href="PractitionerRoleTelecom.md" target="_blank">electronicMedicalRecords/PractitionerRoleTelecom</a>|
|[stateCode](#stateCode)|Status of the Practitioner Role Telecom|<a href="PractitionerRoleTelecom.md" target="_blank">electronicMedicalRecords/PractitionerRoleTelecom</a>|
|[stateCode_display](#stateCode_display)||<a href="PractitionerRoleTelecom.md" target="_blank">electronicMedicalRecords/PractitionerRoleTelecom</a>|
|[statusCode](#statusCode)|Reason for the status of the Practitioner Role Telecom|<a href="PractitionerRoleTelecom.md" target="_blank">electronicMedicalRecords/PractitionerRoleTelecom</a>|
|[statusCode_display](#statusCode_display)||<a href="PractitionerRoleTelecom.md" target="_blank">electronicMedicalRecords/PractitionerRoleTelecom</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/PractitionerRoleTelecom (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Practitioner Role Telecom</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_practitionerroletelecomid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Practitioner Role Telecom</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Practitioner Role Telecom</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
