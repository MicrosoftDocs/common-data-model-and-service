...
- **is.identifiedBy**  
  ...
  ```
  "RiskAssessment/hasAttributes/riskAssessmentId"
  ```
...
- **means.entityState**  
  ...
  ```
  "RiskAssessment/hasAttributes/stateCode"
  ```
