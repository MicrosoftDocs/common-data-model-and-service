---
title: EpisodeOfCareHistory - Common Data Model | Microsoft Docs
...
The history of statuses that the Episode Of Care has been through (without requiring processing the history of the resource).  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/EpisodeOfCareHistory.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="EpisodeOfCareHistory.md" target="_blank">electronicMedicalRecords/EpisodeOfCareHistory</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="EpisodeOfCareHistory.md" target="_blank">electronicMedicalRecords/EpisodeOfCareHistory</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="EpisodeOfCareHistory.md" target="_blank">electronicMedicalRecords/EpisodeOfCareHistory</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="EpisodeOfCareHistory.md" target="_blank">electronicMedicalRecords/EpisodeOfCareHistory</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="EpisodeOfCareHistory.md" target="_blank">electronicMedicalRecords/EpisodeOfCareHistory</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="EpisodeOfCareHistory.md" target="_blank">electronicMedicalRecords/EpisodeOfCareHistory</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="EpisodeOfCareHistory.md" target="_blank">electronicMedicalRecords/EpisodeOfCareHistory</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="EpisodeOfCareHistory.md" target="_blank">electronicMedicalRecords/EpisodeOfCareHistory</a>|
|[ownerId](#ownerId)|Owner Id|<a href="EpisodeOfCareHistory.md" target="_blank">electronicMedicalRecords/EpisodeOfCareHistory</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="EpisodeOfCareHistory.md" target="_blank">electronicMedicalRecords/EpisodeOfCareHistory</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="EpisodeOfCareHistory.md" target="_blank">electronicMedicalRecords/EpisodeOfCareHistory</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="EpisodeOfCareHistory.md" target="_blank">electronicMedicalRecords/EpisodeOfCareHistory</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="EpisodeOfCareHistory.md" target="_blank">electronicMedicalRecords/EpisodeOfCareHistory</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="EpisodeOfCareHistory.md" target="_blank">electronicMedicalRecords/EpisodeOfCareHistory</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="EpisodeOfCareHistory.md" target="_blank">electronicMedicalRecords/EpisodeOfCareHistory</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="EpisodeOfCareHistory.md" target="_blank">electronicMedicalRecords/EpisodeOfCareHistory</a>|
|[description](#description)|The name of the custom entity.|<a href="EpisodeOfCareHistory.md" target="_blank">electronicMedicalRecords/EpisodeOfCareHistory</a>|
|[episodeOfCareId](#episodeOfCareId)|An association between a patient and an organization / healthcare provider(s) during which time encounters may occur.|<a href="EpisodeOfCareHistory.md" target="_blank">electronicMedicalRecords/EpisodeOfCareHistory</a>|
|[episodeOfCareHistoryId](#episodeOfCareHistoryId)|Unique identifier for entity instances|<a href="EpisodeOfCareHistory.md" target="_blank">electronicMedicalRecords/EpisodeOfCareHistory</a>|
|[periodEnd](#periodEnd)|The period during this EpisodeOfCare that the specific status applied.|<a href="EpisodeOfCareHistory.md" target="_blank">electronicMedicalRecords/EpisodeOfCareHistory</a>|
|[periodStart](#periodStart)|The period during this EpisodeOfCare that the specific status applied.|<a href="EpisodeOfCareHistory.md" target="_blank">electronicMedicalRecords/EpisodeOfCareHistory</a>|
|[status](#status)|Previous status of episode.|<a href="EpisodeOfCareHistory.md" target="_blank">electronicMedicalRecords/EpisodeOfCareHistory</a>|
|[status_display](#status_display)||<a href="EpisodeOfCareHistory.md" target="_blank">electronicMedicalRecords/EpisodeOfCareHistory</a>|
|[stateCode](#stateCode)|Status of the Episode of Care History|<a href="EpisodeOfCareHistory.md" target="_blank">electronicMedicalRecords/EpisodeOfCareHistory</a>|
|[stateCode_display](#stateCode_display)||<a href="EpisodeOfCareHistory.md" target="_blank">electronicMedicalRecords/EpisodeOfCareHistory</a>|
|[statusCode](#statusCode)|Reason for the status of the Episode of Care History|<a href="EpisodeOfCareHistory.md" target="_blank">electronicMedicalRecords/EpisodeOfCareHistory</a>|
|[statusCode_display](#statusCode_display)||<a href="EpisodeOfCareHistory.md" target="_blank">electronicMedicalRecords/EpisodeOfCareHistory</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/EpisodeOfCareHistory (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Episode of Care History</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_episodeofcarehistoryid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Period End</td></tr><tr><td>description</td><td>The period during this EpisodeOfCare that the specific status applied.</td></tr><tr><td>dataFormat</td><td>13</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_periodend</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Period Start</td></tr><tr><td>description</td><td>The period during this EpisodeOfCare that the specific status applied.</td></tr><tr><td>dataFormat</td><td>13</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_periodstart</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Episode of Care History</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Episode of Care History</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
