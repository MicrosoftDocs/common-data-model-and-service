---
title: CarePlanActivityReasonReference - Common Data Model | Microsoft Docs
...
# Care Plan Activity Reason Reference

Provides the health condition(s) that drove the inclusion of this particular activity as part of the plan.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/CarePlanActivityReasonReference.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="CarePlanActivityReasonReference.md" target="_blank">electronicMedicalRecords/CarePlanActivityReasonReference</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="CarePlanActivityReasonReference.md" target="_blank">electronicMedicalRecords/CarePlanActivityReasonReference</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="CarePlanActivityReasonReference.md" target="_blank">electronicMedicalRecords/CarePlanActivityReasonReference</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="CarePlanActivityReasonReference.md" target="_blank">electronicMedicalRecords/CarePlanActivityReasonReference</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="CarePlanActivityReasonReference.md" target="_blank">electronicMedicalRecords/CarePlanActivityReasonReference</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="CarePlanActivityReasonReference.md" target="_blank">electronicMedicalRecords/CarePlanActivityReasonReference</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="CarePlanActivityReasonReference.md" target="_blank">electronicMedicalRecords/CarePlanActivityReasonReference</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="CarePlanActivityReasonReference.md" target="_blank">electronicMedicalRecords/CarePlanActivityReasonReference</a>|
|[ownerId](#ownerId)|Owner Id|<a href="CarePlanActivityReasonReference.md" target="_blank">electronicMedicalRecords/CarePlanActivityReasonReference</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="CarePlanActivityReasonReference.md" target="_blank">electronicMedicalRecords/CarePlanActivityReasonReference</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="CarePlanActivityReasonReference.md" target="_blank">electronicMedicalRecords/CarePlanActivityReasonReference</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="CarePlanActivityReasonReference.md" target="_blank">electronicMedicalRecords/CarePlanActivityReasonReference</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="CarePlanActivityReasonReference.md" target="_blank">electronicMedicalRecords/CarePlanActivityReasonReference</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="CarePlanActivityReasonReference.md" target="_blank">electronicMedicalRecords/CarePlanActivityReasonReference</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="CarePlanActivityReasonReference.md" target="_blank">electronicMedicalRecords/CarePlanActivityReasonReference</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="CarePlanActivityReasonReference.md" target="_blank">electronicMedicalRecords/CarePlanActivityReasonReference</a>|
|[activityId](#activityId)|Identifies a planned action to occur as part of the plan. For example, a medication to be used, lab tests to perform, self-monitoring, education, etc.|<a href="CarePlanActivityReasonReference.md" target="_blank">electronicMedicalRecords/CarePlanActivityReasonReference</a>|
|[carePlanActivityReasonReferenceId](#carePlanActivityReasonReferenceId)|Unique identifier for entity instances|<a href="CarePlanActivityReasonReference.md" target="_blank">electronicMedicalRecords/CarePlanActivityReasonReference</a>|
|[name](#name)|The name of the custom entity.|<a href="CarePlanActivityReasonReference.md" target="_blank">electronicMedicalRecords/CarePlanActivityReasonReference</a>|
|[planActivityReasonReferenceId](#planActivityReasonReferenceId)|Provides the health condition(s) that drove the inclusion of this particular activity as part of the plan.|<a href="CarePlanActivityReasonReference.md" target="_blank">electronicMedicalRecords/CarePlanActivityReasonReference</a>|
|[stateCode](#stateCode)|Status of the Care Plan Activity Reason Reference|<a href="CarePlanActivityReasonReference.md" target="_blank">electronicMedicalRecords/CarePlanActivityReasonReference</a>|
|[stateCode_display](#stateCode_display)||<a href="CarePlanActivityReasonReference.md" target="_blank">electronicMedicalRecords/CarePlanActivityReasonReference</a>|
|[statusCode](#statusCode)|Reason for the status of the Care Plan Activity Reason Reference|<a href="CarePlanActivityReasonReference.md" target="_blank">electronicMedicalRecords/CarePlanActivityReasonReference</a>|
|[statusCode_display](#statusCode_display)||<a href="CarePlanActivityReasonReference.md" target="_blank">electronicMedicalRecords/CarePlanActivityReasonReference</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/CarePlanActivityReasonReference (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Care Plan Activity Reason Reference</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_careplanactivityreasonreferenceid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Care Plan Activity Reason Reference</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Care Plan Activity Reason Reference</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
