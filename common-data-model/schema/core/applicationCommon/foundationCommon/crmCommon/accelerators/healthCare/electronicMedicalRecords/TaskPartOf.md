...
Task that this particular task is part of.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/TaskPartOf.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="TaskPartOf.md" target="_blank">electronicMedicalRecords/TaskPartOf</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="TaskPartOf.md" target="_blank">electronicMedicalRecords/TaskPartOf</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="TaskPartOf.md" target="_blank">electronicMedicalRecords/TaskPartOf</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="TaskPartOf.md" target="_blank">electronicMedicalRecords/TaskPartOf</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="TaskPartOf.md" target="_blank">electronicMedicalRecords/TaskPartOf</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="TaskPartOf.md" target="_blank">electronicMedicalRecords/TaskPartOf</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="TaskPartOf.md" target="_blank">electronicMedicalRecords/TaskPartOf</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="TaskPartOf.md" target="_blank">electronicMedicalRecords/TaskPartOf</a>|
|[ownerId](#ownerId)|Owner Id|<a href="TaskPartOf.md" target="_blank">electronicMedicalRecords/TaskPartOf</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="TaskPartOf.md" target="_blank">electronicMedicalRecords/TaskPartOf</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="TaskPartOf.md" target="_blank">electronicMedicalRecords/TaskPartOf</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="TaskPartOf.md" target="_blank">electronicMedicalRecords/TaskPartOf</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="TaskPartOf.md" target="_blank">electronicMedicalRecords/TaskPartOf</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="TaskPartOf.md" target="_blank">electronicMedicalRecords/TaskPartOf</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="TaskPartOf.md" target="_blank">electronicMedicalRecords/TaskPartOf</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="TaskPartOf.md" target="_blank">electronicMedicalRecords/TaskPartOf</a>|
|[name](#name)|The name of the custom entity.|<a href="TaskPartOf.md" target="_blank">electronicMedicalRecords/TaskPartOf</a>|
|[partOfId](#partOfId)|Task that this particular task is part of.|<a href="TaskPartOf.md" target="_blank">electronicMedicalRecords/TaskPartOf</a>|
|[taskId](#taskId)|Unique identifier for Task|<a href="TaskPartOf.md" target="_blank">electronicMedicalRecords/TaskPartOf</a>|
|[taskPartOfId](#taskPartOfId)|Unique identifier for entity instances|<a href="TaskPartOf.md" target="_blank">electronicMedicalRecords/TaskPartOf</a>|
|[stateCode](#stateCode)|Status of the Task Part Of|<a href="TaskPartOf.md" target="_blank">electronicMedicalRecords/TaskPartOf</a>|
|[stateCode_display](#stateCode_display)||<a href="TaskPartOf.md" target="_blank">electronicMedicalRecords/TaskPartOf</a>|
|[statusCode](#statusCode)|Reason for the status of the Task Part Of|<a href="TaskPartOf.md" target="_blank">electronicMedicalRecords/TaskPartOf</a>|
|[statusCode_display](#statusCode_display)||<a href="TaskPartOf.md" target="_blank">electronicMedicalRecords/TaskPartOf</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/TaskPartOf (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Part Of</td></tr><tr><td>description</td><td>Task that this particular task is part of.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_partof</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Task Part Of</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_taskpartofid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Task Part Of</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Task Part Of</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
