...
Links to Provenance records for past versions of this entity or fulfilling request or event resources.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/ReferralRequestRelevantHistory.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="ReferralRequestRelevantHistory.md" target="_blank">electronicMedicalRecords/ReferralRequestRelevantHistory</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="ReferralRequestRelevantHistory.md" target="_blank">electronicMedicalRecords/ReferralRequestRelevantHistory</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="ReferralRequestRelevantHistory.md" target="_blank">electronicMedicalRecords/ReferralRequestRelevantHistory</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="ReferralRequestRelevantHistory.md" target="_blank">electronicMedicalRecords/ReferralRequestRelevantHistory</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="ReferralRequestRelevantHistory.md" target="_blank">electronicMedicalRecords/ReferralRequestRelevantHistory</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="ReferralRequestRelevantHistory.md" target="_blank">electronicMedicalRecords/ReferralRequestRelevantHistory</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="ReferralRequestRelevantHistory.md" target="_blank">electronicMedicalRecords/ReferralRequestRelevantHistory</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="ReferralRequestRelevantHistory.md" target="_blank">electronicMedicalRecords/ReferralRequestRelevantHistory</a>|
|[ownerId](#ownerId)|Owner Id|<a href="ReferralRequestRelevantHistory.md" target="_blank">electronicMedicalRecords/ReferralRequestRelevantHistory</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="ReferralRequestRelevantHistory.md" target="_blank">electronicMedicalRecords/ReferralRequestRelevantHistory</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="ReferralRequestRelevantHistory.md" target="_blank">electronicMedicalRecords/ReferralRequestRelevantHistory</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="ReferralRequestRelevantHistory.md" target="_blank">electronicMedicalRecords/ReferralRequestRelevantHistory</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="ReferralRequestRelevantHistory.md" target="_blank">electronicMedicalRecords/ReferralRequestRelevantHistory</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="ReferralRequestRelevantHistory.md" target="_blank">electronicMedicalRecords/ReferralRequestRelevantHistory</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="ReferralRequestRelevantHistory.md" target="_blank">electronicMedicalRecords/ReferralRequestRelevantHistory</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="ReferralRequestRelevantHistory.md" target="_blank">electronicMedicalRecords/ReferralRequestRelevantHistory</a>|
|[name](#name)|The name of the custom entity.|<a href="ReferralRequestRelevantHistory.md" target="_blank">electronicMedicalRecords/ReferralRequestRelevantHistory</a>|
|[referralRequestId](#referralRequestId)|Unique identifier for the referral request|<a href="ReferralRequestRelevantHistory.md" target="_blank">electronicMedicalRecords/ReferralRequestRelevantHistory</a>|
|[referralRequestRelevantHistoryId](#referralRequestRelevantHistoryId)|Unique identifier for entity instances|<a href="ReferralRequestRelevantHistory.md" target="_blank">electronicMedicalRecords/ReferralRequestRelevantHistory</a>|
|[relevantHistoryId](#relevantHistoryId)|Links to Provenance records for past versions of this resource or fulfilling request or event resources that identify key state transitions or updates.|<a href="ReferralRequestRelevantHistory.md" target="_blank">electronicMedicalRecords/ReferralRequestRelevantHistory</a>|
|[stateCode](#stateCode)|Status of the Referral Request Relevant History|<a href="ReferralRequestRelevantHistory.md" target="_blank">electronicMedicalRecords/ReferralRequestRelevantHistory</a>|
|[stateCode_display](#stateCode_display)||<a href="ReferralRequestRelevantHistory.md" target="_blank">electronicMedicalRecords/ReferralRequestRelevantHistory</a>|
|[statusCode](#statusCode)|Reason for the status of the Referral Request Relevant History|<a href="ReferralRequestRelevantHistory.md" target="_blank">electronicMedicalRecords/ReferralRequestRelevantHistory</a>|
|[statusCode_display](#statusCode_display)||<a href="ReferralRequestRelevantHistory.md" target="_blank">electronicMedicalRecords/ReferralRequestRelevantHistory</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/ReferralRequestRelevantHistory (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Referral Request Relevant History</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_referralrequestrelevanthistoryid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Relevant History</td></tr><tr><td>description</td><td>Links to Provenance records for past versions of this resource or fulfilling request or event resources that identify key state transitions or updates.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_relevanthistory</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Referral Request Relevant History</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Referral Request Relevant History</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
