...
Identifies a particular constituent of interest in the product.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/MedicationIngredient.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/core/applicationCommon/foundationCommon<br>/crmCommon/accelerators/healthCare<br>/electronicMedicalRecords<br>/MedicationIngredient.cdm.json<br>/MedicationIngredient/hasAttributes<br>/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[MedicationIngredient/(resolvedAttributes)/medicationIngredientId](#medicationIngredientId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[MedicationIngredient/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Medication Ingredient</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Identifies a particular constituent of interest in the product.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_medicationingredient"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="MedicationIngredient.md" target="_blank">electronicMedicalRecords/MedicationIngredient</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="MedicationIngredient.md" target="_blank">electronicMedicalRecords/MedicationIngredient</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="MedicationIngredient.md" target="_blank">electronicMedicalRecords/MedicationIngredient</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="MedicationIngredient.md" target="_blank">electronicMedicalRecords/MedicationIngredient</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="MedicationIngredient.md" target="_blank">electronicMedicalRecords/MedicationIngredient</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="MedicationIngredient.md" target="_blank">electronicMedicalRecords/MedicationIngredient</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="MedicationIngredient.md" target="_blank">electronicMedicalRecords/MedicationIngredient</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="MedicationIngredient.md" target="_blank">electronicMedicalRecords/MedicationIngredient</a>|
|[ownerId](#ownerId)|Owner Id|<a href="MedicationIngredient.md" target="_blank">electronicMedicalRecords/MedicationIngredient</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="MedicationIngredient.md" target="_blank">electronicMedicalRecords/MedicationIngredient</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="MedicationIngredient.md" target="_blank">electronicMedicalRecords/MedicationIngredient</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="MedicationIngredient.md" target="_blank">electronicMedicalRecords/MedicationIngredient</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="MedicationIngredient.md" target="_blank">electronicMedicalRecords/MedicationIngredient</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="MedicationIngredient.md" target="_blank">electronicMedicalRecords/MedicationIngredient</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="MedicationIngredient.md" target="_blank">electronicMedicalRecords/MedicationIngredient</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="MedicationIngredient.md" target="_blank">electronicMedicalRecords/MedicationIngredient</a>|
|[amount](#amount)|Specifies how many (or how much) of the items there are in this Medication. For example, 250 mg per tablet. This is expressed as a ratio where the numerator is 250mg and the denominator is 1 tablet.|<a href="MedicationIngredient.md" target="_blank">electronicMedicalRecords/MedicationIngredient</a>|
|[ingredientItemCodeableConceptId](#ingredientItemCodeableConceptId)|The actual ingredient - either a substance (simple ingredient) or another medication.|<a href="MedicationIngredient.md" target="_blank">electronicMedicalRecords/MedicationIngredient</a>|
|[ingredientItemMedicationNewId](#ingredientItemMedicationNewId)||<a href="MedicationIngredient.md" target="_blank">electronicMedicalRecords/MedicationIngredient</a>|
|[ingredientItemSubstanceId](#ingredientItemSubstanceId)|The actual ingredient - either a substance (simple ingredient) or another medication.|<a href="MedicationIngredient.md" target="_blank">electronicMedicalRecords/MedicationIngredient</a>|
|[isActive](#isActive)|Indication of whether this ingredient affects the therapeutic action of the drug.|<a href="MedicationIngredient.md" target="_blank">electronicMedicalRecords/MedicationIngredient</a>|
|[medicationIDNewId](#medicationIDNewId)||<a href="MedicationIngredient.md" target="_blank">electronicMedicalRecords/MedicationIngredient</a>|
|[medicationIngredientId](#medicationIngredientId)|Unique identifier for entity instances|<a href="MedicationIngredient.md" target="_blank">electronicMedicalRecords/MedicationIngredient</a>|
|[name](#name)|The name of the custom entity.|<a href="MedicationIngredient.md" target="_blank">electronicMedicalRecords/MedicationIngredient</a>|
|[stateCode](#stateCode)|Status of the Medication Ingredient|<a href="MedicationIngredient.md" target="_blank">electronicMedicalRecords/MedicationIngredient</a>|
|[stateCode_display](#stateCode_display)||<a href="MedicationIngredient.md" target="_blank">electronicMedicalRecords/MedicationIngredient</a>|
|[statusCode](#statusCode)|Reason for the status of the Medication Ingredient|<a href="MedicationIngredient.md" target="_blank">electronicMedicalRecords/MedicationIngredient</a>|
|[statusCode_display](#statusCode_display)||<a href="MedicationIngredient.md" target="_blank">electronicMedicalRecords/MedicationIngredient</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/MedicationIngredient (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Amount</td></tr><tr><td>description</td><td>Specifies how many (or how much) of the items there are in this Medication. For example, 250 mg per tablet. This is expressed as a ratio where the numerator is 250mg and the denominator is 1 tablet.</td></tr><tr><td>dataFormat</td><td>7</td></tr><tr><td>maximumLength</td><td>100</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_amount</td></tr></table>
...
**is.dataFormat.array**  
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_amount"</td><td>string</td><td></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Specifies how many (or how much) of the items there are in this Medication. For example, 250 mg per tablet. This is expressed as a ratio where the numerator is 250mg and the denominator is 1 tablet.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
### <a href=#ingredientItemCodeableConceptId name="ingredientItemCodeableConceptId">ingredientItemCodeableConceptId</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Ingredient Item Code</td></tr><tr><td>description</td><td>The actual ingredient - either a substance (simple ingredient) or another medication.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_ingredientitemcodeableconcept</td></tr></table>

#### Traits

<details>
<summary>List of traits for the ingredientItemCodeableConceptId attribute are listed below.</summary>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Ingredient Item Code</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>The actual ingredient - either a substance (simple ingredient) or another medication.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_ingredientitemcodeableconcept"</td><td>string</td><td></td></tr></table>
...
### <a href=#ingredientItemMedicationNewId name="ingredientItemMedicationNewId">ingredientItemMedicationNewId</a>

First included in: electronicMedicalRecords/MedicationIngredient (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Ingredient Item (Medication)</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_ingredientitemmedicationnew</td></tr></table>

#### Traits

<details>
<summary>List of traits for the ingredientItemMedicationNewId attribute are listed below.</summary>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Ingredient Item (Medication)</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_ingredientitemmedicationnew"</td><td>string</td><td></td></tr></table>
...
### <a href=#ingredientItemSubstanceId name="ingredientItemSubstanceId">ingredientItemSubstanceId</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Ingredient Item (Substance)</td></tr><tr><td>description</td><td>The actual ingredient - either a substance (simple ingredient) or another medication.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_ingredientitemsubstance</td></tr></table>

#### Traits

<details>
<summary>List of traits for the ingredientItemSubstanceId attribute are listed below.</summary>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Ingredient Item (Substance)</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_ingredientitemsubstance"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Is Active</td></tr><tr><td>description</td><td>Indication of whether this ingredient affects the therapeutic action of the drug.</td></tr><tr><td>dataFormat</td><td>15</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_isactive</td></tr></table>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_isactive"</td><td>string</td><td></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Indication of whether this ingredient affects the therapeutic action of the drug.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
### <a href=#medicationIDNewId name="medicationIDNewId">medicationIDNewId</a>

First included in: electronicMedicalRecords/MedicationIngredient (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Medication ID</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_medicationidnew</td></tr></table>

#### Traits

<details>
<summary>List of traits for the medicationIDNewId attribute are listed below.</summary>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Medication ID</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_medicationidnew"</td><td>string</td><td></td></tr></table>
...
### <a href=#medicationIngredientId name="medicationIngredientId">medicationIngredientId</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Medication Ingredient</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_medicationingredientid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the medicationIngredientId attribute are listed below.</summary>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_medicationingredientid"</td><td>string</td><td></td></tr></table>
...
Status of the Medication Ingredient  
First included in: electronicMedicalRecords/MedicationIngredient (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Medication Ingredient</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the Medication Ingredient</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
Reason for the status of the Medication Ingredient  
First included in: electronicMedicalRecords/MedicationIngredient (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Medication Ingredient</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the Medication Ingredient</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
