---
title: DeviceRequestPriorRequest - Common Data Model | Microsoft Docs
...
# Device Request Prior Request

The request takes the place of the referenced completed or terminated request(s).  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/DeviceRequestPriorRequest.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/core/applicationCommon/foundationCommon<br>/crmCommon/accelerators/healthCare<br>/electronicMedicalRecords<br>/DeviceRequestPriorRequest.cdm.json<br>/DeviceRequestPriorRequest/hasAttributes<br>/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[DeviceRequestPriorRequest/(resolvedAttributes)/deviceRequestPriorRequestId](#deviceRequestPriorRequestId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[DeviceRequestPriorRequest/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Device Request Prior Request</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_devicerequestpriorrequest"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="DeviceRequestPriorRequest.md" target="_blank">electronicMedicalRecords/DeviceRequestPriorRequest</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="DeviceRequestPriorRequest.md" target="_blank">electronicMedicalRecords/DeviceRequestPriorRequest</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="DeviceRequestPriorRequest.md" target="_blank">electronicMedicalRecords/DeviceRequestPriorRequest</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="DeviceRequestPriorRequest.md" target="_blank">electronicMedicalRecords/DeviceRequestPriorRequest</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="DeviceRequestPriorRequest.md" target="_blank">electronicMedicalRecords/DeviceRequestPriorRequest</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="DeviceRequestPriorRequest.md" target="_blank">electronicMedicalRecords/DeviceRequestPriorRequest</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="DeviceRequestPriorRequest.md" target="_blank">electronicMedicalRecords/DeviceRequestPriorRequest</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="DeviceRequestPriorRequest.md" target="_blank">electronicMedicalRecords/DeviceRequestPriorRequest</a>|
|[ownerId](#ownerId)|Owner Id|<a href="DeviceRequestPriorRequest.md" target="_blank">electronicMedicalRecords/DeviceRequestPriorRequest</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="DeviceRequestPriorRequest.md" target="_blank">electronicMedicalRecords/DeviceRequestPriorRequest</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="DeviceRequestPriorRequest.md" target="_blank">electronicMedicalRecords/DeviceRequestPriorRequest</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="DeviceRequestPriorRequest.md" target="_blank">electronicMedicalRecords/DeviceRequestPriorRequest</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="DeviceRequestPriorRequest.md" target="_blank">electronicMedicalRecords/DeviceRequestPriorRequest</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="DeviceRequestPriorRequest.md" target="_blank">electronicMedicalRecords/DeviceRequestPriorRequest</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="DeviceRequestPriorRequest.md" target="_blank">electronicMedicalRecords/DeviceRequestPriorRequest</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="DeviceRequestPriorRequest.md" target="_blank">electronicMedicalRecords/DeviceRequestPriorRequest</a>|
|[deviceRequestId](#deviceRequestId)|Identifier for Device Request|<a href="DeviceRequestPriorRequest.md" target="_blank">electronicMedicalRecords/DeviceRequestPriorRequest</a>|
|[deviceRequestPriorRequestId](#deviceRequestPriorRequestId)|Unique identifier for entity instances|<a href="DeviceRequestPriorRequest.md" target="_blank">electronicMedicalRecords/DeviceRequestPriorRequest</a>|
|[name](#name)|The name of the custom entity.|<a href="DeviceRequestPriorRequest.md" target="_blank">electronicMedicalRecords/DeviceRequestPriorRequest</a>|
|[priorRequest](#priorRequest)|The request takes the place of the referenced completed or terminated request(s).|<a href="DeviceRequestPriorRequest.md" target="_blank">electronicMedicalRecords/DeviceRequestPriorRequest</a>|
|[stateCode](#stateCode)|Status of the Device Request Prior Request|<a href="DeviceRequestPriorRequest.md" target="_blank">electronicMedicalRecords/DeviceRequestPriorRequest</a>|
|[stateCode_display](#stateCode_display)||<a href="DeviceRequestPriorRequest.md" target="_blank">electronicMedicalRecords/DeviceRequestPriorRequest</a>|
|[statusCode](#statusCode)|Reason for the status of the Device Request Prior Request|<a href="DeviceRequestPriorRequest.md" target="_blank">electronicMedicalRecords/DeviceRequestPriorRequest</a>|
|[statusCode_display](#statusCode_display)||<a href="DeviceRequestPriorRequest.md" target="_blank">electronicMedicalRecords/DeviceRequestPriorRequest</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/DeviceRequestPriorRequest (this entity)  
...
### <a href=#deviceRequestPriorRequestId name="deviceRequestPriorRequestId">deviceRequestPriorRequestId</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Device Request Prior Request</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_devicerequestpriorrequestid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the deviceRequestPriorRequestId attribute are listed below.</summary>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_devicerequestpriorrequestid"</td><td>string</td><td></td></tr></table>
...
### <a href=#priorRequest name="priorRequest">priorRequest</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Prior Request</td></tr><tr><td>description</td><td>The request takes the place of the referenced completed or terminated request(s).</td></tr><tr><td>dataFormat</td><td>7</td></tr><tr><td>maximumLength</td><td>2000</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_priorrequest</td></tr></table>

#### Traits

<details>
<summary>List of traits for the priorRequest attribute are listed below.</summary>

**is.dataFormat.character**  
**is.dataFormat.big**  
**is.dataFormat.array**  
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_priorrequest"</td><td>string</td><td></td></tr></table>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Prior Request</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
Status of the Device Request Prior Request  
First included in: electronicMedicalRecords/DeviceRequestPriorRequest (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Device Request Prior Request</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
Reason for the status of the Device Request Prior Request  
First included in: electronicMedicalRecords/DeviceRequestPriorRequest (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Device Request Prior Request</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
