...
The set of accounts that may be used for billing for this Episode Of Care.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/EpisodeOfCareAccount.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="EpisodeOfCareAccount.md" target="_blank">electronicMedicalRecords/EpisodeOfCareAccount</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="EpisodeOfCareAccount.md" target="_blank">electronicMedicalRecords/EpisodeOfCareAccount</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="EpisodeOfCareAccount.md" target="_blank">electronicMedicalRecords/EpisodeOfCareAccount</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="EpisodeOfCareAccount.md" target="_blank">electronicMedicalRecords/EpisodeOfCareAccount</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="EpisodeOfCareAccount.md" target="_blank">electronicMedicalRecords/EpisodeOfCareAccount</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="EpisodeOfCareAccount.md" target="_blank">electronicMedicalRecords/EpisodeOfCareAccount</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="EpisodeOfCareAccount.md" target="_blank">electronicMedicalRecords/EpisodeOfCareAccount</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="EpisodeOfCareAccount.md" target="_blank">electronicMedicalRecords/EpisodeOfCareAccount</a>|
|[ownerId](#ownerId)|Owner Id|<a href="EpisodeOfCareAccount.md" target="_blank">electronicMedicalRecords/EpisodeOfCareAccount</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="EpisodeOfCareAccount.md" target="_blank">electronicMedicalRecords/EpisodeOfCareAccount</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="EpisodeOfCareAccount.md" target="_blank">electronicMedicalRecords/EpisodeOfCareAccount</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="EpisodeOfCareAccount.md" target="_blank">electronicMedicalRecords/EpisodeOfCareAccount</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="EpisodeOfCareAccount.md" target="_blank">electronicMedicalRecords/EpisodeOfCareAccount</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="EpisodeOfCareAccount.md" target="_blank">electronicMedicalRecords/EpisodeOfCareAccount</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="EpisodeOfCareAccount.md" target="_blank">electronicMedicalRecords/EpisodeOfCareAccount</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="EpisodeOfCareAccount.md" target="_blank">electronicMedicalRecords/EpisodeOfCareAccount</a>|
|[accountId](#accountId)|Account that may be used for billing for this EpisodeOfCare.|<a href="EpisodeOfCareAccount.md" target="_blank">electronicMedicalRecords/EpisodeOfCareAccount</a>|
|[episodeOfCareId](#episodeOfCareId)|An association between a patient and an organization / healthcare provider(s) during which time encounters may occur.|<a href="EpisodeOfCareAccount.md" target="_blank">electronicMedicalRecords/EpisodeOfCareAccount</a>|
|[episodeOfCareAccountId](#episodeOfCareAccountId)|Unique identifier for entity instances|<a href="EpisodeOfCareAccount.md" target="_blank">electronicMedicalRecords/EpisodeOfCareAccount</a>|
|[name](#name)|The name of the custom entity.|<a href="EpisodeOfCareAccount.md" target="_blank">electronicMedicalRecords/EpisodeOfCareAccount</a>|
|[stateCode](#stateCode)|Status of the Episode Of Care Account|<a href="EpisodeOfCareAccount.md" target="_blank">electronicMedicalRecords/EpisodeOfCareAccount</a>|
|[stateCode_display](#stateCode_display)||<a href="EpisodeOfCareAccount.md" target="_blank">electronicMedicalRecords/EpisodeOfCareAccount</a>|
|[statusCode](#statusCode)|Reason for the status of the Episode Of Care Account|<a href="EpisodeOfCareAccount.md" target="_blank">electronicMedicalRecords/EpisodeOfCareAccount</a>|
|[statusCode_display](#statusCode_display)||<a href="EpisodeOfCareAccount.md" target="_blank">electronicMedicalRecords/EpisodeOfCareAccount</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/EpisodeOfCareAccount (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Account</td></tr><tr><td>description</td><td>Account that may be used for billing for this EpisodeOfCare.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_account</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Episode Of Care Account</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_episodeofcareaccountid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Episode Of Care Account</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Episode Of Care Account</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
