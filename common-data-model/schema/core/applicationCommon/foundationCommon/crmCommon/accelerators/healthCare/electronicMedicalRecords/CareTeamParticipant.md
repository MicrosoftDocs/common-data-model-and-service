...
- **is.identifiedBy**  
  ...
  ```
  "CareTeamParticipant/hasAttributes/careTeamParticipantId"
  ```
...
- **means.entityState**  
  ...
  ```
  "CareTeamParticipant/hasAttributes/stateCode"
  ```
