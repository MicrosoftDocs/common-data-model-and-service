...
- **is.identifiedBy**  
  ...
  ```
  "CarePlanGoal/hasAttributes/carePlanGoalId"
  ```
...
- **means.entityState**  
  ...
  ```
  "CarePlanGoal/hasAttributes/stateCode"
  ```
