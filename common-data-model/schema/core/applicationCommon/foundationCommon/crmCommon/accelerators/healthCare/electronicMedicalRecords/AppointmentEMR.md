...
A booking of a healthcare event among patient(s), practitioner(s), related person(s) and/or device(s) for a specific date/time. This may result in one or more Encounter(s).  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/AppointmentEMR.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[ownerId](#ownerId)|Owner Id|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[activityAdditionalParams](#activityAdditionalParams)|Additional information provided by the external application as JSON. For internal use only.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[activityId](#activityId)|Unique identifier of the activity.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[actualDurationMinutes](#actualDurationMinutes)|Actual duration of the activity in minutes.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[actualEnd](#actualEnd)|Actual end time of the activity.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[actualStart](#actualStart)|Actual start time of the activity.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[BCC](#BCC)|Blind Carbon-copy (bcc) recipients of the activity.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[CC](#CC)|Carbon-copy (cc) recipients of the activity.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[customers](#customers)|Customer with which the activity is associated.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[deliveryLastAttemptedOn](#deliveryLastAttemptedOn)|Date and time when the delivery of the activity was last attempted.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[description](#description)|Description of the activity.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[exchangeItemID](#exchangeItemID)|The message id of activity which is returned from Exchange Server.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[exchangeWebLink](#exchangeWebLink)|Shows the web link of Activity of type email.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[from](#from)|Person who the activity is from.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[instanceTypeCode](#instanceTypeCode)|Type of instance of a recurring series.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[instanceTypeCode_display](#instanceTypeCode_display)||<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[isBilled](#isBilled)|Information regarding whether the activity was billed as part of resolving a case.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[isMapiPrivate](#isMapiPrivate)|For internal use only.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[isRegularActivity](#isRegularActivity)|Information regarding whether the activity is a regular activity type or event type.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[isWorkflowCreated](#isWorkflowCreated)|Information regarding whether the activity was created from a workflow rule.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[lastOnHoldTime](#lastOnHoldTime)|Contains the date and time stamp of the last on hold time.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[leftVoiceMail](#leftVoiceMail)|Left the voice mail|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[actorDeviceId](#actorDeviceId)|Name of the Person, Location/HealthcareService or Device.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[actorLocationId](#actorLocationId)|Name of the Person, Location/HealthcareService or Device.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[actorPatientId](#actorPatientId)|Name of the Person, Location/HealthcareService or Device.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[actorPractitionerId](#actorPractitionerId)|Name of the Person, Location/HealthcareService or Device.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[actorRelatedPersonId](#actorRelatedPersonId)|Name of the Person, Location/HealthcareService or Device.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[appointmentCreationDate](#appointmentCreationDate)|When appointment is to take place|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[appointmentStatus](#appointmentStatus)||<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[appointmentStatus_display](#appointmentStatus_display)||<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[appointmentTypeId](#appointmentTypeId)||<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[comment](#comment)|Additional comments about the appointment.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[emrdescription](#emrdescription)|The brief description of the appointment as would be shown on a subject line in a meeting request, or appointment list. Detailed or expanded information should be put in the comment field.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[endTime](#endTime)|End time of an appointment.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
...
|[participantActorType](#participantActorType)|Type of appointment participant.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[participantActorType_display](#participantActorType_display)||<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[participantStatus](#participantStatus)|The Participation status of an appointment.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[participantStatus_display](#participantStatus_display)||<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[particpantTypeId](#particpantTypeId)|Role of the participant in the appointment.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[patientInstruction](#patientInstruction)|Detailed information and instructions for the patient.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[priority](#priority)|The priority of the appointment. Can be used to make informed decisions if needing to re-prioritize appointments. (The iCal Standard specifies 0 as undefined, 1 as highest, 9 as lowest priority).|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[required](#required)|Is the Participant required to attend the appointment.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[required_display](#required_display)||<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[serviceCategoryId](#serviceCategoryId)|A broad categorization of the service that is to be performed during this appointment.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[startTime](#startTime)|Start time of an appointment.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[supportingInformation](#supportingInformation)|Additional information may be attachments to support or provide more insight for an appointment.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[onHoldTime](#onHoldTime)|Shows how long, in minutes, that the record was on hold.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[optionalAttendees](#optionalAttendees)|List of optional attendees for the activity.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[organizer](#organizer)|Person who organized the activity.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[partners](#partners)|Outsource vendor with which activity is associated.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[postponeActivityProcessingUntil](#postponeActivityProcessingUntil)|For internal use only.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[priorityCode](#priorityCode)|Priority of the activity.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[priorityCode_display](#priorityCode_display)||<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[processId](#processId)|Unique identifier of the Process.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[regardingObjectId](#regardingObjectId)|Unique identifier of the regardingobject for the item.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[type](#type)||<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[requiredAttendees](#requiredAttendees)|List of required attendees for the activity.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[resources](#resources)|Users or facility/equipment that are required for the activity.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[scheduledDurationMinutes](#scheduledDurationMinutes)|Scheduled duration of the activity, specified in minutes.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[scheduledEnd](#scheduledEnd)|Scheduled end time of the activity.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[scheduledStart](#scheduledStart)|Scheduled start time of the activity.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[senderMailboxId](#senderMailboxId)|Unique identifier of the mailbox associated with the sender of the email message.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[sentOn](#sentOn)|Date and time when the activity was sent.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[seriesId](#seriesId)|Uniqueidentifier specifying the id of recurring series of an instance.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[serviceId](#serviceId)|Unique identifier of an associated service.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[SLAId](#SLAId)|Choose the service level agreement (SLA) that you want to apply to the case record.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[SLAInvokedId](#SLAInvokedId)|Last SLA that was applied to this case. This field is for internal use only.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[sortDate](#sortDate)|Shows the date and time by which the activities are sorted.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[stageId](#stageId)|Unique identifier of the Stage.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[stateCode](#stateCode)|Status of the activity.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[stateCode_display](#stateCode_display)||<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[statusCode](#statusCode)|Reason for the status of the activity.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[statusCode_display](#statusCode_display)||<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[subject](#subject)|Subject associated with the activity.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[to](#to)|Person who is the receiver of the activity.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|
|[traversedPath](#traversedPath)|For internal use only.|<a href="AppointmentEMR.md" target="_blank">electronicMedicalRecords/AppointmentEMR</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/AppointmentEMR (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Actor (Device)</td></tr><tr><td>description</td><td>Name of the Person, Location/HealthcareService or Device.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_actordevice</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Actor (Location)</td></tr><tr><td>description</td><td>Name of the Person, Location/HealthcareService or Device.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_actorlocation</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Actor (Patient)</td></tr><tr><td>description</td><td>Name of the Person, Location/HealthcareService or Device.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_actorpatient</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Actor (Practitioner)</td></tr><tr><td>description</td><td>Name of the Person, Location/HealthcareService or Device.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_actorpractitioner</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Actor (Related Person)</td></tr><tr><td>description</td><td>Name of the Person, Location/HealthcareService or Device.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_actorrelatedperson</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Appointment Creation Date</td></tr><tr><td>description</td><td>When appointment is to take place</td></tr><tr><td>dataFormat</td><td>13</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_appointmentcreationdate</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Appointment Type</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_appointmenttype</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Comment</td></tr><tr><td>description</td><td>Additional comments about the appointment.</td></tr><tr><td>dataFormat</td><td>7</td></tr><tr><td>maximumLength</td><td>2000</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_comment</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Description</td></tr><tr><td>description</td><td>The brief description of the appointment as would be shown on a subject line in a meeting request, or appointment list. Detailed or expanded information should be put in the comment field.</td></tr><tr><td>dataFormat</td><td>7</td></tr><tr><td>maximumLength</td><td>100</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_description</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>End time</td></tr><tr><td>description</td><td>End time of an appointment.</td></tr><tr><td>dataFormat</td><td>13</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_endtime</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Participant Type</td></tr><tr><td>description</td><td>Role of the participant in the appointment.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_particpanttype</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Priority</td></tr><tr><td>description</td><td>The priority of the appointment. Can be used to make informed decisions if needing to re-prioritize appointments. (The iCal Standard specifies 0 as undefined, 1 as highest, 9 as lowest priority).</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>maximumValue</td><td>10</td></tr><tr><td>minimumValue</td><td>0</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_priority</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Start time</td></tr><tr><td>description</td><td>Start time of an appointment.</td></tr><tr><td>dataFormat</td><td>13</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_starttime</td></tr></table>
...
Unique identifier of the regardingobject for the item.  
First included in: electronicMedicalRecords/AppointmentEMR (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Regarding</td></tr><tr><td>description</td><td>Unique identifier of the regardingobject for the item.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>regardingobjectid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Appointment (EMR) Start</td></tr><tr><td>description</td><td>Scheduled start time of the activity.</td></tr><tr><td>dataFormat</td><td>13</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>scheduledstart</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Subject</td></tr><tr><td>description</td><td>Subject associated with the activity.</td></tr><tr><td>dataFormat</td><td>7</td></tr><tr><td>maximumLength</td><td>200</td></tr><tr><td>sourceName</td><td>subject</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>To</td></tr><tr><td>description</td><td>Person who is the receiver of the activity.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>to</td></tr></table>
