...
Indicates specific responsibility of an individual within the care team, such as "Primary care physician", "Trained social worker counselor", "Caregiver", etc.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/CareTeamParticipantRole.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="CareTeamParticipantRole.md" target="_blank">electronicMedicalRecords/CareTeamParticipantRole</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="CareTeamParticipantRole.md" target="_blank">electronicMedicalRecords/CareTeamParticipantRole</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="CareTeamParticipantRole.md" target="_blank">electronicMedicalRecords/CareTeamParticipantRole</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="CareTeamParticipantRole.md" target="_blank">electronicMedicalRecords/CareTeamParticipantRole</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="CareTeamParticipantRole.md" target="_blank">electronicMedicalRecords/CareTeamParticipantRole</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="CareTeamParticipantRole.md" target="_blank">electronicMedicalRecords/CareTeamParticipantRole</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="CareTeamParticipantRole.md" target="_blank">electronicMedicalRecords/CareTeamParticipantRole</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="CareTeamParticipantRole.md" target="_blank">electronicMedicalRecords/CareTeamParticipantRole</a>|
|[ownerId](#ownerId)|Owner Id|<a href="CareTeamParticipantRole.md" target="_blank">electronicMedicalRecords/CareTeamParticipantRole</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="CareTeamParticipantRole.md" target="_blank">electronicMedicalRecords/CareTeamParticipantRole</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="CareTeamParticipantRole.md" target="_blank">electronicMedicalRecords/CareTeamParticipantRole</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="CareTeamParticipantRole.md" target="_blank">electronicMedicalRecords/CareTeamParticipantRole</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="CareTeamParticipantRole.md" target="_blank">electronicMedicalRecords/CareTeamParticipantRole</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="CareTeamParticipantRole.md" target="_blank">electronicMedicalRecords/CareTeamParticipantRole</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="CareTeamParticipantRole.md" target="_blank">electronicMedicalRecords/CareTeamParticipantRole</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="CareTeamParticipantRole.md" target="_blank">electronicMedicalRecords/CareTeamParticipantRole</a>|
|[careTeamParticipantRoleId](#careTeamParticipantRoleId)|Unique identifier for entity instances|<a href="CareTeamParticipantRole.md" target="_blank">electronicMedicalRecords/CareTeamParticipantRole</a>|
|[code](#code)||<a href="CareTeamParticipantRole.md" target="_blank">electronicMedicalRecords/CareTeamParticipantRole</a>|
|[display](#display)|The name of the custom entity.|<a href="CareTeamParticipantRole.md" target="_blank">electronicMedicalRecords/CareTeamParticipantRole</a>|
|[system](#system)||<a href="CareTeamParticipantRole.md" target="_blank">electronicMedicalRecords/CareTeamParticipantRole</a>|
|[stateCode](#stateCode)|Status of the Care Team Participant Role|<a href="CareTeamParticipantRole.md" target="_blank">electronicMedicalRecords/CareTeamParticipantRole</a>|
|[stateCode_display](#stateCode_display)||<a href="CareTeamParticipantRole.md" target="_blank">electronicMedicalRecords/CareTeamParticipantRole</a>|
|[statusCode](#statusCode)|Reason for the status of the Care Team Participant Role|<a href="CareTeamParticipantRole.md" target="_blank">electronicMedicalRecords/CareTeamParticipantRole</a>|
|[statusCode_display](#statusCode_display)||<a href="CareTeamParticipantRole.md" target="_blank">electronicMedicalRecords/CareTeamParticipantRole</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/CareTeamParticipantRole (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Care Team Participant Role</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_careteamparticipantroleid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Care Team Participant Role</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Care Team Participant Role</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
