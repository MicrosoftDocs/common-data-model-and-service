---
title: ObservationComponentReferenceRange - Common Data Model | Microsoft Docs
...
Guidance on how to interpret the value by comparison to a normal or recommended range.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/ObservationComponentReferenceRange.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="ObservationComponentReferenceRange.md" target="_blank">electronicMedicalRecords/ObservationComponentReferenceRange</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="ObservationComponentReferenceRange.md" target="_blank">electronicMedicalRecords/ObservationComponentReferenceRange</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="ObservationComponentReferenceRange.md" target="_blank">electronicMedicalRecords/ObservationComponentReferenceRange</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="ObservationComponentReferenceRange.md" target="_blank">electronicMedicalRecords/ObservationComponentReferenceRange</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="ObservationComponentReferenceRange.md" target="_blank">electronicMedicalRecords/ObservationComponentReferenceRange</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="ObservationComponentReferenceRange.md" target="_blank">electronicMedicalRecords/ObservationComponentReferenceRange</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="ObservationComponentReferenceRange.md" target="_blank">electronicMedicalRecords/ObservationComponentReferenceRange</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="ObservationComponentReferenceRange.md" target="_blank">electronicMedicalRecords/ObservationComponentReferenceRange</a>|
|[ownerId](#ownerId)|Owner Id|<a href="ObservationComponentReferenceRange.md" target="_blank">electronicMedicalRecords/ObservationComponentReferenceRange</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="ObservationComponentReferenceRange.md" target="_blank">electronicMedicalRecords/ObservationComponentReferenceRange</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="ObservationComponentReferenceRange.md" target="_blank">electronicMedicalRecords/ObservationComponentReferenceRange</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="ObservationComponentReferenceRange.md" target="_blank">electronicMedicalRecords/ObservationComponentReferenceRange</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="ObservationComponentReferenceRange.md" target="_blank">electronicMedicalRecords/ObservationComponentReferenceRange</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="ObservationComponentReferenceRange.md" target="_blank">electronicMedicalRecords/ObservationComponentReferenceRange</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="ObservationComponentReferenceRange.md" target="_blank">electronicMedicalRecords/ObservationComponentReferenceRange</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="ObservationComponentReferenceRange.md" target="_blank">electronicMedicalRecords/ObservationComponentReferenceRange</a>|
|[name](#name)|The name of the custom entity.|<a href="ObservationComponentReferenceRange.md" target="_blank">electronicMedicalRecords/ObservationComponentReferenceRange</a>|
|[observationComponentId](#observationComponentId)|Business Identifier for observation component|<a href="ObservationComponentReferenceRange.md" target="_blank">electronicMedicalRecords/ObservationComponentReferenceRange</a>|
|[observationcompreferencerangeId](#observationcompreferencerangeId)|Unique identifier for entity instances|<a href="ObservationComponentReferenceRange.md" target="_blank">electronicMedicalRecords/ObservationComponentReferenceRange</a>|
|[observationReferenceRangeId](#observationReferenceRangeId)|Guidance on how to interpret the value by comparison to a normal or recommended range.|<a href="ObservationComponentReferenceRange.md" target="_blank">electronicMedicalRecords/ObservationComponentReferenceRange</a>|
|[stateCode](#stateCode)|Status of the Observation Component Reference Range|<a href="ObservationComponentReferenceRange.md" target="_blank">electronicMedicalRecords/ObservationComponentReferenceRange</a>|
|[stateCode_display](#stateCode_display)||<a href="ObservationComponentReferenceRange.md" target="_blank">electronicMedicalRecords/ObservationComponentReferenceRange</a>|
|[statusCode](#statusCode)|Reason for the status of the Observation Component Reference Range|<a href="ObservationComponentReferenceRange.md" target="_blank">electronicMedicalRecords/ObservationComponentReferenceRange</a>|
|[statusCode_display](#statusCode_display)||<a href="ObservationComponentReferenceRange.md" target="_blank">electronicMedicalRecords/ObservationComponentReferenceRange</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/ObservationComponentReferenceRange (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Component</td></tr><tr><td>description</td><td>Business Identifier for observation component</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_observationcomponent</td></tr></table>
...
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="ObservationComponent.md" target="_blank">/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/ObservationComponent.cdm.json/ObservationComponent</a></td><td><a href="ObservationComponent.md#observationComponentId" target="_blank">observationComponentId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Observation Component Reference Range</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_observationcompreferencerangeid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Observation Component Reference Range</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Observation Component Reference Range</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
