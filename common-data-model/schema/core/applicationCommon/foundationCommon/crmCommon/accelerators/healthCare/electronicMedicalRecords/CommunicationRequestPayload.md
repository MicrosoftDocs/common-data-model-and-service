---
title: CommunicationRequestPayload - Common Data Model | Microsoft Docs
...
# Communication Request Payload

Text, attachment(s), or resource(s) to be communicated to the recipient.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/CommunicationRequestPayload.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="CommunicationRequestPayload.md" target="_blank">electronicMedicalRecords/CommunicationRequestPayload</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="CommunicationRequestPayload.md" target="_blank">electronicMedicalRecords/CommunicationRequestPayload</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="CommunicationRequestPayload.md" target="_blank">electronicMedicalRecords/CommunicationRequestPayload</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="CommunicationRequestPayload.md" target="_blank">electronicMedicalRecords/CommunicationRequestPayload</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="CommunicationRequestPayload.md" target="_blank">electronicMedicalRecords/CommunicationRequestPayload</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="CommunicationRequestPayload.md" target="_blank">electronicMedicalRecords/CommunicationRequestPayload</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="CommunicationRequestPayload.md" target="_blank">electronicMedicalRecords/CommunicationRequestPayload</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="CommunicationRequestPayload.md" target="_blank">electronicMedicalRecords/CommunicationRequestPayload</a>|
|[ownerId](#ownerId)|Owner Id|<a href="CommunicationRequestPayload.md" target="_blank">electronicMedicalRecords/CommunicationRequestPayload</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="CommunicationRequestPayload.md" target="_blank">electronicMedicalRecords/CommunicationRequestPayload</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="CommunicationRequestPayload.md" target="_blank">electronicMedicalRecords/CommunicationRequestPayload</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="CommunicationRequestPayload.md" target="_blank">electronicMedicalRecords/CommunicationRequestPayload</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="CommunicationRequestPayload.md" target="_blank">electronicMedicalRecords/CommunicationRequestPayload</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="CommunicationRequestPayload.md" target="_blank">electronicMedicalRecords/CommunicationRequestPayload</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="CommunicationRequestPayload.md" target="_blank">electronicMedicalRecords/CommunicationRequestPayload</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="CommunicationRequestPayload.md" target="_blank">electronicMedicalRecords/CommunicationRequestPayload</a>|
|[communicationRequestId](#communicationRequestId)|A request for information to be sent to a receiver.|<a href="CommunicationRequestPayload.md" target="_blank">electronicMedicalRecords/CommunicationRequestPayload</a>|
|[communicationRequestPayloadId](#communicationRequestPayloadId)|Unique identifier for entity instances|<a href="CommunicationRequestPayload.md" target="_blank">electronicMedicalRecords/CommunicationRequestPayload</a>|
|[name](#name)|The name of the custom entity.|<a href="CommunicationRequestPayload.md" target="_blank">electronicMedicalRecords/CommunicationRequestPayload</a>|
|[payloadContentReference](#payloadContentReference)|Text, attachment(s), or resource(s) to be communicated to the recipient.|<a href="CommunicationRequestPayload.md" target="_blank">electronicMedicalRecords/CommunicationRequestPayload</a>|
|[payloadContentString](#payloadContentString)|Text, attachment(s), or resource(s) to be communicated to the recipient.|<a href="CommunicationRequestPayload.md" target="_blank">electronicMedicalRecords/CommunicationRequestPayload</a>|
|[stateCode](#stateCode)|Status of the Communication Request Payload|<a href="CommunicationRequestPayload.md" target="_blank">electronicMedicalRecords/CommunicationRequestPayload</a>|
|[stateCode_display](#stateCode_display)||<a href="CommunicationRequestPayload.md" target="_blank">electronicMedicalRecords/CommunicationRequestPayload</a>|
|[statusCode](#statusCode)|Reason for the status of the Communication Request Payload|<a href="CommunicationRequestPayload.md" target="_blank">electronicMedicalRecords/CommunicationRequestPayload</a>|
|[statusCode_display](#statusCode_display)||<a href="CommunicationRequestPayload.md" target="_blank">electronicMedicalRecords/CommunicationRequestPayload</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/CommunicationRequestPayload (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Communication Request Payload</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_communicationrequestpayloadid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Payload Content Reference</td></tr><tr><td>description</td><td>Text, attachment(s), or resource(s) to be communicated to the recipient.</td></tr><tr><td>dataFormat</td><td>7</td></tr><tr><td>maximumLength</td><td>2000</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_payloadcontentreference</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Communication Request Payload</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Communication Request Payload</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
