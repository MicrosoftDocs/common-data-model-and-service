---
title: PractitionerRoleEndPoint - Common Data Model | Microsoft Docs
...
# Practitioner Role End Point

Technical endpoints providing access to services operated for the practitioner with this role.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/PractitionerRoleEndPoint.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/core/applicationCommon/foundationCommon<br>/crmCommon/accelerators/healthCare<br>/electronicMedicalRecords<br>/PractitionerRoleEndPoint.cdm.json<br>/PractitionerRoleEndPoint/hasAttributes<br>/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[PractitionerRoleEndPoint/(resolvedAttributes)/practitionerRoleEndPointId](#practitionerRoleEndPointId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[PractitionerRoleEndPoint/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Practitioner Role End Point</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Technical endpoints providing access to services operated for the practitioner with this role.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_practitionerroleendpoint"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="PractitionerRoleEndPoint.md" target="_blank">electronicMedicalRecords/PractitionerRoleEndPoint</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="PractitionerRoleEndPoint.md" target="_blank">electronicMedicalRecords/PractitionerRoleEndPoint</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="PractitionerRoleEndPoint.md" target="_blank">electronicMedicalRecords/PractitionerRoleEndPoint</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="PractitionerRoleEndPoint.md" target="_blank">electronicMedicalRecords/PractitionerRoleEndPoint</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="PractitionerRoleEndPoint.md" target="_blank">electronicMedicalRecords/PractitionerRoleEndPoint</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="PractitionerRoleEndPoint.md" target="_blank">electronicMedicalRecords/PractitionerRoleEndPoint</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="PractitionerRoleEndPoint.md" target="_blank">electronicMedicalRecords/PractitionerRoleEndPoint</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="PractitionerRoleEndPoint.md" target="_blank">electronicMedicalRecords/PractitionerRoleEndPoint</a>|
|[ownerId](#ownerId)|Owner Id|<a href="PractitionerRoleEndPoint.md" target="_blank">electronicMedicalRecords/PractitionerRoleEndPoint</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="PractitionerRoleEndPoint.md" target="_blank">electronicMedicalRecords/PractitionerRoleEndPoint</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="PractitionerRoleEndPoint.md" target="_blank">electronicMedicalRecords/PractitionerRoleEndPoint</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="PractitionerRoleEndPoint.md" target="_blank">electronicMedicalRecords/PractitionerRoleEndPoint</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="PractitionerRoleEndPoint.md" target="_blank">electronicMedicalRecords/PractitionerRoleEndPoint</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="PractitionerRoleEndPoint.md" target="_blank">electronicMedicalRecords/PractitionerRoleEndPoint</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="PractitionerRoleEndPoint.md" target="_blank">electronicMedicalRecords/PractitionerRoleEndPoint</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="PractitionerRoleEndPoint.md" target="_blank">electronicMedicalRecords/PractitionerRoleEndPoint</a>|
|[endPointId](#endPointId)|The closing time of day. Note: If the AllDay flag is set, then this time is ignored|<a href="PractitionerRoleEndPoint.md" target="_blank">electronicMedicalRecords/PractitionerRoleEndPoint</a>|
|[name](#name)|The name of the custom entity.|<a href="PractitionerRoleEndPoint.md" target="_blank">electronicMedicalRecords/PractitionerRoleEndPoint</a>|
|[practitionerRoleId](#practitionerRoleId)|Unique identifier for Practitioner Role|<a href="PractitionerRoleEndPoint.md" target="_blank">electronicMedicalRecords/PractitionerRoleEndPoint</a>|
|[practitionerRoleEndPointId](#practitionerRoleEndPointId)|Unique identifier for entity instances|<a href="PractitionerRoleEndPoint.md" target="_blank">electronicMedicalRecords/PractitionerRoleEndPoint</a>|
|[stateCode](#stateCode)|Status of the Practitioner Role End Point|<a href="PractitionerRoleEndPoint.md" target="_blank">electronicMedicalRecords/PractitionerRoleEndPoint</a>|
|[stateCode_display](#stateCode_display)||<a href="PractitionerRoleEndPoint.md" target="_blank">electronicMedicalRecords/PractitionerRoleEndPoint</a>|
|[statusCode](#statusCode)|Reason for the status of the Practitioner Role End Point|<a href="PractitionerRoleEndPoint.md" target="_blank">electronicMedicalRecords/PractitionerRoleEndPoint</a>|
|[statusCode_display](#statusCode_display)||<a href="PractitionerRoleEndPoint.md" target="_blank">electronicMedicalRecords/PractitionerRoleEndPoint</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/PractitionerRoleEndPoint (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>End Point</td></tr><tr><td>description</td><td>The closing time of day. Note: If the AllDay flag is set, then this time is ignored</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_endpoint</td></tr></table>
...
### <a href=#practitionerRoleEndPointId name="practitionerRoleEndPointId">practitionerRoleEndPointId</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Practitioner Role End Point</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_practitionerroleendpointid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the practitionerRoleEndPointId attribute are listed below.</summary>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_practitionerroleendpointid"</td><td>string</td><td></td></tr></table>
...
Status of the Practitioner Role End Point  
First included in: electronicMedicalRecords/PractitionerRoleEndPoint (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Practitioner Role End Point</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the Practitioner Role End Point</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
Reason for the status of the Practitioner Role End Point  
First included in: electronicMedicalRecords/PractitionerRoleEndPoint (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Practitioner Role End Point</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the Practitioner Role End Point</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
