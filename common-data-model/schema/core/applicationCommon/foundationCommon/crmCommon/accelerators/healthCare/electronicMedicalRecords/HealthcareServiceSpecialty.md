...
Collection of specialties handled by the service site.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/HealthcareServiceSpecialty.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/applicationCommon/foundationCommon<br>/crmCommon/accelerators/healthCare<br>/electronicMedicalRecords<br>/HealthcareServiceSpecialty.cdm.json<br>/HealthcareServiceSpecialty/hasAttributes<br>/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>
...
|---|---|---|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="HealthcareServiceSpecialty.md" target="_blank">electronicMedicalRecords/HealthcareServiceSpecialty</a>|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="HealthcareServiceSpecialty.md" target="_blank">electronicMedicalRecords/HealthcareServiceSpecialty</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="HealthcareServiceSpecialty.md" target="_blank">electronicMedicalRecords/HealthcareServiceSpecialty</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="HealthcareServiceSpecialty.md" target="_blank">electronicMedicalRecords/HealthcareServiceSpecialty</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="HealthcareServiceSpecialty.md" target="_blank">electronicMedicalRecords/HealthcareServiceSpecialty</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="HealthcareServiceSpecialty.md" target="_blank">electronicMedicalRecords/HealthcareServiceSpecialty</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="HealthcareServiceSpecialty.md" target="_blank">electronicMedicalRecords/HealthcareServiceSpecialty</a>|
|[healthcareServiceId](#healthcareServiceId)|Unique identifier for Healthcare Service|<a href="HealthcareServiceSpecialty.md" target="_blank">electronicMedicalRecords/HealthcareServiceSpecialty</a>|
|[healthcareServiceSpecialtyId](#healthcareServiceSpecialtyId)|Unique identifier for entity instances|<a href="HealthcareServiceSpecialty.md" target="_blank">electronicMedicalRecords/HealthcareServiceSpecialty</a>|
|[name](#name)|The name of the custom entity.|<a href="HealthcareServiceSpecialty.md" target="_blank">electronicMedicalRecords/HealthcareServiceSpecialty</a>|
|[specialtyId](#specialtyId)|Collection of specialties handled by the service site. This is more of a medical term.|<a href="HealthcareServiceSpecialty.md" target="_blank">electronicMedicalRecords/HealthcareServiceSpecialty</a>|
|[organizationId](#organizationId)|Unique identifier for the organization|<a href="HealthcareServiceSpecialty.md" target="_blank">electronicMedicalRecords/HealthcareServiceSpecialty</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="HealthcareServiceSpecialty.md" target="_blank">electronicMedicalRecords/HealthcareServiceSpecialty</a>|
|[stateCode](#stateCode)|Status of the Healthcare Service Specialty|<a href="HealthcareServiceSpecialty.md" target="_blank">electronicMedicalRecords/HealthcareServiceSpecialty</a>|
|[stateCode_display](#stateCode_display)||<a href="HealthcareServiceSpecialty.md" target="_blank">electronicMedicalRecords/HealthcareServiceSpecialty</a>|
|[statusCode](#statusCode)|Reason for the status of the Healthcare Service Specialty|<a href="HealthcareServiceSpecialty.md" target="_blank">electronicMedicalRecords/HealthcareServiceSpecialty</a>|
|[statusCode_display](#statusCode_display)||<a href="HealthcareServiceSpecialty.md" target="_blank">electronicMedicalRecords/HealthcareServiceSpecialty</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="HealthcareServiceSpecialty.md" target="_blank">electronicMedicalRecords/HealthcareServiceSpecialty</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="HealthcareServiceSpecialty.md" target="_blank">electronicMedicalRecords/HealthcareServiceSpecialty</a>|

### <a href=#createdBy name="createdBy">createdBy</a>

Unique identifier of the user who created the record.  
First included in: electronicMedicalRecords/HealthcareServiceSpecialty (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Healthcare Service Specialty</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_healthcareservicespecialtyid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Specialty</td></tr><tr><td>description</td><td>Collection of specialties handled by the service site. This is more of a medical term.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_specialty</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Healthcare Service Specialty</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Healthcare Service Specialty</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
