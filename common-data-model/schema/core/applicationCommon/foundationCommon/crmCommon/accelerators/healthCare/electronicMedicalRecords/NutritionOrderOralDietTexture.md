---
title: NutritionOrderOralDietTexture - Common Data Model | Microsoft Docs
...
# Nutrition Order Oral Diet Texture

Class that describes any texture modifications required for the patient to safely consume various types of solid foods.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/NutritionOrderOralDietTexture.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="NutritionOrderOralDietTexture.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietTexture</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="NutritionOrderOralDietTexture.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietTexture</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="NutritionOrderOralDietTexture.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietTexture</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="NutritionOrderOralDietTexture.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietTexture</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="NutritionOrderOralDietTexture.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietTexture</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="NutritionOrderOralDietTexture.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietTexture</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="NutritionOrderOralDietTexture.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietTexture</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="NutritionOrderOralDietTexture.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietTexture</a>|
|[ownerId](#ownerId)|Owner Id|<a href="NutritionOrderOralDietTexture.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietTexture</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="NutritionOrderOralDietTexture.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietTexture</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="NutritionOrderOralDietTexture.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietTexture</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="NutritionOrderOralDietTexture.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietTexture</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="NutritionOrderOralDietTexture.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietTexture</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="NutritionOrderOralDietTexture.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietTexture</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="NutritionOrderOralDietTexture.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietTexture</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="NutritionOrderOralDietTexture.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietTexture</a>|
|[name](#name)|The name of the custom entity.|<a href="NutritionOrderOralDietTexture.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietTexture</a>|
|[nutritionOrderId](#nutritionOrderId)|Unique ID for Nutrition Order|<a href="NutritionOrderOralDietTexture.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietTexture</a>|
|[nutritionOrderOralDietTextureId](#nutritionOrderOralDietTextureId)|Unique identifier for entity instances|<a href="NutritionOrderOralDietTexture.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietTexture</a>|
|[oralDietTextureFoodTypeId](#oralDietTextureFoodTypeId)|The food type(s) (e.g. meats, all foods) that the texture modification applies to. This could be all foods types.|<a href="NutritionOrderOralDietTexture.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietTexture</a>|
|[oralDietTextureModifierId](#oralDietTextureModifierId)|Any texture modifications (for solid foods) that should be made, e.g. easy to chew, chopped, ground, and pureed.|<a href="NutritionOrderOralDietTexture.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietTexture</a>|
|[stateCode](#stateCode)|Status of the Nutrition Order Oral Diet Texture|<a href="NutritionOrderOralDietTexture.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietTexture</a>|
|[stateCode_display](#stateCode_display)||<a href="NutritionOrderOralDietTexture.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietTexture</a>|
|[statusCode](#statusCode)|Reason for the status of the Nutrition Order Oral Diet Texture|<a href="NutritionOrderOralDietTexture.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietTexture</a>|
|[statusCode_display](#statusCode_display)||<a href="NutritionOrderOralDietTexture.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietTexture</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/NutritionOrderOralDietTexture (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Nutrition Order Oral Diet Texture</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_nutritionorderoraldiettextureid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Nutrition Order Oral Diet Texture</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Nutrition Order Oral Diet Texture</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
