...
The specific service that is to be performed during this appointment.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/ScheduleServiceType.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="ScheduleServiceType.md" target="_blank">electronicMedicalRecords/ScheduleServiceType</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="ScheduleServiceType.md" target="_blank">electronicMedicalRecords/ScheduleServiceType</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="ScheduleServiceType.md" target="_blank">electronicMedicalRecords/ScheduleServiceType</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="ScheduleServiceType.md" target="_blank">electronicMedicalRecords/ScheduleServiceType</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="ScheduleServiceType.md" target="_blank">electronicMedicalRecords/ScheduleServiceType</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="ScheduleServiceType.md" target="_blank">electronicMedicalRecords/ScheduleServiceType</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="ScheduleServiceType.md" target="_blank">electronicMedicalRecords/ScheduleServiceType</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="ScheduleServiceType.md" target="_blank">electronicMedicalRecords/ScheduleServiceType</a>|
|[ownerId](#ownerId)|Owner Id|<a href="ScheduleServiceType.md" target="_blank">electronicMedicalRecords/ScheduleServiceType</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="ScheduleServiceType.md" target="_blank">electronicMedicalRecords/ScheduleServiceType</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="ScheduleServiceType.md" target="_blank">electronicMedicalRecords/ScheduleServiceType</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="ScheduleServiceType.md" target="_blank">electronicMedicalRecords/ScheduleServiceType</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="ScheduleServiceType.md" target="_blank">electronicMedicalRecords/ScheduleServiceType</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="ScheduleServiceType.md" target="_blank">electronicMedicalRecords/ScheduleServiceType</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="ScheduleServiceType.md" target="_blank">electronicMedicalRecords/ScheduleServiceType</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="ScheduleServiceType.md" target="_blank">electronicMedicalRecords/ScheduleServiceType</a>|
|[name](#name)|The name of the custom entity.|<a href="ScheduleServiceType.md" target="_blank">electronicMedicalRecords/ScheduleServiceType</a>|
|[scheduleId](#scheduleId)|A container for slots of time that may be available for booking appointments.|<a href="ScheduleServiceType.md" target="_blank">electronicMedicalRecords/ScheduleServiceType</a>|
|[scheduleServiceTypeId](#scheduleServiceTypeId)|Unique identifier for entity instances|<a href="ScheduleServiceType.md" target="_blank">electronicMedicalRecords/ScheduleServiceType</a>|
|[serviceTypeNewId](#serviceTypeNewId)||<a href="ScheduleServiceType.md" target="_blank">electronicMedicalRecords/ScheduleServiceType</a>|
|[stateCode](#stateCode)|Status of the Schedule Service Type|<a href="ScheduleServiceType.md" target="_blank">electronicMedicalRecords/ScheduleServiceType</a>|
|[stateCode_display](#stateCode_display)||<a href="ScheduleServiceType.md" target="_blank">electronicMedicalRecords/ScheduleServiceType</a>|
|[statusCode](#statusCode)|Reason for the status of the Schedule Service Type|<a href="ScheduleServiceType.md" target="_blank">electronicMedicalRecords/ScheduleServiceType</a>|
|[statusCode_display](#statusCode_display)||<a href="ScheduleServiceType.md" target="_blank">electronicMedicalRecords/ScheduleServiceType</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/ScheduleServiceType (this entity)  
