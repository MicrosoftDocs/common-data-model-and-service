...
An explanation or justification for why this diagnostic investigation is being requested in coded or textual form. This is often for billing purposes. May relate to the resources referred to in supp  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/ProcedureRequestReasonCode.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="ProcedureRequestReasonCode.md" target="_blank">electronicMedicalRecords/ProcedureRequestReasonCode</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="ProcedureRequestReasonCode.md" target="_blank">electronicMedicalRecords/ProcedureRequestReasonCode</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="ProcedureRequestReasonCode.md" target="_blank">electronicMedicalRecords/ProcedureRequestReasonCode</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="ProcedureRequestReasonCode.md" target="_blank">electronicMedicalRecords/ProcedureRequestReasonCode</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="ProcedureRequestReasonCode.md" target="_blank">electronicMedicalRecords/ProcedureRequestReasonCode</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="ProcedureRequestReasonCode.md" target="_blank">electronicMedicalRecords/ProcedureRequestReasonCode</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="ProcedureRequestReasonCode.md" target="_blank">electronicMedicalRecords/ProcedureRequestReasonCode</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="ProcedureRequestReasonCode.md" target="_blank">electronicMedicalRecords/ProcedureRequestReasonCode</a>|
|[ownerId](#ownerId)|Owner Id|<a href="ProcedureRequestReasonCode.md" target="_blank">electronicMedicalRecords/ProcedureRequestReasonCode</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="ProcedureRequestReasonCode.md" target="_blank">electronicMedicalRecords/ProcedureRequestReasonCode</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="ProcedureRequestReasonCode.md" target="_blank">electronicMedicalRecords/ProcedureRequestReasonCode</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="ProcedureRequestReasonCode.md" target="_blank">electronicMedicalRecords/ProcedureRequestReasonCode</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="ProcedureRequestReasonCode.md" target="_blank">electronicMedicalRecords/ProcedureRequestReasonCode</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="ProcedureRequestReasonCode.md" target="_blank">electronicMedicalRecords/ProcedureRequestReasonCode</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="ProcedureRequestReasonCode.md" target="_blank">electronicMedicalRecords/ProcedureRequestReasonCode</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="ProcedureRequestReasonCode.md" target="_blank">electronicMedicalRecords/ProcedureRequestReasonCode</a>|
|[name](#name)|The name of the custom entity.|<a href="ProcedureRequestReasonCode.md" target="_blank">electronicMedicalRecords/ProcedureRequestReasonCode</a>|
|[procedureRequestId](#procedureRequestId)|Unique identifier for the Procedure Request.|<a href="ProcedureRequestReasonCode.md" target="_blank">electronicMedicalRecords/ProcedureRequestReasonCode</a>|
|[procedureRequestReasonCodeId](#procedureRequestReasonCodeId)|Unique identifier for entity instances|<a href="ProcedureRequestReasonCode.md" target="_blank">electronicMedicalRecords/ProcedureRequestReasonCode</a>|
|[reasonCodeId](#reasonCodeId)|An explanation or justification for why this diagnostic investigation is being requested in coded or textual form. This is often for billing purposes.|<a href="ProcedureRequestReasonCode.md" target="_blank">electronicMedicalRecords/ProcedureRequestReasonCode</a>|
|[stateCode](#stateCode)|Status of the Procedure Request Reason Code|<a href="ProcedureRequestReasonCode.md" target="_blank">electronicMedicalRecords/ProcedureRequestReasonCode</a>|
|[stateCode_display](#stateCode_display)||<a href="ProcedureRequestReasonCode.md" target="_blank">electronicMedicalRecords/ProcedureRequestReasonCode</a>|
|[statusCode](#statusCode)|Reason for the status of the Procedure Request Reason Code|<a href="ProcedureRequestReasonCode.md" target="_blank">electronicMedicalRecords/ProcedureRequestReasonCode</a>|
|[statusCode_display](#statusCode_display)||<a href="ProcedureRequestReasonCode.md" target="_blank">electronicMedicalRecords/ProcedureRequestReasonCode</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/ProcedureRequestReasonCode (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Procedure Request Reason Code</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_procedurerequestreasoncodeid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Procedure Request Reason Code</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Procedure Request Reason Code</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
