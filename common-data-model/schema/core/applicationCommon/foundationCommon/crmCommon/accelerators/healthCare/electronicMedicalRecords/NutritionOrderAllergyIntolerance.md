---
title: NutritionOrderAllergyIntolerance - Common Data Model | Microsoft Docs
...
# Nutrition Order Allergy Intolerance

A link to a record of allergies or intolerance which should be included in the nutrition order.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/NutritionOrderAllergyIntolerance.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="NutritionOrderAllergyIntolerance.md" target="_blank">electronicMedicalRecords/NutritionOrderAllergyIntolerance</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="NutritionOrderAllergyIntolerance.md" target="_blank">electronicMedicalRecords/NutritionOrderAllergyIntolerance</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="NutritionOrderAllergyIntolerance.md" target="_blank">electronicMedicalRecords/NutritionOrderAllergyIntolerance</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="NutritionOrderAllergyIntolerance.md" target="_blank">electronicMedicalRecords/NutritionOrderAllergyIntolerance</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="NutritionOrderAllergyIntolerance.md" target="_blank">electronicMedicalRecords/NutritionOrderAllergyIntolerance</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="NutritionOrderAllergyIntolerance.md" target="_blank">electronicMedicalRecords/NutritionOrderAllergyIntolerance</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="NutritionOrderAllergyIntolerance.md" target="_blank">electronicMedicalRecords/NutritionOrderAllergyIntolerance</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="NutritionOrderAllergyIntolerance.md" target="_blank">electronicMedicalRecords/NutritionOrderAllergyIntolerance</a>|
|[ownerId](#ownerId)|Owner Id|<a href="NutritionOrderAllergyIntolerance.md" target="_blank">electronicMedicalRecords/NutritionOrderAllergyIntolerance</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="NutritionOrderAllergyIntolerance.md" target="_blank">electronicMedicalRecords/NutritionOrderAllergyIntolerance</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="NutritionOrderAllergyIntolerance.md" target="_blank">electronicMedicalRecords/NutritionOrderAllergyIntolerance</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="NutritionOrderAllergyIntolerance.md" target="_blank">electronicMedicalRecords/NutritionOrderAllergyIntolerance</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="NutritionOrderAllergyIntolerance.md" target="_blank">electronicMedicalRecords/NutritionOrderAllergyIntolerance</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="NutritionOrderAllergyIntolerance.md" target="_blank">electronicMedicalRecords/NutritionOrderAllergyIntolerance</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="NutritionOrderAllergyIntolerance.md" target="_blank">electronicMedicalRecords/NutritionOrderAllergyIntolerance</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="NutritionOrderAllergyIntolerance.md" target="_blank">electronicMedicalRecords/NutritionOrderAllergyIntolerance</a>|
|[allergyIntoleranceId](#allergyIntoleranceId)|A link to a record of allergies or intolerances which should be included in the nutrition order.|<a href="NutritionOrderAllergyIntolerance.md" target="_blank">electronicMedicalRecords/NutritionOrderAllergyIntolerance</a>|
|[name](#name)|The name of the custom entity.|<a href="NutritionOrderAllergyIntolerance.md" target="_blank">electronicMedicalRecords/NutritionOrderAllergyIntolerance</a>|
|[nutritionOrderId](#nutritionOrderId)|A request to supply a diet, formula feeding (enteral) or oral nutritional supplement to a patient/resident.|<a href="NutritionOrderAllergyIntolerance.md" target="_blank">electronicMedicalRecords/NutritionOrderAllergyIntolerance</a>|
|[nutritionOrderAllergyIntoleranceId](#nutritionOrderAllergyIntoleranceId)|Unique identifier for entity instances|<a href="NutritionOrderAllergyIntolerance.md" target="_blank">electronicMedicalRecords/NutritionOrderAllergyIntolerance</a>|
|[stateCode](#stateCode)|Status of the Nutrition Order Allergy Intolerance|<a href="NutritionOrderAllergyIntolerance.md" target="_blank">electronicMedicalRecords/NutritionOrderAllergyIntolerance</a>|
|[stateCode_display](#stateCode_display)||<a href="NutritionOrderAllergyIntolerance.md" target="_blank">electronicMedicalRecords/NutritionOrderAllergyIntolerance</a>|
|[statusCode](#statusCode)|Reason for the status of the Nutrition Order Allergy Intolerance|<a href="NutritionOrderAllergyIntolerance.md" target="_blank">electronicMedicalRecords/NutritionOrderAllergyIntolerance</a>|
|[statusCode_display](#statusCode_display)||<a href="NutritionOrderAllergyIntolerance.md" target="_blank">electronicMedicalRecords/NutritionOrderAllergyIntolerance</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/NutritionOrderAllergyIntolerance (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Allergy Intolerance</td></tr><tr><td>description</td><td>A link to a record of allergies or intolerances which should be included in the nutrition order.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_allergyintolerance</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Nutrition Order</td></tr><tr><td>description</td><td>A request to supply a diet, formula feeding (enteral) or oral nutritional supplement to a patient/resident.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_nutritionorder</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Nutrition Order Allergy Intolerance</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_nutritionorderallergyintoleranceid</td></tr></table>
