...
Condition(s) that this care team addresses.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/CareTeamReasonReference.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/core/applicationCommon/foundationCommon<br>/crmCommon/accelerators/healthCare<br>/electronicMedicalRecords<br>/CareTeamReasonReference.cdm.json<br>/CareTeamReasonReference/hasAttributes<br>/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[CareTeamReasonReference/(resolvedAttributes)/careTeamReasonReferenceId](#careTeamReasonReferenceId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[CareTeamReasonReference/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Care Team Reason Reference</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Condition(s) that this care team addresses.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_careteamreasonreference"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="CareTeamReasonReference.md" target="_blank">electronicMedicalRecords/CareTeamReasonReference</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="CareTeamReasonReference.md" target="_blank">electronicMedicalRecords/CareTeamReasonReference</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="CareTeamReasonReference.md" target="_blank">electronicMedicalRecords/CareTeamReasonReference</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="CareTeamReasonReference.md" target="_blank">electronicMedicalRecords/CareTeamReasonReference</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="CareTeamReasonReference.md" target="_blank">electronicMedicalRecords/CareTeamReasonReference</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="CareTeamReasonReference.md" target="_blank">electronicMedicalRecords/CareTeamReasonReference</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="CareTeamReasonReference.md" target="_blank">electronicMedicalRecords/CareTeamReasonReference</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="CareTeamReasonReference.md" target="_blank">electronicMedicalRecords/CareTeamReasonReference</a>|
|[ownerId](#ownerId)|Owner Id|<a href="CareTeamReasonReference.md" target="_blank">electronicMedicalRecords/CareTeamReasonReference</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="CareTeamReasonReference.md" target="_blank">electronicMedicalRecords/CareTeamReasonReference</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="CareTeamReasonReference.md" target="_blank">electronicMedicalRecords/CareTeamReasonReference</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="CareTeamReasonReference.md" target="_blank">electronicMedicalRecords/CareTeamReasonReference</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="CareTeamReasonReference.md" target="_blank">electronicMedicalRecords/CareTeamReasonReference</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="CareTeamReasonReference.md" target="_blank">electronicMedicalRecords/CareTeamReasonReference</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="CareTeamReasonReference.md" target="_blank">electronicMedicalRecords/CareTeamReasonReference</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="CareTeamReasonReference.md" target="_blank">electronicMedicalRecords/CareTeamReasonReference</a>|
|[careTeamId](#careTeamId)|This records identifiers associated with this care team that are defined by business processes and/or used to refer to it when a direct URL reference to the resource itself is not appropriate.|<a href="CareTeamReasonReference.md" target="_blank">electronicMedicalRecords/CareTeamReasonReference</a>|
|[careTeamReasonReferenceId](#careTeamReasonReferenceId)|Unique identifier for entity instances|<a href="CareTeamReasonReference.md" target="_blank">electronicMedicalRecords/CareTeamReasonReference</a>|
|[name](#name)|The name of the custom entity.|<a href="CareTeamReasonReference.md" target="_blank">electronicMedicalRecords/CareTeamReasonReference</a>|
|[referenceId](#referenceId)|Condition(s) that this care team addresses.|<a href="CareTeamReasonReference.md" target="_blank">electronicMedicalRecords/CareTeamReasonReference</a>|
|[stateCode](#stateCode)|Status of the Care Team Reason Reference|<a href="CareTeamReasonReference.md" target="_blank">electronicMedicalRecords/CareTeamReasonReference</a>|
|[stateCode_display](#stateCode_display)||<a href="CareTeamReasonReference.md" target="_blank">electronicMedicalRecords/CareTeamReasonReference</a>|
|[statusCode](#statusCode)|Reason for the status of the Care Team Reason Reference|<a href="CareTeamReasonReference.md" target="_blank">electronicMedicalRecords/CareTeamReasonReference</a>|
|[statusCode_display](#statusCode_display)||<a href="CareTeamReasonReference.md" target="_blank">electronicMedicalRecords/CareTeamReasonReference</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/CareTeamReasonReference (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Care Team</td></tr><tr><td>description</td><td>This records identifiers associated with this care team that are defined by business processes and/or used to refer to it when a direct URL reference to the resource itself is not appropriate.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_careteam</td></tr></table>
...
### <a href=#careTeamReasonReferenceId name="careTeamReasonReferenceId">careTeamReasonReferenceId</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Care Team Reason Reference</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_careteamreasonreferenceid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the careTeamReasonReferenceId attribute are listed below.</summary>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_careteamreasonreferenceid"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Reference</td></tr><tr><td>description</td><td>Condition(s) that this care team addresses.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_reference</td></tr></table>
...
Status of the Care Team Reason Reference  
First included in: electronicMedicalRecords/CareTeamReasonReference (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Care Team Reason Reference</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the Care Team Reason Reference</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
Reason for the status of the Care Team Reason Reference  
First included in: electronicMedicalRecords/CareTeamReasonReference (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Care Team Reason Reference</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the Care Team Reason Reference</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
