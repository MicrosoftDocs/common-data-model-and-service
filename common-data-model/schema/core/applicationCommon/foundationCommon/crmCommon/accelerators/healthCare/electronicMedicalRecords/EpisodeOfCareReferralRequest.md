...
Referral Request(s) that are fulfilled by this Episode Of Care, incoming referrals.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/EpisodeOfCareReferralRequest.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="EpisodeOfCareReferralRequest.md" target="_blank">electronicMedicalRecords/EpisodeOfCareReferralRequest</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="EpisodeOfCareReferralRequest.md" target="_blank">electronicMedicalRecords/EpisodeOfCareReferralRequest</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="EpisodeOfCareReferralRequest.md" target="_blank">electronicMedicalRecords/EpisodeOfCareReferralRequest</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="EpisodeOfCareReferralRequest.md" target="_blank">electronicMedicalRecords/EpisodeOfCareReferralRequest</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="EpisodeOfCareReferralRequest.md" target="_blank">electronicMedicalRecords/EpisodeOfCareReferralRequest</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="EpisodeOfCareReferralRequest.md" target="_blank">electronicMedicalRecords/EpisodeOfCareReferralRequest</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="EpisodeOfCareReferralRequest.md" target="_blank">electronicMedicalRecords/EpisodeOfCareReferralRequest</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="EpisodeOfCareReferralRequest.md" target="_blank">electronicMedicalRecords/EpisodeOfCareReferralRequest</a>|
|[ownerId](#ownerId)|Owner Id|<a href="EpisodeOfCareReferralRequest.md" target="_blank">electronicMedicalRecords/EpisodeOfCareReferralRequest</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="EpisodeOfCareReferralRequest.md" target="_blank">electronicMedicalRecords/EpisodeOfCareReferralRequest</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="EpisodeOfCareReferralRequest.md" target="_blank">electronicMedicalRecords/EpisodeOfCareReferralRequest</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="EpisodeOfCareReferralRequest.md" target="_blank">electronicMedicalRecords/EpisodeOfCareReferralRequest</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="EpisodeOfCareReferralRequest.md" target="_blank">electronicMedicalRecords/EpisodeOfCareReferralRequest</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="EpisodeOfCareReferralRequest.md" target="_blank">electronicMedicalRecords/EpisodeOfCareReferralRequest</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="EpisodeOfCareReferralRequest.md" target="_blank">electronicMedicalRecords/EpisodeOfCareReferralRequest</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="EpisodeOfCareReferralRequest.md" target="_blank">electronicMedicalRecords/EpisodeOfCareReferralRequest</a>|
|[episodeOfCareId](#episodeOfCareId)|An association between a patient and an organization / healthcare provider(s) during which time encounters may occur.|<a href="EpisodeOfCareReferralRequest.md" target="_blank">electronicMedicalRecords/EpisodeOfCareReferralRequest</a>|
|[episodeOfCareReferralRequestId](#episodeOfCareReferralRequestId)|Unique identifier for entity instances|<a href="EpisodeOfCareReferralRequest.md" target="_blank">electronicMedicalRecords/EpisodeOfCareReferralRequest</a>|
|[name](#name)|The name of the custom entity.|<a href="EpisodeOfCareReferralRequest.md" target="_blank">electronicMedicalRecords/EpisodeOfCareReferralRequest</a>|
|[referralRequestId](#referralRequestId)|Referral Request(s) that are fulfilled by this Episode Of Care, incoming referrals.|<a href="EpisodeOfCareReferralRequest.md" target="_blank">electronicMedicalRecords/EpisodeOfCareReferralRequest</a>|
|[stateCode](#stateCode)|Status of the Episode Of Care Referral Request|<a href="EpisodeOfCareReferralRequest.md" target="_blank">electronicMedicalRecords/EpisodeOfCareReferralRequest</a>|
|[stateCode_display](#stateCode_display)||<a href="EpisodeOfCareReferralRequest.md" target="_blank">electronicMedicalRecords/EpisodeOfCareReferralRequest</a>|
|[statusCode](#statusCode)|Reason for the status of the Episode Of Care Referral Request|<a href="EpisodeOfCareReferralRequest.md" target="_blank">electronicMedicalRecords/EpisodeOfCareReferralRequest</a>|
|[statusCode_display](#statusCode_display)||<a href="EpisodeOfCareReferralRequest.md" target="_blank">electronicMedicalRecords/EpisodeOfCareReferralRequest</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/EpisodeOfCareReferralRequest (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Episode Of Care Referral Request</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_episodeofcarereferralrequestid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Episode Of Care Referral Request</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Episode Of Care Referral Request</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
