...
It consists the patient additional names.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/AdditionalName.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="AdditionalName.md" target="_blank">electronicMedicalRecords/AdditionalName</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="AdditionalName.md" target="_blank">electronicMedicalRecords/AdditionalName</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="AdditionalName.md" target="_blank">electronicMedicalRecords/AdditionalName</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="AdditionalName.md" target="_blank">electronicMedicalRecords/AdditionalName</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="AdditionalName.md" target="_blank">electronicMedicalRecords/AdditionalName</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="AdditionalName.md" target="_blank">electronicMedicalRecords/AdditionalName</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="AdditionalName.md" target="_blank">electronicMedicalRecords/AdditionalName</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="AdditionalName.md" target="_blank">electronicMedicalRecords/AdditionalName</a>|
|[ownerId](#ownerId)|Owner Id|<a href="AdditionalName.md" target="_blank">electronicMedicalRecords/AdditionalName</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="AdditionalName.md" target="_blank">electronicMedicalRecords/AdditionalName</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="AdditionalName.md" target="_blank">electronicMedicalRecords/AdditionalName</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="AdditionalName.md" target="_blank">electronicMedicalRecords/AdditionalName</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="AdditionalName.md" target="_blank">electronicMedicalRecords/AdditionalName</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="AdditionalName.md" target="_blank">electronicMedicalRecords/AdditionalName</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="AdditionalName.md" target="_blank">electronicMedicalRecords/AdditionalName</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="AdditionalName.md" target="_blank">electronicMedicalRecords/AdditionalName</a>|
|[additionalNameId](#additionalNameId)|Unique identifier for entity instances|<a href="AdditionalName.md" target="_blank">electronicMedicalRecords/AdditionalName</a>|
|[endDate](#endDate)|End time of validity of name|<a href="AdditionalName.md" target="_blank">electronicMedicalRecords/AdditionalName</a>|
|[familyName](#familyName)|Given Names appear in the correct order for presenting the name|<a href="AdditionalName.md" target="_blank">electronicMedicalRecords/AdditionalName</a>|
|[firstName](#firstName)|Given Names appear in the correct order for presenting the name|<a href="AdditionalName.md" target="_blank">electronicMedicalRecords/AdditionalName</a>|
|[middleName](#middleName)|Given Names appear in the correct order for presenting the name|<a href="AdditionalName.md" target="_blank">electronicMedicalRecords/AdditionalName</a>|
|[name](#name)|The name of the custom entity.|<a href="AdditionalName.md" target="_blank">electronicMedicalRecords/AdditionalName</a>|
|[nameUse](#nameUse)|The use of a human name|<a href="AdditionalName.md" target="_blank">electronicMedicalRecords/AdditionalName</a>|
|[nameUse_display](#nameUse_display)||<a href="AdditionalName.md" target="_blank">electronicMedicalRecords/AdditionalName</a>|
|[patientId](#patientId)|Demographics and other administrative information about an individual or animal receiving care or other health-related services.|<a href="AdditionalName.md" target="_blank">electronicMedicalRecords/AdditionalName</a>|
|[prefix](#prefix)|Part of the name that is acquired as a title due to academic, legal, employment or nobility status, etc. and that appears at the start of the name.|<a href="AdditionalName.md" target="_blank">electronicMedicalRecords/AdditionalName</a>|
|[startDate](#startDate)|Start time of validity of name|<a href="AdditionalName.md" target="_blank">electronicMedicalRecords/AdditionalName</a>|
|[suffix](#suffix)|Part of the name that is acquired as a title due to academic, legal, employment or nobility status, etc. and that appears at the end of the name.|<a href="AdditionalName.md" target="_blank">electronicMedicalRecords/AdditionalName</a>|
|[stateCode](#stateCode)|Status of the Additional Name|<a href="AdditionalName.md" target="_blank">electronicMedicalRecords/AdditionalName</a>|
|[stateCode_display](#stateCode_display)||<a href="AdditionalName.md" target="_blank">electronicMedicalRecords/AdditionalName</a>|
|[statusCode](#statusCode)|Reason for the status of the Additional Name|<a href="AdditionalName.md" target="_blank">electronicMedicalRecords/AdditionalName</a>|
|[statusCode_display](#statusCode_display)||<a href="AdditionalName.md" target="_blank">electronicMedicalRecords/AdditionalName</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/AdditionalName (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Additional Name</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_additionalnameid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Name End Date</td></tr><tr><td>description</td><td>End time of validity of name</td></tr><tr><td>dataFormat</td><td>13</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_enddate</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>First Name</td></tr><tr><td>description</td><td>Given Names appear in the correct order for presenting the name</td></tr><tr><td>dataFormat</td><td>7</td></tr><tr><td>maximumLength</td><td>150</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_firstname</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Middle Name</td></tr><tr><td>description</td><td>Given Names appear in the correct order for presenting the name</td></tr><tr><td>dataFormat</td><td>7</td></tr><tr><td>maximumLength</td><td>512</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_middlename</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Name Start Date</td></tr><tr><td>description</td><td>Start time of validity of name</td></tr><tr><td>dataFormat</td><td>13</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_startdate</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Additional Name</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
