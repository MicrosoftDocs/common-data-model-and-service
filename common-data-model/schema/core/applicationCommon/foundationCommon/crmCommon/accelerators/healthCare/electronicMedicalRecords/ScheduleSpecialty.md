---
title: ScheduleSpecialty - Common Data Model | Microsoft Docs
...
A container for slots of time that may be available for booking appointments.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/ScheduleSpecialty.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="ScheduleSpecialty.md" target="_blank">electronicMedicalRecords/ScheduleSpecialty</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="ScheduleSpecialty.md" target="_blank">electronicMedicalRecords/ScheduleSpecialty</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="ScheduleSpecialty.md" target="_blank">electronicMedicalRecords/ScheduleSpecialty</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="ScheduleSpecialty.md" target="_blank">electronicMedicalRecords/ScheduleSpecialty</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="ScheduleSpecialty.md" target="_blank">electronicMedicalRecords/ScheduleSpecialty</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="ScheduleSpecialty.md" target="_blank">electronicMedicalRecords/ScheduleSpecialty</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="ScheduleSpecialty.md" target="_blank">electronicMedicalRecords/ScheduleSpecialty</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="ScheduleSpecialty.md" target="_blank">electronicMedicalRecords/ScheduleSpecialty</a>|
|[ownerId](#ownerId)|Owner Id|<a href="ScheduleSpecialty.md" target="_blank">electronicMedicalRecords/ScheduleSpecialty</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="ScheduleSpecialty.md" target="_blank">electronicMedicalRecords/ScheduleSpecialty</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="ScheduleSpecialty.md" target="_blank">electronicMedicalRecords/ScheduleSpecialty</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="ScheduleSpecialty.md" target="_blank">electronicMedicalRecords/ScheduleSpecialty</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="ScheduleSpecialty.md" target="_blank">electronicMedicalRecords/ScheduleSpecialty</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="ScheduleSpecialty.md" target="_blank">electronicMedicalRecords/ScheduleSpecialty</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="ScheduleSpecialty.md" target="_blank">electronicMedicalRecords/ScheduleSpecialty</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="ScheduleSpecialty.md" target="_blank">electronicMedicalRecords/ScheduleSpecialty</a>|
|[name](#name)|The name of the custom entity.|<a href="ScheduleSpecialty.md" target="_blank">electronicMedicalRecords/ScheduleSpecialty</a>|
|[scheduleId](#scheduleId)|A container for slots of time that may be available for booking appointments.|<a href="ScheduleSpecialty.md" target="_blank">electronicMedicalRecords/ScheduleSpecialty</a>|
|[scheduleSpecialtyId](#scheduleSpecialtyId)|Unique identifier for entity instances|<a href="ScheduleSpecialty.md" target="_blank">electronicMedicalRecords/ScheduleSpecialty</a>|
|[specialtyId](#specialtyId)|The specialty of a practitioner that would be required to perform the service requested in this appointment.|<a href="ScheduleSpecialty.md" target="_blank">electronicMedicalRecords/ScheduleSpecialty</a>|
|[stateCode](#stateCode)|Status of the Schedule Specialty|<a href="ScheduleSpecialty.md" target="_blank">electronicMedicalRecords/ScheduleSpecialty</a>|
|[stateCode_display](#stateCode_display)||<a href="ScheduleSpecialty.md" target="_blank">electronicMedicalRecords/ScheduleSpecialty</a>|
|[statusCode](#statusCode)|Reason for the status of the Schedule Specialty|<a href="ScheduleSpecialty.md" target="_blank">electronicMedicalRecords/ScheduleSpecialty</a>|
|[statusCode_display](#statusCode_display)||<a href="ScheduleSpecialty.md" target="_blank">electronicMedicalRecords/ScheduleSpecialty</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/ScheduleSpecialty (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Schedule Specialty</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_schedulespecialtyid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Schedule Specialty</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Schedule Specialty</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
