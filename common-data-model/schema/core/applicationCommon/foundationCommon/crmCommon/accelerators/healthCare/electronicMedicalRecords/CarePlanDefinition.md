---
title: CarePlanDefinition - Common Data Model | Microsoft Docs
...
Identifies the protocol, questionnaire, guideline or other specification the care plan should be conducted in accordance with.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/CarePlanDefinition.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="CarePlanDefinition.md" target="_blank">electronicMedicalRecords/CarePlanDefinition</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="CarePlanDefinition.md" target="_blank">electronicMedicalRecords/CarePlanDefinition</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="CarePlanDefinition.md" target="_blank">electronicMedicalRecords/CarePlanDefinition</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="CarePlanDefinition.md" target="_blank">electronicMedicalRecords/CarePlanDefinition</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="CarePlanDefinition.md" target="_blank">electronicMedicalRecords/CarePlanDefinition</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="CarePlanDefinition.md" target="_blank">electronicMedicalRecords/CarePlanDefinition</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="CarePlanDefinition.md" target="_blank">electronicMedicalRecords/CarePlanDefinition</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="CarePlanDefinition.md" target="_blank">electronicMedicalRecords/CarePlanDefinition</a>|
|[ownerId](#ownerId)|Owner Id|<a href="CarePlanDefinition.md" target="_blank">electronicMedicalRecords/CarePlanDefinition</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="CarePlanDefinition.md" target="_blank">electronicMedicalRecords/CarePlanDefinition</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="CarePlanDefinition.md" target="_blank">electronicMedicalRecords/CarePlanDefinition</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="CarePlanDefinition.md" target="_blank">electronicMedicalRecords/CarePlanDefinition</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="CarePlanDefinition.md" target="_blank">electronicMedicalRecords/CarePlanDefinition</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="CarePlanDefinition.md" target="_blank">electronicMedicalRecords/CarePlanDefinition</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="CarePlanDefinition.md" target="_blank">electronicMedicalRecords/CarePlanDefinition</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="CarePlanDefinition.md" target="_blank">electronicMedicalRecords/CarePlanDefinition</a>|
|[carePlanId](#carePlanId)|Describes the intention of how one or more practitioners intend to deliver care for a particular patient, group or community for a period of time, possibly limited to care for a specific condition.|<a href="CarePlanDefinition.md" target="_blank">electronicMedicalRecords/CarePlanDefinition</a>|
|[carePlanDefinitionId](#carePlanDefinitionId)|Unique identifier for entity instances|<a href="CarePlanDefinition.md" target="_blank">electronicMedicalRecords/CarePlanDefinition</a>|
|[definitionType](#definitionType)|Identifies the protocol, questionnaire, guideline or other specification the care plan should be conducted in accordance with.|<a href="CarePlanDefinition.md" target="_blank">electronicMedicalRecords/CarePlanDefinition</a>|
|[definitionType_display](#definitionType_display)||<a href="CarePlanDefinition.md" target="_blank">electronicMedicalRecords/CarePlanDefinition</a>|
|[definitionTypePlanDefinitionId](#definitionTypePlanDefinitionId)|Identifies the protocol, questionnaire, guideline or other specification the care plan should be conducted in accordance with.|<a href="CarePlanDefinition.md" target="_blank">electronicMedicalRecords/CarePlanDefinition</a>|
|[definitionTypePQuestionnaireId](#definitionTypePQuestionnaireId)|Identifies the protocol, questionnaire, guideline or other specification the care plan should be conducted in accordance with.|<a href="CarePlanDefinition.md" target="_blank">electronicMedicalRecords/CarePlanDefinition</a>|
|[name](#name)|The name of the custom entity.|<a href="CarePlanDefinition.md" target="_blank">electronicMedicalRecords/CarePlanDefinition</a>|
|[stateCode](#stateCode)|Status of the Care Plan Definition|<a href="CarePlanDefinition.md" target="_blank">electronicMedicalRecords/CarePlanDefinition</a>|
|[stateCode_display](#stateCode_display)||<a href="CarePlanDefinition.md" target="_blank">electronicMedicalRecords/CarePlanDefinition</a>|
|[statusCode](#statusCode)|Reason for the status of the Care Plan Definition|<a href="CarePlanDefinition.md" target="_blank">electronicMedicalRecords/CarePlanDefinition</a>|
|[statusCode_display](#statusCode_display)||<a href="CarePlanDefinition.md" target="_blank">electronicMedicalRecords/CarePlanDefinition</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/CarePlanDefinition (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Care Plan Definition</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_careplandefinitionid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Plan Definition</td></tr><tr><td>description</td><td>Identifies the protocol, questionnaire, guideline or other specification the care plan should be conducted in accordance with.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_definitiontypeplandefinition</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Care Plan Definition</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Care Plan Definition</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
