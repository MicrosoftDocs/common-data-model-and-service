---
title: EncounterParticipantType - Common Data Model | Microsoft Docs
...
The participant type indicates how an individual participates in an encounter.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/EncounterParticipantType.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="EncounterParticipantType.md" target="_blank">electronicMedicalRecords/EncounterParticipantType</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="EncounterParticipantType.md" target="_blank">electronicMedicalRecords/EncounterParticipantType</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="EncounterParticipantType.md" target="_blank">electronicMedicalRecords/EncounterParticipantType</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="EncounterParticipantType.md" target="_blank">electronicMedicalRecords/EncounterParticipantType</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="EncounterParticipantType.md" target="_blank">electronicMedicalRecords/EncounterParticipantType</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="EncounterParticipantType.md" target="_blank">electronicMedicalRecords/EncounterParticipantType</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="EncounterParticipantType.md" target="_blank">electronicMedicalRecords/EncounterParticipantType</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="EncounterParticipantType.md" target="_blank">electronicMedicalRecords/EncounterParticipantType</a>|
|[ownerId](#ownerId)|Owner Id|<a href="EncounterParticipantType.md" target="_blank">electronicMedicalRecords/EncounterParticipantType</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="EncounterParticipantType.md" target="_blank">electronicMedicalRecords/EncounterParticipantType</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="EncounterParticipantType.md" target="_blank">electronicMedicalRecords/EncounterParticipantType</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="EncounterParticipantType.md" target="_blank">electronicMedicalRecords/EncounterParticipantType</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="EncounterParticipantType.md" target="_blank">electronicMedicalRecords/EncounterParticipantType</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="EncounterParticipantType.md" target="_blank">electronicMedicalRecords/EncounterParticipantType</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="EncounterParticipantType.md" target="_blank">electronicMedicalRecords/EncounterParticipantType</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="EncounterParticipantType.md" target="_blank">electronicMedicalRecords/EncounterParticipantType</a>|
|[encounterParticipantId](#encounterParticipantId)|The list of people responsible for providing the service.|<a href="EncounterParticipantType.md" target="_blank">electronicMedicalRecords/EncounterParticipantType</a>|
|[encounterParticipantTypeId](#encounterParticipantTypeId)|Unique identifier for entity instances|<a href="EncounterParticipantType.md" target="_blank">electronicMedicalRecords/EncounterParticipantType</a>|
|[name](#name)|The name of the custom entity.|<a href="EncounterParticipantType.md" target="_blank">electronicMedicalRecords/EncounterParticipantType</a>|
|[stateCode](#stateCode)|Status of the Encounter Participant Type|<a href="EncounterParticipantType.md" target="_blank">electronicMedicalRecords/EncounterParticipantType</a>|
|[stateCode_display](#stateCode_display)||<a href="EncounterParticipantType.md" target="_blank">electronicMedicalRecords/EncounterParticipantType</a>|
|[statusCode](#statusCode)|Reason for the status of the Encounter Participant Type|<a href="EncounterParticipantType.md" target="_blank">electronicMedicalRecords/EncounterParticipantType</a>|
|[statusCode_display](#statusCode_display)||<a href="EncounterParticipantType.md" target="_blank">electronicMedicalRecords/EncounterParticipantType</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/EncounterParticipantType (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Encounter Participant</td></tr><tr><td>description</td><td>The list of people responsible for providing the service.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_encounterparticipant</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Encounter Participant Type</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Encounter Participant Type</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
