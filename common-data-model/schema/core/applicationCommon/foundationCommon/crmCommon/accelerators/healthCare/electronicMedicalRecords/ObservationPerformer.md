...
Who was responsible for asserting the observed value as "true".  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/ObservationPerformer.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="ObservationPerformer.md" target="_blank">electronicMedicalRecords/ObservationPerformer</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="ObservationPerformer.md" target="_blank">electronicMedicalRecords/ObservationPerformer</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="ObservationPerformer.md" target="_blank">electronicMedicalRecords/ObservationPerformer</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="ObservationPerformer.md" target="_blank">electronicMedicalRecords/ObservationPerformer</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="ObservationPerformer.md" target="_blank">electronicMedicalRecords/ObservationPerformer</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="ObservationPerformer.md" target="_blank">electronicMedicalRecords/ObservationPerformer</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="ObservationPerformer.md" target="_blank">electronicMedicalRecords/ObservationPerformer</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="ObservationPerformer.md" target="_blank">electronicMedicalRecords/ObservationPerformer</a>|
|[ownerId](#ownerId)|Owner Id|<a href="ObservationPerformer.md" target="_blank">electronicMedicalRecords/ObservationPerformer</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="ObservationPerformer.md" target="_blank">electronicMedicalRecords/ObservationPerformer</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="ObservationPerformer.md" target="_blank">electronicMedicalRecords/ObservationPerformer</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="ObservationPerformer.md" target="_blank">electronicMedicalRecords/ObservationPerformer</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="ObservationPerformer.md" target="_blank">electronicMedicalRecords/ObservationPerformer</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="ObservationPerformer.md" target="_blank">electronicMedicalRecords/ObservationPerformer</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="ObservationPerformer.md" target="_blank">electronicMedicalRecords/ObservationPerformer</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="ObservationPerformer.md" target="_blank">electronicMedicalRecords/ObservationPerformer</a>|
|[name](#name)|The name of the custom entity.|<a href="ObservationPerformer.md" target="_blank">electronicMedicalRecords/ObservationPerformer</a>|
|[observationId](#observationId)|Business Identifier for observation|<a href="ObservationPerformer.md" target="_blank">electronicMedicalRecords/ObservationPerformer</a>|
|[observationPerformerId](#observationPerformerId)|Unique identifier for entity instances|<a href="ObservationPerformer.md" target="_blank">electronicMedicalRecords/ObservationPerformer</a>|
|[obsPerformerOrganizationId](#obsPerformerOrganizationId)|Performer is organization|<a href="ObservationPerformer.md" target="_blank">electronicMedicalRecords/ObservationPerformer</a>|
|[obsPerformerPatientId](#obsPerformerPatientId)|Performer is patient|<a href="ObservationPerformer.md" target="_blank">electronicMedicalRecords/ObservationPerformer</a>|
|[obsPerformerPractitionerId](#obsPerformerPractitionerId)|Performer is practitioner|<a href="ObservationPerformer.md" target="_blank">electronicMedicalRecords/ObservationPerformer</a>|
|[obsPerformerRelatedPersonId](#obsPerformerRelatedPersonId)|Performer is person related to patient|<a href="ObservationPerformer.md" target="_blank">electronicMedicalRecords/ObservationPerformer</a>|
|[obsPerformerType](#obsPerformerType)|Who was responsible for asserting the observed value as "true".|<a href="ObservationPerformer.md" target="_blank">electronicMedicalRecords/ObservationPerformer</a>|
|[obsPerformerType_display](#obsPerformerType_display)||<a href="ObservationPerformer.md" target="_blank">electronicMedicalRecords/ObservationPerformer</a>|
|[stateCode](#stateCode)|Status of the Observation Performer|<a href="ObservationPerformer.md" target="_blank">electronicMedicalRecords/ObservationPerformer</a>|
|[stateCode_display](#stateCode_display)||<a href="ObservationPerformer.md" target="_blank">electronicMedicalRecords/ObservationPerformer</a>|
|[statusCode](#statusCode)|Reason for the status of the Observation Performer|<a href="ObservationPerformer.md" target="_blank">electronicMedicalRecords/ObservationPerformer</a>|
|[statusCode_display](#statusCode_display)||<a href="ObservationPerformer.md" target="_blank">electronicMedicalRecords/ObservationPerformer</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/ObservationPerformer (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Observation Performer</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_observationperformerid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Organization</td></tr><tr><td>description</td><td>Performer is organization</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_obsperformerorganization</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Patient</td></tr><tr><td>description</td><td>Performer is patient</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_obsperformerpatient</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Practitioner</td></tr><tr><td>description</td><td>Performer is practitioner</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_obsperformerpractitioner</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Related Person</td></tr><tr><td>description</td><td>Performer is person related to patient</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_obsperformerrelatedperson</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Observation Performer</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Observation Performer</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
