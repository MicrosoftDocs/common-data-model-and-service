---
title: DeviceRequestRelevantHistory - Common Data Model | Microsoft Docs
...
# Device Request Relevant History

Key events in the history of the request.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/DeviceRequestRelevantHistory.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="DeviceRequestRelevantHistory.md" target="_blank">electronicMedicalRecords/DeviceRequestRelevantHistory</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="DeviceRequestRelevantHistory.md" target="_blank">electronicMedicalRecords/DeviceRequestRelevantHistory</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="DeviceRequestRelevantHistory.md" target="_blank">electronicMedicalRecords/DeviceRequestRelevantHistory</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="DeviceRequestRelevantHistory.md" target="_blank">electronicMedicalRecords/DeviceRequestRelevantHistory</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="DeviceRequestRelevantHistory.md" target="_blank">electronicMedicalRecords/DeviceRequestRelevantHistory</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="DeviceRequestRelevantHistory.md" target="_blank">electronicMedicalRecords/DeviceRequestRelevantHistory</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="DeviceRequestRelevantHistory.md" target="_blank">electronicMedicalRecords/DeviceRequestRelevantHistory</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="DeviceRequestRelevantHistory.md" target="_blank">electronicMedicalRecords/DeviceRequestRelevantHistory</a>|
|[ownerId](#ownerId)|Owner Id|<a href="DeviceRequestRelevantHistory.md" target="_blank">electronicMedicalRecords/DeviceRequestRelevantHistory</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="DeviceRequestRelevantHistory.md" target="_blank">electronicMedicalRecords/DeviceRequestRelevantHistory</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="DeviceRequestRelevantHistory.md" target="_blank">electronicMedicalRecords/DeviceRequestRelevantHistory</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="DeviceRequestRelevantHistory.md" target="_blank">electronicMedicalRecords/DeviceRequestRelevantHistory</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="DeviceRequestRelevantHistory.md" target="_blank">electronicMedicalRecords/DeviceRequestRelevantHistory</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="DeviceRequestRelevantHistory.md" target="_blank">electronicMedicalRecords/DeviceRequestRelevantHistory</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="DeviceRequestRelevantHistory.md" target="_blank">electronicMedicalRecords/DeviceRequestRelevantHistory</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="DeviceRequestRelevantHistory.md" target="_blank">electronicMedicalRecords/DeviceRequestRelevantHistory</a>|
|[deviceRequestId](#deviceRequestId)|Identifier for Device Request|<a href="DeviceRequestRelevantHistory.md" target="_blank">electronicMedicalRecords/DeviceRequestRelevantHistory</a>|
|[devicerequestrelevanthistoriesId](#devicerequestrelevanthistoriesId)|Unique identifier for entity instances|<a href="DeviceRequestRelevantHistory.md" target="_blank">electronicMedicalRecords/DeviceRequestRelevantHistory</a>|
|[name](#name)|The name of the custom entity.|<a href="DeviceRequestRelevantHistory.md" target="_blank">electronicMedicalRecords/DeviceRequestRelevantHistory</a>|
|[relevantHistoryId](#relevantHistoryId)|Key events in the history of the request.|<a href="DeviceRequestRelevantHistory.md" target="_blank">electronicMedicalRecords/DeviceRequestRelevantHistory</a>|
|[stateCode](#stateCode)|Status of the Device Request Relevant History|<a href="DeviceRequestRelevantHistory.md" target="_blank">electronicMedicalRecords/DeviceRequestRelevantHistory</a>|
|[stateCode_display](#stateCode_display)||<a href="DeviceRequestRelevantHistory.md" target="_blank">electronicMedicalRecords/DeviceRequestRelevantHistory</a>|
|[statusCode](#statusCode)|Reason for the status of the Device Request Relevant History|<a href="DeviceRequestRelevantHistory.md" target="_blank">electronicMedicalRecords/DeviceRequestRelevantHistory</a>|
|[statusCode_display](#statusCode_display)||<a href="DeviceRequestRelevantHistory.md" target="_blank">electronicMedicalRecords/DeviceRequestRelevantHistory</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/DeviceRequestRelevantHistory (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Device Request Relevant History</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_devicerequestrelevanthistoriesid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Device Request Relevant History</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
