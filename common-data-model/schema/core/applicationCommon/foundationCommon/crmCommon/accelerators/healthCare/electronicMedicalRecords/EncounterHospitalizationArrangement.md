...
Any special requests that have been made for this hospitalization encounter, such as the provision of specific equipment or other things.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/EncounterHospitalizationArrangement.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="EncounterHospitalizationArrangement.md" target="_blank">electronicMedicalRecords/EncounterHospitalizationArrangement</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="EncounterHospitalizationArrangement.md" target="_blank">electronicMedicalRecords/EncounterHospitalizationArrangement</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="EncounterHospitalizationArrangement.md" target="_blank">electronicMedicalRecords/EncounterHospitalizationArrangement</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="EncounterHospitalizationArrangement.md" target="_blank">electronicMedicalRecords/EncounterHospitalizationArrangement</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="EncounterHospitalizationArrangement.md" target="_blank">electronicMedicalRecords/EncounterHospitalizationArrangement</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="EncounterHospitalizationArrangement.md" target="_blank">electronicMedicalRecords/EncounterHospitalizationArrangement</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="EncounterHospitalizationArrangement.md" target="_blank">electronicMedicalRecords/EncounterHospitalizationArrangement</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="EncounterHospitalizationArrangement.md" target="_blank">electronicMedicalRecords/EncounterHospitalizationArrangement</a>|
|[ownerId](#ownerId)|Owner Id|<a href="EncounterHospitalizationArrangement.md" target="_blank">electronicMedicalRecords/EncounterHospitalizationArrangement</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="EncounterHospitalizationArrangement.md" target="_blank">electronicMedicalRecords/EncounterHospitalizationArrangement</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="EncounterHospitalizationArrangement.md" target="_blank">electronicMedicalRecords/EncounterHospitalizationArrangement</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="EncounterHospitalizationArrangement.md" target="_blank">electronicMedicalRecords/EncounterHospitalizationArrangement</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="EncounterHospitalizationArrangement.md" target="_blank">electronicMedicalRecords/EncounterHospitalizationArrangement</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="EncounterHospitalizationArrangement.md" target="_blank">electronicMedicalRecords/EncounterHospitalizationArrangement</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="EncounterHospitalizationArrangement.md" target="_blank">electronicMedicalRecords/EncounterHospitalizationArrangement</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="EncounterHospitalizationArrangement.md" target="_blank">electronicMedicalRecords/EncounterHospitalizationArrangement</a>|
|[encounterId](#encounterId)|An interaction between a patient and healthcare provider(s) for the purpose of providing healthcare service(s) or assessing the health status of a patient.|<a href="EncounterHospitalizationArrangement.md" target="_blank">electronicMedicalRecords/EncounterHospitalizationArrangement</a>|
|[encounterHospitalizationArrangementId](#encounterHospitalizationArrangementId)|Unique identifier for entity instances|<a href="EncounterHospitalizationArrangement.md" target="_blank">electronicMedicalRecords/EncounterHospitalizationArrangement</a>|
|[name](#name)|The name of the custom entity.|<a href="EncounterHospitalizationArrangement.md" target="_blank">electronicMedicalRecords/EncounterHospitalizationArrangement</a>|
|[specialArrangementIdentifierId](#specialArrangementIdentifierId)|Any special requests that have been made for this hospitalization encounter, such as the provision of specific equipment or other things.|<a href="EncounterHospitalizationArrangement.md" target="_blank">electronicMedicalRecords/EncounterHospitalizationArrangement</a>|
|[stateCode](#stateCode)|Status of the Encounter Hospitalization Arrangement|<a href="EncounterHospitalizationArrangement.md" target="_blank">electronicMedicalRecords/EncounterHospitalizationArrangement</a>|
|[stateCode_display](#stateCode_display)||<a href="EncounterHospitalizationArrangement.md" target="_blank">electronicMedicalRecords/EncounterHospitalizationArrangement</a>|
|[statusCode](#statusCode)|Reason for the status of the Encounter Hospitalization Arrangement|<a href="EncounterHospitalizationArrangement.md" target="_blank">electronicMedicalRecords/EncounterHospitalizationArrangement</a>|
|[statusCode_display](#statusCode_display)||<a href="EncounterHospitalizationArrangement.md" target="_blank">electronicMedicalRecords/EncounterHospitalizationArrangement</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/EncounterHospitalizationArrangement (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Encounter Hospitalization Arrangement</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_encounterhospitalizationarrangementid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Special Arrangement</td></tr><tr><td>description</td><td>Any special requests that have been made for this hospitalization encounter, such as the provision of specific equipment or other things.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_specialarrangementidentifier</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Encounter Hospitalization Arrangement</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Encounter Hospitalization Arrangement</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
