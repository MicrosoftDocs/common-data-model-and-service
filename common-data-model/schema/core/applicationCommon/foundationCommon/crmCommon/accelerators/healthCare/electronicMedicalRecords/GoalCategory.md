---
title: GoalCategory - Common Data Model | Microsoft Docs
...
Indicates a category the goal falls within.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/GoalCategory.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="GoalCategory.md" target="_blank">electronicMedicalRecords/GoalCategory</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="GoalCategory.md" target="_blank">electronicMedicalRecords/GoalCategory</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="GoalCategory.md" target="_blank">electronicMedicalRecords/GoalCategory</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="GoalCategory.md" target="_blank">electronicMedicalRecords/GoalCategory</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="GoalCategory.md" target="_blank">electronicMedicalRecords/GoalCategory</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="GoalCategory.md" target="_blank">electronicMedicalRecords/GoalCategory</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="GoalCategory.md" target="_blank">electronicMedicalRecords/GoalCategory</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="GoalCategory.md" target="_blank">electronicMedicalRecords/GoalCategory</a>|
|[ownerId](#ownerId)|Owner Id|<a href="GoalCategory.md" target="_blank">electronicMedicalRecords/GoalCategory</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="GoalCategory.md" target="_blank">electronicMedicalRecords/GoalCategory</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="GoalCategory.md" target="_blank">electronicMedicalRecords/GoalCategory</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="GoalCategory.md" target="_blank">electronicMedicalRecords/GoalCategory</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="GoalCategory.md" target="_blank">electronicMedicalRecords/GoalCategory</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="GoalCategory.md" target="_blank">electronicMedicalRecords/GoalCategory</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="GoalCategory.md" target="_blank">electronicMedicalRecords/GoalCategory</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="GoalCategory.md" target="_blank">electronicMedicalRecords/GoalCategory</a>|
|[goalId](#goalId)|Describes the intended objective(s) for a patient, group or organization care|<a href="GoalCategory.md" target="_blank">electronicMedicalRecords/GoalCategory</a>|
|[goalCategoryId](#goalCategoryId)|Unique identifier for entity instances|<a href="GoalCategory.md" target="_blank">electronicMedicalRecords/GoalCategory</a>|
|[name](#name)|The name of the custom entity.|<a href="GoalCategory.md" target="_blank">electronicMedicalRecords/GoalCategory</a>|
|[stateCode](#stateCode)|Status of the Goal Category|<a href="GoalCategory.md" target="_blank">electronicMedicalRecords/GoalCategory</a>|
|[stateCode_display](#stateCode_display)||<a href="GoalCategory.md" target="_blank">electronicMedicalRecords/GoalCategory</a>|
|[statusCode](#statusCode)|Reason for the status of the Goal Category|<a href="GoalCategory.md" target="_blank">electronicMedicalRecords/GoalCategory</a>|
|[statusCode_display](#statusCode_display)||<a href="GoalCategory.md" target="_blank">electronicMedicalRecords/GoalCategory</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/GoalCategory (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Goal Category</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Goal Category</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
