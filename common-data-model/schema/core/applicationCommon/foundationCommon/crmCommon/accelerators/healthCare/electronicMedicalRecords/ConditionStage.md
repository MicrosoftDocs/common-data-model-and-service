---
title: ConditionStage - Common Data Model | Microsoft Docs
...
Clinical stage or grade of a condition. May include formal severity assessments.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/ConditionStage.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="ConditionStage.md" target="_blank">electronicMedicalRecords/ConditionStage</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="ConditionStage.md" target="_blank">electronicMedicalRecords/ConditionStage</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="ConditionStage.md" target="_blank">electronicMedicalRecords/ConditionStage</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="ConditionStage.md" target="_blank">electronicMedicalRecords/ConditionStage</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="ConditionStage.md" target="_blank">electronicMedicalRecords/ConditionStage</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="ConditionStage.md" target="_blank">electronicMedicalRecords/ConditionStage</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="ConditionStage.md" target="_blank">electronicMedicalRecords/ConditionStage</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="ConditionStage.md" target="_blank">electronicMedicalRecords/ConditionStage</a>|
|[ownerId](#ownerId)|Owner Id|<a href="ConditionStage.md" target="_blank">electronicMedicalRecords/ConditionStage</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="ConditionStage.md" target="_blank">electronicMedicalRecords/ConditionStage</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="ConditionStage.md" target="_blank">electronicMedicalRecords/ConditionStage</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="ConditionStage.md" target="_blank">electronicMedicalRecords/ConditionStage</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="ConditionStage.md" target="_blank">electronicMedicalRecords/ConditionStage</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="ConditionStage.md" target="_blank">electronicMedicalRecords/ConditionStage</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="ConditionStage.md" target="_blank">electronicMedicalRecords/ConditionStage</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="ConditionStage.md" target="_blank">electronicMedicalRecords/ConditionStage</a>|
|[conditionId](#conditionId)|Detailed information about conditions, problems or diagnoses|<a href="ConditionStage.md" target="_blank">electronicMedicalRecords/ConditionStage</a>|
|[conditionStageId](#conditionStageId)|Unique identifier for entity instances|<a href="ConditionStage.md" target="_blank">electronicMedicalRecords/ConditionStage</a>|
|[name](#name)|The name of the custom entity.|<a href="ConditionStage.md" target="_blank">electronicMedicalRecords/ConditionStage</a>|
|[stageAssessmentClinicalImpressionId](#stageAssessmentClinicalImpressionId)|Formal record of assessment that supports the stage identified for a condition likes of Diagnostic report, Clinical Impression or Observation.|<a href="ConditionStage.md" target="_blank">electronicMedicalRecords/ConditionStage</a>|
|[stageAssessmentDiagnosticRecordId](#stageAssessmentDiagnosticRecordId)|Formal record of assessment that supports the stage identified for a condition likes of Diagnostic report, Clinical Impression or Observation.|<a href="ConditionStage.md" target="_blank">electronicMedicalRecords/ConditionStage</a>|
|[stageAssessmentObservationId](#stageAssessmentObservationId)|Formal record of assessment that supports the stage identified for a condition likes of Diagnostic report, Clinical Impression or Observation|<a href="ConditionStage.md" target="_blank">electronicMedicalRecords/ConditionStage</a>|
|[stateCode](#stateCode)|Status of the Condition Stage|<a href="ConditionStage.md" target="_blank">electronicMedicalRecords/ConditionStage</a>|
|[stateCode_display](#stateCode_display)||<a href="ConditionStage.md" target="_blank">electronicMedicalRecords/ConditionStage</a>|
|[statusCode](#statusCode)|Reason for the status of the Condition Stage|<a href="ConditionStage.md" target="_blank">electronicMedicalRecords/ConditionStage</a>|
|[statusCode_display](#statusCode_display)||<a href="ConditionStage.md" target="_blank">electronicMedicalRecords/ConditionStage</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/ConditionStage (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Condition Stage</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_conditionstageid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Condition Stage</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Condition Stage</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
