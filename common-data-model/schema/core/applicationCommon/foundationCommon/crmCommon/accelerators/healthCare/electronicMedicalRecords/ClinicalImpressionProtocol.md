---
title: ClinicalImpressionProtocol - Common Data Model | Microsoft Docs
...
# Clinical Impression Protocol

Reference to a specific published clinical protocol that was followed during this assessment, and/or that provides evidence in support of the diagnosis.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/ClinicalImpressionProtocol.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/core/applicationCommon/foundationCommon<br>/crmCommon/accelerators/healthCare<br>/electronicMedicalRecords<br>/ClinicalImpressionProtocol.cdm.json<br>/ClinicalImpressionProtocol/hasAttributes<br>/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[ClinicalImpressionProtocol/(resolvedAttributes)/clinicalImpressionProtocolId](#clinicalImpressionProtocolId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[ClinicalImpressionProtocol/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Clinical Impression Protocol</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reference to a specific published clinical protocol that was followed during this assessment, and/or that provides evidence in support of the diagnosis.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_clinicalimpressionprotocol"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="ClinicalImpressionProtocol.md" target="_blank">electronicMedicalRecords/ClinicalImpressionProtocol</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="ClinicalImpressionProtocol.md" target="_blank">electronicMedicalRecords/ClinicalImpressionProtocol</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="ClinicalImpressionProtocol.md" target="_blank">electronicMedicalRecords/ClinicalImpressionProtocol</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="ClinicalImpressionProtocol.md" target="_blank">electronicMedicalRecords/ClinicalImpressionProtocol</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="ClinicalImpressionProtocol.md" target="_blank">electronicMedicalRecords/ClinicalImpressionProtocol</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="ClinicalImpressionProtocol.md" target="_blank">electronicMedicalRecords/ClinicalImpressionProtocol</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="ClinicalImpressionProtocol.md" target="_blank">electronicMedicalRecords/ClinicalImpressionProtocol</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="ClinicalImpressionProtocol.md" target="_blank">electronicMedicalRecords/ClinicalImpressionProtocol</a>|
|[ownerId](#ownerId)|Owner Id|<a href="ClinicalImpressionProtocol.md" target="_blank">electronicMedicalRecords/ClinicalImpressionProtocol</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="ClinicalImpressionProtocol.md" target="_blank">electronicMedicalRecords/ClinicalImpressionProtocol</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="ClinicalImpressionProtocol.md" target="_blank">electronicMedicalRecords/ClinicalImpressionProtocol</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="ClinicalImpressionProtocol.md" target="_blank">electronicMedicalRecords/ClinicalImpressionProtocol</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="ClinicalImpressionProtocol.md" target="_blank">electronicMedicalRecords/ClinicalImpressionProtocol</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="ClinicalImpressionProtocol.md" target="_blank">electronicMedicalRecords/ClinicalImpressionProtocol</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="ClinicalImpressionProtocol.md" target="_blank">electronicMedicalRecords/ClinicalImpressionProtocol</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="ClinicalImpressionProtocol.md" target="_blank">electronicMedicalRecords/ClinicalImpressionProtocol</a>|
|[clinicalImpressionIdentifierId](#clinicalImpressionIdentifierId)|A record of a clinical assessment performed to determine what problem(s) may affect the patient and before planning the treatments or management strategies that are best to manage patient condition|<a href="ClinicalImpressionProtocol.md" target="_blank">electronicMedicalRecords/ClinicalImpressionProtocol</a>|
|[clinicalImpressionProtocolId](#clinicalImpressionProtocolId)|Unique identifier for entity instances|<a href="ClinicalImpressionProtocol.md" target="_blank">electronicMedicalRecords/ClinicalImpressionProtocol</a>|
|[name](#name)|The name of the custom entity.|<a href="ClinicalImpressionProtocol.md" target="_blank">electronicMedicalRecords/ClinicalImpressionProtocol</a>|
|[URI](#URI)|Reference to a specific published clinical protocol that was followed during this assessment, and/or that provides evidence in support of the diagnosis.|<a href="ClinicalImpressionProtocol.md" target="_blank">electronicMedicalRecords/ClinicalImpressionProtocol</a>|
|[stateCode](#stateCode)|Status of the Clinical Impression Protocol|<a href="ClinicalImpressionProtocol.md" target="_blank">electronicMedicalRecords/ClinicalImpressionProtocol</a>|
|[stateCode_display](#stateCode_display)||<a href="ClinicalImpressionProtocol.md" target="_blank">electronicMedicalRecords/ClinicalImpressionProtocol</a>|
|[statusCode](#statusCode)|Reason for the status of the Clinical Impression Protocol|<a href="ClinicalImpressionProtocol.md" target="_blank">electronicMedicalRecords/ClinicalImpressionProtocol</a>|
|[statusCode_display](#statusCode_display)||<a href="ClinicalImpressionProtocol.md" target="_blank">electronicMedicalRecords/ClinicalImpressionProtocol</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/ClinicalImpressionProtocol (this entity)  
...
A record of a clinical assessment performed to determine what problem(s) may affect the patient and before planning the treatments or management strategies that are best to manage patient condition  
First included in: electronicMedicalRecords/ClinicalImpressionProtocol (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Clinical Impression</td></tr><tr><td>description</td><td>A record of a clinical assessment performed to determine what problem(s) may affect the patient and before planning the treatments or management strategies that are best to manage patient condition</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_clinicalimpressionidentifier</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>A record of a clinical assessment performed to determine what problem(s) may affect the patient and before planning the treatments or management strategies that are best to manage patient condition</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
### <a href=#clinicalImpressionProtocolId name="clinicalImpressionProtocolId">clinicalImpressionProtocolId</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Clinical Impression Protocol</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_clinicalimpressionprotocolid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the clinicalImpressionProtocolId attribute are listed below.</summary>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_clinicalimpressionprotocolid"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Protocol URI</td></tr><tr><td>description</td><td>Reference to a specific published clinical protocol that was followed during this assessment, and/or that provides evidence in support of the diagnosis.</td></tr><tr><td>dataFormat</td><td>7</td></tr><tr><td>maximumLength</td><td>100</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_uri</td></tr></table>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Protocol URI</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
Status of the Clinical Impression Protocol  
First included in: electronicMedicalRecords/ClinicalImpressionProtocol (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Clinical Impression Protocol</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the Clinical Impression Protocol</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
Reason for the status of the Clinical Impression Protocol  
First included in: electronicMedicalRecords/ClinicalImpressionProtocol (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Clinical Impression Protocol</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the Clinical Impression Protocol</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
