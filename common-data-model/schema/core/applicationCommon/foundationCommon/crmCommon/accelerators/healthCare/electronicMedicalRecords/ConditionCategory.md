---
title: ConditionCategory - Common Data Model | Microsoft Docs
...
A category assigned to the condition.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/ConditionCategory.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="ConditionCategory.md" target="_blank">electronicMedicalRecords/ConditionCategory</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="ConditionCategory.md" target="_blank">electronicMedicalRecords/ConditionCategory</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="ConditionCategory.md" target="_blank">electronicMedicalRecords/ConditionCategory</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="ConditionCategory.md" target="_blank">electronicMedicalRecords/ConditionCategory</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="ConditionCategory.md" target="_blank">electronicMedicalRecords/ConditionCategory</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="ConditionCategory.md" target="_blank">electronicMedicalRecords/ConditionCategory</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="ConditionCategory.md" target="_blank">electronicMedicalRecords/ConditionCategory</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="ConditionCategory.md" target="_blank">electronicMedicalRecords/ConditionCategory</a>|
|[ownerId](#ownerId)|Owner Id|<a href="ConditionCategory.md" target="_blank">electronicMedicalRecords/ConditionCategory</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="ConditionCategory.md" target="_blank">electronicMedicalRecords/ConditionCategory</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="ConditionCategory.md" target="_blank">electronicMedicalRecords/ConditionCategory</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="ConditionCategory.md" target="_blank">electronicMedicalRecords/ConditionCategory</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="ConditionCategory.md" target="_blank">electronicMedicalRecords/ConditionCategory</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="ConditionCategory.md" target="_blank">electronicMedicalRecords/ConditionCategory</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="ConditionCategory.md" target="_blank">electronicMedicalRecords/ConditionCategory</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="ConditionCategory.md" target="_blank">electronicMedicalRecords/ConditionCategory</a>|
|[categoryId](#categoryId)|Categorization of the condition recorded by health care practitioner.|<a href="ConditionCategory.md" target="_blank">electronicMedicalRecords/ConditionCategory</a>|
|[conditionId](#conditionId)|Detailed information about conditions, problems or diagnoses|<a href="ConditionCategory.md" target="_blank">electronicMedicalRecords/ConditionCategory</a>|
|[conditionCategoryId](#conditionCategoryId)|Unique identifier for entity instances|<a href="ConditionCategory.md" target="_blank">electronicMedicalRecords/ConditionCategory</a>|
|[name](#name)|The name of the custom entity.|<a href="ConditionCategory.md" target="_blank">electronicMedicalRecords/ConditionCategory</a>|
|[stateCode](#stateCode)|Status of the Condition Category|<a href="ConditionCategory.md" target="_blank">electronicMedicalRecords/ConditionCategory</a>|
|[stateCode_display](#stateCode_display)||<a href="ConditionCategory.md" target="_blank">electronicMedicalRecords/ConditionCategory</a>|
|[statusCode](#statusCode)|Reason for the status of the Condition Category|<a href="ConditionCategory.md" target="_blank">electronicMedicalRecords/ConditionCategory</a>|
|[statusCode_display](#statusCode_display)||<a href="ConditionCategory.md" target="_blank">electronicMedicalRecords/ConditionCategory</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/ConditionCategory (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Condition Category</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_conditioncategoryid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Condition Category</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Condition Category</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
