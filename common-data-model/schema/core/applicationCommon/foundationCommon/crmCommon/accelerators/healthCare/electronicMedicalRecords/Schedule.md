...
A container for slots of time that may be available for booking appointments.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/Schedule.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/core/applicationCommon/foundationCommon<br>/crmCommon/accelerators/healthCare<br>/electronicMedicalRecords/Schedule.cdm.json<br>/Schedule/hasAttributes/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[Schedule/(resolvedAttributes)/scheduleId](#scheduleId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[Schedule/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="Schedule.md" target="_blank">electronicMedicalRecords/Schedule</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="Schedule.md" target="_blank">electronicMedicalRecords/Schedule</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="Schedule.md" target="_blank">electronicMedicalRecords/Schedule</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="Schedule.md" target="_blank">electronicMedicalRecords/Schedule</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="Schedule.md" target="_blank">electronicMedicalRecords/Schedule</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="Schedule.md" target="_blank">electronicMedicalRecords/Schedule</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="Schedule.md" target="_blank">electronicMedicalRecords/Schedule</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="Schedule.md" target="_blank">electronicMedicalRecords/Schedule</a>|
|[ownerId](#ownerId)|Owner Id|<a href="Schedule.md" target="_blank">electronicMedicalRecords/Schedule</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="Schedule.md" target="_blank">electronicMedicalRecords/Schedule</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="Schedule.md" target="_blank">electronicMedicalRecords/Schedule</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="Schedule.md" target="_blank">electronicMedicalRecords/Schedule</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="Schedule.md" target="_blank">electronicMedicalRecords/Schedule</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="Schedule.md" target="_blank">electronicMedicalRecords/Schedule</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="Schedule.md" target="_blank">electronicMedicalRecords/Schedule</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="Schedule.md" target="_blank">electronicMedicalRecords/Schedule</a>|
|[active](#active)|Whether this schedule record is in active use, or should not be used (such as was entered in error).|<a href="Schedule.md" target="_blank">electronicMedicalRecords/Schedule</a>|
|[actorDeviceId](#actorDeviceId)|This resource identifies an instance or a type of a manufactured item that is used in the provision of healthcare without being substantially changed through that activity.|<a href="Schedule.md" target="_blank">electronicMedicalRecords/Schedule</a>|
|[actorHealthCareServiceId](#actorHealthCareServiceId)|The details of a healthcare service available at a location.|<a href="Schedule.md" target="_blank">electronicMedicalRecords/Schedule</a>|
|[actorLocationId](#actorLocationId)|Details and position information for a physical place where services are provided and resources and participants may be stored, found, contained or accommodated.|<a href="Schedule.md" target="_blank">electronicMedicalRecords/Schedule</a>|
|[actorPatientId](#actorPatientId)|Demographics and other administrative information about an individual or animal receiving care or other health-related services.|<a href="Schedule.md" target="_blank">electronicMedicalRecords/Schedule</a>|
|[actorPractitionerId](#actorPractitionerId)|A person who is directly or indirectly involved in the provisioning of healthcare.|<a href="Schedule.md" target="_blank">electronicMedicalRecords/Schedule</a>|
|[actorPractitionerRoleId](#actorPractitionerRoleId)|A specific set of Roles/Locations/specialties/services that a practitioner may perform at an organization for a period of time.|<a href="Schedule.md" target="_blank">electronicMedicalRecords/Schedule</a>|
|[actorRelatedPersonId](#actorRelatedPersonId)|Information about a person that is involved in the care for a patient, but who is not the target of healthcare, nor has a formal responsibility in the care process.|<a href="Schedule.md" target="_blank">electronicMedicalRecords/Schedule</a>|
|[comment](#comment)|Comments on the availability to describe any extended information. Such as custom constraints on the slots that may be associated.|<a href="Schedule.md" target="_blank">electronicMedicalRecords/Schedule</a>|
|[name](#name)|The name of the custom entity.|<a href="Schedule.md" target="_blank">electronicMedicalRecords/Schedule</a>|
|[planningHorizonEndDateTime](#planningHorizonEndDateTime)|The period End date of time that the slots that are attached to this Schedule resource cover (even if none exist).|<a href="Schedule.md" target="_blank">electronicMedicalRecords/Schedule</a>|
|[planningHorizonStartDateTime](#planningHorizonStartDateTime)|The period of time that the slots that are attached to this Schedule resource cover (even if none exist). These cover the amount of time that an organization's planning horizon.|<a href="Schedule.md" target="_blank">electronicMedicalRecords/Schedule</a>|
|[scheduleId](#scheduleId)|Unique identifier for entity instances|<a href="Schedule.md" target="_blank">electronicMedicalRecords/Schedule</a>|
|[scheduleNumber](#scheduleNumber)|A container for slots of time that may be available for booking appointments.|<a href="Schedule.md" target="_blank">electronicMedicalRecords/Schedule</a>|
|[serviceCategoryId](#serviceCategoryId)|A broad categorization of the service that is to be performed during this appointment.|<a href="Schedule.md" target="_blank">electronicMedicalRecords/Schedule</a>|
|[stateCode](#stateCode)|Status of the Schedule|<a href="Schedule.md" target="_blank">electronicMedicalRecords/Schedule</a>|
|[stateCode_display](#stateCode_display)||<a href="Schedule.md" target="_blank">electronicMedicalRecords/Schedule</a>|
|[statusCode](#statusCode)|Reason for the status of the Schedule|<a href="Schedule.md" target="_blank">electronicMedicalRecords/Schedule</a>|
|[statusCode_display](#statusCode_display)||<a href="Schedule.md" target="_blank">electronicMedicalRecords/Schedule</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/Schedule (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Active</td></tr><tr><td>description</td><td>Whether this schedule record is in active use, or should not be used (such as was entered in error).</td></tr><tr><td>dataFormat</td><td>15</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_active</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Whether this schedule record is in active use, or should not be used (such as was entered in error).</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Comments on the availability to describe any extended information. Such as custom constraints on the slots that may be associated.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
### <a href=#planningHorizonEndDateTime name="planningHorizonEndDateTime">planningHorizonEndDateTime</a>

The period End date of time that the slots that are attached to this Schedule resource cover (even if none exist).  
First included in: electronicMedicalRecords/Schedule (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>End Date Time</td></tr><tr><td>description</td><td>The period End date of time that the slots that are attached to this Schedule resource cover (even if none exist).</td></tr><tr><td>dataFormat</td><td>13</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_planninghorizonenddatetime</td></tr></table>

#### Traits

<details>
<summary>List of traits for the planningHorizonEndDateTime attribute are listed below.</summary>
...
**means.measurement.time**  
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_planninghorizonenddatetime"</td><td>string</td><td></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>The period End date of time that the slots that are attached to this Schedule resource cover (even if none exist).</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
### <a href=#planningHorizonStartDateTime name="planningHorizonStartDateTime">planningHorizonStartDateTime</a>

The period of time that the slots that are attached to this Schedule resource cover (even if none exist). These cover the amount of time that an organization's planning horizon.  
First included in: electronicMedicalRecords/Schedule (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Start Date Time</td></tr><tr><td>description</td><td>The period of time that the slots that are attached to this Schedule resource cover (even if none exist). These cover the amount of time that an organization's planning horizon.</td></tr><tr><td>dataFormat</td><td>13</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_planninghorizonstartdatetime</td></tr></table>

#### Traits

<details>
<summary>List of traits for the planningHorizonStartDateTime attribute are listed below.</summary>
...
**means.measurement.time**  
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_planninghorizonstartdatetime"</td><td>string</td><td></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>The period of time that the slots that are attached to this Schedule resource cover (even if none exist). These cover the amount of time that an organization's planning horizon.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Schedule</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_scheduleid</td></tr></table>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_scheduleid"</td><td>string</td><td></td></tr></table>
...
### <a href=#scheduleNumber name="scheduleNumber">scheduleNumber</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Schedule Number</td></tr><tr><td>description</td><td>A container for slots of time that may be available for booking appointments.</td></tr><tr><td>dataFormat</td><td>7</td></tr><tr><td>maximumLength</td><td>100</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_schedulenumber</td></tr></table>

#### Traits

<details>
<summary>List of traits for the scheduleNumber attribute are listed below.</summary>

**is.dataFormat.character**  
**is.dataFormat.big**  
**is.dataFormat.array**  
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_schedulenumber"</td><td>string</td><td></td></tr></table>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Schedule Number</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Schedule</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the Schedule</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Schedule</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the Schedule</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
