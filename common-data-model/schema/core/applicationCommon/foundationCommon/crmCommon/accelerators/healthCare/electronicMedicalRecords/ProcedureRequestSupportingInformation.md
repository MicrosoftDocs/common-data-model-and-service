...
Additional clinical information about the patient or specimen that may influence the procedure or diagnostics or their interpretations.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/ProcedureRequestSupportingInformation.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="ProcedureRequestSupportingInformation.md" target="_blank">electronicMedicalRecords/ProcedureRequestSupportingInformation</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="ProcedureRequestSupportingInformation.md" target="_blank">electronicMedicalRecords/ProcedureRequestSupportingInformation</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="ProcedureRequestSupportingInformation.md" target="_blank">electronicMedicalRecords/ProcedureRequestSupportingInformation</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="ProcedureRequestSupportingInformation.md" target="_blank">electronicMedicalRecords/ProcedureRequestSupportingInformation</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="ProcedureRequestSupportingInformation.md" target="_blank">electronicMedicalRecords/ProcedureRequestSupportingInformation</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="ProcedureRequestSupportingInformation.md" target="_blank">electronicMedicalRecords/ProcedureRequestSupportingInformation</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="ProcedureRequestSupportingInformation.md" target="_blank">electronicMedicalRecords/ProcedureRequestSupportingInformation</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="ProcedureRequestSupportingInformation.md" target="_blank">electronicMedicalRecords/ProcedureRequestSupportingInformation</a>|
|[ownerId](#ownerId)|Owner Id|<a href="ProcedureRequestSupportingInformation.md" target="_blank">electronicMedicalRecords/ProcedureRequestSupportingInformation</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="ProcedureRequestSupportingInformation.md" target="_blank">electronicMedicalRecords/ProcedureRequestSupportingInformation</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="ProcedureRequestSupportingInformation.md" target="_blank">electronicMedicalRecords/ProcedureRequestSupportingInformation</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="ProcedureRequestSupportingInformation.md" target="_blank">electronicMedicalRecords/ProcedureRequestSupportingInformation</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="ProcedureRequestSupportingInformation.md" target="_blank">electronicMedicalRecords/ProcedureRequestSupportingInformation</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="ProcedureRequestSupportingInformation.md" target="_blank">electronicMedicalRecords/ProcedureRequestSupportingInformation</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="ProcedureRequestSupportingInformation.md" target="_blank">electronicMedicalRecords/ProcedureRequestSupportingInformation</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="ProcedureRequestSupportingInformation.md" target="_blank">electronicMedicalRecords/ProcedureRequestSupportingInformation</a>|
|[name](#name)|The name of the custom entity.|<a href="ProcedureRequestSupportingInformation.md" target="_blank">electronicMedicalRecords/ProcedureRequestSupportingInformation</a>|
|[procedureRequestId](#procedureRequestId)|Unique identifier for the Procedure Request|<a href="ProcedureRequestSupportingInformation.md" target="_blank">electronicMedicalRecords/ProcedureRequestSupportingInformation</a>|
|[procedureRequestSupportingInformationId](#procedureRequestSupportingInformationId)|Unique identifier for entity instances|<a href="ProcedureRequestSupportingInformation.md" target="_blank">electronicMedicalRecords/ProcedureRequestSupportingInformation</a>|
|[supportingInfo](#supportingInfo)|Any additional (administrative, financial or clinical) information required to support request for referral or transfer of care.|<a href="ProcedureRequestSupportingInformation.md" target="_blank">electronicMedicalRecords/ProcedureRequestSupportingInformation</a>|
|[stateCode](#stateCode)|Status of the Procedure Request Supporting Information|<a href="ProcedureRequestSupportingInformation.md" target="_blank">electronicMedicalRecords/ProcedureRequestSupportingInformation</a>|
|[stateCode_display](#stateCode_display)||<a href="ProcedureRequestSupportingInformation.md" target="_blank">electronicMedicalRecords/ProcedureRequestSupportingInformation</a>|
|[statusCode](#statusCode)|Reason for the status of the Procedure Request Supporting Information|<a href="ProcedureRequestSupportingInformation.md" target="_blank">electronicMedicalRecords/ProcedureRequestSupportingInformation</a>|
|[statusCode_display](#statusCode_display)||<a href="ProcedureRequestSupportingInformation.md" target="_blank">electronicMedicalRecords/ProcedureRequestSupportingInformation</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/ProcedureRequestSupportingInformation (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Procedure Request Supporting Information</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_procedurerequestsupportinginformationid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Procedure Request Supporting Information</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Procedure Request Supporting Information</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
