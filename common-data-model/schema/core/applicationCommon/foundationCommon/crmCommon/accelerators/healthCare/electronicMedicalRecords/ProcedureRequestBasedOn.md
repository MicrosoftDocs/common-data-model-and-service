...
Plan/proposal/order fulfilled by this request.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/ProcedureRequestBasedOn.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="ProcedureRequestBasedOn.md" target="_blank">electronicMedicalRecords/ProcedureRequestBasedOn</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="ProcedureRequestBasedOn.md" target="_blank">electronicMedicalRecords/ProcedureRequestBasedOn</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="ProcedureRequestBasedOn.md" target="_blank">electronicMedicalRecords/ProcedureRequestBasedOn</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="ProcedureRequestBasedOn.md" target="_blank">electronicMedicalRecords/ProcedureRequestBasedOn</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="ProcedureRequestBasedOn.md" target="_blank">electronicMedicalRecords/ProcedureRequestBasedOn</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="ProcedureRequestBasedOn.md" target="_blank">electronicMedicalRecords/ProcedureRequestBasedOn</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="ProcedureRequestBasedOn.md" target="_blank">electronicMedicalRecords/ProcedureRequestBasedOn</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="ProcedureRequestBasedOn.md" target="_blank">electronicMedicalRecords/ProcedureRequestBasedOn</a>|
|[ownerId](#ownerId)|Owner Id|<a href="ProcedureRequestBasedOn.md" target="_blank">electronicMedicalRecords/ProcedureRequestBasedOn</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="ProcedureRequestBasedOn.md" target="_blank">electronicMedicalRecords/ProcedureRequestBasedOn</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="ProcedureRequestBasedOn.md" target="_blank">electronicMedicalRecords/ProcedureRequestBasedOn</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="ProcedureRequestBasedOn.md" target="_blank">electronicMedicalRecords/ProcedureRequestBasedOn</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="ProcedureRequestBasedOn.md" target="_blank">electronicMedicalRecords/ProcedureRequestBasedOn</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="ProcedureRequestBasedOn.md" target="_blank">electronicMedicalRecords/ProcedureRequestBasedOn</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="ProcedureRequestBasedOn.md" target="_blank">electronicMedicalRecords/ProcedureRequestBasedOn</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="ProcedureRequestBasedOn.md" target="_blank">electronicMedicalRecords/ProcedureRequestBasedOn</a>|
|[basedOn](#basedOn)|Plan/proposal/order fulfilled by this request.|<a href="ProcedureRequestBasedOn.md" target="_blank">electronicMedicalRecords/ProcedureRequestBasedOn</a>|
|[name](#name)|The name of the custom entity.|<a href="ProcedureRequestBasedOn.md" target="_blank">electronicMedicalRecords/ProcedureRequestBasedOn</a>|
|[procedureRequestId](#procedureRequestId)|Unique identifier for the Procedure Request.|<a href="ProcedureRequestBasedOn.md" target="_blank">electronicMedicalRecords/ProcedureRequestBasedOn</a>|
|[procedureRequestBasedOnId](#procedureRequestBasedOnId)|Unique identifier for entity instances|<a href="ProcedureRequestBasedOn.md" target="_blank">electronicMedicalRecords/ProcedureRequestBasedOn</a>|
|[stateCode](#stateCode)|Status of the Procedure Request Based On|<a href="ProcedureRequestBasedOn.md" target="_blank">electronicMedicalRecords/ProcedureRequestBasedOn</a>|
|[stateCode_display](#stateCode_display)||<a href="ProcedureRequestBasedOn.md" target="_blank">electronicMedicalRecords/ProcedureRequestBasedOn</a>|
|[statusCode](#statusCode)|Reason for the status of the Procedure Request Based On|<a href="ProcedureRequestBasedOn.md" target="_blank">electronicMedicalRecords/ProcedureRequestBasedOn</a>|
|[statusCode_display](#statusCode_display)||<a href="ProcedureRequestBasedOn.md" target="_blank">electronicMedicalRecords/ProcedureRequestBasedOn</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/ProcedureRequestBasedOn (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Based on</td></tr><tr><td>description</td><td>Plan/proposal/order fulfilled by this request.</td></tr><tr><td>dataFormat</td><td>7</td></tr><tr><td>maximumLength</td><td>2000</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_basedon</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Procedure Request Based On</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_procedurerequestbasedonid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Procedure Request Based On</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Procedure Request Based On</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
