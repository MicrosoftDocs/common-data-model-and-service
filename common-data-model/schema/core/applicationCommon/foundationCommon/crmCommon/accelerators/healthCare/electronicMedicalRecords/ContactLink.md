---
title: ContactLink - Common Data Model | Microsoft Docs
description: Link to another patient entity that concerns the same actual patient.
author: nenad1002
...
Link to another patient entity that concerns the same actual patient.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/ContactLink.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/core/applicationCommon/foundationCommon<br>/crmCommon/accelerators/healthCare<br>/electronicMedicalRecords/ContactLink.cdm.json<br>/ContactLink/hasAttributes<br>/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[ContactLink/(resolvedAttributes)/contactLinkId](#contactLinkId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[ContactLink/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Contact Link</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Link to another patient entity that concerns the same actual patient.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_contactlink"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="ContactLink.md" target="_blank">electronicMedicalRecords/ContactLink</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="ContactLink.md" target="_blank">electronicMedicalRecords/ContactLink</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="ContactLink.md" target="_blank">electronicMedicalRecords/ContactLink</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="ContactLink.md" target="_blank">electronicMedicalRecords/ContactLink</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="ContactLink.md" target="_blank">electronicMedicalRecords/ContactLink</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="ContactLink.md" target="_blank">electronicMedicalRecords/ContactLink</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="ContactLink.md" target="_blank">electronicMedicalRecords/ContactLink</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="ContactLink.md" target="_blank">electronicMedicalRecords/ContactLink</a>|
|[ownerId](#ownerId)|Owner Id|<a href="ContactLink.md" target="_blank">electronicMedicalRecords/ContactLink</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="ContactLink.md" target="_blank">electronicMedicalRecords/ContactLink</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="ContactLink.md" target="_blank">electronicMedicalRecords/ContactLink</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="ContactLink.md" target="_blank">electronicMedicalRecords/ContactLink</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="ContactLink.md" target="_blank">electronicMedicalRecords/ContactLink</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="ContactLink.md" target="_blank">electronicMedicalRecords/ContactLink</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="ContactLink.md" target="_blank">electronicMedicalRecords/ContactLink</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="ContactLink.md" target="_blank">electronicMedicalRecords/ContactLink</a>|
|[contactLinkId](#contactLinkId)|Unique identifier for entity instances|<a href="ContactLink.md" target="_blank">electronicMedicalRecords/ContactLink</a>|
|[linkId](#linkId)|Link to another patient resource that concerns the same actual patient.|<a href="ContactLink.md" target="_blank">electronicMedicalRecords/ContactLink</a>|
|[linkTypeId](#linkTypeId)|The type of link between this patient resource and another patient resource.|<a href="ContactLink.md" target="_blank">electronicMedicalRecords/ContactLink</a>|
|[name](#name)|The name of the custom entity.|<a href="ContactLink.md" target="_blank">electronicMedicalRecords/ContactLink</a>|
|[patientId](#patientId)|Information about a person whose communication preference is documented here|<a href="ContactLink.md" target="_blank">electronicMedicalRecords/ContactLink</a>|
|[stateCode](#stateCode)|Status of the Contact Link|<a href="ContactLink.md" target="_blank">electronicMedicalRecords/ContactLink</a>|
|[stateCode_display](#stateCode_display)||<a href="ContactLink.md" target="_blank">electronicMedicalRecords/ContactLink</a>|
|[statusCode](#statusCode)|Reason for the status of the Contact Link|<a href="ContactLink.md" target="_blank">electronicMedicalRecords/ContactLink</a>|
|[statusCode_display](#statusCode_display)||<a href="ContactLink.md" target="_blank">electronicMedicalRecords/ContactLink</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/ContactLink (this entity)  
...
### <a href=#contactLinkId name="contactLinkId">contactLinkId</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Contact Link</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_contactlinkid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the contactLinkId attribute are listed below.</summary>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_contactlinkid"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Patient Link</td></tr><tr><td>description</td><td>Link to another patient resource that concerns the same actual patient.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_link</td></tr></table>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Patient Link</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_link"</td><td>string</td><td></td></tr></table>
...
### <a href=#linkTypeId name="linkTypeId">linkTypeId</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Patient Link Type</td></tr><tr><td>description</td><td>The type of link between this patient resource and another patient resource.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_linktype</td></tr></table>

#### Traits

<details>
<summary>List of traits for the linkTypeId attribute are listed below.</summary>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Patient Link Type</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_linktype"</td><td>string</td><td></td></tr></table>
...
Information about a person whose communication preference is documented here  
First included in: electronicMedicalRecords/ContactLink (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Patient</td></tr><tr><td>description</td><td>Information about a person whose communication preference is documented here</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_patient</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Information about a person whose communication preference is documented here</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the Contact Link</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the Contact Link</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
