---
title: ReferenceRangeAppliesTo - Common Data Model | Microsoft Docs
...
# Reference Range Applies To
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/ReferenceRangeAppliesTo.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="ReferenceRangeAppliesTo.md" target="_blank">electronicMedicalRecords/ReferenceRangeAppliesTo</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="ReferenceRangeAppliesTo.md" target="_blank">electronicMedicalRecords/ReferenceRangeAppliesTo</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="ReferenceRangeAppliesTo.md" target="_blank">electronicMedicalRecords/ReferenceRangeAppliesTo</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="ReferenceRangeAppliesTo.md" target="_blank">electronicMedicalRecords/ReferenceRangeAppliesTo</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="ReferenceRangeAppliesTo.md" target="_blank">electronicMedicalRecords/ReferenceRangeAppliesTo</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="ReferenceRangeAppliesTo.md" target="_blank">electronicMedicalRecords/ReferenceRangeAppliesTo</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="ReferenceRangeAppliesTo.md" target="_blank">electronicMedicalRecords/ReferenceRangeAppliesTo</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="ReferenceRangeAppliesTo.md" target="_blank">electronicMedicalRecords/ReferenceRangeAppliesTo</a>|
|[ownerId](#ownerId)|Owner Id|<a href="ReferenceRangeAppliesTo.md" target="_blank">electronicMedicalRecords/ReferenceRangeAppliesTo</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="ReferenceRangeAppliesTo.md" target="_blank">electronicMedicalRecords/ReferenceRangeAppliesTo</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="ReferenceRangeAppliesTo.md" target="_blank">electronicMedicalRecords/ReferenceRangeAppliesTo</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="ReferenceRangeAppliesTo.md" target="_blank">electronicMedicalRecords/ReferenceRangeAppliesTo</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="ReferenceRangeAppliesTo.md" target="_blank">electronicMedicalRecords/ReferenceRangeAppliesTo</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="ReferenceRangeAppliesTo.md" target="_blank">electronicMedicalRecords/ReferenceRangeAppliesTo</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="ReferenceRangeAppliesTo.md" target="_blank">electronicMedicalRecords/ReferenceRangeAppliesTo</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="ReferenceRangeAppliesTo.md" target="_blank">electronicMedicalRecords/ReferenceRangeAppliesTo</a>|
|[code](#code)||<a href="ReferenceRangeAppliesTo.md" target="_blank">electronicMedicalRecords/ReferenceRangeAppliesTo</a>|
|[display](#display)|The name of the custom entity.|<a href="ReferenceRangeAppliesTo.md" target="_blank">electronicMedicalRecords/ReferenceRangeAppliesTo</a>|
|[referenceRangeAppliesToId](#referenceRangeAppliesToId)|Unique identifier for entity instances|<a href="ReferenceRangeAppliesTo.md" target="_blank">electronicMedicalRecords/ReferenceRangeAppliesTo</a>|
|[system](#system)||<a href="ReferenceRangeAppliesTo.md" target="_blank">electronicMedicalRecords/ReferenceRangeAppliesTo</a>|
|[stateCode](#stateCode)|Status of the Reference Range Applies To|<a href="ReferenceRangeAppliesTo.md" target="_blank">electronicMedicalRecords/ReferenceRangeAppliesTo</a>|
|[stateCode_display](#stateCode_display)||<a href="ReferenceRangeAppliesTo.md" target="_blank">electronicMedicalRecords/ReferenceRangeAppliesTo</a>|
|[statusCode](#statusCode)|Reason for the status of the Reference Range Applies To|<a href="ReferenceRangeAppliesTo.md" target="_blank">electronicMedicalRecords/ReferenceRangeAppliesTo</a>|
|[statusCode_display](#statusCode_display)||<a href="ReferenceRangeAppliesTo.md" target="_blank">electronicMedicalRecords/ReferenceRangeAppliesTo</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/ReferenceRangeAppliesTo (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Reference Range Applies To</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_referencerangeappliestoid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Reference Range Applies To</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Reference Range Applies To</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
