---
title: ProcedureBasedOn - Common Data Model | Microsoft Docs
...
A reference to a resource that contains details of the request for this procedure.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/ProcedureBasedOn.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="ProcedureBasedOn.md" target="_blank">electronicMedicalRecords/ProcedureBasedOn</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="ProcedureBasedOn.md" target="_blank">electronicMedicalRecords/ProcedureBasedOn</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="ProcedureBasedOn.md" target="_blank">electronicMedicalRecords/ProcedureBasedOn</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="ProcedureBasedOn.md" target="_blank">electronicMedicalRecords/ProcedureBasedOn</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="ProcedureBasedOn.md" target="_blank">electronicMedicalRecords/ProcedureBasedOn</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="ProcedureBasedOn.md" target="_blank">electronicMedicalRecords/ProcedureBasedOn</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="ProcedureBasedOn.md" target="_blank">electronicMedicalRecords/ProcedureBasedOn</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="ProcedureBasedOn.md" target="_blank">electronicMedicalRecords/ProcedureBasedOn</a>|
|[ownerId](#ownerId)|Owner Id|<a href="ProcedureBasedOn.md" target="_blank">electronicMedicalRecords/ProcedureBasedOn</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="ProcedureBasedOn.md" target="_blank">electronicMedicalRecords/ProcedureBasedOn</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="ProcedureBasedOn.md" target="_blank">electronicMedicalRecords/ProcedureBasedOn</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="ProcedureBasedOn.md" target="_blank">electronicMedicalRecords/ProcedureBasedOn</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="ProcedureBasedOn.md" target="_blank">electronicMedicalRecords/ProcedureBasedOn</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="ProcedureBasedOn.md" target="_blank">electronicMedicalRecords/ProcedureBasedOn</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="ProcedureBasedOn.md" target="_blank">electronicMedicalRecords/ProcedureBasedOn</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="ProcedureBasedOn.md" target="_blank">electronicMedicalRecords/ProcedureBasedOn</a>|
|[basedOnCarePlanId](#basedOnCarePlanId)|A reference to a resource that contains details of the request for this procedure.|<a href="ProcedureBasedOn.md" target="_blank">electronicMedicalRecords/ProcedureBasedOn</a>|
|[basedOnProcRequestId](#basedOnProcRequestId)|A reference to a resource that contains details of the request for this procedure.|<a href="ProcedureBasedOn.md" target="_blank">electronicMedicalRecords/ProcedureBasedOn</a>|
|[basedOnRefRequestId](#basedOnRefRequestId)|A reference to a resource that contains details of the request for this procedure.|<a href="ProcedureBasedOn.md" target="_blank">electronicMedicalRecords/ProcedureBasedOn</a>|
|[basedOnType](#basedOnType)|Procedure based on type|<a href="ProcedureBasedOn.md" target="_blank">electronicMedicalRecords/ProcedureBasedOn</a>|
|[basedOnType_display](#basedOnType_display)||<a href="ProcedureBasedOn.md" target="_blank">electronicMedicalRecords/ProcedureBasedOn</a>|
|[name](#name)|The name of the custom entity.|<a href="ProcedureBasedOn.md" target="_blank">electronicMedicalRecords/ProcedureBasedOn</a>|
|[procedureId](#procedureId)|An action that is or was performed on a patient. This can be a physical intervention like an operation, or less invasive like counseling or hypnotherapy.|<a href="ProcedureBasedOn.md" target="_blank">electronicMedicalRecords/ProcedureBasedOn</a>|
|[procedureBasedOnId](#procedureBasedOnId)|Unique identifier for entity instances|<a href="ProcedureBasedOn.md" target="_blank">electronicMedicalRecords/ProcedureBasedOn</a>|
|[stateCode](#stateCode)|Status of the Procedure Based On|<a href="ProcedureBasedOn.md" target="_blank">electronicMedicalRecords/ProcedureBasedOn</a>|
|[stateCode_display](#stateCode_display)||<a href="ProcedureBasedOn.md" target="_blank">electronicMedicalRecords/ProcedureBasedOn</a>|
|[statusCode](#statusCode)|Reason for the status of the Procedure Based On|<a href="ProcedureBasedOn.md" target="_blank">electronicMedicalRecords/ProcedureBasedOn</a>|
|[statusCode_display](#statusCode_display)||<a href="ProcedureBasedOn.md" target="_blank">electronicMedicalRecords/ProcedureBasedOn</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/ProcedureBasedOn (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Procedure Based On</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_procedurebasedonid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Procedure Based On</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Procedure Based On</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
