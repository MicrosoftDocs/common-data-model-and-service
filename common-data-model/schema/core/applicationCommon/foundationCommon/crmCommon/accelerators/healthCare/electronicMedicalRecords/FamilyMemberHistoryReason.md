---
title: FamilyMemberHistoryReason - Common Data Model | Microsoft Docs
...
# Family Member History Reason

Describes why the family member history occurred in coded or textual form.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/FamilyMemberHistoryReason.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/core/applicationCommon/foundationCommon<br>/crmCommon/accelerators/healthCare<br>/electronicMedicalRecords<br>/FamilyMemberHistoryReason.cdm.json<br>/FamilyMemberHistoryReason/hasAttributes<br>/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[FamilyMemberHistoryReason/(resolvedAttributes)/familyMemberHistoryReasonId](#familyMemberHistoryReasonId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[FamilyMemberHistoryReason/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Family Member History Reason</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Describes why the family member history occurred in coded or textual form.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_familymemberhistoryreason"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="FamilyMemberHistoryReason.md" target="_blank">electronicMedicalRecords/FamilyMemberHistoryReason</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="FamilyMemberHistoryReason.md" target="_blank">electronicMedicalRecords/FamilyMemberHistoryReason</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="FamilyMemberHistoryReason.md" target="_blank">electronicMedicalRecords/FamilyMemberHistoryReason</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="FamilyMemberHistoryReason.md" target="_blank">electronicMedicalRecords/FamilyMemberHistoryReason</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="FamilyMemberHistoryReason.md" target="_blank">electronicMedicalRecords/FamilyMemberHistoryReason</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="FamilyMemberHistoryReason.md" target="_blank">electronicMedicalRecords/FamilyMemberHistoryReason</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="FamilyMemberHistoryReason.md" target="_blank">electronicMedicalRecords/FamilyMemberHistoryReason</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="FamilyMemberHistoryReason.md" target="_blank">electronicMedicalRecords/FamilyMemberHistoryReason</a>|
|[ownerId](#ownerId)|Owner Id|<a href="FamilyMemberHistoryReason.md" target="_blank">electronicMedicalRecords/FamilyMemberHistoryReason</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="FamilyMemberHistoryReason.md" target="_blank">electronicMedicalRecords/FamilyMemberHistoryReason</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="FamilyMemberHistoryReason.md" target="_blank">electronicMedicalRecords/FamilyMemberHistoryReason</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="FamilyMemberHistoryReason.md" target="_blank">electronicMedicalRecords/FamilyMemberHistoryReason</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="FamilyMemberHistoryReason.md" target="_blank">electronicMedicalRecords/FamilyMemberHistoryReason</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="FamilyMemberHistoryReason.md" target="_blank">electronicMedicalRecords/FamilyMemberHistoryReason</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="FamilyMemberHistoryReason.md" target="_blank">electronicMedicalRecords/FamilyMemberHistoryReason</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="FamilyMemberHistoryReason.md" target="_blank">electronicMedicalRecords/FamilyMemberHistoryReason</a>|
|[familyMemberHistoryId](#familyMemberHistoryId)|Information about patient's relatives, relevant for patient|<a href="FamilyMemberHistoryReason.md" target="_blank">electronicMedicalRecords/FamilyMemberHistoryReason</a>|
|[familyMemberHistoryReasonId](#familyMemberHistoryReasonId)|Unique identifier for entity instances|<a href="FamilyMemberHistoryReason.md" target="_blank">electronicMedicalRecords/FamilyMemberHistoryReason</a>|
|[name](#name)|The name of the custom entity.|<a href="FamilyMemberHistoryReason.md" target="_blank">electronicMedicalRecords/FamilyMemberHistoryReason</a>|
|[reasonCodeId](#reasonCodeId)|Describes why the family member history occurred in coded or textual form|<a href="FamilyMemberHistoryReason.md" target="_blank">electronicMedicalRecords/FamilyMemberHistoryReason</a>|
|[reasonCodeText](#reasonCodeText)|Describes why the family member history occurred in coded or textual form|<a href="FamilyMemberHistoryReason.md" target="_blank">electronicMedicalRecords/FamilyMemberHistoryReason</a>|
|[reasonCodeType](#reasonCodeType)|Type of reason why the family member history occurred.|<a href="FamilyMemberHistoryReason.md" target="_blank">electronicMedicalRecords/FamilyMemberHistoryReason</a>|
|[reasonCodeType_display](#reasonCodeType_display)||<a href="FamilyMemberHistoryReason.md" target="_blank">electronicMedicalRecords/FamilyMemberHistoryReason</a>|
|[stateCode](#stateCode)|Status of the Family Member History Reason|<a href="FamilyMemberHistoryReason.md" target="_blank">electronicMedicalRecords/FamilyMemberHistoryReason</a>|
|[stateCode_display](#stateCode_display)||<a href="FamilyMemberHistoryReason.md" target="_blank">electronicMedicalRecords/FamilyMemberHistoryReason</a>|
|[statusCode](#statusCode)|Reason for the status of the Family Member History Reason|<a href="FamilyMemberHistoryReason.md" target="_blank">electronicMedicalRecords/FamilyMemberHistoryReason</a>|
|[statusCode_display](#statusCode_display)||<a href="FamilyMemberHistoryReason.md" target="_blank">electronicMedicalRecords/FamilyMemberHistoryReason</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/FamilyMemberHistoryReason (this entity)  
...
### <a href=#familyMemberHistoryReasonId name="familyMemberHistoryReasonId">familyMemberHistoryReasonId</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Family Member History Reason</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_familymemberhistoryreasonid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the familyMemberHistoryReasonId attribute are listed below.</summary>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_familymemberhistoryreasonid"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Reason Code</td></tr><tr><td>description</td><td>Describes why the family member history occurred in coded or textual form</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_reasoncode</td></tr></table>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_reasoncode"</td><td>string</td><td></td></tr></table>
...
### <a href=#reasonCodeText name="reasonCodeText">reasonCodeText</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Reason Code Text</td></tr><tr><td>description</td><td>Describes why the family member history occurred in coded or textual form</td></tr><tr><td>dataFormat</td><td>7</td></tr><tr><td>maximumLength</td><td>100</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_reasoncodetext</td></tr></table>

#### Traits

<details>
<summary>List of traits for the reasonCodeText attribute are listed below.</summary>

**is.dataFormat.character**  
**is.dataFormat.big**  
**is.dataFormat.array**  
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_reasoncodetext"</td><td>string</td><td></td></tr></table>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason Code Text</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
### <a href=#reasonCodeType name="reasonCodeType">reasonCodeType</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Reason Code Type</td></tr><tr><td>description</td><td>Type of reason why the family member history occurred.</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_reasoncodetype</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Code</td><td>935000000</td></tr><tr><td>en</td><td>Text</td><td>935000001</td></tr></table></td></tr></table>

#### Traits

<details>
<summary>List of traits for the reasonCodeType attribute are listed below.</summary>

**is.dataFormat.integer**  
**does.haveDefault**  
An attribute has a default value  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>default</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Code</td><td>935000000</td></tr><tr><td>en</td><td>Text</td><td>935000001</td></tr></table></td><td>any</td><td></td></tr></table>

**is.constrainedList**  
the values of an attribute are taken from or looked up from a fixed list of possibilities  

**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_reasoncodetype"</td><td>string</td><td></td></tr></table>

**is.requiredAtLevel**  
The requirement level for setting values into this attribute in CDS for Applications or for including this attribute in entities created in CDS for Analytics  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>level</td><td>"none"</td><td>string</td><td>values can be: 'systemrequired', 'required', 'recommended', 'none'</td></tr></table>

**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason Code Type</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
### <a href=#reasonCodeType_display name="reasonCodeType_display">reasonCodeType_display</a>
...
<details>
<summary>List of traits for the reasonCodeType_display attribute are listed below.</summary>
...
**is.readOnly**  
**is.addedInSupportOf**  
<table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>inSupportOf</td><td>"reasonCodeType"</td><td>attributeName</td><td>output parameter naming the attribute that is being supported</td></tr></table>
...
Status of the Family Member History Reason  
First included in: electronicMedicalRecords/FamilyMemberHistoryReason (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Family Member History Reason</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the Family Member History Reason</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
Reason for the status of the Family Member History Reason  
First included in: electronicMedicalRecords/FamilyMemberHistoryReason (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Family Member History Reason</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
