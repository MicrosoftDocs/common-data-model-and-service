---
title: DeviceRequestReasonReference in electronicMedicalRecords - Common Data Model | Microsoft Docs
...
# Device Request Reason Reference in electronicMedicalRecords

Reason or justification for the use of this device.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/DeviceRequestReasonReference.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/core/applicationCommon/foundationCommon<br>/crmCommon/accelerators/healthCare<br>/electronicMedicalRecords<br>/DeviceRequestReasonReference.cdm.json<br>/DeviceRequestReasonReference/hasAttributes<br>/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[DeviceRequestReasonReference/(resolvedAttributes)/deviceRequestReasonReferenceId](#deviceRequestReasonReferenceId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[DeviceRequestReasonReference/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Device Request Reason Reference</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_devicerequestreasonreference"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="DeviceRequestReasonReference.md" target="_blank">electronicMedicalRecords/DeviceRequestReasonReference</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="DeviceRequestReasonReference.md" target="_blank">electronicMedicalRecords/DeviceRequestReasonReference</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="DeviceRequestReasonReference.md" target="_blank">electronicMedicalRecords/DeviceRequestReasonReference</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="DeviceRequestReasonReference.md" target="_blank">electronicMedicalRecords/DeviceRequestReasonReference</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="DeviceRequestReasonReference.md" target="_blank">electronicMedicalRecords/DeviceRequestReasonReference</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="DeviceRequestReasonReference.md" target="_blank">electronicMedicalRecords/DeviceRequestReasonReference</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="DeviceRequestReasonReference.md" target="_blank">electronicMedicalRecords/DeviceRequestReasonReference</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="DeviceRequestReasonReference.md" target="_blank">electronicMedicalRecords/DeviceRequestReasonReference</a>|
|[ownerId](#ownerId)|Owner Id|<a href="DeviceRequestReasonReference.md" target="_blank">electronicMedicalRecords/DeviceRequestReasonReference</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="DeviceRequestReasonReference.md" target="_blank">electronicMedicalRecords/DeviceRequestReasonReference</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="DeviceRequestReasonReference.md" target="_blank">electronicMedicalRecords/DeviceRequestReasonReference</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="DeviceRequestReasonReference.md" target="_blank">electronicMedicalRecords/DeviceRequestReasonReference</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="DeviceRequestReasonReference.md" target="_blank">electronicMedicalRecords/DeviceRequestReasonReference</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="DeviceRequestReasonReference.md" target="_blank">electronicMedicalRecords/DeviceRequestReasonReference</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="DeviceRequestReasonReference.md" target="_blank">electronicMedicalRecords/DeviceRequestReasonReference</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="DeviceRequestReasonReference.md" target="_blank">electronicMedicalRecords/DeviceRequestReasonReference</a>|
|[deviceRequestId](#deviceRequestId)|Identifier for Device Request|<a href="DeviceRequestReasonReference.md" target="_blank">electronicMedicalRecords/DeviceRequestReasonReference</a>|
|[deviceRequestReasonReferenceId](#deviceRequestReasonReferenceId)|Unique identifier for entity instances|<a href="DeviceRequestReasonReference.md" target="_blank">electronicMedicalRecords/DeviceRequestReasonReference</a>|
|[name](#name)|The name of the custom entity.|<a href="DeviceRequestReasonReference.md" target="_blank">electronicMedicalRecords/DeviceRequestReasonReference</a>|
|[reasonReference](#reasonReference)|Reason or justification for the use of this device.|<a href="DeviceRequestReasonReference.md" target="_blank">electronicMedicalRecords/DeviceRequestReasonReference</a>|
|[stateCode](#stateCode)|Status of the Device Request Reason Reference|<a href="DeviceRequestReasonReference.md" target="_blank">electronicMedicalRecords/DeviceRequestReasonReference</a>|
|[stateCode_display](#stateCode_display)||<a href="DeviceRequestReasonReference.md" target="_blank">electronicMedicalRecords/DeviceRequestReasonReference</a>|
|[statusCode](#statusCode)|Reason for the status of the Device Request Reason Reference|<a href="DeviceRequestReasonReference.md" target="_blank">electronicMedicalRecords/DeviceRequestReasonReference</a>|
|[statusCode_display](#statusCode_display)||<a href="DeviceRequestReasonReference.md" target="_blank">electronicMedicalRecords/DeviceRequestReasonReference</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/DeviceRequestReasonReference (this entity)  
...
### <a href=#deviceRequestReasonReferenceId name="deviceRequestReasonReferenceId">deviceRequestReasonReferenceId</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Device Request Reason Reference</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>sourceName</td><td>msemr_devicerequestreasonreferenceid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the deviceRequestReasonReferenceId attribute are listed below.</summary>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_devicerequestreasonreferenceid"</td><td>string</td><td></td></tr></table>
...
Status of the Device Request Reason Reference  
First included in: electronicMedicalRecords/DeviceRequestReasonReference (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Device Request Reason Reference</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
