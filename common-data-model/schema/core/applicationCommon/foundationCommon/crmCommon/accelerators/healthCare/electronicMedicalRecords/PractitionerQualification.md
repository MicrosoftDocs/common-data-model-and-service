...
- **is.identifiedBy**  
  ...
  ```
  "PractitionerQualification/hasAttributes/practitionerQualificationId"
  ```
...
- **means.entityState**  
  ...
  ```
  "PractitionerQualification/hasAttributes/stateCode"
  ```
