---
title: ProcedureComplication - Common Data Model | Microsoft Docs
...
Any complications that occurred during the procedure, or in the immediate post-performance period.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/ProcedureComplication.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="ProcedureComplication.md" target="_blank">electronicMedicalRecords/ProcedureComplication</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="ProcedureComplication.md" target="_blank">electronicMedicalRecords/ProcedureComplication</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="ProcedureComplication.md" target="_blank">electronicMedicalRecords/ProcedureComplication</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="ProcedureComplication.md" target="_blank">electronicMedicalRecords/ProcedureComplication</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="ProcedureComplication.md" target="_blank">electronicMedicalRecords/ProcedureComplication</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="ProcedureComplication.md" target="_blank">electronicMedicalRecords/ProcedureComplication</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="ProcedureComplication.md" target="_blank">electronicMedicalRecords/ProcedureComplication</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="ProcedureComplication.md" target="_blank">electronicMedicalRecords/ProcedureComplication</a>|
|[ownerId](#ownerId)|Owner Id|<a href="ProcedureComplication.md" target="_blank">electronicMedicalRecords/ProcedureComplication</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="ProcedureComplication.md" target="_blank">electronicMedicalRecords/ProcedureComplication</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="ProcedureComplication.md" target="_blank">electronicMedicalRecords/ProcedureComplication</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="ProcedureComplication.md" target="_blank">electronicMedicalRecords/ProcedureComplication</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="ProcedureComplication.md" target="_blank">electronicMedicalRecords/ProcedureComplication</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="ProcedureComplication.md" target="_blank">electronicMedicalRecords/ProcedureComplication</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="ProcedureComplication.md" target="_blank">electronicMedicalRecords/ProcedureComplication</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="ProcedureComplication.md" target="_blank">electronicMedicalRecords/ProcedureComplication</a>|
|[complicationIdentifierId](#complicationIdentifierId)|Any complications that occurred during the procedure, or in the immediate post-performance period.|<a href="ProcedureComplication.md" target="_blank">electronicMedicalRecords/ProcedureComplication</a>|
|[name](#name)|The name of the custom entity.|<a href="ProcedureComplication.md" target="_blank">electronicMedicalRecords/ProcedureComplication</a>|
|[procedureId](#procedureId)|An action that is or was performed on a patient. This can be a physical intervention like an operation, or less invasive like counseling or hypnotherapy.|<a href="ProcedureComplication.md" target="_blank">electronicMedicalRecords/ProcedureComplication</a>|
|[procedureComplicationId](#procedureComplicationId)|Unique identifier for entity instances|<a href="ProcedureComplication.md" target="_blank">electronicMedicalRecords/ProcedureComplication</a>|
|[stateCode](#stateCode)|Status of the Procedure Complication|<a href="ProcedureComplication.md" target="_blank">electronicMedicalRecords/ProcedureComplication</a>|
|[stateCode_display](#stateCode_display)||<a href="ProcedureComplication.md" target="_blank">electronicMedicalRecords/ProcedureComplication</a>|
|[statusCode](#statusCode)|Reason for the status of the Procedure Complication|<a href="ProcedureComplication.md" target="_blank">electronicMedicalRecords/ProcedureComplication</a>|
|[statusCode_display](#statusCode_display)||<a href="ProcedureComplication.md" target="_blank">electronicMedicalRecords/ProcedureComplication</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/ProcedureComplication (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Procedure Complication</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_procedurecomplicationid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Procedure Complication</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Procedure Complication</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
