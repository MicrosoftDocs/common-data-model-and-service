...
- **is.identifiedBy**  
  ...
  ```
  "RelatedPerson/hasAttributes/relatedPersonId"
  ```
...
- **means.entityState**  
  ...
  ```
  "RelatedPerson/hasAttributes/stateCode"
  ```
