...
Internal reference that identifies the goals that this activity is intended to contribute towards meeting.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/CarePlanActivityGoal.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="CarePlanActivityGoal.md" target="_blank">electronicMedicalRecords/CarePlanActivityGoal</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="CarePlanActivityGoal.md" target="_blank">electronicMedicalRecords/CarePlanActivityGoal</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="CarePlanActivityGoal.md" target="_blank">electronicMedicalRecords/CarePlanActivityGoal</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="CarePlanActivityGoal.md" target="_blank">electronicMedicalRecords/CarePlanActivityGoal</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="CarePlanActivityGoal.md" target="_blank">electronicMedicalRecords/CarePlanActivityGoal</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="CarePlanActivityGoal.md" target="_blank">electronicMedicalRecords/CarePlanActivityGoal</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="CarePlanActivityGoal.md" target="_blank">electronicMedicalRecords/CarePlanActivityGoal</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="CarePlanActivityGoal.md" target="_blank">electronicMedicalRecords/CarePlanActivityGoal</a>|
|[ownerId](#ownerId)|Owner Id|<a href="CarePlanActivityGoal.md" target="_blank">electronicMedicalRecords/CarePlanActivityGoal</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="CarePlanActivityGoal.md" target="_blank">electronicMedicalRecords/CarePlanActivityGoal</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="CarePlanActivityGoal.md" target="_blank">electronicMedicalRecords/CarePlanActivityGoal</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="CarePlanActivityGoal.md" target="_blank">electronicMedicalRecords/CarePlanActivityGoal</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="CarePlanActivityGoal.md" target="_blank">electronicMedicalRecords/CarePlanActivityGoal</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="CarePlanActivityGoal.md" target="_blank">electronicMedicalRecords/CarePlanActivityGoal</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="CarePlanActivityGoal.md" target="_blank">electronicMedicalRecords/CarePlanActivityGoal</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="CarePlanActivityGoal.md" target="_blank">electronicMedicalRecords/CarePlanActivityGoal</a>|
|[activityId](#activityId)|Identifies a planned action to occur as part of the plan. For example, a medication to be used, lab tests to perform, self-monitoring, education, etc.|<a href="CarePlanActivityGoal.md" target="_blank">electronicMedicalRecords/CarePlanActivityGoal</a>|
|[activityGoalId](#activityGoalId)|Internal reference that identifies the goals that this activity is intended to contribute towards meeting.|<a href="CarePlanActivityGoal.md" target="_blank">electronicMedicalRecords/CarePlanActivityGoal</a>|
|[carePlanActivityGoalId](#carePlanActivityGoalId)|Unique identifier for entity instances|<a href="CarePlanActivityGoal.md" target="_blank">electronicMedicalRecords/CarePlanActivityGoal</a>|
|[name](#name)|The name of the custom entity.|<a href="CarePlanActivityGoal.md" target="_blank">electronicMedicalRecords/CarePlanActivityGoal</a>|
|[stateCode](#stateCode)|Status of the Care Plan Activity Goal|<a href="CarePlanActivityGoal.md" target="_blank">electronicMedicalRecords/CarePlanActivityGoal</a>|
|[stateCode_display](#stateCode_display)||<a href="CarePlanActivityGoal.md" target="_blank">electronicMedicalRecords/CarePlanActivityGoal</a>|
|[statusCode](#statusCode)|Reason for the status of the Care Plan Activity Goal|<a href="CarePlanActivityGoal.md" target="_blank">electronicMedicalRecords/CarePlanActivityGoal</a>|
|[statusCode_display](#statusCode_display)||<a href="CarePlanActivityGoal.md" target="_blank">electronicMedicalRecords/CarePlanActivityGoal</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/CarePlanActivityGoal (this entity)  
