---
title: ProcedureUsedReference - Common Data Model | Microsoft Docs
...
Identifies medications, devices and any other substance used as part of the procedure.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/ProcedureUsedReference.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="ProcedureUsedReference.md" target="_blank">electronicMedicalRecords/ProcedureUsedReference</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="ProcedureUsedReference.md" target="_blank">electronicMedicalRecords/ProcedureUsedReference</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="ProcedureUsedReference.md" target="_blank">electronicMedicalRecords/ProcedureUsedReference</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="ProcedureUsedReference.md" target="_blank">electronicMedicalRecords/ProcedureUsedReference</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="ProcedureUsedReference.md" target="_blank">electronicMedicalRecords/ProcedureUsedReference</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="ProcedureUsedReference.md" target="_blank">electronicMedicalRecords/ProcedureUsedReference</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="ProcedureUsedReference.md" target="_blank">electronicMedicalRecords/ProcedureUsedReference</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="ProcedureUsedReference.md" target="_blank">electronicMedicalRecords/ProcedureUsedReference</a>|
|[ownerId](#ownerId)|Owner Id|<a href="ProcedureUsedReference.md" target="_blank">electronicMedicalRecords/ProcedureUsedReference</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="ProcedureUsedReference.md" target="_blank">electronicMedicalRecords/ProcedureUsedReference</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="ProcedureUsedReference.md" target="_blank">electronicMedicalRecords/ProcedureUsedReference</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="ProcedureUsedReference.md" target="_blank">electronicMedicalRecords/ProcedureUsedReference</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="ProcedureUsedReference.md" target="_blank">electronicMedicalRecords/ProcedureUsedReference</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="ProcedureUsedReference.md" target="_blank">electronicMedicalRecords/ProcedureUsedReference</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="ProcedureUsedReference.md" target="_blank">electronicMedicalRecords/ProcedureUsedReference</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="ProcedureUsedReference.md" target="_blank">electronicMedicalRecords/ProcedureUsedReference</a>|
|[medicationNewId](#medicationNewId)||<a href="ProcedureUsedReference.md" target="_blank">electronicMedicalRecords/ProcedureUsedReference</a>|
|[name](#name)|The name of the custom entity.|<a href="ProcedureUsedReference.md" target="_blank">electronicMedicalRecords/ProcedureUsedReference</a>|
|[procedureId](#procedureId)|An action that is or was performed on a patient. This can be a physical intervention like an operation, or less invasive like counseling or hypnotherapy.|<a href="ProcedureUsedReference.md" target="_blank">electronicMedicalRecords/ProcedureUsedReference</a>|
|[procedureUsedReferenceId](#procedureUsedReferenceId)|Unique identifier for entity instances|<a href="ProcedureUsedReference.md" target="_blank">electronicMedicalRecords/ProcedureUsedReference</a>|
|[refDeviceId](#refDeviceId)|Identifies medications, devices and any other substance used as part of the procedure.|<a href="ProcedureUsedReference.md" target="_blank">electronicMedicalRecords/ProcedureUsedReference</a>|
|[refSubstanceId](#refSubstanceId)|Identifies substance used as part of the procedure.|<a href="ProcedureUsedReference.md" target="_blank">electronicMedicalRecords/ProcedureUsedReference</a>|
|[refType](#refType)|Type of reference|<a href="ProcedureUsedReference.md" target="_blank">electronicMedicalRecords/ProcedureUsedReference</a>|
|[refType_display](#refType_display)||<a href="ProcedureUsedReference.md" target="_blank">electronicMedicalRecords/ProcedureUsedReference</a>|
|[stateCode](#stateCode)|Status of the Procedure Used Reference|<a href="ProcedureUsedReference.md" target="_blank">electronicMedicalRecords/ProcedureUsedReference</a>|
|[stateCode_display](#stateCode_display)||<a href="ProcedureUsedReference.md" target="_blank">electronicMedicalRecords/ProcedureUsedReference</a>|
|[statusCode](#statusCode)|Reason for the status of the Procedure Used Reference|<a href="ProcedureUsedReference.md" target="_blank">electronicMedicalRecords/ProcedureUsedReference</a>|
|[statusCode_display](#statusCode_display)||<a href="ProcedureUsedReference.md" target="_blank">electronicMedicalRecords/ProcedureUsedReference</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/ProcedureUsedReference (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Medication</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_medicationnew</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Procedure Used Reference</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_procedureusedreferenceid</td></tr></table>
...
### <a href=#refDeviceId name="refDeviceId">refDeviceId</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Device</td></tr><tr><td>description</td><td>Identifies medications, devices and any other substance used as part of the procedure.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_refdevice</td></tr></table>

#### Traits

<details>
<summary>List of traits for the refDeviceId attribute are listed below.</summary>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_refdevice"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Substance</td></tr><tr><td>description</td><td>Identifies substance used as part of the procedure.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_refsubstance</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Procedure Used Reference</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Procedure Used Reference</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
