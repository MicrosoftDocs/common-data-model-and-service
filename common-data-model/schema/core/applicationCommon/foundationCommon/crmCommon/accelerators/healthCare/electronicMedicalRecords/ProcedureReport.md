---
title: ProcedureReport - Common Data Model | Microsoft Docs
...
Procedure report could represent histology result, pathology report, surgical report, etc.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/ProcedureReport.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="ProcedureReport.md" target="_blank">electronicMedicalRecords/ProcedureReport</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="ProcedureReport.md" target="_blank">electronicMedicalRecords/ProcedureReport</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="ProcedureReport.md" target="_blank">electronicMedicalRecords/ProcedureReport</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="ProcedureReport.md" target="_blank">electronicMedicalRecords/ProcedureReport</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="ProcedureReport.md" target="_blank">electronicMedicalRecords/ProcedureReport</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="ProcedureReport.md" target="_blank">electronicMedicalRecords/ProcedureReport</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="ProcedureReport.md" target="_blank">electronicMedicalRecords/ProcedureReport</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="ProcedureReport.md" target="_blank">electronicMedicalRecords/ProcedureReport</a>|
|[ownerId](#ownerId)|Owner Id|<a href="ProcedureReport.md" target="_blank">electronicMedicalRecords/ProcedureReport</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="ProcedureReport.md" target="_blank">electronicMedicalRecords/ProcedureReport</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="ProcedureReport.md" target="_blank">electronicMedicalRecords/ProcedureReport</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="ProcedureReport.md" target="_blank">electronicMedicalRecords/ProcedureReport</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="ProcedureReport.md" target="_blank">electronicMedicalRecords/ProcedureReport</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="ProcedureReport.md" target="_blank">electronicMedicalRecords/ProcedureReport</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="ProcedureReport.md" target="_blank">electronicMedicalRecords/ProcedureReport</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="ProcedureReport.md" target="_blank">electronicMedicalRecords/ProcedureReport</a>|
|[name](#name)|The name of the custom entity.|<a href="ProcedureReport.md" target="_blank">electronicMedicalRecords/ProcedureReport</a>|
|[procedureId](#procedureId)|An action that is or was performed on a patient. This can be a physical intervention like an operation, or less invasive like counseling or hypnotherapy.|<a href="ProcedureReport.md" target="_blank">electronicMedicalRecords/ProcedureReport</a>|
|[procedureReportId](#procedureReportId)|Unique identifier for entity instances|<a href="ProcedureReport.md" target="_blank">electronicMedicalRecords/ProcedureReport</a>|
|[reportId](#reportId)|This could be a histology result, pathology report, surgical report, etc..|<a href="ProcedureReport.md" target="_blank">electronicMedicalRecords/ProcedureReport</a>|
|[stateCode](#stateCode)|Status of the Procedure Report|<a href="ProcedureReport.md" target="_blank">electronicMedicalRecords/ProcedureReport</a>|
|[stateCode_display](#stateCode_display)||<a href="ProcedureReport.md" target="_blank">electronicMedicalRecords/ProcedureReport</a>|
|[statusCode](#statusCode)|Reason for the status of the Procedure Report|<a href="ProcedureReport.md" target="_blank">electronicMedicalRecords/ProcedureReport</a>|
|[statusCode_display](#statusCode_display)||<a href="ProcedureReport.md" target="_blank">electronicMedicalRecords/ProcedureReport</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/ProcedureReport (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Procedure Report</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_procedurereportid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Report</td></tr><tr><td>description</td><td>This could be a histology result, pathology report, surgical report, etc..</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_report</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Procedure Report</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Procedure Report</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
