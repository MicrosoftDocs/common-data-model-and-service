...
Specific type of encounter (e.g. e-mail consultation, surgical day-care, skilled nursing, rehabilitation).  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/EncounterType.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="EncounterType.md" target="_blank">electronicMedicalRecords/EncounterType</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="EncounterType.md" target="_blank">electronicMedicalRecords/EncounterType</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="EncounterType.md" target="_blank">electronicMedicalRecords/EncounterType</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="EncounterType.md" target="_blank">electronicMedicalRecords/EncounterType</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="EncounterType.md" target="_blank">electronicMedicalRecords/EncounterType</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="EncounterType.md" target="_blank">electronicMedicalRecords/EncounterType</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="EncounterType.md" target="_blank">electronicMedicalRecords/EncounterType</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="EncounterType.md" target="_blank">electronicMedicalRecords/EncounterType</a>|
|[ownerId](#ownerId)|Owner Id|<a href="EncounterType.md" target="_blank">electronicMedicalRecords/EncounterType</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="EncounterType.md" target="_blank">electronicMedicalRecords/EncounterType</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="EncounterType.md" target="_blank">electronicMedicalRecords/EncounterType</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="EncounterType.md" target="_blank">electronicMedicalRecords/EncounterType</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="EncounterType.md" target="_blank">electronicMedicalRecords/EncounterType</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="EncounterType.md" target="_blank">electronicMedicalRecords/EncounterType</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="EncounterType.md" target="_blank">electronicMedicalRecords/EncounterType</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="EncounterType.md" target="_blank">electronicMedicalRecords/EncounterType</a>|
|[encounterId](#encounterId)|An interaction between a patient and healthcare provider(s) for the purpose of providing healthcare service(s) or assessing the health status of a patient.|<a href="EncounterType.md" target="_blank">electronicMedicalRecords/EncounterType</a>|
|[encounterTypeId](#encounterTypeId)|Unique identifier for entity instances|<a href="EncounterType.md" target="_blank">electronicMedicalRecords/EncounterType</a>|
|[name](#name)|The name of the custom entity.|<a href="EncounterType.md" target="_blank">electronicMedicalRecords/EncounterType</a>|
|[stateCode](#stateCode)|Status of the Encounter Type|<a href="EncounterType.md" target="_blank">electronicMedicalRecords/EncounterType</a>|
|[stateCode_display](#stateCode_display)||<a href="EncounterType.md" target="_blank">electronicMedicalRecords/EncounterType</a>|
|[statusCode](#statusCode)|Reason for the status of the Encounter Type|<a href="EncounterType.md" target="_blank">electronicMedicalRecords/EncounterType</a>|
|[statusCode_display](#statusCode_display)||<a href="EncounterType.md" target="_blank">electronicMedicalRecords/EncounterType</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/EncounterType (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Encounter Type</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Encounter Type</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
