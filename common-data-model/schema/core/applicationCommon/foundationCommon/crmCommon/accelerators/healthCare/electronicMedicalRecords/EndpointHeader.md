...
Additional headers / information to send as part of the notification.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/EndpointHeader.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/applicationCommon/foundationCommon<br>/crmCommon/accelerators/healthCare<br>/electronicMedicalRecords/EndpointHeader.cdm.json<br>/EndpointHeader/hasAttributes<br>/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>
...
|---|---|---|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="EndpointHeader.md" target="_blank">electronicMedicalRecords/EndpointHeader</a>|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="EndpointHeader.md" target="_blank">electronicMedicalRecords/EndpointHeader</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="EndpointHeader.md" target="_blank">electronicMedicalRecords/EndpointHeader</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="EndpointHeader.md" target="_blank">electronicMedicalRecords/EndpointHeader</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="EndpointHeader.md" target="_blank">electronicMedicalRecords/EndpointHeader</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="EndpointHeader.md" target="_blank">electronicMedicalRecords/EndpointHeader</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="EndpointHeader.md" target="_blank">electronicMedicalRecords/EndpointHeader</a>|
|[endpointId](#endpointId)|The technical details of an endpoint that can be used for electronic services.|<a href="EndpointHeader.md" target="_blank">electronicMedicalRecords/EndpointHeader</a>|
|[endpointHeaderId](#endpointHeaderId)|Unique identifier for entity instances|<a href="EndpointHeader.md" target="_blank">electronicMedicalRecords/EndpointHeader</a>|
|[header](#header)|Additional headers / information to send as part of the notification|<a href="EndpointHeader.md" target="_blank">electronicMedicalRecords/EndpointHeader</a>|
|[organizationId](#organizationId)|Unique identifier for the organization|<a href="EndpointHeader.md" target="_blank">electronicMedicalRecords/EndpointHeader</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="EndpointHeader.md" target="_blank">electronicMedicalRecords/EndpointHeader</a>|
|[stateCode](#stateCode)|Status of the Endpoint Header|<a href="EndpointHeader.md" target="_blank">electronicMedicalRecords/EndpointHeader</a>|
|[stateCode_display](#stateCode_display)||<a href="EndpointHeader.md" target="_blank">electronicMedicalRecords/EndpointHeader</a>|
|[statusCode](#statusCode)|Reason for the status of the Endpoint Header|<a href="EndpointHeader.md" target="_blank">electronicMedicalRecords/EndpointHeader</a>|
|[statusCode_display](#statusCode_display)||<a href="EndpointHeader.md" target="_blank">electronicMedicalRecords/EndpointHeader</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="EndpointHeader.md" target="_blank">electronicMedicalRecords/EndpointHeader</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="EndpointHeader.md" target="_blank">electronicMedicalRecords/EndpointHeader</a>|

### <a href=#createdBy name="createdBy">createdBy</a>

Unique identifier of the user who created the record.  
First included in: electronicMedicalRecords/EndpointHeader (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Endpoint Header</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_endpointheaderid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Header</td></tr><tr><td>description</td><td>Additional headers / information to send as part of the notification</td></tr><tr><td>dataFormat</td><td>7</td></tr><tr><td>maximumLength</td><td>100</td></tr><tr><td>sourceName</td><td>msemr_header</td></tr></table>
