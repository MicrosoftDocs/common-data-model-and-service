---
title: TaskBasedOn - Common Data Model | Microsoft Docs
...
BasedOn refers to a higher-level authorization that triggered the creation of the task. It references a "request" entity such as a ProcedureRequest, MedicationRequest, ProcedureRequest, CarePlan, etc  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/TaskBasedOn.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="TaskBasedOn.md" target="_blank">electronicMedicalRecords/TaskBasedOn</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="TaskBasedOn.md" target="_blank">electronicMedicalRecords/TaskBasedOn</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="TaskBasedOn.md" target="_blank">electronicMedicalRecords/TaskBasedOn</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="TaskBasedOn.md" target="_blank">electronicMedicalRecords/TaskBasedOn</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="TaskBasedOn.md" target="_blank">electronicMedicalRecords/TaskBasedOn</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="TaskBasedOn.md" target="_blank">electronicMedicalRecords/TaskBasedOn</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="TaskBasedOn.md" target="_blank">electronicMedicalRecords/TaskBasedOn</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="TaskBasedOn.md" target="_blank">electronicMedicalRecords/TaskBasedOn</a>|
|[ownerId](#ownerId)|Owner Id|<a href="TaskBasedOn.md" target="_blank">electronicMedicalRecords/TaskBasedOn</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="TaskBasedOn.md" target="_blank">electronicMedicalRecords/TaskBasedOn</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="TaskBasedOn.md" target="_blank">electronicMedicalRecords/TaskBasedOn</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="TaskBasedOn.md" target="_blank">electronicMedicalRecords/TaskBasedOn</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="TaskBasedOn.md" target="_blank">electronicMedicalRecords/TaskBasedOn</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="TaskBasedOn.md" target="_blank">electronicMedicalRecords/TaskBasedOn</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="TaskBasedOn.md" target="_blank">electronicMedicalRecords/TaskBasedOn</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="TaskBasedOn.md" target="_blank">electronicMedicalRecords/TaskBasedOn</a>|
|[basedOn](#basedOn)|Based On refers to a higher-level authorization that triggered the creation of the task.|<a href="TaskBasedOn.md" target="_blank">electronicMedicalRecords/TaskBasedOn</a>|
|[name](#name)|The name of the custom entity.|<a href="TaskBasedOn.md" target="_blank">electronicMedicalRecords/TaskBasedOn</a>|
|[taskId](#taskId)|Unique identifier for Task|<a href="TaskBasedOn.md" target="_blank">electronicMedicalRecords/TaskBasedOn</a>|
|[taskBasedOnId](#taskBasedOnId)|Unique identifier for entity instances|<a href="TaskBasedOn.md" target="_blank">electronicMedicalRecords/TaskBasedOn</a>|
|[stateCode](#stateCode)|Status of the Task Based On|<a href="TaskBasedOn.md" target="_blank">electronicMedicalRecords/TaskBasedOn</a>|
|[stateCode_display](#stateCode_display)||<a href="TaskBasedOn.md" target="_blank">electronicMedicalRecords/TaskBasedOn</a>|
|[statusCode](#statusCode)|Reason for the status of the Task Based On|<a href="TaskBasedOn.md" target="_blank">electronicMedicalRecords/TaskBasedOn</a>|
|[statusCode_display](#statusCode_display)||<a href="TaskBasedOn.md" target="_blank">electronicMedicalRecords/TaskBasedOn</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/TaskBasedOn (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Based On</td></tr><tr><td>description</td><td>Based On refers to a higher-level authorization that triggered the creation of the task.</td></tr><tr><td>dataFormat</td><td>7</td></tr><tr><td>maximumLength</td><td>2000</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_basedon</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Task Based On</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_taskbasedonid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Task Based On</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Task Based On</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
