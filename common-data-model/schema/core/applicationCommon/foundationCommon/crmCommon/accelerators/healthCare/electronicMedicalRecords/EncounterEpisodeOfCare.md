---
title: EncounterEpisodeOfCare - Common Data Model | Microsoft Docs
...
Where a specific encounter should be classified as a part of a specific episode(s) of care this field should be used.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/EncounterEpisodeOfCare.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="EncounterEpisodeOfCare.md" target="_blank">electronicMedicalRecords/EncounterEpisodeOfCare</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="EncounterEpisodeOfCare.md" target="_blank">electronicMedicalRecords/EncounterEpisodeOfCare</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="EncounterEpisodeOfCare.md" target="_blank">electronicMedicalRecords/EncounterEpisodeOfCare</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="EncounterEpisodeOfCare.md" target="_blank">electronicMedicalRecords/EncounterEpisodeOfCare</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="EncounterEpisodeOfCare.md" target="_blank">electronicMedicalRecords/EncounterEpisodeOfCare</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="EncounterEpisodeOfCare.md" target="_blank">electronicMedicalRecords/EncounterEpisodeOfCare</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="EncounterEpisodeOfCare.md" target="_blank">electronicMedicalRecords/EncounterEpisodeOfCare</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="EncounterEpisodeOfCare.md" target="_blank">electronicMedicalRecords/EncounterEpisodeOfCare</a>|
|[ownerId](#ownerId)|Owner Id|<a href="EncounterEpisodeOfCare.md" target="_blank">electronicMedicalRecords/EncounterEpisodeOfCare</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="EncounterEpisodeOfCare.md" target="_blank">electronicMedicalRecords/EncounterEpisodeOfCare</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="EncounterEpisodeOfCare.md" target="_blank">electronicMedicalRecords/EncounterEpisodeOfCare</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="EncounterEpisodeOfCare.md" target="_blank">electronicMedicalRecords/EncounterEpisodeOfCare</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="EncounterEpisodeOfCare.md" target="_blank">electronicMedicalRecords/EncounterEpisodeOfCare</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="EncounterEpisodeOfCare.md" target="_blank">electronicMedicalRecords/EncounterEpisodeOfCare</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="EncounterEpisodeOfCare.md" target="_blank">electronicMedicalRecords/EncounterEpisodeOfCare</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="EncounterEpisodeOfCare.md" target="_blank">electronicMedicalRecords/EncounterEpisodeOfCare</a>|
|[encounterId](#encounterId)|An interaction between a patient and healthcare provider(s) for the purpose of providing healthcare service(s) or assessing the health status of a patient.|<a href="EncounterEpisodeOfCare.md" target="_blank">electronicMedicalRecords/EncounterEpisodeOfCare</a>|
|[encounterEpisodeOfCareId](#encounterEpisodeOfCareId)|Unique identifier for entity instances|<a href="EncounterEpisodeOfCare.md" target="_blank">electronicMedicalRecords/EncounterEpisodeOfCare</a>|
|[encounterEpisodeOfCareIdentifierId](#encounterEpisodeOfCareIdentifierId)|Where a specific encounter should be classified as a part of a specific episode(s) of care this field should be used.|<a href="EncounterEpisodeOfCare.md" target="_blank">electronicMedicalRecords/EncounterEpisodeOfCare</a>|
|[name](#name)|The name of the custom entity.|<a href="EncounterEpisodeOfCare.md" target="_blank">electronicMedicalRecords/EncounterEpisodeOfCare</a>|
|[stateCode](#stateCode)|Status of the Encounter Episode Of Care|<a href="EncounterEpisodeOfCare.md" target="_blank">electronicMedicalRecords/EncounterEpisodeOfCare</a>|
|[stateCode_display](#stateCode_display)||<a href="EncounterEpisodeOfCare.md" target="_blank">electronicMedicalRecords/EncounterEpisodeOfCare</a>|
|[statusCode](#statusCode)|Reason for the status of the Encounter Episode Of Care|<a href="EncounterEpisodeOfCare.md" target="_blank">electronicMedicalRecords/EncounterEpisodeOfCare</a>|
|[statusCode_display](#statusCode_display)||<a href="EncounterEpisodeOfCare.md" target="_blank">electronicMedicalRecords/EncounterEpisodeOfCare</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/EncounterEpisodeOfCare (this entity)  
