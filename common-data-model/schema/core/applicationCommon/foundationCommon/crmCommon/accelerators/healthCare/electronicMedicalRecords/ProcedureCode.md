---
title: ProcedureCode - Common Data Model | Microsoft Docs
...
# Procedure Code
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/ProcedureCode.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="ProcedureCode.md" target="_blank">electronicMedicalRecords/ProcedureCode</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="ProcedureCode.md" target="_blank">electronicMedicalRecords/ProcedureCode</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="ProcedureCode.md" target="_blank">electronicMedicalRecords/ProcedureCode</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="ProcedureCode.md" target="_blank">electronicMedicalRecords/ProcedureCode</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="ProcedureCode.md" target="_blank">electronicMedicalRecords/ProcedureCode</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="ProcedureCode.md" target="_blank">electronicMedicalRecords/ProcedureCode</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="ProcedureCode.md" target="_blank">electronicMedicalRecords/ProcedureCode</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="ProcedureCode.md" target="_blank">electronicMedicalRecords/ProcedureCode</a>|
|[ownerId](#ownerId)|Owner Id|<a href="ProcedureCode.md" target="_blank">electronicMedicalRecords/ProcedureCode</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="ProcedureCode.md" target="_blank">electronicMedicalRecords/ProcedureCode</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="ProcedureCode.md" target="_blank">electronicMedicalRecords/ProcedureCode</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="ProcedureCode.md" target="_blank">electronicMedicalRecords/ProcedureCode</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="ProcedureCode.md" target="_blank">electronicMedicalRecords/ProcedureCode</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="ProcedureCode.md" target="_blank">electronicMedicalRecords/ProcedureCode</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="ProcedureCode.md" target="_blank">electronicMedicalRecords/ProcedureCode</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="ProcedureCode.md" target="_blank">electronicMedicalRecords/ProcedureCode</a>|
|[code](#code)||<a href="ProcedureCode.md" target="_blank">electronicMedicalRecords/ProcedureCode</a>|
|[display](#display)|The name of the custom entity.|<a href="ProcedureCode.md" target="_blank">electronicMedicalRecords/ProcedureCode</a>|
|[procedureCodeId](#procedureCodeId)|Unique identifier for entity instances|<a href="ProcedureCode.md" target="_blank">electronicMedicalRecords/ProcedureCode</a>|
|[system](#system)||<a href="ProcedureCode.md" target="_blank">electronicMedicalRecords/ProcedureCode</a>|
|[stateCode](#stateCode)|Status of the Procedure Code|<a href="ProcedureCode.md" target="_blank">electronicMedicalRecords/ProcedureCode</a>|
|[stateCode_display](#stateCode_display)||<a href="ProcedureCode.md" target="_blank">electronicMedicalRecords/ProcedureCode</a>|
|[statusCode](#statusCode)|Reason for the status of the Procedure Code|<a href="ProcedureCode.md" target="_blank">electronicMedicalRecords/ProcedureCode</a>|
|[statusCode_display](#statusCode_display)||<a href="ProcedureCode.md" target="_blank">electronicMedicalRecords/ProcedureCode</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/ProcedureCode (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Procedure Code</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_procedurecodeid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Procedure Code</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Procedure Code</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
