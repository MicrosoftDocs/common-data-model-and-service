...
The goal outcome is independent of the outcome of the related activities.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/GoalOutcomeReference.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="GoalOutcomeReference.md" target="_blank">electronicMedicalRecords/GoalOutcomeReference</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="GoalOutcomeReference.md" target="_blank">electronicMedicalRecords/GoalOutcomeReference</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="GoalOutcomeReference.md" target="_blank">electronicMedicalRecords/GoalOutcomeReference</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="GoalOutcomeReference.md" target="_blank">electronicMedicalRecords/GoalOutcomeReference</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="GoalOutcomeReference.md" target="_blank">electronicMedicalRecords/GoalOutcomeReference</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="GoalOutcomeReference.md" target="_blank">electronicMedicalRecords/GoalOutcomeReference</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="GoalOutcomeReference.md" target="_blank">electronicMedicalRecords/GoalOutcomeReference</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="GoalOutcomeReference.md" target="_blank">electronicMedicalRecords/GoalOutcomeReference</a>|
|[ownerId](#ownerId)|Owner Id|<a href="GoalOutcomeReference.md" target="_blank">electronicMedicalRecords/GoalOutcomeReference</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="GoalOutcomeReference.md" target="_blank">electronicMedicalRecords/GoalOutcomeReference</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="GoalOutcomeReference.md" target="_blank">electronicMedicalRecords/GoalOutcomeReference</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="GoalOutcomeReference.md" target="_blank">electronicMedicalRecords/GoalOutcomeReference</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="GoalOutcomeReference.md" target="_blank">electronicMedicalRecords/GoalOutcomeReference</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="GoalOutcomeReference.md" target="_blank">electronicMedicalRecords/GoalOutcomeReference</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="GoalOutcomeReference.md" target="_blank">electronicMedicalRecords/GoalOutcomeReference</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="GoalOutcomeReference.md" target="_blank">electronicMedicalRecords/GoalOutcomeReference</a>|
|[goalId](#goalId)|Describes the intended objective(s) for a patient, group or organization care|<a href="GoalOutcomeReference.md" target="_blank">electronicMedicalRecords/GoalOutcomeReference</a>|
|[goalOutcomeReferenceId](#goalOutcomeReferenceId)|Unique identifier for entity instances|<a href="GoalOutcomeReference.md" target="_blank">electronicMedicalRecords/GoalOutcomeReference</a>|
|[name](#name)|The name of the custom entity.|<a href="GoalOutcomeReference.md" target="_blank">electronicMedicalRecords/GoalOutcomeReference</a>|
|[stateCode](#stateCode)|Status of the Goal Outcome Reference|<a href="GoalOutcomeReference.md" target="_blank">electronicMedicalRecords/GoalOutcomeReference</a>|
|[stateCode_display](#stateCode_display)||<a href="GoalOutcomeReference.md" target="_blank">electronicMedicalRecords/GoalOutcomeReference</a>|
|[statusCode](#statusCode)|Reason for the status of the Goal Outcome Reference|<a href="GoalOutcomeReference.md" target="_blank">electronicMedicalRecords/GoalOutcomeReference</a>|
|[statusCode_display](#statusCode_display)||<a href="GoalOutcomeReference.md" target="_blank">electronicMedicalRecords/GoalOutcomeReference</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/GoalOutcomeReference (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Goal Outcome Reference</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Goal Outcome Reference</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
