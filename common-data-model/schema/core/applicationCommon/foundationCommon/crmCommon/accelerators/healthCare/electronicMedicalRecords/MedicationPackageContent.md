---
title: MedicationPackageContent - Common Data Model | Microsoft Docs
...
A set of components that go to make up the described item.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/MedicationPackageContent.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="MedicationPackageContent.md" target="_blank">electronicMedicalRecords/MedicationPackageContent</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="MedicationPackageContent.md" target="_blank">electronicMedicalRecords/MedicationPackageContent</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="MedicationPackageContent.md" target="_blank">electronicMedicalRecords/MedicationPackageContent</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="MedicationPackageContent.md" target="_blank">electronicMedicalRecords/MedicationPackageContent</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="MedicationPackageContent.md" target="_blank">electronicMedicalRecords/MedicationPackageContent</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="MedicationPackageContent.md" target="_blank">electronicMedicalRecords/MedicationPackageContent</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="MedicationPackageContent.md" target="_blank">electronicMedicalRecords/MedicationPackageContent</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="MedicationPackageContent.md" target="_blank">electronicMedicalRecords/MedicationPackageContent</a>|
|[ownerId](#ownerId)|Owner Id|<a href="MedicationPackageContent.md" target="_blank">electronicMedicalRecords/MedicationPackageContent</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="MedicationPackageContent.md" target="_blank">electronicMedicalRecords/MedicationPackageContent</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="MedicationPackageContent.md" target="_blank">electronicMedicalRecords/MedicationPackageContent</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="MedicationPackageContent.md" target="_blank">electronicMedicalRecords/MedicationPackageContent</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="MedicationPackageContent.md" target="_blank">electronicMedicalRecords/MedicationPackageContent</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="MedicationPackageContent.md" target="_blank">electronicMedicalRecords/MedicationPackageContent</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="MedicationPackageContent.md" target="_blank">electronicMedicalRecords/MedicationPackageContent</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="MedicationPackageContent.md" target="_blank">electronicMedicalRecords/MedicationPackageContent</a>|
|[medicationIDNewId](#medicationIDNewId)||<a href="MedicationPackageContent.md" target="_blank">electronicMedicalRecords/MedicationPackageContent</a>|
|[medicationPackageContentId](#medicationPackageContentId)|Unique identifier for entity instances|<a href="MedicationPackageContent.md" target="_blank">electronicMedicalRecords/MedicationPackageContent</a>|
|[name](#name)|The name of the custom entity.|<a href="MedicationPackageContent.md" target="_blank">electronicMedicalRecords/MedicationPackageContent</a>|
|[packageContentAmount](#packageContentAmount)|The amount of the product that is in the package.|<a href="MedicationPackageContent.md" target="_blank">electronicMedicalRecords/MedicationPackageContent</a>|
|[packageItemCodeableConceptId](#packageItemCodeableConceptId)|Identifies one of the items in the package.|<a href="MedicationPackageContent.md" target="_blank">electronicMedicalRecords/MedicationPackageContent</a>|
|[packageItemMedicationNewId](#packageItemMedicationNewId)||<a href="MedicationPackageContent.md" target="_blank">electronicMedicalRecords/MedicationPackageContent</a>|
|[packageItemType](#packageItemType)|Identifies one of the items in the package.|<a href="MedicationPackageContent.md" target="_blank">electronicMedicalRecords/MedicationPackageContent</a>|
|[packageItemType_display](#packageItemType_display)||<a href="MedicationPackageContent.md" target="_blank">electronicMedicalRecords/MedicationPackageContent</a>|
|[stateCode](#stateCode)|Status of the Medication Package Content|<a href="MedicationPackageContent.md" target="_blank">electronicMedicalRecords/MedicationPackageContent</a>|
|[stateCode_display](#stateCode_display)||<a href="MedicationPackageContent.md" target="_blank">electronicMedicalRecords/MedicationPackageContent</a>|
|[statusCode](#statusCode)|Reason for the status of the Medication Package Content|<a href="MedicationPackageContent.md" target="_blank">electronicMedicalRecords/MedicationPackageContent</a>|
|[statusCode_display](#statusCode_display)||<a href="MedicationPackageContent.md" target="_blank">electronicMedicalRecords/MedicationPackageContent</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/MedicationPackageContent (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Medication Package Content</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_medicationpackagecontentid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Package Amount</td></tr><tr><td>description</td><td>The amount of the product that is in the package.</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>maximumValue</td><td>2147483647</td></tr><tr><td>minimumValue</td><td>-2147483648</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_packagecontentamount</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Package Item Code</td></tr><tr><td>description</td><td>Identifies one of the items in the package.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_packageitemcodeableconcept</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Package Item (Medication)</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_packageitemmedicationnew</td></tr></table>
