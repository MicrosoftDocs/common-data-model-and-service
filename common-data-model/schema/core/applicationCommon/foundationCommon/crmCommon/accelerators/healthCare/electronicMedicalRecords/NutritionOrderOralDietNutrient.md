...
Class that defines the quantity and type of nutrient modifications (for example carbohydrate, fiber or sodium) required for the oral diet.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/NutritionOrderOralDietNutrient.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="NutritionOrderOralDietNutrient.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietNutrient</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="NutritionOrderOralDietNutrient.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietNutrient</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="NutritionOrderOralDietNutrient.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietNutrient</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="NutritionOrderOralDietNutrient.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietNutrient</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="NutritionOrderOralDietNutrient.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietNutrient</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="NutritionOrderOralDietNutrient.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietNutrient</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="NutritionOrderOralDietNutrient.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietNutrient</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="NutritionOrderOralDietNutrient.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietNutrient</a>|
|[ownerId](#ownerId)|Owner Id|<a href="NutritionOrderOralDietNutrient.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietNutrient</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="NutritionOrderOralDietNutrient.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietNutrient</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="NutritionOrderOralDietNutrient.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietNutrient</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="NutritionOrderOralDietNutrient.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietNutrient</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="NutritionOrderOralDietNutrient.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietNutrient</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="NutritionOrderOralDietNutrient.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietNutrient</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="NutritionOrderOralDietNutrient.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietNutrient</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="NutritionOrderOralDietNutrient.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietNutrient</a>|
|[name](#name)|The name of the custom entity.|<a href="NutritionOrderOralDietNutrient.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietNutrient</a>|
|[nutritionOrderId](#nutritionOrderId)|Unique ID for Nutrition Order|<a href="NutritionOrderOralDietNutrient.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietNutrient</a>|
|[nutritionOrderOralDietNutrientId](#nutritionOrderOralDietNutrientId)|Unique identifier for entity instances|<a href="NutritionOrderOralDietNutrient.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietNutrient</a>|
|[oralDietNutrientAmount](#oralDietNutrientAmount)|The quantity of the specified nutrient to include in diet.|<a href="NutritionOrderOralDietNutrient.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietNutrient</a>|
|[oralDietNutrientModifierId](#oralDietNutrientModifierId)|The nutrient that is being modified such as carbohydrate or sodium.|<a href="NutritionOrderOralDietNutrient.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietNutrient</a>|
|[stateCode](#stateCode)|Status of the Nutrition Order Oral Diet Nutrient|<a href="NutritionOrderOralDietNutrient.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietNutrient</a>|
|[stateCode_display](#stateCode_display)||<a href="NutritionOrderOralDietNutrient.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietNutrient</a>|
|[statusCode](#statusCode)|Reason for the status of the Nutrition Order Oral Diet Nutrient|<a href="NutritionOrderOralDietNutrient.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietNutrient</a>|
|[statusCode_display](#statusCode_display)||<a href="NutritionOrderOralDietNutrient.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietNutrient</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/NutritionOrderOralDietNutrient (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Nutrition Order Oral Diet Nutrient</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_nutritionorderoraldietnutrientid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Nutrient Amount</td></tr><tr><td>description</td><td>The quantity of the specified nutrient to include in diet.</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>maximumValue</td><td>2147483647</td></tr><tr><td>minimumValue</td><td>-2147483648</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_oraldietnutrientamount</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Nutrition Order Oral Diet Nutrient</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Nutrition Order Oral Diet Nutrient</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
