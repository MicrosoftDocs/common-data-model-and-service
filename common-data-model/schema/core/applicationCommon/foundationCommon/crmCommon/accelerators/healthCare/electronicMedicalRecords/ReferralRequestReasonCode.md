---
title: ReferralRequestReasonCode - Common Data Model | Microsoft Docs
...
# Referral Request Reason Code

Description of clinical condition indicating why referral/transfer of care is requested.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/ReferralRequestReasonCode.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="ReferralRequestReasonCode.md" target="_blank">electronicMedicalRecords/ReferralRequestReasonCode</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="ReferralRequestReasonCode.md" target="_blank">electronicMedicalRecords/ReferralRequestReasonCode</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="ReferralRequestReasonCode.md" target="_blank">electronicMedicalRecords/ReferralRequestReasonCode</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="ReferralRequestReasonCode.md" target="_blank">electronicMedicalRecords/ReferralRequestReasonCode</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="ReferralRequestReasonCode.md" target="_blank">electronicMedicalRecords/ReferralRequestReasonCode</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="ReferralRequestReasonCode.md" target="_blank">electronicMedicalRecords/ReferralRequestReasonCode</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="ReferralRequestReasonCode.md" target="_blank">electronicMedicalRecords/ReferralRequestReasonCode</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="ReferralRequestReasonCode.md" target="_blank">electronicMedicalRecords/ReferralRequestReasonCode</a>|
|[ownerId](#ownerId)|Owner Id|<a href="ReferralRequestReasonCode.md" target="_blank">electronicMedicalRecords/ReferralRequestReasonCode</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="ReferralRequestReasonCode.md" target="_blank">electronicMedicalRecords/ReferralRequestReasonCode</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="ReferralRequestReasonCode.md" target="_blank">electronicMedicalRecords/ReferralRequestReasonCode</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="ReferralRequestReasonCode.md" target="_blank">electronicMedicalRecords/ReferralRequestReasonCode</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="ReferralRequestReasonCode.md" target="_blank">electronicMedicalRecords/ReferralRequestReasonCode</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="ReferralRequestReasonCode.md" target="_blank">electronicMedicalRecords/ReferralRequestReasonCode</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="ReferralRequestReasonCode.md" target="_blank">electronicMedicalRecords/ReferralRequestReasonCode</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="ReferralRequestReasonCode.md" target="_blank">electronicMedicalRecords/ReferralRequestReasonCode</a>|
|[display](#display)|The name of the custom entity.|<a href="ReferralRequestReasonCode.md" target="_blank">electronicMedicalRecords/ReferralRequestReasonCode</a>|
|[reasonCodeId](#reasonCodeId)|Description of clinical condition indicating why referral/transfer of care is requested. For example: Pathological Anomalies, Disabled (physical or mental), Behavioral Management.|<a href="ReferralRequestReasonCode.md" target="_blank">electronicMedicalRecords/ReferralRequestReasonCode</a>|
|[referralRequestId](#referralRequestId)|Unique identifier for the referral request|<a href="ReferralRequestReasonCode.md" target="_blank">electronicMedicalRecords/ReferralRequestReasonCode</a>|
|[referralRequestReasonCodeId](#referralRequestReasonCodeId)|Unique identifier for entity instances|<a href="ReferralRequestReasonCode.md" target="_blank">electronicMedicalRecords/ReferralRequestReasonCode</a>|
|[stateCode](#stateCode)|Status of the Referral Request Reason Code|<a href="ReferralRequestReasonCode.md" target="_blank">electronicMedicalRecords/ReferralRequestReasonCode</a>|
|[stateCode_display](#stateCode_display)||<a href="ReferralRequestReasonCode.md" target="_blank">electronicMedicalRecords/ReferralRequestReasonCode</a>|
|[statusCode](#statusCode)|Reason for the status of the Referral Request Reason Code|<a href="ReferralRequestReasonCode.md" target="_blank">electronicMedicalRecords/ReferralRequestReasonCode</a>|
|[statusCode_display](#statusCode_display)||<a href="ReferralRequestReasonCode.md" target="_blank">electronicMedicalRecords/ReferralRequestReasonCode</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/ReferralRequestReasonCode (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Reason code</td></tr><tr><td>description</td><td>Description of clinical condition indicating why referral/transfer of care is requested. For example: Pathological Anomalies, Disabled (physical or mental), Behavioral Management.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_reasoncode</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Referral Request Reason Code</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_referralrequestreasoncodeid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Referral Request Reason Code</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Referral Request Reason Code</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
