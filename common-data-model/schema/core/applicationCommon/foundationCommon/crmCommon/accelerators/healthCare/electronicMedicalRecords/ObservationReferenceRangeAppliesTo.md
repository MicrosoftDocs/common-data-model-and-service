---
title: ObservationReferenceRangeAppliesTo - Common Data Model | Microsoft Docs
...
Codes to indicate the target population this reference range applies to. For example, a reference range may be based on the normal population or a particular sex or race.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/ObservationReferenceRangeAppliesTo.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/core/applicationCommon/foundationCommon<br>/crmCommon/accelerators/healthCare<br>/electronicMedicalRecords<br>/ObservationReferenceRangeAppliesTo.cdm.json<br>/ObservationReferenceRangeAppliesTo/hasAttributes<br>/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[ObservationReferenceRangeAppliesTo/(resolvedAttributes)/observationReferenceRangeAppliesToId](#observationReferenceRangeAppliesToId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[ObservationReferenceRangeAppliesTo/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Observation Reference Range Applies To</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Codes to indicate the target population this reference range applies to. For example, a reference range may be based on the normal population or a particular sex or race.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_observationreferencerangeappliesto"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="ObservationReferenceRangeAppliesTo.md" target="_blank">electronicMedicalRecords/ObservationReferenceRangeAppliesTo</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="ObservationReferenceRangeAppliesTo.md" target="_blank">electronicMedicalRecords/ObservationReferenceRangeAppliesTo</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="ObservationReferenceRangeAppliesTo.md" target="_blank">electronicMedicalRecords/ObservationReferenceRangeAppliesTo</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="ObservationReferenceRangeAppliesTo.md" target="_blank">electronicMedicalRecords/ObservationReferenceRangeAppliesTo</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="ObservationReferenceRangeAppliesTo.md" target="_blank">electronicMedicalRecords/ObservationReferenceRangeAppliesTo</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="ObservationReferenceRangeAppliesTo.md" target="_blank">electronicMedicalRecords/ObservationReferenceRangeAppliesTo</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="ObservationReferenceRangeAppliesTo.md" target="_blank">electronicMedicalRecords/ObservationReferenceRangeAppliesTo</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="ObservationReferenceRangeAppliesTo.md" target="_blank">electronicMedicalRecords/ObservationReferenceRangeAppliesTo</a>|
|[ownerId](#ownerId)|Owner Id|<a href="ObservationReferenceRangeAppliesTo.md" target="_blank">electronicMedicalRecords/ObservationReferenceRangeAppliesTo</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="ObservationReferenceRangeAppliesTo.md" target="_blank">electronicMedicalRecords/ObservationReferenceRangeAppliesTo</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="ObservationReferenceRangeAppliesTo.md" target="_blank">electronicMedicalRecords/ObservationReferenceRangeAppliesTo</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="ObservationReferenceRangeAppliesTo.md" target="_blank">electronicMedicalRecords/ObservationReferenceRangeAppliesTo</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="ObservationReferenceRangeAppliesTo.md" target="_blank">electronicMedicalRecords/ObservationReferenceRangeAppliesTo</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="ObservationReferenceRangeAppliesTo.md" target="_blank">electronicMedicalRecords/ObservationReferenceRangeAppliesTo</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="ObservationReferenceRangeAppliesTo.md" target="_blank">electronicMedicalRecords/ObservationReferenceRangeAppliesTo</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="ObservationReferenceRangeAppliesTo.md" target="_blank">electronicMedicalRecords/ObservationReferenceRangeAppliesTo</a>|
|[name](#name)|The name of the custom entity.|<a href="ObservationReferenceRangeAppliesTo.md" target="_blank">electronicMedicalRecords/ObservationReferenceRangeAppliesTo</a>|
|[observationId](#observationId)|Business Identifier for observation|<a href="ObservationReferenceRangeAppliesTo.md" target="_blank">electronicMedicalRecords/ObservationReferenceRangeAppliesTo</a>|
|[observationReferenceRangeAppliesToId](#observationReferenceRangeAppliesToId)|Unique identifier for entity instances|<a href="ObservationReferenceRangeAppliesTo.md" target="_blank">electronicMedicalRecords/ObservationReferenceRangeAppliesTo</a>|
|[obsReferenceRangeAppliesToId](#obsReferenceRangeAppliesToId)|Codes to indicate the target population this reference range applies to. For example, a reference range may be based on the normal population or a particular sex or race.|<a href="ObservationReferenceRangeAppliesTo.md" target="_blank">electronicMedicalRecords/ObservationReferenceRangeAppliesTo</a>|
|[stateCode](#stateCode)|Status of the Observation Reference Range Applies To|<a href="ObservationReferenceRangeAppliesTo.md" target="_blank">electronicMedicalRecords/ObservationReferenceRangeAppliesTo</a>|
|[stateCode_display](#stateCode_display)||<a href="ObservationReferenceRangeAppliesTo.md" target="_blank">electronicMedicalRecords/ObservationReferenceRangeAppliesTo</a>|
|[statusCode](#statusCode)|Reason for the status of the Observation Reference Range Applies To|<a href="ObservationReferenceRangeAppliesTo.md" target="_blank">electronicMedicalRecords/ObservationReferenceRangeAppliesTo</a>|
|[statusCode_display](#statusCode_display)||<a href="ObservationReferenceRangeAppliesTo.md" target="_blank">electronicMedicalRecords/ObservationReferenceRangeAppliesTo</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/ObservationReferenceRangeAppliesTo (this entity)  
...
### <a href=#observationReferenceRangeAppliesToId name="observationReferenceRangeAppliesToId">observationReferenceRangeAppliesToId</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Observation Reference Range Applies To</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_observationreferencerangeappliestoid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the observationReferenceRangeAppliesToId attribute are listed below.</summary>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_observationreferencerangeappliestoid"</td><td>string</td><td></td></tr></table>
...
### <a href=#obsReferenceRangeAppliesToId name="obsReferenceRangeAppliesToId">obsReferenceRangeAppliesToId</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Applies To</td></tr><tr><td>description</td><td>Codes to indicate the target population this reference range applies to. For example, a reference range may be based on the normal population or a particular sex or race.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_obsreferencerangeappliesto</td></tr></table>

#### Traits

<details>
<summary>List of traits for the obsReferenceRangeAppliesToId attribute are listed below.</summary>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Applies To</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_obsreferencerangeappliesto"</td><td>string</td><td></td></tr></table>
...
Status of the Observation Reference Range Applies To  
First included in: electronicMedicalRecords/ObservationReferenceRangeAppliesTo (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Observation Reference Range Applies To</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the Observation Reference Range Applies To</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
Reason for the status of the Observation Reference Range Applies To  
First included in: electronicMedicalRecords/ObservationReferenceRangeAppliesTo (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Observation Reference Range Applies To</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the Observation Reference Range Applies To</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
