---
title: RequestGroupReplace in electronicMedicalRecords - Common Data Model | Microsoft Docs
...
# Request Group Replace in electronicMedicalRecords

Completed or terminated request(s) whose function is taken by this new request.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/RequestGroupReplace.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/core/applicationCommon/foundationCommon<br>/crmCommon/accelerators/healthCare<br>/electronicMedicalRecords<br>/RequestGroupReplace.cdm.json/RequestGroupReplace<br>/hasAttributes/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[RequestGroupReplace/(resolvedAttributes)/requestGroupReplaceId](#requestGroupReplaceId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[RequestGroupReplace/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Request Group Replace</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_requestgroupreplace"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="RequestGroupReplace.md" target="_blank">electronicMedicalRecords/RequestGroupReplace</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="RequestGroupReplace.md" target="_blank">electronicMedicalRecords/RequestGroupReplace</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="RequestGroupReplace.md" target="_blank">electronicMedicalRecords/RequestGroupReplace</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="RequestGroupReplace.md" target="_blank">electronicMedicalRecords/RequestGroupReplace</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="RequestGroupReplace.md" target="_blank">electronicMedicalRecords/RequestGroupReplace</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="RequestGroupReplace.md" target="_blank">electronicMedicalRecords/RequestGroupReplace</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="RequestGroupReplace.md" target="_blank">electronicMedicalRecords/RequestGroupReplace</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="RequestGroupReplace.md" target="_blank">electronicMedicalRecords/RequestGroupReplace</a>|
|[ownerId](#ownerId)|Owner Id|<a href="RequestGroupReplace.md" target="_blank">electronicMedicalRecords/RequestGroupReplace</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="RequestGroupReplace.md" target="_blank">electronicMedicalRecords/RequestGroupReplace</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="RequestGroupReplace.md" target="_blank">electronicMedicalRecords/RequestGroupReplace</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="RequestGroupReplace.md" target="_blank">electronicMedicalRecords/RequestGroupReplace</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="RequestGroupReplace.md" target="_blank">electronicMedicalRecords/RequestGroupReplace</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="RequestGroupReplace.md" target="_blank">electronicMedicalRecords/RequestGroupReplace</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="RequestGroupReplace.md" target="_blank">electronicMedicalRecords/RequestGroupReplace</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="RequestGroupReplace.md" target="_blank">electronicMedicalRecords/RequestGroupReplace</a>|
|[name](#name)|The name of the custom entity.|<a href="RequestGroupReplace.md" target="_blank">electronicMedicalRecords/RequestGroupReplace</a>|
|[replaces](#replaces)|Completed or terminated request(s) whose function is taken by this new request.|<a href="RequestGroupReplace.md" target="_blank">electronicMedicalRecords/RequestGroupReplace</a>|
|[requestGroupId](#requestGroupId)|Identifier for Request Group.|<a href="RequestGroupReplace.md" target="_blank">electronicMedicalRecords/RequestGroupReplace</a>|
|[requestGroupReplaceId](#requestGroupReplaceId)|Unique identifier for entity instances|<a href="RequestGroupReplace.md" target="_blank">electronicMedicalRecords/RequestGroupReplace</a>|
|[stateCode](#stateCode)|Status of the Request Group Replace|<a href="RequestGroupReplace.md" target="_blank">electronicMedicalRecords/RequestGroupReplace</a>|
|[stateCode_display](#stateCode_display)||<a href="RequestGroupReplace.md" target="_blank">electronicMedicalRecords/RequestGroupReplace</a>|
|[statusCode](#statusCode)|Reason for the status of the Request Group Replace|<a href="RequestGroupReplace.md" target="_blank">electronicMedicalRecords/RequestGroupReplace</a>|
|[statusCode_display](#statusCode_display)||<a href="RequestGroupReplace.md" target="_blank">electronicMedicalRecords/RequestGroupReplace</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/RequestGroupReplace (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Replaces</td></tr><tr><td>description</td><td>Completed or terminated request(s) whose function is taken by this new request.</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>2000</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_replaces</td></tr></table>
...
### <a href=#requestGroupReplaceId name="requestGroupReplaceId">requestGroupReplaceId</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Request Group Replace</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>sourceName</td><td>msemr_requestgroupreplaceid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the requestGroupReplaceId attribute are listed below.</summary>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_requestgroupreplaceid"</td><td>string</td><td></td></tr></table>
...
Status of the Request Group Replace  
First included in: electronicMedicalRecords/RequestGroupReplace (this entity)  
...
Reason for the status of the Request Group Replace  
First included in: electronicMedicalRecords/RequestGroupReplace (this entity)  
