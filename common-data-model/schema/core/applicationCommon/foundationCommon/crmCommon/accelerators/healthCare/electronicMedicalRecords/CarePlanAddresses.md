---
title: CarePlanAddresses - Common Data Model | Microsoft Docs
...
Identifies the conditions/problems/concerns/diagnoses/etc. whose management and/or mitigation are handled by this plan.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/CarePlanAddresses.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="CarePlanAddresses.md" target="_blank">electronicMedicalRecords/CarePlanAddresses</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="CarePlanAddresses.md" target="_blank">electronicMedicalRecords/CarePlanAddresses</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="CarePlanAddresses.md" target="_blank">electronicMedicalRecords/CarePlanAddresses</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="CarePlanAddresses.md" target="_blank">electronicMedicalRecords/CarePlanAddresses</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="CarePlanAddresses.md" target="_blank">electronicMedicalRecords/CarePlanAddresses</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="CarePlanAddresses.md" target="_blank">electronicMedicalRecords/CarePlanAddresses</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="CarePlanAddresses.md" target="_blank">electronicMedicalRecords/CarePlanAddresses</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="CarePlanAddresses.md" target="_blank">electronicMedicalRecords/CarePlanAddresses</a>|
|[ownerId](#ownerId)|Owner Id|<a href="CarePlanAddresses.md" target="_blank">electronicMedicalRecords/CarePlanAddresses</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="CarePlanAddresses.md" target="_blank">electronicMedicalRecords/CarePlanAddresses</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="CarePlanAddresses.md" target="_blank">electronicMedicalRecords/CarePlanAddresses</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="CarePlanAddresses.md" target="_blank">electronicMedicalRecords/CarePlanAddresses</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="CarePlanAddresses.md" target="_blank">electronicMedicalRecords/CarePlanAddresses</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="CarePlanAddresses.md" target="_blank">electronicMedicalRecords/CarePlanAddresses</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="CarePlanAddresses.md" target="_blank">electronicMedicalRecords/CarePlanAddresses</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="CarePlanAddresses.md" target="_blank">electronicMedicalRecords/CarePlanAddresses</a>|
|[addressesId](#addressesId)|Links plan to the conditions it manages. The element can identify risks addressed by the plan as well as active conditions.|<a href="CarePlanAddresses.md" target="_blank">electronicMedicalRecords/CarePlanAddresses</a>|
|[carePlanId](#carePlanId)|Describes the intention of how one or more practitioners intend to deliver care for a particular patient, group or community for a period of time, possibly limited to care for a specific condition.|<a href="CarePlanAddresses.md" target="_blank">electronicMedicalRecords/CarePlanAddresses</a>|
|[carePlanAddressesId](#carePlanAddressesId)|Unique identifier for entity instances|<a href="CarePlanAddresses.md" target="_blank">electronicMedicalRecords/CarePlanAddresses</a>|
|[name](#name)|The name of the custom entity.|<a href="CarePlanAddresses.md" target="_blank">electronicMedicalRecords/CarePlanAddresses</a>|
|[stateCode](#stateCode)|Status of the Care Plan Addresses|<a href="CarePlanAddresses.md" target="_blank">electronicMedicalRecords/CarePlanAddresses</a>|
|[stateCode_display](#stateCode_display)||<a href="CarePlanAddresses.md" target="_blank">electronicMedicalRecords/CarePlanAddresses</a>|
|[statusCode](#statusCode)|Reason for the status of the Care Plan Addresses|<a href="CarePlanAddresses.md" target="_blank">electronicMedicalRecords/CarePlanAddresses</a>|
|[statusCode_display](#statusCode_display)||<a href="CarePlanAddresses.md" target="_blank">electronicMedicalRecords/CarePlanAddresses</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/CarePlanAddresses (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Addresses</td></tr><tr><td>description</td><td>Links plan to the conditions it manages. The element can identify risks addressed by the plan as well as active conditions.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_addresses</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Care Plan Addresses</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_careplanaddressesid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Care Plan Addresses</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Care Plan Addresses</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
