---
title: ConditionEvidence - Common Data Model | Microsoft Docs
...
Supporting Evidence / manifestations that are the basis on which this condition is suspected or confirmed.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/ConditionEvidence.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="ConditionEvidence.md" target="_blank">electronicMedicalRecords/ConditionEvidence</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="ConditionEvidence.md" target="_blank">electronicMedicalRecords/ConditionEvidence</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="ConditionEvidence.md" target="_blank">electronicMedicalRecords/ConditionEvidence</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="ConditionEvidence.md" target="_blank">electronicMedicalRecords/ConditionEvidence</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="ConditionEvidence.md" target="_blank">electronicMedicalRecords/ConditionEvidence</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="ConditionEvidence.md" target="_blank">electronicMedicalRecords/ConditionEvidence</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="ConditionEvidence.md" target="_blank">electronicMedicalRecords/ConditionEvidence</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="ConditionEvidence.md" target="_blank">electronicMedicalRecords/ConditionEvidence</a>|
|[ownerId](#ownerId)|Owner Id|<a href="ConditionEvidence.md" target="_blank">electronicMedicalRecords/ConditionEvidence</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="ConditionEvidence.md" target="_blank">electronicMedicalRecords/ConditionEvidence</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="ConditionEvidence.md" target="_blank">electronicMedicalRecords/ConditionEvidence</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="ConditionEvidence.md" target="_blank">electronicMedicalRecords/ConditionEvidence</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="ConditionEvidence.md" target="_blank">electronicMedicalRecords/ConditionEvidence</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="ConditionEvidence.md" target="_blank">electronicMedicalRecords/ConditionEvidence</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="ConditionEvidence.md" target="_blank">electronicMedicalRecords/ConditionEvidence</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="ConditionEvidence.md" target="_blank">electronicMedicalRecords/ConditionEvidence</a>|
|[conditionId](#conditionId)|Detailed information about conditions, problems or diagnoses.|<a href="ConditionEvidence.md" target="_blank">electronicMedicalRecords/ConditionEvidence</a>|
|[conditionEvidenceId](#conditionEvidenceId)|Unique identifier for entity instances|<a href="ConditionEvidence.md" target="_blank">electronicMedicalRecords/ConditionEvidence</a>|
|[detail](#detail)|Supporting Evidence / manifestations that are the basis on which this condition is suspected or confirmed.|<a href="ConditionEvidence.md" target="_blank">electronicMedicalRecords/ConditionEvidence</a>|
|[evidenceCodeId](#evidenceCodeId)|Manifestation and symptom codes.|<a href="ConditionEvidence.md" target="_blank">electronicMedicalRecords/ConditionEvidence</a>|
|[name](#name)|The name of the custom entity.|<a href="ConditionEvidence.md" target="_blank">electronicMedicalRecords/ConditionEvidence</a>|
|[stateCode](#stateCode)|Status of the Condition Evidence|<a href="ConditionEvidence.md" target="_blank">electronicMedicalRecords/ConditionEvidence</a>|
|[stateCode_display](#stateCode_display)||<a href="ConditionEvidence.md" target="_blank">electronicMedicalRecords/ConditionEvidence</a>|
|[statusCode](#statusCode)|Reason for the status of the Condition Evidence|<a href="ConditionEvidence.md" target="_blank">electronicMedicalRecords/ConditionEvidence</a>|
|[statusCode_display](#statusCode_display)||<a href="ConditionEvidence.md" target="_blank">electronicMedicalRecords/ConditionEvidence</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/ConditionEvidence (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Condition Evidence</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_conditionevidenceid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Evidence Detail</td></tr><tr><td>description</td><td>Supporting Evidence / manifestations that are the basis on which this condition is suspected or confirmed.</td></tr><tr><td>dataFormat</td><td>7</td></tr><tr><td>maximumLength</td><td>2000</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_detail</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Evidence Code</td></tr><tr><td>description</td><td>Manifestation and symptom codes.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_evidencecode</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Condition Evidence</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Condition Evidence</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
