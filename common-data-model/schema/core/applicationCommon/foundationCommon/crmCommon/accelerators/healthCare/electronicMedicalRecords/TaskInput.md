...
Additional information that may be needed in the execution of the task.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/TaskInput.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="TaskInput.md" target="_blank">electronicMedicalRecords/TaskInput</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="TaskInput.md" target="_blank">electronicMedicalRecords/TaskInput</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="TaskInput.md" target="_blank">electronicMedicalRecords/TaskInput</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="TaskInput.md" target="_blank">electronicMedicalRecords/TaskInput</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="TaskInput.md" target="_blank">electronicMedicalRecords/TaskInput</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="TaskInput.md" target="_blank">electronicMedicalRecords/TaskInput</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="TaskInput.md" target="_blank">electronicMedicalRecords/TaskInput</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="TaskInput.md" target="_blank">electronicMedicalRecords/TaskInput</a>|
|[ownerId](#ownerId)|Owner Id|<a href="TaskInput.md" target="_blank">electronicMedicalRecords/TaskInput</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="TaskInput.md" target="_blank">electronicMedicalRecords/TaskInput</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="TaskInput.md" target="_blank">electronicMedicalRecords/TaskInput</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="TaskInput.md" target="_blank">electronicMedicalRecords/TaskInput</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="TaskInput.md" target="_blank">electronicMedicalRecords/TaskInput</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="TaskInput.md" target="_blank">electronicMedicalRecords/TaskInput</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="TaskInput.md" target="_blank">electronicMedicalRecords/TaskInput</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="TaskInput.md" target="_blank">electronicMedicalRecords/TaskInput</a>|
|[inputTypeId](#inputTypeId)|A code or description indicating how the input is intended to be used as part of the task execution.|<a href="TaskInput.md" target="_blank">electronicMedicalRecords/TaskInput</a>|
|[inputValue](#inputValue)|The value of the input parameter as a basic type.|<a href="TaskInput.md" target="_blank">electronicMedicalRecords/TaskInput</a>|
|[name](#name)|The name of the custom entity.|<a href="TaskInput.md" target="_blank">electronicMedicalRecords/TaskInput</a>|
|[taskId](#taskId)|Unique identifier for Task.|<a href="TaskInput.md" target="_blank">electronicMedicalRecords/TaskInput</a>|
|[taskInputId](#taskInputId)|Unique identifier for entity instances|<a href="TaskInput.md" target="_blank">electronicMedicalRecords/TaskInput</a>|
|[stateCode](#stateCode)|Status of the Task Input|<a href="TaskInput.md" target="_blank">electronicMedicalRecords/TaskInput</a>|
|[stateCode_display](#stateCode_display)||<a href="TaskInput.md" target="_blank">electronicMedicalRecords/TaskInput</a>|
|[statusCode](#statusCode)|Reason for the status of the Task Input|<a href="TaskInput.md" target="_blank">electronicMedicalRecords/TaskInput</a>|
|[statusCode_display](#statusCode_display)||<a href="TaskInput.md" target="_blank">electronicMedicalRecords/TaskInput</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/TaskInput (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Value (Input)</td></tr><tr><td>description</td><td>The value of the input parameter as a basic type.</td></tr><tr><td>dataFormat</td><td>7</td></tr><tr><td>maximumLength</td><td>100</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_inputvalue</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Task Input</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_taskinputid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Task Input</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Task Input</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
