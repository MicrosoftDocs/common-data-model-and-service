---
title: GoalOutcome - Common Data Model | Microsoft Docs
...
Identifies the change (or lack of change) at the point when the status of the goal is assessed.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/GoalOutcome.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="GoalOutcome.md" target="_blank">electronicMedicalRecords/GoalOutcome</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="GoalOutcome.md" target="_blank">electronicMedicalRecords/GoalOutcome</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="GoalOutcome.md" target="_blank">electronicMedicalRecords/GoalOutcome</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="GoalOutcome.md" target="_blank">electronicMedicalRecords/GoalOutcome</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="GoalOutcome.md" target="_blank">electronicMedicalRecords/GoalOutcome</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="GoalOutcome.md" target="_blank">electronicMedicalRecords/GoalOutcome</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="GoalOutcome.md" target="_blank">electronicMedicalRecords/GoalOutcome</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="GoalOutcome.md" target="_blank">electronicMedicalRecords/GoalOutcome</a>|
|[ownerId](#ownerId)|Owner Id|<a href="GoalOutcome.md" target="_blank">electronicMedicalRecords/GoalOutcome</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="GoalOutcome.md" target="_blank">electronicMedicalRecords/GoalOutcome</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="GoalOutcome.md" target="_blank">electronicMedicalRecords/GoalOutcome</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="GoalOutcome.md" target="_blank">electronicMedicalRecords/GoalOutcome</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="GoalOutcome.md" target="_blank">electronicMedicalRecords/GoalOutcome</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="GoalOutcome.md" target="_blank">electronicMedicalRecords/GoalOutcome</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="GoalOutcome.md" target="_blank">electronicMedicalRecords/GoalOutcome</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="GoalOutcome.md" target="_blank">electronicMedicalRecords/GoalOutcome</a>|
|[goalId](#goalId)|Describes the intended objective(s) for a patient, group or organization care|<a href="GoalOutcome.md" target="_blank">electronicMedicalRecords/GoalOutcome</a>|
|[goalOutcomeCodeId](#goalOutcomeCodeId)|Identifies the change (or lack of change) at the point when the status of the goal is assessed.|<a href="GoalOutcome.md" target="_blank">electronicMedicalRecords/GoalOutcome</a>|
|[goalOutcomeId](#goalOutcomeId)|Unique identifier for entity instances|<a href="GoalOutcome.md" target="_blank">electronicMedicalRecords/GoalOutcome</a>|
|[name](#name)|The name of the custom entity.|<a href="GoalOutcome.md" target="_blank">electronicMedicalRecords/GoalOutcome</a>|
|[stateCode](#stateCode)|Status of the Goal Outcome|<a href="GoalOutcome.md" target="_blank">electronicMedicalRecords/GoalOutcome</a>|
|[stateCode_display](#stateCode_display)||<a href="GoalOutcome.md" target="_blank">electronicMedicalRecords/GoalOutcome</a>|
|[statusCode](#statusCode)|Reason for the status of the Goal Outcome|<a href="GoalOutcome.md" target="_blank">electronicMedicalRecords/GoalOutcome</a>|
|[statusCode_display](#statusCode_display)||<a href="GoalOutcome.md" target="_blank">electronicMedicalRecords/GoalOutcome</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/GoalOutcome (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Goal</td></tr><tr><td>description</td><td>Describes the intended objective(s) for a patient, group or organization care</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_goal</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Goal Outcome</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_goaloutcomeid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Goal Outcome</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Goal Outcome</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
