---
title: PractitionerSpecialty - Common Data Model | Microsoft Docs
...
Specific specialty of the practitioner.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/PractitionerSpecialty.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="PractitionerSpecialty.md" target="_blank">electronicMedicalRecords/PractitionerSpecialty</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="PractitionerSpecialty.md" target="_blank">electronicMedicalRecords/PractitionerSpecialty</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="PractitionerSpecialty.md" target="_blank">electronicMedicalRecords/PractitionerSpecialty</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="PractitionerSpecialty.md" target="_blank">electronicMedicalRecords/PractitionerSpecialty</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="PractitionerSpecialty.md" target="_blank">electronicMedicalRecords/PractitionerSpecialty</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="PractitionerSpecialty.md" target="_blank">electronicMedicalRecords/PractitionerSpecialty</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="PractitionerSpecialty.md" target="_blank">electronicMedicalRecords/PractitionerSpecialty</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="PractitionerSpecialty.md" target="_blank">electronicMedicalRecords/PractitionerSpecialty</a>|
|[ownerId](#ownerId)|Owner Id|<a href="PractitionerSpecialty.md" target="_blank">electronicMedicalRecords/PractitionerSpecialty</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="PractitionerSpecialty.md" target="_blank">electronicMedicalRecords/PractitionerSpecialty</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="PractitionerSpecialty.md" target="_blank">electronicMedicalRecords/PractitionerSpecialty</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="PractitionerSpecialty.md" target="_blank">electronicMedicalRecords/PractitionerSpecialty</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="PractitionerSpecialty.md" target="_blank">electronicMedicalRecords/PractitionerSpecialty</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="PractitionerSpecialty.md" target="_blank">electronicMedicalRecords/PractitionerSpecialty</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="PractitionerSpecialty.md" target="_blank">electronicMedicalRecords/PractitionerSpecialty</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="PractitionerSpecialty.md" target="_blank">electronicMedicalRecords/PractitionerSpecialty</a>|
|[code](#code)||<a href="PractitionerSpecialty.md" target="_blank">electronicMedicalRecords/PractitionerSpecialty</a>|
|[display](#display)|The name of the custom entity.|<a href="PractitionerSpecialty.md" target="_blank">electronicMedicalRecords/PractitionerSpecialty</a>|
|[practitionerSpecialtyId](#practitionerSpecialtyId)|Unique identifier for entity instances|<a href="PractitionerSpecialty.md" target="_blank">electronicMedicalRecords/PractitionerSpecialty</a>|
|[system](#system)||<a href="PractitionerSpecialty.md" target="_blank">electronicMedicalRecords/PractitionerSpecialty</a>|
|[stateCode](#stateCode)|Status of the Practitioner Specialty|<a href="PractitionerSpecialty.md" target="_blank">electronicMedicalRecords/PractitionerSpecialty</a>|
|[stateCode_display](#stateCode_display)||<a href="PractitionerSpecialty.md" target="_blank">electronicMedicalRecords/PractitionerSpecialty</a>|
|[statusCode](#statusCode)|Reason for the status of the Practitioner Specialty|<a href="PractitionerSpecialty.md" target="_blank">electronicMedicalRecords/PractitionerSpecialty</a>|
|[statusCode_display](#statusCode_display)||<a href="PractitionerSpecialty.md" target="_blank">electronicMedicalRecords/PractitionerSpecialty</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/PractitionerSpecialty (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Practitioner Specialty</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_practitionerspecialtyid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Practitioner Specialty</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Practitioner Specialty</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
