---
title: EncounterLocation - Common Data Model | Microsoft Docs
...
List of locations where the patient has been during this encounter.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/EncounterLocation.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="EncounterLocation.md" target="_blank">electronicMedicalRecords/EncounterLocation</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="EncounterLocation.md" target="_blank">electronicMedicalRecords/EncounterLocation</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="EncounterLocation.md" target="_blank">electronicMedicalRecords/EncounterLocation</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="EncounterLocation.md" target="_blank">electronicMedicalRecords/EncounterLocation</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="EncounterLocation.md" target="_blank">electronicMedicalRecords/EncounterLocation</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="EncounterLocation.md" target="_blank">electronicMedicalRecords/EncounterLocation</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="EncounterLocation.md" target="_blank">electronicMedicalRecords/EncounterLocation</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="EncounterLocation.md" target="_blank">electronicMedicalRecords/EncounterLocation</a>|
|[ownerId](#ownerId)|Owner Id|<a href="EncounterLocation.md" target="_blank">electronicMedicalRecords/EncounterLocation</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="EncounterLocation.md" target="_blank">electronicMedicalRecords/EncounterLocation</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="EncounterLocation.md" target="_blank">electronicMedicalRecords/EncounterLocation</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="EncounterLocation.md" target="_blank">electronicMedicalRecords/EncounterLocation</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="EncounterLocation.md" target="_blank">electronicMedicalRecords/EncounterLocation</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="EncounterLocation.md" target="_blank">electronicMedicalRecords/EncounterLocation</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="EncounterLocation.md" target="_blank">electronicMedicalRecords/EncounterLocation</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="EncounterLocation.md" target="_blank">electronicMedicalRecords/EncounterLocation</a>|
|[encounterId](#encounterId)|An interaction between a patient and healthcare provider(s) for the purpose of providing healthcare service(s) or assessing the health status of a patient.|<a href="EncounterLocation.md" target="_blank">electronicMedicalRecords/EncounterLocation</a>|
|[encounterLocationEndDate](#encounterLocationEndDate)|Time period during which the patient was present at the location|<a href="EncounterLocation.md" target="_blank">electronicMedicalRecords/EncounterLocation</a>|
|[encounterLocationId](#encounterLocationId)|Unique identifier for entity instances|<a href="EncounterLocation.md" target="_blank">electronicMedicalRecords/EncounterLocation</a>|
|[encounterLocationIdentifierId](#encounterLocationIdentifierId)|The location where the encounter takes place|<a href="EncounterLocation.md" target="_blank">electronicMedicalRecords/EncounterLocation</a>|
|[encounterLocationStartDate](#encounterLocationStartDate)|Time period during which the patient was present at the location|<a href="EncounterLocation.md" target="_blank">electronicMedicalRecords/EncounterLocation</a>|
...
|[encounterLocationStatus_display](#encounterLocationStatus_display)||<a href="EncounterLocation.md" target="_blank">electronicMedicalRecords/EncounterLocation</a>|
|[name](#name)|The name of the custom entity.|<a href="EncounterLocation.md" target="_blank">electronicMedicalRecords/EncounterLocation</a>|
|[stateCode](#stateCode)|Status of the Encounter Location|<a href="EncounterLocation.md" target="_blank">electronicMedicalRecords/EncounterLocation</a>|
|[stateCode_display](#stateCode_display)||<a href="EncounterLocation.md" target="_blank">electronicMedicalRecords/EncounterLocation</a>|
|[statusCode](#statusCode)|Reason for the status of the Encounter Location|<a href="EncounterLocation.md" target="_blank">electronicMedicalRecords/EncounterLocation</a>|
|[statusCode_display](#statusCode_display)||<a href="EncounterLocation.md" target="_blank">electronicMedicalRecords/EncounterLocation</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/EncounterLocation (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>End Date</td></tr><tr><td>description</td><td>Time period during which the patient was present at the location</td></tr><tr><td>dataFormat</td><td>13</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_encounterlocationenddate</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Encounter Location</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_encounterlocationid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Location</td></tr><tr><td>description</td><td>The location where the encounter takes place</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_encounterlocationidentifier</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Encounter Location</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Encounter Location</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
