---
title: CarePlanActivityOutcome - Common Data Model | Microsoft Docs
...
Identifies the outcome at the point when the status of the activity is assessed. For example, the outcome of an education activity could be patient understands (or not).  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/CarePlanActivityOutcome.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="CarePlanActivityOutcome.md" target="_blank">electronicMedicalRecords/CarePlanActivityOutcome</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="CarePlanActivityOutcome.md" target="_blank">electronicMedicalRecords/CarePlanActivityOutcome</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="CarePlanActivityOutcome.md" target="_blank">electronicMedicalRecords/CarePlanActivityOutcome</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="CarePlanActivityOutcome.md" target="_blank">electronicMedicalRecords/CarePlanActivityOutcome</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="CarePlanActivityOutcome.md" target="_blank">electronicMedicalRecords/CarePlanActivityOutcome</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="CarePlanActivityOutcome.md" target="_blank">electronicMedicalRecords/CarePlanActivityOutcome</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="CarePlanActivityOutcome.md" target="_blank">electronicMedicalRecords/CarePlanActivityOutcome</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="CarePlanActivityOutcome.md" target="_blank">electronicMedicalRecords/CarePlanActivityOutcome</a>|
|[ownerId](#ownerId)|Owner Id|<a href="CarePlanActivityOutcome.md" target="_blank">electronicMedicalRecords/CarePlanActivityOutcome</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="CarePlanActivityOutcome.md" target="_blank">electronicMedicalRecords/CarePlanActivityOutcome</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="CarePlanActivityOutcome.md" target="_blank">electronicMedicalRecords/CarePlanActivityOutcome</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="CarePlanActivityOutcome.md" target="_blank">electronicMedicalRecords/CarePlanActivityOutcome</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="CarePlanActivityOutcome.md" target="_blank">electronicMedicalRecords/CarePlanActivityOutcome</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="CarePlanActivityOutcome.md" target="_blank">electronicMedicalRecords/CarePlanActivityOutcome</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="CarePlanActivityOutcome.md" target="_blank">electronicMedicalRecords/CarePlanActivityOutcome</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="CarePlanActivityOutcome.md" target="_blank">electronicMedicalRecords/CarePlanActivityOutcome</a>|
|[activityId](#activityId)|Identifies a planned action to occur as part of the plan. For example, a medication to be used, lab tests to perform, self-monitoring, education, etc.|<a href="CarePlanActivityOutcome.md" target="_blank">electronicMedicalRecords/CarePlanActivityOutcome</a>|
|[activityOutcomeIdentifierId](#activityOutcomeIdentifierId)|Identifies the outcome at the point when the status of the activity is assessed. For example, the outcome of an education activity could be patient understands (or not).|<a href="CarePlanActivityOutcome.md" target="_blank">electronicMedicalRecords/CarePlanActivityOutcome</a>|
|[carePlanActivityOutcomeId](#carePlanActivityOutcomeId)|Unique identifier for entity instances|<a href="CarePlanActivityOutcome.md" target="_blank">electronicMedicalRecords/CarePlanActivityOutcome</a>|
|[display](#display)|The name of the custom entity.|<a href="CarePlanActivityOutcome.md" target="_blank">electronicMedicalRecords/CarePlanActivityOutcome</a>|
|[stateCode](#stateCode)|Status of the Care Plan Activity Outcome|<a href="CarePlanActivityOutcome.md" target="_blank">electronicMedicalRecords/CarePlanActivityOutcome</a>|
|[stateCode_display](#stateCode_display)||<a href="CarePlanActivityOutcome.md" target="_blank">electronicMedicalRecords/CarePlanActivityOutcome</a>|
|[statusCode](#statusCode)|Reason for the status of the Care Plan Activity Outcome|<a href="CarePlanActivityOutcome.md" target="_blank">electronicMedicalRecords/CarePlanActivityOutcome</a>|
|[statusCode_display](#statusCode_display)||<a href="CarePlanActivityOutcome.md" target="_blank">electronicMedicalRecords/CarePlanActivityOutcome</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/CarePlanActivityOutcome (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Activity Outcome</td></tr><tr><td>description</td><td>Identifies the outcome at the point when the status of the activity is assessed. For example, the outcome of an education activity could be patient understands (or not).</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_activityoutcomeidentifier</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Care Plan Activity Outcome</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_careplanactivityoutcomeid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Care Plan Activity Outcome</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Care Plan Activity Outcome</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
