...
- /crmCommon/accelerators/healthCare/electronicMedicalRecords/Product  
...
|---|---|---|
|[productId](#productId)|Unique identifier of the product.|<a href="Product.md" target="_blank">electronicMedicalRecords/Product</a>|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="Product.md" target="_blank">electronicMedicalRecords/Product</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the product.|<a href="Product.md" target="_blank">electronicMedicalRecords/Product</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="Product.md" target="_blank">electronicMedicalRecords/Product</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who last modified the product.|<a href="Product.md" target="_blank">electronicMedicalRecords/Product</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the product.|<a href="Product.md" target="_blank">electronicMedicalRecords/Product</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who last modified the product.|<a href="Product.md" target="_blank">electronicMedicalRecords/Product</a>|
|[organizationId](#organizationId)|Unique identifier for the organization|<a href="Product.md" target="_blank">electronicMedicalRecords/Product</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="Product.md" target="_blank">electronicMedicalRecords/Product</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="Product.md" target="_blank">electronicMedicalRecords/Product</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="Product.md" target="_blank">electronicMedicalRecords/Product</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="Product.md" target="_blank">electronicMedicalRecords/Product</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="Product.md" target="_blank">electronicMedicalRecords/Product</a>|
|[name](#name)|Name of the product.|<a href="Product.md" target="_blank">electronicMedicalRecords/Product</a>|
|[processId](#processId)|Contains the id of the process associated with the entity.|<a href="Product.md" target="_blank">electronicMedicalRecords/Product</a>|
|[stageId](#stageId)|Contains the id of the stage where the entity is located.|<a href="Product.md" target="_blank">electronicMedicalRecords/Product</a>|
|[traversedPath](#traversedPath)|A comma separated list of string values representing the unique identifiers of stages in a Business Process Flow Instance in the order that they occur.|<a href="Product.md" target="_blank">electronicMedicalRecords/Product</a>|
|[vendorID](#vendorID)|Unique identifier of vendor supplying the product.|<a href="Product.md" target="_blank">electronicMedicalRecords/Product</a>|
|[validFromDate](#validFromDate)|Date from which this product is valid.|<a href="Product.md" target="_blank">electronicMedicalRecords/Product</a>|
|[validToDate](#validToDate)|Date to which this product is valid.|<a href="Product.md" target="_blank">electronicMedicalRecords/Product</a>|
|[currentCost](#currentCost)|Current cost for the product item. Used in price calculations.|<a href="Product.md" target="_blank">electronicMedicalRecords/Product</a>|
|[transactionCurrencyId](#transactionCurrencyId)|Unique identifier of the currency associated with the product.|<a href="Product.md" target="_blank">electronicMedicalRecords/Product</a>|
|[exchangeRate](#exchangeRate)|Exchange rate for the currency associated with the product with respect to the base currency.|<a href="Product.md" target="_blank">electronicMedicalRecords/Product</a>|
|[currentCostBase](#currentCostBase)|Value of the Current Cost in base currency.|<a href="Product.md" target="_blank">electronicMedicalRecords/Product</a>|
|[defaultUoMId](#defaultUoMId)|Default unit for the product.|<a href="Product.md" target="_blank">electronicMedicalRecords/Product</a>|
|[defaultUoMScheduleId](#defaultUoMScheduleId)|Default unit group for the product.|<a href="Product.md" target="_blank">electronicMedicalRecords/Product</a>|
|[description](#description)|Description of the product.|<a href="Product.md" target="_blank">electronicMedicalRecords/Product</a>|
|[isKit](#isKit)|Information that specifies whether the product is a kit.|<a href="Product.md" target="_blank">electronicMedicalRecords/Product</a>|
|[isStockItem](#isStockItem)|Information about whether the product is a stock item.|<a href="Product.md" target="_blank">electronicMedicalRecords/Product</a>|
|[parentProductId](#parentProductId)|Specifies the parent product family hierarchy.|<a href="Product.md" target="_blank">electronicMedicalRecords/Product</a>|
|[price](#price)|List price of the product.|<a href="Product.md" target="_blank">electronicMedicalRecords/Product</a>|
|[priceBase](#priceBase)|Value of the List Price in base currency.|<a href="Product.md" target="_blank">electronicMedicalRecords/Product</a>|
|[productStructure](#productStructure)|Product Structure.|<a href="Product.md" target="_blank">electronicMedicalRecords/Product</a>|
|[productStructure_display](#productStructure_display)||<a href="Product.md" target="_blank">electronicMedicalRecords/Product</a>|
|[productNumber](#productNumber)|User-defined product ID.|<a href="Product.md" target="_blank">electronicMedicalRecords/Product</a>|
|[productTypeCode](#productTypeCode)|Type of product.|<a href="Product.md" target="_blank">electronicMedicalRecords/Product</a>|
|[productTypeCode_display](#productTypeCode_display)||<a href="Product.md" target="_blank">electronicMedicalRecords/Product</a>|
|[productUrl](#productUrl)|URL for the Website associated with the product.|<a href="Product.md" target="_blank">electronicMedicalRecords/Product</a>|
|[quantityDecimal](#quantityDecimal)|Number of decimal places that can be used in monetary amounts for the product.|<a href="Product.md" target="_blank">electronicMedicalRecords/Product</a>|
|[quantityOnHand](#quantityOnHand)|Quantity of the product in stock.|<a href="Product.md" target="_blank">electronicMedicalRecords/Product</a>|
|[size](#size)|Product size.|<a href="Product.md" target="_blank">electronicMedicalRecords/Product</a>|
|[standardCost](#standardCost)|Standard cost of the product.|<a href="Product.md" target="_blank">electronicMedicalRecords/Product</a>|
|[standardCostBase](#standardCostBase)|Value of the Standard Cost in base currency.|<a href="Product.md" target="_blank">electronicMedicalRecords/Product</a>|
|[stateCode](#stateCode)|Status of the product.|<a href="Product.md" target="_blank">electronicMedicalRecords/Product</a>|
|[stateCode_display](#stateCode_display)||<a href="Product.md" target="_blank">electronicMedicalRecords/Product</a>|
|[statusCode](#statusCode)|Reason for the status of the product.|<a href="Product.md" target="_blank">electronicMedicalRecords/Product</a>|
|[statusCode_display](#statusCode_display)||<a href="Product.md" target="_blank">electronicMedicalRecords/Product</a>|
|[stockVolume](#stockVolume)|Stock volume of the product.|<a href="Product.md" target="_blank">electronicMedicalRecords/Product</a>|
|[stockWeight](#stockWeight)|Stock weight of the product.|<a href="Product.md" target="_blank">electronicMedicalRecords/Product</a>|
|[supplierName](#supplierName)|Name of the product's supplier.|<a href="Product.md" target="_blank">electronicMedicalRecords/Product</a>|
|[vendorName](#vendorName)|Name of the product vendor.|<a href="Product.md" target="_blank">electronicMedicalRecords/Product</a>|
|[vendorPartNumber](#vendorPartNumber)|Unique part identifier in vendor catalog of this product.|<a href="Product.md" target="_blank">electronicMedicalRecords/Product</a>|
|[hierarchyPath](#hierarchyPath)|Hierarchy path of the product.|<a href="Product.md" target="_blank">electronicMedicalRecords/Product</a>|
|[priceLevelId](#priceLevelId)|Select the default price list for the product.|<a href="Product.md" target="_blank">electronicMedicalRecords/Product</a>|
|[subjectId](#subjectId)|Select a category for the product.|<a href="Product.md" target="_blank">electronicMedicalRecords/Product</a>|
|[entityImageId](#entityImageId)||<a href="Product.md" target="_blank">electronicMedicalRecords/Product</a>|
|[createdByExternalParty](#createdByExternalParty)|Shows the external party who created the record.|<a href="Product.md" target="_blank">electronicMedicalRecords/Product</a>|
|[modifiedByExternalParty](#modifiedByExternalParty)|Shows the external party who modified the record.|<a href="Product.md" target="_blank">electronicMedicalRecords/Product</a>|
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Form</td></tr><tr><td>description</td><td>Describes the form of the item. Powder; tablets; capsule.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_form</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Describes the form of the item. Powder; tablets; capsule.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_form"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Is Brand</td></tr><tr><td>description</td><td>Set to true if the item is attributable to a specific manufacturer.</td></tr><tr><td>dataFormat</td><td>15</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_isbrand</td></tr></table>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Is Brand</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Set to true if the item is attributable to a specific manufacturer.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.nullable**  
The attribute value may be set to NULL.  

**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_isbrand"</td><td>string</td><td></td></tr></table>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Is Over the Counter</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Set to true if the medication can be obtained without an order from a prescriber.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.nullable**  
The attribute value may be set to NULL.  

**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_isoverthecounter"</td><td>string</td><td></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>A code (or set of codes) that specify this medication, or a textual description if no code is available. Usage note: This could be a standard medication code.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Package Container</td></tr><tr><td>description</td><td>The kind of container that this package comes as.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_packagecontainer</td></tr></table>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Package Container</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>The kind of container that this package comes as.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_packagecontainer"</td><td>string</td><td></td></tr></table>
