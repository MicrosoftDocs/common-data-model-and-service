...
A broad categorization of the service that is to be performed during this appointment.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/AppointmentServiceCategory.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="AppointmentServiceCategory.md" target="_blank">electronicMedicalRecords/AppointmentServiceCategory</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="AppointmentServiceCategory.md" target="_blank">electronicMedicalRecords/AppointmentServiceCategory</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="AppointmentServiceCategory.md" target="_blank">electronicMedicalRecords/AppointmentServiceCategory</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="AppointmentServiceCategory.md" target="_blank">electronicMedicalRecords/AppointmentServiceCategory</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="AppointmentServiceCategory.md" target="_blank">electronicMedicalRecords/AppointmentServiceCategory</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="AppointmentServiceCategory.md" target="_blank">electronicMedicalRecords/AppointmentServiceCategory</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="AppointmentServiceCategory.md" target="_blank">electronicMedicalRecords/AppointmentServiceCategory</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="AppointmentServiceCategory.md" target="_blank">electronicMedicalRecords/AppointmentServiceCategory</a>|
|[ownerId](#ownerId)|Owner Id|<a href="AppointmentServiceCategory.md" target="_blank">electronicMedicalRecords/AppointmentServiceCategory</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="AppointmentServiceCategory.md" target="_blank">electronicMedicalRecords/AppointmentServiceCategory</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="AppointmentServiceCategory.md" target="_blank">electronicMedicalRecords/AppointmentServiceCategory</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="AppointmentServiceCategory.md" target="_blank">electronicMedicalRecords/AppointmentServiceCategory</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="AppointmentServiceCategory.md" target="_blank">electronicMedicalRecords/AppointmentServiceCategory</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="AppointmentServiceCategory.md" target="_blank">electronicMedicalRecords/AppointmentServiceCategory</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="AppointmentServiceCategory.md" target="_blank">electronicMedicalRecords/AppointmentServiceCategory</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="AppointmentServiceCategory.md" target="_blank">electronicMedicalRecords/AppointmentServiceCategory</a>|
...
|[appointmentServiceCategoryId](#appointmentServiceCategoryId)|Unique identifier for entity instances|<a href="AppointmentServiceCategory.md" target="_blank">electronicMedicalRecords/AppointmentServiceCategory</a>|
|[name](#name)|The name of the custom entity.|<a href="AppointmentServiceCategory.md" target="_blank">electronicMedicalRecords/AppointmentServiceCategory</a>|
|[serviceCategoryId](#serviceCategoryId)|A broad categorization of the service that is to be performed during this appointment|<a href="AppointmentServiceCategory.md" target="_blank">electronicMedicalRecords/AppointmentServiceCategory</a>|
|[stateCode](#stateCode)|Status of the Appointment Service Category|<a href="AppointmentServiceCategory.md" target="_blank">electronicMedicalRecords/AppointmentServiceCategory</a>|
|[stateCode_display](#stateCode_display)||<a href="AppointmentServiceCategory.md" target="_blank">electronicMedicalRecords/AppointmentServiceCategory</a>|
|[statusCode](#statusCode)|Reason for the status of the Appointment Service Category|<a href="AppointmentServiceCategory.md" target="_blank">electronicMedicalRecords/AppointmentServiceCategory</a>|
|[statusCode_display](#statusCode_display)||<a href="AppointmentServiceCategory.md" target="_blank">electronicMedicalRecords/AppointmentServiceCategory</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/AppointmentServiceCategory (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Appointment Service Category</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_appointmentservicecategoryid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Appointment Service Category</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Appointment Service Category</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
