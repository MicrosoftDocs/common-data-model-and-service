---
title: EncounterDiagnosis - Common Data Model | Microsoft Docs
...
The list of diagnosis relevant to this encounter.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/EncounterDiagnosis.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="EncounterDiagnosis.md" target="_blank">electronicMedicalRecords/EncounterDiagnosis</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="EncounterDiagnosis.md" target="_blank">electronicMedicalRecords/EncounterDiagnosis</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="EncounterDiagnosis.md" target="_blank">electronicMedicalRecords/EncounterDiagnosis</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="EncounterDiagnosis.md" target="_blank">electronicMedicalRecords/EncounterDiagnosis</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="EncounterDiagnosis.md" target="_blank">electronicMedicalRecords/EncounterDiagnosis</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="EncounterDiagnosis.md" target="_blank">electronicMedicalRecords/EncounterDiagnosis</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="EncounterDiagnosis.md" target="_blank">electronicMedicalRecords/EncounterDiagnosis</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="EncounterDiagnosis.md" target="_blank">electronicMedicalRecords/EncounterDiagnosis</a>|
|[ownerId](#ownerId)|Owner Id|<a href="EncounterDiagnosis.md" target="_blank">electronicMedicalRecords/EncounterDiagnosis</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="EncounterDiagnosis.md" target="_blank">electronicMedicalRecords/EncounterDiagnosis</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="EncounterDiagnosis.md" target="_blank">electronicMedicalRecords/EncounterDiagnosis</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="EncounterDiagnosis.md" target="_blank">electronicMedicalRecords/EncounterDiagnosis</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="EncounterDiagnosis.md" target="_blank">electronicMedicalRecords/EncounterDiagnosis</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="EncounterDiagnosis.md" target="_blank">electronicMedicalRecords/EncounterDiagnosis</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="EncounterDiagnosis.md" target="_blank">electronicMedicalRecords/EncounterDiagnosis</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="EncounterDiagnosis.md" target="_blank">electronicMedicalRecords/EncounterDiagnosis</a>|
|[encounterId](#encounterId)|An interaction between a patient and healthcare provider(s) for the purpose of providing healthcare service(s) or assessing the health status of a patient.|<a href="EncounterDiagnosis.md" target="_blank">electronicMedicalRecords/EncounterDiagnosis</a>|
|[encounterConditionIdentifierId](#encounterConditionIdentifierId)|Reason the encounter takes place, as specified using information from another resource. For admissions, this is the admission diagnosis.|<a href="EncounterDiagnosis.md" target="_blank">electronicMedicalRecords/EncounterDiagnosis</a>|
|[encounterDiagnosisId](#encounterDiagnosisId)|Unique identifier for entity instances|<a href="EncounterDiagnosis.md" target="_blank">electronicMedicalRecords/EncounterDiagnosis</a>|
|[encounterProcedureIdentifierId](#encounterProcedureIdentifierId)|Reason the encounter takes place, as specified using information from another resource. For admissions, this is the admission diagnosis.|<a href="EncounterDiagnosis.md" target="_blank">electronicMedicalRecords/EncounterDiagnosis</a>|
|[encounterRank](#encounterRank)|Ranking of the diagnosis (for each role type).|<a href="EncounterDiagnosis.md" target="_blank">electronicMedicalRecords/EncounterDiagnosis</a>|
|[encounterRoleId](#encounterRoleId)|Role that this diagnosis has within the encounter (e.g. admission, billing, discharge etc).|<a href="EncounterDiagnosis.md" target="_blank">electronicMedicalRecords/EncounterDiagnosis</a>|
|[name](#name)|The name of the custom entity.|<a href="EncounterDiagnosis.md" target="_blank">electronicMedicalRecords/EncounterDiagnosis</a>|
|[stateCode](#stateCode)|Status of the Encounter Diagnosis|<a href="EncounterDiagnosis.md" target="_blank">electronicMedicalRecords/EncounterDiagnosis</a>|
|[stateCode_display](#stateCode_display)||<a href="EncounterDiagnosis.md" target="_blank">electronicMedicalRecords/EncounterDiagnosis</a>|
|[statusCode](#statusCode)|Reason for the status of the Encounter Diagnosis|<a href="EncounterDiagnosis.md" target="_blank">electronicMedicalRecords/EncounterDiagnosis</a>|
|[statusCode_display](#statusCode_display)||<a href="EncounterDiagnosis.md" target="_blank">electronicMedicalRecords/EncounterDiagnosis</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/EncounterDiagnosis (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Encounter Diagnosis</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_encounterdiagnosisid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Encounter Diagnosis</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Encounter Diagnosis</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
