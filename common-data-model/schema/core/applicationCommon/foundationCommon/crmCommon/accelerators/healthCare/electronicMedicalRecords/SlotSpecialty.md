...
The specialty of a practitioner that would be required to perform the service requested in this appointment.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/SlotSpecialty.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/core/applicationCommon/foundationCommon<br>/crmCommon/accelerators/healthCare<br>/electronicMedicalRecords/SlotSpecialty.cdm.json<br>/SlotSpecialty/hasAttributes<br>/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[SlotSpecialty/(resolvedAttributes)/slotSpecialtyId](#slotSpecialtyId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[SlotSpecialty/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Slot Specialty</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_slotspecialty"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="SlotSpecialty.md" target="_blank">electronicMedicalRecords/SlotSpecialty</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="SlotSpecialty.md" target="_blank">electronicMedicalRecords/SlotSpecialty</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="SlotSpecialty.md" target="_blank">electronicMedicalRecords/SlotSpecialty</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="SlotSpecialty.md" target="_blank">electronicMedicalRecords/SlotSpecialty</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="SlotSpecialty.md" target="_blank">electronicMedicalRecords/SlotSpecialty</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="SlotSpecialty.md" target="_blank">electronicMedicalRecords/SlotSpecialty</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="SlotSpecialty.md" target="_blank">electronicMedicalRecords/SlotSpecialty</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="SlotSpecialty.md" target="_blank">electronicMedicalRecords/SlotSpecialty</a>|
|[ownerId](#ownerId)|Owner Id|<a href="SlotSpecialty.md" target="_blank">electronicMedicalRecords/SlotSpecialty</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="SlotSpecialty.md" target="_blank">electronicMedicalRecords/SlotSpecialty</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="SlotSpecialty.md" target="_blank">electronicMedicalRecords/SlotSpecialty</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="SlotSpecialty.md" target="_blank">electronicMedicalRecords/SlotSpecialty</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="SlotSpecialty.md" target="_blank">electronicMedicalRecords/SlotSpecialty</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="SlotSpecialty.md" target="_blank">electronicMedicalRecords/SlotSpecialty</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="SlotSpecialty.md" target="_blank">electronicMedicalRecords/SlotSpecialty</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="SlotSpecialty.md" target="_blank">electronicMedicalRecords/SlotSpecialty</a>|
|[name](#name)|The name of the custom entity.|<a href="SlotSpecialty.md" target="_blank">electronicMedicalRecords/SlotSpecialty</a>|
|[slotId](#slotId)|A slot of time on a schedule that may be available for booking appointments.|<a href="SlotSpecialty.md" target="_blank">electronicMedicalRecords/SlotSpecialty</a>|
|[slotSpecialtyId](#slotSpecialtyId)|Unique identifier for entity instances|<a href="SlotSpecialty.md" target="_blank">electronicMedicalRecords/SlotSpecialty</a>|
|[specialtyId](#specialtyId)|The specialty of a practitioner that would be required to perform the service requested in this appointment.|<a href="SlotSpecialty.md" target="_blank">electronicMedicalRecords/SlotSpecialty</a>|
|[stateCode](#stateCode)|Status of the Slot Specialty|<a href="SlotSpecialty.md" target="_blank">electronicMedicalRecords/SlotSpecialty</a>|
|[stateCode_display](#stateCode_display)||<a href="SlotSpecialty.md" target="_blank">electronicMedicalRecords/SlotSpecialty</a>|
|[statusCode](#statusCode)|Reason for the status of the Slot Specialty|<a href="SlotSpecialty.md" target="_blank">electronicMedicalRecords/SlotSpecialty</a>|
|[statusCode_display](#statusCode_display)||<a href="SlotSpecialty.md" target="_blank">electronicMedicalRecords/SlotSpecialty</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/SlotSpecialty (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Slot</td></tr><tr><td>description</td><td>A slot of time on a schedule that may be available for booking appointments.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_slot</td></tr></table>
...
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="Slot.md" target="_blank">/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/Slot.cdm.json/Slot</a></td><td><a href="Slot.md#slotId" target="_blank">slotId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
...
### <a href=#slotSpecialtyId name="slotSpecialtyId">slotSpecialtyId</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Slot Specialty</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_slotspecialtyid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the slotSpecialtyId attribute are listed below.</summary>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_slotspecialtyid"</td><td>string</td><td></td></tr></table>
...
Status of the Slot Specialty  
First included in: electronicMedicalRecords/SlotSpecialty (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Slot Specialty</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the Slot Specialty</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
Reason for the status of the Slot Specialty  
First included in: electronicMedicalRecords/SlotSpecialty (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Slot Specialty</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the Slot Specialty</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
