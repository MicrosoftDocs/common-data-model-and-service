---
title: NutritionOrderSupplementSchedule - Common Data Model | Microsoft Docs
...
# Nutrition Order Supplement Schedule

The time period and frequency at which the supplement(s) should be given. The supplement should be given for the combination of all schedules if more than one schedule is present.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/NutritionOrderSupplementSchedule.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="NutritionOrderSupplementSchedule.md" target="_blank">electronicMedicalRecords/NutritionOrderSupplementSchedule</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="NutritionOrderSupplementSchedule.md" target="_blank">electronicMedicalRecords/NutritionOrderSupplementSchedule</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="NutritionOrderSupplementSchedule.md" target="_blank">electronicMedicalRecords/NutritionOrderSupplementSchedule</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="NutritionOrderSupplementSchedule.md" target="_blank">electronicMedicalRecords/NutritionOrderSupplementSchedule</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="NutritionOrderSupplementSchedule.md" target="_blank">electronicMedicalRecords/NutritionOrderSupplementSchedule</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="NutritionOrderSupplementSchedule.md" target="_blank">electronicMedicalRecords/NutritionOrderSupplementSchedule</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="NutritionOrderSupplementSchedule.md" target="_blank">electronicMedicalRecords/NutritionOrderSupplementSchedule</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="NutritionOrderSupplementSchedule.md" target="_blank">electronicMedicalRecords/NutritionOrderSupplementSchedule</a>|
|[ownerId](#ownerId)|Owner Id|<a href="NutritionOrderSupplementSchedule.md" target="_blank">electronicMedicalRecords/NutritionOrderSupplementSchedule</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="NutritionOrderSupplementSchedule.md" target="_blank">electronicMedicalRecords/NutritionOrderSupplementSchedule</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="NutritionOrderSupplementSchedule.md" target="_blank">electronicMedicalRecords/NutritionOrderSupplementSchedule</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="NutritionOrderSupplementSchedule.md" target="_blank">electronicMedicalRecords/NutritionOrderSupplementSchedule</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="NutritionOrderSupplementSchedule.md" target="_blank">electronicMedicalRecords/NutritionOrderSupplementSchedule</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="NutritionOrderSupplementSchedule.md" target="_blank">electronicMedicalRecords/NutritionOrderSupplementSchedule</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="NutritionOrderSupplementSchedule.md" target="_blank">electronicMedicalRecords/NutritionOrderSupplementSchedule</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="NutritionOrderSupplementSchedule.md" target="_blank">electronicMedicalRecords/NutritionOrderSupplementSchedule</a>|
|[name](#name)|The name of the custom entity.|<a href="NutritionOrderSupplementSchedule.md" target="_blank">electronicMedicalRecords/NutritionOrderSupplementSchedule</a>|
|[nutritionOrderSupplementId](#nutritionOrderSupplementId)|Unique ID for Nutrition Order Supplement|<a href="NutritionOrderSupplementSchedule.md" target="_blank">electronicMedicalRecords/NutritionOrderSupplementSchedule</a>|
|[nutritionOrderSupplementScheduleId](#nutritionOrderSupplementScheduleId)|Unique identifier for entity instances|<a href="NutritionOrderSupplementSchedule.md" target="_blank">electronicMedicalRecords/NutritionOrderSupplementSchedule</a>|
|[scheduleId](#scheduleId)|The time period and frequency at which the supplement(s) should be given. The supplement should be given for the combination of all schedules if more than one schedule is present.|<a href="NutritionOrderSupplementSchedule.md" target="_blank">electronicMedicalRecords/NutritionOrderSupplementSchedule</a>|
|[stateCode](#stateCode)|Status of the Nutrition Order Supplement Schedule|<a href="NutritionOrderSupplementSchedule.md" target="_blank">electronicMedicalRecords/NutritionOrderSupplementSchedule</a>|
|[stateCode_display](#stateCode_display)||<a href="NutritionOrderSupplementSchedule.md" target="_blank">electronicMedicalRecords/NutritionOrderSupplementSchedule</a>|
|[statusCode](#statusCode)|Reason for the status of the Nutrition Order Supplement Schedule|<a href="NutritionOrderSupplementSchedule.md" target="_blank">electronicMedicalRecords/NutritionOrderSupplementSchedule</a>|
|[statusCode_display](#statusCode_display)||<a href="NutritionOrderSupplementSchedule.md" target="_blank">electronicMedicalRecords/NutritionOrderSupplementSchedule</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/NutritionOrderSupplementSchedule (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Nutrition Order Supplement</td></tr><tr><td>description</td><td>Unique ID for Nutrition Order Supplement</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_nutritionordersupplement</td></tr></table>
...
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="NutritionOrderSupplement.md" target="_blank">/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/NutritionOrderSupplement.cdm.json/NutritionOrderSupplement</a></td><td><a href="NutritionOrderSupplement.md#nutritionOrderSupplementId" target="_blank">nutritionOrderSupplementId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Nutrition Order Supplement Schedule</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_nutritionordersupplementscheduleid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Nutrition Order Supplement Schedule</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Nutrition Order Supplement Schedule</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
