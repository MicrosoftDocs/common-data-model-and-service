---
title: CarePlanActivityReason - Common Data Model | Microsoft Docs
...
# Care Plan Activity Reason

Provides the rationale that drove the inclusion of this particular activity as part of the plan or the reason why the activity was prohibited.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/CarePlanActivityReason.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="CarePlanActivityReason.md" target="_blank">electronicMedicalRecords/CarePlanActivityReason</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="CarePlanActivityReason.md" target="_blank">electronicMedicalRecords/CarePlanActivityReason</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="CarePlanActivityReason.md" target="_blank">electronicMedicalRecords/CarePlanActivityReason</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="CarePlanActivityReason.md" target="_blank">electronicMedicalRecords/CarePlanActivityReason</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="CarePlanActivityReason.md" target="_blank">electronicMedicalRecords/CarePlanActivityReason</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="CarePlanActivityReason.md" target="_blank">electronicMedicalRecords/CarePlanActivityReason</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="CarePlanActivityReason.md" target="_blank">electronicMedicalRecords/CarePlanActivityReason</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="CarePlanActivityReason.md" target="_blank">electronicMedicalRecords/CarePlanActivityReason</a>|
|[ownerId](#ownerId)|Owner Id|<a href="CarePlanActivityReason.md" target="_blank">electronicMedicalRecords/CarePlanActivityReason</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="CarePlanActivityReason.md" target="_blank">electronicMedicalRecords/CarePlanActivityReason</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="CarePlanActivityReason.md" target="_blank">electronicMedicalRecords/CarePlanActivityReason</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="CarePlanActivityReason.md" target="_blank">electronicMedicalRecords/CarePlanActivityReason</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="CarePlanActivityReason.md" target="_blank">electronicMedicalRecords/CarePlanActivityReason</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="CarePlanActivityReason.md" target="_blank">electronicMedicalRecords/CarePlanActivityReason</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="CarePlanActivityReason.md" target="_blank">electronicMedicalRecords/CarePlanActivityReason</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="CarePlanActivityReason.md" target="_blank">electronicMedicalRecords/CarePlanActivityReason</a>|
|[activityId](#activityId)|Identifies a planned action to occur as part of the plan. For example, a medication to be used, lab tests to perform, self-monitoring, education, etc.|<a href="CarePlanActivityReason.md" target="_blank">electronicMedicalRecords/CarePlanActivityReason</a>|
|[carePlanActivityReasonId](#carePlanActivityReasonId)|Unique identifier for entity instances|<a href="CarePlanActivityReason.md" target="_blank">electronicMedicalRecords/CarePlanActivityReason</a>|
|[name](#name)|The name of the custom entity.|<a href="CarePlanActivityReason.md" target="_blank">electronicMedicalRecords/CarePlanActivityReason</a>|
|[planActivityReasonCodeIdentifierId](#planActivityReasonCodeIdentifierId)|Provides the rationale that drove the inclusion of this particular activity as part of the plan or the reason why the activity was prohibited. This could be a diagnosis code.|<a href="CarePlanActivityReason.md" target="_blank">electronicMedicalRecords/CarePlanActivityReason</a>|
|[stateCode](#stateCode)|Status of the Care Plan Activity Reason|<a href="CarePlanActivityReason.md" target="_blank">electronicMedicalRecords/CarePlanActivityReason</a>|
|[stateCode_display](#stateCode_display)||<a href="CarePlanActivityReason.md" target="_blank">electronicMedicalRecords/CarePlanActivityReason</a>|
|[statusCode](#statusCode)|Reason for the status of the Care Plan Activity Reason|<a href="CarePlanActivityReason.md" target="_blank">electronicMedicalRecords/CarePlanActivityReason</a>|
|[statusCode_display](#statusCode_display)||<a href="CarePlanActivityReason.md" target="_blank">electronicMedicalRecords/CarePlanActivityReason</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/CarePlanActivityReason (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Care Plan Activity Reason</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_careplanactivityreasonid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Care Plan Activity Reason</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Care Plan Activity Reason</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
