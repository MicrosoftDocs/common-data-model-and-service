---
title: NutritionOrderOralDietSchedule - Common Data Model | Microsoft Docs
...
# Nutrition Order Oral Diet Schedule

The time period and frequency at which the diet should be given. The diet should be given for the combination of all schedules if more than one schedule is present.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/NutritionOrderOralDietSchedule.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="NutritionOrderOralDietSchedule.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietSchedule</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="NutritionOrderOralDietSchedule.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietSchedule</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="NutritionOrderOralDietSchedule.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietSchedule</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="NutritionOrderOralDietSchedule.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietSchedule</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="NutritionOrderOralDietSchedule.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietSchedule</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="NutritionOrderOralDietSchedule.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietSchedule</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="NutritionOrderOralDietSchedule.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietSchedule</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="NutritionOrderOralDietSchedule.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietSchedule</a>|
|[ownerId](#ownerId)|Owner Id|<a href="NutritionOrderOralDietSchedule.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietSchedule</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="NutritionOrderOralDietSchedule.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietSchedule</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="NutritionOrderOralDietSchedule.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietSchedule</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="NutritionOrderOralDietSchedule.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietSchedule</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="NutritionOrderOralDietSchedule.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietSchedule</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="NutritionOrderOralDietSchedule.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietSchedule</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="NutritionOrderOralDietSchedule.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietSchedule</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="NutritionOrderOralDietSchedule.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietSchedule</a>|
|[name](#name)|The name of the custom entity.|<a href="NutritionOrderOralDietSchedule.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietSchedule</a>|
|[nutritionOrderId](#nutritionOrderId)|Unique ID for Nutrition Order|<a href="NutritionOrderOralDietSchedule.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietSchedule</a>|
|[nutritionOrderOralDietScheduleId](#nutritionOrderOralDietScheduleId)|Unique identifier for entity instances|<a href="NutritionOrderOralDietSchedule.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietSchedule</a>|
|[oralDietScheduleId](#oralDietScheduleId)|The time period and frequency at which the diet should be given. The diet should be given for the combination of all schedules if more than one schedule is present.|<a href="NutritionOrderOralDietSchedule.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietSchedule</a>|
|[stateCode](#stateCode)|Status of the Nutrition Order Oral Diet Schedule|<a href="NutritionOrderOralDietSchedule.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietSchedule</a>|
|[stateCode_display](#stateCode_display)||<a href="NutritionOrderOralDietSchedule.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietSchedule</a>|
|[statusCode](#statusCode)|Reason for the status of the Nutrition Order Oral Diet Schedule|<a href="NutritionOrderOralDietSchedule.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietSchedule</a>|
|[statusCode_display](#statusCode_display)||<a href="NutritionOrderOralDietSchedule.md" target="_blank">electronicMedicalRecords/NutritionOrderOralDietSchedule</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/NutritionOrderOralDietSchedule (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Nutrition Order Oral Diet Schedule</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_nutritionorderoraldietscheduleid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Nutrition Order Oral Diet Schedule</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Nutrition Order Oral Diet Schedule</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
