...
Limited to 'real' people rather than equipment.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/ProcedurePerformer.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="ProcedurePerformer.md" target="_blank">electronicMedicalRecords/ProcedurePerformer</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="ProcedurePerformer.md" target="_blank">electronicMedicalRecords/ProcedurePerformer</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="ProcedurePerformer.md" target="_blank">electronicMedicalRecords/ProcedurePerformer</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="ProcedurePerformer.md" target="_blank">electronicMedicalRecords/ProcedurePerformer</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="ProcedurePerformer.md" target="_blank">electronicMedicalRecords/ProcedurePerformer</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="ProcedurePerformer.md" target="_blank">electronicMedicalRecords/ProcedurePerformer</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="ProcedurePerformer.md" target="_blank">electronicMedicalRecords/ProcedurePerformer</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="ProcedurePerformer.md" target="_blank">electronicMedicalRecords/ProcedurePerformer</a>|
|[ownerId](#ownerId)|Owner Id|<a href="ProcedurePerformer.md" target="_blank">electronicMedicalRecords/ProcedurePerformer</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="ProcedurePerformer.md" target="_blank">electronicMedicalRecords/ProcedurePerformer</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="ProcedurePerformer.md" target="_blank">electronicMedicalRecords/ProcedurePerformer</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="ProcedurePerformer.md" target="_blank">electronicMedicalRecords/ProcedurePerformer</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="ProcedurePerformer.md" target="_blank">electronicMedicalRecords/ProcedurePerformer</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="ProcedurePerformer.md" target="_blank">electronicMedicalRecords/ProcedurePerformer</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="ProcedurePerformer.md" target="_blank">electronicMedicalRecords/ProcedurePerformer</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="ProcedurePerformer.md" target="_blank">electronicMedicalRecords/ProcedurePerformer</a>|
|[name](#name)|The name of the custom entity.|<a href="ProcedurePerformer.md" target="_blank">electronicMedicalRecords/ProcedurePerformer</a>|
|[performerActorDeviceId](#performerActorDeviceId)|Actor is device|<a href="ProcedurePerformer.md" target="_blank">electronicMedicalRecords/ProcedurePerformer</a>|
|[performerActorOrganizationId](#performerActorOrganizationId)|Actor is organization|<a href="ProcedurePerformer.md" target="_blank">electronicMedicalRecords/ProcedurePerformer</a>|
|[performerActorPatientId](#performerActorPatientId)|Actor is patient|<a href="ProcedurePerformer.md" target="_blank">electronicMedicalRecords/ProcedurePerformer</a>|
|[performerActorPractitionerId](#performerActorPractitionerId)|Actor is practitioner|<a href="ProcedurePerformer.md" target="_blank">electronicMedicalRecords/ProcedurePerformer</a>|
|[performerActorRelatedPersonId](#performerActorRelatedPersonId)|Actor is person related to patient|<a href="ProcedurePerformer.md" target="_blank">electronicMedicalRecords/ProcedurePerformer</a>|
|[performerOnBehalfOfId](#performerOnBehalfOfId)|The organization the device or practitioner was acting on behalf of.|<a href="ProcedurePerformer.md" target="_blank">electronicMedicalRecords/ProcedurePerformer</a>|
|[performerRoleId](#performerRoleId)|For example: surgeon, anesthetist, endoscopist.|<a href="ProcedurePerformer.md" target="_blank">electronicMedicalRecords/ProcedurePerformer</a>|
|[performerType](#performerType)|The type of  practitioner who was involved in the procedure.|<a href="ProcedurePerformer.md" target="_blank">electronicMedicalRecords/ProcedurePerformer</a>|
|[performerType_display](#performerType_display)||<a href="ProcedurePerformer.md" target="_blank">electronicMedicalRecords/ProcedurePerformer</a>|
|[procedureId](#procedureId)|An action that is or was performed on a patient. This can be a physical intervention like an operation, or less invasive like counseling or hypnotherapy.|<a href="ProcedurePerformer.md" target="_blank">electronicMedicalRecords/ProcedurePerformer</a>|
|[procedurePerformerId](#procedurePerformerId)|Unique identifier for entity instances|<a href="ProcedurePerformer.md" target="_blank">electronicMedicalRecords/ProcedurePerformer</a>|
|[stateCode](#stateCode)|Status of the Procedure Performer|<a href="ProcedurePerformer.md" target="_blank">electronicMedicalRecords/ProcedurePerformer</a>|
|[stateCode_display](#stateCode_display)||<a href="ProcedurePerformer.md" target="_blank">electronicMedicalRecords/ProcedurePerformer</a>|
|[statusCode](#statusCode)|Reason for the status of the Procedure Performer|<a href="ProcedurePerformer.md" target="_blank">electronicMedicalRecords/ProcedurePerformer</a>|
|[statusCode_display](#statusCode_display)||<a href="ProcedurePerformer.md" target="_blank">electronicMedicalRecords/ProcedurePerformer</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/ProcedurePerformer (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Device</td></tr><tr><td>description</td><td>Actor is device</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_performeractordevice</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Organization</td></tr><tr><td>description</td><td>Actor is organization</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_performeractororganization</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Patient</td></tr><tr><td>description</td><td>Actor is patient</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_performeractorpatient</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Practitioner</td></tr><tr><td>description</td><td>Actor is practitioner</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_performeractorpractitioner</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Related Person</td></tr><tr><td>description</td><td>Actor is person related to patient</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_performeractorrelatedperson</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Role</td></tr><tr><td>description</td><td>For example: surgeon, anesthetist, endoscopist.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_performerrole</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Procedure Performer</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_procedureperformerid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Procedure Performer</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Procedure Performer</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
