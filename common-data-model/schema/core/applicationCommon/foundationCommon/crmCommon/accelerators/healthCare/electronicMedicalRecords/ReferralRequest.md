...
- **is.identifiedBy**  
  ...
  ```
  "ReferralRequest/hasAttributes/referralRequestId"
  ```
...
- **means.entityState**  
  ...
  ```
  "ReferralRequest/hasAttributes/stateCode"
  ```
