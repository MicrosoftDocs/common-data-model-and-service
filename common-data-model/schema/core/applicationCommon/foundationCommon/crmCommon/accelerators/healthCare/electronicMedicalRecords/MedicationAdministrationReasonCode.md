---
title: MedicationAdministrationReasonCode - Common Data Model | Microsoft Docs
...
# Medication Administration Reason Code

A code indicating why the medication was given.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/MedicationAdministrationReasonCode.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="MedicationAdministrationReasonCode.md" target="_blank">electronicMedicalRecords/MedicationAdministrationReasonCode</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="MedicationAdministrationReasonCode.md" target="_blank">electronicMedicalRecords/MedicationAdministrationReasonCode</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="MedicationAdministrationReasonCode.md" target="_blank">electronicMedicalRecords/MedicationAdministrationReasonCode</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="MedicationAdministrationReasonCode.md" target="_blank">electronicMedicalRecords/MedicationAdministrationReasonCode</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="MedicationAdministrationReasonCode.md" target="_blank">electronicMedicalRecords/MedicationAdministrationReasonCode</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="MedicationAdministrationReasonCode.md" target="_blank">electronicMedicalRecords/MedicationAdministrationReasonCode</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="MedicationAdministrationReasonCode.md" target="_blank">electronicMedicalRecords/MedicationAdministrationReasonCode</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="MedicationAdministrationReasonCode.md" target="_blank">electronicMedicalRecords/MedicationAdministrationReasonCode</a>|
|[ownerId](#ownerId)|Owner Id|<a href="MedicationAdministrationReasonCode.md" target="_blank">electronicMedicalRecords/MedicationAdministrationReasonCode</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="MedicationAdministrationReasonCode.md" target="_blank">electronicMedicalRecords/MedicationAdministrationReasonCode</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="MedicationAdministrationReasonCode.md" target="_blank">electronicMedicalRecords/MedicationAdministrationReasonCode</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="MedicationAdministrationReasonCode.md" target="_blank">electronicMedicalRecords/MedicationAdministrationReasonCode</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="MedicationAdministrationReasonCode.md" target="_blank">electronicMedicalRecords/MedicationAdministrationReasonCode</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="MedicationAdministrationReasonCode.md" target="_blank">electronicMedicalRecords/MedicationAdministrationReasonCode</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="MedicationAdministrationReasonCode.md" target="_blank">electronicMedicalRecords/MedicationAdministrationReasonCode</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="MedicationAdministrationReasonCode.md" target="_blank">electronicMedicalRecords/MedicationAdministrationReasonCode</a>|
|[medicationAdministrationId](#medicationAdministrationId)|Unique ID of Medication Administration.|<a href="MedicationAdministrationReasonCode.md" target="_blank">electronicMedicalRecords/MedicationAdministrationReasonCode</a>|
|[medicationAdministrationReasonCodeId](#medicationAdministrationReasonCodeId)|Unique identifier for entity instances|<a href="MedicationAdministrationReasonCode.md" target="_blank">electronicMedicalRecords/MedicationAdministrationReasonCode</a>|
|[name](#name)|The name of the custom entity.|<a href="MedicationAdministrationReasonCode.md" target="_blank">electronicMedicalRecords/MedicationAdministrationReasonCode</a>|
|[reasonCodeId](#reasonCodeId)|A code indicating why the medication was given.|<a href="MedicationAdministrationReasonCode.md" target="_blank">electronicMedicalRecords/MedicationAdministrationReasonCode</a>|
|[stateCode](#stateCode)|Status of the Medication Administration Reason Code|<a href="MedicationAdministrationReasonCode.md" target="_blank">electronicMedicalRecords/MedicationAdministrationReasonCode</a>|
|[stateCode_display](#stateCode_display)||<a href="MedicationAdministrationReasonCode.md" target="_blank">electronicMedicalRecords/MedicationAdministrationReasonCode</a>|
|[statusCode](#statusCode)|Reason for the status of the Medication Administration Reason Code|<a href="MedicationAdministrationReasonCode.md" target="_blank">electronicMedicalRecords/MedicationAdministrationReasonCode</a>|
|[statusCode_display](#statusCode_display)||<a href="MedicationAdministrationReasonCode.md" target="_blank">electronicMedicalRecords/MedicationAdministrationReasonCode</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/MedicationAdministrationReasonCode (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Medication Administration Reason Code</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_medicationadministrationreasoncodeid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Reason Code</td></tr><tr><td>description</td><td>A code indicating why the medication was given.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_reasoncode</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Medication Administration Reason Code</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Medication Administration Reason Code</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
