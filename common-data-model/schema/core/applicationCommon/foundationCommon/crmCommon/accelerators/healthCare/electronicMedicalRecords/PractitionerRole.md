...
- **is.identifiedBy**  
  ...
  ```
  "PractitionerRole/hasAttributes/practitionerRoleId"
  ```
...
- **means.entityState**  
  ...
  ```
  "PractitionerRole/hasAttributes/stateCode"
  ```
