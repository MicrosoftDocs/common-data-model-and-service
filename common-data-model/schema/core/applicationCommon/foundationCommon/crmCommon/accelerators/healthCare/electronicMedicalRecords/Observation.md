...
- **is.identifiedBy**  
  ...
  ```
  "Observation/hasAttributes/observationId"
  ```
...
- **means.entityState**  
  ...
  ```
  "Observation/hasAttributes/stateCode"
  ```
