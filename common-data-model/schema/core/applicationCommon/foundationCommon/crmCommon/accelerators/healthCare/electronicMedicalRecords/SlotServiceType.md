...
The type of appointments that can be booked into this slot. If provided then this overrides the value provided on the availability resource.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/SlotServiceType.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="SlotServiceType.md" target="_blank">electronicMedicalRecords/SlotServiceType</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="SlotServiceType.md" target="_blank">electronicMedicalRecords/SlotServiceType</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="SlotServiceType.md" target="_blank">electronicMedicalRecords/SlotServiceType</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="SlotServiceType.md" target="_blank">electronicMedicalRecords/SlotServiceType</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="SlotServiceType.md" target="_blank">electronicMedicalRecords/SlotServiceType</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="SlotServiceType.md" target="_blank">electronicMedicalRecords/SlotServiceType</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="SlotServiceType.md" target="_blank">electronicMedicalRecords/SlotServiceType</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="SlotServiceType.md" target="_blank">electronicMedicalRecords/SlotServiceType</a>|
|[ownerId](#ownerId)|Owner Id|<a href="SlotServiceType.md" target="_blank">electronicMedicalRecords/SlotServiceType</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="SlotServiceType.md" target="_blank">electronicMedicalRecords/SlotServiceType</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="SlotServiceType.md" target="_blank">electronicMedicalRecords/SlotServiceType</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="SlotServiceType.md" target="_blank">electronicMedicalRecords/SlotServiceType</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="SlotServiceType.md" target="_blank">electronicMedicalRecords/SlotServiceType</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="SlotServiceType.md" target="_blank">electronicMedicalRecords/SlotServiceType</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="SlotServiceType.md" target="_blank">electronicMedicalRecords/SlotServiceType</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="SlotServiceType.md" target="_blank">electronicMedicalRecords/SlotServiceType</a>|
|[name](#name)|The name of the custom entity.|<a href="SlotServiceType.md" target="_blank">electronicMedicalRecords/SlotServiceType</a>|
|[slotId](#slotId)|A slot of time on a schedule that may be available for booking appointments.|<a href="SlotServiceType.md" target="_blank">electronicMedicalRecords/SlotServiceType</a>|
|[slotservicetypeId](#slotservicetypeId)||<a href="SlotServiceType.md" target="_blank">electronicMedicalRecords/SlotServiceType</a>|
|[slotServiceTypeId](#slotServiceTypeId)|Unique identifier for entity instances|<a href="SlotServiceType.md" target="_blank">electronicMedicalRecords/SlotServiceType</a>|
|[stateCode](#stateCode)|Status of the Slot Service Type|<a href="SlotServiceType.md" target="_blank">electronicMedicalRecords/SlotServiceType</a>|
|[stateCode_display](#stateCode_display)||<a href="SlotServiceType.md" target="_blank">electronicMedicalRecords/SlotServiceType</a>|
|[statusCode](#statusCode)|Reason for the status of the Slot Service Type|<a href="SlotServiceType.md" target="_blank">electronicMedicalRecords/SlotServiceType</a>|
|[statusCode_display](#statusCode_display)||<a href="SlotServiceType.md" target="_blank">electronicMedicalRecords/SlotServiceType</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/SlotServiceType (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Service Type</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_slotservicetype</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Slot Service Type</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_slotservicetypeid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Slot Service Type</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Slot Service Type</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
