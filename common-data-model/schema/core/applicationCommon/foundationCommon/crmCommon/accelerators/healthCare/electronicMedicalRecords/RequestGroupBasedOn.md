...
A plan, proposal or order that is fulfilled in whole or in part by this request.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/RequestGroupBasedOn.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="RequestGroupBasedOn.md" target="_blank">electronicMedicalRecords/RequestGroupBasedOn</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="RequestGroupBasedOn.md" target="_blank">electronicMedicalRecords/RequestGroupBasedOn</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="RequestGroupBasedOn.md" target="_blank">electronicMedicalRecords/RequestGroupBasedOn</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="RequestGroupBasedOn.md" target="_blank">electronicMedicalRecords/RequestGroupBasedOn</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="RequestGroupBasedOn.md" target="_blank">electronicMedicalRecords/RequestGroupBasedOn</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="RequestGroupBasedOn.md" target="_blank">electronicMedicalRecords/RequestGroupBasedOn</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="RequestGroupBasedOn.md" target="_blank">electronicMedicalRecords/RequestGroupBasedOn</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="RequestGroupBasedOn.md" target="_blank">electronicMedicalRecords/RequestGroupBasedOn</a>|
|[ownerId](#ownerId)|Owner Id|<a href="RequestGroupBasedOn.md" target="_blank">electronicMedicalRecords/RequestGroupBasedOn</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="RequestGroupBasedOn.md" target="_blank">electronicMedicalRecords/RequestGroupBasedOn</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="RequestGroupBasedOn.md" target="_blank">electronicMedicalRecords/RequestGroupBasedOn</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="RequestGroupBasedOn.md" target="_blank">electronicMedicalRecords/RequestGroupBasedOn</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="RequestGroupBasedOn.md" target="_blank">electronicMedicalRecords/RequestGroupBasedOn</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="RequestGroupBasedOn.md" target="_blank">electronicMedicalRecords/RequestGroupBasedOn</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="RequestGroupBasedOn.md" target="_blank">electronicMedicalRecords/RequestGroupBasedOn</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="RequestGroupBasedOn.md" target="_blank">electronicMedicalRecords/RequestGroupBasedOn</a>|
|[basedOn](#basedOn)|A plan, proposal or order that is fulfilled in whole or in part by this request.|<a href="RequestGroupBasedOn.md" target="_blank">electronicMedicalRecords/RequestGroupBasedOn</a>|
|[name](#name)|The name of the custom entity.|<a href="RequestGroupBasedOn.md" target="_blank">electronicMedicalRecords/RequestGroupBasedOn</a>|
|[requestGroupId](#requestGroupId)|A group of related requests that can be used to capture intended activities that have inter-dependencies such as "give this medication after that one".|<a href="RequestGroupBasedOn.md" target="_blank">electronicMedicalRecords/RequestGroupBasedOn</a>|
|[requestGroupBasedOnId](#requestGroupBasedOnId)|Unique identifier for entity instances|<a href="RequestGroupBasedOn.md" target="_blank">electronicMedicalRecords/RequestGroupBasedOn</a>|
|[stateCode](#stateCode)|Status of the Request Group Based On|<a href="RequestGroupBasedOn.md" target="_blank">electronicMedicalRecords/RequestGroupBasedOn</a>|
|[stateCode_display](#stateCode_display)||<a href="RequestGroupBasedOn.md" target="_blank">electronicMedicalRecords/RequestGroupBasedOn</a>|
|[statusCode](#statusCode)|Reason for the status of the Request Group Based On|<a href="RequestGroupBasedOn.md" target="_blank">electronicMedicalRecords/RequestGroupBasedOn</a>|
|[statusCode_display](#statusCode_display)||<a href="RequestGroupBasedOn.md" target="_blank">electronicMedicalRecords/RequestGroupBasedOn</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/RequestGroupBasedOn (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Based On</td></tr><tr><td>description</td><td>A plan, proposal or order that is fulfilled in whole or in part by this request.</td></tr><tr><td>dataFormat</td><td>7</td></tr><tr><td>maximumLength</td><td>2000</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_basedon</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Request Group Based On</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_requestgroupbasedonid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Request Group Based On</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
