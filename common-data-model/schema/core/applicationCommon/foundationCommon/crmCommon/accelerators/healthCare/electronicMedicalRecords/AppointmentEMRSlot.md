...
The slots from the participants' schedules that will be filled by the appointment.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/AppointmentEMRSlot.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="AppointmentEMRSlot.md" target="_blank">electronicMedicalRecords/AppointmentEMRSlot</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="AppointmentEMRSlot.md" target="_blank">electronicMedicalRecords/AppointmentEMRSlot</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="AppointmentEMRSlot.md" target="_blank">electronicMedicalRecords/AppointmentEMRSlot</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="AppointmentEMRSlot.md" target="_blank">electronicMedicalRecords/AppointmentEMRSlot</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="AppointmentEMRSlot.md" target="_blank">electronicMedicalRecords/AppointmentEMRSlot</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="AppointmentEMRSlot.md" target="_blank">electronicMedicalRecords/AppointmentEMRSlot</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="AppointmentEMRSlot.md" target="_blank">electronicMedicalRecords/AppointmentEMRSlot</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="AppointmentEMRSlot.md" target="_blank">electronicMedicalRecords/AppointmentEMRSlot</a>|
|[ownerId](#ownerId)|Owner Id|<a href="AppointmentEMRSlot.md" target="_blank">electronicMedicalRecords/AppointmentEMRSlot</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="AppointmentEMRSlot.md" target="_blank">electronicMedicalRecords/AppointmentEMRSlot</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="AppointmentEMRSlot.md" target="_blank">electronicMedicalRecords/AppointmentEMRSlot</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="AppointmentEMRSlot.md" target="_blank">electronicMedicalRecords/AppointmentEMRSlot</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="AppointmentEMRSlot.md" target="_blank">electronicMedicalRecords/AppointmentEMRSlot</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="AppointmentEMRSlot.md" target="_blank">electronicMedicalRecords/AppointmentEMRSlot</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="AppointmentEMRSlot.md" target="_blank">electronicMedicalRecords/AppointmentEMRSlot</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="AppointmentEMRSlot.md" target="_blank">electronicMedicalRecords/AppointmentEMRSlot</a>|
|[appointmentEMRId](#appointmentEMRId)|A booking of a healthcare event among patient(s), practitioner(s), related person(s) and/or device(s) for a specific date/time. This may result in one or more Encounter(s)|<a href="AppointmentEMRSlot.md" target="_blank">electronicMedicalRecords/AppointmentEMRSlot</a>|
|[appointmentEMRSlotId](#appointmentEMRSlotId)|Unique identifier for entity instances|<a href="AppointmentEMRSlot.md" target="_blank">electronicMedicalRecords/AppointmentEMRSlot</a>|
|[name](#name)|The name of the custom entity.|<a href="AppointmentEMRSlot.md" target="_blank">electronicMedicalRecords/AppointmentEMRSlot</a>|
|[slotId](#slotId)|A slot of time on a schedule that may be available for booking appointments|<a href="AppointmentEMRSlot.md" target="_blank">electronicMedicalRecords/AppointmentEMRSlot</a>|
|[stateCode](#stateCode)|Status of the Appointment (EMR) Slot|<a href="AppointmentEMRSlot.md" target="_blank">electronicMedicalRecords/AppointmentEMRSlot</a>|
|[stateCode_display](#stateCode_display)||<a href="AppointmentEMRSlot.md" target="_blank">electronicMedicalRecords/AppointmentEMRSlot</a>|
|[statusCode](#statusCode)|Reason for the status of the Appointment (EMR) Slot|<a href="AppointmentEMRSlot.md" target="_blank">electronicMedicalRecords/AppointmentEMRSlot</a>|
|[statusCode_display](#statusCode_display)||<a href="AppointmentEMRSlot.md" target="_blank">electronicMedicalRecords/AppointmentEMRSlot</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/AppointmentEMRSlot (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Appointment (EMR) Slot</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_appointmentemrslotid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Appointment (EMR) Slot</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Appointment (EMR) Slot</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
