---
title: TaskOutput - Common Data Model | Microsoft Docs
...
Outputs produced by the Task.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/TaskOutput.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="TaskOutput.md" target="_blank">electronicMedicalRecords/TaskOutput</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="TaskOutput.md" target="_blank">electronicMedicalRecords/TaskOutput</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="TaskOutput.md" target="_blank">electronicMedicalRecords/TaskOutput</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="TaskOutput.md" target="_blank">electronicMedicalRecords/TaskOutput</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="TaskOutput.md" target="_blank">electronicMedicalRecords/TaskOutput</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="TaskOutput.md" target="_blank">electronicMedicalRecords/TaskOutput</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="TaskOutput.md" target="_blank">electronicMedicalRecords/TaskOutput</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="TaskOutput.md" target="_blank">electronicMedicalRecords/TaskOutput</a>|
|[ownerId](#ownerId)|Owner Id|<a href="TaskOutput.md" target="_blank">electronicMedicalRecords/TaskOutput</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="TaskOutput.md" target="_blank">electronicMedicalRecords/TaskOutput</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="TaskOutput.md" target="_blank">electronicMedicalRecords/TaskOutput</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="TaskOutput.md" target="_blank">electronicMedicalRecords/TaskOutput</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="TaskOutput.md" target="_blank">electronicMedicalRecords/TaskOutput</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="TaskOutput.md" target="_blank">electronicMedicalRecords/TaskOutput</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="TaskOutput.md" target="_blank">electronicMedicalRecords/TaskOutput</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="TaskOutput.md" target="_blank">electronicMedicalRecords/TaskOutput</a>|
|[name](#name)|The name of the custom entity.|<a href="TaskOutput.md" target="_blank">electronicMedicalRecords/TaskOutput</a>|
|[outputTypeId](#outputTypeId)|Inputs are named to enable task automation to bind data and pass it from one task to the next.|<a href="TaskOutput.md" target="_blank">electronicMedicalRecords/TaskOutput</a>|
|[outputValue](#outputValue)|Inputs are named to enable task automation to bind data and pass it from one task to the next.|<a href="TaskOutput.md" target="_blank">electronicMedicalRecords/TaskOutput</a>|
|[taskId](#taskId)|Unique identifier for Task.|<a href="TaskOutput.md" target="_blank">electronicMedicalRecords/TaskOutput</a>|
|[taskOutId](#taskOutId)|Unique identifier for entity instances|<a href="TaskOutput.md" target="_blank">electronicMedicalRecords/TaskOutput</a>|
|[stateCode](#stateCode)|Status of the Task Out|<a href="TaskOutput.md" target="_blank">electronicMedicalRecords/TaskOutput</a>|
|[stateCode_display](#stateCode_display)||<a href="TaskOutput.md" target="_blank">electronicMedicalRecords/TaskOutput</a>|
|[statusCode](#statusCode)|Reason for the status of the Task Out|<a href="TaskOutput.md" target="_blank">electronicMedicalRecords/TaskOutput</a>|
|[statusCode_display](#statusCode_display)||<a href="TaskOutput.md" target="_blank">electronicMedicalRecords/TaskOutput</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/TaskOutput (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Type (Output)</td></tr><tr><td>description</td><td>Inputs are named to enable task automation to bind data and pass it from one task to the next.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_outputtype</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Value (Output)</td></tr><tr><td>description</td><td>Inputs are named to enable task automation to bind data and pass it from one task to the next.</td></tr><tr><td>dataFormat</td><td>7</td></tr><tr><td>maximumLength</td><td>100</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_outputvalue</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Task Out</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_taskoutid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Task Out</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Task Out</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
