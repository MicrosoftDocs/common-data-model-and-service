---
title: MedicationAdministrationReasonNotGiven - Common Data Model | Microsoft Docs
...
# Medication Administration Reason Not Given

A code indicating why the administration was not performed.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/MedicationAdministrationReasonNotGiven.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="MedicationAdministrationReasonNotGiven.md" target="_blank">electronicMedicalRecords/MedicationAdministrationReasonNotGiven</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="MedicationAdministrationReasonNotGiven.md" target="_blank">electronicMedicalRecords/MedicationAdministrationReasonNotGiven</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="MedicationAdministrationReasonNotGiven.md" target="_blank">electronicMedicalRecords/MedicationAdministrationReasonNotGiven</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="MedicationAdministrationReasonNotGiven.md" target="_blank">electronicMedicalRecords/MedicationAdministrationReasonNotGiven</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="MedicationAdministrationReasonNotGiven.md" target="_blank">electronicMedicalRecords/MedicationAdministrationReasonNotGiven</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="MedicationAdministrationReasonNotGiven.md" target="_blank">electronicMedicalRecords/MedicationAdministrationReasonNotGiven</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="MedicationAdministrationReasonNotGiven.md" target="_blank">electronicMedicalRecords/MedicationAdministrationReasonNotGiven</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="MedicationAdministrationReasonNotGiven.md" target="_blank">electronicMedicalRecords/MedicationAdministrationReasonNotGiven</a>|
|[ownerId](#ownerId)|Owner Id|<a href="MedicationAdministrationReasonNotGiven.md" target="_blank">electronicMedicalRecords/MedicationAdministrationReasonNotGiven</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="MedicationAdministrationReasonNotGiven.md" target="_blank">electronicMedicalRecords/MedicationAdministrationReasonNotGiven</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="MedicationAdministrationReasonNotGiven.md" target="_blank">electronicMedicalRecords/MedicationAdministrationReasonNotGiven</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="MedicationAdministrationReasonNotGiven.md" target="_blank">electronicMedicalRecords/MedicationAdministrationReasonNotGiven</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="MedicationAdministrationReasonNotGiven.md" target="_blank">electronicMedicalRecords/MedicationAdministrationReasonNotGiven</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="MedicationAdministrationReasonNotGiven.md" target="_blank">electronicMedicalRecords/MedicationAdministrationReasonNotGiven</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="MedicationAdministrationReasonNotGiven.md" target="_blank">electronicMedicalRecords/MedicationAdministrationReasonNotGiven</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="MedicationAdministrationReasonNotGiven.md" target="_blank">electronicMedicalRecords/MedicationAdministrationReasonNotGiven</a>|
|[medicationAdministrationId](#medicationAdministrationId)|Unique ID of Medication Administration.|<a href="MedicationAdministrationReasonNotGiven.md" target="_blank">electronicMedicalRecords/MedicationAdministrationReasonNotGiven</a>|
|[medicationAdministrationReasonNotGivenId](#medicationAdministrationReasonNotGivenId)|Unique identifier for entity instances|<a href="MedicationAdministrationReasonNotGiven.md" target="_blank">electronicMedicalRecords/MedicationAdministrationReasonNotGiven</a>|
|[name](#name)|The name of the custom entity.|<a href="MedicationAdministrationReasonNotGiven.md" target="_blank">electronicMedicalRecords/MedicationAdministrationReasonNotGiven</a>|
|[reasonNotGivenId](#reasonNotGivenId)|A code indicating why the administration was not performed.|<a href="MedicationAdministrationReasonNotGiven.md" target="_blank">electronicMedicalRecords/MedicationAdministrationReasonNotGiven</a>|
|[stateCode](#stateCode)|Status of the Medication Administration Reason Not Given|<a href="MedicationAdministrationReasonNotGiven.md" target="_blank">electronicMedicalRecords/MedicationAdministrationReasonNotGiven</a>|
|[stateCode_display](#stateCode_display)||<a href="MedicationAdministrationReasonNotGiven.md" target="_blank">electronicMedicalRecords/MedicationAdministrationReasonNotGiven</a>|
|[statusCode](#statusCode)|Reason for the status of the Medication Administration Reason Not Given|<a href="MedicationAdministrationReasonNotGiven.md" target="_blank">electronicMedicalRecords/MedicationAdministrationReasonNotGiven</a>|
|[statusCode_display](#statusCode_display)||<a href="MedicationAdministrationReasonNotGiven.md" target="_blank">electronicMedicalRecords/MedicationAdministrationReasonNotGiven</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/MedicationAdministrationReasonNotGiven (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Medication Administration Reason Not Given</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_medicationadministrationreasonnotgivenid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Reason Not Given</td></tr><tr><td>description</td><td>A code indicating why the administration was not performed.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_reasonnotgiven</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Medication Administration Reason Not Given</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Medication Administration Reason Not Given</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
