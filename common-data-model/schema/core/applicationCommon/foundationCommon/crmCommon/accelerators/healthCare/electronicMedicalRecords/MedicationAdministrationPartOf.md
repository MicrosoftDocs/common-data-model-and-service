...
A larger event of which this particular event is a component or step.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/MedicationAdministrationPartOf.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="MedicationAdministrationPartOf.md" target="_blank">electronicMedicalRecords/MedicationAdministrationPartOf</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="MedicationAdministrationPartOf.md" target="_blank">electronicMedicalRecords/MedicationAdministrationPartOf</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="MedicationAdministrationPartOf.md" target="_blank">electronicMedicalRecords/MedicationAdministrationPartOf</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="MedicationAdministrationPartOf.md" target="_blank">electronicMedicalRecords/MedicationAdministrationPartOf</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="MedicationAdministrationPartOf.md" target="_blank">electronicMedicalRecords/MedicationAdministrationPartOf</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="MedicationAdministrationPartOf.md" target="_blank">electronicMedicalRecords/MedicationAdministrationPartOf</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="MedicationAdministrationPartOf.md" target="_blank">electronicMedicalRecords/MedicationAdministrationPartOf</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="MedicationAdministrationPartOf.md" target="_blank">electronicMedicalRecords/MedicationAdministrationPartOf</a>|
|[ownerId](#ownerId)|Owner Id|<a href="MedicationAdministrationPartOf.md" target="_blank">electronicMedicalRecords/MedicationAdministrationPartOf</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="MedicationAdministrationPartOf.md" target="_blank">electronicMedicalRecords/MedicationAdministrationPartOf</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="MedicationAdministrationPartOf.md" target="_blank">electronicMedicalRecords/MedicationAdministrationPartOf</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="MedicationAdministrationPartOf.md" target="_blank">electronicMedicalRecords/MedicationAdministrationPartOf</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="MedicationAdministrationPartOf.md" target="_blank">electronicMedicalRecords/MedicationAdministrationPartOf</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="MedicationAdministrationPartOf.md" target="_blank">electronicMedicalRecords/MedicationAdministrationPartOf</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="MedicationAdministrationPartOf.md" target="_blank">electronicMedicalRecords/MedicationAdministrationPartOf</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="MedicationAdministrationPartOf.md" target="_blank">electronicMedicalRecords/MedicationAdministrationPartOf</a>|
|[medicationAdministrationId](#medicationAdministrationId)|Unique ID of Medication Administration|<a href="MedicationAdministrationPartOf.md" target="_blank">electronicMedicalRecords/MedicationAdministrationPartOf</a>|
|[medicationAdministrationPartOfId](#medicationAdministrationPartOfId)|Unique identifier for entity instances|<a href="MedicationAdministrationPartOf.md" target="_blank">electronicMedicalRecords/MedicationAdministrationPartOf</a>|
|[name](#name)|The name of the custom entity.|<a href="MedicationAdministrationPartOf.md" target="_blank">electronicMedicalRecords/MedicationAdministrationPartOf</a>|
|[partOfType](#partOfType)|A larger event of which this particular event is a component or step.|<a href="MedicationAdministrationPartOf.md" target="_blank">electronicMedicalRecords/MedicationAdministrationPartOf</a>|
|[partOfType_display](#partOfType_display)||<a href="MedicationAdministrationPartOf.md" target="_blank">electronicMedicalRecords/MedicationAdministrationPartOf</a>|
|[partOfTypeMedicationAdministrationId](#partOfTypeMedicationAdministrationId)|A larger event of which this particular event is a component or step.|<a href="MedicationAdministrationPartOf.md" target="_blank">electronicMedicalRecords/MedicationAdministrationPartOf</a>|
|[partOfTypeProcedureId](#partOfTypeProcedureId)|A larger event of which this particular event is a component or step.|<a href="MedicationAdministrationPartOf.md" target="_blank">electronicMedicalRecords/MedicationAdministrationPartOf</a>|
|[stateCode](#stateCode)|Status of the Medication Administration Part Of|<a href="MedicationAdministrationPartOf.md" target="_blank">electronicMedicalRecords/MedicationAdministrationPartOf</a>|
|[stateCode_display](#stateCode_display)||<a href="MedicationAdministrationPartOf.md" target="_blank">electronicMedicalRecords/MedicationAdministrationPartOf</a>|
|[statusCode](#statusCode)|Reason for the status of the Medication Administration Part Of|<a href="MedicationAdministrationPartOf.md" target="_blank">electronicMedicalRecords/MedicationAdministrationPartOf</a>|
|[statusCode_display](#statusCode_display)||<a href="MedicationAdministrationPartOf.md" target="_blank">electronicMedicalRecords/MedicationAdministrationPartOf</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/MedicationAdministrationPartOf (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Medication Administration Reference</td></tr><tr><td>description</td><td>Unique ID of Medication Administration</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_medicationadministration</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Medication Administration Part Of</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_medicationadministrationpartofid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Procedure</td></tr><tr><td>description</td><td>A larger event of which this particular event is a component or step.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_partoftypeprocedure</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Medication Administration Part Of</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Medication Administration Part Of</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
