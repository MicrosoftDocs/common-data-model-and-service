...
The list of people responsible for providing the service.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/EncounterParticipant.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="EncounterParticipant.md" target="_blank">electronicMedicalRecords/EncounterParticipant</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="EncounterParticipant.md" target="_blank">electronicMedicalRecords/EncounterParticipant</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="EncounterParticipant.md" target="_blank">electronicMedicalRecords/EncounterParticipant</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="EncounterParticipant.md" target="_blank">electronicMedicalRecords/EncounterParticipant</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="EncounterParticipant.md" target="_blank">electronicMedicalRecords/EncounterParticipant</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="EncounterParticipant.md" target="_blank">electronicMedicalRecords/EncounterParticipant</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="EncounterParticipant.md" target="_blank">electronicMedicalRecords/EncounterParticipant</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="EncounterParticipant.md" target="_blank">electronicMedicalRecords/EncounterParticipant</a>|
|[ownerId](#ownerId)|Owner Id|<a href="EncounterParticipant.md" target="_blank">electronicMedicalRecords/EncounterParticipant</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="EncounterParticipant.md" target="_blank">electronicMedicalRecords/EncounterParticipant</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="EncounterParticipant.md" target="_blank">electronicMedicalRecords/EncounterParticipant</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="EncounterParticipant.md" target="_blank">electronicMedicalRecords/EncounterParticipant</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="EncounterParticipant.md" target="_blank">electronicMedicalRecords/EncounterParticipant</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="EncounterParticipant.md" target="_blank">electronicMedicalRecords/EncounterParticipant</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="EncounterParticipant.md" target="_blank">electronicMedicalRecords/EncounterParticipant</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="EncounterParticipant.md" target="_blank">electronicMedicalRecords/EncounterParticipant</a>|
|[encounterParticipantDetailsId](#encounterParticipantDetailsId)|Unique identifier for Encounter associated with Encounter Participant.|<a href="EncounterParticipant.md" target="_blank">electronicMedicalRecords/EncounterParticipant</a>|
|[encounterParticipantId](#encounterParticipantId)|Unique identifier for entity instances|<a href="EncounterParticipant.md" target="_blank">electronicMedicalRecords/EncounterParticipant</a>|
|[encounterParticipantsId](#encounterParticipantsId)|Unique identifier for Contact associated with Encounter Participant.|<a href="EncounterParticipant.md" target="_blank">electronicMedicalRecords/EncounterParticipant</a>|
|[individualType](#individualType)|Type of: The list of people responsible for providing the service.|<a href="EncounterParticipant.md" target="_blank">electronicMedicalRecords/EncounterParticipant</a>|
|[individualType_display](#individualType_display)||<a href="EncounterParticipant.md" target="_blank">electronicMedicalRecords/EncounterParticipant</a>|
|[individualTypePractitionerId](#individualTypePractitionerId)|A person who is directly or indirectly involved in the provisioning of healthcare.|<a href="EncounterParticipant.md" target="_blank">electronicMedicalRecords/EncounterParticipant</a>|
...
|[participantName](#participantName)|The name of the custom entity.|<a href="EncounterParticipant.md" target="_blank">electronicMedicalRecords/EncounterParticipant</a>|
|[periodEnd](#periodEnd)|The period of time that the specified participant participated in the encounter. These can overlap or be sub-sets of the overall encounter's period.|<a href="EncounterParticipant.md" target="_blank">electronicMedicalRecords/EncounterParticipant</a>|
|[periodStart](#periodStart)|The period of time that the specified participant participated in the encounter. These can overlap or be sub-sets of the overall encounter's period.|<a href="EncounterParticipant.md" target="_blank">electronicMedicalRecords/EncounterParticipant</a>|
|[stateCode](#stateCode)|Status of the Encounter Participant|<a href="EncounterParticipant.md" target="_blank">electronicMedicalRecords/EncounterParticipant</a>|
|[stateCode_display](#stateCode_display)||<a href="EncounterParticipant.md" target="_blank">electronicMedicalRecords/EncounterParticipant</a>|
|[statusCode](#statusCode)|Reason for the status of the Encounter Participant|<a href="EncounterParticipant.md" target="_blank">electronicMedicalRecords/EncounterParticipant</a>|
|[statusCode_display](#statusCode_display)||<a href="EncounterParticipant.md" target="_blank">electronicMedicalRecords/EncounterParticipant</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/EncounterParticipant (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Encounter Participant</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_encounterparticipantid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Participant Name</td></tr><tr><td>description</td><td>The name of the custom entity.</td></tr><tr><td>dataFormat</td><td>7</td></tr><tr><td>maximumLength</td><td>256</td></tr><tr><td>sourceName</td><td>msemr_participantname</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Period End</td></tr><tr><td>description</td><td>The period of time that the specified participant participated in the encounter. These can overlap or be sub-sets of the overall encounter's period.</td></tr><tr><td>dataFormat</td><td>13</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_periodend</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Encounter Participant</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Encounter Participant</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
