---
title: MedicationRequestReasonCode - Common Data Model | Microsoft Docs
...
# Medication Request Reason Code

The reason or the indication for ordering the medication.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/MedicationRequestReasonCode.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="MedicationRequestReasonCode.md" target="_blank">electronicMedicalRecords/MedicationRequestReasonCode</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="MedicationRequestReasonCode.md" target="_blank">electronicMedicalRecords/MedicationRequestReasonCode</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="MedicationRequestReasonCode.md" target="_blank">electronicMedicalRecords/MedicationRequestReasonCode</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="MedicationRequestReasonCode.md" target="_blank">electronicMedicalRecords/MedicationRequestReasonCode</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="MedicationRequestReasonCode.md" target="_blank">electronicMedicalRecords/MedicationRequestReasonCode</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="MedicationRequestReasonCode.md" target="_blank">electronicMedicalRecords/MedicationRequestReasonCode</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="MedicationRequestReasonCode.md" target="_blank">electronicMedicalRecords/MedicationRequestReasonCode</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="MedicationRequestReasonCode.md" target="_blank">electronicMedicalRecords/MedicationRequestReasonCode</a>|
|[ownerId](#ownerId)|Owner Id|<a href="MedicationRequestReasonCode.md" target="_blank">electronicMedicalRecords/MedicationRequestReasonCode</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="MedicationRequestReasonCode.md" target="_blank">electronicMedicalRecords/MedicationRequestReasonCode</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="MedicationRequestReasonCode.md" target="_blank">electronicMedicalRecords/MedicationRequestReasonCode</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="MedicationRequestReasonCode.md" target="_blank">electronicMedicalRecords/MedicationRequestReasonCode</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="MedicationRequestReasonCode.md" target="_blank">electronicMedicalRecords/MedicationRequestReasonCode</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="MedicationRequestReasonCode.md" target="_blank">electronicMedicalRecords/MedicationRequestReasonCode</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="MedicationRequestReasonCode.md" target="_blank">electronicMedicalRecords/MedicationRequestReasonCode</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="MedicationRequestReasonCode.md" target="_blank">electronicMedicalRecords/MedicationRequestReasonCode</a>|
|[medicationRequestId](#medicationRequestId)|Business Identifier for Medication Request|<a href="MedicationRequestReasonCode.md" target="_blank">electronicMedicalRecords/MedicationRequestReasonCode</a>|
|[medicationRequestReasonCodeId](#medicationRequestReasonCodeId)|Unique identifier for entity instances|<a href="MedicationRequestReasonCode.md" target="_blank">electronicMedicalRecords/MedicationRequestReasonCode</a>|
|[name](#name)|The name of the custom entity.|<a href="MedicationRequestReasonCode.md" target="_blank">electronicMedicalRecords/MedicationRequestReasonCode</a>|
|[reasonCodeId](#reasonCodeId)|The reason or the indication for ordering the medication.|<a href="MedicationRequestReasonCode.md" target="_blank">electronicMedicalRecords/MedicationRequestReasonCode</a>|
|[stateCode](#stateCode)|Status of the Medication Request Reason Code|<a href="MedicationRequestReasonCode.md" target="_blank">electronicMedicalRecords/MedicationRequestReasonCode</a>|
|[stateCode_display](#stateCode_display)||<a href="MedicationRequestReasonCode.md" target="_blank">electronicMedicalRecords/MedicationRequestReasonCode</a>|
|[statusCode](#statusCode)|Reason for the status of the Medication Request Reason Code|<a href="MedicationRequestReasonCode.md" target="_blank">electronicMedicalRecords/MedicationRequestReasonCode</a>|
|[statusCode_display](#statusCode_display)||<a href="MedicationRequestReasonCode.md" target="_blank">electronicMedicalRecords/MedicationRequestReasonCode</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/MedicationRequestReasonCode (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Medication Request Reason Code</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_medicationrequestreasoncodeid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Reason Code</td></tr><tr><td>description</td><td>The reason or the indication for ordering the medication.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_reasoncode</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Medication Request Reason Code</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Medication Request Reason Code</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
