...
A group of related requests that can be used to capture intended activities that have inter-dependencies such as "give this medication after that one".  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/RequestGroup.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="RequestGroup.md" target="_blank">electronicMedicalRecords/RequestGroup</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="RequestGroup.md" target="_blank">electronicMedicalRecords/RequestGroup</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="RequestGroup.md" target="_blank">electronicMedicalRecords/RequestGroup</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="RequestGroup.md" target="_blank">electronicMedicalRecords/RequestGroup</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="RequestGroup.md" target="_blank">electronicMedicalRecords/RequestGroup</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="RequestGroup.md" target="_blank">electronicMedicalRecords/RequestGroup</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="RequestGroup.md" target="_blank">electronicMedicalRecords/RequestGroup</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="RequestGroup.md" target="_blank">electronicMedicalRecords/RequestGroup</a>|
|[ownerId](#ownerId)|Owner Id|<a href="RequestGroup.md" target="_blank">electronicMedicalRecords/RequestGroup</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="RequestGroup.md" target="_blank">electronicMedicalRecords/RequestGroup</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="RequestGroup.md" target="_blank">electronicMedicalRecords/RequestGroup</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="RequestGroup.md" target="_blank">electronicMedicalRecords/RequestGroup</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="RequestGroup.md" target="_blank">electronicMedicalRecords/RequestGroup</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="RequestGroup.md" target="_blank">electronicMedicalRecords/RequestGroup</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="RequestGroup.md" target="_blank">electronicMedicalRecords/RequestGroup</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="RequestGroup.md" target="_blank">electronicMedicalRecords/RequestGroup</a>|
|[authoredOn](#authoredOn)|Indicates when the request group was created.|<a href="RequestGroup.md" target="_blank">electronicMedicalRecords/RequestGroup</a>|
|[authorType](#authorType)|The type of a reference to the author of the request group.|<a href="RequestGroup.md" target="_blank">electronicMedicalRecords/RequestGroup</a>|
|[authorType_display](#authorType_display)||<a href="RequestGroup.md" target="_blank">electronicMedicalRecords/RequestGroup</a>|
|[authorTypeDeviceId](#authorTypeDeviceId)|Provides a reference to the author of type device to the request group.|<a href="RequestGroup.md" target="_blank">electronicMedicalRecords/RequestGroup</a>|
|[authorTypePractitionerId](#authorTypePractitionerId)|Provides a reference to the author of type practitioner to the request group.|<a href="RequestGroup.md" target="_blank">electronicMedicalRecords/RequestGroup</a>|
|[contextType](#contextType)|Describes the context of the request group, if any.|<a href="RequestGroup.md" target="_blank">electronicMedicalRecords/RequestGroup</a>|
|[contextType_display](#contextType_display)||<a href="RequestGroup.md" target="_blank">electronicMedicalRecords/RequestGroup</a>|
|[contextTypeEncounterId](#contextTypeEncounterId)|Enable this field when Context type is Encounter.|<a href="RequestGroup.md" target="_blank">electronicMedicalRecords/RequestGroup</a>|
|[contextTypeEpisodeOfCareId](#contextTypeEpisodeOfCareId)|Enable this field when Context type is Episode Of Care.|<a href="RequestGroup.md" target="_blank">electronicMedicalRecords/RequestGroup</a>|
|[groupNumber](#groupNumber)|A shared identifier common to all requests that were authorized more or less simultaneously by a single author, representing the identifier of the requisition, prescription or similar form.|<a href="RequestGroup.md" target="_blank">electronicMedicalRecords/RequestGroup</a>|
|[intent](#intent)|Indicates the level of authority/intentionality associated with the request and where the request fits into the workflow chain.|<a href="RequestGroup.md" target="_blank">electronicMedicalRecords/RequestGroup</a>|
|[intent_display](#intent_display)||<a href="RequestGroup.md" target="_blank">electronicMedicalRecords/RequestGroup</a>|
|[name](#name)|The name of the custom entity.|<a href="RequestGroup.md" target="_blank">electronicMedicalRecords/RequestGroup</a>|
|[priority](#priority)|Indicates how quickly the request should be addressed with respect to other requests.|<a href="RequestGroup.md" target="_blank">electronicMedicalRecords/RequestGroup</a>|
|[priority_display](#priority_display)||<a href="RequestGroup.md" target="_blank">electronicMedicalRecords/RequestGroup</a>|
|[reasonCodeableConceptId](#reasonCodeableConceptId)|Enable this field when Reason Type is Codeable Concept.|<a href="RequestGroup.md" target="_blank">electronicMedicalRecords/RequestGroup</a>|
|[reasonReference](#reasonReference)|Enable this field when Reason Type is Reference.|<a href="RequestGroup.md" target="_blank">electronicMedicalRecords/RequestGroup</a>|
|[reasonType](#reasonType)|Indicates the reason the request group was created.|<a href="RequestGroup.md" target="_blank">electronicMedicalRecords/RequestGroup</a>|
|[reasonType_display](#reasonType_display)||<a href="RequestGroup.md" target="_blank">electronicMedicalRecords/RequestGroup</a>|
|[requestGroupId](#requestGroupId)|Unique identifier for entity instances|<a href="RequestGroup.md" target="_blank">electronicMedicalRecords/RequestGroup</a>|
|[requestGroupNumber](#requestGroupNumber)|Allows a service to provide a unique, business identifier for the request.|<a href="RequestGroup.md" target="_blank">electronicMedicalRecords/RequestGroup</a>|
|[status](#status)|The current state of the request. For request groups, the status reflects the status of all the requests in the group.|<a href="RequestGroup.md" target="_blank">electronicMedicalRecords/RequestGroup</a>|
|[status_display](#status_display)||<a href="RequestGroup.md" target="_blank">electronicMedicalRecords/RequestGroup</a>|
|[subjectType](#subjectType)|The subject for which the request group was created.|<a href="RequestGroup.md" target="_blank">electronicMedicalRecords/RequestGroup</a>|
|[subjectType_display](#subjectType_display)||<a href="RequestGroup.md" target="_blank">electronicMedicalRecords/RequestGroup</a>|
|[subjectTypeGroupId](#subjectTypeGroupId)|Enable this field when Subject type is Group.|<a href="RequestGroup.md" target="_blank">electronicMedicalRecords/RequestGroup</a>|
|[subjectTypePatientId](#subjectTypePatientId)|Enable this field when Subject type is Patient|<a href="RequestGroup.md" target="_blank">electronicMedicalRecords/RequestGroup</a>|
|[stateCode](#stateCode)|Status of the Request Group|<a href="RequestGroup.md" target="_blank">electronicMedicalRecords/RequestGroup</a>|
|[stateCode_display](#stateCode_display)||<a href="RequestGroup.md" target="_blank">electronicMedicalRecords/RequestGroup</a>|
|[statusCode](#statusCode)|Reason for the status of the Request Group|<a href="RequestGroup.md" target="_blank">electronicMedicalRecords/RequestGroup</a>|
|[statusCode_display](#statusCode_display)||<a href="RequestGroup.md" target="_blank">electronicMedicalRecords/RequestGroup</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/RequestGroup (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Authored On</td></tr><tr><td>description</td><td>Indicates when the request group was created.</td></tr><tr><td>dataFormat</td><td>13</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_authoredon</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Device</td></tr><tr><td>description</td><td>Provides a reference to the author of type device to the request group.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_authortypedevice</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Encounter</td></tr><tr><td>description</td><td>Enable this field when Context type is Encounter.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_contexttypeencounter</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Episode Of Care</td></tr><tr><td>description</td><td>Enable this field when Context type is Episode Of Care.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_contexttypeepisodeofcare</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Codeable Concept</td></tr><tr><td>description</td><td>Enable this field when Reason Type is Codeable Concept.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_reasoncodeableconcept</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Request Group</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_requestgroupid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Group</td></tr><tr><td>description</td><td>Enable this field when Subject type is Group.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_subjecttypegroup</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Patient</td></tr><tr><td>description</td><td>Enable this field when Subject type is Patient</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_subjecttypepatient</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Request Group</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
