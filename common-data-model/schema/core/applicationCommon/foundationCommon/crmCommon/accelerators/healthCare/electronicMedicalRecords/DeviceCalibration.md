---
title: DeviceCalibration - Common Data Model | Microsoft Docs
...
Describes the calibrations that have been performed or that are required to be performed.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/DeviceCalibration.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="DeviceCalibration.md" target="_blank">electronicMedicalRecords/DeviceCalibration</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="DeviceCalibration.md" target="_blank">electronicMedicalRecords/DeviceCalibration</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="DeviceCalibration.md" target="_blank">electronicMedicalRecords/DeviceCalibration</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="DeviceCalibration.md" target="_blank">electronicMedicalRecords/DeviceCalibration</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="DeviceCalibration.md" target="_blank">electronicMedicalRecords/DeviceCalibration</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="DeviceCalibration.md" target="_blank">electronicMedicalRecords/DeviceCalibration</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="DeviceCalibration.md" target="_blank">electronicMedicalRecords/DeviceCalibration</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="DeviceCalibration.md" target="_blank">electronicMedicalRecords/DeviceCalibration</a>|
|[ownerId](#ownerId)|Owner Id|<a href="DeviceCalibration.md" target="_blank">electronicMedicalRecords/DeviceCalibration</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="DeviceCalibration.md" target="_blank">electronicMedicalRecords/DeviceCalibration</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="DeviceCalibration.md" target="_blank">electronicMedicalRecords/DeviceCalibration</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="DeviceCalibration.md" target="_blank">electronicMedicalRecords/DeviceCalibration</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="DeviceCalibration.md" target="_blank">electronicMedicalRecords/DeviceCalibration</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="DeviceCalibration.md" target="_blank">electronicMedicalRecords/DeviceCalibration</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="DeviceCalibration.md" target="_blank">electronicMedicalRecords/DeviceCalibration</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="DeviceCalibration.md" target="_blank">electronicMedicalRecords/DeviceCalibration</a>|
|[calibrationState](#calibrationState)|Type of: Describes the calibrations that have been performed or that are required to be performed.|<a href="DeviceCalibration.md" target="_blank">electronicMedicalRecords/DeviceCalibration</a>|
|[calibrationState_display](#calibrationState_display)||<a href="DeviceCalibration.md" target="_blank">electronicMedicalRecords/DeviceCalibration</a>|
|[calibrationTime](#calibrationTime)|Describes the calibrations that have been performed or that are required to be performed.|<a href="DeviceCalibration.md" target="_blank">electronicMedicalRecords/DeviceCalibration</a>|
|[description](#description)|The name of the custom entity.|<a href="DeviceCalibration.md" target="_blank">electronicMedicalRecords/DeviceCalibration</a>|
|[deviceCalibrationId](#deviceCalibrationId)|Unique identifier for entity instances|<a href="DeviceCalibration.md" target="_blank">electronicMedicalRecords/DeviceCalibration</a>|
|[deviceMetricIdentifierId](#deviceMetricIdentifierId)|Business Identifier for Device Metric.|<a href="DeviceCalibration.md" target="_blank">electronicMedicalRecords/DeviceCalibration</a>|
|[type](#type)|Type of: Describes the calibrations that have been performed or that are required to be performed.|<a href="DeviceCalibration.md" target="_blank">electronicMedicalRecords/DeviceCalibration</a>|
|[type_display](#type_display)||<a href="DeviceCalibration.md" target="_blank">electronicMedicalRecords/DeviceCalibration</a>|
|[stateCode](#stateCode)|Status of the Device Calibration|<a href="DeviceCalibration.md" target="_blank">electronicMedicalRecords/DeviceCalibration</a>|
|[stateCode_display](#stateCode_display)||<a href="DeviceCalibration.md" target="_blank">electronicMedicalRecords/DeviceCalibration</a>|
|[statusCode](#statusCode)|Reason for the status of the Device Calibration|<a href="DeviceCalibration.md" target="_blank">electronicMedicalRecords/DeviceCalibration</a>|
|[statusCode_display](#statusCode_display)||<a href="DeviceCalibration.md" target="_blank">electronicMedicalRecords/DeviceCalibration</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/DeviceCalibration (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Device Calibration</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_devicecalibrationid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>DeviceMetric ID</td></tr><tr><td>description</td><td>Business Identifier for Device Metric.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_devicemetricidentifier</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Device Calibration</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Device Calibration</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
