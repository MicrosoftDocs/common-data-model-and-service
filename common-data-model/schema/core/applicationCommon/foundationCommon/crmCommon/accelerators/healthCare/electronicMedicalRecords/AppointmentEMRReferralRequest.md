...
The referral request this appointment is allocated to assess (incoming referral).  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/AppointmentEMRReferralRequest.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/core/applicationCommon/foundationCommon<br>/crmCommon/accelerators/healthCare<br>/electronicMedicalRecords<br>/AppointmentEMRReferralRequest.cdm.json<br>/AppointmentEMRReferralRequest/hasAttributes<br>/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[AppointmentEMRReferralRequest/(resolvedAttributes)/appointmentEMRReferralRequestId](#appointmentEMRReferralRequestId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[AppointmentEMRReferralRequest/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Appointment (EMR) Referral Request</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>The referral request this appointment is allocated to assess (incoming referral).</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_appointmentemrreferralrequest"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="AppointmentEMRReferralRequest.md" target="_blank">electronicMedicalRecords/AppointmentEMRReferralRequest</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="AppointmentEMRReferralRequest.md" target="_blank">electronicMedicalRecords/AppointmentEMRReferralRequest</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="AppointmentEMRReferralRequest.md" target="_blank">electronicMedicalRecords/AppointmentEMRReferralRequest</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="AppointmentEMRReferralRequest.md" target="_blank">electronicMedicalRecords/AppointmentEMRReferralRequest</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="AppointmentEMRReferralRequest.md" target="_blank">electronicMedicalRecords/AppointmentEMRReferralRequest</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="AppointmentEMRReferralRequest.md" target="_blank">electronicMedicalRecords/AppointmentEMRReferralRequest</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="AppointmentEMRReferralRequest.md" target="_blank">electronicMedicalRecords/AppointmentEMRReferralRequest</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="AppointmentEMRReferralRequest.md" target="_blank">electronicMedicalRecords/AppointmentEMRReferralRequest</a>|
|[ownerId](#ownerId)|Owner Id|<a href="AppointmentEMRReferralRequest.md" target="_blank">electronicMedicalRecords/AppointmentEMRReferralRequest</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="AppointmentEMRReferralRequest.md" target="_blank">electronicMedicalRecords/AppointmentEMRReferralRequest</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="AppointmentEMRReferralRequest.md" target="_blank">electronicMedicalRecords/AppointmentEMRReferralRequest</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="AppointmentEMRReferralRequest.md" target="_blank">electronicMedicalRecords/AppointmentEMRReferralRequest</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="AppointmentEMRReferralRequest.md" target="_blank">electronicMedicalRecords/AppointmentEMRReferralRequest</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="AppointmentEMRReferralRequest.md" target="_blank">electronicMedicalRecords/AppointmentEMRReferralRequest</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="AppointmentEMRReferralRequest.md" target="_blank">electronicMedicalRecords/AppointmentEMRReferralRequest</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="AppointmentEMRReferralRequest.md" target="_blank">electronicMedicalRecords/AppointmentEMRReferralRequest</a>|
|[appointmentEMRId](#appointmentEMRId)|A booking of a healthcare event among patient(s), practitioner(s), related person(s) and/or device(s) for a specific date/time. This may result in one or more Encounter(s)|<a href="AppointmentEMRReferralRequest.md" target="_blank">electronicMedicalRecords/AppointmentEMRReferralRequest</a>|
|[appointmentEMRReferralRequestId](#appointmentEMRReferralRequestId)|Unique identifier for entity instances|<a href="AppointmentEMRReferralRequest.md" target="_blank">electronicMedicalRecords/AppointmentEMRReferralRequest</a>|
|[incomingreferralId](#incomingreferralId)|The ReferralRequest provided as information to allocate to the Encounter|<a href="AppointmentEMRReferralRequest.md" target="_blank">electronicMedicalRecords/AppointmentEMRReferralRequest</a>|
|[name](#name)|The name of the custom entity.|<a href="AppointmentEMRReferralRequest.md" target="_blank">electronicMedicalRecords/AppointmentEMRReferralRequest</a>|
|[stateCode](#stateCode)|Status of the Appointment EMR Referral Request|<a href="AppointmentEMRReferralRequest.md" target="_blank">electronicMedicalRecords/AppointmentEMRReferralRequest</a>|
|[stateCode_display](#stateCode_display)||<a href="AppointmentEMRReferralRequest.md" target="_blank">electronicMedicalRecords/AppointmentEMRReferralRequest</a>|
|[statusCode](#statusCode)|Reason for the status of the Appointment EMR Referral Request|<a href="AppointmentEMRReferralRequest.md" target="_blank">electronicMedicalRecords/AppointmentEMRReferralRequest</a>|
|[statusCode_display](#statusCode_display)||<a href="AppointmentEMRReferralRequest.md" target="_blank">electronicMedicalRecords/AppointmentEMRReferralRequest</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/AppointmentEMRReferralRequest (this entity)  
...
### <a href=#appointmentEMRReferralRequestId name="appointmentEMRReferralRequestId">appointmentEMRReferralRequestId</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Appointment EMR Referral Request</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_appointmentemrreferralrequestid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the appointmentEMRReferralRequestId attribute are listed below.</summary>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_appointmentemrreferralrequestid"</td><td>string</td><td></td></tr></table>
...
### <a href=#incomingreferralId name="incomingreferralId">incomingreferralId</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Referral request</td></tr><tr><td>description</td><td>The ReferralRequest provided as information to allocate to the Encounter</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_incomingreferral</td></tr></table>

#### Traits

<details>
<summary>List of traits for the incomingreferralId attribute are listed below.</summary>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>The ReferralRequest provided as information to allocate to the Encounter</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_incomingreferral"</td><td>string</td><td></td></tr></table>
...
Status of the Appointment EMR Referral Request  
First included in: electronicMedicalRecords/AppointmentEMRReferralRequest (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Appointment EMR Referral Request</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the Appointment EMR Referral Request</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
Reason for the status of the Appointment EMR Referral Request  
First included in: electronicMedicalRecords/AppointmentEMRReferralRequest (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Appointment EMR Referral Request</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the Appointment EMR Referral Request</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
