---
title: MedicationAdministrationDevice - Common Data Model | Microsoft Docs
...
The device used in administering the medication to the patient. For example, a particular infusion pump.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/MedicationAdministrationDevice.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="MedicationAdministrationDevice.md" target="_blank">electronicMedicalRecords/MedicationAdministrationDevice</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="MedicationAdministrationDevice.md" target="_blank">electronicMedicalRecords/MedicationAdministrationDevice</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="MedicationAdministrationDevice.md" target="_blank">electronicMedicalRecords/MedicationAdministrationDevice</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="MedicationAdministrationDevice.md" target="_blank">electronicMedicalRecords/MedicationAdministrationDevice</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="MedicationAdministrationDevice.md" target="_blank">electronicMedicalRecords/MedicationAdministrationDevice</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="MedicationAdministrationDevice.md" target="_blank">electronicMedicalRecords/MedicationAdministrationDevice</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="MedicationAdministrationDevice.md" target="_blank">electronicMedicalRecords/MedicationAdministrationDevice</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="MedicationAdministrationDevice.md" target="_blank">electronicMedicalRecords/MedicationAdministrationDevice</a>|
|[ownerId](#ownerId)|Owner Id|<a href="MedicationAdministrationDevice.md" target="_blank">electronicMedicalRecords/MedicationAdministrationDevice</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="MedicationAdministrationDevice.md" target="_blank">electronicMedicalRecords/MedicationAdministrationDevice</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="MedicationAdministrationDevice.md" target="_blank">electronicMedicalRecords/MedicationAdministrationDevice</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="MedicationAdministrationDevice.md" target="_blank">electronicMedicalRecords/MedicationAdministrationDevice</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="MedicationAdministrationDevice.md" target="_blank">electronicMedicalRecords/MedicationAdministrationDevice</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="MedicationAdministrationDevice.md" target="_blank">electronicMedicalRecords/MedicationAdministrationDevice</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="MedicationAdministrationDevice.md" target="_blank">electronicMedicalRecords/MedicationAdministrationDevice</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="MedicationAdministrationDevice.md" target="_blank">electronicMedicalRecords/MedicationAdministrationDevice</a>|
|[deviceId](#deviceId)|The device used in administering the medication to the patient. For example, a particular infusion pump.|<a href="MedicationAdministrationDevice.md" target="_blank">electronicMedicalRecords/MedicationAdministrationDevice</a>|
|[medicationAdministrationId](#medicationAdministrationId)|Unique ID of Medication Administration.|<a href="MedicationAdministrationDevice.md" target="_blank">electronicMedicalRecords/MedicationAdministrationDevice</a>|
|[medicationAdministrationDeviceId](#medicationAdministrationDeviceId)|Unique identifier for entity instances|<a href="MedicationAdministrationDevice.md" target="_blank">electronicMedicalRecords/MedicationAdministrationDevice</a>|
|[name](#name)|The name of the custom entity.|<a href="MedicationAdministrationDevice.md" target="_blank">electronicMedicalRecords/MedicationAdministrationDevice</a>|
|[stateCode](#stateCode)|Status of the Medication Administration Device|<a href="MedicationAdministrationDevice.md" target="_blank">electronicMedicalRecords/MedicationAdministrationDevice</a>|
|[stateCode_display](#stateCode_display)||<a href="MedicationAdministrationDevice.md" target="_blank">electronicMedicalRecords/MedicationAdministrationDevice</a>|
|[statusCode](#statusCode)|Reason for the status of the Medication Administration Device|<a href="MedicationAdministrationDevice.md" target="_blank">electronicMedicalRecords/MedicationAdministrationDevice</a>|
|[statusCode_display](#statusCode_display)||<a href="MedicationAdministrationDevice.md" target="_blank">electronicMedicalRecords/MedicationAdministrationDevice</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/MedicationAdministrationDevice (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Device</td></tr><tr><td>description</td><td>The device used in administering the medication to the patient. For example, a particular infusion pump.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_device</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Medication Administration Device</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_medicationadministrationdeviceid</td></tr></table>
