...
Identifies what kind of team. This is to support differentiation between multiple co-existing teams, such as care plan team, episode of care team, longitudinal care team.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/CareTeamCategory.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="CareTeamCategory.md" target="_blank">electronicMedicalRecords/CareTeamCategory</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="CareTeamCategory.md" target="_blank">electronicMedicalRecords/CareTeamCategory</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="CareTeamCategory.md" target="_blank">electronicMedicalRecords/CareTeamCategory</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="CareTeamCategory.md" target="_blank">electronicMedicalRecords/CareTeamCategory</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="CareTeamCategory.md" target="_blank">electronicMedicalRecords/CareTeamCategory</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="CareTeamCategory.md" target="_blank">electronicMedicalRecords/CareTeamCategory</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="CareTeamCategory.md" target="_blank">electronicMedicalRecords/CareTeamCategory</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="CareTeamCategory.md" target="_blank">electronicMedicalRecords/CareTeamCategory</a>|
|[ownerId](#ownerId)|Owner Id|<a href="CareTeamCategory.md" target="_blank">electronicMedicalRecords/CareTeamCategory</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="CareTeamCategory.md" target="_blank">electronicMedicalRecords/CareTeamCategory</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="CareTeamCategory.md" target="_blank">electronicMedicalRecords/CareTeamCategory</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="CareTeamCategory.md" target="_blank">electronicMedicalRecords/CareTeamCategory</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="CareTeamCategory.md" target="_blank">electronicMedicalRecords/CareTeamCategory</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="CareTeamCategory.md" target="_blank">electronicMedicalRecords/CareTeamCategory</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="CareTeamCategory.md" target="_blank">electronicMedicalRecords/CareTeamCategory</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="CareTeamCategory.md" target="_blank">electronicMedicalRecords/CareTeamCategory</a>|
|[careTeamId](#careTeamId)|This records identifiers associated with this care team that are defined by business processes and/or used to refer to it when a direct URL reference to the resource itself is not appropriate.|<a href="CareTeamCategory.md" target="_blank">electronicMedicalRecords/CareTeamCategory</a>|
|[careTeamCategoryId](#careTeamCategoryId)|Unique identifier for entity instances|<a href="CareTeamCategory.md" target="_blank">electronicMedicalRecords/CareTeamCategory</a>|
|[categoryId](#categoryId)|Identifies what kind of team. This is to support differentiation between multiple co-existing teams, such as care plan team, episode of care team, longitudinal care team.|<a href="CareTeamCategory.md" target="_blank">electronicMedicalRecords/CareTeamCategory</a>|
|[name](#name)|The name of the custom entity.|<a href="CareTeamCategory.md" target="_blank">electronicMedicalRecords/CareTeamCategory</a>|
|[stateCode](#stateCode)|Status of the Care Team Category|<a href="CareTeamCategory.md" target="_blank">electronicMedicalRecords/CareTeamCategory</a>|
|[stateCode_display](#stateCode_display)||<a href="CareTeamCategory.md" target="_blank">electronicMedicalRecords/CareTeamCategory</a>|
|[statusCode](#statusCode)|Reason for the status of the Care Team Category|<a href="CareTeamCategory.md" target="_blank">electronicMedicalRecords/CareTeamCategory</a>|
|[statusCode_display](#statusCode_display)||<a href="CareTeamCategory.md" target="_blank">electronicMedicalRecords/CareTeamCategory</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/CareTeamCategory (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Care Team Category</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_careteamcategoryid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Care Team Category</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Care Team Category</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
