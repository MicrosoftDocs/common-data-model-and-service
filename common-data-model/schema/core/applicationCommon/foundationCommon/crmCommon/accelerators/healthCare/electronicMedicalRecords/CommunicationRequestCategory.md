---
title: CommunicationRequestCategory - Common Data Model | Microsoft Docs
...
The type of message to be sent such as alert, notification, reminder, instruction, etc.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/CommunicationRequestCategory.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="CommunicationRequestCategory.md" target="_blank">electronicMedicalRecords/CommunicationRequestCategory</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="CommunicationRequestCategory.md" target="_blank">electronicMedicalRecords/CommunicationRequestCategory</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="CommunicationRequestCategory.md" target="_blank">electronicMedicalRecords/CommunicationRequestCategory</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="CommunicationRequestCategory.md" target="_blank">electronicMedicalRecords/CommunicationRequestCategory</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="CommunicationRequestCategory.md" target="_blank">electronicMedicalRecords/CommunicationRequestCategory</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="CommunicationRequestCategory.md" target="_blank">electronicMedicalRecords/CommunicationRequestCategory</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="CommunicationRequestCategory.md" target="_blank">electronicMedicalRecords/CommunicationRequestCategory</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="CommunicationRequestCategory.md" target="_blank">electronicMedicalRecords/CommunicationRequestCategory</a>|
|[ownerId](#ownerId)|Owner Id|<a href="CommunicationRequestCategory.md" target="_blank">electronicMedicalRecords/CommunicationRequestCategory</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="CommunicationRequestCategory.md" target="_blank">electronicMedicalRecords/CommunicationRequestCategory</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="CommunicationRequestCategory.md" target="_blank">electronicMedicalRecords/CommunicationRequestCategory</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="CommunicationRequestCategory.md" target="_blank">electronicMedicalRecords/CommunicationRequestCategory</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="CommunicationRequestCategory.md" target="_blank">electronicMedicalRecords/CommunicationRequestCategory</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="CommunicationRequestCategory.md" target="_blank">electronicMedicalRecords/CommunicationRequestCategory</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="CommunicationRequestCategory.md" target="_blank">electronicMedicalRecords/CommunicationRequestCategory</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="CommunicationRequestCategory.md" target="_blank">electronicMedicalRecords/CommunicationRequestCategory</a>|
|[categoryId](#categoryId)|The type of message to be sent such as alert, notification, reminder, instruction, etc.|<a href="CommunicationRequestCategory.md" target="_blank">electronicMedicalRecords/CommunicationRequestCategory</a>|
|[communicationRequestId](#communicationRequestId)|A request for information to be sent to a receiver.|<a href="CommunicationRequestCategory.md" target="_blank">electronicMedicalRecords/CommunicationRequestCategory</a>|
|[communicationRequestCategoryId](#communicationRequestCategoryId)|Unique identifier for entity instances|<a href="CommunicationRequestCategory.md" target="_blank">electronicMedicalRecords/CommunicationRequestCategory</a>|
|[name](#name)|The name of the custom entity.|<a href="CommunicationRequestCategory.md" target="_blank">electronicMedicalRecords/CommunicationRequestCategory</a>|
|[stateCode](#stateCode)|Status of the Communication Request Category|<a href="CommunicationRequestCategory.md" target="_blank">electronicMedicalRecords/CommunicationRequestCategory</a>|
|[stateCode_display](#stateCode_display)||<a href="CommunicationRequestCategory.md" target="_blank">electronicMedicalRecords/CommunicationRequestCategory</a>|
|[statusCode](#statusCode)|Reason for the status of the Communication Request Category|<a href="CommunicationRequestCategory.md" target="_blank">electronicMedicalRecords/CommunicationRequestCategory</a>|
|[statusCode_display](#statusCode_display)||<a href="CommunicationRequestCategory.md" target="_blank">electronicMedicalRecords/CommunicationRequestCategory</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/CommunicationRequestCategory (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Communication Request Category</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_communicationrequestcategoryid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Communication Request Category</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Communication Request Category</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
