...
The service(s) that is/are requested to be provided to the patient. For example: cardiac pacemaker insertion.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/ReferralRequestServiceRequested.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="ReferralRequestServiceRequested.md" target="_blank">electronicMedicalRecords/ReferralRequestServiceRequested</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="ReferralRequestServiceRequested.md" target="_blank">electronicMedicalRecords/ReferralRequestServiceRequested</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="ReferralRequestServiceRequested.md" target="_blank">electronicMedicalRecords/ReferralRequestServiceRequested</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="ReferralRequestServiceRequested.md" target="_blank">electronicMedicalRecords/ReferralRequestServiceRequested</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="ReferralRequestServiceRequested.md" target="_blank">electronicMedicalRecords/ReferralRequestServiceRequested</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="ReferralRequestServiceRequested.md" target="_blank">electronicMedicalRecords/ReferralRequestServiceRequested</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="ReferralRequestServiceRequested.md" target="_blank">electronicMedicalRecords/ReferralRequestServiceRequested</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="ReferralRequestServiceRequested.md" target="_blank">electronicMedicalRecords/ReferralRequestServiceRequested</a>|
|[ownerId](#ownerId)|Owner Id|<a href="ReferralRequestServiceRequested.md" target="_blank">electronicMedicalRecords/ReferralRequestServiceRequested</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="ReferralRequestServiceRequested.md" target="_blank">electronicMedicalRecords/ReferralRequestServiceRequested</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="ReferralRequestServiceRequested.md" target="_blank">electronicMedicalRecords/ReferralRequestServiceRequested</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="ReferralRequestServiceRequested.md" target="_blank">electronicMedicalRecords/ReferralRequestServiceRequested</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="ReferralRequestServiceRequested.md" target="_blank">electronicMedicalRecords/ReferralRequestServiceRequested</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="ReferralRequestServiceRequested.md" target="_blank">electronicMedicalRecords/ReferralRequestServiceRequested</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="ReferralRequestServiceRequested.md" target="_blank">electronicMedicalRecords/ReferralRequestServiceRequested</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="ReferralRequestServiceRequested.md" target="_blank">electronicMedicalRecords/ReferralRequestServiceRequested</a>|
|[display](#display)|The name of the custom entity.|<a href="ReferralRequestServiceRequested.md" target="_blank">electronicMedicalRecords/ReferralRequestServiceRequested</a>|
|[referralRequestId](#referralRequestId)|Unique identifier for the referral request|<a href="ReferralRequestServiceRequested.md" target="_blank">electronicMedicalRecords/ReferralRequestServiceRequested</a>|
|[referralRequestServiceReqId](#referralRequestServiceReqId)|Unique identifier for entity instances|<a href="ReferralRequestServiceRequested.md" target="_blank">electronicMedicalRecords/ReferralRequestServiceRequested</a>|
|[serviceRequestedId](#serviceRequestedId)|The service(s) that is/are requested to be provided to the patient. For example: cardiac pacemaker insertion.|<a href="ReferralRequestServiceRequested.md" target="_blank">electronicMedicalRecords/ReferralRequestServiceRequested</a>|
|[stateCode](#stateCode)|Status of the Referral Request Service Req|<a href="ReferralRequestServiceRequested.md" target="_blank">electronicMedicalRecords/ReferralRequestServiceRequested</a>|
|[stateCode_display](#stateCode_display)||<a href="ReferralRequestServiceRequested.md" target="_blank">electronicMedicalRecords/ReferralRequestServiceRequested</a>|
|[statusCode](#statusCode)|Reason for the status of the Referral Request Service Req|<a href="ReferralRequestServiceRequested.md" target="_blank">electronicMedicalRecords/ReferralRequestServiceRequested</a>|
|[statusCode_display](#statusCode_display)||<a href="ReferralRequestServiceRequested.md" target="_blank">electronicMedicalRecords/ReferralRequestServiceRequested</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/ReferralRequestServiceRequested (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Referral Request Service Req</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_referralrequestservicereqid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Referral Request Service Req</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Referral Request Service Req</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
