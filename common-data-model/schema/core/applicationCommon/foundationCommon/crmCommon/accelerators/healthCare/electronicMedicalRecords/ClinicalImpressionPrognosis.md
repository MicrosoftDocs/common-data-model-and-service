---
title: ClinicalImpressionPrognosis - Common Data Model | Microsoft Docs
...
Estimate of likely outcome.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/ClinicalImpressionPrognosis.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="ClinicalImpressionPrognosis.md" target="_blank">electronicMedicalRecords/ClinicalImpressionPrognosis</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="ClinicalImpressionPrognosis.md" target="_blank">electronicMedicalRecords/ClinicalImpressionPrognosis</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="ClinicalImpressionPrognosis.md" target="_blank">electronicMedicalRecords/ClinicalImpressionPrognosis</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="ClinicalImpressionPrognosis.md" target="_blank">electronicMedicalRecords/ClinicalImpressionPrognosis</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="ClinicalImpressionPrognosis.md" target="_blank">electronicMedicalRecords/ClinicalImpressionPrognosis</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="ClinicalImpressionPrognosis.md" target="_blank">electronicMedicalRecords/ClinicalImpressionPrognosis</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="ClinicalImpressionPrognosis.md" target="_blank">electronicMedicalRecords/ClinicalImpressionPrognosis</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="ClinicalImpressionPrognosis.md" target="_blank">electronicMedicalRecords/ClinicalImpressionPrognosis</a>|
|[ownerId](#ownerId)|Owner Id|<a href="ClinicalImpressionPrognosis.md" target="_blank">electronicMedicalRecords/ClinicalImpressionPrognosis</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="ClinicalImpressionPrognosis.md" target="_blank">electronicMedicalRecords/ClinicalImpressionPrognosis</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="ClinicalImpressionPrognosis.md" target="_blank">electronicMedicalRecords/ClinicalImpressionPrognosis</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="ClinicalImpressionPrognosis.md" target="_blank">electronicMedicalRecords/ClinicalImpressionPrognosis</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="ClinicalImpressionPrognosis.md" target="_blank">electronicMedicalRecords/ClinicalImpressionPrognosis</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="ClinicalImpressionPrognosis.md" target="_blank">electronicMedicalRecords/ClinicalImpressionPrognosis</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="ClinicalImpressionPrognosis.md" target="_blank">electronicMedicalRecords/ClinicalImpressionPrognosis</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="ClinicalImpressionPrognosis.md" target="_blank">electronicMedicalRecords/ClinicalImpressionPrognosis</a>|
|[clinicalImpressionIdentifierId](#clinicalImpressionIdentifierId)|A record of a clinical assessment performed to determine what problem(s) may affect the patient and before planning the treatments or management strategies that are best to manage patient's condition.|<a href="ClinicalImpressionPrognosis.md" target="_blank">electronicMedicalRecords/ClinicalImpressionPrognosis</a>|
|[clinicalImpressionPrognosisId](#clinicalImpressionPrognosisId)|Unique identifier for entity instances|<a href="ClinicalImpressionPrognosis.md" target="_blank">electronicMedicalRecords/ClinicalImpressionPrognosis</a>|
|[conceptId](#conceptId)|Estimate of likely outcome.|<a href="ClinicalImpressionPrognosis.md" target="_blank">electronicMedicalRecords/ClinicalImpressionPrognosis</a>|
|[name](#name)|The name of the custom entity.|<a href="ClinicalImpressionPrognosis.md" target="_blank">electronicMedicalRecords/ClinicalImpressionPrognosis</a>|
|[referenceId](#referenceId)|Risk Assessment expressing likely outcome.|<a href="ClinicalImpressionPrognosis.md" target="_blank">electronicMedicalRecords/ClinicalImpressionPrognosis</a>|
|[stateCode](#stateCode)|Status of the Clinical Impression Prognosis|<a href="ClinicalImpressionPrognosis.md" target="_blank">electronicMedicalRecords/ClinicalImpressionPrognosis</a>|
|[stateCode_display](#stateCode_display)||<a href="ClinicalImpressionPrognosis.md" target="_blank">electronicMedicalRecords/ClinicalImpressionPrognosis</a>|
|[statusCode](#statusCode)|Reason for the status of the Clinical Impression Prognosis|<a href="ClinicalImpressionPrognosis.md" target="_blank">electronicMedicalRecords/ClinicalImpressionPrognosis</a>|
|[statusCode_display](#statusCode_display)||<a href="ClinicalImpressionPrognosis.md" target="_blank">electronicMedicalRecords/ClinicalImpressionPrognosis</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: electronicMedicalRecords/ClinicalImpressionPrognosis (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Clinical Impression Prognosis</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msemr_clinicalimpressionprognosisid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Concept</td></tr><tr><td>description</td><td>Estimate of likely outcome.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_concept</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Reference</td></tr><tr><td>description</td><td>Risk Assessment expressing likely outcome.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_reference</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Clinical Impression Prognosis</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Clinical Impression Prognosis</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
