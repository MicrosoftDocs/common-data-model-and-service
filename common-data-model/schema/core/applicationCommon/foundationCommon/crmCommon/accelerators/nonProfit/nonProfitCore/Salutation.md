...
A Salutation represents the way a constituent wishes to be addressed, depending on the source, purpose and content of a of communication.  Salutations may or may not be auto-created by workflow.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/nonProfit/nonProfitCore/Salutation.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[Salutation/(resolvedAttributes)/salutationId](#salutationId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[Salutation/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>A Salutation represents the way a constituent wishes to be addressed, depending on the source, purpose and content of a of communication.  Salutations may or may not be auto-created by workflow.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
  the unique name that identifies this object in Common Data Service for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msnfp_Salutation"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="Salutation.md" target="_blank">nonProfitCore/Salutation</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="Salutation.md" target="_blank">nonProfitCore/Salutation</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="Salutation.md" target="_blank">nonProfitCore/Salutation</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="Salutation.md" target="_blank">nonProfitCore/Salutation</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="Salutation.md" target="_blank">nonProfitCore/Salutation</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="Salutation.md" target="_blank">nonProfitCore/Salutation</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="Salutation.md" target="_blank">nonProfitCore/Salutation</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="Salutation.md" target="_blank">nonProfitCore/Salutation</a>|
|[ownerId](#ownerId)|Owner Id|<a href="Salutation.md" target="_blank">nonProfitCore/Salutation</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="Salutation.md" target="_blank">nonProfitCore/Salutation</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="Salutation.md" target="_blank">nonProfitCore/Salutation</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="Salutation.md" target="_blank">nonProfitCore/Salutation</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="Salutation.md" target="_blank">nonProfitCore/Salutation</a>|
...
|[constituentType_display](#constituentType_display)||<a href="Salutation.md" target="_blank">nonProfitCore/Salutation</a>|
|[firstName](#firstName)|First Name|<a href="Salutation.md" target="_blank">nonProfitCore/Salutation</a>|
|[fullName](#fullName)|Full Name|<a href="Salutation.md" target="_blank">nonProfitCore/Salutation</a>|
|[insideSalutation](#insideSalutation)|This is the information that appears after the word Dear on the correspondence sent to the constituent.|<a href="Salutation.md" target="_blank">nonProfitCore/Salutation</a>|
|[isPreferred](#isPreferred)|Indicates that this Salutation may be applied by business logic when matches on other selection criteria (Comm. method, Account, Constituent Type) are not found.|<a href="Salutation.md" target="_blank">nonProfitCore/Salutation</a>|
|[lastName](#lastName)|Last Name|<a href="Salutation.md" target="_blank">nonProfitCore/Salutation</a>|
|[middleName](#middleName)|Middle Name|<a href="Salutation.md" target="_blank">nonProfitCore/Salutation</a>|
|[name](#name)||<a href="Salutation.md" target="_blank">nonProfitCore/Salutation</a>|
|[onBehalfOfAccount](#onBehalfOfAccount)|Indicates that this Salutation should be applied when the Customer is contacted in the capacity of their role on the indicated Account.|<a href="Salutation.md" target="_blank">nonProfitCore/Salutation</a>|
|[customerId](#customerId)|The customer account or contact to provide a quick link to additional customer details, such as account information, activities, and opportunities.|<a href="Salutation.md" target="_blank">nonProfitCore/Salutation</a>|
|[customerIdType](#customerIdType)|The type of customer, either Account or Contact.|<a href="Salutation.md" target="_blank">nonProfitCore/Salutation</a>|
|[salutationId](#salutationId)|Unique identifier for entity instances|<a href="Salutation.md" target="_blank">nonProfitCore/Salutation</a>|
|[suffix](#suffix)|Suffix|<a href="Salutation.md" target="_blank">nonProfitCore/Salutation</a>|
|[suffix_display](#suffix_display)||<a href="Salutation.md" target="_blank">nonProfitCore/Salutation</a>|
|[title](#title)|Prefix|<a href="Salutation.md" target="_blank">nonProfitCore/Salutation</a>|
|[title_display](#title_display)||<a href="Salutation.md" target="_blank">nonProfitCore/Salutation</a>|
|[type](#type)|Indicates that this Salutation should be applied when the Customer is contacted for the indicated category of mailing or acknowledgement.|<a href="Salutation.md" target="_blank">nonProfitCore/Salutation</a>|
|[type_display](#type_display)||<a href="Salutation.md" target="_blank">nonProfitCore/Salutation</a>|
|[stateCode](#stateCode)|Status of the Salutation|<a href="Salutation.md" target="_blank">nonProfitCore/Salutation</a>|
|[stateCode_display](#stateCode_display)||<a href="Salutation.md" target="_blank">nonProfitCore/Salutation</a>|
|[statusCode](#statusCode)|Reason for the status of the Salutation|<a href="Salutation.md" target="_blank">nonProfitCore/Salutation</a>|
|[statusCode_display](#statusCode_display)||<a href="Salutation.md" target="_blank">nonProfitCore/Salutation</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: nonProfitCore/Salutation (this entity)  
...
Mrs Wilma Smith
1234 Main Street
Anytown, USA 11111</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>255</td></tr><tr><td>sourceName</td><td>msnfp_addresslabelline1</td></tr></table>
...
**is.dataFormat.array**  
**is.CDS.sourceNamed**  
the unique name that identifies this object in Common Data Service for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msnfp_addresslabelline1"</td><td>string</td><td></td></tr></table>
...
>Mrs Wilma Smith
1234 Main Street
Anytown, USA 11111</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>255</td></tr><tr><td>sourceName</td><td>msnfp_addresslabelline2</td></tr></table>
...
**is.dataFormat.array**  
**is.CDS.sourceNamed**  
the unique name that identifies this object in Common Data Service for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msnfp_addresslabelline2"</td><td>string</td><td></td></tr></table>
...
Mrs Wilma Smith c/o Anytown Company
1234 Main Street
Anytown, USA 11111</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>255</td></tr><tr><td>sourceName</td><td>msnfp_addresslabelline3</td></tr></table>
...
**is.dataFormat.array**  
**is.CDS.sourceNamed**  
the unique name that identifies this object in Common Data Service for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msnfp_addresslabelline3"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Communication Method</td></tr><tr><td>description</td><td>Indicates that this Salutation should be applied when the Customer is contacted via the indicated communication channel</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>sourceName</td><td>msnfp_communicationmethod</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>CommChannel</td><td>100000000</td></tr></table></td></tr></table>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in Common Data Service for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msnfp_communicationmethod"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Constituent Type</td></tr><tr><td>description</td><td>Indicates that this Salutation should be applied when the Customer is contacted in their capacity as the indicated ConstituentType</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>sourceName</td><td>msnfp_constituenttype</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>ConstituentTypeOption</td><td>100000000</td></tr></table></td></tr></table>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in Common Data Service for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msnfp_constituenttype"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>First Name</td></tr><tr><td>description</td><td>First Name</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>255</td></tr><tr><td>sourceName</td><td>msnfp_firstname</td></tr></table>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in Common Data Service for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msnfp_firstname"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Full Name</td></tr><tr><td>description</td><td>Full Name</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>255</td></tr><tr><td>sourceName</td><td>msnfp_fullname</td></tr></table>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in Common Data Service for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msnfp_fullname"</td><td>string</td><td></td></tr></table>
...
This is the information that appears after the word Dear on the correspondence sent to the constituent.  
First included in: nonProfitCore/Salutation (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Inside Salutation</td></tr><tr><td>description</td><td>This is the information that appears after the word Dear on the correspondence sent to the constituent.</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>255</td></tr><tr><td>sourceName</td><td>msnfp_insidesalutation</td></tr></table>
...
**is.dataFormat.array**  
**is.CDS.sourceNamed**  
the unique name that identifies this object in Common Data Service for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msnfp_insidesalutation"</td><td>string</td><td></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>This is the information that appears after the word Dear on the correspondence sent to the constituent.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in Common Data Service for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msnfp_ispreferred"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Last Name</td></tr><tr><td>description</td><td>Last Name</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>255</td></tr><tr><td>sourceName</td><td>msnfp_lastname</td></tr></table>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in Common Data Service for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msnfp_lastname"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Middle Name</td></tr><tr><td>description</td><td>Middle Name</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>255</td></tr><tr><td>sourceName</td><td>msnfp_middlename</td></tr></table>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in Common Data Service for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msnfp_middlename"</td><td>string</td><td></td></tr></table>
...
**is.dataFormat.boolean**  
**is.CDS.sourceNamed**  
the unique name that identifies this object in Common Data Service for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msnfp_onbehalfofaccount"</td><td>string</td><td></td></tr></table>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in Common Data Service for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msnfp_salutationid"</td><td>string</td><td></td></tr></table>
...
**is.dataFormat.integer**  
**does.haveDefault**  
An attribute has a default value  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>default</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Jr.</td><td>100000000</td></tr><tr><td>en</td><td>Sr.</td><td>844060000</td></tr></table></td><td>any</td><td></td></tr></table>

**is.constrainedList**  
the values of an attribute are taken from or looked up from a fixed list of possibilities  

**is.CDS.sourceNamed**  
the unique name that identifies this object in Common Data Service for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msnfp_suffix"</td><td>string</td><td></td></tr></table>
...
**is.dataFormat.integer**  
**does.haveDefault**  
An attribute has a default value  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>default</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Mr.</td><td>100000000</td></tr><tr><td>en</td><td>Mrs.</td><td>844060000</td></tr><tr><td>en</td><td>Dr.</td><td>844060001</td></tr><tr><td>en</td><td>Prof.</td><td>844060002</td></tr><tr><td>en</td><td>Ms.</td><td>844060003</td></tr></table></td><td>any</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Salutation</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
