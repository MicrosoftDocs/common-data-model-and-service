...
Representation of a Customer Membership.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/nonProfit/nonProfitIati/Membership.cdm.json" target="_blank">GitHub</a>.  

## Instances

Instances of this entity are listed below.  

- [/foundationCommon/crmCommon/accelerators/nonProfit/nonProfitCore/Membership](../nonProfitCore/Membership.md "/core/applicationCommon/foundationCommon/crmCommon/accelerators/nonProfit/nonProfitCore/Membership.cdm.json/Membership")  
- /crmCommon/accelerators/nonProfit/nonProfitIati/Membership  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="Membership.md" target="_blank">nonProfitIati/Membership</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="Membership.md" target="_blank">nonProfitIati/Membership</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="Membership.md" target="_blank">nonProfitIati/Membership</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="Membership.md" target="_blank">nonProfitIati/Membership</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="Membership.md" target="_blank">nonProfitIati/Membership</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="Membership.md" target="_blank">nonProfitIati/Membership</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="Membership.md" target="_blank">nonProfitIati/Membership</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="Membership.md" target="_blank">nonProfitIati/Membership</a>|
|[ownerId](#ownerId)|Owner Id|<a href="Membership.md" target="_blank">nonProfitIati/Membership</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="Membership.md" target="_blank">nonProfitIati/Membership</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="Membership.md" target="_blank">nonProfitIati/Membership</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="Membership.md" target="_blank">nonProfitIati/Membership</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="Membership.md" target="_blank">nonProfitIati/Membership</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="Membership.md" target="_blank">nonProfitIati/Membership</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="Membership.md" target="_blank">nonProfitIati/Membership</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="Membership.md" target="_blank">nonProfitIati/Membership</a>|
|[customerId](#customerId)|The customer account or contact to provide a quick link to additional customer details, such as account information, activities, and opportunities.|<a href="Membership.md" target="_blank">nonProfitIati/Membership</a>|
|[customerIdType](#customerIdType)|The type of customer, either Account or Contact.|<a href="Membership.md" target="_blank">nonProfitIati/Membership</a>|
|[endDate](#endDate)|Membership end date|<a href="Membership.md" target="_blank">nonProfitIati/Membership</a>|
|[membershipId](#membershipId)|Unique identifier for entity instances|<a href="Membership.md" target="_blank">nonProfitIati/Membership</a>|
|[name](#name)|The name of the custom entity.|<a href="Membership.md" target="_blank">nonProfitIati/Membership</a>|
|[startDate](#startDate)|Membership start date|<a href="Membership.md" target="_blank">nonProfitIati/Membership</a>|
|[stateCode](#stateCode)|Status of the Membership|<a href="Membership.md" target="_blank">nonProfitIati/Membership</a>|
|[stateCode_display](#stateCode_display)||<a href="Membership.md" target="_blank">nonProfitIati/Membership</a>|
|[statusCode](#statusCode)|Reason for the status of the Membership|<a href="Membership.md" target="_blank">nonProfitIati/Membership</a>|
|[statusCode_display](#statusCode_display)||<a href="Membership.md" target="_blank">nonProfitIati/Membership</a>|
|[customer](#customer)|Unique identifier of the customer for the item.|<a href="Membership.md" target="_blank">nonProfitIati/Membership</a>|
|[type](#type)||<a href="Membership.md" target="_blank">nonProfitIati/Membership</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: nonProfitIati/Membership (this entity)  
...
Unique identifier of the customer for the item.  
First included in: nonProfitIati/Membership (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Customer</td></tr><tr><td>description</td><td>Unique identifier of the customer for the item.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msnfp_customer</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Unique identifier of the customer for the item.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msnfp_customer"</td><td>string</td><td></td></tr></table>
