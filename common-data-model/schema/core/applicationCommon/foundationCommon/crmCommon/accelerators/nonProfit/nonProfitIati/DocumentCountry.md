...
The recipient country that is the focus of the document.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/nonProfit/nonProfitIati/DocumentCountry.cdm.json" target="_blank">GitHub</a>.  

## Instances

Instances of this entity are listed below.  

- /crmCommon/accelerators/nonProfit/nonProfitIati/DocumentCountry  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/core/applicationCommon/foundationCommon<br>/crmCommon/accelerators/nonProfit/nonProfitIati<br>/DocumentCountry.cdm.json/DocumentCountry<br>/hasAttributes/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[DocumentCountry/(resolvedAttributes)/documentCountryId](#documentCountryId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[DocumentCountry/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>The recipient country that is the focus of the document.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msiati_documentcountry"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="DocumentCountry.md" target="_blank">nonProfitIati/DocumentCountry</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="DocumentCountry.md" target="_blank">nonProfitIati/DocumentCountry</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="DocumentCountry.md" target="_blank">nonProfitIati/DocumentCountry</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="DocumentCountry.md" target="_blank">nonProfitIati/DocumentCountry</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="DocumentCountry.md" target="_blank">nonProfitIati/DocumentCountry</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="DocumentCountry.md" target="_blank">nonProfitIati/DocumentCountry</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="DocumentCountry.md" target="_blank">nonProfitIati/DocumentCountry</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="DocumentCountry.md" target="_blank">nonProfitIati/DocumentCountry</a>|
|[ownerId](#ownerId)|Owner Id|<a href="DocumentCountry.md" target="_blank">nonProfitIati/DocumentCountry</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="DocumentCountry.md" target="_blank">nonProfitIati/DocumentCountry</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="DocumentCountry.md" target="_blank">nonProfitIati/DocumentCountry</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="DocumentCountry.md" target="_blank">nonProfitIati/DocumentCountry</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="DocumentCountry.md" target="_blank">nonProfitIati/DocumentCountry</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="DocumentCountry.md" target="_blank">nonProfitIati/DocumentCountry</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="DocumentCountry.md" target="_blank">nonProfitIati/DocumentCountry</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="DocumentCountry.md" target="_blank">nonProfitIati/DocumentCountry</a>|
|[countryId](#countryId)|The recipient country that is the focus of the document.|<a href="DocumentCountry.md" target="_blank">nonProfitIati/DocumentCountry</a>|
|[documentCountryId](#documentCountryId)|Unique identifier for entity instances|<a href="DocumentCountry.md" target="_blank">nonProfitIati/DocumentCountry</a>|
|[documentLink](#documentLink)|Unique identifier for Document Link associated with Document Country.|<a href="DocumentCountry.md" target="_blank">nonProfitIati/DocumentCountry</a>|
|[name](#name)|Additional description of the country.|<a href="DocumentCountry.md" target="_blank">nonProfitIati/DocumentCountry</a>|
|[stateCode](#stateCode)|Status of the Document Country|<a href="DocumentCountry.md" target="_blank">nonProfitIati/DocumentCountry</a>|
|[stateCode_display](#stateCode_display)||<a href="DocumentCountry.md" target="_blank">nonProfitIati/DocumentCountry</a>|
|[statusCode](#statusCode)|Reason for the status of the Document Country|<a href="DocumentCountry.md" target="_blank">nonProfitIati/DocumentCountry</a>|
|[statusCode_display](#statusCode_display)||<a href="DocumentCountry.md" target="_blank">nonProfitIati/DocumentCountry</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: nonProfitIati/DocumentCountry (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Country</td></tr><tr><td>description</td><td>The recipient country that is the focus of the document.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msiati_countryid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Document Country</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msiati_documentcountryid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the documentCountryId attribute are listed below.</summary>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msiati_documentcountryid"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Document Link</td></tr><tr><td>description</td><td>Unique identifier for Document Link associated with Document Country.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msiati_documentlinkid</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Unique identifier for Document Link associated with Document Country.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Name</td></tr><tr><td>description</td><td>Additional description of the country.</td></tr><tr><td>dataFormat</td><td>7</td></tr><tr><td>maximumLength</td><td>100</td></tr><tr><td>sourceName</td><td>msiati_name</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Additional description of the country.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Document Country</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the Document Country</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Document Country</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the Document Country</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
