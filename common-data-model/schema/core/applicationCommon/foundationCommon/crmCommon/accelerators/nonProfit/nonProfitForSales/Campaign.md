...
Container for campaign activities and responses, sales literature, products, and lists to create, plan, execute, and track the results of a specific marketing campaign through its life.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/nonProfit/nonProfitForSales/Campaign.cdm.json" target="_blank">GitHub</a>.  
...
- /crmCommon/accelerators/nonProfit/nonProfitForSales/Campaign  
- [/foundationCommon/crmCommon/accelerators/nonProfit/nonProfitIati/Campaign](../nonProfitIati/Campaign.md "/core/applicationCommon/foundationCommon/crmCommon/accelerators/nonProfit/nonProfitIati/Campaign.cdm.json/Campaign")  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="Campaign.md" target="_blank">nonProfitForSales/Campaign</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="Campaign.md" target="_blank">nonProfitForSales/Campaign</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="Campaign.md" target="_blank">nonProfitForSales/Campaign</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="Campaign.md" target="_blank">nonProfitForSales/Campaign</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="Campaign.md" target="_blank">nonProfitForSales/Campaign</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="Campaign.md" target="_blank">nonProfitForSales/Campaign</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="Campaign.md" target="_blank">nonProfitForSales/Campaign</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="Campaign.md" target="_blank">nonProfitForSales/Campaign</a>|
|[ownerId](#ownerId)|Owner Id|<a href="Campaign.md" target="_blank">nonProfitForSales/Campaign</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="Campaign.md" target="_blank">nonProfitForSales/Campaign</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="Campaign.md" target="_blank">nonProfitForSales/Campaign</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="Campaign.md" target="_blank">nonProfitForSales/Campaign</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="Campaign.md" target="_blank">nonProfitForSales/Campaign</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="Campaign.md" target="_blank">nonProfitForSales/Campaign</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="Campaign.md" target="_blank">nonProfitForSales/Campaign</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="Campaign.md" target="_blank">nonProfitForSales/Campaign</a>|
|[campaignId](#campaignId)|Unique identifier of the campaign.|<a href="Campaign.md" target="_blank">nonProfitForSales/Campaign</a>|
|[emailAddress](#emailAddress)|The primary email address for the entity.|<a href="Campaign.md" target="_blank">nonProfitForSales/Campaign</a>|
|[name](#name)|Type a name for the campaign so that it is identified correctly in lists.|<a href="Campaign.md" target="_blank">nonProfitForSales/Campaign</a>|
|[processId](#processId)|Contains the id of the process associated with the entity.|<a href="Campaign.md" target="_blank">nonProfitForSales/Campaign</a>|
|[stageId](#stageId)|Contains the id of the stage where the entity is located.|<a href="Campaign.md" target="_blank">nonProfitForSales/Campaign</a>|
|[traversedPath](#traversedPath)|A comma separated list of string values representing the unique identifiers of stages in a Business Process Flow Instance in the order that they occur.|<a href="Campaign.md" target="_blank">nonProfitForSales/Campaign</a>|
|[actualEnd](#actualEnd)|Enter the date when the campaign was closed or completed.|<a href="Campaign.md" target="_blank">nonProfitForSales/Campaign</a>|
|[actualStart](#actualStart)|Enter the actual start date and time for the campaign.|<a href="Campaign.md" target="_blank">nonProfitForSales/Campaign</a>|
|[budgetedCost](#budgetedCost)|Type the amount budgeted for the campaign to define a limit for how much you can spend.|<a href="Campaign.md" target="_blank">nonProfitForSales/Campaign</a>|
|[transactionCurrencyId](#transactionCurrencyId)|Choose the local currency for the record to make sure budgets are reported in the correct currency.|<a href="Campaign.md" target="_blank">nonProfitForSales/Campaign</a>|
|[exchangeRate](#exchangeRate)|Shows the conversion rate of the record's currency. The exchange rate is used to convert all money fields in the record from the local currency to the system's default currency.|<a href="Campaign.md" target="_blank">nonProfitForSales/Campaign</a>|
|[budgetedCostBase](#budgetedCostBase)|Value of the Budget Allocated in base currency.|<a href="Campaign.md" target="_blank">nonProfitForSales/Campaign</a>|
|[codeName](#codeName)|Type a number or other tracking code to identify the campaign. If no value is entered, a code will be generated automatically.|<a href="Campaign.md" target="_blank">nonProfitForSales/Campaign</a>|
|[description](#description)|Type additional information to describe the campaign, such as the products or services offered or the targeted audience.|<a href="Campaign.md" target="_blank">nonProfitForSales/Campaign</a>|
|[expectedResponse](#expectedResponse)|Type the expected response rate for the campaign as a full number between 0 and 100.|<a href="Campaign.md" target="_blank">nonProfitForSales/Campaign</a>|
|[expectedRevenue](#expectedRevenue)|Type the expected revenue for the campaign for return on investment projections and post-campaign reporting.|<a href="Campaign.md" target="_blank">nonProfitForSales/Campaign</a>|
|[expectedRevenueBase](#expectedRevenueBase)|Value of the Estimated Revenue in base currency.|<a href="Campaign.md" target="_blank">nonProfitForSales/Campaign</a>|
|[isTemplate](#isTemplate)|Select whether the campaign is a template that can be copied when you create future campaigns.|<a href="Campaign.md" target="_blank">nonProfitForSales/Campaign</a>|
|[message](#message)|Type the promotional message or marketing copy for the campaign.|<a href="Campaign.md" target="_blank">nonProfitForSales/Campaign</a>|
|[objective](#objective)|Type the objective of the campaign, including products, services, discounts, and pricing.|<a href="Campaign.md" target="_blank">nonProfitForSales/Campaign</a>|
|[otherCost](#otherCost)|Type the sum of any miscellaneous campaign costs not included in the campaign activities to make sure the actual cost of the campaign is calculated correctly.|<a href="Campaign.md" target="_blank">nonProfitForSales/Campaign</a>|
|[otherCostBase](#otherCostBase)|Value of the Miscellaneous Costs in base currency.|<a href="Campaign.md" target="_blank">nonProfitForSales/Campaign</a>|
|[promotionCodeName](#promotionCodeName)|Type a promotional code to track sales related to the campaign or allow customers to redeem a discount offer.|<a href="Campaign.md" target="_blank">nonProfitForSales/Campaign</a>|
|[proposedEnd](#proposedEnd)|Enter the date when the campaign is scheduled to end.|<a href="Campaign.md" target="_blank">nonProfitForSales/Campaign</a>|
|[proposedStart](#proposedStart)|Enter the date when the campaign is scheduled to start.|<a href="Campaign.md" target="_blank">nonProfitForSales/Campaign</a>|
|[stateCode](#stateCode)|Shows the status of the campaign. By default, campaigns are active and can't be deactivated.|<a href="Campaign.md" target="_blank">nonProfitForSales/Campaign</a>|
|[stateCode_display](#stateCode_display)||<a href="Campaign.md" target="_blank">nonProfitForSales/Campaign</a>|
|[statusCode](#statusCode)|Select the campaign's status.|<a href="Campaign.md" target="_blank">nonProfitForSales/Campaign</a>|
|[statusCode_display](#statusCode_display)||<a href="Campaign.md" target="_blank">nonProfitForSales/Campaign</a>|
|[totalActualCost](#totalActualCost)|Shows the sum of the amounts entered in the Total Cost of Campaign Activities and Miscellaneous Costs fields.|<a href="Campaign.md" target="_blank">nonProfitForSales/Campaign</a>|
|[totalActualCostBase](#totalActualCostBase)|Value of the Total Cost of Campaign in base currency.|<a href="Campaign.md" target="_blank">nonProfitForSales/Campaign</a>|
|[totalCampaignActivityActualCost](#totalCampaignActivityActualCost)|Shows the sum of the values entered in the Actual Cost field on all campaign activities related to the campaign.|<a href="Campaign.md" target="_blank">nonProfitForSales/Campaign</a>|
|[totalCampaignActivityActualCostBase](#totalCampaignActivityActualCostBase)|Value of the Total Cost of Campaign Activities in base currency.|<a href="Campaign.md" target="_blank">nonProfitForSales/Campaign</a>|
|[typeCode](#typeCode)|Select the type of the campaign.|<a href="Campaign.md" target="_blank">nonProfitForSales/Campaign</a>|
|[typeCode_display](#typeCode_display)||<a href="Campaign.md" target="_blank">nonProfitForSales/Campaign</a>|
|[priceListId](#priceListId)|Choose the price list associated with this item to make sure the products associated with the campaign are offered at the correct prices.|<a href="Campaign.md" target="_blank">nonProfitForSales/Campaign</a>|
|[entityImageId](#entityImageId)||<a href="Campaign.md" target="_blank">nonProfitForSales/Campaign</a>|
|[entityImage](#entityImage)|The default image for the entity.|<a href="Campaign.md" target="_blank">nonProfitForSales/Campaign</a>|
|[appealSegment](#appealSegment)|Giving level or operational area the Campaign is soliciting.|<a href="Campaign.md" target="_blank">nonProfitForSales/Campaign</a>|
|[appealSegment_display](#appealSegment_display)||<a href="Campaign.md" target="_blank">nonProfitForSales/Campaign</a>|
|[aquisitionSource](#aquisitionSource)|Source of the donors solicited for the campaign|<a href="Campaign.md" target="_blank">nonProfitForSales/Campaign</a>|
|[campaign_DefaultDesignationId](#campaign_DefaultDesignationId)|Unique identifier for Designation associated with Campaign.|<a href="Campaign.md" target="_blank">nonProfitForSales/Campaign</a>|
|[campaignCategory](#campaignCategory)|Assigned manually by the organization, this field is used for downstream analytics|<a href="Campaign.md" target="_blank">nonProfitForSales/Campaign</a>|
|[campaignCategory_display](#campaignCategory_display)||<a href="Campaign.md" target="_blank">nonProfitForSales/Campaign</a>|
|[campaignType](#campaignType)|Type of gifts the Campaign is soliciting.|<a href="Campaign.md" target="_blank">nonProfitForSales/Campaign</a>|
|[campaignType_display](#campaignType_display)||<a href="Campaign.md" target="_blank">nonProfitForSales/Campaign</a>|
|[channel](#channel)|Method in which the Campaign will be communicated to constituents.|<a href="Campaign.md" target="_blank">nonProfitForSales/Campaign</a>|
|[channel_display](#channel_display)||<a href="Campaign.md" target="_blank">nonProfitForSales/Campaign</a>|
|[effort](#effort)|Number of times correspondence has been sent this Campaign.|<a href="Campaign.md" target="_blank">nonProfitForSales/Campaign</a>|
|[effort_display](#effort_display)||<a href="Campaign.md" target="_blank">nonProfitForSales/Campaign</a>|
|[firstResponseDate](#firstResponseDate)|Date the first response was received against the campaign|<a href="Campaign.md" target="_blank">nonProfitForSales/Campaign</a>|
|[lastResponseDate](#lastResponseDate)|Last day a response is received against the campaign|<a href="Campaign.md" target="_blank">nonProfitForSales/Campaign</a>|
|[sourceCode](#sourceCode)|Source Code of Campaign as generated by rules defined in the Source Codes configuration.|<a href="Campaign.md" target="_blank">nonProfitForSales/Campaign</a>|
|[startDate](#startDate)|Starting date for the campaign.|<a href="Campaign.md" target="_blank">nonProfitForSales/Campaign</a>|
|[subChannel](#subChannel)|Specific way in which the Channel communication will be carried out.|<a href="Campaign.md" target="_blank">nonProfitForSales/Campaign</a>|
|[subChannel_display](#subChannel_display)||<a href="Campaign.md" target="_blank">nonProfitForSales/Campaign</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: nonProfitForSales/Campaign (this entity)  
