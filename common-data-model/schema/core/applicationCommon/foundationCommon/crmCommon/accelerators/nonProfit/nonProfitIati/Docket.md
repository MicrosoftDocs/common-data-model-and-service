...
A Docket is used to group inquiries (LOIs) and/or requests with a specific grant/award cycle or date (usually a review/board meeting).  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/nonProfit/nonProfitIati/Docket.cdm.json" target="_blank">GitHub</a>.  

## Instances

Instances of this entity are listed below.  

- [/foundationCommon/crmCommon/accelerators/nonProfit/nonProfitCore/Docket](../nonProfitCore/Docket.md "/core/applicationCommon/foundationCommon/crmCommon/accelerators/nonProfit/nonProfitCore/Docket.cdm.json/Docket")  
- /crmCommon/accelerators/nonProfit/nonProfitIati/Docket  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="Docket.md" target="_blank">nonProfitIati/Docket</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="Docket.md" target="_blank">nonProfitIati/Docket</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="Docket.md" target="_blank">nonProfitIati/Docket</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="Docket.md" target="_blank">nonProfitIati/Docket</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="Docket.md" target="_blank">nonProfitIati/Docket</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="Docket.md" target="_blank">nonProfitIati/Docket</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="Docket.md" target="_blank">nonProfitIati/Docket</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="Docket.md" target="_blank">nonProfitIati/Docket</a>|
|[ownerId](#ownerId)|Owner Id|<a href="Docket.md" target="_blank">nonProfitIati/Docket</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="Docket.md" target="_blank">nonProfitIati/Docket</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="Docket.md" target="_blank">nonProfitIati/Docket</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="Docket.md" target="_blank">nonProfitIati/Docket</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="Docket.md" target="_blank">nonProfitIati/Docket</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="Docket.md" target="_blank">nonProfitIati/Docket</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="Docket.md" target="_blank">nonProfitIati/Docket</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="Docket.md" target="_blank">nonProfitIati/Docket</a>|
|[assignedToId](#assignedToId)|Assigned To|<a href="Docket.md" target="_blank">nonProfitIati/Docket</a>|
|[awardRecipientId](#awardRecipientId)|Unique identifier of the awardrecipient for the item.|<a href="Docket.md" target="_blank">nonProfitIati/Docket</a>|
|[type](#type)|The type of Docket.|<a href="Docket.md" target="_blank">nonProfitIati/Docket</a>|
|[docket_FiscalSponsorId](#docket_FiscalSponsorId)|Unique identifier of the docket_fiscalsponsor for the item.|<a href="Docket.md" target="_blank">nonProfitIati/Docket</a>|
|[docketId](#docketId)|Unique identifier for entity instances|<a href="Docket.md" target="_blank">nonProfitIati/Docket</a>|
|[internalDueDate](#internalDueDate)|Date the Docket is scheduled to be completed.|<a href="Docket.md" target="_blank">nonProfitIati/Docket</a>|
|[name](#name)||<a href="Docket.md" target="_blank">nonProfitIati/Docket</a>|
|[status](#status)|Indicates the current status of the Docket.|<a href="Docket.md" target="_blank">nonProfitIati/Docket</a>|
|[status_display](#status_display)||<a href="Docket.md" target="_blank">nonProfitIati/Docket</a>|
|[summaryDescription](#summaryDescription)|Short description; longer content may be added as an attachment.|<a href="Docket.md" target="_blank">nonProfitIati/Docket</a>|
|[type_display](#type_display)||<a href="Docket.md" target="_blank">nonProfitIati/Docket</a>|
|[stateCode](#stateCode)|Status of the Docket|<a href="Docket.md" target="_blank">nonProfitIati/Docket</a>|
|[stateCode_display](#stateCode_display)||<a href="Docket.md" target="_blank">nonProfitIati/Docket</a>|
|[statusCode](#statusCode)|Reason for the status of the Docket|<a href="Docket.md" target="_blank">nonProfitIati/Docket</a>|
|[statusCode_display](#statusCode_display)||<a href="Docket.md" target="_blank">nonProfitIati/Docket</a>|
|[docket_FiscalSponsor](#docket_FiscalSponsor)|Unique identifier of the docket_fiscalsponsor for the item.|<a href="Docket.md" target="_blank">nonProfitIati/Docket</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: nonProfitIati/Docket (this entity)  
...
### <a href=#docket_FiscalSponsor name="docket_FiscalSponsor">docket_FiscalSponsor</a>
...
<details>
<summary>List of traits for the docket_FiscalSponsor attribute are listed below.</summary>
