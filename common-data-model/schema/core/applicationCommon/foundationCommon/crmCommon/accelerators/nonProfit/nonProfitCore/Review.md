...
The assessment of a Request made by an internal staff member (or team) or an external third party individual or entity (i.e. Consultant) and all of the relevant information that needs to be tracked.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/nonProfit/nonProfitCore/Review.cdm.json" target="_blank">GitHub</a>.  

## Instances

Instances of this entity are listed below.  

- /crmCommon/accelerators/nonProfit/nonProfitCore/Review  
- [/foundationCommon/crmCommon/accelerators/nonProfit/nonProfitForSales/Review](../nonProfitForSales/Review.md "/core/applicationCommon/foundationCommon/crmCommon/accelerators/nonProfit/nonProfitForSales/Review.cdm.json/Review")  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="Review.md" target="_blank">nonProfitCore/Review</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="Review.md" target="_blank">nonProfitCore/Review</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="Review.md" target="_blank">nonProfitCore/Review</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="Review.md" target="_blank">nonProfitCore/Review</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="Review.md" target="_blank">nonProfitCore/Review</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="Review.md" target="_blank">nonProfitCore/Review</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="Review.md" target="_blank">nonProfitCore/Review</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="Review.md" target="_blank">nonProfitCore/Review</a>|
|[ownerId](#ownerId)|Owner Id|<a href="Review.md" target="_blank">nonProfitCore/Review</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="Review.md" target="_blank">nonProfitCore/Review</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="Review.md" target="_blank">nonProfitCore/Review</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="Review.md" target="_blank">nonProfitCore/Review</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="Review.md" target="_blank">nonProfitCore/Review</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="Review.md" target="_blank">nonProfitCore/Review</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="Review.md" target="_blank">nonProfitCore/Review</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="Review.md" target="_blank">nonProfitCore/Review</a>|
|[awardId](#awardId)|Award|<a href="Review.md" target="_blank">nonProfitCore/Review</a>|
|[awardVersionId](#awardVersionId)|Award Version|<a href="Review.md" target="_blank">nonProfitCore/Review</a>|
|[dateSubmitted](#dateSubmitted)|Date Review was submitted.|<a href="Review.md" target="_blank">nonProfitCore/Review</a>|
|[description](#description)|Description of the Review.|<a href="Review.md" target="_blank">nonProfitCore/Review</a>|
|[dueDate](#dueDate)|Date the review is due.|<a href="Review.md" target="_blank">nonProfitCore/Review</a>|
|[name](#name)||<a href="Review.md" target="_blank">nonProfitCore/Review</a>|
|[requestId](#requestId)|Request|<a href="Review.md" target="_blank">nonProfitCore/Review</a>|
|[review_DocketId](#review_DocketId)|Docket|<a href="Review.md" target="_blank">nonProfitCore/Review</a>|
|[review_ReportId](#review_ReportId)|Report|<a href="Review.md" target="_blank">nonProfitCore/Review</a>|
|[reviewDate](#reviewDate)|Date the review was conducted.|<a href="Review.md" target="_blank">nonProfitCore/Review</a>|
|[reviewerId](#reviewerId)|Reviewer|<a href="Review.md" target="_blank">nonProfitCore/Review</a>|
|[reviewerType](#reviewerType)|Indicates the type of Reviewer.|<a href="Review.md" target="_blank">nonProfitCore/Review</a>|
|[reviewerType_display](#reviewerType_display)||<a href="Review.md" target="_blank">nonProfitCore/Review</a>|
|[reviewId](#reviewId)|Unique identifier for entity instances|<a href="Review.md" target="_blank">nonProfitCore/Review</a>|
|[status](#status)|Status of the Review.|<a href="Review.md" target="_blank">nonProfitCore/Review</a>|
|[status_display](#status_display)||<a href="Review.md" target="_blank">nonProfitCore/Review</a>|
|[type](#type)|The type of Review.|<a href="Review.md" target="_blank">nonProfitCore/Review</a>|
|[type_display](#type_display)||<a href="Review.md" target="_blank">nonProfitCore/Review</a>|
|[stateCode](#stateCode)|Status of the Review|<a href="Review.md" target="_blank">nonProfitCore/Review</a>|
|[stateCode_display](#stateCode_display)||<a href="Review.md" target="_blank">nonProfitCore/Review</a>|
|[statusCode](#statusCode)|Reason for the status of the Review|<a href="Review.md" target="_blank">nonProfitCore/Review</a>|
|[statusCode_display](#statusCode_display)||<a href="Review.md" target="_blank">nonProfitCore/Review</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: nonProfitCore/Review (this entity)  
...
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="Report.md" target="_blank">/core/applicationCommon/foundationCommon/crmCommon/accelerators/nonProfit/nonProfitCore/Report.cdm.json/Report</a></td><td><a href="Report.md#reportId" target="_blank">reportId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
