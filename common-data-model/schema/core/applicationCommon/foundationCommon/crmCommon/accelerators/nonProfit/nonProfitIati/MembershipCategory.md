...
Represents the types of membership associated to products.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/nonProfit/nonProfitIati/MembershipCategory.cdm.json" target="_blank">GitHub</a>.  

## Instances

Instances of this entity are listed below.  

- [/foundationCommon/crmCommon/accelerators/nonProfit/nonProfitCore/MembershipCategory](../nonProfitCore/MembershipCategory.md "/core/applicationCommon/foundationCommon/crmCommon/accelerators/nonProfit/nonProfitCore/MembershipCategory.cdm.json/MembershipCategory")  
- /crmCommon/accelerators/nonProfit/nonProfitIati/MembershipCategory  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/core/applicationCommon/foundationCommon<br>/crmCommon/accelerators/nonProfit/nonProfitCore<br>/MembershipCategory.cdm.json/MembershipCategory<br>/hasAttributes/attributesAddedAtThisScope</td></tr><tr><td>/core/applicationCommon/foundationCommon<br>/crmCommon/accelerators/nonProfit/nonProfitIati<br>/MembershipCategory.cdm.json/MembershipCategory<br>/hasAttributes/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[MembershipCategory/(resolvedAttributes)/membershipCategoryId](#membershipCategoryId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[MembershipCategory/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Membership Category</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Represents the types of membership associated to products.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msnfp_membershipcategory"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="MembershipCategory.md" target="_blank">nonProfitIati/MembershipCategory</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="MembershipCategory.md" target="_blank">nonProfitIati/MembershipCategory</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="MembershipCategory.md" target="_blank">nonProfitIati/MembershipCategory</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="MembershipCategory.md" target="_blank">nonProfitIati/MembershipCategory</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="MembershipCategory.md" target="_blank">nonProfitIati/MembershipCategory</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="MembershipCategory.md" target="_blank">nonProfitIati/MembershipCategory</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="MembershipCategory.md" target="_blank">nonProfitIati/MembershipCategory</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="MembershipCategory.md" target="_blank">nonProfitIati/MembershipCategory</a>|
|[ownerId](#ownerId)|Owner Id|<a href="MembershipCategory.md" target="_blank">nonProfitIati/MembershipCategory</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="MembershipCategory.md" target="_blank">nonProfitIati/MembershipCategory</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="MembershipCategory.md" target="_blank">nonProfitIati/MembershipCategory</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="MembershipCategory.md" target="_blank">nonProfitIati/MembershipCategory</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="MembershipCategory.md" target="_blank">nonProfitIati/MembershipCategory</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="MembershipCategory.md" target="_blank">nonProfitIati/MembershipCategory</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="MembershipCategory.md" target="_blank">nonProfitIati/MembershipCategory</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="MembershipCategory.md" target="_blank">nonProfitIati/MembershipCategory</a>|
|[membershipCategoryId](#membershipCategoryId)|Unique identifier for entity instances|<a href="MembershipCategory.md" target="_blank">nonProfitIati/MembershipCategory</a>|
|[name](#name)|The name of the custom entity.|<a href="MembershipCategory.md" target="_blank">nonProfitIati/MembershipCategory</a>|
|[type](#type)|Membership type|<a href="MembershipCategory.md" target="_blank">nonProfitIati/MembershipCategory</a>|
|[type_display](#type_display)||<a href="MembershipCategory.md" target="_blank">nonProfitIati/MembershipCategory</a>|
|[stateCode](#stateCode)|Status of the Membership Category|<a href="MembershipCategory.md" target="_blank">nonProfitIati/MembershipCategory</a>|
|[stateCode_display](#stateCode_display)||<a href="MembershipCategory.md" target="_blank">nonProfitIati/MembershipCategory</a>|
|[statusCode](#statusCode)|Reason for the status of the Membership Category|<a href="MembershipCategory.md" target="_blank">nonProfitIati/MembershipCategory</a>|
|[statusCode_display](#statusCode_display)||<a href="MembershipCategory.md" target="_blank">nonProfitIati/MembershipCategory</a>|
|[Name](#Name)|The name of the custom entity.|<a href="MembershipCategory.md" target="_blank">nonProfitIati/MembershipCategory</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: nonProfitIati/MembershipCategory (this entity)  
...
### <a href=#membershipCategoryId name="membershipCategoryId">membershipCategoryId</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Membership Category</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msnfp_membershipcategoryid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the membershipCategoryId attribute are listed below.</summary>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msnfp_membershipcategoryid"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Type</td></tr><tr><td>description</td><td>Membership type</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>msnfp_type</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td>[object Object]</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Membership type</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
Status of the Membership Category  
First included in: nonProfitIati/MembershipCategory (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Membership Category</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the Membership Category</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
Reason for the status of the Membership Category  
First included in: nonProfitIati/MembershipCategory (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Membership Category</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the Membership Category</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
