...
- **is.identifiedBy**  
  ...
  ```
  "PaymentSchedule/hasAttributes/paymentScheduleId"
  ```
...
- **means.entityState**  
  ...
  ```
  "PaymentSchedule/hasAttributes/stateCode"
  ```
