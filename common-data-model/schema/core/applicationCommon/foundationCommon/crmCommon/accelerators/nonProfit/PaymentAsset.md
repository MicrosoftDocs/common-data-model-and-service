...
- **is.identifiedBy**  
  ...
  ```
  "PaymentAsset/hasAttributes/paymentAssetId"
  ```
...
- **means.entityState**  
  ...
  ```
  "PaymentAsset/hasAttributes/stateCode"
  ```
