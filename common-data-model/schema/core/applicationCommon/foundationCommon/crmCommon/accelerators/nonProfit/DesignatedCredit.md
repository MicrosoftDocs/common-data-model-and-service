...
- **is.identifiedBy**  
  ...
  ```
  "DesignatedCredit/hasAttributes/designatedCreditId"
  ```
...
- **means.entityState**  
  ...
  ```
  "DesignatedCredit/hasAttributes/stateCode"
  ```
