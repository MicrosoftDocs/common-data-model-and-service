...
The language in which target document is written.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/nonProfit/nonProfitIati/DocumentLanguage.cdm.json" target="_blank">GitHub</a>.  

## Instances

Instances of this entity are listed below.  

- /crmCommon/accelerators/nonProfit/nonProfitIati/DocumentLanguage  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/core/applicationCommon/foundationCommon<br>/crmCommon/accelerators/nonProfit/nonProfitIati<br>/DocumentLanguage.cdm.json/DocumentLanguage<br>/hasAttributes/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[DocumentLanguage/(resolvedAttributes)/documentLanguageId](#documentLanguageId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[DocumentLanguage/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Document Language</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>The language in which target document is written.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msiati_documentlanguage"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="DocumentLanguage.md" target="_blank">nonProfitIati/DocumentLanguage</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="DocumentLanguage.md" target="_blank">nonProfitIati/DocumentLanguage</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="DocumentLanguage.md" target="_blank">nonProfitIati/DocumentLanguage</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="DocumentLanguage.md" target="_blank">nonProfitIati/DocumentLanguage</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="DocumentLanguage.md" target="_blank">nonProfitIati/DocumentLanguage</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="DocumentLanguage.md" target="_blank">nonProfitIati/DocumentLanguage</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="DocumentLanguage.md" target="_blank">nonProfitIati/DocumentLanguage</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="DocumentLanguage.md" target="_blank">nonProfitIati/DocumentLanguage</a>|
|[ownerId](#ownerId)|Owner Id|<a href="DocumentLanguage.md" target="_blank">nonProfitIati/DocumentLanguage</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="DocumentLanguage.md" target="_blank">nonProfitIati/DocumentLanguage</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="DocumentLanguage.md" target="_blank">nonProfitIati/DocumentLanguage</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="DocumentLanguage.md" target="_blank">nonProfitIati/DocumentLanguage</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="DocumentLanguage.md" target="_blank">nonProfitIati/DocumentLanguage</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="DocumentLanguage.md" target="_blank">nonProfitIati/DocumentLanguage</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="DocumentLanguage.md" target="_blank">nonProfitIati/DocumentLanguage</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="DocumentLanguage.md" target="_blank">nonProfitIati/DocumentLanguage</a>|
|[documentLanguageId](#documentLanguageId)|Unique identifier for entity instances|<a href="DocumentLanguage.md" target="_blank">nonProfitIati/DocumentLanguage</a>|
|[documentLink](#documentLink)|Unique identifier for Document Link associated with Document Language.|<a href="DocumentLanguage.md" target="_blank">nonProfitIati/DocumentLanguage</a>|
|[languageId](#languageId)|The language in which target document is written.|<a href="DocumentLanguage.md" target="_blank">nonProfitIati/DocumentLanguage</a>|
|[Name](#Name)|The name of the custom entity.|<a href="DocumentLanguage.md" target="_blank">nonProfitIati/DocumentLanguage</a>|
|[stateCode](#stateCode)|Status of the Document Language|<a href="DocumentLanguage.md" target="_blank">nonProfitIati/DocumentLanguage</a>|
|[stateCode_display](#stateCode_display)||<a href="DocumentLanguage.md" target="_blank">nonProfitIati/DocumentLanguage</a>|
|[statusCode](#statusCode)|Reason for the status of the Document Language|<a href="DocumentLanguage.md" target="_blank">nonProfitIati/DocumentLanguage</a>|
|[statusCode_display](#statusCode_display)||<a href="DocumentLanguage.md" target="_blank">nonProfitIati/DocumentLanguage</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: nonProfitIati/DocumentLanguage (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Document Language</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msiati_documentlanguageid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the documentLanguageId attribute are listed below.</summary>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msiati_documentlanguageid"</td><td>string</td><td></td></tr></table>
...
### <a href=#documentLink name="documentLink">documentLink</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Document Link</td></tr><tr><td>description</td><td>Unique identifier for Document Link associated with Document Language.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msiati_documentlinkid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the documentLink attribute are listed below.</summary>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Document Link</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Unique identifier for Document Link associated with Document Language.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="DocumentLink.md" target="_blank">/core/applicationCommon/foundationCommon/crmCommon/accelerators/nonProfit/nonProfitIati/DocumentLink.cdm.json/DocumentLink</a></td><td><a href="DocumentLink.md#documentLinkId" target="_blank">documentLinkId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>

**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msiati_documentlinkid"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Language</td></tr><tr><td>description</td><td>The language in which target document is written.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msiati_languageid</td></tr></table>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msiati_languageid"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Document Language</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the Document Language</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Document Language</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the Document Language</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
