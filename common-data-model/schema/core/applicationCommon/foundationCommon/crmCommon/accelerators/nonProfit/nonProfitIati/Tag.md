...
Categorizations from established taxonomies that enrich the classification of the Delivery Framework but that, unlike those reported in the sector element, cannot be associated with percentage splits.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/nonProfit/nonProfitIati/Tag.cdm.json" target="_blank">GitHub</a>.  

## Instances

Instances of this entity are listed below.  

- /crmCommon/accelerators/nonProfit/nonProfitIati/Tag  
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Categorizations from established taxonomies that enrich the classification of the Delivery Framework but that, unlike those reported in the sector element, cannot be associated with percentage splits.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msiati_tag"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="Tag.md" target="_blank">nonProfitIati/Tag</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="Tag.md" target="_blank">nonProfitIati/Tag</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="Tag.md" target="_blank">nonProfitIati/Tag</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="Tag.md" target="_blank">nonProfitIati/Tag</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="Tag.md" target="_blank">nonProfitIati/Tag</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="Tag.md" target="_blank">nonProfitIati/Tag</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="Tag.md" target="_blank">nonProfitIati/Tag</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="Tag.md" target="_blank">nonProfitIati/Tag</a>|
|[ownerId](#ownerId)|Owner Id|<a href="Tag.md" target="_blank">nonProfitIati/Tag</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="Tag.md" target="_blank">nonProfitIati/Tag</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="Tag.md" target="_blank">nonProfitIati/Tag</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="Tag.md" target="_blank">nonProfitIati/Tag</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="Tag.md" target="_blank">nonProfitIati/Tag</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="Tag.md" target="_blank">nonProfitIati/Tag</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="Tag.md" target="_blank">nonProfitIati/Tag</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="Tag.md" target="_blank">nonProfitIati/Tag</a>|
|[codeId](#codeId)|The code for the tag as defined in the specified vocabulary.|<a href="Tag.md" target="_blank">nonProfitIati/Tag</a>|
|[deliveryFrameworkId](#deliveryFrameworkId)|Unique identifier for Delivery Framework associated with Tag.|<a href="Tag.md" target="_blank">nonProfitIati/Tag</a>|
|[name](#name)|The name of the custom entity.|<a href="Tag.md" target="_blank">nonProfitIati/Tag</a>|
|[tagId](#tagId)|Unique identifier for entity instances|<a href="Tag.md" target="_blank">nonProfitIati/Tag</a>|
|[stateCode](#stateCode)|Status of the Tag|<a href="Tag.md" target="_blank">nonProfitIati/Tag</a>|
|[stateCode_display](#stateCode_display)||<a href="Tag.md" target="_blank">nonProfitIati/Tag</a>|
|[statusCode](#statusCode)|Reason for the status of the Tag|<a href="Tag.md" target="_blank">nonProfitIati/Tag</a>|
|[statusCode_display](#statusCode_display)||<a href="Tag.md" target="_blank">nonProfitIati/Tag</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: nonProfitIati/Tag (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Code</td></tr><tr><td>description</td><td>The code for the tag as defined in the specified vocabulary.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msiati_codeid</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>The code for the tag as defined in the specified vocabulary.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Delivery Framework</td></tr><tr><td>description</td><td>Unique identifier for Delivery Framework associated with Tag.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msiati_deliveryframeworkid</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Unique identifier for Delivery Framework associated with Tag.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Tag</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msiati_tagid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Tag</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the Tag</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
