...
- **is.identifiedBy**  
  ...
  ```
  "AwardVersion/hasAttributes/awardVersionId"
  ```
...
- **means.entityState**  
  ...
  ```
  "AwardVersion/hasAttributes/stateCode"
  ```
