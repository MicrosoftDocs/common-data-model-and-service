...
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[ownerId](#ownerId)|Owner Id|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[leadId](#leadId)|Unique identifier of the lead.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[fullName](#fullName)|Combines and shows the lead's first and last names so the full name can be displayed in views and reports.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[processId](#processId)|Contains the id of the process associated with the entity.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[stageId](#stageId)|Contains the id of the stage where the entity is located.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[traversedPath](#traversedPath)|A comma separated list of string values representing the unique identifiers of stages in a Business Process Flow Instance in the order that they occur.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[parentAccountId](#parentAccountId)|Choose an account to connect this lead to, so that the relationship is visible in reports and analytics.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[parentContactId](#parentContactId)|Choose a contact to connect this lead to, so that the relationship is visible in reports and analytics.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[address1AddressId](#address1AddressId)|Unique identifier for address 1.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[address1AddressTypeCode](#address1AddressTypeCode)|Select the primary address type.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[address1AddressTypeCode_display](#address1AddressTypeCode_display)||<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[address1City](#address1City)|Type the city for the primary address.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[address1Composite](#address1Composite)|Shows the complete primary address.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[address1Country](#address1Country)|Type the country or region for the primary address.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[address1County](#address1County)|Type the county for the primary address.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[address1Fax](#address1Fax)|Type the fax number associated with the primary address.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[address1Latitude](#address1Latitude)|Type the latitude value for the primary address for use in mapping and other applications.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[address1Line1](#address1Line1)|Type the first line of the primary address.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[address1Line2](#address1Line2)|Type the second line of the primary address.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[address1Line3](#address1Line3)|Type the third line of the primary address.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[address1Longitude](#address1Longitude)|Type the longitude value for the primary address for use in mapping and other applications.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[address1Name](#address1Name)|Type a descriptive name for the primary address, such as Corporate Headquarters.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[address1PostalCode](#address1PostalCode)|Type the ZIP Code or postal code for the primary address.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[address1PostOfficeBox](#address1PostOfficeBox)|Type the post office box number of the primary address.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[address1ShippingMethodCode](#address1ShippingMethodCode)|Select a shipping method for deliveries sent to this address.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[address1ShippingMethodCode_display](#address1ShippingMethodCode_display)||<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[address1StateOrProvince](#address1StateOrProvince)|Type the state or province of the primary address.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[address1Telephone1](#address1Telephone1)|Type the main phone number associated with the primary address.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[address1Telephone2](#address1Telephone2)|Type a second phone number associated with the primary address.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[address1Telephone3](#address1Telephone3)|Type a third phone number associated with the primary address.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[address1UPSZone](#address1UPSZone)|Type the UPS zone of the primary address to make sure shipping charges are calculated correctly and deliveries are made promptly, if shipped by UPS.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[address1UTCOffset](#address1UTCOffset)|Select the time zone, or UTC offset, for this address so that other people can reference it when they contact someone at this address.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[address2AddressId](#address2AddressId)|Unique identifier for address 2.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[address2AddressTypeCode](#address2AddressTypeCode)|Select the secondary address type.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[address2AddressTypeCode_display](#address2AddressTypeCode_display)||<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[address2City](#address2City)|Type the city for the secondary address.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[address2Composite](#address2Composite)|Shows the complete secondary address.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[address2Country](#address2Country)|Type the country or region for the secondary address.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[address2County](#address2County)|Type the county for the secondary address.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[address2Fax](#address2Fax)|Type the fax number associated with the secondary address.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[address2Latitude](#address2Latitude)|Type the latitude value for the secondary address for use in mapping and other applications.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[address2Line1](#address2Line1)|Type the first line of the secondary address.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[address2Line2](#address2Line2)|Type the second line of the secondary address.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[address2Line3](#address2Line3)|Type the third line of the secondary address.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[address2Longitude](#address2Longitude)|Type the longitude value for the secondary address for use in mapping and other applications.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[address2Name](#address2Name)|Type a descriptive name for the secondary address, such as Corporate Headquarters.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[address2PostalCode](#address2PostalCode)|Type the ZIP Code or postal code for the secondary address.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[address2PostOfficeBox](#address2PostOfficeBox)|Type the post office box number of the secondary address.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[address2ShippingMethodCode](#address2ShippingMethodCode)|Select a shipping method for deliveries sent to this address.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[address2ShippingMethodCode_display](#address2ShippingMethodCode_display)||<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[address2StateOrProvince](#address2StateOrProvince)|Type the state or province of the secondary address.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[address2Telephone1](#address2Telephone1)|Type the main phone number associated with the secondary address.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[address2Telephone2](#address2Telephone2)|Type a second phone number associated with the secondary address.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[address2Telephone3](#address2Telephone3)|Type a third phone number associated with the secondary address.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[address2UPSZone](#address2UPSZone)|Type the UPS zone of the secondary address to make sure shipping charges are calculated correctly and deliveries are made promptly, if shipped by UPS.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[address2UTCOffset](#address2UTCOffset)|Select the time zone, or UTC offset, for this address so that other people can reference it when they contact someone at this address.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[budgetAmount](#budgetAmount)|Information about the budget amount of the lead's company or organization.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[transactionCurrencyId](#transactionCurrencyId)|Choose the local currency for the record to make sure budgets are reported in the correct currency.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[exchangeRate](#exchangeRate)|Shows the conversion rate of the record's currency. The exchange rate is used to convert all money fields in the record from the local currency to the system's default currency.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[budgetAmountBase](#budgetAmountBase)|Value of the Budget Amount in base currency.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[budgetStatus](#budgetStatus)|Information about the budget status of the lead's company or organization.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[budgetStatus_display](#budgetStatus_display)||<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[companyName](#companyName)|Type the name of the company associated with the lead. This becomes the account name when the lead is qualified and converted to a customer account.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[confirmInterest](#confirmInterest)|Select whether the lead confirmed interest in your offerings. This helps in determining the lead quality.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[customerId](#customerId)|The customer account or contact to provide a quick link to additional customer details, such as account information, activities, and opportunities.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[customerIdType](#customerIdType)|The type of customer, either Account or Contact.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[decisionMaker](#decisionMaker)|Select whether your notes include information about who makes the purchase decisions at the lead's company.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[description](#description)|Type additional information to describe the lead, such as an excerpt from the company's website.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[doNotBulkEMail](#doNotBulkEMail)|Select whether the lead accepts bulk email sent through marketing campaigns or quick campaigns. If Do Not Allow is selected, the lead can be added to marketing lists, but will be excluded from the email.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[doNotEMail](#doNotEMail)|Select whether the lead allows direct email sent from Microsoft Dynamics 365.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[doNotFax](#doNotFax)|Select whether the lead allows faxes.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[doNotPhone](#doNotPhone)|Select whether the lead allows phone calls.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[doNotPostalMail](#doNotPostalMail)|Select whether the lead allows direct mail.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[doNotSendMM](#doNotSendMM)|Select whether the lead accepts marketing materials, such as brochures or catalogs. Leads that opt out can be excluded from marketing initiatives.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[EMailAddress1](#EMailAddress1)|Type the primary email address for the lead.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[EMailAddress2](#EMailAddress2)|Type the secondary email address for the lead.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[EMailAddress3](#EMailAddress3)|Type a third email address for the lead.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[estimatedAmount](#estimatedAmount)|Type the estimated revenue value that this lead will generate to assist in sales forecasting and planning.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[estimatedAmountBase](#estimatedAmountBase)|Value of the Est. Value in base currency.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[estimatedCloseDate](#estimatedCloseDate)|Enter the expected close date for the lead, so that the sales team can schedule timely follow-up meetings to move the prospect to the next sales stage.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[estimatedValue](#estimatedValue)|Type a numeric value of the lead's estimated value, such as a product quantity, if no revenue amount can be specified in the Est. Value field. This can be used for sales forecasting and planning.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[evaluateFit](#evaluateFit)|Select whether the fit between the lead's requirements and your offerings was evaluated.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[fax](#fax)|Type the fax number for the primary contact for the lead.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[firstName](#firstName)|Type the first name of the primary contact for the lead to make sure the prospect is addressed correctly in sales calls, email, and marketing campaigns.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[industryCode](#industryCode)|Select the primary industry in which the lead's business is focused, for use in marketing segmentation and demographic analysis.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[industryCode_display](#industryCode_display)||<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[initialCommunication](#initialCommunication)|Choose whether someone from the sales team contacted this lead earlier.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[initialCommunication_display](#initialCommunication_display)||<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[jobTitle](#jobTitle)|Type the job title of the primary contact for this lead to make sure the prospect is addressed correctly in sales calls, email, and marketing campaigns.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[lastName](#lastName)|Type the last name of the primary contact for the lead to make sure the prospect is addressed correctly in sales calls, email, and marketing campaigns.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[lastUsedInCampaign](#lastUsedInCampaign)|Shows the date when the lead was last included in a marketing campaign or quick campaign.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[leadQualityCode](#leadQualityCode)|Select a rating value to indicate the lead's potential to become a customer.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[leadQualityCode_display](#leadQualityCode_display)||<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[leadSourceCode](#leadSourceCode)|Select the primary marketing source that prompted the lead to contact you.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[leadSourceCode_display](#leadSourceCode_display)||<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[masterId](#masterId)|Unique identifier of the master lead for merge.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[merged](#merged)|Tells whether the lead has been merged with another lead.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[middleName](#middleName)|Type the middle name or initial of the primary contact for the lead to make sure the prospect is addressed correctly.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[mobilePhone](#mobilePhone)|Type the mobile phone number for the primary contact for the lead.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[need](#need)|Choose how high the level of need is for the lead's company.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[need_display](#need_display)||<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[numberOfEmployees](#numberOfEmployees)|Type the number of employees that work at the company associated with the lead, for use in marketing segmentation and demographic analysis.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[pager](#pager)|Type the pager number for the primary contact for the lead.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[participatesInWorkflow](#participatesInWorkflow)|Shows whether the lead participates in workflow rules.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[preferredContactMethodCode](#preferredContactMethodCode)|Select the preferred method of contact.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[preferredContactMethodCode_display](#preferredContactMethodCode_display)||<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[priorityCode](#priorityCode)|Select the priority so that preferred customers or critical issues are handled quickly.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[priorityCode_display](#priorityCode_display)||<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[purchaseProcess](#purchaseProcess)|Choose whether an individual or a committee will be involved in the  purchase process for the lead.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[purchaseProcess_display](#purchaseProcess_display)||<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[qualificationComments](#qualificationComments)|Type comments about the qualification or scoring of the lead.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[revenue](#revenue)|Type the annual revenue of the company associated with the lead to provide an understanding of the prospect's business.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[revenueBase](#revenueBase)|Value of the Annual Revenue in base currency.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[salesStage](#salesStage)|Select the sales stage of this lead to aid the sales team in their efforts to convert this lead to an opportunity.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[salesStage_display](#salesStage_display)||<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[salesStageCode](#salesStageCode)|Select the sales process stage for the lead to help determine the probability of the lead converting to an opportunity.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[salesStageCode_display](#salesStageCode_display)||<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[salutation](#salutation)|Type the salutation of the primary contact for this lead to make sure the prospect is addressed correctly in sales calls, email messages, and marketing campaigns.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[scheduleFollowupProspect](#scheduleFollowupProspect)|Enter the date and time of the prospecting follow-up meeting with the lead.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[scheduleFollowUpQualify](#scheduleFollowUpQualify)|Enter the date and time of the qualifying follow-up meeting with the lead.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[SIC](#SIC)|Type the Standard Industrial Classification (SIC) code that indicates the lead's primary industry of business for use in marketing segmentation and demographic analysis.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[stateCode](#stateCode)|Shows whether the lead is open, qualified, or disqualified. Qualified and disqualified leads are read-only and can't be edited unless they are reactivated.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[stateCode_display](#stateCode_display)||<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[statusCode](#statusCode)|Select the lead's status.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[statusCode_display](#statusCode_display)||<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[subject](#subject)|Type a subject or descriptive name, such as the expected order, company name, or marketing source list, to identify the lead.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[telephone1](#telephone1)|Type the work phone number for the primary contact for the lead.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[telephone2](#telephone2)|Type the home phone number for the primary contact for the lead.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[telephone3](#telephone3)|Type an alternate phone number for the primary contact for the lead.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[purchaseTimeFrame](#purchaseTimeFrame)|Choose how long the lead will likely take to make the purchase, so the sales team will be aware.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[purchaseTimeFrame_display](#purchaseTimeFrame_display)||<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[webSiteUrl](#webSiteUrl)|Type the website URL for the company associated with this lead.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[SLAId](#SLAId)|Choose the service level agreement (SLA) that you want to apply to the Lead record.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[SLAInvokedId](#SLAInvokedId)|Last SLA that was applied to this case. This field is for internal use only.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[onHoldTime](#onHoldTime)|Shows how long, in minutes, that the record was on hold.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[lastOnHoldTime](#lastOnHoldTime)|Contains the date and time stamp of the last on hold time.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[followEmail](#followEmail)|Information about whether to allow following email activity like opens, attachment views and link clicks for emails sent to the lead.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[timeSpentByMeOnEmailAndMeetings](#timeSpentByMeOnEmailAndMeetings)|Total time spent for emails (read and write) and meetings by me in relation to the lead record.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[entityImageId](#entityImageId)||<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[accountId](#accountId)|Unique identifier of the account with which the lead is associated.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[contactId](#contactId)|Unique identifier of the contact with which the lead is associated.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[yomiCompanyName](#yomiCompanyName)|Type the phonetic spelling of the lead's company name, if the name is specified in Japanese, to make sure the name is pronounced correctly in phone calls with the prospect.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[yomiFirstName](#yomiFirstName)|Type the phonetic spelling of the lead's first name, if the name is specified in Japanese, to make sure the name is pronounced correctly in phone calls with the prospect.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[yomiFullName](#yomiFullName)|Combines and shows the lead's Yomi first and last names so the full phonetic name can be displayed in views and reports.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[yomiLastName](#yomiLastName)|Type the phonetic spelling of the lead's last name, if the name is specified in Japanese, to make sure the name is pronounced correctly in phone calls with the prospect.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[yomiMiddleName](#yomiMiddleName)|Type the phonetic spelling of the lead's middle name, if the name is specified in Japanese, to make sure the name is pronounced correctly in phone calls with the prospect.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[campaignId](#campaignId)|Choose the campaign that the lead was generated from to track the effectiveness of marketing campaigns and identify  communications received by the lead.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[relatedObjectId](#relatedObjectId)|Related Campaign Response.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[originatingCaseId](#originatingCaseId)|This attribute is used for Sample Service Business Processes.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[qualifyingOpportunityId](#qualifyingOpportunityId)|Choose the opportunity that the lead was qualified on and then converted to.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[applicationDeadline](#applicationDeadline)|Deadline to submit application.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[deliveryFrameworkId](#deliveryFrameworkId)||<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[expectedAmountRequested](#expectedAmountRequested)|Amount requested by the Grant Seeker.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[expectedAmountRequested_Base](#expectedAmountRequested_Base)|Value of the Expected Amount Requested in base currency.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[expectedDuration](#expectedDuration)|Expected duration of the Grant in months.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[expectedStartDate](#expectedStartDate)|Expected start date of the Grant.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[isRenewal](#isRenewal)|Indicates if this is a renewal Grant.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[lead_DocketId](#lead_DocketId)|Docket|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[letterOfIntentDeadline](#letterOfIntentDeadline)|Deadline to submit notification to donor that organization will be competing for this grant.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[organizationalBudget](#organizationalBudget)|Total budget of the Organization.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[organizationalBudget_Base](#organizationalBudget_Base)|Value of the Organization Budget in base currency.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[organizationType](#organizationType)|Type of Account.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[organizationType_display](#organizationType_display)||<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[requestType](#requestType)|Indicates the type of Inquiry/LOI/Lead.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[requestType_display](#requestType_display)||<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[totalProjectBudget](#totalProjectBudget)|Budget defined by the Grant Seeker.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
|[totalProjectBudget_Base](#totalProjectBudget_Base)|Value of the Total Project Budget in base currency.|<a href="Lead.md" target="_blank">nonProfitForSales/Lead</a>|
...
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="../nonProfitCore/Contact.md" target="_blank">/core/applicationCommon/foundationCommon/crmCommon/accelerators/nonProfit/nonProfitCore/Contact.cdm.json/Contact</a></td><td><a href="../nonProfitCore/Contact.md#contactId" target="_blank">contactId</a></td></tr><tr><td><a href="../nonProfitCore/Account.md" target="_blank">/core/applicationCommon/foundationCommon/crmCommon/accelerators/nonProfit/nonProfitCore/Account.cdm.json/Account</a></td><td><a href="../nonProfitCore/Account.md#accountId" target="_blank">accountId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Application Deadline</td></tr><tr><td>description</td><td>Deadline to submit application.</td></tr><tr><td>dataFormat</td><td>dateTime</td></tr><tr><td>sourceName</td><td>msnfp_applicationdeadline</td></tr></table>
...
**means.measurement.time**  
**is.CDS.sourceNamed**  
the unique name that identifies this object in Common Data Service for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msnfp_applicationdeadline"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Expected Amount Requested</td></tr><tr><td>description</td><td>Amount requested by the Grant Seeker.</td></tr><tr><td>dataFormat</td><td>decimal</td></tr><tr><td>maximumValue</td><td>1000000000</td></tr><tr><td>minimumValue</td><td>0</td></tr><tr><td>sourceName</td><td>msnfp_expectedamountrequested</td></tr></table>
...
**means.measurement.currency**  
**is.CDS.sourceNamed**  
the unique name that identifies this object in Common Data Service for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msnfp_expectedamountrequested"</td><td>string</td><td></td></tr></table>
...
### <a href=#expectedAmountRequested_Base name="expectedAmountRequested_Base">expectedAmountRequested_Base</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Expected Amount Requested (Base)</td></tr><tr><td>description</td><td>Value of the Expected Amount Requested in base currency.</td></tr><tr><td>dataFormat</td><td>decimal</td></tr><tr><td>maximumValue</td><td>922337203685477</td></tr><tr><td>minimumValue</td><td>-922337203685477</td></tr><tr><td>sourceName</td><td>msnfp_expectedamountrequested_base</td></tr></table>

#### Traits

<details>
<summary>List of traits for the expectedAmountRequested_Base attribute are listed below.</summary>
...
**means.measurement.currency**  
**is.CDS.sourceNamed**  
the unique name that identifies this object in Common Data Service for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msnfp_expectedamountrequested_base"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Expected Duration (Months)</td></tr><tr><td>description</td><td>Expected duration of the Grant in months.</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>maximumValue</td><td>2147483647</td></tr><tr><td>minimumValue</td><td>-2147483648</td></tr><tr><td>sourceName</td><td>msnfp_expectedduration</td></tr></table>
...
**is.dataFormat.integer**  
**is.CDS.sourceNamed**  
the unique name that identifies this object in Common Data Service for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msnfp_expectedduration"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Expected Start Date</td></tr><tr><td>description</td><td>Expected start date of the Grant.</td></tr><tr><td>dataFormat</td><td>dateTime</td></tr><tr><td>sourceName</td><td>msnfp_expectedstartdate</td></tr></table>
...
**means.measurement.time**  
**is.CDS.sourceNamed**  
the unique name that identifies this object in Common Data Service for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msnfp_expectedstartdate"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Is Renewal</td></tr><tr><td>description</td><td>Indicates if this is a renewal Grant.</td></tr><tr><td>dataFormat</td><td>boolean</td></tr><tr><td>sourceName</td><td>msnfp_isrenewal</td></tr></table>
...
**is.dataFormat.boolean**  
**is.CDS.sourceNamed**  
the unique name that identifies this object in Common Data Service for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msnfp_isrenewal"</td><td>string</td><td></td></tr></table>
...
### <a href=#lead_DocketId name="lead_DocketId">lead_DocketId</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Docket</td></tr><tr><td>description</td><td>Docket</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>sourceName</td><td>msnfp_lead_docketid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the lead_DocketId attribute are listed below.</summary>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in Common Data Service for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msnfp_lead_docketid"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Letter of Intent Deadline</td></tr><tr><td>description</td><td>Deadline to submit notification to donor that organization will be competing for this grant.</td></tr><tr><td>dataFormat</td><td>dateTime</td></tr><tr><td>sourceName</td><td>msnfp_letterofintentdeadline</td></tr></table>
...
**means.measurement.time**  
**is.CDS.sourceNamed**  
the unique name that identifies this object in Common Data Service for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msnfp_letterofintentdeadline"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Organization Budget</td></tr><tr><td>description</td><td>Total budget of the Organization.</td></tr><tr><td>dataFormat</td><td>decimal</td></tr><tr><td>maximumValue</td><td>1000000000</td></tr><tr><td>minimumValue</td><td>0</td></tr><tr><td>sourceName</td><td>msnfp_organizationalbudget</td></tr></table>
...
**means.measurement.currency**  
**is.CDS.sourceNamed**  
the unique name that identifies this object in Common Data Service for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msnfp_organizationalbudget"</td><td>string</td><td></td></tr></table>
...
### <a href=#organizationalBudget_Base name="organizationalBudget_Base">organizationalBudget_Base</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Organization Budget (Base)</td></tr><tr><td>description</td><td>Value of the Organization Budget in base currency.</td></tr><tr><td>dataFormat</td><td>decimal</td></tr><tr><td>maximumValue</td><td>922337203685477</td></tr><tr><td>minimumValue</td><td>-922337203685477</td></tr><tr><td>sourceName</td><td>msnfp_organizationalbudget_base</td></tr></table>

#### Traits

<details>
<summary>List of traits for the organizationalBudget_Base attribute are listed below.</summary>
...
**means.measurement.currency**  
**is.CDS.sourceNamed**  
the unique name that identifies this object in Common Data Service for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msnfp_organizationalbudget_base"</td><td>string</td><td></td></tr></table>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in Common Data Service for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msnfp_organizationtype"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Total Project Budget</td></tr><tr><td>description</td><td>Budget defined by the Grant Seeker.</td></tr><tr><td>dataFormat</td><td>decimal</td></tr><tr><td>maximumValue</td><td>1000000000</td></tr><tr><td>minimumValue</td><td>0</td></tr><tr><td>sourceName</td><td>msnfp_totalprojectbudget</td></tr></table>
