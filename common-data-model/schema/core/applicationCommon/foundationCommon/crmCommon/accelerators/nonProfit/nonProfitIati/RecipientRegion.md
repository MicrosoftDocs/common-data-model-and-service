...
A supranational geopolitical region that will benefit from the delivery framework  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/nonProfit/nonProfitIati/RecipientRegion.cdm.json" target="_blank">GitHub</a>.  

## Instances

Instances of this entity are listed below.  

- /crmCommon/accelerators/nonProfit/nonProfitIati/RecipientRegion  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/core/applicationCommon/foundationCommon<br>/crmCommon/accelerators/nonProfit/nonProfitIati<br>/RecipientRegion.cdm.json/RecipientRegion<br>/hasAttributes/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[RecipientRegion/(resolvedAttributes)/recipientRegionId](#recipientRegionId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[RecipientRegion/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>A supranational geopolitical region that will benefit from the delivery framework</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msiati_recipientregion"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="RecipientRegion.md" target="_blank">nonProfitIati/RecipientRegion</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="RecipientRegion.md" target="_blank">nonProfitIati/RecipientRegion</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="RecipientRegion.md" target="_blank">nonProfitIati/RecipientRegion</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="RecipientRegion.md" target="_blank">nonProfitIati/RecipientRegion</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="RecipientRegion.md" target="_blank">nonProfitIati/RecipientRegion</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="RecipientRegion.md" target="_blank">nonProfitIati/RecipientRegion</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="RecipientRegion.md" target="_blank">nonProfitIati/RecipientRegion</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="RecipientRegion.md" target="_blank">nonProfitIati/RecipientRegion</a>|
|[ownerId](#ownerId)|Owner Id|<a href="RecipientRegion.md" target="_blank">nonProfitIati/RecipientRegion</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="RecipientRegion.md" target="_blank">nonProfitIati/RecipientRegion</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="RecipientRegion.md" target="_blank">nonProfitIati/RecipientRegion</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="RecipientRegion.md" target="_blank">nonProfitIati/RecipientRegion</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="RecipientRegion.md" target="_blank">nonProfitIati/RecipientRegion</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="RecipientRegion.md" target="_blank">nonProfitIati/RecipientRegion</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="RecipientRegion.md" target="_blank">nonProfitIati/RecipientRegion</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="RecipientRegion.md" target="_blank">nonProfitIati/RecipientRegion</a>|
|[deliveryFrameworkId](#deliveryFrameworkId)|Unique identifier for Delivery Framework associated with Recipient Region.|<a href="RecipientRegion.md" target="_blank">nonProfitIati/RecipientRegion</a>|
|[name](#name)|The name of the custom entity.|<a href="RecipientRegion.md" target="_blank">nonProfitIati/RecipientRegion</a>|
|[percentage](#percentage)|The percentage of total commitments or total activity budget to this item|<a href="RecipientRegion.md" target="_blank">nonProfitIati/RecipientRegion</a>|
|[recipientRegionId](#recipientRegionId)|Unique identifier for entity instances|<a href="RecipientRegion.md" target="_blank">nonProfitIati/RecipientRegion</a>|
|[regionId](#regionId)|A supranational geopolitical region that will benefit from this delivery framework|<a href="RecipientRegion.md" target="_blank">nonProfitIati/RecipientRegion</a>|
|[stateCode](#stateCode)|Status of the Recipient Region|<a href="RecipientRegion.md" target="_blank">nonProfitIati/RecipientRegion</a>|
|[stateCode_display](#stateCode_display)||<a href="RecipientRegion.md" target="_blank">nonProfitIati/RecipientRegion</a>|
|[statusCode](#statusCode)|Reason for the status of the Recipient Region|<a href="RecipientRegion.md" target="_blank">nonProfitIati/RecipientRegion</a>|
|[statusCode_display](#statusCode_display)||<a href="RecipientRegion.md" target="_blank">nonProfitIati/RecipientRegion</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: nonProfitIati/RecipientRegion (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Delivery Framework</td></tr><tr><td>description</td><td>Unique identifier for Delivery Framework associated with Recipient Region.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msiati_deliveryframeworkid</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Unique identifier for Delivery Framework associated with Recipient Region.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Percentage</td></tr><tr><td>description</td><td>The percentage of total commitments or total activity budget to this item</td></tr><tr><td>dataFormat</td><td>16</td></tr><tr><td>maximumValue</td><td>100</td></tr><tr><td>minimumValue</td><td>0</td></tr><tr><td>sourceName</td><td>msiati_percentage</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>The percentage of total commitments or total activity budget to this item</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Recipient Region</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msiati_recipientregionid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Region</td></tr><tr><td>description</td><td>A supranational geopolitical region that will benefit from this delivery framework</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msiati_regionid</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>A supranational geopolitical region that will benefit from this delivery framework</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msiati_regionid"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Recipient Region</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the Recipient Region</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Recipient Region</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the Recipient Region</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
