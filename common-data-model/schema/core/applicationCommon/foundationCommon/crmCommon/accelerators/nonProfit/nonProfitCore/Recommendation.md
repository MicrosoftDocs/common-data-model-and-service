...
This is the mechanism through which Foundations provide recommendations back to a grant applicant.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/nonProfit/nonProfitCore/Recommendation.cdm.json" target="_blank">GitHub</a>.  

## Instances

Instances of this entity are listed below.  

- /crmCommon/accelerators/nonProfit/nonProfitCore/Recommendation  
- [/foundationCommon/crmCommon/accelerators/nonProfit/nonProfitForSales/Recommendation](../nonProfitForSales/Recommendation.md "/core/applicationCommon/foundationCommon/crmCommon/accelerators/nonProfit/nonProfitForSales/Recommendation.cdm.json/Recommendation")  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="Recommendation.md" target="_blank">nonProfitCore/Recommendation</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="Recommendation.md" target="_blank">nonProfitCore/Recommendation</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="Recommendation.md" target="_blank">nonProfitCore/Recommendation</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="Recommendation.md" target="_blank">nonProfitCore/Recommendation</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="Recommendation.md" target="_blank">nonProfitCore/Recommendation</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="Recommendation.md" target="_blank">nonProfitCore/Recommendation</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="Recommendation.md" target="_blank">nonProfitCore/Recommendation</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="Recommendation.md" target="_blank">nonProfitCore/Recommendation</a>|
|[ownerId](#ownerId)|Owner Id|<a href="Recommendation.md" target="_blank">nonProfitCore/Recommendation</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="Recommendation.md" target="_blank">nonProfitCore/Recommendation</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="Recommendation.md" target="_blank">nonProfitCore/Recommendation</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="Recommendation.md" target="_blank">nonProfitCore/Recommendation</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="Recommendation.md" target="_blank">nonProfitCore/Recommendation</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="Recommendation.md" target="_blank">nonProfitCore/Recommendation</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="Recommendation.md" target="_blank">nonProfitCore/Recommendation</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="Recommendation.md" target="_blank">nonProfitCore/Recommendation</a>|
|[communicationChannel](#communicationChannel)|The media used to communicate the Recommendation|<a href="Recommendation.md" target="_blank">nonProfitCore/Recommendation</a>|
|[communicationChannel_display](#communicationChannel_display)||<a href="Recommendation.md" target="_blank">nonProfitCore/Recommendation</a>|
|[date](#date)|Date the Recommendation was made.|<a href="Recommendation.md" target="_blank">nonProfitCore/Recommendation</a>|
|[dateSubmitted](#dateSubmitted)|Date Recommendation was submitted.|<a href="Recommendation.md" target="_blank">nonProfitCore/Recommendation</a>|
|[description](#description)|Description of the Recommendation.|<a href="Recommendation.md" target="_blank">nonProfitCore/Recommendation</a>|
|[name](#name)||<a href="Recommendation.md" target="_blank">nonProfitCore/Recommendation</a>|
|[recommendationId](#recommendationId)|Unique identifier for entity instances|<a href="Recommendation.md" target="_blank">nonProfitCore/Recommendation</a>|
|[recommenderAccountId](#recommenderAccountId)|On Behalf of Account|<a href="Recommendation.md" target="_blank">nonProfitCore/Recommendation</a>|
|[recommenderContactId](#recommenderContactId)|Recommended by Contact|<a href="Recommendation.md" target="_blank">nonProfitCore/Recommendation</a>|
|[requestId](#requestId)|Request|<a href="Recommendation.md" target="_blank">nonProfitCore/Recommendation</a>|
|[status](#status)|Status of the Recommendation.|<a href="Recommendation.md" target="_blank">nonProfitCore/Recommendation</a>|
|[status_display](#status_display)||<a href="Recommendation.md" target="_blank">nonProfitCore/Recommendation</a>|
|[stateCode](#stateCode)|Status of the Recommendation|<a href="Recommendation.md" target="_blank">nonProfitCore/Recommendation</a>|
|[stateCode_display](#stateCode_display)||<a href="Recommendation.md" target="_blank">nonProfitCore/Recommendation</a>|
|[statusCode](#statusCode)|Reason for the status of the Recommendation|<a href="Recommendation.md" target="_blank">nonProfitCore/Recommendation</a>|
|[statusCode_display](#statusCode_display)||<a href="Recommendation.md" target="_blank">nonProfitCore/Recommendation</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: nonProfitCore/Recommendation (this entity)  
