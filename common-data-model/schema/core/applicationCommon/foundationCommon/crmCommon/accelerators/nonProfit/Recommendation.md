...
- **is.identifiedBy**  
  ...
  ```
  "Recommendation/hasAttributes/recommendationId"
  ```
...
- **means.entityState**  
  ...
  ```
  "Recommendation/hasAttributes/stateCode"
  ```
