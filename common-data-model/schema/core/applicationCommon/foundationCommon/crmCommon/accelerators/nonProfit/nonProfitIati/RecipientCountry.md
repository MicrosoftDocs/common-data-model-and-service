...
The country that will benefit from this delivery framework  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/nonProfit/nonProfitIati/RecipientCountry.cdm.json" target="_blank">GitHub</a>.  

## Instances

Instances of this entity are listed below.  

- /crmCommon/accelerators/nonProfit/nonProfitIati/RecipientCountry  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/core/applicationCommon/foundationCommon<br>/crmCommon/accelerators/nonProfit/nonProfitIati<br>/RecipientCountry.cdm.json/RecipientCountry<br>/hasAttributes/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[RecipientCountry/(resolvedAttributes)/msiati_RecipientCountryId](#msiati_RecipientCountryId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[RecipientCountry/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>The country that will benefit from this delivery framework</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msiati_recipientcountry"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="RecipientCountry.md" target="_blank">nonProfitIati/RecipientCountry</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="RecipientCountry.md" target="_blank">nonProfitIati/RecipientCountry</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="RecipientCountry.md" target="_blank">nonProfitIati/RecipientCountry</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="RecipientCountry.md" target="_blank">nonProfitIati/RecipientCountry</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="RecipientCountry.md" target="_blank">nonProfitIati/RecipientCountry</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="RecipientCountry.md" target="_blank">nonProfitIati/RecipientCountry</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="RecipientCountry.md" target="_blank">nonProfitIati/RecipientCountry</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="RecipientCountry.md" target="_blank">nonProfitIati/RecipientCountry</a>|
|[ownerId](#ownerId)|Owner Id|<a href="RecipientCountry.md" target="_blank">nonProfitIati/RecipientCountry</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="RecipientCountry.md" target="_blank">nonProfitIati/RecipientCountry</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="RecipientCountry.md" target="_blank">nonProfitIati/RecipientCountry</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="RecipientCountry.md" target="_blank">nonProfitIati/RecipientCountry</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="RecipientCountry.md" target="_blank">nonProfitIati/RecipientCountry</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="RecipientCountry.md" target="_blank">nonProfitIati/RecipientCountry</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="RecipientCountry.md" target="_blank">nonProfitIati/RecipientCountry</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="RecipientCountry.md" target="_blank">nonProfitIati/RecipientCountry</a>|
|[countryId](#countryId)|The country that will benefit from this delivery framework|<a href="RecipientCountry.md" target="_blank">nonProfitIati/RecipientCountry</a>|
|[deliveryFrameworkId](#deliveryFrameworkId)|Unique identifier for Delivery Framework associated with Recipient Country.|<a href="RecipientCountry.md" target="_blank">nonProfitIati/RecipientCountry</a>|
|[name](#name)|The name of the custom entity.|<a href="RecipientCountry.md" target="_blank">nonProfitIati/RecipientCountry</a>|
|[percentage](#percentage)|The percentage of total commitments or total activity budget allocated to this country|<a href="RecipientCountry.md" target="_blank">nonProfitIati/RecipientCountry</a>|
|[msiati_RecipientCountryId](#msiati_RecipientCountryId)|Unique identifier for entity instances|<a href="RecipientCountry.md" target="_blank">nonProfitIati/RecipientCountry</a>|
|[stateCode](#stateCode)|Status of the Recipient Country|<a href="RecipientCountry.md" target="_blank">nonProfitIati/RecipientCountry</a>|
|[stateCode_display](#stateCode_display)||<a href="RecipientCountry.md" target="_blank">nonProfitIati/RecipientCountry</a>|
|[statusCode](#statusCode)|Reason for the status of the Recipient Country|<a href="RecipientCountry.md" target="_blank">nonProfitIati/RecipientCountry</a>|
|[statusCode_display](#statusCode_display)||<a href="RecipientCountry.md" target="_blank">nonProfitIati/RecipientCountry</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: nonProfitIati/RecipientCountry (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Country</td></tr><tr><td>description</td><td>The country that will benefit from this delivery framework</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msiati_countryid</td></tr></table>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msiati_countryid"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Delivery Framework</td></tr><tr><td>description</td><td>Unique identifier for Delivery Framework associated with Recipient Country.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msiati_deliveryframeworkid</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Unique identifier for Delivery Framework associated with Recipient Country.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Percentage</td></tr><tr><td>description</td><td>The percentage of total commitments or total activity budget allocated to this country</td></tr><tr><td>dataFormat</td><td>16</td></tr><tr><td>maximumValue</td><td>100</td></tr><tr><td>minimumValue</td><td>0</td></tr><tr><td>sourceName</td><td>msiati_percentage</td></tr></table>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msiati_percentage"</td><td>string</td><td></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>The percentage of total commitments or total activity budget allocated to this country</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
### <a href=#msiati_RecipientCountryId name="msiati_RecipientCountryId">msiati_RecipientCountryId</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Recipient Country</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msiati_recipientcountryid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the msiati_RecipientCountryId attribute are listed below.</summary>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Recipient Country</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the Recipient Country</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Recipient Country</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the Recipient Country</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
