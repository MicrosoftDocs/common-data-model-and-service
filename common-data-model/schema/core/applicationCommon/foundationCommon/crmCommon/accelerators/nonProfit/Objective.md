...
- **is.identifiedBy**  
  ...
  ```
  "Objective/hasAttributes/objectiveId"
  ```
...
- **means.entityState**  
  ...
  ```
  "Objective/hasAttributes/stateCode"
  ```
