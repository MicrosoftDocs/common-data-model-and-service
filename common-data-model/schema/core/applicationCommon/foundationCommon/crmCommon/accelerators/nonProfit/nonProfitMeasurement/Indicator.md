...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>An Indicator describes what will be measured to track evidence of a Result. Indicators can be qualitative or quantitative and may or may not be aggregable.</td></tr><tr><td>en</td><td></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="Indicator.md" target="_blank">nonProfitMeasurement/Indicator</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="Indicator.md" target="_blank">nonProfitMeasurement/Indicator</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="Indicator.md" target="_blank">nonProfitMeasurement/Indicator</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="Indicator.md" target="_blank">nonProfitMeasurement/Indicator</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="Indicator.md" target="_blank">nonProfitMeasurement/Indicator</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="Indicator.md" target="_blank">nonProfitMeasurement/Indicator</a>|
|[ownerId](#ownerId)|Owner Id|<a href="Indicator.md" target="_blank">nonProfitMeasurement/Indicator</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="Indicator.md" target="_blank">nonProfitMeasurement/Indicator</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="Indicator.md" target="_blank">nonProfitMeasurement/Indicator</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="Indicator.md" target="_blank">nonProfitMeasurement/Indicator</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="Indicator.md" target="_blank">nonProfitMeasurement/Indicator</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="Indicator.md" target="_blank">nonProfitMeasurement/Indicator</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="Indicator.md" target="_blank">nonProfitMeasurement/Indicator</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="Indicator.md" target="_blank">nonProfitMeasurement/Indicator</a>|
|[aggregationStatus](#aggregationStatus)|Indicates whether the data in the result set are suitable for aggregation|<a href="Indicator.md" target="_blank">nonProfitMeasurement/Indicator</a>|
|[ascending](#ascending)|An IATI boolean describing the behaviour of the indicator. It is “true” if the indicator improves from small to large (e.g. clinics built); false if it improves from large to small (e.g. cases of a di|<a href="Indicator.md" target="_blank">nonProfitMeasurement/Indicator</a>|
|[baselineValue](#baselineValue)|An IATI string definining the Baseline value for the value being reported.|<a href="Indicator.md" target="_blank">nonProfitMeasurement/Indicator</a>|
|[description](#description)|Description|<a href="Indicator.md" target="_blank">nonProfitMeasurement/Indicator</a>|
|[endDate](#endDate)|End date of the Indicator.|<a href="Indicator.md" target="_blank">nonProfitMeasurement/Indicator</a>|
|[indicatorId](#indicatorId)|Unique identifier for entity instances|<a href="Indicator.md" target="_blank">nonProfitMeasurement/Indicator</a>|
|[measure](#measure)|An IATI code defining the unit of measure in which the value is reported.|<a href="Indicator.md" target="_blank">nonProfitMeasurement/Indicator</a>|
|[measure_display](#measure_display)||<a href="Indicator.md" target="_blank">nonProfitMeasurement/Indicator</a>|
|[name](#name)|The name of the custom entity.|<a href="Indicator.md" target="_blank">nonProfitMeasurement/Indicator</a>|
|[resultId](#resultId)|Result|<a href="Indicator.md" target="_blank">nonProfitMeasurement/Indicator</a>|
|[startDate](#startDate)|Start Date of the Indicator|<a href="Indicator.md" target="_blank">nonProfitMeasurement/Indicator</a>|
|[stateCode](#stateCode)|Status of the Indicator|<a href="Indicator.md" target="_blank">nonProfitMeasurement/Indicator</a>|
|[stateCode_display](#stateCode_display)||<a href="Indicator.md" target="_blank">nonProfitMeasurement/Indicator</a>|
|[statusCode](#statusCode)|Reason for the status of the Indicator|<a href="Indicator.md" target="_blank">nonProfitMeasurement/Indicator</a>|
|[statusCode_display](#statusCode_display)||<a href="Indicator.md" target="_blank">nonProfitMeasurement/Indicator</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: nonProfitMeasurement/Indicator (this entity)  
...
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="Result.md" target="_blank">/core/applicationCommon/foundationCommon/crmCommon/accelerators/nonProfit/nonProfitMeasurement/Result.cdm.json/Result</a></td><td><a href="Result.md#resultId" target="_blank">resultId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
