...
- **is.identifiedBy**  
  ...
  ```
  "Designation/hasAttributes/designationId"
  ```
...
- **means.entityState**  
  ...
  ```
  "Designation/hasAttributes/stateCode"
  ```
