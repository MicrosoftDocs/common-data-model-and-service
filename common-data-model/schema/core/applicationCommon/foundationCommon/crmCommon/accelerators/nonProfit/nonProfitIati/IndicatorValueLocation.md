---
title: IndicatorValueLocation - Common Data Model | Microsoft Docs
...
Indicates the location of the indicator value  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/nonProfit/nonProfitIati/IndicatorValueLocation.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in Common Data Model entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/core/applicationCommon/foundationCommon<br>/crmCommon/accelerators/nonProfit/nonProfitIati<br>/IndicatorValueLocation.cdm.json<br>/IndicatorValueLocation/hasAttributes<br>/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[IndicatorValueLocation/(resolvedAttributes)/indicatorValueLocationId](#indicatorValueLocationId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[IndicatorValueLocation/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Indicator Value Location</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Indicates the location of the indicator value</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
  the unique name that identifies this object in Common Data Service for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msiati_indicatorvaluelocation"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="IndicatorValueLocation.md" target="_blank">nonProfitIati/IndicatorValueLocation</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="IndicatorValueLocation.md" target="_blank">nonProfitIati/IndicatorValueLocation</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="IndicatorValueLocation.md" target="_blank">nonProfitIati/IndicatorValueLocation</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="IndicatorValueLocation.md" target="_blank">nonProfitIati/IndicatorValueLocation</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="IndicatorValueLocation.md" target="_blank">nonProfitIati/IndicatorValueLocation</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="IndicatorValueLocation.md" target="_blank">nonProfitIati/IndicatorValueLocation</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="IndicatorValueLocation.md" target="_blank">nonProfitIati/IndicatorValueLocation</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="IndicatorValueLocation.md" target="_blank">nonProfitIati/IndicatorValueLocation</a>|
|[ownerId](#ownerId)|Owner Id|<a href="IndicatorValueLocation.md" target="_blank">nonProfitIati/IndicatorValueLocation</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="IndicatorValueLocation.md" target="_blank">nonProfitIati/IndicatorValueLocation</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="IndicatorValueLocation.md" target="_blank">nonProfitIati/IndicatorValueLocation</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="IndicatorValueLocation.md" target="_blank">nonProfitIati/IndicatorValueLocation</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="IndicatorValueLocation.md" target="_blank">nonProfitIati/IndicatorValueLocation</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="IndicatorValueLocation.md" target="_blank">nonProfitIati/IndicatorValueLocation</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="IndicatorValueLocation.md" target="_blank">nonProfitIati/IndicatorValueLocation</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="IndicatorValueLocation.md" target="_blank">nonProfitIati/IndicatorValueLocation</a>|
|[indicatorValue](#indicatorValue)|Unique identifier for Indicator Value associated with Indicator Value Location.|<a href="IndicatorValueLocation.md" target="_blank">nonProfitIati/IndicatorValueLocation</a>|
|[indicatorValueLocationId](#indicatorValueLocationId)|Unique identifier for entity instances|<a href="IndicatorValueLocation.md" target="_blank">nonProfitIati/IndicatorValueLocation</a>|
|[locationId](#locationId)|Unique identifier for Location associated with Indicator Value Location.|<a href="IndicatorValueLocation.md" target="_blank">nonProfitIati/IndicatorValueLocation</a>|
|[name](#name)|The name of the custom entity.|<a href="IndicatorValueLocation.md" target="_blank">nonProfitIati/IndicatorValueLocation</a>|
|[stateCode](#stateCode)|Status of the Indicator Value Location|<a href="IndicatorValueLocation.md" target="_blank">nonProfitIati/IndicatorValueLocation</a>|
|[stateCode_display](#stateCode_display)||<a href="IndicatorValueLocation.md" target="_blank">nonProfitIati/IndicatorValueLocation</a>|
|[statusCode](#statusCode)|Reason for the status of the Indicator Value Location|<a href="IndicatorValueLocation.md" target="_blank">nonProfitIati/IndicatorValueLocation</a>|
|[statusCode_display](#statusCode_display)||<a href="IndicatorValueLocation.md" target="_blank">nonProfitIati/IndicatorValueLocation</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: nonProfitIati/IndicatorValueLocation (this entity)  
...
### <a href=#indicatorValue name="indicatorValue">indicatorValue</a>

Unique identifier for Indicator Value associated with Indicator Value Location.  
First included in: nonProfitIati/IndicatorValueLocation (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Indicator Value</td></tr><tr><td>description</td><td>Unique identifier for Indicator Value associated with Indicator Value Location.</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>sourceName</td><td>msiati_indicatorvalueid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the indicatorValue attribute are listed below.</summary>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Unique identifier for Indicator Value associated with Indicator Value Location.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="IndicatorValue.md" target="_blank">/core/applicationCommon/foundationCommon/crmCommon/accelerators/nonProfit/nonProfitIati/IndicatorValue.cdm.json/IndicatorValue</a></td><td><a href="IndicatorValue.md#indicatorValueId" target="_blank">indicatorValueId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>

**is.CDS.sourceNamed**  
the unique name that identifies this object in Common Data Service for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msiati_indicatorvalueid"</td><td>string</td><td></td></tr></table>
...
### <a href=#indicatorValueLocationId name="indicatorValueLocationId">indicatorValueLocationId</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Indicator Value Location</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>sourceName</td><td>msiati_indicatorvaluelocationid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the indicatorValueLocationId attribute are listed below.</summary>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in Common Data Service for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msiati_indicatorvaluelocationid"</td><td>string</td><td></td></tr></table>
...
Unique identifier for Location associated with Indicator Value Location.  
First included in: nonProfitIati/IndicatorValueLocation (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Location</td></tr><tr><td>description</td><td>Unique identifier for Location associated with Indicator Value Location.</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>sourceName</td><td>msiati_locationid</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Unique identifier for Location associated with Indicator Value Location.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
Status of the Indicator Value Location  
First included in: nonProfitIati/IndicatorValueLocation (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Indicator Value Location</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the Indicator Value Location</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
Reason for the status of the Indicator Value Location  
First included in: nonProfitIati/IndicatorValueLocation (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Indicator Value Location</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the Indicator Value Location</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
