...
An area to which funds may be allocated, including a GL-relevant accounting code.  Designations are the way a donor instructs an organization about how their donation should be spent or earmarked.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/nonProfit/nonProfitIati/Designation.cdm.json" target="_blank">GitHub</a>.  

## Instances

Instances of this entity are listed below.  

- [/foundationCommon/crmCommon/accelerators/nonProfit/nonProfitCore/Designation](../nonProfitCore/Designation.md "/core/applicationCommon/foundationCommon/crmCommon/accelerators/nonProfit/nonProfitCore/Designation.cdm.json/Designation")  
- /crmCommon/accelerators/nonProfit/nonProfitIati/Designation  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="Designation.md" target="_blank">nonProfitIati/Designation</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="Designation.md" target="_blank">nonProfitIati/Designation</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="Designation.md" target="_blank">nonProfitIati/Designation</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="Designation.md" target="_blank">nonProfitIati/Designation</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="Designation.md" target="_blank">nonProfitIati/Designation</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="Designation.md" target="_blank">nonProfitIati/Designation</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="Designation.md" target="_blank">nonProfitIati/Designation</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="Designation.md" target="_blank">nonProfitIati/Designation</a>|
|[ownerId](#ownerId)|Owner Id|<a href="Designation.md" target="_blank">nonProfitIati/Designation</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="Designation.md" target="_blank">nonProfitIati/Designation</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="Designation.md" target="_blank">nonProfitIati/Designation</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="Designation.md" target="_blank">nonProfitIati/Designation</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="Designation.md" target="_blank">nonProfitIati/Designation</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="Designation.md" target="_blank">nonProfitIati/Designation</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="Designation.md" target="_blank">nonProfitIati/Designation</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="Designation.md" target="_blank">nonProfitIati/Designation</a>|
|[exchangeRate](#exchangeRate)|Exchange rate for the currency associated with the entity with respect to the base currency.|<a href="Designation.md" target="_blank">nonProfitIati/Designation</a>|
|[acknowledgementName](#acknowledgementName)|e.g. "Childhood hunger relief"|<a href="Designation.md" target="_blank">nonProfitIati/Designation</a>|
|[description](#description)||<a href="Designation.md" target="_blank">nonProfitIati/Designation</a>|
|[designationCode](#designationCode)||<a href="Designation.md" target="_blank">nonProfitIati/Designation</a>|
|[designationGroup](#designationGroup)||<a href="Designation.md" target="_blank">nonProfitIati/Designation</a>|
|[designationId](#designationId)|Unique identifier for entity instances|<a href="Designation.md" target="_blank">nonProfitIati/Designation</a>|
|[endDate](#endDate)||<a href="Designation.md" target="_blank">nonProfitIati/Designation</a>|
|[endowmentType](#endowmentType)||<a href="Designation.md" target="_blank">nonProfitIati/Designation</a>|
|[endowmentType_display](#endowmentType_display)||<a href="Designation.md" target="_blank">nonProfitIati/Designation</a>|
|[glCreditAccount](#glCreditAccount)||<a href="Designation.md" target="_blank">nonProfitIati/Designation</a>|
|[glDebitAccount](#glDebitAccount)||<a href="Designation.md" target="_blank">nonProfitIati/Designation</a>|
|[initiative](#initiative)||<a href="Designation.md" target="_blank">nonProfitIati/Designation</a>|
|[isActive](#isActive)||<a href="Designation.md" target="_blank">nonProfitIati/Designation</a>|
|[name](#name)||<a href="Designation.md" target="_blank">nonProfitIati/Designation</a>|
|[parentDesignationId](#parentDesignationId)|Parent Designation|<a href="Designation.md" target="_blank">nonProfitIati/Designation</a>|
|[program](#program)||<a href="Designation.md" target="_blank">nonProfitIati/Designation</a>|
|[restrictionType](#restrictionType)||<a href="Designation.md" target="_blank">nonProfitIati/Designation</a>|
|[restrictionType_display](#restrictionType_display)||<a href="Designation.md" target="_blank">nonProfitIati/Designation</a>|
|[startDate](#startDate)||<a href="Designation.md" target="_blank">nonProfitIati/Designation</a>|
|[totalDisbursed](#totalDisbursed)||<a href="Designation.md" target="_blank">nonProfitIati/Designation</a>|
|[totalDisbursed_Base](#totalDisbursed_Base)|Value of the Total Disbursed in base currency.|<a href="Designation.md" target="_blank">nonProfitIati/Designation</a>|
|[stateCode](#stateCode)|Status of the Designation|<a href="Designation.md" target="_blank">nonProfitIati/Designation</a>|
|[stateCode_display](#stateCode_display)||<a href="Designation.md" target="_blank">nonProfitIati/Designation</a>|
|[statusCode](#statusCode)|Reason for the status of the Designation|<a href="Designation.md" target="_blank">nonProfitIati/Designation</a>|
|[statusCode_display](#statusCode_display)||<a href="Designation.md" target="_blank">nonProfitIati/Designation</a>|
|[transactionCurrencyId](#transactionCurrencyId)|Unique identifier of the currency associated with the entity.|<a href="Designation.md" target="_blank">nonProfitIati/Designation</a>|
|[Name](#Name)||<a href="Designation.md" target="_blank">nonProfitIati/Designation</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: nonProfitIati/Designation (this entity)  
