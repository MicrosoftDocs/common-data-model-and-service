...
The internal assessment that a staff member (or team) makes of a request and all of the relevant information that must be tracked at the "review" stage of an application.  
...
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="Review.md" target="_blank">nonProfit/Review</a>|
