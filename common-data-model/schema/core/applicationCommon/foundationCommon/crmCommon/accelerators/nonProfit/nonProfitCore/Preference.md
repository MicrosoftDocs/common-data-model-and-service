...
Preference represents an abundance of constituent or organization information that doesn't live cleanly on an account or contact record, or that can be associated with both an Account and a Contact.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/nonProfit/nonProfitCore/Preference.cdm.json" target="_blank">GitHub</a>.  
...
- [/foundationCommon/crmCommon/accelerators/nonProfit/nonProfitForSales/Preference](../nonProfitForSales/Preference.md "/core/applicationCommon/foundationCommon/crmCommon/accelerators/nonProfit/nonProfitForSales/Preference.cdm.json/Preference")  
</details>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="Preference.md" target="_blank">nonProfitCore/Preference</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="Preference.md" target="_blank">nonProfitCore/Preference</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="Preference.md" target="_blank">nonProfitCore/Preference</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="Preference.md" target="_blank">nonProfitCore/Preference</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="Preference.md" target="_blank">nonProfitCore/Preference</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="Preference.md" target="_blank">nonProfitCore/Preference</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="Preference.md" target="_blank">nonProfitCore/Preference</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="Preference.md" target="_blank">nonProfitCore/Preference</a>|
|[ownerId](#ownerId)|Owner Id|<a href="Preference.md" target="_blank">nonProfitCore/Preference</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="Preference.md" target="_blank">nonProfitCore/Preference</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="Preference.md" target="_blank">nonProfitCore/Preference</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="Preference.md" target="_blank">nonProfitCore/Preference</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="Preference.md" target="_blank">nonProfitCore/Preference</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="Preference.md" target="_blank">nonProfitCore/Preference</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="Preference.md" target="_blank">nonProfitCore/Preference</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="Preference.md" target="_blank">nonProfitCore/Preference</a>|
|[confidence](#confidence)|Specifies the confidence that the Preference is accurate.|<a href="Preference.md" target="_blank">nonProfitCore/Preference</a>|
|[confidence_display](#confidence_display)||<a href="Preference.md" target="_blank">nonProfitCore/Preference</a>|
|[endDate](#endDate)|Indicates the date this preference ends and ceases to be valid.|<a href="Preference.md" target="_blank">nonProfitCore/Preference</a>|
|[key](#key)|The referenced Preference Key to which this record attaches a value or "true"|<a href="Preference.md" target="_blank">nonProfitCore/Preference</a>|
|[key_display](#key_display)||<a href="Preference.md" target="_blank">nonProfitCore/Preference</a>|
|[name](#name)||<a href="Preference.md" target="_blank">nonProfitCore/Preference</a>|
|[accountOrContactId](#accountOrContactId)|Unique identifier of the accountorcontact for the item.|<a href="Preference.md" target="_blank">nonProfitCore/Preference</a>|
|[type](#type)||<a href="Preference.md" target="_blank">nonProfitCore/Preference</a>|
|[preferenceId](#preferenceId)|Unique identifier for entity instances|<a href="Preference.md" target="_blank">nonProfitCore/Preference</a>|
|[priority](#priority)|A numeric priority that may be used to disambiguate multiple preference values expressed for the same key, which may have differing effective dates.|<a href="Preference.md" target="_blank">nonProfitCore/Preference</a>|
|[startDate](#startDate)|Indicates the date this preference begins.|<a href="Preference.md" target="_blank">nonProfitCore/Preference</a>|
|[value](#value)|The user-entered value that may be attached to the referenced key. If none is present, default interpretation is "true"|<a href="Preference.md" target="_blank">nonProfitCore/Preference</a>|
|[weight](#weight)|Holds an integral value that may be incremented as the preference is re-expressed or emphasized by the Customer|<a href="Preference.md" target="_blank">nonProfitCore/Preference</a>|
|[stateCode](#stateCode)|Status of the Preference|<a href="Preference.md" target="_blank">nonProfitCore/Preference</a>|
|[stateCode_display](#stateCode_display)||<a href="Preference.md" target="_blank">nonProfitCore/Preference</a>|
|[statusCode](#statusCode)|Reason for the status of the Preference|<a href="Preference.md" target="_blank">nonProfitCore/Preference</a>|
|[statusCode_display](#statusCode_display)||<a href="Preference.md" target="_blank">nonProfitCore/Preference</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: nonProfitCore/Preference (this entity)  
