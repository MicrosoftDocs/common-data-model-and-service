...
A standardised means of identifying the indicator from a code in a recognised vocabulary.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/nonProfit/nonProfitIati/IndicatorReference.cdm.json" target="_blank">GitHub</a>.  

## Instances

Instances of this entity are listed below.  

- /crmCommon/accelerators/nonProfit/nonProfitIati/IndicatorReference  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/core/applicationCommon/foundationCommon<br>/crmCommon/accelerators/nonProfit/nonProfitIati<br>/IndicatorReference.cdm.json/IndicatorReference<br>/hasAttributes/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[IndicatorReference/(resolvedAttributes)/indicatorReferenceId](#indicatorReferenceId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[IndicatorReference/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Indicator Reference</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>A standardised means of identifying the indicator from a code in a recognised vocabulary.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msiati_indicatorreference"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="IndicatorReference.md" target="_blank">nonProfitIati/IndicatorReference</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="IndicatorReference.md" target="_blank">nonProfitIati/IndicatorReference</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="IndicatorReference.md" target="_blank">nonProfitIati/IndicatorReference</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="IndicatorReference.md" target="_blank">nonProfitIati/IndicatorReference</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="IndicatorReference.md" target="_blank">nonProfitIati/IndicatorReference</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="IndicatorReference.md" target="_blank">nonProfitIati/IndicatorReference</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="IndicatorReference.md" target="_blank">nonProfitIati/IndicatorReference</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="IndicatorReference.md" target="_blank">nonProfitIati/IndicatorReference</a>|
|[ownerId](#ownerId)|Owner Id|<a href="IndicatorReference.md" target="_blank">nonProfitIati/IndicatorReference</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="IndicatorReference.md" target="_blank">nonProfitIati/IndicatorReference</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="IndicatorReference.md" target="_blank">nonProfitIati/IndicatorReference</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="IndicatorReference.md" target="_blank">nonProfitIati/IndicatorReference</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="IndicatorReference.md" target="_blank">nonProfitIati/IndicatorReference</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="IndicatorReference.md" target="_blank">nonProfitIati/IndicatorReference</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="IndicatorReference.md" target="_blank">nonProfitIati/IndicatorReference</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="IndicatorReference.md" target="_blank">nonProfitIati/IndicatorReference</a>|
|[indicatorCodeId](#indicatorCodeId)|A code for an indicator defined in the specified vocabulary specified.|<a href="IndicatorReference.md" target="_blank">nonProfitIati/IndicatorReference</a>|
|[indicatorId](#indicatorId)|Unique identifier for Indicator associated with Indicator Reference.|<a href="IndicatorReference.md" target="_blank">nonProfitIati/IndicatorReference</a>|
|[indicatorReferenceId](#indicatorReferenceId)|Unique identifier for entity instances|<a href="IndicatorReference.md" target="_blank">nonProfitIati/IndicatorReference</a>|
|[name](#name)|The name of the custom entity.|<a href="IndicatorReference.md" target="_blank">nonProfitIati/IndicatorReference</a>|
|[stateCode](#stateCode)|Status of the Indicator Reference|<a href="IndicatorReference.md" target="_blank">nonProfitIati/IndicatorReference</a>|
|[stateCode_display](#stateCode_display)||<a href="IndicatorReference.md" target="_blank">nonProfitIati/IndicatorReference</a>|
|[statusCode](#statusCode)|Reason for the status of the Indicator Reference|<a href="IndicatorReference.md" target="_blank">nonProfitIati/IndicatorReference</a>|
|[statusCode_display](#statusCode_display)||<a href="IndicatorReference.md" target="_blank">nonProfitIati/IndicatorReference</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: nonProfitIati/IndicatorReference (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Indicator Code</td></tr><tr><td>description</td><td>A code for an indicator defined in the specified vocabulary specified.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msiati_indicatorcodeid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the indicatorCodeId attribute are listed below.</summary>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Indicator Code</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>A code for an indicator defined in the specified vocabulary specified.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msiati_indicatorcodeid"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Indicator</td></tr><tr><td>description</td><td>Unique identifier for Indicator associated with Indicator Reference.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msiati_indicatorid</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Unique identifier for Indicator associated with Indicator Reference.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Indicator Reference</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msiati_indicatorreferenceid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the indicatorReferenceId attribute are listed below.</summary>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msiati_indicatorreferenceid"</td><td>string</td><td></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the Indicator Reference</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the Indicator Reference</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
