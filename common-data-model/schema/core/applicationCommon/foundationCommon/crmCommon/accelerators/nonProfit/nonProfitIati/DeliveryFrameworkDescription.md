...
A longer, human-readable description containing a meaningful description of the delivery framework  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/nonProfit/nonProfitIati/DeliveryFrameworkDescription.cdm.json" target="_blank">GitHub</a>.  

## Instances

Instances of this entity are listed below.  

- /crmCommon/accelerators/nonProfit/nonProfitIati/DeliveryFrameworkDescription  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/core/applicationCommon/foundationCommon<br>/crmCommon/accelerators/nonProfit/nonProfitIati<br>/DeliveryFrameworkDescription.cdm.json<br>/DeliveryFrameworkDescription/hasAttributes<br>/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[DeliveryFrameworkDescription/(resolvedAttributes)/deliveryFrameworkDescriptionId](#deliveryFrameworkDescriptionId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[DeliveryFrameworkDescription/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Delivery Framework Description</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>A longer, human-readable description containing a meaningful description of the delivery framework</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msiati_deliveryframeworkdescription"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="DeliveryFrameworkDescription.md" target="_blank">nonProfitIati/DeliveryFrameworkDescription</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="DeliveryFrameworkDescription.md" target="_blank">nonProfitIati/DeliveryFrameworkDescription</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="DeliveryFrameworkDescription.md" target="_blank">nonProfitIati/DeliveryFrameworkDescription</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="DeliveryFrameworkDescription.md" target="_blank">nonProfitIati/DeliveryFrameworkDescription</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="DeliveryFrameworkDescription.md" target="_blank">nonProfitIati/DeliveryFrameworkDescription</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="DeliveryFrameworkDescription.md" target="_blank">nonProfitIati/DeliveryFrameworkDescription</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="DeliveryFrameworkDescription.md" target="_blank">nonProfitIati/DeliveryFrameworkDescription</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="DeliveryFrameworkDescription.md" target="_blank">nonProfitIati/DeliveryFrameworkDescription</a>|
|[ownerId](#ownerId)|Owner Id|<a href="DeliveryFrameworkDescription.md" target="_blank">nonProfitIati/DeliveryFrameworkDescription</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="DeliveryFrameworkDescription.md" target="_blank">nonProfitIati/DeliveryFrameworkDescription</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="DeliveryFrameworkDescription.md" target="_blank">nonProfitIati/DeliveryFrameworkDescription</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="DeliveryFrameworkDescription.md" target="_blank">nonProfitIati/DeliveryFrameworkDescription</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="DeliveryFrameworkDescription.md" target="_blank">nonProfitIati/DeliveryFrameworkDescription</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="DeliveryFrameworkDescription.md" target="_blank">nonProfitIati/DeliveryFrameworkDescription</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="DeliveryFrameworkDescription.md" target="_blank">nonProfitIati/DeliveryFrameworkDescription</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="DeliveryFrameworkDescription.md" target="_blank">nonProfitIati/DeliveryFrameworkDescription</a>|
|[deliveryFrameworkDescriptionId](#deliveryFrameworkDescriptionId)|Unique identifier for entity instances|<a href="DeliveryFrameworkDescription.md" target="_blank">nonProfitIati/DeliveryFrameworkDescription</a>|
|[deliveryFrameworkId](#deliveryFrameworkId)|Unique identifier for Delivery Framework associated with Delivery Framework Description.|<a href="DeliveryFrameworkDescription.md" target="_blank">nonProfitIati/DeliveryFrameworkDescription</a>|
|[description](#description)|Description of the delivery framework|<a href="DeliveryFrameworkDescription.md" target="_blank">nonProfitIati/DeliveryFrameworkDescription</a>|
|[name](#name)|The name of the custom entity.|<a href="DeliveryFrameworkDescription.md" target="_blank">nonProfitIati/DeliveryFrameworkDescription</a>|
|[typeId](#typeId)|The type of description being provided.|<a href="DeliveryFrameworkDescription.md" target="_blank">nonProfitIati/DeliveryFrameworkDescription</a>|
|[stateCode](#stateCode)|Status of the Delivery Framework Description|<a href="DeliveryFrameworkDescription.md" target="_blank">nonProfitIati/DeliveryFrameworkDescription</a>|
|[stateCode_display](#stateCode_display)||<a href="DeliveryFrameworkDescription.md" target="_blank">nonProfitIati/DeliveryFrameworkDescription</a>|
|[statusCode](#statusCode)|Reason for the status of the Delivery Framework Description|<a href="DeliveryFrameworkDescription.md" target="_blank">nonProfitIati/DeliveryFrameworkDescription</a>|
|[statusCode_display](#statusCode_display)||<a href="DeliveryFrameworkDescription.md" target="_blank">nonProfitIati/DeliveryFrameworkDescription</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: nonProfitIati/DeliveryFrameworkDescription (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Delivery Framework Description</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msiati_deliveryframeworkdescriptionid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the deliveryFrameworkDescriptionId attribute are listed below.</summary>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msiati_deliveryframeworkdescriptionid"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Delivery Framework</td></tr><tr><td>description</td><td>Unique identifier for Delivery Framework associated with Delivery Framework Description.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msiati_deliveryframeworkid</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Unique identifier for Delivery Framework associated with Delivery Framework Description.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Description</td></tr><tr><td>description</td><td>Description of the delivery framework</td></tr><tr><td>dataFormat</td><td>7</td></tr><tr><td>maximumLength</td><td>4000</td></tr><tr><td>sourceName</td><td>msiati_description</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Description of the delivery framework</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Type</td></tr><tr><td>description</td><td>The type of description being provided.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msiati_typeid</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>The type of description being provided.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Delivery Framework Description</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the Delivery Framework Description</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Delivery Framework Description</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the Delivery Framework Description</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
