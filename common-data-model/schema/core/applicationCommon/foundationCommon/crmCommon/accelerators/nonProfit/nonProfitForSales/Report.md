...
Reports represent information submitted by an awardee to the awarding entity (i.e., a Foundation) or information submitted by an authorized awarding entity individual/entity about an awardee.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/nonProfit/nonProfitForSales/Report.cdm.json" target="_blank">GitHub</a>.  

## Instances

Instances of this entity are listed below.  

- [/foundationCommon/crmCommon/accelerators/nonProfit/nonProfitCore/Report](../nonProfitCore/Report.md "/core/applicationCommon/foundationCommon/crmCommon/accelerators/nonProfit/nonProfitCore/Report.cdm.json/Report")  
- /crmCommon/accelerators/nonProfit/nonProfitForSales/Report  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="Report.md" target="_blank">nonProfitForSales/Report</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="Report.md" target="_blank">nonProfitForSales/Report</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="Report.md" target="_blank">nonProfitForSales/Report</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="Report.md" target="_blank">nonProfitForSales/Report</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="Report.md" target="_blank">nonProfitForSales/Report</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="Report.md" target="_blank">nonProfitForSales/Report</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="Report.md" target="_blank">nonProfitForSales/Report</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="Report.md" target="_blank">nonProfitForSales/Report</a>|
|[ownerId](#ownerId)|Owner Id|<a href="Report.md" target="_blank">nonProfitForSales/Report</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="Report.md" target="_blank">nonProfitForSales/Report</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="Report.md" target="_blank">nonProfitForSales/Report</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="Report.md" target="_blank">nonProfitForSales/Report</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="Report.md" target="_blank">nonProfitForSales/Report</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="Report.md" target="_blank">nonProfitForSales/Report</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="Report.md" target="_blank">nonProfitForSales/Report</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="Report.md" target="_blank">nonProfitForSales/Report</a>|
|[awardId](#awardId)|Award|<a href="Report.md" target="_blank">nonProfitForSales/Report</a>|
|[awardVersionId](#awardVersionId)|Award Version|<a href="Report.md" target="_blank">nonProfitForSales/Report</a>|
|[description](#description)|Description of the Report.|<a href="Report.md" target="_blank">nonProfitForSales/Report</a>|
|[dueDate](#dueDate)|Date Report is due.|<a href="Report.md" target="_blank">nonProfitForSales/Report</a>|
|[name](#name)||<a href="Report.md" target="_blank">nonProfitForSales/Report</a>|
|[primaryContactId](#primaryContactId)|Unique identifier for Contact associated with Report.|<a href="Report.md" target="_blank">nonProfitForSales/Report</a>|
|[report_AccountId](#report_AccountId)|Account|<a href="Report.md" target="_blank">nonProfitForSales/Report</a>|
|[report_SubmittedById](#report_SubmittedById)|Unique identifier for Contact associated with Report.|<a href="Report.md" target="_blank">nonProfitForSales/Report</a>|
|[reportId](#reportId)|Unique identifier for entity instances|<a href="Report.md" target="_blank">nonProfitForSales/Report</a>|
|[requestId](#requestId)|Request|<a href="Report.md" target="_blank">nonProfitForSales/Report</a>|
|[status](#status)|Status of the Report.|<a href="Report.md" target="_blank">nonProfitForSales/Report</a>|
|[status_display](#status_display)||<a href="Report.md" target="_blank">nonProfitForSales/Report</a>|
|[submittedDate](#submittedDate)|Date Report was submitted.|<a href="Report.md" target="_blank">nonProfitForSales/Report</a>|
|[type](#type)|Type of Report.|<a href="Report.md" target="_blank">nonProfitForSales/Report</a>|
|[type_display](#type_display)||<a href="Report.md" target="_blank">nonProfitForSales/Report</a>|
|[stateCode](#stateCode)|Status of the Report|<a href="Report.md" target="_blank">nonProfitForSales/Report</a>|
|[stateCode_display](#stateCode_display)||<a href="Report.md" target="_blank">nonProfitForSales/Report</a>|
|[statusCode](#statusCode)|Reason for the status of the Report|<a href="Report.md" target="_blank">nonProfitForSales/Report</a>|
|[statusCode_display](#statusCode_display)||<a href="Report.md" target="_blank">nonProfitForSales/Report</a>|
|[report_LeadId](#report_LeadId)|Lead|<a href="Report.md" target="_blank">nonProfitForSales/Report</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: nonProfitForSales/Report (this entity)  
...
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="../nonProfitCore/AwardVersion.md" target="_blank">/core/applicationCommon/foundationCommon/crmCommon/accelerators/nonProfit/nonProfitCore/AwardVersion.cdm.json/AwardVersion</a></td><td><a href="../nonProfitCore/AwardVersion.md#awardVersionId" target="_blank">awardVersionId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
...
### <a href=#report_LeadId name="report_LeadId">report_LeadId</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Lead</td></tr><tr><td>description</td><td>Lead</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msnfp_report_leadid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the report_LeadId attribute are listed below.</summary>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msnfp_report_leadid"</td><td>string</td><td></td></tr></table>
