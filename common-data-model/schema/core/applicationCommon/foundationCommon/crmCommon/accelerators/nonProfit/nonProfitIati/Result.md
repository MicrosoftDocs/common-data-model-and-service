---
title: Result in nonProfitIati - Common Data Model | Microsoft Docs
...
# Result in nonProfitIati

A Result is a container that represents the changes in the context in which an organization operates..  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/nonProfit/nonProfitIati/Result.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="Result.md" target="_blank">nonProfitIati/Result</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="Result.md" target="_blank">nonProfitIati/Result</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="Result.md" target="_blank">nonProfitIati/Result</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="Result.md" target="_blank">nonProfitIati/Result</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="Result.md" target="_blank">nonProfitIati/Result</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="Result.md" target="_blank">nonProfitIati/Result</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="Result.md" target="_blank">nonProfitIati/Result</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="Result.md" target="_blank">nonProfitIati/Result</a>|
|[ownerId](#ownerId)|Owner Id|<a href="Result.md" target="_blank">nonProfitIati/Result</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="Result.md" target="_blank">nonProfitIati/Result</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="Result.md" target="_blank">nonProfitIati/Result</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="Result.md" target="_blank">nonProfitIati/Result</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="Result.md" target="_blank">nonProfitIati/Result</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="Result.md" target="_blank">nonProfitIati/Result</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="Result.md" target="_blank">nonProfitIati/Result</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="Result.md" target="_blank">nonProfitIati/Result</a>|
|[aggregationStatus](#aggregationStatus)|Indicates whether the data in the result set are suitable for aggregation|<a href="Result.md" target="_blank">nonProfitIati/Result</a>|
|[deliveryFrameworkId](#deliveryFrameworkId)||<a href="Result.md" target="_blank">nonProfitIati/Result</a>|
|[description](#description)|Description|<a href="Result.md" target="_blank">nonProfitIati/Result</a>|
|[endDate](#endDate)|End Date of the result|<a href="Result.md" target="_blank">nonProfitIati/Result</a>|
|[name](#name)|The name of the custom entity.|<a href="Result.md" target="_blank">nonProfitIati/Result</a>|
|[parentResultId](#parentResultId)|This field contains the unique identifier for the parent result. |<a href="Result.md" target="_blank">nonProfitIati/Result</a>|
|[resultId](#resultId)|Unique identifier for entity instances|<a href="Result.md" target="_blank">nonProfitIati/Result</a>|
|[resultType](#resultType)|The type of result being recorded.|<a href="Result.md" target="_blank">nonProfitIati/Result</a>|
|[resultType_display](#resultType_display)||<a href="Result.md" target="_blank">nonProfitIati/Result</a>|
|[startDate](#startDate)|Start Date of the result|<a href="Result.md" target="_blank">nonProfitIati/Result</a>|
|[stateCode](#stateCode)|Status of the Result|<a href="Result.md" target="_blank">nonProfitIati/Result</a>|
|[stateCode_display](#stateCode_display)||<a href="Result.md" target="_blank">nonProfitIati/Result</a>|
|[statusCode](#statusCode)|Reason for the status of the Result|<a href="Result.md" target="_blank">nonProfitIati/Result</a>|
|[statusCode_display](#statusCode_display)||<a href="Result.md" target="_blank">nonProfitIati/Result</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: nonProfitIati/Result (this entity)  
