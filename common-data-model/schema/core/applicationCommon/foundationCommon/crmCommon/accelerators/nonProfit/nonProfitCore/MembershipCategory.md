...
Represents the types of membership associated to products.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/nonProfit/nonProfitCore/MembershipCategory.cdm.json" target="_blank">GitHub</a>.  

## Instances

Instances of this entity are listed below.  

- /crmCommon/accelerators/nonProfit/nonProfitCore/MembershipCategory  
- [/foundationCommon/crmCommon/accelerators/nonProfit/nonProfitIati/MembershipCategory](../nonProfitIati/MembershipCategory.md "/core/applicationCommon/foundationCommon/crmCommon/accelerators/nonProfit/nonProfitIati/MembershipCategory.cdm.json/MembershipCategory")  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="MembershipCategory.md" target="_blank">nonProfitCore/MembershipCategory</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="MembershipCategory.md" target="_blank">nonProfitCore/MembershipCategory</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="MembershipCategory.md" target="_blank">nonProfitCore/MembershipCategory</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="MembershipCategory.md" target="_blank">nonProfitCore/MembershipCategory</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="MembershipCategory.md" target="_blank">nonProfitCore/MembershipCategory</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="MembershipCategory.md" target="_blank">nonProfitCore/MembershipCategory</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="MembershipCategory.md" target="_blank">nonProfitCore/MembershipCategory</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="MembershipCategory.md" target="_blank">nonProfitCore/MembershipCategory</a>|
|[ownerId](#ownerId)|Owner Id|<a href="MembershipCategory.md" target="_blank">nonProfitCore/MembershipCategory</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="MembershipCategory.md" target="_blank">nonProfitCore/MembershipCategory</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="MembershipCategory.md" target="_blank">nonProfitCore/MembershipCategory</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="MembershipCategory.md" target="_blank">nonProfitCore/MembershipCategory</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="MembershipCategory.md" target="_blank">nonProfitCore/MembershipCategory</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="MembershipCategory.md" target="_blank">nonProfitCore/MembershipCategory</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="MembershipCategory.md" target="_blank">nonProfitCore/MembershipCategory</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="MembershipCategory.md" target="_blank">nonProfitCore/MembershipCategory</a>|
|[membershipCategoryId](#membershipCategoryId)|Unique identifier for entity instances|<a href="MembershipCategory.md" target="_blank">nonProfitCore/MembershipCategory</a>|
|[name](#name)|The name of the custom entity.|<a href="MembershipCategory.md" target="_blank">nonProfitCore/MembershipCategory</a>|
|[type](#type)|Membership type|<a href="MembershipCategory.md" target="_blank">nonProfitCore/MembershipCategory</a>|
|[type_display](#type_display)||<a href="MembershipCategory.md" target="_blank">nonProfitCore/MembershipCategory</a>|
|[stateCode](#stateCode)|Status of the Membership Category|<a href="MembershipCategory.md" target="_blank">nonProfitCore/MembershipCategory</a>|
|[stateCode_display](#stateCode_display)||<a href="MembershipCategory.md" target="_blank">nonProfitCore/MembershipCategory</a>|
|[statusCode](#statusCode)|Reason for the status of the Membership Category|<a href="MembershipCategory.md" target="_blank">nonProfitCore/MembershipCategory</a>|
|[statusCode_display](#statusCode_display)||<a href="MembershipCategory.md" target="_blank">nonProfitCore/MembershipCategory</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: nonProfitCore/MembershipCategory (this entity)  
