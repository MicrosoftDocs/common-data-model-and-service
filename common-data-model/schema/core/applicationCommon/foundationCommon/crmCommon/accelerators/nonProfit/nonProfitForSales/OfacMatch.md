...
OFAC Match is a placeholder entity for tracking Office of Foreign Assets Control (OFAC) Specially Designated Naturals (SDN) searches and results.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/nonProfit/nonProfitForSales/OfacMatch.cdm.json" target="_blank">GitHub</a>.  

## Instances

Instances of this entity are listed below.  

- [/foundationCommon/crmCommon/accelerators/nonProfit/nonProfitCore/OfacMatch](../nonProfitCore/OfacMatch.md "/core/applicationCommon/foundationCommon/crmCommon/accelerators/nonProfit/nonProfitCore/OfacMatch.cdm.json/OfacMatch")  
- /crmCommon/accelerators/nonProfit/nonProfitForSales/OfacMatch  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="OfacMatch.md" target="_blank">nonProfitForSales/OfacMatch</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="OfacMatch.md" target="_blank">nonProfitForSales/OfacMatch</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="OfacMatch.md" target="_blank">nonProfitForSales/OfacMatch</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="OfacMatch.md" target="_blank">nonProfitForSales/OfacMatch</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="OfacMatch.md" target="_blank">nonProfitForSales/OfacMatch</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="OfacMatch.md" target="_blank">nonProfitForSales/OfacMatch</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="OfacMatch.md" target="_blank">nonProfitForSales/OfacMatch</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="OfacMatch.md" target="_blank">nonProfitForSales/OfacMatch</a>|
|[ownerId](#ownerId)|Owner Id|<a href="OfacMatch.md" target="_blank">nonProfitForSales/OfacMatch</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="OfacMatch.md" target="_blank">nonProfitForSales/OfacMatch</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="OfacMatch.md" target="_blank">nonProfitForSales/OfacMatch</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="OfacMatch.md" target="_blank">nonProfitForSales/OfacMatch</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="OfacMatch.md" target="_blank">nonProfitForSales/OfacMatch</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="OfacMatch.md" target="_blank">nonProfitForSales/OfacMatch</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="OfacMatch.md" target="_blank">nonProfitForSales/OfacMatch</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="OfacMatch.md" target="_blank">nonProfitForSales/OfacMatch</a>|
|[matchType](#matchType)|Indicates if a match exists.|<a href="OfacMatch.md" target="_blank">nonProfitForSales/OfacMatch</a>|
|[name](#name)||<a href="OfacMatch.md" target="_blank">nonProfitForSales/OfacMatch</a>|
|[ofacMatch_CustomerId](#ofacMatch_CustomerId)|Unique identifier of the ofacmatch_customer for the item.|<a href="OfacMatch.md" target="_blank">nonProfitForSales/OfacMatch</a>|
|[type](#type)||<a href="OfacMatch.md" target="_blank">nonProfitForSales/OfacMatch</a>|
|[OFACMatchId](#OFACMatchId)|Unique identifier for entity instances|<a href="OfacMatch.md" target="_blank">nonProfitForSales/OfacMatch</a>|
|[reportDate](#reportDate)|The Date that the OFAC Report was retrieved|<a href="OfacMatch.md" target="_blank">nonProfitForSales/OfacMatch</a>|
|[requestId](#requestId)|Request|<a href="OfacMatch.md" target="_blank">nonProfitForSales/OfacMatch</a>|
|[SDNName](#SDNName)|Name of SDN match.|<a href="OfacMatch.md" target="_blank">nonProfitForSales/OfacMatch</a>|
|[SDNNumber](#SDNNumber)|Number of SDN match.|<a href="OfacMatch.md" target="_blank">nonProfitForSales/OfacMatch</a>|
|[title](#title)|Title of SDN match.|<a href="OfacMatch.md" target="_blank">nonProfitForSales/OfacMatch</a>|
|[stateCode](#stateCode)|Status of the OFAC Match|<a href="OfacMatch.md" target="_blank">nonProfitForSales/OfacMatch</a>|
|[stateCode_display](#stateCode_display)||<a href="OfacMatch.md" target="_blank">nonProfitForSales/OfacMatch</a>|
|[statusCode](#statusCode)|Reason for the status of the OFAC Match|<a href="OfacMatch.md" target="_blank">nonProfitForSales/OfacMatch</a>|
|[statusCode_display](#statusCode_display)||<a href="OfacMatch.md" target="_blank">nonProfitForSales/OfacMatch</a>|
|[inquiryId](#inquiryId)|Inquiry / Lead|<a href="OfacMatch.md" target="_blank">nonProfitForSales/OfacMatch</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: nonProfitForSales/OfacMatch (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Inquiry / Lead</td></tr><tr><td>description</td><td>Inquiry / Lead</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msnfp_inquiryid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the inquiryId attribute are listed below.</summary>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Inquiry / Lead</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msnfp_inquiryid"</td><td>string</td><td></td></tr></table>
