...
- **is.identifiedBy**  
  ...
  ```
  "DeliveryFramework/hasAttributes/deliveryFrameworkId"
  ```
...
- **means.entityState**  
  ...
  ```
  "DeliveryFramework/hasAttributes/stateCode"
  ```
