...
# Result
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/nonProfit/nonProfitMeasurement/Result.cdm.json" target="_blank">GitHub</a>.  
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>A Result is a container that represents the changes in the context in which an organization operates..</td></tr><tr><td>en</td><td></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="Result.md" target="_blank">nonProfitMeasurement/Result</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="Result.md" target="_blank">nonProfitMeasurement/Result</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="Result.md" target="_blank">nonProfitMeasurement/Result</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="Result.md" target="_blank">nonProfitMeasurement/Result</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="Result.md" target="_blank">nonProfitMeasurement/Result</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="Result.md" target="_blank">nonProfitMeasurement/Result</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="Result.md" target="_blank">nonProfitMeasurement/Result</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="Result.md" target="_blank">nonProfitMeasurement/Result</a>|
|[ownerId](#ownerId)|Owner Id|<a href="Result.md" target="_blank">nonProfitMeasurement/Result</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="Result.md" target="_blank">nonProfitMeasurement/Result</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="Result.md" target="_blank">nonProfitMeasurement/Result</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="Result.md" target="_blank">nonProfitMeasurement/Result</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="Result.md" target="_blank">nonProfitMeasurement/Result</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="Result.md" target="_blank">nonProfitMeasurement/Result</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="Result.md" target="_blank">nonProfitMeasurement/Result</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="Result.md" target="_blank">nonProfitMeasurement/Result</a>|
|[aggregationStatus](#aggregationStatus)|Indicates whether the data in the result set are suitable for aggregation|<a href="Result.md" target="_blank">nonProfitMeasurement/Result</a>|
|[deliveryFrameworkId](#deliveryFrameworkId)||<a href="Result.md" target="_blank">nonProfitMeasurement/Result</a>|
|[description](#description)|Description|<a href="Result.md" target="_blank">nonProfitMeasurement/Result</a>|
...
|[stateCode_display](#stateCode_display)||<a href="Result.md" target="_blank">nonProfitMeasurement/Result</a>|
|[statusCode](#statusCode)|Reason for the status of the Result|<a href="Result.md" target="_blank">nonProfitMeasurement/Result</a>|
|[statusCode_display](#statusCode_display)||<a href="Result.md" target="_blank">nonProfitMeasurement/Result</a>|
|[parentResultId](#parentResultId)|This field contains the unique identifier for the parent result. |<a href="Result.md" target="_blank">nonProfitMeasurement/Result</a>|
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Parent Result</td></tr><tr><td>description</td><td>This field contains the unique identifier for the parent result. </td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msnfp_parentresultid</td></tr></table>
