...
- **is.identifiedBy**  
  ...
  ```
  "DesignationPlan/hasAttributes/designationPlanId"
  ```
...
- **means.entityState**  
  ...
  ```
  "DesignationPlan/hasAttributes/stateCode"
  ```
