...
An Objective represents the organization's highest priorities, strategies and/or goals that guide investments (in the case of Requests and Awards) and program delivery.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/nonProfit/nonProfitIati/Objective.cdm.json" target="_blank">GitHub</a>.  

## Instances

Instances of this entity are listed below.  

- [/foundationCommon/crmCommon/accelerators/nonProfit/nonProfitCore/Objective](../nonProfitCore/Objective.md "/core/applicationCommon/foundationCommon/crmCommon/accelerators/nonProfit/nonProfitCore/Objective.cdm.json/Objective")  
- /crmCommon/accelerators/nonProfit/nonProfitIati/Objective  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="Objective.md" target="_blank">nonProfitIati/Objective</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="Objective.md" target="_blank">nonProfitIati/Objective</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="Objective.md" target="_blank">nonProfitIati/Objective</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="Objective.md" target="_blank">nonProfitIati/Objective</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="Objective.md" target="_blank">nonProfitIati/Objective</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="Objective.md" target="_blank">nonProfitIati/Objective</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="Objective.md" target="_blank">nonProfitIati/Objective</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="Objective.md" target="_blank">nonProfitIati/Objective</a>|
|[ownerId](#ownerId)|Owner Id|<a href="Objective.md" target="_blank">nonProfitIati/Objective</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="Objective.md" target="_blank">nonProfitIati/Objective</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="Objective.md" target="_blank">nonProfitIati/Objective</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="Objective.md" target="_blank">nonProfitIati/Objective</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="Objective.md" target="_blank">nonProfitIati/Objective</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="Objective.md" target="_blank">nonProfitIati/Objective</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="Objective.md" target="_blank">nonProfitIati/Objective</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="Objective.md" target="_blank">nonProfitIati/Objective</a>|
|[description](#description)|Description of the Objective.|<a href="Objective.md" target="_blank">nonProfitIati/Objective</a>|
|[endDate](#endDate)|End date of the objective|<a href="Objective.md" target="_blank">nonProfitIati/Objective</a>|
|[name](#name)||<a href="Objective.md" target="_blank">nonProfitIati/Objective</a>|
|[objective_AccountId](#objective_AccountId)|Account|<a href="Objective.md" target="_blank">nonProfitIati/Objective</a>|
|[objectiveId](#objectiveId)|Unique identifier for entity instances|<a href="Objective.md" target="_blank">nonProfitIati/Objective</a>|
|[objectiveType](#objectiveType)|Indicates the type of Objective.|<a href="Objective.md" target="_blank">nonProfitIati/Objective</a>|
|[objectiveType_display](#objectiveType_display)||<a href="Objective.md" target="_blank">nonProfitIati/Objective</a>|
|[parentObjectiveId](#parentObjectiveId)|Parent Objective|<a href="Objective.md" target="_blank">nonProfitIati/Objective</a>|
|[startDate](#startDate)|Start date off the objective|<a href="Objective.md" target="_blank">nonProfitIati/Objective</a>|
|[stateCode](#stateCode)|Status of the Objective|<a href="Objective.md" target="_blank">nonProfitIati/Objective</a>|
|[stateCode_display](#stateCode_display)||<a href="Objective.md" target="_blank">nonProfitIati/Objective</a>|
|[statusCode](#statusCode)|Reason for the status of the Objective|<a href="Objective.md" target="_blank">nonProfitIati/Objective</a>|
|[statusCode_display](#statusCode_display)||<a href="Objective.md" target="_blank">nonProfitIati/Objective</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: nonProfitIati/Objective (this entity)  
