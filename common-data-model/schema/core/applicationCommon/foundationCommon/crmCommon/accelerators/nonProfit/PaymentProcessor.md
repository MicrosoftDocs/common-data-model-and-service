...
- **is.identifiedBy**  
  ...
  ```
  "PaymentProcessor/hasAttributes/paymentProcessorId"
  ```
...
- **means.entityState**  
  ...
  ```
  "PaymentProcessor/hasAttributes/stateCode"
  ```
