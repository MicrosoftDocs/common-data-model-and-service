...
A placeholder entity that the Payment Method object references.  This entity is intended to be customized with configuration data necessary to connect to a payment processor and authorize payments.  
...
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="PaymentProcessor.md" target="_blank">nonProfit/PaymentProcessor</a>|
