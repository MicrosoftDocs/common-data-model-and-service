---
title: TheoryOfChange - Common Data Model | Microsoft Docs
...
Theories of Change are hypotheses for achieving a desired social impact and are comprised of a sequence of cause-and-effect actions or occurrences.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/nonProfit/nonProfitCore/TheoryOfChange.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/core/applicationCommon/foundationCommon<br>/crmCommon/accelerators/nonProfit/nonProfitCore<br>/TheoryOfChange.cdm.json/TheoryOfChange<br>/hasAttributes/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[TheoryOfChange/(resolvedAttributes)/theoryOfChangeId](#theoryOfChangeId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[TheoryOfChange/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Theories of Change are hypotheses for achieving a desired social impact and are comprised of a sequence of cause-and-effect actions or occurrences.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msnfp_theoryofchange"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="TheoryOfChange.md" target="_blank">nonProfitCore/TheoryOfChange</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="TheoryOfChange.md" target="_blank">nonProfitCore/TheoryOfChange</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="TheoryOfChange.md" target="_blank">nonProfitCore/TheoryOfChange</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="TheoryOfChange.md" target="_blank">nonProfitCore/TheoryOfChange</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="TheoryOfChange.md" target="_blank">nonProfitCore/TheoryOfChange</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="TheoryOfChange.md" target="_blank">nonProfitCore/TheoryOfChange</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="TheoryOfChange.md" target="_blank">nonProfitCore/TheoryOfChange</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="TheoryOfChange.md" target="_blank">nonProfitCore/TheoryOfChange</a>|
|[ownerId](#ownerId)|Owner Id|<a href="TheoryOfChange.md" target="_blank">nonProfitCore/TheoryOfChange</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="TheoryOfChange.md" target="_blank">nonProfitCore/TheoryOfChange</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="TheoryOfChange.md" target="_blank">nonProfitCore/TheoryOfChange</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="TheoryOfChange.md" target="_blank">nonProfitCore/TheoryOfChange</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="TheoryOfChange.md" target="_blank">nonProfitCore/TheoryOfChange</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="TheoryOfChange.md" target="_blank">nonProfitCore/TheoryOfChange</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="TheoryOfChange.md" target="_blank">nonProfitCore/TheoryOfChange</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="TheoryOfChange.md" target="_blank">nonProfitCore/TheoryOfChange</a>|
|[description](#description)|Description of the theory of change.|<a href="TheoryOfChange.md" target="_blank">nonProfitCore/TheoryOfChange</a>|
|[name](#name)|The name of the custom entity.|<a href="TheoryOfChange.md" target="_blank">nonProfitCore/TheoryOfChange</a>|
|[parentTheoryOfChangeId](#parentTheoryOfChangeId)|The parent Theory Of Change associated with this Theory of Change to show parent and child records.|<a href="TheoryOfChange.md" target="_blank">nonProfitCore/TheoryOfChange</a>|
|[theoryOfChangeId](#theoryOfChangeId)|Unique identifier for entity instances|<a href="TheoryOfChange.md" target="_blank">nonProfitCore/TheoryOfChange</a>|
|[type](#type)|Type of theory of change.|<a href="TheoryOfChange.md" target="_blank">nonProfitCore/TheoryOfChange</a>|
|[type_display](#type_display)||<a href="TheoryOfChange.md" target="_blank">nonProfitCore/TheoryOfChange</a>|
|[stateCode](#stateCode)|Status of the Theory of Change|<a href="TheoryOfChange.md" target="_blank">nonProfitCore/TheoryOfChange</a>|
|[stateCode_display](#stateCode_display)||<a href="TheoryOfChange.md" target="_blank">nonProfitCore/TheoryOfChange</a>|
|[statusCode](#statusCode)|Reason for the status of the Theory of Change|<a href="TheoryOfChange.md" target="_blank">nonProfitCore/TheoryOfChange</a>|
|[statusCode_display](#statusCode_display)||<a href="TheoryOfChange.md" target="_blank">nonProfitCore/TheoryOfChange</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: nonProfitCore/TheoryOfChange (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Description</td></tr><tr><td>description</td><td>Description of the theory of change.</td></tr><tr><td>dataFormat</td><td>7</td></tr><tr><td>maximumLength</td><td>2000</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msnfp_description</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Description of the theory of change.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
### <a href=#parentTheoryOfChangeId name="parentTheoryOfChangeId">parentTheoryOfChangeId</a>

The parent Theory Of Change associated with this Theory of Change to show parent and child records.  
First included in: nonProfitCore/TheoryOfChange (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Parent Theory of Change</td></tr><tr><td>description</td><td>The parent Theory Of Change associated with this Theory of Change to show parent and child records.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msnfp_parenttheoryofchangeid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the parentTheoryOfChangeId attribute are listed below.</summary>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Parent Theory of Change</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>The parent Theory Of Change associated with this Theory of Change to show parent and child records.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msnfp_parenttheoryofchangeid"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Theory of Change</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msnfp_theoryofchangeid</td></tr></table>
...
Type of theory of change.  
First included in: nonProfitCore/TheoryOfChange (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Type</td></tr><tr><td>description</td><td>Type of theory of change.</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msnfp_type</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr></tr><tr></tr><tr></tr><tr></tr><tr></tr></table></td></tr></table>
...
**is.dataFormat.integer**  
**does.haveDefault**  
An attribute has a default value  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>default</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>System</td><td>844060000</td></tr><tr><td>en</td><td>Organization</td><td>844060001</td></tr><tr><td>en</td><td>Program</td><td>844060002</td></tr><tr><td>en</td><td>Project</td><td>844060003</td></tr></table></td><td>any</td><td></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Type of theory of change.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
Status of the Theory of Change  
First included in: nonProfitCore/TheoryOfChange (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Theory of Change</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the Theory of Change</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the Theory of Change</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
