...
A web address.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/nonProfit/nonProfitIati/Website.cdm.json" target="_blank">GitHub</a>.  
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>A web address.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
  the unique name that identifies this object in Common Data Service for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msiati_website"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="Website.md" target="_blank">nonProfitIati/Website</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="Website.md" target="_blank">nonProfitIati/Website</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="Website.md" target="_blank">nonProfitIati/Website</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="Website.md" target="_blank">nonProfitIati/Website</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="Website.md" target="_blank">nonProfitIati/Website</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="Website.md" target="_blank">nonProfitIati/Website</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="Website.md" target="_blank">nonProfitIati/Website</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="Website.md" target="_blank">nonProfitIati/Website</a>|
|[ownerId](#ownerId)|Owner Id|<a href="Website.md" target="_blank">nonProfitIati/Website</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="Website.md" target="_blank">nonProfitIati/Website</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="Website.md" target="_blank">nonProfitIati/Website</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="Website.md" target="_blank">nonProfitIati/Website</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="Website.md" target="_blank">nonProfitIati/Website</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="Website.md" target="_blank">nonProfitIati/Website</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="Website.md" target="_blank">nonProfitIati/Website</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="Website.md" target="_blank">nonProfitIati/Website</a>|
|[contactId](#contactId)|Unique identifier for Contact associated with Website.|<a href="Website.md" target="_blank">nonProfitIati/Website</a>|
|[name](#name)|The name of the custom entity.|<a href="Website.md" target="_blank">nonProfitIati/Website</a>|
|[url](#url)|The website's URL.|<a href="Website.md" target="_blank">nonProfitIati/Website</a>|
|[websiteId](#websiteId)|Unique identifier for entity instances|<a href="Website.md" target="_blank">nonProfitIati/Website</a>|
|[stateCode](#stateCode)|Status of the Website|<a href="Website.md" target="_blank">nonProfitIati/Website</a>|
|[stateCode_display](#stateCode_display)||<a href="Website.md" target="_blank">nonProfitIati/Website</a>|
|[statusCode](#statusCode)|Reason for the status of the Website|<a href="Website.md" target="_blank">nonProfitIati/Website</a>|
|[statusCode_display](#statusCode_display)||<a href="Website.md" target="_blank">nonProfitIati/Website</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: nonProfitIati/Website (this entity)  
...
Unique identifier for Contact associated with Website.  
First included in: nonProfitIati/Website (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Contact</td></tr><tr><td>description</td><td>Unique identifier for Contact associated with Website.</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>sourceName</td><td>msiati_contactid</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Unique identifier for Contact associated with Website.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>URL</td></tr><tr><td>description</td><td>The website's URL.</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>250</td></tr><tr><td>sourceName</td><td>msiati_url</td></tr></table>
...
**means.reference.URL**  
**is.CDS.sourceNamed**  
the unique name that identifies this object in Common Data Service for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msiati_url"</td><td>string</td><td></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>The website's URL.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Website</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>sourceName</td><td>msiati_websiteid</td></tr></table>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in Common Data Service for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msiati_websiteid"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Website</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the Website</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
