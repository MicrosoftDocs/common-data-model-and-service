---
title: DonorCommitment in nonProfitCore - Common Data Model | Microsoft Docs
...
# Donor Commitment in nonProfitCore
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="DonorCommitment.md" target="_blank">nonProfitCore/DonorCommitment</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="DonorCommitment.md" target="_blank">nonProfitCore/DonorCommitment</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="DonorCommitment.md" target="_blank">nonProfitCore/DonorCommitment</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="DonorCommitment.md" target="_blank">nonProfitCore/DonorCommitment</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="DonorCommitment.md" target="_blank">nonProfitCore/DonorCommitment</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="DonorCommitment.md" target="_blank">nonProfitCore/DonorCommitment</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="DonorCommitment.md" target="_blank">nonProfitCore/DonorCommitment</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="DonorCommitment.md" target="_blank">nonProfitCore/DonorCommitment</a>|
|[ownerId](#ownerId)|Owner Id|<a href="DonorCommitment.md" target="_blank">nonProfitCore/DonorCommitment</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="DonorCommitment.md" target="_blank">nonProfitCore/DonorCommitment</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="DonorCommitment.md" target="_blank">nonProfitCore/DonorCommitment</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="DonorCommitment.md" target="_blank">nonProfitCore/DonorCommitment</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="DonorCommitment.md" target="_blank">nonProfitCore/DonorCommitment</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="DonorCommitment.md" target="_blank">nonProfitCore/DonorCommitment</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="DonorCommitment.md" target="_blank">nonProfitCore/DonorCommitment</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="DonorCommitment.md" target="_blank">nonProfitCore/DonorCommitment</a>|
|[exchangeRate](#exchangeRate)|Exchange rate for the currency associated with the entity with respect to the base currency.|<a href="DonorCommitment.md" target="_blank">nonProfitCore/DonorCommitment</a>|
|[anonymity](#anonymity)||<a href="DonorCommitment.md" target="_blank">nonProfitCore/DonorCommitment</a>|
|[anonymity_display](#anonymity_display)||<a href="DonorCommitment.md" target="_blank">nonProfitCore/DonorCommitment</a>|
|[bookDate](#bookDate)|The date on which revenue will be recognized|<a href="DonorCommitment.md" target="_blank">nonProfitCore/DonorCommitment</a>|
|[commitmentDefaultDesignationId](#commitmentDefaultDesignationId)|Default Designation|<a href="DonorCommitment.md" target="_blank">nonProfitCore/DonorCommitment</a>|
|[commitmentDate](#commitmentDate)|This is the date that the donor made the commitment, not necessarily the date that the commitment was entered into the system.|<a href="DonorCommitment.md" target="_blank">nonProfitCore/DonorCommitment</a>|
|[commitmentType](#commitmentType)||<a href="DonorCommitment.md" target="_blank">nonProfitCore/DonorCommitment</a>|
|[commitmentType_display](#commitmentType_display)||<a href="DonorCommitment.md" target="_blank">nonProfitCore/DonorCommitment</a>|
|[dataEntryReference](#dataEntryReference)||<a href="DonorCommitment.md" target="_blank">nonProfitCore/DonorCommitment</a>|
|[dataEntrySource](#dataEntrySource)||<a href="DonorCommitment.md" target="_blank">nonProfitCore/DonorCommitment</a>|
|[dataEntrySource_display](#dataEntrySource_display)||<a href="DonorCommitment.md" target="_blank">nonProfitCore/DonorCommitment</a>|
|[donorCommitmentPlannedGivingId](#donorCommitmentPlannedGivingId)|Planned Giving|<a href="DonorCommitment.md" target="_blank">nonProfitCore/DonorCommitment</a>|
|[donorCommitmentId](#donorCommitmentId)|Unique identifier for entity instances|<a href="DonorCommitment.md" target="_blank">nonProfitCore/DonorCommitment</a>|
|[expectedByDate](#expectedByDate)||<a href="DonorCommitment.md" target="_blank">nonProfitCore/DonorCommitment</a>|
|[isBookable](#isBookable)||<a href="DonorCommitment.md" target="_blank">nonProfitCore/DonorCommitment</a>|
|[name](#name)||<a href="DonorCommitment.md" target="_blank">nonProfitCore/DonorCommitment</a>|
|[nextPaymentAmount](#nextPaymentAmount)||<a href="DonorCommitment.md" target="_blank">nonProfitCore/DonorCommitment</a>|
|[nextPaymentAmountBase](#nextPaymentAmountBase)|Value of the Next Payment Amount in base currency.|<a href="DonorCommitment.md" target="_blank">nonProfitCore/DonorCommitment</a>|
|[nextPaymentDate](#nextPaymentDate)||<a href="DonorCommitment.md" target="_blank">nonProfitCore/DonorCommitment</a>|
|[pledgedByAccountId](#pledgedByAccountId)|Unique identifier for Account associated with Donor Commitment.|<a href="DonorCommitment.md" target="_blank">nonProfitCore/DonorCommitment</a>|
|[pledgedByContactId](#pledgedByContactId)|Pledged By Contact|<a href="DonorCommitment.md" target="_blank">nonProfitCore/DonorCommitment</a>|
|[pledgedOnAccountId](#pledgedOnAccountId)|Pledged On Account|<a href="DonorCommitment.md" target="_blank">nonProfitCore/DonorCommitment</a>|
|[receivedDate](#receivedDate)||<a href="DonorCommitment.md" target="_blank">nonProfitCore/DonorCommitment</a>|
|[totalAmount](#totalAmount)||<a href="DonorCommitment.md" target="_blank">nonProfitCore/DonorCommitment</a>|
|[totalAmountBase](#totalAmountBase)|Value of the Total Amount in base currency.|<a href="DonorCommitment.md" target="_blank">nonProfitCore/DonorCommitment</a>|
|[stateCode](#stateCode)|Status of the Donor Commitment|<a href="DonorCommitment.md" target="_blank">nonProfitCore/DonorCommitment</a>|
|[stateCode_display](#stateCode_display)||<a href="DonorCommitment.md" target="_blank">nonProfitCore/DonorCommitment</a>|
|[statusCode](#statusCode)|Reason for the status of the Donor Commitment|<a href="DonorCommitment.md" target="_blank">nonProfitCore/DonorCommitment</a>|
|[statusCode_display](#statusCode_display)||<a href="DonorCommitment.md" target="_blank">nonProfitCore/DonorCommitment</a>|
|[transactionCurrencyId](#transactionCurrencyId)|Unique identifier of the currency associated with the entity.|<a href="DonorCommitment.md" target="_blank">nonProfitCore/DonorCommitment</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: nonProfitCore/DonorCommitment (this entity)  
