---
title: DeliveryFrameworkContact - Common Data Model | Microsoft Docs
...
Contact information for the Delivery Framework.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/nonProfit/nonProfitIati/DeliveryFrameworkContact.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in Common Data Model entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/core/applicationCommon/foundationCommon<br>/crmCommon/accelerators/nonProfit/nonProfitIati<br>/DeliveryFrameworkContact.cdm.json<br>/DeliveryFrameworkContact/hasAttributes<br>/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[DeliveryFrameworkContact/(resolvedAttributes)/deliveryFrameworkContactId](#deliveryFrameworkContactId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[DeliveryFrameworkContact/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Delivery Framework Contact</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Contact information for the Delivery Framework.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
  the unique name that identifies this object in Common Data Service for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msiati_deliveryframeworkcontact"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="DeliveryFrameworkContact.md" target="_blank">nonProfitIati/DeliveryFrameworkContact</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="DeliveryFrameworkContact.md" target="_blank">nonProfitIati/DeliveryFrameworkContact</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="DeliveryFrameworkContact.md" target="_blank">nonProfitIati/DeliveryFrameworkContact</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="DeliveryFrameworkContact.md" target="_blank">nonProfitIati/DeliveryFrameworkContact</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="DeliveryFrameworkContact.md" target="_blank">nonProfitIati/DeliveryFrameworkContact</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="DeliveryFrameworkContact.md" target="_blank">nonProfitIati/DeliveryFrameworkContact</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="DeliveryFrameworkContact.md" target="_blank">nonProfitIati/DeliveryFrameworkContact</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="DeliveryFrameworkContact.md" target="_blank">nonProfitIati/DeliveryFrameworkContact</a>|
|[ownerId](#ownerId)|Owner Id|<a href="DeliveryFrameworkContact.md" target="_blank">nonProfitIati/DeliveryFrameworkContact</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="DeliveryFrameworkContact.md" target="_blank">nonProfitIati/DeliveryFrameworkContact</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="DeliveryFrameworkContact.md" target="_blank">nonProfitIati/DeliveryFrameworkContact</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="DeliveryFrameworkContact.md" target="_blank">nonProfitIati/DeliveryFrameworkContact</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="DeliveryFrameworkContact.md" target="_blank">nonProfitIati/DeliveryFrameworkContact</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="DeliveryFrameworkContact.md" target="_blank">nonProfitIati/DeliveryFrameworkContact</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="DeliveryFrameworkContact.md" target="_blank">nonProfitIati/DeliveryFrameworkContact</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="DeliveryFrameworkContact.md" target="_blank">nonProfitIati/DeliveryFrameworkContact</a>|
|[ContactId](#ContactId)|Unique identifier for Contact associated with Delivery Framework Contact.|<a href="DeliveryFrameworkContact.md" target="_blank">nonProfitIati/DeliveryFrameworkContact</a>|
|[ContactType](#ContactType)|The type of contact.|<a href="DeliveryFrameworkContact.md" target="_blank">nonProfitIati/DeliveryFrameworkContact</a>|
|[deliveryFrameworkContactId](#deliveryFrameworkContactId)|Unique identifier for entity instances|<a href="DeliveryFrameworkContact.md" target="_blank">nonProfitIati/DeliveryFrameworkContact</a>|
|[deliveryFrameworkId](#deliveryFrameworkId)|Unique identifier for Delivery Framework associated with Delivery Framework Contact.|<a href="DeliveryFrameworkContact.md" target="_blank">nonProfitIati/DeliveryFrameworkContact</a>|
|[name](#name)|The name of the custom entity.|<a href="DeliveryFrameworkContact.md" target="_blank">nonProfitIati/DeliveryFrameworkContact</a>|
|[stateCode](#stateCode)|Status of the Delivery Framework Contact|<a href="DeliveryFrameworkContact.md" target="_blank">nonProfitIati/DeliveryFrameworkContact</a>|
|[stateCode_display](#stateCode_display)||<a href="DeliveryFrameworkContact.md" target="_blank">nonProfitIati/DeliveryFrameworkContact</a>|
|[statusCode](#statusCode)|Reason for the status of the Delivery Framework Contact|<a href="DeliveryFrameworkContact.md" target="_blank">nonProfitIati/DeliveryFrameworkContact</a>|
|[statusCode_display](#statusCode_display)||<a href="DeliveryFrameworkContact.md" target="_blank">nonProfitIati/DeliveryFrameworkContact</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: nonProfitIati/DeliveryFrameworkContact (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Contact</td></tr><tr><td>description</td><td>Unique identifier for Contact associated with Delivery Framework Contact.</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>sourceName</td><td>msiati_contactid</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Unique identifier for Contact associated with Delivery Framework Contact.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in Common Data Service for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msiati_contactid"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Contact Type</td></tr><tr><td>description</td><td>The type of contact.</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>sourceName</td><td>msiati_contacttypeid</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>The type of contact.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in Common Data Service for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msiati_contacttypeid"</td><td>string</td><td></td></tr></table>
...
### <a href=#deliveryFrameworkContactId name="deliveryFrameworkContactId">deliveryFrameworkContactId</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Delivery Framework Contact</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>sourceName</td><td>msiati_deliveryframeworkcontactid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the deliveryFrameworkContactId attribute are listed below.</summary>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in Common Data Service for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msiati_deliveryframeworkcontactid"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Delivery Framework</td></tr><tr><td>description</td><td>Unique identifier for Delivery Framework associated with Delivery Framework Contact.</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>sourceName</td><td>msiati_deliveryframeworkid</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Unique identifier for Delivery Framework associated with Delivery Framework Contact.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the Delivery Framework Contact</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the Delivery Framework Contact</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
