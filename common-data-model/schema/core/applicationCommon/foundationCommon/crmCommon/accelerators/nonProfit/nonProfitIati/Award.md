...
An Award represents the total amount of funding that has been agreed to be awarded to an individual or institution.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/nonProfit/nonProfitIati/Award.cdm.json" target="_blank">GitHub</a>.  

## Instances

Instances of this entity are listed below.  

- [/foundationCommon/crmCommon/accelerators/nonProfit/nonProfitCore/Award](../nonProfitCore/Award.md "/core/applicationCommon/foundationCommon/crmCommon/accelerators/nonProfit/nonProfitCore/Award.cdm.json/Award")  
- /crmCommon/accelerators/nonProfit/nonProfitIati/Award  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="Award.md" target="_blank">nonProfitIati/Award</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="Award.md" target="_blank">nonProfitIati/Award</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="Award.md" target="_blank">nonProfitIati/Award</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="Award.md" target="_blank">nonProfitIati/Award</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="Award.md" target="_blank">nonProfitIati/Award</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="Award.md" target="_blank">nonProfitIati/Award</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="Award.md" target="_blank">nonProfitIati/Award</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="Award.md" target="_blank">nonProfitIati/Award</a>|
|[ownerId](#ownerId)|Owner Id|<a href="Award.md" target="_blank">nonProfitIati/Award</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="Award.md" target="_blank">nonProfitIati/Award</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="Award.md" target="_blank">nonProfitIati/Award</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="Award.md" target="_blank">nonProfitIati/Award</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="Award.md" target="_blank">nonProfitIati/Award</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="Award.md" target="_blank">nonProfitIati/Award</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="Award.md" target="_blank">nonProfitIati/Award</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="Award.md" target="_blank">nonProfitIati/Award</a>|
|[awardId](#awardId)|Unique identifier for entity instances|<a href="Award.md" target="_blank">nonProfitIati/Award</a>|
|[docketId](#docketId)|Docket|<a href="Award.md" target="_blank">nonProfitIati/Award</a>|
|[fiscalSponsorId](#fiscalSponsorId)|Fiscal Sponsor|<a href="Award.md" target="_blank">nonProfitIati/Award</a>|
|[internalContactId](#internalContactId)|Internal Contact|<a href="Award.md" target="_blank">nonProfitIati/Award</a>|
|[name](#name)|The name of the custom entity.|<a href="Award.md" target="_blank">nonProfitIati/Award</a>|
|[noticeOfAwardChannel](#noticeOfAwardChannel)|Comm method by which customer is notified that Award is approved.|<a href="Award.md" target="_blank">nonProfitIati/Award</a>|
|[noticeOfAwardChannel_display](#noticeOfAwardChannel_display)||<a href="Award.md" target="_blank">nonProfitIati/Award</a>|
|[noticeOfAwardDate](#noticeOfAwardDate)|Date when customer is notified that Award is approved.|<a href="Award.md" target="_blank">nonProfitIati/Award</a>|
|[recipientId](#recipientId)|Unique identifier of the recipient for the item.|<a href="Award.md" target="_blank">nonProfitIati/Award</a>|
|[type](#type)|Type of Award|<a href="Award.md" target="_blank">nonProfitIati/Award</a>|
|[requestId](#requestId)|Request|<a href="Award.md" target="_blank">nonProfitIati/Award</a>|
|[type_display](#type_display)||<a href="Award.md" target="_blank">nonProfitIati/Award</a>|
|[stateCode](#stateCode)|Status of the Award|<a href="Award.md" target="_blank">nonProfitIati/Award</a>|
|[stateCode_display](#stateCode_display)||<a href="Award.md" target="_blank">nonProfitIati/Award</a>|
|[statusCode](#statusCode)|Reason for the status of the Award|<a href="Award.md" target="_blank">nonProfitIati/Award</a>|
|[statusCode_display](#statusCode_display)||<a href="Award.md" target="_blank">nonProfitIati/Award</a>|
|[recipient](#recipient)|Unique identifier of the recipient for the item.|<a href="Award.md" target="_blank">nonProfitIati/Award</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: nonProfitIati/Award (this entity)  
...
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="Docket.md" target="_blank">/core/applicationCommon/foundationCommon/crmCommon/accelerators/nonProfit/nonProfitIati/Docket.cdm.json/Docket</a></td><td><a href="Docket.md#docketId" target="_blank">docketId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
...
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="Account.md" target="_blank">/core/applicationCommon/foundationCommon/crmCommon/accelerators/nonProfit/nonProfitIati/Account.cdm.json/Account</a></td><td><a href="Account.md#accountId" target="_blank">accountId</a></td></tr><tr><td><a href="Contact.md" target="_blank">/core/applicationCommon/foundationCommon/crmCommon/accelerators/nonProfit/nonProfitIati/Contact.cdm.json/Contact</a></td><td><a href="Contact.md#contactId" target="_blank">contactId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
...
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="Request.md" target="_blank">/core/applicationCommon/foundationCommon/crmCommon/accelerators/nonProfit/nonProfitIati/Request.cdm.json/Request</a></td><td><a href="Request.md#requestId" target="_blank">requestId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
