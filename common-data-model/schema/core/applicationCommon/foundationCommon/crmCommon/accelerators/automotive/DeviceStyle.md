---
title: DeviceStyle - Common Data Model | Microsoft Docs
...
Distinctive form or type of vehicle or device such as sedan or station wagon car, wheeled or crawler excavator, and so on.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/automotive/DeviceStyle.cdm.json" target="_blank">GitHub</a>.  

## Instances

Instances of this entity are listed below.  

- /crmCommon/accelerators/automotive/DeviceStyle  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/core/applicationCommon/foundationCommon<br>/crmCommon/accelerators/automotive<br>/DeviceStyle.cdm.json/DeviceStyle/hasAttributes<br>/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[DeviceStyle/(resolvedAttributes)/deviceStyleId](#deviceStyleId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[DeviceStyle/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Distinctive form or type of vehicle or device such as sedan or station wagon car, wheeled or crawler excavator, and so on.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msauto_devicestyle"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="DeviceStyle.md" target="_blank">automotive/DeviceStyle</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="DeviceStyle.md" target="_blank">automotive/DeviceStyle</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="DeviceStyle.md" target="_blank">automotive/DeviceStyle</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="DeviceStyle.md" target="_blank">automotive/DeviceStyle</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="DeviceStyle.md" target="_blank">automotive/DeviceStyle</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="DeviceStyle.md" target="_blank">automotive/DeviceStyle</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="DeviceStyle.md" target="_blank">automotive/DeviceStyle</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="DeviceStyle.md" target="_blank">automotive/DeviceStyle</a>|
|[ownerId](#ownerId)|Owner Id|<a href="DeviceStyle.md" target="_blank">automotive/DeviceStyle</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="DeviceStyle.md" target="_blank">automotive/DeviceStyle</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="DeviceStyle.md" target="_blank">automotive/DeviceStyle</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="DeviceStyle.md" target="_blank">automotive/DeviceStyle</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="DeviceStyle.md" target="_blank">automotive/DeviceStyle</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="DeviceStyle.md" target="_blank">automotive/DeviceStyle</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="DeviceStyle.md" target="_blank">automotive/DeviceStyle</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="DeviceStyle.md" target="_blank">automotive/DeviceStyle</a>|
|[entityImage](#entityImage)||<a href="DeviceStyle.md" target="_blank">automotive/DeviceStyle</a>|
|[code](#code)|Unique code for the style.|<a href="DeviceStyle.md" target="_blank">automotive/DeviceStyle</a>|
|[description](#description)|Description of the style.|<a href="DeviceStyle.md" target="_blank">automotive/DeviceStyle</a>|
|[deviceStyleId](#deviceStyleId)|Unique identifier for entity instances|<a href="DeviceStyle.md" target="_blank">automotive/DeviceStyle</a>|
|[deviceTypeId](#deviceTypeId)|Device type for which this style is applicable.|<a href="DeviceStyle.md" target="_blank">automotive/DeviceStyle</a>|
|[name](#name)|Name of the style.|<a href="DeviceStyle.md" target="_blank">automotive/DeviceStyle</a>|
|[stateCode](#stateCode)|Status of the Device Style|<a href="DeviceStyle.md" target="_blank">automotive/DeviceStyle</a>|
|[stateCode_display](#stateCode_display)||<a href="DeviceStyle.md" target="_blank">automotive/DeviceStyle</a>|
|[statusCode](#statusCode)|Reason for the status of the Device Style|<a href="DeviceStyle.md" target="_blank">automotive/DeviceStyle</a>|
|[statusCode_display](#statusCode_display)||<a href="DeviceStyle.md" target="_blank">automotive/DeviceStyle</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: automotive/DeviceStyle (this entity)  
...
Unique code for the style.  
First included in: automotive/DeviceStyle (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Code</td></tr><tr><td>description</td><td>Unique code for the style.</td></tr><tr><td>dataFormat</td><td>7</td></tr><tr><td>maximumLength</td><td>100</td></tr><tr><td>sourceName</td><td>msauto_code</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Unique code for the style.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Description</td></tr><tr><td>description</td><td>Description of the style.</td></tr><tr><td>dataFormat</td><td>7</td></tr><tr><td>maximumLength</td><td>2000</td></tr><tr><td>sourceName</td><td>msauto_description</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Description of the style.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Device Style</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msauto_devicestyleid</td></tr></table>
...
Device type for which this style is applicable.  
First included in: automotive/DeviceStyle (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Device Type</td></tr><tr><td>description</td><td>Device type for which this style is applicable.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msauto_devicetypeid</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Device type for which this style is applicable.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Name</td></tr><tr><td>description</td><td>Name of the style.</td></tr><tr><td>dataFormat</td><td>7</td></tr><tr><td>maximumLength</td><td>100</td></tr><tr><td>sourceName</td><td>msauto_name</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Name of the style.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
Status of the Device Style  
First included in: automotive/DeviceStyle (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Device Style</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the Device Style</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
Reason for the status of the Device Style  
First included in: automotive/DeviceStyle (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Device Style</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the Device Style</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
