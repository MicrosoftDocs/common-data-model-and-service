---
title: ConfigurationCode - Common Data Model | Microsoft Docs
...
Unique OEM code for a given combination of configuration options.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/automotive/ConfigurationCode.cdm.json" target="_blank">GitHub</a>.  

## Instances

Instances of this entity are listed below.  

- /crmCommon/accelerators/automotive/ConfigurationCode  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/core/applicationCommon/foundationCommon<br>/crmCommon/accelerators/automotive<br>/ConfigurationCode.cdm.json/ConfigurationCode<br>/hasAttributes/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[ConfigurationCode/(resolvedAttributes)/configurationCodeId](#configurationCodeId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[ConfigurationCode/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Unique OEM code for a given combination of configuration options.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msauto_configurationcode"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="ConfigurationCode.md" target="_blank">automotive/ConfigurationCode</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="ConfigurationCode.md" target="_blank">automotive/ConfigurationCode</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="ConfigurationCode.md" target="_blank">automotive/ConfigurationCode</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="ConfigurationCode.md" target="_blank">automotive/ConfigurationCode</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="ConfigurationCode.md" target="_blank">automotive/ConfigurationCode</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="ConfigurationCode.md" target="_blank">automotive/ConfigurationCode</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="ConfigurationCode.md" target="_blank">automotive/ConfigurationCode</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="ConfigurationCode.md" target="_blank">automotive/ConfigurationCode</a>|
|[ownerId](#ownerId)|Owner Id|<a href="ConfigurationCode.md" target="_blank">automotive/ConfigurationCode</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="ConfigurationCode.md" target="_blank">automotive/ConfigurationCode</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="ConfigurationCode.md" target="_blank">automotive/ConfigurationCode</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="ConfigurationCode.md" target="_blank">automotive/ConfigurationCode</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="ConfigurationCode.md" target="_blank">automotive/ConfigurationCode</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="ConfigurationCode.md" target="_blank">automotive/ConfigurationCode</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="ConfigurationCode.md" target="_blank">automotive/ConfigurationCode</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="ConfigurationCode.md" target="_blank">automotive/ConfigurationCode</a>|
|[configurationCodeId](#configurationCodeId)|Unique identifier for entity instances|<a href="ConfigurationCode.md" target="_blank">automotive/ConfigurationCode</a>|
|[description](#description)|Description of the configuration code.|<a href="ConfigurationCode.md" target="_blank">automotive/ConfigurationCode</a>|
|[name](#name)|Name of the configuration code.|<a href="ConfigurationCode.md" target="_blank">automotive/ConfigurationCode</a>|
|[stateCode](#stateCode)|Status of the Configuration Code|<a href="ConfigurationCode.md" target="_blank">automotive/ConfigurationCode</a>|
|[stateCode_display](#stateCode_display)||<a href="ConfigurationCode.md" target="_blank">automotive/ConfigurationCode</a>|
|[statusCode](#statusCode)|Reason for the status of the Configuration Code|<a href="ConfigurationCode.md" target="_blank">automotive/ConfigurationCode</a>|
|[statusCode_display](#statusCode_display)||<a href="ConfigurationCode.md" target="_blank">automotive/ConfigurationCode</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: automotive/ConfigurationCode (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Configuration Code</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msauto_configurationcodeid</td></tr></table>
...
Description of the configuration code.  
First included in: automotive/ConfigurationCode (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Description</td></tr><tr><td>description</td><td>Description of the configuration code.</td></tr><tr><td>dataFormat</td><td>7</td></tr><tr><td>maximumLength</td><td>2000</td></tr><tr><td>sourceName</td><td>msauto_description</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Description of the configuration code.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
Name of the configuration code.  
First included in: automotive/ConfigurationCode (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Name</td></tr><tr><td>description</td><td>Name of the configuration code.</td></tr><tr><td>dataFormat</td><td>7</td></tr><tr><td>maximumLength</td><td>100</td></tr><tr><td>sourceName</td><td>msauto_name</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Name of the configuration code.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
Status of the Configuration Code  
First included in: automotive/ConfigurationCode (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Configuration Code</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the Configuration Code</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
Reason for the status of the Configuration Code  
First included in: automotive/ConfigurationCode (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Configuration Code</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the Configuration Code</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
