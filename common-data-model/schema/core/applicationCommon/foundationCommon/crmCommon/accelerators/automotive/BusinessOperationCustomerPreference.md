...
Customer preference for a given type of business operation, such as preferred service center or rental depot.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/automotive/BusinessOperationCustomerPreference.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in Common Data Model entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/core/applicationCommon/foundationCommon<br>/crmCommon/accelerators/automotive<br>/BusinessOperationCustomerPreference.cdm.json<br>/BusinessOperationCustomerPreference/hasAttributes<br>/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[BusinessOperationCustomerPreference/(resolvedAttributes)/businessOperationCustomerPreferenceId](#businessOperationCustomerPreferenceId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[BusinessOperationCustomerPreference/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Business Operation Customer Preference</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Customer preference for a given type of business operation, such as preferred service center or rental depot.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
  the unique name that identifies this object in Common Data Service for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msauto_businessoperationcustomerpreference"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="BusinessOperationCustomerPreference.md" target="_blank">automotive/BusinessOperationCustomerPreference</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="BusinessOperationCustomerPreference.md" target="_blank">automotive/BusinessOperationCustomerPreference</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="BusinessOperationCustomerPreference.md" target="_blank">automotive/BusinessOperationCustomerPreference</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="BusinessOperationCustomerPreference.md" target="_blank">automotive/BusinessOperationCustomerPreference</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="BusinessOperationCustomerPreference.md" target="_blank">automotive/BusinessOperationCustomerPreference</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="BusinessOperationCustomerPreference.md" target="_blank">automotive/BusinessOperationCustomerPreference</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="BusinessOperationCustomerPreference.md" target="_blank">automotive/BusinessOperationCustomerPreference</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="BusinessOperationCustomerPreference.md" target="_blank">automotive/BusinessOperationCustomerPreference</a>|
|[ownerId](#ownerId)|Owner Id|<a href="BusinessOperationCustomerPreference.md" target="_blank">automotive/BusinessOperationCustomerPreference</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="BusinessOperationCustomerPreference.md" target="_blank">automotive/BusinessOperationCustomerPreference</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="BusinessOperationCustomerPreference.md" target="_blank">automotive/BusinessOperationCustomerPreference</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="BusinessOperationCustomerPreference.md" target="_blank">automotive/BusinessOperationCustomerPreference</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="BusinessOperationCustomerPreference.md" target="_blank">automotive/BusinessOperationCustomerPreference</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="BusinessOperationCustomerPreference.md" target="_blank">automotive/BusinessOperationCustomerPreference</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="BusinessOperationCustomerPreference.md" target="_blank">automotive/BusinessOperationCustomerPreference</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="BusinessOperationCustomerPreference.md" target="_blank">automotive/BusinessOperationCustomerPreference</a>|
|[businessOperationCustomerPreferenceId](#businessOperationCustomerPreferenceId)|Unique identifier for entity instances|<a href="BusinessOperationCustomerPreference.md" target="_blank">automotive/BusinessOperationCustomerPreference</a>|
|[businessOperationId](#businessOperationId)|Department/team at the business operation responsible for the customer.|<a href="BusinessOperationCustomerPreference.md" target="_blank">automotive/BusinessOperationCustomerPreference</a>|
|[customerId](#customerId)|The customer account or contact to provide a quick link to additional customer details, such as account information, activities, and opportunities.|<a href="BusinessOperationCustomerPreference.md" target="_blank">automotive/BusinessOperationCustomerPreference</a>|
|[customerIdType](#customerIdType)|The type of customer, either Account or Contact.|<a href="BusinessOperationCustomerPreference.md" target="_blank">automotive/BusinessOperationCustomerPreference</a>|
|[name](#name)|Name of the customer preference record.|<a href="BusinessOperationCustomerPreference.md" target="_blank">automotive/BusinessOperationCustomerPreference</a>|
|[validFrom](#validFrom)|First date for which the business operation customer is valid.|<a href="BusinessOperationCustomerPreference.md" target="_blank">automotive/BusinessOperationCustomerPreference</a>|
|[validTo](#validTo)|Last date for which the business operation customer is valid.|<a href="BusinessOperationCustomerPreference.md" target="_blank">automotive/BusinessOperationCustomerPreference</a>|
|[stateCode](#stateCode)|Status of the Business Operation Customer Preference|<a href="BusinessOperationCustomerPreference.md" target="_blank">automotive/BusinessOperationCustomerPreference</a>|
|[stateCode_display](#stateCode_display)||<a href="BusinessOperationCustomerPreference.md" target="_blank">automotive/BusinessOperationCustomerPreference</a>|
|[statusCode](#statusCode)|Reason for the status of the Business Operation Customer Preference|<a href="BusinessOperationCustomerPreference.md" target="_blank">automotive/BusinessOperationCustomerPreference</a>|
|[statusCode_display](#statusCode_display)||<a href="BusinessOperationCustomerPreference.md" target="_blank">automotive/BusinessOperationCustomerPreference</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: automotive/BusinessOperationCustomerPreference (this entity)  
...
### <a href=#businessOperationCustomerPreferenceId name="businessOperationCustomerPreferenceId">businessOperationCustomerPreferenceId</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Business Operation Customer Preference</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>sourceName</td><td>msauto_businessoperationcustomerpreferenceid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the businessOperationCustomerPreferenceId attribute are listed below.</summary>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in Common Data Service for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msauto_businessoperationcustomerpreferenceid"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Business Operation</td></tr><tr><td>description</td><td>Department/team at the business operation responsible for the customer.</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>sourceName</td><td>msauto_businessoperationid</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Department/team at the business operation responsible for the customer.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in Common Data Service for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msauto_businessoperationid"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Name</td></tr><tr><td>description</td><td>Name of the customer preference record.</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>100</td></tr><tr><td>sourceName</td><td>msauto_name</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Name of the customer preference record.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Valid From</td></tr><tr><td>description</td><td>First date for which the business operation customer is valid.</td></tr><tr><td>dataFormat</td><td>dateTime</td></tr><tr><td>sourceName</td><td>msauto_validfrom</td></tr></table>
...
**means.measurement.time**  
**is.CDS.sourceNamed**  
the unique name that identifies this object in Common Data Service for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msauto_validfrom"</td><td>string</td><td></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>First date for which the business operation customer is valid.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Valid To</td></tr><tr><td>description</td><td>Last date for which the business operation customer is valid.</td></tr><tr><td>dataFormat</td><td>dateTime</td></tr><tr><td>sourceName</td><td>msauto_validto</td></tr></table>
...
**means.measurement.time**  
**is.CDS.sourceNamed**  
the unique name that identifies this object in Common Data Service for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msauto_validto"</td><td>string</td><td></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Last date for which the business operation customer is valid.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Business Operation Customer Preference</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the Business Operation Customer Preference</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Business Operation Customer Preference</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the Business Operation Customer Preference</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
