---
title: CustomerAttachment in automotive - Common Data Model | Microsoft Docs
description: Document or file related to a given customer or deal file.
author: nenad1002
...
# Customer Attachment in automotive

Document or file related to a given customer or deal file.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/automotive/CustomerAttachment.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/core/applicationCommon/foundationCommon<br>/crmCommon/accelerators/automotive<br>/CustomerAttachment.cdm.json/CustomerAttachment<br>/hasAttributes/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[CustomerAttachment/(resolvedAttributes)/customerAttachmentId](#customerAttachmentId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[CustomerAttachment/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Customer Attachment</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Document or file related to a given customer or deal file.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msauto_customerattachment"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="CustomerAttachment.md" target="_blank">automotive/CustomerAttachment</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="CustomerAttachment.md" target="_blank">automotive/CustomerAttachment</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="CustomerAttachment.md" target="_blank">automotive/CustomerAttachment</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="CustomerAttachment.md" target="_blank">automotive/CustomerAttachment</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="CustomerAttachment.md" target="_blank">automotive/CustomerAttachment</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="CustomerAttachment.md" target="_blank">automotive/CustomerAttachment</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="CustomerAttachment.md" target="_blank">automotive/CustomerAttachment</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="CustomerAttachment.md" target="_blank">automotive/CustomerAttachment</a>|
|[ownerId](#ownerId)|Owner Id|<a href="CustomerAttachment.md" target="_blank">automotive/CustomerAttachment</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="CustomerAttachment.md" target="_blank">automotive/CustomerAttachment</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="CustomerAttachment.md" target="_blank">automotive/CustomerAttachment</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="CustomerAttachment.md" target="_blank">automotive/CustomerAttachment</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="CustomerAttachment.md" target="_blank">automotive/CustomerAttachment</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="CustomerAttachment.md" target="_blank">automotive/CustomerAttachment</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="CustomerAttachment.md" target="_blank">automotive/CustomerAttachment</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="CustomerAttachment.md" target="_blank">automotive/CustomerAttachment</a>|
|[customerAttachmentId](#customerAttachmentId)|Unique identifier for entity instances|<a href="CustomerAttachment.md" target="_blank">automotive/CustomerAttachment</a>|
|[description](#description)|Description of the customer attachment|<a href="CustomerAttachment.md" target="_blank">automotive/CustomerAttachment</a>|
|[name](#name)|The name of the custom entity.|<a href="CustomerAttachment.md" target="_blank">automotive/CustomerAttachment</a>|
|[stateCode](#stateCode)|Status of the Customer Attachment|<a href="CustomerAttachment.md" target="_blank">automotive/CustomerAttachment</a>|
|[stateCode_display](#stateCode_display)||<a href="CustomerAttachment.md" target="_blank">automotive/CustomerAttachment</a>|
|[statusCode](#statusCode)|Reason for the status of the Customer Attachment|<a href="CustomerAttachment.md" target="_blank">automotive/CustomerAttachment</a>|
|[statusCode_display](#statusCode_display)||<a href="CustomerAttachment.md" target="_blank">automotive/CustomerAttachment</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: automotive/CustomerAttachment (this entity)  
...
### <a href=#customerAttachmentId name="customerAttachmentId">customerAttachmentId</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Customer Attachment</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>sourceName</td><td>msauto_customerattachmentid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the customerAttachmentId attribute are listed below.</summary>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msauto_customerattachmentid"</td><td>string</td><td></td></tr></table>
...
Description of the customer attachment  
First included in: automotive/CustomerAttachment (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Description</td></tr><tr><td>description</td><td>Description of the customer attachment</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>2000</td></tr><tr><td>sourceName</td><td>msauto_description</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Description of the customer attachment</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
Status of the Customer Attachment  
First included in: automotive/CustomerAttachment (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Customer Attachment</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the Customer Attachment</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
Reason for the status of the Customer Attachment  
First included in: automotive/CustomerAttachment (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Customer Attachment</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the Customer Attachment</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
