---
title: ConfigurationOption - Common Data Model | Microsoft Docs
...
Configuration option included in devices with a given configuration code.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/automotive/ConfigurationOption.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in Common Data Model entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/core/applicationCommon/foundationCommon<br>/crmCommon/accelerators/automotive<br>/ConfigurationOption.cdm.json/ConfigurationOption<br>/hasAttributes/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[ConfigurationOption/(resolvedAttributes)/configurationOptionId](#configurationOptionId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[ConfigurationOption/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Configuration option included in devices with a given configuration code.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
  the unique name that identifies this object in Common Data Service for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msauto_configurationoption"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="ConfigurationOption.md" target="_blank">automotive/ConfigurationOption</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="ConfigurationOption.md" target="_blank">automotive/ConfigurationOption</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="ConfigurationOption.md" target="_blank">automotive/ConfigurationOption</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="ConfigurationOption.md" target="_blank">automotive/ConfigurationOption</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="ConfigurationOption.md" target="_blank">automotive/ConfigurationOption</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="ConfigurationOption.md" target="_blank">automotive/ConfigurationOption</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="ConfigurationOption.md" target="_blank">automotive/ConfigurationOption</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="ConfigurationOption.md" target="_blank">automotive/ConfigurationOption</a>|
|[ownerId](#ownerId)|Owner Id|<a href="ConfigurationOption.md" target="_blank">automotive/ConfigurationOption</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="ConfigurationOption.md" target="_blank">automotive/ConfigurationOption</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="ConfigurationOption.md" target="_blank">automotive/ConfigurationOption</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="ConfigurationOption.md" target="_blank">automotive/ConfigurationOption</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="ConfigurationOption.md" target="_blank">automotive/ConfigurationOption</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="ConfigurationOption.md" target="_blank">automotive/ConfigurationOption</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="ConfigurationOption.md" target="_blank">automotive/ConfigurationOption</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="ConfigurationOption.md" target="_blank">automotive/ConfigurationOption</a>|
|[entityImage](#entityImage)||<a href="ConfigurationOption.md" target="_blank">automotive/ConfigurationOption</a>|
|[exchangeRate](#exchangeRate)|Exchange rate for the currency associated with the entity with respect to the base currency.|<a href="ConfigurationOption.md" target="_blank">automotive/ConfigurationOption</a>|
|[configurationCodeId](#configurationCodeId)|Unique code for the configuration.|<a href="ConfigurationOption.md" target="_blank">automotive/ConfigurationOption</a>|
|[configurationOptionId](#configurationOptionId)|Unique identifier for entity instances|<a href="ConfigurationOption.md" target="_blank">automotive/ConfigurationOption</a>|
|[description](#description)|Description of the configuration code.|<a href="ConfigurationOption.md" target="_blank">automotive/ConfigurationOption</a>|
|[externalCode](#externalCode)|External code for the configuration.|<a href="ConfigurationOption.md" target="_blank">automotive/ConfigurationOption</a>|
|[name](#name)|Name of the configuration.|<a href="ConfigurationOption.md" target="_blank">automotive/ConfigurationOption</a>|
|[quantity](#quantity)|Number of the configuration option.|<a href="ConfigurationOption.md" target="_blank">automotive/ConfigurationOption</a>|
|[salesPrice](#salesPrice)|Price of the configuration option per a single quantity.|<a href="ConfigurationOption.md" target="_blank">automotive/ConfigurationOption</a>|
|[salesPriceBase](#salesPriceBase)|Value of the Sales Price in base currency.|<a href="ConfigurationOption.md" target="_blank">automotive/ConfigurationOption</a>|
|[stateCode](#stateCode)|Status of the Configuration Option|<a href="ConfigurationOption.md" target="_blank">automotive/ConfigurationOption</a>|
|[stateCode_display](#stateCode_display)||<a href="ConfigurationOption.md" target="_blank">automotive/ConfigurationOption</a>|
|[statusCode](#statusCode)|Reason for the status of the Configuration Option|<a href="ConfigurationOption.md" target="_blank">automotive/ConfigurationOption</a>|
|[statusCode_display](#statusCode_display)||<a href="ConfigurationOption.md" target="_blank">automotive/ConfigurationOption</a>|
|[transactionCurrencyId](#transactionCurrencyId)|Unique identifier of the currency associated with the entity.|<a href="ConfigurationOption.md" target="_blank">automotive/ConfigurationOption</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: automotive/ConfigurationOption (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Configuration Code</td></tr><tr><td>description</td><td>Unique code for the configuration.</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>sourceName</td><td>msauto_configurationcodeid</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Unique code for the configuration.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Configuration Option</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>sourceName</td><td>msauto_configurationoptionid</td></tr></table>
...
External code for the configuration.  
First included in: automotive/ConfigurationOption (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>External Code</td></tr><tr><td>description</td><td>External code for the configuration.</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>100</td></tr><tr><td>sourceName</td><td>msauto_externalcode</td></tr></table>
...
**is.dataFormat.array**  
**is.CDS.sourceNamed**  
the unique name that identifies this object in Common Data Service for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msauto_externalcode"</td><td>string</td><td></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>External code for the configuration.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Name</td></tr><tr><td>description</td><td>Name of the configuration.</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>100</td></tr><tr><td>sourceName</td><td>msauto_name</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Name of the configuration.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
Number of the configuration option.  
First included in: automotive/ConfigurationOption (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Quantity</td></tr><tr><td>description</td><td>Number of the configuration option.</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>maximumValue</td><td>2147483647</td></tr><tr><td>minimumValue</td><td>0</td></tr><tr><td>sourceName</td><td>msauto_quantity</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Number of the configuration option.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
Price of the configuration option per a single quantity.  
First included in: automotive/ConfigurationOption (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Sales Price</td></tr><tr><td>description</td><td>Price of the configuration option per a single quantity.</td></tr><tr><td>dataFormat</td><td>decimal</td></tr><tr><td>maximumValue</td><td>922337203685477</td></tr><tr><td>minimumValue</td><td>-922337203685477</td></tr><tr><td>sourceName</td><td>msauto_salesprice</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Price of the configuration option per a single quantity.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
Status of the Configuration Option  
First included in: automotive/ConfigurationOption (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Configuration Option</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the Configuration Option</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
Reason for the status of the Configuration Option  
First included in: automotive/ConfigurationOption (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Configuration Option</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the Configuration Option</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
