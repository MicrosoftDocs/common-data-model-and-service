---
title: LeadDispositionActivity - Common Data Model | Microsoft Docs
...
Specific activity that should be taken to follow up and nurture a lead.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/automotive/LeadDispositionActivity.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in Common Data Model entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/core/applicationCommon/foundationCommon<br>/crmCommon/accelerators/automotive<br>/LeadDispositionActivity.cdm.json<br>/LeadDispositionActivity/hasAttributes<br>/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[LeadDispositionActivity/(resolvedAttributes)/leadDispositionActivityId](#leadDispositionActivityId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[LeadDispositionActivity/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Lead Disposition Activity</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Specific activity that should be taken to follow up and nurture a lead.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
  the unique name that identifies this object in Common Data Service for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msauto_leaddispositionactivity"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="LeadDispositionActivity.md" target="_blank">automotive/LeadDispositionActivity</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="LeadDispositionActivity.md" target="_blank">automotive/LeadDispositionActivity</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="LeadDispositionActivity.md" target="_blank">automotive/LeadDispositionActivity</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="LeadDispositionActivity.md" target="_blank">automotive/LeadDispositionActivity</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="LeadDispositionActivity.md" target="_blank">automotive/LeadDispositionActivity</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="LeadDispositionActivity.md" target="_blank">automotive/LeadDispositionActivity</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="LeadDispositionActivity.md" target="_blank">automotive/LeadDispositionActivity</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="LeadDispositionActivity.md" target="_blank">automotive/LeadDispositionActivity</a>|
|[ownerId](#ownerId)|Owner Id|<a href="LeadDispositionActivity.md" target="_blank">automotive/LeadDispositionActivity</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="LeadDispositionActivity.md" target="_blank">automotive/LeadDispositionActivity</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="LeadDispositionActivity.md" target="_blank">automotive/LeadDispositionActivity</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="LeadDispositionActivity.md" target="_blank">automotive/LeadDispositionActivity</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="LeadDispositionActivity.md" target="_blank">automotive/LeadDispositionActivity</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="LeadDispositionActivity.md" target="_blank">automotive/LeadDispositionActivity</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="LeadDispositionActivity.md" target="_blank">automotive/LeadDispositionActivity</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="LeadDispositionActivity.md" target="_blank">automotive/LeadDispositionActivity</a>|
|[description](#description)|Description of the lead disposition activity|<a href="LeadDispositionActivity.md" target="_blank">automotive/LeadDispositionActivity</a>|
|[leadDispositionActivityId](#leadDispositionActivityId)|Unique identifier for entity instances|<a href="LeadDispositionActivity.md" target="_blank">automotive/LeadDispositionActivity</a>|
|[name](#name)|Name of the lead disposition activity.|<a href="LeadDispositionActivity.md" target="_blank">automotive/LeadDispositionActivity</a>|
|[stateCode](#stateCode)|Status of the Lead Disposition Activity|<a href="LeadDispositionActivity.md" target="_blank">automotive/LeadDispositionActivity</a>|
|[stateCode_display](#stateCode_display)||<a href="LeadDispositionActivity.md" target="_blank">automotive/LeadDispositionActivity</a>|
|[statusCode](#statusCode)|Reason for the status of the Lead Disposition Activity|<a href="LeadDispositionActivity.md" target="_blank">automotive/LeadDispositionActivity</a>|
|[statusCode_display](#statusCode_display)||<a href="LeadDispositionActivity.md" target="_blank">automotive/LeadDispositionActivity</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: automotive/LeadDispositionActivity (this entity)  
...
Description of the lead disposition activity  
First included in: automotive/LeadDispositionActivity (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Description</td></tr><tr><td>description</td><td>Description of the lead disposition activity</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>2000</td></tr><tr><td>sourceName</td><td>msauto_description</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Description of the lead disposition activity</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.dataFormat.character**  
**is.dataFormat.array**  
</details>

### <a href=#leadDispositionActivityId name="leadDispositionActivityId">leadDispositionActivityId</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Lead Disposition Activity</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>sourceName</td><td>msauto_leaddispositionactivityid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the leadDispositionActivityId attribute are listed below.</summary>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in Common Data Service for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msauto_leaddispositionactivityid"</td><td>string</td><td></td></tr></table>
...
Name of the lead disposition activity.  
First included in: automotive/LeadDispositionActivity (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Name</td></tr><tr><td>description</td><td>Name of the lead disposition activity.</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>100</td></tr><tr><td>sourceName</td><td>msauto_name</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Name of the lead disposition activity.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
Status of the Lead Disposition Activity  
First included in: automotive/LeadDispositionActivity (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Lead Disposition Activity</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the Lead Disposition Activity</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
Reason for the status of the Lead Disposition Activity  
First included in: automotive/LeadDispositionActivity (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Lead Disposition Activity</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the Lead Disposition Activity</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
