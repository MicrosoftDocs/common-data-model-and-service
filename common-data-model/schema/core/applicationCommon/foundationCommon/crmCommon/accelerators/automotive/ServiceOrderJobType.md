...
Type of service job that is performed frequently and should follow a standard procedure.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/automotive/ServiceOrderJobType.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in Common Data Model entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/core/applicationCommon/foundationCommon<br>/crmCommon/accelerators/automotive<br>/ServiceOrderJobType.cdm.json/ServiceOrderJobType<br>/hasAttributes/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[ServiceOrderJobType/(resolvedAttributes)/serviceOrderJobTypeId](#serviceOrderJobTypeId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[ServiceOrderJobType/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Service Order Job Type</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Type of service job that is performed frequently and should follow a standard procedure.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
  the unique name that identifies this object in Common Data Service for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msauto_serviceorderjobtype"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="ServiceOrderJobType.md" target="_blank">automotive/ServiceOrderJobType</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="ServiceOrderJobType.md" target="_blank">automotive/ServiceOrderJobType</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="ServiceOrderJobType.md" target="_blank">automotive/ServiceOrderJobType</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="ServiceOrderJobType.md" target="_blank">automotive/ServiceOrderJobType</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="ServiceOrderJobType.md" target="_blank">automotive/ServiceOrderJobType</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="ServiceOrderJobType.md" target="_blank">automotive/ServiceOrderJobType</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="ServiceOrderJobType.md" target="_blank">automotive/ServiceOrderJobType</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="ServiceOrderJobType.md" target="_blank">automotive/ServiceOrderJobType</a>|
|[ownerId](#ownerId)|Owner Id|<a href="ServiceOrderJobType.md" target="_blank">automotive/ServiceOrderJobType</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="ServiceOrderJobType.md" target="_blank">automotive/ServiceOrderJobType</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="ServiceOrderJobType.md" target="_blank">automotive/ServiceOrderJobType</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="ServiceOrderJobType.md" target="_blank">automotive/ServiceOrderJobType</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="ServiceOrderJobType.md" target="_blank">automotive/ServiceOrderJobType</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="ServiceOrderJobType.md" target="_blank">automotive/ServiceOrderJobType</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="ServiceOrderJobType.md" target="_blank">automotive/ServiceOrderJobType</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="ServiceOrderJobType.md" target="_blank">automotive/ServiceOrderJobType</a>|
|[description](#description)|Description of the service order job type.|<a href="ServiceOrderJobType.md" target="_blank">automotive/ServiceOrderJobType</a>|
|[deviceInspectionChecklistId](#deviceInspectionChecklistId)|Inspection checklist associated to this service order job type.|<a href="ServiceOrderJobType.md" target="_blank">automotive/ServiceOrderJobType</a>|
|[name](#name)|Name of the service order job type.|<a href="ServiceOrderJobType.md" target="_blank">automotive/ServiceOrderJobType</a>|
|[number](#number)|Unique number for this service order job type.|<a href="ServiceOrderJobType.md" target="_blank">automotive/ServiceOrderJobType</a>|
|[serviceOrderJobTypeId](#serviceOrderJobTypeId)|Unique identifier for entity instances|<a href="ServiceOrderJobType.md" target="_blank">automotive/ServiceOrderJobType</a>|
|[type](#type)|Type of job (manufacturer, distributor, dealer or customer). |<a href="ServiceOrderJobType.md" target="_blank">automotive/ServiceOrderJobType</a>|
|[type_display](#type_display)||<a href="ServiceOrderJobType.md" target="_blank">automotive/ServiceOrderJobType</a>|
|[stateCode](#stateCode)|Status of the Service Order Job Type|<a href="ServiceOrderJobType.md" target="_blank">automotive/ServiceOrderJobType</a>|
|[stateCode_display](#stateCode_display)||<a href="ServiceOrderJobType.md" target="_blank">automotive/ServiceOrderJobType</a>|
|[statusCode](#statusCode)|Reason for the status of the Service Order Job Type|<a href="ServiceOrderJobType.md" target="_blank">automotive/ServiceOrderJobType</a>|
|[statusCode_display](#statusCode_display)||<a href="ServiceOrderJobType.md" target="_blank">automotive/ServiceOrderJobType</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: automotive/ServiceOrderJobType (this entity)  
...
Description of the service order job type.  
First included in: automotive/ServiceOrderJobType (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Description</td></tr><tr><td>description</td><td>Description of the service order job type.</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>2000</td></tr><tr><td>sourceName</td><td>msauto_description</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Description of the service order job type.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
Inspection checklist associated to this service order job type.  
First included in: automotive/ServiceOrderJobType (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Device Inspection Checklist</td></tr><tr><td>description</td><td>Inspection checklist associated to this service order job type.</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>sourceName</td><td>msauto_deviceinspectionchecklistid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the deviceInspectionChecklistId attribute are listed below.</summary>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Device Inspection Checklist</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Inspection checklist associated to this service order job type.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="DeviceInspectionChecklist.md" target="_blank">/core/applicationCommon/foundationCommon/crmCommon/accelerators/automotive/DeviceInspectionChecklist.cdm.json/DeviceInspectionChecklist</a></td><td><a href="DeviceInspectionChecklist.md#deviceInspectionChecklistId" target="_blank">deviceInspectionChecklistId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>

**is.CDS.sourceNamed**  
the unique name that identifies this object in Common Data Service for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msauto_deviceinspectionchecklistid"</td><td>string</td><td></td></tr></table>
...
Name of the service order job type.  
First included in: automotive/ServiceOrderJobType (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Name</td></tr><tr><td>description</td><td>Name of the service order job type.</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>100</td></tr><tr><td>sourceName</td><td>msauto_name</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Name of the service order job type.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
Unique number for this service order job type.  
First included in: automotive/ServiceOrderJobType (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Number</td></tr><tr><td>description</td><td>Unique number for this service order job type.</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>100</td></tr><tr><td>sourceName</td><td>msauto_number</td></tr></table>
...
**is.dataFormat.array**  
**is.CDS.sourceNamed**  
the unique name that identifies this object in Common Data Service for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msauto_number"</td><td>string</td><td></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Unique number for this service order job type.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Service Order Job Type</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>sourceName</td><td>msauto_serviceorderjobtypeid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the serviceOrderJobTypeId attribute are listed below.</summary>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in Common Data Service for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msauto_serviceorderjobtypeid"</td><td>string</td><td></td></tr></table>
...
Type of job (manufacturer, distributor, dealer or customer).   
First included in: automotive/ServiceOrderJobType (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Type</td></tr><tr><td>description</td><td>Type of job (manufacturer, distributor, dealer or customer). </td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>sourceName</td><td>msauto_type</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr></tr><tr></tr><tr></tr><tr></tr><tr></tr></table></td></tr></table>
...
**is.dataFormat.integer**  
**does.haveDefault**  
An attribute has a default value  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>default</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>OEM</td><td>972230000</td></tr><tr><td>en</td><td>Distributor</td><td>972230001</td></tr><tr><td>en</td><td>Dealer</td><td>972230002</td></tr><tr><td>en</td><td>Custom</td><td>972230003</td></tr></table></td><td>any</td><td></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Type of job (manufacturer, distributor, dealer or customer). </td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
Status of the Service Order Job Type  
First included in: automotive/ServiceOrderJobType (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Service Order Job Type</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the Service Order Job Type</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
Reason for the status of the Service Order Job Type  
First included in: automotive/ServiceOrderJobType (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Service Order Job Type</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the Service Order Job Type</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
