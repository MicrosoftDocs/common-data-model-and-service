...
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="Fax.md" target="_blank">crmCommon/Fax</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="Fax.md" target="_blank">crmCommon/Fax</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="Fax.md" target="_blank">crmCommon/Fax</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="Fax.md" target="_blank">crmCommon/Fax</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="Fax.md" target="_blank">crmCommon/Fax</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="Fax.md" target="_blank">crmCommon/Fax</a>|
|[ownerId](#ownerId)|Owner Id|<a href="Fax.md" target="_blank">crmCommon/Fax</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="Fax.md" target="_blank">crmCommon/Fax</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="Fax.md" target="_blank">crmCommon/Fax</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="Fax.md" target="_blank">crmCommon/Fax</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="Fax.md" target="_blank">crmCommon/Fax</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="Fax.md" target="_blank">crmCommon/Fax</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="Fax.md" target="_blank">crmCommon/Fax</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="Fax.md" target="_blank">crmCommon/Fax</a>|
|[activityId](#activityId)|Unique identifier of the activity.|<a href="Fax.md" target="_blank">crmCommon/Fax</a>|
|[activityTypeCode](#activityTypeCode)|Type of activity.|<a href="Fax.md" target="_blank">crmCommon/Fax</a>|
|[isBilled](#isBilled)|Information regarding whether the fax activity was billed as part of resolving a case.|<a href="Fax.md" target="_blank">crmCommon/Fax</a>|
|[isRegularActivity](#isRegularActivity)|Information regarding whether the activity is a regular activity type or event type.|<a href="Fax.md" target="_blank">crmCommon/Fax</a>|
|[isWorkflowCreated](#isWorkflowCreated)|Information regarding whether the activity was created from a workflow rule.|<a href="Fax.md" target="_blank">crmCommon/Fax</a>|
|[priorityCode](#priorityCode)|Priority of the activity.|<a href="Fax.md" target="_blank">crmCommon/Fax</a>|
|[priorityCode_display](#priorityCode_display)||<a href="Fax.md" target="_blank">crmCommon/Fax</a>|
|[regardingObjectId](#regardingObjectId)|Unique identifier of the object with which the activity is associated.|<a href="Fax.md" target="_blank">crmCommon/Fax</a>|
|[regardingObjectTypeCode](#regardingObjectTypeCode)|The name of the entity linked by regardingObjectId|<a href="Fax.md" target="_blank">crmCommon/Fax</a>|
|[scheduledEnd](#scheduledEnd)|Scheduled end time of the activity.|<a href="Fax.md" target="_blank">crmCommon/Fax</a>|
|[scheduledStart](#scheduledStart)|Scheduled start time of the activity.|<a href="Fax.md" target="_blank">crmCommon/Fax</a>|
|[sortDate](#sortDate)|Shows the date and time by which the activities are sorted.|<a href="Fax.md" target="_blank">crmCommon/Fax</a>|
|[subject](#subject)|Subject associated with the activity.|<a href="Fax.md" target="_blank">crmCommon/Fax</a>|
|[scheduledDurationMinutes](#scheduledDurationMinutes)|Scheduled duration of the activity, specified in minutes.|<a href="Fax.md" target="_blank">crmCommon/Fax</a>|
|[actualDurationMinutes](#actualDurationMinutes)|Actual duration of the activity in minutes.|<a href="Fax.md" target="_blank">crmCommon/Fax</a>|
|[actualEnd](#actualEnd)|Actual end time of the activity.|<a href="Fax.md" target="_blank">crmCommon/Fax</a>|
|[actualStart](#actualStart)|Actual start time of the activity.|<a href="Fax.md" target="_blank">crmCommon/Fax</a>|
|[category](#category)|Type a category to identify the activity type, such as lead outreach, customer follow-up, or service alert, to tie the eactivity to a business group or function.|<a href="Fax.md" target="_blank">crmCommon/Fax</a>|
|[subcategory](#subcategory)|Type a subcategory to identify the activity type and relate the activity to a specific product, sales region, business group, or other function.|<a href="Fax.md" target="_blank">crmCommon/Fax</a>|
|[to](#to)|Enter the account, contact, lead, queue, or user recipients for the fax.|<a href="Fax.md" target="_blank">crmCommon/Fax</a>|
|[from](#from)|Enter the account, contact, lead, queue, or user who sent the fax.|<a href="Fax.md" target="_blank">crmCommon/Fax</a>|
|[directionCode](#directionCode)|Select the direction of the activity as incoming or outbound.|<a href="Fax.md" target="_blank">crmCommon/Fax</a>|
|[coverPageName](#coverPageName)|Type the name of the cover page to use when sending the fax.|<a href="Fax.md" target="_blank">crmCommon/Fax</a>|
|[billingCode](#billingCode)|Type the billing code for the fax to make sure the fax is charged to the correct sender or customer account.|<a href="Fax.md" target="_blank">crmCommon/Fax</a>|
|[stateCode](#stateCode)|Shows whether the fax activity is open, completed, or canceled. Completed and canceled fax activities are read-only and can't be edited.|<a href="Fax.md" target="_blank">crmCommon/Fax</a>|
|[stateCode_display](#stateCode_display)||<a href="Fax.md" target="_blank">crmCommon/Fax</a>|
|[numberOfPages](#numberOfPages)|Type the number of pages included in the fax.|<a href="Fax.md" target="_blank">crmCommon/Fax</a>|
|[description](#description)|Type additional information to describe the fax, such as the primary message or the products and services featured.|<a href="Fax.md" target="_blank">crmCommon/Fax</a>|
|[faxNumber](#faxNumber)|Type the recipient's fax number.|<a href="Fax.md" target="_blank">crmCommon/Fax</a>|
|[tsid](#tsid)|Type the Transmitting Subscriber ID (TSID) associated with a send action. This is typically a combination of the recipient's fax or phone number and company name.|<a href="Fax.md" target="_blank">crmCommon/Fax</a>|
|[statusCode](#statusCode)|Select the fax's status.|<a href="Fax.md" target="_blank">crmCommon/Fax</a>|
|[statusCode_display](#statusCode_display)||<a href="Fax.md" target="_blank">crmCommon/Fax</a>|
|[transactionCurrencyId](#transactionCurrencyId)|Choose the local currency for the record to make sure budgets are reported in the correct currency.|<a href="Fax.md" target="_blank">crmCommon/Fax</a>|
|[exchangeRate](#exchangeRate)|Shows the conversion rate of the record's currency. The exchange rate is used to convert all money fields in the record from the local currency to the system's default currency.|<a href="Fax.md" target="_blank">crmCommon/Fax</a>|
|[processId](#processId)|Shows the ID of the process.|<a href="Fax.md" target="_blank">crmCommon/Fax</a>|
|[stageId](#stageId)|Shows the ID of the stage.|<a href="Fax.md" target="_blank">crmCommon/Fax</a>|
|[traversedPath](#traversedPath)|For internal use only.|<a href="Fax.md" target="_blank">crmCommon/Fax</a>|
|[SLAId](#SLAId)|Choose the service level agreement (SLA) that you want to apply to the fax record.|<a href="Fax.md" target="_blank">crmCommon/Fax</a>|
|[SLAInvokedId](#SLAInvokedId)|Last SLA that was applied to this fax. This field is for internal use only.|<a href="Fax.md" target="_blank">crmCommon/Fax</a>|
|[onHoldTime](#onHoldTime)|Shows how long, in minutes, that the record was on hold.|<a href="Fax.md" target="_blank">crmCommon/Fax</a>|
|[lastOnHoldTime](#lastOnHoldTime)|Contains the date and time stamp of the last on hold time.|<a href="Fax.md" target="_blank">crmCommon/Fax</a>|
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Call To</td></tr><tr><td>description</td><td>Enter the account, contact, lead, queue, or user recipients for the fax.</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>to</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>The account, contact, lead, queue, or user recipients for the activity.</td></tr><tr><td>en</td><td>Enter the account, contact, lead, or user recipients of the phone call.</td></tr><tr><td>en</td><td>Enter the account, contact, lead, queue, or user recipients for the email.</td></tr><tr><td>en</td><td>Enter the account, contact, lead, queue, or user recipients for the fax.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>From</td></tr><tr><td>description</td><td>Enter the account, contact, lead, queue, or user who sent the fax.</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>from</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>The sender of the activity.</td></tr><tr><td>en</td><td>Enter the account, contact, lead, queue, or user who sent the fax.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
