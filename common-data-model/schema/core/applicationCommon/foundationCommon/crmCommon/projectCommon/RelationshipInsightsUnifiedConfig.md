---
title: RelationshipInsightsUnifiedConfig in projectCommon - Common Data Model | Microsoft Docs
...
# msdyn_relationshipinsightsunifiedconfig in projectCommon(RelationshipInsightsUnifiedConfig)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/projectCommon/RelationshipInsightsUnifiedConfig.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/core/applicationCommon/foundationCommon<br>/crmCommon/projectCommon<br>/RelationshipInsightsUnifiedConfig.cdm.json<br>/RelationshipInsightsUnifiedConfig/hasAttributes<br>/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[RelationshipInsightsUnifiedConfig/(resolvedAttributes)/relationshipInsightsUnifiedConfigId](#relationshipInsightsUnifiedConfigId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[RelationshipInsightsUnifiedConfig/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>msdyn_relationshipinsightsunifiedconfig</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_relationshipinsightsunifiedconfig"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="RelationshipInsightsUnifiedConfig.md" target="_blank">projectCommon/RelationshipInsightsUnifiedConfig</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="RelationshipInsightsUnifiedConfig.md" target="_blank">projectCommon/RelationshipInsightsUnifiedConfig</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="RelationshipInsightsUnifiedConfig.md" target="_blank">projectCommon/RelationshipInsightsUnifiedConfig</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="RelationshipInsightsUnifiedConfig.md" target="_blank">projectCommon/RelationshipInsightsUnifiedConfig</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="RelationshipInsightsUnifiedConfig.md" target="_blank">projectCommon/RelationshipInsightsUnifiedConfig</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="RelationshipInsightsUnifiedConfig.md" target="_blank">projectCommon/RelationshipInsightsUnifiedConfig</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="RelationshipInsightsUnifiedConfig.md" target="_blank">projectCommon/RelationshipInsightsUnifiedConfig</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="RelationshipInsightsUnifiedConfig.md" target="_blank">projectCommon/RelationshipInsightsUnifiedConfig</a>|
|[ownerId](#ownerId)|Owner Id|<a href="RelationshipInsightsUnifiedConfig.md" target="_blank">projectCommon/RelationshipInsightsUnifiedConfig</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="RelationshipInsightsUnifiedConfig.md" target="_blank">projectCommon/RelationshipInsightsUnifiedConfig</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="RelationshipInsightsUnifiedConfig.md" target="_blank">projectCommon/RelationshipInsightsUnifiedConfig</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="RelationshipInsightsUnifiedConfig.md" target="_blank">projectCommon/RelationshipInsightsUnifiedConfig</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="RelationshipInsightsUnifiedConfig.md" target="_blank">projectCommon/RelationshipInsightsUnifiedConfig</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="RelationshipInsightsUnifiedConfig.md" target="_blank">projectCommon/RelationshipInsightsUnifiedConfig</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="RelationshipInsightsUnifiedConfig.md" target="_blank">projectCommon/RelationshipInsightsUnifiedConfig</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="RelationshipInsightsUnifiedConfig.md" target="_blank">projectCommon/RelationshipInsightsUnifiedConfig</a>|
|[relationshipInsightsUnifiedConfigId](#relationshipInsightsUnifiedConfigId)|Unique identifier for entity instances|<a href="RelationshipInsightsUnifiedConfig.md" target="_blank">projectCommon/RelationshipInsightsUnifiedConfig</a>|
|[stateCode](#stateCode)|Status of the msdyn_relationshipinsightsunifiedconfig|<a href="RelationshipInsightsUnifiedConfig.md" target="_blank">projectCommon/RelationshipInsightsUnifiedConfig</a>|
|[stateCode_display](#stateCode_display)||<a href="RelationshipInsightsUnifiedConfig.md" target="_blank">projectCommon/RelationshipInsightsUnifiedConfig</a>|
|[statusCode](#statusCode)|Reason for the status of the msdyn_relationshipinsightsunifiedconfig|<a href="RelationshipInsightsUnifiedConfig.md" target="_blank">projectCommon/RelationshipInsightsUnifiedConfig</a>|
|[statusCode_display](#statusCode_display)||<a href="RelationshipInsightsUnifiedConfig.md" target="_blank">projectCommon/RelationshipInsightsUnifiedConfig</a>|
|[newName](#newName)|The name of the custom entity.|<a href="RelationshipInsightsUnifiedConfig.md" target="_blank">projectCommon/RelationshipInsightsUnifiedConfig</a>|
|[useNewConfigExperience](#useNewConfigExperience)||<a href="RelationshipInsightsUnifiedConfig.md" target="_blank">projectCommon/RelationshipInsightsUnifiedConfig</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: projectCommon/RelationshipInsightsUnifiedConfig (this entity)  
...
### <a href=#relationshipInsightsUnifiedConfigId name="relationshipInsightsUnifiedConfigId">relationshipInsightsUnifiedConfigId</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>msdyn_relationshipinsightsunifiedconfig</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>sourceName</td><td>msdyn_relationshipinsightsunifiedconfigid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the relationshipInsightsUnifiedConfigId attribute are listed below.</summary>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_relationshipinsightsunifiedconfigid"</td><td>string</td><td></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the msdyn_relationshipinsightsunifiedconfig</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the msdyn_relationshipinsightsunifiedconfig</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
### <a href=#newName name="newName">newName</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Name</td></tr><tr><td>description</td><td>The name of the custom entity.</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>100</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>new_name</td></tr></table>

#### Traits

<details>
<summary>List of traits for the newName attribute are listed below.</summary>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"new_name"</td><td>string</td><td></td></tr></table>
...
### <a href=#useNewConfigExperience name="useNewConfigExperience">useNewConfigExperience</a>

First included in: projectCommon/RelationshipInsightsUnifiedConfig (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>msdyn_usenewconfigexperience</td></tr><tr><td>dataFormat</td><td>boolean</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyn_usenewconfigexperience</td></tr></table>

#### Traits

<details>
<summary>List of traits for the useNewConfigExperience attribute are listed below.</summary>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>msdyn_usenewconfigexperience</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.nullable**  
The attribute value may be set to NULL.  

**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_usenewconfigexperience"</td><td>string</td><td></td></tr></table>
