...
- /crmCommon/projectCommon/projectServiceAutomation/PriceList  
...
|---|---|---|
|[priceLevelId](#priceLevelId)|Unique identifier of the price list.|<a href="PriceList.md" target="_blank">projectServiceAutomation/PriceList</a>|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="PriceList.md" target="_blank">projectServiceAutomation/PriceList</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the price list.|<a href="PriceList.md" target="_blank">projectServiceAutomation/PriceList</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="PriceList.md" target="_blank">projectServiceAutomation/PriceList</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who last modified the price list.|<a href="PriceList.md" target="_blank">projectServiceAutomation/PriceList</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the pricelevel.|<a href="PriceList.md" target="_blank">projectServiceAutomation/PriceList</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who last modified the pricelevel.|<a href="PriceList.md" target="_blank">projectServiceAutomation/PriceList</a>|
|[organizationId](#organizationId)|Unique identifier for the organization|<a href="PriceList.md" target="_blank">projectServiceAutomation/PriceList</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="PriceList.md" target="_blank">projectServiceAutomation/PriceList</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="PriceList.md" target="_blank">projectServiceAutomation/PriceList</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="PriceList.md" target="_blank">projectServiceAutomation/PriceList</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="PriceList.md" target="_blank">projectServiceAutomation/PriceList</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="PriceList.md" target="_blank">projectServiceAutomation/PriceList</a>|
|[name](#name)|Name of the price list.|<a href="PriceList.md" target="_blank">projectServiceAutomation/PriceList</a>|
|[beginDate](#beginDate)|Date on which the price list becomes effective.|<a href="PriceList.md" target="_blank">projectServiceAutomation/PriceList</a>|
|[description](#description)|Description of the price list.|<a href="PriceList.md" target="_blank">projectServiceAutomation/PriceList</a>|
|[endDate](#endDate)|Date that is the last day the price list is valid.|<a href="PriceList.md" target="_blank">projectServiceAutomation/PriceList</a>|
|[freightTermsCode](#freightTermsCode)|Freight terms for the price list.|<a href="PriceList.md" target="_blank">projectServiceAutomation/PriceList</a>|
|[freightTermsCode_display](#freightTermsCode_display)||<a href="PriceList.md" target="_blank">projectServiceAutomation/PriceList</a>|
|[paymentMethodCode](#paymentMethodCode)|Payment terms to use with the price list.|<a href="PriceList.md" target="_blank">projectServiceAutomation/PriceList</a>|
|[paymentMethodCode_display](#paymentMethodCode_display)||<a href="PriceList.md" target="_blank">projectServiceAutomation/PriceList</a>|
|[shippingMethodCode](#shippingMethodCode)|Method of shipment for products in the price list.|<a href="PriceList.md" target="_blank">projectServiceAutomation/PriceList</a>|
|[shippingMethodCode_display](#shippingMethodCode_display)||<a href="PriceList.md" target="_blank">projectServiceAutomation/PriceList</a>|
|[stateCode](#stateCode)|Status of the price list.|<a href="PriceList.md" target="_blank">projectServiceAutomation/PriceList</a>|
|[stateCode_display](#stateCode_display)||<a href="PriceList.md" target="_blank">projectServiceAutomation/PriceList</a>|
|[statusCode](#statusCode)|Reason for the status of the price list.|<a href="PriceList.md" target="_blank">projectServiceAutomation/PriceList</a>|
|[statusCode_display](#statusCode_display)||<a href="PriceList.md" target="_blank">projectServiceAutomation/PriceList</a>|
|[exchangeRate](#exchangeRate)|Shows the conversion rate of the record's currency. The exchange rate is used to convert all money fields in the record from the local currency to the system's default currency.|<a href="PriceList.md" target="_blank">projectServiceAutomation/PriceList</a>|
|[transactionCurrencyId](#transactionCurrencyId)|Unique identifier of the currency associated with the price level.|<a href="PriceList.md" target="_blank">projectServiceAutomation/PriceList</a>|
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Copied From</td></tr><tr><td>description</td><td>Shows the price level that this price level was copied from.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyn_copiedfrompricelevel</td></tr></table>

#### Traits

<details>
<summary>List of traits for the copiedFromPriceLevel attribute are listed below.</summary>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Copied From</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Shows the price level that this price level was copied from.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.nullable**  
The attribute value may be set to NULL.  

**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_copiedfrompricelevel"</td><td>string</td><td></td></tr></table>
...
**is.dataFormat.integer**  
**does.haveDefault**  
An attribute has a default value  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>default</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Organization</td><td>192350000</td></tr><tr><td>en</td><td>Customer</td><td>192350001</td></tr><tr><td>en</td><td>Sales document</td><td>192350002</td></tr><tr><td>en</td><td>Project</td><td>192350003</td></tr></table></td><td>any</td><td></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Select the entity for this price level.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<details>
<summary>List of traits for the entity_display attribute are listed below.</summary>
...
**is.readOnly**  
**is.addedInSupportOf**  
<table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>inSupportOf</td><td>"entity"</td><td>attributeName</td><td>output parameter naming the attribute that is being supported</td></tr></table>
...
**is.dataFormat.integer**  
**does.haveDefault**  
An attribute has a default value  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>default</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Cost</td><td>192350000</td></tr><tr><td>en</td><td>Purchase</td><td>192350001</td></tr><tr><td>en</td><td>Sales</td><td>192350002</td></tr></table></td><td>any</td><td></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Select the context for this price level i.e whether it is sales prices, cost prices or purchase prices</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.nullable**  
The attribute value may be set to NULL.  

**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_module"</td><td>string</td><td></td></tr></table>
...
<details>
<summary>List of traits for the module_display attribute are listed below.</summary>
...
**is.readOnly**  
**is.addedInSupportOf**  
<table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>inSupportOf</td><td>"module"</td><td>attributeName</td><td>output parameter naming the attribute that is being supported</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Time Unit</td></tr><tr><td>description</td><td>Select the default unit of role based time on this price list</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyn_timeunit</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Select the default unit of role based time on this price list</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.nullable**  
The attribute value may be set to NULL.  

**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_timeunit"</td><td>string</td><td></td></tr></table>
