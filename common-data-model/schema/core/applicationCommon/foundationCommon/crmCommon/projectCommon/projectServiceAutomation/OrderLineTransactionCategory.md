---
title: OrderLineTransactionCategory in projectServiceAutomation - Common Data Model | Microsoft Docs
description: List of transaction categories that will be considered as costs when computing the profit of a project contract line.
author: nenad1002
...
# Project Contract Line Transaction Category in projectServiceAutomation(OrderLineTransactionCategory)

List of transaction categories that will be considered as costs when computing the profit of a project contract line.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/projectCommon/projectServiceAutomation/OrderLineTransactionCategory.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/core/applicationCommon/foundationCommon<br>/crmCommon/projectCommon/projectServiceAutomation<br>/OrderLineTransactionCategory.cdm.json<br>/OrderLineTransactionCategory/hasAttributes<br>/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[OrderLineTransactionCategory/(resolvedAttributes)/orderLineTransactionCategoryId](#orderLineTransactionCategoryId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[OrderLineTransactionCategory/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Project Contract Line Transaction Category</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_orderlinetransactioncategory"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="OrderLineTransactionCategory.md" target="_blank">projectServiceAutomation/OrderLineTransactionCategory</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="OrderLineTransactionCategory.md" target="_blank">projectServiceAutomation/OrderLineTransactionCategory</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="OrderLineTransactionCategory.md" target="_blank">projectServiceAutomation/OrderLineTransactionCategory</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="OrderLineTransactionCategory.md" target="_blank">projectServiceAutomation/OrderLineTransactionCategory</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="OrderLineTransactionCategory.md" target="_blank">projectServiceAutomation/OrderLineTransactionCategory</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="OrderLineTransactionCategory.md" target="_blank">projectServiceAutomation/OrderLineTransactionCategory</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="OrderLineTransactionCategory.md" target="_blank">projectServiceAutomation/OrderLineTransactionCategory</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="OrderLineTransactionCategory.md" target="_blank">projectServiceAutomation/OrderLineTransactionCategory</a>|
|[ownerId](#ownerId)|Owner Id|<a href="OrderLineTransactionCategory.md" target="_blank">projectServiceAutomation/OrderLineTransactionCategory</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="OrderLineTransactionCategory.md" target="_blank">projectServiceAutomation/OrderLineTransactionCategory</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="OrderLineTransactionCategory.md" target="_blank">projectServiceAutomation/OrderLineTransactionCategory</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="OrderLineTransactionCategory.md" target="_blank">projectServiceAutomation/OrderLineTransactionCategory</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="OrderLineTransactionCategory.md" target="_blank">projectServiceAutomation/OrderLineTransactionCategory</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="OrderLineTransactionCategory.md" target="_blank">projectServiceAutomation/OrderLineTransactionCategory</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="OrderLineTransactionCategory.md" target="_blank">projectServiceAutomation/OrderLineTransactionCategory</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="OrderLineTransactionCategory.md" target="_blank">projectServiceAutomation/OrderLineTransactionCategory</a>|
|[orderLineTransactionCategoryId](#orderLineTransactionCategoryId)|Shows the entity instances.|<a href="OrderLineTransactionCategory.md" target="_blank">projectServiceAutomation/OrderLineTransactionCategory</a>|
|[stateCode](#stateCode)|Status of the Project Contract Line Transaction Category|<a href="OrderLineTransactionCategory.md" target="_blank">projectServiceAutomation/OrderLineTransactionCategory</a>|
|[stateCode_display](#stateCode_display)||<a href="OrderLineTransactionCategory.md" target="_blank">projectServiceAutomation/OrderLineTransactionCategory</a>|
|[statusCode](#statusCode)|Reason for the status of the Project Contract Line Transaction Category|<a href="OrderLineTransactionCategory.md" target="_blank">projectServiceAutomation/OrderLineTransactionCategory</a>|
|[statusCode_display](#statusCode_display)||<a href="OrderLineTransactionCategory.md" target="_blank">projectServiceAutomation/OrderLineTransactionCategory</a>|
|[description](#description)|Type the name of the custom entity.|<a href="OrderLineTransactionCategory.md" target="_blank">projectServiceAutomation/OrderLineTransactionCategory</a>|
|[billingType](#billingType)|Select whether this category will be charged to the customer or not. Only transactions logged for chargeable categories will add to the invoice total|<a href="OrderLineTransactionCategory.md" target="_blank">projectServiceAutomation/OrderLineTransactionCategory</a>|
|[billingType_display](#billingType_display)||<a href="OrderLineTransactionCategory.md" target="_blank">projectServiceAutomation/OrderLineTransactionCategory</a>|
|[contractLine](#contractLine)|(Deprecated) Project contract line corresponding to this record.|<a href="OrderLineTransactionCategory.md" target="_blank">projectServiceAutomation/OrderLineTransactionCategory</a>|
|[contractLineId](#contractLineId)|Unique identifier for Project Contract Line associated with Project Contract Line Transaction Category.|<a href="OrderLineTransactionCategory.md" target="_blank">projectServiceAutomation/OrderLineTransactionCategory</a>|
|[contractLineTransactionClassification](#contractLineTransactionClassification)|Select the transaction classification on the project contract line. Four broad classifications are supported: Select the time, Expense, Material, and Fee.|<a href="OrderLineTransactionCategory.md" target="_blank">projectServiceAutomation/OrderLineTransactionCategory</a>|
|[transactionCategory](#transactionCategory)|Transaction category of the Project Contract line transaction|<a href="OrderLineTransactionCategory.md" target="_blank">projectServiceAutomation/OrderLineTransactionCategory</a>|
|[transactionClassification](#transactionClassification)|Transaction type corresponding to this record|<a href="OrderLineTransactionCategory.md" target="_blank">projectServiceAutomation/OrderLineTransactionCategory</a>|
|[transactionClassification_display](#transactionClassification_display)||<a href="OrderLineTransactionCategory.md" target="_blank">projectServiceAutomation/OrderLineTransactionCategory</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: projectServiceAutomation/OrderLineTransactionCategory (this entity)  
...
### <a href=#orderLineTransactionCategoryId name="orderLineTransactionCategoryId">orderLineTransactionCategoryId</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Project Contract Line Transaction Category</td></tr><tr><td>description</td><td>Shows the entity instances.</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>sourceName</td><td>msdyn_orderlinetransactioncategoryid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the orderLineTransactionCategoryId attribute are listed below.</summary>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_orderlinetransactioncategoryid"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Project Contract Line Transaction Category</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the Project Contract Line Transaction Category</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the Project Contract Line Transaction Category</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Select whether this category will be charged to the customer or not. Only transactions logged for chargeable categories will add to the invoice total</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Project Contract Line</td></tr><tr><td>description</td><td>Unique identifier for Project Contract Line associated with Project Contract Line Transaction Category.</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyn_contractlineid</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Unique identifier for Project Contract Line associated with Project Contract Line Transaction Category.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Select the transaction classification on the project contract line. Four broad classifications are supported: Select the time, Expense, Material, and Fee.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Transaction category of the Project Contract line transaction</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
