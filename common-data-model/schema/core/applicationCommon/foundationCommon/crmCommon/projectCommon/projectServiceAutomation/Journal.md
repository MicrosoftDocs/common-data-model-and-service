---
title: Journal - Common Data Model | Microsoft Docs
...
Unposted business transactions, for example, time and expense.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/projectCommon/projectServiceAutomation/Journal.cdm.json" target="_blank">GitHub</a>.  

## Instances

Instances of this entity are listed below.  

- /crmCommon/projectCommon/projectServiceAutomation/Journal  
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Unposted business transactions, for example, time and expense.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="Journal.md" target="_blank">projectServiceAutomation/Journal</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="Journal.md" target="_blank">projectServiceAutomation/Journal</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="Journal.md" target="_blank">projectServiceAutomation/Journal</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="Journal.md" target="_blank">projectServiceAutomation/Journal</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="Journal.md" target="_blank">projectServiceAutomation/Journal</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="Journal.md" target="_blank">projectServiceAutomation/Journal</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="Journal.md" target="_blank">projectServiceAutomation/Journal</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="Journal.md" target="_blank">projectServiceAutomation/Journal</a>|
|[ownerId](#ownerId)|Owner Id|<a href="Journal.md" target="_blank">projectServiceAutomation/Journal</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="Journal.md" target="_blank">projectServiceAutomation/Journal</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="Journal.md" target="_blank">projectServiceAutomation/Journal</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="Journal.md" target="_blank">projectServiceAutomation/Journal</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="Journal.md" target="_blank">projectServiceAutomation/Journal</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="Journal.md" target="_blank">projectServiceAutomation/Journal</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="Journal.md" target="_blank">projectServiceAutomation/Journal</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="Journal.md" target="_blank">projectServiceAutomation/Journal</a>|
|[journalId](#journalId)|Unique identifier for entity instances|<a href="Journal.md" target="_blank">projectServiceAutomation/Journal</a>|
|[stateCode](#stateCode)|Status of the Journal|<a href="Journal.md" target="_blank">projectServiceAutomation/Journal</a>|
|[stateCode_display](#stateCode_display)||<a href="Journal.md" target="_blank">projectServiceAutomation/Journal</a>|
|[statusCode](#statusCode)|Reason for the status of the Journal|<a href="Journal.md" target="_blank">projectServiceAutomation/Journal</a>|
|[statusCode_display](#statusCode_display)||<a href="Journal.md" target="_blank">projectServiceAutomation/Journal</a>|
|[description](#description)|The name of the custom entity.|<a href="Journal.md" target="_blank">projectServiceAutomation/Journal</a>|
|[processId](#processId)|Contains the id of the process associated with the entity.|<a href="Journal.md" target="_blank">projectServiceAutomation/Journal</a>|
|[stageId](#stageId)|Contains the id of the stage where the entity is located.|<a href="Journal.md" target="_blank">projectServiceAutomation/Journal</a>|
|[traversedPath](#traversedPath)|A comma separated list of string values representing the unique identifiers of stages in a Business Process Flow Instance in the order that they occur.|<a href="Journal.md" target="_blank">projectServiceAutomation/Journal</a>|
|[defaultProject](#defaultProject)||<a href="Journal.md" target="_blank">projectServiceAutomation/Journal</a>|
|[isPosted](#isPosted)|Shows if the journal has been submitted.|<a href="Journal.md" target="_blank">projectServiceAutomation/Journal</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: projectServiceAutomation/Journal (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Journal</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msdyn_journalid</td></tr></table>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_journalid"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Journal</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the Journal</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Journal</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the Journal</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
### <a href=#defaultProject name="defaultProject">defaultProject</a>

First included in: projectServiceAutomation/Journal (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Default Project</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyn_defaultproject</td></tr></table>

#### Traits

<details>
<summary>List of traits for the defaultProject attribute are listed below.</summary>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Default Project</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.nullable**  
The attribute value may be set to NULL.  

**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_defaultproject"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Is Submitted</td></tr><tr><td>description</td><td>Shows if the journal has been submitted.</td></tr><tr><td>dataFormat</td><td>15</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyn_isposted</td></tr></table>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Is Submitted</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Shows if the journal has been submitted.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
