...
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[ownerId](#ownerId)|Owner Id|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[opportunityId](#opportunityId)|Unique identifier of the opportunity.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[emailAddress](#emailAddress)|The primary email address for the entity.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[name](#name)|Type a subject or descriptive name, such as the expected order or company name, for the opportunity.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[processId](#processId)|Contains the id of the process associated with the entity.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[stageId](#stageId)|Contains the id of the stage where the entity is located.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[traversedPath](#traversedPath)|A comma separated list of string values representing the unique identifiers of stages in a Business Process Flow Instance in the order that they occur.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[actualCloseDate](#actualCloseDate)|Shows the date and time when the opportunity was closed or canceled.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[actualValue](#actualValue)|Type the actual revenue amount for the opportunity for reporting and analysis of estimated versus actual sales. Field defaults to the Est. Revenue value when an opportunity is won.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[transactionCurrencyId](#transactionCurrencyId)|Choose the local currency for the record to make sure budgets are reported in the correct currency.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[exchangeRate](#exchangeRate)|Shows the conversion rate of the record's currency. The exchange rate is used to convert all money fields in the record from the local currency to the system's default currency.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[actualValueBase](#actualValueBase)|Value of the Actual Revenue in base currency.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[budgetAmount](#budgetAmount)|Type a value between 0 and 1,000,000,000,000 to indicate the lead's potential available budget.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[budgetAmountBase](#budgetAmountBase)|Value of the Budget Amount in base currency.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[budgetStatus](#budgetStatus)|Select the likely budget status for the lead's company. This may help determine the lead rating or your sales approach.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[budgetStatus_display](#budgetStatus_display)||<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[closeProbability](#closeProbability)|Type a number from 0 to 100 that represents the likelihood of closing the opportunity. This can aid the sales team in their efforts to convert the opportunity in a sale.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[completeInternalReview](#completeInternalReview)|Select whether an internal review has been completed for this opportunity.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[confirmInterest](#confirmInterest)|Select whether the lead confirmed interest in your offerings. This helps in determining the lead quality and the probability of it turning into an opportunity.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[currentSituation](#currentSituation)|Type notes about the company or organization associated with the opportunity.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[customerId](#customerId)|The customer account or contact to provide a quick link to additional customer details, such as account information, activities, and opportunities.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[customerIdType](#customerIdType)|The type of customer, either Account or Contact.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[customerNeed](#customerNeed)|Type some notes about the customer's requirements, to help the sales team identify products and services that could meet their requirements.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[customerPainPoints](#customerPainPoints)|Type notes about the customer's pain points to help the sales team identify products and services that could address these pain points.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[decisionMaker](#decisionMaker)|Select whether your notes include information about who makes the purchase decisions at the lead's company.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[description](#description)|Type additional information to describe the opportunity, such as possible products to sell or past purchases from the customer.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[developProposal](#developProposal)|Select whether a proposal has been developed for the opportunity.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[discountAmount](#discountAmount)|Type the discount amount for the opportunity if the customer is eligible for special savings.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[discountAmountBase](#discountAmountBase)|Value of the Opportunity Discount Amount in base currency.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[discountPercentage](#discountPercentage)|Type the discount rate that should be applied to the Product Totals field to include additional savings for the customer in the opportunity.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[estimatedCloseDate](#estimatedCloseDate)|Enter the expected closing date of the opportunity to help make accurate revenue forecasts.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[estimatedValue](#estimatedValue)|Type the estimated revenue amount to indicate the potential sale or value of the opportunity for revenue forecasting. This field can be either system-populated or editable based on the selection in the Revenue field.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[estimatedValueBase](#estimatedValueBase)|Value of the Est. Revenue in base currency.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[evaluateFit](#evaluateFit)|Select whether the fit between the lead's requirements and your offerings was evaluated.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[resolveFeedback](#resolveFeedback)|Choose whether the proposal feedback has been captured and resolved for the opportunity.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[fileDebrief](#fileDebrief)|Choose whether the sales team has recorded detailed notes on the proposals and the account's responses.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[completeFinalProposal](#completeFinalProposal)|Select whether a final proposal has been completed for the opportunity.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[finalDecisionDate](#finalDecisionDate)|Enter the date and time when the final decision of the opportunity was made.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[freightAmount](#freightAmount)|Type the cost of freight or shipping for the products included in the opportunity for use in calculating the Total Amount field.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[freightAmountBase](#freightAmountBase)|Value of the Freight Amount in base currency.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[initialCommunication](#initialCommunication)|Choose whether someone from the sales team contacted this lead earlier.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[initialCommunication_display](#initialCommunication_display)||<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[isRevenueSystemCalculated](#isRevenueSystemCalculated)|Select whether the estimated revenue for the opportunity is calculated automatically based on the products entered or entered manually by a user.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[need](#need)|Choose how high the level of need is for the lead's company.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[need_display](#need_display)||<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[opportunityRatingCode](#opportunityRatingCode)|Select the expected value or priority of the opportunity based on revenue, customer status, or closing probability.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[opportunityRatingCode_display](#opportunityRatingCode_display)||<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
...
|[parentContactId](#parentContactId)|Choose a contact to connect this opportunity to, so that the relationship is visible in reports and analytics.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[participatesInWorkflow](#participatesInWorkflow)|Information about whether the opportunity participates in workflow rules.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[priceLevelId](#priceLevelId)|Choose the price list associated with this record to make sure the products associated with the campaign are offered at the correct prices.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[pricingErrorCode](#pricingErrorCode)|Pricing error for the opportunity.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[pricingErrorCode_display](#pricingErrorCode_display)||<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[priorityCode](#priorityCode)|Select the priority so that preferred customers or critical issues are handled quickly.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[priorityCode_display](#priorityCode_display)||<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[purchaseProcess](#purchaseProcess)|Choose whether an individual or a committee will be involved in the  purchase process for the lead.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[purchaseProcess_display](#purchaseProcess_display)||<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[purchaseTimeFrame](#purchaseTimeFrame)|Choose how long the lead will likely take to make the purchase.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[purchaseTimeFrame_display](#purchaseTimeFrame_display)||<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[salesStage](#salesStage)|Select the sales stage of this opportunity to aid the sales team in their efforts to win this opportunity.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[salesStage_display](#salesStage_display)||<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[salesStageCode](#salesStageCode)|Select the sales process stage for the opportunity to indicate the probability of closing the opportunity.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[salesStageCode_display](#salesStageCode_display)||<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[presentProposal](#presentProposal)|Select whether a proposal for the opportunity has been presented to the account.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[captureProposalFeedback](#captureProposalFeedback)|Choose whether the proposal feedback has been captured for the opportunity.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[proposedSolution](#proposedSolution)|Type notes about the proposed solution for the opportunity.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[pursuitDecision](#pursuitDecision)|Select whether the decision about pursuing the opportunity has been made.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[qualificationComments](#qualificationComments)|Type comments about the qualification or scoring of the lead.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[quoteComments](#quoteComments)|Type comments about the quotes associated with the opportunity.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[sendThankYouNote](#sendThankYouNote)|Select whether a thank you note has been sent to the account for considering the proposal.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[scheduleFollowupProspect](#scheduleFollowupProspect)|Enter the date and time of the prospecting follow-up meeting with the lead.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[scheduleFollowUpQualify](#scheduleFollowUpQualify)|Enter the date and time of the qualifying follow-up meeting with the lead.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[scheduleProposalMeeting](#scheduleProposalMeeting)|Enter the date and time of the proposal meeting for the opportunity.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[stateCode](#stateCode)|Shows whether the opportunity is open, won, or lost. Won and lost opportunities are read-only and can't be edited until they are reactivated.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[stateCode_display](#stateCode_display)||<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[statusCode](#statusCode)|Select the opportunity's status.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[statusCode_display](#statusCode_display)||<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[stepId](#stepId)|Shows the ID of the workflow step.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[stepName](#stepName)|Shows the current phase in the sales pipeline for the opportunity. This is updated by a workflow.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[timeLine](#timeLine)|Select when the opportunity is likely to be closed.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[timeLine_display](#timeLine_display)||<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[totalAmount](#totalAmount)|Shows the total amount due, calculated as the sum of the products, discounts, freight, and taxes for the opportunity.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[totalAmountBase](#totalAmountBase)|Value of the Total Amount in base currency.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[totalAmountLessFreight](#totalAmountLessFreight)|Shows the total product amount for the opportunity, minus any discounts. This value is added to freight and tax amounts in the calculation for the total amount of the opportunity.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[totalAmountLessFreightBase](#totalAmountLessFreightBase)|Value of the Total Pre-Freight Amount in base currency.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[totalDiscountAmount](#totalDiscountAmount)|Shows the total discount amount, based on the discount price and rate entered on the opportunity.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[totalDiscountAmountBase](#totalDiscountAmountBase)|Value of the Total Discount Amount in base currency.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[totalLineItemAmount](#totalLineItemAmount)|Shows the sum of all existing and write-in products included on the opportunity, based on the specified price list and quantities.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[totalLineItemAmountBase](#totalLineItemAmountBase)|Value of the Total Detail Amount in base currency.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
...
|[totalLineItemDiscountAmountBase](#totalLineItemDiscountAmountBase)|Value of the Total Line Item Discount Amount in base currency.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[totalTax](#totalTax)|Shows the total of the Tax amounts specified on all products included in the opportunity, included in the Total Amount field calculation for the opportunity.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[totalTaxBase](#totalTaxBase)|Value of the Total Tax in base currency.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[identifyCustomerContacts](#identifyCustomerContacts)|Select whether the customer contacts for this opportunity have been identified.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[identifyCompetitors](#identifyCompetitors)|Select whether information about competitors is included.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[identifyPursuitTeam](#identifyPursuitTeam)|Choose whether you have recorded who will pursue the opportunity.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[presentFinalProposal](#presentFinalProposal)|Select whether the final proposal has been presented to the account.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[onHoldTime](#onHoldTime)|Shows the duration in minutes for which the opportunity was on hold.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[lastOnHoldTime](#lastOnHoldTime)|Contains the date time stamp of the last on hold time.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[SLAId](#SLAId)|Choose the service level agreement (SLA) that you want to apply to the opportunity record.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[SLAInvokedId](#SLAInvokedId)|Last SLA that was applied to this opportunity. This field is for internal use only.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[timeSpentByMeOnEmailAndMeetings](#timeSpentByMeOnEmailAndMeetings)|Total time spent for emails (read and write) and meetings by me in relation to the opportunity record.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
...
|[accountId](#accountId)|Unique identifier of the account with which the opportunity is associated.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[contactId](#contactId)|Unique identifier of the contact associated with the opportunity.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[campaignId](#campaignId)|Shows the campaign that the opportunity was created from. The ID is used for tracking the success of the campaign.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[accountManagerId](#accountManagerId)|The account manager responsible for the opportunity.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[contractOrganizationalUnitId](#contractOrganizationalUnitId)|The organizational unit in charge of the opportunity.|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[orderType](#orderType)|Whether the Opportunity is for an Item- based or a Work-based sale|<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|
|[orderType_display](#orderType_display)||<a href="Opportunity.md" target="_blank">projectServiceAutomation/Opportunity</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: projectServiceAutomation/Opportunity (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Account Manager</td></tr><tr><td>description</td><td>The account manager responsible for the opportunity.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyn_accountmanagerid</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>The account manager responsible for the opportunity.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.CDS.ordered**  
the column number for an attribute with an entity in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>ordinal</td><td>"10192"</td><td>integer</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Contracting Unit</td></tr><tr><td>description</td><td>The organizational unit in charge of the opportunity.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyn_contractorganizationalunitid</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>The organizational unit in charge of the opportunity.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
