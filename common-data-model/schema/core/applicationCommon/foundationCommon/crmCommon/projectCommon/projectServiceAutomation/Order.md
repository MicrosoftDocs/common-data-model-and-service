...
- /crmCommon/projectCommon/projectServiceAutomation/Order  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[ownerId](#ownerId)|Owner Id|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[salesOrderId](#salesOrderId)|Unique identifier of the order.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[emailAddress](#emailAddress)|The primary email address for the entity.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[name](#name)|Type a descriptive name for the order.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[processId](#processId)|Contains the id of the process associated with the entity.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[stageId](#stageId)|Contains the id of the stage where the entity is located.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[traversedPath](#traversedPath)|A comma separated list of string values representing the unique identifiers of stages in a Business Process Flow Instance in the order that they occur.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[billToAddressId](#billToAddressId)|Unique identifier of the billing address.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[billToCity](#billToCity)|Type the city for the customer's billing address.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[billToComposite](#billToComposite)|Shows the complete Bill To address.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[billToContactName](#billToContactName)|Type the primary contact name at the customer's billing address.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[billToCountry](#billToCountry)|Type the country or region for the customer's billing address.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[billToFax](#billToFax)|Type the fax number for the customer's billing address.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[billToLine1](#billToLine1)|Type the first line of the customer's billing address.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[billToLine2](#billToLine2)|Type the second line of the customer's billing address.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[billToLine3](#billToLine3)|Type the third line of the billing address.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[billToName](#billToName)|Type a name for the customer's billing address, such as "Headquarters" or "Field office", to identify the address.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[billToPostalCode](#billToPostalCode)|Type the ZIP Code or postal code for the billing address.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[billToStateOrProvince](#billToStateOrProvince)|Type the state or province for the billing address.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[billToTelephone](#billToTelephone)|Type the phone number for the customer's billing address.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[customerId](#customerId)|The customer account or contact to provide a quick link to additional customer details, such as account information, activities, and opportunities.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[customerIdType](#customerIdType)|The type of customer, either Account or Contact.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[dateFulfilled](#dateFulfilled)|Enter the date that all or part of the order was shipped to the customer.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[description](#description)|Type additional information to describe the order, such as the products or services offered or details about the customer's product preferences.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[discountAmount](#discountAmount)|Type the discount amount for the order if the customer is eligible for special savings.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[transactionCurrencyId](#transactionCurrencyId)|Choose the local currency for the record to make sure budgets are reported in the correct currency.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[exchangeRate](#exchangeRate)|Shows the conversion rate of the record's currency. The exchange rate is used to convert all money fields in the record from the local currency to the system's default currency.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[discountAmountBase](#discountAmountBase)|Value of the Order Discount Amount in base currency.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[discountPercentage](#discountPercentage)|Type the discount rate that should be applied to the Detail Amount field to include additional savings for the customer in the order.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[freightAmount](#freightAmount)|Type the cost of freight or shipping for the products included in the order for use in calculating the Total Amount field.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[freightAmountBase](#freightAmountBase)|Value of the Freight Amount in base currency.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[freightTermsCode](#freightTermsCode)|Select the freight terms to make sure shipping charges are processed correctly.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[freightTermsCode_display](#freightTermsCode_display)||<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[isPriceLocked](#isPriceLocked)|Select whether prices specified on the invoice are locked from any further updates.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[lastBackofficeSubmit](#lastBackofficeSubmit)|Enter the date and time when the order was last submitted to an accounting or ERP system for processing.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[opportunityId](#opportunityId)|Choose the related opportunity so that the data for the order and opportunity are linked for reporting and analytics.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[orderNumber](#orderNumber)|Shows the order number for customer reference and to use in search. The number cannot be modified.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[paymentTermsCode](#paymentTermsCode)|Select the payment terms to indicate when the customer needs to pay the total amount.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[paymentTermsCode_display](#paymentTermsCode_display)||<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[priceLevelId](#priceLevelId)|Choose the price list associated with this record to make sure the products associated with the campaign are offered at the correct prices.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[pricingErrorCode](#pricingErrorCode)|Select the type of pricing error, such as a missing or invalid product, or missing quantity.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[pricingErrorCode_display](#pricingErrorCode_display)||<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[priorityCode](#priorityCode)|Select the priority so that preferred customers or critical issues are handled quickly.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[priorityCode_display](#priorityCode_display)||<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[quoteId](#quoteId)|Choose the related quote so that order data and quote data are linked for reporting and analytics.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[requestDeliveryBy](#requestDeliveryBy)|Enter the delivery date requested by the customer for all products in the order.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[shippingMethodCode](#shippingMethodCode)|Select a shipping method for deliveries sent to this address.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[shippingMethodCode_display](#shippingMethodCode_display)||<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[shipToAddressId](#shipToAddressId)|Unique identifier of the shipping address.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[shipToCity](#shipToCity)|Type the city for the customer's shipping address.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[shipToComposite](#shipToComposite)|Shows the complete Ship To address.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[shipToContactName](#shipToContactName)|Type the primary contact name at the customer's shipping address.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[shipToCountry](#shipToCountry)|Type the country or region for the customer's shipping address.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[shipToFax](#shipToFax)|Type the fax number for the customer's shipping address.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[shipToFreightTermsCode](#shipToFreightTermsCode)|Select the freight terms to make sure shipping orders are processed correctly.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[shipToFreightTermsCode_display](#shipToFreightTermsCode_display)||<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[shipToLine1](#shipToLine1)|Type the first line of the customer's shipping address.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[shipToLine2](#shipToLine2)|Type the second line of the customer's shipping address.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[shipToLine3](#shipToLine3)|Type the third line of the shipping address.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[shipToName](#shipToName)|Type a name for the customer's shipping address, such as "Headquarters" or "Field office",  to identify the address.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[shipToPostalCode](#shipToPostalCode)|Type the ZIP Code or postal code for the shipping address.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[shipToStateOrProvince](#shipToStateOrProvince)|Type the state or province for the shipping address.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[shipToTelephone](#shipToTelephone)|Type the phone number for the customer's shipping address.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[stateCode](#stateCode)|Shows whether the order is active, submitted, fulfilled, canceled, or invoiced. Only active orders can be edited.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[stateCode_display](#stateCode_display)||<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[statusCode](#statusCode)|Select the order's status.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[statusCode_display](#statusCode_display)||<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[submitDate](#submitDate)|Enter the date when the order was submitted to the fulfillment or shipping center.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[submitStatus](#submitStatus)|Type the code for the submitted status in the fulfillment or shipping center system.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[submitStatusDescription](#submitStatusDescription)|Type additional details or notes about the order for the fulfillment or shipping center.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[totalAmount](#totalAmount)|Shows the total amount due, calculated as the sum of the products, discounts, freight, and taxes for the order.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[totalAmountBase](#totalAmountBase)|Value of the Total Amount in base currency.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[totalAmountLessFreight](#totalAmountLessFreight)|Shows the total product amount for the order, minus any discounts. This value is added to freight and tax amounts in the calculation for the total amount due for the order.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[totalAmountLessFreightBase](#totalAmountLessFreightBase)|Value of the Total Pre-Freight Amount in base currency.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[totalDiscountAmount](#totalDiscountAmount)|Shows the total discount amount, based on the discount price and rate entered on the order.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[totalDiscountAmountBase](#totalDiscountAmountBase)|Value of the Total Discount Amount in base currency.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[totalLineItemAmount](#totalLineItemAmount)|Shows the sum of all existing and write-in products included on the order, based on the specified price list and quantities.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[totalLineItemAmountBase](#totalLineItemAmountBase)|Value of the Total Detail Amount in base currency.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[totalLineItemDiscountAmount](#totalLineItemDiscountAmount)|Shows the total of the Manual Discount amounts specified on all products included in the order. This value is reflected in the Detail Amount field on the order and is added to any discount amount or rate specified on the order.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[totalLineItemDiscountAmountBase](#totalLineItemDiscountAmountBase)|Value of the Total Line Item Discount Amount in base currency.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[totalTax](#totalTax)|Shows the Tax amounts specified on all products included in the order, included in the Total Amount due calculation for the order.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[totalTaxBase](#totalTaxBase)|Value of the Total Tax in base currency.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[willCall](#willCall)|Select whether the products included in the order should be shipped to the specified address or held until the customer calls with further pick-up or delivery instructions.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[onHoldTime](#onHoldTime)|Shows the duration in minutes for which the order was on hold.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[lastOnHoldTime](#lastOnHoldTime)|Contains the date time stamp of the last on hold time.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[SLAId](#SLAId)|Choose the service level agreement (SLA) that you want to apply to the sales order record.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[SLAInvokedId](#SLAInvokedId)|Last SLA that was applied to this sales order. This field is for internal use only.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[entityImageId](#entityImageId)||<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[accountId](#accountId)|Shows the parent account related to the record. This information is used to link the sales order to the account selected in the Customer field for reporting and analytics.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[contactId](#contactId)|Shows the parent contact related to the record. This information is used to link the contract to the contact selected in the Customer field for reporting and analytics.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
|[campaignId](#campaignId)|Shows the campaign that the order was created from.|<a href="Order.md" target="_blank">projectServiceAutomation/Order</a>|
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>User responsible for managing the account referenced by this contract.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Contracting Unit</td></tr><tr><td>description</td><td>Organizational unit responsible for this contract.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyn_contractorganizationalunitid</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Organizational unit responsible for this contract.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Order Type</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Whether it is for an Item- based or a Work-based sale</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Contract Status</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Shows the current state of the project contract.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.nullable**  
The attribute value may be set to NULL.  

**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_psastate"</td><td>string</td><td></td></tr></table>
...
<details>
<summary>List of traits for the PSAState_display attribute are listed below.</summary>
...
**is.readOnly**  
**is.addedInSupportOf**  
<table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>inSupportOf</td><td>"PSAState"</td><td>attributeName</td><td>output parameter naming the attribute that is being supported</td></tr></table>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Contract Status Reason</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Shows the reason for the project contract status.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.nullable**  
The attribute value may be set to NULL.  

**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_psastatusreason"</td><td>string</td><td></td></tr></table>
...
<details>
<summary>List of traits for the PSAStatusReason_display attribute are listed below.</summary>
...
**is.readOnly**  
**is.addedInSupportOf**  
<table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>inSupportOf</td><td>"PSAStatusReason"</td><td>attributeName</td><td>output parameter naming the attribute that is being supported</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Total Non-chargeable Cost</td></tr><tr><td>description</td><td>Total estimated cost that will not be charged to the customer.</td></tr><tr><td>dataFormat</td><td>16</td></tr><tr><td>maximumValue</td><td>922337203685477</td></tr><tr><td>minimumValue</td><td>-922337203685477</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyn_totalnonchargeablecostrollup</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Total estimated cost that will not be charged to the customer.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
