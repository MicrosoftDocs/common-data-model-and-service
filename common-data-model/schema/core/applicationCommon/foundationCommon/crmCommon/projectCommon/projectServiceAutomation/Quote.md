...
- /crmCommon/projectCommon/projectServiceAutomation/Quote  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[ownerId](#ownerId)|Owner Id|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[quoteId](#quoteId)|Unique identifier of the quote.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[emailAddress](#emailAddress)|The primary email address for the entity.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[name](#name)|Type a descriptive name for the quote.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[processId](#processId)|Contains the id of the process associated with the entity.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[stageId](#stageId)|Contains the id of the stage where the entity is located.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[traversedPath](#traversedPath)|A comma separated list of string values representing the unique identifiers of stages in a Business Process Flow Instance in the order that they occur.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[billToAddressId](#billToAddressId)|Unique identifier of the billing address.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[billToCity](#billToCity)|Type the city for the customer's billing address.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[billToComposite](#billToComposite)|Shows the complete Bill To address.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[billToContactName](#billToContactName)|Type the primary contact name at the customer's billing address.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[billToCountry](#billToCountry)|Type the country or region for the customer's billing address.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[billToFax](#billToFax)|Type the fax number for the customer's billing address.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[billToLine1](#billToLine1)|Type the first line of the customer's billing address.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[billToLine2](#billToLine2)|Type the second line of the customer's billing address.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[billToLine3](#billToLine3)|Type the third line of the billing address.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[billToName](#billToName)|Type a name for the customer's billing address, such as "Headquarters" or "Field office", to identify the address.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[billToPostalCode](#billToPostalCode)|Type the ZIP Code or postal code for the billing address.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[billToStateOrProvince](#billToStateOrProvince)|Type the state or province for the billing address.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[billToTelephone](#billToTelephone)|Type the phone number for the customer's billing address.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[closedOn](#closedOn)|Enter the date when the quote was closed to indicate the expiration, revision, or cancellation date.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[customerId](#customerId)|The customer account or contact to provide a quick link to additional customer details, such as account information, activities, and opportunities.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[customerIdType](#customerIdType)|The type of customer, either Account or Contact.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[description](#description)|Type additional information to describe the quote, such as the products or services offered or details about the customer's product preferences.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[discountAmount](#discountAmount)|Type the discount amount for the quote if the customer is eligible for special savings.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[transactionCurrencyId](#transactionCurrencyId)|Choose the local currency for the record to make sure budgets are reported in the correct currency.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[exchangeRate](#exchangeRate)|Shows the conversion rate of the record's currency. The exchange rate is used to convert all money fields in the record from the local currency to the system's default currency.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[discountAmountBase](#discountAmountBase)|Value of the Quote Discount Amount in base currency.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[discountPercentage](#discountPercentage)|Type the discount rate that should be applied to the Detail Amount field to include additional savings for the customer in the quote.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[effectiveFrom](#effectiveFrom)|Enter the date when the quote pricing is effective or was first communicated to the customer.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[effectiveTo](#effectiveTo)|Enter the expiration date or last day the quote pricing is effective for the customer.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[expiresOn](#expiresOn)|Enter the date a decision or order is due from the customer to indicate the expiration date of the quote.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[freightAmount](#freightAmount)|Type the cost of freight or shipping for the products included in the quote for use in calculating the Total Amount field.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[freightAmountBase](#freightAmountBase)|Value of the Freight Amount in base currency.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[freightTermsCode](#freightTermsCode)|Select the freight terms to make sure shipping charges are processed correctly.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[freightTermsCode_display](#freightTermsCode_display)||<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[opportunityId](#opportunityId)|Choose the opportunity that the quote is related to for reporting and analytics.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[paymentTermsCode](#paymentTermsCode)|Select the payment terms to indicate when the customer needs to pay the total amount.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[paymentTermsCode_display](#paymentTermsCode_display)||<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[priceLevelId](#priceLevelId)|Choose the price list associated with this record to make sure the products associated with the campaign are offered at the correct prices.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[pricingErrorCode](#pricingErrorCode)|Pricing error for the quote.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[pricingErrorCode_display](#pricingErrorCode_display)||<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[quoteNumber](#quoteNumber)|Shows the quote number for customer reference and searching capabilities. The number cannot be modified.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[requestDeliveryBy](#requestDeliveryBy)|Enter the delivery date requested by the customer for all products in the quote.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[revisionNumber](#revisionNumber)|Shows the version number of the quote for revision history tracking.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[shippingMethodCode](#shippingMethodCode)|Select a shipping method for deliveries sent to this address.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[shippingMethodCode_display](#shippingMethodCode_display)||<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[shipToAddressId](#shipToAddressId)|Unique identifier of the shipping address.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[shipToCity](#shipToCity)|Type the city for the customer's shipping address.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[shipToComposite](#shipToComposite)|Shows the complete Ship To address.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[shipToContactName](#shipToContactName)|Type the primary contact name at the customer's shipping address.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[shipToCountry](#shipToCountry)|Type the country or region for the customer's shipping address.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[shipToFax](#shipToFax)|Type the fax number for the customer's shipping address.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[shipToFreightTermsCode](#shipToFreightTermsCode)|Select the freight terms to make sure shipping orders are processed correctly.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[shipToFreightTermsCode_display](#shipToFreightTermsCode_display)||<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[shipToLine1](#shipToLine1)|Type the first line of the customer's shipping address.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[shipToLine2](#shipToLine2)|Type the second line of the customer's shipping address.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[shipToLine3](#shipToLine3)|Type the third line of the shipping address.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[shipToName](#shipToName)|Type a name for the customer's shipping address, such as "Headquarters" or "Field office",  to identify the address.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[shipToPostalCode](#shipToPostalCode)|Type the ZIP Code or postal code for the shipping address.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[shipToStateOrProvince](#shipToStateOrProvince)|Type the state or province for the shipping address.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[shipToTelephone](#shipToTelephone)|Type the phone number for the customer's shipping address.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[stateCode](#stateCode)|Shows whether the quote is draft, active, won, or closed. Only draft quotes can be edited.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[stateCode_display](#stateCode_display)||<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[statusCode](#statusCode)|Select the quote's status.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[statusCode_display](#statusCode_display)||<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[totalAmount](#totalAmount)|Shows the total amount due, calculated as the sum of the products, discounts, freight, and taxes for the quote.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[totalAmountBase](#totalAmountBase)|Value of the Total Amount in base currency.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[totalAmountLessFreight](#totalAmountLessFreight)|Shows the total product amount for the quote, minus any discounts. This value is added to freight and tax amounts in the calculation for the total amount due for the quote.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[totalAmountLessFreightBase](#totalAmountLessFreightBase)|Value of the Total Pre-Freight Amount in base currency.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[totalDiscountAmount](#totalDiscountAmount)|Shows the total discount amount, based on the discount price and rate entered on the quote.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[totalDiscountAmountBase](#totalDiscountAmountBase)|Value of the Total Discount Amount in base currency.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[totalLineItemAmount](#totalLineItemAmount)|Shows the sum of all existing and write-in products included on the quote, based on the specified price list and quantities.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[totalLineItemAmountBase](#totalLineItemAmountBase)|Value of the Total Detail Amount in base currency.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
...
|[totalLineItemDiscountAmountBase](#totalLineItemDiscountAmountBase)|Value of the Total Line Item Discount Amount in base currency.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[totalTax](#totalTax)|Shows the total of the Tax amounts specified on all products included in the quote, included in the Total Amount due calculation for the quote.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[totalTaxBase](#totalTaxBase)|Value of the Total Tax in base currency.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[willCall](#willCall)|Select whether the products included in the quote should be shipped to the specified address or held until the customer calls with further pick up or delivery instructions.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[onHoldTime](#onHoldTime)|Shows the duration in minutes for which the quote was on hold.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[lastOnHoldTime](#lastOnHoldTime)|Contains the date time stamp of the last on hold time.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[SLAId](#SLAId)|Choose the service level agreement (SLA) that you want to apply to the quote record.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[SLAInvokedId](#SLAInvokedId)|Last SLA that was applied to this quote. This field is for internal use only.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[accountId](#accountId)|Unique identifier of the account with which the quote is associated.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[contactId](#contactId)|Unique identifier of the contact associated with the quote.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
|[campaignId](#campaignId)|Shows the campaign that the order was created from.|<a href="Quote.md" target="_blank">projectServiceAutomation/Quote</a>|
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Account Manager</td></tr><tr><td>description</td><td>Account manager responsible for the quote.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyn_accountmanagerid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the accountManagerId attribute are listed below.</summary>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Account Manager</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Account manager responsible for the quote.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.nullable**  
The attribute value may be set to NULL.  

**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_accountmanagerid"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Contracting Unit</td></tr><tr><td>description</td><td>The organizational unit in charge of the contract.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyn_contractorganizationalunitid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the contractOrganizationalUnitId attribute are listed below.</summary>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>The organizational unit in charge of the contract.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Feasibility</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Shows how the quote estimation compares to project estimation. Possible values are 0: Feasibility Not Available, 1: Feasible, and 2: Not Feasible.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.nullable**  
The attribute value may be set to NULL.  

**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_feasible"</td><td>string</td><td></td></tr></table>
...
<details>
<summary>List of traits for the feasible_display attribute are listed below.</summary>
...
**is.readOnly**  
**is.addedInSupportOf**  
<table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>inSupportOf</td><td>"feasible"</td><td>attributeName</td><td>output parameter naming the attribute that is being supported</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Adjusted Gross Margin (%)</td></tr><tr><td>description</td><td>Shows the estimated gross margin after accounting for non-chargeable components.</td></tr><tr><td>dataFormat</td><td>16</td></tr><tr><td>maximumValue</td><td>100000000000</td></tr><tr><td>minimumValue</td><td>-100000000000</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyn_adjustedgrossmargin</td></tr></table>

#### Traits

<details>
<summary>List of traits for the adjustedGrossMargin attribute are listed below.</summary>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Adjusted Gross Margin (%)</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Shows the estimated gross margin after accounting for non-chargeable components.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.nullable**  
The attribute value may be set to NULL.  

**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_adjustedgrossmargin"</td><td>string</td><td></td></tr></table>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Competitive</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Shows how the quote estimation of sales value and schedule compare to customer expectations on those parameters. Possible values are 1: Within Customer expectations, 2: Not Within Customer expectations, and 0: Customer expectations Not Available.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.nullable**  
The attribute value may be set to NULL.  

**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_competitive"</td><td>string</td><td></td></tr></table>
...
<details>
<summary>List of traits for the competitive_display attribute are listed below.</summary>
...
**is.readOnly**  
**is.addedInSupportOf**  
<table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>inSupportOf</td><td>"competitive"</td><td>attributeName</td><td>output parameter naming the attribute that is being supported</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Customer Budget</td></tr><tr><td>description</td><td>Shows the total customer budget for the quote, computed from all the quote lines.</td></tr><tr><td>dataFormat</td><td>16</td></tr><tr><td>maximumValue</td><td>922337203685477</td></tr><tr><td>minimumValue</td><td>-922337203685477</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyn_customerbudgetrollup</td></tr></table>

#### Traits

<details>
<summary>List of traits for the customerBudgetRollUp attribute are listed below.</summary>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Shows the total customer budget for the quote, computed from all the quote lines.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.nullable**  
The attribute value may be set to NULL.  

**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_customerbudgetrollup"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Customer Budget (Base)</td></tr><tr><td>description</td><td>Shows the value of the customer budget in the base currency.</td></tr><tr><td>dataFormat</td><td>16</td></tr><tr><td>maximumValue</td><td>922337203685477</td></tr><tr><td>minimumValue</td><td>-922337203685477</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyn_customerbudgetrollup_base</td></tr></table>

#### Traits

<details>
<summary>List of traits for the customerBudgetRollupBase attribute are listed below.</summary>
...
**means.measurement.currency**  
**is.calculationOf**  
the attribute value is the result of a calculation on the sourceAttribute  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>sourceAttribute</td><td>"customerBudgetRollUp"</td><td>attributeName</td><td></td></tr></table>

**is.requiredAtLevel**  
The requirement level for setting values into this attribute in CDS for Applications or for including this attribute in entities created in CDS for Analytics  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>level</td><td>"none"</td><td>string</td><td>values can be: 'systemrequired', 'required', 'recommended', 'none'</td></tr></table>

**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Customer Budget (Base)</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Shows the value of the customer budget in the base currency.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.nullable**  
The attribute value may be set to NULL.  

**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_customerbudgetrollup_base"</td><td>string</td><td></td></tr></table>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Estimated Budget</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Shows how the estimated sales value on the quote compares to customer budgets. Possible values are 1: Within Customer Budget, 2: Exceeds Customer Budget, 0: Budget Estimate Not Available</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.nullable**  
The attribute value may be set to NULL.  

**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_estimatedbudget"</td><td>string</td><td></td></tr></table>
...
<details>
<summary>List of traits for the estimatedBudget_display attribute are listed below.</summary>
...
**is.readOnly**  
**is.addedInSupportOf**  
<table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>inSupportOf</td><td>"estimatedBudget"</td><td>attributeName</td><td>output parameter naming the attribute that is being supported</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Estimated Completion</td></tr><tr><td>description</td><td>Estimated completion date, computed from the details of each quote line.</td></tr><tr><td>dataFormat</td><td>13</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyn_estimatedcompletionrollup</td></tr></table>

#### Traits

<details>
<summary>List of traits for the estimatedCompletionRollUp attribute are listed below.</summary>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Estimated Completion</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Estimated completion date, computed from the details of each quote line.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.nullable**  
The attribute value may be set to NULL.  

**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_estimatedcompletionrollup"</td><td>string</td><td></td></tr></table>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Estimated Schedule</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Shows how the estimated schedule on the quote compares to customer expectations. Possible values are 1: Estimated To Finish Early, 2: Estimated To Finish Late, 3: Estimated To Finish On Schedule, and 0: Schedule Not Available.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.nullable**  
The attribute value may be set to NULL.  

**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_estimatedschedule"</td><td>string</td><td></td></tr></table>

**is.CDS.ordered**  
the column number for an attribute with an entity in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>ordinal</td><td>"10178"</td><td>integer</td><td></td></tr></table>
...
<details>
<summary>List of traits for the estimatedSchedule_display attribute are listed below.</summary>
...
**is.readOnly**  
**is.addedInSupportOf**  
<table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>inSupportOf</td><td>"estimatedSchedule"</td><td>attributeName</td><td>output parameter naming the attribute that is being supported</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Shows the estimated gross margin without accounting for non-chargeable components.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Profitability</td></tr><tr><td>description</td><td>Shows the estimated profitability of the quote. Possible values are Profitable, Not Profitable, and Profitability not available.</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyn_profitability</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Profitability Not Available</td><td>192350000</td></tr><tr><td>en</td><td>Profitable</td><td>192350001</td></tr><tr><td>en</td><td>Not Profitable</td><td>192350002</td></tr></table></td></tr></table>

#### Traits

<details>
<summary>List of traits for the profitability attribute are listed below.</summary>

**is.dataFormat.integer**  
**does.haveDefault**  
An attribute has a default value  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>default</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Profitability Not Available</td><td>192350000</td></tr><tr><td>en</td><td>Profitable</td><td>192350001</td></tr><tr><td>en</td><td>Not Profitable</td><td>192350002</td></tr></table></td><td>any</td><td></td></tr></table>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Profitability</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Shows the estimated profitability of the quote. Possible values are Profitable, Not Profitable, and Profitability not available.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.nullable**  
The attribute value may be set to NULL.  

**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_profitability"</td><td>string</td><td></td></tr></table>

**is.CDS.ordered**  
the column number for an attribute with an entity in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>ordinal</td><td>"10181"</td><td>integer</td><td></td></tr></table>
...
<details>
<summary>List of traits for the profitability_display attribute are listed below.</summary>
...
**is.readOnly**  
**is.addedInSupportOf**  
<table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>inSupportOf</td><td>"profitability"</td><td>attributeName</td><td>output parameter naming the attribute that is being supported</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Total Chargeable Cost</td></tr><tr><td>dataFormat</td><td>16</td></tr><tr><td>maximumValue</td><td>922337203685477</td></tr><tr><td>minimumValue</td><td>-922337203685477</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyn_totalchargeablecostrollup</td></tr></table>

#### Traits

<details>
<summary>List of traits for the totalChargeableCostRollup attribute are listed below.</summary>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Total Chargeable Cost</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.nullable**  
The attribute value may be set to NULL.  

**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_totalchargeablecostrollup"</td><td>string</td><td></td></tr></table>

**is.CDS.ordered**  
the column number for an attribute with an entity in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>ordinal</td><td>"10183"</td><td>integer</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Total Chargeable Cost (Base)</td></tr><tr><td>description</td><td>Value of the Total Chargeable Cost in base currency.</td></tr><tr><td>dataFormat</td><td>16</td></tr><tr><td>maximumValue</td><td>922337203685477</td></tr><tr><td>minimumValue</td><td>-922337203685477</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyn_totalchargeablecostrollup_base</td></tr></table>

#### Traits

<details>
<summary>List of traits for the totalChargeableCostRollupBase attribute are listed below.</summary>
...
**means.measurement.currency**  
**is.calculationOf**  
the attribute value is the result of a calculation on the sourceAttribute  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>sourceAttribute</td><td>"totalChargeableCostRollup"</td><td>attributeName</td><td></td></tr></table>

**is.requiredAtLevel**  
The requirement level for setting values into this attribute in CDS for Applications or for including this attribute in entities created in CDS for Analytics  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>level</td><td>"none"</td><td>string</td><td>values can be: 'systemrequired', 'required', 'recommended', 'none'</td></tr></table>

**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Total Chargeable Cost (Base)</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Value of the Total Chargeable Cost in base currency.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.nullable**  
The attribute value may be set to NULL.  

**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_totalchargeablecostrollup_base"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Total Non-chargeable Cost</td></tr><tr><td>dataFormat</td><td>16</td></tr><tr><td>maximumValue</td><td>922337203685477</td></tr><tr><td>minimumValue</td><td>-922337203685477</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyn_totalnonchargeablecostrollup</td></tr></table>

#### Traits

<details>
<summary>List of traits for the totalNonchargeableCostRollup attribute are listed below.</summary>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Total Non-chargeable Cost</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.nullable**  
The attribute value may be set to NULL.  

**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_totalnonchargeablecostrollup"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Total Non-chargeable Cost (Base)</td></tr><tr><td>description</td><td>Value of the Total Non-chargeable Cost in base currency.</td></tr><tr><td>dataFormat</td><td>16</td></tr><tr><td>maximumValue</td><td>922337203685477</td></tr><tr><td>minimumValue</td><td>-922337203685477</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyn_totalnonchargeablecostrollup_base</td></tr></table>

#### Traits

<details>
<summary>List of traits for the totalNonchargeableCostRollupBase attribute are listed below.</summary>
...
**means.measurement.currency**  
**is.calculationOf**  
the attribute value is the result of a calculation on the sourceAttribute  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>sourceAttribute</td><td>"totalNonchargeableCostRollup"</td><td>attributeName</td><td></td></tr></table>

**is.requiredAtLevel**  
The requirement level for setting values into this attribute in CDS for Applications or for including this attribute in entities created in CDS for Analytics  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>level</td><td>"none"</td><td>string</td><td>values can be: 'systemrequired', 'required', 'recommended', 'none'</td></tr></table>

**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Total Non-chargeable Cost (Base)</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Value of the Total Non-chargeable Cost in base currency.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.nullable**  
The attribute value may be set to NULL.  

**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_totalnonchargeablecostrollup_base"</td><td>string</td><td></td></tr></table>

**is.CDS.ordered**  
the column number for an attribute with an entity in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>ordinal</td><td>"10188"</td><td>integer</td><td></td></tr></table>
