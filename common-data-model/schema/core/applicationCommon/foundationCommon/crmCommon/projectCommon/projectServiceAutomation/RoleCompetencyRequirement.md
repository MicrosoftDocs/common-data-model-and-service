...
Entity used  to associate skills in a role.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/projectCommon/projectServiceAutomation/RoleCompetencyRequirement.cdm.json" target="_blank">GitHub</a>.  

## Instances

Instances of this entity are listed below.  

- /crmCommon/projectCommon/projectServiceAutomation/RoleCompetencyRequirement  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/core/applicationCommon/foundationCommon<br>/crmCommon/projectCommon/projectServiceAutomation<br>/RoleCompetencyRequirement.cdm.json<br>/RoleCompetencyRequirement/hasAttributes<br>/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[RoleCompetencyRequirement/(resolvedAttributes)/roleCompetencyRequirementId](#roleCompetencyRequirementId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[RoleCompetencyRequirement/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Role competency requirement</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Entity used  to associate skills in a role.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_rolecompetencyrequirement"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="RoleCompetencyRequirement.md" target="_blank">projectServiceAutomation/RoleCompetencyRequirement</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="RoleCompetencyRequirement.md" target="_blank">projectServiceAutomation/RoleCompetencyRequirement</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="RoleCompetencyRequirement.md" target="_blank">projectServiceAutomation/RoleCompetencyRequirement</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="RoleCompetencyRequirement.md" target="_blank">projectServiceAutomation/RoleCompetencyRequirement</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="RoleCompetencyRequirement.md" target="_blank">projectServiceAutomation/RoleCompetencyRequirement</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="RoleCompetencyRequirement.md" target="_blank">projectServiceAutomation/RoleCompetencyRequirement</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="RoleCompetencyRequirement.md" target="_blank">projectServiceAutomation/RoleCompetencyRequirement</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="RoleCompetencyRequirement.md" target="_blank">projectServiceAutomation/RoleCompetencyRequirement</a>|
|[ownerId](#ownerId)|Owner Id|<a href="RoleCompetencyRequirement.md" target="_blank">projectServiceAutomation/RoleCompetencyRequirement</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="RoleCompetencyRequirement.md" target="_blank">projectServiceAutomation/RoleCompetencyRequirement</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="RoleCompetencyRequirement.md" target="_blank">projectServiceAutomation/RoleCompetencyRequirement</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="RoleCompetencyRequirement.md" target="_blank">projectServiceAutomation/RoleCompetencyRequirement</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="RoleCompetencyRequirement.md" target="_blank">projectServiceAutomation/RoleCompetencyRequirement</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="RoleCompetencyRequirement.md" target="_blank">projectServiceAutomation/RoleCompetencyRequirement</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="RoleCompetencyRequirement.md" target="_blank">projectServiceAutomation/RoleCompetencyRequirement</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="RoleCompetencyRequirement.md" target="_blank">projectServiceAutomation/RoleCompetencyRequirement</a>|
|[roleCompetencyRequirementId](#roleCompetencyRequirementId)|Shows the entity instances.|<a href="RoleCompetencyRequirement.md" target="_blank">projectServiceAutomation/RoleCompetencyRequirement</a>|
|[stateCode](#stateCode)|Status of the Role competency requirement|<a href="RoleCompetencyRequirement.md" target="_blank">projectServiceAutomation/RoleCompetencyRequirement</a>|
|[stateCode_display](#stateCode_display)||<a href="RoleCompetencyRequirement.md" target="_blank">projectServiceAutomation/RoleCompetencyRequirement</a>|
|[statusCode](#statusCode)|Reason for the status of the Role competency requirement|<a href="RoleCompetencyRequirement.md" target="_blank">projectServiceAutomation/RoleCompetencyRequirement</a>|
|[statusCode_display](#statusCode_display)||<a href="RoleCompetencyRequirement.md" target="_blank">projectServiceAutomation/RoleCompetencyRequirement</a>|
|[name](#name)|Type the name of the custom entity.|<a href="RoleCompetencyRequirement.md" target="_blank">projectServiceAutomation/RoleCompetencyRequirement</a>|
|[characteristic](#characteristic)|Select the characteristic foreign key.|<a href="RoleCompetencyRequirement.md" target="_blank">projectServiceAutomation/RoleCompetencyRequirement</a>|
|[bookableCharacteristicType](#bookableCharacteristicType)|Select the type of the characteristic.|<a href="RoleCompetencyRequirement.md" target="_blank">projectServiceAutomation/RoleCompetencyRequirement</a>|
|[bookableCharacteristicType_display](#bookableCharacteristicType_display)||<a href="RoleCompetencyRequirement.md" target="_blank">projectServiceAutomation/RoleCompetencyRequirement</a>|
|[ratingValue](#ratingValue)|Shows the required proficiency for this role.|<a href="RoleCompetencyRequirement.md" target="_blank">projectServiceAutomation/RoleCompetencyRequirement</a>|
|[resourceCategory](#resourceCategory)|Select the resource role.|<a href="RoleCompetencyRequirement.md" target="_blank">projectServiceAutomation/RoleCompetencyRequirement</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: projectServiceAutomation/RoleCompetencyRequirement (this entity)  
...
### <a href=#roleCompetencyRequirementId name="roleCompetencyRequirementId">roleCompetencyRequirementId</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Role competency requirement</td></tr><tr><td>description</td><td>Shows the entity instances.</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>msdyn_rolecompetencyrequirementid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the roleCompetencyRequirementId attribute are listed below.</summary>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_rolecompetencyrequirementid"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Role competency requirement</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the Role competency requirement</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Role competency requirement</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the Role competency requirement</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Characteristic</td></tr><tr><td>description</td><td>Select the characteristic foreign key.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyn_characteristic</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Select the characteristic foreign key.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
### <a href=#bookableCharacteristicType name="bookableCharacteristicType">bookableCharacteristicType</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Bookable Characteristic Type</td></tr><tr><td>description</td><td>Select the type of the characteristic.</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyn_characteristictype</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td></td></tr></table>

#### Traits

<details>
<summary>List of traits for the bookableCharacteristicType attribute are listed below.</summary>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Bookable Characteristic Type</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Select the type of the characteristic.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.nullable**  
The attribute value may be set to NULL.  

**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_characteristictype"</td><td>string</td><td></td></tr></table>
...
### <a href=#bookableCharacteristicType_display name="bookableCharacteristicType_display">bookableCharacteristicType_display</a>
...
<details>
<summary>List of traits for the bookableCharacteristicType_display attribute are listed below.</summary>
...
**is.readOnly**  
**is.addedInSupportOf**  
<table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>inSupportOf</td><td>"bookableCharacteristicType"</td><td>attributeName</td><td>output parameter naming the attribute that is being supported</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Rating Value</td></tr><tr><td>description</td><td>Shows the required proficiency for this role.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyn_ratingvalue</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Shows the required proficiency for this role.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
