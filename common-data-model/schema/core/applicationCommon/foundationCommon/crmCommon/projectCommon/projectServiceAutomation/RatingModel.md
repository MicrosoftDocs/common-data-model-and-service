...
Represents a model to evaluate skills or other related entities.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/projectCommon/projectServiceAutomation/RatingModel.cdm.json" target="_blank">GitHub</a>.  

## Instances

Instances of this entity are listed below.  

- [/foundationCommon/RatingModel](../../../RatingModel.md "/core/applicationCommon/foundationCommon/RatingModel.cdm.json/RatingModel")  
- /crmCommon/projectCommon/projectServiceAutomation/RatingModel  
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Represents a model to evaluate skills or other related entities.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="RatingModel.md" target="_blank">projectServiceAutomation/RatingModel</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="RatingModel.md" target="_blank">projectServiceAutomation/RatingModel</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="RatingModel.md" target="_blank">projectServiceAutomation/RatingModel</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="RatingModel.md" target="_blank">projectServiceAutomation/RatingModel</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="RatingModel.md" target="_blank">projectServiceAutomation/RatingModel</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="RatingModel.md" target="_blank">projectServiceAutomation/RatingModel</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="RatingModel.md" target="_blank">projectServiceAutomation/RatingModel</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="RatingModel.md" target="_blank">projectServiceAutomation/RatingModel</a>|
|[ownerId](#ownerId)|Owner Id|<a href="RatingModel.md" target="_blank">projectServiceAutomation/RatingModel</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="RatingModel.md" target="_blank">projectServiceAutomation/RatingModel</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="RatingModel.md" target="_blank">projectServiceAutomation/RatingModel</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="RatingModel.md" target="_blank">projectServiceAutomation/RatingModel</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="RatingModel.md" target="_blank">projectServiceAutomation/RatingModel</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="RatingModel.md" target="_blank">projectServiceAutomation/RatingModel</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="RatingModel.md" target="_blank">projectServiceAutomation/RatingModel</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="RatingModel.md" target="_blank">projectServiceAutomation/RatingModel</a>|
|[ratingModelId](#ratingModelId)|Unique identifier of the rating model.|<a href="RatingModel.md" target="_blank">projectServiceAutomation/RatingModel</a>|
|[name](#name)|Type the name of the rating model.|<a href="RatingModel.md" target="_blank">projectServiceAutomation/RatingModel</a>|
|[maxRatingValue](#maxRatingValue)|Enter the maximum rating value.|<a href="RatingModel.md" target="_blank">projectServiceAutomation/RatingModel</a>|
|[minRatingValue](#minRatingValue)|Enter the minimum rating value.|<a href="RatingModel.md" target="_blank">projectServiceAutomation/RatingModel</a>|
|[stateCode](#stateCode)|Status of the Rating Model|<a href="RatingModel.md" target="_blank">projectServiceAutomation/RatingModel</a>|
|[stateCode_display](#stateCode_display)||<a href="RatingModel.md" target="_blank">projectServiceAutomation/RatingModel</a>|
|[statusCode](#statusCode)|Reason for the status of the Rating Model|<a href="RatingModel.md" target="_blank">projectServiceAutomation/RatingModel</a>|
|[statusCode_display](#statusCode_display)||<a href="RatingModel.md" target="_blank">projectServiceAutomation/RatingModel</a>|
|[exchangeRate](#exchangeRate)|Exchange rate for the currency associated with the ratingmodel with respect to the base currency.|<a href="RatingModel.md" target="_blank">projectServiceAutomation/RatingModel</a>|
|[transactionCurrencyId](#transactionCurrencyId)|Exchange rate for the currency associated with the RatingModel with respect to the base currency.|<a href="RatingModel.md" target="_blank">projectServiceAutomation/RatingModel</a>|
|[ratableEntity](#ratableEntity)|Shows whether the entity can use the rating model.|<a href="RatingModel.md" target="_blank">projectServiceAutomation/RatingModel</a>|
|[ratableEntity_display](#ratableEntity_display)||<a href="RatingModel.md" target="_blank">projectServiceAutomation/RatingModel</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: projectServiceAutomation/RatingModel (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Rating Model</td></tr><tr><td>description</td><td>Unique identifier of the rating model.</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>sourceName</td><td>ratingmodelid</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Unique identifier of the rating model.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"ratingmodelid"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Name</td></tr><tr><td>description</td><td>Type the name of the rating model.</td></tr><tr><td>dataFormat</td><td>7</td></tr><tr><td>maximumLength</td><td>100</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>name</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Type the name of the rating model.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
### <a href=#maxRatingValue name="maxRatingValue">maxRatingValue</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Max Rating Value</td></tr><tr><td>description</td><td>Enter the maximum rating value.</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>maximumValue</td><td>200</td></tr><tr><td>minimumValue</td><td>-200</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>maxratingvalue</td></tr></table>

#### Traits

<details>
<summary>List of traits for the maxRatingValue attribute are listed below.</summary>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Max Rating Value</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"maxratingvalue"</td><td>string</td><td></td></tr></table>
...
### <a href=#minRatingValue name="minRatingValue">minRatingValue</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Min Rating Value</td></tr><tr><td>description</td><td>Enter the minimum rating value.</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>maximumValue</td><td>200</td></tr><tr><td>minimumValue</td><td>-200</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>minratingvalue</td></tr></table>

#### Traits

<details>
<summary>List of traits for the minRatingValue attribute are listed below.</summary>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Min Rating Value</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"minratingvalue"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Rating Model</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the Rating Model</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Rating Model</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the Rating Model</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>ExchangeRate</td></tr><tr><td>description</td><td>Exchange rate for the currency associated with the ratingmodel with respect to the base currency.</td></tr><tr><td>dataFormat</td><td>16</td></tr><tr><td>maximumValue</td><td>100000000000</td></tr><tr><td>minimumValue</td><td>1E-10</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>exchangerate</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Currency</td></tr><tr><td>description</td><td>Exchange rate for the currency associated with the RatingModel with respect to the base currency.</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>transactioncurrencyid</td></tr></table>
...
### <a href=#ratableEntity name="ratableEntity">ratableEntity</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Ratable Entity</td></tr><tr><td>description</td><td>Shows whether the entity can use the rating model.</td></tr><tr><td>dataFormat</td><td>2</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyn_ratableentity</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>None</td><td>192350000</td></tr><tr><td>en</td><td>Skill</td><td>192350001</td></tr></table></td></tr></table>

#### Traits

<details>
<summary>List of traits for the ratableEntity attribute are listed below.</summary>

**is.dataFormat.integer**  
**does.haveDefault**  
An attribute has a default value  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>default</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>None</td><td>192350000</td></tr><tr><td>en</td><td>Skill</td><td>192350001</td></tr></table></td><td>any</td><td></td></tr></table>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Ratable Entity</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Shows whether the entity can use the rating model.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.nullable**  
The attribute value may be set to NULL.  

**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_ratableentity"</td><td>string</td><td></td></tr></table>
...
### <a href=#ratableEntity_display name="ratableEntity_display">ratableEntity_display</a>
...
<details>
<summary>List of traits for the ratableEntity_display attribute are listed below.</summary>
...
**is.readOnly**  
**is.addedInSupportOf**  
<table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>inSupportOf</td><td>"ratableEntity"</td><td>attributeName</td><td>output parameter naming the attribute that is being supported</td></tr></table>
