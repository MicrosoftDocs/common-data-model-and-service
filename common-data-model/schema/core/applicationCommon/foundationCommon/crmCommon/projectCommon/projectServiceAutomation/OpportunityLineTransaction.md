...
# Opportunity Line Detail (Deprecated) in projectServiceAutomation(OpportunityLineTransaction)
...
|[createdBy](#createdBy)|Shows who created the record.|<a href="OpportunityLineTransaction.md" target="_blank">projectServiceAutomation/OpportunityLineTransaction</a>|
...
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="OpportunityLineTransaction.md" target="_blank">projectServiceAutomation/OpportunityLineTransaction</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="OpportunityLineTransaction.md" target="_blank">projectServiceAutomation/OpportunityLineTransaction</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="OpportunityLineTransaction.md" target="_blank">projectServiceAutomation/OpportunityLineTransaction</a>|
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>End Date Time</td></tr><tr><td>description</td><td>Enter the end time of the opportunity line estimate.</td></tr><tr><td>dataFormat</td><td>dateTime</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyn_enddatetime</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Start Date Time</td></tr><tr><td>description</td><td>Enter the start date of the opportunity line estimate.</td></tr><tr><td>dataFormat</td><td>dateTime</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyn_startdatetime</td></tr></table>
