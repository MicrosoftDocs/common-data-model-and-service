---
title: ResourceRequirementDetail in scheduling - Common Data Model | Microsoft Docs
...
# Resource Requirement Detail in scheduling
...
|[createdBy](#createdBy)|Shows who created the record.|<a href="ResourceRequirementDetail.md" target="_blank">scheduling/ResourceRequirementDetail</a>|
...
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="ResourceRequirementDetail.md" target="_blank">scheduling/ResourceRequirementDetail</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="ResourceRequirementDetail.md" target="_blank">scheduling/ResourceRequirementDetail</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="ResourceRequirementDetail.md" target="_blank">scheduling/ResourceRequirementDetail</a>|
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>From</td></tr><tr><td>description</td><td>Enter the date and time from which a contiguous piece of time duration is required</td></tr><tr><td>dataFormat</td><td>dateTime</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyn_from</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>To</td></tr><tr><td>description</td><td>The end of requirement detail</td></tr><tr><td>dataFormat</td><td>dateTime</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyn_to</td></tr></table>
