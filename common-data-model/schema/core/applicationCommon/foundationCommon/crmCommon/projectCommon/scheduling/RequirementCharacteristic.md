---
title: RequirementCharacteristic in scheduling - Common Data Model | Microsoft Docs
...
# Requirement Characteristic in scheduling

Requirement Characteristic  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/projectCommon/scheduling/RequirementCharacteristic.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/core/applicationCommon/foundationCommon<br>/crmCommon/projectCommon/scheduling<br>/RequirementCharacteristic.cdm.json<br>/RequirementCharacteristic/hasAttributes<br>/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[RequirementCharacteristic/(resolvedAttributes)/requirementCharacteristicId](#requirementCharacteristicId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[RequirementCharacteristic/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Requirement Characteristic</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Requirement Characteristic</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_requirementcharacteristic"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="RequirementCharacteristic.md" target="_blank">scheduling/RequirementCharacteristic</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="RequirementCharacteristic.md" target="_blank">scheduling/RequirementCharacteristic</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="RequirementCharacteristic.md" target="_blank">scheduling/RequirementCharacteristic</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="RequirementCharacteristic.md" target="_blank">scheduling/RequirementCharacteristic</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="RequirementCharacteristic.md" target="_blank">scheduling/RequirementCharacteristic</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="RequirementCharacteristic.md" target="_blank">scheduling/RequirementCharacteristic</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="RequirementCharacteristic.md" target="_blank">scheduling/RequirementCharacteristic</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="RequirementCharacteristic.md" target="_blank">scheduling/RequirementCharacteristic</a>|
|[ownerId](#ownerId)|Owner Id|<a href="RequirementCharacteristic.md" target="_blank">scheduling/RequirementCharacteristic</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="RequirementCharacteristic.md" target="_blank">scheduling/RequirementCharacteristic</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="RequirementCharacteristic.md" target="_blank">scheduling/RequirementCharacteristic</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="RequirementCharacteristic.md" target="_blank">scheduling/RequirementCharacteristic</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="RequirementCharacteristic.md" target="_blank">scheduling/RequirementCharacteristic</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="RequirementCharacteristic.md" target="_blank">scheduling/RequirementCharacteristic</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="RequirementCharacteristic.md" target="_blank">scheduling/RequirementCharacteristic</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="RequirementCharacteristic.md" target="_blank">scheduling/RequirementCharacteristic</a>|
|[requirementCharacteristicId](#requirementCharacteristicId)|A unique identifier for an entity instance|<a href="RequirementCharacteristic.md" target="_blank">scheduling/RequirementCharacteristic</a>|
|[stateCode](#stateCode)|Status of the Requirement Characteristic|<a href="RequirementCharacteristic.md" target="_blank">scheduling/RequirementCharacteristic</a>|
|[stateCode_display](#stateCode_display)||<a href="RequirementCharacteristic.md" target="_blank">scheduling/RequirementCharacteristic</a>|
|[statusCode](#statusCode)|Reason for the status of the Requirement Characteristic|<a href="RequirementCharacteristic.md" target="_blank">scheduling/RequirementCharacteristic</a>|
|[statusCode_display](#statusCode_display)||<a href="RequirementCharacteristic.md" target="_blank">scheduling/RequirementCharacteristic</a>|
|[name](#name)|The name of a custom entity|<a href="RequirementCharacteristic.md" target="_blank">scheduling/RequirementCharacteristic</a>|
|[characteristic](#characteristic)|Characteristic|<a href="RequirementCharacteristic.md" target="_blank">scheduling/RequirementCharacteristic</a>|
|[ratingValue](#ratingValue)|Rating Value|<a href="RequirementCharacteristic.md" target="_blank">scheduling/RequirementCharacteristic</a>|
|[resourceRequirement](#resourceRequirement)|Resource Requirement|<a href="RequirementCharacteristic.md" target="_blank">scheduling/RequirementCharacteristic</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: scheduling/RequirementCharacteristic (this entity)  
...
### <a href=#requirementCharacteristicId name="requirementCharacteristicId">requirementCharacteristicId</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Requirement Characteristic</td></tr><tr><td>description</td><td>A unique identifier for an entity instance</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>sourceName</td><td>msdyn_requirementcharacteristicid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the requirementCharacteristicId attribute are listed below.</summary>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_requirementcharacteristicid"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Requirement Characteristic</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the Requirement Characteristic</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the Requirement Characteristic</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Name</td></tr><tr><td>description</td><td>The name of a custom entity</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>100</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyn_name</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>The name of a custom entity</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Characteristic</td></tr><tr><td>description</td><td>Characteristic</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyn_characteristic</td></tr></table>
...
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="../projectServiceAutomation/Characteristic.md" target="_blank">/core/applicationCommon/foundationCommon/crmCommon/projectCommon/projectServiceAutomation/Characteristic.cdm.json/Characteristic</a></td><td><a href="../projectServiceAutomation/Characteristic.md#characteristicId" target="_blank">characteristicId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Rating Value</td></tr><tr><td>description</td><td>Rating Value</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyn_ratingvalue</td></tr></table>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_ratingvalue"</td><td>string</td><td></td></tr></table>
