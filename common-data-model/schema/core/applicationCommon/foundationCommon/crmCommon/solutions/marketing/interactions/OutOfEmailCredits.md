...
<a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/solutions/marketing/interactions/OutOfEmailCredits.cdm.json" target="_blank">Entity definition</a> on GitHub.  

## Instances

interactions/OutOfEmailCredits  

## Traits for Out of email credits
...
- **is.identifiedBy**  
  ...
  ```
  "OutOfEmailCredits_/hasAttributes/interactionId"
  ```
