---
title: FormPageTemplate in MarketingSolution - Common Data Model | Microsoft Docs
...
# Form Page Template in MarketingSolution

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Marketing\MarketingSolution/FormPageTemplate.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/Marketing/MarketingSolution<br>/FormPageTemplate.cdm.json/FormPageTemplate<br>/hasAttributes/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specific identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[FormPageTemplate/(resolvedAttributes)/formPageTemplateId](#formPageTemplateId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[FormPageTemplate/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Form Page Template</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyncrm_formpagetemplate"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="FormPageTemplate.md" target="_blank">Marketing\MarketingSolution/FormPageTemplate</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="FormPageTemplate.md" target="_blank">Marketing\MarketingSolution/FormPageTemplate</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="FormPageTemplate.md" target="_blank">Marketing\MarketingSolution/FormPageTemplate</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="FormPageTemplate.md" target="_blank">Marketing\MarketingSolution/FormPageTemplate</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="FormPageTemplate.md" target="_blank">Marketing\MarketingSolution/FormPageTemplate</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="FormPageTemplate.md" target="_blank">Marketing\MarketingSolution/FormPageTemplate</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="FormPageTemplate.md" target="_blank">Marketing\MarketingSolution/FormPageTemplate</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="FormPageTemplate.md" target="_blank">Marketing\MarketingSolution/FormPageTemplate</a>|
|[ownerId](#ownerId)|Owner Id|<a href="FormPageTemplate.md" target="_blank">Marketing\MarketingSolution/FormPageTemplate</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="FormPageTemplate.md" target="_blank">Marketing\MarketingSolution/FormPageTemplate</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="FormPageTemplate.md" target="_blank">Marketing\MarketingSolution/FormPageTemplate</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="FormPageTemplate.md" target="_blank">Marketing\MarketingSolution/FormPageTemplate</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="FormPageTemplate.md" target="_blank">Marketing\MarketingSolution/FormPageTemplate</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="FormPageTemplate.md" target="_blank">Marketing\MarketingSolution/FormPageTemplate</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="FormPageTemplate.md" target="_blank">Marketing\MarketingSolution/FormPageTemplate</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="FormPageTemplate.md" target="_blank">Marketing\MarketingSolution/FormPageTemplate</a>|
|[confirmationMessage](#confirmationMessage)||<a href="FormPageTemplate.md" target="_blank">Marketing\MarketingSolution/FormPageTemplate</a>|
|[errorMessage](#errorMessage)||<a href="FormPageTemplate.md" target="_blank">Marketing\MarketingSolution/FormPageTemplate</a>|
|[marketingFormId](#marketingFormId)|Usage of a marketing form on a marketing page template.|<a href="FormPageTemplate.md" target="_blank">Marketing\MarketingSolution/FormPageTemplate</a>|
|[formPageTemplateId](#formPageTemplateId)|Unique ID for entity instances|<a href="FormPageTemplate.md" target="_blank">Marketing\MarketingSolution/FormPageTemplate</a>|
|[limitExceededMessage](#limitExceededMessage)||<a href="FormPageTemplate.md" target="_blank">Marketing\MarketingSolution/FormPageTemplate</a>|
|[marketingPageTemplateId](#marketingPageTemplateId)|Unique ID of the marketing page template associated with the form-page template|<a href="FormPageTemplate.md" target="_blank">Marketing\MarketingSolution/FormPageTemplate</a>|
|[name](#name)|Name of the marketing form page template|<a href="FormPageTemplate.md" target="_blank">Marketing\MarketingSolution/FormPageTemplate</a>|
|[redirectURL](#redirectURL)||<a href="FormPageTemplate.md" target="_blank">Marketing\MarketingSolution/FormPageTemplate</a>|
|[ownerIdName](#ownerIdName)|Name of the owner|<a href="FormPageTemplate.md" target="_blank">Marketing\MarketingSolution/FormPageTemplate</a>|
|[ownerIdYomiName](#ownerIdYomiName)|Yomi name of the owner|<a href="FormPageTemplate.md" target="_blank">Marketing\MarketingSolution/FormPageTemplate</a>|
|[stateCode](#stateCode)|Status of the form page template|<a href="FormPageTemplate.md" target="_blank">Marketing\MarketingSolution/FormPageTemplate</a>|
|[stateCode_display](#stateCode_display)||<a href="FormPageTemplate.md" target="_blank">Marketing\MarketingSolution/FormPageTemplate</a>|
|[statusCode](#statusCode)|Form page template status reason|<a href="FormPageTemplate.md" target="_blank">Marketing\MarketingSolution/FormPageTemplate</a>|
|[statusCode_display](#statusCode_display)||<a href="FormPageTemplate.md" target="_blank">Marketing\MarketingSolution/FormPageTemplate</a>|
|[successImageURL](#successImageURL)||<a href="FormPageTemplate.md" target="_blank">Marketing\MarketingSolution/FormPageTemplate</a>|
|[errorImageURL](#errorImageURL)||<a href="FormPageTemplate.md" target="_blank">Marketing\MarketingSolution/FormPageTemplate</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: Marketing\\MarketingSolution/FormPageTemplate (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Marketing form</td></tr><tr><td>description</td><td>Usage of a marketing form on a marketing page template.</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyncrm_marketingformid</td></tr></table>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Usage of a marketing form on a marketing page template.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.linkedEntity.identifier*  
  Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="MarketingForm.md" target="_blank">MarketingForm.cdm.json/MarketingForm</a></td><td><a href="MarketingForm.md#marketingFormId" target="_blank">marketingFormId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
...
### <a href=#formPageTemplateId name="formPageTemplateId">formPageTemplateId</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Form page template</td></tr><tr><td>description</td><td>Unique ID for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>sourceName</td><td>msdyncrm_formpagetemplateid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the formPageTemplateId attribute are listed below.</summary>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyncrm_formpagetemplateid"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Marketing page template</td></tr><tr><td>description</td><td>Unique ID of the marketing page template associated with the form-page template</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyncrm_marketingpagetemplateid</td></tr></table>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Unique ID of the marketing page template associated with the form-page template</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyncrm_marketingpagetemplateid"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Name</td></tr><tr><td>description</td><td>Name of the marketing form page template</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>100</td></tr><tr><td>sourceName</td><td>msdyncrm_name</td></tr></table>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Name of the marketing form page template</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the form page template</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the form page template</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status reason</td></tr><tr><td>description</td><td>Form page template status reason</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Form page template status reason</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
