...
<a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/solutions/marketing/interactions/ActivityContactDispatched.cdm.json" target="_blank">Entity definition</a> on GitHub.  

## Instances

interactions/ActivityContactDispatched  

## Traits for Activity contact dispatched
...
- **is.identifiedBy**  
  ...
  ```
  "ActivityContactDispatched_/hasAttributes/interactionId"
  ```
