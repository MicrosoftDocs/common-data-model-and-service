...
- **is.identifiedBy**  
  ...
  ```
  "EventVendor/hasAttributes/eventVendorId"
  ```
...
- **means.entityState**  
  ...
  ```
  "EventVendor/hasAttributes/stateCode"
  ```
