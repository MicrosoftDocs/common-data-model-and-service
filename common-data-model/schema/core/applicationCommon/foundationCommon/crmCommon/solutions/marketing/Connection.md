---
title: Connection in MarketingSolution - Common Data Model | Microsoft Docs
...
# Connection in MarketingSolution

Relationship between two entities.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Marketing\MarketingSolution/Connection.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specific identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[Connection/(resolvedAttributes)/connectionId](#connectionId)</td><td>attribute</td><td></td></tr></table>
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/applicationCommon/Connection.cdm.json<br>/Connection/hasAttributes<br>/attributesAddedAtThisScope</td></tr><tr><td>/Marketing/MarketingSolution/Connection.cdm.json<br>/Connection/hasAttributes<br>/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>
...
|---|---|---|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="Connection.md" target="_blank">Marketing\MarketingSolution/Connection</a>|
|[owningUser](#owningUser)|Unique identifier of the user who owns the connection.|<a href="Connection.md" target="_blank">Marketing\MarketingSolution/Connection</a>|
|[statusCode](#statusCode)|Reason for the status of the connection.|<a href="Connection.md" target="_blank">Marketing\MarketingSolution/Connection</a>|
|[statusCode_display](#statusCode_display)||<a href="Connection.md" target="_blank">Marketing\MarketingSolution/Connection</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="Connection.md" target="_blank">Marketing\MarketingSolution/Connection</a>|
|[connectionId](#connectionId)|Unique identifier of the connection.|<a href="Connection.md" target="_blank">Marketing\MarketingSolution/Connection</a>|
|[versionNumber](#versionNumber)|Version number of the connection.|<a href="Connection.md" target="_blank">Marketing\MarketingSolution/Connection</a>|
|[effectiveStart](#effectiveStart)|Enter the start date of the connection.|<a href="Connection.md" target="_blank">Marketing\MarketingSolution/Connection</a>|
|[isMaster](#isMaster)|Indicates that this is the master record.|<a href="Connection.md" target="_blank">Marketing\MarketingSolution/Connection</a>|
|[ownerId](#ownerId)|Owner Id|<a href="Connection.md" target="_blank">Marketing\MarketingSolution/Connection</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="Connection.md" target="_blank">Marketing\MarketingSolution/Connection</a>|
|[relatedConnectionId](#relatedConnectionId)|Unique identifier for the reciprocal connection record.|<a href="Connection.md" target="_blank">Marketing\MarketingSolution/Connection</a>|
|[description](#description)|Type additional information to describe the connection, such as the length or quality of the relationship.|<a href="Connection.md" target="_blank">Marketing\MarketingSolution/Connection</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Shows the business unit that the record owner belongs to.|<a href="Connection.md" target="_blank">Marketing\MarketingSolution/Connection</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="Connection.md" target="_blank">Marketing\MarketingSolution/Connection</a>|
|[record2Id](#record2Id)|Unique identifier of the target record.|<a href="Connection.md" target="_blank">Marketing\MarketingSolution/Connection</a>|
|[record2IdObjectTypeCode](#record2IdObjectTypeCode)|The name of the entity linked by record2Id|<a href="Connection.md" target="_blank">Marketing\MarketingSolution/Connection</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="Connection.md" target="_blank">Marketing\MarketingSolution/Connection</a>|
|[record2RoleId](#record2RoleId)|Choose the secondary party's role or relationship with the primary party.|<a href="Connection.md" target="_blank">Marketing\MarketingSolution/Connection</a>|
|[effectiveEnd](#effectiveEnd)|Enter the end date of the connection.|<a href="Connection.md" target="_blank">Marketing\MarketingSolution/Connection</a>|
|[record1RoleId](#record1RoleId)|Choose the primary party's role or relationship with the second party.|<a href="Connection.md" target="_blank">Marketing\MarketingSolution/Connection</a>|
|[createdOn](#createdOn)|Shows the date and time when the record was created. The date and time are displayed in the time zone selected in Microsoft Dynamics 365 options.|<a href="Connection.md" target="_blank">Marketing\MarketingSolution/Connection</a>|
|[modifiedOn](#modifiedOn)|Shows the date and time when the record was last updated. The date and time are displayed in the time zone selected in Microsoft Dynamics 365 options.|<a href="Connection.md" target="_blank">Marketing\MarketingSolution/Connection</a>|
|[record1Id](#record1Id)|Unique identifier of the source record.|<a href="Connection.md" target="_blank">Marketing\MarketingSolution/Connection</a>|
|[record1IdObjectTypeCode](#record1IdObjectTypeCode)|The name of the entity linked by record1Id|<a href="Connection.md" target="_blank">Marketing\MarketingSolution/Connection</a>|
|[stateCode](#stateCode)|Shows whether the connection is active or inactive. Inactive connections are read-only and can't be edited unless they are reactivated.|<a href="Connection.md" target="_blank">Marketing\MarketingSolution/Connection</a>|
|[stateCode_display](#stateCode_display)||<a href="Connection.md" target="_blank">Marketing\MarketingSolution/Connection</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="Connection.md" target="_blank">Marketing\MarketingSolution/Connection</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="Connection.md" target="_blank">Marketing\MarketingSolution/Connection</a>|
|[owningTeam](#owningTeam)|Unique identifier of the team who owns the connection.|<a href="Connection.md" target="_blank">Marketing\MarketingSolution/Connection</a>|
|[transactionCurrencyId](#transactionCurrencyId)|Choose the local currency for the record to make sure budgets are reported in the correct currency.|<a href="Connection.md" target="_blank">Marketing\MarketingSolution/Connection</a>|
|[exchangeRate](#exchangeRate)|Shows the conversion rate of the record's currency. The exchange rate is used to convert all money fields in the record from the local currency to the system's default currency.|<a href="Connection.md" target="_blank">Marketing\MarketingSolution/Connection</a>|
|[record2ObjectTypeCode](#record2ObjectTypeCode)|Shows the record type of the target record.|<a href="Connection.md" target="_blank">Marketing\MarketingSolution/Connection</a>|
|[record2ObjectTypeCode_display](#record2ObjectTypeCode_display)||<a href="Connection.md" target="_blank">Marketing\MarketingSolution/Connection</a>|
|[record1ObjectTypeCode](#record1ObjectTypeCode)|Shows the record type of the source record.|<a href="Connection.md" target="_blank">Marketing\MarketingSolution/Connection</a>|
|[record1ObjectTypeCode_display](#record1ObjectTypeCode_display)||<a href="Connection.md" target="_blank">Marketing\MarketingSolution/Connection</a>|
|[name](#name)|Name of the connection.|<a href="Connection.md" target="_blank">Marketing\MarketingSolution/Connection</a>|
|[entityImageId](#entityImageId)|For internal use only.|<a href="Connection.md" target="_blank">Marketing\MarketingSolution/Connection</a>|

### <a href=#modifiedBy name="modifiedBy">modifiedBy</a>

Shows who last updated the record.  
First included in: Marketing\\MarketingSolution/Connection (this entity)  
...
*is.linkedEntity.identifier*  
  Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="../core/applicationCommon/SocialActivity.md" target="_blank">/core/applicationCommon/SocialActivity.cdm.json/SocialActivity</a></td><td><a href="../core/applicationCommon/SocialActivity.md#activityId" target="_blank">activityId</a></td></tr><tr><td><a href="../core/applicationCommon/Letter.md" target="_blank">/core/applicationCommon/Letter.cdm.json/Letter</a></td><td><a href="../core/applicationCommon/Letter.md#activityId" target="_blank">activityId</a></td></tr><tr><td><a href="../core/applicationCommon/Email.md" target="_blank">/core/applicationCommon/Email.cdm.json/Email</a></td><td><a href="../core/applicationCommon/Email.md#activityId" target="_blank">activityId</a></td></tr><tr><td><a href="../core/applicationCommon/User.md" target="_blank">/core/applicationCommon/User.cdm.json/User</a></td><td><a href="../core/applicationCommon/User.md#systemUserId" target="_blank">systemUserId</a></td></tr><tr><td><a href="Account.md" target="_blank">Account.cdm.json/Account</a></td><td><a href="Account.md#accountId" target="_blank">accountId</a></td></tr><tr><td><a href="Appointment.md" target="_blank">Appointment.cdm.json/Appointment</a></td><td><a href="Appointment.md#activityId" target="_blank">activityId</a></td></tr><tr><td><a href="Contact.md" target="_blank">Contact.cdm.json/Contact</a></td><td><a href="Contact.md#contactId" target="_blank">contactId</a></td></tr><tr><td><a href="Task.md" target="_blank">Task.cdm.json/Task</a></td><td><a href="Task.md#activityId" target="_blank">activityId</a></td></tr><tr><td><a href="../core/applicationCommon/SocialProfile.md" target="_blank">/core/applicationCommon/SocialProfile.cdm.json/SocialProfile</a></td><td><a href="../core/applicationCommon/SocialProfile.md#socialProfileId" target="_blank">socialProfileId</a></td></tr><tr><td><a href="../core/applicationCommon/Activity.md" target="_blank">/core/applicationCommon/Activity.cdm.json/Activity</a></td><td><a href="../core/applicationCommon/Activity.md#activityId" target="_blank">activityId</a></td></tr><tr><td><a href="../core/applicationCommon/Goal.md" target="_blank">/core/applicationCommon/Goal.cdm.json/Goal</a></td><td><a href="../core/applicationCommon/Goal.md#goalId" target="_blank">goalId</a></td></tr><tr><td><a href="../core/applicationCommon/KnowledgeBaseRecord.md" target="_blank">/core/applicationCommon/KnowledgeBaseRecord.cdm.json/KnowledgeBaseRecord</a></td><td><a href="../core/applicationCommon/KnowledgeBaseRecord.md#knowledgeBaseRecordId" target="_blank">knowledgeBaseRecordId</a></td></tr><tr><td><a href="../core/applicationCommon/KnowledgeArticle.md" target="_blank">/core/applicationCommon/KnowledgeArticle.cdm.json/KnowledgeArticle</a></td><td><a href="../core/applicationCommon/KnowledgeArticle.md#knowledgearticleId" target="_blank">knowledgearticleId</a></td></tr><tr><td><a href="../core/applicationCommon/Position.md" target="_blank">/core/applicationCommon/Position.cdm.json/Position</a></td><td><a href="../core/applicationCommon/Position.md#positionId" target="_blank">positionId</a></td></tr><tr><td><a href="../core/applicationCommon/Fax.md" target="_blank">/core/applicationCommon/Fax.cdm.json/Fax</a></td><td><a href="../core/applicationCommon/Fax.md#activityId" target="_blank">activityId</a></td></tr><tr><td><a href="../core/applicationCommon/Team.md" target="_blank">/core/applicationCommon/Team.cdm.json/Team</a></td><td><a href="../core/applicationCommon/Team.md#teamId" target="_blank">teamId</a></td></tr><tr><td><a href="../core/applicationCommon/RecurringAppointment.md" target="_blank">/core/applicationCommon/RecurringAppointment.cdm.json/RecurringAppointment</a></td><td><a href="../core/applicationCommon/RecurringAppointment.md#activityId" target="_blank">activityId</a></td></tr><tr><td><a href="PhoneCall.md" target="_blank">PhoneCall.cdm.json/PhoneCall</a></td><td><a href="PhoneCall.md#activityId" target="_blank">activityId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
...
*is.linkedEntity.identifier*  
  Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="../core/applicationCommon/ConnectionRole.md" target="_blank">/core/applicationCommon/ConnectionRole.cdm.json/ConnectionRole</a></td><td><a href="../core/applicationCommon/ConnectionRole.md#connectionRoleId" target="_blank">connectionRoleId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
