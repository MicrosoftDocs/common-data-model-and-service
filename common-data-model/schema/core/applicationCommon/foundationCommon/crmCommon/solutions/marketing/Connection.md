---
title: Connection in marketing - Common Data Model | Microsoft Docs
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/applicationCommon/Connection.cdm.json<br>/Connection/hasAttributes<br>/attributesAddedAtThisScope</td></tr><tr><td>/core/applicationCommon/foundationCommon<br>/crmCommon/solutions/marketing/Connection.cdm.json<br>/Connection/hasAttributes<br>/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>
...
|[statusCode](#statusCode)|Reason for the status of the connection.|<a href="Connection.md" target="_blank">marketing/Connection</a>|
|[statusCode_display](#statusCode_display)||<a href="Connection.md" target="_blank">marketing/Connection</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="Connection.md" target="_blank">marketing/Connection</a>|
|[connectionId](#connectionId)|Unique identifier of the connection.|<a href="Connection.md" target="_blank">marketing/Connection</a>|
|[versionNumber](#versionNumber)|Version number of the connection.|<a href="Connection.md" target="_blank">marketing/Connection</a>|
|[effectiveStart](#effectiveStart)|Enter the start date of the connection.|<a href="Connection.md" target="_blank">marketing/Connection</a>|
|[isMaster](#isMaster)|Indicates that this is the master record.|<a href="Connection.md" target="_blank">marketing/Connection</a>|
|[ownerId](#ownerId)|Owner Id|<a href="Connection.md" target="_blank">marketing/Connection</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="Connection.md" target="_blank">marketing/Connection</a>|
|[relatedConnectionId](#relatedConnectionId)|Unique identifier for the reciprocal connection record.|<a href="Connection.md" target="_blank">marketing/Connection</a>|
|[description](#description)|Type additional information to describe the connection, such as the length or quality of the relationship.|<a href="Connection.md" target="_blank">marketing/Connection</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Shows the business unit that the record owner belongs to.|<a href="Connection.md" target="_blank">marketing/Connection</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="Connection.md" target="_blank">marketing/Connection</a>|
|[record2Id](#record2Id)|Unique ID of the target record|<a href="Connection.md" target="_blank">marketing/Connection</a>|
|[record2IdObjectTypeCode](#record2IdObjectTypeCode)|The name of the entity linked by record2Id|<a href="Connection.md" target="_blank">marketing/Connection</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="Connection.md" target="_blank">marketing/Connection</a>|
|[record2RoleId](#record2RoleId)|Choose the secondary party's role or relationship with the primary party.|<a href="Connection.md" target="_blank">marketing/Connection</a>|
|[effectiveEnd](#effectiveEnd)|Enter the end date of the connection.|<a href="Connection.md" target="_blank">marketing/Connection</a>|
|[record1RoleId](#record1RoleId)|Choose the primary party's role or relationship with the second party.|<a href="Connection.md" target="_blank">marketing/Connection</a>|
|[createdOn](#createdOn)|Shows the date and time when the record was created. The date and time are displayed in the time zone selected in Microsoft Dynamics 365 options.|<a href="Connection.md" target="_blank">marketing/Connection</a>|
|[modifiedOn](#modifiedOn)|Shows the date and time when the record was last updated. The date and time are displayed in the time zone selected in Microsoft Dynamics 365 options.|<a href="Connection.md" target="_blank">marketing/Connection</a>|
|[record1Id](#record1Id)|Unique ID of the source record|<a href="Connection.md" target="_blank">marketing/Connection</a>|
|[record1IdObjectTypeCode](#record1IdObjectTypeCode)|The name of the entity linked by record1Id|<a href="Connection.md" target="_blank">marketing/Connection</a>|
|[stateCode](#stateCode)|Shows whether the connection is active or inactive. Inactive connections are read-only and can't be edited unless they are reactivated.|<a href="Connection.md" target="_blank">marketing/Connection</a>|
|[stateCode_display](#stateCode_display)||<a href="Connection.md" target="_blank">marketing/Connection</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="Connection.md" target="_blank">marketing/Connection</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="Connection.md" target="_blank">marketing/Connection</a>|
|[owningTeam](#owningTeam)|Unique identifier of the team who owns the connection.|<a href="Connection.md" target="_blank">marketing/Connection</a>|
|[transactionCurrencyId](#transactionCurrencyId)|Choose the local currency for the record to make sure budgets are reported in the correct currency.|<a href="Connection.md" target="_blank">marketing/Connection</a>|
|[exchangeRate](#exchangeRate)|Shows the conversion rate of the record's currency. The exchange rate is used to convert all money fields in the record from the local currency to the system's default currency.|<a href="Connection.md" target="_blank">marketing/Connection</a>|
|[record2ObjectTypeCode](#record2ObjectTypeCode)|Shows the record type of the target record.|<a href="Connection.md" target="_blank">marketing/Connection</a>|
|[record2ObjectTypeCode_display](#record2ObjectTypeCode_display)||<a href="Connection.md" target="_blank">marketing/Connection</a>|
|[record1ObjectTypeCode](#record1ObjectTypeCode)|Shows the record type of the source record.|<a href="Connection.md" target="_blank">marketing/Connection</a>|
|[record1ObjectTypeCode_display](#record1ObjectTypeCode_display)||<a href="Connection.md" target="_blank">marketing/Connection</a>|
|[name](#name)|Name of the connection.|<a href="Connection.md" target="_blank">marketing/Connection</a>|
|[entityImageId](#entityImageId)|For internal use only.|<a href="Connection.md" target="_blank">marketing/Connection</a>|

### <a href=#modifiedBy name="modifiedBy">modifiedBy</a>

Shows who last updated the record.  
First included in: marketing/Connection (this entity)  
...
Unique ID of the target record  
First included in: marketing/Connection (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Connected to</td></tr><tr><td>description</td><td>Unique ID of the target record</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>record2id</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Connected from</td></tr><tr><td>description</td><td>Unique ID of the source record</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>record1id</td></tr></table>
