...
- **is.identifiedBy**  
  ...
  ```
  "LinkedInFormQuestion/hasAttributes/linkedInFormQuestionId"
  ```
...
- **means.entityState**  
  ...
  ```
  "LinkedInFormQuestion/hasAttributes/stateCode"
  ```
