...
- **is.identifiedBy**  
  ...
  ```
  "MarketingEmail/hasAttributes/marketingEmailId"
  ```
...
- **means.entityState**  
  ...
  ```
  "MarketingEmail/hasAttributes/stateCode"
  ```
