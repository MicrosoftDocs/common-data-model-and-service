---
title: PhoneCallActivityMarketingTemplate in MarketingSolution - Common Data Model | Microsoft Docs
...
# Phone Call Activity Marketing Template in MarketingSolution

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Marketing\MarketingSolution/PhoneCallActivityMarketingTemplate.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/Marketing/MarketingSolution<br>/PhoneCallActivityMarketingTemplate.cdm.json<br>/PhoneCallActivityMarketingTemplate/hasAttributes<br>/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specific identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[PhoneCallActivityMarketingTemplate/(resolvedAttributes)/phoneCallActivityMarketingTemplateId](#phoneCallActivityMarketingTemplateId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[PhoneCallActivityMarketingTemplate/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Phone Call Activity Marketing Template</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyncrm_phonecallactivitymarketingtemplate"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="PhoneCallActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/PhoneCallActivityMarketingTemplate</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="PhoneCallActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/PhoneCallActivityMarketingTemplate</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="PhoneCallActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/PhoneCallActivityMarketingTemplate</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="PhoneCallActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/PhoneCallActivityMarketingTemplate</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="PhoneCallActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/PhoneCallActivityMarketingTemplate</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="PhoneCallActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/PhoneCallActivityMarketingTemplate</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="PhoneCallActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/PhoneCallActivityMarketingTemplate</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="PhoneCallActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/PhoneCallActivityMarketingTemplate</a>|
|[ownerId](#ownerId)|Owner Id|<a href="PhoneCallActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/PhoneCallActivityMarketingTemplate</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="PhoneCallActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/PhoneCallActivityMarketingTemplate</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="PhoneCallActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/PhoneCallActivityMarketingTemplate</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="PhoneCallActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/PhoneCallActivityMarketingTemplate</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="PhoneCallActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/PhoneCallActivityMarketingTemplate</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="PhoneCallActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/PhoneCallActivityMarketingTemplate</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="PhoneCallActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/PhoneCallActivityMarketingTemplate</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="PhoneCallActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/PhoneCallActivityMarketingTemplate</a>|
|[scheduleddurationminutes](#scheduleddurationminutes)|Shows the expected duration of the phone call, in minutes|<a href="PhoneCallActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/PhoneCallActivityMarketingTemplate</a>|
|[description](#description)|Enter additional information to describe the phone call, such as the primary message or the products and services discussed|<a href="PhoneCallActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/PhoneCallActivityMarketingTemplate</a>|
|[name](#name)|The name of the custom entity|<a href="PhoneCallActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/PhoneCallActivityMarketingTemplate</a>|
|[phoneCallActivityMarketingTemplateId](#phoneCallActivityMarketingTemplateId)|Unique ID for entity instances|<a href="PhoneCallActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/PhoneCallActivityMarketingTemplate</a>|
|[prioritycode](#prioritycode)|Select the priority so that preferred customers or critical issues are handled quickly|<a href="PhoneCallActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/PhoneCallActivityMarketingTemplate</a>|
|[prioritycode_display](#prioritycode_display)||<a href="PhoneCallActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/PhoneCallActivityMarketingTemplate</a>|
|[scheduleType](#scheduleType)||<a href="PhoneCallActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/PhoneCallActivityMarketingTemplate</a>|
|[scheduleType_display](#scheduleType_display)||<a href="PhoneCallActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/PhoneCallActivityMarketingTemplate</a>|
|[startDate](#startDate)||<a href="PhoneCallActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/PhoneCallActivityMarketingTemplate</a>|
|[startDelay](#startDelay)||<a href="PhoneCallActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/PhoneCallActivityMarketingTemplate</a>|
|[startTimeHour](#startTimeHour)||<a href="PhoneCallActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/PhoneCallActivityMarketingTemplate</a>|
|[startTimeHour_display](#startTimeHour_display)||<a href="PhoneCallActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/PhoneCallActivityMarketingTemplate</a>|
|[startTimeMinute](#startTimeMinute)||<a href="PhoneCallActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/PhoneCallActivityMarketingTemplate</a>|
|[startTimeMinute_display](#startTimeMinute_display)||<a href="PhoneCallActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/PhoneCallActivityMarketingTemplate</a>|
|[subject](#subject)|Enter a short description about the objective or primary topic of the phone call|<a href="PhoneCallActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/PhoneCallActivityMarketingTemplate</a>|
|[ownerIdName](#ownerIdName)|Name of the owner|<a href="PhoneCallActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/PhoneCallActivityMarketingTemplate</a>|
|[ownerIdYomiName](#ownerIdYomiName)|Yomi name of the owner|<a href="PhoneCallActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/PhoneCallActivityMarketingTemplate</a>|
|[stateCode](#stateCode)|Status of the phone-call activity marketing template|<a href="PhoneCallActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/PhoneCallActivityMarketingTemplate</a>|
|[stateCode_display](#stateCode_display)||<a href="PhoneCallActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/PhoneCallActivityMarketingTemplate</a>|
|[statusCode](#statusCode)|Reason for the status of the phone-call activity marketing template|<a href="PhoneCallActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/PhoneCallActivityMarketingTemplate</a>|
|[statusCode_display](#statusCode_display)||<a href="PhoneCallActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/PhoneCallActivityMarketingTemplate</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: Marketing\\MarketingSolution/PhoneCallActivityMarketingTemplate (this entity)  
...
Shows the expected duration of the phone call, in minutes  
First included in: Marketing\\MarketingSolution/PhoneCallActivityMarketingTemplate (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Duration</td></tr><tr><td>description</td><td>Shows the expected duration of the phone call, in minutes</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>maximumValue</td><td>2147483647</td></tr><tr><td>minimumValue</td><td>0</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyncrm_scheduleddurationminutes</td></tr></table>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Shows the expected duration of the phone call, in minutes</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
Enter additional information to describe the phone call, such as the primary message or the products and services discussed  
First included in: Marketing\\MarketingSolution/PhoneCallActivityMarketingTemplate (this entity)  
...
### <a href=#phoneCallActivityMarketingTemplateId name="phoneCallActivityMarketingTemplateId">phoneCallActivityMarketingTemplateId</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Phone-call activity marketing template</td></tr><tr><td>description</td><td>Unique ID for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>sourceName</td><td>msdyncrm_phonecallactivitymarketingtemplateid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the phoneCallActivityMarketingTemplateId attribute are listed below.</summary>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyncrm_phonecallactivitymarketingtemplateid"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Priority</td></tr><tr><td>description</td><td>Select the priority so that preferred customers or critical issues are handled quickly</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>sourceName</td><td>msdyncrm_prioritycode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Low</td><td>0</td></tr><tr><td>en</td><td>Normal</td><td>1</td></tr><tr><td>en</td><td>High</td><td>2</td></tr></table></td></tr></table>
...
Enter a short description about the objective or primary topic of the phone call  
First included in: Marketing\\MarketingSolution/PhoneCallActivityMarketingTemplate (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Subject</td></tr><tr><td>description</td><td>Enter a short description about the objective or primary topic of the phone call</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>200</td></tr><tr><td>sourceName</td><td>msdyncrm_subject</td></tr></table>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Enter a short description about the objective or primary topic of the phone call</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the phone-call activity marketing template</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
Reason for the status of the phone-call activity marketing template  
First included in: Marketing\\MarketingSolution/PhoneCallActivityMarketingTemplate (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status reason</td></tr><tr><td>description</td><td>Reason for the status of the phone-call activity marketing template</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the phone-call activity marketing template</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
