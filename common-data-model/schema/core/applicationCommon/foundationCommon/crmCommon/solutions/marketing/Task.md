...
Generic activity representing work needed to be done.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/solutions/marketing/Task.cdm.json" target="_blank">GitHub</a>.  
...
- [/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/Task](../../accelerators/healthCare/electronicMedicalRecords/Task.md "/core/applicationCommon/foundationCommon/crmCommon/accelerators/healthCare/electronicMedicalRecords/Task.cdm.json/Task")  
...
- /crmCommon/solutions/marketing/Task  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="Task.md" target="_blank">marketing/Task</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="Task.md" target="_blank">marketing/Task</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="Task.md" target="_blank">marketing/Task</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="Task.md" target="_blank">marketing/Task</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="Task.md" target="_blank">marketing/Task</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="Task.md" target="_blank">marketing/Task</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="Task.md" target="_blank">marketing/Task</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="Task.md" target="_blank">marketing/Task</a>|
|[ownerId](#ownerId)|Owner Id|<a href="Task.md" target="_blank">marketing/Task</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="Task.md" target="_blank">marketing/Task</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="Task.md" target="_blank">marketing/Task</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="Task.md" target="_blank">marketing/Task</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="Task.md" target="_blank">marketing/Task</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="Task.md" target="_blank">marketing/Task</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="Task.md" target="_blank">marketing/Task</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="Task.md" target="_blank">marketing/Task</a>|
|[activityId](#activityId)|Unique identifier of the activity.|<a href="Task.md" target="_blank">marketing/Task</a>|
|[activityTypeCode](#activityTypeCode)|Type of activity.|<a href="Task.md" target="_blank">marketing/Task</a>|
|[isBilled](#isBilled)|Information regarding whether the fax activity was billed as part of resolving a case.|<a href="Task.md" target="_blank">marketing/Task</a>|
|[isRegularActivity](#isRegularActivity)|Information regarding whether the activity is a regular activity type or event type.|<a href="Task.md" target="_blank">marketing/Task</a>|
|[isWorkflowCreated](#isWorkflowCreated)|Information regarding whether the activity was created from a workflow rule.|<a href="Task.md" target="_blank">marketing/Task</a>|
|[priorityCode](#priorityCode)|Priority of the activity.|<a href="Task.md" target="_blank">marketing/Task</a>|
|[priorityCode_display](#priorityCode_display)||<a href="Task.md" target="_blank">marketing/Task</a>|
|[regardingObjectId](#regardingObjectId)|Unique identifier of the object with which the activity is associated.|<a href="Task.md" target="_blank">marketing/Task</a>|
|[regardingObjectTypeCode](#regardingObjectTypeCode)|The name of the entity linked by regardingObjectId|<a href="Task.md" target="_blank">marketing/Task</a>|
|[scheduledEnd](#scheduledEnd)|Scheduled end time of the activity.|<a href="Task.md" target="_blank">marketing/Task</a>|
|[scheduledStart](#scheduledStart)|Scheduled start time of the activity.|<a href="Task.md" target="_blank">marketing/Task</a>|
|[sortDate](#sortDate)|Shows the date and time by which the activities are sorted.|<a href="Task.md" target="_blank">marketing/Task</a>|
|[subject](#subject)|Subject associated with the activity.|<a href="Task.md" target="_blank">marketing/Task</a>|
|[scheduledDurationMinutes](#scheduledDurationMinutes)|Scheduled duration of the activity, specified in minutes.|<a href="Task.md" target="_blank">marketing/Task</a>|
|[actualDurationMinutes](#actualDurationMinutes)|Actual duration of the activity in minutes.|<a href="Task.md" target="_blank">marketing/Task</a>|
|[actualEnd](#actualEnd)|Actual end time of the activity.|<a href="Task.md" target="_blank">marketing/Task</a>|
|[actualStart](#actualStart)|Actual start time of the activity.|<a href="Task.md" target="_blank">marketing/Task</a>|
|[category](#category)|Type a category to identify the activity type, such as lead outreach, customer follow-up, or service alert, to tie the eactivity to a business group or function.|<a href="Task.md" target="_blank">marketing/Task</a>|
|[subcategory](#subcategory)|Type a subcategory to identify the activity type and relate the activity to a specific product, sales region, business group, or other function.|<a href="Task.md" target="_blank">marketing/Task</a>|
|[activityAdditionalParams](#activityAdditionalParams)|Additional information provided by the external application as JSON. For internal use only.|<a href="Task.md" target="_blank">marketing/Task</a>|
|[stateCode](#stateCode)|Shows whether the task is open, completed, or canceled. Completed and canceled tasks are read-only and can't be edited.|<a href="Task.md" target="_blank">marketing/Task</a>|
|[stateCode_display](#stateCode_display)||<a href="Task.md" target="_blank">marketing/Task</a>|
|[description](#description)|Type additional information to describe the task.|<a href="Task.md" target="_blank">marketing/Task</a>|
|[percentComplete](#percentComplete)|Type the percentage complete value for the task to track tasks to completion.|<a href="Task.md" target="_blank">marketing/Task</a>|
|[statusCode](#statusCode)|Select the task's status.|<a href="Task.md" target="_blank">marketing/Task</a>|
|[statusCode_display](#statusCode_display)||<a href="Task.md" target="_blank">marketing/Task</a>|
|[transactionCurrencyId](#transactionCurrencyId)|Choose the local currency for the record to make sure budgets are reported in the correct currency.|<a href="Task.md" target="_blank">marketing/Task</a>|
|[exchangeRate](#exchangeRate)|Shows the conversion rate of the record's currency. The exchange rate is used to convert all money fields in the record from the local currency to the system's default currency.|<a href="Task.md" target="_blank">marketing/Task</a>|
|[processId](#processId)|Shows the ID of the process.|<a href="Task.md" target="_blank">marketing/Task</a>|
|[stageId](#stageId)|Shows the ID of the stage.|<a href="Task.md" target="_blank">marketing/Task</a>|
|[traversedPath](#traversedPath)|For internal use only.|<a href="Task.md" target="_blank">marketing/Task</a>|
|[crmTaskAssignedUniqueId](#crmTaskAssignedUniqueId)|Assigned Task Unique Id|<a href="Task.md" target="_blank">marketing/Task</a>|
|[SLAId](#SLAId)|Choose the service level agreement (SLA) that you want to apply to the Task record.|<a href="Task.md" target="_blank">marketing/Task</a>|
|[SLAInvokedId](#SLAInvokedId)|Last SLA that was applied to this Task. This field is for internal use only.|<a href="Task.md" target="_blank">marketing/Task</a>|
|[onHoldTime](#onHoldTime)|Shows how long, in minutes, that the record was on hold.|<a href="Task.md" target="_blank">marketing/Task</a>|
|[lastOnHoldTime](#lastOnHoldTime)|Contains the date and time stamp of the last on hold time.|<a href="Task.md" target="_blank">marketing/Task</a>|
|[serviceId](#serviceId)|Choose the service that is associated with this activity.|<a href="Task.md" target="_blank">marketing/Task</a>|
|[customerJourneyIteration](#customerJourneyIteration)|Customer journey iteration|<a href="Task.md" target="_blank">marketing/Task</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: marketing/Task (this entity)  
