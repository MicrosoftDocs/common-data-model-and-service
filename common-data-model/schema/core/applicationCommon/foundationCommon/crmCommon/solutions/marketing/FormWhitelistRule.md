---
title: FormWhitelistRule in MarketingSolution - Common Data Model | Microsoft Docs
...
# Form whitelist rule in MarketingSolution(FormWhitelistRule)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Marketing\MarketingSolution/FormWhitelistRule.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/Marketing/MarketingSolution<br>/FormWhitelistRule.cdm.json/FormWhitelistRule<br>/hasAttributes/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specific identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[FormWhitelistRule/(resolvedAttributes)/marketingformwhitelistruleId](#marketingformwhitelistruleId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[FormWhitelistRule/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Form whitelist rule</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyncrm_marketingformwhitelistrule"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="FormWhitelistRule.md" target="_blank">Marketing\MarketingSolution/FormWhitelistRule</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="FormWhitelistRule.md" target="_blank">Marketing\MarketingSolution/FormWhitelistRule</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="FormWhitelistRule.md" target="_blank">Marketing\MarketingSolution/FormWhitelistRule</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="FormWhitelistRule.md" target="_blank">Marketing\MarketingSolution/FormWhitelistRule</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="FormWhitelistRule.md" target="_blank">Marketing\MarketingSolution/FormWhitelistRule</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="FormWhitelistRule.md" target="_blank">Marketing\MarketingSolution/FormWhitelistRule</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="FormWhitelistRule.md" target="_blank">Marketing\MarketingSolution/FormWhitelistRule</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="FormWhitelistRule.md" target="_blank">Marketing\MarketingSolution/FormWhitelistRule</a>|
|[ownerId](#ownerId)|Owner Id|<a href="FormWhitelistRule.md" target="_blank">Marketing\MarketingSolution/FormWhitelistRule</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="FormWhitelistRule.md" target="_blank">Marketing\MarketingSolution/FormWhitelistRule</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="FormWhitelistRule.md" target="_blank">Marketing\MarketingSolution/FormWhitelistRule</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="FormWhitelistRule.md" target="_blank">Marketing\MarketingSolution/FormWhitelistRule</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="FormWhitelistRule.md" target="_blank">Marketing\MarketingSolution/FormWhitelistRule</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="FormWhitelistRule.md" target="_blank">Marketing\MarketingSolution/FormWhitelistRule</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="FormWhitelistRule.md" target="_blank">Marketing\MarketingSolution/FormWhitelistRule</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="FormWhitelistRule.md" target="_blank">Marketing\MarketingSolution/FormWhitelistRule</a>|
|[marketingFormId](#marketingFormId)|Unique ID for the marketing form associated with the whitelist rule|<a href="FormWhitelistRule.md" target="_blank">Marketing\MarketingSolution/FormWhitelistRule</a>|
|[marketingformwhitelistruleId](#marketingformwhitelistruleId)|Unique ID for entity instances|<a href="FormWhitelistRule.md" target="_blank">Marketing\MarketingSolution/FormWhitelistRule</a>|
|[name](#name)|The name of the custom entity|<a href="FormWhitelistRule.md" target="_blank">Marketing\MarketingSolution/FormWhitelistRule</a>|
|[stateCode](#stateCode)|Status of the form whitelist rule|<a href="FormWhitelistRule.md" target="_blank">Marketing\MarketingSolution/FormWhitelistRule</a>|
|[stateCode_display](#stateCode_display)||<a href="FormWhitelistRule.md" target="_blank">Marketing\MarketingSolution/FormWhitelistRule</a>|
|[statusCode](#statusCode)|Reason for the status of the form whitelist rule|<a href="FormWhitelistRule.md" target="_blank">Marketing\MarketingSolution/FormWhitelistRule</a>|
|[statusCode_display](#statusCode_display)||<a href="FormWhitelistRule.md" target="_blank">Marketing\MarketingSolution/FormWhitelistRule</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: Marketing\\MarketingSolution/FormWhitelistRule (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Marketing form</td></tr><tr><td>description</td><td>Unique ID for the marketing form associated with the whitelist rule</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>sourceName</td><td>msdyncrm_marketingformid</td></tr></table>
...
### <a href=#marketingformwhitelistruleId name="marketingformwhitelistruleId">marketingformwhitelistruleId</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Form whitelist rule</td></tr><tr><td>description</td><td>Unique ID for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>sourceName</td><td>msdyncrm_marketingformwhitelistruleid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the marketingformwhitelistruleId attribute are listed below.</summary>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyncrm_marketingformwhitelistruleid"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the form whitelist rule</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the form whitelist rule</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status reason</td></tr><tr><td>description</td><td>Reason for the status of the form whitelist rule</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the form whitelist rule</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
