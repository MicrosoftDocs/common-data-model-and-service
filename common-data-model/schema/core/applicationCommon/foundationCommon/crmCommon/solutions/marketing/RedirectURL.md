---
title: RedirectURL in MarketingSolution - Common Data Model | Microsoft Docs
...
# Redirect URL in MarketingSolution

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Marketing\MarketingSolution/RedirectURL.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/Marketing/MarketingSolution/RedirectURL.cdm.json<br>/RedirectURL/hasAttributes<br>/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specific identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[RedirectURL/(resolvedAttributes)/redirectURLId](#redirectURLId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[RedirectURL/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="RedirectURL.md" target="_blank">Marketing\MarketingSolution/RedirectURL</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="RedirectURL.md" target="_blank">Marketing\MarketingSolution/RedirectURL</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="RedirectURL.md" target="_blank">Marketing\MarketingSolution/RedirectURL</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="RedirectURL.md" target="_blank">Marketing\MarketingSolution/RedirectURL</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="RedirectURL.md" target="_blank">Marketing\MarketingSolution/RedirectURL</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="RedirectURL.md" target="_blank">Marketing\MarketingSolution/RedirectURL</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="RedirectURL.md" target="_blank">Marketing\MarketingSolution/RedirectURL</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="RedirectURL.md" target="_blank">Marketing\MarketingSolution/RedirectURL</a>|
|[ownerId](#ownerId)|Owner Id|<a href="RedirectURL.md" target="_blank">Marketing\MarketingSolution/RedirectURL</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="RedirectURL.md" target="_blank">Marketing\MarketingSolution/RedirectURL</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="RedirectURL.md" target="_blank">Marketing\MarketingSolution/RedirectURL</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="RedirectURL.md" target="_blank">Marketing\MarketingSolution/RedirectURL</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="RedirectURL.md" target="_blank">Marketing\MarketingSolution/RedirectURL</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="RedirectURL.md" target="_blank">Marketing\MarketingSolution/RedirectURL</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="RedirectURL.md" target="_blank">Marketing\MarketingSolution/RedirectURL</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="RedirectURL.md" target="_blank">Marketing\MarketingSolution/RedirectURL</a>|
|[insightsResults](#insightsResults)||<a href="RedirectURL.md" target="_blank">Marketing\MarketingSolution/RedirectURL</a>|
|[insightsTimeline](#insightsTimeline)||<a href="RedirectURL.md" target="_blank">Marketing\MarketingSolution/RedirectURL</a>|
|[name](#name)|The name of the custom entity|<a href="RedirectURL.md" target="_blank">Marketing\MarketingSolution/RedirectURL</a>|
|[originalURL](#originalURL)|The original URL|<a href="RedirectURL.md" target="_blank">Marketing\MarketingSolution/RedirectURL</a>|
|[redirectingURL](#redirectingURL)|The redirecting URL|<a href="RedirectURL.md" target="_blank">Marketing\MarketingSolution/RedirectURL</a>|
|[redirectURLId](#redirectURLId)|Unique ID for entity instances|<a href="RedirectURL.md" target="_blank">Marketing\MarketingSolution/RedirectURL</a>|
|[ownerIdName](#ownerIdName)|Name of the owner|<a href="RedirectURL.md" target="_blank">Marketing\MarketingSolution/RedirectURL</a>|
|[ownerIdYomiName](#ownerIdYomiName)|Yomi name of the owner|<a href="RedirectURL.md" target="_blank">Marketing\MarketingSolution/RedirectURL</a>|
|[stateCode](#stateCode)|Status of the Redirect URL|<a href="RedirectURL.md" target="_blank">Marketing\MarketingSolution/RedirectURL</a>|
|[stateCode_display](#stateCode_display)||<a href="RedirectURL.md" target="_blank">Marketing\MarketingSolution/RedirectURL</a>|
|[statusCode](#statusCode)|Redirect URL status reason|<a href="RedirectURL.md" target="_blank">Marketing\MarketingSolution/RedirectURL</a>|
|[statusCode_display](#statusCode_display)||<a href="RedirectURL.md" target="_blank">Marketing\MarketingSolution/RedirectURL</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: Marketing\\MarketingSolution/RedirectURL (this entity)  
...
### <a href=#insightsResults name="insightsResults">insightsResults</a>

First included in: Marketing\\MarketingSolution/RedirectURL (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Insights results</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>100</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyncrm_insightsresults</td></tr></table>

#### Traits

<details>
<summary>List of traits for the insightsResults attribute are listed below.</summary>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyncrm_insightsresults"</td><td>string</td><td></td></tr></table>
...
*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Insights results</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
### <a href=#insightsTimeline name="insightsTimeline">insightsTimeline</a>

First included in: Marketing\\MarketingSolution/RedirectURL (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Insights timeline</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>100</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyncrm_insightstimeline</td></tr></table>

#### Traits

<details>
<summary>List of traits for the insightsTimeline attribute are listed below.</summary>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyncrm_insightstimeline"</td><td>string</td><td></td></tr></table>
...
*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Insights timeline</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Original URL</td></tr><tr><td>description</td><td>The original URL</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>2000</td></tr><tr><td>sourceName</td><td>msdyncrm_originalurl</td></tr></table>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyncrm_originalurl"</td><td>string</td><td></td></tr></table>
...
*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Original URL</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>The original URL</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
### <a href=#redirectingURL name="redirectingURL">redirectingURL</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Redirecting URL</td></tr><tr><td>description</td><td>The redirecting URL</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>2000</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyncrm_redirectingurl</td></tr></table>

#### Traits

<details>
<summary>List of traits for the redirectingURL attribute are listed below.</summary>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyncrm_redirectingurl"</td><td>string</td><td></td></tr></table>
...
*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Redirecting URL</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>The redirecting URL</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
### <a href=#redirectURLId name="redirectURLId">redirectURLId</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Redirect URL</td></tr><tr><td>description</td><td>Unique ID for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>sourceName</td><td>msdyncrm_redirecturlid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the redirectURLId attribute are listed below.</summary>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyncrm_redirecturlid"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Redirect URL</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the Redirect URL</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status reason</td></tr><tr><td>description</td><td>Redirect URL status reason</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Redirect URL status reason</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
