...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="Invitation.md" target="_blank">eventManagement/Invitation</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="Invitation.md" target="_blank">eventManagement/Invitation</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="Invitation.md" target="_blank">eventManagement/Invitation</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="Invitation.md" target="_blank">eventManagement/Invitation</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="Invitation.md" target="_blank">eventManagement/Invitation</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="Invitation.md" target="_blank">eventManagement/Invitation</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="Invitation.md" target="_blank">eventManagement/Invitation</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="Invitation.md" target="_blank">eventManagement/Invitation</a>|
|[ownerId](#ownerId)|Owner Id|<a href="Invitation.md" target="_blank">eventManagement/Invitation</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="Invitation.md" target="_blank">eventManagement/Invitation</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="Invitation.md" target="_blank">eventManagement/Invitation</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="Invitation.md" target="_blank">eventManagement/Invitation</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="Invitation.md" target="_blank">eventManagement/Invitation</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="Invitation.md" target="_blank">eventManagement/Invitation</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="Invitation.md" target="_blank">eventManagement/Invitation</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="Invitation.md" target="_blank">eventManagement/Invitation</a>|
|[invitationId](#invitationId)|Shows the entity instance.|<a href="Invitation.md" target="_blank">eventManagement/Invitation</a>|
|[stateCode](#stateCode)|Status of the Invitation|<a href="Invitation.md" target="_blank">eventManagement/Invitation</a>|
|[stateCode_display](#stateCode_display)||<a href="Invitation.md" target="_blank">eventManagement/Invitation</a>|
|[statusCode](#statusCode)|Select the invitation's status.|<a href="Invitation.md" target="_blank">eventManagement/Invitation</a>|
|[statusCode_display](#statusCode_display)||<a href="Invitation.md" target="_blank">eventManagement/Invitation</a>|
|[name](#name)|Type the name of the custom entity.|<a href="Invitation.md" target="_blank">eventManagement/Invitation</a>|
|[assignToAccount](#assignToAccount)|An account record to assign the redeemed contact to.|<a href="Invitation.md" target="_blank">eventManagement/Invitation</a>|
|[expiryDate](#expiryDate)|The date the invitation is no longer valid for redemption.|<a href="Invitation.md" target="_blank">eventManagement/Invitation</a>|
|[invitationCode](#invitationCode)|Shows the user who is redeeming the invitation.|<a href="Invitation.md" target="_blank">eventManagement/Invitation</a>|
|[inviteContact](#inviteContact)|The contact to send an invitation to.|<a href="Invitation.md" target="_blank">eventManagement/Invitation</a>|
|[inviterContact](#inviterContact)|The contact that invited.|<a href="Invitation.md" target="_blank">eventManagement/Invitation</a>|
|[maximumRedemptions](#maximumRedemptions)||<a href="Invitation.md" target="_blank">eventManagement/Invitation</a>|
|[redeemedContact](#redeemedContact)|The contact associated with the redemption of this invitation.|<a href="Invitation.md" target="_blank">eventManagement/Invitation</a>|
|[redemptions](#redemptions)|The current number of times this invitation has been redeemed.|<a href="Invitation.md" target="_blank">eventManagement/Invitation</a>|
|[redemptionWorkflow](#redemptionWorkflow)|A workflow to execute on the redeeming contact.|<a href="Invitation.md" target="_blank">eventManagement/Invitation</a>|
|[type](#type)|The type of invitation.|<a href="Invitation.md" target="_blank">eventManagement/Invitation</a>|
|[type_display](#type_display)||<a href="Invitation.md" target="_blank">eventManagement/Invitation</a>|
|[website](#website)|Unique identifier for Website associated with Invitation.|<a href="Invitation.md" target="_blank">eventManagement/Invitation</a>|
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Event Portal Invitation</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Indicates whether the Invitation is used by the Event Portal.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.nullable**  
The attribute value may be set to NULL.  

**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"adx_eventportalinvitation"</td><td>string</td><td></td></tr></table>
