---
title: MarketingDynamicContentMetadata in MarketingSolution - Common Data Model | Microsoft Docs
...
# MarketingDynamicContentMetadata in MarketingSolution

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Marketing\MarketingSolution/MarketingDynamicContentMetadata.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/Marketing/MarketingSolution<br>/MarketingDynamicContentMetadata.cdm.json<br>/MarketingDynamicContentMetadata/hasAttributes<br>/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specific identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[MarketingDynamicContentMetadata/(resolvedAttributes)/marketingdynamiccontentmetadataId](#marketingdynamiccontentmetadataId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[MarketingDynamicContentMetadata/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>MarketingDynamicContentMetadata</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyncrm_marketingdynamiccontentmetadata"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="MarketingDynamicContentMetadata.md" target="_blank">Marketing\MarketingSolution/MarketingDynamicContentMetadata</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="MarketingDynamicContentMetadata.md" target="_blank">Marketing\MarketingSolution/MarketingDynamicContentMetadata</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="MarketingDynamicContentMetadata.md" target="_blank">Marketing\MarketingSolution/MarketingDynamicContentMetadata</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="MarketingDynamicContentMetadata.md" target="_blank">Marketing\MarketingSolution/MarketingDynamicContentMetadata</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="MarketingDynamicContentMetadata.md" target="_blank">Marketing\MarketingSolution/MarketingDynamicContentMetadata</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="MarketingDynamicContentMetadata.md" target="_blank">Marketing\MarketingSolution/MarketingDynamicContentMetadata</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="MarketingDynamicContentMetadata.md" target="_blank">Marketing\MarketingSolution/MarketingDynamicContentMetadata</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="MarketingDynamicContentMetadata.md" target="_blank">Marketing\MarketingSolution/MarketingDynamicContentMetadata</a>|
|[ownerId](#ownerId)|Owner Id|<a href="MarketingDynamicContentMetadata.md" target="_blank">Marketing\MarketingSolution/MarketingDynamicContentMetadata</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="MarketingDynamicContentMetadata.md" target="_blank">Marketing\MarketingSolution/MarketingDynamicContentMetadata</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="MarketingDynamicContentMetadata.md" target="_blank">Marketing\MarketingSolution/MarketingDynamicContentMetadata</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="MarketingDynamicContentMetadata.md" target="_blank">Marketing\MarketingSolution/MarketingDynamicContentMetadata</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="MarketingDynamicContentMetadata.md" target="_blank">Marketing\MarketingSolution/MarketingDynamicContentMetadata</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="MarketingDynamicContentMetadata.md" target="_blank">Marketing\MarketingSolution/MarketingDynamicContentMetadata</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="MarketingDynamicContentMetadata.md" target="_blank">Marketing\MarketingSolution/MarketingDynamicContentMetadata</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="MarketingDynamicContentMetadata.md" target="_blank">Marketing\MarketingSolution/MarketingDynamicContentMetadata</a>|
|[marketingdynamiccontentmetadataId](#marketingdynamiccontentmetadataId)|Unique ID for entity instances|<a href="MarketingDynamicContentMetadata.md" target="_blank">Marketing\MarketingSolution/MarketingDynamicContentMetadata</a>|
|[value](#value)|The value of the custom entity|<a href="MarketingDynamicContentMetadata.md" target="_blank">Marketing\MarketingSolution/MarketingDynamicContentMetadata</a>|
|[ownerIdName](#ownerIdName)|Name of the owner|<a href="MarketingDynamicContentMetadata.md" target="_blank">Marketing\MarketingSolution/MarketingDynamicContentMetadata</a>|
|[ownerIdYomiName](#ownerIdYomiName)|Yomi name of the owner|<a href="MarketingDynamicContentMetadata.md" target="_blank">Marketing\MarketingSolution/MarketingDynamicContentMetadata</a>|
|[stateCode](#stateCode)|Status of the marketing dynamic-content metadata|<a href="MarketingDynamicContentMetadata.md" target="_blank">Marketing\MarketingSolution/MarketingDynamicContentMetadata</a>|
|[stateCode_display](#stateCode_display)||<a href="MarketingDynamicContentMetadata.md" target="_blank">Marketing\MarketingSolution/MarketingDynamicContentMetadata</a>|
|[statusCode](#statusCode)|Dynamic-content metadata status reason|<a href="MarketingDynamicContentMetadata.md" target="_blank">Marketing\MarketingSolution/MarketingDynamicContentMetadata</a>|
|[statusCode_display](#statusCode_display)||<a href="MarketingDynamicContentMetadata.md" target="_blank">Marketing\MarketingSolution/MarketingDynamicContentMetadata</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: Marketing\\MarketingSolution/MarketingDynamicContentMetadata (this entity)  
...
### <a href=#marketingdynamiccontentmetadataId name="marketingdynamiccontentmetadataId">marketingdynamiccontentmetadataId</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Dynamic-content metadata</td></tr><tr><td>description</td><td>Unique ID for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>sourceName</td><td>msdyncrm_marketingdynamiccontentmetadataid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the marketingdynamiccontentmetadataId attribute are listed below.</summary>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyncrm_marketingdynamiccontentmetadataid"</td><td>string</td><td></td></tr></table>

*is.requiredAtLevel*  
  The requirement level for setting values into this attribute in CDS for Applications or for including this attribute in entities created in CDS for Analytics  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>level</td><td>"systemrequired"</td><td>string</td><td>values can be: 'systemrequired', 'required', 'recommended', 'none'</td></tr></table>

*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Dynamic-content metadata</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Value</td></tr><tr><td>description</td><td>The value of the custom entity</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>1000</td></tr><tr><td>sourceName</td><td>msdyncrm_value</td></tr></table>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>The value of the custom entity</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the marketing dynamic-content metadata</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
