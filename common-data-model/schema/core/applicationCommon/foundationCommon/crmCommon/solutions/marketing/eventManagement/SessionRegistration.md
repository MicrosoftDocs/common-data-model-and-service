...
- **is.identifiedBy**  
  ...
  ```
  "SessionRegistration/hasAttributes/sessionRegistrationId"
  ```
...
- **means.entityState**  
  ...
  ```
  "SessionRegistration/hasAttributes/stateCode"
  ```
