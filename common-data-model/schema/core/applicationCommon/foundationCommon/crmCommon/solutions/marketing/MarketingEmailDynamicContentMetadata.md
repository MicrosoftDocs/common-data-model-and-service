---
title: MarketingEmailDynamicContentMetadata in MarketingSolution - Common Data Model | Microsoft Docs
...
# MarketingEmailDynamicContentMetadata in MarketingSolution

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Marketing\MarketingSolution/MarketingEmailDynamicContentMetadata.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/Marketing/MarketingSolution<br>/MarketingEmailDynamicContentMetadata.cdm.json<br>/MarketingEmailDynamicContentMetadata<br>/hasAttributes/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specific identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[MarketingEmailDynamicContentMetadata/(resolvedAttributes)/marketingEmailDynamicContentMetadataId](#marketingEmailDynamicContentMetadataId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[MarketingEmailDynamicContentMetadata/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>MarketingEmailDynamicContentMetadata</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyncrm_marketingemaildynamiccontentmetadata"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="MarketingEmailDynamicContentMetadata.md" target="_blank">Marketing\MarketingSolution/MarketingEmailDynamicContentMetadata</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="MarketingEmailDynamicContentMetadata.md" target="_blank">Marketing\MarketingSolution/MarketingEmailDynamicContentMetadata</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="MarketingEmailDynamicContentMetadata.md" target="_blank">Marketing\MarketingSolution/MarketingEmailDynamicContentMetadata</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="MarketingEmailDynamicContentMetadata.md" target="_blank">Marketing\MarketingSolution/MarketingEmailDynamicContentMetadata</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="MarketingEmailDynamicContentMetadata.md" target="_blank">Marketing\MarketingSolution/MarketingEmailDynamicContentMetadata</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="MarketingEmailDynamicContentMetadata.md" target="_blank">Marketing\MarketingSolution/MarketingEmailDynamicContentMetadata</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="MarketingEmailDynamicContentMetadata.md" target="_blank">Marketing\MarketingSolution/MarketingEmailDynamicContentMetadata</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="MarketingEmailDynamicContentMetadata.md" target="_blank">Marketing\MarketingSolution/MarketingEmailDynamicContentMetadata</a>|
|[ownerId](#ownerId)|Owner Id|<a href="MarketingEmailDynamicContentMetadata.md" target="_blank">Marketing\MarketingSolution/MarketingEmailDynamicContentMetadata</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="MarketingEmailDynamicContentMetadata.md" target="_blank">Marketing\MarketingSolution/MarketingEmailDynamicContentMetadata</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="MarketingEmailDynamicContentMetadata.md" target="_blank">Marketing\MarketingSolution/MarketingEmailDynamicContentMetadata</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="MarketingEmailDynamicContentMetadata.md" target="_blank">Marketing\MarketingSolution/MarketingEmailDynamicContentMetadata</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="MarketingEmailDynamicContentMetadata.md" target="_blank">Marketing\MarketingSolution/MarketingEmailDynamicContentMetadata</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="MarketingEmailDynamicContentMetadata.md" target="_blank">Marketing\MarketingSolution/MarketingEmailDynamicContentMetadata</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="MarketingEmailDynamicContentMetadata.md" target="_blank">Marketing\MarketingSolution/MarketingEmailDynamicContentMetadata</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="MarketingEmailDynamicContentMetadata.md" target="_blank">Marketing\MarketingSolution/MarketingEmailDynamicContentMetadata</a>|
|[fields](#fields)||<a href="MarketingEmailDynamicContentMetadata.md" target="_blank">Marketing\MarketingSolution/MarketingEmailDynamicContentMetadata</a>|
|[isContextEntity](#isContextEntity)||<a href="MarketingEmailDynamicContentMetadata.md" target="_blank">Marketing\MarketingSolution/MarketingEmailDynamicContentMetadata</a>|
|[displayName](#displayName)||<a href="MarketingEmailDynamicContentMetadata.md" target="_blank">Marketing\MarketingSolution/MarketingEmailDynamicContentMetadata</a>|
|[itemType](#itemType)||<a href="MarketingEmailDynamicContentMetadata.md" target="_blank">Marketing\MarketingSolution/MarketingEmailDynamicContentMetadata</a>|
|[marketingEmailDynamicContentMetadataId](#marketingEmailDynamicContentMetadataId)|Unique ID for entity instances|<a href="MarketingEmailDynamicContentMetadata.md" target="_blank">Marketing\MarketingSolution/MarketingEmailDynamicContentMetadata</a>|
|[name](#name)|The name of the custom entity|<a href="MarketingEmailDynamicContentMetadata.md" target="_blank">Marketing\MarketingSolution/MarketingEmailDynamicContentMetadata</a>|
|[syntax](#syntax)||<a href="MarketingEmailDynamicContentMetadata.md" target="_blank">Marketing\MarketingSolution/MarketingEmailDynamicContentMetadata</a>|
|[ownerIdName](#ownerIdName)|Name of the owner|<a href="MarketingEmailDynamicContentMetadata.md" target="_blank">Marketing\MarketingSolution/MarketingEmailDynamicContentMetadata</a>|
|[ownerIdYomiName](#ownerIdYomiName)|Yomi name of the owner|<a href="MarketingEmailDynamicContentMetadata.md" target="_blank">Marketing\MarketingSolution/MarketingEmailDynamicContentMetadata</a>|
|[stateCode](#stateCode)|Status of the marketing email dynamic-content metadata|<a href="MarketingEmailDynamicContentMetadata.md" target="_blank">Marketing\MarketingSolution/MarketingEmailDynamicContentMetadata</a>|
|[stateCode_display](#stateCode_display)||<a href="MarketingEmailDynamicContentMetadata.md" target="_blank">Marketing\MarketingSolution/MarketingEmailDynamicContentMetadata</a>|
|[statusCode](#statusCode)|Marketing email dynamic-content metadata status reason|<a href="MarketingEmailDynamicContentMetadata.md" target="_blank">Marketing\MarketingSolution/MarketingEmailDynamicContentMetadata</a>|
|[statusCode_display](#statusCode_display)||<a href="MarketingEmailDynamicContentMetadata.md" target="_blank">Marketing\MarketingSolution/MarketingEmailDynamicContentMetadata</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: Marketing\\MarketingSolution/MarketingEmailDynamicContentMetadata (this entity)  
...
### <a href=#fields name="fields">fields</a>

First included in: Marketing\\MarketingSolution/MarketingEmailDynamicContentMetadata (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Marketing form</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>500000</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyncrm_fields</td></tr></table>

#### Traits

<details>
<summary>List of traits for the fields attribute are listed below.</summary>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyncrm_fields"</td><td>string</td><td></td></tr></table>
...
### <a href=#isContextEntity name="isContextEntity">isContextEntity</a>

First included in: Marketing\\MarketingSolution/MarketingEmailDynamicContentMetadata (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Is context entity</td></tr><tr><td>dataFormat</td><td>boolean</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyncrm_iscontextentity</td></tr></table>

#### Traits

<details>
<summary>List of traits for the isContextEntity attribute are listed below.</summary>

*is.dataFormat.boolean*  
  *is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyncrm_iscontextentity"</td><td>string</td><td></td></tr></table>

*is.requiredAtLevel*  
  The requirement level for setting values into this attribute in CDS for Applications or for including this attribute in entities created in CDS for Analytics  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>level</td><td>"none"</td><td>string</td><td>values can be: 'systemrequired', 'required', 'recommended', 'none'</td></tr></table>

*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Is context entity</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Display name</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>4000</td></tr><tr><td>sourceName</td><td>msdyncrm_displayname</td></tr></table>
...
*means.identity.name*  
  *is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyncrm_displayname"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Item type</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>100</td></tr><tr><td>sourceName</td><td>msdyncrm_itemtype</td></tr></table>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyncrm_itemtype"</td><td>string</td><td></td></tr></table>
...
### <a href=#marketingEmailDynamicContentMetadataId name="marketingEmailDynamicContentMetadataId">marketingEmailDynamicContentMetadataId</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Marketing email dynamic-content metadata</td></tr><tr><td>description</td><td>Unique ID for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>sourceName</td><td>msdyncrm_marketingemaildynamiccontentmetadataid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the marketingEmailDynamicContentMetadataId attribute are listed below.</summary>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyncrm_marketingemaildynamiccontentmetadataid"</td><td>string</td><td></td></tr></table>

*is.requiredAtLevel*  
  The requirement level for setting values into this attribute in CDS for Applications or for including this attribute in entities created in CDS for Analytics  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>level</td><td>"systemrequired"</td><td>string</td><td>values can be: 'systemrequired', 'required', 'recommended', 'none'</td></tr></table>

*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Marketing email dynamic-content metadata</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
### <a href=#syntax name="syntax">syntax</a>

First included in: Marketing\\MarketingSolution/MarketingEmailDynamicContentMetadata (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Syntax</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>100</td></tr><tr><td>sourceName</td><td>msdyncrm_syntax</td></tr></table>

#### Traits

<details>
<summary>List of traits for the syntax attribute are listed below.</summary>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyncrm_syntax"</td><td>string</td><td></td></tr></table>
...
*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Syntax</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the marketing email dynamic-content metadata</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
