...
- **is.identifiedBy**  
  ...
  ```
  "HotelRoomReservation/hasAttributes/hotelRoomReservationId"
  ```
...
- **means.entityState**  
  ...
  ```
  "HotelRoomReservation/hasAttributes/stateCode"
  ```
