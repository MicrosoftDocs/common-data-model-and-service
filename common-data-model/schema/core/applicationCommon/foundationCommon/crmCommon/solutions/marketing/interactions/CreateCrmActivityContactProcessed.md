...
<a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/solutions/marketing/interactions/CreateCrmActivityContactProcessed.cdm.json" target="_blank">Entity definition</a> on GitHub.  

## Instances

interactions/CreateCrmActivityContactProcessed  

## Traits for Create activity contact processed
...
- **is.identifiedBy**  
  ...
  ```
  "CreateCrmActivityContactProcessed_/hasAttributes/interactionId"
  ```
