...
- /crmCommon/solutions/marketing/interactions/EmailOpened  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[EmailOpened/(resolvedAttributes)/interactionId](#interactionId)</td><td>attribute</td><td></td></tr></table>
...
|[contactId](#contactId)|Contact ID|<a href="EmailOpened.md" target="_blank">interactions/EmailOpened</a>|
|[accountId](#accountId)|Account ID|<a href="EmailOpened.md" target="_blank">interactions/EmailOpened</a>|
|[marketingEmailId](#marketingEmailId)|Message|<a href="EmailOpened.md" target="_blank">interactions/EmailOpened</a>|
|[customerJourneyId](#customerJourneyId)|Customer Journey ID|<a href="EmailOpened.md" target="_blank">interactions/EmailOpened</a>|
|[messageId](#messageId)|Message ID|<a href="EmailOpened.md" target="_blank">interactions/EmailOpened</a>|
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Message</td></tr><tr><td>description</td><td>Message</td></tr><tr><td>dataFormat</td><td>6</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>MessageId</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Message ID</td></tr><tr><td>description</td><td>Message ID</td></tr><tr><td>dataFormat</td><td>7</td></tr><tr><td>isNullable</td><td>true</td></tr></table>
