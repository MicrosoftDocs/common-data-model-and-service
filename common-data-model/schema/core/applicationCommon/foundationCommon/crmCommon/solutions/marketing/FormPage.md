---
title: FormPage in MarketingSolution - Common Data Model | Microsoft Docs
...
# Form Page in MarketingSolution

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Marketing\MarketingSolution/FormPage.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/Marketing/MarketingSolution/FormPage.cdm.json<br>/FormPage/hasAttributes/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specific identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[FormPage/(resolvedAttributes)/formPageId](#formPageId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[FormPage/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Form Page</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyncrm_formpage"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="FormPage.md" target="_blank">Marketing\MarketingSolution/FormPage</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="FormPage.md" target="_blank">Marketing\MarketingSolution/FormPage</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="FormPage.md" target="_blank">Marketing\MarketingSolution/FormPage</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="FormPage.md" target="_blank">Marketing\MarketingSolution/FormPage</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="FormPage.md" target="_blank">Marketing\MarketingSolution/FormPage</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="FormPage.md" target="_blank">Marketing\MarketingSolution/FormPage</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="FormPage.md" target="_blank">Marketing\MarketingSolution/FormPage</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="FormPage.md" target="_blank">Marketing\MarketingSolution/FormPage</a>|
|[ownerId](#ownerId)|Owner Id|<a href="FormPage.md" target="_blank">Marketing\MarketingSolution/FormPage</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="FormPage.md" target="_blank">Marketing\MarketingSolution/FormPage</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="FormPage.md" target="_blank">Marketing\MarketingSolution/FormPage</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="FormPage.md" target="_blank">Marketing\MarketingSolution/FormPage</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="FormPage.md" target="_blank">Marketing\MarketingSolution/FormPage</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="FormPage.md" target="_blank">Marketing\MarketingSolution/FormPage</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="FormPage.md" target="_blank">Marketing\MarketingSolution/FormPage</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="FormPage.md" target="_blank">Marketing\MarketingSolution/FormPage</a>|
|[confirmationMessage](#confirmationMessage)||<a href="FormPage.md" target="_blank">Marketing\MarketingSolution/FormPage</a>|
|[errorMessage](#errorMessage)||<a href="FormPage.md" target="_blank">Marketing\MarketingSolution/FormPage</a>|
|[marketingFormId](#marketingFormId)|Usage of a marketing form on a marketing page.|<a href="FormPage.md" target="_blank">Marketing\MarketingSolution/FormPage</a>|
|[formPageId](#formPageId)|Unique ID for entity instances|<a href="FormPage.md" target="_blank">Marketing\MarketingSolution/FormPage</a>|
|[limitExceededMessage](#limitExceededMessage)||<a href="FormPage.md" target="_blank">Marketing\MarketingSolution/FormPage</a>|
|[marketingPageId](#marketingPageId)|The marketing page contains a marketing form.|<a href="FormPage.md" target="_blank">Marketing\MarketingSolution/FormPage</a>|
|[webSiteId](#webSiteId)|The website contains a marketing form|<a href="FormPage.md" target="_blank">Marketing\MarketingSolution/FormPage</a>|
|[name](#name)|Name of the marketing form page|<a href="FormPage.md" target="_blank">Marketing\MarketingSolution/FormPage</a>|
|[redirectURL](#redirectURL)||<a href="FormPage.md" target="_blank">Marketing\MarketingSolution/FormPage</a>|
|[javaScriptCode](#javaScriptCode)||<a href="FormPage.md" target="_blank">Marketing\MarketingSolution/FormPage</a>|
|[externalformhostingIframe](#externalformhostingIframe)||<a href="FormPage.md" target="_blank">Marketing\MarketingSolution/FormPage</a>|
|[externalHostingFormatDescription](#externalHostingFormatDescription)|External hosting format description|<a href="FormPage.md" target="_blank">Marketing\MarketingSolution/FormPage</a>|
|[externalHostingFormat](#externalHostingFormat)|External Hosting Format|<a href="FormPage.md" target="_blank">Marketing\MarketingSolution/FormPage</a>|
|[externalHostingFormat_display](#externalHostingFormat_display)||<a href="FormPage.md" target="_blank">Marketing\MarketingSolution/FormPage</a>|
|[javascriptcodeCompound](#javascriptcodeCompound)||<a href="FormPage.md" target="_blank">Marketing\MarketingSolution/FormPage</a>|
|[ownerIdName](#ownerIdName)|Name of the owner|<a href="FormPage.md" target="_blank">Marketing\MarketingSolution/FormPage</a>|
|[ownerIdYomiName](#ownerIdYomiName)|Yomi name of the owner|<a href="FormPage.md" target="_blank">Marketing\MarketingSolution/FormPage</a>|
|[stateCode](#stateCode)|Status of the form page|<a href="FormPage.md" target="_blank">Marketing\MarketingSolution/FormPage</a>|
|[stateCode_display](#stateCode_display)||<a href="FormPage.md" target="_blank">Marketing\MarketingSolution/FormPage</a>|
|[statusCode](#statusCode)|Form page status reason|<a href="FormPage.md" target="_blank">Marketing\MarketingSolution/FormPage</a>|
|[statusCode_display](#statusCode_display)||<a href="FormPage.md" target="_blank">Marketing\MarketingSolution/FormPage</a>|
|[successImageURL](#successImageURL)||<a href="FormPage.md" target="_blank">Marketing\MarketingSolution/FormPage</a>|
|[errorImageURL](#errorImageURL)||<a href="FormPage.md" target="_blank">Marketing\MarketingSolution/FormPage</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: Marketing\\MarketingSolution/FormPage (this entity)  
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyncrm_formpageid"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Web site</td></tr><tr><td>description</td><td>The website contains a marketing form</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyncrm_websiteid</td></tr></table>
...
*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Web site</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>The website contains a marketing form</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Name</td></tr><tr><td>description</td><td>Name of the marketing form page</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>100</td></tr><tr><td>sourceName</td><td>msdyncrm_name</td></tr></table>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Name of the marketing form page</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
### <a href=#externalformhostingIframe name="externalformhostingIframe">externalformhostingIframe</a>

First included in: Marketing\\MarketingSolution/FormPage (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>External hosting iframe</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>5000</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyncrm_externalformhosting_iframe</td></tr></table>

#### Traits

<details>
<summary>List of traits for the externalformhostingIframe attribute are listed below.</summary>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyncrm_externalformhosting_iframe"</td><td>string</td><td></td></tr></table>
...
*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>External hosting iframe</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
### <a href=#externalHostingFormatDescription name="externalHostingFormatDescription">externalHostingFormatDescription</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>External hosting format description</td></tr><tr><td>description</td><td>External hosting format description</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>5000</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyncrm_externalhostingformat_description</td></tr></table>

#### Traits

<details>
<summary>List of traits for the externalHostingFormatDescription attribute are listed below.</summary>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyncrm_externalhostingformat_description"</td><td>string</td><td></td></tr></table>
...
*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>External hosting format description</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
### <a href=#externalHostingFormat name="externalHostingFormat">externalHostingFormat</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>External Hosting Format</td></tr><tr><td>description</td><td>External Hosting Format</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyncrm_externalhostingformat</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>I want to host it as a script</td><td>192350000</td></tr><tr><td>en</td><td>I want to host it as an iframe</td><td>192350001</td></tr></table></td></tr></table>

#### Traits

<details>
<summary>List of traits for the externalHostingFormat attribute are listed below.</summary>
...
*is.dataFormat.numeric*  
  *does.haveDefault*  
  An attribute has a default value  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>default</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>I want to host it as a script</td><td>192350000</td></tr><tr><td>en</td><td>I want to host it as an iframe</td><td>192350001</td></tr></table></td><td>any</td><td></td></tr></table>

*is.constrainedList*  
  the values of an attribute are taken from or looked up from a fixed list of possibilities  

*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyncrm_externalhostingformat"</td><td>string</td><td></td></tr></table>

*is.requiredAtLevel*  
  The requirement level for setting values into this attribute in CDS for Applications or for including this attribute in entities created in CDS for Analytics  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>level</td><td>"none"</td><td>string</td><td>values can be: 'systemrequired', 'required', 'recommended', 'none'</td></tr></table>

*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>External Hosting Format</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
### <a href=#externalHostingFormat_display name="externalHostingFormat_display">externalHostingFormat_display</a>
...
<details>
<summary>List of traits for the externalHostingFormat_display attribute are listed below.</summary>
...
*is.addedInSupportOf*  
    <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>inSupportOf</td><td>"externalHostingFormat"</td><td>attributeName</td><td>output parameter naming the attribute that is being supported</td></tr></table>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the form page</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Form page status reason</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
