...
- **is.identifiedBy**  
  ...
  ```
  "SponsorableArticle/hasAttributes/sponsorableArticleId"
  ```
...
- **means.entityState**  
  ...
  ```
  "SponsorableArticle/hasAttributes/stateCode"
  ```
