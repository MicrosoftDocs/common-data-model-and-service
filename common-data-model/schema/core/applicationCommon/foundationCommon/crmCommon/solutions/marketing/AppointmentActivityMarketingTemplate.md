---
title: AppointmentActivityMarketingTemplate in MarketingSolution - Common Data Model | Microsoft Docs
...
# Appointment Activity Marketing Template in MarketingSolution

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Marketing\MarketingSolution/AppointmentActivityMarketingTemplate.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/Marketing/MarketingSolution<br>/AppointmentActivityMarketingTemplate.cdm.json<br>/AppointmentActivityMarketingTemplate<br>/hasAttributes/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specific identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[AppointmentActivityMarketingTemplate/(resolvedAttributes)/appointmentActivityMarketingTemplateId](#appointmentActivityMarketingTemplateId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[AppointmentActivityMarketingTemplate/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Appointment Activity Marketing Template</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyncrm_appointmentactivitymarketingtemplate"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="AppointmentActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/AppointmentActivityMarketingTemplate</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="AppointmentActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/AppointmentActivityMarketingTemplate</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="AppointmentActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/AppointmentActivityMarketingTemplate</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="AppointmentActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/AppointmentActivityMarketingTemplate</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="AppointmentActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/AppointmentActivityMarketingTemplate</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="AppointmentActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/AppointmentActivityMarketingTemplate</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="AppointmentActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/AppointmentActivityMarketingTemplate</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="AppointmentActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/AppointmentActivityMarketingTemplate</a>|
|[ownerId](#ownerId)|Owner Id|<a href="AppointmentActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/AppointmentActivityMarketingTemplate</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="AppointmentActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/AppointmentActivityMarketingTemplate</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="AppointmentActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/AppointmentActivityMarketingTemplate</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="AppointmentActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/AppointmentActivityMarketingTemplate</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="AppointmentActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/AppointmentActivityMarketingTemplate</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="AppointmentActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/AppointmentActivityMarketingTemplate</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="AppointmentActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/AppointmentActivityMarketingTemplate</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="AppointmentActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/AppointmentActivityMarketingTemplate</a>|
|[appointmentActivityMarketingTemplateId](#appointmentActivityMarketingTemplateId)|Unique ID for entity instances|<a href="AppointmentActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/AppointmentActivityMarketingTemplate</a>|
|[description](#description)|Enter additional information to describe this appointment|<a href="AppointmentActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/AppointmentActivityMarketingTemplate</a>|
|[isalldayevent](#isalldayevent)|Select whether the appointment is an all-day event to make sure that the required resources are scheduled for the full day|<a href="AppointmentActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/AppointmentActivityMarketingTemplate</a>|
|[location](#location)|Enter the location where the appointment will take place, such as a conference room or customer office|<a href="AppointmentActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/AppointmentActivityMarketingTemplate</a>|
|[name](#name)|The name of the custom entity|<a href="AppointmentActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/AppointmentActivityMarketingTemplate</a>|
|[prioritycode](#prioritycode)|Select the priority so that preferred customers or critical issues are handled quickly|<a href="AppointmentActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/AppointmentActivityMarketingTemplate</a>|
|[prioritycode_display](#prioritycode_display)||<a href="AppointmentActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/AppointmentActivityMarketingTemplate</a>|
|[scheduleddurationminutes](#scheduleddurationminutes)|Shows the expected duration of the appointment, in minutes|<a href="AppointmentActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/AppointmentActivityMarketingTemplate</a>|
|[scheduleType](#scheduleType)||<a href="AppointmentActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/AppointmentActivityMarketingTemplate</a>|
|[scheduleType_display](#scheduleType_display)||<a href="AppointmentActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/AppointmentActivityMarketingTemplate</a>|
|[startDate](#startDate)||<a href="AppointmentActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/AppointmentActivityMarketingTemplate</a>|
|[startDelay](#startDelay)||<a href="AppointmentActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/AppointmentActivityMarketingTemplate</a>|
|[startTimeHour](#startTimeHour)||<a href="AppointmentActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/AppointmentActivityMarketingTemplate</a>|
|[startTimeHour_display](#startTimeHour_display)||<a href="AppointmentActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/AppointmentActivityMarketingTemplate</a>|
|[startTimeMinute](#startTimeMinute)||<a href="AppointmentActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/AppointmentActivityMarketingTemplate</a>|
|[startTimeMinute_display](#startTimeMinute_display)||<a href="AppointmentActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/AppointmentActivityMarketingTemplate</a>|
|[subject](#subject)|Enter a short description about the objective or primary topic of the appointment|<a href="AppointmentActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/AppointmentActivityMarketingTemplate</a>|
|[ownerIdName](#ownerIdName)|Name of the owner|<a href="AppointmentActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/AppointmentActivityMarketingTemplate</a>|
|[ownerIdYomiName](#ownerIdYomiName)|Yomi name of the owner|<a href="AppointmentActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/AppointmentActivityMarketingTemplate</a>|
|[stateCode](#stateCode)|Status of the appointment activity marketing template|<a href="AppointmentActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/AppointmentActivityMarketingTemplate</a>|
|[stateCode_display](#stateCode_display)||<a href="AppointmentActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/AppointmentActivityMarketingTemplate</a>|
|[statusCode](#statusCode)|Status of the appointment activity marketing template|<a href="AppointmentActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/AppointmentActivityMarketingTemplate</a>|
|[statusCode_display](#statusCode_display)||<a href="AppointmentActivityMarketingTemplate.md" target="_blank">Marketing\MarketingSolution/AppointmentActivityMarketingTemplate</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: Marketing\\MarketingSolution/AppointmentActivityMarketingTemplate (this entity)  
...
### <a href=#appointmentActivityMarketingTemplateId name="appointmentActivityMarketingTemplateId">appointmentActivityMarketingTemplateId</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Appointment activity marketing template</td></tr><tr><td>description</td><td>Unique ID for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>sourceName</td><td>msdyncrm_appointmentactivitymarketingtemplateid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the appointmentActivityMarketingTemplateId attribute are listed below.</summary>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyncrm_appointmentactivitymarketingtemplateid"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Description</td></tr><tr><td>description</td><td>Enter additional information to describe this appointment</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>2000</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyncrm_description</td></tr></table>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Enter additional information to describe this appointment</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.dataFormat.boolean*  
  *is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyncrm_isalldayevent"</td><td>string</td><td></td></tr></table>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyncrm_location"</td><td>string</td><td></td></tr></table>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Shows the expected duration of the appointment, in minutes</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Subject</td></tr><tr><td>description</td><td>Enter a short description about the objective or primary topic of the appointment</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>200</td></tr><tr><td>sourceName</td><td>msdyncrm_subject</td></tr></table>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Enter a short description about the objective or primary topic of the appointment</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the appointment activity marketing template</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
