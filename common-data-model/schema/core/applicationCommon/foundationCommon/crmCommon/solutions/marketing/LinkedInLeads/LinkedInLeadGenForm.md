...
- **is.identifiedBy**  
  ...
  ```
  "LinkedInLeadGenForm/hasAttributes/linkedinformId"
  ```
...
- **means.entityState**  
  ...
  ```
  "LinkedInLeadGenForm/hasAttributes/stateCode"
  ```
