...
|[adxCreatedByIPAddress](#adxCreatedByIPAddress)||[portals/Contact](../portals/Contact.md)|
|[adxCreatedByUsername](#adxCreatedByUsername)||[portals/Contact](../portals/Contact.md)|
|[adxModifiedByIPAddress](#adxModifiedByIPAddress)||[portals/Contact](../portals/Contact.md)|
|[adxModifiedByUsername](#adxModifiedByUsername)||[portals/Contact](../portals/Contact.md)|
|[adxOrganizationName](#adxOrganizationName)||[portals/Contact](../portals/Contact.md)|
|[adxTimeZone](#adxTimeZone)||[portals/Contact](../portals/Contact.md)|
|[managingPartner](#managingPartner)|Unique identifier for Account associated with Contact.|[portals/Contact](../portals/Contact.md)|
|[disableWebTracking](#disableWebTracking)|Indicates that the contact has opted out of web tracking.|[portals/Contact](../portals/Contact.md)|
|[isMinor](#isMinor)|Indicates that the contact is considered a minor in their jurisdiction.|[portals/Contact](../portals/Contact.md)|
|[isMinorWithParentalConsent](#isMinorWithParentalConsent)|Indicates that the contact is considered a minor in their jurisdiction and has parental consent.|[portals/Contact](../portals/Contact.md)|
|[portalTermsAgreementDate](#portalTermsAgreementDate)|Indicates the date and time that the person agreed to the portal terms and conditions.|[portals/Contact](../portals/Contact.md)|
|[preferredLanguage](#preferredLanguage)|User’s preferred portal language|[portals/Contact](../portals/Contact.md)|
|[profileAlert](#profileAlert)||[portals/Contact](../portals/Contact.md)|
|[profileAlertDate](#profileAlertDate)||[portals/Contact](../portals/Contact.md)|
|[profileAlertInstructions](#profileAlertInstructions)||[portals/Contact](../portals/Contact.md)|
|[adxProfileIsAnonymous](#adxProfileIsAnonymous)||[portals/Contact](../portals/Contact.md)|
|[adxProfileLastActivity](#adxProfileLastActivity)||[portals/Contact](../portals/Contact.md)|
|[profileModifiedOn](#profileModifiedOn)||[portals/Contact](../portals/Contact.md)|
|[publicProfileCopy](#publicProfileCopy)||[portals/Contact](../portals/Contact.md)|
|[accessFailedCount](#accessFailedCount)|Shows the current count of failed password attempts for the contact.|[portals/Contact](../portals/Contact.md)|
|[emailConfirmed](#emailConfirmed)|Determines if the email is confirmed by the contact.|[portals/Contact](../portals/Contact.md)|
|[lastSuccessfulLogin](#lastSuccessfulLogin)|Indicates the last date and time the user successfully signed in to a portal.|[portals/Contact](../portals/Contact.md)|
|[localLoginDisabled](#localLoginDisabled)|Indicates that the contact can no longer sign in to the portal using the local account.|[portals/Contact](../portals/Contact.md)|
|[lockoutEnabled](#lockoutEnabled)|Determines if this contact will track failed access attempts and become locked after too many failed attempts. To prevent the contact from becoming locked, you can disable this setting.|[portals/Contact](../portals/Contact.md)|
|[lockoutEndDate](#lockoutEndDate)|Shows the moment in time when the locked contact becomes unlocked again.|[portals/Contact](../portals/Contact.md)|
|[loginEnabled](#loginEnabled)|Determines if web authentication is enabled for the contact.|[portals/Contact](../portals/Contact.md)|
|[mobilePhoneConfirmed](#mobilePhoneConfirmed)|Determines if the phone number is confirmed by the contact.|[portals/Contact](../portals/Contact.md)|
|[passwordHash](#passwordHash)||[portals/Contact](../portals/Contact.md)|
|[securityStamp](#securityStamp)|A token used to manage the web authentication session.|[portals/Contact](../portals/Contact.md)|
|[twoFactorEnabled](#twoFactorEnabled)|Determines if two-factor authentication is enabled for the contact.|[portals/Contact](../portals/Contact.md)|
|[userName](#userName)|Shows the user identity for local web authentication.|[portals/Contact](../portals/Contact.md)|
|[originatingEvent](#originatingEvent)|Shows the event the contact was created from, if the contact was created by registering event in Microsoft Dynamics 365. This is used to relate the contact to the data on the originating event.|[marketing/Contact](Contact.md)|
|[sourceCustomerJourney](#sourceCustomerJourney)||[marketing/Contact](Contact.md)|
|[sourceEmail](#sourceEmail)||[marketing/Contact](Contact.md)|
|[sourceForm](#sourceForm)||[marketing/Contact](Contact.md)|
|[sourceLandingPage](#sourceLandingPage)||[marketing/Contact](Contact.md)|
|[rememberMe](#rememberMe)||[marketing/Contact](Contact.md)|
|[insightsPlaceholder](#insightsPlaceholder)||[marketing/Contact](Contact.md)|
