...
- /foundationCommon/crmCommon/solutions/marketing/Contact.cdm.json/Contact  
[/foundationCommon/crmCommon/solutions/portals/Contact.cdm.json/Contact](../portals/Contact.md "/core/applicationCommon/foundationCommon/crmCommon/solutions/portals/Contact.cdm.json/Contact")  
...
|[adxCreatedByIPAddress](#adxCreatedByIPAddress)||<a href="../portals/Contact.md" target="_blank">portals/Contact</a>|
|[adxCreatedByUsername](#adxCreatedByUsername)||<a href="../portals/Contact.md" target="_blank">portals/Contact</a>|
|[adxModifiedByIPAddress](#adxModifiedByIPAddress)||<a href="../portals/Contact.md" target="_blank">portals/Contact</a>|
|[adxModifiedByUsername](#adxModifiedByUsername)||<a href="../portals/Contact.md" target="_blank">portals/Contact</a>|
|[adxOrganizationName](#adxOrganizationName)||<a href="../portals/Contact.md" target="_blank">portals/Contact</a>|
|[adxTimeZone](#adxTimeZone)||<a href="../portals/Contact.md" target="_blank">portals/Contact</a>|
|[managingPartner](#managingPartner)|Unique identifier for Account associated with Contact.|<a href="../portals/Contact.md" target="_blank">portals/Contact</a>|
|[disableWebTracking](#disableWebTracking)|Indicates that the contact has opted out of web tracking.|<a href="../portals/Contact.md" target="_blank">portals/Contact</a>|
|[isMinor](#isMinor)|Indicates that the contact is considered a minor in their jurisdiction.|<a href="../portals/Contact.md" target="_blank">portals/Contact</a>|
|[isMinorWithParentalConsent](#isMinorWithParentalConsent)|Indicates that the contact is considered a minor in their jurisdiction and has parental consent.|<a href="../portals/Contact.md" target="_blank">portals/Contact</a>|
|[portalTermsAgreementDate](#portalTermsAgreementDate)|Indicates the date and time that the person agreed to the portal terms and conditions.|<a href="../portals/Contact.md" target="_blank">portals/Contact</a>|
|[preferredLanguage](#preferredLanguage)|User’s preferred portal language|<a href="../portals/Contact.md" target="_blank">portals/Contact</a>|
|[profileAlert](#profileAlert)||<a href="../portals/Contact.md" target="_blank">portals/Contact</a>|
|[profileAlertDate](#profileAlertDate)||<a href="../portals/Contact.md" target="_blank">portals/Contact</a>|
|[profileAlertInstructions](#profileAlertInstructions)||<a href="../portals/Contact.md" target="_blank">portals/Contact</a>|
|[adxProfileIsAnonymous](#adxProfileIsAnonymous)||<a href="../portals/Contact.md" target="_blank">portals/Contact</a>|
|[adxProfileLastActivity](#adxProfileLastActivity)||<a href="../portals/Contact.md" target="_blank">portals/Contact</a>|
|[profileModifiedOn](#profileModifiedOn)||<a href="../portals/Contact.md" target="_blank">portals/Contact</a>|
|[publicProfileCopy](#publicProfileCopy)||<a href="../portals/Contact.md" target="_blank">portals/Contact</a>|
|[accessFailedCount](#accessFailedCount)|Shows the current count of failed password attempts for the contact.|<a href="../portals/Contact.md" target="_blank">portals/Contact</a>|
|[emailConfirmed](#emailConfirmed)|Determines if the email is confirmed by the contact.|<a href="../portals/Contact.md" target="_blank">portals/Contact</a>|
|[lastSuccessfulLogin](#lastSuccessfulLogin)|Indicates the last date and time the user successfully signed in to a portal.|<a href="../portals/Contact.md" target="_blank">portals/Contact</a>|
|[localLoginDisabled](#localLoginDisabled)|Indicates that the contact can no longer sign in to the portal using the local account.|<a href="../portals/Contact.md" target="_blank">portals/Contact</a>|
|[lockoutEnabled](#lockoutEnabled)|Determines if this contact will track failed access attempts and become locked after too many failed attempts. To prevent the contact from becoming locked, you can disable this setting.|<a href="../portals/Contact.md" target="_blank">portals/Contact</a>|
|[lockoutEndDate](#lockoutEndDate)|Shows the moment in time when the locked contact becomes unlocked again.|<a href="../portals/Contact.md" target="_blank">portals/Contact</a>|
|[loginEnabled](#loginEnabled)|Determines if web authentication is enabled for the contact.|<a href="../portals/Contact.md" target="_blank">portals/Contact</a>|
|[mobilePhoneConfirmed](#mobilePhoneConfirmed)|Determines if the phone number is confirmed by the contact.|<a href="../portals/Contact.md" target="_blank">portals/Contact</a>|
|[passwordHash](#passwordHash)||<a href="../portals/Contact.md" target="_blank">portals/Contact</a>|
|[securityStamp](#securityStamp)|A token used to manage the web authentication session.|<a href="../portals/Contact.md" target="_blank">portals/Contact</a>|
|[twoFactorEnabled](#twoFactorEnabled)|Determines if two-factor authentication is enabled for the contact.|<a href="../portals/Contact.md" target="_blank">portals/Contact</a>|
|[userName](#userName)|Shows the user identity for local web authentication.|<a href="../portals/Contact.md" target="_blank">portals/Contact</a>|
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Contact</td></tr><tr><td>description</td><td>Unique identifier of the contact.</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>Guid</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msevtmgt_contactid</td></tr></table>
...
First included in: <a href="../portals/Contact.md" target="_blank">portals/Contact</a>  
