...
- **is.identifiedBy**  
  ...
  ```
  "LinkedInFormSubmissionAnswer/hasAttributes/linkedInFormAnswerId"
  ```
...
- **means.entityState**  
  ...
  ```
  "LinkedInFormSubmissionAnswer/hasAttributes/stateCode"
  ```
