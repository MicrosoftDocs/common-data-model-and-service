...
<a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/solutions/marketing/interactions/TriggerCrmWorkflowActivityContactProcessed.cdm.json" target="_blank">Entity definition</a> on GitHub.  

## Instances

interactions/TriggerCrmWorkflowActivityContactProcessed  

## Traits for Trigger workflow activity contact processed

- **is.CDM.entityVersion**  
  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>versionNumber</td><td>0.8.1</td><td>string</td><td>semantic version number of the entity</td></tr></table>

- **is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>"TriggerCrmWorkflowActivityContactProcessed_/hasAt...(see Definition below)</td><td>attribute</td><td></td></tr></table>Definition:  
  ```
  "TriggerCrmWorkflowActivityContactProcessed_/hasAttributes/interactionId"
  ```
...
First included in: /core/applicationCommon/foundationCommon/crmCommon/solutions/marketing/interactions/TriggerCrmWorkflowActivityContactProcessed.cdm.json/TriggerCrmWorkflowActivityContactProcessed  
