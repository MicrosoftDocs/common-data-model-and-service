...
<a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/solutions/marketing/interactions/SplitterActivityContactProcessed.cdm.json" target="_blank">Entity definition</a> on GitHub.  

## Instances

interactions/SplitterActivityContactProcessed  

## Traits for Splitter activity contact processed
...
- **is.identifiedBy**  
  ...
  ```
  "SplitterActivityContactProcessed_/hasAttributes/interactionId"
  ```
