...
<a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/solutions/marketing/interactions/WebsiteClicked.cdm.json" target="_blank">Entity definition</a> on GitHub.  

## Instances

interactions/WebsiteClicked  

## Traits for Website clicked
...
- **is.identifiedBy**  
  ...
  ```
  "WebsiteClicked_/hasAttributes/interactionId"
  ```
