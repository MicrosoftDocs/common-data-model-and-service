...
<a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/solutions/marketing/interactions/EmailSent.cdm.json" target="_blank">Entity definition</a> on GitHub.  

## Instances

interactions/EmailSent  

## Traits for Email sent
...
- **is.identifiedBy**  
  ...
  ```
  "EmailSent_/hasAttributes/interactionId"
  ```
