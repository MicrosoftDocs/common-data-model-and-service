---
title: CustomerJourneyIteration in MarketingSolution - Common Data Model | Microsoft Docs
...
# Customer Journey Iteration in MarketingSolution

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Marketing\MarketingSolution/CustomerJourneyIteration.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/Marketing/MarketingSolution<br>/CustomerJourneyIteration.cdm.json<br>/CustomerJourneyIteration/hasAttributes<br>/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specific identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[CustomerJourneyIteration/(resolvedAttributes)/customerJourneyIterationId](#customerJourneyIterationId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[CustomerJourneyIteration/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>
...
**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyncrm_customerjourneyiteration"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="CustomerJourneyIteration.md" target="_blank">Marketing\MarketingSolution/CustomerJourneyIteration</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="CustomerJourneyIteration.md" target="_blank">Marketing\MarketingSolution/CustomerJourneyIteration</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="CustomerJourneyIteration.md" target="_blank">Marketing\MarketingSolution/CustomerJourneyIteration</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="CustomerJourneyIteration.md" target="_blank">Marketing\MarketingSolution/CustomerJourneyIteration</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="CustomerJourneyIteration.md" target="_blank">Marketing\MarketingSolution/CustomerJourneyIteration</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="CustomerJourneyIteration.md" target="_blank">Marketing\MarketingSolution/CustomerJourneyIteration</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="CustomerJourneyIteration.md" target="_blank">Marketing\MarketingSolution/CustomerJourneyIteration</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="CustomerJourneyIteration.md" target="_blank">Marketing\MarketingSolution/CustomerJourneyIteration</a>|
|[ownerId](#ownerId)|Owner Id|<a href="CustomerJourneyIteration.md" target="_blank">Marketing\MarketingSolution/CustomerJourneyIteration</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="CustomerJourneyIteration.md" target="_blank">Marketing\MarketingSolution/CustomerJourneyIteration</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="CustomerJourneyIteration.md" target="_blank">Marketing\MarketingSolution/CustomerJourneyIteration</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="CustomerJourneyIteration.md" target="_blank">Marketing\MarketingSolution/CustomerJourneyIteration</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="CustomerJourneyIteration.md" target="_blank">Marketing\MarketingSolution/CustomerJourneyIteration</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="CustomerJourneyIteration.md" target="_blank">Marketing\MarketingSolution/CustomerJourneyIteration</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="CustomerJourneyIteration.md" target="_blank">Marketing\MarketingSolution/CustomerJourneyIteration</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="CustomerJourneyIteration.md" target="_blank">Marketing\MarketingSolution/CustomerJourneyIteration</a>|
|[customerJourneyId](#customerJourneyId)|The customer journey that this iteration belongs to|<a href="CustomerJourneyIteration.md" target="_blank">Marketing\MarketingSolution/CustomerJourneyIteration</a>|
|[customerJourneyIterationId](#customerJourneyIterationId)|Unique ID for entity instances|<a href="CustomerJourneyIteration.md" target="_blank">Marketing\MarketingSolution/CustomerJourneyIteration</a>|
|[designerState](#designerState)|The state of customer journey|<a href="CustomerJourneyIteration.md" target="_blank">Marketing\MarketingSolution/CustomerJourneyIteration</a>|
|[endDate](#endDate)|The end date for this iteration of the customer journey|<a href="CustomerJourneyIteration.md" target="_blank">Marketing\MarketingSolution/CustomerJourneyIteration</a>|
|[iterationNumber](#iterationNumber)|Current iteration sequence number for a recurring customer journey|<a href="CustomerJourneyIteration.md" target="_blank">Marketing\MarketingSolution/CustomerJourneyIteration</a>|
|[name](#name)|The name of the custom entity|<a href="CustomerJourneyIteration.md" target="_blank">Marketing\MarketingSolution/CustomerJourneyIteration</a>|
|[startDate](#startDate)|The start date of the customer-journey iteration|<a href="CustomerJourneyIteration.md" target="_blank">Marketing\MarketingSolution/CustomerJourneyIteration</a>|
|[workflowDefinition](#workflowDefinition)|Definition of the customer journey design|<a href="CustomerJourneyIteration.md" target="_blank">Marketing\MarketingSolution/CustomerJourneyIteration</a>|
|[ownerIdName](#ownerIdName)|Name of the owner|<a href="CustomerJourneyIteration.md" target="_blank">Marketing\MarketingSolution/CustomerJourneyIteration</a>|
|[ownerIdYomiName](#ownerIdYomiName)|Yomi name of the owner|<a href="CustomerJourneyIteration.md" target="_blank">Marketing\MarketingSolution/CustomerJourneyIteration</a>|
|[stateCode](#stateCode)|Status of the customer journey iteration|<a href="CustomerJourneyIteration.md" target="_blank">Marketing\MarketingSolution/CustomerJourneyIteration</a>|
|[stateCode_display](#stateCode_display)||<a href="CustomerJourneyIteration.md" target="_blank">Marketing\MarketingSolution/CustomerJourneyIteration</a>|
|[statusCode](#statusCode)|Reason for the status of the customer journey iteration|<a href="CustomerJourneyIteration.md" target="_blank">Marketing\MarketingSolution/CustomerJourneyIteration</a>|
|[statusCode_display](#statusCode_display)||<a href="CustomerJourneyIteration.md" target="_blank">Marketing\MarketingSolution/CustomerJourneyIteration</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: Marketing\\MarketingSolution/CustomerJourneyIteration (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Customer journey</td></tr><tr><td>description</td><td>The customer journey that this iteration belongs to</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>sourceName</td><td>msdyncrm_customerjourneyid</td></tr></table>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>The customer journey that this iteration belongs to</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Customer journey iteration</td></tr><tr><td>description</td><td>Unique ID for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>sourceName</td><td>msdyncrm_customerjourneyiterationid</td></tr></table>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyncrm_customerjourneyiterationid"</td><td>string</td><td></td></tr></table>
...
### <a href=#designerState name="designerState">designerState</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Designer state</td></tr><tr><td>description</td><td>The state of customer journey</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>100000</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyncrm_designerstate</td></tr></table>

#### Traits

<details>
<summary>List of traits for the designerState attribute are listed below.</summary>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyncrm_designerstate"</td><td>string</td><td></td></tr></table>
...
*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Designer state</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>End date</td></tr><tr><td>description</td><td>The end date for this iteration of the customer journey</td></tr><tr><td>dataFormat</td><td>dateTime</td></tr><tr><td>sourceName</td><td>msdyncrm_enddate</td></tr></table>
...
*is.dataFormat.date*  
  ...
  *means.measurement.time*  
  *is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyncrm_enddate"</td><td>string</td><td></td></tr></table>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>The end date for this iteration of the customer journey</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.dataFormat.time*  
  *is.dataFormat.date*  
  </details>

### <a href=#iterationNumber name="iterationNumber">iterationNumber</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Iteration number</td></tr><tr><td>description</td><td>Current iteration sequence number for a recurring customer journey</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>maximumValue</td><td>2147483647</td></tr><tr><td>minimumValue</td><td>-2147483648</td></tr><tr><td>sourceName</td><td>msdyncrm_iterationnumber</td></tr></table>

#### Traits

<details>
<summary>List of traits for the iterationNumber attribute are listed below.</summary>
...
*is.dataFormat.numeric*  
  *is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyncrm_iterationnumber"</td><td>string</td><td></td></tr></table>
...
*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Iteration number</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Current iteration sequence number for a recurring customer journey</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Name</td></tr><tr><td>description</td><td>The name of the custom entity</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>256</td></tr><tr><td>sourceName</td><td>msdyncrm_name</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Start date</td></tr><tr><td>description</td><td>The start date of the customer-journey iteration</td></tr><tr><td>dataFormat</td><td>dateTime</td></tr><tr><td>sourceName</td><td>msdyncrm_startdate</td></tr></table>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>The start date of the customer-journey iteration</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Definition of the customer journey design</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the customer journey iteration</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the customer journey iteration</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status reason</td></tr><tr><td>description</td><td>Reason for the status of the customer journey iteration</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the customer journey iteration</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
