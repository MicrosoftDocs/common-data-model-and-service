...
<a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/solutions/marketing/interactions/EmailBlockBounced.cdm.json" target="_blank">Entity definition</a> on GitHub.  

## Instances

interactions/EmailBlockBounced  

## Traits for Email block bounced
...
- **is.identifiedBy**  
  ...
  ```
  "EmailBlockBounced_/hasAttributes/interactionId"
  ```
