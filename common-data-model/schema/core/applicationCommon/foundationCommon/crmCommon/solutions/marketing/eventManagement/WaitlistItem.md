...
- **is.identifiedBy**  
  ...
  ```
  "WaitlistItem/hasAttributes/waitListItemId"
  ```
...
- **means.entityState**  
  ...
  ```
  "WaitlistItem/hasAttributes/stateCode"
  ```
