...
<a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/solutions/marketing/MarketingWebsite.cdm.json" target="_blank">Entity definition</a> on GitHub.  
...
- **is.identifiedBy**  
  ...
  ```
  "MarketingWebsite_/hasAttributes/websiteId"
  ```
...
- **means.entityState**  
  ...
  ```
  "MarketingWebsite_/hasAttributes/stateCode"
  ```
