---
title: InvalidSenderAddress in interactions - Common Data Model | Microsoft Docs
...
# Invalid sender address in interactions(InvalidSenderAddress)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/solutions/marketing/interactions/InvalidSenderAddress.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[InvalidSenderAddress/(resolvedAttributes)/interactionId](#interactionId)</td><td>attribute</td><td></td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Invalid sender address</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[interactionId](#interactionId)|Unique identifier of the interaction.|<a href="InvalidSenderAddress.md" target="_blank">interactions/InvalidSenderAddress</a>|
|[contactId](#contactId)|Contact ID|<a href="InvalidSenderAddress.md" target="_blank">interactions/InvalidSenderAddress</a>|
|[accountId](#accountId)|Account ID|<a href="InvalidSenderAddress.md" target="_blank">interactions/InvalidSenderAddress</a>|
|[messageId](#messageId)|Message ID|<a href="InvalidSenderAddress.md" target="_blank">interactions/InvalidSenderAddress</a>|
|[customerJourneyId](#customerJourneyId)|Customer Journey ID|<a href="InvalidSenderAddress.md" target="_blank">interactions/InvalidSenderAddress</a>|
|[organizationId](#organizationId)|Organization ID|<a href="InvalidSenderAddress.md" target="_blank">interactions/InvalidSenderAddress</a>|
|[sendingId](#sendingId)|Sending ID|<a href="InvalidSenderAddress.md" target="_blank">interactions/InvalidSenderAddress</a>|
|[customerJourneyIterationId](#customerJourneyIterationId)|Customer journey iteration ID|<a href="InvalidSenderAddress.md" target="_blank">interactions/InvalidSenderAddress</a>|
|[usageType](#usageType)|Usage type|<a href="InvalidSenderAddress.md" target="_blank">interactions/InvalidSenderAddress</a>|
|[interactionType](#interactionType)|Interaction type|<a href="InvalidSenderAddress.md" target="_blank">interactions/InvalidSenderAddress</a>|
|[blockedReason](#blockedReason)|Blocked reason|<a href="InvalidSenderAddress.md" target="_blank">interactions/InvalidSenderAddress</a>|
|[timestamp](#timestamp)|Timestamp|<a href="InvalidSenderAddress.md" target="_blank">interactions/InvalidSenderAddress</a>|

### <a href=#interactionId name="interactionId">interactionId</a>

Unique identifier of the interaction.  
First included in: interactions/InvalidSenderAddress (this entity)  
