---
title: MarketingEmailTemplate in MarketingSolution - Common Data Model | Microsoft Docs
...
# Marketing Email Template in MarketingSolution

Template for marketing emails  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Marketing\MarketingSolution/MarketingEmailTemplate.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/Marketing/MarketingSolution<br>/MarketingEmailTemplate.cdm.json<br>/MarketingEmailTemplate/hasAttributes<br>/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specific identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[MarketingEmailTemplate/(resolvedAttributes)/marketingEmailTemplateId](#marketingEmailTemplateId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[MarketingEmailTemplate/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Marketing Email Template</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Template for marketing emails</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyncrm_marketingemailtemplate"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="MarketingEmailTemplate.md" target="_blank">Marketing\MarketingSolution/MarketingEmailTemplate</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="MarketingEmailTemplate.md" target="_blank">Marketing\MarketingSolution/MarketingEmailTemplate</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="MarketingEmailTemplate.md" target="_blank">Marketing\MarketingSolution/MarketingEmailTemplate</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="MarketingEmailTemplate.md" target="_blank">Marketing\MarketingSolution/MarketingEmailTemplate</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="MarketingEmailTemplate.md" target="_blank">Marketing\MarketingSolution/MarketingEmailTemplate</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="MarketingEmailTemplate.md" target="_blank">Marketing\MarketingSolution/MarketingEmailTemplate</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="MarketingEmailTemplate.md" target="_blank">Marketing\MarketingSolution/MarketingEmailTemplate</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="MarketingEmailTemplate.md" target="_blank">Marketing\MarketingSolution/MarketingEmailTemplate</a>|
|[ownerId](#ownerId)|Owner Id|<a href="MarketingEmailTemplate.md" target="_blank">Marketing\MarketingSolution/MarketingEmailTemplate</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="MarketingEmailTemplate.md" target="_blank">Marketing\MarketingSolution/MarketingEmailTemplate</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="MarketingEmailTemplate.md" target="_blank">Marketing\MarketingSolution/MarketingEmailTemplate</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="MarketingEmailTemplate.md" target="_blank">Marketing\MarketingSolution/MarketingEmailTemplate</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="MarketingEmailTemplate.md" target="_blank">Marketing\MarketingSolution/MarketingEmailTemplate</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="MarketingEmailTemplate.md" target="_blank">Marketing\MarketingSolution/MarketingEmailTemplate</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="MarketingEmailTemplate.md" target="_blank">Marketing\MarketingSolution/MarketingEmailTemplate</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="MarketingEmailTemplate.md" target="_blank">Marketing\MarketingSolution/MarketingEmailTemplate</a>|
|[formToSave](#formToSave)|Form to save|<a href="MarketingEmailTemplate.md" target="_blank">Marketing\MarketingSolution/MarketingEmailTemplate</a>|
|[entityImage](#entityImage)|Thumbnail preview of template.|<a href="MarketingEmailTemplate.md" target="_blank">Marketing\MarketingSolution/MarketingEmailTemplate</a>|
|[sourceEmailID](#sourceEmailID)||<a href="MarketingEmailTemplate.md" target="_blank">Marketing\MarketingSolution/MarketingEmailTemplate</a>|
|[designerHTML](#designerHTML)|Clean email body: HTML with no CSS inlining and no compression|<a href="MarketingEmailTemplate.md" target="_blank">Marketing\MarketingSolution/MarketingEmailTemplate</a>|
|[emailTemplateMarketTypeOptionset](#emailTemplateMarketTypeOptionset)|Market type|<a href="MarketingEmailTemplate.md" target="_blank">Marketing\MarketingSolution/MarketingEmailTemplate</a>|
|[emailTemplateMarketTypeOptionset_display](#emailTemplateMarketTypeOptionset_display)||<a href="MarketingEmailTemplate.md" target="_blank">Marketing\MarketingSolution/MarketingEmailTemplate</a>|
|[emailTemplateOptimizedforOptionset](#emailTemplateOptimizedforOptionset)|Optimized for|<a href="MarketingEmailTemplate.md" target="_blank">Marketing\MarketingSolution/MarketingEmailTemplate</a>|
|[emailTemplateOptimizedforOptionset_display](#emailTemplateOptimizedforOptionset_display)||<a href="MarketingEmailTemplate.md" target="_blank">Marketing\MarketingSolution/MarketingEmailTemplate</a>|
|[emailTemplatePurposeOptionset](#emailTemplatePurposeOptionset)|Purpose|<a href="MarketingEmailTemplate.md" target="_blank">Marketing\MarketingSolution/MarketingEmailTemplate</a>|
|[emailTemplatePurposeOptionset_display](#emailTemplatePurposeOptionset_display)||<a href="MarketingEmailTemplate.md" target="_blank">Marketing\MarketingSolution/MarketingEmailTemplate</a>|
|[emailTemplateVisualStyleOptionset](#emailTemplateVisualStyleOptionset)|Visual style|<a href="MarketingEmailTemplate.md" target="_blank">Marketing\MarketingSolution/MarketingEmailTemplate</a>|
|[emailTemplateVisualStyleOptionset_display](#emailTemplateVisualStyleOptionset_display)||<a href="MarketingEmailTemplate.md" target="_blank">Marketing\MarketingSolution/MarketingEmailTemplate</a>|
|[emailBody](#emailBody)||<a href="MarketingEmailTemplate.md" target="_blank">Marketing\MarketingSolution/MarketingEmailTemplate</a>|
|[language](#language)||<a href="MarketingEmailTemplate.md" target="_blank">Marketing\MarketingSolution/MarketingEmailTemplate</a>|
|[language_display](#language_display)||<a href="MarketingEmailTemplate.md" target="_blank">Marketing\MarketingSolution/MarketingEmailTemplate</a>|
|[marketingEmailTemplateId](#marketingEmailTemplateId)|Unique ID for entity instances|<a href="MarketingEmailTemplate.md" target="_blank">Marketing\MarketingSolution/MarketingEmailTemplate</a>|
|[marketingProvided](#marketingProvided)||<a href="MarketingEmailTemplate.md" target="_blank">Marketing\MarketingSolution/MarketingEmailTemplate</a>|
|[emailContenttype](#emailContenttype)||<a href="MarketingEmailTemplate.md" target="_blank">Marketing\MarketingSolution/MarketingEmailTemplate</a>|
|[emailContenttype_display](#emailContenttype_display)||<a href="MarketingEmailTemplate.md" target="_blank">Marketing\MarketingSolution/MarketingEmailTemplate</a>|
|[messagedesignation](#messagedesignation)||<a href="MarketingEmailTemplate.md" target="_blank">Marketing\MarketingSolution/MarketingEmailTemplate</a>|
|[messagedesignation_display](#messagedesignation_display)||<a href="MarketingEmailTemplate.md" target="_blank">Marketing\MarketingSolution/MarketingEmailTemplate</a>|
|[name](#name)|The name of the template|<a href="MarketingEmailTemplate.md" target="_blank">Marketing\MarketingSolution/MarketingEmailTemplate</a>|
|[subject](#subject)||<a href="MarketingEmailTemplate.md" target="_blank">Marketing\MarketingSolution/MarketingEmailTemplate</a>|
|[textpart](#textpart)||<a href="MarketingEmailTemplate.md" target="_blank">Marketing\MarketingSolution/MarketingEmailTemplate</a>|
|[automaticallyGenerateTextPart](#automaticallyGenerateTextPart)||<a href="MarketingEmailTemplate.md" target="_blank">Marketing\MarketingSolution/MarketingEmailTemplate</a>|
|[ownerIdName](#ownerIdName)|Name of the owner|<a href="MarketingEmailTemplate.md" target="_blank">Marketing\MarketingSolution/MarketingEmailTemplate</a>|
|[ownerIdYomiName](#ownerIdYomiName)|Yomi name of the owner|<a href="MarketingEmailTemplate.md" target="_blank">Marketing\MarketingSolution/MarketingEmailTemplate</a>|
|[stateCode](#stateCode)|Status of the marketing email template|<a href="MarketingEmailTemplate.md" target="_blank">Marketing\MarketingSolution/MarketingEmailTemplate</a>|
|[stateCode_display](#stateCode_display)||<a href="MarketingEmailTemplate.md" target="_blank">Marketing\MarketingSolution/MarketingEmailTemplate</a>|
|[statusCode](#statusCode)|Marketing email template status reason|<a href="MarketingEmailTemplate.md" target="_blank">Marketing\MarketingSolution/MarketingEmailTemplate</a>|
|[statusCode_display](#statusCode_display)||<a href="MarketingEmailTemplate.md" target="_blank">Marketing\MarketingSolution/MarketingEmailTemplate</a>|
|[tag](#tag)|deprecated|<a href="MarketingEmailTemplate.md" target="_blank">Marketing\MarketingSolution/MarketingEmailTemplate</a>|
|[tag_display](#tag_display)||<a href="MarketingEmailTemplate.md" target="_blank">Marketing\MarketingSolution/MarketingEmailTemplate</a>|
|[label](#label)||<a href="MarketingEmailTemplate.md" target="_blank">Marketing\MarketingSolution/MarketingEmailTemplate</a>|
|[label_display](#label_display)||<a href="MarketingEmailTemplate.md" target="_blank">Marketing\MarketingSolution/MarketingEmailTemplate</a>|
|[fromEmail](#fromEmail)||<a href="MarketingEmailTemplate.md" target="_blank">Marketing\MarketingSolution/MarketingEmailTemplate</a>|
|[fromName](#fromName)||<a href="MarketingEmailTemplate.md" target="_blank">Marketing\MarketingSolution/MarketingEmailTemplate</a>|
|[to](#to)||<a href="MarketingEmailTemplate.md" target="_blank">Marketing\MarketingSolution/MarketingEmailTemplate</a>|
|[replyToEmail](#replyToEmail)||<a href="MarketingEmailTemplate.md" target="_blank">Marketing\MarketingSolution/MarketingEmailTemplate</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: Marketing\\MarketingSolution/MarketingEmailTemplate (this entity)  
...
### <a href=#sourceEmailID name="sourceEmailID">sourceEmailID</a>

First included in: Marketing\\MarketingSolution/MarketingEmailTemplate (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Source email ID</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>100</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyncrm_sourceemailid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the sourceEmailID attribute are listed below.</summary>
...
*means.identity.service.email*  
  *is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyncrm_sourceemailid"</td><td>string</td><td></td></tr></table>
...
*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Source email ID</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
### <a href=#emailTemplateMarketTypeOptionset name="emailTemplateMarketTypeOptionset">emailTemplateMarketTypeOptionset</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Market type</td></tr><tr><td>description</td><td>Market type</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyncrm_email_template_market_type_optionset</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>B2B</td><td>0</td></tr><tr><td>en</td><td>B2C</td><td>1</td></tr><tr><td>en</td><td>B2B & B2C</td><td>2</td></tr></table></td></tr></table>

#### Traits

<details>
<summary>List of traits for the emailTemplateMarketTypeOptionset attribute are listed below.</summary>
...
*is.dataFormat.numeric*  
  *does.haveDefault*  
  An attribute has a default value  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>default</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>B2B</td><td>0</td></tr><tr><td>en</td><td>B2C</td><td>1</td></tr><tr><td>en</td><td>B2B & B2C</td><td>2</td></tr></table></td><td>any</td><td></td></tr></table>

*is.constrainedList*  
  the values of an attribute are taken from or looked up from a fixed list of possibilities  

*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyncrm_email_template_market_type_optionset"</td><td>string</td><td></td></tr></table>
...
### <a href=#emailTemplateMarketTypeOptionset_display name="emailTemplateMarketTypeOptionset_display">emailTemplateMarketTypeOptionset_display</a>
...
<details>
<summary>List of traits for the emailTemplateMarketTypeOptionset_display attribute are listed below.</summary>
...
*is.addedInSupportOf*  
    <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>inSupportOf</td><td>"emailTemplateMarketTypeOptionset"</td><td>attributeName</td><td>output parameter naming the attribute that is being supported</td></tr></table>
...
### <a href=#emailTemplateOptimizedforOptionset name="emailTemplateOptimizedforOptionset">emailTemplateOptimizedforOptionset</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Optimized for</td></tr><tr><td>description</td><td>Optimized for</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyncrm_email_template_optimizedfor_optionset</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Wide reach</td><td>0</td></tr><tr><td>en</td><td>Mobile</td><td>1</td></tr><tr><td>en</td><td>Desktop</td><td>2</td></tr></table></td></tr></table>

#### Traits

<details>
<summary>List of traits for the emailTemplateOptimizedforOptionset attribute are listed below.</summary>
...
*is.dataFormat.numeric*  
  *does.haveDefault*  
  An attribute has a default value  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>default</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Wide reach</td><td>0</td></tr><tr><td>en</td><td>Mobile</td><td>1</td></tr><tr><td>en</td><td>Desktop</td><td>2</td></tr></table></td><td>any</td><td></td></tr></table>

*is.constrainedList*  
  the values of an attribute are taken from or looked up from a fixed list of possibilities  

*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyncrm_email_template_optimizedfor_optionset"</td><td>string</td><td></td></tr></table>
...
### <a href=#emailTemplateOptimizedforOptionset_display name="emailTemplateOptimizedforOptionset_display">emailTemplateOptimizedforOptionset_display</a>
...
<details>
<summary>List of traits for the emailTemplateOptimizedforOptionset_display attribute are listed below.</summary>
...
*is.addedInSupportOf*  
    <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>inSupportOf</td><td>"emailTemplateOptimizedforOptionset"</td><td>attributeName</td><td>output parameter naming the attribute that is being supported</td></tr></table>
...
### <a href=#emailTemplatePurposeOptionset name="emailTemplatePurposeOptionset">emailTemplatePurposeOptionset</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Purpose</td></tr><tr><td>description</td><td>Purpose</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyncrm_email_template_purpose_optionset</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Structural</td><td>0</td></tr><tr><td>en</td><td>Announcement</td><td>2</td></tr><tr><td>en</td><td>Birthday</td><td>3</td></tr><tr><td>en</td><td>Blog promotion</td><td>4</td></tr><tr><td>en</td><td>Content promotion</td><td>5</td></tr><tr><td>en</td><td>Event countdown</td><td>6</td></tr><tr><td>en</td><td>Event or webinar invitation</td><td>7</td></tr><tr><td>en</td><td>Follow-up</td><td>8</td></tr><tr><td>en</td><td>Holiday greetings</td><td>9</td></tr><tr><td>en</td><td>Information</td><td>10</td></tr><tr><td>en</td><td>Hospitality</td><td>11</td></tr><tr><td>en</td><td>Newsletter</td><td>12</td></tr><tr><td>en</td><td>Post purchase</td><td>13</td></tr><tr><td>en</td><td>Promotional (up-sell/cross-sell)</td><td>14</td></tr><tr><td>en</td><td>Abandoned shopping cart</td><td>15</td></tr><tr><td>en</td><td>Thank you</td><td>16</td></tr><tr><td>en</td><td>Upcoming event</td><td>17</td></tr><tr><td>en</td><td>Welcome</td><td>18</td></tr><tr><td>en</td><td>Win-back/re-engage</td><td>19</td></tr><tr><td>en</td><td>Feedback request</td><td>20</td></tr><tr><td>en</td><td>Anniversary</td><td>21</td></tr><tr><td>en</td><td>Lead nurturing</td><td>22</td></tr><tr><td>en</td><td>Double opt-in, email based confirmation</td><td>23</td></tr></table></td></tr></table>

#### Traits

<details>
<summary>List of traits for the emailTemplatePurposeOptionset attribute are listed below.</summary>
...
*is.dataFormat.numeric*  
  *does.haveDefault*  
  An attribute has a default value  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>default</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Structural</td><td>0</td></tr><tr><td>en</td><td>Announcement</td><td>2</td></tr><tr><td>en</td><td>Birthday</td><td>3</td></tr><tr><td>en</td><td>Blog promotion</td><td>4</td></tr><tr><td>en</td><td>Content promotion</td><td>5</td></tr><tr><td>en</td><td>Event countdown</td><td>6</td></tr><tr><td>en</td><td>Event or webinar invitation</td><td>7</td></tr><tr><td>en</td><td>Follow-up</td><td>8</td></tr><tr><td>en</td><td>Holiday greetings</td><td>9</td></tr><tr><td>en</td><td>Information</td><td>10</td></tr><tr><td>en</td><td>Hospitality</td><td>11</td></tr><tr><td>en</td><td>Newsletter</td><td>12</td></tr><tr><td>en</td><td>Post purchase</td><td>13</td></tr><tr><td>en</td><td>Promotional (up-sell/cross-sell)</td><td>14</td></tr><tr><td>en</td><td>Abandoned shopping cart</td><td>15</td></tr><tr><td>en</td><td>Thank you</td><td>16</td></tr><tr><td>en</td><td>Upcoming event</td><td>17</td></tr><tr><td>en</td><td>Welcome</td><td>18</td></tr><tr><td>en</td><td>Win-back/re-engage</td><td>19</td></tr><tr><td>en</td><td>Feedback request</td><td>20</td></tr><tr><td>en</td><td>Anniversary</td><td>21</td></tr><tr><td>en</td><td>Lead nurturing</td><td>22</td></tr><tr><td>en</td><td>Double opt-in, email based confirmation</td><td>23</td></tr></table></td><td>any</td><td></td></tr></table>

*is.constrainedList*  
  the values of an attribute are taken from or looked up from a fixed list of possibilities  

*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyncrm_email_template_purpose_optionset"</td><td>string</td><td></td></tr></table>
...
### <a href=#emailTemplatePurposeOptionset_display name="emailTemplatePurposeOptionset_display">emailTemplatePurposeOptionset_display</a>
...
<details>
<summary>List of traits for the emailTemplatePurposeOptionset_display attribute are listed below.</summary>
...
*is.addedInSupportOf*  
    <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>inSupportOf</td><td>"emailTemplatePurposeOptionset"</td><td>attributeName</td><td>output parameter naming the attribute that is being supported</td></tr></table>
...
### <a href=#emailTemplateVisualStyleOptionset name="emailTemplateVisualStyleOptionset">emailTemplateVisualStyleOptionset</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Visual style</td></tr><tr><td>description</td><td>Visual style</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyncrm_email_template_visual_style_optionset</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Other</td><td>0</td></tr><tr><td>en</td><td>Light</td><td>1</td></tr><tr><td>en</td><td>Colorful</td><td>2</td></tr><tr><td>en</td><td>Dark</td><td>3</td></tr></table></td></tr></table>

#### Traits

<details>
<summary>List of traits for the emailTemplateVisualStyleOptionset attribute are listed below.</summary>
...
*is.dataFormat.numeric*  
  *does.haveDefault*  
  An attribute has a default value  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>default</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Other</td><td>0</td></tr><tr><td>en</td><td>Light</td><td>1</td></tr><tr><td>en</td><td>Colorful</td><td>2</td></tr><tr><td>en</td><td>Dark</td><td>3</td></tr></table></td><td>any</td><td></td></tr></table>

*is.constrainedList*  
  the values of an attribute are taken from or looked up from a fixed list of possibilities  

*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyncrm_email_template_visual_style_optionset"</td><td>string</td><td></td></tr></table>
...
### <a href=#emailTemplateVisualStyleOptionset_display name="emailTemplateVisualStyleOptionset_display">emailTemplateVisualStyleOptionset_display</a>
...
<details>
<summary>List of traits for the emailTemplateVisualStyleOptionset_display attribute are listed below.</summary>
...
*is.addedInSupportOf*  
    <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>inSupportOf</td><td>"emailTemplateVisualStyleOptionset"</td><td>attributeName</td><td>output parameter naming the attribute that is being supported</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Email body</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>500000</td></tr><tr><td>sourceName</td><td>msdyncrm_emailbody</td></tr></table>
...
### <a href=#marketingEmailTemplateId name="marketingEmailTemplateId">marketingEmailTemplateId</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Marketing email template</td></tr><tr><td>description</td><td>Unique ID for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>sourceName</td><td>msdyncrm_marketingemailtemplateid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the marketingEmailTemplateId attribute are listed below.</summary>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyncrm_marketingemailtemplateid"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Name</td></tr><tr><td>description</td><td>The name of the template</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>256</td></tr><tr><td>sourceName</td><td>msdyncrm_name</td></tr></table>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>The name of the template</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Subject</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>256</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyncrm_subject</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Automatically generate text part</td></tr><tr><td>dataFormat</td><td>boolean</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyncrm_automaticallygeneratetextpart</td></tr></table>
...
*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Automatically generate text part</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the marketing email template</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the marketing email template</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Marketing email template status reason</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>From Email</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>500</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyncrm_fromemail</td></tr></table>
...
*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>From Email</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>From Name</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>500</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyncrm_fromname</td></tr></table>
...
*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>From Name</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
