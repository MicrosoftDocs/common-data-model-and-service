...
<a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/solutions/marketing/eventManagement/SpeakerEngagement.cdm.json" target="_blank">Entity definition</a> on GitHub.  

## Instances

eventManagement/SpeakerEngagement  

## Traits for Speaker Engagement
...
- **is.identifiedBy**  
  ...
  ```
  "SpeakerEngagement_/hasAttributes/speakerEngagementId"
  ```
...
- **means.entityState**  
  ...
  ```
  "SpeakerEngagement_/hasAttributes/stateCode"
  ```
