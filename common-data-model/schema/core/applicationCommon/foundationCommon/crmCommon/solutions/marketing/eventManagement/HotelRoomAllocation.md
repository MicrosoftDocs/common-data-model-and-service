...
- **is.identifiedBy**  
  ...
  ```
  "HotelRoomAllocation/hasAttributes/hotelRoomAllocationId"
  ```
...
- **means.entityState**  
  ...
  ```
  "HotelRoomAllocation/hasAttributes/stateCode"
  ```
