---
title: CdnConfiguration in MarketingSolution - Common Data Model | Microsoft Docs
...
# cdn configuration in MarketingSolution(CdnConfiguration)

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Marketing\MarketingSolution/CdnConfiguration.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/Marketing/MarketingSolution<br>/CdnConfiguration.cdm.json/CdnConfiguration<br>/hasAttributes/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specific identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[CdnConfiguration/(resolvedAttributes)/CDNConfigurationId](#CDNConfigurationId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[CdnConfiguration/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>cdn configuration</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyncrm_cdnconfiguration"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="CdnConfiguration.md" target="_blank">Marketing\MarketingSolution/CdnConfiguration</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="CdnConfiguration.md" target="_blank">Marketing\MarketingSolution/CdnConfiguration</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="CdnConfiguration.md" target="_blank">Marketing\MarketingSolution/CdnConfiguration</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="CdnConfiguration.md" target="_blank">Marketing\MarketingSolution/CdnConfiguration</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="CdnConfiguration.md" target="_blank">Marketing\MarketingSolution/CdnConfiguration</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="CdnConfiguration.md" target="_blank">Marketing\MarketingSolution/CdnConfiguration</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="CdnConfiguration.md" target="_blank">Marketing\MarketingSolution/CdnConfiguration</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="CdnConfiguration.md" target="_blank">Marketing\MarketingSolution/CdnConfiguration</a>|
|[ownerId](#ownerId)|Owner Id|<a href="CdnConfiguration.md" target="_blank">Marketing\MarketingSolution/CdnConfiguration</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="CdnConfiguration.md" target="_blank">Marketing\MarketingSolution/CdnConfiguration</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="CdnConfiguration.md" target="_blank">Marketing\MarketingSolution/CdnConfiguration</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="CdnConfiguration.md" target="_blank">Marketing\MarketingSolution/CdnConfiguration</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="CdnConfiguration.md" target="_blank">Marketing\MarketingSolution/CdnConfiguration</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="CdnConfiguration.md" target="_blank">Marketing\MarketingSolution/CdnConfiguration</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="CdnConfiguration.md" target="_blank">Marketing\MarketingSolution/CdnConfiguration</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="CdnConfiguration.md" target="_blank">Marketing\MarketingSolution/CdnConfiguration</a>|
|[CDNConfigurationId](#CDNConfigurationId)|Unique ID for entity instances|<a href="CdnConfiguration.md" target="_blank">Marketing\MarketingSolution/CdnConfiguration</a>|
|[CDNEnabled](#CDNEnabled)|CDN enabled value|<a href="CdnConfiguration.md" target="_blank">Marketing\MarketingSolution/CdnConfiguration</a>|
|[name](#name)|The name of the custom entity|<a href="CdnConfiguration.md" target="_blank">Marketing\MarketingSolution/CdnConfiguration</a>|
|[publicAssetsCDN](#publicAssetsCDN)|Public assets CDN|<a href="CdnConfiguration.md" target="_blank">Marketing\MarketingSolution/CdnConfiguration</a>|
|[ownerIdName](#ownerIdName)|Name of the owner|<a href="CdnConfiguration.md" target="_blank">Marketing\MarketingSolution/CdnConfiguration</a>|
|[ownerIdYomiName](#ownerIdYomiName)|Yomi name of the owner|<a href="CdnConfiguration.md" target="_blank">Marketing\MarketingSolution/CdnConfiguration</a>|
|[stateCode](#stateCode)|Status of the CDN configuration|<a href="CdnConfiguration.md" target="_blank">Marketing\MarketingSolution/CdnConfiguration</a>|
|[stateCode_display](#stateCode_display)||<a href="CdnConfiguration.md" target="_blank">Marketing\MarketingSolution/CdnConfiguration</a>|
|[statusCode](#statusCode)|Reason for the status of the CDN configuration|<a href="CdnConfiguration.md" target="_blank">Marketing\MarketingSolution/CdnConfiguration</a>|
|[statusCode_display](#statusCode_display)||<a href="CdnConfiguration.md" target="_blank">Marketing\MarketingSolution/CdnConfiguration</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: Marketing\\MarketingSolution/CdnConfiguration (this entity)  
...
### <a href=#CDNConfigurationId name="CDNConfigurationId">CDNConfigurationId</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>CDN configuration</td></tr><tr><td>description</td><td>Unique ID for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>sourceName</td><td>msdyncrm_cdnconfigurationid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the CDNConfigurationId attribute are listed below.</summary>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyncrm_cdnconfigurationid"</td><td>string</td><td></td></tr></table>
...
### <a href=#CDNEnabled name="CDNEnabled">CDNEnabled</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>CDN enabled</td></tr><tr><td>description</td><td>CDN enabled value</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>100</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyncrm_cdnenabled</td></tr></table>

#### Traits

<details>
<summary>List of traits for the CDNEnabled attribute are listed below.</summary>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyncrm_cdnenabled"</td><td>string</td><td></td></tr></table>
...
*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>CDN enabled</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>CDN enabled value</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
### <a href=#publicAssetsCDN name="publicAssetsCDN">publicAssetsCDN</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Public assets CDN</td></tr><tr><td>description</td><td>Public assets CDN</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>100</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyncrm_publicassetscdn</td></tr></table>

#### Traits

<details>
<summary>List of traits for the publicAssetsCDN attribute are listed below.</summary>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyncrm_publicassetscdn"</td><td>string</td><td></td></tr></table>
...
*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Public assets CDN</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the CDN configuration</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
Reason for the status of the CDN configuration  
First included in: Marketing\\MarketingSolution/CdnConfiguration (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status reason</td></tr><tr><td>description</td><td>Reason for the status of the CDN configuration</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the CDN configuration</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
