...
- **is.identifiedBy**  
  ...
  ```
  "AttendeePass/hasAttributes/attendeePassId"
  ```
...
- **means.entityState**  
  ...
  ```
  "AttendeePass/hasAttributes/stateCode"
  ```
