---
title: PhoneCall in MarketingSolution - Common Data Model | Microsoft Docs
...
# Phone Call in MarketingSolution

Activity to track a telephone call.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Marketing\MarketingSolution/PhoneCall.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="PhoneCall.md" target="_blank">Marketing\MarketingSolution/PhoneCall</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="PhoneCall.md" target="_blank">Marketing\MarketingSolution/PhoneCall</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="PhoneCall.md" target="_blank">Marketing\MarketingSolution/PhoneCall</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="PhoneCall.md" target="_blank">Marketing\MarketingSolution/PhoneCall</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="PhoneCall.md" target="_blank">Marketing\MarketingSolution/PhoneCall</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="PhoneCall.md" target="_blank">Marketing\MarketingSolution/PhoneCall</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="PhoneCall.md" target="_blank">Marketing\MarketingSolution/PhoneCall</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="PhoneCall.md" target="_blank">Marketing\MarketingSolution/PhoneCall</a>|
|[ownerId](#ownerId)|Owner Id|<a href="PhoneCall.md" target="_blank">Marketing\MarketingSolution/PhoneCall</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="PhoneCall.md" target="_blank">Marketing\MarketingSolution/PhoneCall</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="PhoneCall.md" target="_blank">Marketing\MarketingSolution/PhoneCall</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="PhoneCall.md" target="_blank">Marketing\MarketingSolution/PhoneCall</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="PhoneCall.md" target="_blank">Marketing\MarketingSolution/PhoneCall</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="PhoneCall.md" target="_blank">Marketing\MarketingSolution/PhoneCall</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="PhoneCall.md" target="_blank">Marketing\MarketingSolution/PhoneCall</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="PhoneCall.md" target="_blank">Marketing\MarketingSolution/PhoneCall</a>|
|[activityId](#activityId)|Unique identifier of the activity.|<a href="PhoneCall.md" target="_blank">Marketing\MarketingSolution/PhoneCall</a>|
|[activityTypeCode](#activityTypeCode)|Type of activity.|<a href="PhoneCall.md" target="_blank">Marketing\MarketingSolution/PhoneCall</a>|
|[isBilled](#isBilled)|Information regarding whether the activity was billed as part of resolving a case.|<a href="PhoneCall.md" target="_blank">Marketing\MarketingSolution/PhoneCall</a>|
|[isRegularActivity](#isRegularActivity)|Information regarding whether the activity is a regular activity type or event type.|<a href="PhoneCall.md" target="_blank">Marketing\MarketingSolution/PhoneCall</a>|
|[isWorkflowCreated](#isWorkflowCreated)|Information regarding whether the activity was created from a workflow rule.|<a href="PhoneCall.md" target="_blank">Marketing\MarketingSolution/PhoneCall</a>|
|[priorityCode](#priorityCode)|Priority of the activity.|<a href="PhoneCall.md" target="_blank">Marketing\MarketingSolution/PhoneCall</a>|
|[priorityCode_display](#priorityCode_display)||<a href="PhoneCall.md" target="_blank">Marketing\MarketingSolution/PhoneCall</a>|
|[regardingObjectId](#regardingObjectId)|Unique identifier of the object with which the activity is associated.|<a href="PhoneCall.md" target="_blank">Marketing\MarketingSolution/PhoneCall</a>|
|[regardingObjectTypeCode](#regardingObjectTypeCode)|The name of the entity linked by regardingObjectId|<a href="PhoneCall.md" target="_blank">Marketing\MarketingSolution/PhoneCall</a>|
|[scheduledEnd](#scheduledEnd)|Scheduled end time of the activity.|<a href="PhoneCall.md" target="_blank">Marketing\MarketingSolution/PhoneCall</a>|
|[scheduledStart](#scheduledStart)|Scheduled start time of the activity.|<a href="PhoneCall.md" target="_blank">Marketing\MarketingSolution/PhoneCall</a>|
|[sortDate](#sortDate)|Shows the date and time by which the activities are sorted.|<a href="PhoneCall.md" target="_blank">Marketing\MarketingSolution/PhoneCall</a>|
|[subject](#subject)|Subject associated with the activity.|<a href="PhoneCall.md" target="_blank">Marketing\MarketingSolution/PhoneCall</a>|
|[scheduledDurationMinutes](#scheduledDurationMinutes)|Scheduled duration of the activity, specified in minutes.|<a href="PhoneCall.md" target="_blank">Marketing\MarketingSolution/PhoneCall</a>|
|[actualDurationMinutes](#actualDurationMinutes)|Actual duration of the activity in minutes.|<a href="PhoneCall.md" target="_blank">Marketing\MarketingSolution/PhoneCall</a>|
|[actualEnd](#actualEnd)|Actual end time of the activity.|<a href="PhoneCall.md" target="_blank">Marketing\MarketingSolution/PhoneCall</a>|
|[actualStart](#actualStart)|Actual start time of the activity.|<a href="PhoneCall.md" target="_blank">Marketing\MarketingSolution/PhoneCall</a>|
|[category](#category)|Type a category to identify the activity type, such as lead outreach, customer follow-up, or service alert, to tie the eactivity to a business group or function.|<a href="PhoneCall.md" target="_blank">Marketing\MarketingSolution/PhoneCall</a>|
|[subcategory](#subcategory)|Type a subcategory to identify the activity type and relate the activity to a specific product, sales region, business group, or other function.|<a href="PhoneCall.md" target="_blank">Marketing\MarketingSolution/PhoneCall</a>|
|[activityAdditionalParams](#activityAdditionalParams)|Additional information provided by the external application as JSON. For internal use only.|<a href="PhoneCall.md" target="_blank">Marketing\MarketingSolution/PhoneCall</a>|
|[to](#to)|The account, contact, lead, queue, or user recipients for the activity.|<a href="PhoneCall.md" target="_blank">Marketing\MarketingSolution/PhoneCall</a>|
|[from](#from)|The sender of the activity.|<a href="PhoneCall.md" target="_blank">Marketing\MarketingSolution/PhoneCall</a>|
|[leftVoiceMail](#leftVoiceMail)|Left the voice mail|<a href="PhoneCall.md" target="_blank">Marketing\MarketingSolution/PhoneCall</a>|
|[directionCode](#directionCode)|Select the direction of the activity as incoming or outbound.|<a href="PhoneCall.md" target="_blank">Marketing\MarketingSolution/PhoneCall</a>|
|[phoneNumber](#phoneNumber)|Type the phone number.|<a href="PhoneCall.md" target="_blank">Marketing\MarketingSolution/PhoneCall</a>|
|[description](#description)|Additional information to describe the phone call, such as the primary message or the products and services discussed.|<a href="PhoneCall.md" target="_blank">Marketing\MarketingSolution/PhoneCall</a>|
|[stateCode](#stateCode)|Shows whether the phone call is open, completed, or canceled. Completed and canceled phone calls are read-only and can't be edited.|<a href="PhoneCall.md" target="_blank">Marketing\MarketingSolution/PhoneCall</a>|
|[stateCode_display](#stateCode_display)||<a href="PhoneCall.md" target="_blank">Marketing\MarketingSolution/PhoneCall</a>|
|[statusCode](#statusCode)|Select the phone call's status.|<a href="PhoneCall.md" target="_blank">Marketing\MarketingSolution/PhoneCall</a>|
|[statusCode_display](#statusCode_display)||<a href="PhoneCall.md" target="_blank">Marketing\MarketingSolution/PhoneCall</a>|
|[transactionCurrencyId](#transactionCurrencyId)|Choose the local currency for the record to make sure budgets are reported in the correct currency.|<a href="PhoneCall.md" target="_blank">Marketing\MarketingSolution/PhoneCall</a>|
|[exchangeRate](#exchangeRate)|Shows the conversion rate of the record's currency. The exchange rate is used to convert all money fields in the record from the local currency to the system's default currency.|<a href="PhoneCall.md" target="_blank">Marketing\MarketingSolution/PhoneCall</a>|
|[processId](#processId)|Shows the ID of the process.|<a href="PhoneCall.md" target="_blank">Marketing\MarketingSolution/PhoneCall</a>|
|[stageId](#stageId)|Shows the ID of the stage.|<a href="PhoneCall.md" target="_blank">Marketing\MarketingSolution/PhoneCall</a>|
|[traversedPath](#traversedPath)|For internal use only.|<a href="PhoneCall.md" target="_blank">Marketing\MarketingSolution/PhoneCall</a>|
|[SLAInvokedId](#SLAInvokedId)|Last SLA that was applied to this Phone Call. This field is for internal use only.|<a href="PhoneCall.md" target="_blank">Marketing\MarketingSolution/PhoneCall</a>|
|[onHoldTime](#onHoldTime)|Shows how long, in minutes, that the record was on hold.|<a href="PhoneCall.md" target="_blank">Marketing\MarketingSolution/PhoneCall</a>|
|[lastOnHoldTime](#lastOnHoldTime)|Contains the date and time stamp of the last on hold time.|<a href="PhoneCall.md" target="_blank">Marketing\MarketingSolution/PhoneCall</a>|
|[SLAId](#SLAId)|Choose the service level agreement (SLA) that you want to apply to the Phone Call record.|<a href="PhoneCall.md" target="_blank">Marketing\MarketingSolution/PhoneCall</a>|
|[associatedCustomerjourneyiterationId](#associatedCustomerjourneyiterationId)|Customer journey iteration|<a href="PhoneCall.md" target="_blank">Marketing\MarketingSolution/PhoneCall</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: Marketing\\MarketingSolution/PhoneCall (this entity)  
...
*is.dataFormat.guid*  
  *means.identity.entityId*  
  *is.identifiedBy*  
  names a specific identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[PhoneCall/(resolvedAttributes)/activityId](#activityId)</td><td>attribute</td><td></td></tr></table>
...
*is.dataFormat.numeric*  
  *means.measurement.dimension.time*  
  measurement of time  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>dimension</td><td>"time"</td><td>string</td><td>the name of the physical dimension being measured</td></tr></table>

*means.measurement.duration.minutes*  
  *has.measurement.fundamentalComponent.second*  
  a fundamental component expressing time in seconds  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>fundamentalUnit</td><td>"second"</td><td>string</td><td>the name of the fundamental unit that is a component of some derived unit.</td></tr><tr><td>symbol</td><td>"s"</td><td>string</td><td>the common symbolic representation of the unit</td></tr><tr><td>dimension</td><td>"time"</td><td>string</td><td>dimension being measured</td></tr><tr><td>fundamentalExponent</td><td>"1"</td><td>double</td><td>the exponent, positive, negative, fractional (for inverse) that the component contributes to the base derived unit.</td></tr><tr><td>fundamentalScale</td><td>"60"</td><td>double</td><td>the constant scale factor applied to the fundamental unit (prior to application of exponent) by the derived unit</td></tr><tr><td>fundamentalOffset</td><td>"0"</td><td>double</td><td>the constant offset applied to the scaled fundamental unit (prior to application of exponent) by the derived unit</td></tr></table>
...
The account, contact, lead, queue, or user recipients for the activity.  
First included in: Marketing\\MarketingSolution/PhoneCall (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>To</td></tr><tr><td>description</td><td>The account, contact, lead, queue, or user recipients for the activity.</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>to</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Select the phone call's status.</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Open</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Made</td><td>2</td><td>1</td></tr><tr><td>en</td><td>Canceled</td><td>3</td><td>2</td></tr><tr><td>en</td><td>Received</td><td>4</td><td>1</td></tr></table></td></tr></table>
...
*does.haveDefault*  
  An attribute has a default value  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>default</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Open</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Made</td><td>2</td><td>1</td></tr><tr><td>en</td><td>Canceled</td><td>3</td><td>2</td></tr><tr><td>en</td><td>Received</td><td>4</td><td>1</td></tr></table></td><td>any</td><td></td></tr></table>
...
### <a href=#associatedCustomerjourneyiterationId name="associatedCustomerjourneyiterationId">associatedCustomerjourneyiterationId</a>
...
<details>
<summary>List of traits for the associatedCustomerjourneyiterationId attribute are listed below.</summary>
...
*is.linkedEntity.identifier*  
  Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="CustomerJourneyIteration.md" target="_blank">CustomerJourneyIteration.cdm.json/CustomerJourneyIteration</a></td><td><a href="CustomerJourneyIteration.md#customerJourneyIterationId" target="_blank">customerJourneyIterationId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
