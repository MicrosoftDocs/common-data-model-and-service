...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in Common Data Model entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/activityCommon</td></tr><tr><td>/core/applicationCommon/PhoneCall.cdm.json<br>/PhoneCall/hasAttributes<br>/attributesAddedAtThisScope</td></tr><tr><td>/core/applicationCommon/foundationCommon<br>/crmCommon/PhoneCall.cdm.json/PhoneCall<br>/hasAttributes/attributesAddedAtThisScope</td></tr><tr><td>/core/applicationCommon/foundationCommon<br>/crmCommon/solutions/marketing/PhoneCall.cdm.json<br>/PhoneCall/hasAttributes<br>/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.ordered**  
  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[PhoneCall/(resolvedAttributes)/sortDate](#sortDate)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[PhoneCall/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Phone Call</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Activity to track a telephone call.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
  the unique name that identifies this object in Common Data Service for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"PhoneCall"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="PhoneCall.md" target="_blank">marketing/PhoneCall</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="PhoneCall.md" target="_blank">marketing/PhoneCall</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="PhoneCall.md" target="_blank">marketing/PhoneCall</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="PhoneCall.md" target="_blank">marketing/PhoneCall</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="PhoneCall.md" target="_blank">marketing/PhoneCall</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="PhoneCall.md" target="_blank">marketing/PhoneCall</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="PhoneCall.md" target="_blank">marketing/PhoneCall</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="PhoneCall.md" target="_blank">marketing/PhoneCall</a>|
|[ownerId](#ownerId)|Owner Id|<a href="PhoneCall.md" target="_blank">marketing/PhoneCall</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="PhoneCall.md" target="_blank">marketing/PhoneCall</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="PhoneCall.md" target="_blank">marketing/PhoneCall</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="PhoneCall.md" target="_blank">marketing/PhoneCall</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="PhoneCall.md" target="_blank">marketing/PhoneCall</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="PhoneCall.md" target="_blank">marketing/PhoneCall</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="PhoneCall.md" target="_blank">marketing/PhoneCall</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="PhoneCall.md" target="_blank">marketing/PhoneCall</a>|
|[activityId](#activityId)|Unique identifier of the activity.|<a href="PhoneCall.md" target="_blank">marketing/PhoneCall</a>|
|[activityTypeCode](#activityTypeCode)|Type of activity.|<a href="PhoneCall.md" target="_blank">marketing/PhoneCall</a>|
|[isBilled](#isBilled)|Information regarding whether the fax activity was billed as part of resolving a case.|<a href="PhoneCall.md" target="_blank">marketing/PhoneCall</a>|
|[isRegularActivity](#isRegularActivity)|Information regarding whether the activity is a regular activity type or event type.|<a href="PhoneCall.md" target="_blank">marketing/PhoneCall</a>|
|[isWorkflowCreated](#isWorkflowCreated)|Information regarding whether the activity was created from a workflow rule.|<a href="PhoneCall.md" target="_blank">marketing/PhoneCall</a>|
|[priorityCode](#priorityCode)|Priority of the activity.|<a href="PhoneCall.md" target="_blank">marketing/PhoneCall</a>|
|[priorityCode_display](#priorityCode_display)||<a href="PhoneCall.md" target="_blank">marketing/PhoneCall</a>|
|[regardingObjectId](#regardingObjectId)|Unique identifier of the object with which the activity is associated.|<a href="PhoneCall.md" target="_blank">marketing/PhoneCall</a>|
|[regardingObjectTypeCode](#regardingObjectTypeCode)|The name of the entity linked by regardingObjectId|<a href="PhoneCall.md" target="_blank">marketing/PhoneCall</a>|
|[scheduledEnd](#scheduledEnd)|Scheduled end time of the activity.|<a href="PhoneCall.md" target="_blank">marketing/PhoneCall</a>|
|[scheduledStart](#scheduledStart)|Scheduled start time of the activity.|<a href="PhoneCall.md" target="_blank">marketing/PhoneCall</a>|
|[sortDate](#sortDate)|Shows the date and time by which the activities are sorted.|<a href="PhoneCall.md" target="_blank">marketing/PhoneCall</a>|
|[subject](#subject)|Subject associated with the activity.|<a href="PhoneCall.md" target="_blank">marketing/PhoneCall</a>|
|[scheduledDurationMinutes](#scheduledDurationMinutes)|Scheduled duration of the activity, specified in minutes.|<a href="PhoneCall.md" target="_blank">marketing/PhoneCall</a>|
|[actualDurationMinutes](#actualDurationMinutes)|Actual duration of the activity in minutes.|<a href="PhoneCall.md" target="_blank">marketing/PhoneCall</a>|
|[actualEnd](#actualEnd)|Actual end time of the activity.|<a href="PhoneCall.md" target="_blank">marketing/PhoneCall</a>|
|[actualStart](#actualStart)|Actual start time of the activity.|<a href="PhoneCall.md" target="_blank">marketing/PhoneCall</a>|
|[category](#category)|Type a category to identify the activity type, such as lead outreach, customer follow-up, or service alert, to tie the eactivity to a business group or function.|<a href="PhoneCall.md" target="_blank">marketing/PhoneCall</a>|
|[subcategory](#subcategory)|Type a subcategory to identify the activity type and relate the activity to a specific product, sales region, business group, or other function.|<a href="PhoneCall.md" target="_blank">marketing/PhoneCall</a>|
|[activityAdditionalParams](#activityAdditionalParams)|Additional information provided by the external application as JSON. For internal use only.|<a href="PhoneCall.md" target="_blank">marketing/PhoneCall</a>|
|[to](#to)|Person who is the receiver of the activity.|<a href="PhoneCall.md" target="_blank">marketing/PhoneCall</a>|
|[from](#from)|Person who the activity is from.|<a href="PhoneCall.md" target="_blank">marketing/PhoneCall</a>|
|[leftVoiceMail](#leftVoiceMail)|Left the voice mail|<a href="PhoneCall.md" target="_blank">marketing/PhoneCall</a>|
|[directionCode](#directionCode)|Select the direction of the activity as incoming or outbound.|<a href="PhoneCall.md" target="_blank">marketing/PhoneCall</a>|
|[phoneNumber](#phoneNumber)|Type the phone number.|<a href="PhoneCall.md" target="_blank">marketing/PhoneCall</a>|
|[description](#description)|Additional information to describe the phone call, such as the primary message or the products and services discussed.|<a href="PhoneCall.md" target="_blank">marketing/PhoneCall</a>|
|[stateCode](#stateCode)|Shows whether the phone call is open, completed, or canceled. Completed and canceled phone calls are read-only and can't be edited.|<a href="PhoneCall.md" target="_blank">marketing/PhoneCall</a>|
|[stateCode_display](#stateCode_display)||<a href="PhoneCall.md" target="_blank">marketing/PhoneCall</a>|
|[statusCode](#statusCode)|Select the phone call's status.|<a href="PhoneCall.md" target="_blank">marketing/PhoneCall</a>|
|[statusCode_display](#statusCode_display)||<a href="PhoneCall.md" target="_blank">marketing/PhoneCall</a>|
|[transactionCurrencyId](#transactionCurrencyId)|Choose the local currency for the record to make sure budgets are reported in the correct currency.|<a href="PhoneCall.md" target="_blank">marketing/PhoneCall</a>|
|[exchangeRate](#exchangeRate)|Shows the conversion rate of the record's currency. The exchange rate is used to convert all money fields in the record from the local currency to the system's default currency.|<a href="PhoneCall.md" target="_blank">marketing/PhoneCall</a>|
|[processId](#processId)|Shows the ID of the process.|<a href="PhoneCall.md" target="_blank">marketing/PhoneCall</a>|
|[stageId](#stageId)|Shows the ID of the stage.|<a href="PhoneCall.md" target="_blank">marketing/PhoneCall</a>|
|[traversedPath](#traversedPath)|For internal use only.|<a href="PhoneCall.md" target="_blank">marketing/PhoneCall</a>|
|[SLAInvokedId](#SLAInvokedId)|Last SLA that was applied to this Phone Call. This field is for internal use only.|<a href="PhoneCall.md" target="_blank">marketing/PhoneCall</a>|
|[onHoldTime](#onHoldTime)|Shows how long, in minutes, that the record was on hold.|<a href="PhoneCall.md" target="_blank">marketing/PhoneCall</a>|
|[lastOnHoldTime](#lastOnHoldTime)|Contains the date and time stamp of the last on hold time.|<a href="PhoneCall.md" target="_blank">marketing/PhoneCall</a>|
|[SLAId](#SLAId)|Choose the service level agreement (SLA) that you want to apply to the Phone Call record.|<a href="PhoneCall.md" target="_blank">marketing/PhoneCall</a>|
|[serviceId](#serviceId)|Unique identifier for an associated service.|<a href="PhoneCall.md" target="_blank">marketing/PhoneCall</a>|
|[customerJourneyIteration](#customerJourneyIteration)|Customer journey iteration|<a href="PhoneCall.md" target="_blank">marketing/PhoneCall</a>|
...
**means.identity.entityId**  
**is.identifiedBy**  
names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[PhoneCall/(resolvedAttributes)/activityId](#activityId)</td><td>attribute</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Call To</td></tr><tr><td>description</td><td>Person who is the receiver of the activity.</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>to</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>The account, contact, lead, queue, or user recipients for the activity.</td></tr><tr><td>en</td><td>Enter the account, contact, lead, or user recipients of the phone call.</td></tr><tr><td>en</td><td>Enter the account, contact, lead, queue, or user recipients for the email.</td></tr><tr><td>en</td><td>Enter the account, contact, lead, queue, or user recipients for the fax.</td></tr><tr><td>en</td><td>Enter the account, contact, lead, or user recipients for the letter.</td></tr><tr><td>en</td><td>Person who is the receiver of the activity.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Call From</td></tr><tr><td>description</td><td>Person who the activity is from.</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>from</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>The sender of the activity.</td></tr><tr><td>en</td><td>Enter the account, contact, lead, queue, or user who sent the fax.</td></tr><tr><td>en</td><td>Enter the account, contact, lead, or user who sent the letter.</td></tr><tr><td>en</td><td>Enter the account, contact, lead, or user who made the phone call.</td></tr><tr><td>en</td><td>Person who the activity is from.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Phone Number</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Type the phone number.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.nullable**  
The attribute value may be set to NULL.  

**is.CDS.sourceNamed**  
the unique name that identifies this object in Common Data Service for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"phonenumber"</td><td>string</td><td></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Additional information to describe the phone call, such as the primary message or the products and services discussed.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Shows whether the phone call is open, completed, or canceled. Completed and canceled phone calls are read-only and can't be edited.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Select the phone call's status.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Last SLA that was applied to this Phone Call. This field is for internal use only.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Choose the service level agreement (SLA) that you want to apply to the Phone Call record.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Customer journey iteration</td></tr><tr><td>description</td><td>Customer journey iteration</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyncrm_associatedcustomerjourneyiteration</td></tr></table>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Customer journey iteration</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in Common Data Service for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyncrm_associatedcustomerjourneyiteration"</td><td>string</td><td></td></tr></table>
