...
<a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/solutions/marketing/interactions/InvalidRecipientAddress.cdm.json" target="_blank">Entity definition</a> on GitHub.  

## Instances

interactions/InvalidRecipientAddress  

## Traits for The recipient address isn't valid.
...
- **is.identifiedBy**  
  ...
  ```
  "InvalidRecipientAddress_/hasAttributes/interactionId"
  ```
