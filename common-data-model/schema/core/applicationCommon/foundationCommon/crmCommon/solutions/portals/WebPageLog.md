...
- **is.identifiedBy**  
  ...
  ```
  "WebPageLog/hasAttributes/webpagelogId"
  ```
...
- **means.entityState**  
  ...
  ```
  "WebPageLog/hasAttributes/stateCode"
  ```
