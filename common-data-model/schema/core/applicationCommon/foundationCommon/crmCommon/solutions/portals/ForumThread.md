...
- **is.identifiedBy**  
  ...
  ```
  "ForumThread/hasAttributes/communityForumThreadId"
  ```
...
- **means.entityState**  
  ...
  ```
  "ForumThread/hasAttributes/stateCode"
  ```
