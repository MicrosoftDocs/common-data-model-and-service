...
- **is.identifiedBy**  
  ...
  ```
  "IdeaForum/hasAttributes/ideaForumId"
  ```
...
- **means.entityState**  
  ...
  ```
  "IdeaForum/hasAttributes/stateCode"
  ```
