...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/applicationCommon/Feedback.cdm.json<br>/Feedback/hasAttributes/attributesAddedAtThisScope</td></tr><tr><td>/core/applicationCommon/foundationCommon<br>/crmCommon/solutions/portals/Feedback.cdm.json<br>/Feedback/hasAttributes/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>
...
|[minRating](#minRating)|Enter the minimum rating value.|<a href="Feedback.md" target="_blank">portals/Feedback</a>|
|[maxRating](#maxRating)|Enter the maximum rating value.|<a href="Feedback.md" target="_blank">portals/Feedback</a>|
|[normalizedRating](#normalizedRating)|Shows the rating scaled to a value between 0 and 1 based on minimum and maximum ratings.|<a href="Feedback.md" target="_blank">portals/Feedback</a>|
|[comments](#comments)|Type the feedback comments.|<a href="Feedback.md" target="_blank">portals/Feedback</a>|
|[source](#source)|Shows where the feedback was submitted from.|<a href="Feedback.md" target="_blank">portals/Feedback</a>|
|[source_display](#source_display)||<a href="Feedback.md" target="_blank">portals/Feedback</a>|
|[stateCode](#stateCode)|Shows whether the feedback is open, rejected or closed.|<a href="Feedback.md" target="_blank">portals/Feedback</a>|
|[stateCode_display](#stateCode_display)||<a href="Feedback.md" target="_blank">portals/Feedback</a>|
|[statusCode](#statusCode)|Select the feedback's status.|<a href="Feedback.md" target="_blank">portals/Feedback</a>|
|[statusCode_display](#statusCode_display)||<a href="Feedback.md" target="_blank">portals/Feedback</a>|
|[versionNumber](#versionNumber)|Version number of the feedback.|<a href="Feedback.md" target="_blank">portals/Feedback</a>|
|[regardingObjectId](#regardingObjectId)|Shows the record that the feedback is associated with.|<a href="Feedback.md" target="_blank">portals/Feedback</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="Feedback.md" target="_blank">portals/Feedback</a>|
|[createdOn](#createdOn)|Shows the date and time when the record was created. The date and time are displayed in the time zone selected in Microsoft Dynamics 365 options.|<a href="Feedback.md" target="_blank">portals/Feedback</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="Feedback.md" target="_blank">portals/Feedback</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="Feedback.md" target="_blank">portals/Feedback</a>|
|[modifiedOn](#modifiedOn)|Shows the date and time when the record was last updated. The date and time are displayed in the time zone selected in Microsoft Dynamics 365 options.|<a href="Feedback.md" target="_blank">portals/Feedback</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="Feedback.md" target="_blank">portals/Feedback</a>|
|[ownerId](#ownerId)|Owner Id|<a href="Feedback.md" target="_blank">portals/Feedback</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="Feedback.md" target="_blank">portals/Feedback</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier of the business unit that owns the knowledge article views.|<a href="Feedback.md" target="_blank">portals/Feedback</a>|
|[owningUser](#owningUser)|Unique identifier of the user who owns this feedback.|<a href="Feedback.md" target="_blank">portals/Feedback</a>|
|[owningTeam](#owningTeam)|Unique identifier of the team that owns the feedback.|<a href="Feedback.md" target="_blank">portals/Feedback</a>|
|[closedBy](#closedBy)|Shows who closed the record.|<a href="Feedback.md" target="_blank">portals/Feedback</a>|
|[closedOn](#closedOn)|Shows the date and time when the record was closed. The date and time are displayed in the time zone selected in Microsoft Dynamics 365 options.|<a href="Feedback.md" target="_blank">portals/Feedback</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="Feedback.md" target="_blank">portals/Feedback</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="Feedback.md" target="_blank">portals/Feedback</a>|
|[transactionCurrencyId](#transactionCurrencyId)|Choose the local currency for the record to make sure budgets are reported in the correct currency.|<a href="Feedback.md" target="_blank">portals/Feedback</a>|
|[exchangeRate](#exchangeRate)|Shows the conversion rate of the record's currency. The exchange rate is used to convert all money fields in the record from the local currency to the system's default currency.|<a href="Feedback.md" target="_blank">portals/Feedback</a>|
|[title](#title)|Type a title for the feedback.|<a href="Feedback.md" target="_blank">portals/Feedback</a>|
|[createdByContact](#createdByContact)|Shows the contact who created the record.|<a href="Feedback.md" target="_blank">portals/Feedback</a>|
|[createdOnBehalfByContact](#createdOnBehalfByContact)|Shows the contact who created the record on behalf of another user.|<a href="Feedback.md" target="_blank">portals/Feedback</a>|
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Published To Web</td></tr><tr><td>description</td><td>Shows whether the feedback is approved for display.</td></tr><tr><td>dataFormat</td><td>15</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>adx_approved</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Shows whether the feedback is approved for display.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Author URL</td></tr><tr><td>description</td><td>The URL of the author’s home page/blog.</td></tr><tr><td>dataFormat</td><td>7</td></tr><tr><td>maximumLength</td><td>200</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>adx_authorurl</td></tr></table>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Author URL</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>The URL of the author’s home page/blog.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.nullable**  
The attribute value may be set to NULL.  

**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"adx_authorurl"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Email</td></tr><tr><td>description</td><td>Email of the contact who created the record.</td></tr><tr><td>dataFormat</td><td>7</td></tr><tr><td>maximumLength</td><td>100</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>adx_contactemail</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Email of the contact who created the record.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.nullable**  
The attribute value may be set to NULL.  

**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"adx_contactemail"</td><td>string</td><td></td></tr></table>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Username</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Username of the contact who created the record.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.nullable**  
The attribute value may be set to NULL.  

**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"adx_contactusername"</td><td>string</td><td></td></tr></table>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Created By Name (Contact)</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Name of the contact who created the record.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.nullable**  
The attribute value may be set to NULL.  

**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"adx_createdbycontact"</td><td>string</td><td></td></tr></table>
