...
- [/KnowledgeArticleViews.cdm.json/KnowledgeArticleViews](../../../../KnowledgeArticleViews.md "/core/applicationCommon/KnowledgeArticleViews.cdm.json/KnowledgeArticleViews")  
- /crmCommon/solutions/portals/KnowledgeArticleViews  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/applicationCommon<br>/KnowledgeArticleViews.cdm.json<br>/KnowledgeArticleViews/hasAttributes<br>/attributesAddedAtThisScope</td></tr><tr><td>/core/applicationCommon/foundationCommon<br>/crmCommon/solutions/portals<br>/KnowledgeArticleViews.cdm.json<br>/KnowledgeArticleViews/hasAttributes<br>/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>
...
|---|---|---|
|[knowledgeArticleViewsId](#knowledgeArticleViewsId)|Unique identifier of the Knowledge Article Views|<a href="KnowledgeArticleViews.md" target="_blank">portals/KnowledgeArticleViews</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="KnowledgeArticleViews.md" target="_blank">portals/KnowledgeArticleViews</a>|
|[transactionCurrencyId](#transactionCurrencyId)|Choose the local currency for the record to make sure budgets are reported in the correct currency.|<a href="KnowledgeArticleViews.md" target="_blank">portals/KnowledgeArticleViews</a>|
|[exchangeRate](#exchangeRate)|Shows the conversion rate of the record's currency. The exchange rate is used to convert all money fields in the record from the local currency to the system's default currency.|<a href="KnowledgeArticleViews.md" target="_blank">portals/KnowledgeArticleViews</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="KnowledgeArticleViews.md" target="_blank">portals/KnowledgeArticleViews</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="KnowledgeArticleViews.md" target="_blank">portals/KnowledgeArticleViews</a>|
|[versionNumber](#versionNumber)||<a href="KnowledgeArticleViews.md" target="_blank">portals/KnowledgeArticleViews</a>|
|[knowledgeArticleView](#knowledgeArticleView)|Number of Knowledge Article Views visited per day|<a href="KnowledgeArticleViews.md" target="_blank">portals/KnowledgeArticleViews</a>|
|[viewDate](#viewDate)|Information about the Day|<a href="KnowledgeArticleViews.md" target="_blank">portals/KnowledgeArticleViews</a>|
|[knowledgearticleId](#knowledgearticleId)|Choose the Knowledge Article.|<a href="KnowledgeArticleViews.md" target="_blank">portals/KnowledgeArticleViews</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="KnowledgeArticleViews.md" target="_blank">portals/KnowledgeArticleViews</a>|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="KnowledgeArticleViews.md" target="_blank">portals/KnowledgeArticleViews</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="KnowledgeArticleViews.md" target="_blank">portals/KnowledgeArticleViews</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="KnowledgeArticleViews.md" target="_blank">portals/KnowledgeArticleViews</a>|
|[modifiedOn](#modifiedOn)|Shows the date and time when the record was last updated. The date and time are displayed in the time zone selected in Microsoft Dynamics 365 options.|<a href="KnowledgeArticleViews.md" target="_blank">portals/KnowledgeArticleViews</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="KnowledgeArticleViews.md" target="_blank">portals/KnowledgeArticleViews</a>|
|[ownerId](#ownerId)|Owner Id|<a href="KnowledgeArticleViews.md" target="_blank">portals/KnowledgeArticleViews</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="KnowledgeArticleViews.md" target="_blank">portals/KnowledgeArticleViews</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier of the business unit that owns the knowledge article views.|<a href="KnowledgeArticleViews.md" target="_blank">portals/KnowledgeArticleViews</a>|
|[owningUser](#owningUser)|Unique identifier of the user who owns the knowledge article views.|<a href="KnowledgeArticleViews.md" target="_blank">portals/KnowledgeArticleViews</a>|
|[stateCode](#stateCode)|Status of the Knowledge Article Views|<a href="KnowledgeArticleViews.md" target="_blank">portals/KnowledgeArticleViews</a>|
|[stateCode_display](#stateCode_display)||<a href="KnowledgeArticleViews.md" target="_blank">portals/KnowledgeArticleViews</a>|
|[statusCode](#statusCode)|Reason for the status of the Knowledge Article Views|<a href="KnowledgeArticleViews.md" target="_blank">portals/KnowledgeArticleViews</a>|
|[statusCode_display](#statusCode_display)||<a href="KnowledgeArticleViews.md" target="_blank">portals/KnowledgeArticleViews</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="KnowledgeArticleViews.md" target="_blank">portals/KnowledgeArticleViews</a>|
|[location](#location)|Shows where the knowledge was used|<a href="KnowledgeArticleViews.md" target="_blank">portals/KnowledgeArticleViews</a>|
|[location_display](#location_display)||<a href="KnowledgeArticleViews.md" target="_blank">portals/KnowledgeArticleViews</a>|
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Knowledge Article View</td></tr><tr><td>en</td><td>View Count</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Domain name of the portal that is tracking knowledge article referrers.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.nullable**  
The attribute value may be set to NULL.  

**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"adx_domainname"</td><td>string</td><td></td></tr></table>
...
**is.dataFormat.integer**  
**does.haveDefault**  
An attribute has a default value  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>default</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Browse</td><td>1</td></tr><tr><td>en</td><td>Portal Search</td><td>2</td></tr><tr><td>en</td><td>External Search Engine</td><td>3</td></tr><tr><td>en</td><td>External Website</td><td>4</td></tr><tr><td>en</td><td>Portal Case Deflection Search</td><td>5</td></tr><tr><td>en</td><td>Direct Link</td><td>6</td></tr></table></td><td>any</td><td></td></tr></table>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Referrer</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Types of knowledge article referrers that will be tracked for a portal.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.nullable**  
The attribute value may be set to NULL.  

**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"adx_referrer"</td><td>string</td><td></td></tr></table>
...
**is.readOnly**  
**is.addedInSupportOf**  
<table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>inSupportOf</td><td>"referrer"</td><td>attributeName</td><td>output parameter naming the attribute that is being supported</td></tr></table>
