...
- **is.identifiedBy**  
  ...
  ```
  "CaseDeflection/hasAttributes/caseDeflectionId"
  ```
...
- **means.entityState**  
  ...
  ```
  "CaseDeflection/hasAttributes/stateCode"
  ```
