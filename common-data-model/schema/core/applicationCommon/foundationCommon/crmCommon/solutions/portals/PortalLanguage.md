...
- **is.identifiedBy**  
  ...
  ```
  "PortalLanguage/hasAttributes/portalLanguageId"
  ```
...
- **means.entityState**  
  ...
  ```
  "PortalLanguage/hasAttributes/stateCode"
  ```
