...
- **is.identifiedBy**  
  ...
  ```
  "ForumPost/hasAttributes/communityForumPostId"
  ```
...
- **means.entityState**  
  ...
  ```
  "ForumPost/hasAttributes/stateCode"
  ```
