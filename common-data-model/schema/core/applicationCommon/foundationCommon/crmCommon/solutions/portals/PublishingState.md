...
- **is.identifiedBy**  
  ...
  ```
  "PublishingState/hasAttributes/publishingStateId"
  ```
...
- **means.entityState**  
  ...
  ```
  "PublishingState/hasAttributes/stateCode"
  ```
