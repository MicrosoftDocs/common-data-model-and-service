...
- **is.identifiedBy**  
  ...
  ```
  "WebsiteLanguage/hasAttributes/websiteLanguageId"
  ```
...
- **means.entityState**  
  ...
  ```
  "WebsiteLanguage/hasAttributes/stateCode"
  ```
