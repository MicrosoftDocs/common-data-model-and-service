...
<a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/solutions/portals/ForumThreadType.cdm.json" target="_blank">Entity definition</a> on GitHub.  

## Instances

portals/ForumThreadType  

## Traits for Forum Thread Type
...
- **is.identifiedBy**  
  ...
  ```
  "ForumThreadType_/hasAttributes/forumThreadTypeId"
  ```
...
- **means.entityState**  
  ...
  ```
  "ForumThreadType_/hasAttributes/stateCode"
  ```
