...
Latest version (0.8.1)of the json entity definition is available on GitHub (<a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/solutions/portals/ForumThreadType.cdm.json" target="_blank">Link on GitHub</a>).  

### Instances

portals/ForumThreadType  

## Attributes - Summary

|Name|Description|First Included in Instance|
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|[portals/ForumThreadType](ForumThreadType.md)|
|[createdBy](#createdBy)|Shows who created the record.|[portals/ForumThreadType](ForumThreadType.md)|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|[portals/ForumThreadType](ForumThreadType.md)|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|[portals/ForumThreadType](ForumThreadType.md)|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|[portals/ForumThreadType](ForumThreadType.md)|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|[portals/ForumThreadType](ForumThreadType.md)|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|[portals/ForumThreadType](ForumThreadType.md)|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|[portals/ForumThreadType](ForumThreadType.md)|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|[portals/ForumThreadType](ForumThreadType.md)|
|[ownerId](#ownerId)|Owner Id|[portals/ForumThreadType](ForumThreadType.md)|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|[portals/ForumThreadType](ForumThreadType.md)|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|[portals/ForumThreadType](ForumThreadType.md)|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|[portals/ForumThreadType](ForumThreadType.md)|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|[portals/ForumThreadType](ForumThreadType.md)|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|[portals/ForumThreadType](ForumThreadType.md)|
|[versionNumber](#versionNumber)|Version Number|[portals/ForumThreadType](ForumThreadType.md)|
|[forumThreadTypeId](#forumThreadTypeId)|Shows the entity instances.|[portals/ForumThreadType](ForumThreadType.md)|
|[stateCode](#stateCode)|Status of the Forum Thread Type|[portals/ForumThreadType](ForumThreadType.md)|
|[stateCode_display](#stateCode_display)||[portals/ForumThreadType](ForumThreadType.md)|
|[statusCode](#statusCode)|Select the forum thread type's status.
|[portals/ForumThreadType](ForumThreadType.md)|
|[statusCode_display](#statusCode_display)||[portals/ForumThreadType](ForumThreadType.md)|
|[name](#name)|Shows the name of the custom entity.|[portals/ForumThreadType](ForumThreadType.md)|
|[allowsVoting](#allowsVoting)||[portals/ForumThreadType](ForumThreadType.md)|
|[displayOrder](#displayOrder)||[portals/ForumThreadType](ForumThreadType.md)|
|[isDefault](#isDefault)||[portals/ForumThreadType](ForumThreadType.md)|
|[requiresAnswer](#requiresAnswer)||[portals/ForumThreadType](ForumThreadType.md)|
|[websiteId](#websiteId)|Shows the Website associated with the forum thread type.|[portals/ForumThreadType](ForumThreadType.md)|

### Traits

<details>
<summary>List of traits for the Forum Thread Type entity are listed below.</summary>

- **is.CDM.entityVersion**  
  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>versionNumber</td><td>0.8.1</td><td>string</td><td>semantic version number of the entity</td></tr></table>

- **is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json/<br>cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json/<br>cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json/<br>cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json/<br>cdsVersionTracking</td></tr><tr><td>/core/applicationCommon/foundationCommon/<br>crmCommon/solutions/portals/ForumThreadType.cdm.json/ForumThreadType/hasAttributes/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

- **is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>"ForumThreadType_/hasAttributes/forumThreadTypeId"</td><td>attribute</td><td></td></tr></table>Definition:  
  ```
  "ForumThreadType/hasAttributes/forumThreadTypeId"
  ```


- **means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>"ForumThreadType_/hasAttributes/stateCode"</td><td>attribute</td><td></td></tr></table>Definition:  
  ```
  "ForumThreadType/hasAttributes/stateCode"
  ```


- **is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Forum Thread Type</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

- **is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>Adx_forumthreadtype</td><td>string</td><td></td></tr></table>
...
First included in: /core/applicationCommon/foundationCommon/crmCommon/solutions/portals/ForumThreadType.cdm.json/ForumThreadType  
...
<details>
<summary>List of traits for the forumThreadTypeId attribute are listed below.</summary>
...
- **is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>adx_forumthreadtypeid</td><td>string</td><td></td></tr></table>
...
- **is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the Forum Thread Type</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
- **is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Select the forum thread type's status.
</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<details>
<summary>List of traits for the allowsVoting attribute are listed below.</summary>
...
- **is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Allows Voting</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

- **is.nullable**  
The attribute value may be set to NULL.  

- **is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>adx_allowsvoting</td><td>string</td><td></td></tr></table>
...
<details>
<summary>List of traits for the requiresAnswer attribute are listed below.</summary>
...
- **is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Requires Answer</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

- **is.nullable**  
The attribute value may be set to NULL.  

- **is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>adx_requiresanswer</td><td>string</td><td></td></tr></table>
...
- **is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Shows the Website associated with the forum thread type.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
