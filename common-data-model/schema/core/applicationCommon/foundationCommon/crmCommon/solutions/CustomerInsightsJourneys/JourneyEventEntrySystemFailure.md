---
title: JourneyEventEntrySystemFailure in CustomerInsightsJourneys - Common Data Model | Microsoft Docs
description: Logged when a customer fails to enter the journey due to a system error
...
# JourneyEventEntrySystemFailure in CustomerInsightsJourneys

Logged when a customer fails to enter the journey due to a system error  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/CustomerInsightsJourneys/JourneyEventEntrySystemFailure.cdm.json" target="_blank">GitHub</a>.  
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Logged when a customer fails to enter the journey due to a system error</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[BusinessUnitId](#BusinessUnitId)|Unique identifier of the Business unit\.|<a href="JourneyEventEntrySystemFailure.md" target="_blank">CustomerInsightsJourneys/JourneyEventEntrySystemFailure</a>|
|[CustomerJourneyId](#CustomerJourneyId)| Unique identifier of the Customer journey|<a href="JourneyEventEntrySystemFailure.md" target="_blank">CustomerInsightsJourneys/JourneyEventEntrySystemFailure</a>|
|[DropoffId](#DropoffId)|Unique identifier for events that cause a person to leave the journey\.|<a href="JourneyEventEntrySystemFailure.md" target="_blank">CustomerInsightsJourneys/JourneyEventEntrySystemFailure</a>|
|[IdempotencyId](#IdempotencyId)|Idempotency ID defines uniqueness of an analytics event\.|<a href="JourneyEventEntrySystemFailure.md" target="_blank">CustomerInsightsJourneys/JourneyEventEntrySystemFailure</a>|
|[InteractionType](#InteractionType)|Type of the interaction\.|<a href="JourneyEventEntrySystemFailure.md" target="_blank">CustomerInsightsJourneys/JourneyEventEntrySystemFailure</a>|
|[InternalMarketingInteractionId](#InternalMarketingInteractionId)|Internal marketing interaction Id\.|<a href="JourneyEventEntrySystemFailure.md" target="_blank">CustomerInsightsJourneys/JourneyEventEntrySystemFailure</a>|
|[IsUnresolvedProfile](#IsUnresolvedProfile)||<a href="JourneyEventEntrySystemFailure.md" target="_blank">CustomerInsightsJourneys/JourneyEventEntrySystemFailure</a>|
|[JourneyActionId](#JourneyActionId)|GUID of the journey action step associated with this event\.|<a href="JourneyEventEntrySystemFailure.md" target="_blank">CustomerInsightsJourneys/JourneyEventEntrySystemFailure</a>|
|[JourneyRunId](#JourneyRunId)|Flow run ID of the Power Automate run instance associated with this event\.|<a href="JourneyEventEntrySystemFailure.md" target="_blank">CustomerInsightsJourneys/JourneyEventEntrySystemFailure</a>|
|[JourneyStatus](#JourneyStatus)|Describes the results of processing a person entering a journey\. Indicates if a person was allowed or blocked from starting the journey\.|<a href="JourneyEventEntrySystemFailure.md" target="_blank">CustomerInsightsJourneys/JourneyEventEntrySystemFailure</a>|
|[JourneyVersion](#JourneyVersion)|Version number of the journey\.|<a href="JourneyEventEntrySystemFailure.md" target="_blank">CustomerInsightsJourneys/JourneyEventEntrySystemFailure</a>|
|[MessageId](#MessageId)|Message ID|<a href="JourneyEventEntrySystemFailure.md" target="_blank">CustomerInsightsJourneys/JourneyEventEntrySystemFailure</a>|
|[MessageTemplateVersion](#MessageTemplateVersion)|Message template version|<a href="JourneyEventEntrySystemFailure.md" target="_blank">CustomerInsightsJourneys/JourneyEventEntrySystemFailure</a>|
|[OrganizationId](#OrganizationId)|Organization Id\.|<a href="JourneyEventEntrySystemFailure.md" target="_blank">CustomerInsightsJourneys/JourneyEventEntrySystemFailure</a>|
|[ProfileId](#ProfileId)|Unique identifier of the profile\.|<a href="JourneyEventEntrySystemFailure.md" target="_blank">CustomerInsightsJourneys/JourneyEventEntrySystemFailure</a>|
|[ProfileType](#ProfileType)|The profile type \(Contact, Lead or CI Profile\)|<a href="JourneyEventEntrySystemFailure.md" target="_blank">CustomerInsightsJourneys/JourneyEventEntrySystemFailure</a>|
|[Reason](#Reason)|Journey status reason|<a href="JourneyEventEntrySystemFailure.md" target="_blank">CustomerInsightsJourneys/JourneyEventEntrySystemFailure</a>|
