...
description: Triggered when we can’t fetch related record used in personalization query
...
Triggered when we can’t fetch related record used in personalization query  
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Triggered when we can’t fetch related record used in personalization query</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[AccountId](#AccountId)|Unique identifier of the Account\.|<a href="EmailBlockedMissingRelatedData.md" target="_blank">CustomerInsightsJourneys/EmailBlockedMissingRelatedData</a>|
|[ActivityExpiryTime](#ActivityExpiryTime)|Activity expiry time|<a href="EmailBlockedMissingRelatedData.md" target="_blank">CustomerInsightsJourneys/EmailBlockedMissingRelatedData</a>|
|[ActivityId](#ActivityId)|Activity ID|<a href="EmailBlockedMissingRelatedData.md" target="_blank">CustomerInsightsJourneys/EmailBlockedMissingRelatedData</a>|
|[BlockedReason](#BlockedReason)|Indicates the reason for email block\.|<a href="EmailBlockedMissingRelatedData.md" target="_blank">CustomerInsightsJourneys/EmailBlockedMissingRelatedData</a>|
|[BusinessUnitId](#BusinessUnitId)|Unique identifier of the Business unit\.|<a href="EmailBlockedMissingRelatedData.md" target="_blank">CustomerInsightsJourneys/EmailBlockedMissingRelatedData</a>|
|[Category](#Category)|Category|<a href="EmailBlockedMissingRelatedData.md" target="_blank">CustomerInsightsJourneys/EmailBlockedMissingRelatedData</a>|
|[ContactId](#ContactId)|Unique identifier of the Contact\.|<a href="EmailBlockedMissingRelatedData.md" target="_blank">CustomerInsightsJourneys/EmailBlockedMissingRelatedData</a>|
|[CustomerJourneyId](#CustomerJourneyId)| Unique identifier of the Customer journey|<a href="EmailBlockedMissingRelatedData.md" target="_blank">CustomerInsightsJourneys/EmailBlockedMissingRelatedData</a>|
|[CustomerJourneyIterationId](#CustomerJourneyIterationId)|Customer journey iteration ID|<a href="EmailBlockedMissingRelatedData.md" target="_blank">CustomerInsightsJourneys/EmailBlockedMissingRelatedData</a>|
|[Details](#Details)|Contains additional information regarding the reason of block\.|<a href="EmailBlockedMissingRelatedData.md" target="_blank">CustomerInsightsJourneys/EmailBlockedMissingRelatedData</a>|
|[EmailAddressUsed](#EmailAddressUsed)|The profile's email address\.|<a href="EmailBlockedMissingRelatedData.md" target="_blank">CustomerInsightsJourneys/EmailBlockedMissingRelatedData</a>|
|[IdempotencyId](#IdempotencyId)|Idempotency ID defines uniqueness of an analytics event\.|<a href="EmailBlockedMissingRelatedData.md" target="_blank">CustomerInsightsJourneys/EmailBlockedMissingRelatedData</a>|
|[InteractionType](#InteractionType)|Type of the interaction\.|<a href="EmailBlockedMissingRelatedData.md" target="_blank">CustomerInsightsJourneys/EmailBlockedMissingRelatedData</a>|
|[InternalMarketingInteractionId](#InternalMarketingInteractionId)|Internal marketing interaction Id\.|<a href="EmailBlockedMissingRelatedData.md" target="_blank">CustomerInsightsJourneys/EmailBlockedMissingRelatedData</a>|
...
|[JourneyActionId](#JourneyActionId)|GUID of the journey action step associated with this event\.|<a href="EmailBlockedMissingRelatedData.md" target="_blank">CustomerInsightsJourneys/EmailBlockedMissingRelatedData</a>|
|[JourneyRunId](#JourneyRunId)|Flow run ID of the Power Automate run instance associated with this event\.|<a href="EmailBlockedMissingRelatedData.md" target="_blank">CustomerInsightsJourneys/EmailBlockedMissingRelatedData</a>|
|[MessageId](#MessageId)|Message ID|<a href="EmailBlockedMissingRelatedData.md" target="_blank">CustomerInsightsJourneys/EmailBlockedMissingRelatedData</a>|
|[MessageTemplateVersion](#MessageTemplateVersion)|Message template version|<a href="EmailBlockedMissingRelatedData.md" target="_blank">CustomerInsightsJourneys/EmailBlockedMissingRelatedData</a>|
...
|[MissingData](#MissingData)|Missing data|<a href="EmailBlockedMissingRelatedData.md" target="_blank">CustomerInsightsJourneys/EmailBlockedMissingRelatedData</a>|
|[OrganizationId](#OrganizationId)|Organization Id\.|<a href="EmailBlockedMissingRelatedData.md" target="_blank">CustomerInsightsJourneys/EmailBlockedMissingRelatedData</a>|
|[ProfileId](#ProfileId)|Unique identifier of the profile\.|<a href="EmailBlockedMissingRelatedData.md" target="_blank">CustomerInsightsJourneys/EmailBlockedMissingRelatedData</a>|
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>description</td><td>Missing data</td></tr><tr><td>dataFormat</td><td>string</td></tr></table>
...
\*\*is\.localized\.describedAs\*\*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Missing data</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
