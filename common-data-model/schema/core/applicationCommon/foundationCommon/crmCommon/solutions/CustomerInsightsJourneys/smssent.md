---
title: SmsSent in CustomerInsightsJourneys - Common Data Model | Microsoft Docs
description: Generated when an SMS is successfully sent.
...
# SmsSent in CustomerInsightsJourneys

Generated when an SMS is successfully sent\.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/CustomerInsightsJourneys/SmsSent.cdm.json" target="_blank">GitHub</a>.  
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Generated when an SMS is successfully sent.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[BusinessUnitId](#BusinessUnitId)|Unique identifier of the Business unit\.|<a href="SmsSent.md" target="_blank">CustomerInsightsJourneys/SmsSent</a>|
|[ChannelEventName](#ChannelEventName)|Channel event name|<a href="SmsSent.md" target="_blank">CustomerInsightsJourneys/SmsSent</a>|
|[Country](#Country)|The three letter ISO code associated with the SMS recipient's country\.|<a href="SmsSent.md" target="_blank">CustomerInsightsJourneys/SmsSent</a>|
|[CustomerJourneyId](#CustomerJourneyId)| Unique identifier of the Customer journey|<a href="SmsSent.md" target="_blank">CustomerInsightsJourneys/SmsSent</a>|
|[Details](#Details)|Additional details|<a href="SmsSent.md" target="_blank">CustomerInsightsJourneys/SmsSent</a>|
|[IdempotencyId](#IdempotencyId)|Idempotency ID defines uniqueness of an analytics event\.|<a href="SmsSent.md" target="_blank">CustomerInsightsJourneys/SmsSent</a>|
|[InteractionType](#InteractionType)|Type of the interaction\.|<a href="SmsSent.md" target="_blank">CustomerInsightsJourneys/SmsSent</a>|
|[InternalMarketingInteractionId](#InternalMarketingInteractionId)|Internal marketing interaction Id\.|<a href="SmsSent.md" target="_blank">CustomerInsightsJourneys/SmsSent</a>|
|[IsUnresolvedProfile](#IsUnresolvedProfile)||<a href="SmsSent.md" target="_blank">CustomerInsightsJourneys/SmsSent</a>|
|[JourneyActionId](#JourneyActionId)|GUID of the journey action step associated with this event\.|<a href="SmsSent.md" target="_blank">CustomerInsightsJourneys/SmsSent</a>|
|[JourneyRunId](#JourneyRunId)|Flow run ID of the Power Automate run instance associated with this event\.|<a href="SmsSent.md" target="_blank">CustomerInsightsJourneys/SmsSent</a>|
|[MessageId](#MessageId)|Message ID|<a href="SmsSent.md" target="_blank">CustomerInsightsJourneys/SmsSent</a>|
|[MessageTemplateVersion](#MessageTemplateVersion)|Message template version|<a href="SmsSent.md" target="_blank">CustomerInsightsJourneys/SmsSent</a>|
|[OrganizationId](#OrganizationId)|Organization Id\.|<a href="SmsSent.md" target="_blank">CustomerInsightsJourneys/SmsSent</a>|
|[ProfileId](#ProfileId)|Unique identifier of the profile\.|<a href="SmsSent.md" target="_blank">CustomerInsightsJourneys/SmsSent</a>|
...
|[SmsId](#SmsId)|Unique identifier of the Sms entity|<a href="SmsSent.md" target="_blank">CustomerInsightsJourneys/SmsSent</a>|
