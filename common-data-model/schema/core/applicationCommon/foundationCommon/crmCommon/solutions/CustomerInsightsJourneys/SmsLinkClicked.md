---
title: SmsLinkClicked in CustomerInsightsJourneys - Common Data Model | Microsoft Docs
description: Triggered when an SMS link is clicked.
...
# SmsLinkClicked in CustomerInsightsJourneys

Triggered when an SMS link is clicked\.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/CustomerInsightsJourneys/SmsLinkClicked.cdm.json" target="_blank">GitHub</a>.  
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Triggered when an SMS link is clicked.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[BusinessUnitId](#BusinessUnitId)|Unique identifier of the Business unit\.|<a href="SmsLinkClicked.md" target="_blank">CustomerInsightsJourneys/SmsLinkClicked</a>|
|[ChannelEventName](#ChannelEventName)|Channel event name|<a href="SmsLinkClicked.md" target="_blank">CustomerInsightsJourneys/SmsLinkClicked</a>|
|[Country](#Country)|The three letter ISO code associated with the SMS recipient's country\.|<a href="SmsLinkClicked.md" target="_blank">CustomerInsightsJourneys/SmsLinkClicked</a>|
|[CustomerJourneyId](#CustomerJourneyId)| Unique identifier of the Customer journey|<a href="SmsLinkClicked.md" target="_blank">CustomerInsightsJourneys/SmsLinkClicked</a>|
|[IdempotencyId](#IdempotencyId)|Idempotency ID defines uniqueness of an analytics event\.|<a href="SmsLinkClicked.md" target="_blank">CustomerInsightsJourneys/SmsLinkClicked</a>|
|[InteractionType](#InteractionType)|Type of the interaction\.|<a href="SmsLinkClicked.md" target="_blank">CustomerInsightsJourneys/SmsLinkClicked</a>|
|[InternalMarketingInteractionId](#InternalMarketingInteractionId)|Internal marketing interaction Id\.|<a href="SmsLinkClicked.md" target="_blank">CustomerInsightsJourneys/SmsLinkClicked</a>|
|[IsUnresolvedProfile](#IsUnresolvedProfile)||<a href="SmsLinkClicked.md" target="_blank">CustomerInsightsJourneys/SmsLinkClicked</a>|
|[JourneyActionId](#JourneyActionId)|GUID of the journey action step associated with this event\.|<a href="SmsLinkClicked.md" target="_blank">CustomerInsightsJourneys/SmsLinkClicked</a>|
|[JourneyRunId](#JourneyRunId)|Flow run ID of the Power Automate run instance associated with this event\.|<a href="SmsLinkClicked.md" target="_blank">CustomerInsightsJourneys/SmsLinkClicked</a>|
|[LinkId](#LinkId)|Link ID|<a href="SmsLinkClicked.md" target="_blank">CustomerInsightsJourneys/SmsLinkClicked</a>|
|[LinkName](#LinkName)|This field is unused|<a href="SmsLinkClicked.md" target="_blank">CustomerInsightsJourneys/SmsLinkClicked</a>|
|[MessageId](#MessageId)|Message ID|<a href="SmsLinkClicked.md" target="_blank">CustomerInsightsJourneys/SmsLinkClicked</a>|
|[MessageTemplateVersion](#MessageTemplateVersion)|Message template version|<a href="SmsLinkClicked.md" target="_blank">CustomerInsightsJourneys/SmsLinkClicked</a>|
|[OrganizationId](#OrganizationId)|Organization Id\.|<a href="SmsLinkClicked.md" target="_blank">CustomerInsightsJourneys/SmsLinkClicked</a>|
|[OriginalContentLink](#OriginalContentLink)|Original content link|<a href="SmsLinkClicked.md" target="_blank">CustomerInsightsJourneys/SmsLinkClicked</a>|
|[ProfileId](#ProfileId)|Unique identifier of the profile\.|<a href="SmsLinkClicked.md" target="_blank">CustomerInsightsJourneys/SmsLinkClicked</a>|
|[ProfileType](#ProfileType)|The profile type \(Contact, Lead or CI Profile\)|<a href="SmsLinkClicked.md" target="_blank">CustomerInsightsJourneys/SmsLinkClicked</a>|
|[RecipientPhoneNumber](#RecipientPhoneNumber)|The recipient's phone number\.|<a href="SmsLinkClicked.md" target="_blank">CustomerInsightsJourneys/SmsLinkClicked</a>|
|[SmsId](#SmsId)|Unique identifier of the Sms entity|<a href="SmsLinkClicked.md" target="_blank">CustomerInsightsJourneys/SmsLinkClicked</a>|
|[SourceSystem](#SourceSystem)| Refers to the source system that generated the interaction\. Outbound marketing \(OBM\) is represented by value 1\. Any other value than 1 represents Real-time journeys \(RTJ\)\.|<a href="SmsLinkClicked.md" target="_blank">CustomerInsightsJourneys/SmsLinkClicked</a>|
|[TargetUrl](#TargetUrl)|Represents the actual URL that a user clicked, including any personalized elements\. It shows the specific webpage or destination the user was directed to after clicking\.|<a href="SmsLinkClicked.md" target="_blank">CustomerInsightsJourneys/SmsLinkClicked</a>|
|[Timestamp](#Timestamp)|Indicates the exact date and time when the interaction was emitted\.|<a href="SmsLinkClicked.md" target="_blank">CustomerInsightsJourneys/SmsLinkClicked</a>|
|[Version](#Version)|Interaction version\. Used for updating the interaction\.|<a href="SmsLinkClicked.md" target="_blank">CustomerInsightsJourneys/SmsLinkClicked</a>|

### <a href=#BusinessUnitId name="BusinessUnitId">BusinessUnitId</a>

Unique identifier of the Business unit\.  
First included in: CustomerInsightsJourneys/SmsLinkClicked \(this entity\)  
