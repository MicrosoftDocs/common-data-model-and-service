---
title: CustomerVoiceSuveyResponseSubmitted in CustomerInsightsJourneys - Common Data Model | Microsoft Docs
description: Generated when Customer Voice response is submitted
...
# CustomerVoiceSuveyResponseSubmitted in CustomerInsightsJourneys

Generated when Customer Voice response is submitted  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/CustomerInsightsJourneys/CustomerVoiceSuveyResponseSubmitted.cdm.json" target="_blank">GitHub</a>.  
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Generated when Customer Voice response is submitted</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[BusinessUnitId](#BusinessUnitId)|Unique identifier of the Business unit\.|<a href="CustomerVoiceSuveyResponseSubmitted.md" target="_blank">CustomerInsightsJourneys/CustomerVoiceSuveyResponseSubmitted</a>|
|[CustomerJourneyId](#CustomerJourneyId)| Unique identifier of the Customer journey|<a href="CustomerVoiceSuveyResponseSubmitted.md" target="_blank">CustomerInsightsJourneys/CustomerVoiceSuveyResponseSubmitted</a>|
|[IdempotencyId](#IdempotencyId)|Idempotency ID defines uniqueness of an analytics event\.|<a href="CustomerVoiceSuveyResponseSubmitted.md" target="_blank">CustomerInsightsJourneys/CustomerVoiceSuveyResponseSubmitted</a>|
|[InteractionType](#InteractionType)|Type of the interaction\.|<a href="CustomerVoiceSuveyResponseSubmitted.md" target="_blank">CustomerInsightsJourneys/CustomerVoiceSuveyResponseSubmitted</a>|
|[InternalMarketingInteractionId](#InternalMarketingInteractionId)|Internal marketing interaction Id\.|<a href="CustomerVoiceSuveyResponseSubmitted.md" target="_blank">CustomerInsightsJourneys/CustomerVoiceSuveyResponseSubmitted</a>|
|[IsUnresolvedProfile](#IsUnresolvedProfile)||<a href="CustomerVoiceSuveyResponseSubmitted.md" target="_blank">CustomerInsightsJourneys/CustomerVoiceSuveyResponseSubmitted</a>|
|[JourneyActionId](#JourneyActionId)|GUID of the journey action step associated with this event\.|<a href="CustomerVoiceSuveyResponseSubmitted.md" target="_blank">CustomerInsightsJourneys/CustomerVoiceSuveyResponseSubmitted</a>|
|[JourneyRunId](#JourneyRunId)|Flow run ID of the Power Automate run instance associated with this event\.|<a href="CustomerVoiceSuveyResponseSubmitted.md" target="_blank">CustomerInsightsJourneys/CustomerVoiceSuveyResponseSubmitted</a>|
|[JourneyVersion](#JourneyVersion)|Version number of the journey\.|<a href="CustomerVoiceSuveyResponseSubmitted.md" target="_blank">CustomerInsightsJourneys/CustomerVoiceSuveyResponseSubmitted</a>|
|[MessageId](#MessageId)|Message ID|<a href="CustomerVoiceSuveyResponseSubmitted.md" target="_blank">CustomerInsightsJourneys/CustomerVoiceSuveyResponseSubmitted</a>|
|[MessageTemplateVersion](#MessageTemplateVersion)|Message template version|<a href="CustomerVoiceSuveyResponseSubmitted.md" target="_blank">CustomerInsightsJourneys/CustomerVoiceSuveyResponseSubmitted</a>|
|[OrganizationId](#OrganizationId)|Organization Id\.|<a href="CustomerVoiceSuveyResponseSubmitted.md" target="_blank">CustomerInsightsJourneys/CustomerVoiceSuveyResponseSubmitted</a>|
|[ProfileId](#ProfileId)|Unique identifier of the profile\.|<a href="CustomerVoiceSuveyResponseSubmitted.md" target="_blank">CustomerInsightsJourneys/CustomerVoiceSuveyResponseSubmitted</a>|
|[ProfileType](#ProfileType)|The profile type \(Contact, Lead or CI Profile\)|<a href="CustomerVoiceSuveyResponseSubmitted.md" target="_blank">CustomerInsightsJourneys/CustomerVoiceSuveyResponseSubmitted</a>|
|[SourceSystem](#SourceSystem)| Refers to the source system that generated the interaction\. Outbound marketing \(OBM\) is represented by value 1\. Any other value than 1 represents Real-time journeys \(RTJ\)\.|<a href="CustomerVoiceSuveyResponseSubmitted.md" target="_blank">CustomerInsightsJourneys/CustomerVoiceSuveyResponseSubmitted</a>|
|[SurveyFormId](#SurveyFormId)|Survey form ID|<a href="CustomerVoiceSuveyResponseSubmitted.md" target="_blank">CustomerInsightsJourneys/CustomerVoiceSuveyResponseSubmitted</a>|
|[SurveyId](#SurveyId)|Survey ID|<a href="CustomerVoiceSuveyResponseSubmitted.md" target="_blank">CustomerInsightsJourneys/CustomerVoiceSuveyResponseSubmitted</a>|
|[SurveyInvite](#SurveyInvite)|Survey invite|<a href="CustomerVoiceSuveyResponseSubmitted.md" target="_blank">CustomerInsightsJourneys/CustomerVoiceSuveyResponseSubmitted</a>|
|[SurveyName](#SurveyName)|Survey name|<a href="CustomerVoiceSuveyResponseSubmitted.md" target="_blank">CustomerInsightsJourneys/CustomerVoiceSuveyResponseSubmitted</a>|
|[SurveyResponseId](#SurveyResponseId)|Survey response ID|<a href="CustomerVoiceSuveyResponseSubmitted.md" target="_blank">CustomerInsightsJourneys/CustomerVoiceSuveyResponseSubmitted</a>|
|[SurveyResponseName](#SurveyResponseName)|Survey response name|<a href="CustomerVoiceSuveyResponseSubmitted.md" target="_blank">CustomerInsightsJourneys/CustomerVoiceSuveyResponseSubmitted</a>|
|[Timestamp](#Timestamp)|Indicates the exact date and time when the interaction was emitted\.|<a href="CustomerVoiceSuveyResponseSubmitted.md" target="_blank">CustomerInsightsJourneys/CustomerVoiceSuveyResponseSubmitted</a>|
|[Version](#Version)|Interaction version\. Used for updating the interaction\.|<a href="CustomerVoiceSuveyResponseSubmitted.md" target="_blank">CustomerInsightsJourneys/CustomerVoiceSuveyResponseSubmitted</a>|

### <a href=#BusinessUnitId name="BusinessUnitId">BusinessUnitId</a>

Unique identifier of the Business unit\.  
First included in: CustomerInsightsJourneys/CustomerVoiceSuveyResponseSubmitted \(this entity\)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>description</td><td>Survey form ID</td></tr><tr><td>dataFormat</td><td>string</td></tr></table>

#### Traits

<details>
<summary>List of traits for the SurveyFormId attribute are listed below.</summary>
...
\*\*is\.localized\.describedAs\*\*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Survey form ID</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>description</td><td>Survey invite</td></tr><tr><td>dataFormat</td><td>string</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>description</td><td>Survey name</td></tr><tr><td>dataFormat</td><td>string</td></tr></table>

#### Traits

<details>
<summary>List of traits for the SurveyName attribute are listed below.</summary>
...
\*\*is\.localized\.describedAs\*\*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Survey name</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
### <a href=#SurveyResponseName name="SurveyResponseName">SurveyResponseName</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>description</td><td>Survey response name</td></tr><tr><td>dataFormat</td><td>string</td></tr></table>

#### Traits

<details>
<summary>List of traits for the SurveyResponseName attribute are listed below.</summary>
...
\*\*is\.localized\.describedAs\*\*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Survey response name</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
