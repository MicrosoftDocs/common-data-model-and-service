...
description: Triggered when an email contains flagged blacklisted links.
...
Triggered when an email contains flagged blocklisted links\.  
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Triggered when an email contains flagged blocklisted links.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|[ActivityExpiryTime](#ActivityExpiryTime)|Activity expiry time|<a href="EmailContainsBlacklistedLinks.md" target="_blank">CustomerInsightsJourneys/EmailContainsBlacklistedLinks</a>|
...
|[BlacklistedLink](#BlacklistedLink)|Blocklisted link|<a href="EmailContainsBlacklistedLinks.md" target="_blank">CustomerInsightsJourneys/EmailContainsBlacklistedLinks</a>|
|[BusinessUnitId](#BusinessUnitId)|Unique identifier of the Business unit\.|<a href="EmailContainsBlacklistedLinks.md" target="_blank">CustomerInsightsJourneys/EmailContainsBlacklistedLinks</a>|
...
|[CustomerJourneyId](#CustomerJourneyId)| Unique identifier of the Customer journey|<a href="EmailContainsBlacklistedLinks.md" target="_blank">CustomerInsightsJourneys/EmailContainsBlacklistedLinks</a>|
...
|[IdempotencyId](#IdempotencyId)|Idempotency ID defines uniqueness of an analytics event\.|<a href="EmailContainsBlacklistedLinks.md" target="_blank">CustomerInsightsJourneys/EmailContainsBlacklistedLinks</a>|
...
|[InternalMarketingInteractionId](#InternalMarketingInteractionId)|Internal marketing interaction Id\.|<a href="EmailContainsBlacklistedLinks.md" target="_blank">CustomerInsightsJourneys/EmailContainsBlacklistedLinks</a>|
|[LeadId](#LeadId)|Unique identifier of the Lead\.|<a href="EmailContainsBlacklistedLinks.md" target="_blank">CustomerInsightsJourneys/EmailContainsBlacklistedLinks</a>|
|[MessageId](#MessageId)|Message ID|<a href="EmailContainsBlacklistedLinks.md" target="_blank">CustomerInsightsJourneys/EmailContainsBlacklistedLinks</a>|
...
|[SendingId](#SendingId)|Indicates the journey iteration ID\.|<a href="EmailContainsBlacklistedLinks.md" target="_blank">CustomerInsightsJourneys/EmailContainsBlacklistedLinks</a>|
|[SourceSystem](#SourceSystem)| Refers to the source system that generated the interaction\. Outbound marketing \(OBM\) is represented by value 1\. Any other value than 1 represents Real-time journeys \(RTJ\)\.|<a href="EmailContainsBlacklistedLinks.md" target="_blank">CustomerInsightsJourneys/EmailContainsBlacklistedLinks</a>|
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>description</td><td>Blocklisted link</td></tr><tr><td>dataFormat</td><td>string</td></tr></table>
