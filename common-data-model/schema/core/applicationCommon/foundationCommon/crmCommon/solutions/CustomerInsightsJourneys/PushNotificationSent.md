...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Triggered when a push notification is sent.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|[PushNotificationId](#PushNotificationId)|Unique identifier of the Push notification entity|<a href="PushNotificationSent.md" target="_blank">CustomerInsightsJourneys/PushNotificationSent</a>|
