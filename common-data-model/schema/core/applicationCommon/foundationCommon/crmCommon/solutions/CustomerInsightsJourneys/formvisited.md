...
description: Generated when a contact or lead visits a tracked form page.
...
Generated when a contact or lead visits a tracked form page\.  
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Generated when a contact or lead visits a tracked form page.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[AccountId](#AccountId)|Unique identifier of the Account\.|<a href="FormVisited.md" target="_blank">CustomerInsightsJourneys/FormVisited</a>|
|[ActivityExpiryTime](#ActivityExpiryTime)|Activity expiry time|<a href="FormVisited.md" target="_blank">CustomerInsightsJourneys/FormVisited</a>|
|[ActivityId](#ActivityId)|Unique identifier of the Activity\.|<a href="FormVisited.md" target="_blank">CustomerInsightsJourneys/FormVisited</a>|
|[BrowserId](#BrowserId)|Browser ID|<a href="FormVisited.md" target="_blank">CustomerInsightsJourneys/FormVisited</a>|
|[BrowserVersion](#BrowserVersion)|Browser version|<a href="FormVisited.md" target="_blank">CustomerInsightsJourneys/FormVisited</a>|
|[BusinessUnitId](#BusinessUnitId)|Unique identifier of the Business unit\.|<a href="FormVisited.md" target="_blank">CustomerInsightsJourneys/FormVisited</a>|
|[City](#City)|City|<a href="FormVisited.md" target="_blank">CustomerInsightsJourneys/FormVisited</a>|
|[ContactId](#ContactId)|Unique identifier of the Contact\.|<a href="FormVisited.md" target="_blank">CustomerInsightsJourneys/FormVisited</a>|
|[CountryIsoCode](#CountryIsoCode)|Country ISO code|<a href="FormVisited.md" target="_blank">CustomerInsightsJourneys/FormVisited</a>|
|[CustomerJourneyId](#CustomerJourneyId)| Unique identifier of the Customer journey|<a href="FormVisited.md" target="_blank">CustomerInsightsJourneys/FormVisited</a>|
|[CustomerJourneyIterationId](#CustomerJourneyIterationId)|Customer journey iteration ID|<a href="FormVisited.md" target="_blank">CustomerInsightsJourneys/FormVisited</a>|
|[EmailAddressUsed](#EmailAddressUsed)|The profile's email address\.|<a href="FormVisited.md" target="_blank">CustomerInsightsJourneys/FormVisited</a>|
|[EmailDomain](#EmailDomain)|Email domain|<a href="FormVisited.md" target="_blank">CustomerInsightsJourneys/FormVisited</a>|
|[FormId](#FormId)|Form ID|<a href="FormVisited.md" target="_blank">CustomerInsightsJourneys/FormVisited</a>|
|[IdempotencyId](#IdempotencyId)|Idempotency ID defines uniqueness of an analytics event\.|<a href="FormVisited.md" target="_blank">CustomerInsightsJourneys/FormVisited</a>|
|[InteractionType](#InteractionType)|Type of the interaction\.|<a href="FormVisited.md" target="_blank">CustomerInsightsJourneys/FormVisited</a>|
|[InternalMarketingInteractionId](#InternalMarketingInteractionId)|Internal marketing interaction Id\.|<a href="FormVisited.md" target="_blank">CustomerInsightsJourneys/FormVisited</a>|
|[IsSmartScheduled](#IsSmartScheduled)||<a href="FormVisited.md" target="_blank">CustomerInsightsJourneys/FormVisited</a>|
|[IsUnresolvedProfile](#IsUnresolvedProfile)||<a href="FormVisited.md" target="_blank">CustomerInsightsJourneys/FormVisited</a>|
|[JourneyActionId](#JourneyActionId)|GUID of the journey action step associated with this event\.|<a href="FormVisited.md" target="_blank">CustomerInsightsJourneys/FormVisited</a>|
|[JourneyRunId](#JourneyRunId)|Flow run ID of the Power Automate run instance associated with this event\.|<a href="FormVisited.md" target="_blank">CustomerInsightsJourneys/FormVisited</a>|
|[JourneyVersion](#JourneyVersion)|Version number of the journey\.|<a href="FormVisited.md" target="_blank">CustomerInsightsJourneys/FormVisited</a>|
|[LeadId](#LeadId)|Unique identifier of the Lead\.|<a href="FormVisited.md" target="_blank">CustomerInsightsJourneys/FormVisited</a>|
|[MessageId](#MessageId)|Message ID|<a href="FormVisited.md" target="_blank">CustomerInsightsJourneys/FormVisited</a>|
|[MessageTemplateVersion](#MessageTemplateVersion)|Message template version|<a href="FormVisited.md" target="_blank">CustomerInsightsJourneys/FormVisited</a>|
|[OperatingSystemId](#OperatingSystemId)|Operating system ID|<a href="FormVisited.md" target="_blank">CustomerInsightsJourneys/FormVisited</a>|
|[OperatingSystemVersion](#OperatingSystemVersion)|Operating system version|<a href="FormVisited.md" target="_blank">CustomerInsightsJourneys/FormVisited</a>|
|[OrganizationId](#OrganizationId)|Organization Id\.|<a href="FormVisited.md" target="_blank">CustomerInsightsJourneys/FormVisited</a>|
|[PageId](#PageId)|Page ID|<a href="FormVisited.md" target="_blank">CustomerInsightsJourneys/FormVisited</a>|
|[PageUrl](#PageUrl)|Page URL|<a href="FormVisited.md" target="_blank">CustomerInsightsJourneys/FormVisited</a>|
|[PostalCode](#PostalCode)|Postal code|<a href="FormVisited.md" target="_blank">CustomerInsightsJourneys/FormVisited</a>|
|[ProfileId](#ProfileId)|Unique identifier of the profile\.|<a href="FormVisited.md" target="_blank">CustomerInsightsJourneys/FormVisited</a>|
|[ProfileType](#ProfileType)|The profile type \(Contact, Lead or CI Profile\)|<a href="FormVisited.md" target="_blank">CustomerInsightsJourneys/FormVisited</a>|
|[ReferrerUri](#ReferrerUri)|Referrer URL|<a href="FormVisited.md" target="_blank">CustomerInsightsJourneys/FormVisited</a>|
|[SchedulerId](#SchedulerId)||<a href="FormVisited.md" target="_blank">CustomerInsightsJourneys/FormVisited</a>|
|[SearchEngineName](#SearchEngineName)|Search engine name|<a href="FormVisited.md" target="_blank">CustomerInsightsJourneys/FormVisited</a>|
|[SearchPhrase](#SearchPhrase)|Search phrase|<a href="FormVisited.md" target="_blank">CustomerInsightsJourneys/FormVisited</a>|
|[SendingId](#SendingId)|Indicates the journey iteration ID\.|<a href="FormVisited.md" target="_blank">CustomerInsightsJourneys/FormVisited</a>|
|[SessionId](#SessionId)|Session ID|<a href="FormVisited.md" target="_blank">CustomerInsightsJourneys/FormVisited</a>|
|[SourceEntityId](#SourceEntityId)|Source entity ID|<a href="FormVisited.md" target="_blank">CustomerInsightsJourneys/FormVisited</a>|
|[SourceEntityName](#SourceEntityName)|Source entity name|<a href="FormVisited.md" target="_blank">CustomerInsightsJourneys/FormVisited</a>|
|[SourceSystem](#SourceSystem)| Refers to the source system that generated the interaction\. Outbound marketing \(OBM\) is represented by value 1\. Any other value than 1 represents Real-time journeys \(RTJ\)\.|<a href="FormVisited.md" target="_blank">CustomerInsightsJourneys/FormVisited</a>|
|[State](#State)|State|<a href="FormVisited.md" target="_blank">CustomerInsightsJourneys/FormVisited</a>|
|[Timestamp](#Timestamp)|Indicates the exact date and time when the interaction was emitted\.|<a href="FormVisited.md" target="_blank">CustomerInsightsJourneys/FormVisited</a>|
|[UsageType](#UsageType)|Usage type|<a href="FormVisited.md" target="_blank">CustomerInsightsJourneys/FormVisited</a>|
|[Version](#Version)|Interaction version\. Used for updating the interaction\.|<a href="FormVisited.md" target="_blank">CustomerInsightsJourneys/FormVisited</a>|
|[VisitDuration](#VisitDuration)|Visit duration|<a href="FormVisited.md" target="_blank">CustomerInsightsJourneys/FormVisited</a>|
|[VisitorAnonymousStatus](#VisitorAnonymousStatus)|Visitor anonymous status|<a href="FormVisited.md" target="_blank">CustomerInsightsJourneys/FormVisited</a>|
|[VisitorId](#VisitorId)|Visitor ID|<a href="FormVisited.md" target="_blank">CustomerInsightsJourneys/FormVisited</a>|
|[VisitorReturningStatus](#VisitorReturningStatus)|Visitor returning statusD|<a href="FormVisited.md" target="_blank">CustomerInsightsJourneys/FormVisited</a>|
|[WebsiteId](#WebsiteId)|Website ID|<a href="FormVisited.md" target="_blank">CustomerInsightsJourneys/FormVisited</a>|
...
Visitor returning statusD  
First included in: CustomerInsightsJourneys/FormVisited \(this entity\)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>description</td><td>Visitor returning statusD</td></tr><tr><td>dataFormat</td><td>string</td></tr></table>
...
\*\*is\.localized\.describedAs\*\*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Visitor returning statusD</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
