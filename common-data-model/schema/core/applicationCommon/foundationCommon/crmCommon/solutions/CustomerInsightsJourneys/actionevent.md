---
title: ActionEvent in Customer Insights Journeys - Common Data Model | Microsoft Docs
...
# ActionEvent in Customer Insights Journeys
...
|---|---|---|
|[ActionStatus](#ActionStatus)|Action status|<a href="actionevent.md" target="_blank">CustomerInsightsJourneys/actionevent</a>|
|[ParentActionId](#ParentActionId)|Parent action id|<a href="actionevent.md" target="_blank">CustomerInsightsJourneys/actionevent</a>|
...
|[JourneyActionId](#JourneyActionId)|Journey Action Id|<a href="actionevent.md" target="_blank">CustomerInsightsJourneys/actionevent</a>|
|[CustomerJourneyId](#CustomerJourneyId)| Unique identifier of the Customer journey|<a href="actionevent.md" target="_blank">CustomerInsightsJourneys/actionevent</a>|
|[BusinessUnitId](#BusinessUnitId)|Unique identifier of the Business unit.|<a href="actionevent.md" target="_blank">CustomerInsightsJourneys/actionevent</a>|
|[IdempotencyId](#IdempotencyId)|Idempotency ID defines uniqueness of an analytics event.|<a href="actionevent.md" target="_blank">CustomerInsightsJourneys/actionevent</a>|
|[InternalMarketingInteractionId](#InternalMarketingInteractionId)|Internal marketing interaction Id.|<a href="actionevent.md" target="_blank">CustomerInsightsJourneys/actionevent</a>|
...
|[SourceSystem](#SourceSystem)| Refers to the source system that generated the interaction. Outbound marketing (OBM) is represented by value 1. Any other value than 1 represents Real-time journeys (RTJ).|<a href="actionevent.md" target="_blank">CustomerInsightsJourneys/actionevent</a>|
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>description</td><td>Parent action id</td></tr><tr><td>dataFormat</td><td>string</td></tr></table>
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Parent action id</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
