---
title: EmailSoftBounced in CustomerInsightsJourneys - Common Data Model | Microsoft Docs
...
# EmailSoftBounced in CustomerInsightsJourneys

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/CustomerInsightsJourneys/EmailSoftBounced.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[AccountId](#AccountId)|Unique identifier of the Account\.|<a href="EmailSoftBounced.md" target="_blank">CustomerInsightsJourneys/EmailSoftBounced</a>|
|[ActivityExpiryTime](#ActivityExpiryTime)|Activity expiry time|<a href="EmailSoftBounced.md" target="_blank">CustomerInsightsJourneys/EmailSoftBounced</a>|
|[ActivityId](#ActivityId)|Activity ID|<a href="EmailSoftBounced.md" target="_blank">CustomerInsightsJourneys/EmailSoftBounced</a>|
|[BounceCategory](#BounceCategory)|Indicates the bounce category\.|<a href="EmailSoftBounced.md" target="_blank">CustomerInsightsJourneys/EmailSoftBounced</a>|
|[BounceReason](#BounceReason)|Bounce reason|<a href="EmailSoftBounced.md" target="_blank">CustomerInsightsJourneys/EmailSoftBounced</a>|
|[BounceType](#BounceType)|Indicates the bounce type \(soft bounce, hard bounce\)\.|<a href="EmailSoftBounced.md" target="_blank">CustomerInsightsJourneys/EmailSoftBounced</a>|
|[BusinessUnitId](#BusinessUnitId)|Unique identifier of the Business unit\.|<a href="EmailSoftBounced.md" target="_blank">CustomerInsightsJourneys/EmailSoftBounced</a>|
|[ContactId](#ContactId)|Unique identifier of the Contact\.|<a href="EmailSoftBounced.md" target="_blank">CustomerInsightsJourneys/EmailSoftBounced</a>|
|[CustomerJourneyId](#CustomerJourneyId)| Unique identifier of the Customer journey|<a href="EmailSoftBounced.md" target="_blank">CustomerInsightsJourneys/EmailSoftBounced</a>|
|[CustomerJourneyIterationId](#CustomerJourneyIterationId)|Unique identifier of the Account\.|<a href="EmailSoftBounced.md" target="_blank">CustomerInsightsJourneys/EmailSoftBounced</a>|
|[Details](#Details)|Details|<a href="EmailSoftBounced.md" target="_blank">CustomerInsightsJourneys/EmailSoftBounced</a>|
|[EmailAddressUsed](#EmailAddressUsed)|The profile's email address\.|<a href="EmailSoftBounced.md" target="_blank">CustomerInsightsJourneys/EmailSoftBounced</a>|
|[EmailDomain](#EmailDomain)|Email domain|<a href="EmailSoftBounced.md" target="_blank">CustomerInsightsJourneys/EmailSoftBounced</a>|
|[IdempotencyId](#IdempotencyId)|Idempotency ID defines uniqueness of an analytics event\.|<a href="EmailSoftBounced.md" target="_blank">CustomerInsightsJourneys/EmailSoftBounced</a>|
|[InteractionType](#InteractionType)|Type of the interaction\.|<a href="EmailSoftBounced.md" target="_blank">CustomerInsightsJourneys/EmailSoftBounced</a>|
|[InternalMarketingInteractionId](#InternalMarketingInteractionId)|Internal marketing interaction Id\.|<a href="EmailSoftBounced.md" target="_blank">CustomerInsightsJourneys/EmailSoftBounced</a>|
|[IsSmartScheduled](#IsSmartScheduled)||<a href="EmailSoftBounced.md" target="_blank">CustomerInsightsJourneys/EmailSoftBounced</a>|
|[IsUnresolvedProfile](#IsUnresolvedProfile)||<a href="EmailSoftBounced.md" target="_blank">CustomerInsightsJourneys/EmailSoftBounced</a>|
|[JourneyActionId](#JourneyActionId)|GUID of the journey action step associated with this event\.|<a href="EmailSoftBounced.md" target="_blank">CustomerInsightsJourneys/EmailSoftBounced</a>|
|[JourneyRunId](#JourneyRunId)|Flow run ID of the Power Automate run instance associated with this event\.|<a href="EmailSoftBounced.md" target="_blank">CustomerInsightsJourneys/EmailSoftBounced</a>|
|[MessageId](#MessageId)|Message ID|<a href="EmailSoftBounced.md" target="_blank">CustomerInsightsJourneys/EmailSoftBounced</a>|
|[MessageTemplateVersion](#MessageTemplateVersion)|Message template version|<a href="EmailSoftBounced.md" target="_blank">CustomerInsightsJourneys/EmailSoftBounced</a>|
|[MessageVariationIndexes](#MessageVariationIndexes)||<a href="EmailSoftBounced.md" target="_blank">CustomerInsightsJourneys/EmailSoftBounced</a>|
|[MessageVariationName](#MessageVariationName)||<a href="EmailSoftBounced.md" target="_blank">CustomerInsightsJourneys/EmailSoftBounced</a>|
|[OrganizationId](#OrganizationId)|Organization Id\.|<a href="EmailSoftBounced.md" target="_blank">CustomerInsightsJourneys/EmailSoftBounced</a>|
|[ProfileId](#ProfileId)|Unique identifier of the profile\.|<a href="EmailSoftBounced.md" target="_blank">CustomerInsightsJourneys/EmailSoftBounced</a>|
|[ProfileType](#ProfileType)|The profile type \(Contact, Lead or CI Profile\)|<a href="EmailSoftBounced.md" target="_blank">CustomerInsightsJourneys/EmailSoftBounced</a>|
|[RemoteBounce](#RemoteBounce)|Indicates if it is a remote bounce\.|<a href="EmailSoftBounced.md" target="_blank">CustomerInsightsJourneys/EmailSoftBounced</a>|
|[SchedulerId](#SchedulerId)||<a href="EmailSoftBounced.md" target="_blank">CustomerInsightsJourneys/EmailSoftBounced</a>|
|[SendingId](#SendingId)|Indicates the journey iteration ID\.|<a href="EmailSoftBounced.md" target="_blank">CustomerInsightsJourneys/EmailSoftBounced</a>|
|[SourceSystem](#SourceSystem)| Refers to the source system that generated the interaction\. Outbound marketing \(OBM\) is represented by value 1\. Any other value than 1 represents Real\x2dtime journeys \(RTJ\)\.|<a href="EmailSoftBounced.md" target="_blank">CustomerInsightsJourneys/EmailSoftBounced</a>|
|[Timestamp](#Timestamp)|Indicates the exact date and time when the interaction was emitted\.|<a href="EmailSoftBounced.md" target="_blank">CustomerInsightsJourneys/EmailSoftBounced</a>|
|[UsageType](#UsageType)|Usage type|<a href="EmailSoftBounced.md" target="_blank">CustomerInsightsJourneys/EmailSoftBounced</a>|
|[Version](#Version)|Interaction version\. Used for updating the interaction\.|<a href="EmailSoftBounced.md" target="_blank">CustomerInsightsJourneys/EmailSoftBounced</a>|
...
\*\*is\.dataFormat\.guid\*\*  
  \*\*means\.identity\.entityId\*\*  
  \*\*is\.linkedEntity\.identifier\*\*  
  Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="/MarketingSolution/CustomerJourneyIteration.md" target="_blank">/Marketing/MarketingSolution/CustomerJourneyIteration.cdm.json</a></td><td><a href="/MarketingSolution/CustomerJourneyIteration.md#customerJourneyIterationId" target="_blank">customerJourneyIterationId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
