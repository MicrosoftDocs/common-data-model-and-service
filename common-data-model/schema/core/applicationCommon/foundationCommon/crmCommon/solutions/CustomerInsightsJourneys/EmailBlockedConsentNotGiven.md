...
|---|---|---|
|[BlockedReason](#BlockedReason)|Indicates the reason for email block\.|<a href="EmailBlockedConsentNotGiven.md" target="_blank">CustomerInsightsJourneys/EmailBlockedConsentNotGiven</a>|
|[BusinessUnitId](#BusinessUnitId)|Unique identifier of the Business unit\.|<a href="EmailBlockedConsentNotGiven.md" target="_blank">CustomerInsightsJourneys/EmailBlockedConsentNotGiven</a>|
|[Category](#Category)|Category|<a href="EmailBlockedConsentNotGiven.md" target="_blank">CustomerInsightsJourneys/EmailBlockedConsentNotGiven</a>|
|[CustomerJourneyId](#CustomerJourneyId)| Unique identifier of the Customer journey|<a href="EmailBlockedConsentNotGiven.md" target="_blank">CustomerInsightsJourneys/EmailBlockedConsentNotGiven</a>|
|[Details](#Details)|Contains additional information regarding the reason of block\.|<a href="EmailBlockedConsentNotGiven.md" target="_blank">CustomerInsightsJourneys/EmailBlockedConsentNotGiven</a>|
|[EmailAddressUsed](#EmailAddressUsed)|The profile's email address\.|<a href="EmailBlockedConsentNotGiven.md" target="_blank">CustomerInsightsJourneys/EmailBlockedConsentNotGiven</a>|
|[IdempotencyId](#IdempotencyId)|Idempotency ID defines uniqueness of an analytics event\.|<a href="EmailBlockedConsentNotGiven.md" target="_blank">CustomerInsightsJourneys/EmailBlockedConsentNotGiven</a>|
|[InteractionType](#InteractionType)|Type of the interaction\.|<a href="EmailBlockedConsentNotGiven.md" target="_blank">CustomerInsightsJourneys/EmailBlockedConsentNotGiven</a>|
|[InternalMarketingInteractionId](#InternalMarketingInteractionId)|Internal marketing interaction Id\.|<a href="EmailBlockedConsentNotGiven.md" target="_blank">CustomerInsightsJourneys/EmailBlockedConsentNotGiven</a>|
...
|[JourneyActionId](#JourneyActionId)|GUID of the journey action step associated with this event\.|<a href="EmailBlockedConsentNotGiven.md" target="_blank">CustomerInsightsJourneys/EmailBlockedConsentNotGiven</a>|
|[JourneyRunId](#JourneyRunId)|Flow run ID of the Power Automate run instance associated with this event\.|<a href="EmailBlockedConsentNotGiven.md" target="_blank">CustomerInsightsJourneys/EmailBlockedConsentNotGiven</a>|
|[MessageId](#MessageId)|Message ID|<a href="EmailBlockedConsentNotGiven.md" target="_blank">CustomerInsightsJourneys/EmailBlockedConsentNotGiven</a>|
|[MessageTemplateVersion](#MessageTemplateVersion)|Message template version|<a href="EmailBlockedConsentNotGiven.md" target="_blank">CustomerInsightsJourneys/EmailBlockedConsentNotGiven</a>|
