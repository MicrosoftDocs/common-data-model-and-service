---
title: JourneyEventUndefined in CustomerInsightsJourneys - Common Data Model | Microsoft Docs
...
# JourneyEventUndefined in CustomerInsightsJourneys

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/CustomerInsightsJourneys/JourneyEventUndefined.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[BusinessUnitId](#BusinessUnitId)|Unique identifier of the Business unit\.|<a href="JourneyEventUndefined.md" target="_blank">CustomerInsightsJourneys/JourneyEventUndefined</a>|
|[CustomerJourneyId](#CustomerJourneyId)| Unique identifier of the Customer journey|<a href="JourneyEventUndefined.md" target="_blank">CustomerInsightsJourneys/JourneyEventUndefined</a>|
|[DropoffId](#DropoffId)|Unique identifier for events that cause a person to leave the journey\.|<a href="JourneyEventUndefined.md" target="_blank">CustomerInsightsJourneys/JourneyEventUndefined</a>|
|[IdempotencyId](#IdempotencyId)|Idempotency ID defines uniqueness of an analytics event\.|<a href="JourneyEventUndefined.md" target="_blank">CustomerInsightsJourneys/JourneyEventUndefined</a>|
|[InteractionType](#InteractionType)|Type of the interaction\.|<a href="JourneyEventUndefined.md" target="_blank">CustomerInsightsJourneys/JourneyEventUndefined</a>|
|[InternalMarketingInteractionId](#InternalMarketingInteractionId)|Internal marketing interaction Id\.|<a href="JourneyEventUndefined.md" target="_blank">CustomerInsightsJourneys/JourneyEventUndefined</a>|
|[IsUnresolvedProfile](#IsUnresolvedProfile)||<a href="JourneyEventUndefined.md" target="_blank">CustomerInsightsJourneys/JourneyEventUndefined</a>|
|[JourneyActionId](#JourneyActionId)|GUID of the journey action step associated with this event\.|<a href="JourneyEventUndefined.md" target="_blank">CustomerInsightsJourneys/JourneyEventUndefined</a>|
|[JourneyRunId](#JourneyRunId)|Flow run ID of the Power Automate run instance associated with this event\.|<a href="JourneyEventUndefined.md" target="_blank">CustomerInsightsJourneys/JourneyEventUndefined</a>|
|[JourneyStatus](#JourneyStatus)|Describes the results of processing a person entering a journey\. Indicates if a person was allowed or blocked from starting the journey\.|<a href="JourneyEventUndefined.md" target="_blank">CustomerInsightsJourneys/JourneyEventUndefined</a>|
|[JourneyVersion](#JourneyVersion)|Version number of the journey\.|<a href="JourneyEventUndefined.md" target="_blank">CustomerInsightsJourneys/JourneyEventUndefined</a>|
|[MessageId](#MessageId)|Message ID|<a href="JourneyEventUndefined.md" target="_blank">CustomerInsightsJourneys/JourneyEventUndefined</a>|
|[MessageTemplateVersion](#MessageTemplateVersion)|Message template version|<a href="JourneyEventUndefined.md" target="_blank">CustomerInsightsJourneys/JourneyEventUndefined</a>|
|[OrganizationId](#OrganizationId)|Organization Id\.|<a href="JourneyEventUndefined.md" target="_blank">CustomerInsightsJourneys/JourneyEventUndefined</a>|
|[ProfileId](#ProfileId)|Unique identifier of the profile\.|<a href="JourneyEventUndefined.md" target="_blank">CustomerInsightsJourneys/JourneyEventUndefined</a>|
|[ProfileType](#ProfileType)|The profile type \(Contact, Lead or CI Profile\)|<a href="JourneyEventUndefined.md" target="_blank">CustomerInsightsJourneys/JourneyEventUndefined</a>|
|[Reason](#Reason)|Journey status reason|<a href="JourneyEventUndefined.md" target="_blank">CustomerInsightsJourneys/JourneyEventUndefined</a>|
|[ReasonDetail](#ReasonDetail)|Provides additional information about the status of this event\.|<a href="JourneyEventUndefined.md" target="_blank">CustomerInsightsJourneys/JourneyEventUndefined</a>|
|[SegmentId](#SegmentId)|For segment based journeys, the GUID of the segment for this journey\.|<a href="JourneyEventUndefined.md" target="_blank">CustomerInsightsJourneys/JourneyEventUndefined</a>|
|[SegmentName](#SegmentName)|Segment name|<a href="JourneyEventUndefined.md" target="_blank">CustomerInsightsJourneys/JourneyEventUndefined</a>|
|[SourceSystem](#SourceSystem)| Refers to the source system that generated the interaction\. Outbound marketing \(OBM\) is represented by value 1\. Any other value than 1 represents Real\x2dtime journeys \(RTJ\)\.|<a href="JourneyEventUndefined.md" target="_blank">CustomerInsightsJourneys/JourneyEventUndefined</a>|
|[Timestamp](#Timestamp)|Indicates the exact date and time when the interaction was emitted\.|<a href="JourneyEventUndefined.md" target="_blank">CustomerInsightsJourneys/JourneyEventUndefined</a>|
|[Version](#Version)|Interaction version\. Used for updating the interaction\.|<a href="JourneyEventUndefined.md" target="_blank">CustomerInsightsJourneys/JourneyEventUndefined</a>|

### <a href=#BusinessUnitId name="BusinessUnitId">BusinessUnitId</a>

Unique identifier of the Business unit\.  
First included in: CustomerInsightsJourneys/JourneyEventUndefined \(this entity\)  
