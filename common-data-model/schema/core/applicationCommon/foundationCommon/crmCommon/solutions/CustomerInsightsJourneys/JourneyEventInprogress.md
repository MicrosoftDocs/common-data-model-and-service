---
title: JourneyEventInprogress in CustomerInsightsJourneys - Common Data Model | Microsoft Docs
...
# JourneyEventInprogress in CustomerInsightsJourneys

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/CustomerInsightsJourneys/JourneyEventInprogress.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[BusinessUnitId](#BusinessUnitId)|Unique identifier of the Business unit.|<a href="JourneyEventInprogress.md" target="_blank">CustomerInsightsJourneys/JourneyEventInprogress</a>|
|[CustomerJourneyId](#CustomerJourneyId)| Unique identifier of the Customer journey|<a href="JourneyEventInprogress.md" target="_blank">CustomerInsightsJourneys/JourneyEventInprogress</a>|
|[DropoffId](#DropoffId)|Unique identifier for events that cause a person to leave the journey.|<a href="JourneyEventInprogress.md" target="_blank">CustomerInsightsJourneys/JourneyEventInprogress</a>|
|[IdempotencyId](#IdempotencyId)|Idempotency ID defines uniqueness of an analytics event.|<a href="JourneyEventInprogress.md" target="_blank">CustomerInsightsJourneys/JourneyEventInprogress</a>|
|[InteractionType](#InteractionType)|Type of the interaction.|<a href="JourneyEventInprogress.md" target="_blank">CustomerInsightsJourneys/JourneyEventInprogress</a>|
|[InternalMarketingInteractionId](#InternalMarketingInteractionId)|Internal marketing interaction Id.|<a href="JourneyEventInprogress.md" target="_blank">CustomerInsightsJourneys/JourneyEventInprogress</a>|
|[IsUnresolvedProfile](#IsUnresolvedProfile)||<a href="JourneyEventInprogress.md" target="_blank">CustomerInsightsJourneys/JourneyEventInprogress</a>|
|[JourneyActionId](#JourneyActionId)|GUID of the journey action step associated with this event.|<a href="JourneyEventInprogress.md" target="_blank">CustomerInsightsJourneys/JourneyEventInprogress</a>|
|[JourneyRunId](#JourneyRunId)|Flow run ID of the Power Automate run instance associated with this event.|<a href="JourneyEventInprogress.md" target="_blank">CustomerInsightsJourneys/JourneyEventInprogress</a>|
|[JourneyStatus](#JourneyStatus)|Describes the results of processing a person entering a journey. Indicates if a person was allowed or blocked from starting the journey.|<a href="JourneyEventInprogress.md" target="_blank">CustomerInsightsJourneys/JourneyEventInprogress</a>|
|[JourneyVersion](#JourneyVersion)|Version number of the journey.|<a href="JourneyEventInprogress.md" target="_blank">CustomerInsightsJourneys/JourneyEventInprogress</a>|
|[MessageId](#MessageId)|Message ID|<a href="JourneyEventInprogress.md" target="_blank">CustomerInsightsJourneys/JourneyEventInprogress</a>|
|[MessageTemplateVersion](#MessageTemplateVersion)|Message template version|<a href="JourneyEventInprogress.md" target="_blank">CustomerInsightsJourneys/JourneyEventInprogress</a>|
|[OrganizationId](#OrganizationId)|Organization Id.|<a href="JourneyEventInprogress.md" target="_blank">CustomerInsightsJourneys/JourneyEventInprogress</a>|
|[ProfileId](#ProfileId)|Unique identifier of the profile.|<a href="JourneyEventInprogress.md" target="_blank">CustomerInsightsJourneys/JourneyEventInprogress</a>|
|[ProfileType](#ProfileType)|The profile type \(Contact, Lead or CI Profile\)|<a href="JourneyEventInprogress.md" target="_blank">CustomerInsightsJourneys/JourneyEventInprogress</a>|
|[Reason](#Reason)|Journey status reason|<a href="JourneyEventInprogress.md" target="_blank">CustomerInsightsJourneys/JourneyEventInprogress</a>|
|[ReasonDetail](#ReasonDetail)|Provides additional information about the status of this event.|<a href="JourneyEventInprogress.md" target="_blank">CustomerInsightsJourneys/JourneyEventInprogress</a>|
|[SegmentId](#SegmentId)|For segment based journeys, the GUID of the segment for this journey.|<a href="JourneyEventInprogress.md" target="_blank">CustomerInsightsJourneys/JourneyEventInprogress</a>|
|[SegmentName](#SegmentName)|Segment name|<a href="JourneyEventInprogress.md" target="_blank">CustomerInsightsJourneys/JourneyEventInprogress</a>|
|[SourceSystem](#SourceSystem)| Refers to the source system that generated the interaction. Outbound marketing \(OBM\) is represented by value 1. Any other value than 1 represents Real\x2dtime journeys \(RTJ\).|<a href="JourneyEventInprogress.md" target="_blank">CustomerInsightsJourneys/JourneyEventInprogress</a>|
|[Timestamp](#Timestamp)|Indicates the exact date and time when the interaction was emitted.|<a href="JourneyEventInprogress.md" target="_blank">CustomerInsightsJourneys/JourneyEventInprogress</a>|
|[Version](#Version)|Interaction version. Used for updating the interaction.|<a href="JourneyEventInprogress.md" target="_blank">CustomerInsightsJourneys/JourneyEventInprogress</a>|

### <a href=#BusinessUnitId name="BusinessUnitId">BusinessUnitId</a>

Unique identifier of the Business unit.  
First included in: CustomerInsightsJourneys/JourneyEventInprogress \(this entity\)  
...
<details>
<summary>List of traits for the DropoffId attribute are listed below.</summary>
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Unique identifier for events that cause a person to leave the journey.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<details>
<summary>List of traits for the JourneyStatus attribute are listed below.</summary>
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Describes the results of processing a person entering a journey. Indicates if a person was allowed or blocked from starting the journey.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.dataFormat.guid**  
  **is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>For segment based journeys, the GUID of the segment for this journey.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Segment name</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
