---
title: EmailBlockedInvalidSenderAddress in CustomerInsightsJourneys - Common Data Model | Microsoft Docs
...
# EmailBlockedInvalidSenderAddress in CustomerInsightsJourneys

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/CustomerInsightsJourneys/EmailBlockedInvalidSenderAddress.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[BlockedReason](#BlockedReason)|Indicates the reason for email block.|<a href="EmailBlockedInvalidSenderAddress.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInvalidSenderAddress</a>|
|[BusinessUnitId](#BusinessUnitId)|Unique identifier of the Business unit.|<a href="EmailBlockedInvalidSenderAddress.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInvalidSenderAddress</a>|
|[Category](#Category)|Category|<a href="EmailBlockedInvalidSenderAddress.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInvalidSenderAddress</a>|
|[CustomerJourneyId](#CustomerJourneyId)| Unique identifier of the Customer journey|<a href="EmailBlockedInvalidSenderAddress.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInvalidSenderAddress</a>|
|[Details](#Details)|Contains additional information regarding the reason of block.|<a href="EmailBlockedInvalidSenderAddress.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInvalidSenderAddress</a>|
|[EmailAddressUsed](#EmailAddressUsed)|The profile's email address.|<a href="EmailBlockedInvalidSenderAddress.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInvalidSenderAddress</a>|
|[IdempotencyId](#IdempotencyId)|Idempotency ID defines uniqueness of an analytics event.|<a href="EmailBlockedInvalidSenderAddress.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInvalidSenderAddress</a>|
|[InteractionType](#InteractionType)|Type of the interaction.|<a href="EmailBlockedInvalidSenderAddress.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInvalidSenderAddress</a>|
|[InternalMarketingInteractionId](#InternalMarketingInteractionId)|Internal marketing interaction Id.|<a href="EmailBlockedInvalidSenderAddress.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInvalidSenderAddress</a>|
|[IsUnresolvedProfile](#IsUnresolvedProfile)||<a href="EmailBlockedInvalidSenderAddress.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInvalidSenderAddress</a>|
|[JourneyActionId](#JourneyActionId)|GUID of the journey action step associated with this event.|<a href="EmailBlockedInvalidSenderAddress.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInvalidSenderAddress</a>|
|[JourneyRunId](#JourneyRunId)|Flow run ID of the Power Automate run instance associated with this event.|<a href="EmailBlockedInvalidSenderAddress.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInvalidSenderAddress</a>|
|[MessageId](#MessageId)|Message ID|<a href="EmailBlockedInvalidSenderAddress.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInvalidSenderAddress</a>|
|[MessageTemplateVersion](#MessageTemplateVersion)|Message template version|<a href="EmailBlockedInvalidSenderAddress.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInvalidSenderAddress</a>|
|[MessageVariationIndexes](#MessageVariationIndexes)||<a href="EmailBlockedInvalidSenderAddress.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInvalidSenderAddress</a>|
|[MessageVariationName](#MessageVariationName)||<a href="EmailBlockedInvalidSenderAddress.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInvalidSenderAddress</a>|
|[OrganizationId](#OrganizationId)|Organization Id.|<a href="EmailBlockedInvalidSenderAddress.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInvalidSenderAddress</a>|
|[ProfileId](#ProfileId)|Unique identifier of the profile.|<a href="EmailBlockedInvalidSenderAddress.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInvalidSenderAddress</a>|
|[ProfileType](#ProfileType)|The profile type \(Contact, Lead or CI Profile\)|<a href="EmailBlockedInvalidSenderAddress.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInvalidSenderAddress</a>|
|[SourceSystem](#SourceSystem)| Refers to the source system that generated the interaction. Outbound marketing \(OBM\) is represented by value 1. Any other value than 1 represents Real\x2dtime journeys \(RTJ\).|<a href="EmailBlockedInvalidSenderAddress.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInvalidSenderAddress</a>|
|[Timestamp](#Timestamp)|Indicates the exact date and time when the interaction was emitted.|<a href="EmailBlockedInvalidSenderAddress.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInvalidSenderAddress</a>|
|[Version](#Version)|Interaction version. Used for updating the interaction.|<a href="EmailBlockedInvalidSenderAddress.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInvalidSenderAddress</a>|
