---
title: VoiceCallBlocked in CustomerInsightsJourneys - Common Data Model | Microsoft Docs
description: Triggered when CIJ blocks sending a request to Contact Center to make a phone call
...
# VoiceCallBlocked in CustomerInsightsJourneys

Triggered when CIJ blocks sending a request to Contact Center to make a phone call  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/CustomerInsightsJourneys/VoiceCallBlocked.cdm.json" target="_blank">GitHub</a>.  
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Triggered when CIJ blocks sending a request to Contact Center to make a phone call</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[BusinessUnitId](#BusinessUnitId)|Unique identifier of the Business unit\.|<a href="VoiceCallBlocked.md" target="_blank">CustomerInsightsJourneys/VoiceCallBlocked</a>|
|[CustomerJourneyId](#CustomerJourneyId)| Unique identifier of the Customer journey|<a href="VoiceCallBlocked.md" target="_blank">CustomerInsightsJourneys/VoiceCallBlocked</a>|
|[Details](#Details)|Additional details|<a href="VoiceCallBlocked.md" target="_blank">CustomerInsightsJourneys/VoiceCallBlocked</a>|
|[IdempotencyId](#IdempotencyId)|Idempotency ID defines uniqueness of an analytics event\.|<a href="VoiceCallBlocked.md" target="_blank">CustomerInsightsJourneys/VoiceCallBlocked</a>|
|[InteractionType](#InteractionType)|Type of the interaction\.|<a href="VoiceCallBlocked.md" target="_blank">CustomerInsightsJourneys/VoiceCallBlocked</a>|
|[InternalMarketingInteractionId](#InternalMarketingInteractionId)|Internal marketing interaction Id\.|<a href="VoiceCallBlocked.md" target="_blank">CustomerInsightsJourneys/VoiceCallBlocked</a>|
|[IsUnresolvedProfile](#IsUnresolvedProfile)||<a href="VoiceCallBlocked.md" target="_blank">CustomerInsightsJourneys/VoiceCallBlocked</a>|
|[JourneyActionId](#JourneyActionId)|GUID of the journey action step associated with this event\.|<a href="VoiceCallBlocked.md" target="_blank">CustomerInsightsJourneys/VoiceCallBlocked</a>|
|[JourneyRunId](#JourneyRunId)|Flow run ID of the Power Automate run instance associated with this event\.|<a href="VoiceCallBlocked.md" target="_blank">CustomerInsightsJourneys/VoiceCallBlocked</a>|
|[MessageId](#MessageId)|Message ID|<a href="VoiceCallBlocked.md" target="_blank">CustomerInsightsJourneys/VoiceCallBlocked</a>|
|[MessageTemplateVersion](#MessageTemplateVersion)|Message template version|<a href="VoiceCallBlocked.md" target="_blank">CustomerInsightsJourneys/VoiceCallBlocked</a>|
|[OrganizationId](#OrganizationId)|Organization Id\.|<a href="VoiceCallBlocked.md" target="_blank">CustomerInsightsJourneys/VoiceCallBlocked</a>|
|[ProactiveEngagementConfigId](#ProactiveEngagementConfigId)|The ID of proactive engagement entity|<a href="VoiceCallBlocked.md" target="_blank">CustomerInsightsJourneys/VoiceCallBlocked</a>|
|[ProfileId](#ProfileId)|Unique identifier of the profile\.|<a href="VoiceCallBlocked.md" target="_blank">CustomerInsightsJourneys/VoiceCallBlocked</a>|
|[ProfileType](#ProfileType)|The profile type \(Contact, Lead or CI Profile\)|<a href="VoiceCallBlocked.md" target="_blank">CustomerInsightsJourneys/VoiceCallBlocked</a>|
|[Reason](#Reason)|Failure reason codes with a root cause of the failure|<a href="VoiceCallBlocked.md" target="_blank">CustomerInsightsJourneys/VoiceCallBlocked</a>|
|[RecipientPhoneNumber](#RecipientPhoneNumber)|The recipient's phone number\.|<a href="VoiceCallBlocked.md" target="_blank">CustomerInsightsJourneys/VoiceCallBlocked</a>|
|[SourceSystem](#SourceSystem)| Refers to the source system that generated the interaction\. Outbound marketing \(OBM\) is represented by value 1\. Any other value than 1 represents Real-time journeys \(RTJ\)\.|<a href="VoiceCallBlocked.md" target="_blank">CustomerInsightsJourneys/VoiceCallBlocked</a>|
|[Timestamp](#Timestamp)|Indicates the exact date and time when the interaction was emitted\.|<a href="VoiceCallBlocked.md" target="_blank">CustomerInsightsJourneys/VoiceCallBlocked</a>|
|[Version](#Version)|Interaction version\. Used for updating the interaction\.|<a href="VoiceCallBlocked.md" target="_blank">CustomerInsightsJourneys/VoiceCallBlocked</a>|

### <a href=#BusinessUnitId name="BusinessUnitId">BusinessUnitId</a>

Unique identifier of the Business unit\.  
First included in: CustomerInsightsJourneys/VoiceCallBlocked \(this entity\)  
