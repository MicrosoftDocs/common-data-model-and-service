---
title: VoiceCallSent in CustomerInsightsJourneys - Common Data Model | Microsoft Docs
description: Triggered when CIJ send a request to Contact Center to make a phone call
...
# VoiceCallSent in CustomerInsightsJourneys

Triggered when CIJ send a request to Contact Center to make a phone call  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/CustomerInsightsJourneys/VoiceCallSent.cdm.json" target="_blank">GitHub</a>.  
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Triggered when CIJ send a request to Contact Center to make a phone call</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[BusinessUnitId](#BusinessUnitId)|Unique identifier of the Business unit\.|<a href="VoiceCallSent.md" target="_blank">CustomerInsightsJourneys/VoiceCallSent</a>|
|[CustomerJourneyId](#CustomerJourneyId)| Unique identifier of the Customer journey|<a href="VoiceCallSent.md" target="_blank">CustomerInsightsJourneys/VoiceCallSent</a>|
|[Details](#Details)|Additional details|<a href="VoiceCallSent.md" target="_blank">CustomerInsightsJourneys/VoiceCallSent</a>|
|[IdempotencyId](#IdempotencyId)|Idempotency ID defines uniqueness of an analytics event\.|<a href="VoiceCallSent.md" target="_blank">CustomerInsightsJourneys/VoiceCallSent</a>|
|[InteractionType](#InteractionType)|Type of the interaction\.|<a href="VoiceCallSent.md" target="_blank">CustomerInsightsJourneys/VoiceCallSent</a>|
|[InternalMarketingInteractionId](#InternalMarketingInteractionId)|Internal marketing interaction Id\.|<a href="VoiceCallSent.md" target="_blank">CustomerInsightsJourneys/VoiceCallSent</a>|
|[IsUnresolvedProfile](#IsUnresolvedProfile)||<a href="VoiceCallSent.md" target="_blank">CustomerInsightsJourneys/VoiceCallSent</a>|
|[JourneyActionId](#JourneyActionId)|GUID of the journey action step associated with this event\.|<a href="VoiceCallSent.md" target="_blank">CustomerInsightsJourneys/VoiceCallSent</a>|
|[JourneyRunId](#JourneyRunId)|Flow run ID of the Power Automate run instance associated with this event\.|<a href="VoiceCallSent.md" target="_blank">CustomerInsightsJourneys/VoiceCallSent</a>|
|[MessageId](#MessageId)|Message ID|<a href="VoiceCallSent.md" target="_blank">CustomerInsightsJourneys/VoiceCallSent</a>|
|[MessageTemplateVersion](#MessageTemplateVersion)|Message template version|<a href="VoiceCallSent.md" target="_blank">CustomerInsightsJourneys/VoiceCallSent</a>|
|[OrganizationId](#OrganizationId)|Organization Id\.|<a href="VoiceCallSent.md" target="_blank">CustomerInsightsJourneys/VoiceCallSent</a>|
|[ProactiveEngagementConfigId](#ProactiveEngagementConfigId)|The ID of proactive engagement entity|<a href="VoiceCallSent.md" target="_blank">CustomerInsightsJourneys/VoiceCallSent</a>|
