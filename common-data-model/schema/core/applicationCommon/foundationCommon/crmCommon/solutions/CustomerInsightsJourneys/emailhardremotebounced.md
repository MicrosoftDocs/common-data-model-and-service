---
title: EmailHardRemoteBounced in CustomerInsightsJourneys - Common Data Model | Microsoft Docs
...
# EmailHardRemoteBounced in CustomerInsightsJourneys

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/CustomerInsightsJourneys/EmailHardRemoteBounced.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[AccountId](#AccountId)|Unique identifier of the Account\.|<a href="EmailHardRemoteBounced.md" target="_blank">CustomerInsightsJourneys/EmailHardRemoteBounced</a>|
|[ActivityExpiryTime](#ActivityExpiryTime)|Activity expiry time|<a href="EmailHardRemoteBounced.md" target="_blank">CustomerInsightsJourneys/EmailHardRemoteBounced</a>|
|[ActivityId](#ActivityId)|Unique identifier of the Activity\.|<a href="EmailHardRemoteBounced.md" target="_blank">CustomerInsightsJourneys/EmailHardRemoteBounced</a>|
|[BounceCategory](#BounceCategory)|Indicates the bounce category\.|<a href="EmailHardRemoteBounced.md" target="_blank">CustomerInsightsJourneys/EmailHardRemoteBounced</a>|
|[BounceReason](#BounceReason)|Indicates if it is a remote bounce\.|<a href="EmailHardRemoteBounced.md" target="_blank">CustomerInsightsJourneys/EmailHardRemoteBounced</a>|
|[BusinessUnitId](#BusinessUnitId)|Unique identifier of the Business unit\.|<a href="EmailHardRemoteBounced.md" target="_blank">CustomerInsightsJourneys/EmailHardRemoteBounced</a>|
|[ContactId](#ContactId)|Unique identifier of the Contact\.|<a href="EmailHardRemoteBounced.md" target="_blank">CustomerInsightsJourneys/EmailHardRemoteBounced</a>|
|[CustomerJourneyId](#CustomerJourneyId)| Unique identifier of the Customer journey|<a href="EmailHardRemoteBounced.md" target="_blank">CustomerInsightsJourneys/EmailHardRemoteBounced</a>|
|[CustomerJourneyIterationId](#CustomerJourneyIterationId)|Customer journey iteration ID|<a href="EmailHardRemoteBounced.md" target="_blank">CustomerInsightsJourneys/EmailHardRemoteBounced</a>|
|[EmailAddressUsed](#EmailAddressUsed)|The profile's email address\.|<a href="EmailHardRemoteBounced.md" target="_blank">CustomerInsightsJourneys/EmailHardRemoteBounced</a>|
|[EmailDomain](#EmailDomain)|Email domain|<a href="EmailHardRemoteBounced.md" target="_blank">CustomerInsightsJourneys/EmailHardRemoteBounced</a>|
|[IdempotencyId](#IdempotencyId)|Idempotency ID defines uniqueness of an analytics event\.|<a href="EmailHardRemoteBounced.md" target="_blank">CustomerInsightsJourneys/EmailHardRemoteBounced</a>|
|[InteractionType](#InteractionType)|Type of the interaction\.|<a href="EmailHardRemoteBounced.md" target="_blank">CustomerInsightsJourneys/EmailHardRemoteBounced</a>|
|[InternalMarketingInteractionId](#InternalMarketingInteractionId)|Internal marketing interaction Id\.|<a href="EmailHardRemoteBounced.md" target="_blank">CustomerInsightsJourneys/EmailHardRemoteBounced</a>|
|[LeadId](#LeadId)|Unique identifier of the Lead\.|<a href="EmailHardRemoteBounced.md" target="_blank">CustomerInsightsJourneys/EmailHardRemoteBounced</a>|
|[MessageId](#MessageId)|Message ID|<a href="EmailHardRemoteBounced.md" target="_blank">CustomerInsightsJourneys/EmailHardRemoteBounced</a>|
|[OrganizationId](#OrganizationId)|Organization Id\.|<a href="EmailHardRemoteBounced.md" target="_blank">CustomerInsightsJourneys/EmailHardRemoteBounced</a>|
|[ProfileId](#ProfileId)|Unique identifier of the profile\.|<a href="EmailHardRemoteBounced.md" target="_blank">CustomerInsightsJourneys/EmailHardRemoteBounced</a>|
|[ProfileType](#ProfileType)|The profile type \(Contact, Lead or CI Profile\)|<a href="EmailHardRemoteBounced.md" target="_blank">CustomerInsightsJourneys/EmailHardRemoteBounced</a>|
|[RemoteBounce](#RemoteBounce)|Remote bounce|<a href="EmailHardRemoteBounced.md" target="_blank">CustomerInsightsJourneys/EmailHardRemoteBounced</a>|
|[SendingId](#SendingId)|Indicates the journey iteration ID\.|<a href="EmailHardRemoteBounced.md" target="_blank">CustomerInsightsJourneys/EmailHardRemoteBounced</a>|
|[SourceSystem](#SourceSystem)| Refers to the source system that generated the interaction\. Outbound marketing \(OBM\) is represented by value 1\. Any other value than 1 represents Real\x2dtime journeys \(RTJ\)\.|<a href="EmailHardRemoteBounced.md" target="_blank">CustomerInsightsJourneys/EmailHardRemoteBounced</a>|
|[Timestamp](#Timestamp)|Indicates the exact date and time when the interaction was emitted\.|<a href="EmailHardRemoteBounced.md" target="_blank">CustomerInsightsJourneys/EmailHardRemoteBounced</a>|
|[UsageType](#UsageType)|Usage type|<a href="EmailHardRemoteBounced.md" target="_blank">CustomerInsightsJourneys/EmailHardRemoteBounced</a>|
|[Version](#Version)|Interaction version\. Used for updating the interaction\.|<a href="EmailHardRemoteBounced.md" target="_blank">CustomerInsightsJourneys/EmailHardRemoteBounced</a>|
