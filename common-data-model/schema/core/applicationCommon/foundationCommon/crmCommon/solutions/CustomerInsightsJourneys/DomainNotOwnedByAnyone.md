---
title: DomainNotOwnedByAnyone in CustomerInsightsJourneys - Common Data Model | Microsoft Docs
description: Triggered when during sending an email, the domain used isn’t authenticated anywhere
...
# DomainNotOwnedByAnyone in CustomerInsightsJourneys

Triggered when during sending an email, the domain used isn’t authenticated anywhere  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/CustomerInsightsJourneys/DomainNotOwnedByAnyone.cdm.json" target="_blank">GitHub</a>.  
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Triggered when during sending an email, the domain used isn’t authenticated anywhere</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[AccountId](#AccountId)|Unique identifier of the Account\.|<a href="DomainNotOwnedByAnyone.md" target="_blank">CustomerInsightsJourneys/DomainNotOwnedByAnyone</a>|
|[ActivityExpiryTime](#ActivityExpiryTime)|Activity expiry time|<a href="DomainNotOwnedByAnyone.md" target="_blank">CustomerInsightsJourneys/DomainNotOwnedByAnyone</a>|
|[ActivityId](#ActivityId)|Unique identifier of the Activity\.|<a href="DomainNotOwnedByAnyone.md" target="_blank">CustomerInsightsJourneys/DomainNotOwnedByAnyone</a>|
|[BlockedReason](#BlockedReason)|Indicates the reason for email block\.|<a href="DomainNotOwnedByAnyone.md" target="_blank">CustomerInsightsJourneys/DomainNotOwnedByAnyone</a>|
|[BusinessUnitId](#BusinessUnitId)|Unique identifier of the Business unit\.|<a href="DomainNotOwnedByAnyone.md" target="_blank">CustomerInsightsJourneys/DomainNotOwnedByAnyone</a>|
|[ContactId](#ContactId)|Unique identifier of the Contact\.|<a href="DomainNotOwnedByAnyone.md" target="_blank">CustomerInsightsJourneys/DomainNotOwnedByAnyone</a>|
|[CustomerJourneyId](#CustomerJourneyId)| Unique identifier of the Customer journey|<a href="DomainNotOwnedByAnyone.md" target="_blank">CustomerInsightsJourneys/DomainNotOwnedByAnyone</a>|
|[CustomerJourneyIterationId](#CustomerJourneyIterationId)|Customer journey iteration ID|<a href="DomainNotOwnedByAnyone.md" target="_blank">CustomerInsightsJourneys/DomainNotOwnedByAnyone</a>|
|[IdempotencyId](#IdempotencyId)|Idempotency ID defines uniqueness of an analytics event\.|<a href="DomainNotOwnedByAnyone.md" target="_blank">CustomerInsightsJourneys/DomainNotOwnedByAnyone</a>|
|[InteractionType](#InteractionType)|Type of the interaction\.|<a href="DomainNotOwnedByAnyone.md" target="_blank">CustomerInsightsJourneys/DomainNotOwnedByAnyone</a>|
|[InternalMarketingInteractionId](#InternalMarketingInteractionId)|Internal marketing interaction Id\.|<a href="DomainNotOwnedByAnyone.md" target="_blank">CustomerInsightsJourneys/DomainNotOwnedByAnyone</a>|
|[LeadId](#LeadId)|Unique identifier of the Lead\.|<a href="DomainNotOwnedByAnyone.md" target="_blank">CustomerInsightsJourneys/DomainNotOwnedByAnyone</a>|
|[MessageId](#MessageId)|Message ID|<a href="DomainNotOwnedByAnyone.md" target="_blank">CustomerInsightsJourneys/DomainNotOwnedByAnyone</a>|
|[OrganizationId](#OrganizationId)|Organization Id\.|<a href="DomainNotOwnedByAnyone.md" target="_blank">CustomerInsightsJourneys/DomainNotOwnedByAnyone</a>|
|[ProfileId](#ProfileId)|Unique identifier of the profile\.|<a href="DomainNotOwnedByAnyone.md" target="_blank">CustomerInsightsJourneys/DomainNotOwnedByAnyone</a>|
|[ProfileType](#ProfileType)|The profile type \(Contact, Lead or CI Profile\)|<a href="DomainNotOwnedByAnyone.md" target="_blank">CustomerInsightsJourneys/DomainNotOwnedByAnyone</a>|
|[SendingId](#SendingId)|Indicates the journey iteration ID\.|<a href="DomainNotOwnedByAnyone.md" target="_blank">CustomerInsightsJourneys/DomainNotOwnedByAnyone</a>|
|[SourceSystem](#SourceSystem)| Refers to the source system that generated the interaction\. Outbound marketing \(OBM\) is represented by value 1\. Any other value than 1 represents Real-time journeys \(RTJ\)\.|<a href="DomainNotOwnedByAnyone.md" target="_blank">CustomerInsightsJourneys/DomainNotOwnedByAnyone</a>|
|[Timestamp](#Timestamp)|Indicates the exact date and time when the interaction was emitted\.|<a href="DomainNotOwnedByAnyone.md" target="_blank">CustomerInsightsJourneys/DomainNotOwnedByAnyone</a>|
|[UsageType](#UsageType)|Usage type|<a href="DomainNotOwnedByAnyone.md" target="_blank">CustomerInsightsJourneys/DomainNotOwnedByAnyone</a>|
|[Version](#Version)|Interaction version\. Used for updating the interaction\.|<a href="DomainNotOwnedByAnyone.md" target="_blank">CustomerInsightsJourneys/DomainNotOwnedByAnyone</a>|

### <a href=#AccountId name="AccountId">AccountId</a>

Unique identifier of the Account\.  
First included in: CustomerInsightsJourneys/DomainNotOwnedByAnyone \(this entity\)  
