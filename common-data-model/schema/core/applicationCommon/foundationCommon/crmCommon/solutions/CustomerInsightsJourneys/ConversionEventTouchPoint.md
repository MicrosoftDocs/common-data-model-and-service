---
title: ConversionEventTouchPoint in CustomerInsightsJourneys - Common Data Model | Microsoft Docs
...
# ConversionEventTouchPoint in CustomerInsightsJourneys

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/CustomerInsightsJourneys/ConversionEventTouchPoint.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[BusinessUnitId](#BusinessUnitId)|Unique identifier of the Business unit.|<a href="ConversionEventTouchPoint.md" target="_blank">CustomerInsightsJourneys/ConversionEventTouchPoint</a>|
|[ConversionEventDefinitionId](#ConversionEventDefinitionId)|Conversion Event definition id.|<a href="ConversionEventTouchPoint.md" target="_blank">CustomerInsightsJourneys/ConversionEventTouchPoint</a>|
|[ConversionEventDefinitionName](#ConversionEventDefinitionName)|Conversion Event definition name.|<a href="ConversionEventTouchPoint.md" target="_blank">CustomerInsightsJourneys/ConversionEventTouchPoint</a>|
|[EventArrivalTimestamp](#EventArrivalTimestamp)|Event arrival timestamp.|<a href="ConversionEventTouchPoint.md" target="_blank">CustomerInsightsJourneys/ConversionEventTouchPoint</a>|
|[IdempotencyId](#IdempotencyId)|Idempotency ID defines uniqueness of an analytics event.|<a href="ConversionEventTouchPoint.md" target="_blank">CustomerInsightsJourneys/ConversionEventTouchPoint</a>|
|[InteractionType](#InteractionType)|Type of the interaction.|<a href="ConversionEventTouchPoint.md" target="_blank">CustomerInsightsJourneys/ConversionEventTouchPoint</a>|
...
|[SourceSystem](#SourceSystem)| Refers to the source system that generated the interaction. Outbound marketing (OBM) is represented by value 1. Any other value than 1 represents Real-time journeys (RTJ).|<a href="ConversionEventTouchPoint.md" target="_blank">CustomerInsightsJourneys/ConversionEventTouchPoint</a>|
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>description</td><td>Conversion Event definition id.</td></tr><tr><td>dataFormat</td><td>guid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the ConversionEventDefinitionId attribute are listed below.</summary>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>description</td><td>Conversion Event definition name.</td></tr><tr><td>dataFormat</td><td>string</td></tr></table>

#### Traits

<details>
<summary>List of traits for the ConversionEventDefinitionName attribute are listed below.</summary>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>description</td><td>Event arrival timestamp.</td></tr><tr><td>dataFormat</td><td>dateTime</td></tr></table>

#### Traits

<details>
<summary>List of traits for the EventArrivalTimestamp attribute are listed below.</summary>
...
**is.dataFormat.date**  
  ...
  **is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Event arrival timestamp.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
