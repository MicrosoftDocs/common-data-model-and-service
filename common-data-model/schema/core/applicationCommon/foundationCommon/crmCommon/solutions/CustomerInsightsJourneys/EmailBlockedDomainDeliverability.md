...
|---|---|---|
|[BlockedReason](#BlockedReason)|Indicates the reason for email block.|<a href="EmailBlockedDomainDeliverability.md" target="_blank">CustomerInsightsJourneys/EmailBlockedDomainDeliverability</a>|
|[BusinessUnitId](#BusinessUnitId)|Unique identifier of the Business unit.|<a href="EmailBlockedDomainDeliverability.md" target="_blank">CustomerInsightsJourneys/EmailBlockedDomainDeliverability</a>|
|[Category](#Category)|Category|<a href="EmailBlockedDomainDeliverability.md" target="_blank">CustomerInsightsJourneys/EmailBlockedDomainDeliverability</a>|
|[CustomerJourneyId](#CustomerJourneyId)| Unique identifier of the Customer journey|<a href="EmailBlockedDomainDeliverability.md" target="_blank">CustomerInsightsJourneys/EmailBlockedDomainDeliverability</a>|
|[Details](#Details)|Contains additional information regarding the reason of block.|<a href="EmailBlockedDomainDeliverability.md" target="_blank">CustomerInsightsJourneys/EmailBlockedDomainDeliverability</a>|
|[EmailAddressUsed](#EmailAddressUsed)|The profile's email address.|<a href="EmailBlockedDomainDeliverability.md" target="_blank">CustomerInsightsJourneys/EmailBlockedDomainDeliverability</a>|
|[IdempotencyId](#IdempotencyId)|Idempotency ID defines uniqueness of an analytics event.|<a href="EmailBlockedDomainDeliverability.md" target="_blank">CustomerInsightsJourneys/EmailBlockedDomainDeliverability</a>|
|[InteractionType](#InteractionType)|Type of the interaction.|<a href="EmailBlockedDomainDeliverability.md" target="_blank">CustomerInsightsJourneys/EmailBlockedDomainDeliverability</a>|
|[InternalMarketingInteractionId](#InternalMarketingInteractionId)|Internal marketing interaction Id.|<a href="EmailBlockedDomainDeliverability.md" target="_blank">CustomerInsightsJourneys/EmailBlockedDomainDeliverability</a>|
...
|[JourneyActionId](#JourneyActionId)|GUID of the journey action step associated with this event.|<a href="EmailBlockedDomainDeliverability.md" target="_blank">CustomerInsightsJourneys/EmailBlockedDomainDeliverability</a>|
|[JourneyRunId](#JourneyRunId)|Flow run ID of the Power Automate run instance associated with this event.|<a href="EmailBlockedDomainDeliverability.md" target="_blank">CustomerInsightsJourneys/EmailBlockedDomainDeliverability</a>|
|[MessageId](#MessageId)|Message ID|<a href="EmailBlockedDomainDeliverability.md" target="_blank">CustomerInsightsJourneys/EmailBlockedDomainDeliverability</a>|
|[MessageTemplateVersion](#MessageTemplateVersion)|Message template version|<a href="EmailBlockedDomainDeliverability.md" target="_blank">CustomerInsightsJourneys/EmailBlockedDomainDeliverability</a>|
...
|[OrganizationId](#OrganizationId)|Organization Id.|<a href="EmailBlockedDomainDeliverability.md" target="_blank">CustomerInsightsJourneys/EmailBlockedDomainDeliverability</a>|
|[ProfileId](#ProfileId)|Unique identifier of the profile.|<a href="EmailBlockedDomainDeliverability.md" target="_blank">CustomerInsightsJourneys/EmailBlockedDomainDeliverability</a>|
|[ProfileType](#ProfileType)|The profile type \(Contact, Lead or CI Profile\)|<a href="EmailBlockedDomainDeliverability.md" target="_blank">CustomerInsightsJourneys/EmailBlockedDomainDeliverability</a>|
|[SourceSystem](#SourceSystem)| Refers to the source system that generated the interaction. Outbound marketing \(OBM\) is represented by value 1. Any other value than 1 represents Real\x2dtime journeys \(RTJ\).|<a href="EmailBlockedDomainDeliverability.md" target="_blank">CustomerInsightsJourneys/EmailBlockedDomainDeliverability</a>|
|[Timestamp](#Timestamp)|Indicates the exact date and time when the interaction was emitted.|<a href="EmailBlockedDomainDeliverability.md" target="_blank">CustomerInsightsJourneys/EmailBlockedDomainDeliverability</a>|
|[Version](#Version)|Interaction version. Used for updating the interaction.|<a href="EmailBlockedDomainDeliverability.md" target="_blank">CustomerInsightsJourneys/EmailBlockedDomainDeliverability</a>|
