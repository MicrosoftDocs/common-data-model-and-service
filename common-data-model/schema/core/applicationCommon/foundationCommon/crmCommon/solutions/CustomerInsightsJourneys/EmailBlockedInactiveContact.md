---
title: EmailBlockedInactiveContact in CustomerInsightsJourneys - Common Data Model | Microsoft Docs
description: Logged when an email is blocked due to an inactive contact.
...
# EmailBlockedInactiveContact in CustomerInsightsJourneys

Logged when an email is blocked due to an inactive contact\.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/CustomerInsightsJourneys/EmailBlockedInactiveContact.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[AccountId](#AccountId)|Unique identifier of the Account\.|<a href="EmailBlockedInactiveContact.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInactiveContact</a>|
|[ActivityExpiryTime](#ActivityExpiryTime)|Activity expiry time|<a href="EmailBlockedInactiveContact.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInactiveContact</a>|
|[ActivityId](#ActivityId)|Activity ID|<a href="EmailBlockedInactiveContact.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInactiveContact</a>|
|[BlockedReason](#BlockedReason)|Indicates the reason for email block\.|<a href="EmailBlockedInactiveContact.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInactiveContact</a>|
|[BusinessUnitId](#BusinessUnitId)|Unique identifier of the Business unit\.|<a href="EmailBlockedInactiveContact.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInactiveContact</a>|
|[Category](#Category)|Category|<a href="EmailBlockedInactiveContact.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInactiveContact</a>|
|[ContactId](#ContactId)|Unique identifier of the Contact\.|<a href="EmailBlockedInactiveContact.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInactiveContact</a>|
|[CustomerJourneyId](#CustomerJourneyId)| Unique identifier of the Customer journey|<a href="EmailBlockedInactiveContact.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInactiveContact</a>|
|[CustomerJourneyIterationId](#CustomerJourneyIterationId)|Customer journey iteration ID|<a href="EmailBlockedInactiveContact.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInactiveContact</a>|
|[Details](#Details)|Contains additional information regarding the reason of block\.|<a href="EmailBlockedInactiveContact.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInactiveContact</a>|
|[EmailAddressUsed](#EmailAddressUsed)|The profile's email address\.|<a href="EmailBlockedInactiveContact.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInactiveContact</a>|
|[IdempotencyId](#IdempotencyId)|Idempotency ID defines uniqueness of an analytics event\.|<a href="EmailBlockedInactiveContact.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInactiveContact</a>|
|[InteractionType](#InteractionType)|Type of the interaction\.|<a href="EmailBlockedInactiveContact.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInactiveContact</a>|
|[InternalMarketingInteractionId](#InternalMarketingInteractionId)|Internal marketing interaction Id\.|<a href="EmailBlockedInactiveContact.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInactiveContact</a>|
|[IsSmartScheduled](#IsSmartScheduled)||<a href="EmailBlockedInactiveContact.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInactiveContact</a>|
|[IsUnresolvedProfile](#IsUnresolvedProfile)||<a href="EmailBlockedInactiveContact.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInactiveContact</a>|
|[JourneyActionId](#JourneyActionId)|GUID of the journey action step associated with this event\.|<a href="EmailBlockedInactiveContact.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInactiveContact</a>|
|[JourneyRunId](#JourneyRunId)|Flow run ID of the Power Automate run instance associated with this event\.|<a href="EmailBlockedInactiveContact.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInactiveContact</a>|
|[MessageId](#MessageId)|Message ID|<a href="EmailBlockedInactiveContact.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInactiveContact</a>|
|[MessageTemplateVersion](#MessageTemplateVersion)|Message template version|<a href="EmailBlockedInactiveContact.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInactiveContact</a>|
|[MessageVariationIndexes](#MessageVariationIndexes)||<a href="EmailBlockedInactiveContact.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInactiveContact</a>|
|[MessageVariationName](#MessageVariationName)||<a href="EmailBlockedInactiveContact.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInactiveContact</a>|
|[OrganizationId](#OrganizationId)|Organization Id\.|<a href="EmailBlockedInactiveContact.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInactiveContact</a>|
|[ProfileId](#ProfileId)|Unique identifier of the profile\.|<a href="EmailBlockedInactiveContact.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInactiveContact</a>|
|[ProfileType](#ProfileType)|The profile type \(Contact, Lead or CI Profile\)|<a href="EmailBlockedInactiveContact.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInactiveContact</a>|
|[SchedulerId](#SchedulerId)||<a href="EmailBlockedInactiveContact.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInactiveContact</a>|
|[SendingId](#SendingId)|Indicates the journey iteration ID\.|<a href="EmailBlockedInactiveContact.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInactiveContact</a>|
|[SourceSystem](#SourceSystem)| Refers to the source system that generated the interaction\. Outbound marketing \(OBM\) is represented by value 1\. Any other value than 1 represents Real-time journeys \(RTJ\)\.|<a href="EmailBlockedInactiveContact.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInactiveContact</a>|
|[Timestamp](#Timestamp)|Indicates the exact date and time when the interaction was emitted\.|<a href="EmailBlockedInactiveContact.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInactiveContact</a>|
|[UsageType](#UsageType)|Indicates if it's a test send, journey or trigger based\.|<a href="EmailBlockedInactiveContact.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInactiveContact</a>|
|[Version](#Version)|Interaction version\. Used for updating the interaction\.|<a href="EmailBlockedInactiveContact.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInactiveContact</a>|

### <a href=#AccountId name="AccountId">AccountId</a>

Unique identifier of the Account\.  
First included in: CustomerInsightsJourneys/EmailBlockedInactiveContact \(this entity\)  
