---
title: PassThroughActivityContactProcessed in CustomerInsightsJourneys - Common Data Model | Microsoft Docs
...
# PassThroughActivityContactProcessed in CustomerInsightsJourneys

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/CustomerInsightsJourneys/PassThroughActivityContactProcessed.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[AccountId](#AccountId)|Unique identifier of the Account\.|<a href="PassThroughActivityContactProcessed.md" target="_blank">CustomerInsightsJourneys/PassThroughActivityContactProcessed</a>|
|[ActivityExpiryTime](#ActivityExpiryTime)|Activity expiry time|<a href="PassThroughActivityContactProcessed.md" target="_blank">CustomerInsightsJourneys/PassThroughActivityContactProcessed</a>|
|[ActivityId](#ActivityId)|Unique identifier of the Activity\.|<a href="PassThroughActivityContactProcessed.md" target="_blank">CustomerInsightsJourneys/PassThroughActivityContactProcessed</a>|
|[BusinessUnitId](#BusinessUnitId)|Unique identifier of the Business unit\.|<a href="PassThroughActivityContactProcessed.md" target="_blank">CustomerInsightsJourneys/PassThroughActivityContactProcessed</a>|
|[ContactId](#ContactId)|Unique identifier of the Contact\.|<a href="PassThroughActivityContactProcessed.md" target="_blank">CustomerInsightsJourneys/PassThroughActivityContactProcessed</a>|
|[CustomerJourneyId](#CustomerJourneyId)| Unique identifier of the Customer journey|<a href="PassThroughActivityContactProcessed.md" target="_blank">CustomerInsightsJourneys/PassThroughActivityContactProcessed</a>|
|[CustomerJourneyIterationId](#CustomerJourneyIterationId)|Customer journey iteration ID|<a href="PassThroughActivityContactProcessed.md" target="_blank">CustomerInsightsJourneys/PassThroughActivityContactProcessed</a>|
|[IdempotencyId](#IdempotencyId)|Idempotency ID defines uniqueness of an analytics event\.|<a href="PassThroughActivityContactProcessed.md" target="_blank">CustomerInsightsJourneys/PassThroughActivityContactProcessed</a>|
|[InteractionType](#InteractionType)|Type of the interaction\.|<a href="PassThroughActivityContactProcessed.md" target="_blank">CustomerInsightsJourneys/PassThroughActivityContactProcessed</a>|
|[InternalMarketingInteractionId](#InternalMarketingInteractionId)|Internal marketing interaction Id\.|<a href="PassThroughActivityContactProcessed.md" target="_blank">CustomerInsightsJourneys/PassThroughActivityContactProcessed</a>|
|[LeadId](#LeadId)|Unique identifier of the Lead\.|<a href="PassThroughActivityContactProcessed.md" target="_blank">CustomerInsightsJourneys/PassThroughActivityContactProcessed</a>|
|[OrganizationId](#OrganizationId)|Organization Id\.|<a href="PassThroughActivityContactProcessed.md" target="_blank">CustomerInsightsJourneys/PassThroughActivityContactProcessed</a>|
|[ProfileId](#ProfileId)|Unique identifier of the profile\.|<a href="PassThroughActivityContactProcessed.md" target="_blank">CustomerInsightsJourneys/PassThroughActivityContactProcessed</a>|
|[ProfileType](#ProfileType)|The profile type \(Contact, Lead or CI Profile\)|<a href="PassThroughActivityContactProcessed.md" target="_blank">CustomerInsightsJourneys/PassThroughActivityContactProcessed</a>|
|[SourceSystem](#SourceSystem)| Refers to the source system that generated the interaction\. Outbound marketing \(OBM\) is represented by value 1\. Any other value than 1 represents Real\x2dtime journeys \(RTJ\)\.|<a href="PassThroughActivityContactProcessed.md" target="_blank">CustomerInsightsJourneys/PassThroughActivityContactProcessed</a>|
|[Timestamp](#Timestamp)|Indicates the exact date and time when the interaction was emitted\.|<a href="PassThroughActivityContactProcessed.md" target="_blank">CustomerInsightsJourneys/PassThroughActivityContactProcessed</a>|
|[Version](#Version)|Interaction version\. Used for updating the interaction\.|<a href="PassThroughActivityContactProcessed.md" target="_blank">CustomerInsightsJourneys/PassThroughActivityContactProcessed</a>|
|[WorkflowId](#WorkflowId)|Outbound Marketing Workflow ID|<a href="PassThroughActivityContactProcessed.md" target="_blank">CustomerInsightsJourneys/PassThroughActivityContactProcessed</a>|

### <a href=#AccountId name="AccountId">AccountId</a>

Unique identifier of the Account\.  
First included in: CustomerInsightsJourneys/PassThroughActivityContactProcessed \(this entity\)  
