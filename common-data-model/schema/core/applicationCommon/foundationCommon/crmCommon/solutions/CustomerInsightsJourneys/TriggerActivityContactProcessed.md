---
title: TriggerActivityContactProcessed in CustomerInsightsJourneys - Common Data Model | Microsoft Docs
...
# TriggerActivityContactProcessed in CustomerInsightsJourneys

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/CustomerInsightsJourneys/TriggerActivityContactProcessed.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[AccountId](#AccountId)|Unique identifier of the Account\.|<a href="TriggerActivityContactProcessed.md" target="_blank">CustomerInsightsJourneys/TriggerActivityContactProcessed</a>|
|[ActivityExpiryTime](#ActivityExpiryTime)|Activity expiry time|<a href="TriggerActivityContactProcessed.md" target="_blank">CustomerInsightsJourneys/TriggerActivityContactProcessed</a>|
|[ActivityId](#ActivityId)|Unique identifier of the Activity\.|<a href="TriggerActivityContactProcessed.md" target="_blank">CustomerInsightsJourneys/TriggerActivityContactProcessed</a>|
|[BusinessUnitId](#BusinessUnitId)|Unique identifier of the Business unit\.|<a href="TriggerActivityContactProcessed.md" target="_blank">CustomerInsightsJourneys/TriggerActivityContactProcessed</a>|
|[ContactId](#ContactId)|Unique identifier of the Contact\.|<a href="TriggerActivityContactProcessed.md" target="_blank">CustomerInsightsJourneys/TriggerActivityContactProcessed</a>|
|[CustomerJourneyId](#CustomerJourneyId)| Unique identifier of the Customer journey|<a href="TriggerActivityContactProcessed.md" target="_blank">CustomerInsightsJourneys/TriggerActivityContactProcessed</a>|
|[CustomerJourneyIterationId](#CustomerJourneyIterationId)|Customer journey iteration ID|<a href="TriggerActivityContactProcessed.md" target="_blank">CustomerInsightsJourneys/TriggerActivityContactProcessed</a>|
|[IdempotencyId](#IdempotencyId)|Idempotency ID defines uniqueness of an analytics event\.|<a href="TriggerActivityContactProcessed.md" target="_blank">CustomerInsightsJourneys/TriggerActivityContactProcessed</a>|
|[InteractionType](#InteractionType)|Type of the interaction\.|<a href="TriggerActivityContactProcessed.md" target="_blank">CustomerInsightsJourneys/TriggerActivityContactProcessed</a>|
|[InternalMarketingInteractionId](#InternalMarketingInteractionId)|Internal marketing interaction Id\.|<a href="TriggerActivityContactProcessed.md" target="_blank">CustomerInsightsJourneys/TriggerActivityContactProcessed</a>|
|[LeadId](#LeadId)|Unique identifier of the Lead\.|<a href="TriggerActivityContactProcessed.md" target="_blank">CustomerInsightsJourneys/TriggerActivityContactProcessed</a>|
|[OrganizationId](#OrganizationId)|Organization Id\.|<a href="TriggerActivityContactProcessed.md" target="_blank">CustomerInsightsJourneys/TriggerActivityContactProcessed</a>|
|[Path](#Path)|Path|<a href="TriggerActivityContactProcessed.md" target="_blank">CustomerInsightsJourneys/TriggerActivityContactProcessed</a>|
|[ProfileId](#ProfileId)|Unique identifier of the profile\.|<a href="TriggerActivityContactProcessed.md" target="_blank">CustomerInsightsJourneys/TriggerActivityContactProcessed</a>|
|[ProfileType](#ProfileType)|The profile type \(Contact, Lead or CI Profile\)|<a href="TriggerActivityContactProcessed.md" target="_blank">CustomerInsightsJourneys/TriggerActivityContactProcessed</a>|
|[SourceSystem](#SourceSystem)| Refers to the source system that generated the interaction\. Outbound marketing \(OBM\) is represented by value 1\. Any other value than 1 represents Real\x2dtime journeys \(RTJ\)\.|<a href="TriggerActivityContactProcessed.md" target="_blank">CustomerInsightsJourneys/TriggerActivityContactProcessed</a>|
|[Timestamp](#Timestamp)|Indicates the exact date and time when the interaction was emitted\.|<a href="TriggerActivityContactProcessed.md" target="_blank">CustomerInsightsJourneys/TriggerActivityContactProcessed</a>|
|[Version](#Version)|Interaction version\. Used for updating the interaction\.|<a href="TriggerActivityContactProcessed.md" target="_blank">CustomerInsightsJourneys/TriggerActivityContactProcessed</a>|
|[WorkflowId](#WorkflowId)|Outbound Marketing Workflow ID|<a href="TriggerActivityContactProcessed.md" target="_blank">CustomerInsightsJourneys/TriggerActivityContactProcessed</a>|

### <a href=#AccountId name="AccountId">AccountId</a>

Unique identifier of the Account\.  
First included in: CustomerInsightsJourneys/TriggerActivityContactProcessed \(this entity\)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>description</td><td>Path</td></tr><tr><td>dataFormat</td><td>string</td></tr></table>
