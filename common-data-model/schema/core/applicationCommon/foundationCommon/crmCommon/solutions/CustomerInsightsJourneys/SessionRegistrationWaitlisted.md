---
title: SessionRegistrationWaitlisted in CustomerInsightsJourneys - Common Data Model | Microsoft Docs
...
# SessionRegistrationWaitlisted in CustomerInsightsJourneys

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/CustomerInsightsJourneys/SessionRegistrationWaitlisted.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[AccountId](#AccountId)|Unique identifier of the Account\.|<a href="SessionRegistrationWaitlisted.md" target="_blank">CustomerInsightsJourneys/SessionRegistrationWaitlisted</a>|
|[BindingId](#BindingId)||<a href="SessionRegistrationWaitlisted.md" target="_blank">CustomerInsightsJourneys/SessionRegistrationWaitlisted</a>|
|[BusinessUnitId](#BusinessUnitId)|Unique identifier of the Business unit\.|<a href="SessionRegistrationWaitlisted.md" target="_blank">CustomerInsightsJourneys/SessionRegistrationWaitlisted</a>|
|[ContactId](#ContactId)|Unique identifier of the Contact\.|<a href="SessionRegistrationWaitlisted.md" target="_blank">CustomerInsightsJourneys/SessionRegistrationWaitlisted</a>|
|[CustomerJourneyId](#CustomerJourneyId)| Unique identifier of the Customer journey|<a href="SessionRegistrationWaitlisted.md" target="_blank">CustomerInsightsJourneys/SessionRegistrationWaitlisted</a>|
|[EventId](#EventId)|Event ID|<a href="SessionRegistrationWaitlisted.md" target="_blank">CustomerInsightsJourneys/SessionRegistrationWaitlisted</a>|
|[IdempotencyId](#IdempotencyId)|Idempotency ID defines uniqueness of an analytics event\.|<a href="SessionRegistrationWaitlisted.md" target="_blank">CustomerInsightsJourneys/SessionRegistrationWaitlisted</a>|
|[InteractionType](#InteractionType)|Type of the interaction\.|<a href="SessionRegistrationWaitlisted.md" target="_blank">CustomerInsightsJourneys/SessionRegistrationWaitlisted</a>|
|[InternalMarketingInteractionId](#InternalMarketingInteractionId)|Internal marketing interaction Id\.|<a href="SessionRegistrationWaitlisted.md" target="_blank">CustomerInsightsJourneys/SessionRegistrationWaitlisted</a>|
|[IsUnresolvedProfile](#IsUnresolvedProfile)||<a href="SessionRegistrationWaitlisted.md" target="_blank">CustomerInsightsJourneys/SessionRegistrationWaitlisted</a>|
|[JourneyActionId](#JourneyActionId)|GUID of the journey action step associated with this event\.|<a href="SessionRegistrationWaitlisted.md" target="_blank">CustomerInsightsJourneys/SessionRegistrationWaitlisted</a>|
|[JourneyRunId](#JourneyRunId)|Flow run ID of the Power Automate run instance associated with this event\.|<a href="SessionRegistrationWaitlisted.md" target="_blank">CustomerInsightsJourneys/SessionRegistrationWaitlisted</a>|
|[MessageId](#MessageId)|Message ID|<a href="SessionRegistrationWaitlisted.md" target="_blank">CustomerInsightsJourneys/SessionRegistrationWaitlisted</a>|
|[MessageTemplateVersion](#MessageTemplateVersion)|Message template version|<a href="SessionRegistrationWaitlisted.md" target="_blank">CustomerInsightsJourneys/SessionRegistrationWaitlisted</a>|
|[OrganizationId](#OrganizationId)|Organization Id\.|<a href="SessionRegistrationWaitlisted.md" target="_blank">CustomerInsightsJourneys/SessionRegistrationWaitlisted</a>|
|[ProfileId](#ProfileId)|Unique identifier of the profile\.|<a href="SessionRegistrationWaitlisted.md" target="_blank">CustomerInsightsJourneys/SessionRegistrationWaitlisted</a>|
|[ProfileType](#ProfileType)|The profile type \(Contact, Lead or CI Profile\)|<a href="SessionRegistrationWaitlisted.md" target="_blank">CustomerInsightsJourneys/SessionRegistrationWaitlisted</a>|
|[SessionId](#SessionId)|Session ID|<a href="SessionRegistrationWaitlisted.md" target="_blank">CustomerInsightsJourneys/SessionRegistrationWaitlisted</a>|
|[SessionRegistrationId](#SessionRegistrationId)|Session registration ID|<a href="SessionRegistrationWaitlisted.md" target="_blank">CustomerInsightsJourneys/SessionRegistrationWaitlisted</a>|
|[SourceEntityId](#SourceEntityId)|Source entity ID|<a href="SessionRegistrationWaitlisted.md" target="_blank">CustomerInsightsJourneys/SessionRegistrationWaitlisted</a>|
|[SourceEntityName](#SourceEntityName)|Source entity name|<a href="SessionRegistrationWaitlisted.md" target="_blank">CustomerInsightsJourneys/SessionRegistrationWaitlisted</a>|
|[SourceSystem](#SourceSystem)| Refers to the source system that generated the interaction\. Outbound marketing \(OBM\) is represented by value 1\. Any other value than 1 represents Real-time journeys \(RTJ\)\.|<a href="SessionRegistrationWaitlisted.md" target="_blank">CustomerInsightsJourneys/SessionRegistrationWaitlisted</a>|
|[Timestamp](#Timestamp)|Indicates the exact date and time when the interaction was emitted\.|<a href="SessionRegistrationWaitlisted.md" target="_blank">CustomerInsightsJourneys/SessionRegistrationWaitlisted</a>|
|[Version](#Version)|Interaction version\. Used for updating the interaction\.|<a href="SessionRegistrationWaitlisted.md" target="_blank">CustomerInsightsJourneys/SessionRegistrationWaitlisted</a>|

### <a href=#AccountId name="AccountId">AccountId</a>

Unique identifier of the Account\.  
First included in: CustomerInsightsJourneys/SessionRegistrationWaitlisted \(this entity\)  
