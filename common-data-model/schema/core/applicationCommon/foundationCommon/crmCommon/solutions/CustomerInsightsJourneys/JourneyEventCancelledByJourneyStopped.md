---
title: JourneyEventCancelledByJourneyStopped in CustomerInsightsJourneys - Common Data Model | Microsoft Docs
description: Logged when a journey instance is terminated because the user has stopped the journey
...
# JourneyEventCancelledByJourneyStopped in CustomerInsightsJourneys

Logged when a journey instance is terminated because the user has stopped the journey  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/CustomerInsightsJourneys/JourneyEventCancelledByJourneyStopped.cdm.json" target="_blank">GitHub</a>.  
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Logged when a journey instance is terminated because the user has stopped the journey</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[BusinessUnitId](#BusinessUnitId)|Unique identifier of the Business unit\.|<a href="JourneyEventCancelledByJourneyStopped.md" target="_blank">CustomerInsightsJourneys/JourneyEventCancelledByJourneyStopped</a>|
|[CustomerJourneyId](#CustomerJourneyId)| Unique identifier of the Customer journey|<a href="JourneyEventCancelledByJourneyStopped.md" target="_blank">CustomerInsightsJourneys/JourneyEventCancelledByJourneyStopped</a>|
|[DropoffId](#DropoffId)|Unique identifier for events that cause a person to leave the journey\.|<a href="JourneyEventCancelledByJourneyStopped.md" target="_blank">CustomerInsightsJourneys/JourneyEventCancelledByJourneyStopped</a>|
|[IdempotencyId](#IdempotencyId)|Idempotency ID defines uniqueness of an analytics event\.|<a href="JourneyEventCancelledByJourneyStopped.md" target="_blank">CustomerInsightsJourneys/JourneyEventCancelledByJourneyStopped</a>|
|[InteractionType](#InteractionType)|Type of the interaction\.|<a href="JourneyEventCancelledByJourneyStopped.md" target="_blank">CustomerInsightsJourneys/JourneyEventCancelledByJourneyStopped</a>|
|[InternalMarketingInteractionId](#InternalMarketingInteractionId)|Internal marketing interaction Id\.|<a href="JourneyEventCancelledByJourneyStopped.md" target="_blank">CustomerInsightsJourneys/JourneyEventCancelledByJourneyStopped</a>|
|[IsUnresolvedProfile](#IsUnresolvedProfile)||<a href="JourneyEventCancelledByJourneyStopped.md" target="_blank">CustomerInsightsJourneys/JourneyEventCancelledByJourneyStopped</a>|
|[JourneyActionId](#JourneyActionId)|GUID of the journey action step associated with this event\.|<a href="JourneyEventCancelledByJourneyStopped.md" target="_blank">CustomerInsightsJourneys/JourneyEventCancelledByJourneyStopped</a>|
|[JourneyRunId](#JourneyRunId)|Flow run ID of the Power Automate run instance associated with this event\.|<a href="JourneyEventCancelledByJourneyStopped.md" target="_blank">CustomerInsightsJourneys/JourneyEventCancelledByJourneyStopped</a>|
|[JourneyStatus](#JourneyStatus)|Describes the results of processing a person entering a journey\. Indicates if a person was allowed or blocked from starting the journey\.|<a href="JourneyEventCancelledByJourneyStopped.md" target="_blank">CustomerInsightsJourneys/JourneyEventCancelledByJourneyStopped</a>|
|[JourneyVersion](#JourneyVersion)|Version number of the journey\.|<a href="JourneyEventCancelledByJourneyStopped.md" target="_blank">CustomerInsightsJourneys/JourneyEventCancelledByJourneyStopped</a>|
|[MessageId](#MessageId)|Message ID|<a href="JourneyEventCancelledByJourneyStopped.md" target="_blank">CustomerInsightsJourneys/JourneyEventCancelledByJourneyStopped</a>|
|[MessageTemplateVersion](#MessageTemplateVersion)|Message template version|<a href="JourneyEventCancelledByJourneyStopped.md" target="_blank">CustomerInsightsJourneys/JourneyEventCancelledByJourneyStopped</a>|
|[OrganizationId](#OrganizationId)|Organization Id\.|<a href="JourneyEventCancelledByJourneyStopped.md" target="_blank">CustomerInsightsJourneys/JourneyEventCancelledByJourneyStopped</a>|
|[ProfileId](#ProfileId)|Unique identifier of the profile\.|<a href="JourneyEventCancelledByJourneyStopped.md" target="_blank">CustomerInsightsJourneys/JourneyEventCancelledByJourneyStopped</a>|
|[ProfileType](#ProfileType)|The profile type \(Contact, Lead or CI Profile\)|<a href="JourneyEventCancelledByJourneyStopped.md" target="_blank">CustomerInsightsJourneys/JourneyEventCancelledByJourneyStopped</a>|
|[Reason](#Reason)|Journey status reason|<a href="JourneyEventCancelledByJourneyStopped.md" target="_blank">CustomerInsightsJourneys/JourneyEventCancelledByJourneyStopped</a>|
|[ReasonDetail](#ReasonDetail)|Provides additional information about the status of this event\.|<a href="JourneyEventCancelledByJourneyStopped.md" target="_blank">CustomerInsightsJourneys/JourneyEventCancelledByJourneyStopped</a>|
|[SegmentId](#SegmentId)|For segment based journeys, the GUID of the segment for this journey\.|<a href="JourneyEventCancelledByJourneyStopped.md" target="_blank">CustomerInsightsJourneys/JourneyEventCancelledByJourneyStopped</a>|
|[SegmentName](#SegmentName)|Segment name|<a href="JourneyEventCancelledByJourneyStopped.md" target="_blank">CustomerInsightsJourneys/JourneyEventCancelledByJourneyStopped</a>|
|[SourceSystem](#SourceSystem)| Refers to the source system that generated the interaction\. Outbound marketing \(OBM\) is represented by value 1\. Any other value than 1 represents Real-time journeys \(RTJ\)\.|<a href="JourneyEventCancelledByJourneyStopped.md" target="_blank">CustomerInsightsJourneys/JourneyEventCancelledByJourneyStopped</a>|
|[Timestamp](#Timestamp)|Indicates the exact date and time when the interaction was emitted\.|<a href="JourneyEventCancelledByJourneyStopped.md" target="_blank">CustomerInsightsJourneys/JourneyEventCancelledByJourneyStopped</a>|
|[Version](#Version)|Interaction version\. Used for updating the interaction\.|<a href="JourneyEventCancelledByJourneyStopped.md" target="_blank">CustomerInsightsJourneys/JourneyEventCancelledByJourneyStopped</a>|

### <a href=#BusinessUnitId name="BusinessUnitId">BusinessUnitId</a>

Unique identifier of the Business unit\.  
First included in: CustomerInsightsJourneys/JourneyEventCancelledByJourneyStopped \(this entity\)  
