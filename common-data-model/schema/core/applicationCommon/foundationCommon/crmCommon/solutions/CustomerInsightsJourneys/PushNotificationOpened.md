---
title: PushNotificationOpened in CustomerInsightsJourneys - Common Data Model | Microsoft Docs
description: Logged when a push notification is opened.
...
# PushNotificationOpened in CustomerInsightsJourneys

Logged when a push notification is opened\.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/CustomerInsightsJourneys/PushNotificationOpened.cdm.json" target="_blank">GitHub</a>.  
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Logged when a push notification is opened.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[BusinessUnitId](#BusinessUnitId)|Unique identifier of the Business unit\.|<a href="PushNotificationOpened.md" target="_blank">CustomerInsightsJourneys/PushNotificationOpened</a>|
|[CustomerJourneyId](#CustomerJourneyId)| Unique identifier of the Customer journey|<a href="PushNotificationOpened.md" target="_blank">CustomerInsightsJourneys/PushNotificationOpened</a>|
|[DeviceId](#DeviceId)|Unique identifier of the recipient's device|<a href="PushNotificationOpened.md" target="_blank">CustomerInsightsJourneys/PushNotificationOpened</a>|
|[IdempotencyId](#IdempotencyId)|Idempotency ID defines uniqueness of an analytics event\.|<a href="PushNotificationOpened.md" target="_blank">CustomerInsightsJourneys/PushNotificationOpened</a>|
|[InteractionType](#InteractionType)|Type of the interaction\.|<a href="PushNotificationOpened.md" target="_blank">CustomerInsightsJourneys/PushNotificationOpened</a>|
|[InternalMarketingInteractionId](#InternalMarketingInteractionId)|Internal marketing interaction Id\.|<a href="PushNotificationOpened.md" target="_blank">CustomerInsightsJourneys/PushNotificationOpened</a>|
|[IsUnresolvedProfile](#IsUnresolvedProfile)||<a href="PushNotificationOpened.md" target="_blank">CustomerInsightsJourneys/PushNotificationOpened</a>|
|[JourneyActionId](#JourneyActionId)|GUID of the journey action step associated with this event\.|<a href="PushNotificationOpened.md" target="_blank">CustomerInsightsJourneys/PushNotificationOpened</a>|
|[JourneyRunId](#JourneyRunId)|Flow run ID of the Power Automate run instance associated with this event\.|<a href="PushNotificationOpened.md" target="_blank">CustomerInsightsJourneys/PushNotificationOpened</a>|
|[MessageId](#MessageId)|Message ID|<a href="PushNotificationOpened.md" target="_blank">CustomerInsightsJourneys/PushNotificationOpened</a>|
|[MessageTemplateVersion](#MessageTemplateVersion)|Message template version|<a href="PushNotificationOpened.md" target="_blank">CustomerInsightsJourneys/PushNotificationOpened</a>|
|[OrganizationId](#OrganizationId)|Organization Id\.|<a href="PushNotificationOpened.md" target="_blank">CustomerInsightsJourneys/PushNotificationOpened</a>|
|[Platform](#Platform)|The mobile platform used for the sumbission \(iOS or Android\)\.|<a href="PushNotificationOpened.md" target="_blank">CustomerInsightsJourneys/PushNotificationOpened</a>|
|[ProfileId](#ProfileId)|Unique identifier of the profile\.|<a href="PushNotificationOpened.md" target="_blank">CustomerInsightsJourneys/PushNotificationOpened</a>|
|[ProfileType](#ProfileType)|The profile type \(Contact, Lead or CI Profile\)|<a href="PushNotificationOpened.md" target="_blank">CustomerInsightsJourneys/PushNotificationOpened</a>|
|[PushNotificationId](#PushNotificationId)|Unique identifier of the Push notification entity|<a href="PushNotificationOpened.md" target="_blank">CustomerInsightsJourneys/PushNotificationOpened</a>|
|[SourceSystem](#SourceSystem)| Refers to the source system that generated the interaction\. Outbound marketing \(OBM\) is represented by value 1\. Any other value than 1 represents Real-time journeys \(RTJ\)\.|<a href="PushNotificationOpened.md" target="_blank">CustomerInsightsJourneys/PushNotificationOpened</a>|
|[Timestamp](#Timestamp)|Indicates the exact date and time when the interaction was emitted\.|<a href="PushNotificationOpened.md" target="_blank">CustomerInsightsJourneys/PushNotificationOpened</a>|
|[Version](#Version)|Interaction version\. Used for updating the interaction\.|<a href="PushNotificationOpened.md" target="_blank">CustomerInsightsJourneys/PushNotificationOpened</a>|

### <a href=#BusinessUnitId name="BusinessUnitId">BusinessUnitId</a>

Unique identifier of the Business unit\.  
First included in: CustomerInsightsJourneys/PushNotificationOpened \(this entity\)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>description</td><td>Unique identifier of the recipient's device</td></tr><tr><td>dataFormat</td><td>guid</td></tr></table>
...
\*\*is\.dataFormat\.guid\*\*  
  \*\*is\.localized\.describedAs\*\*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Unique identifier of the recipient's device</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
### <a href=#PushNotificationId name="PushNotificationId">PushNotificationId</a>

Unique identifier of the Push notification entity  
First included in: CustomerInsightsJourneys/PushNotificationOpened \(this entity\)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>description</td><td>Unique identifier of the Push notification entity</td></tr><tr><td>dataFormat</td><td>string</td></tr></table>

#### Traits

<details>
<summary>List of traits for the PushNotificationId attribute are listed below.</summary>
...
\*\*is\.localized\.describedAs\*\*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Unique identifier of the Push notification entity</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
