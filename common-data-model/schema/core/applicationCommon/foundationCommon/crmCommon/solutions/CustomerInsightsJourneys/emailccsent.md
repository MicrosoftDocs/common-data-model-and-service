---
title: EmailCcSent in CustomerInsightsJourneys - Common Data Model | Microsoft Docs
description: Generated when an email is successfully sent to a cc recipient.
...
# EmailCcSent in CustomerInsightsJourneys

Generated when an email is successfully sent to a cc recipient\.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/CustomerInsightsJourneys/EmailCcSent.cdm.json" target="_blank">GitHub</a>.  
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Generated when an email is successfully sent to a cc recipient.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[BusinessUnitId](#BusinessUnitId)|Unique identifier of the Business unit\.|<a href="EmailCcSent.md" target="_blank">CustomerInsightsJourneys/EmailCcSent</a>|
|[CopiesCount](#CopiesCount)|Indicates the count of CC recipients\.|<a href="EmailCcSent.md" target="_blank">CustomerInsightsJourneys/EmailCcSent</a>|
|[CustomerJourneyId](#CustomerJourneyId)| Unique identifier of the Customer journey|<a href="EmailCcSent.md" target="_blank">CustomerInsightsJourneys/EmailCcSent</a>|
|[EmailAddressUsed](#EmailAddressUsed)|The profile's email address\.|<a href="EmailCcSent.md" target="_blank">CustomerInsightsJourneys/EmailCcSent</a>|
|[IdempotencyId](#IdempotencyId)|Idempotency ID defines uniqueness of an analytics event\.|<a href="EmailCcSent.md" target="_blank">CustomerInsightsJourneys/EmailCcSent</a>|
...
|[InternalMarketingInteractionId](#InternalMarketingInteractionId)|Internal marketing interaction Id\.|<a href="EmailCcSent.md" target="_blank">CustomerInsightsJourneys/EmailCcSent</a>|
|[IsUnresolvedProfile](#IsUnresolvedProfile)||<a href="EmailCcSent.md" target="_blank">CustomerInsightsJourneys/EmailCcSent</a>|
|[JourneyActionId](#JourneyActionId)|GUID of the journey action step associated with this event\.|<a href="EmailCcSent.md" target="_blank">CustomerInsightsJourneys/EmailCcSent</a>|
|[JourneyRunId](#JourneyRunId)|Flow run ID of the Power Automate run instance associated with this event\.|<a href="EmailCcSent.md" target="_blank">CustomerInsightsJourneys/EmailCcSent</a>|
|[MessageId](#MessageId)|Message ID|<a href="EmailCcSent.md" target="_blank">CustomerInsightsJourneys/EmailCcSent</a>|
|[MessageTemplateVersion](#MessageTemplateVersion)|Message template version|<a href="EmailCcSent.md" target="_blank">CustomerInsightsJourneys/EmailCcSent</a>|
...
|[SourceSystem](#SourceSystem)| Refers to the source system that generated the interaction\. Outbound marketing \(OBM\) is represented by value 1\. Any other value than 1 represents Real-time journeys \(RTJ\)\.|<a href="EmailCcSent.md" target="_blank">CustomerInsightsJourneys/EmailCcSent</a>|
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>description</td><td>Indicates the count of CC recipients.</td></tr><tr><td>dataFormat</td><td>int32</td></tr></table>

#### Traits

<details>
<summary>List of traits for the CopiesCount attribute are listed below.</summary>
...
\*\*is\.dataFormat\.numeric\*\*  
  \*\*is\.localized\.describedAs\*\*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Indicates the count of CC recipients.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
