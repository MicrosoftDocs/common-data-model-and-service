---
title: EventRegistration in CustomerInsightsJourneys - Common Data Model | Microsoft Docs
description: Logged when event registration is created.
...
# EventRegistration in CustomerInsightsJourneys

Logged when event registration is created\.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/CustomerInsightsJourneys/EventRegistration.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[AccountId](#AccountId)|Unique identifier of the Account\.|<a href="EventRegistration.md" target="_blank">CustomerInsightsJourneys/EventRegistration</a>|
|[ActivityExpiryTime](#ActivityExpiryTime)|Activity expiry time|<a href="EventRegistration.md" target="_blank">CustomerInsightsJourneys/EventRegistration</a>|
|[ActivityId](#ActivityId)|Unique identifier of the Activity\.|<a href="EventRegistration.md" target="_blank">CustomerInsightsJourneys/EventRegistration</a>|
|[BindingId](#BindingId)|Binding ID|<a href="EventRegistration.md" target="_blank">CustomerInsightsJourneys/EventRegistration</a>|
|[BusinessUnitId](#BusinessUnitId)|Unique identifier of the Business unit\.|<a href="EventRegistration.md" target="_blank">CustomerInsightsJourneys/EventRegistration</a>|
|[ContactId](#ContactId)|Unique identifier of the Contact\.|<a href="EventRegistration.md" target="_blank">CustomerInsightsJourneys/EventRegistration</a>|
|[CustomerJourneyId](#CustomerJourneyId)| Unique identifier of the Customer journey|<a href="EventRegistration.md" target="_blank">CustomerInsightsJourneys/EventRegistration</a>|
|[CustomerJourneyIterationId](#CustomerJourneyIterationId)|Customer journey iteration ID|<a href="EventRegistration.md" target="_blank">CustomerInsightsJourneys/EventRegistration</a>|
|[EventId](#EventId)|Event ID|<a href="EventRegistration.md" target="_blank">CustomerInsightsJourneys/EventRegistration</a>|
|[EventRegistrationId](#EventRegistrationId)|Event registration ID|<a href="EventRegistration.md" target="_blank">CustomerInsightsJourneys/EventRegistration</a>|
|[IdempotencyId](#IdempotencyId)|Idempotency ID defines uniqueness of an analytics event\.|<a href="EventRegistration.md" target="_blank">CustomerInsightsJourneys/EventRegistration</a>|
|[InteractionType](#InteractionType)|Type of the interaction\.|<a href="EventRegistration.md" target="_blank">CustomerInsightsJourneys/EventRegistration</a>|
|[InternalMarketingInteractionId](#InternalMarketingInteractionId)|Internal marketing interaction Id\.|<a href="EventRegistration.md" target="_blank">CustomerInsightsJourneys/EventRegistration</a>|
|[IsUnresolvedProfile](#IsUnresolvedProfile)||<a href="EventRegistration.md" target="_blank">CustomerInsightsJourneys/EventRegistration</a>|
|[JourneyActionId](#JourneyActionId)|GUID of the journey action step associated with this event\.|<a href="EventRegistration.md" target="_blank">CustomerInsightsJourneys/EventRegistration</a>|
|[JourneyRunId](#JourneyRunId)|Flow run ID of the Power Automate run instance associated with this event\.|<a href="EventRegistration.md" target="_blank">CustomerInsightsJourneys/EventRegistration</a>|
...
|[SourceSystem](#SourceSystem)| Refers to the source system that generated the interaction\. Outbound marketing \(OBM\) is represented by value 1\. Any other value than 1 represents Real-time journeys \(RTJ\)\.|<a href="EventRegistration.md" target="_blank">CustomerInsightsJourneys/EventRegistration</a>|
