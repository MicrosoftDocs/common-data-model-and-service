...
|[InteractionType](#InteractionType)|Type of the interaction.|<a href="CustomNotSent.md" target="_blank">CustomerInsightsJourneys/CustomNotSent</a>|
|[InternalMarketingInteractionId](#InternalMarketingInteractionId)|Internal marketing interaction Id.|<a href="CustomNotSent.md" target="_blank">CustomerInsightsJourneys/CustomNotSent</a>|
|[IsUnresolvedProfile](#IsUnresolvedProfile)||<a href="CustomNotSent.md" target="_blank">CustomerInsightsJourneys/CustomNotSent</a>|
|[JourneyActionId](#JourneyActionId)|GUID of the journey action step associated with this event.|<a href="CustomNotSent.md" target="_blank">CustomerInsightsJourneys/CustomNotSent</a>|
|[JourneyRunId](#JourneyRunId)|Flow run ID of the Power Automate run instance associated with this event.|<a href="CustomNotSent.md" target="_blank">CustomerInsightsJourneys/CustomNotSent</a>|
|[MessageId](#MessageId)|Message ID|<a href="CustomNotSent.md" target="_blank">CustomerInsightsJourneys/CustomNotSent</a>|
|[MessageTemplateVersion](#MessageTemplateVersion)|Message template version|<a href="CustomNotSent.md" target="_blank">CustomerInsightsJourneys/CustomNotSent</a>|
|[MessageVariationIndexes](#MessageVariationIndexes)||<a href="CustomNotSent.md" target="_blank">CustomerInsightsJourneys/CustomNotSent</a>|
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>description</td><td>Reason the message was blocked</td></tr><tr><td>dataFormat</td><td>string</td></tr></table>
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason the message was blocked</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>description</td><td>Unique identifier of the custom channel</td></tr><tr><td>dataFormat</td><td>guid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the ChannelDefinitionId attribute are listed below.</summary>
...
**is.dataFormat.guid**  
  **is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Unique identifier of the custom channel</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>description</td><td>Type of the channel (custom, sms, push, email)</td></tr><tr><td>dataFormat</td><td>string</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>description</td><td>Contains additional information about the event</td></tr><tr><td>dataFormat</td><td>string</td></tr></table>
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Contains additional information about the event</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>description</td><td>Receipient of the custom message</td></tr><tr><td>dataFormat</td><td>string</td></tr></table>
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Receipient of the custom message</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>description</td><td>Sender of the custom message</td></tr><tr><td>dataFormat</td><td>string</td></tr></table>
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Sender of the custom message</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
