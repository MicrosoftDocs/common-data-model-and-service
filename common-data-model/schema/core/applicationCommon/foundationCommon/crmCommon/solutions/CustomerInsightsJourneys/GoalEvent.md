---
title: GoalEvent in CustomerInsightsJourneys - Common Data Model | Microsoft Docs
description: Logged when a customer meets the goal for the journey
...
# GoalEvent in CustomerInsightsJourneys

Logged when a customer meets the goal for the journey  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/CustomerInsightsJourneys/GoalEvent.cdm.json" target="_blank">GitHub</a>.  
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Logged when a customer meets the goal for the journey</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[BusinessUnitId](#BusinessUnitId)|Unique identifier of the Business unit\.|<a href="GoalEvent.md" target="_blank">CustomerInsightsJourneys/GoalEvent</a>|
|[CustomerJourneyId](#CustomerJourneyId)| Unique identifier of the Customer journey|<a href="GoalEvent.md" target="_blank">CustomerInsightsJourneys/GoalEvent</a>|
|[GoalEventId](#GoalEventId)|Goal event id\.|<a href="GoalEvent.md" target="_blank">CustomerInsightsJourneys/GoalEvent</a>|
|[IdempotencyId](#IdempotencyId)|Idempotency ID defines uniqueness of an analytics event\.|<a href="GoalEvent.md" target="_blank">CustomerInsightsJourneys/GoalEvent</a>|
|[InteractionType](#InteractionType)|Type of the interaction\.|<a href="GoalEvent.md" target="_blank">CustomerInsightsJourneys/GoalEvent</a>|
|[InternalMarketingInteractionId](#InternalMarketingInteractionId)|Internal marketing interaction Id\.|<a href="GoalEvent.md" target="_blank">CustomerInsightsJourneys/GoalEvent</a>|
|[IsUnresolvedProfile](#IsUnresolvedProfile)||<a href="GoalEvent.md" target="_blank">CustomerInsightsJourneys/GoalEvent</a>|
|[JourneyActionId](#JourneyActionId)|GUID of the journey action step associated with this event\.|<a href="GoalEvent.md" target="_blank">CustomerInsightsJourneys/GoalEvent</a>|
|[JourneyRunId](#JourneyRunId)|Flow run ID of the Power Automate run instance associated with this event\.|<a href="GoalEvent.md" target="_blank">CustomerInsightsJourneys/GoalEvent</a>|
|[MessageId](#MessageId)|Message ID|<a href="GoalEvent.md" target="_blank">CustomerInsightsJourneys/GoalEvent</a>|
|[MessageTemplateVersion](#MessageTemplateVersion)|Message template version|<a href="GoalEvent.md" target="_blank">CustomerInsightsJourneys/GoalEvent</a>|
...
### <a href=#GoalEventId name="GoalEventId">GoalEventId</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>description</td><td>Goal event id.</td></tr><tr><td>dataFormat</td><td>string</td></tr></table>

#### Traits

<details>
<summary>List of traits for the GoalEventId attribute are listed below.</summary>
...
\*\*is\.localized\.describedAs\*\*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Goal event id.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
