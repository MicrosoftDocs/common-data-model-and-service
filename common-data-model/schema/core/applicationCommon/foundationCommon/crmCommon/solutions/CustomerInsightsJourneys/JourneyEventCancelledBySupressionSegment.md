---
title: JourneyEventCancelledBySupressionSegment in CustomerInsightsJourneys - Common Data Model | Microsoft Docs
description: Logged when a customer does not go to the next journey step because they belong to a suppression segment which excludes them from the journey
...
# JourneyEventCancelledBySupressionSegment in CustomerInsightsJourneys

Logged when a customer does not go to the next journey step because they belong to a suppression segment which excludes them from the journey  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/CustomerInsightsJourneys/JourneyEventCancelledBySupressionSegment.cdm.json" target="_blank">GitHub</a>.  
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Logged when a customer does not go to the next journey step because they belong to a suppression segment which excludes them from the journey</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[BusinessUnitId](#BusinessUnitId)|Unique identifier of the Business unit\.|<a href="JourneyEventCancelledBySupressionSegment.md" target="_blank">CustomerInsightsJourneys/JourneyEventCancelledBySupressionSegment</a>|
|[CustomerJourneyId](#CustomerJourneyId)| Unique identifier of the Customer journey|<a href="JourneyEventCancelledBySupressionSegment.md" target="_blank">CustomerInsightsJourneys/JourneyEventCancelledBySupressionSegment</a>|
|[DropoffId](#DropoffId)|Unique identifier for events that cause a person to leave the journey\.|<a href="JourneyEventCancelledBySupressionSegment.md" target="_blank">CustomerInsightsJourneys/JourneyEventCancelledBySupressionSegment</a>|
|[IdempotencyId](#IdempotencyId)|Idempotency ID defines uniqueness of an analytics event\.|<a href="JourneyEventCancelledBySupressionSegment.md" target="_blank">CustomerInsightsJourneys/JourneyEventCancelledBySupressionSegment</a>|
|[InteractionType](#InteractionType)|Type of the interaction\.|<a href="JourneyEventCancelledBySupressionSegment.md" target="_blank">CustomerInsightsJourneys/JourneyEventCancelledBySupressionSegment</a>|
|[InternalMarketingInteractionId](#InternalMarketingInteractionId)|Internal marketing interaction Id\.|<a href="JourneyEventCancelledBySupressionSegment.md" target="_blank">CustomerInsightsJourneys/JourneyEventCancelledBySupressionSegment</a>|
|[IsUnresolvedProfile](#IsUnresolvedProfile)||<a href="JourneyEventCancelledBySupressionSegment.md" target="_blank">CustomerInsightsJourneys/JourneyEventCancelledBySupressionSegment</a>|
|[JourneyActionId](#JourneyActionId)|GUID of the journey action step associated with this event\.|<a href="JourneyEventCancelledBySupressionSegment.md" target="_blank">CustomerInsightsJourneys/JourneyEventCancelledBySupressionSegment</a>|
|[JourneyRunId](#JourneyRunId)|Flow run ID of the Power Automate run instance associated with this event\.|<a href="JourneyEventCancelledBySupressionSegment.md" target="_blank">CustomerInsightsJourneys/JourneyEventCancelledBySupressionSegment</a>|
|[JourneyStatus](#JourneyStatus)|Describes the results of processing a person entering a journey\. Indicates if a person was allowed or blocked from starting the journey\.|<a href="JourneyEventCancelledBySupressionSegment.md" target="_blank">CustomerInsightsJourneys/JourneyEventCancelledBySupressionSegment</a>|
|[JourneyVersion](#JourneyVersion)|Version number of the journey\.|<a href="JourneyEventCancelledBySupressionSegment.md" target="_blank">CustomerInsightsJourneys/JourneyEventCancelledBySupressionSegment</a>|
|[MessageId](#MessageId)|Message ID|<a href="JourneyEventCancelledBySupressionSegment.md" target="_blank">CustomerInsightsJourneys/JourneyEventCancelledBySupressionSegment</a>|
|[MessageTemplateVersion](#MessageTemplateVersion)|Message template version|<a href="JourneyEventCancelledBySupressionSegment.md" target="_blank">CustomerInsightsJourneys/JourneyEventCancelledBySupressionSegment</a>|
|[OrganizationId](#OrganizationId)|Organization Id\.|<a href="JourneyEventCancelledBySupressionSegment.md" target="_blank">CustomerInsightsJourneys/JourneyEventCancelledBySupressionSegment</a>|
|[ProfileId](#ProfileId)|Unique identifier of the profile\.|<a href="JourneyEventCancelledBySupressionSegment.md" target="_blank">CustomerInsightsJourneys/JourneyEventCancelledBySupressionSegment</a>|
|[ProfileType](#ProfileType)|The profile type \(Contact, Lead or CI Profile\)|<a href="JourneyEventCancelledBySupressionSegment.md" target="_blank">CustomerInsightsJourneys/JourneyEventCancelledBySupressionSegment</a>|
|[Reason](#Reason)|Journey status reason|<a href="JourneyEventCancelledBySupressionSegment.md" target="_blank">CustomerInsightsJourneys/JourneyEventCancelledBySupressionSegment</a>|
