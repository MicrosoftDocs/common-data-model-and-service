---
title: JourneyEventPreEntryDropoff in CustomerInsightsJourneys - Common Data Model | Microsoft Docs
description: Logged when a customer drops off before attempting to enter a journey
...
# JourneyEventPreEntryDropoff in CustomerInsightsJourneys

Logged when a customer drops off before attempting to enter a journey  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/CustomerInsightsJourneys/JourneyEventPreEntryDropoff.cdm.json" target="_blank">GitHub</a>.  
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Logged when a customer drops off before attempting to enter a journey</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[BusinessUnitId](#BusinessUnitId)|Unique identifier of the Business unit\.|<a href="JourneyEventPreEntryDropoff.md" target="_blank">CustomerInsightsJourneys/JourneyEventPreEntryDropoff</a>|
|[CustomerJourneyId](#CustomerJourneyId)| Unique identifier of the Customer journey|<a href="JourneyEventPreEntryDropoff.md" target="_blank">CustomerInsightsJourneys/JourneyEventPreEntryDropoff</a>|
|[DropoffId](#DropoffId)|Unique identifier for events that cause a person to leave the journey\.|<a href="JourneyEventPreEntryDropoff.md" target="_blank">CustomerInsightsJourneys/JourneyEventPreEntryDropoff</a>|
|[IdempotencyId](#IdempotencyId)|Idempotency ID defines uniqueness of an analytics event\.|<a href="JourneyEventPreEntryDropoff.md" target="_blank">CustomerInsightsJourneys/JourneyEventPreEntryDropoff</a>|
|[InteractionType](#InteractionType)|Type of the interaction\.|<a href="JourneyEventPreEntryDropoff.md" target="_blank">CustomerInsightsJourneys/JourneyEventPreEntryDropoff</a>|
|[InternalMarketingInteractionId](#InternalMarketingInteractionId)|Internal marketing interaction Id\.|<a href="JourneyEventPreEntryDropoff.md" target="_blank">CustomerInsightsJourneys/JourneyEventPreEntryDropoff</a>|
|[IsUnresolvedProfile](#IsUnresolvedProfile)||<a href="JourneyEventPreEntryDropoff.md" target="_blank">CustomerInsightsJourneys/JourneyEventPreEntryDropoff</a>|
|[JourneyActionId](#JourneyActionId)|GUID of the journey action step associated with this event\.|<a href="JourneyEventPreEntryDropoff.md" target="_blank">CustomerInsightsJourneys/JourneyEventPreEntryDropoff</a>|
|[JourneyRunId](#JourneyRunId)|Flow run ID of the Power Automate run instance associated with this event\.|<a href="JourneyEventPreEntryDropoff.md" target="_blank">CustomerInsightsJourneys/JourneyEventPreEntryDropoff</a>|
|[JourneyStatus](#JourneyStatus)|Describes the results of processing a person entering a journey\. Indicates if a person was allowed or blocked from starting the journey\.|<a href="JourneyEventPreEntryDropoff.md" target="_blank">CustomerInsightsJourneys/JourneyEventPreEntryDropoff</a>|
|[JourneyVersion](#JourneyVersion)|Version number of the journey\.|<a href="JourneyEventPreEntryDropoff.md" target="_blank">CustomerInsightsJourneys/JourneyEventPreEntryDropoff</a>|
|[MessageId](#MessageId)|Message ID|<a href="JourneyEventPreEntryDropoff.md" target="_blank">CustomerInsightsJourneys/JourneyEventPreEntryDropoff</a>|
|[MessageTemplateVersion](#MessageTemplateVersion)|Message template version|<a href="JourneyEventPreEntryDropoff.md" target="_blank">CustomerInsightsJourneys/JourneyEventPreEntryDropoff</a>|
|[OrganizationId](#OrganizationId)|Organization Id\.|<a href="JourneyEventPreEntryDropoff.md" target="_blank">CustomerInsightsJourneys/JourneyEventPreEntryDropoff</a>|
|[ProfileId](#ProfileId)|Unique identifier of the profile\.|<a href="JourneyEventPreEntryDropoff.md" target="_blank">CustomerInsightsJourneys/JourneyEventPreEntryDropoff</a>|
|[ProfileType](#ProfileType)|The profile type \(Contact, Lead or CI Profile\)|<a href="JourneyEventPreEntryDropoff.md" target="_blank">CustomerInsightsJourneys/JourneyEventPreEntryDropoff</a>|
|[Reason](#Reason)|Journey status reason|<a href="JourneyEventPreEntryDropoff.md" target="_blank">CustomerInsightsJourneys/JourneyEventPreEntryDropoff</a>|
