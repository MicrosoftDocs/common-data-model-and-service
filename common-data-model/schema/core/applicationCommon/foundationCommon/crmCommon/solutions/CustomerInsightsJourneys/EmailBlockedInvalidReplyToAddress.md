---
title: EmailBlockedInvalidReplyToAddress in CustomerInsightsJourneys - Common Data Model | Microsoft Docs
...
# EmailBlockedInvalidReplyToAddress in CustomerInsightsJourneys

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/CustomerInsightsJourneys/EmailBlockedInvalidReplyToAddress.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[BlockedReason](#BlockedReason)|Indicates the reason for email block.|<a href="EmailBlockedInvalidReplyToAddress.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInvalidReplyToAddress</a>|
|[BusinessUnitId](#BusinessUnitId)|Unique identifier of the Business unit.|<a href="EmailBlockedInvalidReplyToAddress.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInvalidReplyToAddress</a>|
|[Category](#Category)|Category|<a href="EmailBlockedInvalidReplyToAddress.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInvalidReplyToAddress</a>|
|[CustomerJourneyId](#CustomerJourneyId)| Unique identifier of the Customer journey|<a href="EmailBlockedInvalidReplyToAddress.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInvalidReplyToAddress</a>|
|[Details](#Details)|Contains additional information regarding the reason of block.|<a href="EmailBlockedInvalidReplyToAddress.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInvalidReplyToAddress</a>|
|[EmailAddressUsed](#EmailAddressUsed)|The profile's email address.|<a href="EmailBlockedInvalidReplyToAddress.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInvalidReplyToAddress</a>|
|[IdempotencyId](#IdempotencyId)|Idempotency ID defines uniqueness of an analytics event.|<a href="EmailBlockedInvalidReplyToAddress.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInvalidReplyToAddress</a>|
|[InteractionType](#InteractionType)|Type of the interaction.|<a href="EmailBlockedInvalidReplyToAddress.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInvalidReplyToAddress</a>|
|[InternalMarketingInteractionId](#InternalMarketingInteractionId)|Internal marketing interaction Id.|<a href="EmailBlockedInvalidReplyToAddress.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInvalidReplyToAddress</a>|
|[IsUnresolvedProfile](#IsUnresolvedProfile)||<a href="EmailBlockedInvalidReplyToAddress.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInvalidReplyToAddress</a>|
|[JourneyActionId](#JourneyActionId)|GUID of the journey action step associated with this event.|<a href="EmailBlockedInvalidReplyToAddress.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInvalidReplyToAddress</a>|
|[JourneyRunId](#JourneyRunId)|Flow run ID of the Power Automate run instance associated with this event.|<a href="EmailBlockedInvalidReplyToAddress.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInvalidReplyToAddress</a>|
|[MessageId](#MessageId)|Message ID|<a href="EmailBlockedInvalidReplyToAddress.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInvalidReplyToAddress</a>|
|[MessageTemplateVersion](#MessageTemplateVersion)|Message template version|<a href="EmailBlockedInvalidReplyToAddress.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInvalidReplyToAddress</a>|
|[MessageVariationIndexes](#MessageVariationIndexes)||<a href="EmailBlockedInvalidReplyToAddress.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInvalidReplyToAddress</a>|
|[MessageVariationName](#MessageVariationName)||<a href="EmailBlockedInvalidReplyToAddress.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInvalidReplyToAddress</a>|
|[OrganizationId](#OrganizationId)|Organization Id.|<a href="EmailBlockedInvalidReplyToAddress.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInvalidReplyToAddress</a>|
|[ProfileId](#ProfileId)|Unique identifier of the profile.|<a href="EmailBlockedInvalidReplyToAddress.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInvalidReplyToAddress</a>|
|[ProfileType](#ProfileType)|The profile type (Contact, Lead or CI Profile)|<a href="EmailBlockedInvalidReplyToAddress.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInvalidReplyToAddress</a>|
|[SourceSystem](#SourceSystem)| Refers to the source system that generated the interaction. Outbound marketing (OBM) is represented by value 1. Any other value than 1 represents Real\x2dtime journeys (RTJ).|<a href="EmailBlockedInvalidReplyToAddress.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInvalidReplyToAddress</a>|
|[Timestamp](#Timestamp)|Indicates the exact date and time when the interaction was emitted.|<a href="EmailBlockedInvalidReplyToAddress.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInvalidReplyToAddress</a>|
|[Version](#Version)|Interaction version. Used for updating the interaction.|<a href="EmailBlockedInvalidReplyToAddress.md" target="_blank">CustomerInsightsJourneys/EmailBlockedInvalidReplyToAddress</a>|

### <a href=#BlockedReason name="BlockedReason">BlockedReason</a>

Indicates the reason for email block.  
First included in: CustomerInsightsJourneys/EmailBlockedInvalidReplyToAddress (this entity)  
