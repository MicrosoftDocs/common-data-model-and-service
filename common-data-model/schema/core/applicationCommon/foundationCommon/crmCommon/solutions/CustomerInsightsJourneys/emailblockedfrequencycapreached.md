...
|---|---|---|
|[BlockedReason](#BlockedReason)|Indicates the reason for email block.|<a href="EmailBlockedFrequencyCapReached.md" target="_blank">CustomerInsightsJourneys/EmailBlockedFrequencyCapReached</a>|
|[BusinessUnitId](#BusinessUnitId)|Unique identifier of the Business unit.|<a href="EmailBlockedFrequencyCapReached.md" target="_blank">CustomerInsightsJourneys/EmailBlockedFrequencyCapReached</a>|
|[Category](#Category)|Category|<a href="EmailBlockedFrequencyCapReached.md" target="_blank">CustomerInsightsJourneys/EmailBlockedFrequencyCapReached</a>|
|[CustomerJourneyId](#CustomerJourneyId)| Unique identifier of the Customer journey|<a href="EmailBlockedFrequencyCapReached.md" target="_blank">CustomerInsightsJourneys/EmailBlockedFrequencyCapReached</a>|
|[Details](#Details)|Contains additional information regarding the reason of block.|<a href="EmailBlockedFrequencyCapReached.md" target="_blank">CustomerInsightsJourneys/EmailBlockedFrequencyCapReached</a>|
|[EmailAddressUsed](#EmailAddressUsed)|The profile's email address.|<a href="EmailBlockedFrequencyCapReached.md" target="_blank">CustomerInsightsJourneys/EmailBlockedFrequencyCapReached</a>|
|[IdempotencyId](#IdempotencyId)|Idempotency ID defines uniqueness of an analytics event.|<a href="EmailBlockedFrequencyCapReached.md" target="_blank">CustomerInsightsJourneys/EmailBlockedFrequencyCapReached</a>|
|[InteractionType](#InteractionType)|Type of the interaction.|<a href="EmailBlockedFrequencyCapReached.md" target="_blank">CustomerInsightsJourneys/EmailBlockedFrequencyCapReached</a>|
|[InternalMarketingInteractionId](#InternalMarketingInteractionId)|Internal marketing interaction Id.|<a href="EmailBlockedFrequencyCapReached.md" target="_blank">CustomerInsightsJourneys/EmailBlockedFrequencyCapReached</a>|
...
|[JourneyActionId](#JourneyActionId)|GUID of the journey action step associated with this event.|<a href="EmailBlockedFrequencyCapReached.md" target="_blank">CustomerInsightsJourneys/EmailBlockedFrequencyCapReached</a>|
|[JourneyRunId](#JourneyRunId)|Flow run ID of the Power Automate run instance associated with this event.|<a href="EmailBlockedFrequencyCapReached.md" target="_blank">CustomerInsightsJourneys/EmailBlockedFrequencyCapReached</a>|
|[MessageId](#MessageId)|Message ID|<a href="EmailBlockedFrequencyCapReached.md" target="_blank">CustomerInsightsJourneys/EmailBlockedFrequencyCapReached</a>|
|[MessageTemplateVersion](#MessageTemplateVersion)|Message template version|<a href="EmailBlockedFrequencyCapReached.md" target="_blank">CustomerInsightsJourneys/EmailBlockedFrequencyCapReached</a>|
...
|[OrganizationId](#OrganizationId)|Organization Id.|<a href="EmailBlockedFrequencyCapReached.md" target="_blank">CustomerInsightsJourneys/EmailBlockedFrequencyCapReached</a>|
|[ProfileId](#ProfileId)|Unique identifier of the profile.|<a href="EmailBlockedFrequencyCapReached.md" target="_blank">CustomerInsightsJourneys/EmailBlockedFrequencyCapReached</a>|
|[ProfileType](#ProfileType)|The profile type \(Contact, Lead or CI Profile\)|<a href="EmailBlockedFrequencyCapReached.md" target="_blank">CustomerInsightsJourneys/EmailBlockedFrequencyCapReached</a>|
|[SourceSystem](#SourceSystem)| Refers to the source system that generated the interaction. Outbound marketing \(OBM\) is represented by value 1. Any other value than 1 represents Real\x2dtime journeys \(RTJ\).|<a href="EmailBlockedFrequencyCapReached.md" target="_blank">CustomerInsightsJourneys/EmailBlockedFrequencyCapReached</a>|
|[Timestamp](#Timestamp)|Indicates the exact date and time when the interaction was emitted.|<a href="EmailBlockedFrequencyCapReached.md" target="_blank">CustomerInsightsJourneys/EmailBlockedFrequencyCapReached</a>|
|[Version](#Version)|Interaction version. Used for updating the interaction.|<a href="EmailBlockedFrequencyCapReached.md" target="_blank">CustomerInsightsJourneys/EmailBlockedFrequencyCapReached</a>|
