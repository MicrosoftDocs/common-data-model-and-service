---
title: PushNotificationNotSent in CustomerInsightsJourneys - Common Data Model | Microsoft Docs
description: Indicates a push notification failed to send.
...
# PushNotificationNotSent in CustomerInsightsJourneys

Indicates a push notification failed to send\.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/CustomerInsightsJourneys/PushNotificationNotSent.cdm.json" target="_blank">GitHub</a>.  
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Indicates a push notification failed to send.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|[BusinessUnitId](#BusinessUnitId)|Unique identifier of the Business unit\.|<a href="PushNotificationNotSent.md" target="_blank">CustomerInsightsJourneys/PushNotificationNotSent</a>|
|[CustomerJourneyId](#CustomerJourneyId)| Unique identifier of the Customer journey|<a href="PushNotificationNotSent.md" target="_blank">CustomerInsightsJourneys/PushNotificationNotSent</a>|
|[Details](#Details)|Contains additional information regarding the reason of block\.|<a href="PushNotificationNotSent.md" target="_blank">CustomerInsightsJourneys/PushNotificationNotSent</a>|
...
|[IdempotencyId](#IdempotencyId)|Idempotency ID defines uniqueness of an analytics event\.|<a href="PushNotificationNotSent.md" target="_blank">CustomerInsightsJourneys/PushNotificationNotSent</a>|
...
|[InternalMarketingInteractionId](#InternalMarketingInteractionId)|Internal marketing interaction Id\.|<a href="PushNotificationNotSent.md" target="_blank">CustomerInsightsJourneys/PushNotificationNotSent</a>|
...
|[JourneyActionId](#JourneyActionId)|GUID of the journey action step associated with this event\.|<a href="PushNotificationNotSent.md" target="_blank">CustomerInsightsJourneys/PushNotificationNotSent</a>|
|[JourneyRunId](#JourneyRunId)|Flow run ID of the Power Automate run instance associated with this event\.|<a href="PushNotificationNotSent.md" target="_blank">CustomerInsightsJourneys/PushNotificationNotSent</a>|
...
|[MessageTemplateVersion](#MessageTemplateVersion)|Message template version|<a href="PushNotificationNotSent.md" target="_blank">CustomerInsightsJourneys/PushNotificationNotSent</a>|
...
|[PushNotificationId](#PushNotificationId)|Unique identifier of the Push notification entity|<a href="PushNotificationNotSent.md" target="_blank">CustomerInsightsJourneys/PushNotificationNotSent</a>|
|[SourceSystem](#SourceSystem)| Refers to the source system that generated the interaction\. Outbound marketing \(OBM\) is represented by value 1\. Any other value than 1 represents Real-time journeys \(RTJ\)\.|<a href="PushNotificationNotSent.md" target="_blank">CustomerInsightsJourneys/PushNotificationNotSent</a>|
