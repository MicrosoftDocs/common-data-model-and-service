---
title: MissingDataAccessPrivileges in CustomerInsightsJourneys - Common Data Model | Microsoft Docs
...
# MissingDataAccessPrivileges in CustomerInsightsJourneys

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/CustomerInsightsJourneys/MissingDataAccessPrivileges.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[AccountId](#AccountId)|Unique identifier of the Account\.|<a href="MissingDataAccessPrivileges.md" target="_blank">CustomerInsightsJourneys/MissingDataAccessPrivileges</a>|
|[ActivityExpiryTime](#ActivityExpiryTime)|Activity expiry time|<a href="MissingDataAccessPrivileges.md" target="_blank">CustomerInsightsJourneys/MissingDataAccessPrivileges</a>|
|[ActivityId](#ActivityId)|Unique identifier of the Activity\.|<a href="MissingDataAccessPrivileges.md" target="_blank">CustomerInsightsJourneys/MissingDataAccessPrivileges</a>|
|[BusinessUnitId](#BusinessUnitId)|Unique identifier of the Business unit\.|<a href="MissingDataAccessPrivileges.md" target="_blank">CustomerInsightsJourneys/MissingDataAccessPrivileges</a>|
|[ContactId](#ContactId)|Unique identifier of the Contact\.|<a href="MissingDataAccessPrivileges.md" target="_blank">CustomerInsightsJourneys/MissingDataAccessPrivileges</a>|
|[CustomerJourneyId](#CustomerJourneyId)| Unique identifier of the Customer journey|<a href="MissingDataAccessPrivileges.md" target="_blank">CustomerInsightsJourneys/MissingDataAccessPrivileges</a>|
|[CustomerJourneyIterationId](#CustomerJourneyIterationId)|Customer journey iteration ID|<a href="MissingDataAccessPrivileges.md" target="_blank">CustomerInsightsJourneys/MissingDataAccessPrivileges</a>|
|[EntityName](#EntityName)|The entity name\.|<a href="MissingDataAccessPrivileges.md" target="_blank">CustomerInsightsJourneys/MissingDataAccessPrivileges</a>|
|[IdempotencyId](#IdempotencyId)|Idempotency ID defines uniqueness of an analytics event\.|<a href="MissingDataAccessPrivileges.md" target="_blank">CustomerInsightsJourneys/MissingDataAccessPrivileges</a>|
|[InteractionType](#InteractionType)|Type of the interaction\.|<a href="MissingDataAccessPrivileges.md" target="_blank">CustomerInsightsJourneys/MissingDataAccessPrivileges</a>|
|[InternalMarketingInteractionId](#InternalMarketingInteractionId)|Internal marketing interaction Id\.|<a href="MissingDataAccessPrivileges.md" target="_blank">CustomerInsightsJourneys/MissingDataAccessPrivileges</a>|
|[LeadId](#LeadId)|Unique identifier of the Lead\.|<a href="MissingDataAccessPrivileges.md" target="_blank">CustomerInsightsJourneys/MissingDataAccessPrivileges</a>|
|[MessageId](#MessageId)|Message ID|<a href="MissingDataAccessPrivileges.md" target="_blank">CustomerInsightsJourneys/MissingDataAccessPrivileges</a>|
|[OrganizationId](#OrganizationId)|Organization Id\.|<a href="MissingDataAccessPrivileges.md" target="_blank">CustomerInsightsJourneys/MissingDataAccessPrivileges</a>|
|[ProfileId](#ProfileId)|Unique identifier of the profile\.|<a href="MissingDataAccessPrivileges.md" target="_blank">CustomerInsightsJourneys/MissingDataAccessPrivileges</a>|
|[ProfileType](#ProfileType)|The profile type \(Contact, Lead or CI Profile\)|<a href="MissingDataAccessPrivileges.md" target="_blank">CustomerInsightsJourneys/MissingDataAccessPrivileges</a>|
|[SendingId](#SendingId)|Indicates the journey iteration ID\.|<a href="MissingDataAccessPrivileges.md" target="_blank">CustomerInsightsJourneys/MissingDataAccessPrivileges</a>|
|[SourceSystem](#SourceSystem)| Refers to the source system that generated the interaction\. Outbound marketing \(OBM\) is represented by value 1\. Any other value than 1 represents Real\x2dtime journeys \(RTJ\)\.|<a href="MissingDataAccessPrivileges.md" target="_blank">CustomerInsightsJourneys/MissingDataAccessPrivileges</a>|
|[Timestamp](#Timestamp)|Indicates the exact date and time when the interaction was emitted\.|<a href="MissingDataAccessPrivileges.md" target="_blank">CustomerInsightsJourneys/MissingDataAccessPrivileges</a>|
|[UsageType](#UsageType)|Usage type|<a href="MissingDataAccessPrivileges.md" target="_blank">CustomerInsightsJourneys/MissingDataAccessPrivileges</a>|
|[Version](#Version)|Interaction version\. Used for updating the interaction\.|<a href="MissingDataAccessPrivileges.md" target="_blank">CustomerInsightsJourneys/MissingDataAccessPrivileges</a>|
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>description</td><td>The entity name.</td></tr><tr><td>dataFormat</td><td>string</td></tr></table>
...
\*\*is\.localized\.describedAs\*\*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>The entity name.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
