---
title: SessionRegistrationCreatedFromWaitlist in CustomerInsightsJourneys - Common Data Model | Microsoft Docs
...
# SessionRegistrationCreatedFromWaitlist in CustomerInsightsJourneys

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/CustomerInsightsJourneys/SessionRegistrationCreatedFromWaitlist.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[AccountId](#AccountId)|Unique identifier of the Account\.|<a href="SessionRegistrationCreatedFromWaitlist.md" target="_blank">CustomerInsightsJourneys/SessionRegistrationCreatedFromWaitlist</a>|
|[BindingId](#BindingId)||<a href="SessionRegistrationCreatedFromWaitlist.md" target="_blank">CustomerInsightsJourneys/SessionRegistrationCreatedFromWaitlist</a>|
|[BusinessUnitId](#BusinessUnitId)|Unique identifier of the Business unit\.|<a href="SessionRegistrationCreatedFromWaitlist.md" target="_blank">CustomerInsightsJourneys/SessionRegistrationCreatedFromWaitlist</a>|
|[ContactId](#ContactId)|Unique identifier of the Contact\.|<a href="SessionRegistrationCreatedFromWaitlist.md" target="_blank">CustomerInsightsJourneys/SessionRegistrationCreatedFromWaitlist</a>|
|[CustomerJourneyId](#CustomerJourneyId)| Unique identifier of the Customer journey|<a href="SessionRegistrationCreatedFromWaitlist.md" target="_blank">CustomerInsightsJourneys/SessionRegistrationCreatedFromWaitlist</a>|
|[EventId](#EventId)|Event ID|<a href="SessionRegistrationCreatedFromWaitlist.md" target="_blank">CustomerInsightsJourneys/SessionRegistrationCreatedFromWaitlist</a>|
|[IdempotencyId](#IdempotencyId)|Idempotency ID defines uniqueness of an analytics event\.|<a href="SessionRegistrationCreatedFromWaitlist.md" target="_blank">CustomerInsightsJourneys/SessionRegistrationCreatedFromWaitlist</a>|
|[InteractionType](#InteractionType)|Type of the interaction\.|<a href="SessionRegistrationCreatedFromWaitlist.md" target="_blank">CustomerInsightsJourneys/SessionRegistrationCreatedFromWaitlist</a>|
|[InternalMarketingInteractionId](#InternalMarketingInteractionId)|Internal marketing interaction Id\.|<a href="SessionRegistrationCreatedFromWaitlist.md" target="_blank">CustomerInsightsJourneys/SessionRegistrationCreatedFromWaitlist</a>|
|[IsUnresolvedProfile](#IsUnresolvedProfile)||<a href="SessionRegistrationCreatedFromWaitlist.md" target="_blank">CustomerInsightsJourneys/SessionRegistrationCreatedFromWaitlist</a>|
|[JourneyActionId](#JourneyActionId)|GUID of the journey action step associated with this event\.|<a href="SessionRegistrationCreatedFromWaitlist.md" target="_blank">CustomerInsightsJourneys/SessionRegistrationCreatedFromWaitlist</a>|
|[JourneyRunId](#JourneyRunId)|Flow run ID of the Power Automate run instance associated with this event\.|<a href="SessionRegistrationCreatedFromWaitlist.md" target="_blank">CustomerInsightsJourneys/SessionRegistrationCreatedFromWaitlist</a>|
|[MessageId](#MessageId)|Message ID|<a href="SessionRegistrationCreatedFromWaitlist.md" target="_blank">CustomerInsightsJourneys/SessionRegistrationCreatedFromWaitlist</a>|
|[MessageTemplateVersion](#MessageTemplateVersion)|Message template version|<a href="SessionRegistrationCreatedFromWaitlist.md" target="_blank">CustomerInsightsJourneys/SessionRegistrationCreatedFromWaitlist</a>|
|[OrganizationId](#OrganizationId)|Organization Id\.|<a href="SessionRegistrationCreatedFromWaitlist.md" target="_blank">CustomerInsightsJourneys/SessionRegistrationCreatedFromWaitlist</a>|
|[ProfileId](#ProfileId)|Unique identifier of the profile\.|<a href="SessionRegistrationCreatedFromWaitlist.md" target="_blank">CustomerInsightsJourneys/SessionRegistrationCreatedFromWaitlist</a>|
|[ProfileType](#ProfileType)|The profile type \(Contact, Lead or CI Profile\)|<a href="SessionRegistrationCreatedFromWaitlist.md" target="_blank">CustomerInsightsJourneys/SessionRegistrationCreatedFromWaitlist</a>|
|[SessionId](#SessionId)|Session ID|<a href="SessionRegistrationCreatedFromWaitlist.md" target="_blank">CustomerInsightsJourneys/SessionRegistrationCreatedFromWaitlist</a>|
|[SessionRegistrationId](#SessionRegistrationId)|Session registration ID|<a href="SessionRegistrationCreatedFromWaitlist.md" target="_blank">CustomerInsightsJourneys/SessionRegistrationCreatedFromWaitlist</a>|
|[SourceEntityId](#SourceEntityId)|Source entity ID|<a href="SessionRegistrationCreatedFromWaitlist.md" target="_blank">CustomerInsightsJourneys/SessionRegistrationCreatedFromWaitlist</a>|
|[SourceEntityName](#SourceEntityName)|Source entity name|<a href="SessionRegistrationCreatedFromWaitlist.md" target="_blank">CustomerInsightsJourneys/SessionRegistrationCreatedFromWaitlist</a>|
|[SourceSystem](#SourceSystem)| Refers to the source system that generated the interaction\. Outbound marketing \(OBM\) is represented by value 1\. Any other value than 1 represents Real-time journeys \(RTJ\)\.|<a href="SessionRegistrationCreatedFromWaitlist.md" target="_blank">CustomerInsightsJourneys/SessionRegistrationCreatedFromWaitlist</a>|
|[Timestamp](#Timestamp)|Indicates the exact date and time when the interaction was emitted\.|<a href="SessionRegistrationCreatedFromWaitlist.md" target="_blank">CustomerInsightsJourneys/SessionRegistrationCreatedFromWaitlist</a>|
|[Version](#Version)|Interaction version\. Used for updating the interaction\.|<a href="SessionRegistrationCreatedFromWaitlist.md" target="_blank">CustomerInsightsJourneys/SessionRegistrationCreatedFromWaitlist</a>|

### <a href=#AccountId name="AccountId">AccountId</a>

Unique identifier of the Account\.  
First included in: CustomerInsightsJourneys/SessionRegistrationCreatedFromWaitlist \(this entity\)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>description</td><td>Session registration ID</td></tr><tr><td>dataFormat</td><td>guid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the SessionRegistrationId attribute are listed below.</summary>
...
\*\*is\.dataFormat\.guid\*\*  
  \*\*is\.localized\.describedAs\*\*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Session registration ID</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
