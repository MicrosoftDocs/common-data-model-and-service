...
|---|---|---|
|[AccountId](#AccountId)|Unique identifier of the Account\.|<a href="CustomerJourneyIterationStarted.md" target="_blank">CustomerInsightsJourneys/CustomerJourneyIterationStarted</a>|
|[ActivityExpiryTime](#ActivityExpiryTime)|Activity expiry time|<a href="CustomerJourneyIterationStarted.md" target="_blank">CustomerInsightsJourneys/CustomerJourneyIterationStarted</a>|
|[ActivityId](#ActivityId)|Unique identifier of the Activity\.|<a href="CustomerJourneyIterationStarted.md" target="_blank">CustomerInsightsJourneys/CustomerJourneyIterationStarted</a>|
|[BusinessUnitId](#BusinessUnitId)|Unique identifier of the Business unit\.|<a href="CustomerJourneyIterationStarted.md" target="_blank">CustomerInsightsJourneys/CustomerJourneyIterationStarted</a>|
|[ContactId](#ContactId)|Unique identifier of the Contact\.|<a href="CustomerJourneyIterationStarted.md" target="_blank">CustomerInsightsJourneys/CustomerJourneyIterationStarted</a>|
|[CustomerJourneyId](#CustomerJourneyId)| Unique identifier of the Customer journey|<a href="CustomerJourneyIterationStarted.md" target="_blank">CustomerInsightsJourneys/CustomerJourneyIterationStarted</a>|
|[CustomerJourneyIterationId](#CustomerJourneyIterationId)|Customer journey iteration ID|<a href="CustomerJourneyIterationStarted.md" target="_blank">CustomerInsightsJourneys/CustomerJourneyIterationStarted</a>|
|[IdempotencyId](#IdempotencyId)|Idempotency ID defines uniqueness of an analytics event\.|<a href="CustomerJourneyIterationStarted.md" target="_blank">CustomerInsightsJourneys/CustomerJourneyIterationStarted</a>|
|[InteractionType](#InteractionType)|Type of the interaction\.|<a href="CustomerJourneyIterationStarted.md" target="_blank">CustomerInsightsJourneys/CustomerJourneyIterationStarted</a>|
|[InternalMarketingInteractionId](#InternalMarketingInteractionId)|Internal marketing interaction Id\.|<a href="CustomerJourneyIterationStarted.md" target="_blank">CustomerInsightsJourneys/CustomerJourneyIterationStarted</a>|
...
|[SourceSystem](#SourceSystem)| Refers to the source system that generated the interaction\. Outbound marketing \(OBM\) is represented by value 1\. Any other value than 1 represents Real-time journeys \(RTJ\)\.|<a href="CustomerJourneyIterationStarted.md" target="_blank">CustomerInsightsJourneys/CustomerJourneyIterationStarted</a>|
