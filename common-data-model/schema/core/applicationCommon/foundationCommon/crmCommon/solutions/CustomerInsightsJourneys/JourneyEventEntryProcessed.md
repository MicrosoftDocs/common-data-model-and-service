---
title: JourneyEventEntryProcessed in CustomerInsightsJourneys - Common Data Model | Microsoft Docs
description: Logged when a customer enters the journey (emitted by the flow)
...
# JourneyEventEntryProcessed in CustomerInsightsJourneys

Logged when a customer enters the journey \(emitted by the flow\)  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/CustomerInsightsJourneys/JourneyEventEntryProcessed.cdm.json" target="_blank">GitHub</a>.  
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Logged when a customer enters the journey (emitted by the flow)</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[BusinessUnitId](#BusinessUnitId)|Unique identifier of the Business unit\.|<a href="JourneyEventEntryProcessed.md" target="_blank">CustomerInsightsJourneys/JourneyEventEntryProcessed</a>|
|[CustomerJourneyId](#CustomerJourneyId)| Unique identifier of the Customer journey|<a href="JourneyEventEntryProcessed.md" target="_blank">CustomerInsightsJourneys/JourneyEventEntryProcessed</a>|
|[DropoffId](#DropoffId)|Unique identifier for events that cause a person to leave the journey\.|<a href="JourneyEventEntryProcessed.md" target="_blank">CustomerInsightsJourneys/JourneyEventEntryProcessed</a>|
|[IdempotencyId](#IdempotencyId)|Idempotency ID defines uniqueness of an analytics event\.|<a href="JourneyEventEntryProcessed.md" target="_blank">CustomerInsightsJourneys/JourneyEventEntryProcessed</a>|
|[InteractionType](#InteractionType)|Type of the interaction\.|<a href="JourneyEventEntryProcessed.md" target="_blank">CustomerInsightsJourneys/JourneyEventEntryProcessed</a>|
|[InternalMarketingInteractionId](#InternalMarketingInteractionId)|Internal marketing interaction Id\.|<a href="JourneyEventEntryProcessed.md" target="_blank">CustomerInsightsJourneys/JourneyEventEntryProcessed</a>|
|[IsUnresolvedProfile](#IsUnresolvedProfile)||<a href="JourneyEventEntryProcessed.md" target="_blank">CustomerInsightsJourneys/JourneyEventEntryProcessed</a>|
|[JourneyActionId](#JourneyActionId)|GUID of the journey action step associated with this event\.|<a href="JourneyEventEntryProcessed.md" target="_blank">CustomerInsightsJourneys/JourneyEventEntryProcessed</a>|
|[JourneyRunId](#JourneyRunId)|Flow run ID of the Power Automate run instance associated with this event\.|<a href="JourneyEventEntryProcessed.md" target="_blank">CustomerInsightsJourneys/JourneyEventEntryProcessed</a>|
|[JourneyStatus](#JourneyStatus)|Describes the results of processing a person entering a journey\. Indicates if a person was allowed or blocked from starting the journey\.|<a href="JourneyEventEntryProcessed.md" target="_blank">CustomerInsightsJourneys/JourneyEventEntryProcessed</a>|
|[JourneyVersion](#JourneyVersion)|Version number of the journey\.|<a href="JourneyEventEntryProcessed.md" target="_blank">CustomerInsightsJourneys/JourneyEventEntryProcessed</a>|
|[MessageId](#MessageId)|Message ID|<a href="JourneyEventEntryProcessed.md" target="_blank">CustomerInsightsJourneys/JourneyEventEntryProcessed</a>|
|[MessageTemplateVersion](#MessageTemplateVersion)|Message template version|<a href="JourneyEventEntryProcessed.md" target="_blank">CustomerInsightsJourneys/JourneyEventEntryProcessed</a>|
|[OrganizationId](#OrganizationId)|Organization Id\.|<a href="JourneyEventEntryProcessed.md" target="_blank">CustomerInsightsJourneys/JourneyEventEntryProcessed</a>|
|[ProfileId](#ProfileId)|Unique identifier of the profile\.|<a href="JourneyEventEntryProcessed.md" target="_blank">CustomerInsightsJourneys/JourneyEventEntryProcessed</a>|
|[ProfileType](#ProfileType)|The profile type \(Contact, Lead or CI Profile\)|<a href="JourneyEventEntryProcessed.md" target="_blank">CustomerInsightsJourneys/JourneyEventEntryProcessed</a>|
|[Reason](#Reason)|Journey status reason|<a href="JourneyEventEntryProcessed.md" target="_blank">CustomerInsightsJourneys/JourneyEventEntryProcessed</a>|
|[ReasonDetail](#ReasonDetail)|Provides additional information about the status of this event\.|<a href="JourneyEventEntryProcessed.md" target="_blank">CustomerInsightsJourneys/JourneyEventEntryProcessed</a>|
|[SegmentId](#SegmentId)|For segment based journeys, the GUID of the segment for this journey\.|<a href="JourneyEventEntryProcessed.md" target="_blank">CustomerInsightsJourneys/JourneyEventEntryProcessed</a>|
|[SegmentName](#SegmentName)|Segment name|<a href="JourneyEventEntryProcessed.md" target="_blank">CustomerInsightsJourneys/JourneyEventEntryProcessed</a>|
|[SourceSystem](#SourceSystem)| Refers to the source system that generated the interaction\. Outbound marketing \(OBM\) is represented by value 1\. Any other value than 1 represents Real-time journeys \(RTJ\)\.|<a href="JourneyEventEntryProcessed.md" target="_blank">CustomerInsightsJourneys/JourneyEventEntryProcessed</a>|
|[Timestamp](#Timestamp)|Indicates the exact date and time when the interaction was emitted\.|<a href="JourneyEventEntryProcessed.md" target="_blank">CustomerInsightsJourneys/JourneyEventEntryProcessed</a>|
|[Version](#Version)|Interaction version\. Used for updating the interaction\.|<a href="JourneyEventEntryProcessed.md" target="_blank">CustomerInsightsJourneys/JourneyEventEntryProcessed</a>|

### <a href=#BusinessUnitId name="BusinessUnitId">BusinessUnitId</a>

Unique identifier of the Business unit\.  
First included in: CustomerInsightsJourneys/JourneyEventEntryProcessed \(this entity\)  
