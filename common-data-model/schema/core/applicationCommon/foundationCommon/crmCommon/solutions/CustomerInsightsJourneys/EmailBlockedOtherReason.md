---
title: EmailBlockedOtherReason in CustomerInsightsJourneys - Common Data Model | Microsoft Docs
description: Logged when an email is blocked due to other reasons.
...
# EmailBlockedOtherReason in CustomerInsightsJourneys

Logged when an email is blocked due to other reasons\.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/CustomerInsightsJourneys/EmailBlockedOtherReason.cdm.json" target="_blank">GitHub</a>.  
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Logged when an email is blocked due to other reasons.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[AccountId](#AccountId)|Unique identifier of the Account\.|<a href="EmailBlockedOtherReason.md" target="_blank">CustomerInsightsJourneys/EmailBlockedOtherReason</a>|
|[ActivityExpiryTime](#ActivityExpiryTime)|Activity expiry time|<a href="EmailBlockedOtherReason.md" target="_blank">CustomerInsightsJourneys/EmailBlockedOtherReason</a>|
|[ActivityId](#ActivityId)|Activity ID|<a href="EmailBlockedOtherReason.md" target="_blank">CustomerInsightsJourneys/EmailBlockedOtherReason</a>|
|[BlockedReason](#BlockedReason)|Indicates the reason for email block\.|<a href="EmailBlockedOtherReason.md" target="_blank">CustomerInsightsJourneys/EmailBlockedOtherReason</a>|
|[BusinessUnitId](#BusinessUnitId)|Unique identifier of the Business unit\.|<a href="EmailBlockedOtherReason.md" target="_blank">CustomerInsightsJourneys/EmailBlockedOtherReason</a>|
|[Category](#Category)|Category|<a href="EmailBlockedOtherReason.md" target="_blank">CustomerInsightsJourneys/EmailBlockedOtherReason</a>|
|[ContactId](#ContactId)|Unique identifier of the Contact\.|<a href="EmailBlockedOtherReason.md" target="_blank">CustomerInsightsJourneys/EmailBlockedOtherReason</a>|
|[CustomerJourneyId](#CustomerJourneyId)| Unique identifier of the Customer journey|<a href="EmailBlockedOtherReason.md" target="_blank">CustomerInsightsJourneys/EmailBlockedOtherReason</a>|
|[CustomerJourneyIterationId](#CustomerJourneyIterationId)|Customer journey iteration ID|<a href="EmailBlockedOtherReason.md" target="_blank">CustomerInsightsJourneys/EmailBlockedOtherReason</a>|
|[Details](#Details)|Contains additional information regarding the reason of block\.|<a href="EmailBlockedOtherReason.md" target="_blank">CustomerInsightsJourneys/EmailBlockedOtherReason</a>|
|[EmailAddressUsed](#EmailAddressUsed)|The profile's email address\.|<a href="EmailBlockedOtherReason.md" target="_blank">CustomerInsightsJourneys/EmailBlockedOtherReason</a>|
|[IdempotencyId](#IdempotencyId)|Idempotency ID defines uniqueness of an analytics event\.|<a href="EmailBlockedOtherReason.md" target="_blank">CustomerInsightsJourneys/EmailBlockedOtherReason</a>|
|[InteractionType](#InteractionType)|Type of the interaction\.|<a href="EmailBlockedOtherReason.md" target="_blank">CustomerInsightsJourneys/EmailBlockedOtherReason</a>|
|[InternalMarketingInteractionId](#InternalMarketingInteractionId)|Internal marketing interaction Id\.|<a href="EmailBlockedOtherReason.md" target="_blank">CustomerInsightsJourneys/EmailBlockedOtherReason</a>|
|[IsSmartScheduled](#IsSmartScheduled)||<a href="EmailBlockedOtherReason.md" target="_blank">CustomerInsightsJourneys/EmailBlockedOtherReason</a>|
|[IsUnresolvedProfile](#IsUnresolvedProfile)||<a href="EmailBlockedOtherReason.md" target="_blank">CustomerInsightsJourneys/EmailBlockedOtherReason</a>|
|[JourneyActionId](#JourneyActionId)|GUID of the journey action step associated with this event\.|<a href="EmailBlockedOtherReason.md" target="_blank">CustomerInsightsJourneys/EmailBlockedOtherReason</a>|
|[JourneyRunId](#JourneyRunId)|Flow run ID of the Power Automate run instance associated with this event\.|<a href="EmailBlockedOtherReason.md" target="_blank">CustomerInsightsJourneys/EmailBlockedOtherReason</a>|
|[MessageId](#MessageId)|Message ID|<a href="EmailBlockedOtherReason.md" target="_blank">CustomerInsightsJourneys/EmailBlockedOtherReason</a>|
|[MessageTemplateVersion](#MessageTemplateVersion)|Message template version|<a href="EmailBlockedOtherReason.md" target="_blank">CustomerInsightsJourneys/EmailBlockedOtherReason</a>|
|[MessageVariationIndexes](#MessageVariationIndexes)||<a href="EmailBlockedOtherReason.md" target="_blank">CustomerInsightsJourneys/EmailBlockedOtherReason</a>|
|[MessageVariationName](#MessageVariationName)||<a href="EmailBlockedOtherReason.md" target="_blank">CustomerInsightsJourneys/EmailBlockedOtherReason</a>|
|[OrganizationId](#OrganizationId)|Organization Id\.|<a href="EmailBlockedOtherReason.md" target="_blank">CustomerInsightsJourneys/EmailBlockedOtherReason</a>|
|[ProfileId](#ProfileId)|Unique identifier of the profile\.|<a href="EmailBlockedOtherReason.md" target="_blank">CustomerInsightsJourneys/EmailBlockedOtherReason</a>|
|[ProfileType](#ProfileType)|The profile type \(Contact, Lead or CI Profile\)|<a href="EmailBlockedOtherReason.md" target="_blank">CustomerInsightsJourneys/EmailBlockedOtherReason</a>|
|[SchedulerId](#SchedulerId)||<a href="EmailBlockedOtherReason.md" target="_blank">CustomerInsightsJourneys/EmailBlockedOtherReason</a>|
|[SendingId](#SendingId)|Indicates the journey iteration ID\.|<a href="EmailBlockedOtherReason.md" target="_blank">CustomerInsightsJourneys/EmailBlockedOtherReason</a>|
|[SourceSystem](#SourceSystem)| Refers to the source system that generated the interaction\. Outbound marketing \(OBM\) is represented by value 1\. Any other value than 1 represents Real\x2dtime journeys \(RTJ\)\.|<a href="EmailBlockedOtherReason.md" target="_blank">CustomerInsightsJourneys/EmailBlockedOtherReason</a>|
|[Timestamp](#Timestamp)|Indicates the exact date and time when the interaction was emitted\.|<a href="EmailBlockedOtherReason.md" target="_blank">CustomerInsightsJourneys/EmailBlockedOtherReason</a>|
|[UsageType](#UsageType)|Indicates if it's a test send, journey or trigger based\.|<a href="EmailBlockedOtherReason.md" target="_blank">CustomerInsightsJourneys/EmailBlockedOtherReason</a>|
|[Version](#Version)|Interaction version\. Used for updating the interaction\.|<a href="EmailBlockedOtherReason.md" target="_blank">CustomerInsightsJourneys/EmailBlockedOtherReason</a>|

### <a href=#AccountId name="AccountId">AccountId</a>

Unique identifier of the Account\.  
First included in: CustomerInsightsJourneys/EmailBlockedOtherReason \(this entity\)  
