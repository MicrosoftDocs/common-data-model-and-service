---
title: ActivityContactDispatched in CustomerInsightsJourneys - Common Data Model | Microsoft Docs
...
# ActivityContactDispatched in CustomerInsightsJourneys

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/CustomerInsightsJourneys/ActivityContactDispatched.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[AccountId](#AccountId)|Unique identifier of the Account.|<a href="ActivityContactDispatched.md" target="_blank">CustomerInsightsJourneys/ActivityContactDispatched</a>|
|[ActivityExpiryTime](#ActivityExpiryTime)|Activity expiry time|<a href="ActivityContactDispatched.md" target="_blank">CustomerInsightsJourneys/ActivityContactDispatched</a>|
|[ActivityId](#ActivityId)|Unique identifier of the Activity.|<a href="ActivityContactDispatched.md" target="_blank">CustomerInsightsJourneys/ActivityContactDispatched</a>|
|[ActivityTypeId](#ActivityTypeId)|Activity type ID|<a href="ActivityContactDispatched.md" target="_blank">CustomerInsightsJourneys/ActivityContactDispatched</a>|
|[BusinessUnitId](#BusinessUnitId)|Unique identifier of the Business unit.|<a href="ActivityContactDispatched.md" target="_blank">CustomerInsightsJourneys/ActivityContactDispatched</a>|
|[ContactId](#ContactId)|Unique identifier of the Contact.|<a href="ActivityContactDispatched.md" target="_blank">CustomerInsightsJourneys/ActivityContactDispatched</a>|
|[CustomerJourneyId](#CustomerJourneyId)| Unique identifier of the Customer journey|<a href="ActivityContactDispatched.md" target="_blank">CustomerInsightsJourneys/ActivityContactDispatched</a>|
|[CustomerJourneyIterationId](#CustomerJourneyIterationId)|Customer journey iteration ID|<a href="ActivityContactDispatched.md" target="_blank">CustomerInsightsJourneys/ActivityContactDispatched</a>|
|[IdempotencyId](#IdempotencyId)|Idempotency ID defines uniqueness of an analytics event.|<a href="ActivityContactDispatched.md" target="_blank">CustomerInsightsJourneys/ActivityContactDispatched</a>|
|[InteractionType](#InteractionType)|Type of the interaction.|<a href="ActivityContactDispatched.md" target="_blank">CustomerInsightsJourneys/ActivityContactDispatched</a>|
|[InternalMarketingInteractionId](#InternalMarketingInteractionId)|Internal marketing interaction Id.|<a href="ActivityContactDispatched.md" target="_blank">CustomerInsightsJourneys/ActivityContactDispatched</a>|
|[InternalMarketingProperties](#InternalMarketingProperties)|Internal marketing properties|<a href="ActivityContactDispatched.md" target="_blank">CustomerInsightsJourneys/ActivityContactDispatched</a>|
...
|[SourceSystem](#SourceSystem)| Refers to the source system that generated the interaction. Outbound marketing (OBM) is represented by value 1. Any other value than 1 represents Real-time journeys (RTJ).|<a href="ActivityContactDispatched.md" target="_blank">CustomerInsightsJourneys/ActivityContactDispatched</a>|
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>description</td><td>Internal marketing properties</td></tr><tr><td>dataFormat</td><td>string</td></tr></table>

#### Traits

<details>
<summary>List of traits for the InternalMarketingProperties attribute are listed below.</summary>
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Internal marketing properties</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
