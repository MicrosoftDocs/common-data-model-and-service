---
title: JourneyEventCompleted in CustomerInsightsJourneys - Common Data Model | Microsoft Docs
description: Logged when a customer completes a journey run
...
# JourneyEventCompleted in CustomerInsightsJourneys

Logged when a customer completes a journey run  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/CustomerInsightsJourneys/JourneyEventCompleted.cdm.json" target="_blank">GitHub</a>.  
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Logged when a customer completes a journey run</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[BusinessUnitId](#BusinessUnitId)|Unique identifier of the Business unit\.|<a href="JourneyEventCompleted.md" target="_blank">CustomerInsightsJourneys/JourneyEventCompleted</a>|
|[CustomerJourneyId](#CustomerJourneyId)| Unique identifier of the Customer journey|<a href="JourneyEventCompleted.md" target="_blank">CustomerInsightsJourneys/JourneyEventCompleted</a>|
|[DropoffId](#DropoffId)|Unique identifier for events that cause a person to leave the journey\.|<a href="JourneyEventCompleted.md" target="_blank">CustomerInsightsJourneys/JourneyEventCompleted</a>|
|[IdempotencyId](#IdempotencyId)|Idempotency ID defines uniqueness of an analytics event\.|<a href="JourneyEventCompleted.md" target="_blank">CustomerInsightsJourneys/JourneyEventCompleted</a>|
|[InteractionType](#InteractionType)|Type of the interaction\.|<a href="JourneyEventCompleted.md" target="_blank">CustomerInsightsJourneys/JourneyEventCompleted</a>|
|[InternalMarketingInteractionId](#InternalMarketingInteractionId)|Internal marketing interaction Id\.|<a href="JourneyEventCompleted.md" target="_blank">CustomerInsightsJourneys/JourneyEventCompleted</a>|
|[IsUnresolvedProfile](#IsUnresolvedProfile)||<a href="JourneyEventCompleted.md" target="_blank">CustomerInsightsJourneys/JourneyEventCompleted</a>|
|[JourneyActionId](#JourneyActionId)|GUID of the journey action step associated with this event\.|<a href="JourneyEventCompleted.md" target="_blank">CustomerInsightsJourneys/JourneyEventCompleted</a>|
|[JourneyRunId](#JourneyRunId)|Flow run ID of the Power Automate run instance associated with this event\.|<a href="JourneyEventCompleted.md" target="_blank">CustomerInsightsJourneys/JourneyEventCompleted</a>|
|[JourneyStatus](#JourneyStatus)|Describes the results of processing a person entering a journey\. Indicates if a person was allowed or blocked from starting the journey\.|<a href="JourneyEventCompleted.md" target="_blank">CustomerInsightsJourneys/JourneyEventCompleted</a>|
|[JourneyVersion](#JourneyVersion)|Version number of the journey\.|<a href="JourneyEventCompleted.md" target="_blank">CustomerInsightsJourneys/JourneyEventCompleted</a>|
|[MessageId](#MessageId)|Message ID|<a href="JourneyEventCompleted.md" target="_blank">CustomerInsightsJourneys/JourneyEventCompleted</a>|
|[MessageTemplateVersion](#MessageTemplateVersion)|Message template version|<a href="JourneyEventCompleted.md" target="_blank">CustomerInsightsJourneys/JourneyEventCompleted</a>|
|[OrganizationId](#OrganizationId)|Organization Id\.|<a href="JourneyEventCompleted.md" target="_blank">CustomerInsightsJourneys/JourneyEventCompleted</a>|
|[ProfileId](#ProfileId)|Unique identifier of the profile\.|<a href="JourneyEventCompleted.md" target="_blank">CustomerInsightsJourneys/JourneyEventCompleted</a>|
|[ProfileType](#ProfileType)|The profile type \(Contact, Lead or CI Profile\)|<a href="JourneyEventCompleted.md" target="_blank">CustomerInsightsJourneys/JourneyEventCompleted</a>|
|[Reason](#Reason)|Journey status reason|<a href="JourneyEventCompleted.md" target="_blank">CustomerInsightsJourneys/JourneyEventCompleted</a>|
|[ReasonDetail](#ReasonDetail)|Provides additional information about the status of this event\.|<a href="JourneyEventCompleted.md" target="_blank">CustomerInsightsJourneys/JourneyEventCompleted</a>|
|[SegmentId](#SegmentId)|For segment based journeys, the GUID of the segment for this journey\.|<a href="JourneyEventCompleted.md" target="_blank">CustomerInsightsJourneys/JourneyEventCompleted</a>|
|[SegmentName](#SegmentName)|Segment name|<a href="JourneyEventCompleted.md" target="_blank">CustomerInsightsJourneys/JourneyEventCompleted</a>|
|[SourceSystem](#SourceSystem)| Refers to the source system that generated the interaction\. Outbound marketing \(OBM\) is represented by value 1\. Any other value than 1 represents Real-time journeys \(RTJ\)\.|<a href="JourneyEventCompleted.md" target="_blank">CustomerInsightsJourneys/JourneyEventCompleted</a>|
|[Timestamp](#Timestamp)|Indicates the exact date and time when the interaction was emitted\.|<a href="JourneyEventCompleted.md" target="_blank">CustomerInsightsJourneys/JourneyEventCompleted</a>|
|[Version](#Version)|Interaction version\. Used for updating the interaction\.|<a href="JourneyEventCompleted.md" target="_blank">CustomerInsightsJourneys/JourneyEventCompleted</a>|

### <a href=#BusinessUnitId name="BusinessUnitId">BusinessUnitId</a>

Unique identifier of the Business unit\.  
First included in: CustomerInsightsJourneys/JourneyEventCompleted \(this entity\)  
