---
title: EmailBounced in CustomerInsightsJourneys - Common Data Model | Microsoft Docs
description: Logged when an email fails to deliver due to a bounce.
...
# EmailBounced in CustomerInsightsJourneys

Logged when an email fails to deliver due to a bounce\.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/CustomerInsightsJourneys/EmailBounced.cdm.json" target="_blank">GitHub</a>.  
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Logged when an email fails to deliver due to a bounce.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[AccountId](#AccountId)|Unique identifier of the Account\.|<a href="EmailBounced.md" target="_blank">CustomerInsightsJourneys/EmailBounced</a>|
|[ActivityExpiryTime](#ActivityExpiryTime)|Activity expiry time|<a href="EmailBounced.md" target="_blank">CustomerInsightsJourneys/EmailBounced</a>|
|[ActivityId](#ActivityId)|Unique identifier of the Activity\.|<a href="EmailBounced.md" target="_blank">CustomerInsightsJourneys/EmailBounced</a>|
|[BounceCategory](#BounceCategory)|Indicates the bounce category\.|<a href="EmailBounced.md" target="_blank">CustomerInsightsJourneys/EmailBounced</a>|
|[BounceReason](#BounceReason)|Indicates if it is a remote bounce\.|<a href="EmailBounced.md" target="_blank">CustomerInsightsJourneys/EmailBounced</a>|
|[BounceType](#BounceType)|Indicates the bounce type \(soft bounce, hard bounce\)\.|<a href="EmailBounced.md" target="_blank">CustomerInsightsJourneys/EmailBounced</a>|
|[BusinessUnitId](#BusinessUnitId)|Unique identifier of the Business unit\.|<a href="EmailBounced.md" target="_blank">CustomerInsightsJourneys/EmailBounced</a>|
|[ContactId](#ContactId)|Unique identifier of the Contact\.|<a href="EmailBounced.md" target="_blank">CustomerInsightsJourneys/EmailBounced</a>|
|[CustomerJourneyId](#CustomerJourneyId)| Unique identifier of the Customer journey|<a href="EmailBounced.md" target="_blank">CustomerInsightsJourneys/EmailBounced</a>|
|[CustomerJourneyIterationId](#CustomerJourneyIterationId)|Customer journey iteration ID|<a href="EmailBounced.md" target="_blank">CustomerInsightsJourneys/EmailBounced</a>|
|[Details](#Details)|Contains additional information regarding the reason of bounce\.|<a href="EmailBounced.md" target="_blank">CustomerInsightsJourneys/EmailBounced</a>|
|[EmailAddressUsed](#EmailAddressUsed)|The profile's email address\.|<a href="EmailBounced.md" target="_blank">CustomerInsightsJourneys/EmailBounced</a>|
|[EmailDomain](#EmailDomain)|Email domain|<a href="EmailBounced.md" target="_blank">CustomerInsightsJourneys/EmailBounced</a>|
|[IdempotencyId](#IdempotencyId)|Idempotency ID defines uniqueness of an analytics event\.|<a href="EmailBounced.md" target="_blank">CustomerInsightsJourneys/EmailBounced</a>|
|[InteractionType](#InteractionType)|Type of the interaction\.|<a href="EmailBounced.md" target="_blank">CustomerInsightsJourneys/EmailBounced</a>|
|[InternalMarketingInteractionId](#InternalMarketingInteractionId)|Internal marketing interaction Id\.|<a href="EmailBounced.md" target="_blank">CustomerInsightsJourneys/EmailBounced</a>|
|[IsSmartScheduled](#IsSmartScheduled)||<a href="EmailBounced.md" target="_blank">CustomerInsightsJourneys/EmailBounced</a>|
|[IsUnresolvedProfile](#IsUnresolvedProfile)||<a href="EmailBounced.md" target="_blank">CustomerInsightsJourneys/EmailBounced</a>|
|[JourneyActionId](#JourneyActionId)|GUID of the journey action step associated with this event\.|<a href="EmailBounced.md" target="_blank">CustomerInsightsJourneys/EmailBounced</a>|
|[JourneyRunId](#JourneyRunId)|Flow run ID of the Power Automate run instance associated with this event\.|<a href="EmailBounced.md" target="_blank">CustomerInsightsJourneys/EmailBounced</a>|
|[LeadId](#LeadId)|Unique identifier of the Lead\.|<a href="EmailBounced.md" target="_blank">CustomerInsightsJourneys/EmailBounced</a>|
|[MessageId](#MessageId)|Message ID|<a href="EmailBounced.md" target="_blank">CustomerInsightsJourneys/EmailBounced</a>|
|[MessageVariationIndexes](#MessageVariationIndexes)||<a href="EmailBounced.md" target="_blank">CustomerInsightsJourneys/EmailBounced</a>|
|[MessageVariationName](#MessageVariationName)||<a href="EmailBounced.md" target="_blank">CustomerInsightsJourneys/EmailBounced</a>|
|[OrganizationId](#OrganizationId)|Organization Id\.|<a href="EmailBounced.md" target="_blank">CustomerInsightsJourneys/EmailBounced</a>|
|[ProfileId](#ProfileId)|Unique identifier of the profile\.|<a href="EmailBounced.md" target="_blank">CustomerInsightsJourneys/EmailBounced</a>|
|[ProfileType](#ProfileType)|The profile type \(Contact, Lead or CI Profile\)|<a href="EmailBounced.md" target="_blank">CustomerInsightsJourneys/EmailBounced</a>|
...
|[SourceEntityId](#SourceEntityId)|Source entity ID|<a href="EmailBounced.md" target="_blank">CustomerInsightsJourneys/EmailBounced</a>|
|[SourceEntityName](#SourceEntityName)|Source entity name|<a href="EmailBounced.md" target="_blank">CustomerInsightsJourneys/EmailBounced</a>|
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>description</td><td>Remote bounce</td></tr><tr><td>dataFormat</td><td>string</td></tr></table>
...
\*\*is\.localized\.describedAs\*\*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Remote bounce</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
