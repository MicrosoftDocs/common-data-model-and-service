---
title: CreateRecord in CustomerInsightsJourneys - Common Data Model | Microsoft Docs
...
# CreateRecord in CustomerInsightsJourneys

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/CustomerInsightsJourneys/CreateRecord.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[ActionName](#ActionName)|Action name|<a href="CreateRecord.md" target="_blank">CustomerInsightsJourneys/CreateRecord</a>|
|[ActionStatus](#ActionStatus)|Action status|<a href="CreateRecord.md" target="_blank">CustomerInsightsJourneys/CreateRecord</a>|
|[AudienceName](#AudienceName)|Audience name|<a href="CreateRecord.md" target="_blank">CustomerInsightsJourneys/CreateRecord</a>|
|[BindingId](#BindingId)|Binding ID|<a href="CreateRecord.md" target="_blank">CustomerInsightsJourneys/CreateRecord</a>|
|[BusinessUnitId](#BusinessUnitId)|Unique identifier of the Business unit.|<a href="CreateRecord.md" target="_blank">CustomerInsightsJourneys/CreateRecord</a>|
|[CustomerJourneyId](#CustomerJourneyId)| Unique identifier of the Customer journey|<a href="CreateRecord.md" target="_blank">CustomerInsightsJourneys/CreateRecord</a>|
|[EmailAddress](#EmailAddress)|Email address|<a href="CreateRecord.md" target="_blank">CustomerInsightsJourneys/CreateRecord</a>|
|[IdempotencyId](#IdempotencyId)|Idempotency ID defines uniqueness of an analytics event.|<a href="CreateRecord.md" target="_blank">CustomerInsightsJourneys/CreateRecord</a>|
|[InteractionType](#InteractionType)|Type of the interaction.|<a href="CreateRecord.md" target="_blank">CustomerInsightsJourneys/CreateRecord</a>|
|[InternalMarketingInteractionId](#InternalMarketingInteractionId)|Internal marketing interaction Id.|<a href="CreateRecord.md" target="_blank">CustomerInsightsJourneys/CreateRecord</a>|
|[IsUnresolvedProfile](#IsUnresolvedProfile)||<a href="CreateRecord.md" target="_blank">CustomerInsightsJourneys/CreateRecord</a>|
|[JourneyActionId](#JourneyActionId)|GUID of the journey action step associated with this event.|<a href="CreateRecord.md" target="_blank">CustomerInsightsJourneys/CreateRecord</a>|
|[JourneyRunId](#JourneyRunId)|Flow run ID of the Power Automate run instance associated with this event.|<a href="CreateRecord.md" target="_blank">CustomerInsightsJourneys/CreateRecord</a>|
|[MessageId](#MessageId)|Message ID|<a href="CreateRecord.md" target="_blank">CustomerInsightsJourneys/CreateRecord</a>|
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>description</td><td>Action name</td></tr><tr><td>dataFormat</td><td>string</td></tr></table>

#### Traits

<details>
<summary>List of traits for the ActionName attribute are listed below.</summary>
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Action name</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>description</td><td>Action status</td></tr><tr><td>dataFormat</td><td>string</td></tr></table>
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Action status</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>description</td><td>Audience name</td></tr><tr><td>dataFormat</td><td>string</td></tr></table>

#### Traits

<details>
<summary>List of traits for the AudienceName attribute are listed below.</summary>
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Audience name</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>description</td><td>Binding ID</td></tr><tr><td>dataFormat</td><td>string</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>description</td><td>Email address</td></tr><tr><td>dataFormat</td><td>string</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>description</td><td>Indicates detailed reason for the create record event</td></tr><tr><td>dataFormat</td><td>string</td></tr></table>
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Indicates detailed reason for the create record event</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>description</td><td>Record ID</td></tr><tr><td>dataFormat</td><td>string</td></tr></table>
