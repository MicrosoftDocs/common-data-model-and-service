---
title: EmailBlockedSuspension in CustomerInsightsJourneys - Common Data Model | Microsoft Docs
...
# EmailBlockedSuspension in CustomerInsightsJourneys

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/CustomerInsightsJourneys/EmailBlockedSuspension.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[BlockedReason](#BlockedReason)|Indicates the reason for email block.|<a href="EmailBlockedSuspension.md" target="_blank">CustomerInsightsJourneys/EmailBlockedSuspension</a>|
|[BusinessUnitId](#BusinessUnitId)|Unique identifier of the Business unit.|<a href="EmailBlockedSuspension.md" target="_blank">CustomerInsightsJourneys/EmailBlockedSuspension</a>|
|[Category](#Category)|Category|<a href="EmailBlockedSuspension.md" target="_blank">CustomerInsightsJourneys/EmailBlockedSuspension</a>|
|[CustomerJourneyId](#CustomerJourneyId)| Unique identifier of the Customer journey|<a href="EmailBlockedSuspension.md" target="_blank">CustomerInsightsJourneys/EmailBlockedSuspension</a>|
|[Details](#Details)|Contains additional information regarding the reason of block.|<a href="EmailBlockedSuspension.md" target="_blank">CustomerInsightsJourneys/EmailBlockedSuspension</a>|
|[EmailAddressUsed](#EmailAddressUsed)|The profile's email address.|<a href="EmailBlockedSuspension.md" target="_blank">CustomerInsightsJourneys/EmailBlockedSuspension</a>|
|[IdempotencyId](#IdempotencyId)|Idempotency ID defines uniqueness of an analytics event.|<a href="EmailBlockedSuspension.md" target="_blank">CustomerInsightsJourneys/EmailBlockedSuspension</a>|
|[InteractionType](#InteractionType)|Type of the interaction.|<a href="EmailBlockedSuspension.md" target="_blank">CustomerInsightsJourneys/EmailBlockedSuspension</a>|
|[InternalMarketingInteractionId](#InternalMarketingInteractionId)|Internal marketing interaction Id.|<a href="EmailBlockedSuspension.md" target="_blank">CustomerInsightsJourneys/EmailBlockedSuspension</a>|
|[IsUnresolvedProfile](#IsUnresolvedProfile)||<a href="EmailBlockedSuspension.md" target="_blank">CustomerInsightsJourneys/EmailBlockedSuspension</a>|
|[JourneyActionId](#JourneyActionId)|GUID of the journey action step associated with this event.|<a href="EmailBlockedSuspension.md" target="_blank">CustomerInsightsJourneys/EmailBlockedSuspension</a>|
|[JourneyRunId](#JourneyRunId)|Flow run ID of the Power Automate run instance associated with this event.|<a href="EmailBlockedSuspension.md" target="_blank">CustomerInsightsJourneys/EmailBlockedSuspension</a>|
|[MessageId](#MessageId)|Message ID|<a href="EmailBlockedSuspension.md" target="_blank">CustomerInsightsJourneys/EmailBlockedSuspension</a>|
|[MessageTemplateVersion](#MessageTemplateVersion)|Message template version|<a href="EmailBlockedSuspension.md" target="_blank">CustomerInsightsJourneys/EmailBlockedSuspension</a>|
|[MessageVariationIndexes](#MessageVariationIndexes)||<a href="EmailBlockedSuspension.md" target="_blank">CustomerInsightsJourneys/EmailBlockedSuspension</a>|
|[MessageVariationName](#MessageVariationName)||<a href="EmailBlockedSuspension.md" target="_blank">CustomerInsightsJourneys/EmailBlockedSuspension</a>|
|[OrganizationId](#OrganizationId)|Organization Id.|<a href="EmailBlockedSuspension.md" target="_blank">CustomerInsightsJourneys/EmailBlockedSuspension</a>|
|[ProfileId](#ProfileId)|Unique identifier of the profile.|<a href="EmailBlockedSuspension.md" target="_blank">CustomerInsightsJourneys/EmailBlockedSuspension</a>|
|[ProfileType](#ProfileType)|The profile type \(Contact, Lead or CI Profile\)|<a href="EmailBlockedSuspension.md" target="_blank">CustomerInsightsJourneys/EmailBlockedSuspension</a>|
|[SourceSystem](#SourceSystem)| Refers to the source system that generated the interaction. Outbound marketing \(OBM\) is represented by value 1. Any other value than 1 represents Real\x2dtime journeys \(RTJ\).|<a href="EmailBlockedSuspension.md" target="_blank">CustomerInsightsJourneys/EmailBlockedSuspension</a>|
|[Timestamp](#Timestamp)|Indicates the exact date and time when the interaction was emitted.|<a href="EmailBlockedSuspension.md" target="_blank">CustomerInsightsJourneys/EmailBlockedSuspension</a>|
|[Version](#Version)|Interaction version. Used for updating the interaction.|<a href="EmailBlockedSuspension.md" target="_blank">CustomerInsightsJourneys/EmailBlockedSuspension</a>|

### <a href=#BlockedReason name="BlockedReason">BlockedReason</a>

Indicates the reason for email block.  
First included in: CustomerInsightsJourneys/EmailBlockedSuspension \(this entity\)  
