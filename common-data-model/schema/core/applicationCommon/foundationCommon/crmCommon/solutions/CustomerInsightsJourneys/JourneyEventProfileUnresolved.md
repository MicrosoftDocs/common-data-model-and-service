---
title: JourneyEventProfileUnresolved in CustomerInsightsJourneys - Common Data Model | Microsoft Docs
description: Logged when the system can't find a matching customer for the event
...
# JourneyEventProfileUnresolved in CustomerInsightsJourneys

Logged when the system can't find a matching customer for the event  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/CustomerInsightsJourneys/JourneyEventProfileUnresolved.cdm.json" target="_blank">GitHub</a>.  
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Logged when the system can't find a matching customer for the event</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[BusinessUnitId](#BusinessUnitId)|Unique identifier of the Business unit\.|<a href="JourneyEventProfileUnresolved.md" target="_blank">CustomerInsightsJourneys/JourneyEventProfileUnresolved</a>|
|[CustomerJourneyId](#CustomerJourneyId)| Unique identifier of the Customer journey|<a href="JourneyEventProfileUnresolved.md" target="_blank">CustomerInsightsJourneys/JourneyEventProfileUnresolved</a>|
|[DropoffId](#DropoffId)|Unique identifier for events that cause a person to leave the journey\.|<a href="JourneyEventProfileUnresolved.md" target="_blank">CustomerInsightsJourneys/JourneyEventProfileUnresolved</a>|
|[IdempotencyId](#IdempotencyId)|Idempotency ID defines uniqueness of an analytics event\.|<a href="JourneyEventProfileUnresolved.md" target="_blank">CustomerInsightsJourneys/JourneyEventProfileUnresolved</a>|
|[InteractionType](#InteractionType)|Type of the interaction\.|<a href="JourneyEventProfileUnresolved.md" target="_blank">CustomerInsightsJourneys/JourneyEventProfileUnresolved</a>|
|[InternalMarketingInteractionId](#InternalMarketingInteractionId)|Internal marketing interaction Id\.|<a href="JourneyEventProfileUnresolved.md" target="_blank">CustomerInsightsJourneys/JourneyEventProfileUnresolved</a>|
|[IsUnresolvedProfile](#IsUnresolvedProfile)||<a href="JourneyEventProfileUnresolved.md" target="_blank">CustomerInsightsJourneys/JourneyEventProfileUnresolved</a>|
|[JourneyActionId](#JourneyActionId)|GUID of the journey action step associated with this event\.|<a href="JourneyEventProfileUnresolved.md" target="_blank">CustomerInsightsJourneys/JourneyEventProfileUnresolved</a>|
|[JourneyRunId](#JourneyRunId)|Flow run ID of the Power Automate run instance associated with this event\.|<a href="JourneyEventProfileUnresolved.md" target="_blank">CustomerInsightsJourneys/JourneyEventProfileUnresolved</a>|
|[JourneyStatus](#JourneyStatus)|Describes the results of processing a person entering a journey\. Indicates if a person was allowed or blocked from starting the journey\.|<a href="JourneyEventProfileUnresolved.md" target="_blank">CustomerInsightsJourneys/JourneyEventProfileUnresolved</a>|
|[JourneyVersion](#JourneyVersion)|Version number of the journey\.|<a href="JourneyEventProfileUnresolved.md" target="_blank">CustomerInsightsJourneys/JourneyEventProfileUnresolved</a>|
|[MessageId](#MessageId)|Message ID|<a href="JourneyEventProfileUnresolved.md" target="_blank">CustomerInsightsJourneys/JourneyEventProfileUnresolved</a>|
