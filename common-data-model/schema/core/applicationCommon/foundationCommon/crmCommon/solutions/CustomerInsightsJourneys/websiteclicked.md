---
title: WebsiteClicked in CustomerInsightsJourneys - Common Data Model | Microsoft Docs
description: Logged when a known contact, lead, or CI profile clicks a tracked website link.
...
# WebsiteClicked in CustomerInsightsJourneys

Logged when a known contact, lead, or CI profile clicks a tracked website link\.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/CustomerInsightsJourneys/WebsiteClicked.cdm.json" target="_blank">GitHub</a>.  
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Logged when a known contact, lead, or CI profile clicks a tracked website link.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[AccountId](#AccountId)|Unique identifier of the Account\.|<a href="WebsiteClicked.md" target="_blank">CustomerInsightsJourneys/WebsiteClicked</a>|
|[ActionElapsedTime](#ActionElapsedTime)|Action elapsed time|<a href="WebsiteClicked.md" target="_blank">CustomerInsightsJourneys/WebsiteClicked</a>|
|[ActionElementId](#ActionElementId)|Action element ID|<a href="WebsiteClicked.md" target="_blank">CustomerInsightsJourneys/WebsiteClicked</a>|
|[ActionIsOutbound](#ActionIsOutbound)|Specifies whether the action is outbound|<a href="WebsiteClicked.md" target="_blank">CustomerInsightsJourneys/WebsiteClicked</a>|
|[ActionName](#ActionName)|Action name|<a href="WebsiteClicked.md" target="_blank">CustomerInsightsJourneys/WebsiteClicked</a>|
|[ActionTarget](#ActionTarget)|Action target|<a href="WebsiteClicked.md" target="_blank">CustomerInsightsJourneys/WebsiteClicked</a>|
|[ActionType](#ActionType)|Action type|<a href="WebsiteClicked.md" target="_blank">CustomerInsightsJourneys/WebsiteClicked</a>|
|[ActivityExpiryTime](#ActivityExpiryTime)|Activity expiry time|<a href="WebsiteClicked.md" target="_blank">CustomerInsightsJourneys/WebsiteClicked</a>|
|[ActivityId](#ActivityId)|Unique identifier of the Activity\.|<a href="WebsiteClicked.md" target="_blank">CustomerInsightsJourneys/WebsiteClicked</a>|
|[BrowserId](#BrowserId)|Browser ID|<a href="WebsiteClicked.md" target="_blank">CustomerInsightsJourneys/WebsiteClicked</a>|
|[BrowserLanguage](#BrowserLanguage)|Browser language|<a href="WebsiteClicked.md" target="_blank">CustomerInsightsJourneys/WebsiteClicked</a>|
|[BrowserVersion](#BrowserVersion)|Browser version|<a href="WebsiteClicked.md" target="_blank">CustomerInsightsJourneys/WebsiteClicked</a>|
|[BusinessUnitId](#BusinessUnitId)|Unique identifier of the Business unit\.|<a href="WebsiteClicked.md" target="_blank">CustomerInsightsJourneys/WebsiteClicked</a>|
|[City](#City)|City|<a href="WebsiteClicked.md" target="_blank">CustomerInsightsJourneys/WebsiteClicked</a>|
|[ClickCoordinates](#ClickCoordinates)|Click coordinates|<a href="WebsiteClicked.md" target="_blank">CustomerInsightsJourneys/WebsiteClicked</a>|
|[ContactId](#ContactId)|Unique identifier of the Contact\.|<a href="WebsiteClicked.md" target="_blank">CustomerInsightsJourneys/WebsiteClicked</a>|
|[Country](#Country)|Country|<a href="WebsiteClicked.md" target="_blank">CustomerInsightsJourneys/WebsiteClicked</a>|
|[CountryIsoCode](#CountryIsoCode)|Country ISO code|<a href="WebsiteClicked.md" target="_blank">CustomerInsightsJourneys/WebsiteClicked</a>|
|[CustomerJourneyId](#CustomerJourneyId)| Unique identifier of the Customer journey|<a href="WebsiteClicked.md" target="_blank">CustomerInsightsJourneys/WebsiteClicked</a>|
|[CustomerJourneyIterationId](#CustomerJourneyIterationId)|Customer journey iteration ID|<a href="WebsiteClicked.md" target="_blank">CustomerInsightsJourneys/WebsiteClicked</a>|
|[EmailAddressUsed](#EmailAddressUsed)|The profile's email address\.|<a href="WebsiteClicked.md" target="_blank">CustomerInsightsJourneys/WebsiteClicked</a>|
|[EmailDomain](#EmailDomain)|Email domain|<a href="WebsiteClicked.md" target="_blank">CustomerInsightsJourneys/WebsiteClicked</a>|
|[FormSubmissionId](#FormSubmissionId)|The form submission Id|<a href="WebsiteClicked.md" target="_blank">CustomerInsightsJourneys/WebsiteClicked</a>|
|[IdempotencyId](#IdempotencyId)|Idempotency ID defines uniqueness of an analytics event\.|<a href="WebsiteClicked.md" target="_blank">CustomerInsightsJourneys/WebsiteClicked</a>|
|[InteractionType](#InteractionType)|Type of the interaction\.|<a href="WebsiteClicked.md" target="_blank">CustomerInsightsJourneys/WebsiteClicked</a>|
|[InternalMarketingInteractionId](#InternalMarketingInteractionId)|Internal marketing interaction Id\.|<a href="WebsiteClicked.md" target="_blank">CustomerInsightsJourneys/WebsiteClicked</a>|
|[IsSmartScheduled](#IsSmartScheduled)||<a href="WebsiteClicked.md" target="_blank">CustomerInsightsJourneys/WebsiteClicked</a>|
|[IsUnresolvedProfile](#IsUnresolvedProfile)||<a href="WebsiteClicked.md" target="_blank">CustomerInsightsJourneys/WebsiteClicked</a>|
|[IsUserLoggedIn](#IsUserLoggedIn)|Specifies whether the user is logged in|<a href="WebsiteClicked.md" target="_blank">CustomerInsightsJourneys/WebsiteClicked</a>|
|[LeadId](#LeadId)|Unique identifier of the Lead\.|<a href="WebsiteClicked.md" target="_blank">CustomerInsightsJourneys/WebsiteClicked</a>|
|[Link](#Link)|Link|<a href="WebsiteClicked.md" target="_blank">CustomerInsightsJourneys/WebsiteClicked</a>|
|[LinkFriendlyName](#LinkFriendlyName)|Link friendly name|<a href="WebsiteClicked.md" target="_blank">CustomerInsightsJourneys/WebsiteClicked</a>|
|[MessageId](#MessageId)|Message ID|<a href="WebsiteClicked.md" target="_blank">CustomerInsightsJourneys/WebsiteClicked</a>|
|[OperatingSystemId](#OperatingSystemId)|Operating system ID|<a href="WebsiteClicked.md" target="_blank">CustomerInsightsJourneys/WebsiteClicked</a>|
|[OperatingSystemVersion](#OperatingSystemVersion)|Operating system version|<a href="WebsiteClicked.md" target="_blank">CustomerInsightsJourneys/WebsiteClicked</a>|
|[OrganizationId](#OrganizationId)|Organization Id\.|<a href="WebsiteClicked.md" target="_blank">CustomerInsightsJourneys/WebsiteClicked</a>|
|[OrgGeo](#OrgGeo)|Org geo|<a href="WebsiteClicked.md" target="_blank">CustomerInsightsJourneys/WebsiteClicked</a>|
|[OrgTenantId](#OrgTenantId)|Org tenant ID|<a href="WebsiteClicked.md" target="_blank">CustomerInsightsJourneys/WebsiteClicked</a>|
|[PageAddress](#PageAddress)|Page address|<a href="WebsiteClicked.md" target="_blank">CustomerInsightsJourneys/WebsiteClicked</a>|
|[PageId](#PageId)|Page ID|<a href="WebsiteClicked.md" target="_blank">CustomerInsightsJourneys/WebsiteClicked</a>|
|[PostalCode](#PostalCode)|Postal code|<a href="WebsiteClicked.md" target="_blank">CustomerInsightsJourneys/WebsiteClicked</a>|
|[PreviousViews](#PreviousViews)|Previous views|<a href="WebsiteClicked.md" target="_blank">CustomerInsightsJourneys/WebsiteClicked</a>|
|[ProfileId](#ProfileId)|Unique identifier of the profile\.|<a href="WebsiteClicked.md" target="_blank">CustomerInsightsJourneys/WebsiteClicked</a>|
|[ProfileType](#ProfileType)|The profile type \(Contact, Lead or CI Profile\)|<a href="WebsiteClicked.md" target="_blank">CustomerInsightsJourneys/WebsiteClicked</a>|
|[ReferrerType](#ReferrerType)|Referrer type|<a href="WebsiteClicked.md" target="_blank">CustomerInsightsJourneys/WebsiteClicked</a>|
|[ReferrerUri](#ReferrerUri)|The uri of page from which the visited page has been requested|<a href="WebsiteClicked.md" target="_blank">CustomerInsightsJourneys/WebsiteClicked</a>|
|[SchedulerId](#SchedulerId)||<a href="WebsiteClicked.md" target="_blank">CustomerInsightsJourneys/WebsiteClicked</a>|
|[SearchEngineName](#SearchEngineName)|Search engine name|<a href="WebsiteClicked.md" target="_blank">CustomerInsightsJourneys/WebsiteClicked</a>|
|[SearchPhrase](#SearchPhrase)|Search phrase|<a href="WebsiteClicked.md" target="_blank">CustomerInsightsJourneys/WebsiteClicked</a>|
|[SendingId](#SendingId)|Indicates the journey iteration ID\.|<a href="WebsiteClicked.md" target="_blank">CustomerInsightsJourneys/WebsiteClicked</a>|
...
|[Timezone](#Timezone)|Timezone|<a href="WebsiteClicked.md" target="_blank">CustomerInsightsJourneys/WebsiteClicked</a>|
|[UsageType](#UsageType)|Usage type|<a href="WebsiteClicked.md" target="_blank">CustomerInsightsJourneys/WebsiteClicked</a>|
|[UserAgent](#UserAgent)|User agent|<a href="WebsiteClicked.md" target="_blank">CustomerInsightsJourneys/WebsiteClicked</a>|
|[UserLocalId](#UserLocalId)|User local ID|<a href="WebsiteClicked.md" target="_blank">CustomerInsightsJourneys/WebsiteClicked</a>|
|[UserState](#UserState)|User state|<a href="WebsiteClicked.md" target="_blank">CustomerInsightsJourneys/WebsiteClicked</a>|
|[UserTimeSinceVisit](#UserTimeSinceVisit)|The time the user spends on the page until a cookie is created|<a href="WebsiteClicked.md" target="_blank">CustomerInsightsJourneys/WebsiteClicked</a>|
|[UserTrackingContext](#UserTrackingContext)|The tracking context Id associated with the user|<a href="WebsiteClicked.md" target="_blank">CustomerInsightsJourneys/WebsiteClicked</a>|
|[Version](#Version)|Interaction version\. Used for updating the interaction\.|<a href="WebsiteClicked.md" target="_blank">CustomerInsightsJourneys/WebsiteClicked</a>|
|[ViewTitle](#ViewTitle)|View title|<a href="WebsiteClicked.md" target="_blank">CustomerInsightsJourneys/WebsiteClicked</a>|
|[ViewType](#ViewType)|View type|<a href="WebsiteClicked.md" target="_blank">CustomerInsightsJourneys/WebsiteClicked</a>|
|[VisitDuration](#VisitDuration)|Visit duration|<a href="WebsiteClicked.md" target="_blank">CustomerInsightsJourneys/WebsiteClicked</a>|
|[VisitorAnonymousStatus](#VisitorAnonymousStatus)|Visitor anonymous status|<a href="WebsiteClicked.md" target="_blank">CustomerInsightsJourneys/WebsiteClicked</a>|
|[VisitorId](#VisitorId)|Visitor ID|<a href="WebsiteClicked.md" target="_blank">CustomerInsightsJourneys/WebsiteClicked</a>|
|[VisitorReturningStatus](#VisitorReturningStatus)|Visitor returning status|<a href="WebsiteClicked.md" target="_blank">CustomerInsightsJourneys/WebsiteClicked</a>|
|[WebsiteId](#WebsiteId)|Website ID|<a href="WebsiteClicked.md" target="_blank">CustomerInsightsJourneys/WebsiteClicked</a>|
...
### <a href=#ActionElapsedTime name="ActionElapsedTime">ActionElapsedTime</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>description</td><td>Action elapsed time</td></tr><tr><td>dataFormat</td><td>string</td></tr></table>

#### Traits

<details>
<summary>List of traits for the ActionElapsedTime attribute are listed below.</summary>
...
\*\*is\.localized\.describedAs\*\*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Action elapsed time</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
### <a href=#ActionElementId name="ActionElementId">ActionElementId</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>description</td><td>Action element ID</td></tr><tr><td>dataFormat</td><td>string</td></tr></table>

#### Traits

<details>
<summary>List of traits for the ActionElementId attribute are listed below.</summary>
...
\*\*is\.localized\.describedAs\*\*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Action element ID</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
### <a href=#ActionIsOutbound name="ActionIsOutbound">ActionIsOutbound</a>

Specifies whether the action is outbound  
First included in: CustomerInsightsJourneys/WebsiteClicked \(this entity\)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>description</td><td>Specifies whether the action is outbound</td></tr><tr><td>dataFormat</td><td>boolean</td></tr></table>

#### Traits

<details>
<summary>List of traits for the ActionIsOutbound attribute are listed below.</summary>

\*\*is\.dataFormat\.boolean\*\*  
  \*\*is\.localized\.describedAs\*\*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Specifies whether the action is outbound</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
### <a href=#ActionTarget name="ActionTarget">ActionTarget</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>description</td><td>Action target</td></tr><tr><td>dataFormat</td><td>string</td></tr></table>

#### Traits

<details>
<summary>List of traits for the ActionTarget attribute are listed below.</summary>
...
\*\*is\.localized\.describedAs\*\*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Action target</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
