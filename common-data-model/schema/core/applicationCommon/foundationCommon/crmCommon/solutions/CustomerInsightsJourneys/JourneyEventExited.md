---
title: JourneyEventExited in CustomerInsightsJourneys - Common Data Model | Microsoft Docs
...
# JourneyEventExited in CustomerInsightsJourneys

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/CustomerInsightsJourneys/JourneyEventExited.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[BusinessUnitId](#BusinessUnitId)|Unique identifier of the Business unit\.|<a href="JourneyEventExited.md" target="_blank">CustomerInsightsJourneys/JourneyEventExited</a>|
|[CustomerJourneyId](#CustomerJourneyId)| Unique identifier of the Customer journey|<a href="JourneyEventExited.md" target="_blank">CustomerInsightsJourneys/JourneyEventExited</a>|
|[DropoffId](#DropoffId)|Unique identifier for events that cause a person to leave the journey\.|<a href="JourneyEventExited.md" target="_blank">CustomerInsightsJourneys/JourneyEventExited</a>|
|[IdempotencyId](#IdempotencyId)|Idempotency ID defines uniqueness of an analytics event\.|<a href="JourneyEventExited.md" target="_blank">CustomerInsightsJourneys/JourneyEventExited</a>|
|[InteractionType](#InteractionType)|Type of the interaction\.|<a href="JourneyEventExited.md" target="_blank">CustomerInsightsJourneys/JourneyEventExited</a>|
|[InternalMarketingInteractionId](#InternalMarketingInteractionId)|Internal marketing interaction Id\.|<a href="JourneyEventExited.md" target="_blank">CustomerInsightsJourneys/JourneyEventExited</a>|
|[IsUnresolvedProfile](#IsUnresolvedProfile)||<a href="JourneyEventExited.md" target="_blank">CustomerInsightsJourneys/JourneyEventExited</a>|
|[JourneyActionId](#JourneyActionId)|GUID of the journey action step associated with this event\.|<a href="JourneyEventExited.md" target="_blank">CustomerInsightsJourneys/JourneyEventExited</a>|
|[JourneyRunId](#JourneyRunId)|Flow run ID of the Power Automate run instance associated with this event\.|<a href="JourneyEventExited.md" target="_blank">CustomerInsightsJourneys/JourneyEventExited</a>|
|[JourneyStatus](#JourneyStatus)|Describes the results of processing a person entering a journey\. Indicates if a person was allowed or blocked from starting the journey\.|<a href="JourneyEventExited.md" target="_blank">CustomerInsightsJourneys/JourneyEventExited</a>|
|[JourneyVersion](#JourneyVersion)|Version number of the journey\.|<a href="JourneyEventExited.md" target="_blank">CustomerInsightsJourneys/JourneyEventExited</a>|
|[MessageId](#MessageId)|Message ID|<a href="JourneyEventExited.md" target="_blank">CustomerInsightsJourneys/JourneyEventExited</a>|
|[MessageTemplateVersion](#MessageTemplateVersion)|Message template version|<a href="JourneyEventExited.md" target="_blank">CustomerInsightsJourneys/JourneyEventExited</a>|
|[OrganizationId](#OrganizationId)|Organization Id\.|<a href="JourneyEventExited.md" target="_blank">CustomerInsightsJourneys/JourneyEventExited</a>|
|[ProfileId](#ProfileId)|Unique identifier of the profile\.|<a href="JourneyEventExited.md" target="_blank">CustomerInsightsJourneys/JourneyEventExited</a>|
|[ProfileType](#ProfileType)|The profile type \(Contact, Lead or CI Profile\)|<a href="JourneyEventExited.md" target="_blank">CustomerInsightsJourneys/JourneyEventExited</a>|
|[Reason](#Reason)|Journey status reason|<a href="JourneyEventExited.md" target="_blank">CustomerInsightsJourneys/JourneyEventExited</a>|
|[ReasonDetail](#ReasonDetail)|Provides additional information about the status of this event\.|<a href="JourneyEventExited.md" target="_blank">CustomerInsightsJourneys/JourneyEventExited</a>|
|[SegmentId](#SegmentId)|For segment based journeys, the GUID of the segment for this journey\.|<a href="JourneyEventExited.md" target="_blank">CustomerInsightsJourneys/JourneyEventExited</a>|
|[SegmentName](#SegmentName)|Segment name|<a href="JourneyEventExited.md" target="_blank">CustomerInsightsJourneys/JourneyEventExited</a>|
|[SourceSystem](#SourceSystem)| Refers to the source system that generated the interaction\. Outbound marketing \(OBM\) is represented by value 1\. Any other value than 1 represents Real\x2dtime journeys \(RTJ\)\.|<a href="JourneyEventExited.md" target="_blank">CustomerInsightsJourneys/JourneyEventExited</a>|
|[Timestamp](#Timestamp)|Indicates the exact date and time when the interaction was emitted\.|<a href="JourneyEventExited.md" target="_blank">CustomerInsightsJourneys/JourneyEventExited</a>|
|[Version](#Version)|Interaction version\. Used for updating the interaction\.|<a href="JourneyEventExited.md" target="_blank">CustomerInsightsJourneys/JourneyEventExited</a>|

### <a href=#BusinessUnitId name="BusinessUnitId">BusinessUnitId</a>

Unique identifier of the Business unit\.  
First included in: CustomerInsightsJourneys/JourneyEventExited \(this entity\)  
