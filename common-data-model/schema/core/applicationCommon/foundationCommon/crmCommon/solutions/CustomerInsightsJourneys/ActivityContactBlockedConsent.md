...
|---|---|---|
|[AccountId](#AccountId)|Unique identifier of the Account\.|<a href="ActivityContactBlockedConsent.md" target="_blank">CustomerInsightsJourneys/ActivityContactBlockedConsent</a>|
|[ActivityExpiryTime](#ActivityExpiryTime)|Activity expiry time|<a href="ActivityContactBlockedConsent.md" target="_blank">CustomerInsightsJourneys/ActivityContactBlockedConsent</a>|
|[ActivityId](#ActivityId)|Unique identifier of the Activity\.|<a href="ActivityContactBlockedConsent.md" target="_blank">CustomerInsightsJourneys/ActivityContactBlockedConsent</a>|
|[ActivityTypeId](#ActivityTypeId)|Activity type ID|<a href="ActivityContactBlockedConsent.md" target="_blank">CustomerInsightsJourneys/ActivityContactBlockedConsent</a>|
|[BusinessUnitId](#BusinessUnitId)|Unique identifier of the Business unit\.|<a href="ActivityContactBlockedConsent.md" target="_blank">CustomerInsightsJourneys/ActivityContactBlockedConsent</a>|
|[ContactId](#ContactId)|Unique identifier of the Contact\.|<a href="ActivityContactBlockedConsent.md" target="_blank">CustomerInsightsJourneys/ActivityContactBlockedConsent</a>|
|[CustomerJourneyId](#CustomerJourneyId)| Unique identifier of the Customer journey|<a href="ActivityContactBlockedConsent.md" target="_blank">CustomerInsightsJourneys/ActivityContactBlockedConsent</a>|
|[CustomerJourneyIterationId](#CustomerJourneyIterationId)|Customer journey iteration ID|<a href="ActivityContactBlockedConsent.md" target="_blank">CustomerInsightsJourneys/ActivityContactBlockedConsent</a>|
|[IdempotencyId](#IdempotencyId)|Idempotency ID defines uniqueness of an analytics event\.|<a href="ActivityContactBlockedConsent.md" target="_blank">CustomerInsightsJourneys/ActivityContactBlockedConsent</a>|
|[InteractionType](#InteractionType)|Type of the interaction\.|<a href="ActivityContactBlockedConsent.md" target="_blank">CustomerInsightsJourneys/ActivityContactBlockedConsent</a>|
|[InternalMarketingInteractionId](#InternalMarketingInteractionId)|Internal marketing interaction Id\.|<a href="ActivityContactBlockedConsent.md" target="_blank">CustomerInsightsJourneys/ActivityContactBlockedConsent</a>|
|[LeadId](#LeadId)|Unique identifier of the Lead\.|<a href="ActivityContactBlockedConsent.md" target="_blank">CustomerInsightsJourneys/ActivityContactBlockedConsent</a>|
|[OrganizationId](#OrganizationId)|Organization Id\.|<a href="ActivityContactBlockedConsent.md" target="_blank">CustomerInsightsJourneys/ActivityContactBlockedConsent</a>|
|[ProfileId](#ProfileId)|Unique identifier of the profile\.|<a href="ActivityContactBlockedConsent.md" target="_blank">CustomerInsightsJourneys/ActivityContactBlockedConsent</a>|
|[ProfileType](#ProfileType)|The profile type \(Contact, Lead or CI Profile\)|<a href="ActivityContactBlockedConsent.md" target="_blank">CustomerInsightsJourneys/ActivityContactBlockedConsent</a>|
|[SourceSystem](#SourceSystem)| Refers to the source system that generated the interaction\. Outbound marketing \(OBM\) is represented by value 1\. Any other value than 1 represents Real\x2dtime journeys \(RTJ\)\.|<a href="ActivityContactBlockedConsent.md" target="_blank">CustomerInsightsJourneys/ActivityContactBlockedConsent</a>|
|[Timestamp](#Timestamp)|Indicates the exact date and time when the interaction was emitted\.|<a href="ActivityContactBlockedConsent.md" target="_blank">CustomerInsightsJourneys/ActivityContactBlockedConsent</a>|
|[Version](#Version)|Interaction version\. Used for updating the interaction\.|<a href="ActivityContactBlockedConsent.md" target="_blank">CustomerInsightsJourneys/ActivityContactBlockedConsent</a>|
|[WorkflowId](#WorkflowId)|Outbound Marketing Workflow ID|<a href="ActivityContactBlockedConsent.md" target="_blank">CustomerInsightsJourneys/ActivityContactBlockedConsent</a>|
