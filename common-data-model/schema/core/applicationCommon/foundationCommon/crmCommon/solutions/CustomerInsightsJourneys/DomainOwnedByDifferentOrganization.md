...
description: Triggered when using non authenticated domain that is owned by another organization
...
Triggered when using non authenticated domain that is owned by another organization  
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Triggered when using non authenticated domain that is owned by another organization</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[AccountId](#AccountId)|Unique identifier of the Account\.|<a href="DomainOwnedByDifferentOrganization.md" target="_blank">CustomerInsightsJourneys/DomainOwnedByDifferentOrganization</a>|
|[ActivityExpiryTime](#ActivityExpiryTime)|Activity expiry time|<a href="DomainOwnedByDifferentOrganization.md" target="_blank">CustomerInsightsJourneys/DomainOwnedByDifferentOrganization</a>|
|[ActivityId](#ActivityId)|Unique identifier of the Activity\.|<a href="DomainOwnedByDifferentOrganization.md" target="_blank">CustomerInsightsJourneys/DomainOwnedByDifferentOrganization</a>|
|[BlockedReason](#BlockedReason)|Indicates the reason for email block\.|<a href="DomainOwnedByDifferentOrganization.md" target="_blank">CustomerInsightsJourneys/DomainOwnedByDifferentOrganization</a>|
|[BusinessUnitId](#BusinessUnitId)|Unique identifier of the Business unit\.|<a href="DomainOwnedByDifferentOrganization.md" target="_blank">CustomerInsightsJourneys/DomainOwnedByDifferentOrganization</a>|
|[ContactId](#ContactId)|Unique identifier of the Contact\.|<a href="DomainOwnedByDifferentOrganization.md" target="_blank">CustomerInsightsJourneys/DomainOwnedByDifferentOrganization</a>|
|[CustomerJourneyId](#CustomerJourneyId)| Unique identifier of the Customer journey|<a href="DomainOwnedByDifferentOrganization.md" target="_blank">CustomerInsightsJourneys/DomainOwnedByDifferentOrganization</a>|
|[CustomerJourneyIterationId](#CustomerJourneyIterationId)|Customer journey iteration ID|<a href="DomainOwnedByDifferentOrganization.md" target="_blank">CustomerInsightsJourneys/DomainOwnedByDifferentOrganization</a>|
|[IdempotencyId](#IdempotencyId)|Idempotency ID defines uniqueness of an analytics event\.|<a href="DomainOwnedByDifferentOrganization.md" target="_blank">CustomerInsightsJourneys/DomainOwnedByDifferentOrganization</a>|
|[InteractionType](#InteractionType)|Type of the interaction\.|<a href="DomainOwnedByDifferentOrganization.md" target="_blank">CustomerInsightsJourneys/DomainOwnedByDifferentOrganization</a>|
|[InternalMarketingInteractionId](#InternalMarketingInteractionId)|Internal marketing interaction Id\.|<a href="DomainOwnedByDifferentOrganization.md" target="_blank">CustomerInsightsJourneys/DomainOwnedByDifferentOrganization</a>|
|[IsSmartScheduled](#IsSmartScheduled)||<a href="DomainOwnedByDifferentOrganization.md" target="_blank">CustomerInsightsJourneys/DomainOwnedByDifferentOrganization</a>|
|[LeadId](#LeadId)|Unique identifier of the Lead\.|<a href="DomainOwnedByDifferentOrganization.md" target="_blank">CustomerInsightsJourneys/DomainOwnedByDifferentOrganization</a>|
|[MessageId](#MessageId)|Message ID|<a href="DomainOwnedByDifferentOrganization.md" target="_blank">CustomerInsightsJourneys/DomainOwnedByDifferentOrganization</a>|
|[OrganizationId](#OrganizationId)|Organization Id\.|<a href="DomainOwnedByDifferentOrganization.md" target="_blank">CustomerInsightsJourneys/DomainOwnedByDifferentOrganization</a>|
|[ProfileId](#ProfileId)|Unique identifier of the profile\.|<a href="DomainOwnedByDifferentOrganization.md" target="_blank">CustomerInsightsJourneys/DomainOwnedByDifferentOrganization</a>|
