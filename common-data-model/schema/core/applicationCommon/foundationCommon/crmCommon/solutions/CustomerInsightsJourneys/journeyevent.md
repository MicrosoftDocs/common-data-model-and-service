---
title: JourneyEvent in Customer Insights Journeys - Common Data Model | Microsoft Docs
...
# JourneyEvent in Customer Insights Journeys

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/CustomerInsightsJourneys/journeyevent.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[JourneyStatus](#JourneyStatus)|Journey status|<a href="journeyevent.md" target="_blank">CustomerInsightsJourneys/journeyevent</a>|
|[Reason](#Reason)|Journey status reason|<a href="journeyevent.md" target="_blank">CustomerInsightsJourneys/journeyevent</a>|
|[DropoffId](#DropoffId)|Dropoff ID|<a href="journeyevent.md" target="_blank">CustomerInsightsJourneys/journeyevent</a>|
|[ReasonDetail](#ReasonDetail)|Reason details|<a href="journeyevent.md" target="_blank">CustomerInsightsJourneys/journeyevent</a>|
|[JourneyVersion](#JourneyVersion)|Journey version|<a href="journeyevent.md" target="_blank">CustomerInsightsJourneys/journeyevent</a>|
|[SegmentId](#SegmentId)|Segment ID|<a href="journeyevent.md" target="_blank">CustomerInsightsJourneys/journeyevent</a>|
|[SegmentName](#SegmentName)|Segment name|<a href="journeyevent.md" target="_blank">CustomerInsightsJourneys/journeyevent</a>|
|[ProfileId](#ProfileId)|Unique identifier of the profile.|<a href="journeyevent.md" target="_blank">CustomerInsightsJourneys/journeyevent</a>|
|[ProfileType](#ProfileType)|The profile type (Contact, Lead or CI Profile)|<a href="journeyevent.md" target="_blank">CustomerInsightsJourneys/journeyevent</a>|
|[MessageId](#MessageId)|Message ID|<a href="journeyevent.md" target="_blank">CustomerInsightsJourneys/journeyevent</a>|
|[IsUnresolvedProfile](#IsUnresolvedProfile)||<a href="journeyevent.md" target="_blank">CustomerInsightsJourneys/journeyevent</a>|
|[JourneyRunId](#JourneyRunId)|Unique identifier of the Journey's execution.|<a href="journeyevent.md" target="_blank">CustomerInsightsJourneys/journeyevent</a>|
|[JourneyActionId](#JourneyActionId)|Journey Action Id|<a href="journeyevent.md" target="_blank">CustomerInsightsJourneys/journeyevent</a>|
|[CustomerJourneyId](#CustomerJourneyId)| Unique identifier of the Customer journey|<a href="journeyevent.md" target="_blank">CustomerInsightsJourneys/journeyevent</a>|
|[BusinessUnitId](#BusinessUnitId)|Unique identifier of the Business unit.|<a href="journeyevent.md" target="_blank">CustomerInsightsJourneys/journeyevent</a>|
|[IdempotencyId](#IdempotencyId)|Idempotency ID defines uniqueness of an analytics event.|<a href="journeyevent.md" target="_blank">CustomerInsightsJourneys/journeyevent</a>|
|[InternalMarketingInteractionId](#InternalMarketingInteractionId)|Internal marketing interaction Id.|<a href="journeyevent.md" target="_blank">CustomerInsightsJourneys/journeyevent</a>|
|[OrganizationId](#OrganizationId)|Organization Id.|<a href="journeyevent.md" target="_blank">CustomerInsightsJourneys/journeyevent</a>|
|[Timestamp](#Timestamp)|Indicates the exact date and time when the interaction was emitted.|<a href="journeyevent.md" target="_blank">CustomerInsightsJourneys/journeyevent</a>|
|[Version](#Version)|Interaction version. Used for updating the interaction.|<a href="journeyevent.md" target="_blank">CustomerInsightsJourneys/journeyevent</a>|
|[SourceSystem](#SourceSystem)| Refers to the source system that generated the interaction. Outbound marketing (OBM) is represented by value 1. Any other value than 1 represents Real-time journeys (RTJ).|<a href="journeyevent.md" target="_blank">CustomerInsightsJourneys/journeyevent</a>|
|[InteractionType](#InteractionType)|Type of the interaction.|<a href="journeyevent.md" target="_blank">CustomerInsightsJourneys/journeyevent</a>|
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>description</td><td>Journey status</td></tr><tr><td>dataFormat</td><td>string</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>description</td><td>Dropoff ID</td></tr><tr><td>dataFormat</td><td>string</td></tr></table>
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Dropoff ID</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>description</td><td>Reason details</td></tr><tr><td>dataFormat</td><td>string</td></tr></table>
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason details</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>description</td><td>Journey version</td></tr><tr><td>dataFormat</td><td>string</td></tr></table>
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Journey version</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>description</td><td>Segment ID</td></tr><tr><td>dataFormat</td><td>guid</td></tr></table>
...
**is.dataFormat.guid**  
  **is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Segment ID</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
