---
title: TriggerCrmWorkflowActivityContactProcessed in CustomerInsightsJourneys - Common Data Model | Microsoft Docs
...
# TriggerCrmWorkflowActivityContactProcessed in CustomerInsightsJourneys

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/CustomerInsightsJourneys/TriggerCrmWorkflowActivityContactProcessed.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[AccountId](#AccountId)|Unique identifier of the Account\.|<a href="TriggerCrmWorkflowActivityContactProcessed.md" target="_blank">CustomerInsightsJourneys/TriggerCrmWorkflowActivityContactProcessed</a>|
|[ActivityExpiryTime](#ActivityExpiryTime)|Activity expiry time|<a href="TriggerCrmWorkflowActivityContactProcessed.md" target="_blank">CustomerInsightsJourneys/TriggerCrmWorkflowActivityContactProcessed</a>|
|[ActivityId](#ActivityId)|Unique identifier of the Activity\.|<a href="TriggerCrmWorkflowActivityContactProcessed.md" target="_blank">CustomerInsightsJourneys/TriggerCrmWorkflowActivityContactProcessed</a>|
|[BusinessUnitId](#BusinessUnitId)|Unique identifier of the Business unit\.|<a href="TriggerCrmWorkflowActivityContactProcessed.md" target="_blank">CustomerInsightsJourneys/TriggerCrmWorkflowActivityContactProcessed</a>|
|[ContactId](#ContactId)|Unique identifier of the Contact\.|<a href="TriggerCrmWorkflowActivityContactProcessed.md" target="_blank">CustomerInsightsJourneys/TriggerCrmWorkflowActivityContactProcessed</a>|
|[CustomerJourneyId](#CustomerJourneyId)| Unique identifier of the Customer journey|<a href="TriggerCrmWorkflowActivityContactProcessed.md" target="_blank">CustomerInsightsJourneys/TriggerCrmWorkflowActivityContactProcessed</a>|
|[CustomerJourneyIterationId](#CustomerJourneyIterationId)|Customer journey iteration ID|<a href="TriggerCrmWorkflowActivityContactProcessed.md" target="_blank">CustomerInsightsJourneys/TriggerCrmWorkflowActivityContactProcessed</a>|
|[IdempotencyId](#IdempotencyId)|Idempotency ID defines uniqueness of an analytics event\.|<a href="TriggerCrmWorkflowActivityContactProcessed.md" target="_blank">CustomerInsightsJourneys/TriggerCrmWorkflowActivityContactProcessed</a>|
|[InteractionType](#InteractionType)|Type of the interaction\.|<a href="TriggerCrmWorkflowActivityContactProcessed.md" target="_blank">CustomerInsightsJourneys/TriggerCrmWorkflowActivityContactProcessed</a>|
|[InternalMarketingInteractionId](#InternalMarketingInteractionId)|Internal marketing interaction Id\.|<a href="TriggerCrmWorkflowActivityContactProcessed.md" target="_blank">CustomerInsightsJourneys/TriggerCrmWorkflowActivityContactProcessed</a>|
|[LeadId](#LeadId)|Unique identifier of the Lead\.|<a href="TriggerCrmWorkflowActivityContactProcessed.md" target="_blank">CustomerInsightsJourneys/TriggerCrmWorkflowActivityContactProcessed</a>|
|[OrganizationId](#OrganizationId)|Organization Id\.|<a href="TriggerCrmWorkflowActivityContactProcessed.md" target="_blank">CustomerInsightsJourneys/TriggerCrmWorkflowActivityContactProcessed</a>|
|[ProfileId](#ProfileId)|Unique identifier of the profile\.|<a href="TriggerCrmWorkflowActivityContactProcessed.md" target="_blank">CustomerInsightsJourneys/TriggerCrmWorkflowActivityContactProcessed</a>|
|[ProfileType](#ProfileType)|The profile type \(Contact, Lead or CI Profile\)|<a href="TriggerCrmWorkflowActivityContactProcessed.md" target="_blank">CustomerInsightsJourneys/TriggerCrmWorkflowActivityContactProcessed</a>|
|[SourceSystem](#SourceSystem)| Refers to the source system that generated the interaction\. Outbound marketing \(OBM\) is represented by value 1\. Any other value than 1 represents Real\x2dtime journeys \(RTJ\)\.|<a href="TriggerCrmWorkflowActivityContactProcessed.md" target="_blank">CustomerInsightsJourneys/TriggerCrmWorkflowActivityContactProcessed</a>|
|[Timestamp](#Timestamp)|Indicates the exact date and time when the interaction was emitted\.|<a href="TriggerCrmWorkflowActivityContactProcessed.md" target="_blank">CustomerInsightsJourneys/TriggerCrmWorkflowActivityContactProcessed</a>|
|[Version](#Version)|Interaction version\. Used for updating the interaction\.|<a href="TriggerCrmWorkflowActivityContactProcessed.md" target="_blank">CustomerInsightsJourneys/TriggerCrmWorkflowActivityContactProcessed</a>|
|[WorkflowId](#WorkflowId)|Outbound Marketing Workflow ID|<a href="TriggerCrmWorkflowActivityContactProcessed.md" target="_blank">CustomerInsightsJourneys/TriggerCrmWorkflowActivityContactProcessed</a>|

### <a href=#AccountId name="AccountId">AccountId</a>

Unique identifier of the Account\.  
First included in: CustomerInsightsJourneys/TriggerCrmWorkflowActivityContactProcessed \(this entity\)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>description</td><td>Outbound Marketing Workflow ID</td></tr><tr><td>dataFormat</td><td>guid</td></tr></table>
