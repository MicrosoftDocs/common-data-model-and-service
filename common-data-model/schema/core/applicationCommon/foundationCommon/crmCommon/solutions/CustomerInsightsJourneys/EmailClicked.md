...
|---|---|---|
|[AccountId](#AccountId)|Unique identifier of the Account\.|<a href="EmailClicked.md" target="_blank">CustomerInsightsJourneys/EmailClicked</a>|
|[ActivityExpiryTime](#ActivityExpiryTime)|Activity expiry time|<a href="EmailClicked.md" target="_blank">CustomerInsightsJourneys/EmailClicked</a>|
|[ActivityId](#ActivityId)|Unique identifier of the Activity\.|<a href="EmailClicked.md" target="_blank">CustomerInsightsJourneys/EmailClicked</a>|
|[BrowserId](#BrowserId)|Browser ID|<a href="EmailClicked.md" target="_blank">CustomerInsightsJourneys/EmailClicked</a>|
|[BrowserVersion](#BrowserVersion)|Browser version|<a href="EmailClicked.md" target="_blank">CustomerInsightsJourneys/EmailClicked</a>|
|[BusinessUnitId](#BusinessUnitId)|Unique identifier of the Business unit\.|<a href="EmailClicked.md" target="_blank">CustomerInsightsJourneys/EmailClicked</a>|
|[ChannelEventName](#ChannelEventName)|Channel event name|<a href="EmailClicked.md" target="_blank">CustomerInsightsJourneys/EmailClicked</a>|
|[City](#City)|City|<a href="EmailClicked.md" target="_blank">CustomerInsightsJourneys/EmailClicked</a>|
|[ContactId](#ContactId)|Unique identifier of the Contact\.|<a href="EmailClicked.md" target="_blank">CustomerInsightsJourneys/EmailClicked</a>|
|[CountryIsoCode](#CountryIsoCode)|Country ISO code|<a href="EmailClicked.md" target="_blank">CustomerInsightsJourneys/EmailClicked</a>|
|[CustomerJourneyId](#CustomerJourneyId)| Unique identifier of the Customer journey|<a href="EmailClicked.md" target="_blank">CustomerInsightsJourneys/EmailClicked</a>|
|[CustomerJourneyIterationId](#CustomerJourneyIterationId)|Customer journey iteration ID|<a href="EmailClicked.md" target="_blank">CustomerInsightsJourneys/EmailClicked</a>|
|[Details](#Details)|Details|<a href="EmailClicked.md" target="_blank">CustomerInsightsJourneys/EmailClicked</a>|
|[DeviceTypeId](#DeviceTypeId)|Represents device type id that maps to a device type name extracted during parsing of an user agent|<a href="EmailClicked.md" target="_blank">CustomerInsightsJourneys/EmailClicked</a>|
|[EmailAddressUsed](#EmailAddressUsed)|The profile's email address\.|<a href="EmailClicked.md" target="_blank">CustomerInsightsJourneys/EmailClicked</a>|
|[EmailDomain](#EmailDomain)|Email domain|<a href="EmailClicked.md" target="_blank">CustomerInsightsJourneys/EmailClicked</a>|
|[IdempotencyId](#IdempotencyId)|Idempotency ID defines uniqueness of an analytics event\.|<a href="EmailClicked.md" target="_blank">CustomerInsightsJourneys/EmailClicked</a>|
|[InteractionType](#InteractionType)|Type of the interaction\.|<a href="EmailClicked.md" target="_blank">CustomerInsightsJourneys/EmailClicked</a>|
|[InternalMarketingInteractionId](#InternalMarketingInteractionId)|Internal marketing interaction Id\.|<a href="EmailClicked.md" target="_blank">CustomerInsightsJourneys/EmailClicked</a>|
|[IsSmartScheduled](#IsSmartScheduled)||<a href="EmailClicked.md" target="_blank">CustomerInsightsJourneys/EmailClicked</a>|
|[IsUnresolvedProfile](#IsUnresolvedProfile)||<a href="EmailClicked.md" target="_blank">CustomerInsightsJourneys/EmailClicked</a>|
|[JourneyActionId](#JourneyActionId)|GUID of the journey action step associated with this event\.|<a href="EmailClicked.md" target="_blank">CustomerInsightsJourneys/EmailClicked</a>|
|[JourneyRunId](#JourneyRunId)|Flow run ID of the Power Automate run instance associated with this event\.|<a href="EmailClicked.md" target="_blank">CustomerInsightsJourneys/EmailClicked</a>|
|[LeadId](#LeadId)|Unique identifier of the Lead\.|<a href="EmailClicked.md" target="_blank">CustomerInsightsJourneys/EmailClicked</a>|
|[Link](#Link)|Link|<a href="EmailClicked.md" target="_blank">CustomerInsightsJourneys/EmailClicked</a>|
|[LinkFriendlyName](#LinkFriendlyName)|Link friendly name|<a href="EmailClicked.md" target="_blank">CustomerInsightsJourneys/EmailClicked</a>|
|[LinkId](#LinkId)|Link ID|<a href="EmailClicked.md" target="_blank">CustomerInsightsJourneys/EmailClicked</a>|
|[LinkText](#LinkText)|Link text|<a href="EmailClicked.md" target="_blank">CustomerInsightsJourneys/EmailClicked</a>|
|[MessageId](#MessageId)|Message ID|<a href="EmailClicked.md" target="_blank">CustomerInsightsJourneys/EmailClicked</a>|
|[MessageVariationIndexes](#MessageVariationIndexes)||<a href="EmailClicked.md" target="_blank">CustomerInsightsJourneys/EmailClicked</a>|
|[MessageVariationName](#MessageVariationName)||<a href="EmailClicked.md" target="_blank">CustomerInsightsJourneys/EmailClicked</a>|
|[OperatingSystemId](#OperatingSystemId)|Operating system ID|<a href="EmailClicked.md" target="_blank">CustomerInsightsJourneys/EmailClicked</a>|
|[OperatingSystemVersion](#OperatingSystemVersion)|Operating system version|<a href="EmailClicked.md" target="_blank">CustomerInsightsJourneys/EmailClicked</a>|
|[OrganizationId](#OrganizationId)|Organization Id\.|<a href="EmailClicked.md" target="_blank">CustomerInsightsJourneys/EmailClicked</a>|
|[OriginalContentLink](#OriginalContentLink)|Original content link|<a href="EmailClicked.md" target="_blank">CustomerInsightsJourneys/EmailClicked</a>|
|[OriginalLink](#OriginalLink)|Original link|<a href="EmailClicked.md" target="_blank">CustomerInsightsJourneys/EmailClicked</a>|
|[OriginalUrl](#OriginalUrl)|Refers to the original, unaltered URL provided to the user before any personalization or dynamic content was applied\.|<a href="EmailClicked.md" target="_blank">CustomerInsightsJourneys/EmailClicked</a>|
|[PostalCode](#PostalCode)|Postal code|<a href="EmailClicked.md" target="_blank">CustomerInsightsJourneys/EmailClicked</a>|
|[ProfileId](#ProfileId)|Unique identifier of the profile\.|<a href="EmailClicked.md" target="_blank">CustomerInsightsJourneys/EmailClicked</a>|
|[ProfileType](#ProfileType)|The profile type \(Contact, Lead or CI Profile\)|<a href="EmailClicked.md" target="_blank">CustomerInsightsJourneys/EmailClicked</a>|
|[SchedulerId](#SchedulerId)||<a href="EmailClicked.md" target="_blank">CustomerInsightsJourneys/EmailClicked</a>|
|[SearchEngineName](#SearchEngineName)|Search engine name|<a href="EmailClicked.md" target="_blank">CustomerInsightsJourneys/EmailClicked</a>|
|[SearchPhrase](#SearchPhrase)|Search phrase|<a href="EmailClicked.md" target="_blank">CustomerInsightsJourneys/EmailClicked</a>|
|[SendingId](#SendingId)|Indicates the journey iteration ID\.|<a href="EmailClicked.md" target="_blank">CustomerInsightsJourneys/EmailClicked</a>|
...
|[UsageType](#UsageType)|Usage type|<a href="EmailClicked.md" target="_blank">CustomerInsightsJourneys/EmailClicked</a>|
|[Version](#Version)|Interaction version\. Used for updating the interaction\.|<a href="EmailClicked.md" target="_blank">CustomerInsightsJourneys/EmailClicked</a>|
|[VisitDuration](#VisitDuration)|Visit duration|<a href="EmailClicked.md" target="_blank">CustomerInsightsJourneys/EmailClicked</a>|
|[VisitorAnonymousStatus](#VisitorAnonymousStatus)|Visitor anonymous status|<a href="EmailClicked.md" target="_blank">CustomerInsightsJourneys/EmailClicked</a>|
|[VisitorId](#VisitorId)|Visitor ID|<a href="EmailClicked.md" target="_blank">CustomerInsightsJourneys/EmailClicked</a>|
|[VisitorReturningStatus](#VisitorReturningStatus)|Visitor returning status|<a href="EmailClicked.md" target="_blank">CustomerInsightsJourneys/EmailClicked</a>|
...
Represents device type id that maps to a device type name extracted during parsing of an user agent  
First included in: CustomerInsightsJourneys/EmailClicked \(this entity\)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>description</td><td>Represents device type id that maps to a device type name extracted during parsing of an user agent</td></tr><tr><td>dataFormat</td><td>guid</td></tr></table>
