---
title: EmailBlockedContactabilityDoNotEmail in CustomerInsightsJourneys - Common Data Model | Microsoft Docs
...
# EmailBlockedContactabilityDoNotEmail in CustomerInsightsJourneys

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/CustomerInsightsJourneys/EmailBlockedContactabilityDoNotEmail.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[BlockedReason](#BlockedReason)|Indicates the reason for email block\.|<a href="EmailBlockedContactabilityDoNotEmail.md" target="_blank">CustomerInsightsJourneys/EmailBlockedContactabilityDoNotEmail</a>|
|[BusinessUnitId](#BusinessUnitId)|Unique identifier of the Business unit\.|<a href="EmailBlockedContactabilityDoNotEmail.md" target="_blank">CustomerInsightsJourneys/EmailBlockedContactabilityDoNotEmail</a>|
|[Category](#Category)|Category|<a href="EmailBlockedContactabilityDoNotEmail.md" target="_blank">CustomerInsightsJourneys/EmailBlockedContactabilityDoNotEmail</a>|
|[CustomerJourneyId](#CustomerJourneyId)| Unique identifier of the Customer journey|<a href="EmailBlockedContactabilityDoNotEmail.md" target="_blank">CustomerInsightsJourneys/EmailBlockedContactabilityDoNotEmail</a>|
|[Details](#Details)|Contains additional information regarding the reason of block\.|<a href="EmailBlockedContactabilityDoNotEmail.md" target="_blank">CustomerInsightsJourneys/EmailBlockedContactabilityDoNotEmail</a>|
|[EmailAddressUsed](#EmailAddressUsed)|The profile's email address\.|<a href="EmailBlockedContactabilityDoNotEmail.md" target="_blank">CustomerInsightsJourneys/EmailBlockedContactabilityDoNotEmail</a>|
|[IdempotencyId](#IdempotencyId)|Idempotency ID defines uniqueness of an analytics event\.|<a href="EmailBlockedContactabilityDoNotEmail.md" target="_blank">CustomerInsightsJourneys/EmailBlockedContactabilityDoNotEmail</a>|
|[InteractionType](#InteractionType)|Type of the interaction\.|<a href="EmailBlockedContactabilityDoNotEmail.md" target="_blank">CustomerInsightsJourneys/EmailBlockedContactabilityDoNotEmail</a>|
|[InternalMarketingInteractionId](#InternalMarketingInteractionId)|Internal marketing interaction Id\.|<a href="EmailBlockedContactabilityDoNotEmail.md" target="_blank">CustomerInsightsJourneys/EmailBlockedContactabilityDoNotEmail</a>|
|[IsUnresolvedProfile](#IsUnresolvedProfile)||<a href="EmailBlockedContactabilityDoNotEmail.md" target="_blank">CustomerInsightsJourneys/EmailBlockedContactabilityDoNotEmail</a>|
|[JourneyActionId](#JourneyActionId)|GUID of the journey action step associated with this event\.|<a href="EmailBlockedContactabilityDoNotEmail.md" target="_blank">CustomerInsightsJourneys/EmailBlockedContactabilityDoNotEmail</a>|
|[JourneyRunId](#JourneyRunId)|Flow run ID of the Power Automate run instance associated with this event\.|<a href="EmailBlockedContactabilityDoNotEmail.md" target="_blank">CustomerInsightsJourneys/EmailBlockedContactabilityDoNotEmail</a>|
|[MessageId](#MessageId)|Message ID|<a href="EmailBlockedContactabilityDoNotEmail.md" target="_blank">CustomerInsightsJourneys/EmailBlockedContactabilityDoNotEmail</a>|
|[MessageTemplateVersion](#MessageTemplateVersion)|Message template version|<a href="EmailBlockedContactabilityDoNotEmail.md" target="_blank">CustomerInsightsJourneys/EmailBlockedContactabilityDoNotEmail</a>|
|[MessageVariationIndexes](#MessageVariationIndexes)||<a href="EmailBlockedContactabilityDoNotEmail.md" target="_blank">CustomerInsightsJourneys/EmailBlockedContactabilityDoNotEmail</a>|
|[MessageVariationName](#MessageVariationName)||<a href="EmailBlockedContactabilityDoNotEmail.md" target="_blank">CustomerInsightsJourneys/EmailBlockedContactabilityDoNotEmail</a>|
|[OrganizationId](#OrganizationId)|Organization Id\.|<a href="EmailBlockedContactabilityDoNotEmail.md" target="_blank">CustomerInsightsJourneys/EmailBlockedContactabilityDoNotEmail</a>|
|[ProfileId](#ProfileId)|Unique identifier of the profile\.|<a href="EmailBlockedContactabilityDoNotEmail.md" target="_blank">CustomerInsightsJourneys/EmailBlockedContactabilityDoNotEmail</a>|
|[ProfileType](#ProfileType)|The profile type \(Contact, Lead or CI Profile\)|<a href="EmailBlockedContactabilityDoNotEmail.md" target="_blank">CustomerInsightsJourneys/EmailBlockedContactabilityDoNotEmail</a>|
|[SourceSystem](#SourceSystem)| Refers to the source system that generated the interaction\. Outbound marketing \(OBM\) is represented by value 1\. Any other value than 1 represents Real\x2dtime journeys \(RTJ\)\.|<a href="EmailBlockedContactabilityDoNotEmail.md" target="_blank">CustomerInsightsJourneys/EmailBlockedContactabilityDoNotEmail</a>|
|[Timestamp](#Timestamp)|Indicates the exact date and time when the interaction was emitted\.|<a href="EmailBlockedContactabilityDoNotEmail.md" target="_blank">CustomerInsightsJourneys/EmailBlockedContactabilityDoNotEmail</a>|
|[Version](#Version)|Interaction version\. Used for updating the interaction\.|<a href="EmailBlockedContactabilityDoNotEmail.md" target="_blank">CustomerInsightsJourneys/EmailBlockedContactabilityDoNotEmail</a>|

### <a href=#BlockedReason name="BlockedReason">BlockedReason</a>

Indicates the reason for email block\.  
First included in: CustomerInsightsJourneys/EmailBlockedContactabilityDoNotEmail \(this entity\)  
