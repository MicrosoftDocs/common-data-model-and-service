...
- [/SLAKPIInstance.cdm.json/SLAKPIInstance](../../../SLAKPIInstance.md "/core/applicationCommon/SLAKPIInstance.cdm.json/SLAKPIInstance")  
- /crmCommon/service/SLAKPIInstance  
...
|---|---|---|
|[SLAKPIInstanceId](#SLAKPIInstanceId)|Unique identifier of the SLA KPI Instance.|<a href="SLAKPIInstance.md" target="_blank">service/SLAKPIInstance</a>|
|[name](#name)|Type a descriptive name for the service level agreement (SLA) key performance indicator (KPI) instance.|<a href="SLAKPIInstance.md" target="_blank">service/SLAKPIInstance</a>|
|[computedFailureTime](#computedFailureTime)|Computed Failure Date and time|<a href="SLAKPIInstance.md" target="_blank">service/SLAKPIInstance</a>|
|[computedWarningTime](#computedWarningTime)|Computed Warning Date and time|<a href="SLAKPIInstance.md" target="_blank">service/SLAKPIInstance</a>|
|[failureTime](#failureTime)|Enter the date and time when the service level agreement (SLA) key performance indicator (KPI) will expire.|<a href="SLAKPIInstance.md" target="_blank">service/SLAKPIInstance</a>|
|[ownerId](#ownerId)|Owner Id|<a href="SLAKPIInstance.md" target="_blank">service/SLAKPIInstance</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="SLAKPIInstance.md" target="_blank">service/SLAKPIInstance</a>|
|[owningUser](#owningUser)|Owning User.|<a href="SLAKPIInstance.md" target="_blank">service/SLAKPIInstance</a>|
|[owningTeam](#owningTeam)|OwningTeam.|<a href="SLAKPIInstance.md" target="_blank">service/SLAKPIInstance</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Owning Business Unit.|<a href="SLAKPIInstance.md" target="_blank">service/SLAKPIInstance</a>|
|[regarding](#regarding)|Unique identifier of the record that this service level agreement (SLA) key performance indicator (KPI) instance is associated with.|<a href="SLAKPIInstance.md" target="_blank">service/SLAKPIInstance</a>|
|[status](#status)|Reason for the status of the service level agreement (SLA) key performance indicator (KPI) instance. For example, the SLA KPI could be Noncompliant or Succeeded.|<a href="SLAKPIInstance.md" target="_blank">service/SLAKPIInstance</a>|
|[status_display](#status_display)||<a href="SLAKPIInstance.md" target="_blank">service/SLAKPIInstance</a>|
|[succeededOn](#succeededOn)|Shows the date and time when the service level agreement (SLA) key performance indicator (KPI) success criteria was met.|<a href="SLAKPIInstance.md" target="_blank">service/SLAKPIInstance</a>|
|[warningTime](#warningTime)|Enter the date and time when the service level agreement (SLA) key performance indicator (KPI)will go to a warning state.|<a href="SLAKPIInstance.md" target="_blank">service/SLAKPIInstance</a>|
|[transactionCurrencyId](#transactionCurrencyId)|Choose the local currency for the record to make sure budgets are reported in the correct currency.|<a href="SLAKPIInstance.md" target="_blank">service/SLAKPIInstance</a>|
|[exchangeRate](#exchangeRate)|For internal use only.|<a href="SLAKPIInstance.md" target="_blank">service/SLAKPIInstance</a>|
|[createdBy](#createdBy)|For internal use only.|<a href="SLAKPIInstance.md" target="_blank">service/SLAKPIInstance</a>|
|[createdOn](#createdOn)|For internal use only.|<a href="SLAKPIInstance.md" target="_blank">service/SLAKPIInstance</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|For internal use only.|<a href="SLAKPIInstance.md" target="_blank">service/SLAKPIInstance</a>|
|[description](#description)|For internal use only.|<a href="SLAKPIInstance.md" target="_blank">service/SLAKPIInstance</a>|
|[modifiedBy](#modifiedBy)|For internal use only.|<a href="SLAKPIInstance.md" target="_blank">service/SLAKPIInstance</a>|
|[modifiedOn](#modifiedOn)|For internal use only.|<a href="SLAKPIInstance.md" target="_blank">service/SLAKPIInstance</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|For internal use only.|<a href="SLAKPIInstance.md" target="_blank">service/SLAKPIInstance</a>|
|[versionNumber](#versionNumber)|For internal use only.|<a href="SLAKPIInstance.md" target="_blank">service/SLAKPIInstance</a>|
|[warningTimeReached](#warningTimeReached)|Shows information about whether the case has reached its warning time.|<a href="SLAKPIInstance.md" target="_blank">service/SLAKPIInstance</a>|
|[warningTimeReached_display](#warningTimeReached_display)||<a href="SLAKPIInstance.md" target="_blank">service/SLAKPIInstance</a>|
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Regarding Type</td></tr><tr><td>description</td><td>The name of the entity linked by Regarding</td></tr><tr><td>dataFormat</td><td>7</td></tr><tr><td>isReadOnly</td><td>true</td></tr><tr><td>sourceName</td><td>regardingobjecttypecode</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>The name of the entity linked by Regarding</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
