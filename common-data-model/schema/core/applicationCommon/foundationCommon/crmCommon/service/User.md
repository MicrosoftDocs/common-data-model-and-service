---
title: User in service - Common Data Model | Microsoft Docs
...
|---|---|---|
|[systemUserId](#systemUserId)|Unique identifier for the user.|<a href="User.md" target="_blank">service/User</a>|
|[organizationId](#organizationId)|Unique identifier of the organization associated with the user.|<a href="User.md" target="_blank">service/User</a>|
|[businessUnitId](#businessUnitId)|Unique identifier of the business unit with which the user is associated.|<a href="User.md" target="_blank">service/User</a>|
|[parentSystemUserId](#parentSystemUserId)|Unique identifier of the manager of the user.|<a href="User.md" target="_blank">service/User</a>|
|[firstName](#firstName)|First name of the user.|<a href="User.md" target="_blank">service/User</a>|
|[salutation](#salutation)|Salutation for correspondence with the user.|<a href="User.md" target="_blank">service/User</a>|
|[middleName](#middleName)|Middle name of the user.|<a href="User.md" target="_blank">service/User</a>|
|[lastName](#lastName)|Last name of the user.|<a href="User.md" target="_blank">service/User</a>|
|[personalEMailAddress](#personalEMailAddress)|Personal email address of the user.|<a href="User.md" target="_blank">service/User</a>|
|[fullName](#fullName)|Full name of the user.|<a href="User.md" target="_blank">service/User</a>|
|[nickName](#nickName)|Nickname of the user.|<a href="User.md" target="_blank">service/User</a>|
|[title](#title)|Title of the user.|<a href="User.md" target="_blank">service/User</a>|
|[internalEMailAddress](#internalEMailAddress)|Internal email address for the user.|<a href="User.md" target="_blank">service/User</a>|
|[jobTitle](#jobTitle)|Job title of the user.|<a href="User.md" target="_blank">service/User</a>|
|[mobileAlertEMail](#mobileAlertEMail)|Mobile alert email address for the user.|<a href="User.md" target="_blank">service/User</a>|
|[preferredEmailCode](#preferredEmailCode)|Preferred email address for the user.|<a href="User.md" target="_blank">service/User</a>|
|[preferredEmailCode_display](#preferredEmailCode_display)||<a href="User.md" target="_blank">service/User</a>|
|[homePhone](#homePhone)|Home phone number for the user.|<a href="User.md" target="_blank">service/User</a>|
|[mobilePhone](#mobilePhone)|Mobile phone number for the user.|<a href="User.md" target="_blank">service/User</a>|
|[preferredPhoneCode](#preferredPhoneCode)|Preferred phone number for the user.|<a href="User.md" target="_blank">service/User</a>|
|[preferredPhoneCode_display](#preferredPhoneCode_display)||<a href="User.md" target="_blank">service/User</a>|
|[preferredAddressCode](#preferredAddressCode)|Preferred address for the user.|<a href="User.md" target="_blank">service/User</a>|
|[preferredAddressCode_display](#preferredAddressCode_display)||<a href="User.md" target="_blank">service/User</a>|
|[photoUrl](#photoUrl)|URL for the Website on which a photo of the user is located.|<a href="User.md" target="_blank">service/User</a>|
|[domainName](#domainName)|Active Directory domain of which the user is a member.|<a href="User.md" target="_blank">service/User</a>|
|[passportLo](#passportLo)|For internal use only.|<a href="User.md" target="_blank">service/User</a>|
|[createdOn](#createdOn)|Date and time when the user was created.|<a href="User.md" target="_blank">service/User</a>|
|[passportHi](#passportHi)|For internal use only.|<a href="User.md" target="_blank">service/User</a>|
|[disabledReason](#disabledReason)|Reason for disabling the user.|<a href="User.md" target="_blank">service/User</a>|
|[modifiedOn](#modifiedOn)|Date and time when the user was last modified.|<a href="User.md" target="_blank">service/User</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the user.|<a href="User.md" target="_blank">service/User</a>|
|[employeeId](#employeeId)|Employee identifier for the user.|<a href="User.md" target="_blank">service/User</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who last modified the user.|<a href="User.md" target="_blank">service/User</a>|
|[isDisabled](#isDisabled)|Information about whether the user is enabled.|<a href="User.md" target="_blank">service/User</a>|
|[governmentId](#governmentId)|Government identifier for the user.|<a href="User.md" target="_blank">service/User</a>|
|[versionNumber](#versionNumber)|Version number of the user.|<a href="User.md" target="_blank">service/User</a>|
|[address1AddressId](#address1AddressId)|Unique identifier for address 1.|<a href="User.md" target="_blank">service/User</a>|
|[address1AddressTypeCode](#address1AddressTypeCode)|Type of address for address 1, such as billing, shipping, or primary address.|<a href="User.md" target="_blank">service/User</a>|
|[address1AddressTypeCode_display](#address1AddressTypeCode_display)||<a href="User.md" target="_blank">service/User</a>|
|[address1Name](#address1Name)|Name to enter for address 1.|<a href="User.md" target="_blank">service/User</a>|
|[address1Line1](#address1Line1)|First line for entering address 1 information.|<a href="User.md" target="_blank">service/User</a>|
|[address1Line2](#address1Line2)|Second line for entering address 1 information.|<a href="User.md" target="_blank">service/User</a>|
|[address1Line3](#address1Line3)|Third line for entering address 1 information.|<a href="User.md" target="_blank">service/User</a>|
|[address1City](#address1City)|City name for address 1.|<a href="User.md" target="_blank">service/User</a>|
|[address1StateOrProvince](#address1StateOrProvince)|State or province for address 1.|<a href="User.md" target="_blank">service/User</a>|
|[address1County](#address1County)|County name for address 1.|<a href="User.md" target="_blank">service/User</a>|
|[address1Country](#address1Country)|Country/region name in address 1.|<a href="User.md" target="_blank">service/User</a>|
|[address1PostOfficeBox](#address1PostOfficeBox)|Post office box number for address 1.|<a href="User.md" target="_blank">service/User</a>|
|[address1PostalCode](#address1PostalCode)|ZIP Code or postal code for address 1.|<a href="User.md" target="_blank">service/User</a>|
|[address1UTCOffset](#address1UTCOffset)|UTC offset for address 1. This is the difference between local time and standard Coordinated Universal Time.|<a href="User.md" target="_blank">service/User</a>|
|[address1UPSZone](#address1UPSZone)|United Parcel Service (UPS) zone for address 1.|<a href="User.md" target="_blank">service/User</a>|
|[address1Latitude](#address1Latitude)|Latitude for address 1.|<a href="User.md" target="_blank">service/User</a>|
|[address1Telephone1](#address1Telephone1)|First telephone number associated with address 1.|<a href="User.md" target="_blank">service/User</a>|
|[address1Longitude](#address1Longitude)|Longitude for address 1.|<a href="User.md" target="_blank">service/User</a>|
|[address1ShippingMethodCode](#address1ShippingMethodCode)|Method of shipment for address 1.|<a href="User.md" target="_blank">service/User</a>|
|[address1ShippingMethodCode_display](#address1ShippingMethodCode_display)||<a href="User.md" target="_blank">service/User</a>|
|[address1Telephone2](#address1Telephone2)|Second telephone number associated with address 1.|<a href="User.md" target="_blank">service/User</a>|
|[address1Telephone3](#address1Telephone3)|Third telephone number associated with address 1.|<a href="User.md" target="_blank">service/User</a>|
|[address1Fax](#address1Fax)|Fax number for address 1.|<a href="User.md" target="_blank">service/User</a>|
|[address2AddressId](#address2AddressId)|Unique identifier for address 2.|<a href="User.md" target="_blank">service/User</a>|
|[address2AddressTypeCode](#address2AddressTypeCode)|Type of address for address 2, such as billing, shipping, or primary address.|<a href="User.md" target="_blank">service/User</a>|
|[address2AddressTypeCode_display](#address2AddressTypeCode_display)||<a href="User.md" target="_blank">service/User</a>|
|[address2Name](#address2Name)|Name to enter for address 2.|<a href="User.md" target="_blank">service/User</a>|
|[address2Line1](#address2Line1)|First line for entering address 2 information.|<a href="User.md" target="_blank">service/User</a>|
|[address2Line2](#address2Line2)|Second line for entering address 2 information.|<a href="User.md" target="_blank">service/User</a>|
|[address2Line3](#address2Line3)|Third line for entering address 2 information.|<a href="User.md" target="_blank">service/User</a>|
|[address2City](#address2City)|City name for address 2.|<a href="User.md" target="_blank">service/User</a>|
|[address2StateOrProvince](#address2StateOrProvince)|State or province for address 2.|<a href="User.md" target="_blank">service/User</a>|
|[address2County](#address2County)|County name for address 2.|<a href="User.md" target="_blank">service/User</a>|
|[address2Country](#address2Country)|Country/region name in address 2.|<a href="User.md" target="_blank">service/User</a>|
|[address2PostOfficeBox](#address2PostOfficeBox)|Post office box number for address 2.|<a href="User.md" target="_blank">service/User</a>|
|[address2PostalCode](#address2PostalCode)|ZIP Code or postal code for address 2.|<a href="User.md" target="_blank">service/User</a>|
|[address2UTCOffset](#address2UTCOffset)|UTC offset for address 2. This is the difference between local time and standard Coordinated Universal Time.|<a href="User.md" target="_blank">service/User</a>|
|[address2UPSZone](#address2UPSZone)|United Parcel Service (UPS) zone for address 2.|<a href="User.md" target="_blank">service/User</a>|
|[address2Latitude](#address2Latitude)|Latitude for address 2.|<a href="User.md" target="_blank">service/User</a>|
|[address2Telephone1](#address2Telephone1)|First telephone number associated with address 2.|<a href="User.md" target="_blank">service/User</a>|
|[address2Longitude](#address2Longitude)|Longitude for address 2.|<a href="User.md" target="_blank">service/User</a>|
|[address2ShippingMethodCode](#address2ShippingMethodCode)|Method of shipment for address 2.|<a href="User.md" target="_blank">service/User</a>|
|[address2ShippingMethodCode_display](#address2ShippingMethodCode_display)||<a href="User.md" target="_blank">service/User</a>|
|[address2Telephone2](#address2Telephone2)|Second telephone number associated with address 2.|<a href="User.md" target="_blank">service/User</a>|
|[address2Telephone3](#address2Telephone3)|Third telephone number associated with address 2.|<a href="User.md" target="_blank">service/User</a>|
|[address2Fax](#address2Fax)|Fax number for address 2.|<a href="User.md" target="_blank">service/User</a>|
|[skills](#skills)|Skill set of the user.|<a href="User.md" target="_blank">service/User</a>|
|[displayInServiceViews](#displayInServiceViews)|Whether to display the user in service views.|<a href="User.md" target="_blank">service/User</a>|
|[calendarId](#calendarId)|Fiscal calendar associated with the user.|<a href="User.md" target="_blank">service/User</a>|
|[setupUser](#setupUser)|Check if user is a setup user.|<a href="User.md" target="_blank">service/User</a>|
|[windowsLiveID](#windowsLiveID)|Windows Live ID|<a href="User.md" target="_blank">service/User</a>|
|[incomingEmailDeliveryMethod](#incomingEmailDeliveryMethod)|Incoming email delivery method for the user.|<a href="User.md" target="_blank">service/User</a>|
|[incomingEmailDeliveryMethod_display](#incomingEmailDeliveryMethod_display)||<a href="User.md" target="_blank">service/User</a>|
|[outgoingEmailDeliveryMethod](#outgoingEmailDeliveryMethod)|Outgoing email delivery method for the user.|<a href="User.md" target="_blank">service/User</a>|
|[outgoingEmailDeliveryMethod_display](#outgoingEmailDeliveryMethod_display)||<a href="User.md" target="_blank">service/User</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="User.md" target="_blank">service/User</a>|
|[accessMode](#accessMode)|Type of user.|<a href="User.md" target="_blank">service/User</a>|
|[accessMode_display](#accessMode_display)||<a href="User.md" target="_blank">service/User</a>|
|[inviteStatusCode](#inviteStatusCode)|User invitation status.|<a href="User.md" target="_blank">service/User</a>|
|[inviteStatusCode_display](#inviteStatusCode_display)||<a href="User.md" target="_blank">service/User</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="User.md" target="_blank">service/User</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="User.md" target="_blank">service/User</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="User.md" target="_blank">service/User</a>|
|[yomiFullName](#yomiFullName)|Pronunciation of the full name of the user, written in phonetic hiragana or katakana characters.|<a href="User.md" target="_blank">service/User</a>|
|[yomiLastName](#yomiLastName)|Pronunciation of the last name of the user, written in phonetic hiragana or katakana characters.|<a href="User.md" target="_blank">service/User</a>|
|[yomiMiddleName](#yomiMiddleName)|Pronunciation of the middle name of the user, written in phonetic hiragana or katakana characters.|<a href="User.md" target="_blank">service/User</a>|
|[yomiFirstName](#yomiFirstName)|Pronunciation of the first name of the user, written in phonetic hiragana or katakana characters.|<a href="User.md" target="_blank">service/User</a>|
|[isIntegrationUser](#isIntegrationUser)|Check if user is an integration user.|<a href="User.md" target="_blank">service/User</a>|
|[defaultFiltersPopulated](#defaultFiltersPopulated)|Indicates if default outlook filters have been populated.|<a href="User.md" target="_blank">service/User</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the systemuser.|<a href="User.md" target="_blank">service/User</a>|
|[queueId](#queueId)|Unique identifier of the default queue for the user.|<a href="User.md" target="_blank">service/User</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who last modified the systemuser.|<a href="User.md" target="_blank">service/User</a>|
|[emailRouterAccessApproval](#emailRouterAccessApproval)|Shows the status of the primary email address.|<a href="User.md" target="_blank">service/User</a>|
|[emailRouterAccessApproval_display](#emailRouterAccessApproval_display)||<a href="User.md" target="_blank">service/User</a>|
|[transactionCurrencyId](#transactionCurrencyId)|Unique identifier of the currency associated with the systemuser.|<a href="User.md" target="_blank">service/User</a>|
|[exchangeRate](#exchangeRate)|Exchange rate for the currency associated with the systemuser with respect to the base currency.|<a href="User.md" target="_blank">service/User</a>|
|[CALType](#CALType)|License type of user.|<a href="User.md" target="_blank">service/User</a>|
|[CALType_display](#CALType_display)||<a href="User.md" target="_blank">service/User</a>|
|[isLicensed](#isLicensed)|Information about whether the user is licensed.|<a href="User.md" target="_blank">service/User</a>|
|[isSyncWithDirectory](#isSyncWithDirectory)|Information about whether the user is synced with the directory.|<a href="User.md" target="_blank">service/User</a>|
|[yammerEmailAddress](#yammerEmailAddress)|User's Yammer login email address|<a href="User.md" target="_blank">service/User</a>|
|[yammerUserId](#yammerUserId)|User's Yammer ID|<a href="User.md" target="_blank">service/User</a>|
|[defaultMailbox](#defaultMailbox)|Select the mailbox associated with this user.|<a href="User.md" target="_blank">service/User</a>|
|[userLicenseType](#userLicenseType)|Shows the type of user license.|<a href="User.md" target="_blank">service/User</a>|
|[entityImageId](#entityImageId)|For internal use only.|<a href="User.md" target="_blank">service/User</a>|
|[address2Composite](#address2Composite)|Shows the complete secondary address.|<a href="User.md" target="_blank">service/User</a>|
|[address1Composite](#address1Composite)|Shows the complete primary address.|<a href="User.md" target="_blank">service/User</a>|
|[processId](#processId)|Shows the ID of the process.|<a href="User.md" target="_blank">service/User</a>|
|[stageId](#stageId)|Shows the ID of the stage.|<a href="User.md" target="_blank">service/User</a>|
|[isEmailAddressApprovedByO365Admin](#isEmailAddressApprovedByO365Admin)|Shows the status of approval of the email address by O365 Admin.|<a href="User.md" target="_blank">service/User</a>|
|[positionId](#positionId)|User's position in hierarchical security model.|<a href="User.md" target="_blank">service/User</a>|
|[traversedPath](#traversedPath)|For internal use only.|<a href="User.md" target="_blank">service/User</a>|
|[sharePointEmailAddress](#sharePointEmailAddress)|SharePoint Work Email Address|<a href="User.md" target="_blank">service/User</a>|
|[mobileOfflineProfileId](#mobileOfflineProfileId)|Items contained with a particular SystemUser.|<a href="User.md" target="_blank">service/User</a>|
|[defaultOdbFolderName](#defaultOdbFolderName)|Type a default folder name for the user's OneDrive For Business location.|<a href="User.md" target="_blank">service/User</a>|
|[applicationId](#applicationId)|The identifier for the application. This is used to access data in another application.|<a href="User.md" target="_blank">service/User</a>|
|[applicationIdUri](#applicationIdUri)|The URI used as a unique logical identifier for the external app. This can be used to validate the application.|<a href="User.md" target="_blank">service/User</a>|
|[azureActiveDirectoryObjectId](#azureActiveDirectoryObjectId)|This is the application directory object Id.|<a href="User.md" target="_blank">service/User</a>|
|[identityId](#identityId)|For internal use only.|<a href="User.md" target="_blank">service/User</a>|
|[territoryId](#territoryId)|Unique identifier of the territory to which the user is assigned.|<a href="User.md" target="_blank">service/User</a>|
