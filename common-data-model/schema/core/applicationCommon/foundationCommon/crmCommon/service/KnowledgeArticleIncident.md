...
- **is.identifiedBy**  
  ...
  ```
  "KnowledgeArticleIncident/hasAttributes/knowledgeArticleIncidentId"
  ```
...
- **means.entityState**  
  ...
  ```
  "KnowledgeArticleIncident/hasAttributes/stateCode"
  ```
