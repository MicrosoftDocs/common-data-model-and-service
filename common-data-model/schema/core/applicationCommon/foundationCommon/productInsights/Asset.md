...
Place holder for Asset Entity from FSA  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/productInsights/Asset.cdm.json" target="_blank">GitHub</a>.  
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Place holder for Asset Entity from FSA</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="Asset.md" target="_blank">productInsights/Asset</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="Asset.md" target="_blank">productInsights/Asset</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="Asset.md" target="_blank">productInsights/Asset</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="Asset.md" target="_blank">productInsights/Asset</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="Asset.md" target="_blank">productInsights/Asset</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="Asset.md" target="_blank">productInsights/Asset</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="Asset.md" target="_blank">productInsights/Asset</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="Asset.md" target="_blank">productInsights/Asset</a>|
|[ownerId](#ownerId)|Owner Id|<a href="Asset.md" target="_blank">productInsights/Asset</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="Asset.md" target="_blank">productInsights/Asset</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="Asset.md" target="_blank">productInsights/Asset</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="Asset.md" target="_blank">productInsights/Asset</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="Asset.md" target="_blank">productInsights/Asset</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="Asset.md" target="_blank">productInsights/Asset</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="Asset.md" target="_blank">productInsights/Asset</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="Asset.md" target="_blank">productInsights/Asset</a>|
|[assetId](#assetId)||<a href="Asset.md" target="_blank">productInsights/Asset</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: productInsights/Asset (this entity)  
...
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="../../User.md" target="_blank">/core/applicationCommon/User.cdm.json/User</a></td><td><a href="../../User.md#systemUserId" target="_blank">systemUserId</a></td></tr><tr><td><a href="../crmCommon/projectCommon/User.md" target="_blank">/core/applicationCommon/foundationCommon/crmCommon/projectCommon/User.cdm.json/User</a></td><td><a href="../crmCommon/projectCommon/User.md#systemUserId" target="_blank">systemUserId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>guid</td></tr></table>
