...
<a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/RatingModel.cdm.json" target="_blank">Entity definition</a> on GitHub.  

## Instances

foundationCommon/RatingModel  

## Traits for Rating Model
...
- **is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>"RatingModel_/hasAttributes/ratingModelId"</td><td>attribute</td><td></td></tr></table>Definition:  
  ```
...
- **means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>"RatingModel_/hasAttributes/stateCode"</td><td>attribute</td><td></td></tr></table>Definition:  
  ```
...
First included in: /core/applicationCommon/foundationCommon/RatingModel.cdm.json/RatingModel  
