...
- [/foundationCommon/crmCommon/accelerators/nonProfit/nonProfitVolunteers/Account](foundationCommon/crmCommon/accelerators/nonProfit/nonProfitVolunteers/Account.md "/core/applicationCommon/foundationCommon/crmCommon/accelerators/nonProfit/nonProfitVolunteers/Account.cdm.json/Account")  
...
**is.CDS.sourceNamed**  
  the unique name that identifies this object in Common Data Model for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"Account"</td><td>string</td><td></td></tr></table>
...
**is.requiredAtLevel**  
The requirement level for setting values into this attribute in Common Data Service for Applications or for including this attribute in entities created in CDS for Analytics  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>level</td><td>"systemrequired"</td><td>string</td><td>values can be: 'systemrequired', 'required', 'recommended', 'none'</td></tr></table>
