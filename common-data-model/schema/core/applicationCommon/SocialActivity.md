...
Latest version (0.8.1)of the json entity definition is available on GitHub (<a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/SocialActivity.cdm.json" target="_blank">Link on GitHub</a>).  
...
- **is.ordered**  
  ...
  ```
  "SocialActivity/hasAttributes/sortDate"
  ```
...
- **means.entityState**  
  ...
  ```
  "SocialActivity/hasAttributes/stateCode"
  ```
...
names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>"SocialActivity_/hasAttributes/activityId"</td><td>attribute</td><td></td></tr></table>Definition:  
  ```
  "SocialActivity/hasAttributes/activityId"
  ```
