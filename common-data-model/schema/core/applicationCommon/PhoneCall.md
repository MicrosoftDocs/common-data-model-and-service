---
title: PhoneCall in applicationCommon - Common Data Model | Microsoft Docs
...
# Phone Call in applicationCommon

Activity to track a telephone call.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/PhoneCall.cdm.json" target="_blank">GitHub</a>.  
...
|[from](#from)|The sender of the activity.|<a href="PhoneCall.md" target="_blank">applicationCommon/PhoneCall</a>|
...
First included in: applicationCommon/PhoneCall (this entity)  
