---
title: BusinessTravelType in Sustainability - Common Data Model | Microsoft Docs
...
Entity used for classifying the type of business travel, as defined in the reporting company.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Sustainability/BusinessTravelType.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/Sustainability/BusinessTravelType.cdm.json<br>/BusinessTravelType/hasAttributes<br>/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>
...
|---|---|---|
|[businesstraveltypeId](#businesstraveltypeId)|Unique identifier for entity instances|<a href="BusinessTravelType.md" target="_blank">Sustainability/BusinessTravelType</a>|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="BusinessTravelType.md" target="_blank">Sustainability/BusinessTravelType</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="BusinessTravelType.md" target="_blank">Sustainability/BusinessTravelType</a>|
|[statecode](#statecode)|Status of the Business travel type|<a href="BusinessTravelType.md" target="_blank">Sustainability/BusinessTravelType</a>|
|[statuscode](#statuscode)|Reason for the status of the Business travel type|<a href="BusinessTravelType.md" target="_blank">Sustainability/BusinessTravelType</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="BusinessTravelType.md" target="_blank">Sustainability/BusinessTravelType</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="BusinessTravelType.md" target="_blank">Sustainability/BusinessTravelType</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="BusinessTravelType.md" target="_blank">Sustainability/BusinessTravelType</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="BusinessTravelType.md" target="_blank">Sustainability/BusinessTravelType</a>|
|[name](#name)|The name of the custom entity.|<a href="BusinessTravelType.md" target="_blank">Sustainability/BusinessTravelType</a>|
|[description](#description)|Optional description that provides additional detail about the entity or attribute.|<a href="BusinessTravelType.md" target="_blank">Sustainability/BusinessTravelType</a>|
|[origincorrelationid](#origincorrelationid)|An optional identifier to correlate record with data origin.|<a href="BusinessTravelType.md" target="_blank">Sustainability/BusinessTravelType</a>|

### <a href=#businesstraveltypeId name="businesstraveltypeId">businesstraveltypeId</a>

Unique identifier for entity instances  
First included in: Sustainability/BusinessTravelType (this entity)  
