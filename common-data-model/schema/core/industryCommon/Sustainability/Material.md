---
title: Material in Sustainability - Common Data Model
...
# Material in Sustainability

Entity used for classifying the type of material, as defined in the reporting company.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Sustainability/Material.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[Material/(resolvedAttributes)/materialId](#materialId)</td><td>attribute</td><td></td></tr></table>
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/Sustainability/Material.cdm.json/Material<br>/hasAttributes/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>
...
|---|---|---|
|[materialId](#materialId)|Unique identifier for entity instances|<a href="Material.md" target="_blank">Sustainability/Material</a>|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="Material.md" target="_blank">Sustainability/Material</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="Material.md" target="_blank">Sustainability/Material</a>|
|[statecode](#statecode)|Status of the Material|<a href="Material.md" target="_blank">Sustainability/Material</a>|
|[statuscode](#statuscode)|Reason for the status of the Material|<a href="Material.md" target="_blank">Sustainability/Material</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="Material.md" target="_blank">Sustainability/Material</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="Material.md" target="_blank">Sustainability/Material</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="Material.md" target="_blank">Sustainability/Material</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="Material.md" target="_blank">Sustainability/Material</a>|
|[name](#name)|The name of the custom entity.|<a href="Material.md" target="_blank">Sustainability/Material</a>|
|[description](#description)|Optional description that provides additional detail about the entity or attribute.|<a href="Material.md" target="_blank">Sustainability/Material</a>|
|[origincorrelationid](#origincorrelationid)|An optional identifier to correlate record with data origin.|<a href="Material.md" target="_blank">Sustainability/Material</a>|

### <a href=#materialId name="materialId">materialId</a>

Unique identifier for entity instances  
First included in: Sustainability/Material (this entity)  
