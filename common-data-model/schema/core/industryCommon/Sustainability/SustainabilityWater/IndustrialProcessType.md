...
# Industrial process type in Sustainability water (IndustrialProcessType)

Entity to store process classifications for various industrial processes, such as extraction and manufacturing processes.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/SustainabilityWater/IndustrialProcessType.cdm.json" target="_blank">GitHub</a>.  
