...
|[cost](#cost)|Cost associated with water diversion\.|<a href="WaterQuantity.md" target="_blank">Sustainability\CloudforSustainabilityWaterDataModel/WaterQuantity</a>|
|[costunit](#costunit)|Unit associated with the cost quantity\.|<a href="WaterQuantity.md" target="_blank">Sustainability\CloudforSustainabilityWaterDataModel/WaterQuantity</a>|
...
|[customdimension](#customdimension)|Field where Custom Dimension values are stored in JSON format\.|<a href="WaterQuantity.md" target="_blank">Sustainability\CloudforSustainabilityWaterDataModel/WaterQuantity</a>|
|[reportingdate](#reportingdate)|Date used to parameterize reports\.|<a href="WaterQuantity.md" target="_blank">Sustainability\CloudforSustainabilityWaterDataModel/WaterQuantity</a>|
|[source](#source)|Lookup to external source activity\.|<a href="WaterQuantity.md" target="_blank">Sustainability\CloudforSustainabilityWaterDataModel/WaterQuantity</a>|
|[parentsource](#parentsource)|Lookup to parent source activity\.|<a href="WaterQuantity.md" target="_blank">Sustainability\CloudforSustainabilityWaterDataModel/WaterQuantity</a>|
...
\*\*is\.localized\.displayedAs\*\*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Activity entity name (Deprecated)</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
\*\*is\.localized\.displayedAs\*\*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Activity ID (Deprecated)</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
Lookup to external source activity\.  
First included in: Sustainability\\CloudforSustainabilityWaterDataModel/WaterQuantity \(this entity\)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Source</td></tr><tr><td>description</td><td>Lookup to external source activity.</td></tr><tr><td>dataFormat</td><td>guid</td></tr></table>
...
\*\*is\.localized\.describedAs\*\*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Lookup to external source activity.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
\*\*is\.linkedEntity\.identifier\*\*  
  Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th><th>relationshipName</th></tr><tr><td><a href="../Sustainability/CloudforSustainabilitySharedDataModel/FacilityCapacity.md" target="_blank">/Sustainability/CloudforSustainabilitySharedDataModel/FacilityCapacity.cdm.json/FacilityCapacity</a></td><td><a href="../Sustainability/CloudforSustainabilitySharedDataModel/FacilityCapacity.md#facilitycapacityId" target="_blank">facilitycapacityId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
...
### <a href=#parentsource name="parentsource">parentsource</a>

Lookup to parent source activity\.  
First included in: Sustainability\\CloudforSustainabilityWaterDataModel/WaterQuantity \(this entity\)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Parent source</td></tr><tr><td>description</td><td>Lookup to parent source activity.</td></tr><tr><td>dataFormat</td><td>guid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the parentsource attribute are listed below.</summary>
...
\*\*is\.localized\.describedAs\*\*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Lookup to parent source activity.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

\*\*is\.localized\.displayedAs\*\*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Parent source</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

\*\*is\.CDS\.lookup\*\*  
  The attribute represents a style of lookup in CDS for Applications  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>style</td><td>"single"</td><td>string</td><td></td></tr></table>

\*\*is\.linkedEntity\.identifier\*\*  
  Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th><th>relationshipName</th></tr><tr><td><a href="../../WaterQuantity.md" target="_blank">WaterQuantity.cdm.json/WaterQuantity</a></td><td><a href="../../WaterQuantity.md#waterquantityId" target="_blank">waterquantityId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
