...
Upstream and downstream transportation and distribution activities.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Sustainability/TransportationAndDistribution.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[TransportationAndDistribution/(resolvedAttributes)/transportationanddistributionId](#transportationanddistributionId)</td><td>attribute</td><td></td></tr></table>

**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>TransportationAndDistribution.cdm.json<br>/TransportationAndDistribution/hasAttributes<br>/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Upstream and downstream transportation and distribution activities.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Transportation and distribution</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_transportationanddistribution"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[transportationanddistributionId](#transportationanddistributionId)|Unique identifier for entity instances|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/TransportationAndDistribution</a>|
|[TTLInSeconds](#TTLInSeconds)|Time to live in seconds.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/TransportationAndDistribution</a>|
|[partitionId](#partitionId)|Logical partition id. A logical partition consists of a set of records with same partition id.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/TransportationAndDistribution</a>|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/TransportationAndDistribution</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/TransportationAndDistribution</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/TransportationAndDistribution</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/TransportationAndDistribution</a>|
|[name](#name)|The name of the custom entity.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/TransportationAndDistribution</a>|
|[consumptionenddate](#consumptionenddate)|End date of activity consumption.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/TransportationAndDistribution</a>|
|[consumptionstartdate](#consumptionstartdate)|Start date of activity consumption.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/TransportationAndDistribution</a>|
|[cost](#cost)|Cost associated with the activity data.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/TransportationAndDistribution</a>|
|[costunit](#costunit)|Unit associated with the cost quantity.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/TransportationAndDistribution</a>|
|[dataqualitytype](#dataqualitytype)|Description of the data quality which identifies if the data is actual, estimated, or other descriptors of the data.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/TransportationAndDistribution</a>|
|[description](#description)|Optional description that provides additional detail about the entity or attribute.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/TransportationAndDistribution</a>|
|[distance](#distance)|Quantity associated with the distance activity which contributes to mobile combustion or supply chain travel.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/TransportationAndDistribution</a>|
|[distanceunit](#distanceunit)|Unique identifier for the unit associated with distance.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/TransportationAndDistribution</a>|
|[evidence](#evidence)|Optional field where evidence can be linked to the entity or attribute, if required.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/TransportationAndDistribution</a>|
|[facilityid](#facilityid)|Unique identifier associated with Transportation and distribution|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/TransportationAndDistribution</a>|
|[fuelquantity](#fuelquantity)|Unique identifier for the fuel consumption data associated with combustion or supply chain fuel usage.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/TransportationAndDistribution</a>|
|[fuelquantityunit](#fuelquantityunit)|Unique identifier for the unit associated with fuel data.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/TransportationAndDistribution</a>|
|[fueltypeid](#fueltypeid)|Unique identifier for the fuel type associated with combustion or supply chain fuel usage.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/TransportationAndDistribution</a>|
|[goodandservicetypeid](#goodandservicetypeid)|Unique identifier for the good and service type associated with transportation and distribution.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/TransportationAndDistribution</a>|
|[goodsquantity](#goodsquantity)|The quantity of goods being transported and distributed, which is used for calculation.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/TransportationAndDistribution</a>|
|[goodsunit](#goodsunit)|Unique identifier for the unit relating to transportation and distribution of goods.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/TransportationAndDistribution</a>|
|[industrialprocesstypeid](#industrialprocesstypeid)|Unique identifier for the industrial process type associated with activity.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/TransportationAndDistribution</a>|
|[organizationalunitid](#organizationalunitid)|Unique identifier for the organizational unit associated with transportation and distribution.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/TransportationAndDistribution</a>|
|[quantity](#quantity)|Generic quanity field associated with activity entities.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/TransportationAndDistribution</a>|
|[quantityunit](#quantityunit)|Unit associated with the quantity field.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/TransportationAndDistribution</a>|
|[origincorrelationid](#origincorrelationid)|An optional identifier to correlate record with data origin.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/TransportationAndDistribution</a>|
|[transactiondate](#transactiondate)|Date associated with the actual date when the transaction occurred.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/TransportationAndDistribution</a>|
|[transportationanddistributiontype](#transportationanddistributiontype)|Marks what type of transportation and distribution this record represents.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/TransportationAndDistribution</a>|
|[transportmode](#transportmode)|The transport mode that corresponds to this transportation and distribution activity.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/TransportationAndDistribution</a>|
|[vehicletype](#vehicletype)|Unique identifier for the vehicle type associated with combustion or supply chain transportation activities.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/TransportationAndDistribution</a>|
|[spendtypeid](#spendtypeid)|Unique identifier for the spend type associated with transportation and distribution.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/TransportationAndDistribution</a>|
|[valuechainpartnerid](#valuechainpartnerid)|Reference to the value chain partner or supplier associated with the transaction.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/TransportationAndDistribution</a>|
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Transportation and Distribution</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>sourceName</td><td>msdyn_transportationanddistributionid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the transportationanddistributionId attribute are listed below.</summary>
...
**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_transportationanddistributionid"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Evidence</td></tr><tr><td>description</td><td>Optional field where evidence can be linked to the entity or attribute, if required.</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>250</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyn_evidence</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Facility</td></tr><tr><td>description</td><td>Unique identifier associated with Transportation and distribution</td></tr><tr><td>dataFormat</td><td>guid</td></tr></table>
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Unique identifier associated with Transportation and distribution</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Fuel quantity</td></tr><tr><td>description</td><td>Unique identifier for the fuel consumption data associated with combustion or supply chain fuel usage.</td></tr><tr><td>dataFormat</td><td>decimal</td></tr><tr><td>maximumValue</td><td>100000000000</td></tr><tr><td>minimumValue</td><td>-100000000000</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyn_fuelquantity</td></tr></table>
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Unique identifier for the fuel consumption data associated with combustion or supply chain fuel usage.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
### <a href=#goodandservicetypeid name="goodandservicetypeid">goodandservicetypeid</a>

Unique identifier for the good and service type associated with transportation and distribution.  
First included in: Sustainability/TransportationAndDistribution (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Good and service type</td></tr><tr><td>description</td><td>Unique identifier for the good and service type associated with transportation and distribution.</td></tr><tr><td>dataFormat</td><td>guid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the goodandservicetypeid attribute are listed below.</summary>
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Unique identifier for the good and service type associated with transportation and distribution.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Good and service type</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.lookup**  
  The attribute represents a style of lookup in CDS for Applications  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>style</td><td>"single"</td><td>string</td><td></td></tr></table>

**is.linkedEntity.identifier**  
  Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th><th>relationshipName</th></tr><tr><td><a href="../../PurchasedGoodAndService.md" target="_blank">PurchasedGoodAndService.cdm.json/PurchasedGoodAndService</a></td><td><a href="../../PurchasedGoodAndService.md#purchasedgoodandserviceId" target="_blank">purchasedgoodandserviceId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Goods quantity (mass)</td></tr><tr><td>description</td><td>The quantity of goods being transported and distributed, which is used for calculation.</td></tr><tr><td>dataFormat</td><td>decimal</td></tr><tr><td>maximumValue</td><td>100000000000</td></tr><tr><td>minimumValue</td><td>-100000000000</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyn_goodsquantity</td></tr></table>
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>The quantity of goods being transported and distributed, which is used for calculation.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Goods quantity (mass)</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Goods quantity (mass) unit</td></tr><tr><td>description</td><td>Unique identifier for the unit relating to transportation and distribution of goods.</td></tr><tr><td>dataFormat</td><td>guid</td></tr></table>
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Unique identifier for the unit relating to transportation and distribution of goods.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Goods quantity (mass) unit</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Industrial process type</td></tr><tr><td>description</td><td>Unique identifier for the industrial process type associated with activity.</td></tr><tr><td>dataFormat</td><td>guid</td></tr></table>
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Unique identifier for the industrial process type associated with activity.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Organizational unit</td></tr><tr><td>description</td><td>Unique identifier for the organizational unit associated with transportation and distribution.</td></tr><tr><td>dataFormat</td><td>guid</td></tr></table>
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Unique identifier for the organizational unit associated with transportation and distribution.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Spend type</td></tr><tr><td>description</td><td>Unique identifier for the spend type associated with transportation and distribution.</td></tr><tr><td>dataFormat</td><td>guid</td></tr></table>
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Unique identifier for the spend type associated with transportation and distribution.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
