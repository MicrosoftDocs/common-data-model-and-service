...
Grouping of units.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Sustainability/UnitGroup.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/Sustainability/UnitGroup.cdm.json/UnitGroup<br>/hasAttributes/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Grouping of units.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[unitgroupId](#unitgroupId)|Unique identifier for entity instances|<a href="UnitGroup.md" target="_blank">Sustainability/UnitGroup</a>|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="UnitGroup.md" target="_blank">Sustainability/UnitGroup</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="UnitGroup.md" target="_blank">Sustainability/UnitGroup</a>|
|[statecode](#statecode)|Status of the Unit Group|<a href="UnitGroup.md" target="_blank">Sustainability/UnitGroup</a>|
|[statuscode](#statuscode)|Reason for the status of the Unit Group|<a href="UnitGroup.md" target="_blank">Sustainability/UnitGroup</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="UnitGroup.md" target="_blank">Sustainability/UnitGroup</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="UnitGroup.md" target="_blank">Sustainability/UnitGroup</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="UnitGroup.md" target="_blank">Sustainability/UnitGroup</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="UnitGroup.md" target="_blank">Sustainability/UnitGroup</a>|
|[name](#name)|The name of the custom entity.|<a href="UnitGroup.md" target="_blank">Sustainability/UnitGroup</a>|
|[baseunit](#baseunit)|The base or primary unit of the unit group.|<a href="UnitGroup.md" target="_blank">Sustainability/UnitGroup</a>|
|[description](#description)|Optional description that provides additional detail about the entity or attribute.|<a href="UnitGroup.md" target="_blank">Sustainability/UnitGroup</a>|
|[reportingunit](#reportingunit)|Unique identifier for the unit associated with the unit group which will be used in reports.|<a href="UnitGroup.md" target="_blank">Sustainability/UnitGroup</a>|

### <a href=#unitgroupId name="unitgroupId">unitgroupId</a>

Unique identifier for entity instances  
First included in: Sustainability/UnitGroup (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Unit group</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>sourceName</td><td>msdyn_unitgroupid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the unitgroupId attribute are listed below.</summary>
...
**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_unitgroupid"</td><td>string</td><td></td></tr></table>
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the Unit Group</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the Unit Group</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<details>
<summary>List of traits for the baseunit attribute are listed below.</summary>
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>The base or primary unit of the unit group.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<details>
<summary>List of traits for the reportingunit attribute are listed below.</summary>
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Unique identifier for the unit associated with the unit group which will be used in reports.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
