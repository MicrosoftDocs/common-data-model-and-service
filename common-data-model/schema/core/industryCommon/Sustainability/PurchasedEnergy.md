...
Electric energy, measured in MWh, delivered by the utility to a customer in accordance with the signed agreement.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Sustainability/PurchasedEnergy.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[purchasedenergyId](#purchasedenergyId)|Unique identifier for entity instances|<a href="PurchasedEnergy.md" target="_blank">Sustainability/PurchasedEnergy</a>|
|[TTLInSeconds](#TTLInSeconds)|Time to live in seconds.|<a href="PurchasedEnergy.md" target="_blank">Sustainability/PurchasedEnergy</a>|
|[partitionId](#partitionId)|Logical partition id. A logical partition consists of a set of records with same partition id.|<a href="PurchasedEnergy.md" target="_blank">Sustainability/PurchasedEnergy</a>|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="PurchasedEnergy.md" target="_blank">Sustainability/PurchasedEnergy</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="PurchasedEnergy.md" target="_blank">Sustainability/PurchasedEnergy</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="PurchasedEnergy.md" target="_blank">Sustainability/PurchasedEnergy</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="PurchasedEnergy.md" target="_blank">Sustainability/PurchasedEnergy</a>|
|[name](#name)|The name of the custom entity.|<a href="PurchasedEnergy.md" target="_blank">Sustainability/PurchasedEnergy</a>|
|[consumptionenddate](#consumptionenddate)|End date of activity consumption.|<a href="PurchasedEnergy.md" target="_blank">Sustainability/PurchasedEnergy</a>|
|[consumptionstartdate](#consumptionstartdate)|Start date of activity consumption.|<a href="PurchasedEnergy.md" target="_blank">Sustainability/PurchasedEnergy</a>|
|[contractualinstrumenttypeid](#contractualinstrumenttypeid)|Unique identifier for the contractual instrument type associated with the purchased energy.|<a href="PurchasedEnergy.md" target="_blank">Sustainability/PurchasedEnergy</a>|
|[cost](#cost)|Cost associated with activity data.|<a href="PurchasedEnergy.md" target="_blank">Sustainability/PurchasedEnergy</a>|
|[costunit](#costunit)|Unit associated with the cost quantity.|<a href="PurchasedEnergy.md" target="_blank">Sustainability/PurchasedEnergy</a>|
...
Unique identifier for the contractual instrument type associated with the purchased energy.  
First included in: Sustainability/PurchasedEnergy (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Contractual Instrument Type</td></tr><tr><td>description</td><td>Unique identifier for the contractual instrument type associated with the purchased energy.</td></tr><tr><td>dataFormat</td><td>guid</td></tr></table>
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Unique identifier for the contractual instrument type associated with the purchased energy.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
### <a href=#energyprovidername name="energyprovidername">energyprovidername</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Energy Provider Name</td></tr><tr><td>description</td><td>Name of the energy provider.</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>100</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyn_energyprovidername</td></tr></table>

#### Traits

<details>
<summary>List of traits for the energyprovidername attribute are listed below.</summary>
...
**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Energy Provider Name</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_energyprovidername"</td><td>string</td><td></td></tr></table>
...
<details>
<summary>List of traits for the energytype attribute are listed below.</summary>
...
**is.dataFormat.numeric**  
  **does.haveDefault**  
  An attribute has a default value  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>default</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Electricity</td><td>700610000</td></tr><tr><td>en</td><td>Steam</td><td>700610001</td></tr><tr><td>en</td><td>Heating</td><td>700610002</td></tr><tr><td>en</td><td>Cooling</td><td>700610003</td></tr></table></td><td>any</td><td></td></tr></table>
...
**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_energytype"</td><td>string</td><td></td></tr></table>
...
Unique identifier for the organizational unit associated with the purchased energy.  
First included in: Sustainability/PurchasedEnergy (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Organizational Unit</td></tr><tr><td>description</td><td>Unique identifier for the organizational unit associated with the purchased energy.</td></tr><tr><td>dataFormat</td><td>guid</td></tr></table>
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Unique identifier for the organizational unit associated with the purchased energy.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
