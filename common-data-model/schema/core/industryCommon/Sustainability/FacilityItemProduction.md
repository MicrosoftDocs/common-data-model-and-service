---
title: FacilityItemProduction in Sustainability - Common Data Model | Microsoft Docs
...
Entity used to record the production quantity of an item in a facility for a specified period\.   
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Sustainability/FacilityItemProduction.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/Sustainability/FacilityItemProduction.cdm.json<br>/FacilityItemProduction/hasAttributes<br>/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Entity used to record the production quantity of an item in a facility for a specified period. </td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Facility item production</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_facilityitemproduction"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[facilityitemproductionId](#facilityitemproductionId)|The unique identifier of the item production in a facility\.|<a href="FacilityItemProduction.md" target="_blank">Sustainability/FacilityItemProduction</a>|
|[TTLInSeconds](#TTLInSeconds)|Time to live in seconds\.|<a href="FacilityItemProduction.md" target="_blank">Sustainability/FacilityItemProduction</a>|
|[partitionId](#partitionId)|Logical partition id\. A logical partition consists of a set of records with same partition id\.|<a href="FacilityItemProduction.md" target="_blank">Sustainability/FacilityItemProduction</a>|
|[createdOn](#createdOn)|Date and time when the record was created\.|<a href="FacilityItemProduction.md" target="_blank">Sustainability/FacilityItemProduction</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified\.|<a href="FacilityItemProduction.md" target="_blank">Sustainability/FacilityItemProduction</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record\.|<a href="FacilityItemProduction.md" target="_blank">Sustainability/FacilityItemProduction</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated\.|<a href="FacilityItemProduction.md" target="_blank">Sustainability/FacilityItemProduction</a>|
|[name](#name)|The name of the custom entity\.|<a href="FacilityItemProduction.md" target="_blank">Sustainability/FacilityItemProduction</a>|
|[dataqualitytype](#dataqualitytype)|Indicates whether the data is actual, estimated, or metered\.|<a href="FacilityItemProduction.md" target="_blank">Sustainability/FacilityItemProduction</a>|
|[description](#description)|Description|<a href="FacilityItemProduction.md" target="_blank">Sustainability/FacilityItemProduction</a>|
|[facility](#facility)|The facility that is producing the item\.|<a href="FacilityItemProduction.md" target="_blank">Sustainability/FacilityItemProduction</a>|
|[sustainabilityitemsku](#sustainabilityitemsku)|The item that is being produced in the facility\.|<a href="FacilityItemProduction.md" target="_blank">Sustainability/FacilityItemProduction</a>|
|[productionenddate](#productionenddate)|The date on which the last unit of the item/finished product was produced\.|<a href="FacilityItemProduction.md" target="_blank">Sustainability/FacilityItemProduction</a>|
|[productionstartdate](#productionstartdate)|The date on which the first unit of the item/finished product was produced\.|<a href="FacilityItemProduction.md" target="_blank">Sustainability/FacilityItemProduction</a>|
|[quantityproduced](#quantityproduced)|The quantity of the item produced in the specified period\.|<a href="FacilityItemProduction.md" target="_blank">Sustainability/FacilityItemProduction</a>|
|[unit](#unit)|The unit of measure for the quantity produced\.|<a href="FacilityItemProduction.md" target="_blank">Sustainability/FacilityItemProduction</a>|
|[origincorrelationid](#origincorrelationid)|Optional field for origin correlation id|<a href="FacilityItemProduction.md" target="_blank">Sustainability/FacilityItemProduction</a>|
...
First included in: Sustainability/FacilityItemProduction \(this entity\)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Facility item production id</td></tr><tr><td>description</td><td>The unique identifier of the item production in a facility.</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>sourceName</td><td>msdyn_facilityitemproductionid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the facilityitemproductionId attribute are listed below.</summary>
...
\*\*is\.localized\.describedAs\*\*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>The unique identifier of the item production in a facility.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

\*\*is\.localized\.displayedAs\*\*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Facility item production id</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

\*\*is\.CDS\.sourceNamed\*\*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_facilityitemproductionid"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Description</td></tr><tr><td>description</td><td>Description</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>200</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyn_description</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Facility</td></tr><tr><td>description</td><td>The facility that is producing the item.</td></tr><tr><td>dataFormat</td><td>guid</td></tr></table>
...
\*\*is\.localized\.describedAs\*\*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>The facility that is producing the item.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Item</td></tr><tr><td>description</td><td>The item that is being produced in the facility.</td></tr><tr><td>dataFormat</td><td>guid</td></tr></table>
...
\*\*is\.localized\.describedAs\*\*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>The item that is being produced in the facility.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Production end date</td></tr><tr><td>description</td><td>The date on which the last unit of the item/finished product was produced.</td></tr><tr><td>dataFormat</td><td>dateTime</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyn_productionenddate</td></tr></table>

#### Traits

<details>
<summary>List of traits for the productionenddate attribute are listed below.</summary>
...
\*\*is\.localized\.describedAs\*\*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>The date on which the last unit of the item/finished product was produced.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

\*\*is\.localized\.displayedAs\*\*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Production end date</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

\*\*is\.nullable\*\*  
  The attribute value may be set to NULL.  

\*\*is\.CDS\.sourceNamed\*\*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_productionenddate"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Production start date</td></tr><tr><td>description</td><td>The date on which the first unit of the item/finished product was produced.</td></tr><tr><td>dataFormat</td><td>dateTime</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyn_productionstartdate</td></tr></table>

#### Traits

<details>
<summary>List of traits for the productionstartdate attribute are listed below.</summary>
...
\*\*is\.localized\.describedAs\*\*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>The date on which the first unit of the item/finished product was produced.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

\*\*is\.localized\.displayedAs\*\*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Production start date</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

\*\*is\.nullable\*\*  
  The attribute value may be set to NULL.  

\*\*is\.CDS\.sourceNamed\*\*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_productionstartdate"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Quantity produced</td></tr><tr><td>description</td><td>The quantity of the item produced in the specified period.</td></tr><tr><td>dataFormat</td><td>decimal</td></tr><tr><td>maximumValue</td><td>100000000000</td></tr><tr><td>minimumValue</td><td>0</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyn_quantityproduced</td></tr></table>

#### Traits

<details>
<summary>List of traits for the quantityproduced attribute are listed below.</summary>
...
\*\*is\.localized\.describedAs\*\*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>The quantity of the item produced in the specified period.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

\*\*is\.localized\.displayedAs\*\*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Quantity produced</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
\*\*is\.CDS\.sourceNamed\*\*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_quantityproduced"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Unit</td></tr><tr><td>description</td><td>The unit of measure for the quantity produced.</td></tr><tr><td>dataFormat</td><td>guid</td></tr></table>
...
\*\*is\.localized\.describedAs\*\*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>The unit of measure for the quantity produced.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
