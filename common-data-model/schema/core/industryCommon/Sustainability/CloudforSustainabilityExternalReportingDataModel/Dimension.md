...
# Dimension in ExternalESGReportingDataModel

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Sustainability\ExternalESGReportingDataModel/Dimension.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specific identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[Dimension/(resolvedAttributes)/esgdimensionId](#esgdimensionId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[Dimension/(resolvedAttributes)/statecode](#statecode)</td><td>attribute</td><td></td></tr></table>

**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/Sustainability/ExternalESGReportingDataModel<br>/Dimension.cdm.json/Dimension/hasAttributes<br>/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>
...
**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_esgdimension"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[esgdimensionId](#esgdimensionId)|Unique identifier for entity instances|<a href="Dimension.md" target="_blank">Sustainability\ExternalESGReportingDataModel/Dimension</a>|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="Dimension.md" target="_blank">Sustainability\ExternalESGReportingDataModel/Dimension</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="Dimension.md" target="_blank">Sustainability\ExternalESGReportingDataModel/Dimension</a>|
|[statecode](#statecode)|Status of the Dimension|<a href="Dimension.md" target="_blank">Sustainability\ExternalESGReportingDataModel/Dimension</a>|
|[statuscode](#statuscode)|Reason for the status of the Dimension|<a href="Dimension.md" target="_blank">Sustainability\ExternalESGReportingDataModel/Dimension</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="Dimension.md" target="_blank">Sustainability\ExternalESGReportingDataModel/Dimension</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="Dimension.md" target="_blank">Sustainability\ExternalESGReportingDataModel/Dimension</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="Dimension.md" target="_blank">Sustainability\ExternalESGReportingDataModel/Dimension</a>|
|[name](#name)||<a href="Dimension.md" target="_blank">Sustainability\ExternalESGReportingDataModel/Dimension</a>|
|[referencedatadefinition](#referencedatadefinition)|Reference data definition|<a href="Dimension.md" target="_blank">Sustainability\ExternalESGReportingDataModel/Dimension</a>|
|[origincorrelationid](#origincorrelationid)|An optional identifier to correlate record with data origin.|<a href="Dimension.md" target="_blank">Sustainability\ExternalESGReportingDataModel/Dimension</a>|
|[source](#source)||<a href="Dimension.md" target="_blank">Sustainability\ExternalESGReportingDataModel/Dimension</a>|

### <a href=#esgdimensionId name="esgdimensionId">esgdimensionId</a>

Unique identifier for entity instances  
First included in: Sustainability\\ExternalESGReportingDataModel/Dimension (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Dimension</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>sourceName</td><td>msdyn_esgdimensionid</td></tr></table>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_esgdimensionid"</td><td>string</td><td></td></tr></table>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the Dimension</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the Dimension</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
### <a href=#referencedatadefinition name="referencedatadefinition">referencedatadefinition</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Reference data definition</td></tr><tr><td>description</td><td>Reference data definition</td></tr><tr><td>dataFormat</td><td>guid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the referencedatadefinition attribute are listed below.</summary>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reference data definition</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
