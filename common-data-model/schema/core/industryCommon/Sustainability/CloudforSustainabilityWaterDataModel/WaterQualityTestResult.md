...
**is.identifiedBy**  
  names a specific identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[WaterQualityTestResult/(resolvedAttributes)/waterqualitytestresultId](#waterqualitytestresultId)</td><td>attribute</td><td></td></tr></table>

**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/Sustainability<br>/CloudforSustainabilityWaterDataModel<br>/WaterQualityTestResult.cdm.json<br>/WaterQualityTestResult/hasAttributes<br>/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Describes the results coming from the laboratory water quality test for a characteristic in the water sample.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Water quality test result</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_waterqualitytestresult"</td><td>string</td><td></td></tr></table>
...
|[measuredvalue](#measuredvalue)|The reportable measured value of a characteristic being analyzed.|<a href="WaterQualityTestResult.md" target="_blank">Sustainability\CloudforSustainabilityWaterDataModel/WaterQualityTestResult</a>|
|[precision](#precision)|Indicates how the measurements for a property has been prescribed.|<a href="WaterQualityTestResult.md" target="_blank">Sustainability\CloudforSustainabilityWaterDataModel/WaterQualityTestResult</a>|
|[resultstatus](#resultstatus)|Indicates whether the measure of the characteristic is within the permissible range.|<a href="WaterQualityTestResult.md" target="_blank">Sustainability\CloudforSustainabilityWaterDataModel/WaterQualityTestResult</a>|
|[unit](#unit)|The unit of measurement of the measure value in the test result.|<a href="WaterQualityTestResult.md" target="_blank">Sustainability\CloudforSustainabilityWaterDataModel/WaterQualityTestResult</a>|
|[waterqualitycharacteristic](#waterqualitycharacteristic)|Indicates the measurable property for which the water sample has been analyzed and measured value provided.|<a href="WaterQualityTestResult.md" target="_blank">Sustainability\CloudforSustainabilityWaterDataModel/WaterQualityTestResult</a>|
|[watersample](#watersample)|Indicates the details of the water sample collected for the water quality test.|<a href="WaterQualityTestResult.md" target="_blank">Sustainability\CloudforSustainabilityWaterDataModel/WaterQualityTestResult</a>|
|[watersamplev2](#watersamplev2)|Indicates the details of the water sample collected for the water quality test.|<a href="WaterQualityTestResult.md" target="_blank">Sustainability\CloudforSustainabilityWaterDataModel/WaterQualityTestResult</a>|
|[reportingdate](#reportingdate)|Date used to parameterize reports.|<a href="WaterQualityTestResult.md" target="_blank">Sustainability\CloudforSustainabilityWaterDataModel/WaterQualityTestResult</a>|
...
<details>
<summary>List of traits for the waterqualitytestresultId attribute are listed below.</summary>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_waterqualitytestresultid"</td><td>string</td><td></td></tr></table>
...
<details>
<summary>List of traits for the waterqualityanalysis attribute are listed below.</summary>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Indicates the analysis that was performed to arrive at the water quality test result.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<details>
<summary>List of traits for the waterqualitytestdate attribute are listed below.</summary>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_waterqualitytestdate"</td><td>string</td><td></td></tr></table>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Optional field that indicates the any additional details regarding the result provided by the analysis.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>The reportable measured value of a characteristic being analyzed.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Indicates whether the measure of the characteristic is within the permissible range.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Indicates the measurable property for which the water sample has been analyzed and measured value provided.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Water sample (Deprecated)</td></tr><tr><td>description</td><td>Indicates the details of the water sample collected for the water quality test.</td></tr><tr><td>dataFormat</td><td>guid</td></tr></table>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Indicates the details of the water sample collected for the water quality test.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.linkedEntity.identifier*  
  Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th><th>relationshipName</th></tr><tr><td><a href="WaterSampleDeprecated.md" target="_blank">WaterSampleDeprecated.cdm.json/WaterSampleDeprecated</a></td><td><a href="WaterSampleDeprecated.md#watersampleId" target="_blank">watersampleId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
...
### <a href=#watersamplev2 name="watersamplev2">watersamplev2</a>
...
<details>
<summary>List of traits for the watersamplev2 attribute are listed below.</summary>
...
*is.linkedEntity.identifier*  
  Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th><th>relationshipName</th></tr><tr><td><a href="WaterSample.md" target="_blank">WaterSample.cdm.json/WaterSample</a></td><td><a href="WaterSample.md#watersamplev2Id" target="_blank">watersamplev2Id</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
