---
title: FactorLibrary in Sustainability - Common Data Model | Microsoft Docs
...
Repository for emission and estimation factor sets, including both system and user added.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Sustainability/FactorLibrary.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/Sustainability/FactorLibrary.cdm.json<br>/FactorLibrary/hasAttributes<br>/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>
...
|---|---|---|
|[calculationlibraryId](#calculationlibraryId)|Unique identifier for entity instances|<a href="FactorLibrary.md" target="_blank">Sustainability/FactorLibrary</a>|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="FactorLibrary.md" target="_blank">Sustainability/FactorLibrary</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="FactorLibrary.md" target="_blank">Sustainability/FactorLibrary</a>|
|[statecode](#statecode)|Status of the normalentity|<a href="FactorLibrary.md" target="_blank">Sustainability/FactorLibrary</a>|
|[statuscode](#statuscode)|Reason for the status of the normalentity|<a href="FactorLibrary.md" target="_blank">Sustainability/FactorLibrary</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="FactorLibrary.md" target="_blank">Sustainability/FactorLibrary</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="FactorLibrary.md" target="_blank">Sustainability/FactorLibrary</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="FactorLibrary.md" target="_blank">Sustainability/FactorLibrary</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="FactorLibrary.md" target="_blank">Sustainability/FactorLibrary</a>|
|[name](#name)|The name of the custom entity.|<a href="FactorLibrary.md" target="_blank">Sustainability/FactorLibrary</a>|
|[description](#description)|Optional description that provides additional detail about the entity or attribute.|<a href="FactorLibrary.md" target="_blank">Sustainability/FactorLibrary</a>|
|[documentationreference](#documentationreference)|The documentation reference for the factor library.|<a href="FactorLibrary.md" target="_blank">Sustainability/FactorLibrary</a>|
|[librarytype](#librarytype)|Factor library type: estimation or emission.|<a href="FactorLibrary.md" target="_blank">Sustainability/FactorLibrary</a>|
|[origincorrelationid](#origincorrelationid)|An optional identifier to correlate record with data origin.|<a href="FactorLibrary.md" target="_blank">Sustainability/FactorLibrary</a>|
|[version](#version)|The version of the library.|<a href="FactorLibrary.md" target="_blank">Sustainability/FactorLibrary</a>|
|[year](#year)|The year of the library.|<a href="FactorLibrary.md" target="_blank">Sustainability/FactorLibrary</a>|
|[type](#type)|Strings indicating the type of factor library|<a href="FactorLibrary.md" target="_blank">Sustainability/FactorLibrary</a>|
