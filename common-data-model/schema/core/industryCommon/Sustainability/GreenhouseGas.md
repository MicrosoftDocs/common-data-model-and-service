...
Entity for greenhouse gases.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Sustainability/GreenhouseGas.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>GreenhouseGas.cdm.json/GreenhouseGas<br>/hasAttributes/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>
...
**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_greenhousegas"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[greenhousegasId](#greenhousegasId)|Unique identifier for entity instances|<a href="GreenhouseGas.md" target="_blank">Sustainability/GreenhouseGas</a>|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="GreenhouseGas.md" target="_blank">Sustainability/GreenhouseGas</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="GreenhouseGas.md" target="_blank">Sustainability/GreenhouseGas</a>|
|[statecode](#statecode)|Status of the Greenhouse Gas|<a href="GreenhouseGas.md" target="_blank">Sustainability/GreenhouseGas</a>|
|[statuscode](#statuscode)|Reason for the status of the Greenhouse Gas|<a href="GreenhouseGas.md" target="_blank">Sustainability/GreenhouseGas</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="GreenhouseGas.md" target="_blank">Sustainability/GreenhouseGas</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="GreenhouseGas.md" target="_blank">Sustainability/GreenhouseGas</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="GreenhouseGas.md" target="_blank">Sustainability/GreenhouseGas</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="GreenhouseGas.md" target="_blank">Sustainability/GreenhouseGas</a>|
|[name](#name)|The name of the custom entity.|<a href="GreenhouseGas.md" target="_blank">Sustainability/GreenhouseGas</a>|
|[category](#category)|The category of greenhouse gas.|<a href="GreenhouseGas.md" target="_blank">Sustainability/GreenhouseGas</a>|
|[datafield](#datafield)|Optional field entity for additional views.|<a href="GreenhouseGas.md" target="_blank">Sustainability/GreenhouseGas</a>|
|[description](#description)|Optional description that provides additional detail about the entity or attribute.|<a href="GreenhouseGas.md" target="_blank">Sustainability/GreenhouseGas</a>|
|[gwpfactor](#gwpfactor)|Global warming potential factor.|<a href="GreenhouseGas.md" target="_blank">Sustainability/GreenhouseGas</a>|
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Greenhouse gas</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>sourceName</td><td>msdyn_greenhousegasid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the greenhousegasId attribute are listed below.</summary>
...
**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_greenhousegasid"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Greenhouse Gas</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the Greenhouse Gas</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the Greenhouse Gas</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Category</td></tr><tr><td>description</td><td>The category of greenhouse gas.</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyn_category</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Perfluorocarbons (PFC)</td><td>700610000</td></tr><tr><td>en</td><td>Hydrofluorocarbons (HFC)</td><td>700610001</td></tr><tr><td>en</td><td>Sulfur Hexafluoride (SF₆)</td><td>700610002</td></tr><tr><td>en</td><td>Nitrogen Trifluoride (NF₃)</td><td>700610003</td></tr><tr><td>en</td><td>Non Fluorinated</td><td>700610004</td></tr></table></td></tr></table>
...
**is.dataFormat.numeric**  
  **does.haveDefault**  
  An attribute has a default value  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>default</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Perfluorocarbons (PFC)</td><td>700610000</td></tr><tr><td>en</td><td>Hydrofluorocarbons (HFC)</td><td>700610001</td></tr><tr><td>en</td><td>Sulfur Hexafluoride (SF₆)</td><td>700610002</td></tr><tr><td>en</td><td>Nitrogen Trifluoride (NF₃)</td><td>700610003</td></tr><tr><td>en</td><td>Non Fluorinated</td><td>700610004</td></tr></table></td><td>any</td><td></td></tr></table>
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>The category of greenhouse gas.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_datafield"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>GWP factor</td></tr><tr><td>description</td><td>Global warming potential factor.</td></tr><tr><td>dataFormat</td><td>decimal</td></tr><tr><td>maximumValue</td><td>100000000000</td></tr><tr><td>minimumValue</td><td>-100000000000</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyn_gwpfactor</td></tr></table>

#### Traits

<details>
<summary>List of traits for the gwpfactor attribute are listed below.</summary>
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Global warming potential factor.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>GWP factor</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_gwpfactor"</td><td>string</td><td></td></tr></table>
