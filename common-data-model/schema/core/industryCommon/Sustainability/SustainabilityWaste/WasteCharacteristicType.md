...
Stores all the different classifications for the waste quality characteristics.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Sustainability\CloudforSustainabilityWasteDataModel/WasteCharacteristicType.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specific identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[WasteCharacteristicType/(resolvedAttributes)/wastecharacteristictypeId](#wastecharacteristictypeId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[WasteCharacteristicType/(resolvedAttributes)/statecode](#statecode)</td><td>attribute</td><td></td></tr></table>

**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/Sustainability<br>/CloudforSustainabilityWasteDataModel<br>/WasteCharacteristicType.cdm.json<br>/WasteCharacteristicType/hasAttributes<br>/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Stores all the different classifications for the waste quality characteristics.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Waste characteristic type</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_wastecharacteristictype"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[wastecharacteristictypeId](#wastecharacteristictypeId)|Unique identifier for entity instances|<a href="WasteCharacteristicType.md" target="_blank">Sustainability\CloudforSustainabilityWasteDataModel/WasteCharacteristicType</a>|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="WasteCharacteristicType.md" target="_blank">Sustainability\CloudforSustainabilityWasteDataModel/WasteCharacteristicType</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="WasteCharacteristicType.md" target="_blank">Sustainability\CloudforSustainabilityWasteDataModel/WasteCharacteristicType</a>|
|[statecode](#statecode)|Status of the waste characteristic type.|<a href="WasteCharacteristicType.md" target="_blank">Sustainability\CloudforSustainabilityWasteDataModel/WasteCharacteristicType</a>|
|[statuscode](#statuscode)|Reason for the status of the waste characteristic type.|<a href="WasteCharacteristicType.md" target="_blank">Sustainability\CloudforSustainabilityWasteDataModel/WasteCharacteristicType</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="WasteCharacteristicType.md" target="_blank">Sustainability\CloudforSustainabilityWasteDataModel/WasteCharacteristicType</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="WasteCharacteristicType.md" target="_blank">Sustainability\CloudforSustainabilityWasteDataModel/WasteCharacteristicType</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="WasteCharacteristicType.md" target="_blank">Sustainability\CloudforSustainabilityWasteDataModel/WasteCharacteristicType</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="WasteCharacteristicType.md" target="_blank">Sustainability\CloudforSustainabilityWasteDataModel/WasteCharacteristicType</a>|
|[name](#name)|The name of the custom entity.|<a href="WasteCharacteristicType.md" target="_blank">Sustainability\CloudforSustainabilityWasteDataModel/WasteCharacteristicType</a>|
|[description](#description)|Optional field that provides additional detail about the entity or attribute.|<a href="WasteCharacteristicType.md" target="_blank">Sustainability\CloudforSustainabilityWasteDataModel/WasteCharacteristicType</a>|
|[origincorrelationid](#origincorrelationid)|Optional field to store source unique identifier for the characteristic that is being tested for in the waste sample.|<a href="WasteCharacteristicType.md" target="_blank">Sustainability\CloudforSustainabilityWasteDataModel/WasteCharacteristicType</a>|

### <a href=#wastecharacteristictypeId name="wastecharacteristictypeId">wastecharacteristictypeId</a>

Unique identifier for entity instances  
First included in: Sustainability/SustainabilityWaste/WasteCharacteristicType (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Waste characteristic type</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>sourceName</td><td>msdyn_wastecharacteristictypeid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the wastecharacteristictypeId attribute are listed below.</summary>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_wastecharacteristictypeid"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the waste characteristic type.</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the waste characteristic type.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the waste characteristic type.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
