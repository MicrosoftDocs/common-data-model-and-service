...
**is.identifiedBy**  
  names a specific identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[WasteQuantity/(resolvedAttributes)/wastequantityId](#wastequantityId)</td><td>attribute</td><td></td></tr></table>

**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/Sustainability<br>/CloudforSustainabilityWasteDataModel<br>/WasteQuantity.cdm.json/WasteQuantity<br>/hasAttributes/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Stores information on the actual waste quantity of the organization.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[wastequantityId](#wastequantityId)|Unique identifier for entity instances.|<a href="WasteQuantity.md" target="_blank">Sustainability/SustainabilityWaste/WasteQuantity</a>|
|[TTLInSeconds](#TTLInSeconds)|Time to live in seconds.|<a href="WasteQuantity.md" target="_blank">Sustainability/SustainabilityWaste/WasteQuantity</a>|
|[partitionId](#partitionId)|Logical partition identifier. A logical partition consists of a set of records with same partition ID.|<a href="WasteQuantity.md" target="_blank">Sustainability/SustainabilityWaste/WasteQuantity</a>|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="WasteQuantity.md" target="_blank">Sustainability/SustainabilityWaste/WasteQuantity</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="WasteQuantity.md" target="_blank">Sustainability/SustainabilityWaste/WasteQuantity</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="WasteQuantity.md" target="_blank">Sustainability/SustainabilityWaste/WasteQuantity</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="WasteQuantity.md" target="_blank">Sustainability/SustainabilityWaste/WasteQuantity</a>|
|[name](#name)|The name of the custom entity.|<a href="WasteQuantity.md" target="_blank">Sustainability/SustainabilityWaste/WasteQuantity</a>|
|[cost](#cost)|Cost associated with waste diversion.|<a href="WasteQuantity.md" target="_blank">Sustainability/SustainabilityWaste/WasteQuantity</a>|
|[costunit](#costunit)|Unit associated with the cost quantity.|<a href="WasteQuantity.md" target="_blank">Sustainability/SustainabilityWaste/WasteQuantity</a>|
|[dataqualitytype](#dataqualitytype)|Description of the data quality that identifies if the data is actual, estimated, or other descriptors of the data.|<a href="WasteQuantity.md" target="_blank">Sustainability/SustainabilityWaste/WasteQuantity</a>|
|[description](#description)|Optional description to give additional detail to the entity or attribute..|<a href="WasteQuantity.md" target="_blank">Sustainability/SustainabilityWaste/WasteQuantity</a>|
|[diversionenddate](#diversionenddate)|End date of the period for which the waste diverted needs to be reported.|<a href="WasteQuantity.md" target="_blank">Sustainability/SustainabilityWaste/WasteQuantity</a>|
|[diversionmethod](#diversionmethod)|Method of waste diversion, such as recovery or disposal.|<a href="WasteQuantity.md" target="_blank">Sustainability/SustainabilityWaste/WasteQuantity</a>|
|[diversionmethodsubtype](#diversionmethodsubtype)|Field to further classify the waste diversion method. |<a href="WasteQuantity.md" target="_blank">Sustainability/SustainabilityWaste/WasteQuantity</a>|
|[diversionstartdate](#diversionstartdate)|Start date of the period for which the waste diverted needs to be reported.|<a href="WasteQuantity.md" target="_blank">Sustainability/SustainabilityWaste/WasteQuantity</a>|
|[evidence](#evidence)|Optional field where evidence such as invoice, system records can be linked to an entity or attribute, if required.|<a href="WasteQuantity.md" target="_blank">Sustainability/SustainabilityWaste/WasteQuantity</a>|
|[expensetype](#expensetype)|Describes the expense type associated with the waste diversion operation.|<a href="WasteQuantity.md" target="_blank">Sustainability/SustainabilityWaste/WasteQuantity</a>|
|[facility](#facility)|Unique identifier for facility associated with waste diversion operation.|<a href="WasteQuantity.md" target="_blank">Sustainability/SustainabilityWaste/WasteQuantity</a>|
|[industrialprocesstype](#industrialprocesstype)|Type of industrial process used to track and associate with the waste diversion operation.|<a href="WasteQuantity.md" target="_blank">Sustainability/SustainabilityWaste/WasteQuantity</a>|
|[material](#material)|Material composition of the waste such as glass, plastic, metals, or biomass.|<a href="WasteQuantity.md" target="_blank">Sustainability/SustainabilityWaste/WasteQuantity</a>|
|[organizationalunit](#organizationalunit)|Unique identifier for the organizational unit associated with waste diversion operation.|<a href="WasteQuantity.md" target="_blank">Sustainability/SustainabilityWaste/WasteQuantity</a>|
|[valuechainpartner](#valuechainpartner)|Reference to the value chain partner or supplier associated with the transaction.|<a href="WasteQuantity.md" target="_blank">Sustainability/SustainabilityWaste/WasteQuantity</a>|
|[wastediversionsitetype](#wastediversionsitetype)|The site type where the waste diversion occurs. |<a href="WasteQuantity.md" target="_blank">Sustainability/SustainabilityWaste/WasteQuantity</a>|
|[wastetype](#wastetype)|Reference to the classification of the waste type and category.|<a href="WasteQuantity.md" target="_blank">Sustainability/SustainabilityWaste/WasteQuantity</a>|
|[wastevolume](#wastevolume)|Optional field for the volume of waste diverted.|<a href="WasteQuantity.md" target="_blank">Sustainability/SustainabilityWaste/WasteQuantity</a>|
|[wastevolumeunit](#wastevolumeunit)|Unit associated with the volume of waste diverted.|<a href="WasteQuantity.md" target="_blank">Sustainability/SustainabilityWaste/WasteQuantity</a>|
|[wasteweight](#wasteweight)|Weight of the waste diverted.|<a href="WasteQuantity.md" target="_blank">Sustainability/SustainabilityWaste/WasteQuantity</a>|
|[wasteweightunit](#wasteweightunit)|Unit associated with the weight of waste diverted.|<a href="WasteQuantity.md" target="_blank">Sustainability/SustainabilityWaste/WasteQuantity</a>|
|[origincorrelationid](#origincorrelationid)|Optional field to store source unique identifier values for the entity.|<a href="WasteQuantity.md" target="_blank">Sustainability/SustainabilityWaste/WasteQuantity</a>|
|[customdimension](#customdimension)|Field where Custom Dimension values are stored in JSON format.|<a href="WasteQuantity.md" target="_blank">Sustainability/SustainabilityWaste/WasteQuantity</a>|
|[reportingdate](#reportingdate)|Date used to parameterize reports.|<a href="WasteQuantity.md" target="_blank">Sustainability/SustainabilityWaste/WasteQuantity</a>|

### <a href=#wastequantityId name="wastequantityId">wastequantityId</a>

Unique identifier for entity instances.  
First included in: Sustainability/SustainabilityWaste/WasteQuantity (this entity)  
...
<details>
<summary>List of traits for the wastequantityId attribute are listed below.</summary>
...
**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_wastequantityid"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Cost</td></tr><tr><td>description</td><td>Cost associated with waste diversion.</td></tr><tr><td>dataFormat</td><td>decimal</td></tr><tr><td>maximumValue</td><td>100000000000</td></tr><tr><td>minimumValue</td><td>-100000000000</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyn_cost</td></tr></table>
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Cost associated with waste diversion.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Diversion end date</td></tr><tr><td>description</td><td>End date of the period for which the waste diverted needs to be reported.</td></tr><tr><td>dataFormat</td><td>dateTime</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyn_diversionenddate</td></tr></table>

#### Traits

<details>
<summary>List of traits for the diversionenddate attribute are listed below.</summary>
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>End date of the period for which the waste diverted needs to be reported.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Diversion end date</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.nullable**  
  The attribute value may be set to NULL.  

**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_diversionenddate"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Diversion method</td></tr><tr><td>description</td><td>Method of waste diversion, such as recovery or disposal.</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyn_diversionmethod</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Waste diverted from disposal by recovery</td><td>700610000</td></tr><tr><td>en</td><td>Waste directed to disposal</td><td>700610001</td></tr><tr><td>en</td><td>Others</td><td>700610002</td></tr></table></td></tr></table>

#### Traits

<details>
<summary>List of traits for the diversionmethod attribute are listed below.</summary>
...
**is.dataFormat.numeric**  
  **does.haveDefault**  
  An attribute has a default value  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>default</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Waste diverted from disposal by recovery</td><td>700610000</td></tr><tr><td>en</td><td>Waste directed to disposal</td><td>700610001</td></tr><tr><td>en</td><td>Others</td><td>700610002</td></tr></table></td><td>any</td><td></td></tr></table>
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Method of waste diversion, such as recovery or disposal.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Diversion method</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.nullable**  
  The attribute value may be set to NULL.  

**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_diversionmethod"</td><td>string</td><td></td></tr></table>
...
<details>
<summary>List of traits for the diversionmethodsubtype attribute are listed below.</summary>
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Field to further classify the waste diversion method. </td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Diversion method sub-type</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.nullable**  
  The attribute value may be set to NULL.  

**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_diversionmethodsubtype"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Diversion start date </td></tr><tr><td>description</td><td>Start date of the period for which the waste diverted needs to be reported.</td></tr><tr><td>dataFormat</td><td>dateTime</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyn_diversionstartdate</td></tr></table>

#### Traits

<details>
<summary>List of traits for the diversionstartdate attribute are listed below.</summary>
...
**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Diversion start date </td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.nullable**  
  The attribute value may be set to NULL.  

**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_diversionstartdate"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Evidence</td></tr><tr><td>description</td><td>Optional field where evidence such as invoice, system records can be linked to an entity or attribute, if required.</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>100</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyn_evidence</td></tr></table>
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Optional field where evidence such as invoice, system records can be linked to an entity or attribute, if required.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Expense type</td></tr><tr><td>description</td><td>Describes the expense type associated with the waste diversion operation.</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>100</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyn_expensetype</td></tr></table>
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Describes the expense type associated with the waste diversion operation.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_expensetype"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Facility</td></tr><tr><td>description</td><td>Unique identifier for facility associated with waste diversion operation.</td></tr><tr><td>dataFormat</td><td>guid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Industrial process type</td></tr><tr><td>description</td><td>Type of industrial process used to track and associate with the waste diversion operation.</td></tr><tr><td>dataFormat</td><td>guid</td></tr></table>
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Type of industrial process used to track and associate with the waste diversion operation.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Organizational unit</td></tr><tr><td>description</td><td>Unique identifier for the organizational unit associated with waste diversion operation.</td></tr><tr><td>dataFormat</td><td>guid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td> Waste diversion site type </td></tr><tr><td>description</td><td>The site type where the waste diversion occurs. </td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyn_wastediversionsitetype</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Onsite</td><td>700610000</td></tr><tr><td>en</td><td>Offsite</td><td>700610001</td></tr></table></td></tr></table>

#### Traits

<details>
<summary>List of traits for the wastediversionsitetype attribute are listed below.</summary>
...
**is.dataFormat.numeric**  
  **does.haveDefault**  
  An attribute has a default value  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>default</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Onsite</td><td>700610000</td></tr><tr><td>en</td><td>Offsite</td><td>700610001</td></tr></table></td><td>any</td><td></td></tr></table>
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>The site type where the waste diversion occurs. </td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td> Waste diversion site type </td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.nullable**  
  The attribute value may be set to NULL.  

**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_wastediversionsitetype"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Waste type</td></tr><tr><td>description</td><td>Reference to the classification of the waste type and category.</td></tr><tr><td>dataFormat</td><td>guid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the wastetype attribute are listed below.</summary>
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reference to the classification of the waste type and category.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Waste type</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.lookup**  
  The attribute represents a style of lookup in CDS for Applications  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>style</td><td>"single"</td><td>string</td><td></td></tr></table>

**is.linkedEntity.identifier**  
  Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th><th>relationshipName</th></tr><tr><td><a href="WasteType.md" target="_blank">WasteType.cdm.json/WasteType</a></td><td><a href="WasteType.md#wastetypeId" target="_blank">wastetypeId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Waste volume</td></tr><tr><td>description</td><td>Optional field for the volume of waste diverted.</td></tr><tr><td>dataFormat</td><td>decimal</td></tr><tr><td>maximumValue</td><td>100000000000</td></tr><tr><td>minimumValue</td><td>-100000000000</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyn_wastevolume</td></tr></table>

#### Traits

<details>
<summary>List of traits for the wastevolume attribute are listed below.</summary>
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Optional field for the volume of waste diverted.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Waste volume</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_wastevolume"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Waste volume unit</td></tr><tr><td>description</td><td>Unit associated with the volume of waste diverted.</td></tr><tr><td>dataFormat</td><td>guid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the wastevolumeunit attribute are listed below.</summary>
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Unit associated with the volume of waste diverted.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Waste volume unit</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Waste weight </td></tr><tr><td>description</td><td>Weight of the waste diverted.</td></tr><tr><td>dataFormat</td><td>decimal</td></tr><tr><td>maximumValue</td><td>100000000000</td></tr><tr><td>minimumValue</td><td>-100000000000</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyn_wasteweight</td></tr></table>

#### Traits

<details>
<summary>List of traits for the wasteweight attribute are listed below.</summary>
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Weight of the waste diverted.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Waste weight </td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_wasteweight"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Waste weight unit</td></tr><tr><td>description</td><td>Unit associated with the weight of waste diverted.</td></tr><tr><td>dataFormat</td><td>guid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the wasteweightunit attribute are listed below.</summary>
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Unit associated with the weight of waste diverted.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Waste weight unit</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
