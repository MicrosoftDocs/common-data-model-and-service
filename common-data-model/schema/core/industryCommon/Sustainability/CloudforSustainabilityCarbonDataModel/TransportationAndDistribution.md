---
title: TransportationAndDistribution in Microsoft for Sustainability carbon data model 
...
# Transportation and distribution in Microsoft for Sustainability carbon data model(TransportationAndDistribution)

Upstream and downstream transportation and distribution activities.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Sustainability\CloudforSustainabilityCarbonDataModel/TransportationAndDistribution.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specific identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[TransportationAndDistribution/(resolvedAttributes)/transportationanddistributionId](#transportationanddistributionId)</td><td>attribute</td><td></td></tr></table>

**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/Sustainability<br>/CloudforSustainabilityCarbonDataModel<br>/TransportationAndDistribution.cdm.json<br>/TransportationAndDistribution/hasAttributes<br>/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>
...
|---|---|---|
|[transportationanddistributionId](#transportationanddistributionId)|Unique identifier for entity instances|<a href="TransportationAndDistribution.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/TransportationAndDistribution</a>|
|[TTLInSeconds](#TTLInSeconds)|Time to live in seconds.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/TransportationAndDistribution</a>|
|[partitionId](#partitionId)|Logical partition id. A logical partition consists of a set of records with same partition id.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/TransportationAndDistribution</a>|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/TransportationAndDistribution</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/TransportationAndDistribution</a>|
...
|[cost](#cost)|Cost associated with the activity data.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/TransportationAndDistribution</a>|
|[costunit](#costunit)|Unit associated with the cost quantity.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/TransportationAndDistribution</a>|
|[customdimension](#customdimension)|Field where Custom Dimension values are stored in JSON format.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/TransportationAndDistribution</a>|
|[dataqualitytype](#dataqualitytype)|Description of the data quality which identifies if the data is actual, estimated, or other descriptors of the data.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/TransportationAndDistribution</a>|
|[description](#description)|Optional description that provides additional detail about the entity or attribute.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/TransportationAndDistribution</a>|
|[distance](#distance)|Quantity associated with the distance activity which contributes to mobile combustion or supply chain travel.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/TransportationAndDistribution</a>|
|[distanceunit](#distanceunit)|Unique identifier for the unit associated with distance.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/TransportationAndDistribution</a>|
|[evidence](#evidence)|Optional field where evidence can be linked to the entity or attribute, if required.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/TransportationAndDistribution</a>|
|[facilityid](#facilityid)|Unique identifier associated with Transportation and distribution|<a href="TransportationAndDistribution.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/TransportationAndDistribution</a>|
|[fuelquantity](#fuelquantity)|Unique identifier for the fuel consumption data associated with combustion or supply chain fuel usage.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/TransportationAndDistribution</a>|
|[fuelquantityunit](#fuelquantityunit)|Unique identifier for the unit associated with fuel data.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/TransportationAndDistribution</a>|
|[fueltypeid](#fueltypeid)|Unique identifier for the fuel type associated with combustion or supply chain fuel usage.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/TransportationAndDistribution</a>|
|[goodsquantity](#goodsquantity)|The quantity of goods being transported and distributed, which is used for calculation.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/TransportationAndDistribution</a>|
|[goodsunit](#goodsunit)|Unique identifier for the unit relating to transportation and distribution of goods.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/TransportationAndDistribution</a>|
|[industrialprocesstypeid](#industrialprocesstypeid)|Unique identifier for the industrial process type associated with activity.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/TransportationAndDistribution</a>|
|[organizationalunitid](#organizationalunitid)|Unique identifier for the organizational unit associated with transportation and distribution.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/TransportationAndDistribution</a>|
|[quantity](#quantity)|Generic quantity field associated with activity entities.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/TransportationAndDistribution</a>|
|[quantityunit](#quantityunit)|Unit associated with the quantity field.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/TransportationAndDistribution</a>|
|[reportingdate](#reportingdate)|Date used to parameterize reports.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/TransportationAndDistribution</a>|
|[origincorrelationid](#origincorrelationid)|An optional identifier to correlate record with data origin.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/TransportationAndDistribution</a>|
|[transactiondate](#transactiondate)|Date associated with the actual date when the transaction occurred.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/TransportationAndDistribution</a>|
