...
Combustion that occurs in a fixed asset, such as a boiler or furnace.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Sustainability\CloudforSustainabilityCarbonDataModel/StationaryCombustion.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specific identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[StationaryCombustion/(resolvedAttributes)/stationarycombustionId](#stationarycombustionId)</td><td>attribute</td><td></td></tr></table>

**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/Sustainability<br>/CloudforSustainabilityCarbonDataModel<br>/StationaryCombustion.cdm.json<br>/StationaryCombustion/hasAttributes<br>/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Combustion that occurs in a fixed asset, such as a boiler or furnace.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Stationary combustion</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_stationarycombustion"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[stationarycombustionId](#stationarycombustionId)|Unique identifier for entity instances|<a href="StationaryCombustion.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/StationaryCombustion</a>|
|[TTLInSeconds](#TTLInSeconds)|Time to live in seconds.|<a href="StationaryCombustion.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/StationaryCombustion</a>|
|[partitionId](#partitionId)|Logical partition id. A logical partition consists of a set of records with same partition id.|<a href="StationaryCombustion.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/StationaryCombustion</a>|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="StationaryCombustion.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/StationaryCombustion</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="StationaryCombustion.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/StationaryCombustion</a>|
...
|[costunit](#costunit)|Unit associated with the cost quantity.|<a href="StationaryCombustion.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/StationaryCombustion</a>|
|[customdimension](#customdimension)|Field where Custom Dimension values are stored in JSON format.|<a href="StationaryCombustion.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/StationaryCombustion</a>|
|[dataqualitytype](#dataqualitytype)|Description of the data quality which identifies if the data is actual, estimated, or other descriptors of the data.|<a href="StationaryCombustion.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/StationaryCombustion</a>|
|[description](#description)|Optional description that provides additional detail about the entity or attribute.|<a href="StationaryCombustion.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/StationaryCombustion</a>|
|[evidence](#evidence)|Optional field where evidence can be linked to the entity or attribute, if required.|<a href="StationaryCombustion.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/StationaryCombustion</a>|
|[facilityid](#facilityid)|Unique identifier for the facility associated with stationary combustion.|<a href="StationaryCombustion.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/StationaryCombustion</a>|
|[facilityusagedetailid](#facilityusagedetailid)|The facility usage detail associated with this stationary combustion|<a href="StationaryCombustion.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/StationaryCombustion</a>|
|[fueltypeid](#fueltypeid)|Unique identifier for the fuel type associated with combustion or supply chain fuel usage.|<a href="StationaryCombustion.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/StationaryCombustion</a>|
|[industrialprocesstypeid](#industrialprocesstypeid)|Unique identifier for the industrial process type associated with stationary combustion.|<a href="StationaryCombustion.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/StationaryCombustion</a>|
|[leasedassetcategory](#leasedassetcategory)|Indicator of classification of category. An empty value means this activity is in scope 1.|<a href="StationaryCombustion.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/StationaryCombustion</a>|
|[meternumber](#meternumber)|Field representing meter number for stationary combustion entity.|<a href="StationaryCombustion.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/StationaryCombustion</a>|
|[meterid](#meterid)|Field representing meter for stationary combustion entity.|<a href="StationaryCombustion.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/StationaryCombustion</a>|
|[lifespaninyears](#lifespaninyears)|The product lifespan refers to the duration of time (in years) a consumer can expect a product to remain useful and functional after purchase.|<a href="StationaryCombustion.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/StationaryCombustion</a>|
|[organizationalunitid](#organizationalunitid)|Unique identifier for the organizational unit associated with the stationary combustion.|<a href="StationaryCombustion.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/StationaryCombustion</a>|
...
|[goodsunit](#goodsunit)|Quantity of goods in the corresponding activity data.|<a href="StationaryCombustion.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/StationaryCombustion</a>|
...
|[reportingdate](#reportingdate)|Date used to parameterize reports.|<a href="StationaryCombustion.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/StationaryCombustion</a>|
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Stationary combustion</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>sourceName</td><td>msdyn_stationarycombustionid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the stationarycombustionId attribute are listed below.</summary>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_stationarycombustionid"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Facility</td></tr><tr><td>description</td><td>Unique identifier for the facility associated with stationary combustion.</td></tr><tr><td>dataFormat</td><td>guid</td></tr></table>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Unique identifier for the facility associated with stationary combustion.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Facility usage detail</td></tr><tr><td>description</td><td>The facility usage detail associated with this stationary combustion</td></tr><tr><td>dataFormat</td><td>guid</td></tr></table>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>The facility usage detail associated with this stationary combustion</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Industrial Process Type</td></tr><tr><td>description</td><td>Unique identifier for the industrial process type associated with stationary combustion.</td></tr><tr><td>dataFormat</td><td>guid</td></tr></table>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Unique identifier for the industrial process type associated with stationary combustion.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Meter</td></tr><tr><td>description</td><td>Field representing meter for stationary combustion entity.</td></tr><tr><td>dataFormat</td><td>guid</td></tr></table>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Field representing meter for stationary combustion entity.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Organizational Unit</td></tr><tr><td>description</td><td>Unique identifier for the organizational unit associated with the stationary combustion.</td></tr><tr><td>dataFormat</td><td>guid</td></tr></table>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Unique identifier for the organizational unit associated with the stationary combustion.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Quantity of fuel in the corresponding activity data.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Fuel quantity unit</td></tr><tr><td>description</td><td>Unique identifier for the unit associated with fuel data.</td></tr><tr><td>dataFormat</td><td>guid</td></tr></table>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Unique identifier for the unit associated with fuel data.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Goods quantity unit</td></tr><tr><td>description</td><td>Quantity of goods in the corresponding activity data.</td></tr><tr><td>dataFormat</td><td>guid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>(Deprecated) Value chain partner</td></tr><tr><td>description</td><td>Reference to the value chain partner or supplier associated with the transaction. Generally applies to scope 3 emissions.</td></tr><tr><td>dataFormat</td><td>guid</td></tr></table>
