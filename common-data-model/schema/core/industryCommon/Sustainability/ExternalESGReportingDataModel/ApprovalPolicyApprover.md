...
Captures information for a specific approval policy approver  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Sustainability\ExternalESGReportingDataModel/ApprovalPolicyApprover.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/Sustainability/ExternalESGReportingDataModel<br>/ApprovalPolicyApprover.cdm.json<br>/ApprovalPolicyApprover/hasAttributes<br>/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>
...
|---|---|---|
|[approvalpolicylineId](#approvalpolicylineId)|Unique identifier for entity instances|<a href="ApprovalPolicyApprover.md" target="_blank">Sustainability\ExternalESGReportingDataModel/ApprovalPolicyApprover</a>|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="ApprovalPolicyApprover.md" target="_blank">Sustainability\ExternalESGReportingDataModel/ApprovalPolicyApprover</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="ApprovalPolicyApprover.md" target="_blank">Sustainability\ExternalESGReportingDataModel/ApprovalPolicyApprover</a>|
|[statecode](#statecode)|Status of the Approval Policy Line|<a href="ApprovalPolicyApprover.md" target="_blank">Sustainability\ExternalESGReportingDataModel/ApprovalPolicyApprover</a>|
|[statuscode](#statuscode)|Reason for the status of the Approval Policy Line|<a href="ApprovalPolicyApprover.md" target="_blank">Sustainability\ExternalESGReportingDataModel/ApprovalPolicyApprover</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="ApprovalPolicyApprover.md" target="_blank">Sustainability\ExternalESGReportingDataModel/ApprovalPolicyApprover</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="ApprovalPolicyApprover.md" target="_blank">Sustainability\ExternalESGReportingDataModel/ApprovalPolicyApprover</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="ApprovalPolicyApprover.md" target="_blank">Sustainability\ExternalESGReportingDataModel/ApprovalPolicyApprover</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="ApprovalPolicyApprover.md" target="_blank">Sustainability\ExternalESGReportingDataModel/ApprovalPolicyApprover</a>|
|[name](#name)|Name|<a href="ApprovalPolicyApprover.md" target="_blank">Sustainability\ExternalESGReportingDataModel/ApprovalPolicyApprover</a>|
|[approvalpolicy](#approvalpolicy)|Approval Policy|<a href="ApprovalPolicyApprover.md" target="_blank">Sustainability\ExternalESGReportingDataModel/ApprovalPolicyApprover</a>|
|[approvalsequence](#approvalsequence)|Approval sequence|<a href="ApprovalPolicyApprover.md" target="_blank">Sustainability\ExternalESGReportingDataModel/ApprovalPolicyApprover</a>|

### <a href=#approvalpolicylineId name="approvalpolicylineId">approvalpolicylineId</a>

Unique identifier for entity instances  
First included in: Sustainability\\ExternalESGReportingDataModel/ApprovalPolicyApprover (this entity)  
