...
|[customerSizeCode](#customerSizeCode)|Select the size of the contact's company for segmentation and reporting purposes.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[customerTypeCode](#customerTypeCode)|Select the category that best describes the relationship between the contact and your organization.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[preferredContactMethodCode](#preferredContactMethodCode)|Select the preferred method of contact.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[leadSourceCode](#leadSourceCode)|Select the primary marketing source that directed the contact to your organization.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[paymentTermsCode](#paymentTermsCode)|Select the payment terms to indicate when the customer needs to pay the total amount.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[shippingMethodCode](#shippingMethodCode)|Select a shipping method for deliveries sent to this address.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[accountId](#accountId)|Unique identifier of the account with which the contact is associated.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[participatesInWorkflow](#participatesInWorkflow)|Shows whether the contact participates in workflow rules.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[isBackofficeCustomer](#isBackofficeCustomer)|Select whether the contact exists in a separate accounting or other system, such as Microsoft Dynamics GP or another ERP database, for use in integration processes.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[salutation](#salutation)|Type the salutation of the contact to make sure the contact is addressed correctly in sales calls, email messages, and marketing campaigns.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[jobTitle](#jobTitle)|Type the job title of the contact to make sure the contact is addressed correctly in sales calls, email, and marketing campaigns.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[firstName](#firstName)|Type the contact's first name to make sure the contact is addressed correctly in sales calls, email, and marketing campaigns.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[department](#department)|Type the department or business unit where the contact works in the parent company or business.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[nickName](#nickName)|Type the contact's nickname.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[middleName](#middleName)|Type the contact's middle name or initial to make sure the contact is addressed correctly.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[lastName](#lastName)|Type the contact's last name to make sure the contact is addressed correctly in sales calls, email, and marketing campaigns.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[suffix](#suffix)|Type the suffix used in the contact's name, such as Jr. or Sr. to make sure the contact is addressed correctly in sales calls, email, and marketing campaigns.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[yomiFirstName](#yomiFirstName)|Type the phonetic spelling of the contact's first name, if the name is specified in Japanese, to make sure the name is pronounced correctly in phone calls with the contact.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[fullName](#fullName)|Combines and shows the contact's first and last names so that the full name can be displayed in views and reports.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[yomiMiddleName](#yomiMiddleName)|Type the phonetic spelling of the contact's middle name, if the name is specified in Japanese, to make sure the name is pronounced correctly in phone calls with the contact.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[yomiLastName](#yomiLastName)|Type the phonetic spelling of the contact's last name, if the name is specified in Japanese, to make sure the name is pronounced correctly in phone calls with the contact.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[anniversary](#anniversary)|Enter the date of the contact's wedding or service anniversary for use in customer gift programs or other communications.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[birthDate](#birthDate)|Enter the contact's birthday for use in customer gift programs or other communications.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[governmentId](#governmentId)|Type the passport number or other government ID for the contact for use in documents or reports.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[yomiFullName](#yomiFullName)|Shows the combined Yomi first and last names of the contact so that the full phonetic name can be displayed in views and reports.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[description](#description)|Type additional information to describe the contact, such as an excerpt from the company's website.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[employeeId](#employeeId)|Type the employee ID or number for the contact for reference in orders, service cases, or other communications with the contact's organization.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[genderCode](#genderCode)|Select the contact's gender to make sure the contact is addressed correctly in sales calls, email, and marketing campaigns.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[annualIncome](#annualIncome)|Type the contact's annual income for use in profiling and financial analysis.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[hasChildrenCode](#hasChildrenCode)|Select whether the contact has any children for reference in follow-up phone calls and other communications.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[educationCode](#educationCode)|Select the contact's highest level of education for use in segmentation and analysis.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[webSiteUrl](#webSiteUrl)|Type the contact's professional or personal website or blog URL.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[familyStatusCode](#familyStatusCode)|Select the marital status of the contact for reference in follow-up phone calls and other communications.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[ftpSiteUrl](#ftpSiteUrl)|Type the URL for the contact's FTP site to enable users to access data and share documents.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[EMailAddress1](#EMailAddress1)|Type the primary email address for the contact.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[spousesName](#spousesName)|Type the name of the contact's spouse or partner for reference during calls, events, or other communications with the contact.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[assistantName](#assistantName)|Type the name of the contact's assistant.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[EMailAddress2](#EMailAddress2)|Type the secondary email address for the contact.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[assistantPhone](#assistantPhone)|Type the phone number for the contact's assistant.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[EMailAddress3](#EMailAddress3)|Type an alternate email address for the contact.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[doNotPhone](#doNotPhone)|Select whether the contact accepts phone calls. If Do Not Allow is selected, the contact will be excluded from any phone call activities distributed in marketing campaigns.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[managerName](#managerName)|Type the name of the contact's manager for use in escalating issues or other follow-up communications with the contact.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[managerPhone](#managerPhone)|Type the phone number for the contact's manager.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[doNotFax](#doNotFax)|Select whether the contact allows faxes. If Do Not Allow is selected, the contact will be excluded from any fax activities distributed in marketing campaigns.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[doNotEMail](#doNotEMail)|Select whether the contact allows direct email sent from Microsoft Dynamics 365. If Do Not Allow is selected, Microsoft Dynamics 365 will not send the email.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[doNotPostalMail](#doNotPostalMail)|Select whether the contact allows direct mail. If Do Not Allow is selected, the contact will be excluded from letter activities distributed in marketing campaigns.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[doNotBulkEMail](#doNotBulkEMail)|Select whether the contact accepts bulk email sent through marketing campaigns or quick campaigns. If Do Not Allow is selected, the contact can be added to marketing lists, but will be excluded from the email.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
...
|[accountRoleCode](#accountRoleCode)|Select the contact's role within the company or sales process, such as decision maker, employee, or influencer.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[territoryCode](#territoryCode)|Select a region or territory for the contact for use in segmentation and analysis.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[creditLimit](#creditLimit)|Type the credit limit of the contact for reference when you address invoice and accounting issues with the customer.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[createdOn](#createdOn)|Shows the date and time when the record was created. The date and time are displayed in the time zone selected in Microsoft Dynamics 365 options.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[creditOnHold](#creditOnHold)|Select whether the contact is on a credit hold, for reference when addressing invoice and accounting issues.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[modifiedOn](#modifiedOn)|Shows the date and time when the record was last updated. The date and time are displayed in the time zone selected in Microsoft Dynamics 365 options.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[numberOfChildren](#numberOfChildren)|Type the number of children the contact has for reference in follow-up phone calls and other communications.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[childrensNames](#childrensNames)|Type the names of the contact's children for reference in communications and client programs.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[mobilePhone](#mobilePhone)|Type the mobile phone number for the contact.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[pager](#pager)|Type the pager number for the contact.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[telephone1](#telephone1)|Type the main phone number for this contact.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[telephone2](#telephone2)|Type a second phone number for this contact.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[telephone3](#telephone3)|Type a third phone number for this contact.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[fax](#fax)|Type the fax number for the contact.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[aging30](#aging30)|For system use only.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[stateCode](#stateCode)|Shows whether the contact is active or inactive. Inactive contacts are read-only and can't be edited unless they are reactivated.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[aging60](#aging60)|For system use only.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[statusCode](#statusCode)|Select the contact's status.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[aging90](#aging90)|For system use only.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[parentContactId](#parentContactId)|Unique identifier of the parent contact.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[address1_AddressId](#address1_AddressId)|Unique identifier for address 1.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[address1_AddressTypeCode](#address1_AddressTypeCode)|Select the primary address type.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[address1_Name](#address1_Name)|Type a descriptive name for the primary address, such as Corporate Headquarters.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[address1_PrimaryContactName](#address1_PrimaryContactName)|Type the name of the main contact at the account's primary address.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[address1_Line1](#address1_Line1)|Type the first line of the primary address.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[address1_Line2](#address1_Line2)|Type the second line of the primary address.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[address1_Line3](#address1_Line3)|Type the third line of the primary address.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[address1_City](#address1_City)|Type the city for the primary address.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[address1_StateOrProvince](#address1_StateOrProvince)|Type the state or province of the primary address.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[address1_County](#address1_County)|Type the county for the primary address.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[address1_Country](#address1_Country)|Type the country or region for the primary address.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[address1_PostOfficeBox](#address1_PostOfficeBox)|Type the post office box number of the primary address.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[address1_PostalCode](#address1_PostalCode)|Type the ZIP Code or postal code for the primary address.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[address1_UTCOffset](#address1_UTCOffset)|Select the time zone, or UTC offset, for this address so that other people can reference it when they contact someone at this address.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[address1_FreightTermsCode](#address1_FreightTermsCode)|Select the freight terms for the primary address to make sure shipping orders are processed correctly.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[address1_UPSZone](#address1_UPSZone)|Type the UPS zone of the primary address to make sure shipping charges are calculated correctly and deliveries are made promptly, if shipped by UPS.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[address1_Latitude](#address1_Latitude)|Type the latitude value for the primary address for use in mapping and other applications.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[address1_Telephone1](#address1_Telephone1)|Type the main phone number associated with the primary address.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[address1_Longitude](#address1_Longitude)|Type the longitude value for the primary address for use in mapping and other applications.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[address1_ShippingMethodCode](#address1_ShippingMethodCode)|Select a shipping method for deliveries sent to this address.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[address1_Telephone2](#address1_Telephone2)|Type a second phone number associated with the primary address.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[address1_Telephone3](#address1_Telephone3)|Type a third phone number associated with the primary address.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[address1_Fax](#address1_Fax)|Type the fax number associated with the primary address.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[address2_AddressId](#address2_AddressId)|Unique identifier for address 2.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[address2_AddressTypeCode](#address2_AddressTypeCode)|Select the secondary address type.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[address2_Name](#address2_Name)|Type a descriptive name for the secondary address, such as Corporate Headquarters.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[address2_PrimaryContactName](#address2_PrimaryContactName)|Type the name of the main contact at the account's secondary address.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[address2_Line1](#address2_Line1)|Type the first line of the secondary address.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[address2_Line2](#address2_Line2)|Type the second line of the secondary address.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[address2_Line3](#address2_Line3)|Type the third line of the secondary address.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[address2_City](#address2_City)|Type the city for the secondary address.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[address2_StateOrProvince](#address2_StateOrProvince)|Type the state or province of the secondary address.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[address2_County](#address2_County)|Type the county for the secondary address.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[address2_Country](#address2_Country)|Type the country or region for the secondary address.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[address2_PostOfficeBox](#address2_PostOfficeBox)|Type the post office box number of the secondary address.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[address2_PostalCode](#address2_PostalCode)|Type the ZIP Code or postal code for the secondary address.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[address2_UTCOffset](#address2_UTCOffset)|Select the time zone, or UTC offset, for this address so that other people can reference it when they contact someone at this address.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[address2_FreightTermsCode](#address2_FreightTermsCode)|Select the freight terms for the secondary address to make sure shipping orders are processed correctly.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[address2_UPSZone](#address2_UPSZone)|Type the UPS zone of the secondary address to make sure shipping charges are calculated correctly and deliveries are made promptly, if shipped by UPS.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[address2_Latitude](#address2_Latitude)|Type the latitude value for the secondary address for use in mapping and other applications.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[address2_Telephone1](#address2_Telephone1)|Type the main phone number associated with the secondary address.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[address2_Longitude](#address2_Longitude)|Type the longitude value for the secondary address for use in mapping and other applications.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[address2_ShippingMethodCode](#address2_ShippingMethodCode)|Select a shipping method for deliveries sent to this address.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[address2_Telephone2](#address2_Telephone2)|Type a second phone number associated with the secondary address.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[address2_Telephone3](#address2_Telephone3)|Type a third phone number associated with the secondary address.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[address2_Fax](#address2_Fax)|Type the fax number associated with the secondary address.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[masterId](#masterId)|Unique identifier of the master contact for merge.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[preferredAppointmentDayCode](#preferredAppointmentDayCode)|Select the preferred day of the week for service appointments.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[preferredAppointmentTimeCode](#preferredAppointmentTimeCode)|Select the preferred time of day for service appointments.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[doNotSendMM](#doNotSendMM)|Select whether the contact accepts marketing materials, such as brochures or catalogs. Contacts that opt out can be excluded from marketing initiatives.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[parentCustomerId](#parentCustomerId)|Select the parent account or parent contact for the contact to provide a quick link to additional details, such as financial information, activities, and opportunities.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[parentCustomerIdType](#parentCustomerIdType)|Select the parent account or parent contact for the contact to provide a quick link to additional details, such as financial information, activities, and opportunities.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[merged](#merged)|Shows whether the account has been merged with a master contact.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[externalUserIdentifier](#externalUserIdentifier)|Identifier for an external user.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[lastUsedInCampaign](#lastUsedInCampaign)|Shows the date when the contact was last included in a marketing campaign or quick campaign.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[exchangeRate](#exchangeRate)|Shows the conversion rate of the record's currency. The exchange rate is used to convert all money fields in the record from the local currency to the system's default currency.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[annualIncome_Base](#annualIncome_Base)|Shows the Annual Income field converted to the system's default base currency. The calculations use the exchange rate specified in the Currencies area.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[creditLimit_Base](#creditLimit_Base)|Shows the Credit Limit field converted to the system's default base currency for reporting purposes. The calculations use the exchange rate specified in the Currencies area.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[aging60_Base](#aging60_Base)|Shows the Aging 60 field converted to the system's default base currency. The calculations use the exchange rate specified in the Currencies area.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[aging90_Base](#aging90_Base)|Shows the Aging 90 field converted to the system's default base currency. The calculations use the exchange rate specified in the Currencies area.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[aging30_Base](#aging30_Base)|Shows the Aging 30 field converted to the system's default base currency. The calculations use the exchange rate specified in the Currencies area.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[stageId](#stageId)|Shows the ID of the stage.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[processId](#processId)|Shows the ID of the process.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[address2_Composite](#address2_Composite)|Shows the complete secondary address.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[address1_Composite](#address1_Composite)|Shows the complete primary address.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[entityImageId](#entityImageId)|For internal use only.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[traversedPath](#traversedPath)|For internal use only.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[SLAId](#SLAId)|Choose the service level agreement (SLA) that you want to apply to the Contact record.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[SLAInvokedId](#SLAInvokedId)|Last SLA that was applied to this case. This field is for internal use only.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[onHoldTime](#onHoldTime)|Shows how long, in minutes, that the record was on hold.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[lastOnHoldTime](#lastOnHoldTime)|Contains the date and time stamp of the last on hold time.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[followEmail](#followEmail)|Information about whether to allow following email activity like opens, attachment views and link clicks for emails sent to the contact.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[timeSpentByMeOnEmailAndMeetings](#timeSpentByMeOnEmailAndMeetings)|Total time spent for emails (read and write) and meetings by me in relation to the contact record.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[address3_Country](#address3_Country)|the country or region for the 3rd address.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[address3_Line1](#address3_Line1)|the first line of the 3rd address.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[address3_Line2](#address3_Line2)|the second line of the 3rd address.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[address3_Line3](#address3_Line3)|the third line of the 3rd address.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[address3_PostalCode](#address3_PostalCode)|the ZIP Code or postal code for the 3rd address.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[address3_PostOfficeBox](#address3_PostOfficeBox)|the post office box number of the 3rd address.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[address3_StateOrProvince](#address3_StateOrProvince)|the state or province of the third address.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[address3_City](#address3_City)|Type the city for the 3rd address.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[business2](#business2)|Type a second business phone number for this contact.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[callback](#callback)|Type a callback phone number for this contact.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[company](#company)|Type the company phone of the contact.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[home2](#home2)|Type a second home phone number for this contact.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[address3_AddressId](#address3_AddressId)|Unique identifier for address 3.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[address3_Composite](#address3_Composite)|Shows the complete third address.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[address3_Fax](#address3_Fax)|Type the fax number associated with the third address.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[address3_FreightTermsCode](#address3_FreightTermsCode)|Select the freight terms for the third address to make sure shipping orders are processed correctly.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[address3_Latitude](#address3_Latitude)|Type the latitude value for the third address for use in mapping and other applications.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[address3_Longitude](#address3_Longitude)|Type the longitude value for the third address for use in mapping and other applications.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[address3_Name](#address3_Name)|Type a descriptive name for the third address, such as Corporate Headquarters.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[address3_PrimaryContactName](#address3_PrimaryContactName)|Type the name of the main contact at the account's third address.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[address3_ShippingMethodCode](#address3_ShippingMethodCode)|Select a shipping method for deliveries sent to this address.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[address3_Telephone1](#address3_Telephone1)|Type the main phone number associated with the third address.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[address3_Telephone2](#address3_Telephone2)|Type a second phone number associated with the third address.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[address3_Telephone3](#address3_Telephone3)|Type a third phone number associated with the primary address.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[address3_UPSZone](#address3_UPSZone)|Type the UPS zone of the third address to make sure shipping charges are calculated correctly and deliveries are made promptly, if shipped by UPS.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[address3_UTCOffset](#address3_UTCOffset)|Select the time zone, or UTC offset, for this address so that other people can reference it when they contact someone at this address.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[address3_County](#address3_County)|Type the county for the third address.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[address3_AddressTypeCode](#address3_AddressTypeCode)|Select the third address type.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[createdByExternalParty](#createdByExternalParty)|Shows the external party who created the record.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[modifiedByExternalParty](#modifiedByExternalParty)|Shows the external party who modified the record.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[marketingOnly](#marketingOnly)|Whether is only for marketing|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[adx_CreatedByIPAddress](#adx_CreatedByIPAddress)||<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[adx_CreatedByUsername](#adx_CreatedByUsername)||<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[adx_ModifiedByIPAddress](#adx_ModifiedByIPAddress)||<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[adx_ModifiedByUsername](#adx_ModifiedByUsername)||<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[adx_OrganizationName](#adx_OrganizationName)||<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[adx_TimeZone](#adx_TimeZone)||<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[msa_managingpartnerid](#msa_managingpartnerid)|Unique identifier for Account associated with Contact.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[disablewebtracking](#disablewebtracking)|Indicates that the contact has opted out of web tracking.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[isminor](#isminor)|Indicates that the contact is considered a minor in their jurisdiction.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[isminorwithparentalconsent](#isminorwithparentalconsent)|Indicates that the contact is considered a minor in their jurisdiction and has parental consent.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[portaltermsagreementdate](#portaltermsagreementdate)|Indicates the date and time that the person agreed to the portal terms and conditions.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[adx_ConfirmRemovePassword](#adx_ConfirmRemovePassword)||<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[adx_identity_accessfailedcount](#adx_identity_accessfailedcount)|Shows the current count of failed password attempts for the contact.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[adx_identity_emailaddress1confirmed](#adx_identity_emailaddress1confirmed)|Determines if the email is confirmed by the contact.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[adx_identity_lastsuccessfullogin](#adx_identity_lastsuccessfullogin)|Indicates the last date and time the user successfully signed in to a portal.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[adx_identity_locallogindisabled](#adx_identity_locallogindisabled)|Indicates that the contact can no longer sign in to the portal using the local account.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[adx_identity_lockoutenabled](#adx_identity_lockoutenabled)|Determines if this contact will track failed access attempts and become locked after too many failed attempts. To prevent the contact from becoming locked, you can disable this setting.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[adx_identity_lockoutenddate](#adx_identity_lockoutenddate)|Shows the moment in time when the locked contact becomes unlocked again.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[adx_identity_logonenabled](#adx_identity_logonenabled)|Determines if web authentication is enabled for the contact.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[adx_identity_mobilephoneconfirmed](#adx_identity_mobilephoneconfirmed)|Determines if the phone number is confirmed by the contact.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[adx_identity_newpassword](#adx_identity_newpassword)||<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[adx_identity_passwordhash](#adx_identity_passwordhash)||<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[adx_identity_securitystamp](#adx_identity_securitystamp)|A token used to manage the web authentication session.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[adx_identity_twofactorenabled](#adx_identity_twofactorenabled)|Determines if two-factor authentication is enabled for the contact.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[adx_identity_username](#adx_identity_username)|Shows the user identity for local web authentication.|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[adx_preferredlcid](#adx_preferredlcid)|User’s preferred portal LCID|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[adx_profilealert](#adx_profilealert)||<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[adx_profilealertdate](#adx_profilealertdate)||<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[adx_profilealertinstructions](#adx_profilealertinstructions)||<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[adx_ProfileIsAnonymous](#adx_ProfileIsAnonymous)||<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[adx_ProfileLastActivity](#adx_ProfileLastActivity)||<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[adx_profilemodifiedon](#adx_profilemodifiedon)||<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[adx_PublicProfileCopy](#adx_PublicProfileCopy)||<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
|[mspp_userpreferredlcid](#mspp_userpreferredlcid)|User’s preferred portal language|<a href="Contact.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Contact</a>|
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Account</td></tr><tr><td>description</td><td>Unique identifier of the account with which the contact is associated.</td></tr><tr><td>dataFormat</td><td>guid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Annual Income</td></tr><tr><td>description</td><td>Type the contact's annual income for use in profiling and financial analysis.</td></tr><tr><td>dataFormat</td><td>decimal</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>annualincome</td></tr></table>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Shows the date and time when the record was created. The date and time are displayed in the time zone selected in Microsoft Dynamics 365 options.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Aging 30</td></tr><tr><td>description</td><td>For system use only.</td></tr><tr><td>dataFormat</td><td>decimal</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>aging30</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Aging 60</td></tr><tr><td>description</td><td>For system use only.</td></tr><tr><td>dataFormat</td><td>decimal</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>aging60</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Aging 90</td></tr><tr><td>description</td><td>For system use only.</td></tr><tr><td>dataFormat</td><td>decimal</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>aging90</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Parent Contact</td></tr><tr><td>description</td><td>Unique identifier of the parent contact.</td></tr><tr><td>dataFormat</td><td>guid</td></tr></table>
...
### <a href=#address1_AddressId name="address1_AddressId">address1_AddressId</a>
...
<details>
<summary>List of traits for the address1_AddressId attribute are listed below.</summary>
...
*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Address 1: ID</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.nullable*  
  The attribute value may be set to NULL.  

*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"address1_addressid"</td><td>string</td><td></td></tr></table>
...
### <a href=#address1_AddressTypeCode name="address1_AddressTypeCode">address1_AddressTypeCode</a>
...
<details>
<summary>List of traits for the address1_AddressTypeCode attribute are listed below.</summary>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Select the primary address type.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Address 1: Address Type</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.nullable*  
  The attribute value may be set to NULL.  

*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"address1_addresstypecode"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Address 1: Name</td></tr><tr><td>description</td><td>Type a descriptive name for the primary address, such as Corporate Headquarters.</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>200</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>address1_name</td></tr></table>

#### Traits

<details>
<summary>List of traits for the address1_Name attribute are listed below.</summary>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Type a descriptive name for the primary address, such as Corporate Headquarters.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Address 1: Name</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"address1_name"</td><td>string</td><td></td></tr></table>
...
### <a href=#address1_PrimaryContactName name="address1_PrimaryContactName">address1_PrimaryContactName</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Address 1: Primary Contact Name</td></tr><tr><td>description</td><td>Type the name of the main contact at the account's primary address.</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>100</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>address1_primarycontactname</td></tr></table>

#### Traits

<details>
<summary>List of traits for the address1_PrimaryContactName attribute are listed below.</summary>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Type the name of the main contact at the account's primary address.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Address 1: Primary Contact Name</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"address1_primarycontactname"</td><td>string</td><td></td></tr></table>
...
### <a href=#address1_Line1 name="address1_Line1">address1_Line1</a>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Type the first line of the primary address.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Address 1: Street 1</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"address1_line1"</td><td>string</td><td></td></tr></table>
...
### <a href=#address1_Line2 name="address1_Line2">address1_Line2</a>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Type the second line of the primary address.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Address 1: Street 2</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"address1_line2"</td><td>string</td><td></td></tr></table>
...
### <a href=#address1_Line3 name="address1_Line3">address1_Line3</a>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Type the third line of the primary address.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Address 1: Street 3</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"address1_line3"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Address 1: City</td></tr><tr><td>description</td><td>Type the city for the primary address.</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>80</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>address1_city</td></tr></table>

#### Traits

<details>
<summary>List of traits for the address1_City attribute are listed below.</summary>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Type the city for the primary address.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Address 1: City</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"address1_city"</td><td>string</td><td></td></tr></table>
...
### <a href=#address1_StateOrProvince name="address1_StateOrProvince">address1_StateOrProvince</a>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Type the state or province of the primary address.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Address 1: State/Province</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"address1_stateorprovince"</td><td>string</td><td></td></tr></table>

*is.CDS.ordered*  
  the column number for an attribute with an entity in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>ordinal</td><td>"97"</td><td>integer</td><td></td></tr></table>
...
<details>
<summary>List of traits for the address1_County attribute are listed below.</summary>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Type the county for the primary address.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Address 1: County</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"address1_county"</td><td>string</td><td></td></tr></table>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Type the country or region for the primary address.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Address 1: Country/Region</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"address1_country"</td><td>string</td><td></td></tr></table>
...
### <a href=#address1_PostOfficeBox name="address1_PostOfficeBox">address1_PostOfficeBox</a>
...
<details>
<summary>List of traits for the address1_PostOfficeBox attribute are listed below.</summary>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Type the post office box number of the primary address.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Address 1: Post Office Box</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"address1_postofficebox"</td><td>string</td><td></td></tr></table>

*is.CDS.ordered*  
  the column number for an attribute with an entity in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>ordinal</td><td>"100"</td><td>integer</td><td></td></tr></table>
...
### <a href=#address1_PostalCode name="address1_PostalCode">address1_PostalCode</a>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Type the ZIP Code or postal code for the primary address.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Address 1: ZIP/Postal Code</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"address1_postalcode"</td><td>string</td><td></td></tr></table>
...
### <a href=#address1_UTCOffset name="address1_UTCOffset">address1_UTCOffset</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Address 1: UTC Offset</td></tr><tr><td>description</td><td>Select the time zone, or UTC offset, for this address so that other people can reference it when they contact someone at this address.</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>maximumValue</td><td>1500</td></tr><tr><td>minimumValue</td><td>-1500</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>address1_utcoffset</td></tr></table>

#### Traits

<details>
<summary>List of traits for the address1_UTCOffset attribute are listed below.</summary>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Select the time zone, or UTC offset, for this address so that other people can reference it when they contact someone at this address.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Address 1: UTC Offset</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"address1_utcoffset"</td><td>string</td><td></td></tr></table>
...
### <a href=#address1_FreightTermsCode name="address1_FreightTermsCode">address1_FreightTermsCode</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Address 1: Freight Terms</td></tr><tr><td>description</td><td>Select the freight terms for the primary address to make sure shipping orders are processed correctly.</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>address1_freighttermscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>FOB</td><td>1</td></tr><tr><td>en</td><td>No Charge</td><td>2</td></tr></table></td></tr></table>

#### Traits

<details>
<summary>List of traits for the address1_FreightTermsCode attribute are listed below.</summary>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Select the freight terms for the primary address to make sure shipping orders are processed correctly.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Address 1: Freight Terms</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.nullable*  
  The attribute value may be set to NULL.  

*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"address1_freighttermscode"</td><td>string</td><td></td></tr></table>

*is.CDS.ordered*  
  the column number for an attribute with an entity in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>ordinal</td><td>"103"</td><td>integer</td><td></td></tr></table>

*is.dataFormat.integer*  
  </details>

### <a href=#address1_UPSZone name="address1_UPSZone">address1_UPSZone</a>
...
<details>
<summary>List of traits for the address1_UPSZone attribute are listed below.</summary>
...
*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Address 1: UPS Zone</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"address1_upszone"</td><td>string</td><td></td></tr></table>
...
### <a href=#address1_Latitude name="address1_Latitude">address1_Latitude</a>
...
<details>
<summary>List of traits for the address1_Latitude attribute are listed below.</summary>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Type the latitude value for the primary address for use in mapping and other applications.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Address 1: Latitude</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"address1_latitude"</td><td>string</td><td></td></tr></table>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Type the main phone number associated with the primary address.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Address 1: Phone</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"address1_telephone1"</td><td>string</td><td></td></tr></table>
...
### <a href=#address1_Longitude name="address1_Longitude">address1_Longitude</a>
...
<details>
<summary>List of traits for the address1_Longitude attribute are listed below.</summary>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Type the longitude value for the primary address for use in mapping and other applications.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Address 1: Longitude</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"address1_longitude"</td><td>string</td><td></td></tr></table>
...
### <a href=#address1_ShippingMethodCode name="address1_ShippingMethodCode">address1_ShippingMethodCode</a>
...
<details>
<summary>List of traits for the address1_ShippingMethodCode attribute are listed below.</summary>
...
*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Address 1: Shipping Method</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.nullable*  
  The attribute value may be set to NULL.  

*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"address1_shippingmethodcode"</td><td>string</td><td></td></tr></table>
...
### <a href=#address1_Telephone2 name="address1_Telephone2">address1_Telephone2</a>
...
<details>
<summary>List of traits for the address1_Telephone2 attribute are listed below.</summary>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Type a second phone number associated with the primary address.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Address 1: Telephone 2</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"address1_telephone2"</td><td>string</td><td></td></tr></table>
...
### <a href=#address1_Telephone3 name="address1_Telephone3">address1_Telephone3</a>
...
<details>
<summary>List of traits for the address1_Telephone3 attribute are listed below.</summary>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Type a third phone number associated with the primary address.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Address 1: Telephone 3</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"address1_telephone3"</td><td>string</td><td></td></tr></table>

*is.CDS.ordered*  
  the column number for an attribute with an entity in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>ordinal</td><td>"110"</td><td>integer</td><td></td></tr></table>
...
### <a href=#address1_Fax name="address1_Fax">address1_Fax</a>
...
<details>
<summary>List of traits for the address1_Fax attribute are listed below.</summary>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Type the fax number associated with the primary address.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Address 1: Fax</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"address1_fax"</td><td>string</td><td></td></tr></table>
...
### <a href=#address2_AddressId name="address2_AddressId">address2_AddressId</a>
...
<details>
<summary>List of traits for the address2_AddressId attribute are listed below.</summary>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Unique identifier for address 2.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Address 2: ID</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.nullable*  
  The attribute value may be set to NULL.  

*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"address2_addressid"</td><td>string</td><td></td></tr></table>
...
### <a href=#address2_AddressTypeCode name="address2_AddressTypeCode">address2_AddressTypeCode</a>
...
<details>
<summary>List of traits for the address2_AddressTypeCode attribute are listed below.</summary>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Select the secondary address type.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Address 2: Address Type</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.nullable*  
  The attribute value may be set to NULL.  

*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"address2_addresstypecode"</td><td>string</td><td></td></tr></table>
...
<details>
<summary>List of traits for the address2_Name attribute are listed below.</summary>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Type a descriptive name for the secondary address, such as Corporate Headquarters.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Address 2: Name</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"address2_name"</td><td>string</td><td></td></tr></table>

*is.CDS.ordered*  
  the column number for an attribute with an entity in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>ordinal</td><td>"114"</td><td>integer</td><td></td></tr></table>
...
### <a href=#address2_PrimaryContactName name="address2_PrimaryContactName">address2_PrimaryContactName</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Address 2: Primary Contact Name</td></tr><tr><td>description</td><td>Type the name of the main contact at the account's secondary address.</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>100</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>address2_primarycontactname</td></tr></table>

#### Traits

<details>
<summary>List of traits for the address2_PrimaryContactName attribute are listed below.</summary>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Type the name of the main contact at the account's secondary address.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Address 2: Primary Contact Name</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"address2_primarycontactname"</td><td>string</td><td></td></tr></table>
...
### <a href=#address2_Line1 name="address2_Line1">address2_Line1</a>
...
<details>
<summary>List of traits for the address2_Line1 attribute are listed below.</summary>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Type the first line of the secondary address.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Address 2: Street 1</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"address2_line1"</td><td>string</td><td></td></tr></table>
...
### <a href=#address2_Line2 name="address2_Line2">address2_Line2</a>
...
<details>
<summary>List of traits for the address2_Line2 attribute are listed below.</summary>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Type the second line of the secondary address.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"address2_line2"</td><td>string</td><td></td></tr></table>
...
### <a href=#address2_Line3 name="address2_Line3">address2_Line3</a>
...
<details>
<summary>List of traits for the address2_Line3 attribute are listed below.</summary>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Type the third line of the secondary address.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"address2_line3"</td><td>string</td><td></td></tr></table>
...
### <a href=#address2_City name="address2_City">address2_City</a>
...
<details>
<summary>List of traits for the address2_City attribute are listed below.</summary>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Type the city for the secondary address.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Address 2: City</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"address2_city"</td><td>string</td><td></td></tr></table>
...
### <a href=#address2_StateOrProvince name="address2_StateOrProvince">address2_StateOrProvince</a>
...
<details>
<summary>List of traits for the address2_StateOrProvince attribute are listed below.</summary>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Type the state or province of the secondary address.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Address 2: State/Province</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"address2_stateorprovince"</td><td>string</td><td></td></tr></table>

*is.CDS.ordered*  
  the column number for an attribute with an entity in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>ordinal</td><td>"120"</td><td>integer</td><td></td></tr></table>
...
### <a href=#address2_County name="address2_County">address2_County</a>
...
<details>
<summary>List of traits for the address2_County attribute are listed below.</summary>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Type the county for the secondary address.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Address 2: County</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"address2_county"</td><td>string</td><td></td></tr></table>

*is.CDS.ordered*  
  the column number for an attribute with an entity in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>ordinal</td><td>"121"</td><td>integer</td><td></td></tr></table>
...
### <a href=#address2_Country name="address2_Country">address2_Country</a>
...
<details>
<summary>List of traits for the address2_Country attribute are listed below.</summary>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Type the country or region for the secondary address.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Address 2: Country/Region</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"address2_country"</td><td>string</td><td></td></tr></table>

*is.CDS.ordered*  
  the column number for an attribute with an entity in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>ordinal</td><td>"122"</td><td>integer</td><td></td></tr></table>
...
### <a href=#address2_PostOfficeBox name="address2_PostOfficeBox">address2_PostOfficeBox</a>
...
<details>
<summary>List of traits for the address2_PostOfficeBox attribute are listed below.</summary>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Type the post office box number of the secondary address.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Address 2: Post Office Box</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"address2_postofficebox"</td><td>string</td><td></td></tr></table>
...
### <a href=#address2_PostalCode name="address2_PostalCode">address2_PostalCode</a>
...
<details>
<summary>List of traits for the address2_PostalCode attribute are listed below.</summary>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Type the ZIP Code or postal code for the secondary address.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Address 2: ZIP/Postal Code</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"address2_postalcode"</td><td>string</td><td></td></tr></table>
...
### <a href=#address2_UTCOffset name="address2_UTCOffset">address2_UTCOffset</a>
...
<details>
<summary>List of traits for the address2_UTCOffset attribute are listed below.</summary>
...
*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Address 2: UTC Offset</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"address2_utcoffset"</td><td>string</td><td></td></tr></table>
...
### <a href=#address2_FreightTermsCode name="address2_FreightTermsCode">address2_FreightTermsCode</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Address 2: Freight Terms</td></tr><tr><td>description</td><td>Select the freight terms for the secondary address to make sure shipping orders are processed correctly.</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>address2_freighttermscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Default Value</td><td>1</td></tr></table></td></tr></table>

#### Traits

<details>
<summary>List of traits for the address2_FreightTermsCode attribute are listed below.</summary>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Select the freight terms for the secondary address to make sure shipping orders are processed correctly.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Address 2: Freight Terms</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.nullable*  
  The attribute value may be set to NULL.  

*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"address2_freighttermscode"</td><td>string</td><td></td></tr></table>
...
### <a href=#address2_UPSZone name="address2_UPSZone">address2_UPSZone</a>
...
<details>
<summary>List of traits for the address2_UPSZone attribute are listed below.</summary>
...
*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Address 2: UPS Zone</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"address2_upszone"</td><td>string</td><td></td></tr></table>
...
### <a href=#address2_Latitude name="address2_Latitude">address2_Latitude</a>
...
<details>
<summary>List of traits for the address2_Latitude attribute are listed below.</summary>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Type the latitude value for the secondary address for use in mapping and other applications.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Address 2: Latitude</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"address2_latitude"</td><td>string</td><td></td></tr></table>
...
### <a href=#address2_Telephone1 name="address2_Telephone1">address2_Telephone1</a>
...
<details>
<summary>List of traits for the address2_Telephone1 attribute are listed below.</summary>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Type the main phone number associated with the secondary address.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Address 2: Telephone 1</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"address2_telephone1"</td><td>string</td><td></td></tr></table>
...
### <a href=#address2_Longitude name="address2_Longitude">address2_Longitude</a>
...
<details>
<summary>List of traits for the address2_Longitude attribute are listed below.</summary>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Type the longitude value for the secondary address for use in mapping and other applications.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Address 2: Longitude</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"address2_longitude"</td><td>string</td><td></td></tr></table>
...
### <a href=#address2_ShippingMethodCode name="address2_ShippingMethodCode">address2_ShippingMethodCode</a>
...
<details>
<summary>List of traits for the address2_ShippingMethodCode attribute are listed below.</summary>
...
*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Address 2: Shipping Method</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.nullable*  
  The attribute value may be set to NULL.  

*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"address2_shippingmethodcode"</td><td>string</td><td></td></tr></table>
...
### <a href=#address2_Telephone2 name="address2_Telephone2">address2_Telephone2</a>
...
<details>
<summary>List of traits for the address2_Telephone2 attribute are listed below.</summary>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Type a second phone number associated with the secondary address.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Address 2: Telephone 2</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"address2_telephone2"</td><td>string</td><td></td></tr></table>
...
### <a href=#address2_Telephone3 name="address2_Telephone3">address2_Telephone3</a>
...
<details>
<summary>List of traits for the address2_Telephone3 attribute are listed below.</summary>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Type a third phone number associated with the secondary address.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Address 2: Telephone 3</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"address2_telephone3"</td><td>string</td><td></td></tr></table>
...
### <a href=#address2_Fax name="address2_Fax">address2_Fax</a>
...
<details>
<summary>List of traits for the address2_Fax attribute are listed below.</summary>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Type the fax number associated with the secondary address.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Address 2: Fax</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"address2_fax"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Master ID</td></tr><tr><td>description</td><td>Unique identifier of the master contact for merge.</td></tr><tr><td>dataFormat</td><td>guid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Company Name</td></tr><tr><td>description</td><td>Select the parent account or parent contact for the contact to provide a quick link to additional details, such as financial information, activities, and opportunities.</td></tr><tr><td>dataFormat</td><td>guid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Company Name</td></tr><tr><td>description</td><td>Select the parent account or parent contact for the contact to provide a quick link to additional details, such as financial information, activities, and opportunities.</td></tr><tr><td>dataFormat</td><td>string</td></tr></table>
...
*is.CDS.ordered*  
  the column number for an attribute with an entity in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>ordinal</td><td>"201"</td><td>integer</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Exchange Rate</td></tr><tr><td>description</td><td>Shows the conversion rate of the record's currency. The exchange rate is used to convert all money fields in the record from the local currency to the system's default currency.</td></tr><tr><td>dataFormat</td><td>decimal</td></tr><tr><td>maximumValue</td><td>100000000000</td></tr><tr><td>minimumValue</td><td>0.000000000001</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>exchangerate</td></tr></table>
...
*is.constrained*  
  maximum length or value constraints  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>minimumValue</td><td>"0.000000000001"</td><td>decimal</td><td></td></tr><tr><td>maximumValue</td><td>"100000000000"</td><td>decimal</td><td></td></tr></table>
...
*is.CDS.ordered*  
  the column number for an attribute with an entity in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>ordinal</td><td>"203"</td><td>integer</td><td></td></tr></table>
...
*is.CDS.ordered*  
  the column number for an attribute with an entity in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>ordinal</td><td>"205"</td><td>integer</td><td></td></tr></table>

*is.dataFormat.integer*  
  </details>

### <a href=#annualIncome_Base name="annualIncome_Base">annualIncome_Base</a>
...
### <a href=#aging60_Base name="aging60_Base">aging60_Base</a>
...
<details>
<summary>List of traits for the aging60_Base attribute are listed below.</summary>
...
### <a href=#aging90_Base name="aging90_Base">aging90_Base</a>
...
<details>
<summary>List of traits for the aging90_Base attribute are listed below.</summary>
...
### <a href=#aging30_Base name="aging30_Base">aging30_Base</a>
...
<details>
<summary>List of traits for the aging30_Base attribute are listed below.</summary>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>(Deprecated) Process Stage</td></tr><tr><td>description</td><td>Shows the ID of the stage.</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>stageid</td></tr></table>
...
*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>(Deprecated) Process Stage</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
### <a href=#address2_Composite name="address2_Composite">address2_Composite</a>
...
<details>
<summary>List of traits for the address2_Composite attribute are listed below.</summary>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Shows the complete secondary address.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Address 2</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"address2_composite"</td><td>string</td><td></td></tr></table>

*is.CDS.ordered*  
  the column number for an attribute with an entity in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>ordinal</td><td>"235"</td><td>integer</td><td></td></tr></table>
...
### <a href=#address1_Composite name="address1_Composite">address1_Composite</a>
...
<details>
<summary>List of traits for the address1_Composite attribute are listed below.</summary>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Shows the complete primary address.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Address 1</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"address1_composite"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>(Deprecated) Traversed Path</td></tr><tr><td>description</td><td>For internal use only.</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>1250</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>traversedpath</td></tr></table>
...
### <a href=#address3_Country name="address3_Country">address3_Country</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Address3: Country/Region</td></tr><tr><td>description</td><td>the country or region for the 3rd address.</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>80</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>address3_country</td></tr></table>

#### Traits

<details>
<summary>List of traits for the address3_Country attribute are listed below.</summary>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>the country or region for the 3rd address.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Address3: Country/Region</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"address3_country"</td><td>string</td><td></td></tr></table>

*is.CDS.ordered*  
  the column number for an attribute with an entity in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>ordinal</td><td>"259"</td><td>integer</td><td></td></tr></table>
...
### <a href=#address3_Line1 name="address3_Line1">address3_Line1</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Address3: Street 1</td></tr><tr><td>description</td><td>the first line of the 3rd address.</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>250</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>address3_line1</td></tr></table>

#### Traits

<details>
<summary>List of traits for the address3_Line1 attribute are listed below.</summary>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>the first line of the 3rd address.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Address3: Street 1</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"address3_line1"</td><td>string</td><td></td></tr></table>

*is.CDS.ordered*  
  the column number for an attribute with an entity in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>ordinal</td><td>"260"</td><td>integer</td><td></td></tr></table>
...
### <a href=#address3_Line2 name="address3_Line2">address3_Line2</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Address3: Street 2</td></tr><tr><td>description</td><td>the second line of the 3rd address.</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>250</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>address3_line2</td></tr></table>

#### Traits

<details>
<summary>List of traits for the address3_Line2 attribute are listed below.</summary>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>the second line of the 3rd address.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Address3: Street 2</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"address3_line2"</td><td>string</td><td></td></tr></table>

*is.CDS.ordered*  
  the column number for an attribute with an entity in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>ordinal</td><td>"261"</td><td>integer</td><td></td></tr></table>
...
### <a href=#address3_Line3 name="address3_Line3">address3_Line3</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Address3: Street 3</td></tr><tr><td>description</td><td>the third line of the 3rd address.</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>250</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>address3_line3</td></tr></table>

#### Traits

<details>
<summary>List of traits for the address3_Line3 attribute are listed below.</summary>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>the third line of the 3rd address.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Address3: Street 3</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"address3_line3"</td><td>string</td><td></td></tr></table>

*is.CDS.ordered*  
  the column number for an attribute with an entity in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>ordinal</td><td>"262"</td><td>integer</td><td></td></tr></table>
...
### <a href=#address3_PostalCode name="address3_PostalCode">address3_PostalCode</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Address3: ZIP/Postal Code</td></tr><tr><td>description</td><td>the ZIP Code or postal code for the 3rd address.</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>20</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>address3_postalcode</td></tr></table>

#### Traits

<details>
<summary>List of traits for the address3_PostalCode attribute are listed below.</summary>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>the ZIP Code or postal code for the 3rd address.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Address3: ZIP/Postal Code</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"address3_postalcode"</td><td>string</td><td></td></tr></table>

*is.CDS.ordered*  
  the column number for an attribute with an entity in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>ordinal</td><td>"263"</td><td>integer</td><td></td></tr></table>
...
### <a href=#address3_PostOfficeBox name="address3_PostOfficeBox">address3_PostOfficeBox</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Address 3: Post Office Box</td></tr><tr><td>description</td><td>the post office box number of the 3rd address.</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>20</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>address3_postofficebox</td></tr></table>

#### Traits

<details>
<summary>List of traits for the address3_PostOfficeBox attribute are listed below.</summary>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>the post office box number of the 3rd address.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Address 3: Post Office Box</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"address3_postofficebox"</td><td>string</td><td></td></tr></table>

*is.CDS.ordered*  
  the column number for an attribute with an entity in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>ordinal</td><td>"264"</td><td>integer</td><td></td></tr></table>
...
### <a href=#address3_StateOrProvince name="address3_StateOrProvince">address3_StateOrProvince</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Address3: State/Province</td></tr><tr><td>description</td><td>the state or province of the third address.</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>50</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>address3_stateorprovince</td></tr></table>

#### Traits

<details>
<summary>List of traits for the address3_StateOrProvince attribute are listed below.</summary>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>the state or province of the third address.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Address3: State/Province</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"address3_stateorprovince"</td><td>string</td><td></td></tr></table>

*is.CDS.ordered*  
  the column number for an attribute with an entity in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>ordinal</td><td>"265"</td><td>integer</td><td></td></tr></table>
...
### <a href=#address3_City name="address3_City">address3_City</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Address 3: City</td></tr><tr><td>description</td><td>Type the city for the 3rd address.</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>80</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>address3_city</td></tr></table>

#### Traits

<details>
<summary>List of traits for the address3_City attribute are listed below.</summary>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Type the city for the 3rd address.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Address 3: City</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"address3_city"</td><td>string</td><td></td></tr></table>

*is.CDS.ordered*  
  the column number for an attribute with an entity in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>ordinal</td><td>"266"</td><td>integer</td><td></td></tr></table>
...
### <a href=#address3_AddressId name="address3_AddressId">address3_AddressId</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Address 3: ID</td></tr><tr><td>description</td><td>Unique identifier for address 3.</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>address3_addressid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the address3_AddressId attribute are listed below.</summary>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Unique identifier for address 3.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Address 3: ID</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.nullable*  
  The attribute value may be set to NULL.  

*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"address3_addressid"</td><td>string</td><td></td></tr></table>

*is.CDS.ordered*  
  the column number for an attribute with an entity in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>ordinal</td><td>"280"</td><td>integer</td><td></td></tr></table>
...
### <a href=#address3_Composite name="address3_Composite">address3_Composite</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Address 3</td></tr><tr><td>description</td><td>Shows the complete third address.</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>1000</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>address3_composite</td></tr></table>

#### Traits

<details>
<summary>List of traits for the address3_Composite attribute are listed below.</summary>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Shows the complete third address.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Address 3</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"address3_composite"</td><td>string</td><td></td></tr></table>

*is.CDS.ordered*  
  the column number for an attribute with an entity in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>ordinal</td><td>"282"</td><td>integer</td><td></td></tr></table>
...
### <a href=#address3_Fax name="address3_Fax">address3_Fax</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Address 3: Fax</td></tr><tr><td>description</td><td>Type the fax number associated with the third address.</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>50</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>address3_fax</td></tr></table>

#### Traits

<details>
<summary>List of traits for the address3_Fax attribute are listed below.</summary>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Type the fax number associated with the third address.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Address 3: Fax</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"address3_fax"</td><td>string</td><td></td></tr></table>

*is.CDS.ordered*  
  the column number for an attribute with an entity in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>ordinal</td><td>"283"</td><td>integer</td><td></td></tr></table>
...
### <a href=#address3_FreightTermsCode name="address3_FreightTermsCode">address3_FreightTermsCode</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Address 3: Freight Terms</td></tr><tr><td>description</td><td>Select the freight terms for the third address to make sure shipping orders are processed correctly.</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>address3_freighttermscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Default Value</td><td>1</td></tr></table></td></tr></table>

#### Traits

<details>
<summary>List of traits for the address3_FreightTermsCode attribute are listed below.</summary>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Select the freight terms for the third address to make sure shipping orders are processed correctly.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Address 3: Freight Terms</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.nullable*  
  The attribute value may be set to NULL.  

*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"address3_freighttermscode"</td><td>string</td><td></td></tr></table>

*is.CDS.ordered*  
  the column number for an attribute with an entity in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>ordinal</td><td>"284"</td><td>integer</td><td></td></tr></table>

*is.dataFormat.integer*  
  </details>

### <a href=#address3_Latitude name="address3_Latitude">address3_Latitude</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Address 3: Latitude</td></tr><tr><td>description</td><td>Type the latitude value for the third address for use in mapping and other applications.</td></tr><tr><td>dataFormat</td><td>double</td></tr><tr><td>maximumValue</td><td>90</td></tr><tr><td>minimumValue</td><td>-90</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>address3_latitude</td></tr></table>

#### Traits

<details>
<summary>List of traits for the address3_Latitude attribute are listed below.</summary>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Type the latitude value for the third address for use in mapping and other applications.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Address 3: Latitude</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"address3_latitude"</td><td>string</td><td></td></tr></table>

*is.CDS.ordered*  
  the column number for an attribute with an entity in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>ordinal</td><td>"286"</td><td>integer</td><td></td></tr></table>
...
### <a href=#address3_Longitude name="address3_Longitude">address3_Longitude</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Address 3: Longitude</td></tr><tr><td>description</td><td>Type the longitude value for the third address for use in mapping and other applications.</td></tr><tr><td>dataFormat</td><td>double</td></tr><tr><td>maximumValue</td><td>180</td></tr><tr><td>minimumValue</td><td>-180</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>address3_longitude</td></tr></table>

#### Traits

<details>
<summary>List of traits for the address3_Longitude attribute are listed below.</summary>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Type the longitude value for the third address for use in mapping and other applications.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Address 3: Longitude</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"address3_longitude"</td><td>string</td><td></td></tr></table>

*is.CDS.ordered*  
  the column number for an attribute with an entity in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>ordinal</td><td>"287"</td><td>integer</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Address 3: Name</td></tr><tr><td>description</td><td>Type a descriptive name for the third address, such as Corporate Headquarters.</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>200</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>address3_name</td></tr></table>

#### Traits

<details>
<summary>List of traits for the address3_Name attribute are listed below.</summary>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Type a descriptive name for the third address, such as Corporate Headquarters.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Address 3: Name</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"address3_name"</td><td>string</td><td></td></tr></table>

*is.CDS.ordered*  
  the column number for an attribute with an entity in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>ordinal</td><td>"288"</td><td>integer</td><td></td></tr></table>
...
### <a href=#address3_PrimaryContactName name="address3_PrimaryContactName">address3_PrimaryContactName</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Address 3: Primary Contact Name</td></tr><tr><td>description</td><td>Type the name of the main contact at the account's third address.</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>100</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>address3_primarycontactname</td></tr></table>

#### Traits

<details>
<summary>List of traits for the address3_PrimaryContactName attribute are listed below.</summary>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Type the name of the main contact at the account's third address.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Address 3: Primary Contact Name</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"address3_primarycontactname"</td><td>string</td><td></td></tr></table>

*is.CDS.ordered*  
  the column number for an attribute with an entity in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>ordinal</td><td>"289"</td><td>integer</td><td></td></tr></table>
...
### <a href=#address3_ShippingMethodCode name="address3_ShippingMethodCode">address3_ShippingMethodCode</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Address 3: Shipping Method</td></tr><tr><td>description</td><td>Select a shipping method for deliveries sent to this address.</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>address3_shippingmethodcode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Default Value</td><td>1</td></tr></table></td></tr></table>

#### Traits

<details>
<summary>List of traits for the address3_ShippingMethodCode attribute are listed below.</summary>
...
*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Address 3: Shipping Method</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.nullable*  
  The attribute value may be set to NULL.  

*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"address3_shippingmethodcode"</td><td>string</td><td></td></tr></table>

*is.CDS.ordered*  
  the column number for an attribute with an entity in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>ordinal</td><td>"290"</td><td>integer</td><td></td></tr></table>

*is.dataFormat.integer*  
  </details>

### <a href=#address3_Telephone1 name="address3_Telephone1">address3_Telephone1</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Address 3: Telephone1</td></tr><tr><td>description</td><td>Type the main phone number associated with the third address.</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>50</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>address3_telephone1</td></tr></table>

#### Traits

<details>
<summary>List of traits for the address3_Telephone1 attribute are listed below.</summary>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Type the main phone number associated with the third address.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Address 3: Telephone1</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"address3_telephone1"</td><td>string</td><td></td></tr></table>
...
### <a href=#address3_Telephone2 name="address3_Telephone2">address3_Telephone2</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Address 3: Telephone2</td></tr><tr><td>description</td><td>Type a second phone number associated with the third address.</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>50</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>address3_telephone2</td></tr></table>

#### Traits

<details>
<summary>List of traits for the address3_Telephone2 attribute are listed below.</summary>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Type a second phone number associated with the third address.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Address 3: Telephone2</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"address3_telephone2"</td><td>string</td><td></td></tr></table>

*is.CDS.ordered*  
  the column number for an attribute with an entity in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>ordinal</td><td>"293"</td><td>integer</td><td></td></tr></table>
...
### <a href=#address3_Telephone3 name="address3_Telephone3">address3_Telephone3</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Address 3: Telephone3</td></tr><tr><td>description</td><td>Type a third phone number associated with the primary address.</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>50</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>address3_telephone3</td></tr></table>

#### Traits

<details>
<summary>List of traits for the address3_Telephone3 attribute are listed below.</summary>
...
*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Address 3: Telephone3</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"address3_telephone3"</td><td>string</td><td></td></tr></table>

*is.CDS.ordered*  
  the column number for an attribute with an entity in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>ordinal</td><td>"294"</td><td>integer</td><td></td></tr></table>
...
### <a href=#address3_UPSZone name="address3_UPSZone">address3_UPSZone</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Address 3: UPS Zone</td></tr><tr><td>description</td><td>Type the UPS zone of the third address to make sure shipping charges are calculated correctly and deliveries are made promptly, if shipped by UPS.</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>4</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>address3_upszone</td></tr></table>

#### Traits

<details>
<summary>List of traits for the address3_UPSZone attribute are listed below.</summary>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Type the UPS zone of the third address to make sure shipping charges are calculated correctly and deliveries are made promptly, if shipped by UPS.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Address 3: UPS Zone</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"address3_upszone"</td><td>string</td><td></td></tr></table>

*is.CDS.ordered*  
  the column number for an attribute with an entity in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>ordinal</td><td>"295"</td><td>integer</td><td></td></tr></table>
...
### <a href=#address3_UTCOffset name="address3_UTCOffset">address3_UTCOffset</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Address 3: UTC Offset</td></tr><tr><td>description</td><td>Select the time zone, or UTC offset, for this address so that other people can reference it when they contact someone at this address.</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>maximumValue</td><td>1500</td></tr><tr><td>minimumValue</td><td>-1500</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>address3_utcoffset</td></tr></table>

#### Traits

<details>
<summary>List of traits for the address3_UTCOffset attribute are listed below.</summary>
...
*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Address 3: UTC Offset</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"address3_utcoffset"</td><td>string</td><td></td></tr></table>

*is.CDS.ordered*  
  the column number for an attribute with an entity in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>ordinal</td><td>"296"</td><td>integer</td><td></td></tr></table>

*is.dataFormat.integer*  
  </details>

### <a href=#address3_County name="address3_County">address3_County</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Address 3: County</td></tr><tr><td>description</td><td>Type the county for the third address.</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>50</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>address3_county</td></tr></table>

#### Traits

<details>
<summary>List of traits for the address3_County attribute are listed below.</summary>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Type the county for the third address.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Address 3: County</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"address3_county"</td><td>string</td><td></td></tr></table>

*is.CDS.ordered*  
  the column number for an attribute with an entity in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>ordinal</td><td>"297"</td><td>integer</td><td></td></tr></table>
...
### <a href=#address3_AddressTypeCode name="address3_AddressTypeCode">address3_AddressTypeCode</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Address 3: Address Type</td></tr><tr><td>description</td><td>Select the third address type.</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>address3_addresstypecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Default Value</td><td>1</td></tr></table></td></tr></table>

#### Traits

<details>
<summary>List of traits for the address3_AddressTypeCode attribute are listed below.</summary>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Select the third address type.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Address 3: Address Type</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.nullable*  
  The attribute value may be set to NULL.  

*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"address3_addresstypecode"</td><td>string</td><td></td></tr></table>

*is.CDS.ordered*  
  the column number for an attribute with an entity in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>ordinal</td><td>"298"</td><td>integer</td><td></td></tr></table>
...
### <a href=#adx_CreatedByIPAddress name="adx_CreatedByIPAddress">adx_CreatedByIPAddress</a>
...
<details>
<summary>List of traits for the adx_CreatedByIPAddress attribute are listed below.</summary>
...
### <a href=#adx_CreatedByUsername name="adx_CreatedByUsername">adx_CreatedByUsername</a>
...
<details>
<summary>List of traits for the adx_CreatedByUsername attribute are listed below.</summary>
...
### <a href=#adx_ModifiedByIPAddress name="adx_ModifiedByIPAddress">adx_ModifiedByIPAddress</a>
...
<details>
<summary>List of traits for the adx_ModifiedByIPAddress attribute are listed below.</summary>
...
### <a href=#adx_ModifiedByUsername name="adx_ModifiedByUsername">adx_ModifiedByUsername</a>
...
<details>
<summary>List of traits for the adx_ModifiedByUsername attribute are listed below.</summary>
...
### <a href=#adx_OrganizationName name="adx_OrganizationName">adx_OrganizationName</a>
...
<details>
<summary>List of traits for the adx_OrganizationName attribute are listed below.</summary>
...
### <a href=#adx_TimeZone name="adx_TimeZone">adx_TimeZone</a>

First included in: Sustainability/SustainabilityShared/Contact (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Time Zone</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>maximumValue</td><td>1500</td></tr><tr><td>minimumValue</td><td>-1500</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>adx_timezone</td></tr></table>

#### Traits

<details>
<summary>List of traits for the adx_TimeZone attribute are listed below.</summary>
...
### <a href=#msa_managingpartnerid name="msa_managingpartnerid">msa_managingpartnerid</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Managing Partner</td></tr><tr><td>description</td><td>Unique identifier for Account associated with Contact.</td></tr><tr><td>dataFormat</td><td>guid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the msa_managingpartnerid attribute are listed below.</summary>
...
### <a href=#adx_ConfirmRemovePassword name="adx_ConfirmRemovePassword">adx_ConfirmRemovePassword</a>

First included in: Sustainability/SustainabilityShared/Contact (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Confirm Remove Password</td></tr><tr><td>dataFormat</td><td>boolean</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>adx_confirmremovepassword</td></tr></table>

#### Traits

<details>
<summary>List of traits for the adx_ConfirmRemovePassword attribute are listed below.</summary>
...
*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Confirm Remove Password</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.nullable*  
  The attribute value may be set to NULL.  

*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"adx_confirmremovepassword"</td><td>string</td><td></td></tr></table>
...
### <a href=#adx_identity_accessfailedcount name="adx_identity_accessfailedcount">adx_identity_accessfailedcount</a>
...
<details>
<summary>List of traits for the adx_identity_accessfailedcount attribute are listed below.</summary>
...
### <a href=#adx_identity_emailaddress1confirmed name="adx_identity_emailaddress1confirmed">adx_identity_emailaddress1confirmed</a>
...
<details>
<summary>List of traits for the adx_identity_emailaddress1confirmed attribute are listed below.</summary>
...
### <a href=#adx_identity_lastsuccessfullogin name="adx_identity_lastsuccessfullogin">adx_identity_lastsuccessfullogin</a>
...
<details>
<summary>List of traits for the adx_identity_lastsuccessfullogin attribute are listed below.</summary>
...
### <a href=#adx_identity_locallogindisabled name="adx_identity_locallogindisabled">adx_identity_locallogindisabled</a>
...
<details>
<summary>List of traits for the adx_identity_locallogindisabled attribute are listed below.</summary>
...
### <a href=#adx_identity_lockoutenabled name="adx_identity_lockoutenabled">adx_identity_lockoutenabled</a>
...
<details>
<summary>List of traits for the adx_identity_lockoutenabled attribute are listed below.</summary>
...
### <a href=#adx_identity_lockoutenddate name="adx_identity_lockoutenddate">adx_identity_lockoutenddate</a>
...
<details>
<summary>List of traits for the adx_identity_lockoutenddate attribute are listed below.</summary>
...
### <a href=#adx_identity_logonenabled name="adx_identity_logonenabled">adx_identity_logonenabled</a>
...
<details>
<summary>List of traits for the adx_identity_logonenabled attribute are listed below.</summary>
...
### <a href=#adx_identity_mobilephoneconfirmed name="adx_identity_mobilephoneconfirmed">adx_identity_mobilephoneconfirmed</a>
...
<details>
<summary>List of traits for the adx_identity_mobilephoneconfirmed attribute are listed below.</summary>
...
### <a href=#adx_identity_newpassword name="adx_identity_newpassword">adx_identity_newpassword</a>

First included in: Sustainability/SustainabilityShared/Contact (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>New Password Input</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>100</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>adx_identity_newpassword</td></tr></table>

#### Traits

<details>
<summary>List of traits for the adx_identity_newpassword attribute are listed below.</summary>
...
*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>New Password Input</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"adx_identity_newpassword"</td><td>string</td><td></td></tr></table>
...
### <a href=#adx_identity_passwordhash name="adx_identity_passwordhash">adx_identity_passwordhash</a>
...
<details>
<summary>List of traits for the adx_identity_passwordhash attribute are listed below.</summary>
...
### <a href=#adx_identity_securitystamp name="adx_identity_securitystamp">adx_identity_securitystamp</a>
...
<details>
<summary>List of traits for the adx_identity_securitystamp attribute are listed below.</summary>
...
### <a href=#adx_identity_twofactorenabled name="adx_identity_twofactorenabled">adx_identity_twofactorenabled</a>
...
<details>
<summary>List of traits for the adx_identity_twofactorenabled attribute are listed below.</summary>
...
### <a href=#adx_identity_username name="adx_identity_username">adx_identity_username</a>
...
<details>
<summary>List of traits for the adx_identity_username attribute are listed below.</summary>
...
### <a href=#adx_preferredlcid name="adx_preferredlcid">adx_preferredlcid</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Preferred LCID (Deprecated)</td></tr><tr><td>description</td><td>User’s preferred portal LCID</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>maximumValue</td><td>2147483647</td></tr><tr><td>minimumValue</td><td>-2147483648</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>adx_preferredlcid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the adx_preferredlcid attribute are listed below.</summary>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>User’s preferred portal LCID</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Preferred LCID (Deprecated)</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"adx_preferredlcid"</td><td>string</td><td></td></tr></table>
...
### <a href=#adx_profilealert name="adx_profilealert">adx_profilealert</a>
...
<details>
<summary>List of traits for the adx_profilealert attribute are listed below.</summary>
...
### <a href=#adx_profilealertdate name="adx_profilealertdate">adx_profilealertdate</a>
...
<details>
<summary>List of traits for the adx_profilealertdate attribute are listed below.</summary>
...
### <a href=#adx_profilealertinstructions name="adx_profilealertinstructions">adx_profilealertinstructions</a>
...
<details>
<summary>List of traits for the adx_profilealertinstructions attribute are listed below.</summary>
...
### <a href=#adx_ProfileIsAnonymous name="adx_ProfileIsAnonymous">adx_ProfileIsAnonymous</a>
...
<details>
<summary>List of traits for the adx_ProfileIsAnonymous attribute are listed below.</summary>
...
### <a href=#adx_ProfileLastActivity name="adx_ProfileLastActivity">adx_ProfileLastActivity</a>
...
<details>
<summary>List of traits for the adx_ProfileLastActivity attribute are listed below.</summary>
...
### <a href=#adx_profilemodifiedon name="adx_profilemodifiedon">adx_profilemodifiedon</a>
...
<details>
<summary>List of traits for the adx_profilemodifiedon attribute are listed below.</summary>
...
### <a href=#adx_PublicProfileCopy name="adx_PublicProfileCopy">adx_PublicProfileCopy</a>
...
<details>
<summary>List of traits for the adx_PublicProfileCopy attribute are listed below.</summary>
...
### <a href=#mspp_userpreferredlcid name="mspp_userpreferredlcid">mspp_userpreferredlcid</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Preferred Language</td></tr><tr><td>description</td><td>User’s preferred portal language</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>mspp_userpreferredlcid</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Arabic</td><td>1025</td></tr><tr><td>en</td><td>Basque - Basque</td><td>1069</td></tr><tr><td>en</td><td>Bulgarian - Bulgaria</td><td>1026</td></tr><tr><td>en</td><td>Catalan - Catalan</td><td>1027</td></tr><tr><td>en</td><td>Chinese - China</td><td>2052</td></tr><tr><td>en</td><td>Chinese - Hong Kong SAR</td><td>3076</td></tr><tr><td>en</td><td>Chinese - Traditional</td><td>1028</td></tr><tr><td>en</td><td>Croatian - Croatia</td><td>1050</td></tr><tr><td>en</td><td>Czech - Czech Republic</td><td>1029</td></tr><tr><td>en</td><td>Danish - Denmark</td><td>1030</td></tr><tr><td>en</td><td>Dutch - Netherlands</td><td>1043</td></tr><tr><td>en</td><td>English</td><td>1033</td></tr><tr><td>en</td><td>Estonian - Estonia</td><td>1061</td></tr><tr><td>en</td><td>Finnish - Finland</td><td>1035</td></tr><tr><td>en</td><td>French - France</td><td>1036</td></tr><tr><td>en</td><td>Galician - Spain</td><td>1110</td></tr><tr><td>en</td><td>German - Germany</td><td>1031</td></tr><tr><td>en</td><td>Greek - Greece</td><td>1032</td></tr><tr><td>en</td><td>Hebrew</td><td>1037</td></tr><tr><td>en</td><td>Hindi - India</td><td>1081</td></tr><tr><td>en</td><td>Hungarian - Hungary</td><td>1038</td></tr><tr><td>en</td><td>Indonesian - Indonesia</td><td>1057</td></tr><tr><td>en</td><td>Italian - Italy</td><td>1040</td></tr><tr><td>en</td><td>Japanese - Japan</td><td>1041</td></tr><tr><td>en</td><td>Kazakh - Kazakhstan</td><td>1087</td></tr><tr><td>en</td><td>Korean - Korea</td><td>1042</td></tr><tr><td>en</td><td>Latvian - Latvia</td><td>1062</td></tr><tr><td>en</td><td>Lithuanian - Lithuania</td><td>1063</td></tr><tr><td>en</td><td>Malay - Malaysia</td><td>1086</td></tr><tr><td>en</td><td>Norwegian (Bokmål) - Norway</td><td>1044</td></tr><tr><td>en</td><td>Polish - Poland</td><td>1045</td></tr><tr><td>en</td><td>Portuguese - Brazil</td><td>1046</td></tr><tr><td>en</td><td>Portuguese - Portugal</td><td>2070</td></tr><tr><td>en</td><td>Romanian - Romania</td><td>1048</td></tr><tr><td>en</td><td>Russian - Russia</td><td>1049</td></tr><tr><td>en</td><td>Serbian (Cyrillic) - Serbia</td><td>3098</td></tr><tr><td>en</td><td>Serbian (Latin) - Serbia</td><td>2074</td></tr><tr><td>en</td><td>Slovak - Slovakia</td><td>1051</td></tr><tr><td>en</td><td>Slovenian - Slovenia</td><td>1060</td></tr><tr><td>en</td><td>Spanish (Traditional Sort) - Spain</td><td>3082</td></tr><tr><td>en</td><td>Swedish - Sweden</td><td>1053</td></tr><tr><td>en</td><td>Thai - Thailand</td><td>1054</td></tr><tr><td>en</td><td>Turkish - Türkiye</td><td>1055</td></tr><tr><td>en</td><td>Ukrainian - Ukraine</td><td>1058</td></tr><tr><td>en</td><td>Vietnamese - Vietnam</td><td>1066</td></tr></table></td></tr></table>

#### Traits

<details>
<summary>List of traits for the mspp_userpreferredlcid attribute are listed below.</summary>
...
*is.dataFormat.numeric*  
  *does.haveDefault*  
  An attribute has a default value  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>default</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Arabic</td><td>1025</td></tr><tr><td>en</td><td>Basque - Basque</td><td>1069</td></tr><tr><td>en</td><td>Bulgarian - Bulgaria</td><td>1026</td></tr><tr><td>en</td><td>Catalan - Catalan</td><td>1027</td></tr><tr><td>en</td><td>Chinese - China</td><td>2052</td></tr><tr><td>en</td><td>Chinese - Hong Kong SAR</td><td>3076</td></tr><tr><td>en</td><td>Chinese - Traditional</td><td>1028</td></tr><tr><td>en</td><td>Croatian - Croatia</td><td>1050</td></tr><tr><td>en</td><td>Czech - Czech Republic</td><td>1029</td></tr><tr><td>en</td><td>Danish - Denmark</td><td>1030</td></tr><tr><td>en</td><td>Dutch - Netherlands</td><td>1043</td></tr><tr><td>en</td><td>English</td><td>1033</td></tr><tr><td>en</td><td>Estonian - Estonia</td><td>1061</td></tr><tr><td>en</td><td>Finnish - Finland</td><td>1035</td></tr><tr><td>en</td><td>French - France</td><td>1036</td></tr><tr><td>en</td><td>Galician - Spain</td><td>1110</td></tr><tr><td>en</td><td>German - Germany</td><td>1031</td></tr><tr><td>en</td><td>Greek - Greece</td><td>1032</td></tr><tr><td>en</td><td>Hebrew</td><td>1037</td></tr><tr><td>en</td><td>Hindi - India</td><td>1081</td></tr><tr><td>en</td><td>Hungarian - Hungary</td><td>1038</td></tr><tr><td>en</td><td>Indonesian - Indonesia</td><td>1057</td></tr><tr><td>en</td><td>Italian - Italy</td><td>1040</td></tr><tr><td>en</td><td>Japanese - Japan</td><td>1041</td></tr><tr><td>en</td><td>Kazakh - Kazakhstan</td><td>1087</td></tr><tr><td>en</td><td>Korean - Korea</td><td>1042</td></tr><tr><td>en</td><td>Latvian - Latvia</td><td>1062</td></tr><tr><td>en</td><td>Lithuanian - Lithuania</td><td>1063</td></tr><tr><td>en</td><td>Malay - Malaysia</td><td>1086</td></tr><tr><td>en</td><td>Norwegian (Bokmål) - Norway</td><td>1044</td></tr><tr><td>en</td><td>Polish - Poland</td><td>1045</td></tr><tr><td>en</td><td>Portuguese - Brazil</td><td>1046</td></tr><tr><td>en</td><td>Portuguese - Portugal</td><td>2070</td></tr><tr><td>en</td><td>Romanian - Romania</td><td>1048</td></tr><tr><td>en</td><td>Russian - Russia</td><td>1049</td></tr><tr><td>en</td><td>Serbian (Cyrillic) - Serbia</td><td>3098</td></tr><tr><td>en</td><td>Serbian (Latin) - Serbia</td><td>2074</td></tr><tr><td>en</td><td>Slovak - Slovakia</td><td>1051</td></tr><tr><td>en</td><td>Slovenian - Slovenia</td><td>1060</td></tr><tr><td>en</td><td>Spanish (Traditional Sort) - Spain</td><td>3082</td></tr><tr><td>en</td><td>Swedish - Sweden</td><td>1053</td></tr><tr><td>en</td><td>Thai - Thailand</td><td>1054</td></tr><tr><td>en</td><td>Turkish - Türkiye</td><td>1055</td></tr><tr><td>en</td><td>Ukrainian - Ukraine</td><td>1058</td></tr><tr><td>en</td><td>Vietnamese - Vietnam</td><td>1066</td></tr></table></td><td>any</td><td></td></tr></table>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"mspp_userpreferredlcid"</td><td>string</td><td></td></tr></table>
