...
Approach or method to quantify and report the environmental footprint of an organization's activities, encompassing greenhouse gas emissions and broader sustainability factors.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Sustainability\CloudforSustainabilitySharedDataModel/AccountingMethod.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specific identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[AccountingMethod/(resolvedAttributes)/accountingmethodId](#accountingmethodId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[AccountingMethod/(resolvedAttributes)/statecode](#statecode)</td><td>attribute</td><td></td></tr></table>

**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/Sustainability<br>/CloudforSustainabilitySharedDataModel<br>/AccountingMethod.cdm.json/AccountingMethod<br>/hasAttributes/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>
...
**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_accountingmethod"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[accountingmethodId](#accountingmethodId)|Unique identifier for entity instances|<a href="AccountingMethod.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/AccountingMethod</a>|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="AccountingMethod.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/AccountingMethod</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="AccountingMethod.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/AccountingMethod</a>|
|[statecode](#statecode)|Status of the Accounting method|<a href="AccountingMethod.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/AccountingMethod</a>|
|[statuscode](#statuscode)|Reason for the status of the Accounting method|<a href="AccountingMethod.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/AccountingMethod</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="AccountingMethod.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/AccountingMethod</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="AccountingMethod.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/AccountingMethod</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="AccountingMethod.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/AccountingMethod</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="AccountingMethod.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/AccountingMethod</a>|
|[name](#name)||<a href="AccountingMethod.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/AccountingMethod</a>|
|[overwriteTime](#overwriteTime)|For internal use only.|<a href="AccountingMethod.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/AccountingMethod</a>|
|[solutionId](#solutionId)|Unique identifier of the associated solution.|<a href="AccountingMethod.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/AccountingMethod</a>|
|[componentState](#componentState)|For internal use only.|<a href="AccountingMethod.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/AccountingMethod</a>|
|[componentIdUnique](#componentIdUnique)|For internal use only.|<a href="AccountingMethod.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/AccountingMethod</a>|
|[isManaged](#isManaged)|Indicates whether the solution component is part of a managed solution.|<a href="AccountingMethod.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/AccountingMethod</a>|
|[description](#description)|Description of the accounting method.|<a href="AccountingMethod.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/AccountingMethod</a>|
|[origincorrelationid](#origincorrelationid)|An optional identifier to correlate record with data origin.|<a href="AccountingMethod.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/AccountingMethod</a>|
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Accounting method</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>sourceName</td><td>msdyn_accountingmethodid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the accountingmethodId attribute are listed below.</summary>
...
*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_accountingmethodid"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Accounting method</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the Accounting method</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the Accounting method</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Description</td></tr><tr><td>description</td><td>Description of the accounting method.</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>100</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyn_description</td></tr></table>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Description of the accounting method.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
