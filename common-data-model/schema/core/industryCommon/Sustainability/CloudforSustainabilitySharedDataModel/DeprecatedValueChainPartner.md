...
Entity for value chain partner or supplier.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Sustainability\CloudforSustainabilitySharedDataModel/DeprecatedValueChainPartner.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specific identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[DeprecatedValueChainPartner/(resolvedAttributes)/valuechainpartnerId](#valuechainpartnerId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[DeprecatedValueChainPartner/(resolvedAttributes)/statecode](#statecode)</td><td>attribute</td><td></td></tr></table>

**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/Sustainability<br>/CloudforSustainabilitySharedDataModel<br>/DeprecatedValueChainPartner.cdm.json<br>/DeprecatedValueChainPartner/hasAttributes<br>/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>
...
|---|---|---|
|[valuechainpartnerId](#valuechainpartnerId)|Unique identifier for entity instances|<a href="DeprecatedValueChainPartner.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/DeprecatedValueChainPartner</a>|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="DeprecatedValueChainPartner.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/DeprecatedValueChainPartner</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="DeprecatedValueChainPartner.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/DeprecatedValueChainPartner</a>|
|[statecode](#statecode)|Status of the Value Chain Partner|<a href="DeprecatedValueChainPartner.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/DeprecatedValueChainPartner</a>|
|[statuscode](#statuscode)|Reason for the status of the Value Chain Partner|<a href="DeprecatedValueChainPartner.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/DeprecatedValueChainPartner</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="DeprecatedValueChainPartner.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/DeprecatedValueChainPartner</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="DeprecatedValueChainPartner.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/DeprecatedValueChainPartner</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="DeprecatedValueChainPartner.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/DeprecatedValueChainPartner</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="DeprecatedValueChainPartner.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/DeprecatedValueChainPartner</a>|
|[name](#name)|The name of the custom entity.|<a href="DeprecatedValueChainPartner.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/DeprecatedValueChainPartner</a>|
|[addresscity](#addresscity)|City associated with the value chain partner.|<a href="DeprecatedValueChainPartner.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/DeprecatedValueChainPartner</a>|
|[addresscountryisocode](#addresscountryisocode)|The three letter ISO code of the country/region.|<a href="DeprecatedValueChainPartner.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/DeprecatedValueChainPartner</a>|
|[countryregioncode](#countryregioncode)|Lookup field for Country/region.|<a href="DeprecatedValueChainPartner.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/DeprecatedValueChainPartner</a>|
|[addresscounty](#addresscounty)|County associated with the value chain partner address.|<a href="DeprecatedValueChainPartner.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/DeprecatedValueChainPartner</a>|
|[addressstateprovince](#addressstateprovince)|State/province associated with the value chain partner address.|<a href="DeprecatedValueChainPartner.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/DeprecatedValueChainPartner</a>|
|[addressstreet1](#addressstreet1)|Address line 1 of the street address.|<a href="DeprecatedValueChainPartner.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/DeprecatedValueChainPartner</a>|
|[addressstreet2](#addressstreet2)|Address line 2 of the street address.|<a href="DeprecatedValueChainPartner.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/DeprecatedValueChainPartner</a>|
|[addresszippostalcode](#addresszippostalcode)|Zip code or postal code associated with the address.|<a href="DeprecatedValueChainPartner.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/DeprecatedValueChainPartner</a>|
|[companyregistrationnumber](#companyregistrationnumber)|Unique identifier that is related to the value chain partner.|<a href="DeprecatedValueChainPartner.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/DeprecatedValueChainPartner</a>|
|[description](#description)|Optional description that provides additional detail about the entity or attribute.|<a href="DeprecatedValueChainPartner.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/DeprecatedValueChainPartner</a>|
|[origincorrelationid](#origincorrelationid)|An optional identifier to correlate record with data origin.|<a href="DeprecatedValueChainPartner.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/DeprecatedValueChainPartner</a>|

### <a href=#valuechainpartnerId name="valuechainpartnerId">valuechainpartnerId</a>

Unique identifier for entity instances  
First included in: Sustainability/SustainabilityShared/DeprecatedValueChainPartner (this entity)  
