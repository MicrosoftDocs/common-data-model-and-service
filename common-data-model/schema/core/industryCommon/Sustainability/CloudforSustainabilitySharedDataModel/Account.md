---
title: Account in Cloud for Sustainability shared data model
description: Business that represents a customer or potential customer in the shared data model. The company is billed in business transactions.
author: lsuresh
...
|[customerSizeCode](#customerSizeCode)|Select the size category or range of the account for segmentation and reporting purposes.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[preferredContactMethodCode](#preferredContactMethodCode)|Select the preferred method of contact.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[customerTypeCode](#customerTypeCode)|Select the category that best describes the relationship between the account and your organization.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[accountRatingCode](#accountRatingCode)|Select a rating to indicate the value of the customer account.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[industryCode](#industryCode)|Select the account's primary industry for use in marketing segmentation and demographic analysis.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[territoryCode](#territoryCode)|Select a region or territory for the account for use in segmentation and analysis.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[accountClassificationCode](#accountClassificationCode)|Select a classification code to indicate the potential value of the customer account based on the projected return on investment, cooperation level, sales cycle length or other criteria.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[businessTypeCode](#businessTypeCode)|Select the legal designation or other business type of the account for contracts or reporting purposes.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[traversedPath](#traversedPath)|For internal use only.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[paymentTermsCode](#paymentTermsCode)|Select the payment terms to indicate when the customer needs to pay the total amount.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[shippingMethodCode](#shippingMethodCode)|Select a shipping method for deliveries sent to the account's address to designate the preferred carrier or other delivery option.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[primaryContactId](#primaryContactId)|Choose the primary contact for the account to provide quick access to contact details.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[participatesInWorkflow](#participatesInWorkflow)|For system use only. Legacy Microsoft Dynamics CRM 3.0 workflow data.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[name](#name)|Type the company or business name.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[accountNumber](#accountNumber)|Type an ID number or code for the account to quickly search and identify the account in system views.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[revenue](#revenue)|Type the annual revenue for the account, used as an indicator in financial performance analysis.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[numberOfEmployees](#numberOfEmployees)|Type the number of employees that work at the account for use in marketing segmentation and demographic analysis.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[description](#description)|Type additional information to describe the account, such as an excerpt from the company's website.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[SIC](#SIC)|Type the Standard Industrial Classification (SIC) code that indicates the account's primary industry of business, for use in marketing segmentation and demographic analysis.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[ownershipCode](#ownershipCode)|Select the account's ownership structure, such as public or private.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[marketCap](#marketCap)|Type the market capitalization of the account to identify the company's equity, used as an indicator in financial performance analysis.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[sharesOutstanding](#sharesOutstanding)|Type the number of shares available to the public for the account. This number is used as an indicator in financial performance analysis.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[tickerSymbol](#tickerSymbol)|Type the stock exchange symbol for the account to track financial performance of the company. You can click the code entered in this field to access the latest trading information from MSN Money.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[stockExchange](#stockExchange)|Type the stock exchange at which the account is listed to track their stock and financial performance of the company.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[webSiteURL](#webSiteURL)|Type the account's website URL to get quick details about the company profile.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[ftpSiteURL](#ftpSiteURL)|Type the URL for the account's FTP site to enable users to access data and share documents.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[EMailAddress1](#EMailAddress1)|Type the primary email address for the account.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[EMailAddress2](#EMailAddress2)|Type the secondary email address for the account.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[EMailAddress3](#EMailAddress3)|Type an alternate email address for the account.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[doNotPhone](#doNotPhone)|Select whether the account allows phone calls. If Do Not Allow is selected, the account will be excluded from phone call activities distributed in marketing campaigns.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[doNotFax](#doNotFax)|Select whether the account allows faxes. If Do Not Allow is selected, the account will be excluded from fax activities distributed in marketing campaigns.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[telephone1](#telephone1)|Type the main phone number for this account.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[doNotEMail](#doNotEMail)|Select whether the account allows direct email sent from Microsoft Dynamics 365.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[telephone2](#telephone2)|Type a second phone number for this account.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[fax](#fax)|Type the fax number for the account.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[telephone3](#telephone3)|Type a third phone number for this account.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[doNotPostalMail](#doNotPostalMail)|Select whether the account allows direct mail. If Do Not Allow is selected, the account will be excluded from letter activities distributed in marketing campaigns.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[doNotBulkEMail](#doNotBulkEMail)|Select whether the account allows bulk email sent through campaigns. If Do Not Allow is selected, the account can be added to marketing lists, but is excluded from email.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
...
|[creditLimit](#creditLimit)|Type the credit limit of the account. This is a useful reference when you address invoice and accounting issues with the customer.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[creditOnHold](#creditOnHold)|Select whether the credit for the account is on hold. This is a useful reference while addressing the invoice and accounting issues with the customer.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[createdOn](#createdOn)|Shows the date and time when the record was created. The date and time are displayed in the time zone selected in Microsoft Dynamics 365 options.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[modifiedOn](#modifiedOn)|Shows the date and time when the record was last updated. The date and time are displayed in the time zone selected in Microsoft Dynamics 365 options.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[parentAccountId](#parentAccountId)|Choose the parent account associated with this account to show parent and child businesses in reporting and analytics.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[aging30](#aging30)|For system use only.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[stateCode](#stateCode)|Shows whether the account is active or inactive. Inactive accounts are read-only and can't be edited unless they are reactivated.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[aging60](#aging60)|For system use only.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[statusCode](#statusCode)|Select the account's status.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[aging90](#aging90)|For system use only.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[address1_AddressId](#address1_AddressId)|Unique identifier for address 1.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[address1_AddressTypeCode](#address1_AddressTypeCode)|Select the primary address type.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[address1_Name](#address1_Name)|Type a descriptive name for the primary address, such as Corporate Headquarters.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[address1_PrimaryContactName](#address1_PrimaryContactName)|Type the name of the main contact at the account's primary address.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[address1_Line1](#address1_Line1)|Type the first line of the primary address.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[address1_Line2](#address1_Line2)|Type the second line of the primary address.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[address1_Line3](#address1_Line3)|Type the third line of the primary address.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[address1_City](#address1_City)|Type the city for the primary address.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[address1_StateOrProvince](#address1_StateOrProvince)|Type the state or province of the primary address.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[address1_County](#address1_County)|Type the county for the primary address.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[address1_Country](#address1_Country)|Type the country or region for the primary address.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[address1_PostOfficeBox](#address1_PostOfficeBox)|Type the post office box number of the primary address.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[address1_PostalCode](#address1_PostalCode)|Type the ZIP Code or postal code for the primary address.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[address1_UTCOffset](#address1_UTCOffset)|Select the time zone, or UTC offset, for this address so that other people can reference it when they contact someone at this address.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[address1_FreightTermsCode](#address1_FreightTermsCode)|Select the freight terms for the primary address to make sure shipping orders are processed correctly.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[address1_UPSZone](#address1_UPSZone)|Type the UPS zone of the primary address to make sure shipping charges are calculated correctly and deliveries are made promptly, if shipped by UPS.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[address1_Latitude](#address1_Latitude)|Type the latitude value for the primary address for use in mapping and other applications.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[address1_Telephone1](#address1_Telephone1)|Type the main phone number associated with the primary address.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[address1_Longitude](#address1_Longitude)|Type the longitude value for the primary address for use in mapping and other applications.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[address1_ShippingMethodCode](#address1_ShippingMethodCode)|Select a shipping method for deliveries sent to this address.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[address1_Telephone2](#address1_Telephone2)|Type a second phone number associated with the primary address.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[address1_Telephone3](#address1_Telephone3)|Type a third phone number associated with the primary address.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[address1_Fax](#address1_Fax)|Type the fax number associated with the primary address.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[address2_AddressId](#address2_AddressId)|Unique identifier for address 2.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[address2_AddressTypeCode](#address2_AddressTypeCode)|Select the secondary address type.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[address2_Name](#address2_Name)|Type a descriptive name for the secondary address, such as Corporate Headquarters.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[address2_PrimaryContactName](#address2_PrimaryContactName)|Type the name of the main contact at the account's secondary address.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[address2_Line1](#address2_Line1)|Type the first line of the secondary address.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[address2_Line2](#address2_Line2)|Type the second line of the secondary address.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[address2_Line3](#address2_Line3)|Type the third line of the secondary address.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[address2_City](#address2_City)|Type the city for the secondary address.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[address2_StateOrProvince](#address2_StateOrProvince)|Type the state or province of the secondary address.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[address2_County](#address2_County)|Type the county for the secondary address.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[address2_Country](#address2_Country)|Type the country or region for the secondary address.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[address2_PostOfficeBox](#address2_PostOfficeBox)|Type the post office box number of the secondary address.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[address2_PostalCode](#address2_PostalCode)|Type the ZIP Code or postal code for the secondary address.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[address2_UTCOffset](#address2_UTCOffset)|Select the time zone, or UTC offset, for this address so that other people can reference it when they contact someone at this address.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[address2_FreightTermsCode](#address2_FreightTermsCode)|Select the freight terms for the secondary address to make sure shipping orders are processed correctly.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[address2_UPSZone](#address2_UPSZone)|Type the UPS zone of the secondary address to make sure shipping charges are calculated correctly and deliveries are made promptly, if shipped by UPS.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[address2_Latitude](#address2_Latitude)|Type the latitude value for the secondary address for use in mapping and other applications.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[address2_Telephone1](#address2_Telephone1)|Type the main phone number associated with the secondary address.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[address2_Longitude](#address2_Longitude)|Type the longitude value for the secondary address for use in mapping and other applications.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[address2_ShippingMethodCode](#address2_ShippingMethodCode)|Select a shipping method for deliveries sent to this address.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[address2_Telephone2](#address2_Telephone2)|Type a second phone number associated with the secondary address.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[address2_Telephone3](#address2_Telephone3)|Type a third phone number associated with the secondary address.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[address2_Fax](#address2_Fax)|Type the fax number associated with the secondary address.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[preferredAppointmentDayCode](#preferredAppointmentDayCode)|Select the preferred day of the week for service appointments.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[preferredAppointmentTimeCode](#preferredAppointmentTimeCode)|Select the preferred time of day for service appointments.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[merged](#merged)|Shows whether the account has been merged with another account.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[doNotSendMM](#doNotSendMM)|Select whether the account accepts marketing materials, such as brochures or catalogs.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[masterId](#masterId)|Shows the master account that the account was merged with.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[lastUsedInCampaign](#lastUsedInCampaign)|Shows the date when the account was last included in a marketing campaign or quick campaign.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[exchangeRate](#exchangeRate)|Shows the conversion rate of the record's currency. The exchange rate is used to convert all money fields in the record from the local currency to the system's default currency.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[creditLimit_Base](#creditLimit_Base)|Shows the credit limit converted to the system's default base currency for reporting purposes.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[aging30_Base](#aging30_Base)|The base currency equivalent of the aging 30 field.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[revenue_Base](#revenue_Base)|Shows the annual revenue converted to the system's default base currency. The calculations use the exchange rate specified in the Currencies area.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[aging90_Base](#aging90_Base)|The base currency equivalent of the aging 90 field.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[marketCap_Base](#marketCap_Base)|Shows the market capitalization converted to the system's default base currency.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[aging60_Base](#aging60_Base)|The base currency equivalent of the aging 60 field.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[yomiName](#yomiName)|Type the phonetic spelling of the company name, if specified in Japanese, to make sure the name is pronounced correctly in phone calls and other communications.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[stageId](#stageId)|Shows the ID of the stage.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[processId](#processId)|Shows the ID of the process.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[address2_Composite](#address2_Composite)|Shows the complete secondary address.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[address1_Composite](#address1_Composite)|Shows the complete primary address.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[entityImageId](#entityImageId)|For internal use only.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[timeSpentByMeOnEmailAndMeetings](#timeSpentByMeOnEmailAndMeetings)|Total time spent for emails (read and write) and meetings by me in relation to account record.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[createdByExternalParty](#createdByExternalParty)|Shows the external party who created the record.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[modifiedByExternalParty](#modifiedByExternalParty)|Shows the external party who modified the record.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[primarySatoriId](#primarySatoriId)|Primary Satori ID for Account|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[primaryTwitterId](#primaryTwitterId)|Primary Twitter ID for Account|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[SLAId](#SLAId)|Choose the service level agreement (SLA) that you want to apply to the Account record.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[SLAInvokedId](#SLAInvokedId)|Last SLA that was applied to this case. This field is for internal use only.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[onHoldTime](#onHoldTime)|Shows how long, in minutes, that the record was on hold.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[lastOnHoldTime](#lastOnHoldTime)|Contains the date and time stamp of the last on hold time.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[followEmail](#followEmail)|Information about whether to allow following email activity like opens, attachment views and link clicks for emails sent to the account.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[marketingOnly](#marketingOnly)|Whether is only for marketing|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[adx_CreatedByIPAddress](#adx_CreatedByIPAddress)||<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[adx_CreatedByUsername](#adx_CreatedByUsername)||<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[adx_ModifiedByIPAddress](#adx_ModifiedByIPAddress)||<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[adx_ModifiedByUsername](#adx_ModifiedByUsername)||<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
|[msa_managingpartnerid](#msa_managingpartnerid)|Unique identifier for Account associated with Account.|<a href="Account.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/Account</a>|
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Primary Contact</td></tr><tr><td>description</td><td>Choose the primary contact for the account to provide quick access to contact details.</td></tr><tr><td>dataFormat</td><td>guid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Annual Revenue</td></tr><tr><td>description</td><td>Type the annual revenue for the account, used as an indicator in financial performance analysis.</td></tr><tr><td>dataFormat</td><td>decimal</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>revenue</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Market Capitalization</td></tr><tr><td>description</td><td>Type the market capitalization of the account to identify the company's equity, used as an indicator in financial performance analysis.</td></tr><tr><td>dataFormat</td><td>decimal</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>marketcap</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Credit Limit</td></tr><tr><td>description</td><td>Type the credit limit of the account. This is a useful reference when you address invoice and accounting issues with the customer.</td></tr><tr><td>dataFormat</td><td>decimal</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>creditlimit</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Parent Account</td></tr><tr><td>description</td><td>Choose the parent account associated with this account to show parent and child businesses in reporting and analytics.</td></tr><tr><td>dataFormat</td><td>guid</td></tr></table>
...
*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Address Phone</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Address 2: Name</td></tr><tr><td>description</td><td>Type a descriptive name for the secondary address, such as Corporate Headquarters.</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>200</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>address2_name</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Master ID</td></tr><tr><td>description</td><td>Shows the master account that the account was merged with.</td></tr><tr><td>dataFormat</td><td>guid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Aging 30 (Base)</td></tr><tr><td>description</td><td>The base currency equivalent of the aging 30 field.</td></tr><tr><td>dataFormat</td><td>decimal</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>aging30_base</td></tr></table>
...
### <a href=#revenue_Base name="revenue_Base">revenue_Base</a>
...
<details>
<summary>List of traits for the revenue_Base attribute are listed below.</summary>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Aging 90 (Base)</td></tr><tr><td>description</td><td>The base currency equivalent of the aging 90 field.</td></tr><tr><td>dataFormat</td><td>decimal</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>aging90_base</td></tr></table>
...
### <a href=#marketCap_Base name="marketCap_Base">marketCap_Base</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Market Capitalization (Base)</td></tr><tr><td>description</td><td>Shows the market capitalization converted to the system's default base currency.</td></tr><tr><td>dataFormat</td><td>decimal</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>marketcap_base</td></tr></table>

#### Traits

<details>
<summary>List of traits for the marketCap_Base attribute are listed below.</summary>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Aging 60 (Base)</td></tr><tr><td>description</td><td>The base currency equivalent of the aging 60 field.</td></tr><tr><td>dataFormat</td><td>decimal</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>aging60_base</td></tr></table>
...
*is.CDS.ordered*  
  the column number for an attribute with an entity in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>ordinal</td><td>"213"</td><td>integer</td><td></td></tr></table>
...
*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Created By (User Name)</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Modified By (User Name)</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Managing Partner</td></tr><tr><td>description</td><td>Unique identifier for Account associated with Account.</td></tr><tr><td>dataFormat</td><td>guid</td></tr></table>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Unique identifier for Account associated with Account.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
