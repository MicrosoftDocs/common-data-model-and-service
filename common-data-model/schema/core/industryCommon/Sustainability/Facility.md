...
**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[Facility/(resolvedAttributes)/statecode](#statecode)</td><td>attribute</td><td></td></tr></table>

**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/Sustainability/Facility.cdm.json/Facility<br>/hasAttributes/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Base-level location to attribute activity data. May contain multiple buildings and organizational units.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="Facility.md" target="_blank">Sustainability/Facility</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="Facility.md" target="_blank">Sustainability/Facility</a>|
|[statecode](#statecode)|Status of the Facility|<a href="Facility.md" target="_blank">Sustainability/Facility</a>|
|[statuscode](#statuscode)|Reason for the status of the Facility|<a href="Facility.md" target="_blank">Sustainability/Facility</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="Facility.md" target="_blank">Sustainability/Facility</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="Facility.md" target="_blank">Sustainability/Facility</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="Facility.md" target="_blank">Sustainability/Facility</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="Facility.md" target="_blank">Sustainability/Facility</a>|
|[name](#name)|The name of the custom entity.|<a href="Facility.md" target="_blank">Sustainability/Facility</a>|
|[addresscity](#addresscity)|The city in which the facility resides.|<a href="Facility.md" target="_blank">Sustainability/Facility</a>|
|[addresscountryisocode](#addresscountryisocode)|The three letter ISO code of the country/region.|<a href="Facility.md" target="_blank">Sustainability/Facility</a>|
|[addresscounty](#addresscounty)|The county/region in which the facility resides.|<a href="Facility.md" target="_blank">Sustainability/Facility</a>|
|[addressstateprovince](#addressstateprovince)|The state or province in which the facility resides.|<a href="Facility.md" target="_blank">Sustainability/Facility</a>|
|[addressstreet1](#addressstreet1)|The street address including the number and street name of the facility.|<a href="Facility.md" target="_blank">Sustainability/Facility</a>|
|[addressstreet2](#addressstreet2)|Secondary street address information.|<a href="Facility.md" target="_blank">Sustainability/Facility</a>|
|[addresszippostalcode](#addresszippostalcode)|The zip or postal code in which the facility resides.|<a href="Facility.md" target="_blank">Sustainability/Facility</a>|
|[latitude](#latitude)|This information can make it easier to submit reports for public disclosure.|<a href="Facility.md" target="_blank">Sustainability/Facility</a>|
|[longitude](#longitude)|This information can make it easier to submit reports for public disclosure.|<a href="Facility.md" target="_blank">Sustainability/Facility</a>|
|[origincorrelationid](#origincorrelationid)|An optional identifier to correlate record with data origin.|<a href="Facility.md" target="_blank">Sustainability/Facility</a>|
...
**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_facilityid"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>City</td></tr><tr><td>description</td><td>The city in which the facility resides.</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>100</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyn_addresscity</td></tr></table>
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>The city in which the facility resides.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>County</td></tr><tr><td>description</td><td>The county/region in which the facility resides.</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>100</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyn_addresscounty</td></tr></table>
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>The county/region in which the facility resides.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>The state or province in which the facility resides.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>The zip or postal code in which the facility resides.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
