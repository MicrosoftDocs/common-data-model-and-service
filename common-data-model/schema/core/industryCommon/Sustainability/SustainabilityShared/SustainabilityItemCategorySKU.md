---
title: SustainabilityItemCategorySKU in Cloud for Sustainability shared data model
...
The category of the item such as abrasives, castings or accessories  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Sustainability\CloudforSustainabilitySharedDataModel/SustainabilityItemCategorySKU.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specific identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[SustainabilityItemCategorySKU/(resolvedAttributes)/sustainabilityitemcategoryskuId](#sustainabilityitemcategoryskuId)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Sustainability item category SKU</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_sustainabilityitemcategorysku"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[sustainabilityitemcategoryskuId](#sustainabilityitemcategoryskuId)|The unique identifier of the item category in the undertaking’s upstream systems.|<a href="SustainabilityItemCategorySKU.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/SustainabilityItemCategorySKU</a>|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="SustainabilityItemCategorySKU.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/SustainabilityItemCategorySKU</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="SustainabilityItemCategorySKU.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/SustainabilityItemCategorySKU</a>|
|[statecode](#statecode)|Status of the Sustainability item category SKU|<a href="SustainabilityItemCategorySKU.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/SustainabilityItemCategorySKU</a>|
|[statuscode](#statuscode)|Reason for the status of the Sustainability item category SKU|<a href="SustainabilityItemCategorySKU.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/SustainabilityItemCategorySKU</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="SustainabilityItemCategorySKU.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/SustainabilityItemCategorySKU</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="SustainabilityItemCategorySKU.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/SustainabilityItemCategorySKU</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="SustainabilityItemCategorySKU.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/SustainabilityItemCategorySKU</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="SustainabilityItemCategorySKU.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/SustainabilityItemCategorySKU</a>|
|[name](#name)|The name of the item category, such as abrasives, castings, instruments, or accessories.|<a href="SustainabilityItemCategorySKU.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/SustainabilityItemCategorySKU</a>|
|[description](#description)|Optional description that provides more details about the attribute.|<a href="SustainabilityItemCategorySKU.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/SustainabilityItemCategorySKU</a>|
|[origincorrelationid](#origincorrelationid)|Optional field to store origin correlation id|<a href="SustainabilityItemCategorySKU.md" target="_blank">Sustainability\CloudforSustainabilitySharedDataModel/SustainabilityItemCategorySKU</a>|
...
First included in: Sustainability/SustainabilityShared/SustainabilityItemCategorySKU (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Sustainability item category SKU id</td></tr><tr><td>description</td><td>The unique identifier of the item category in the undertaking’s upstream systems.</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>sourceName</td><td>msdyn_sustainabilityitemcategoryskuid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the sustainabilityitemcategoryskuId attribute are listed below.</summary>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>The unique identifier of the item category in the undertaking’s upstream systems.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Sustainability item category SKU id</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.CDS.sourceNamed*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_sustainabilityitemcategoryskuid"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Sustainability item category SKU</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the Sustainability item category SKU</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the Sustainability item category SKU</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Sustainability item category SKU name</td></tr><tr><td>description</td><td>The name of the item category, such as abrasives, castings, instruments, or accessories.</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>100</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyn_name</td></tr></table>
...
*is.localized.describedAs*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>The name of the item category, such as abrasives, castings, instruments, or accessories.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

*is.localized.displayedAs*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Sustainability item category SKU name</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
