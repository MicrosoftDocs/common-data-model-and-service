...
# Purchased energy in Cloud for Sustainability carbon data model (PurchasedEnergy)

Electric energy, measured in MWh, delivered by the utility to a customer in accordance with the signed agreement.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Sustainability\CloudforSustainabilityCarbonDataModel/PurchasedEnergy.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[purchasedenergyId](#purchasedenergyId)|Unique identifier for entity instances|<a href="PurchasedEnergy.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedEnergy</a>|
|[TTLInSeconds](#TTLInSeconds)|Time to live in seconds.|<a href="PurchasedEnergy.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedEnergy</a>|
|[partitionId](#partitionId)|Logical partition id. A logical partition consists of a set of records with same partition id.|<a href="PurchasedEnergy.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedEnergy</a>|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="PurchasedEnergy.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedEnergy</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="PurchasedEnergy.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedEnergy</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="PurchasedEnergy.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedEnergy</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="PurchasedEnergy.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedEnergy</a>|
|[name](#name)|The name of the custom entity.|<a href="PurchasedEnergy.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedEnergy</a>|
|[countryregioncode](#countryregioncode)|Lookup field for country/region.|<a href="PurchasedEnergy.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedEnergy</a>|
|[accountid](#accountid)|Comprehensive information about a supplier, customer, third-party manufacturer, or investee.|<a href="PurchasedEnergy.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedEnergy</a>|
|[consumptionenddate](#consumptionenddate)|End date of activity consumption.|<a href="PurchasedEnergy.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedEnergy</a>|
|[consumptionstartdate](#consumptionstartdate)|Start date of activity consumption.|<a href="PurchasedEnergy.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedEnergy</a>|
|[contractualinstrumenttypeid](#contractualinstrumenttypeid)|Unique identifier for the contractual instrument type associated with the purchased energy.|<a href="PurchasedEnergy.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedEnergy</a>|
|[cost](#cost)|Cost associated with activity data.|<a href="PurchasedEnergy.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedEnergy</a>|
|[costunit](#costunit)|Unit associated with the cost quantity.|<a href="PurchasedEnergy.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedEnergy</a>|
|[customdimension](#customdimension)|Field where Custom Dimension values are stored in JSON format.|<a href="PurchasedEnergy.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedEnergy</a>|
|[dataqualitytype](#dataqualitytype)|Description of the data quality which identifies if the data is actual, estimated, or other descriptors of the data.|<a href="PurchasedEnergy.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedEnergy</a>|
|[description](#description)|Optional description that provides additional detail about the entity or attribute.|<a href="PurchasedEnergy.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedEnergy</a>|
|[energyprovidername](#energyprovidername)|Name of the energy provider.|<a href="PurchasedEnergy.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedEnergy</a>|
|[energytype](#energytype)|Energy sub-category within Scope 2 emissions. |<a href="PurchasedEnergy.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedEnergy</a>|
|[evidence](#evidence)|Optional field where evidence can be linked to the entity or attribute, if required.|<a href="PurchasedEnergy.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedEnergy</a>|
|[facilityid](#facilityid)|Unique identifier for the facility associated with the purchased energy.|<a href="PurchasedEnergy.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedEnergy</a>|
|[facilityusagedetailid](#facilityusagedetailid)|The facility usage detail associated with this purchased energy|<a href="PurchasedEnergy.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedEnergy</a>|
|[isrenewable](#isrenewable)|Identifier used to determine if the source electric energy is renewable or not.|<a href="PurchasedEnergy.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedEnergy</a>|
|[leasedassetcategory](#leasedassetcategory)|Indicator of classification of category. An empty value means this activity is in scope 2.|<a href="PurchasedEnergy.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedEnergy</a>|
|[meternumber](#meternumber)|Field representing meter number for purchased energy entity.|<a href="PurchasedEnergy.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedEnergy</a>|
|[meterid](#meterid)|Field representing meter for purchased energy entity.|<a href="PurchasedEnergy.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedEnergy</a>|
|[lifespaninyears](#lifespaninyears)|The product lifespan refers to the duration of time (in years) a consumer can expect a product to remain useful and functional after purchase.|<a href="PurchasedEnergy.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedEnergy</a>|
|[organizationalunitid](#organizationalunitid)|Unique identifier for the organizational unit associated with the purchased energy.|<a href="PurchasedEnergy.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedEnergy</a>|
|[quantity](#quantity)|Generic quanity field associated with activity entities.|<a href="PurchasedEnergy.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedEnergy</a>|
|[origincorrelationid](#origincorrelationid)|An optional identifier to correlate record with data origin.|<a href="PurchasedEnergy.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedEnergy</a>|
|[transactiondate](#transactiondate)|Date associated with the actual date when the transaction occurred.|<a href="PurchasedEnergy.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedEnergy</a>|
|[quantityunit](#quantityunit)|Unit associated with the quantity field |<a href="PurchasedEnergy.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedEnergy</a>|
|[goodsquantity](#goodsquantity)|Quantity of goods in the corresponding activity data.|<a href="PurchasedEnergy.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedEnergy</a>|
|[goodsunit](#goodsunit)|Unit of measure for the goods quantity in record.|<a href="PurchasedEnergy.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedEnergy</a>|
|[spendtypeid](#spendtypeid)|Unique identifier for the spend type associated with the spend category. Generally, applies to scope 3 emissions.|<a href="PurchasedEnergy.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedEnergy</a>|
|[valuechainpartnerid](#valuechainpartnerid)|Reference to the value chain partner or supplier associated with the transaction. Generally applies to scope 3 emissions.|<a href="PurchasedEnergy.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedEnergy</a>|
|[product](#product)|A tangible or intangible item created through manufacturing, design, or development, intended for sale or use. (Deprecated)|<a href="PurchasedEnergy.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedEnergy</a>|
|[sustainabilityproductitem](#sustainabilityproductitem)|A tangible or intangible item created through manufacturing, design, or development, intended for sale or use.|<a href="PurchasedEnergy.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedEnergy</a>|
|[productfootprint](#productfootprint)|Product carbon footprint that this activity contributes to, such as first-party end product. (Deprecated)|<a href="PurchasedEnergy.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedEnergy</a>|
|[productidentifier](#productidentifier)|A unique alphanumeric code or number assigned to a specific product for the purpose of identification, tracking, and inventory management. (Deprecated)|<a href="PurchasedEnergy.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedEnergy</a>|
|[category](#category)|Indicator of classification of category.|<a href="PurchasedEnergy.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedEnergy</a>|
|[reportingdate](#reportingdate)|Date used to parameterize reports.|<a href="PurchasedEnergy.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedEnergy</a>|

### <a href=#purchasedenergyId name="purchasedenergyId">purchasedenergyId</a>

Unique identifier for entity instances  
First included in: Sustainability/SustainabilityCarbon/PurchasedEnergy (this entity)  
...
Field representing meter for purchased energy entity.  
First included in: Sustainability/SustainabilityCarbon/PurchasedEnergy (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Meter</td></tr><tr><td>description</td><td>Field representing meter for purchased energy entity.</td></tr><tr><td>dataFormat</td><td>guid</td></tr></table>
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Field representing meter for purchased energy entity.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
