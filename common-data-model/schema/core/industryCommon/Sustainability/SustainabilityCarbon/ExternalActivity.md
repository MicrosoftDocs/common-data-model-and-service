---
title: ExternalActivity in CloudforSustainabilityCarbonDataModel - Common Data Model | Microsoft Docs
...
# External activity in CloudforSustainabilityCarbonDataModel(ExternalActivity)

Table that holds activities from external sources  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Sustainability\CloudforSustainabilityCarbonDataModel/ExternalActivity.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[ExternalActivity/(resolvedAttributes)/externalactivityId](#externalactivityId)</td><td>attribute</td><td></td></tr></table>

**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/Sustainability<br>/CloudforSustainabilityCarbonDataModel<br>/ExternalActivity.cdm.json/ExternalActivity<br>/hasAttributes/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Table that holds activities from external sources</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>External activity</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_externalactivity"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[externalactivityId](#externalactivityId)|Unique identifier for entity instances|<a href="ExternalActivity.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalActivity</a>|
|[TTLInSeconds](#TTLInSeconds)|Time to live in seconds\.|<a href="ExternalActivity.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalActivity</a>|
|[partitionId](#partitionId)|Logical partition id\. A logical partition consists of a set of records with same partition id\.|<a href="ExternalActivity.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalActivity</a>|
|[createdOn](#createdOn)|Date and time when the record was created\.|<a href="ExternalActivity.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalActivity</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified\.|<a href="ExternalActivity.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalActivity</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record\.|<a href="ExternalActivity.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalActivity</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated\.|<a href="ExternalActivity.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalActivity</a>|
|[name](#name)||<a href="ExternalActivity.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalActivity</a>|
|[accountid](#accountid)|Comprehensive information about a supplier, customer, third\x2dparty manufacturer, or investee\.|<a href="ExternalActivity.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalActivity</a>|
|[businesstraveltypeid](#businesstraveltypeid)|Unique identifier related to the business travel type\. Used to identify emission factors\.|<a href="ExternalActivity.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalActivity</a>|
|[consumptionenddate](#consumptionenddate)|Comprehensive information about a supplier, customer, third\x2dparty manufacturer, or investee\.|<a href="ExternalActivity.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalActivity</a>|
|[consumptionstartdate](#consumptionstartdate)|Comprehensive information about a supplier, customer, third\x2dparty manufacturer, or investee\.|<a href="ExternalActivity.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalActivity</a>|
|[dataqualitytype](#dataqualitytype)|Description of the data quality which identifies if the data is actual, estimated, or other descriptors of the data\.|<a href="ExternalActivity.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalActivity</a>|
|[disposalmethodid](#disposalmethodid)|Method of waste disposal, such as compost or recycle\.|<a href="ExternalActivity.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalActivity</a>|
|[employeecommutingtypeid](#employeecommutingtypeid)|Unique identifier related to the employee commuting type\. Used to identify emission factors\.|<a href="ExternalActivity.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalActivity</a>|
|[fueltypeid](#fueltypeid)|Unique identifier for the fuel type associated with combustion or supply chain fuel usage\.|<a href="ExternalActivity.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalActivity</a>|
|[greenhousegas](#greenhousegas)|Unique identifier for the greenhouse gas associated with the fugitive emission\.|<a href="ExternalActivity.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalActivity</a>|
|[industrialprocesstypeid](#industrialprocesstypeid)|Unique identifier for the industrial process type associated with the industrial process|<a href="ExternalActivity.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalActivity</a>|
|[isrenewable](#isrenewable)|Identifier used to determine if the source electric energy is renewable or not\.|<a href="ExternalActivity.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalActivity</a>|
|[materialid](#materialid)|Material of waste, such as aluminum\.|<a href="ExternalActivity.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalActivity</a>|
|[organizationalunitid](#organizationalunitid)|Unique identifier for the organizational unit associated with the external activity\.|<a href="ExternalActivity.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalActivity</a>|
|[quantity](#quantity)|Generic quanity field associated with activity entities\.|<a href="ExternalActivity.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalActivity</a>|
|[quantityunit](#quantityunit)|Unit associated with the quantity field|<a href="ExternalActivity.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalActivity</a>|
|[spendtypeid](#spendtypeid)|Unique identifier for the spend type associated with the purchased good and service\.|<a href="ExternalActivity.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalActivity</a>|
|[transactiondate](#transactiondate)|Date associated with the actual date when the transaction occurred\.|<a href="ExternalActivity.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalActivity</a>|
|[transportationanddistributiontype](#transportationanddistributiontype)|Marks what type of transportation and distribution this record represents\.|<a href="ExternalActivity.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalActivity</a>|
|[transportmode](#transportmode)|The transport mode that corresponds to this transportation and distribution activity\.|<a href="ExternalActivity.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalActivity</a>|
|[vehicletype](#vehicletype)|Unique identifier for the vehicle type associated with combustion or supply chain transportation activities\.|<a href="ExternalActivity.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalActivity</a>|

### <a href=#externalactivityId name="externalactivityId">externalactivityId</a>

Unique identifier for entity instances  
First included in: Sustainability\\CloudforSustainabilityCarbonDataModel/ExternalActivity \(this entity\)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>External activity</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>sourceName</td><td>msdyn_externalactivityid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the externalactivityId attribute are listed below.</summary>
...
\*\*is\.CDS\.sourceNamed\*\*  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_externalactivityid"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Name</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>250</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyn_name</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Business travel type</td></tr><tr><td>description</td><td>Unique identifier related to the business travel type. Used to identify emission factors.</td></tr><tr><td>dataFormat</td><td>guid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the businesstraveltypeid attribute are listed below.</summary>
...
\*\*is\.localized\.describedAs\*\*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Unique identifier related to the business travel type. Used to identify emission factors.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

\*\*is\.localized\.displayedAs\*\*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Business travel type</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

\*\*is\.CDS\.lookup\*\*  
  The attribute represents a style of lookup in CDS for Applications  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>style</td><td>"single"</td><td>string</td><td></td></tr></table>

\*\*is\.linkedEntity\.identifier\*\*  
  Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th><th>relationshipName</th></tr><tr><td><a href="../../BusinessTravelType.md" target="_blank">BusinessTravelType.cdm.json/BusinessTravelType</a></td><td><a href="../../BusinessTravelType.md#businesstraveltypeId" target="_blank">businesstraveltypeId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Consumption end date</td></tr><tr><td>description</td><td>Comprehensive information about a supplier, customer, third-party manufacturer, or investee.</td></tr><tr><td>dataFormat</td><td>date</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyn_consumptionenddate</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Consumption start date</td></tr><tr><td>description</td><td>Comprehensive information about a supplier, customer, third-party manufacturer, or investee.</td></tr><tr><td>dataFormat</td><td>date</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyn_consumptionstartdate</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Employee commuting type</td></tr><tr><td>description</td><td>Unique identifier related to the employee commuting type. Used to identify emission factors.</td></tr><tr><td>dataFormat</td><td>guid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the employeecommutingtypeid attribute are listed below.</summary>
...
\*\*is\.localized\.describedAs\*\*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Unique identifier related to the employee commuting type. Used to identify emission factors.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

\*\*is\.localized\.displayedAs\*\*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Employee commuting type</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

\*\*is\.CDS\.lookup\*\*  
  The attribute represents a style of lookup in CDS for Applications  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>style</td><td>"single"</td><td>string</td><td></td></tr></table>

\*\*is\.linkedEntity\.identifier\*\*  
  Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th><th>relationshipName</th></tr><tr><td><a href="../../EmployeeCommutingType.md" target="_blank">EmployeeCommutingType.cdm.json/EmployeeCommutingType</a></td><td><a href="../../EmployeeCommutingType.md#employeecommutingtypeId" target="_blank">employeecommutingtypeId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
...
<details>
<summary>List of traits for the fueltypeid attribute are listed below.</summary>
...
\*\*is\.linkedEntity\.identifier\*\*  
  Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th><th>relationshipName</th></tr><tr><td><a href="../../FuelType.md" target="_blank">FuelType.cdm.json/FuelType</a></td><td><a href="../../FuelType.md#fueltypeId" target="_blank">fueltypeId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Industrial process type</td></tr><tr><td>description</td><td>Unique identifier for the industrial process type associated with the industrial process</td></tr><tr><td>dataFormat</td><td>guid</td></tr></table>
...
\*\*is\.localized\.describedAs\*\*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Unique identifier for the industrial process type associated with the industrial process</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Is renewable</td></tr><tr><td>description</td><td>Identifier used to determine if the source electric energy is renewable or not.</td></tr><tr><td>dataFormat</td><td>boolean</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyn_isrenewable</td></tr></table>

#### Traits

<details>
<summary>List of traits for the isrenewable attribute are listed below.</summary>
...
\*\*is\.localized\.describedAs\*\*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Identifier used to determine if the source electric energy is renewable or not.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

\*\*is\.localized\.displayedAs\*\*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Is renewable</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
\*\*is\.linkedEntity\.identifier\*\*  
  Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th><th>relationshipName</th></tr><tr><td><a href="../Sustainability/CloudforSustainabilitySharedDataModel/Material.md" target="_blank">/Sustainability/CloudforSustainabilitySharedDataModel/Material.cdm.json/Material</a></td><td><a href="../Sustainability/CloudforSustainabilitySharedDataModel/Material.md#materialId" target="_blank">materialId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Organizational unit</td></tr><tr><td>description</td><td>Unique identifier for the organizational unit associated with the external activity.</td></tr><tr><td>dataFormat</td><td>guid</td></tr></table>
...
\*\*is\.localized\.describedAs\*\*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Unique identifier for the organizational unit associated with the external activity.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Spend type</td></tr><tr><td>description</td><td>Unique identifier for the spend type associated with the purchased good and service.</td></tr><tr><td>dataFormat</td><td>guid</td></tr></table>
...
\*\*is\.localized\.describedAs\*\*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Unique identifier for the spend type associated with the purchased good and service.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Transportation and distribution type</td></tr><tr><td>description</td><td>Marks what type of transportation and distribution this record represents.</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyn_transportationanddistributiontype</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Downstream</td><td>700610001</td></tr><tr><td>en</td><td>Upstream</td><td>700610000</td></tr></table></td></tr></table>

#### Traits

<details>
<summary>List of traits for the transportationanddistributiontype attribute are listed below.</summary>
...
\*\*is\.dataFormat\.numeric\*\*  
  \*\*does\.haveDefault\*\*  
  An attribute has a default value  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>default</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Downstream</td><td>700610001</td></tr><tr><td>en</td><td>Upstream</td><td>700610000</td></tr></table></td><td>any</td><td></td></tr></table>
...
\*\*is\.localized\.describedAs\*\*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Marks what type of transportation and distribution this record represents.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

\*\*is\.localized\.displayedAs\*\*  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Transportation and distribution type</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Transport mode</td></tr><tr><td>description</td><td>The transport mode that corresponds to this transportation and distribution activity.</td></tr><tr><td>dataFormat</td><td>guid</td></tr></table>
...
\*\*is\.localized\.describedAs\*\*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>The transport mode that corresponds to this transportation and distribution activity.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
