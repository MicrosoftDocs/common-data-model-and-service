---
title: ExternalEmissions in Cloud for Sustainability carbon data model - Common Data Model | Microsoft Docs
...
# External Emissions in Cloud for Sustainability carbon data model

Emissions from external sources  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Sustainability\CloudforSustainabilityCarbonDataModel/ExternalEmissions.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[ExternalEmissions/(resolvedAttributes)/externalemissionId](#externalemissionId)</td><td>attribute</td><td></td></tr></table>

**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/Sustainability<br>/CloudforSustainabilityCarbonDataModel<br>/ExternalEmissions.cdm.json/ExternalEmissions<br>/hasAttributes/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>
...
|---|---|---|
|[externalemissionId](#externalemissionId)|Unique identifier for entity instances|<a href="ExternalEmissions.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalEmissions</a>|
|[TTLInSeconds](#TTLInSeconds)|Time to live in seconds.|<a href="ExternalEmissions.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalEmissions</a>|
|[partitionId](#partitionId)|Logical partition id. A logical partition consists of a set of records with same partition id.|<a href="ExternalEmissions.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalEmissions</a>|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="ExternalEmissions.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalEmissions</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="ExternalEmissions.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalEmissions</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="ExternalEmissions.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalEmissions</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="ExternalEmissions.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalEmissions</a>|
|[name](#name)|Name of external emission|<a href="ExternalEmissions.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalEmissions</a>|
|[account](#account)|Lookup to account.|<a href="ExternalEmissions.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalEmissions</a>|
|[source](#source)||<a href="ExternalEmissions.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalEmissions</a>|
|[activity](#activity)|Unique identifier of the activity linked to the emission.|<a href="ExternalEmissions.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalEmissions</a>|
|[activityentityname](#activityentityname)|Activity entity name|<a href="ExternalEmissions.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalEmissions</a>|
|[activityid](#activityid)|Activity ID|<a href="ExternalEmissions.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalEmissions</a>|
|[activityname](#activityname)|Category or reference data used for reporting purposes and populated during the calculation process.|<a href="ExternalEmissions.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalEmissions</a>|
|[actualquantity](#actualquantity)|Adjusted activity quantity used for emission calculation.|<a href="ExternalEmissions.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalEmissions</a>|
|[actualquantityunit](#actualquantityunit)|Adjusted activity quantity unit used for emission calculation.|<a href="ExternalEmissions.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalEmissions</a>|
|[calculationdate](#calculationdate)|Date calculation occurred|<a href="ExternalEmissions.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalEmissions</a>|
|[category](#category)|Scope 3 category number.|<a href="ExternalEmissions.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalEmissions</a>|
|[ch4](#ch4)|The amount of the CH₄ factor.|<a href="ExternalEmissions.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalEmissions</a>|
|[ch4unit](#ch4unit)|The unit for the CH₄ amount.|<a href="ExternalEmissions.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalEmissions</a>|
|[co2](#co2)|The amount of the CO₂ factor.|<a href="ExternalEmissions.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalEmissions</a>|
|[co2e](#co2e)|The amount of the CO₂ equivalent factor.|<a href="ExternalEmissions.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalEmissions</a>|
|[co2emt](#co2emt)|The amount of the CO₂ equivalent factor in metric tons.|<a href="ExternalEmissions.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalEmissions</a>|
|[co2eunit](#co2eunit)|Unique identifier for the unit associated with the emission.|<a href="ExternalEmissions.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalEmissions</a>|
|[co2unit](#co2unit)|The unit for the CO₂ factor.|<a href="ExternalEmissions.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalEmissions</a>|
|[consumptionenddate](#consumptionenddate)|End date of activity consumption.|<a href="ExternalEmissions.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalEmissions</a>|
|[consumptionstartdate](#consumptionstartdate)|Start date of activity consumption.|<a href="ExternalEmissions.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalEmissions</a>|
|[countryisocode](#countryisocode)|The three letter ISO code of the country/region.|<a href="ExternalEmissions.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalEmissions</a>|
|[customdimension](#customdimension)|Field where Custom Dimension values are stored in JSON format.|<a href="ExternalEmissions.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalEmissions</a>|
|[emissionfactor](#emissionfactor)|Emission factor through which external emission is calculated|<a href="ExternalEmissions.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalEmissions</a>|
|[emissionlookup](#emissionlookup)|Factor mapping used for emission calculations.|<a href="ExternalEmissions.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalEmissions</a>|
|[emissionsource](#emissionsource)|Emissions Source (Internal)|<a href="ExternalEmissions.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalEmissions</a>|
|[emissionsourcev2](#emissionsourcev2)|Emissions source reference.|<a href="ExternalEmissions.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalEmissions</a>|
|[facilityid](#facilityid)|Unique identifier for the facility associated with mobile combustion.|<a href="ExternalEmissions.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalEmissions</a>|
|[hfcs](#hfcs)|The amount of hydrofluorocarbons factor.|<a href="ExternalEmissions.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalEmissions</a>|
|[hfcsunit](#hfcsunit)|The unit for the hydrofluorocarbons factor.|<a href="ExternalEmissions.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalEmissions</a>|
|[isbiogenic](#isbiogenic)|Indicates if it is a biogenic emission, or emission from a natural source.|<a href="ExternalEmissions.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalEmissions</a>|
|[ismarketbased](#ismarketbased)|Indicates if emission calculation is market-based or considered a "net" calculation.|<a href="ExternalEmissions.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalEmissions</a>|
|[latitude](#latitude)|This information can make it easier to submit reports for public disclosure.|<a href="ExternalEmissions.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalEmissions</a>|
|[longitude](#longitude)|This information can make it easier to submit reports for public disclosure.|<a href="ExternalEmissions.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalEmissions</a>|
|[n2o](#n2o)|The amount of the N₂O factor.|<a href="ExternalEmissions.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalEmissions</a>|
|[n2ounit](#n2ounit)|Unique identifier for the unit associated with the emission.|<a href="ExternalEmissions.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalEmissions</a>|
|[nf3](#nf3)|The amount of nitrogen trifluoride factor.|<a href="ExternalEmissions.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalEmissions</a>|
|[nf3unit](#nf3unit)|The unit for the NF₃ factor.|<a href="ExternalEmissions.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalEmissions</a>|
|[organizationalunitid](#organizationalunitid)|Unique identifier for the organizational unit associated with the emission.|<a href="ExternalEmissions.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalEmissions</a>|
|[origincorrelationid](#origincorrelationid)|An optional identifier to correlate record with data origin.|<a href="ExternalEmissions.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalEmissions</a>|
|[otherghgs](#otherghgs)|Greenhouse gases associated with emissions that are not allocated in an individual category.|<a href="ExternalEmissions.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalEmissions</a>|
|[otherghgsunit](#otherghgsunit)|Unique identifier for the unit associated with the emission.|<a href="ExternalEmissions.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalEmissions</a>|
|[pfcs](#pfcs)|The amount of perfluorocarbons factor.|<a href="ExternalEmissions.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalEmissions</a>|
|[pfcsunit](#pfcsunit)|The unit for the perfluorocarbons factor.|<a href="ExternalEmissions.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalEmissions</a>|
|[product](#product)|A tangible or intangible item created through manufacturing, design, or development, intended for sale or use.|<a href="ExternalEmissions.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalEmissions</a>|
|[productfootprint](#productfootprint)|Product footprint|<a href="ExternalEmissions.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalEmissions</a>|
|[productidentifier](#productidentifier)|A unique alphanumeric code or number assigned to a specific product for the purpose of identification, tracking, and inventory management.|<a href="ExternalEmissions.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalEmissions</a>|
|[sf6](#sf6)|The amount of sulfur hexafluoride factor.|<a href="ExternalEmissions.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalEmissions</a>|
|[sf6unit](#sf6unit)|The unit for SF₆ factor.|<a href="ExternalEmissions.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalEmissions</a>|
|[transactiondate](#transactiondate)|Date associated with the actual date when the transaction occurred.|<a href="ExternalEmissions.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalEmissions</a>|
|[emissionoriginator](#emissionoriginator)|Identifies emission as customer, supplier or other origination|<a href="ExternalEmissions.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalEmissions</a>|
|[scope](#scope)|Emission scope as defined by the Greenhouse Gas Protocol.|<a href="ExternalEmissions.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/ExternalEmissions</a>|

### <a href=#externalemissionId name="externalemissionId">externalemissionId</a>

Unique identifier for entity instances  
First included in: Sustainability\\CloudforSustainabilityCarbonDataModel/ExternalEmissions (this entity)  
...
**is.linkedEntity.identifier**  
  Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th><th>relationshipName</th></tr><tr><td><a href="ExternalActivity.md" target="_blank">ExternalActivity.cdm.json/ExternalActivity</a></td><td><a href="ExternalActivity.md#externalactivityId" target="_blank">externalactivityId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
