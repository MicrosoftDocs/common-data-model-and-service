...
Entity for purchased goods and services.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Sustainability\CloudforSustainabilityCarbonDataModel/PurchasedGoodAndService.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specific identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[PurchasedGoodAndService/(resolvedAttributes)/purchasedgoodandserviceId](#purchasedgoodandserviceId)</td><td>attribute</td><td></td></tr></table>

**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/Sustainability<br>/CloudforSustainabilityCarbonDataModel<br>/PurchasedGoodAndService.cdm.json<br>/PurchasedGoodAndService/hasAttributes<br>/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Entity for purchased goods and services.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Purchased good and service</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_purchasedgoodandservice"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[purchasedgoodandserviceId](#purchasedgoodandserviceId)|Unique identifier for entity instances|<a href="PurchasedGoodAndService.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedGoodAndService</a>|
|[TTLInSeconds](#TTLInSeconds)|Time to live in seconds.|<a href="PurchasedGoodAndService.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedGoodAndService</a>|
|[partitionId](#partitionId)|Logical partition id. A logical partition consists of a set of records with same partition id.|<a href="PurchasedGoodAndService.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedGoodAndService</a>|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="PurchasedGoodAndService.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedGoodAndService</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="PurchasedGoodAndService.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedGoodAndService</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="PurchasedGoodAndService.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedGoodAndService</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="PurchasedGoodAndService.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedGoodAndService</a>|
|[name](#name)|The name of the purchased good and service.|<a href="PurchasedGoodAndService.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedGoodAndService</a>|
|[countryregioncode](#countryregioncode)|Lookup field for country/region.|<a href="PurchasedGoodAndService.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedGoodAndService</a>|
|[accountid](#accountid)||<a href="PurchasedGoodAndService.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedGoodAndService</a>|
|[consumptionenddate](#consumptionenddate)|End date of activity consumption.|<a href="PurchasedGoodAndService.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedGoodAndService</a>|
|[consumptionstartdate](#consumptionstartdate)|Start date of activity consumption.|<a href="PurchasedGoodAndService.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedGoodAndService</a>|
|[cost](#cost)|Cost associated with activity data.|<a href="PurchasedGoodAndService.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedGoodAndService</a>|
|[costunit](#costunit)|Unit associated with the cost quantity.|<a href="PurchasedGoodAndService.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedGoodAndService</a>|
|[customdimension](#customdimension)|Field where Custom Dimension values are stored in JSON format.|<a href="PurchasedGoodAndService.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedGoodAndService</a>|
|[dataqualitytype](#dataqualitytype)|Description of the data quality which identifies if the data is actual, estimated, or other descriptors of the data.|<a href="PurchasedGoodAndService.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedGoodAndService</a>|
|[description](#description)|Optional description that provides additional detail about the entity or attribute.|<a href="PurchasedGoodAndService.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedGoodAndService</a>|
|[evidence](#evidence)|Optional field where evidence can be linked to the entity or attribute, if required.|<a href="PurchasedGoodAndService.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedGoodAndService</a>|
|[facilityid](#facilityid)|Unique identifier used to associate the facility with the purchased good and service.|<a href="PurchasedGoodAndService.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedGoodAndService</a>|
|[goodsquantity](#goodsquantity)|Quantity of goods in the corresponding activity data.|<a href="PurchasedGoodAndService.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedGoodAndService</a>|
|[goodsunit](#goodsunit)|Unique identifier for the goods unit in the purchased good and service.|<a href="PurchasedGoodAndService.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedGoodAndService</a>|
|[industrialprocesstypeid](#industrialprocesstypeid)|Unique identifier for the industrial process type associated with the purchased good and service.|<a href="PurchasedGoodAndService.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedGoodAndService</a>|
|[organizationalunitid](#organizationalunitid)|Unique Identifier for Organizational Unit associated with Purchased Good and Service|<a href="PurchasedGoodAndService.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedGoodAndService</a>|
|[quantity](#quantity)|Generic quanity field associated with activity entities.|<a href="PurchasedGoodAndService.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedGoodAndService</a>|
|[quantityunit](#quantityunit)|Unique identifier for Unit associated with Purchased Goods and Services.|<a href="PurchasedGoodAndService.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedGoodAndService</a>|
|[reportingdate](#reportingdate)|Date used to parameterize reports.|<a href="PurchasedGoodAndService.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedGoodAndService</a>|
|[origincorrelationid](#origincorrelationid)|An optional identifier to correlate record with data origin.|<a href="PurchasedGoodAndService.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedGoodAndService</a>|
|[transactiondate](#transactiondate)|Date associated with the actual date when the transaction occurred.|<a href="PurchasedGoodAndService.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedGoodAndService</a>|
|[spendtypeid](#spendtypeid)|Unique identifier for the spend type associated with the purchased good and service.|<a href="PurchasedGoodAndService.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedGoodAndService</a>|
|[valuechainpartnerid](#valuechainpartnerid)|Reference to the value chain partner or supplier associated with the transaction.|<a href="PurchasedGoodAndService.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedGoodAndService</a>|
|[productfootprint](#productfootprint)|Product carbon footprint that this activity contributes to, such as first-party end product. (Deprecated)|<a href="PurchasedGoodAndService.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedGoodAndService</a>|
|[productfootprintreporting](#productfootprintreporting)|Product footprint that contains per-unit emissions data that can be used to compute emissions.|<a href="PurchasedGoodAndService.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedGoodAndService</a>|
|[sustainabilityproductitem](#sustainabilityproductitem)|A tangible or intangible item created through manufacturing, design, or development, intended for sale or use.|<a href="PurchasedGoodAndService.md" target="_blank">Sustainability/SustainabilityCarbon/PurchasedGoodAndService</a>|

### <a href=#purchasedgoodandserviceId name="purchasedgoodandserviceId">purchasedgoodandserviceId</a>

Unique identifier for entity instances  
First included in: Sustainability/SustainabilityCarbon/PurchasedGoodAndService (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Purchased Good and Service</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>sourceName</td><td>msdyn_purchasedgoodandserviceid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the purchasedgoodandserviceId attribute are listed below.</summary>
...
**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msdyn_purchasedgoodandserviceid"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Name</td></tr><tr><td>description</td><td>The name of the purchased good and service.</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>225</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msdyn_name</td></tr></table>
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>The name of the purchased good and service.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Facility</td></tr><tr><td>description</td><td>Unique identifier used to associate the facility with the purchased good and service.</td></tr><tr><td>dataFormat</td><td>guid</td></tr></table>
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Unique identifier used to associate the facility with the purchased good and service.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Goods quantity unit</td></tr><tr><td>description</td><td>Unique identifier for the goods unit in the purchased good and service.</td></tr><tr><td>dataFormat</td><td>guid</td></tr></table>
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Unique identifier for the goods unit in the purchased good and service.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Industrial process type</td></tr><tr><td>description</td><td>Unique identifier for the industrial process type associated with the purchased good and service.</td></tr><tr><td>dataFormat</td><td>guid</td></tr></table>
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Unique identifier for the industrial process type associated with the purchased good and service.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Organizational unit</td></tr><tr><td>description</td><td>Unique Identifier for Organizational Unit associated with Purchased Good and Service</td></tr><tr><td>dataFormat</td><td>guid</td></tr></table>
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Unique Identifier for Organizational Unit associated with Purchased Good and Service</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Quantity unit</td></tr><tr><td>description</td><td>Unique identifier for Unit associated with Purchased Goods and Services.</td></tr><tr><td>dataFormat</td><td>guid</td></tr></table>
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Unique identifier for Unit associated with Purchased Goods and Services.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
