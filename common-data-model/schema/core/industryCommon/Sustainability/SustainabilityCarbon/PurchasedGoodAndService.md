...
|---|---|---|
|[purchasedgoodandserviceId](#purchasedgoodandserviceId)|Unique identifier for entity instances|<a href="PurchasedGoodAndService.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/PurchasedGoodAndService</a>|
|[TTLInSeconds](#TTLInSeconds)|Time to live in seconds.|<a href="PurchasedGoodAndService.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/PurchasedGoodAndService</a>|
|[partitionId](#partitionId)|Logical partition id. A logical partition consists of a set of records with same partition id.|<a href="PurchasedGoodAndService.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/PurchasedGoodAndService</a>|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="PurchasedGoodAndService.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/PurchasedGoodAndService</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="PurchasedGoodAndService.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/PurchasedGoodAndService</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="PurchasedGoodAndService.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/PurchasedGoodAndService</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="PurchasedGoodAndService.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/PurchasedGoodAndService</a>|
|[name](#name)|The name of the purchased good and service.|<a href="PurchasedGoodAndService.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/PurchasedGoodAndService</a>|
|[countryregioncode](#countryregioncode)|Lookup field for Country/region.|<a href="PurchasedGoodAndService.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/PurchasedGoodAndService</a>|
|[accountid](#accountid)|Account|<a href="PurchasedGoodAndService.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/PurchasedGoodAndService</a>|
|[consumptionenddate](#consumptionenddate)|End date of activity consumption.|<a href="PurchasedGoodAndService.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/PurchasedGoodAndService</a>|
|[consumptionstartdate](#consumptionstartdate)|Start date of activity consumption.|<a href="PurchasedGoodAndService.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/PurchasedGoodAndService</a>|
|[cost](#cost)|Cost associated with activity data.|<a href="PurchasedGoodAndService.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/PurchasedGoodAndService</a>|
|[costunit](#costunit)|Unit associated with the cost quantity.|<a href="PurchasedGoodAndService.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/PurchasedGoodAndService</a>|
|[customdimension](#customdimension)|Field where Custom Dimension values are stored in JSON format.|<a href="PurchasedGoodAndService.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/PurchasedGoodAndService</a>|
|[dataqualitytype](#dataqualitytype)|Description of the data quality which identifies if the data is actual, estimated, or other descriptors of the data.|<a href="PurchasedGoodAndService.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/PurchasedGoodAndService</a>|
|[description](#description)|Optional description that provides additional detail about the entity or attribute.|<a href="PurchasedGoodAndService.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/PurchasedGoodAndService</a>|
|[evidence](#evidence)|Optional field where evidence can be linked to the entity or attribute, if required.|<a href="PurchasedGoodAndService.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/PurchasedGoodAndService</a>|
|[facilityid](#facilityid)|Unique identifier used to associate the facility with the purchased good and service.|<a href="PurchasedGoodAndService.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/PurchasedGoodAndService</a>|
|[goodsquantity](#goodsquantity)|Quantity of goods in the corresponding activity data.|<a href="PurchasedGoodAndService.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/PurchasedGoodAndService</a>|
|[goodsunit](#goodsunit)|Unique identifier for the goods unit in the purchased good and service.|<a href="PurchasedGoodAndService.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/PurchasedGoodAndService</a>|
|[industrialprocesstypeid](#industrialprocesstypeid)|Unique identifier for the industrial process type associated with the purchased good and service.|<a href="PurchasedGoodAndService.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/PurchasedGoodAndService</a>|
|[organizationalunitid](#organizationalunitid)|Unique Identifier for Organizational Unit associated with Purchased Good and Service|<a href="PurchasedGoodAndService.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/PurchasedGoodAndService</a>|
|[quantity](#quantity)|Generic quanity field associated with activity entities.|<a href="PurchasedGoodAndService.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/PurchasedGoodAndService</a>|
|[quantityunit](#quantityunit)|Unique identifier for Unit associated with Purchased Goods and Services.|<a href="PurchasedGoodAndService.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/PurchasedGoodAndService</a>|
|[reportingdate](#reportingdate)|Date used to parameterize reports.|<a href="PurchasedGoodAndService.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/PurchasedGoodAndService</a>|
|[origincorrelationid](#origincorrelationid)|An optional identifier to correlate record with data origin.|<a href="PurchasedGoodAndService.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/PurchasedGoodAndService</a>|
...
|[productbartprint](#productbartprint)|Product carbon bartprint that this activity contributes to, such as first-party end product. (Deprecated)|<a href="PurchasedGoodAndService.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/PurchasedGoodAndService</a>|
|[productbartprintreporting](#productbartprintreporting)|Product bartprint that contains per-unit emissions data that can be used to compute emissions.|<a href="PurchasedGoodAndService.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/PurchasedGoodAndService</a>|
