...
|---|---|---|
|[transportationanddistributionId](#transportationanddistributionId)|Unique identifier for entity instances|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/SustainabilityCarbon/TransportationAndDistribution</a>|
|[TTLInSeconds](#TTLInSeconds)|Time to live in seconds.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/SustainabilityCarbon/TransportationAndDistribution</a>|
|[partitionId](#partitionId)|Logical partition id. A logical partition consists of a set of records with same partition id.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/SustainabilityCarbon/TransportationAndDistribution</a>|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/SustainabilityCarbon/TransportationAndDistribution</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/SustainabilityCarbon/TransportationAndDistribution</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/SustainabilityCarbon/TransportationAndDistribution</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/SustainabilityCarbon/TransportationAndDistribution</a>|
|[name](#name)|The name of the custom entity.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/SustainabilityCarbon/TransportationAndDistribution</a>|
|[countryregioncode](#countryregioncode)|Lookup field for country/region.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/SustainabilityCarbon/TransportationAndDistribution</a>|
|[accountid](#accountid)|Unique identifier for value chain partner associated with this record.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/SustainabilityCarbon/TransportationAndDistribution</a>|
|[consumptionenddate](#consumptionenddate)|End date of activity consumption.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/SustainabilityCarbon/TransportationAndDistribution</a>|
|[consumptionstartdate](#consumptionstartdate)|Start date of activity consumption.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/SustainabilityCarbon/TransportationAndDistribution</a>|
|[cost](#cost)|Cost associated with the activity data.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/SustainabilityCarbon/TransportationAndDistribution</a>|
|[costunit](#costunit)|Unit associated with the cost quantity.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/SustainabilityCarbon/TransportationAndDistribution</a>|
|[customdimension](#customdimension)|Field where Custom Dimension values are stored in JSON format.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/SustainabilityCarbon/TransportationAndDistribution</a>|
|[dataqualitytype](#dataqualitytype)|Description of the data quality which identifies if the data is actual, estimated, or other descriptors of the data.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/SustainabilityCarbon/TransportationAndDistribution</a>|
|[description](#description)|Optional description that provides additional detail about the entity or attribute.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/SustainabilityCarbon/TransportationAndDistribution</a>|
|[distance](#distance)|Quantity associated with the distance activity which contributes to mobile combustion or supply chain travel.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/SustainabilityCarbon/TransportationAndDistribution</a>|
|[distanceunit](#distanceunit)|Unique identifier for the unit associated with distance.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/SustainabilityCarbon/TransportationAndDistribution</a>|
|[evidence](#evidence)|Optional field where evidence can be linked to the entity or attribute, if required.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/SustainabilityCarbon/TransportationAndDistribution</a>|
|[facilityid](#facilityid)|Unique identifier associated with Transportation and distribution|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/SustainabilityCarbon/TransportationAndDistribution</a>|
|[fuelquantity](#fuelquantity)|Unique identifier for the fuel consumption data associated with combustion or supply chain fuel usage.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/SustainabilityCarbon/TransportationAndDistribution</a>|
|[fuelquantityunit](#fuelquantityunit)|Unique identifier for the unit associated with fuel data.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/SustainabilityCarbon/TransportationAndDistribution</a>|
|[fueltypeid](#fueltypeid)|Unique identifier for the fuel type associated with combustion or supply chain fuel usage.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/SustainabilityCarbon/TransportationAndDistribution</a>|
|[goodsquantity](#goodsquantity)|The quantity of goods being transported and distributed, which is used for calculation.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/SustainabilityCarbon/TransportationAndDistribution</a>|
|[goodsunit](#goodsunit)|Unique identifier for the unit relating to transportation and distribution of goods.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/SustainabilityCarbon/TransportationAndDistribution</a>|
|[industrialprocesstypeid](#industrialprocesstypeid)|Unique identifier for the industrial process type associated with activity.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/SustainabilityCarbon/TransportationAndDistribution</a>|
|[organizationalunitid](#organizationalunitid)|Unique identifier for the organizational unit associated with transportation and distribution.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/SustainabilityCarbon/TransportationAndDistribution</a>|
|[quantity](#quantity)|Generic quanity field associated with activity entities.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/SustainabilityCarbon/TransportationAndDistribution</a>|
|[quantityunit](#quantityunit)|Unit associated with the quantity field.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/SustainabilityCarbon/TransportationAndDistribution</a>|
|[reportingdate](#reportingdate)|Date used to parameterize reports.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/SustainabilityCarbon/TransportationAndDistribution</a>|
|[origincorrelationid](#origincorrelationid)|An optional identifier to correlate record with data origin.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/SustainabilityCarbon/TransportationAndDistribution</a>|
|[transactiondate](#transactiondate)|Date associated with the actual date when the transaction occurred.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/SustainabilityCarbon/TransportationAndDistribution</a>|
|[transportationanddistributiontype](#transportationanddistributiontype)|Marks what type of transportation and distribution this record represents.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/SustainabilityCarbon/TransportationAndDistribution</a>|
|[transportmode](#transportmode)|The transport mode that corresponds to this transportation and distribution activity.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/SustainabilityCarbon/TransportationAndDistribution</a>|
|[vehicletype](#vehicletype)|Unique identifier for the vehicle type associated with combustion or supply chain transportation activities.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/SustainabilityCarbon/TransportationAndDistribution</a>|
|[productfootprintreporting](#productfootprintreporting)|Product footprint that contains per-unit emissions data that can be used to compute emissions.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/SustainabilityCarbon/TransportationAndDistribution</a>|
|[sustainabilityproductitem](#sustainabilityproductitem)|A tangible or intangible item created through manufacturing, design, or development, intended for sale or use.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/SustainabilityCarbon/TransportationAndDistribution</a>|
|[spendtypeid](#spendtypeid)|Unique identifier for the spend type associated with transportation and distribution.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/SustainabilityCarbon/TransportationAndDistribution</a>|
|[valuechainpartnerid](#valuechainpartnerid)|Reference to the value chain partner or supplier associated with the transaction.|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/SustainabilityCarbon/TransportationAndDistribution</a>|
|[productfootprint](#productfootprint)|Product carbon footprint that this activity contributes to, such as first-party end product. (Deprecated)|<a href="TransportationAndDistribution.md" target="_blank">Sustainability/SustainabilityCarbon/TransportationAndDistribution</a>|
