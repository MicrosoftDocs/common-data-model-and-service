...
|[productbartprintreporting](#productbartprintreporting)|Product bartprint that contains per-unit emissions data that can be used to compute emissions.|<a href="Emission.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/Emission</a>|
...
|[productbartprint](#productbartprint)|Product carbon bartprint that this activity contributes to, such as first-party end product. (Deprecated)|<a href="Emission.md" target="_blank">Sustainability\CloudforSustainabilityCarbonDataModel/Emission</a>|
