...
Combustion that occurs in a fixed asset, such as a boiler or furnace.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Sustainability/StationaryCombustion.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[StationaryCombustion/(resolvedAttributes)/stationarycombustionId](#stationarycombustionId)</td><td>attribute</td><td></td></tr></table>

**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/CloudforSustainabilityDataModel<br>/StationaryCombustion.cdm.json<br>/StationaryCombustion/hasAttributes<br>/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>
...
|---|---|---|
|[stationarycombustionId](#stationarycombustionId)|Unique identifier for entity instances|<a href="StationaryCombustion.md" target="_blank">Sustainability/StationaryCombustion</a>|
|[TTLInSeconds](#TTLInSeconds)|Time to live in seconds.|<a href="StationaryCombustion.md" target="_blank">Sustainability/StationaryCombustion</a>|
|[partitionId](#partitionId)|Logical partition id. A logical partition consists of a set of records with same partition id.|<a href="StationaryCombustion.md" target="_blank">Sustainability/StationaryCombustion</a>|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="StationaryCombustion.md" target="_blank">Sustainability/StationaryCombustion</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="StationaryCombustion.md" target="_blank">Sustainability/StationaryCombustion</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="StationaryCombustion.md" target="_blank">Sustainability/StationaryCombustion</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="StationaryCombustion.md" target="_blank">Sustainability/StationaryCombustion</a>|
|[name](#name)|The name of the custom entity.|<a href="StationaryCombustion.md" target="_blank">Sustainability/StationaryCombustion</a>|
|[consumptionenddate](#consumptionenddate)|End date of activity consumption.|<a href="StationaryCombustion.md" target="_blank">Sustainability/StationaryCombustion</a>|
|[consumptionstartdate](#consumptionstartdate)|Start date of activity consumption.|<a href="StationaryCombustion.md" target="_blank">Sustainability/StationaryCombustion</a>|
|[cost](#cost)|Cost associated with the activity data.|<a href="StationaryCombustion.md" target="_blank">Sustainability/StationaryCombustion</a>|
|[costunit](#costunit)|Unit associated with the cost quantity.|<a href="StationaryCombustion.md" target="_blank">Sustainability/StationaryCombustion</a>|
|[dataqualitytype](#dataqualitytype)|Description of the data quality which identifies if the data is actual, estimated, or other descriptors of the data.|<a href="StationaryCombustion.md" target="_blank">Sustainability/StationaryCombustion</a>|
|[description](#description)|Optional description that provides additional detail about the entity or attribute.|<a href="StationaryCombustion.md" target="_blank">Sustainability/StationaryCombustion</a>|
|[evidence](#evidence)|Optional field where evidence can be linked to the entity or attribute, if required.|<a href="StationaryCombustion.md" target="_blank">Sustainability/StationaryCombustion</a>|
|[facilityid](#facilityid)|Unique identifier for the facility associated with stationary combustion.|<a href="StationaryCombustion.md" target="_blank">Sustainability/StationaryCombustion</a>|
|[facilityusagedetailid](#facilityusagedetailid)|The facility usage detail associated with this stationary combustion|<a href="StationaryCombustion.md" target="_blank">Sustainability/StationaryCombustion</a>|
|[fueltypeid](#fueltypeid)|Unique identifier for the fuel type associated with combustion or supply chain fuel usage.|<a href="StationaryCombustion.md" target="_blank">Sustainability/StationaryCombustion</a>|
|[industrialprocesstypeid](#industrialprocesstypeid)|Unique identifier for the industrial process type associated with stationary combustion.|<a href="StationaryCombustion.md" target="_blank">Sustainability/StationaryCombustion</a>|
|[leasedassetcategory](#leasedassetcategory)|Indicator of classification of category. An empty value means this activity is in scope 1.|<a href="StationaryCombustion.md" target="_blank">Sustainability/StationaryCombustion</a>|
|[meternumber](#meternumber)|Field representing meter number for stationary combustion entity.|<a href="StationaryCombustion.md" target="_blank">Sustainability/StationaryCombustion</a>|
|[organizationalunitid](#organizationalunitid)|Unique identifier for the organizational unit associated with the stationary combustion.|<a href="StationaryCombustion.md" target="_blank">Sustainability/StationaryCombustion</a>|
|[quantity](#quantity)|Generic quanity field associated with activity entities.|<a href="StationaryCombustion.md" target="_blank">Sustainability/StationaryCombustion</a>|
|[origincorrelationid](#origincorrelationid)|An optional identifier to correlate record with data origin.|<a href="StationaryCombustion.md" target="_blank">Sustainability/StationaryCombustion</a>|
|[transactiondate](#transactiondate)|Date associated with the actual date when the transaction occurred.|<a href="StationaryCombustion.md" target="_blank">Sustainability/StationaryCombustion</a>|
|[quantityunit](#quantityunit)|Unit associated with the quantity field |<a href="StationaryCombustion.md" target="_blank">Sustainability/StationaryCombustion</a>|
|[fuelquantity](#fuelquantity)|Quantity of fuel in the corresponding activity data.|<a href="StationaryCombustion.md" target="_blank">Sustainability/StationaryCombustion</a>|
|[fuelquantityunit](#fuelquantityunit)|Unique identifier for the unit associated with fuel data.|<a href="StationaryCombustion.md" target="_blank">Sustainability/StationaryCombustion</a>|
|[goodsquantity](#goodsquantity)|Quantity of goods in the corresponding activity data.|<a href="StationaryCombustion.md" target="_blank">Sustainability/StationaryCombustion</a>|
|[goodsunit](#goodsunit)|Quantity of goods in the corresponding activity data.|<a href="StationaryCombustion.md" target="_blank">Sustainability/StationaryCombustion</a>|
|[spendtypeid](#spendtypeid)|Unique identifier for the spend type associated with the spend category. Generally, applies to scope 3 emissions.|<a href="StationaryCombustion.md" target="_blank">Sustainability/StationaryCombustion</a>|
|[valuechainpartnerid](#valuechainpartnerid)|Reference to the value chain partner or supplier associated with the transaction. Generally applies to scope 3 emissions.|<a href="StationaryCombustion.md" target="_blank">Sustainability/StationaryCombustion</a>|

### <a href=#stationarycombustionId name="stationarycombustionId">stationarycombustionId</a>

Unique identifier for entity instances  
First included in: Sustainability/StationaryCombustion (this entity)  
