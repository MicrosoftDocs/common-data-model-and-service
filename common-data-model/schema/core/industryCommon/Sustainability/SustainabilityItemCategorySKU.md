...
The category of the item such as abrasives, castings or accessories  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Sustainability/SustainabilityItemCategorySKU.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[sustainabilityitemcategoryskuId](#sustainabilityitemcategoryskuId)|The unique identifier of the item category in the undertaking’s upstream systems.|<a href="SustainabilityItemCategorySKU.md" target="_blank">Sustainability/SustainabilityItemCategorySKU</a>|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="SustainabilityItemCategorySKU.md" target="_blank">Sustainability/SustainabilityItemCategorySKU</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="SustainabilityItemCategorySKU.md" target="_blank">Sustainability/SustainabilityItemCategorySKU</a>|
|[statecode](#statecode)|Status of the Item category|<a href="SustainabilityItemCategorySKU.md" target="_blank">Sustainability/SustainabilityItemCategorySKU</a>|
|[statuscode](#statuscode)|Reason for the status of the Item category|<a href="SustainabilityItemCategorySKU.md" target="_blank">Sustainability/SustainabilityItemCategorySKU</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="SustainabilityItemCategorySKU.md" target="_blank">Sustainability/SustainabilityItemCategorySKU</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="SustainabilityItemCategorySKU.md" target="_blank">Sustainability/SustainabilityItemCategorySKU</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="SustainabilityItemCategorySKU.md" target="_blank">Sustainability/SustainabilityItemCategorySKU</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="SustainabilityItemCategorySKU.md" target="_blank">Sustainability/SustainabilityItemCategorySKU</a>|
|[name](#name)|The name of the item category, such as abrasives, castings, instruments, or accessories.|<a href="SustainabilityItemCategorySKU.md" target="_blank">Sustainability/SustainabilityItemCategorySKU</a>|
|[description](#description)|Optional description that provides more details about the attribute.|<a href="SustainabilityItemCategorySKU.md" target="_blank">Sustainability/SustainabilityItemCategorySKU</a>|
|[origincorrelationid](#origincorrelationid)|Optional field to store origin correlation id|<a href="SustainabilityItemCategorySKU.md" target="_blank">Sustainability/SustainabilityItemCategorySKU</a>|
...
**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Item category id</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
Status of the Item category  
First included in: Sustainability/SustainabilityItemCategorySKU (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Item category</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the Item category</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the Item category</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Item category name</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
