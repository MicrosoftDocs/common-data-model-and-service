...
# Appointment (EMR) Indication in AdministrationAppointmentEMR(AppointmentEMRIndication)
...
Reason the appointment has been scheduled to take place, as specified using information from another entity. The indication will typically be a Condition or a Procedure  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Administration/AdministrationAppointmentEMR/AppointmentEMRIndication.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/Healthcare/Administration<br>/AdministrationAppointmentEMR<br>/AppointmentEMRIndication.cdm.json<br>/AppointmentEMRIndication/hasAttributes<br>/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[AppointmentEMRIndication/(resolvedAttributes)/appointmentEMRIndicationId](#appointmentEMRIndicationId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[AppointmentEMRIndication/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Appointment (EMR) Indication</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason the appointment has been scheduled to take place, as specified using information from another entity. The indication will typically be a Condition or a Procedure</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_appointmentemrindication"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="AppointmentEMRIndication.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRIndication</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="AppointmentEMRIndication.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRIndication</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="AppointmentEMRIndication.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRIndication</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="AppointmentEMRIndication.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRIndication</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="AppointmentEMRIndication.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRIndication</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="AppointmentEMRIndication.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRIndication</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="AppointmentEMRIndication.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRIndication</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="AppointmentEMRIndication.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRIndication</a>|
|[ownerId](#ownerId)|Owner Id|<a href="AppointmentEMRIndication.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRIndication</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="AppointmentEMRIndication.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRIndication</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="AppointmentEMRIndication.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRIndication</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="AppointmentEMRIndication.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRIndication</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="AppointmentEMRIndication.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRIndication</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="AppointmentEMRIndication.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRIndication</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="AppointmentEMRIndication.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRIndication</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="AppointmentEMRIndication.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRIndication</a>|
|[appointmentEMRId](#appointmentEMRId)|A booking of a healthcare event among patient(s), practitioner(s), related person(s) and/or device(s) for a specific date/time. This may result in one or more Encounter(s)|<a href="AppointmentEMRIndication.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRIndication</a>|
|[appointmentEMRIndicationId](#appointmentEMRIndicationId)|Unique identifier for entity instances|<a href="AppointmentEMRIndication.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRIndication</a>|
|[conditionId](#conditionId)|Points to a unique condition record|<a href="AppointmentEMRIndication.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRIndication</a>|
|[name](#name)|The name of the custom entity.|<a href="AppointmentEMRIndication.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRIndication</a>|
|[procedureId](#procedureId)|Points to a unique procedure record|<a href="AppointmentEMRIndication.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRIndication</a>|
|[stateCode](#stateCode)|Status of the Appointment (EMR) Indication|<a href="AppointmentEMRIndication.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRIndication</a>|
|[stateCode_display](#stateCode_display)||<a href="AppointmentEMRIndication.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRIndication</a>|
|[statusCode](#statusCode)|Reason for the status of the Appointment (EMR) Indication|<a href="AppointmentEMRIndication.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRIndication</a>|
|[statusCode_display](#statusCode_display)||<a href="AppointmentEMRIndication.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRIndication</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: AdministrationAppointmentEMR/AppointmentEMRIndication (this entity)  
...
### <a href=#appointmentEMRIndicationId name="appointmentEMRIndicationId">appointmentEMRIndicationId</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Appointment (EMR) Indication</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>sourceName</td><td>msemr_appointmentemrindicationid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the appointmentEMRIndicationId attribute are listed below.</summary>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_appointmentemrindicationid"</td><td>string</td><td></td></tr></table>
...
Points to a unique condition record  
First included in: AdministrationAppointmentEMR/AppointmentEMRIndication (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Condition</td></tr><tr><td>description</td><td>Points to a unique condition record</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_condition</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Points to a unique condition record</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
Points to a unique procedure record  
First included in: AdministrationAppointmentEMR/AppointmentEMRIndication (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Procedure</td></tr><tr><td>description</td><td>Points to a unique procedure record</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_procedure</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Points to a unique procedure record</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
Status of the Appointment (EMR) Indication  
First included in: AdministrationAppointmentEMR/AppointmentEMRIndication (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Appointment (EMR) Indication</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the Appointment (EMR) Indication</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
Reason for the status of the Appointment (EMR) Indication  
First included in: AdministrationAppointmentEMR/AppointmentEMRIndication (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Appointment (EMR) Indication</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the Appointment (EMR) Indication</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
