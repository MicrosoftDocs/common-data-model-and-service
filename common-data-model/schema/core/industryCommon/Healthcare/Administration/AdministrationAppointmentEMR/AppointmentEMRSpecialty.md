---
title: AppointmentEMRSpecialty in AdministrationAppointmentEMR - Common Data Model | Microsoft Docs
...
# Appointment (EMR) Specialty in AdministrationAppointmentEMR(AppointmentEMRSpecialty)

The specialty of a practitioner that would be required to perform the service requested in this appointment.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Administration/AdministrationAppointmentEMR/AppointmentEMRSpecialty.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="AppointmentEMRSpecialty.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRSpecialty</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="AppointmentEMRSpecialty.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRSpecialty</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="AppointmentEMRSpecialty.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRSpecialty</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="AppointmentEMRSpecialty.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRSpecialty</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="AppointmentEMRSpecialty.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRSpecialty</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="AppointmentEMRSpecialty.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRSpecialty</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="AppointmentEMRSpecialty.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRSpecialty</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="AppointmentEMRSpecialty.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRSpecialty</a>|
|[ownerId](#ownerId)|Owner Id|<a href="AppointmentEMRSpecialty.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRSpecialty</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="AppointmentEMRSpecialty.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRSpecialty</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="AppointmentEMRSpecialty.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRSpecialty</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="AppointmentEMRSpecialty.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRSpecialty</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="AppointmentEMRSpecialty.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRSpecialty</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="AppointmentEMRSpecialty.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRSpecialty</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="AppointmentEMRSpecialty.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRSpecialty</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="AppointmentEMRSpecialty.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRSpecialty</a>|
|[appointmentEMRId](#appointmentEMRId)|A booking of a healthcare event among patient(s), practitioner(s), related person(s) and/or device(s) for a specific date/time. This may result in one or more Encounter(s).|<a href="AppointmentEMRSpecialty.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRSpecialty</a>|
|[appointmentEMRSpecialtyId](#appointmentEMRSpecialtyId)|Unique identifier for entity instances|<a href="AppointmentEMRSpecialty.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRSpecialty</a>|
|[name](#name)|The name of the custom entity.|<a href="AppointmentEMRSpecialty.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRSpecialty</a>|
|[specialtyCodeId](#specialtyCodeId)|The specialty of a practitioner that would be required to perform the service requested in this appointment|<a href="AppointmentEMRSpecialty.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRSpecialty</a>|
|[stateCode](#stateCode)|Status of the Appointment (EMR) Specialty|<a href="AppointmentEMRSpecialty.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRSpecialty</a>|
|[stateCode_display](#stateCode_display)||<a href="AppointmentEMRSpecialty.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRSpecialty</a>|
|[statusCode](#statusCode)|Reason for the status of the Appointment (EMR) Specialty|<a href="AppointmentEMRSpecialty.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRSpecialty</a>|
|[statusCode_display](#statusCode_display)||<a href="AppointmentEMRSpecialty.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRSpecialty</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: AdministrationAppointmentEMR/AppointmentEMRSpecialty (this entity)  
