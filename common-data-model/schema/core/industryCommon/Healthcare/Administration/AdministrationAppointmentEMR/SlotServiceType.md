...
# Slot Service Type in AdministrationAppointmentEMR
...
The type of appointments that can be booked into this slot. If provided then this overrides the value provided on the availability resource.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Administration/AdministrationAppointmentEMR/SlotServiceType.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/Healthcare/Administration<br>/AdministrationAppointmentEMR<br>/SlotServiceType.cdm.json/SlotServiceType<br>/hasAttributes/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[SlotServiceType/(resolvedAttributes)/slotServiceTypeId](#slotServiceTypeId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[SlotServiceType/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Slot Service Type</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>The type of appointments that can be booked into this slot. If provided then this overrides the value provided on the availability resource.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_slotservicetype"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="SlotServiceType.md" target="_blank">AdministrationAppointmentEMR/SlotServiceType</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="SlotServiceType.md" target="_blank">AdministrationAppointmentEMR/SlotServiceType</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="SlotServiceType.md" target="_blank">AdministrationAppointmentEMR/SlotServiceType</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="SlotServiceType.md" target="_blank">AdministrationAppointmentEMR/SlotServiceType</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="SlotServiceType.md" target="_blank">AdministrationAppointmentEMR/SlotServiceType</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="SlotServiceType.md" target="_blank">AdministrationAppointmentEMR/SlotServiceType</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="SlotServiceType.md" target="_blank">AdministrationAppointmentEMR/SlotServiceType</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="SlotServiceType.md" target="_blank">AdministrationAppointmentEMR/SlotServiceType</a>|
|[ownerId](#ownerId)|Owner Id|<a href="SlotServiceType.md" target="_blank">AdministrationAppointmentEMR/SlotServiceType</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="SlotServiceType.md" target="_blank">AdministrationAppointmentEMR/SlotServiceType</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="SlotServiceType.md" target="_blank">AdministrationAppointmentEMR/SlotServiceType</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="SlotServiceType.md" target="_blank">AdministrationAppointmentEMR/SlotServiceType</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="SlotServiceType.md" target="_blank">AdministrationAppointmentEMR/SlotServiceType</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="SlotServiceType.md" target="_blank">AdministrationAppointmentEMR/SlotServiceType</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="SlotServiceType.md" target="_blank">AdministrationAppointmentEMR/SlotServiceType</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="SlotServiceType.md" target="_blank">AdministrationAppointmentEMR/SlotServiceType</a>|
|[name](#name)|The name of the custom entity.|<a href="SlotServiceType.md" target="_blank">AdministrationAppointmentEMR/SlotServiceType</a>|
|[slotId](#slotId)|A slot of time on a schedule that may be available for booking appointments.|<a href="SlotServiceType.md" target="_blank">AdministrationAppointmentEMR/SlotServiceType</a>|
|[slotservicetypeId](#slotservicetypeId)||<a href="SlotServiceType.md" target="_blank">AdministrationAppointmentEMR/SlotServiceType</a>|
|[slotServiceTypeId](#slotServiceTypeId)|Unique identifier for entity instances|<a href="SlotServiceType.md" target="_blank">AdministrationAppointmentEMR/SlotServiceType</a>|
|[stateCode](#stateCode)|Status of the Slot Service Type|<a href="SlotServiceType.md" target="_blank">AdministrationAppointmentEMR/SlotServiceType</a>|
|[stateCode_display](#stateCode_display)||<a href="SlotServiceType.md" target="_blank">AdministrationAppointmentEMR/SlotServiceType</a>|
|[statusCode](#statusCode)|Reason for the status of the Slot Service Type|<a href="SlotServiceType.md" target="_blank">AdministrationAppointmentEMR/SlotServiceType</a>|
|[statusCode_display](#statusCode_display)||<a href="SlotServiceType.md" target="_blank">AdministrationAppointmentEMR/SlotServiceType</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: AdministrationAppointmentEMR/SlotServiceType (this entity)  
...
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="Slot.md" target="_blank">/Healthcare/Administration/AdministrationAppointmentEMR/Slot.cdm.json/Slot</a></td><td><a href="Slot.md#slotId" target="_blank">slotId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
...
### <a href=#slotservicetypeId name="slotservicetypeId">slotservicetypeId</a>

First included in: AdministrationAppointmentEMR/SlotServiceType (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Service Type</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_slotservicetype</td></tr></table>

#### Traits

<details>
<summary>List of traits for the slotservicetypeId attribute are listed below.</summary>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Slot Service Type</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>sourceName</td><td>msemr_slotservicetypeid</td></tr></table>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_slotservicetypeid"</td><td>string</td><td></td></tr></table>
...
Status of the Slot Service Type  
First included in: AdministrationAppointmentEMR/SlotServiceType (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Slot Service Type</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the Slot Service Type</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
Reason for the status of the Slot Service Type  
First included in: AdministrationAppointmentEMR/SlotServiceType (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Slot Service Type</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the Slot Service Type</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
