...
# Appointment (EMR) Reason in AdministrationAppointmentEMR(AppointmentEMRReason)

The reason that this appointment is being scheduled. This is more clinical than administrative.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Administration/AdministrationAppointmentEMR/AppointmentEMRReason.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="AppointmentEMRReason.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRReason</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="AppointmentEMRReason.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRReason</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="AppointmentEMRReason.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRReason</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="AppointmentEMRReason.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRReason</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="AppointmentEMRReason.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRReason</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="AppointmentEMRReason.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRReason</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="AppointmentEMRReason.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRReason</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="AppointmentEMRReason.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRReason</a>|
|[ownerId](#ownerId)|Owner Id|<a href="AppointmentEMRReason.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRReason</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="AppointmentEMRReason.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRReason</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="AppointmentEMRReason.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRReason</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="AppointmentEMRReason.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRReason</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="AppointmentEMRReason.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRReason</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="AppointmentEMRReason.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRReason</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="AppointmentEMRReason.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRReason</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="AppointmentEMRReason.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRReason</a>|
|[appointmentEMRId](#appointmentEMRId)|A booking of a healthcare event among patient(s), practitioner(s), related person(s) and/or device(s) for a specific date/time. This may result in one or more Encounter(s).|<a href="AppointmentEMRReason.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRReason</a>|
|[appointmentEMRReasonId](#appointmentEMRReasonId)|Unique identifier for entity instances|<a href="AppointmentEMRReason.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRReason</a>|
|[name](#name)|The name of the custom entity.|<a href="AppointmentEMRReason.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRReason</a>|
|[reasonCodeId](#reasonCodeId)|Reason this appointment is scheduled|<a href="AppointmentEMRReason.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRReason</a>|
|[stateCode](#stateCode)|Status of the Appointment (EMR) Reason|<a href="AppointmentEMRReason.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRReason</a>|
|[stateCode_display](#stateCode_display)||<a href="AppointmentEMRReason.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRReason</a>|
|[statusCode](#statusCode)|Reason for the status of the Appointment (EMR) Reason|<a href="AppointmentEMRReason.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRReason</a>|
|[statusCode_display](#statusCode_display)||<a href="AppointmentEMRReason.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRReason</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: AdministrationAppointmentEMR/AppointmentEMRReason (this entity)  
