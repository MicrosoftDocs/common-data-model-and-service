---
title: SlotSpecialty in AdministrationAppointmentEMR - Common Data Model | Microsoft Docs
...
# Slot Specialty in AdministrationAppointmentEMR

The specialty of a practitioner that would be required to perform the service requested in this appointment.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Administration/AdministrationAppointmentEMR/SlotSpecialty.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="SlotSpecialty.md" target="_blank">AdministrationAppointmentEMR/SlotSpecialty</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="SlotSpecialty.md" target="_blank">AdministrationAppointmentEMR/SlotSpecialty</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="SlotSpecialty.md" target="_blank">AdministrationAppointmentEMR/SlotSpecialty</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="SlotSpecialty.md" target="_blank">AdministrationAppointmentEMR/SlotSpecialty</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="SlotSpecialty.md" target="_blank">AdministrationAppointmentEMR/SlotSpecialty</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="SlotSpecialty.md" target="_blank">AdministrationAppointmentEMR/SlotSpecialty</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="SlotSpecialty.md" target="_blank">AdministrationAppointmentEMR/SlotSpecialty</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="SlotSpecialty.md" target="_blank">AdministrationAppointmentEMR/SlotSpecialty</a>|
|[ownerId](#ownerId)|Owner Id|<a href="SlotSpecialty.md" target="_blank">AdministrationAppointmentEMR/SlotSpecialty</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="SlotSpecialty.md" target="_blank">AdministrationAppointmentEMR/SlotSpecialty</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="SlotSpecialty.md" target="_blank">AdministrationAppointmentEMR/SlotSpecialty</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="SlotSpecialty.md" target="_blank">AdministrationAppointmentEMR/SlotSpecialty</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="SlotSpecialty.md" target="_blank">AdministrationAppointmentEMR/SlotSpecialty</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="SlotSpecialty.md" target="_blank">AdministrationAppointmentEMR/SlotSpecialty</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="SlotSpecialty.md" target="_blank">AdministrationAppointmentEMR/SlotSpecialty</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="SlotSpecialty.md" target="_blank">AdministrationAppointmentEMR/SlotSpecialty</a>|
|[name](#name)|The name of the custom entity.|<a href="SlotSpecialty.md" target="_blank">AdministrationAppointmentEMR/SlotSpecialty</a>|
|[slotId](#slotId)|A slot of time on a schedule that may be available for booking appointments.|<a href="SlotSpecialty.md" target="_blank">AdministrationAppointmentEMR/SlotSpecialty</a>|
|[slotSpecialtyId](#slotSpecialtyId)|Unique identifier for entity instances|<a href="SlotSpecialty.md" target="_blank">AdministrationAppointmentEMR/SlotSpecialty</a>|
|[specialtyId](#specialtyId)|The specialty of a practitioner that would be required to perform the service requested in this appointment.|<a href="SlotSpecialty.md" target="_blank">AdministrationAppointmentEMR/SlotSpecialty</a>|
|[stateCode](#stateCode)|Status of the Slot Specialty|<a href="SlotSpecialty.md" target="_blank">AdministrationAppointmentEMR/SlotSpecialty</a>|
|[stateCode_display](#stateCode_display)||<a href="SlotSpecialty.md" target="_blank">AdministrationAppointmentEMR/SlotSpecialty</a>|
|[statusCode](#statusCode)|Reason for the status of the Slot Specialty|<a href="SlotSpecialty.md" target="_blank">AdministrationAppointmentEMR/SlotSpecialty</a>|
|[statusCode_display](#statusCode_display)||<a href="SlotSpecialty.md" target="_blank">AdministrationAppointmentEMR/SlotSpecialty</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: AdministrationAppointmentEMR/SlotSpecialty (this entity)  
