...
# Appointment (EMR) Referral Request in AdministrationAppointmentEMR(AppointmentEMRReferralRequest)

The referral request this appointment is allocated to assess (incoming referral).  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Administration/AdministrationAppointmentEMR/AppointmentEMRReferralRequest.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="AppointmentEMRReferralRequest.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRReferralRequest</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="AppointmentEMRReferralRequest.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRReferralRequest</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="AppointmentEMRReferralRequest.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRReferralRequest</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="AppointmentEMRReferralRequest.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRReferralRequest</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="AppointmentEMRReferralRequest.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRReferralRequest</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="AppointmentEMRReferralRequest.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRReferralRequest</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="AppointmentEMRReferralRequest.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRReferralRequest</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="AppointmentEMRReferralRequest.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRReferralRequest</a>|
|[ownerId](#ownerId)|Owner Id|<a href="AppointmentEMRReferralRequest.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRReferralRequest</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="AppointmentEMRReferralRequest.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRReferralRequest</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="AppointmentEMRReferralRequest.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRReferralRequest</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="AppointmentEMRReferralRequest.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRReferralRequest</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="AppointmentEMRReferralRequest.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRReferralRequest</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="AppointmentEMRReferralRequest.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRReferralRequest</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="AppointmentEMRReferralRequest.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRReferralRequest</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="AppointmentEMRReferralRequest.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRReferralRequest</a>|
|[appointmentEMRId](#appointmentEMRId)|A booking of a healthcare event among patient(s), practitioner(s), related person(s) and/or device(s) for a specific date/time. This may result in one or more Encounter(s)|<a href="AppointmentEMRReferralRequest.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRReferralRequest</a>|
|[appointmentEMRReferralRequestId](#appointmentEMRReferralRequestId)|Unique identifier for entity instances|<a href="AppointmentEMRReferralRequest.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRReferralRequest</a>|
|[incomingreferralId](#incomingreferralId)|The ReferralRequest provided as information to allocate to the Encounter|<a href="AppointmentEMRReferralRequest.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRReferralRequest</a>|
|[name](#name)|The name of the custom entity.|<a href="AppointmentEMRReferralRequest.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRReferralRequest</a>|
|[stateCode](#stateCode)|Status of the Appointment EMR Referral Request|<a href="AppointmentEMRReferralRequest.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRReferralRequest</a>|
|[stateCode_display](#stateCode_display)||<a href="AppointmentEMRReferralRequest.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRReferralRequest</a>|
|[statusCode](#statusCode)|Reason for the status of the Appointment EMR Referral Request|<a href="AppointmentEMRReferralRequest.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRReferralRequest</a>|
|[statusCode_display](#statusCode_display)||<a href="AppointmentEMRReferralRequest.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRReferralRequest</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: AdministrationAppointmentEMR/AppointmentEMRReferralRequest (this entity)  
