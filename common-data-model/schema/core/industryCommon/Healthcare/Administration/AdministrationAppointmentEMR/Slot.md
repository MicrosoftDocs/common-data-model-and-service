---
title: Slot in AdministrationAppointmentEMR - Common Data Model | Microsoft Docs
...
# Slot in AdministrationAppointmentEMR

A slot of time on a schedule that may be available for booking appointments.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Administration/AdministrationAppointmentEMR/Slot.cdm.json" target="_blank">GitHub</a>.  
...
- [/SyncAgentCDMUpdates/Slot](../../AzureAPIforFHIRsupport/SyncAgentCDMUpdates/Slot.md "/Healthcare/AzureAPIforFHIRsupport/SyncAgentCDMUpdates/Slot.cdm.json/Slot")  
</details>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="Slot.md" target="_blank">AdministrationAppointmentEMR/Slot</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="Slot.md" target="_blank">AdministrationAppointmentEMR/Slot</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="Slot.md" target="_blank">AdministrationAppointmentEMR/Slot</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="Slot.md" target="_blank">AdministrationAppointmentEMR/Slot</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="Slot.md" target="_blank">AdministrationAppointmentEMR/Slot</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="Slot.md" target="_blank">AdministrationAppointmentEMR/Slot</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="Slot.md" target="_blank">AdministrationAppointmentEMR/Slot</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="Slot.md" target="_blank">AdministrationAppointmentEMR/Slot</a>|
|[ownerId](#ownerId)|Owner Id|<a href="Slot.md" target="_blank">AdministrationAppointmentEMR/Slot</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="Slot.md" target="_blank">AdministrationAppointmentEMR/Slot</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="Slot.md" target="_blank">AdministrationAppointmentEMR/Slot</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="Slot.md" target="_blank">AdministrationAppointmentEMR/Slot</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="Slot.md" target="_blank">AdministrationAppointmentEMR/Slot</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="Slot.md" target="_blank">AdministrationAppointmentEMR/Slot</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="Slot.md" target="_blank">AdministrationAppointmentEMR/Slot</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="Slot.md" target="_blank">AdministrationAppointmentEMR/Slot</a>|
|[appointmentemrId](#appointmentemrId)|A booking of a healthcare event among patient(s), practitioner(s), related person(s) and/or device(s) for a specific date/time. This may result in one or more Encounter(s)|<a href="Slot.md" target="_blank">AdministrationAppointmentEMR/Slot</a>|
|[appointmentTypeNew](#appointmentTypeNew)||<a href="Slot.md" target="_blank">AdministrationAppointmentEMR/Slot</a>|
|[appointmentTypeNew_display](#appointmentTypeNew_display)||<a href="Slot.md" target="_blank">AdministrationAppointmentEMR/Slot</a>|
|[comment](#comment)|Comments on the slot to describe any extended information. Such as custom constraints on the slot|<a href="Slot.md" target="_blank">AdministrationAppointmentEMR/Slot</a>|
|[end](#end)|Date/Time that the slot is to conclude|<a href="Slot.md" target="_blank">AdministrationAppointmentEMR/Slot</a>|
|[name](#name)|The name of the custom entity.|<a href="Slot.md" target="_blank">AdministrationAppointmentEMR/Slot</a>|
|[overbooked](#overbooked)|This slot has already been overbooked, appointments are unlikely to be accepted for this time|<a href="Slot.md" target="_blank">AdministrationAppointmentEMR/Slot</a>|
|[scheduleId](#scheduleId)|The schedule resource that this slot defines an interval of status information.|<a href="Slot.md" target="_blank">AdministrationAppointmentEMR/Slot</a>|
|[serviceCategoryId](#serviceCategoryId)|A broad categorization of the service that is to be performed during this appointment|<a href="Slot.md" target="_blank">AdministrationAppointmentEMR/Slot</a>|
|[serviceTypeNewId](#serviceTypeNewId)||<a href="Slot.md" target="_blank">AdministrationAppointmentEMR/Slot</a>|
|[slotId](#slotId)|Unique identifier for entity instances|<a href="Slot.md" target="_blank">AdministrationAppointmentEMR/Slot</a>|
|[specialtyId](#specialtyId)|The specialty of a practitioner that would be required to perform the service requested in this appointment|<a href="Slot.md" target="_blank">AdministrationAppointmentEMR/Slot</a>|
|[start](#start)|Date/Time that the slot is to begin|<a href="Slot.md" target="_blank">AdministrationAppointmentEMR/Slot</a>|
|[status](#status)|The free/busy status of the slot|<a href="Slot.md" target="_blank">AdministrationAppointmentEMR/Slot</a>|
|[status_display](#status_display)||<a href="Slot.md" target="_blank">AdministrationAppointmentEMR/Slot</a>|
|[stateCode](#stateCode)|Status of the Slot|<a href="Slot.md" target="_blank">AdministrationAppointmentEMR/Slot</a>|
|[stateCode_display](#stateCode_display)||<a href="Slot.md" target="_blank">AdministrationAppointmentEMR/Slot</a>|
|[statusCode](#statusCode)|Reason for the status of the Slot|<a href="Slot.md" target="_blank">AdministrationAppointmentEMR/Slot</a>|
|[statusCode_display](#statusCode_display)||<a href="Slot.md" target="_blank">AdministrationAppointmentEMR/Slot</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: AdministrationAppointmentEMR/Slot (this entity)  
