---
title: AppointmentEMRSlot in AdministrationAppointmentEMR - Common Data Model | Microsoft Docs
...
# Appointment (EMR) Slot in AdministrationAppointmentEMR(AppointmentEMRSlot)
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="AppointmentEMRSlot.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRSlot</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="AppointmentEMRSlot.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRSlot</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="AppointmentEMRSlot.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRSlot</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="AppointmentEMRSlot.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRSlot</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="AppointmentEMRSlot.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRSlot</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="AppointmentEMRSlot.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRSlot</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="AppointmentEMRSlot.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRSlot</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="AppointmentEMRSlot.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRSlot</a>|
|[ownerId](#ownerId)|Owner Id|<a href="AppointmentEMRSlot.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRSlot</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="AppointmentEMRSlot.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRSlot</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="AppointmentEMRSlot.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRSlot</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="AppointmentEMRSlot.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRSlot</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="AppointmentEMRSlot.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRSlot</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="AppointmentEMRSlot.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRSlot</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="AppointmentEMRSlot.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRSlot</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="AppointmentEMRSlot.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRSlot</a>|
|[appointmentEMRId](#appointmentEMRId)|A booking of a healthcare event among patient(s), practitioner(s), related person(s) and/or device(s) for a specific date/time. This may result in one or more Encounter(s)|<a href="AppointmentEMRSlot.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRSlot</a>|
|[appointmentEMRSlotId](#appointmentEMRSlotId)|Unique identifier for entity instances|<a href="AppointmentEMRSlot.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRSlot</a>|
|[name](#name)|The name of the custom entity.|<a href="AppointmentEMRSlot.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRSlot</a>|
|[slotId](#slotId)|A slot of time on a schedule that may be available for booking appointments|<a href="AppointmentEMRSlot.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRSlot</a>|
|[stateCode](#stateCode)|Status of the Appointment (EMR) Slot|<a href="AppointmentEMRSlot.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRSlot</a>|
|[stateCode_display](#stateCode_display)||<a href="AppointmentEMRSlot.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRSlot</a>|
|[statusCode](#statusCode)|Reason for the status of the Appointment (EMR) Slot|<a href="AppointmentEMRSlot.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRSlot</a>|
|[statusCode_display](#statusCode_display)||<a href="AppointmentEMRSlot.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRSlot</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: AdministrationAppointmentEMR/AppointmentEMRSlot (this entity)  
