...
# Schedule Service Type in AdministrationAppointmentEMR

The specific service that is to be performed during this appointment.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Administration/AdministrationAppointmentEMR/ScheduleServiceType.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/Healthcare/Administration<br>/AdministrationAppointmentEMR<br>/ScheduleServiceType.cdm.json/ScheduleServiceType<br>/hasAttributes/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[ScheduleServiceType/(resolvedAttributes)/scheduleServiceTypeId](#scheduleServiceTypeId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[ScheduleServiceType/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Schedule Service Type</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_scheduleservicetype"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="ScheduleServiceType.md" target="_blank">AdministrationAppointmentEMR/ScheduleServiceType</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="ScheduleServiceType.md" target="_blank">AdministrationAppointmentEMR/ScheduleServiceType</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="ScheduleServiceType.md" target="_blank">AdministrationAppointmentEMR/ScheduleServiceType</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="ScheduleServiceType.md" target="_blank">AdministrationAppointmentEMR/ScheduleServiceType</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="ScheduleServiceType.md" target="_blank">AdministrationAppointmentEMR/ScheduleServiceType</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="ScheduleServiceType.md" target="_blank">AdministrationAppointmentEMR/ScheduleServiceType</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="ScheduleServiceType.md" target="_blank">AdministrationAppointmentEMR/ScheduleServiceType</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="ScheduleServiceType.md" target="_blank">AdministrationAppointmentEMR/ScheduleServiceType</a>|
|[ownerId](#ownerId)|Owner Id|<a href="ScheduleServiceType.md" target="_blank">AdministrationAppointmentEMR/ScheduleServiceType</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="ScheduleServiceType.md" target="_blank">AdministrationAppointmentEMR/ScheduleServiceType</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="ScheduleServiceType.md" target="_blank">AdministrationAppointmentEMR/ScheduleServiceType</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="ScheduleServiceType.md" target="_blank">AdministrationAppointmentEMR/ScheduleServiceType</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="ScheduleServiceType.md" target="_blank">AdministrationAppointmentEMR/ScheduleServiceType</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="ScheduleServiceType.md" target="_blank">AdministrationAppointmentEMR/ScheduleServiceType</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="ScheduleServiceType.md" target="_blank">AdministrationAppointmentEMR/ScheduleServiceType</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="ScheduleServiceType.md" target="_blank">AdministrationAppointmentEMR/ScheduleServiceType</a>|
|[name](#name)|The name of the custom entity.|<a href="ScheduleServiceType.md" target="_blank">AdministrationAppointmentEMR/ScheduleServiceType</a>|
|[scheduleId](#scheduleId)|A container for slots of time that may be available for booking appointments.|<a href="ScheduleServiceType.md" target="_blank">AdministrationAppointmentEMR/ScheduleServiceType</a>|
|[scheduleServiceTypeId](#scheduleServiceTypeId)|Unique identifier for entity instances|<a href="ScheduleServiceType.md" target="_blank">AdministrationAppointmentEMR/ScheduleServiceType</a>|
|[serviceTypeNewId](#serviceTypeNewId)||<a href="ScheduleServiceType.md" target="_blank">AdministrationAppointmentEMR/ScheduleServiceType</a>|
|[stateCode](#stateCode)|Status of the Schedule Service Type|<a href="ScheduleServiceType.md" target="_blank">AdministrationAppointmentEMR/ScheduleServiceType</a>|
|[stateCode_display](#stateCode_display)||<a href="ScheduleServiceType.md" target="_blank">AdministrationAppointmentEMR/ScheduleServiceType</a>|
|[statusCode](#statusCode)|Reason for the status of the Schedule Service Type|<a href="ScheduleServiceType.md" target="_blank">AdministrationAppointmentEMR/ScheduleServiceType</a>|
|[statusCode_display](#statusCode_display)||<a href="ScheduleServiceType.md" target="_blank">AdministrationAppointmentEMR/ScheduleServiceType</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: AdministrationAppointmentEMR/ScheduleServiceType (this entity)  
...
### <a href=#scheduleServiceTypeId name="scheduleServiceTypeId">scheduleServiceTypeId</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Schedule Service Type</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_scheduleservicetypeid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the scheduleServiceTypeId attribute are listed below.</summary>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>The specific service that is to be performed during this appointment.</td></tr><tr><td>en</td><td>Unique identifier for entity instances</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_scheduleservicetypeid"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Schedule Service Type</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_servicetypenew</td></tr></table>
...
Status of the Schedule Service Type  
First included in: AdministrationAppointmentEMR/ScheduleServiceType (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Schedule Service Type</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the Schedule Service Type</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
Reason for the status of the Schedule Service Type  
First included in: AdministrationAppointmentEMR/ScheduleServiceType (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Schedule Service Type</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the Schedule Service Type</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
