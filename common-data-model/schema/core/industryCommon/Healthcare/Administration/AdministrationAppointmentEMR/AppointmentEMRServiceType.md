---
title: AppointmentEMRServiceType in AdministrationAppointmentEMR - Common Data Model | Microsoft Docs
...
# Appointment (EMR) Service Type in AdministrationAppointmentEMR(AppointmentEMRServiceType)

The specific service that is to be performed during this appointment.s  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Administration/AdministrationAppointmentEMR/AppointmentEMRServiceType.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="AppointmentEMRServiceType.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRServiceType</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="AppointmentEMRServiceType.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRServiceType</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="AppointmentEMRServiceType.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRServiceType</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="AppointmentEMRServiceType.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRServiceType</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="AppointmentEMRServiceType.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRServiceType</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="AppointmentEMRServiceType.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRServiceType</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="AppointmentEMRServiceType.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRServiceType</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="AppointmentEMRServiceType.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRServiceType</a>|
|[ownerId](#ownerId)|Owner Id|<a href="AppointmentEMRServiceType.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRServiceType</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="AppointmentEMRServiceType.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRServiceType</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="AppointmentEMRServiceType.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRServiceType</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="AppointmentEMRServiceType.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRServiceType</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="AppointmentEMRServiceType.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRServiceType</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="AppointmentEMRServiceType.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRServiceType</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="AppointmentEMRServiceType.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRServiceType</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="AppointmentEMRServiceType.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRServiceType</a>|
|[appointmentEMRId](#appointmentEMRId)|A booking of a healthcare event among patient(s), practitioner(s), related person(s) and/or device(s) for a specific date/time. This may result in one or more Encounter(s).|<a href="AppointmentEMRServiceType.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRServiceType</a>|
|[appointmentEMRServiceTypeId](#appointmentEMRServiceTypeId)|Unique identifier for entity instances|<a href="AppointmentEMRServiceType.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRServiceType</a>|
|[name](#name)|The name of the custom entity.|<a href="AppointmentEMRServiceType.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRServiceType</a>|
|[serviceTypeId](#serviceTypeId)|The specific service that is to be performed during this appointment.|<a href="AppointmentEMRServiceType.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRServiceType</a>|
|[serviceTypeCodeNewId](#serviceTypeCodeNewId)||<a href="AppointmentEMRServiceType.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRServiceType</a>|
|[stateCode](#stateCode)|Status of the Appointment (EMR) Service Type|<a href="AppointmentEMRServiceType.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRServiceType</a>|
|[stateCode_display](#stateCode_display)||<a href="AppointmentEMRServiceType.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRServiceType</a>|
|[statusCode](#statusCode)|Reason for the status of the Appointment (EMR) Service Type|<a href="AppointmentEMRServiceType.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRServiceType</a>|
|[statusCode_display](#statusCode_display)||<a href="AppointmentEMRServiceType.md" target="_blank">AdministrationAppointmentEMR/AppointmentEMRServiceType</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: AdministrationAppointmentEMR/AppointmentEMRServiceType (this entity)  
