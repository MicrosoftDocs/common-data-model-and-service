---
title: PractitionerRoleEndPoint in AdministrationCore - Common Data Model | Microsoft Docs
...
# Practitioner Role End Point in AdministrationCore

Technical endpoints providing access to services operated for the practitioner with this role.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Administration/AdministrationCore/PractitionerRoleEndPoint.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="PractitionerRoleEndPoint.md" target="_blank">AdministrationCore/PractitionerRoleEndPoint</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="PractitionerRoleEndPoint.md" target="_blank">AdministrationCore/PractitionerRoleEndPoint</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="PractitionerRoleEndPoint.md" target="_blank">AdministrationCore/PractitionerRoleEndPoint</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="PractitionerRoleEndPoint.md" target="_blank">AdministrationCore/PractitionerRoleEndPoint</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="PractitionerRoleEndPoint.md" target="_blank">AdministrationCore/PractitionerRoleEndPoint</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="PractitionerRoleEndPoint.md" target="_blank">AdministrationCore/PractitionerRoleEndPoint</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="PractitionerRoleEndPoint.md" target="_blank">AdministrationCore/PractitionerRoleEndPoint</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="PractitionerRoleEndPoint.md" target="_blank">AdministrationCore/PractitionerRoleEndPoint</a>|
|[ownerId](#ownerId)|Owner Id|<a href="PractitionerRoleEndPoint.md" target="_blank">AdministrationCore/PractitionerRoleEndPoint</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="PractitionerRoleEndPoint.md" target="_blank">AdministrationCore/PractitionerRoleEndPoint</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="PractitionerRoleEndPoint.md" target="_blank">AdministrationCore/PractitionerRoleEndPoint</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="PractitionerRoleEndPoint.md" target="_blank">AdministrationCore/PractitionerRoleEndPoint</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="PractitionerRoleEndPoint.md" target="_blank">AdministrationCore/PractitionerRoleEndPoint</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="PractitionerRoleEndPoint.md" target="_blank">AdministrationCore/PractitionerRoleEndPoint</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="PractitionerRoleEndPoint.md" target="_blank">AdministrationCore/PractitionerRoleEndPoint</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="PractitionerRoleEndPoint.md" target="_blank">AdministrationCore/PractitionerRoleEndPoint</a>|
|[endPointId](#endPointId)|The closing time of day. Note: If the AllDay flag is set, then this time is ignored|<a href="PractitionerRoleEndPoint.md" target="_blank">AdministrationCore/PractitionerRoleEndPoint</a>|
|[name](#name)|The name of the custom entity.|<a href="PractitionerRoleEndPoint.md" target="_blank">AdministrationCore/PractitionerRoleEndPoint</a>|
|[practitionerRoleId](#practitionerRoleId)|Unique identifier for Practitioner Role|<a href="PractitionerRoleEndPoint.md" target="_blank">AdministrationCore/PractitionerRoleEndPoint</a>|
|[practitionerRoleEndPointId](#practitionerRoleEndPointId)|Unique identifier for entity instances|<a href="PractitionerRoleEndPoint.md" target="_blank">AdministrationCore/PractitionerRoleEndPoint</a>|
|[stateCode](#stateCode)|Status of the Practitioner Role End Point|<a href="PractitionerRoleEndPoint.md" target="_blank">AdministrationCore/PractitionerRoleEndPoint</a>|
|[stateCode_display](#stateCode_display)||<a href="PractitionerRoleEndPoint.md" target="_blank">AdministrationCore/PractitionerRoleEndPoint</a>|
|[statusCode](#statusCode)|Reason for the status of the Practitioner Role End Point|<a href="PractitionerRoleEndPoint.md" target="_blank">AdministrationCore/PractitionerRoleEndPoint</a>|
|[statusCode_display](#statusCode_display)||<a href="PractitionerRoleEndPoint.md" target="_blank">AdministrationCore/PractitionerRoleEndPoint</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: AdministrationCore/PractitionerRoleEndPoint (this entity)  
