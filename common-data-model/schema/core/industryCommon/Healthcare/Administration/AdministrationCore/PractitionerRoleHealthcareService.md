---
title: PractitionerRoleHealthcareService in AdministrationCore - Common Data Model | Microsoft Docs
...
# Practitioner Role Healthcare Service in AdministrationCore

The list of healthcare services that this worker provides for this role's Organization/Location(s).  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Administration/AdministrationCore/PractitionerRoleHealthcareService.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="PractitionerRoleHealthcareService.md" target="_blank">AdministrationCore/PractitionerRoleHealthcareService</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="PractitionerRoleHealthcareService.md" target="_blank">AdministrationCore/PractitionerRoleHealthcareService</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="PractitionerRoleHealthcareService.md" target="_blank">AdministrationCore/PractitionerRoleHealthcareService</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="PractitionerRoleHealthcareService.md" target="_blank">AdministrationCore/PractitionerRoleHealthcareService</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="PractitionerRoleHealthcareService.md" target="_blank">AdministrationCore/PractitionerRoleHealthcareService</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="PractitionerRoleHealthcareService.md" target="_blank">AdministrationCore/PractitionerRoleHealthcareService</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="PractitionerRoleHealthcareService.md" target="_blank">AdministrationCore/PractitionerRoleHealthcareService</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="PractitionerRoleHealthcareService.md" target="_blank">AdministrationCore/PractitionerRoleHealthcareService</a>|
|[ownerId](#ownerId)|Owner Id|<a href="PractitionerRoleHealthcareService.md" target="_blank">AdministrationCore/PractitionerRoleHealthcareService</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="PractitionerRoleHealthcareService.md" target="_blank">AdministrationCore/PractitionerRoleHealthcareService</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="PractitionerRoleHealthcareService.md" target="_blank">AdministrationCore/PractitionerRoleHealthcareService</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="PractitionerRoleHealthcareService.md" target="_blank">AdministrationCore/PractitionerRoleHealthcareService</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="PractitionerRoleHealthcareService.md" target="_blank">AdministrationCore/PractitionerRoleHealthcareService</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="PractitionerRoleHealthcareService.md" target="_blank">AdministrationCore/PractitionerRoleHealthcareService</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="PractitionerRoleHealthcareService.md" target="_blank">AdministrationCore/PractitionerRoleHealthcareService</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="PractitionerRoleHealthcareService.md" target="_blank">AdministrationCore/PractitionerRoleHealthcareService</a>|
|[healthcareServiceId](#healthcareServiceId)|The list of healthcare services that this worker provides for this role's Organization/Location(s)|<a href="PractitionerRoleHealthcareService.md" target="_blank">AdministrationCore/PractitionerRoleHealthcareService</a>|
|[name](#name)|The name of the custom entity.|<a href="PractitionerRoleHealthcareService.md" target="_blank">AdministrationCore/PractitionerRoleHealthcareService</a>|
|[practitionerRoleId](#practitionerRoleId)|Unique identifier for Practitioner Role|<a href="PractitionerRoleHealthcareService.md" target="_blank">AdministrationCore/PractitionerRoleHealthcareService</a>|
|[practitionerRoleHealthcareServiceId](#practitionerRoleHealthcareServiceId)|Unique identifier for entity instances|<a href="PractitionerRoleHealthcareService.md" target="_blank">AdministrationCore/PractitionerRoleHealthcareService</a>|
|[stateCode](#stateCode)|Status of the Practitioner Role Healthcare Service|<a href="PractitionerRoleHealthcareService.md" target="_blank">AdministrationCore/PractitionerRoleHealthcareService</a>|
|[stateCode_display](#stateCode_display)||<a href="PractitionerRoleHealthcareService.md" target="_blank">AdministrationCore/PractitionerRoleHealthcareService</a>|
|[statusCode](#statusCode)|Reason for the status of the Practitioner Role Healthcare Service|<a href="PractitionerRoleHealthcareService.md" target="_blank">AdministrationCore/PractitionerRoleHealthcareService</a>|
|[statusCode_display](#statusCode_display)||<a href="PractitionerRoleHealthcareService.md" target="_blank">AdministrationCore/PractitionerRoleHealthcareService</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: AdministrationCore/PractitionerRoleHealthcareService (this entity)  
