---
title: PractitionerSpecialty in AdministrationCore - Common Data Model | Microsoft Docs
...
# Practitioner Specialty in AdministrationCore

Specific specialty of the practitioner.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Administration/AdministrationCore/PractitionerSpecialty.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/Healthcare/Administration/AdministrationCore<br>/PractitionerSpecialty.cdm.json<br>/PractitionerSpecialty/hasAttributes<br>/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[PractitionerSpecialty/(resolvedAttributes)/practitionerSpecialtyId](#practitionerSpecialtyId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[PractitionerSpecialty/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="PractitionerSpecialty.md" target="_blank">AdministrationCore/PractitionerSpecialty</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="PractitionerSpecialty.md" target="_blank">AdministrationCore/PractitionerSpecialty</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="PractitionerSpecialty.md" target="_blank">AdministrationCore/PractitionerSpecialty</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="PractitionerSpecialty.md" target="_blank">AdministrationCore/PractitionerSpecialty</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="PractitionerSpecialty.md" target="_blank">AdministrationCore/PractitionerSpecialty</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="PractitionerSpecialty.md" target="_blank">AdministrationCore/PractitionerSpecialty</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="PractitionerSpecialty.md" target="_blank">AdministrationCore/PractitionerSpecialty</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="PractitionerSpecialty.md" target="_blank">AdministrationCore/PractitionerSpecialty</a>|
|[ownerId](#ownerId)|Owner Id|<a href="PractitionerSpecialty.md" target="_blank">AdministrationCore/PractitionerSpecialty</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="PractitionerSpecialty.md" target="_blank">AdministrationCore/PractitionerSpecialty</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="PractitionerSpecialty.md" target="_blank">AdministrationCore/PractitionerSpecialty</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="PractitionerSpecialty.md" target="_blank">AdministrationCore/PractitionerSpecialty</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="PractitionerSpecialty.md" target="_blank">AdministrationCore/PractitionerSpecialty</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="PractitionerSpecialty.md" target="_blank">AdministrationCore/PractitionerSpecialty</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="PractitionerSpecialty.md" target="_blank">AdministrationCore/PractitionerSpecialty</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="PractitionerSpecialty.md" target="_blank">AdministrationCore/PractitionerSpecialty</a>|
|[code](#code)||<a href="PractitionerSpecialty.md" target="_blank">AdministrationCore/PractitionerSpecialty</a>|
|[display](#display)|The name of the custom entity.|<a href="PractitionerSpecialty.md" target="_blank">AdministrationCore/PractitionerSpecialty</a>|
|[practitionerSpecialtyId](#practitionerSpecialtyId)|Unique identifier for entity instances|<a href="PractitionerSpecialty.md" target="_blank">AdministrationCore/PractitionerSpecialty</a>|
|[system](#system)||<a href="PractitionerSpecialty.md" target="_blank">AdministrationCore/PractitionerSpecialty</a>|
|[stateCode](#stateCode)|Status of the Practitioner Specialty|<a href="PractitionerSpecialty.md" target="_blank">AdministrationCore/PractitionerSpecialty</a>|
|[stateCode_display](#stateCode_display)||<a href="PractitionerSpecialty.md" target="_blank">AdministrationCore/PractitionerSpecialty</a>|
|[statusCode](#statusCode)|Reason for the status of the Practitioner Specialty|<a href="PractitionerSpecialty.md" target="_blank">AdministrationCore/PractitionerSpecialty</a>|
|[statusCode_display](#statusCode_display)||<a href="PractitionerSpecialty.md" target="_blank">AdministrationCore/PractitionerSpecialty</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: AdministrationCore/PractitionerSpecialty (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Practitioner Specialty</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>sourceName</td><td>msemr_practitionerspecialtyid</td></tr></table>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_practitionerspecialtyid"</td><td>string</td><td></td></tr></table>
...
Status of the Practitioner Specialty  
First included in: AdministrationCore/PractitionerSpecialty (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Practitioner Specialty</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the Practitioner Specialty</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
Reason for the status of the Practitioner Specialty  
First included in: AdministrationCore/PractitionerSpecialty (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Practitioner Specialty</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the Practitioner Specialty</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
