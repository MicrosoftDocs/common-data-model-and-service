...
# Practitioner Role Location in AdministrationCore

The location(s) at which this practitioner provides care.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Administration/AdministrationCore/PractitionerRoleLocation.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="PractitionerRoleLocation.md" target="_blank">AdministrationCore/PractitionerRoleLocation</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="PractitionerRoleLocation.md" target="_blank">AdministrationCore/PractitionerRoleLocation</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="PractitionerRoleLocation.md" target="_blank">AdministrationCore/PractitionerRoleLocation</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="PractitionerRoleLocation.md" target="_blank">AdministrationCore/PractitionerRoleLocation</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="PractitionerRoleLocation.md" target="_blank">AdministrationCore/PractitionerRoleLocation</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="PractitionerRoleLocation.md" target="_blank">AdministrationCore/PractitionerRoleLocation</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="PractitionerRoleLocation.md" target="_blank">AdministrationCore/PractitionerRoleLocation</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="PractitionerRoleLocation.md" target="_blank">AdministrationCore/PractitionerRoleLocation</a>|
|[ownerId](#ownerId)|Owner Id|<a href="PractitionerRoleLocation.md" target="_blank">AdministrationCore/PractitionerRoleLocation</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="PractitionerRoleLocation.md" target="_blank">AdministrationCore/PractitionerRoleLocation</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="PractitionerRoleLocation.md" target="_blank">AdministrationCore/PractitionerRoleLocation</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="PractitionerRoleLocation.md" target="_blank">AdministrationCore/PractitionerRoleLocation</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="PractitionerRoleLocation.md" target="_blank">AdministrationCore/PractitionerRoleLocation</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="PractitionerRoleLocation.md" target="_blank">AdministrationCore/PractitionerRoleLocation</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="PractitionerRoleLocation.md" target="_blank">AdministrationCore/PractitionerRoleLocation</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="PractitionerRoleLocation.md" target="_blank">AdministrationCore/PractitionerRoleLocation</a>|
|[locationId](#locationId)|The location(s) at which this practitioner provides care.|<a href="PractitionerRoleLocation.md" target="_blank">AdministrationCore/PractitionerRoleLocation</a>|
|[name](#name)|The name of the custom entity.|<a href="PractitionerRoleLocation.md" target="_blank">AdministrationCore/PractitionerRoleLocation</a>|
|[practitionerRoleId](#practitionerRoleId)|Unique identifier for Practitioner Role|<a href="PractitionerRoleLocation.md" target="_blank">AdministrationCore/PractitionerRoleLocation</a>|
|[practitionerRoleLocationId](#practitionerRoleLocationId)|Unique identifier for entity instances|<a href="PractitionerRoleLocation.md" target="_blank">AdministrationCore/PractitionerRoleLocation</a>|
|[stateCode](#stateCode)|Status of the Practitioner Role Location|<a href="PractitionerRoleLocation.md" target="_blank">AdministrationCore/PractitionerRoleLocation</a>|
|[stateCode_display](#stateCode_display)||<a href="PractitionerRoleLocation.md" target="_blank">AdministrationCore/PractitionerRoleLocation</a>|
|[statusCode](#statusCode)|Reason for the status of the Practitioner Role Location|<a href="PractitionerRoleLocation.md" target="_blank">AdministrationCore/PractitionerRoleLocation</a>|
|[statusCode_display](#statusCode_display)||<a href="PractitionerRoleLocation.md" target="_blank">AdministrationCore/PractitionerRoleLocation</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: AdministrationCore/PractitionerRoleLocation (this entity)  
