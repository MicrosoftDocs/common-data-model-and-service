---
title: ContactLink in AdministrationCore - Common Data Model | Microsoft Docs
...
# Contact Link in AdministrationCore

Link to another patient entity that concerns the same actual patient.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Administration/AdministrationCore/ContactLink.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="ContactLink.md" target="_blank">AdministrationCore/ContactLink</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="ContactLink.md" target="_blank">AdministrationCore/ContactLink</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="ContactLink.md" target="_blank">AdministrationCore/ContactLink</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="ContactLink.md" target="_blank">AdministrationCore/ContactLink</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="ContactLink.md" target="_blank">AdministrationCore/ContactLink</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="ContactLink.md" target="_blank">AdministrationCore/ContactLink</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="ContactLink.md" target="_blank">AdministrationCore/ContactLink</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="ContactLink.md" target="_blank">AdministrationCore/ContactLink</a>|
|[ownerId](#ownerId)|Owner Id|<a href="ContactLink.md" target="_blank">AdministrationCore/ContactLink</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="ContactLink.md" target="_blank">AdministrationCore/ContactLink</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="ContactLink.md" target="_blank">AdministrationCore/ContactLink</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="ContactLink.md" target="_blank">AdministrationCore/ContactLink</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="ContactLink.md" target="_blank">AdministrationCore/ContactLink</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="ContactLink.md" target="_blank">AdministrationCore/ContactLink</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="ContactLink.md" target="_blank">AdministrationCore/ContactLink</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="ContactLink.md" target="_blank">AdministrationCore/ContactLink</a>|
|[contactLinkId](#contactLinkId)|Unique identifier for entity instances|<a href="ContactLink.md" target="_blank">AdministrationCore/ContactLink</a>|
|[linkId](#linkId)|Link to another patient resource that concerns the same actual patient.|<a href="ContactLink.md" target="_blank">AdministrationCore/ContactLink</a>|
|[linkTypeId](#linkTypeId)|The type of link between this patient resource and another patient resource.|<a href="ContactLink.md" target="_blank">AdministrationCore/ContactLink</a>|
|[name](#name)|The name of the custom entity.|<a href="ContactLink.md" target="_blank">AdministrationCore/ContactLink</a>|
|[patientId](#patientId)|Information about a person whose communication preference is documented here|<a href="ContactLink.md" target="_blank">AdministrationCore/ContactLink</a>|
|[stateCode](#stateCode)|Status of the Contact Link|<a href="ContactLink.md" target="_blank">AdministrationCore/ContactLink</a>|
|[stateCode_display](#stateCode_display)||<a href="ContactLink.md" target="_blank">AdministrationCore/ContactLink</a>|
|[statusCode](#statusCode)|Reason for the status of the Contact Link|<a href="ContactLink.md" target="_blank">AdministrationCore/ContactLink</a>|
|[statusCode_display](#statusCode_display)||<a href="ContactLink.md" target="_blank">AdministrationCore/ContactLink</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: AdministrationCore/ContactLink (this entity)  
