---
title: PractitionerRoleCode in AdministrationCore - Common Data Model | Microsoft Docs
...
# Practitioner Role Code in AdministrationCore

Roles which this practitioner is authorized to perform for the organization.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Administration/AdministrationCore/PractitionerRoleCode.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="PractitionerRoleCode.md" target="_blank">AdministrationCore/PractitionerRoleCode</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="PractitionerRoleCode.md" target="_blank">AdministrationCore/PractitionerRoleCode</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="PractitionerRoleCode.md" target="_blank">AdministrationCore/PractitionerRoleCode</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="PractitionerRoleCode.md" target="_blank">AdministrationCore/PractitionerRoleCode</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="PractitionerRoleCode.md" target="_blank">AdministrationCore/PractitionerRoleCode</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="PractitionerRoleCode.md" target="_blank">AdministrationCore/PractitionerRoleCode</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="PractitionerRoleCode.md" target="_blank">AdministrationCore/PractitionerRoleCode</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="PractitionerRoleCode.md" target="_blank">AdministrationCore/PractitionerRoleCode</a>|
|[ownerId](#ownerId)|Owner Id|<a href="PractitionerRoleCode.md" target="_blank">AdministrationCore/PractitionerRoleCode</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="PractitionerRoleCode.md" target="_blank">AdministrationCore/PractitionerRoleCode</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="PractitionerRoleCode.md" target="_blank">AdministrationCore/PractitionerRoleCode</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="PractitionerRoleCode.md" target="_blank">AdministrationCore/PractitionerRoleCode</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="PractitionerRoleCode.md" target="_blank">AdministrationCore/PractitionerRoleCode</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="PractitionerRoleCode.md" target="_blank">AdministrationCore/PractitionerRoleCode</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="PractitionerRoleCode.md" target="_blank">AdministrationCore/PractitionerRoleCode</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="PractitionerRoleCode.md" target="_blank">AdministrationCore/PractitionerRoleCode</a>|
|[codeId](#codeId)|Roles which this practitioner is authorized to perform for the organization.|<a href="PractitionerRoleCode.md" target="_blank">AdministrationCore/PractitionerRoleCode</a>|
|[name](#name)|The name of the custom entity.|<a href="PractitionerRoleCode.md" target="_blank">AdministrationCore/PractitionerRoleCode</a>|
|[practitionerRoleId](#practitionerRoleId)|Unique identifier for Practitioner Role|<a href="PractitionerRoleCode.md" target="_blank">AdministrationCore/PractitionerRoleCode</a>|
|[practitionerRoleCodeId](#practitionerRoleCodeId)|Unique identifier for entity instances|<a href="PractitionerRoleCode.md" target="_blank">AdministrationCore/PractitionerRoleCode</a>|
|[stateCode](#stateCode)|Status of the Practitioner Role Code|<a href="PractitionerRoleCode.md" target="_blank">AdministrationCore/PractitionerRoleCode</a>|
|[stateCode_display](#stateCode_display)||<a href="PractitionerRoleCode.md" target="_blank">AdministrationCore/PractitionerRoleCode</a>|
|[statusCode](#statusCode)|Reason for the status of the Practitioner Role Code|<a href="PractitionerRoleCode.md" target="_blank">AdministrationCore/PractitionerRoleCode</a>|
|[statusCode_display](#statusCode_display)||<a href="PractitionerRoleCode.md" target="_blank">AdministrationCore/PractitionerRoleCode</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: AdministrationCore/PractitionerRoleCode (this entity)  
