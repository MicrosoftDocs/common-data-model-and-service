---
title: PractitionerRoleSpecialty in AdministrationCore - Common Data Model | Microsoft Docs
...
# Practitioner Role Specialty in AdministrationCore

Specific specialty of the practitioner.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Administration/AdministrationCore/PractitionerRoleSpecialty.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="PractitionerRoleSpecialty.md" target="_blank">AdministrationCore/PractitionerRoleSpecialty</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="PractitionerRoleSpecialty.md" target="_blank">AdministrationCore/PractitionerRoleSpecialty</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="PractitionerRoleSpecialty.md" target="_blank">AdministrationCore/PractitionerRoleSpecialty</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="PractitionerRoleSpecialty.md" target="_blank">AdministrationCore/PractitionerRoleSpecialty</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="PractitionerRoleSpecialty.md" target="_blank">AdministrationCore/PractitionerRoleSpecialty</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="PractitionerRoleSpecialty.md" target="_blank">AdministrationCore/PractitionerRoleSpecialty</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="PractitionerRoleSpecialty.md" target="_blank">AdministrationCore/PractitionerRoleSpecialty</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="PractitionerRoleSpecialty.md" target="_blank">AdministrationCore/PractitionerRoleSpecialty</a>|
|[ownerId](#ownerId)|Owner Id|<a href="PractitionerRoleSpecialty.md" target="_blank">AdministrationCore/PractitionerRoleSpecialty</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="PractitionerRoleSpecialty.md" target="_blank">AdministrationCore/PractitionerRoleSpecialty</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="PractitionerRoleSpecialty.md" target="_blank">AdministrationCore/PractitionerRoleSpecialty</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="PractitionerRoleSpecialty.md" target="_blank">AdministrationCore/PractitionerRoleSpecialty</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="PractitionerRoleSpecialty.md" target="_blank">AdministrationCore/PractitionerRoleSpecialty</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="PractitionerRoleSpecialty.md" target="_blank">AdministrationCore/PractitionerRoleSpecialty</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="PractitionerRoleSpecialty.md" target="_blank">AdministrationCore/PractitionerRoleSpecialty</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="PractitionerRoleSpecialty.md" target="_blank">AdministrationCore/PractitionerRoleSpecialty</a>|
|[name](#name)|The name of the custom entity.|<a href="PractitionerRoleSpecialty.md" target="_blank">AdministrationCore/PractitionerRoleSpecialty</a>|
|[practitionerRoleId](#practitionerRoleId)|Unique identifier for Practitioner Role|<a href="PractitionerRoleSpecialty.md" target="_blank">AdministrationCore/PractitionerRoleSpecialty</a>|
|[practitionerRoleSpecialtyId](#practitionerRoleSpecialtyId)|Unique identifier for entity instances|<a href="PractitionerRoleSpecialty.md" target="_blank">AdministrationCore/PractitionerRoleSpecialty</a>|
|[specialtyId](#specialtyId)|Specific specialty of the practitioner.|<a href="PractitionerRoleSpecialty.md" target="_blank">AdministrationCore/PractitionerRoleSpecialty</a>|
|[stateCode](#stateCode)|Status of the Practitioner Role Specialty|<a href="PractitionerRoleSpecialty.md" target="_blank">AdministrationCore/PractitionerRoleSpecialty</a>|
|[stateCode_display](#stateCode_display)||<a href="PractitionerRoleSpecialty.md" target="_blank">AdministrationCore/PractitionerRoleSpecialty</a>|
|[statusCode](#statusCode)|Reason for the status of the Practitioner Role Specialty|<a href="PractitionerRoleSpecialty.md" target="_blank">AdministrationCore/PractitionerRoleSpecialty</a>|
|[statusCode_display](#statusCode_display)||<a href="PractitionerRoleSpecialty.md" target="_blank">AdministrationCore/PractitionerRoleSpecialty</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: AdministrationCore/PractitionerRoleSpecialty (this entity)  
