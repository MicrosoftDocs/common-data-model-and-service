...
# Account in AdministrationCore

Business that represents a customer or potential customer. The company that is billed in business transactions.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Administration/AdministrationCore/Account.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[ownerId](#ownerId)|Owner Id|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[accountId](#accountId)|Unique identifier of the account.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[accountCategoryCode](#accountCategoryCode)|Select a category to indicate whether the customer account is standard or preferred.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[accountCategoryCode_display](#accountCategoryCode_display)||<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[customerSizeCode](#customerSizeCode)|Select the size category or range of the account for segmentation and reporting purposes.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[customerSizeCode_display](#customerSizeCode_display)||<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[preferredContactMethodCode](#preferredContactMethodCode)|Select the preferred method of contact.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[preferredContactMethodCode_display](#preferredContactMethodCode_display)||<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[customerTypeCode](#customerTypeCode)|Select the category that best describes the relationship between the account and your organization.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[customerTypeCode_display](#customerTypeCode_display)||<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[accountRatingCode](#accountRatingCode)|Select a rating to indicate the value of the customer account.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[accountRatingCode_display](#accountRatingCode_display)||<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[industryCode](#industryCode)|Select the account's primary industry for use in marketing segmentation and demographic analysis.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[industryCode_display](#industryCode_display)||<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[territoryCode](#territoryCode)|Select a region or territory for the account for use in segmentation and analysis.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[territoryCode_display](#territoryCode_display)||<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[accountClassificationCode](#accountClassificationCode)|Select a classification code to indicate the potential value of the customer account based on the projected return on investment, cooperation level, sales cycle length or other criteria.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[accountClassificationCode_display](#accountClassificationCode_display)||<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[businessTypeCode](#businessTypeCode)|Select the legal designation or other business type of the account for contracts or reporting purposes.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[businessTypeCode_display](#businessTypeCode_display)||<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[traversedPath](#traversedPath)|For internal use only.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[paymentTermsCode](#paymentTermsCode)|Select the payment terms to indicate when the customer needs to pay the total amount.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[paymentTermsCode_display](#paymentTermsCode_display)||<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[shippingMethodCode](#shippingMethodCode)|Select a shipping method for deliveries sent to the account's address to designate the preferred carrier or other delivery option.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[shippingMethodCode_display](#shippingMethodCode_display)||<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[primaryContactId](#primaryContactId)|Choose the primary contact for the account to provide quick access to contact details.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[participatesInWorkflow](#participatesInWorkflow)|For system use only. Legacy Microsoft Dynamics CRM 3.0 workflow data.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[name](#name)|Type the company or business name.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[accountNumber](#accountNumber)|Type an ID number or code for the account to quickly search and identify the account in system views.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[revenue](#revenue)|Type the annual revenue for the account, used as an indicator in financial performance analysis.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[numberOfEmployees](#numberOfEmployees)|Type the number of employees that work at the account for use in marketing segmentation and demographic analysis.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[description](#description)|Type additional information to describe the account, such as an excerpt from the company's website.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[SIC](#SIC)|Type the Standard Industrial Classification (SIC) code that indicates the account's primary industry of business, for use in marketing segmentation and demographic analysis.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[ownershipCode](#ownershipCode)|Select the account's ownership structure, such as public or private.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[ownershipCode_display](#ownershipCode_display)||<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[marketCap](#marketCap)|Type the market capitalization of the account to identify the company's equity, used as an indicator in financial performance analysis.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[sharesOutstanding](#sharesOutstanding)|Type the number of shares available to the public for the account. This number is used as an indicator in financial performance analysis.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[tickerSymbol](#tickerSymbol)|Type the stock exchange symbol for the account to track financial performance of the company. You can click the code entered in this field to access the latest trading information from MSN Money.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[stockExchange](#stockExchange)|Type the stock exchange at which the account is listed to track their stock and financial performance of the company.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[webSiteUrl](#webSiteUrl)|Type the account's website URL to get quick details about the company profile.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[ftpSiteUrl](#ftpSiteUrl)|Type the URL for the account's FTP site to enable users to access data and share documents.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[EMailAddress1](#EMailAddress1)|Type the primary email address for the account.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[EMailAddress2](#EMailAddress2)|Type the secondary email address for the account.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[EMailAddress3](#EMailAddress3)|Type an alternate email address for the account.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[doNotPhone](#doNotPhone)|Select whether the account allows phone calls. If Do Not Allow is selected, the account will be excluded from phone call activities distributed in marketing campaigns.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[doNotFax](#doNotFax)|Select whether the account allows faxes. If Do Not Allow is selected, the account will be excluded from fax activities distributed in marketing campaigns.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[telephone1](#telephone1)|Type the main phone number for this account.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[doNotEMail](#doNotEMail)|Select whether the account allows direct email sent from Microsoft Dynamics 365.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[telephone2](#telephone2)|Type a second phone number for this account.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[fax](#fax)|Type the fax number for the account.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[telephone3](#telephone3)|Type a third phone number for this account.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[doNotPostalMail](#doNotPostalMail)|Select whether the account allows direct mail. If Do Not Allow is selected, the account will be excluded from letter activities distributed in marketing campaigns.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[doNotBulkEMail](#doNotBulkEMail)|Select whether the account allows bulk email sent through campaigns. If Do Not Allow is selected, the account can be added to marketing lists, but is excluded from email.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[doNotBulkPostalMail](#doNotBulkPostalMail)|Select whether the account allows bulk postal mail sent through marketing campaigns or quick campaigns. If Do Not Allow is selected, the account can be added to marketing lists, but will be excluded from the postal mail.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[creditLimit](#creditLimit)|Type the credit limit of the account. This is a useful reference when you address invoice and accounting issues with the customer.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[creditOnHold](#creditOnHold)|Select whether the credit for the account is on hold. This is a useful reference while addressing the invoice and accounting issues with the customer.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[parentAccountId](#parentAccountId)|Choose the parent account associated with this account to show parent and child businesses in reporting and analytics.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[aging30](#aging30)|For system use only.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[stateCode](#stateCode)|Shows whether the account is active or inactive. Inactive accounts are read-only and can't be edited unless they are reactivated.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[stateCode_display](#stateCode_display)||<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[aging60](#aging60)|For system use only.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[statusCode](#statusCode)|Select the account's status.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[statusCode_display](#statusCode_display)||<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[aging90](#aging90)|For system use only.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[address1AddressId](#address1AddressId)|Unique identifier for address 1.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[address1AddressTypeCode](#address1AddressTypeCode)|Select the address type, such as primary or billing.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[address1AddressTypeCode_display](#address1AddressTypeCode_display)||<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[address1Name](#address1Name)|Type a descriptive name for the customer's address, such as Corporate Headquarters.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[address1PrimaryContactName](#address1PrimaryContactName)|Type the name of the primary contact person for the customer's address.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[address1Line1](#address1Line1)|Type the first line of the customer's address to help identify the location.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[address1Line2](#address1Line2)|Type the second line of the customer's address.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[address1Line3](#address1Line3)|Type the third line of the customer's address.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[address1City](#address1City)|Type the city for the customer's address to help identify the location.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[address1StateOrProvince](#address1StateOrProvince)|Type the state or province of the customer's address.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[address1County](#address1County)|Type the county for the customer's address.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[address1Country](#address1Country)|Type the country or region for the customer's address.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[address1PostOfficeBox](#address1PostOfficeBox)|Type the post office box number of the customer's address.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[address1PostalCode](#address1PostalCode)|Type the ZIP Code or postal code for the address.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[address1UTCOffset](#address1UTCOffset)|Select the time zone for the address.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[address1FreightTermsCode](#address1FreightTermsCode)|Select the freight terms to make sure shipping charges are processed correctly.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[address1FreightTermsCode_display](#address1FreightTermsCode_display)||<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[address1UPSZone](#address1UPSZone)|Type the UPS zone of the customer's address to make sure shipping charges are calculated correctly and deliveries are made promptly, if shipped by UPS.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[address1Latitude](#address1Latitude)|Type the latitude value for the customer's address, for use in mapping and other applications.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[address1Telephone1](#address1Telephone1)|Type the primary phone number for the customer's address.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[address1Longitude](#address1Longitude)|Type the longitude value for the customer's address, for use in mapping and other applications.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[address1ShippingMethodCode](#address1ShippingMethodCode)|Select a shipping method for deliveries sent to this address.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[address1ShippingMethodCode_display](#address1ShippingMethodCode_display)||<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[address1Telephone2](#address1Telephone2)|Type a second phone number for the customer's address.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[address1Telephone3](#address1Telephone3)|Type a third phone number for the customer's address.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[address1Fax](#address1Fax)|Type the fax number associated with the customer's address.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[address1Composite](#address1Composite)|Shows the complete address.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[address2AddressId](#address2AddressId)|Unique identifier for address 1.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[address2AddressTypeCode](#address2AddressTypeCode)|Select the address type, such as primary or billing.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[address2AddressTypeCode_display](#address2AddressTypeCode_display)||<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[address2Name](#address2Name)|Type a descriptive name for the customer's address, such as Corporate Headquarters.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[address2PrimaryContactName](#address2PrimaryContactName)|Type the name of the primary contact person for the customer's address.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[address2Line1](#address2Line1)|Type the first line of the customer's address to help identify the location.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[address2Line2](#address2Line2)|Type the second line of the customer's address.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[address2Line3](#address2Line3)|Type the third line of the customer's address.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[address2City](#address2City)|Type the city for the customer's address to help identify the location.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[address2StateOrProvince](#address2StateOrProvince)|Type the state or province of the customer's address.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[address2County](#address2County)|Type the county for the customer's address.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[address2Country](#address2Country)|Type the country or region for the customer's address.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[address2PostOfficeBox](#address2PostOfficeBox)|Type the post office box number of the customer's address.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[address2PostalCode](#address2PostalCode)|Type the ZIP Code or postal code for the address.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[address2UTCOffset](#address2UTCOffset)|Select the time zone for the address.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[address2FreightTermsCode](#address2FreightTermsCode)|Select the freight terms to make sure shipping charges are processed correctly.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[address2FreightTermsCode_display](#address2FreightTermsCode_display)||<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[address2UPSZone](#address2UPSZone)|Type the UPS zone of the customer's address to make sure shipping charges are calculated correctly and deliveries are made promptly, if shipped by UPS.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[address2Latitude](#address2Latitude)|Type the latitude value for the customer's address, for use in mapping and other applications.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[address2Telephone1](#address2Telephone1)|Type the primary phone number for the customer's address.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[address2Longitude](#address2Longitude)|Type the longitude value for the customer's address, for use in mapping and other applications.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[address2ShippingMethodCode](#address2ShippingMethodCode)|Select a shipping method for deliveries sent to this address.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[address2ShippingMethodCode_display](#address2ShippingMethodCode_display)||<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[address2Telephone2](#address2Telephone2)|Type a second phone number for the customer's address.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[address2Telephone3](#address2Telephone3)|Type a third phone number for the customer's address.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[address2Fax](#address2Fax)|Type the fax number associated with the customer's address.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[address2Composite](#address2Composite)|Shows the complete address.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[preferredAppointmentDayCode](#preferredAppointmentDayCode)|Select the preferred day of the week for service appointments.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[preferredAppointmentDayCode_display](#preferredAppointmentDayCode_display)||<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[preferredSystemUserId](#preferredSystemUserId)|Choose the preferred service representative for reference when you schedule service activities for the account.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[preferredAppointmentTimeCode](#preferredAppointmentTimeCode)|Select the preferred time of day for service appointments.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[preferredAppointmentTimeCode_display](#preferredAppointmentTimeCode_display)||<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[merged](#merged)|Shows whether the account has been merged with another account.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[doNotSendMM](#doNotSendMM)|Select whether the account accepts marketing materials, such as brochures or catalogs.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[masterId](#masterId)|Shows the master account that the account was merged with.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[lastUsedInCampaign](#lastUsedInCampaign)|Shows the date when the account was last included in a marketing campaign or quick campaign.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[exchangeRate](#exchangeRate)|Shows the conversion rate of the record's currency. The exchange rate is used to convert all money fields in the record from the local currency to the system's default currency.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[transactionCurrencyId](#transactionCurrencyId)|Choose the local currency for the record to make sure budgets are reported in the correct currency.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[creditLimitBase](#creditLimitBase)|Shows the credit limit converted to the system's default base currency for reporting purposes.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[aging30Base](#aging30Base)|The base currency equivalent of the aging 30 field.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[revenueBase](#revenueBase)|Shows the annual revenue converted to the system's default base currency. The calculations use the exchange rate specified in the Currencies area.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[aging90Base](#aging90Base)|The base currency equivalent of the aging 90 field.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[marketCapBase](#marketCapBase)|Shows the market capitalization converted to the system's default base currency.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[aging60Base](#aging60Base)|The base currency equivalent of the aging 60 field.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[yomiName](#yomiName)|Type the phonetic spelling of the company name, if specified in Japanese, to make sure the name is pronounced correctly in phone calls and other communications.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[stageId](#stageId)|Shows the ID of the stage.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[processId](#processId)|Shows the ID of the process.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[entityImageId](#entityImageId)|For internal use only.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[timeSpentByMeOnEmailAndMeetings](#timeSpentByMeOnEmailAndMeetings)|Total time spent for emails (read and write) and meetings by me in relation to account record.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[createdByExternalParty](#createdByExternalParty)|Shows the external party who created the record.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[modifiedByExternalParty](#modifiedByExternalParty)|Shows the external party who modified the record.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[primarySatoriId](#primarySatoriId)|Primary Satori ID for Account|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[primaryTwitterId](#primaryTwitterId)|Primary Twitter ID for Account|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[SLAId](#SLAId)|Choose the service level agreement (SLA) that you want to apply to the Account record.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[SLAInvokedId](#SLAInvokedId)|Last SLA that was applied to this case. This field is for internal use only.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[onHoldTime](#onHoldTime)|Shows how long, in minutes, that the record was on hold.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[lastOnHoldTime](#lastOnHoldTime)|Contains the date and time stamp of the last on hold time.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[followEmail](#followEmail)|Information about whether to allow following email activity like opens, attachment views and link clicks for emails sent to the account.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[marketingOnly](#marketingOnly)|Whether is only for marketing|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[accountType](#accountType)|The kind(s) of organization that this is|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[accountType_display](#accountType_display)||<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[address1PeriodEndDate](#address1PeriodEndDate)|Time period when address was/is in use|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[address1PeriodStartDate](#address1PeriodStartDate)|Time period when address was/is in use|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[address2PeriodEndDate](#address2PeriodEndDate)|Time period when address was/is in use|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[address2PeriodStartDate](#address2PeriodStartDate)|Time period when address was/is in use|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[alias](#alias)|A list of alternate names that the organization is known as, or was known as in the past.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[contact1PuroposeId](#contact1PuroposeId)|Indicates a purpose for which the contact can be reached.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[contact2Id](#contact2Id)|Contact for the organization for a certain purpose.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[contact2PuroposeId](#contact2PuroposeId)|Indicates a purpose for which the contact can be reached.|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[telecom1EndDate](#telecom1EndDate)|End time of validity of telecom|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[telecom1Rank](#telecom1Rank)|Specify preferred order of use (1 = highest)|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[telecom1StartDate](#telecom1StartDate)|Start time of validtity of telecom|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[telecom1System](#telecom1System)|Type of Technology mediated contact point|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[telecom1System_display](#telecom1System_display)||<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[telecom1Use](#telecom1Use)|purpose of this contact point|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[telecom1Use_display](#telecom1Use_display)||<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[telecom2EndDate](#telecom2EndDate)|End time of validity of telecom|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[telecom2Rank](#telecom2Rank)|Specify preferred order of use (1 = highest)|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[telecom2StartDate](#telecom2StartDate)|Start time of validity of telecom|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[telecom2System](#telecom2System)|Type of Technology mediated contact point|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[telecom2System_display](#telecom2System_display)||<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[telecom2Use](#telecom2Use)|purpose of this contact point|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[telecom2Use_display](#telecom2Use_display)||<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[telecom3EndDate](#telecom3EndDate)|End time of validity of telecom|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[telecom3Rank](#telecom3Rank)|Specify preferred order of use (1 = highest)|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[telecom3StartDate](#telecom3StartDate)|Start time of validtity of telecom|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[telecom3System](#telecom3System)|Type of Technology mediated contact point|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[telecom3System_display](#telecom3System_display)||<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[telecom3Use](#telecom3Use)|purpose of this contact point|<a href="Account.md" target="_blank">AdministrationCore/Account</a>|
|[telecom3Use_display](#telecom3Use_display)||<a href="Account.md" target="_blank">AdministrationCore/Account</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: AdministrationCore/Account (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Account Type</td></tr><tr><td>description</td><td>The kind(s) of organization that this is</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_accounttype</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Practice</td><td>935000000</td></tr><tr><td>en</td><td>Organization</td><td>935000001</td></tr></table></td></tr></table>
...
**is.dataFormat.integer**  
**does.haveDefault**  
An attribute has a default value  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>default</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Practice</td><td>935000000</td></tr><tr><td>en</td><td>Organization</td><td>935000001</td></tr></table></td><td>any</td><td></td></tr></table>

**is.constrainedList**  
the values of an attribute are taken from or looked up from a fixed list of possibilities  

**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_accounttype"</td><td>string</td><td></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>The kind(s) of organization that this is</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Primary - Primary End Date</td></tr><tr><td>description</td><td>Time period when address was/is in use</td></tr><tr><td>dataFormat</td><td>dateTime</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_address1periodenddate</td></tr></table>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Primary - Primary End Date</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Secondary  - Address Period End Date</td></tr><tr><td>description</td><td>Time period when address was/is in use</td></tr><tr><td>dataFormat</td><td>dateTime</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_address2periodenddate</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>DBA</td></tr><tr><td>description</td><td>A list of alternate names that the organization is known as, or was known as in the past.</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>100</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_alias</td></tr></table>

#### Traits

<details>
<summary>List of traits for the alias attribute are listed below.</summary>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_alias"</td><td>string</td><td></td></tr></table>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>DBA</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>A list of alternate names that the organization is known as, or was known as in the past.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
### <a href=#contact1PuroposeId name="contact1PuroposeId">contact1PuroposeId</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Primary Contact Purpose</td></tr><tr><td>description</td><td>Indicates a purpose for which the contact can be reached.</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_contact1puropose</td></tr></table>

#### Traits

<details>
<summary>List of traits for the contact1PuroposeId attribute are listed below.</summary>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Primary Contact Purpose</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Indicates a purpose for which the contact can be reached.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_contact1puropose"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Primary Contact</td></tr><tr><td>description</td><td>Contact for the organization for a certain purpose.</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_contact2</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Contact for the organization for a certain purpose.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
### <a href=#contact2PuroposeId name="contact2PuroposeId">contact2PuroposeId</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Primary Contact Purpose</td></tr><tr><td>description</td><td>Indicates a purpose for which the contact can be reached.</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_contact2puropose</td></tr></table>

#### Traits

<details>
<summary>List of traits for the contact2PuroposeId attribute are listed below.</summary>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_contact2puropose"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Primary Phone End Date</td></tr><tr><td>description</td><td>End time of validity of telecom</td></tr><tr><td>dataFormat</td><td>dateTime</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_telecom1enddate</td></tr></table>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Primary Phone End Date</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Rank Of Contact</td></tr><tr><td>description</td><td>Specify preferred order of use (1 = highest)</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>maximumValue</td><td>2147483647</td></tr><tr><td>minimumValue</td><td>-2147483648</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_telecom1rank</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Primary Phone Start Date</td></tr><tr><td>description</td><td>Start time of validtity of telecom</td></tr><tr><td>dataFormat</td><td>dateTime</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_telecom1startdate</td></tr></table>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Primary Phone Start Date</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Start time of validtity of telecom</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Secondary Phone End Date</td></tr><tr><td>description</td><td>End time of validity of telecom</td></tr><tr><td>dataFormat</td><td>dateTime</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_telecom2enddate</td></tr></table>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Secondary Phone End Date</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Secondary Phone Start Date</td></tr><tr><td>description</td><td>Start time of validity of telecom</td></tr><tr><td>dataFormat</td><td>dateTime</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_telecom2startdate</td></tr></table>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Secondary Phone Start Date</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Primary Email End Date</td></tr><tr><td>description</td><td>End time of validity of telecom</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>100</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_telecom3enddate</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Primary Email Start Date</td></tr><tr><td>description</td><td>Start time of validtity of telecom</td></tr><tr><td>dataFormat</td><td>dateTime</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_telecom3startdate</td></tr></table>
