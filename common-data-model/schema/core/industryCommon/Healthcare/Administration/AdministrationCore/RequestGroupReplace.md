---
title: RequestGroupReplace in AdministrationCore - Common Data Model | Microsoft Docs
...
# Request Group Replace in AdministrationCore

Completed or terminated request(s) whose function is taken by this new request.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Administration/AdministrationCore/RequestGroupReplace.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="RequestGroupReplace.md" target="_blank">AdministrationCore/RequestGroupReplace</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="RequestGroupReplace.md" target="_blank">AdministrationCore/RequestGroupReplace</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="RequestGroupReplace.md" target="_blank">AdministrationCore/RequestGroupReplace</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="RequestGroupReplace.md" target="_blank">AdministrationCore/RequestGroupReplace</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="RequestGroupReplace.md" target="_blank">AdministrationCore/RequestGroupReplace</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="RequestGroupReplace.md" target="_blank">AdministrationCore/RequestGroupReplace</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="RequestGroupReplace.md" target="_blank">AdministrationCore/RequestGroupReplace</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="RequestGroupReplace.md" target="_blank">AdministrationCore/RequestGroupReplace</a>|
|[ownerId](#ownerId)|Owner Id|<a href="RequestGroupReplace.md" target="_blank">AdministrationCore/RequestGroupReplace</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="RequestGroupReplace.md" target="_blank">AdministrationCore/RequestGroupReplace</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="RequestGroupReplace.md" target="_blank">AdministrationCore/RequestGroupReplace</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="RequestGroupReplace.md" target="_blank">AdministrationCore/RequestGroupReplace</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="RequestGroupReplace.md" target="_blank">AdministrationCore/RequestGroupReplace</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="RequestGroupReplace.md" target="_blank">AdministrationCore/RequestGroupReplace</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="RequestGroupReplace.md" target="_blank">AdministrationCore/RequestGroupReplace</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="RequestGroupReplace.md" target="_blank">AdministrationCore/RequestGroupReplace</a>|
|[name](#name)|The name of the custom entity.|<a href="RequestGroupReplace.md" target="_blank">AdministrationCore/RequestGroupReplace</a>|
|[replaces](#replaces)|Completed or terminated request(s) whose function is taken by this new request.|<a href="RequestGroupReplace.md" target="_blank">AdministrationCore/RequestGroupReplace</a>|
|[requestGroupId](#requestGroupId)|Identifier for Request Group.|<a href="RequestGroupReplace.md" target="_blank">AdministrationCore/RequestGroupReplace</a>|
|[requestGroupReplaceId](#requestGroupReplaceId)|Unique identifier for entity instances|<a href="RequestGroupReplace.md" target="_blank">AdministrationCore/RequestGroupReplace</a>|
|[stateCode](#stateCode)|Status of the Request Group Replace|<a href="RequestGroupReplace.md" target="_blank">AdministrationCore/RequestGroupReplace</a>|
|[stateCode_display](#stateCode_display)||<a href="RequestGroupReplace.md" target="_blank">AdministrationCore/RequestGroupReplace</a>|
|[statusCode](#statusCode)|Reason for the status of the Request Group Replace|<a href="RequestGroupReplace.md" target="_blank">AdministrationCore/RequestGroupReplace</a>|
|[statusCode_display](#statusCode_display)||<a href="RequestGroupReplace.md" target="_blank">AdministrationCore/RequestGroupReplace</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: AdministrationCore/RequestGroupReplace (this entity)  
