...
# Encounter Episode Of Care in AdministrationEncounter

Where a specific encounter should be classified as a part of a specific episode(s) of care this field should be used.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Administration/AdministrationEncounter/EncounterEpisodeOfCare.cdm.json" target="_blank">GitHub</a>.  
...
- [/HealthcareFoundation/EncounterEpisodeOfCare](../../Foundational/HealthcareFoundation/EncounterEpisodeOfCare.md "/Healthcare/Foundational/HealthcareFoundation/EncounterEpisodeOfCare.cdm.json/EncounterEpisodeOfCare")  
</details>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="EncounterEpisodeOfCare.md" target="_blank">AdministrationEncounter/EncounterEpisodeOfCare</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="EncounterEpisodeOfCare.md" target="_blank">AdministrationEncounter/EncounterEpisodeOfCare</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="EncounterEpisodeOfCare.md" target="_blank">AdministrationEncounter/EncounterEpisodeOfCare</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="EncounterEpisodeOfCare.md" target="_blank">AdministrationEncounter/EncounterEpisodeOfCare</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="EncounterEpisodeOfCare.md" target="_blank">AdministrationEncounter/EncounterEpisodeOfCare</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="EncounterEpisodeOfCare.md" target="_blank">AdministrationEncounter/EncounterEpisodeOfCare</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="EncounterEpisodeOfCare.md" target="_blank">AdministrationEncounter/EncounterEpisodeOfCare</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="EncounterEpisodeOfCare.md" target="_blank">AdministrationEncounter/EncounterEpisodeOfCare</a>|
|[ownerId](#ownerId)|Owner Id|<a href="EncounterEpisodeOfCare.md" target="_blank">AdministrationEncounter/EncounterEpisodeOfCare</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="EncounterEpisodeOfCare.md" target="_blank">AdministrationEncounter/EncounterEpisodeOfCare</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="EncounterEpisodeOfCare.md" target="_blank">AdministrationEncounter/EncounterEpisodeOfCare</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="EncounterEpisodeOfCare.md" target="_blank">AdministrationEncounter/EncounterEpisodeOfCare</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="EncounterEpisodeOfCare.md" target="_blank">AdministrationEncounter/EncounterEpisodeOfCare</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="EncounterEpisodeOfCare.md" target="_blank">AdministrationEncounter/EncounterEpisodeOfCare</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="EncounterEpisodeOfCare.md" target="_blank">AdministrationEncounter/EncounterEpisodeOfCare</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="EncounterEpisodeOfCare.md" target="_blank">AdministrationEncounter/EncounterEpisodeOfCare</a>|
|[encounterId](#encounterId)|An interaction between a patient and healthcare provider(s) for the purpose of providing healthcare service(s) or assessing the health status of a patient.|<a href="EncounterEpisodeOfCare.md" target="_blank">AdministrationEncounter/EncounterEpisodeOfCare</a>|
|[encounterEpisodeOfCareId](#encounterEpisodeOfCareId)|Unique identifier for entity instances|<a href="EncounterEpisodeOfCare.md" target="_blank">AdministrationEncounter/EncounterEpisodeOfCare</a>|
|[encounterEpisodeOfCareIdentifierId](#encounterEpisodeOfCareIdentifierId)|Where a specific encounter should be classified as a part of a specific episode(s) of care this field should be used.|<a href="EncounterEpisodeOfCare.md" target="_blank">AdministrationEncounter/EncounterEpisodeOfCare</a>|
|[name](#name)|The name of the custom entity.|<a href="EncounterEpisodeOfCare.md" target="_blank">AdministrationEncounter/EncounterEpisodeOfCare</a>|
|[stateCode](#stateCode)|Status of the Encounter Episode Of Care|<a href="EncounterEpisodeOfCare.md" target="_blank">AdministrationEncounter/EncounterEpisodeOfCare</a>|
|[stateCode_display](#stateCode_display)||<a href="EncounterEpisodeOfCare.md" target="_blank">AdministrationEncounter/EncounterEpisodeOfCare</a>|
|[statusCode](#statusCode)|Reason for the status of the Encounter Episode Of Care|<a href="EncounterEpisodeOfCare.md" target="_blank">AdministrationEncounter/EncounterEpisodeOfCare</a>|
|[statusCode_display](#statusCode_display)||<a href="EncounterEpisodeOfCare.md" target="_blank">AdministrationEncounter/EncounterEpisodeOfCare</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: AdministrationEncounter/EncounterEpisodeOfCare (this entity)  
