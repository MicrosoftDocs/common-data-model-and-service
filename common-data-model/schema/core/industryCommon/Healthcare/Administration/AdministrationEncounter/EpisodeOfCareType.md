...
# Episode Of Care Type in AdministrationEncounter

A classification of the type of episode of care; e.g. specialist referral, disease management, type of funded care.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Administration/AdministrationEncounter/EpisodeOfCareType.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="EpisodeOfCareType.md" target="_blank">AdministrationEncounter/EpisodeOfCareType</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="EpisodeOfCareType.md" target="_blank">AdministrationEncounter/EpisodeOfCareType</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="EpisodeOfCareType.md" target="_blank">AdministrationEncounter/EpisodeOfCareType</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="EpisodeOfCareType.md" target="_blank">AdministrationEncounter/EpisodeOfCareType</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="EpisodeOfCareType.md" target="_blank">AdministrationEncounter/EpisodeOfCareType</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="EpisodeOfCareType.md" target="_blank">AdministrationEncounter/EpisodeOfCareType</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="EpisodeOfCareType.md" target="_blank">AdministrationEncounter/EpisodeOfCareType</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="EpisodeOfCareType.md" target="_blank">AdministrationEncounter/EpisodeOfCareType</a>|
|[ownerId](#ownerId)|Owner Id|<a href="EpisodeOfCareType.md" target="_blank">AdministrationEncounter/EpisodeOfCareType</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="EpisodeOfCareType.md" target="_blank">AdministrationEncounter/EpisodeOfCareType</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="EpisodeOfCareType.md" target="_blank">AdministrationEncounter/EpisodeOfCareType</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="EpisodeOfCareType.md" target="_blank">AdministrationEncounter/EpisodeOfCareType</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="EpisodeOfCareType.md" target="_blank">AdministrationEncounter/EpisodeOfCareType</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="EpisodeOfCareType.md" target="_blank">AdministrationEncounter/EpisodeOfCareType</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="EpisodeOfCareType.md" target="_blank">AdministrationEncounter/EpisodeOfCareType</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="EpisodeOfCareType.md" target="_blank">AdministrationEncounter/EpisodeOfCareType</a>|
|[episodeOfCareId](#episodeOfCareId)|An association between a patient and an organization / healthcare provider(s) during which time encounters may occur.|<a href="EpisodeOfCareType.md" target="_blank">AdministrationEncounter/EpisodeOfCareType</a>|
|[episodeOfCareTypeId](#episodeOfCareTypeId)|Unique identifier for entity instances|<a href="EpisodeOfCareType.md" target="_blank">AdministrationEncounter/EpisodeOfCareType</a>|
|[name](#name)|The name of the custom entity.|<a href="EpisodeOfCareType.md" target="_blank">AdministrationEncounter/EpisodeOfCareType</a>|
|[typeId](#typeId)|A classification of the type of episode of care; e.g. specialist referral, disease management, type of funded care.|<a href="EpisodeOfCareType.md" target="_blank">AdministrationEncounter/EpisodeOfCareType</a>|
|[stateCode](#stateCode)|Status of the Episode Of Care Type|<a href="EpisodeOfCareType.md" target="_blank">AdministrationEncounter/EpisodeOfCareType</a>|
|[stateCode_display](#stateCode_display)||<a href="EpisodeOfCareType.md" target="_blank">AdministrationEncounter/EpisodeOfCareType</a>|
|[statusCode](#statusCode)|Reason for the status of the Episode Of Care Type|<a href="EpisodeOfCareType.md" target="_blank">AdministrationEncounter/EpisodeOfCareType</a>|
|[statusCode_display](#statusCode_display)||<a href="EpisodeOfCareType.md" target="_blank">AdministrationEncounter/EpisodeOfCareType</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: AdministrationEncounter/EpisodeOfCareType (this entity)  
