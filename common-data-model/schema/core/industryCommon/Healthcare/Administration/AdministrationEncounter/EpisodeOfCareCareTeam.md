...
# Episode Of Care Care Team in AdministrationEncounter

The list of practitioners that may be facilitating this episode of care for specific purposes.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Administration/AdministrationEncounter/EpisodeOfCareCareTeam.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="EpisodeOfCareCareTeam.md" target="_blank">AdministrationEncounter/EpisodeOfCareCareTeam</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="EpisodeOfCareCareTeam.md" target="_blank">AdministrationEncounter/EpisodeOfCareCareTeam</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="EpisodeOfCareCareTeam.md" target="_blank">AdministrationEncounter/EpisodeOfCareCareTeam</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="EpisodeOfCareCareTeam.md" target="_blank">AdministrationEncounter/EpisodeOfCareCareTeam</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="EpisodeOfCareCareTeam.md" target="_blank">AdministrationEncounter/EpisodeOfCareCareTeam</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="EpisodeOfCareCareTeam.md" target="_blank">AdministrationEncounter/EpisodeOfCareCareTeam</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="EpisodeOfCareCareTeam.md" target="_blank">AdministrationEncounter/EpisodeOfCareCareTeam</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="EpisodeOfCareCareTeam.md" target="_blank">AdministrationEncounter/EpisodeOfCareCareTeam</a>|
|[ownerId](#ownerId)|Owner Id|<a href="EpisodeOfCareCareTeam.md" target="_blank">AdministrationEncounter/EpisodeOfCareCareTeam</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="EpisodeOfCareCareTeam.md" target="_blank">AdministrationEncounter/EpisodeOfCareCareTeam</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="EpisodeOfCareCareTeam.md" target="_blank">AdministrationEncounter/EpisodeOfCareCareTeam</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="EpisodeOfCareCareTeam.md" target="_blank">AdministrationEncounter/EpisodeOfCareCareTeam</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="EpisodeOfCareCareTeam.md" target="_blank">AdministrationEncounter/EpisodeOfCareCareTeam</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="EpisodeOfCareCareTeam.md" target="_blank">AdministrationEncounter/EpisodeOfCareCareTeam</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="EpisodeOfCareCareTeam.md" target="_blank">AdministrationEncounter/EpisodeOfCareCareTeam</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="EpisodeOfCareCareTeam.md" target="_blank">AdministrationEncounter/EpisodeOfCareCareTeam</a>|
|[careTeamMemberId](#careTeamMemberId)|The practitioner that is facilitating this episode of care for specific purposes.|<a href="EpisodeOfCareCareTeam.md" target="_blank">AdministrationEncounter/EpisodeOfCareCareTeam</a>|
|[episodeOfCareId](#episodeOfCareId)|An association between a patient and an organization / healthcare provider(s) during which time encounters may occur.|<a href="EpisodeOfCareCareTeam.md" target="_blank">AdministrationEncounter/EpisodeOfCareCareTeam</a>|
|[episodeOfCareCareTeamId](#episodeOfCareCareTeamId)|Unique identifier for entity instances|<a href="EpisodeOfCareCareTeam.md" target="_blank">AdministrationEncounter/EpisodeOfCareCareTeam</a>|
|[name](#name)|The name of the custom entity.|<a href="EpisodeOfCareCareTeam.md" target="_blank">AdministrationEncounter/EpisodeOfCareCareTeam</a>|
|[stateCode](#stateCode)|Status of the Episode Of Care Care Team|<a href="EpisodeOfCareCareTeam.md" target="_blank">AdministrationEncounter/EpisodeOfCareCareTeam</a>|
|[stateCode_display](#stateCode_display)||<a href="EpisodeOfCareCareTeam.md" target="_blank">AdministrationEncounter/EpisodeOfCareCareTeam</a>|
|[statusCode](#statusCode)|Reason for the status of the Episode Of Care Care Team|<a href="EpisodeOfCareCareTeam.md" target="_blank">AdministrationEncounter/EpisodeOfCareCareTeam</a>|
|[statusCode_display](#statusCode_display)||<a href="EpisodeOfCareCareTeam.md" target="_blank">AdministrationEncounter/EpisodeOfCareCareTeam</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: AdministrationEncounter/EpisodeOfCareCareTeam (this entity)  
