---
title: EncounterHospitalizationArrangement in AdministrationEncounter - Common Data Model | Microsoft Docs
...
# Encounter Hospitalization Arrangement in AdministrationEncounter
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="EncounterHospitalizationArrangement.md" target="_blank">AdministrationEncounter/EncounterHospitalizationArrangement</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="EncounterHospitalizationArrangement.md" target="_blank">AdministrationEncounter/EncounterHospitalizationArrangement</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="EncounterHospitalizationArrangement.md" target="_blank">AdministrationEncounter/EncounterHospitalizationArrangement</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="EncounterHospitalizationArrangement.md" target="_blank">AdministrationEncounter/EncounterHospitalizationArrangement</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="EncounterHospitalizationArrangement.md" target="_blank">AdministrationEncounter/EncounterHospitalizationArrangement</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="EncounterHospitalizationArrangement.md" target="_blank">AdministrationEncounter/EncounterHospitalizationArrangement</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="EncounterHospitalizationArrangement.md" target="_blank">AdministrationEncounter/EncounterHospitalizationArrangement</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="EncounterHospitalizationArrangement.md" target="_blank">AdministrationEncounter/EncounterHospitalizationArrangement</a>|
|[ownerId](#ownerId)|Owner Id|<a href="EncounterHospitalizationArrangement.md" target="_blank">AdministrationEncounter/EncounterHospitalizationArrangement</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="EncounterHospitalizationArrangement.md" target="_blank">AdministrationEncounter/EncounterHospitalizationArrangement</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="EncounterHospitalizationArrangement.md" target="_blank">AdministrationEncounter/EncounterHospitalizationArrangement</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="EncounterHospitalizationArrangement.md" target="_blank">AdministrationEncounter/EncounterHospitalizationArrangement</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="EncounterHospitalizationArrangement.md" target="_blank">AdministrationEncounter/EncounterHospitalizationArrangement</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="EncounterHospitalizationArrangement.md" target="_blank">AdministrationEncounter/EncounterHospitalizationArrangement</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="EncounterHospitalizationArrangement.md" target="_blank">AdministrationEncounter/EncounterHospitalizationArrangement</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="EncounterHospitalizationArrangement.md" target="_blank">AdministrationEncounter/EncounterHospitalizationArrangement</a>|
|[encounterId](#encounterId)|An interaction between a patient and healthcare provider(s) for the purpose of providing healthcare service(s) or assessing the health status of a patient.|<a href="EncounterHospitalizationArrangement.md" target="_blank">AdministrationEncounter/EncounterHospitalizationArrangement</a>|
|[encounterHospitalizationArrangementId](#encounterHospitalizationArrangementId)|Unique identifier for entity instances|<a href="EncounterHospitalizationArrangement.md" target="_blank">AdministrationEncounter/EncounterHospitalizationArrangement</a>|
|[name](#name)|The name of the custom entity.|<a href="EncounterHospitalizationArrangement.md" target="_blank">AdministrationEncounter/EncounterHospitalizationArrangement</a>|
|[specialArrangementIdentifierId](#specialArrangementIdentifierId)|Any special requests that have been made for this hospitalization encounter, such as the provision of specific equipment or other things.|<a href="EncounterHospitalizationArrangement.md" target="_blank">AdministrationEncounter/EncounterHospitalizationArrangement</a>|
|[stateCode](#stateCode)|Status of the Encounter Hospitalization Arrangement|<a href="EncounterHospitalizationArrangement.md" target="_blank">AdministrationEncounter/EncounterHospitalizationArrangement</a>|
|[stateCode_display](#stateCode_display)||<a href="EncounterHospitalizationArrangement.md" target="_blank">AdministrationEncounter/EncounterHospitalizationArrangement</a>|
|[statusCode](#statusCode)|Reason for the status of the Encounter Hospitalization Arrangement|<a href="EncounterHospitalizationArrangement.md" target="_blank">AdministrationEncounter/EncounterHospitalizationArrangement</a>|
|[statusCode_display](#statusCode_display)||<a href="EncounterHospitalizationArrangement.md" target="_blank">AdministrationEncounter/EncounterHospitalizationArrangement</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: AdministrationEncounter/EncounterHospitalizationArrangement (this entity)  
