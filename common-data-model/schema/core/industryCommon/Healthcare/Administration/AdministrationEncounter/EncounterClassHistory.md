...
# Encounter Class History in AdministrationEncounter

The class history permits the tracking of the encounters transitions without needing to go through the entity history.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Administration/AdministrationEncounter/EncounterClassHistory.cdm.json" target="_blank">GitHub</a>.  
...
- [/HealthcareFoundation/EncounterClassHistory](../../Foundational/HealthcareFoundation/EncounterClassHistory.md "/Healthcare/Foundational/HealthcareFoundation/EncounterClassHistory.cdm.json/EncounterClassHistory")  
</details>
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/Healthcare/Administration<br>/AdministrationEncounter<br>/EncounterClassHistory.cdm.json<br>/EncounterClassHistory/hasAttributes<br>/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[EncounterClassHistory/(resolvedAttributes)/encounterClassHistoryId](#encounterClassHistoryId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[EncounterClassHistory/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Encounter Class History</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>The class history permits the tracking of the encounters transitions without needing to go through the entity history.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_encounterclasshistory"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="EncounterClassHistory.md" target="_blank">AdministrationEncounter/EncounterClassHistory</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="EncounterClassHistory.md" target="_blank">AdministrationEncounter/EncounterClassHistory</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="EncounterClassHistory.md" target="_blank">AdministrationEncounter/EncounterClassHistory</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="EncounterClassHistory.md" target="_blank">AdministrationEncounter/EncounterClassHistory</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="EncounterClassHistory.md" target="_blank">AdministrationEncounter/EncounterClassHistory</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="EncounterClassHistory.md" target="_blank">AdministrationEncounter/EncounterClassHistory</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="EncounterClassHistory.md" target="_blank">AdministrationEncounter/EncounterClassHistory</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="EncounterClassHistory.md" target="_blank">AdministrationEncounter/EncounterClassHistory</a>|
|[ownerId](#ownerId)|Owner Id|<a href="EncounterClassHistory.md" target="_blank">AdministrationEncounter/EncounterClassHistory</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="EncounterClassHistory.md" target="_blank">AdministrationEncounter/EncounterClassHistory</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="EncounterClassHistory.md" target="_blank">AdministrationEncounter/EncounterClassHistory</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="EncounterClassHistory.md" target="_blank">AdministrationEncounter/EncounterClassHistory</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="EncounterClassHistory.md" target="_blank">AdministrationEncounter/EncounterClassHistory</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="EncounterClassHistory.md" target="_blank">AdministrationEncounter/EncounterClassHistory</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="EncounterClassHistory.md" target="_blank">AdministrationEncounter/EncounterClassHistory</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="EncounterClassHistory.md" target="_blank">AdministrationEncounter/EncounterClassHistory</a>|
|[encounterId](#encounterId)|An interaction between a patient and healthcare provider(s) for the purpose of providing healthcare service(s) or assessing the health status of a patient.|<a href="EncounterClassHistory.md" target="_blank">AdministrationEncounter/EncounterClassHistory</a>|
|[encounterClass](#encounterClass)|Refers to the class of encounter previously set|<a href="EncounterClassHistory.md" target="_blank">AdministrationEncounter/EncounterClassHistory</a>|
|[encounterClass_display](#encounterClass_display)||<a href="EncounterClassHistory.md" target="_blank">AdministrationEncounter/EncounterClassHistory</a>|
|[encounterClassEndDate](#encounterClassEndDate)|The time that the episode was in the specified class.|<a href="EncounterClassHistory.md" target="_blank">AdministrationEncounter/EncounterClassHistory</a>|
|[encounterClassHistoryId](#encounterClassHistoryId)|Unique identifier for entity instances|<a href="EncounterClassHistory.md" target="_blank">AdministrationEncounter/EncounterClassHistory</a>|
|[encounterClassStartDate](#encounterClassStartDate)|inpatient \| outpatient \| ambulatory \| emergency +.|<a href="EncounterClassHistory.md" target="_blank">AdministrationEncounter/EncounterClassHistory</a>|
|[name](#name)|The name of the custom entity.|<a href="EncounterClassHistory.md" target="_blank">AdministrationEncounter/EncounterClassHistory</a>|
|[stateCode](#stateCode)|Status of the Encounter Class History|<a href="EncounterClassHistory.md" target="_blank">AdministrationEncounter/EncounterClassHistory</a>|
|[stateCode_display](#stateCode_display)||<a href="EncounterClassHistory.md" target="_blank">AdministrationEncounter/EncounterClassHistory</a>|
|[statusCode](#statusCode)|Reason for the status of the Encounter Class History|<a href="EncounterClassHistory.md" target="_blank">AdministrationEncounter/EncounterClassHistory</a>|
|[statusCode_display](#statusCode_display)||<a href="EncounterClassHistory.md" target="_blank">AdministrationEncounter/EncounterClassHistory</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: AdministrationEncounter/EncounterClassHistory (this entity)  
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Refers to the class of encounter previously set</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
### <a href=#encounterClassEndDate name="encounterClassEndDate">encounterClassEndDate</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>End Date</td></tr><tr><td>description</td><td>The time that the episode was in the specified class.</td></tr><tr><td>dataFormat</td><td>dateTime</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_encounterclassenddate</td></tr></table>

#### Traits

<details>
<summary>List of traits for the encounterClassEndDate attribute are listed below.</summary>
...
**means.measurement.time**  
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_encounterclassenddate"</td><td>string</td><td></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>The time that the episode was in the specified class.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
### <a href=#encounterClassHistoryId name="encounterClassHistoryId">encounterClassHistoryId</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Encounter Class History</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>sourceName</td><td>msemr_encounterclasshistoryid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the encounterClassHistoryId attribute are listed below.</summary>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_encounterclasshistoryid"</td><td>string</td><td></td></tr></table>
...
<details>
<summary>List of traits for the encounterClassStartDate attribute are listed below.</summary>
...
**means.measurement.time**  
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_encounterclassstartdate"</td><td>string</td><td></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>inpatient | outpatient | ambulatory | emergency +.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
Status of the Encounter Class History  
First included in: AdministrationEncounter/EncounterClassHistory (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Encounter Class History</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the Encounter Class History</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
Reason for the status of the Encounter Class History  
First included in: AdministrationEncounter/EncounterClassHistory (this entity)  
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the Encounter Class History</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
