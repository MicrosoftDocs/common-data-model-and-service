...
# Encounter Account in AdministrationEncounter
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="EncounterAccount.md" target="_blank">AdministrationEncounter/EncounterAccount</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="EncounterAccount.md" target="_blank">AdministrationEncounter/EncounterAccount</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="EncounterAccount.md" target="_blank">AdministrationEncounter/EncounterAccount</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="EncounterAccount.md" target="_blank">AdministrationEncounter/EncounterAccount</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="EncounterAccount.md" target="_blank">AdministrationEncounter/EncounterAccount</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="EncounterAccount.md" target="_blank">AdministrationEncounter/EncounterAccount</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="EncounterAccount.md" target="_blank">AdministrationEncounter/EncounterAccount</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="EncounterAccount.md" target="_blank">AdministrationEncounter/EncounterAccount</a>|
|[ownerId](#ownerId)|Owner Id|<a href="EncounterAccount.md" target="_blank">AdministrationEncounter/EncounterAccount</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="EncounterAccount.md" target="_blank">AdministrationEncounter/EncounterAccount</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="EncounterAccount.md" target="_blank">AdministrationEncounter/EncounterAccount</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="EncounterAccount.md" target="_blank">AdministrationEncounter/EncounterAccount</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="EncounterAccount.md" target="_blank">AdministrationEncounter/EncounterAccount</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="EncounterAccount.md" target="_blank">AdministrationEncounter/EncounterAccount</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="EncounterAccount.md" target="_blank">AdministrationEncounter/EncounterAccount</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="EncounterAccount.md" target="_blank">AdministrationEncounter/EncounterAccount</a>|
|[encounterId](#encounterId)|An interaction between a patient and healthcare provider(s) for the purpose of providing healthcare service(s) or assessing the health status of a patient.|<a href="EncounterAccount.md" target="_blank">AdministrationEncounter/EncounterAccount</a>|
|[encounterAccountId](#encounterAccountId)|Unique identifier for entity instances|<a href="EncounterAccount.md" target="_blank">AdministrationEncounter/EncounterAccount</a>|
|[name](#name)|The name of the custom entity.|<a href="EncounterAccount.md" target="_blank">AdministrationEncounter/EncounterAccount</a>|
|[stateCode](#stateCode)|Status of the Encounter Account|<a href="EncounterAccount.md" target="_blank">AdministrationEncounter/EncounterAccount</a>|
|[stateCode_display](#stateCode_display)||<a href="EncounterAccount.md" target="_blank">AdministrationEncounter/EncounterAccount</a>|
|[statusCode](#statusCode)|Reason for the status of the Encounter Account|<a href="EncounterAccount.md" target="_blank">AdministrationEncounter/EncounterAccount</a>|
|[statusCode_display](#statusCode_display)||<a href="EncounterAccount.md" target="_blank">AdministrationEncounter/EncounterAccount</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: AdministrationEncounter/EncounterAccount (this entity)  
