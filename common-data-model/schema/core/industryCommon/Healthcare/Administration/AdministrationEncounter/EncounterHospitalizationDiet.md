...
# Encounter Hospitalization Diet in AdministrationEncounter
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="EncounterHospitalizationDiet.md" target="_blank">AdministrationEncounter/EncounterHospitalizationDiet</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="EncounterHospitalizationDiet.md" target="_blank">AdministrationEncounter/EncounterHospitalizationDiet</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="EncounterHospitalizationDiet.md" target="_blank">AdministrationEncounter/EncounterHospitalizationDiet</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="EncounterHospitalizationDiet.md" target="_blank">AdministrationEncounter/EncounterHospitalizationDiet</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="EncounterHospitalizationDiet.md" target="_blank">AdministrationEncounter/EncounterHospitalizationDiet</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="EncounterHospitalizationDiet.md" target="_blank">AdministrationEncounter/EncounterHospitalizationDiet</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="EncounterHospitalizationDiet.md" target="_blank">AdministrationEncounter/EncounterHospitalizationDiet</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="EncounterHospitalizationDiet.md" target="_blank">AdministrationEncounter/EncounterHospitalizationDiet</a>|
|[ownerId](#ownerId)|Owner Id|<a href="EncounterHospitalizationDiet.md" target="_blank">AdministrationEncounter/EncounterHospitalizationDiet</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="EncounterHospitalizationDiet.md" target="_blank">AdministrationEncounter/EncounterHospitalizationDiet</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="EncounterHospitalizationDiet.md" target="_blank">AdministrationEncounter/EncounterHospitalizationDiet</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="EncounterHospitalizationDiet.md" target="_blank">AdministrationEncounter/EncounterHospitalizationDiet</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="EncounterHospitalizationDiet.md" target="_blank">AdministrationEncounter/EncounterHospitalizationDiet</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="EncounterHospitalizationDiet.md" target="_blank">AdministrationEncounter/EncounterHospitalizationDiet</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="EncounterHospitalizationDiet.md" target="_blank">AdministrationEncounter/EncounterHospitalizationDiet</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="EncounterHospitalizationDiet.md" target="_blank">AdministrationEncounter/EncounterHospitalizationDiet</a>|
|[encounterId](#encounterId)|An interaction between a patient and healthcare provider(s) for the purpose of providing healthcare service(s) or assessing the health status of a patient.|<a href="EncounterHospitalizationDiet.md" target="_blank">AdministrationEncounter/EncounterHospitalizationDiet</a>|
|[encounterDietPreferenceId](#encounterDietPreferenceId)|Diet preferences reported by the patient|<a href="EncounterHospitalizationDiet.md" target="_blank">AdministrationEncounter/EncounterHospitalizationDiet</a>|
|[encounterHospitalizationDietId](#encounterHospitalizationDietId)|Unique identifier for entity instances|<a href="EncounterHospitalizationDiet.md" target="_blank">AdministrationEncounter/EncounterHospitalizationDiet</a>|
|[name](#name)|The name of the custom entity.|<a href="EncounterHospitalizationDiet.md" target="_blank">AdministrationEncounter/EncounterHospitalizationDiet</a>|
|[stateCode](#stateCode)|Status of the Encounter Hospitalization Diet|<a href="EncounterHospitalizationDiet.md" target="_blank">AdministrationEncounter/EncounterHospitalizationDiet</a>|
|[stateCode_display](#stateCode_display)||<a href="EncounterHospitalizationDiet.md" target="_blank">AdministrationEncounter/EncounterHospitalizationDiet</a>|
|[statusCode](#statusCode)|Reason for the status of the Encounter Hospitalization Diet|<a href="EncounterHospitalizationDiet.md" target="_blank">AdministrationEncounter/EncounterHospitalizationDiet</a>|
|[statusCode_display](#statusCode_display)||<a href="EncounterHospitalizationDiet.md" target="_blank">AdministrationEncounter/EncounterHospitalizationDiet</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: AdministrationEncounter/EncounterHospitalizationDiet (this entity)  
