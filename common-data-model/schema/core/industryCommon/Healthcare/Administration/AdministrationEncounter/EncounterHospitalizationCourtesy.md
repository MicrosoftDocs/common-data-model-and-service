---
title: EncounterHospitalizationCourtesy in AdministrationEncounter - Common Data Model | Microsoft Docs
...
# Encounter Hospitalization Courtesy in AdministrationEncounter

Special courtesies (VIP, board member).  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Administration/AdministrationEncounter/EncounterHospitalizationCourtesy.cdm.json" target="_blank">GitHub</a>.  
...
- [/HealthcareFoundation/EncounterHospitalizationCourtesy](../../Foundational/HealthcareFoundation/EncounterHospitalizationCourtesy.md "/Healthcare/Foundational/HealthcareFoundation/EncounterHospitalizationCourtesy.cdm.json/EncounterHospitalizationCourtesy")  
</details>
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/Healthcare/Administration<br>/AdministrationEncounter<br>/EncounterHospitalizationCourtesy.cdm.json<br>/EncounterHospitalizationCourtesy/hasAttributes<br>/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[EncounterHospitalizationCourtesy/(resolvedAttributes)/encounterHospitalizationCourtesyId](#encounterHospitalizationCourtesyId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[EncounterHospitalizationCourtesy/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Encounter Hospitalization Courtesy</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Special courtesies (VIP, board member).</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_encounterhospitalizationcourtesy"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="EncounterHospitalizationCourtesy.md" target="_blank">AdministrationEncounter/EncounterHospitalizationCourtesy</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="EncounterHospitalizationCourtesy.md" target="_blank">AdministrationEncounter/EncounterHospitalizationCourtesy</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="EncounterHospitalizationCourtesy.md" target="_blank">AdministrationEncounter/EncounterHospitalizationCourtesy</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="EncounterHospitalizationCourtesy.md" target="_blank">AdministrationEncounter/EncounterHospitalizationCourtesy</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="EncounterHospitalizationCourtesy.md" target="_blank">AdministrationEncounter/EncounterHospitalizationCourtesy</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="EncounterHospitalizationCourtesy.md" target="_blank">AdministrationEncounter/EncounterHospitalizationCourtesy</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="EncounterHospitalizationCourtesy.md" target="_blank">AdministrationEncounter/EncounterHospitalizationCourtesy</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="EncounterHospitalizationCourtesy.md" target="_blank">AdministrationEncounter/EncounterHospitalizationCourtesy</a>|
|[ownerId](#ownerId)|Owner Id|<a href="EncounterHospitalizationCourtesy.md" target="_blank">AdministrationEncounter/EncounterHospitalizationCourtesy</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="EncounterHospitalizationCourtesy.md" target="_blank">AdministrationEncounter/EncounterHospitalizationCourtesy</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="EncounterHospitalizationCourtesy.md" target="_blank">AdministrationEncounter/EncounterHospitalizationCourtesy</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="EncounterHospitalizationCourtesy.md" target="_blank">AdministrationEncounter/EncounterHospitalizationCourtesy</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="EncounterHospitalizationCourtesy.md" target="_blank">AdministrationEncounter/EncounterHospitalizationCourtesy</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="EncounterHospitalizationCourtesy.md" target="_blank">AdministrationEncounter/EncounterHospitalizationCourtesy</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="EncounterHospitalizationCourtesy.md" target="_blank">AdministrationEncounter/EncounterHospitalizationCourtesy</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="EncounterHospitalizationCourtesy.md" target="_blank">AdministrationEncounter/EncounterHospitalizationCourtesy</a>|
|[encounterId](#encounterId)|An interaction between a patient and healthcare provider(s) for the purpose of providing healthcare service(s) or assessing the health status of a patient.|<a href="EncounterHospitalizationCourtesy.md" target="_blank">AdministrationEncounter/EncounterHospitalizationCourtesy</a>|
|[encounterHospitalizationCourtesyId](#encounterHospitalizationCourtesyId)|Unique identifier for entity instances|<a href="EncounterHospitalizationCourtesy.md" target="_blank">AdministrationEncounter/EncounterHospitalizationCourtesy</a>|
|[name](#name)|The name of the custom entity.|<a href="EncounterHospitalizationCourtesy.md" target="_blank">AdministrationEncounter/EncounterHospitalizationCourtesy</a>|
|[specialCourtesyIdentifierId](#specialCourtesyIdentifierId)|Special courtesies (VIP, board member).|<a href="EncounterHospitalizationCourtesy.md" target="_blank">AdministrationEncounter/EncounterHospitalizationCourtesy</a>|
|[stateCode](#stateCode)|Status of the Encounter Hospitalization Courtesy|<a href="EncounterHospitalizationCourtesy.md" target="_blank">AdministrationEncounter/EncounterHospitalizationCourtesy</a>|
|[stateCode_display](#stateCode_display)||<a href="EncounterHospitalizationCourtesy.md" target="_blank">AdministrationEncounter/EncounterHospitalizationCourtesy</a>|
|[statusCode](#statusCode)|Reason for the status of the Encounter Hospitalization Courtesy|<a href="EncounterHospitalizationCourtesy.md" target="_blank">AdministrationEncounter/EncounterHospitalizationCourtesy</a>|
|[statusCode_display](#statusCode_display)||<a href="EncounterHospitalizationCourtesy.md" target="_blank">AdministrationEncounter/EncounterHospitalizationCourtesy</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: AdministrationEncounter/EncounterHospitalizationCourtesy (this entity)  
...
### <a href=#encounterHospitalizationCourtesyId name="encounterHospitalizationCourtesyId">encounterHospitalizationCourtesyId</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Encounter Hospitalization Courtesy</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>sourceName</td><td>msemr_encounterhospitalizationcourtesyid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the encounterHospitalizationCourtesyId attribute are listed below.</summary>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_encounterhospitalizationcourtesyid"</td><td>string</td><td></td></tr></table>
...
### <a href=#specialCourtesyIdentifierId name="specialCourtesyIdentifierId">specialCourtesyIdentifierId</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Special Courtesy</td></tr><tr><td>description</td><td>Special courtesies (VIP, board member).</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_specialcourtesyidentifier</td></tr></table>

#### Traits

<details>
<summary>List of traits for the specialCourtesyIdentifierId attribute are listed below.</summary>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Special Courtesy</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_specialcourtesyidentifier"</td><td>string</td><td></td></tr></table>
...
Status of the Encounter Hospitalization Courtesy  
First included in: AdministrationEncounter/EncounterHospitalizationCourtesy (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Encounter Hospitalization Courtesy</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the Encounter Hospitalization Courtesy</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
Reason for the status of the Encounter Hospitalization Courtesy  
First included in: AdministrationEncounter/EncounterHospitalizationCourtesy (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Encounter Hospitalization Courtesy</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the Encounter Hospitalization Courtesy</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
