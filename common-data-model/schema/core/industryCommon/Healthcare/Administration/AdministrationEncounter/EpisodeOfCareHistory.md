...
# Episode of Care History in AdministrationEncounter(EpisodeOfCareHistory)

The history of statuses that the Episode Of Care has been through (without requiring processing the history of the resource).  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Administration/AdministrationEncounter/EpisodeOfCareHistory.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/Healthcare/Administration<br>/AdministrationEncounter<br>/EpisodeOfCareHistory.cdm.json<br>/EpisodeOfCareHistory/hasAttributes<br>/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[EpisodeOfCareHistory/(resolvedAttributes)/episodeOfCareHistoryId](#episodeOfCareHistoryId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[EpisodeOfCareHistory/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Episode of Care History</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>The history of statuses that the Episode Of Care has been through (without requiring processing the history of the resource).</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_episodeofcarehistory"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="EpisodeOfCareHistory.md" target="_blank">AdministrationEncounter/EpisodeOfCareHistory</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="EpisodeOfCareHistory.md" target="_blank">AdministrationEncounter/EpisodeOfCareHistory</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="EpisodeOfCareHistory.md" target="_blank">AdministrationEncounter/EpisodeOfCareHistory</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="EpisodeOfCareHistory.md" target="_blank">AdministrationEncounter/EpisodeOfCareHistory</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="EpisodeOfCareHistory.md" target="_blank">AdministrationEncounter/EpisodeOfCareHistory</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="EpisodeOfCareHistory.md" target="_blank">AdministrationEncounter/EpisodeOfCareHistory</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="EpisodeOfCareHistory.md" target="_blank">AdministrationEncounter/EpisodeOfCareHistory</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="EpisodeOfCareHistory.md" target="_blank">AdministrationEncounter/EpisodeOfCareHistory</a>|
|[ownerId](#ownerId)|Owner Id|<a href="EpisodeOfCareHistory.md" target="_blank">AdministrationEncounter/EpisodeOfCareHistory</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="EpisodeOfCareHistory.md" target="_blank">AdministrationEncounter/EpisodeOfCareHistory</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="EpisodeOfCareHistory.md" target="_blank">AdministrationEncounter/EpisodeOfCareHistory</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="EpisodeOfCareHistory.md" target="_blank">AdministrationEncounter/EpisodeOfCareHistory</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="EpisodeOfCareHistory.md" target="_blank">AdministrationEncounter/EpisodeOfCareHistory</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="EpisodeOfCareHistory.md" target="_blank">AdministrationEncounter/EpisodeOfCareHistory</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="EpisodeOfCareHistory.md" target="_blank">AdministrationEncounter/EpisodeOfCareHistory</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="EpisodeOfCareHistory.md" target="_blank">AdministrationEncounter/EpisodeOfCareHistory</a>|
|[description](#description)|The name of the custom entity.|<a href="EpisodeOfCareHistory.md" target="_blank">AdministrationEncounter/EpisodeOfCareHistory</a>|
|[episodeOfCareId](#episodeOfCareId)|An association between a patient and an organization / healthcare provider(s) during which time encounters may occur.|<a href="EpisodeOfCareHistory.md" target="_blank">AdministrationEncounter/EpisodeOfCareHistory</a>|
|[episodeOfCareHistoryId](#episodeOfCareHistoryId)|Unique identifier for entity instances|<a href="EpisodeOfCareHistory.md" target="_blank">AdministrationEncounter/EpisodeOfCareHistory</a>|
|[periodEnd](#periodEnd)|The period during this EpisodeOfCare that the specific status applied.|<a href="EpisodeOfCareHistory.md" target="_blank">AdministrationEncounter/EpisodeOfCareHistory</a>|
|[periodStart](#periodStart)|The period during this EpisodeOfCare that the specific status applied.|<a href="EpisodeOfCareHistory.md" target="_blank">AdministrationEncounter/EpisodeOfCareHistory</a>|
|[status](#status)|Previous status of episode.|<a href="EpisodeOfCareHistory.md" target="_blank">AdministrationEncounter/EpisodeOfCareHistory</a>|
|[status_display](#status_display)||<a href="EpisodeOfCareHistory.md" target="_blank">AdministrationEncounter/EpisodeOfCareHistory</a>|
|[stateCode](#stateCode)|Status of the Episode of Care History|<a href="EpisodeOfCareHistory.md" target="_blank">AdministrationEncounter/EpisodeOfCareHistory</a>|
|[stateCode_display](#stateCode_display)||<a href="EpisodeOfCareHistory.md" target="_blank">AdministrationEncounter/EpisodeOfCareHistory</a>|
|[statusCode](#statusCode)|Reason for the status of the Episode of Care History|<a href="EpisodeOfCareHistory.md" target="_blank">AdministrationEncounter/EpisodeOfCareHistory</a>|
|[statusCode_display](#statusCode_display)||<a href="EpisodeOfCareHistory.md" target="_blank">AdministrationEncounter/EpisodeOfCareHistory</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: AdministrationEncounter/EpisodeOfCareHistory (this entity)  
...
### <a href=#episodeOfCareHistoryId name="episodeOfCareHistoryId">episodeOfCareHistoryId</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Episode of Care History</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>sourceName</td><td>msemr_episodeofcarehistoryid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the episodeOfCareHistoryId attribute are listed below.</summary>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_episodeofcarehistoryid"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Period End</td></tr><tr><td>description</td><td>The period during this EpisodeOfCare that the specific status applied.</td></tr><tr><td>dataFormat</td><td>dateTime</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_periodend</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>The period during this EpisodeOfCare that the specific status applied.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Previous status of episode.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
Status of the Episode of Care History  
First included in: AdministrationEncounter/EpisodeOfCareHistory (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Episode of Care History</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the Episode of Care History</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
Reason for the status of the Episode of Care History  
First included in: AdministrationEncounter/EpisodeOfCareHistory (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Episode of Care History</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the Episode of Care History</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
