---
title: EncounterReferralRequest in AdministrationEncounter - Common Data Model | Microsoft Docs
...
# Encounter Referral Request in AdministrationEncounter
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="EncounterReferralRequest.md" target="_blank">AdministrationEncounter/EncounterReferralRequest</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="EncounterReferralRequest.md" target="_blank">AdministrationEncounter/EncounterReferralRequest</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="EncounterReferralRequest.md" target="_blank">AdministrationEncounter/EncounterReferralRequest</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="EncounterReferralRequest.md" target="_blank">AdministrationEncounter/EncounterReferralRequest</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="EncounterReferralRequest.md" target="_blank">AdministrationEncounter/EncounterReferralRequest</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="EncounterReferralRequest.md" target="_blank">AdministrationEncounter/EncounterReferralRequest</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="EncounterReferralRequest.md" target="_blank">AdministrationEncounter/EncounterReferralRequest</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="EncounterReferralRequest.md" target="_blank">AdministrationEncounter/EncounterReferralRequest</a>|
|[ownerId](#ownerId)|Owner Id|<a href="EncounterReferralRequest.md" target="_blank">AdministrationEncounter/EncounterReferralRequest</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="EncounterReferralRequest.md" target="_blank">AdministrationEncounter/EncounterReferralRequest</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="EncounterReferralRequest.md" target="_blank">AdministrationEncounter/EncounterReferralRequest</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="EncounterReferralRequest.md" target="_blank">AdministrationEncounter/EncounterReferralRequest</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="EncounterReferralRequest.md" target="_blank">AdministrationEncounter/EncounterReferralRequest</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="EncounterReferralRequest.md" target="_blank">AdministrationEncounter/EncounterReferralRequest</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="EncounterReferralRequest.md" target="_blank">AdministrationEncounter/EncounterReferralRequest</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="EncounterReferralRequest.md" target="_blank">AdministrationEncounter/EncounterReferralRequest</a>|
|[encounterId](#encounterId)|An interaction between a patient and healthcare provider(s) for the purpose of providing healthcare service(s) or assessing the health status of a patient.|<a href="EncounterReferralRequest.md" target="_blank">AdministrationEncounter/EncounterReferralRequest</a>|
|[encounterReferralRequestId](#encounterReferralRequestId)|Unique identifier for entity instances|<a href="EncounterReferralRequest.md" target="_blank">AdministrationEncounter/EncounterReferralRequest</a>|
|[name](#name)|The name of the custom entity.|<a href="EncounterReferralRequest.md" target="_blank">AdministrationEncounter/EncounterReferralRequest</a>|
|[stateCode](#stateCode)|Status of the Encounter Referral Request|<a href="EncounterReferralRequest.md" target="_blank">AdministrationEncounter/EncounterReferralRequest</a>|
|[stateCode_display](#stateCode_display)||<a href="EncounterReferralRequest.md" target="_blank">AdministrationEncounter/EncounterReferralRequest</a>|
|[statusCode](#statusCode)|Reason for the status of the Encounter Referral Request|<a href="EncounterReferralRequest.md" target="_blank">AdministrationEncounter/EncounterReferralRequest</a>|
|[statusCode_display](#statusCode_display)||<a href="EncounterReferralRequest.md" target="_blank">AdministrationEncounter/EncounterReferralRequest</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: AdministrationEncounter/EncounterReferralRequest (this entity)  
