...
# Encounter Reason in AdministrationEncounter

Reason the encounter takes place, expressed as a code. For admissions, this can be used for a coded admission diagnosis.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Administration/AdministrationEncounter/EncounterReason.cdm.json" target="_blank">GitHub</a>.  
...
- [/HealthcareFoundation/EncounterReason](../../Foundational/HealthcareFoundation/EncounterReason.md "/Healthcare/Foundational/HealthcareFoundation/EncounterReason.cdm.json/EncounterReason")  
</details>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="EncounterReason.md" target="_blank">AdministrationEncounter/EncounterReason</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="EncounterReason.md" target="_blank">AdministrationEncounter/EncounterReason</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="EncounterReason.md" target="_blank">AdministrationEncounter/EncounterReason</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="EncounterReason.md" target="_blank">AdministrationEncounter/EncounterReason</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="EncounterReason.md" target="_blank">AdministrationEncounter/EncounterReason</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="EncounterReason.md" target="_blank">AdministrationEncounter/EncounterReason</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="EncounterReason.md" target="_blank">AdministrationEncounter/EncounterReason</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="EncounterReason.md" target="_blank">AdministrationEncounter/EncounterReason</a>|
|[ownerId](#ownerId)|Owner Id|<a href="EncounterReason.md" target="_blank">AdministrationEncounter/EncounterReason</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="EncounterReason.md" target="_blank">AdministrationEncounter/EncounterReason</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="EncounterReason.md" target="_blank">AdministrationEncounter/EncounterReason</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="EncounterReason.md" target="_blank">AdministrationEncounter/EncounterReason</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="EncounterReason.md" target="_blank">AdministrationEncounter/EncounterReason</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="EncounterReason.md" target="_blank">AdministrationEncounter/EncounterReason</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="EncounterReason.md" target="_blank">AdministrationEncounter/EncounterReason</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="EncounterReason.md" target="_blank">AdministrationEncounter/EncounterReason</a>|
|[code](#code)|Reason the encounter takes place, expressed as a code. For admissions, this can be used for a coded admission diagnosis.|<a href="EncounterReason.md" target="_blank">AdministrationEncounter/EncounterReason</a>|
|[display](#display)|The name of the custom entity.|<a href="EncounterReason.md" target="_blank">AdministrationEncounter/EncounterReason</a>|
|[encounterId](#encounterId)|An interaction between a patient and healthcare provider(s) for the purpose of providing healthcare service(s) or assessing the health status of a patient.|<a href="EncounterReason.md" target="_blank">AdministrationEncounter/EncounterReason</a>|
|[encounterReasonCodeId](#encounterReasonCodeId)|Reason the encounter takes place, expressed as a code. For admissions, this can be used for a coded admission diagnosis.|<a href="EncounterReason.md" target="_blank">AdministrationEncounter/EncounterReason</a>|
|[encounterReasonId](#encounterReasonId)|Unique identifier for entity instances|<a href="EncounterReason.md" target="_blank">AdministrationEncounter/EncounterReason</a>|
|[stateCode](#stateCode)|Status of the Encounter Reason|<a href="EncounterReason.md" target="_blank">AdministrationEncounter/EncounterReason</a>|
|[stateCode_display](#stateCode_display)||<a href="EncounterReason.md" target="_blank">AdministrationEncounter/EncounterReason</a>|
|[statusCode](#statusCode)|Reason for the status of the Encounter Reason|<a href="EncounterReason.md" target="_blank">AdministrationEncounter/EncounterReason</a>|
|[statusCode_display](#statusCode_display)||<a href="EncounterReason.md" target="_blank">AdministrationEncounter/EncounterReason</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: AdministrationEncounter/EncounterReason (this entity)  
