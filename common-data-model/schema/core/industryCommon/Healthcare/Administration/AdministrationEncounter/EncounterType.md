...
# Encounter Type in AdministrationEncounter

Specific type of encounter (e.g. e-mail consultation, surgical day-care, skilled nursing, rehabilitation).  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Administration/AdministrationEncounter/EncounterType.cdm.json" target="_blank">GitHub</a>.  
...
- [/HealthcareFoundation/EncounterType](../../Foundational/HealthcareFoundation/EncounterType.md "/Healthcare/Foundational/HealthcareFoundation/EncounterType.cdm.json/EncounterType")  
</details>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="EncounterType.md" target="_blank">AdministrationEncounter/EncounterType</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="EncounterType.md" target="_blank">AdministrationEncounter/EncounterType</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="EncounterType.md" target="_blank">AdministrationEncounter/EncounterType</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="EncounterType.md" target="_blank">AdministrationEncounter/EncounterType</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="EncounterType.md" target="_blank">AdministrationEncounter/EncounterType</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="EncounterType.md" target="_blank">AdministrationEncounter/EncounterType</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="EncounterType.md" target="_blank">AdministrationEncounter/EncounterType</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="EncounterType.md" target="_blank">AdministrationEncounter/EncounterType</a>|
|[ownerId](#ownerId)|Owner Id|<a href="EncounterType.md" target="_blank">AdministrationEncounter/EncounterType</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="EncounterType.md" target="_blank">AdministrationEncounter/EncounterType</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="EncounterType.md" target="_blank">AdministrationEncounter/EncounterType</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="EncounterType.md" target="_blank">AdministrationEncounter/EncounterType</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="EncounterType.md" target="_blank">AdministrationEncounter/EncounterType</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="EncounterType.md" target="_blank">AdministrationEncounter/EncounterType</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="EncounterType.md" target="_blank">AdministrationEncounter/EncounterType</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="EncounterType.md" target="_blank">AdministrationEncounter/EncounterType</a>|
|[encounterId](#encounterId)|An interaction between a patient and healthcare provider(s) for the purpose of providing healthcare service(s) or assessing the health status of a patient.|<a href="EncounterType.md" target="_blank">AdministrationEncounter/EncounterType</a>|
|[encounterTypeId](#encounterTypeId)|Unique identifier for entity instances|<a href="EncounterType.md" target="_blank">AdministrationEncounter/EncounterType</a>|
|[name](#name)|The name of the custom entity.|<a href="EncounterType.md" target="_blank">AdministrationEncounter/EncounterType</a>|
|[stateCode](#stateCode)|Status of the Encounter Type|<a href="EncounterType.md" target="_blank">AdministrationEncounter/EncounterType</a>|
|[stateCode_display](#stateCode_display)||<a href="EncounterType.md" target="_blank">AdministrationEncounter/EncounterType</a>|
|[statusCode](#statusCode)|Reason for the status of the Encounter Type|<a href="EncounterType.md" target="_blank">AdministrationEncounter/EncounterType</a>|
|[statusCode_display](#statusCode_display)||<a href="EncounterType.md" target="_blank">AdministrationEncounter/EncounterType</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: AdministrationEncounter/EncounterType (this entity)  
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_encountertypeid"</td><td>string</td><td></td></tr></table>
