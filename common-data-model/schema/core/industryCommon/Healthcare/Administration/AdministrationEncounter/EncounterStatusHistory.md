...
# Encounter Status History in AdministrationEncounter
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="EncounterStatusHistory.md" target="_blank">AdministrationEncounter/EncounterStatusHistory</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="EncounterStatusHistory.md" target="_blank">AdministrationEncounter/EncounterStatusHistory</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="EncounterStatusHistory.md" target="_blank">AdministrationEncounter/EncounterStatusHistory</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="EncounterStatusHistory.md" target="_blank">AdministrationEncounter/EncounterStatusHistory</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="EncounterStatusHistory.md" target="_blank">AdministrationEncounter/EncounterStatusHistory</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="EncounterStatusHistory.md" target="_blank">AdministrationEncounter/EncounterStatusHistory</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="EncounterStatusHistory.md" target="_blank">AdministrationEncounter/EncounterStatusHistory</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="EncounterStatusHistory.md" target="_blank">AdministrationEncounter/EncounterStatusHistory</a>|
|[ownerId](#ownerId)|Owner Id|<a href="EncounterStatusHistory.md" target="_blank">AdministrationEncounter/EncounterStatusHistory</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="EncounterStatusHistory.md" target="_blank">AdministrationEncounter/EncounterStatusHistory</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="EncounterStatusHistory.md" target="_blank">AdministrationEncounter/EncounterStatusHistory</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="EncounterStatusHistory.md" target="_blank">AdministrationEncounter/EncounterStatusHistory</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="EncounterStatusHistory.md" target="_blank">AdministrationEncounter/EncounterStatusHistory</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="EncounterStatusHistory.md" target="_blank">AdministrationEncounter/EncounterStatusHistory</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="EncounterStatusHistory.md" target="_blank">AdministrationEncounter/EncounterStatusHistory</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="EncounterStatusHistory.md" target="_blank">AdministrationEncounter/EncounterStatusHistory</a>|
|[encounterId](#encounterId)|An interaction between a patient and healthcare provider(s) for the purpose of providing healthcare service(s) or assessing the health status of a patient.|<a href="EncounterStatusHistory.md" target="_blank">AdministrationEncounter/EncounterStatusHistory</a>|
|[encounterStatus](#encounterStatus)|The status history permits the encounter resource to contain the status history without needing to read through the historical versions of the resource, or even have the server store them.|<a href="EncounterStatusHistory.md" target="_blank">AdministrationEncounter/EncounterStatusHistory</a>|
|[encounterStatus_display](#encounterStatus_display)||<a href="EncounterStatusHistory.md" target="_blank">AdministrationEncounter/EncounterStatusHistory</a>|
|[encounterStatusEndDate](#encounterStatusEndDate)|The time that the episode was in the specified status.|<a href="EncounterStatusHistory.md" target="_blank">AdministrationEncounter/EncounterStatusHistory</a>|
|[encounterStatusHistoryId](#encounterStatusHistoryId)|Unique identifier for entity instances|<a href="EncounterStatusHistory.md" target="_blank">AdministrationEncounter/EncounterStatusHistory</a>|
|[encounterStatusStartDate](#encounterStatusStartDate)|The time that the episode was in the specified status.|<a href="EncounterStatusHistory.md" target="_blank">AdministrationEncounter/EncounterStatusHistory</a>|
|[name](#name)|The name of the custom entity.|<a href="EncounterStatusHistory.md" target="_blank">AdministrationEncounter/EncounterStatusHistory</a>|
|[stateCode](#stateCode)|Status of the Encounter Status History|<a href="EncounterStatusHistory.md" target="_blank">AdministrationEncounter/EncounterStatusHistory</a>|
|[stateCode_display](#stateCode_display)||<a href="EncounterStatusHistory.md" target="_blank">AdministrationEncounter/EncounterStatusHistory</a>|
|[statusCode](#statusCode)|Reason for the status of the Encounter Status History|<a href="EncounterStatusHistory.md" target="_blank">AdministrationEncounter/EncounterStatusHistory</a>|
|[statusCode_display](#statusCode_display)||<a href="EncounterStatusHistory.md" target="_blank">AdministrationEncounter/EncounterStatusHistory</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: AdministrationEncounter/EncounterStatusHistory (this entity)  
