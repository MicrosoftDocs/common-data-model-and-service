---
title: DeviceStatus in AdministrationDevice - Common Data Model | Microsoft Docs
...
# Device Status in AdministrationDevice

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Administration/AdministrationDevice/DeviceStatus.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="DeviceStatus.md" target="_blank">AdministrationDevice/DeviceStatus</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="DeviceStatus.md" target="_blank">AdministrationDevice/DeviceStatus</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="DeviceStatus.md" target="_blank">AdministrationDevice/DeviceStatus</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="DeviceStatus.md" target="_blank">AdministrationDevice/DeviceStatus</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="DeviceStatus.md" target="_blank">AdministrationDevice/DeviceStatus</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="DeviceStatus.md" target="_blank">AdministrationDevice/DeviceStatus</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="DeviceStatus.md" target="_blank">AdministrationDevice/DeviceStatus</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="DeviceStatus.md" target="_blank">AdministrationDevice/DeviceStatus</a>|
|[ownerId](#ownerId)|Owner Id|<a href="DeviceStatus.md" target="_blank">AdministrationDevice/DeviceStatus</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="DeviceStatus.md" target="_blank">AdministrationDevice/DeviceStatus</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="DeviceStatus.md" target="_blank">AdministrationDevice/DeviceStatus</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="DeviceStatus.md" target="_blank">AdministrationDevice/DeviceStatus</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="DeviceStatus.md" target="_blank">AdministrationDevice/DeviceStatus</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="DeviceStatus.md" target="_blank">AdministrationDevice/DeviceStatus</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="DeviceStatus.md" target="_blank">AdministrationDevice/DeviceStatus</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="DeviceStatus.md" target="_blank">AdministrationDevice/DeviceStatus</a>|
|[code](#code)||<a href="DeviceStatus.md" target="_blank">AdministrationDevice/DeviceStatus</a>|
|[deviceStatusId](#deviceStatusId)|Unique identifier for entity instances|<a href="DeviceStatus.md" target="_blank">AdministrationDevice/DeviceStatus</a>|
|[display](#display)|The name of the custom entity.|<a href="DeviceStatus.md" target="_blank">AdministrationDevice/DeviceStatus</a>|
|[system](#system)||<a href="DeviceStatus.md" target="_blank">AdministrationDevice/DeviceStatus</a>|
|[stateCode](#stateCode)|Status of the Device Status|<a href="DeviceStatus.md" target="_blank">AdministrationDevice/DeviceStatus</a>|
|[stateCode_display](#stateCode_display)||<a href="DeviceStatus.md" target="_blank">AdministrationDevice/DeviceStatus</a>|
|[statusCode](#statusCode)|Reason for the status of the Device Status|<a href="DeviceStatus.md" target="_blank">AdministrationDevice/DeviceStatus</a>|
|[statusCode_display](#statusCode_display)||<a href="DeviceStatus.md" target="_blank">AdministrationDevice/DeviceStatus</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: AdministrationDevice/DeviceStatus (this entity)  
