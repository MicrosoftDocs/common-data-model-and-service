...
# Device Metric Type in AdministrationDevice

Describes the type of the metric. For example: Heart Rate, PEEP Setting, etc.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Administration/AdministrationDevice/DeviceMetricType.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/Healthcare/Administration/AdministrationDevice<br>/DeviceMetricType.cdm.json/DeviceMetricType<br>/hasAttributes/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[DeviceMetricType/(resolvedAttributes)/deviceMetricTypeId](#deviceMetricTypeId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[DeviceMetricType/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Device Metric Type</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_devicemetrictype"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="DeviceMetricType.md" target="_blank">AdministrationDevice/DeviceMetricType</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="DeviceMetricType.md" target="_blank">AdministrationDevice/DeviceMetricType</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="DeviceMetricType.md" target="_blank">AdministrationDevice/DeviceMetricType</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="DeviceMetricType.md" target="_blank">AdministrationDevice/DeviceMetricType</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="DeviceMetricType.md" target="_blank">AdministrationDevice/DeviceMetricType</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="DeviceMetricType.md" target="_blank">AdministrationDevice/DeviceMetricType</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="DeviceMetricType.md" target="_blank">AdministrationDevice/DeviceMetricType</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="DeviceMetricType.md" target="_blank">AdministrationDevice/DeviceMetricType</a>|
|[ownerId](#ownerId)|Owner Id|<a href="DeviceMetricType.md" target="_blank">AdministrationDevice/DeviceMetricType</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="DeviceMetricType.md" target="_blank">AdministrationDevice/DeviceMetricType</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="DeviceMetricType.md" target="_blank">AdministrationDevice/DeviceMetricType</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="DeviceMetricType.md" target="_blank">AdministrationDevice/DeviceMetricType</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="DeviceMetricType.md" target="_blank">AdministrationDevice/DeviceMetricType</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="DeviceMetricType.md" target="_blank">AdministrationDevice/DeviceMetricType</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="DeviceMetricType.md" target="_blank">AdministrationDevice/DeviceMetricType</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="DeviceMetricType.md" target="_blank">AdministrationDevice/DeviceMetricType</a>|
|[code](#code)||<a href="DeviceMetricType.md" target="_blank">AdministrationDevice/DeviceMetricType</a>|
|[deviceMetricTypeId](#deviceMetricTypeId)|Unique identifier for entity instances|<a href="DeviceMetricType.md" target="_blank">AdministrationDevice/DeviceMetricType</a>|
|[display](#display)|The name of the custom entity.|<a href="DeviceMetricType.md" target="_blank">AdministrationDevice/DeviceMetricType</a>|
|[system](#system)||<a href="DeviceMetricType.md" target="_blank">AdministrationDevice/DeviceMetricType</a>|
|[stateCode](#stateCode)|Status of the Device Metric Type|<a href="DeviceMetricType.md" target="_blank">AdministrationDevice/DeviceMetricType</a>|
|[stateCode_display](#stateCode_display)||<a href="DeviceMetricType.md" target="_blank">AdministrationDevice/DeviceMetricType</a>|
|[statusCode](#statusCode)|Reason for the status of the Device Metric Type|<a href="DeviceMetricType.md" target="_blank">AdministrationDevice/DeviceMetricType</a>|
|[statusCode_display](#statusCode_display)||<a href="DeviceMetricType.md" target="_blank">AdministrationDevice/DeviceMetricType</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: AdministrationDevice/DeviceMetricType (this entity)  
...
### <a href=#deviceMetricTypeId name="deviceMetricTypeId">deviceMetricTypeId</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Device Metric Type</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>sourceName</td><td>msemr_devicemetrictypeid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the deviceMetricTypeId attribute are listed below.</summary>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_devicemetrictypeid"</td><td>string</td><td></td></tr></table>
...
Status of the Device Metric Type  
First included in: AdministrationDevice/DeviceMetricType (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Device Metric Type</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the Device Metric Type</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
Reason for the status of the Device Metric Type  
First included in: AdministrationDevice/DeviceMetricType (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Device Metric Type</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the Device Metric Type</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
