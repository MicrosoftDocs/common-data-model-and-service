---
title: DeviceSafety in AdministrationDevice - Common Data Model | Microsoft Docs
...
# Device Safety in AdministrationDevice

Provides additional safety characteristics about a medical device. For example devices containing latex.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Administration/AdministrationDevice/DeviceSafety.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="DeviceSafety.md" target="_blank">AdministrationDevice/DeviceSafety</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="DeviceSafety.md" target="_blank">AdministrationDevice/DeviceSafety</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="DeviceSafety.md" target="_blank">AdministrationDevice/DeviceSafety</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="DeviceSafety.md" target="_blank">AdministrationDevice/DeviceSafety</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="DeviceSafety.md" target="_blank">AdministrationDevice/DeviceSafety</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="DeviceSafety.md" target="_blank">AdministrationDevice/DeviceSafety</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="DeviceSafety.md" target="_blank">AdministrationDevice/DeviceSafety</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="DeviceSafety.md" target="_blank">AdministrationDevice/DeviceSafety</a>|
|[ownerId](#ownerId)|Owner Id|<a href="DeviceSafety.md" target="_blank">AdministrationDevice/DeviceSafety</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="DeviceSafety.md" target="_blank">AdministrationDevice/DeviceSafety</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="DeviceSafety.md" target="_blank">AdministrationDevice/DeviceSafety</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="DeviceSafety.md" target="_blank">AdministrationDevice/DeviceSafety</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="DeviceSafety.md" target="_blank">AdministrationDevice/DeviceSafety</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="DeviceSafety.md" target="_blank">AdministrationDevice/DeviceSafety</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="DeviceSafety.md" target="_blank">AdministrationDevice/DeviceSafety</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="DeviceSafety.md" target="_blank">AdministrationDevice/DeviceSafety</a>|
|[deviceSafetyId](#deviceSafetyId)|Unique identifier for entity instances|<a href="DeviceSafety.md" target="_blank">AdministrationDevice/DeviceSafety</a>|
|[name](#name)|The name of the custom entity.|<a href="DeviceSafety.md" target="_blank">AdministrationDevice/DeviceSafety</a>|
|[stateCode](#stateCode)|Status of the Device Safety|<a href="DeviceSafety.md" target="_blank">AdministrationDevice/DeviceSafety</a>|
|[stateCode_display](#stateCode_display)||<a href="DeviceSafety.md" target="_blank">AdministrationDevice/DeviceSafety</a>|
|[statusCode](#statusCode)|Reason for the status of the Device Safety|<a href="DeviceSafety.md" target="_blank">AdministrationDevice/DeviceSafety</a>|
|[statusCode_display](#statusCode_display)||<a href="DeviceSafety.md" target="_blank">AdministrationDevice/DeviceSafety</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: AdministrationDevice/DeviceSafety (this entity)  
