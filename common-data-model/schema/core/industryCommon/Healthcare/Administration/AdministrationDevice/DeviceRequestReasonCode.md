---
title: DeviceRequestReasonCode in AdministrationDevice - Common Data Model | Microsoft Docs
...
# Device Request Reason Code in AdministrationDevice

Reason or justification for the use of this device.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Administration/AdministrationDevice/DeviceRequestReasonCode.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/Healthcare/Administration/AdministrationDevice<br>/DeviceRequestReasonCode.cdm.json<br>/DeviceRequestReasonCode/hasAttributes<br>/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[DeviceRequestReasonCode/(resolvedAttributes)/deviceRequestReasonCodeId](#deviceRequestReasonCodeId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[DeviceRequestReasonCode/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason or justification for the use of this device.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_devicerequestreasoncode"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="DeviceRequestReasonCode.md" target="_blank">AdministrationDevice/DeviceRequestReasonCode</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="DeviceRequestReasonCode.md" target="_blank">AdministrationDevice/DeviceRequestReasonCode</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="DeviceRequestReasonCode.md" target="_blank">AdministrationDevice/DeviceRequestReasonCode</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="DeviceRequestReasonCode.md" target="_blank">AdministrationDevice/DeviceRequestReasonCode</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="DeviceRequestReasonCode.md" target="_blank">AdministrationDevice/DeviceRequestReasonCode</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="DeviceRequestReasonCode.md" target="_blank">AdministrationDevice/DeviceRequestReasonCode</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="DeviceRequestReasonCode.md" target="_blank">AdministrationDevice/DeviceRequestReasonCode</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="DeviceRequestReasonCode.md" target="_blank">AdministrationDevice/DeviceRequestReasonCode</a>|
|[ownerId](#ownerId)|Owner Id|<a href="DeviceRequestReasonCode.md" target="_blank">AdministrationDevice/DeviceRequestReasonCode</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="DeviceRequestReasonCode.md" target="_blank">AdministrationDevice/DeviceRequestReasonCode</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="DeviceRequestReasonCode.md" target="_blank">AdministrationDevice/DeviceRequestReasonCode</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="DeviceRequestReasonCode.md" target="_blank">AdministrationDevice/DeviceRequestReasonCode</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="DeviceRequestReasonCode.md" target="_blank">AdministrationDevice/DeviceRequestReasonCode</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="DeviceRequestReasonCode.md" target="_blank">AdministrationDevice/DeviceRequestReasonCode</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="DeviceRequestReasonCode.md" target="_blank">AdministrationDevice/DeviceRequestReasonCode</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="DeviceRequestReasonCode.md" target="_blank">AdministrationDevice/DeviceRequestReasonCode</a>|
|[deviceRequestId](#deviceRequestId)|Identifier for Device Request|<a href="DeviceRequestReasonCode.md" target="_blank">AdministrationDevice/DeviceRequestReasonCode</a>|
|[deviceRequestReasonCodeId](#deviceRequestReasonCodeId)|Unique identifier for entity instances|<a href="DeviceRequestReasonCode.md" target="_blank">AdministrationDevice/DeviceRequestReasonCode</a>|
|[name](#name)|The name of the custom entity.|<a href="DeviceRequestReasonCode.md" target="_blank">AdministrationDevice/DeviceRequestReasonCode</a>|
|[reasonCodeId](#reasonCodeId)|Reason or justification for the use of this device.|<a href="DeviceRequestReasonCode.md" target="_blank">AdministrationDevice/DeviceRequestReasonCode</a>|
|[stateCode](#stateCode)|Status of the Device Request Reason Code|<a href="DeviceRequestReasonCode.md" target="_blank">AdministrationDevice/DeviceRequestReasonCode</a>|
|[stateCode_display](#stateCode_display)||<a href="DeviceRequestReasonCode.md" target="_blank">AdministrationDevice/DeviceRequestReasonCode</a>|
|[statusCode](#statusCode)|Reason for the status of the Device Request Reason Code|<a href="DeviceRequestReasonCode.md" target="_blank">AdministrationDevice/DeviceRequestReasonCode</a>|
|[statusCode_display](#statusCode_display)||<a href="DeviceRequestReasonCode.md" target="_blank">AdministrationDevice/DeviceRequestReasonCode</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: AdministrationDevice/DeviceRequestReasonCode (this entity)  
...
### <a href=#deviceRequestReasonCodeId name="deviceRequestReasonCodeId">deviceRequestReasonCodeId</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Device Request Reason Code</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>sourceName</td><td>msemr_devicerequestreasoncodeid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the deviceRequestReasonCodeId attribute are listed below.</summary>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_devicerequestreasoncodeid"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Reason Code</td></tr><tr><td>description</td><td>Reason or justification for the use of this device.</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_reasoncode</td></tr></table>
...
Status of the Device Request Reason Code  
First included in: AdministrationDevice/DeviceRequestReasonCode (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Device Request Reason Code</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
Reason for the status of the Device Request Reason Code  
First included in: AdministrationDevice/DeviceRequestReasonCode (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Device Request Reason Code</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
