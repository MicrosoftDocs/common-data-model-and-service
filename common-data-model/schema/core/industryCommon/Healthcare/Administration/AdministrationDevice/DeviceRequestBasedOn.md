---
title: DeviceRequestBasedOn in AdministrationDevice - Common Data Model | Microsoft Docs
...
# Device Request Based On in AdministrationDevice

Plan/proposal/order fulfilled by this request.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Administration/AdministrationDevice/DeviceRequestBasedOn.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="DeviceRequestBasedOn.md" target="_blank">AdministrationDevice/DeviceRequestBasedOn</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="DeviceRequestBasedOn.md" target="_blank">AdministrationDevice/DeviceRequestBasedOn</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="DeviceRequestBasedOn.md" target="_blank">AdministrationDevice/DeviceRequestBasedOn</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="DeviceRequestBasedOn.md" target="_blank">AdministrationDevice/DeviceRequestBasedOn</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="DeviceRequestBasedOn.md" target="_blank">AdministrationDevice/DeviceRequestBasedOn</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="DeviceRequestBasedOn.md" target="_blank">AdministrationDevice/DeviceRequestBasedOn</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="DeviceRequestBasedOn.md" target="_blank">AdministrationDevice/DeviceRequestBasedOn</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="DeviceRequestBasedOn.md" target="_blank">AdministrationDevice/DeviceRequestBasedOn</a>|
|[ownerId](#ownerId)|Owner Id|<a href="DeviceRequestBasedOn.md" target="_blank">AdministrationDevice/DeviceRequestBasedOn</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="DeviceRequestBasedOn.md" target="_blank">AdministrationDevice/DeviceRequestBasedOn</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="DeviceRequestBasedOn.md" target="_blank">AdministrationDevice/DeviceRequestBasedOn</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="DeviceRequestBasedOn.md" target="_blank">AdministrationDevice/DeviceRequestBasedOn</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="DeviceRequestBasedOn.md" target="_blank">AdministrationDevice/DeviceRequestBasedOn</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="DeviceRequestBasedOn.md" target="_blank">AdministrationDevice/DeviceRequestBasedOn</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="DeviceRequestBasedOn.md" target="_blank">AdministrationDevice/DeviceRequestBasedOn</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="DeviceRequestBasedOn.md" target="_blank">AdministrationDevice/DeviceRequestBasedOn</a>|
|[basedOn](#basedOn)|Plan/proposal/order fulfilled by this request.|<a href="DeviceRequestBasedOn.md" target="_blank">AdministrationDevice/DeviceRequestBasedOn</a>|
|[deviceRequestId](#deviceRequestId)|Identifier for Device Request|<a href="DeviceRequestBasedOn.md" target="_blank">AdministrationDevice/DeviceRequestBasedOn</a>|
|[deviceRequestBasedOnId](#deviceRequestBasedOnId)|Unique identifier for entity instances|<a href="DeviceRequestBasedOn.md" target="_blank">AdministrationDevice/DeviceRequestBasedOn</a>|
|[name](#name)|The name of the custom entity.|<a href="DeviceRequestBasedOn.md" target="_blank">AdministrationDevice/DeviceRequestBasedOn</a>|
|[stateCode](#stateCode)|Status of the Device Request Based On|<a href="DeviceRequestBasedOn.md" target="_blank">AdministrationDevice/DeviceRequestBasedOn</a>|
|[stateCode_display](#stateCode_display)||<a href="DeviceRequestBasedOn.md" target="_blank">AdministrationDevice/DeviceRequestBasedOn</a>|
|[statusCode](#statusCode)|Reason for the status of the Device Request Based On|<a href="DeviceRequestBasedOn.md" target="_blank">AdministrationDevice/DeviceRequestBasedOn</a>|
|[statusCode_display](#statusCode_display)||<a href="DeviceRequestBasedOn.md" target="_blank">AdministrationDevice/DeviceRequestBasedOn</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: AdministrationDevice/DeviceRequestBasedOn (this entity)  
