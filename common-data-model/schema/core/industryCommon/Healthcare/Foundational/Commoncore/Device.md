---
title: Device in Commoncore - Common Data Model | Microsoft Docs
...
This entity identifies an instance or a type of a manufactured item that is used in the provision of healthcare without being substantially changed through that activity.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Foundational/Commoncore/Device.cdm.json" target="_blank">GitHub</a>.  
...
- [/SyncAgentCDMUpdates/Device](../../AzureAPIforFHIRsupport/SyncAgentCDMUpdates/Device.md "/Healthcare/AzureAPIforFHIRsupport/SyncAgentCDMUpdates/Device.cdm.json/Device")  
</details>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="Device.md" target="_blank">Commoncore/Device</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="Device.md" target="_blank">Commoncore/Device</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="Device.md" target="_blank">Commoncore/Device</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="Device.md" target="_blank">Commoncore/Device</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="Device.md" target="_blank">Commoncore/Device</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="Device.md" target="_blank">Commoncore/Device</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="Device.md" target="_blank">Commoncore/Device</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="Device.md" target="_blank">Commoncore/Device</a>|
|[ownerId](#ownerId)|Owner Id|<a href="Device.md" target="_blank">Commoncore/Device</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="Device.md" target="_blank">Commoncore/Device</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="Device.md" target="_blank">Commoncore/Device</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="Device.md" target="_blank">Commoncore/Device</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="Device.md" target="_blank">Commoncore/Device</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="Device.md" target="_blank">Commoncore/Device</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="Device.md" target="_blank">Commoncore/Device</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="Device.md" target="_blank">Commoncore/Device</a>|
|[carrierAIDC](#carrierAIDC)|The full UDI carrier of the Automatic Identification and Data Capture (AIDC) technology representation of the bar code string as printed on the packaging of the device - E.g a bar code or RFID.|<a href="Device.md" target="_blank">Commoncore/Device</a>|
|[deviceId](#deviceId)|Unique identifier for entity instances|<a href="Device.md" target="_blank">Commoncore/Device</a>|
|[deviceNumber](#deviceNumber)|Unique instance identifiers assigned to a device by manufacturers other organizations or owners.|<a href="Device.md" target="_blank">Commoncore/Device</a>|
|[deviceStatus](#deviceStatus)|Status of the Device availability.|<a href="Device.md" target="_blank">Commoncore/Device</a>|
|[deviceStatus_display](#deviceStatus_display)||<a href="Device.md" target="_blank">Commoncore/Device</a>|
|[expirationDate](#expirationDate)|The date and time beyond which this device is no longer valid or should not be used (if applicable).|<a href="Device.md" target="_blank">Commoncore/Device</a>|
|[locationId](#locationId)|The place where the device can be found.|<a href="Device.md" target="_blank">Commoncore/Device</a>|
|[lotNumber](#lotNumber)|Lot number assigned by the manufacturer.|<a href="Device.md" target="_blank">Commoncore/Device</a>|
|[manufacturer](#manufacturer)|A name of the manufacturer.|<a href="Device.md" target="_blank">Commoncore/Device</a>|
|[manufacturerDate](#manufacturerDate)|The date and time when the device was manufactured.|<a href="Device.md" target="_blank">Commoncore/Device</a>|
|[model](#model)|The "model" is an identifier assigned by the manufacturer to identify the product by its type. This number is shared by the all devices sold as the same type.|<a href="Device.md" target="_blank">Commoncore/Device</a>|
|[name](#name)|The name of the custom entity.|<a href="Device.md" target="_blank">Commoncore/Device</a>|
|[patientId](#patientId)|Demographics and other administrative information about an individual or animal receiving care or other health-related services.|<a href="Device.md" target="_blank">Commoncore/Device</a>|
|[typeId](#typeId)|Code or identifier to identify a kind of device.|<a href="Device.md" target="_blank">Commoncore/Device</a>|
|[UDI](#UDI)|Unique device identifier (UDI) assigned to device label or package.|<a href="Device.md" target="_blank">Commoncore/Device</a>|
|[UDICarrierHRF](#UDICarrierHRF)|Unique device identifier (UDI) assigned to device label or package.|<a href="Device.md" target="_blank">Commoncore/Device</a>|
|[UDIEntryType](#UDIEntryType)|A coded entry to indicate how the data was entered.|<a href="Device.md" target="_blank">Commoncore/Device</a>|
|[UDIEntryType_display](#UDIEntryType_display)||<a href="Device.md" target="_blank">Commoncore/Device</a>|
|[UDIIssuer](#UDIIssuer)|Organization that is charged with issuing UDIs for devices|<a href="Device.md" target="_blank">Commoncore/Device</a>|
|[udiJurisdiction](#udiJurisdiction)|The identity of the authoritative source for UDI generation within a jurisdiction. All UDIs are globally unique within a single namespace with the appropriate repository uri as the system.|<a href="Device.md" target="_blank">Commoncore/Device</a>|
|[URL](#URL)|A network address on which the device may be contacted directly.|<a href="Device.md" target="_blank">Commoncore/Device</a>|
|[version](#version)|The version of the device, if the device has multiple releases under the same model, or if the device is software or carries firmware.|<a href="Device.md" target="_blank">Commoncore/Device</a>|
|[stateCode](#stateCode)|Status of the Device|<a href="Device.md" target="_blank">Commoncore/Device</a>|
|[stateCode_display](#stateCode_display)||<a href="Device.md" target="_blank">Commoncore/Device</a>|
|[statusCode](#statusCode)|Reason for the status of the Device|<a href="Device.md" target="_blank">Commoncore/Device</a>|
|[statusCode_display](#statusCode_display)||<a href="Device.md" target="_blank">Commoncore/Device</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: Commoncore/Device (this entity)  
