---
title: AccountType in Commoncore - Common Data Model | Microsoft Docs
...
# Account Type in Commoncore

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Foundational/Commoncore/AccountType.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="AccountType.md" target="_blank">Commoncore/AccountType</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="AccountType.md" target="_blank">Commoncore/AccountType</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="AccountType.md" target="_blank">Commoncore/AccountType</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="AccountType.md" target="_blank">Commoncore/AccountType</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="AccountType.md" target="_blank">Commoncore/AccountType</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="AccountType.md" target="_blank">Commoncore/AccountType</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="AccountType.md" target="_blank">Commoncore/AccountType</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="AccountType.md" target="_blank">Commoncore/AccountType</a>|
|[ownerId](#ownerId)|Owner Id|<a href="AccountType.md" target="_blank">Commoncore/AccountType</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="AccountType.md" target="_blank">Commoncore/AccountType</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="AccountType.md" target="_blank">Commoncore/AccountType</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="AccountType.md" target="_blank">Commoncore/AccountType</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="AccountType.md" target="_blank">Commoncore/AccountType</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="AccountType.md" target="_blank">Commoncore/AccountType</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="AccountType.md" target="_blank">Commoncore/AccountType</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="AccountType.md" target="_blank">Commoncore/AccountType</a>|
|[accountTypeId](#accountTypeId)|Unique identifier for entity instances|<a href="AccountType.md" target="_blank">Commoncore/AccountType</a>|
|[code](#code)||<a href="AccountType.md" target="_blank">Commoncore/AccountType</a>|
|[display](#display)|The name of the custom entity.|<a href="AccountType.md" target="_blank">Commoncore/AccountType</a>|
|[system](#system)||<a href="AccountType.md" target="_blank">Commoncore/AccountType</a>|
|[stateCode](#stateCode)|Status of the Account Type|<a href="AccountType.md" target="_blank">Commoncore/AccountType</a>|
|[stateCode_display](#stateCode_display)||<a href="AccountType.md" target="_blank">Commoncore/AccountType</a>|
|[statusCode](#statusCode)|Reason for the status of the Account Type|<a href="AccountType.md" target="_blank">Commoncore/AccountType</a>|
|[statusCode_display](#statusCode_display)||<a href="AccountType.md" target="_blank">Commoncore/AccountType</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: Commoncore/AccountType (this entity)  
