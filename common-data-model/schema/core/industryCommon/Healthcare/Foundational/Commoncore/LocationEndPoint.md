---
title: LocationEndPoint in Commoncore - Common Data Model | Microsoft Docs
...
# Location End Point in Commoncore

Technical endpoints providing access to services operated for the location.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Foundational/Commoncore/LocationEndPoint.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="LocationEndPoint.md" target="_blank">Commoncore/LocationEndPoint</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="LocationEndPoint.md" target="_blank">Commoncore/LocationEndPoint</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="LocationEndPoint.md" target="_blank">Commoncore/LocationEndPoint</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="LocationEndPoint.md" target="_blank">Commoncore/LocationEndPoint</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="LocationEndPoint.md" target="_blank">Commoncore/LocationEndPoint</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="LocationEndPoint.md" target="_blank">Commoncore/LocationEndPoint</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="LocationEndPoint.md" target="_blank">Commoncore/LocationEndPoint</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="LocationEndPoint.md" target="_blank">Commoncore/LocationEndPoint</a>|
|[ownerId](#ownerId)|Owner Id|<a href="LocationEndPoint.md" target="_blank">Commoncore/LocationEndPoint</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="LocationEndPoint.md" target="_blank">Commoncore/LocationEndPoint</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="LocationEndPoint.md" target="_blank">Commoncore/LocationEndPoint</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="LocationEndPoint.md" target="_blank">Commoncore/LocationEndPoint</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="LocationEndPoint.md" target="_blank">Commoncore/LocationEndPoint</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="LocationEndPoint.md" target="_blank">Commoncore/LocationEndPoint</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="LocationEndPoint.md" target="_blank">Commoncore/LocationEndPoint</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="LocationEndPoint.md" target="_blank">Commoncore/LocationEndPoint</a>|
|[locationId](#locationId)|Identifier for Location|<a href="LocationEndPoint.md" target="_blank">Commoncore/LocationEndPoint</a>|
|[locationEndpointId](#locationEndpointId)|Technical endpoints providing access to services operated for the location.|<a href="LocationEndPoint.md" target="_blank">Commoncore/LocationEndPoint</a>|
|[locationEndPointId](#locationEndPointId)|Unique identifier for entity instances|<a href="LocationEndPoint.md" target="_blank">Commoncore/LocationEndPoint</a>|
|[name](#name)|The name of the custom entity.|<a href="LocationEndPoint.md" target="_blank">Commoncore/LocationEndPoint</a>|
|[stateCode](#stateCode)|Status of the Location End Point|<a href="LocationEndPoint.md" target="_blank">Commoncore/LocationEndPoint</a>|
|[stateCode_display](#stateCode_display)||<a href="LocationEndPoint.md" target="_blank">Commoncore/LocationEndPoint</a>|
|[statusCode](#statusCode)|Reason for the status of the Location End Point|<a href="LocationEndPoint.md" target="_blank">Commoncore/LocationEndPoint</a>|
|[statusCode_display](#statusCode_display)||<a href="LocationEndPoint.md" target="_blank">Commoncore/LocationEndPoint</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: Commoncore/LocationEndPoint (this entity)  
...
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="Endpoint.md" target="_blank">/Healthcare/Foundational/Commoncore/Endpoint.cdm.json/Endpoint</a></td><td><a href="Endpoint.md#endpointId" target="_blank">endpointId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
