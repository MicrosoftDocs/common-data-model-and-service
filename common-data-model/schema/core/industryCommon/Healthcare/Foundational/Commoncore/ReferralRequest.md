...
# Referral Request in Commoncore

Used to record and send details about a request for referral service or transfer of a patient to the care of another provider or provider organization.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Foundational/Commoncore/ReferralRequest.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="ReferralRequest.md" target="_blank">Commoncore/ReferralRequest</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="ReferralRequest.md" target="_blank">Commoncore/ReferralRequest</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="ReferralRequest.md" target="_blank">Commoncore/ReferralRequest</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="ReferralRequest.md" target="_blank">Commoncore/ReferralRequest</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="ReferralRequest.md" target="_blank">Commoncore/ReferralRequest</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="ReferralRequest.md" target="_blank">Commoncore/ReferralRequest</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="ReferralRequest.md" target="_blank">Commoncore/ReferralRequest</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="ReferralRequest.md" target="_blank">Commoncore/ReferralRequest</a>|
|[ownerId](#ownerId)|Owner Id|<a href="ReferralRequest.md" target="_blank">Commoncore/ReferralRequest</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="ReferralRequest.md" target="_blank">Commoncore/ReferralRequest</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="ReferralRequest.md" target="_blank">Commoncore/ReferralRequest</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="ReferralRequest.md" target="_blank">Commoncore/ReferralRequest</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="ReferralRequest.md" target="_blank">Commoncore/ReferralRequest</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="ReferralRequest.md" target="_blank">Commoncore/ReferralRequest</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="ReferralRequest.md" target="_blank">Commoncore/ReferralRequest</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="ReferralRequest.md" target="_blank">Commoncore/ReferralRequest</a>|
|[appointmentEMRId](#appointmentEMRId)||<a href="ReferralRequest.md" target="_blank">Commoncore/ReferralRequest</a>|
|[authoredOn](#authoredOn)|Date/DateTime of creation for draft requests and date of activation for active requests.|<a href="ReferralRequest.md" target="_blank">Commoncore/ReferralRequest</a>|
|[basedOnReferralId](#basedOnReferralId)||<a href="ReferralRequest.md" target="_blank">Commoncore/ReferralRequest</a>|
|[contextType](#contextType)|The encounter at which the request for referral or transfer of care is initiated.|<a href="ReferralRequest.md" target="_blank">Commoncore/ReferralRequest</a>|
|[contextType_display](#contextType_display)||<a href="ReferralRequest.md" target="_blank">Commoncore/ReferralRequest</a>|
|[description](#description)|The reason element gives a short description of why the referral is being made, the description expands on this to support a more complete clinical summary.|<a href="ReferralRequest.md" target="_blank">Commoncore/ReferralRequest</a>|
|[groupIdentifier](#groupIdentifier)|The business identifier of the logical ""grouping"" request/order that this referral is a part of.|<a href="ReferralRequest.md" target="_blank">Commoncore/ReferralRequest</a>|
|[initiatingEncounterId](#initiatingEncounterId)||<a href="ReferralRequest.md" target="_blank">Commoncore/ReferralRequest</a>|
|[initiatingEpisodeOfCareId](#initiatingEpisodeOfCareId)||<a href="ReferralRequest.md" target="_blank">Commoncore/ReferralRequest</a>|
|[intent](#intent)|Distinguishes the "level" of authorization/demand implicit in this request.|<a href="ReferralRequest.md" target="_blank">Commoncore/ReferralRequest</a>|
|[intent_display](#intent_display)||<a href="ReferralRequest.md" target="_blank">Commoncore/ReferralRequest</a>|
|[name](#name)|The name of the custom entity.|<a href="ReferralRequest.md" target="_blank">Commoncore/ReferralRequest</a>|
|[occurencePeriodEndDate](#occurencePeriodEndDate)|End time with inclusive boundary, if not ongoing.|<a href="ReferralRequest.md" target="_blank">Commoncore/ReferralRequest</a>|
|[occurencePeriodStartDate](#occurencePeriodStartDate)|Starting time with inclusive boundary.|<a href="ReferralRequest.md" target="_blank">Commoncore/ReferralRequest</a>|
|[occurrenceDate](#occurrenceDate)|The period of time within which the services identified in the referral/transfer of care is specified or required to occur.|<a href="ReferralRequest.md" target="_blank">Commoncore/ReferralRequest</a>|
|[occurrenceType](#occurrenceType)|The type of the period of time within which the services identified in the referral/transfer of care is specified or required to occur.|<a href="ReferralRequest.md" target="_blank">Commoncore/ReferralRequest</a>|
|[occurrenceType_display](#occurrenceType_display)||<a href="ReferralRequest.md" target="_blank">Commoncore/ReferralRequest</a>|
|[practitionerSpecialtyId](#practitionerSpecialtyId)|Indication of the clinical domain or discipline to which the referral or transfer of care request is sent. For example: Cardiology Gastroenterology Diabetology.|<a href="ReferralRequest.md" target="_blank">Commoncore/ReferralRequest</a>|
|[priority](#priority)|An indication of the urgency of referral (or where applicable the type of transfer of care) request.|<a href="ReferralRequest.md" target="_blank">Commoncore/ReferralRequest</a>|
|[priority_display](#priority_display)||<a href="ReferralRequest.md" target="_blank">Commoncore/ReferralRequest</a>|
|[referralRequestId](#referralRequestId)|Unique identifier for entity instances|<a href="ReferralRequest.md" target="_blank">Commoncore/ReferralRequest</a>|
|[referralRequestNumber](#referralRequestNumber)|Business identifier that uniquely identifies the referral/care transfer request instance.|<a href="ReferralRequest.md" target="_blank">Commoncore/ReferralRequest</a>|
|[requesterAgent](#requesterAgent)|The device, practitioner, etc. who initiated the request.|<a href="ReferralRequest.md" target="_blank">Commoncore/ReferralRequest</a>|
|[requesterAgent_display](#requesterAgent_display)||<a href="ReferralRequest.md" target="_blank">Commoncore/ReferralRequest</a>|
|[requesterAgentDeviceId](#requesterAgentDeviceId)|This resource identifies an instance or a type of a manufactured item that is used in the provision of healthcare without being substantially changed through that activity.|<a href="ReferralRequest.md" target="_blank">Commoncore/ReferralRequest</a>|
|[requesterAgentOrganizationId](#requesterAgentOrganizationId)|A formally or informally recognized grouping of people or organizations formed for the purpose of achieving some form of collective action. Includes companies, institutions, corporations, departments.|<a href="ReferralRequest.md" target="_blank">Commoncore/ReferralRequest</a>|
|[requesterAgentPatientId](#requesterAgentPatientId)|Demographics and other administrative information about an individual or animal receiving care or other health-related services.|<a href="ReferralRequest.md" target="_blank">Commoncore/ReferralRequest</a>|
|[requesterAgentPractitionerId](#requesterAgentPractitionerId)|A person who is directly or indirectly involved in the provisioning of healthcare.|<a href="ReferralRequest.md" target="_blank">Commoncore/ReferralRequest</a>|
|[requesterAgentRelatedPersonId](#requesterAgentRelatedPersonId)|Information about a person that is involved in the care for a patient, but who is not the target of healthcare, nor has a formal responsibility in the care process.|<a href="ReferralRequest.md" target="_blank">Commoncore/ReferralRequest</a>|
|[requesterOnBehalfOfId](#requesterOnBehalfOfId)|This resource identifies an instance or a type of a manufactured item that is used in the provision of healthcare without being substantially changed through that activity.|<a href="ReferralRequest.md" target="_blank">Commoncore/ReferralRequest</a>|
|[requestorId](#requestorId)|Unique identifier of the requestor for the item.|<a href="ReferralRequest.md" target="_blank">Commoncore/ReferralRequest</a>|
|[type](#type)||<a href="ReferralRequest.md" target="_blank">Commoncore/ReferralRequest</a>|
|[status](#status)|The status of the authorization/intention reflected by the referral request record.|<a href="ReferralRequest.md" target="_blank">Commoncore/ReferralRequest</a>|
|[status_display](#status_display)||<a href="ReferralRequest.md" target="_blank">Commoncore/ReferralRequest</a>|
|[subject](#subject)|The patient who is the subject of a referral or transfer of care request.|<a href="ReferralRequest.md" target="_blank">Commoncore/ReferralRequest</a>|
|[subject_display](#subject_display)||<a href="ReferralRequest.md" target="_blank">Commoncore/ReferralRequest</a>|
|[subjectContextEncounterId](#subjectContextEncounterId)|An interaction between a patient and healthcare provider(s) for the purpose of providing healthcare service(s) or assessing the health status of a patient.|<a href="ReferralRequest.md" target="_blank">Commoncore/ReferralRequest</a>|
|[subjectContextEpisodeOfCareId](#subjectContextEpisodeOfCareId)|An association between a patient and an organization / healthcare provider(s) during which time encounters may occur.|<a href="ReferralRequest.md" target="_blank">Commoncore/ReferralRequest</a>|
|[subjectGroupId](#subjectGroupId)|Represents a defined collection of entities that may be discussed or acted upon collectively but which are not expected to act collectively and are not formally or legally recognized.|<a href="ReferralRequest.md" target="_blank">Commoncore/ReferralRequest</a>|
|[subjectPatientId](#subjectPatientId)|The patient who is the subject of a referral or transfer of care request.|<a href="ReferralRequest.md" target="_blank">Commoncore/ReferralRequest</a>|
|[typeId](#typeId)|An indication of the type of referral (or where applicable the type of transfer of care) request.|<a href="ReferralRequest.md" target="_blank">Commoncore/ReferralRequest</a>|
|[stateCode](#stateCode)|Status of the Referral Request|<a href="ReferralRequest.md" target="_blank">Commoncore/ReferralRequest</a>|
|[stateCode_display](#stateCode_display)||<a href="ReferralRequest.md" target="_blank">Commoncore/ReferralRequest</a>|
|[statusCode](#statusCode)|Reason for the status of the Referral Request|<a href="ReferralRequest.md" target="_blank">Commoncore/ReferralRequest</a>|
|[statusCode_display](#statusCode_display)||<a href="ReferralRequest.md" target="_blank">Commoncore/ReferralRequest</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: Commoncore/ReferralRequest (this entity)  
