---
title: Condition in Commoncore - Common Data Model | Microsoft Docs
...
# Condition in Commoncore

A clinical condition, problem, diagnosis, or other event, situation, issue, or clinical concept that has risen to a level of concern.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Foundational/Commoncore/Condition.cdm.json" target="_blank">GitHub</a>.  
...
- [/SyncAgentCDMUpdates/Condition](../../AzureAPIforFHIRsupport/SyncAgentCDMUpdates/Condition.md "/Healthcare/AzureAPIforFHIRsupport/SyncAgentCDMUpdates/Condition.cdm.json/Condition")  
- [/HealthcareFoundation/Condition](../HealthcareFoundation/Condition.md "/Healthcare/Foundational/HealthcareFoundation/Condition.cdm.json/Condition")  
</details>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="Condition.md" target="_blank">Commoncore/Condition</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="Condition.md" target="_blank">Commoncore/Condition</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="Condition.md" target="_blank">Commoncore/Condition</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="Condition.md" target="_blank">Commoncore/Condition</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="Condition.md" target="_blank">Commoncore/Condition</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="Condition.md" target="_blank">Commoncore/Condition</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="Condition.md" target="_blank">Commoncore/Condition</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="Condition.md" target="_blank">Commoncore/Condition</a>|
|[ownerId](#ownerId)|Owner Id|<a href="Condition.md" target="_blank">Commoncore/Condition</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="Condition.md" target="_blank">Commoncore/Condition</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="Condition.md" target="_blank">Commoncore/Condition</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="Condition.md" target="_blank">Commoncore/Condition</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="Condition.md" target="_blank">Commoncore/Condition</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="Condition.md" target="_blank">Commoncore/Condition</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="Condition.md" target="_blank">Commoncore/Condition</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="Condition.md" target="_blank">Commoncore/Condition</a>|
|[abatementAge](#abatementAge)|The date or estimated date that the condition resolved or went into remission. This is called "abatement" because of the many overloaded connotations associated with "remission" or "resolution" -|<a href="Condition.md" target="_blank">Commoncore/Condition</a>|
|[abatementDate](#abatementDate)|The date or estimated date that the condition resolved or went into remission. This is called "abatement" because of the many overloaded connotations associated with "remission" or "resolution"|<a href="Condition.md" target="_blank">Commoncore/Condition</a>|
|[abatementPeriodEndDate](#abatementPeriodEndDate)|The date or estimated date that the condition resolved or went into remission. This is called "abatement" because of the many overloaded connotations associated with "remission" or "resolution"|<a href="Condition.md" target="_blank">Commoncore/Condition</a>|
|[abatementPeriodStartDate](#abatementPeriodStartDate)|The date or estimated date that the condition resolved or went into remission. This is called "abatement" because of the many overloaded connotations associated with "remission" or "resolution"|<a href="Condition.md" target="_blank">Commoncore/Condition</a>|
|[abatementRangeHigh](#abatementRangeHigh)|The date or estimated date that the condition resolved or went into remission. This is called "abatement" because of the many overloaded connotations associated with "remission" or "resolution"|<a href="Condition.md" target="_blank">Commoncore/Condition</a>|
|[abatementRangeLow](#abatementRangeLow)|The date or estimated date that the condition resolved or went into remission. This is called "abatement" because of the many overloaded connotations associated with "remission" or "resolution"|<a href="Condition.md" target="_blank">Commoncore/Condition</a>|
|[abatementString](#abatementString)|The date or estimated date that the condition resolved or went into remission. This is called "abatement" because of the many overloaded connotations associated with "remission" or "resolution"|<a href="Condition.md" target="_blank">Commoncore/Condition</a>|
|[abatementType](#abatementType)|Type of: The date or estimated date that the condition resolved or went into remission. This is called "abatement" because of the many overloaded connotations associated with "remission"/resolution.|<a href="Condition.md" target="_blank">Commoncore/Condition</a>|
|[abatementType_display](#abatementType_display)||<a href="Condition.md" target="_blank">Commoncore/Condition</a>|
|[appointmentId](#appointmentId)|A booking of a healthcare event among patient(s), practitioner(s), related person(s) and/or device(s) for a specific date/time. This may result in one or more Encounter(s).|<a href="Condition.md" target="_blank">Commoncore/Condition</a>|
|[assertedDate](#assertedDate)|The date on which the existence of the Condition was first asserted or acknowledged.|<a href="Condition.md" target="_blank">Commoncore/Condition</a>|
|[asserterId](#asserterId)|Person who asserts this condition|<a href="Condition.md" target="_blank">Commoncore/Condition</a>|
|[carePlanId](#carePlanId)|Describes the intention of how one or more practitioners intend to deliver care for a particular patient, group or community for a period of time, possibly limited to care for a specific condition.|<a href="Condition.md" target="_blank">Commoncore/Condition</a>|
|[categoryId](#categoryId)|Categorization of the condition recorded by health care practitioner.|<a href="Condition.md" target="_blank">Commoncore/Condition</a>|
|[clinicalStatus](#clinicalStatus)|The clinical status of the condition.|<a href="Condition.md" target="_blank">Commoncore/Condition</a>|
|[clinicalStatus_display](#clinicalStatus_display)||<a href="Condition.md" target="_blank">Commoncore/Condition</a>|
|[conditionCodeId](#conditionCodeId)|List of diagnosis/condition codes|<a href="Condition.md" target="_blank">Commoncore/Condition</a>|
|[conditionId](#conditionId)|Unique identifier for entity instances|<a href="Condition.md" target="_blank">Commoncore/Condition</a>|
|[contextEncounterId](#contextEncounterId)|Categorization of the condition recorded by health care practitioner.|<a href="Condition.md" target="_blank">Commoncore/Condition</a>|
|[contextEpisodeOfCareId](#contextEpisodeOfCareId)|Encounter or episode when condition first asserted|<a href="Condition.md" target="_blank">Commoncore/Condition</a>|
|[contextType](#contextType)|Type of: Encounter during which the condition was first asserted.|<a href="Condition.md" target="_blank">Commoncore/Condition</a>|
|[contextType_display](#contextType_display)||<a href="Condition.md" target="_blank">Commoncore/Condition</a>|
|[encounterId](#encounterId)|An interaction between a patient and healthcare provider(s) for the purpose of providing healthcare service(s) or assessing the health status of a patient.|<a href="Condition.md" target="_blank">Commoncore/Condition</a>|
|[isAbatement](#isAbatement)|The date or estimated date that the condition resolved or went into remission. This is called "abatement" because of the many overloaded connotations associated with "remission" or "resolution"|<a href="Condition.md" target="_blank">Commoncore/Condition</a>|
|[name](#name)|The name of the custom entity.|<a href="Condition.md" target="_blank">Commoncore/Condition</a>|
|[onsetAge](#onsetAge)|Estimated or actual date or date-time the condition began, in the opinion of the clinician.|<a href="Condition.md" target="_blank">Commoncore/Condition</a>|
|[onsetDate](#onsetDate)|Estimated or actual date or date-time the condition began, in the opinion of the clinician.|<a href="Condition.md" target="_blank">Commoncore/Condition</a>|
|[onsetPeriodEndDate](#onsetPeriodEndDate)|Estimated or actual date or date-time the condition began, in the opinion of the clinician.|<a href="Condition.md" target="_blank">Commoncore/Condition</a>|
|[onsetPeriodStartDate](#onsetPeriodStartDate)|Estimated or actual date or date-time the condition began, in the opinion of the clinician.|<a href="Condition.md" target="_blank">Commoncore/Condition</a>|
|[onsetRangeHigh](#onsetRangeHigh)|Estimated or actual date or date-time the condition began, in the opinion of the clinician.|<a href="Condition.md" target="_blank">Commoncore/Condition</a>|
|[onsetRangeLow](#onsetRangeLow)|Estimated or actual date or date-time the condition began, in the opinion of the clinician.|<a href="Condition.md" target="_blank">Commoncore/Condition</a>|
|[onsetString](#onsetString)|Estimated or actual date or date-time the condition began, in the opinion of the clinician.|<a href="Condition.md" target="_blank">Commoncore/Condition</a>|
|[onsetType](#onsetType)|Type of: Estimated or actual date or date-time the condition began, in the opinion of the clinician.|<a href="Condition.md" target="_blank">Commoncore/Condition</a>|
|[onsetType_display](#onsetType_display)||<a href="Condition.md" target="_blank">Commoncore/Condition</a>|
|[practitionerId](#practitionerId)|Individual who is making the condition statement.|<a href="Condition.md" target="_blank">Commoncore/Condition</a>|
|[reasonReferenceReferralRequestId](#reasonReferenceReferralRequestId)||<a href="Condition.md" target="_blank">Commoncore/Condition</a>|
|[severityId](#severityId)|Grading  of the severity of the condition recorded|<a href="Condition.md" target="_blank">Commoncore/Condition</a>|
|[stageId](#stageId)|Specific stage of condition|<a href="Condition.md" target="_blank">Commoncore/Condition</a>|
|[subjectType](#subjectType)|Type of: Indicates the patient or group who the condition record is associated with.|<a href="Condition.md" target="_blank">Commoncore/Condition</a>|
|[subjectType_display](#subjectType_display)||<a href="Condition.md" target="_blank">Commoncore/Condition</a>|
|[subjectTypeGroupId](#subjectTypeGroupId)|Indicates the patient or group who the condition record is associated with.|<a href="Condition.md" target="_blank">Commoncore/Condition</a>|
|[subjectTypePatientId](#subjectTypePatientId)|Indicates the patient or group who the condition record is associated with.|<a href="Condition.md" target="_blank">Commoncore/Condition</a>|
|[verificationStatus](#verificationStatus)|Type of: The verification status to support the clinical status of the condition.|<a href="Condition.md" target="_blank">Commoncore/Condition</a>|
|[verificationStatus_display](#verificationStatus_display)||<a href="Condition.md" target="_blank">Commoncore/Condition</a>|
|[stateCode](#stateCode)|Status of the Condition|<a href="Condition.md" target="_blank">Commoncore/Condition</a>|
|[stateCode_display](#stateCode_display)||<a href="Condition.md" target="_blank">Commoncore/Condition</a>|
|[statusCode](#statusCode)|Reason for the status of the Condition|<a href="Condition.md" target="_blank">Commoncore/Condition</a>|
|[statusCode_display](#statusCode_display)||<a href="Condition.md" target="_blank">Commoncore/Condition</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: Commoncore/Condition (this entity)  
...
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="Encounter.md" target="_blank">/Healthcare/Foundational/Commoncore/Encounter.cdm.json/Encounter</a></td><td><a href="Encounter.md#encounterId" target="_blank">encounterId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
...
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="EpisodeOfCare.md" target="_blank">/Healthcare/Foundational/Commoncore/EpisodeOfCare.cdm.json/EpisodeOfCare</a></td><td><a href="EpisodeOfCare.md#episodeOfCareId" target="_blank">episodeOfCareId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
...
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="ReferralRequest.md" target="_blank">/Healthcare/Foundational/Commoncore/ReferralRequest.cdm.json/ReferralRequest</a></td><td><a href="ReferralRequest.md#referralRequestId" target="_blank">referralRequestId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
