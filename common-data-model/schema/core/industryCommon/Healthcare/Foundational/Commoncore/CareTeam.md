---
title: CareTeam in Commoncore - Common Data Model | Microsoft Docs
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="CareTeam.md" target="_blank">Commoncore/CareTeam</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="CareTeam.md" target="_blank">Commoncore/CareTeam</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="CareTeam.md" target="_blank">Commoncore/CareTeam</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="CareTeam.md" target="_blank">Commoncore/CareTeam</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="CareTeam.md" target="_blank">Commoncore/CareTeam</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="CareTeam.md" target="_blank">Commoncore/CareTeam</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="CareTeam.md" target="_blank">Commoncore/CareTeam</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="CareTeam.md" target="_blank">Commoncore/CareTeam</a>|
|[ownerId](#ownerId)|Owner Id|<a href="CareTeam.md" target="_blank">Commoncore/CareTeam</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="CareTeam.md" target="_blank">Commoncore/CareTeam</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="CareTeam.md" target="_blank">Commoncore/CareTeam</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="CareTeam.md" target="_blank">Commoncore/CareTeam</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="CareTeam.md" target="_blank">Commoncore/CareTeam</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="CareTeam.md" target="_blank">Commoncore/CareTeam</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="CareTeam.md" target="_blank">Commoncore/CareTeam</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="CareTeam.md" target="_blank">Commoncore/CareTeam</a>|
|[entityImage](#entityImage)|The image of the record|<a href="CareTeam.md" target="_blank">Commoncore/CareTeam</a>|
|[careTeamId](#careTeamId)|Unique identifier for entity instances|<a href="CareTeam.md" target="_blank">Commoncore/CareTeam</a>|
|[careTeamNumber](#careTeamNumber)|This records identifiers associated with this care team that are defined by business processes and/or used to refer to it when a direct URL reference to the resource itself is not appropriate.|<a href="CareTeam.md" target="_blank">Commoncore/CareTeam</a>|
|[careTeamStatus](#careTeamStatus)|Indicates the current state of the care team.|<a href="CareTeam.md" target="_blank">Commoncore/CareTeam</a>|
|[careTeamStatus_display](#careTeamStatus_display)||<a href="CareTeam.md" target="_blank">Commoncore/CareTeam</a>|
|[contextType](#contextType)|The encounter or episode of care that establishes the context for this care team.|<a href="CareTeam.md" target="_blank">Commoncore/CareTeam</a>|
|[contextType_display](#contextType_display)||<a href="CareTeam.md" target="_blank">Commoncore/CareTeam</a>|
|[encounterId](#encounterId)|The encounter or episode of care that establishes the context for this care team.|<a href="CareTeam.md" target="_blank">Commoncore/CareTeam</a>|
|[episodeOfCareId](#episodeOfCareId)|The encounter or episode of care that establishes the context for this care team.|<a href="CareTeam.md" target="_blank">Commoncore/CareTeam</a>|
|[name](#name)|The name of the custom entity.|<a href="CareTeam.md" target="_blank">Commoncore/CareTeam</a>|
|[periodEnd](#periodEnd)|Indicates when the team did (or is intended to) come into effect and end.|<a href="CareTeam.md" target="_blank">Commoncore/CareTeam</a>|
|[periodStart](#periodStart)|Indicates when the team did (or is intended to) come into effect and end.|<a href="CareTeam.md" target="_blank">Commoncore/CareTeam</a>|
|[subjectGroupId](#subjectGroupId)|Subject is group|<a href="CareTeam.md" target="_blank">Commoncore/CareTeam</a>|
|[subjectPatientId](#subjectPatientId)|Subject is patient|<a href="CareTeam.md" target="_blank">Commoncore/CareTeam</a>|
|[subjectType](#subjectType)|Identifies the patient or group whose intended care is handled by the team.|<a href="CareTeam.md" target="_blank">Commoncore/CareTeam</a>|
|[subjectType_display](#subjectType_display)||<a href="CareTeam.md" target="_blank">Commoncore/CareTeam</a>|
|[stateCode](#stateCode)|Status of the Care Team|<a href="CareTeam.md" target="_blank">Commoncore/CareTeam</a>|
|[stateCode_display](#stateCode_display)||<a href="CareTeam.md" target="_blank">Commoncore/CareTeam</a>|
|[statusCode](#statusCode)|Reason for the status of the Care Team|<a href="CareTeam.md" target="_blank">Commoncore/CareTeam</a>|
|[statusCode_display](#statusCode_display)||<a href="CareTeam.md" target="_blank">Commoncore/CareTeam</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: Commoncore/CareTeam (this entity)  
