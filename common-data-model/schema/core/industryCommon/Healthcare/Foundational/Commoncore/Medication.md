---
title: Medication in Commoncore - Common Data Model | Microsoft Docs
...
# Medication in Commoncore

Medications  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Foundational/Commoncore/Medication.cdm.json" target="_blank">GitHub</a>.  
...
- [/SyncAgentCDMUpdates/Medication](../../AzureAPIforFHIRsupport/SyncAgentCDMUpdates/Medication.md "/Healthcare/AzureAPIforFHIRsupport/SyncAgentCDMUpdates/Medication.cdm.json/Medication")  
</details>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="Medication.md" target="_blank">Commoncore/Medication</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="Medication.md" target="_blank">Commoncore/Medication</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="Medication.md" target="_blank">Commoncore/Medication</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="Medication.md" target="_blank">Commoncore/Medication</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="Medication.md" target="_blank">Commoncore/Medication</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="Medication.md" target="_blank">Commoncore/Medication</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="Medication.md" target="_blank">Commoncore/Medication</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="Medication.md" target="_blank">Commoncore/Medication</a>|
|[ownerId](#ownerId)|Owner Id|<a href="Medication.md" target="_blank">Commoncore/Medication</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="Medication.md" target="_blank">Commoncore/Medication</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="Medication.md" target="_blank">Commoncore/Medication</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="Medication.md" target="_blank">Commoncore/Medication</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="Medication.md" target="_blank">Commoncore/Medication</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="Medication.md" target="_blank">Commoncore/Medication</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="Medication.md" target="_blank">Commoncore/Medication</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="Medication.md" target="_blank">Commoncore/Medication</a>|
|[amount](#amount)||<a href="Medication.md" target="_blank">Commoncore/Medication</a>|
|[codeId](#codeId)||<a href="Medication.md" target="_blank">Commoncore/Medication</a>|
|[formId](#formId)|Describes the form of the item. Powder; tablets; capsule.|<a href="Medication.md" target="_blank">Commoncore/Medication</a>|
|[isBrand](#isBrand)|Set to true if the item is attributable to a specific manufacturer.|<a href="Medication.md" target="_blank">Commoncore/Medication</a>|
|[isOverTheCounter](#isOverTheCounter)|Set to true if the medication can be obtained without an order from a prescriber.|<a href="Medication.md" target="_blank">Commoncore/Medication</a>|
|[manufacturerId](#manufacturerId)||<a href="Medication.md" target="_blank">Commoncore/Medication</a>|
|[medicationCodeId](#medicationCodeId)|A code (or set of codes) that specify this medication, or a textual description if no code is available. Usage note: This could be a standard medication code.|<a href="Medication.md" target="_blank">Commoncore/Medication</a>|
|[medicationId](#medicationId)|Unique identifier for entity instances|<a href="Medication.md" target="_blank">Commoncore/Medication</a>|
|[name](#name)|The name of the custom entity.|<a href="Medication.md" target="_blank">Commoncore/Medication</a>|
|[packageContainerId](#packageContainerId)|The kind of container that this package comes as.|<a href="Medication.md" target="_blank">Commoncore/Medication</a>|
|[stateCode](#stateCode)|Status of the Medication|<a href="Medication.md" target="_blank">Commoncore/Medication</a>|
|[stateCode_display](#stateCode_display)||<a href="Medication.md" target="_blank">Commoncore/Medication</a>|
|[statusCode](#statusCode)|Reason for the status of the Medication|<a href="Medication.md" target="_blank">Commoncore/Medication</a>|
|[statusCode_display](#statusCode_display)||<a href="Medication.md" target="_blank">Commoncore/Medication</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: Commoncore/Medication (this entity)  
