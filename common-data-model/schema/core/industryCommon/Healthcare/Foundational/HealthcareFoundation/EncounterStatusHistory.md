---
title: EncounterStatusHistory in HealthcareFoundation - Common Data Model | Microsoft Docs
...
# Encounter Status History in HealthcareFoundation
...
The status history permits the encounter entity to contain the status history without needing to read through the historical versions of the entity, or even have the server store them  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Foundational/HealthcareFoundation/EncounterStatusHistory.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="EncounterStatusHistory.md" target="_blank">HealthcareFoundation/EncounterStatusHistory</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="EncounterStatusHistory.md" target="_blank">HealthcareFoundation/EncounterStatusHistory</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="EncounterStatusHistory.md" target="_blank">HealthcareFoundation/EncounterStatusHistory</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="EncounterStatusHistory.md" target="_blank">HealthcareFoundation/EncounterStatusHistory</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="EncounterStatusHistory.md" target="_blank">HealthcareFoundation/EncounterStatusHistory</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="EncounterStatusHistory.md" target="_blank">HealthcareFoundation/EncounterStatusHistory</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="EncounterStatusHistory.md" target="_blank">HealthcareFoundation/EncounterStatusHistory</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="EncounterStatusHistory.md" target="_blank">HealthcareFoundation/EncounterStatusHistory</a>|
|[ownerId](#ownerId)|Owner Id|<a href="EncounterStatusHistory.md" target="_blank">HealthcareFoundation/EncounterStatusHistory</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="EncounterStatusHistory.md" target="_blank">HealthcareFoundation/EncounterStatusHistory</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="EncounterStatusHistory.md" target="_blank">HealthcareFoundation/EncounterStatusHistory</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="EncounterStatusHistory.md" target="_blank">HealthcareFoundation/EncounterStatusHistory</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="EncounterStatusHistory.md" target="_blank">HealthcareFoundation/EncounterStatusHistory</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="EncounterStatusHistory.md" target="_blank">HealthcareFoundation/EncounterStatusHistory</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="EncounterStatusHistory.md" target="_blank">HealthcareFoundation/EncounterStatusHistory</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="EncounterStatusHistory.md" target="_blank">HealthcareFoundation/EncounterStatusHistory</a>|
|[encounterId](#encounterId)|An interaction between a patient and healthcare provider(s) for the purpose of providing healthcare service(s) or assessing the health status of a patient.|<a href="EncounterStatusHistory.md" target="_blank">HealthcareFoundation/EncounterStatusHistory</a>|
|[encounterStatus](#encounterStatus)|The status history permits the encounter resource to contain the status history without needing to read through the historical versions of the resource, or even have the server store them.|<a href="EncounterStatusHistory.md" target="_blank">HealthcareFoundation/EncounterStatusHistory</a>|
|[encounterStatus_display](#encounterStatus_display)||<a href="EncounterStatusHistory.md" target="_blank">HealthcareFoundation/EncounterStatusHistory</a>|
|[encounterStatusEndDate](#encounterStatusEndDate)|The time that the episode was in the specified status.|<a href="EncounterStatusHistory.md" target="_blank">HealthcareFoundation/EncounterStatusHistory</a>|
|[encounterStatusHistoryId](#encounterStatusHistoryId)|Unique identifier for entity instances|<a href="EncounterStatusHistory.md" target="_blank">HealthcareFoundation/EncounterStatusHistory</a>|
|[encounterStatusStartDate](#encounterStatusStartDate)|The time that the episode was in the specified status.|<a href="EncounterStatusHistory.md" target="_blank">HealthcareFoundation/EncounterStatusHistory</a>|
|[name](#name)|The name of the custom entity.|<a href="EncounterStatusHistory.md" target="_blank">HealthcareFoundation/EncounterStatusHistory</a>|
|[stateCode](#stateCode)|Status of the Encounter Status History|<a href="EncounterStatusHistory.md" target="_blank">HealthcareFoundation/EncounterStatusHistory</a>|
|[stateCode_display](#stateCode_display)||<a href="EncounterStatusHistory.md" target="_blank">HealthcareFoundation/EncounterStatusHistory</a>|
|[statusCode](#statusCode)|Reason for the status of the Encounter Status History|<a href="EncounterStatusHistory.md" target="_blank">HealthcareFoundation/EncounterStatusHistory</a>|
|[statusCode_display](#statusCode_display)||<a href="EncounterStatusHistory.md" target="_blank">HealthcareFoundation/EncounterStatusHistory</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: HealthcareFoundation/EncounterStatusHistory (this entity)  
