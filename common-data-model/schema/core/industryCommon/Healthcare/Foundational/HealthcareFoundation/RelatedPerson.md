---
title: RelatedPerson in HealthcareFoundation - Common Data Model | Microsoft Docs
...
# Related Person in HealthcareFoundation

Information about a person that is involved in the care for a patient, but who is not the target of healthcare, nor has a formal responsibility in the care process.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Foundational/HealthcareFoundation/RelatedPerson.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="RelatedPerson.md" target="_blank">HealthcareFoundation/RelatedPerson</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="RelatedPerson.md" target="_blank">HealthcareFoundation/RelatedPerson</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="RelatedPerson.md" target="_blank">HealthcareFoundation/RelatedPerson</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="RelatedPerson.md" target="_blank">HealthcareFoundation/RelatedPerson</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="RelatedPerson.md" target="_blank">HealthcareFoundation/RelatedPerson</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="RelatedPerson.md" target="_blank">HealthcareFoundation/RelatedPerson</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="RelatedPerson.md" target="_blank">HealthcareFoundation/RelatedPerson</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="RelatedPerson.md" target="_blank">HealthcareFoundation/RelatedPerson</a>|
|[ownerId](#ownerId)|Owner Id|<a href="RelatedPerson.md" target="_blank">HealthcareFoundation/RelatedPerson</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="RelatedPerson.md" target="_blank">HealthcareFoundation/RelatedPerson</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="RelatedPerson.md" target="_blank">HealthcareFoundation/RelatedPerson</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="RelatedPerson.md" target="_blank">HealthcareFoundation/RelatedPerson</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="RelatedPerson.md" target="_blank">HealthcareFoundation/RelatedPerson</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="RelatedPerson.md" target="_blank">HealthcareFoundation/RelatedPerson</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="RelatedPerson.md" target="_blank">HealthcareFoundation/RelatedPerson</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="RelatedPerson.md" target="_blank">HealthcareFoundation/RelatedPerson</a>|
|[active](#active)|Whether this related person record is in active use.|<a href="RelatedPerson.md" target="_blank">HealthcareFoundation/RelatedPerson</a>|
|[name](#name)|The name of the custom entity.|<a href="RelatedPerson.md" target="_blank">HealthcareFoundation/RelatedPerson</a>|
|[patientId](#patientId)|The patient this person is related to.|<a href="RelatedPerson.md" target="_blank">HealthcareFoundation/RelatedPerson</a>|
|[relatedPersonId](#relatedPersonId)|Unique identifier for entity instances|<a href="RelatedPerson.md" target="_blank">HealthcareFoundation/RelatedPerson</a>|
|[relatedPersonPeriodEndDate](#relatedPersonPeriodEndDate)|The period of time that this relationship is considered to be valid. If there are no dates defined, then the interval is unknown.|<a href="RelatedPerson.md" target="_blank">HealthcareFoundation/RelatedPerson</a>|
|[relatedPersonPeriodStartDate](#relatedPersonPeriodStartDate)|The period of time that this relationship is considered to be valid. If there are no dates defined, then the interval is unknown.|<a href="RelatedPerson.md" target="_blank">HealthcareFoundation/RelatedPerson</a>|
|[relationshipId](#relationshipId)|The nature of the relationship between a patient and the related person.|<a href="RelatedPerson.md" target="_blank">HealthcareFoundation/RelatedPerson</a>|
|[stateCode](#stateCode)|Status of the Related Person|<a href="RelatedPerson.md" target="_blank">HealthcareFoundation/RelatedPerson</a>|
|[stateCode_display](#stateCode_display)||<a href="RelatedPerson.md" target="_blank">HealthcareFoundation/RelatedPerson</a>|
|[statusCode](#statusCode)|Reason for the status of the Related Person|<a href="RelatedPerson.md" target="_blank">HealthcareFoundation/RelatedPerson</a>|
|[statusCode_display](#statusCode_display)||<a href="RelatedPerson.md" target="_blank">HealthcareFoundation/RelatedPerson</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: HealthcareFoundation/RelatedPerson (this entity)  
