---
title: CareTeam in HealthcareFoundation - Common Data Model | Microsoft Docs
...
# Care Team in HealthcareFoundation

The Care Team includes all the people and organizations who plan to participate in the coordination and delivery of care for a patient.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Foundational/HealthcareFoundation/CareTeam.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="CareTeam.md" target="_blank">HealthcareFoundation/CareTeam</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="CareTeam.md" target="_blank">HealthcareFoundation/CareTeam</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="CareTeam.md" target="_blank">HealthcareFoundation/CareTeam</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="CareTeam.md" target="_blank">HealthcareFoundation/CareTeam</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="CareTeam.md" target="_blank">HealthcareFoundation/CareTeam</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="CareTeam.md" target="_blank">HealthcareFoundation/CareTeam</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="CareTeam.md" target="_blank">HealthcareFoundation/CareTeam</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="CareTeam.md" target="_blank">HealthcareFoundation/CareTeam</a>|
|[ownerId](#ownerId)|Owner Id|<a href="CareTeam.md" target="_blank">HealthcareFoundation/CareTeam</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="CareTeam.md" target="_blank">HealthcareFoundation/CareTeam</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="CareTeam.md" target="_blank">HealthcareFoundation/CareTeam</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="CareTeam.md" target="_blank">HealthcareFoundation/CareTeam</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="CareTeam.md" target="_blank">HealthcareFoundation/CareTeam</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="CareTeam.md" target="_blank">HealthcareFoundation/CareTeam</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="CareTeam.md" target="_blank">HealthcareFoundation/CareTeam</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="CareTeam.md" target="_blank">HealthcareFoundation/CareTeam</a>|
|[entityImage](#entityImage)|The image of the record|<a href="CareTeam.md" target="_blank">HealthcareFoundation/CareTeam</a>|
|[careTeamId](#careTeamId)|Unique identifier for entity instances|<a href="CareTeam.md" target="_blank">HealthcareFoundation/CareTeam</a>|
|[careTeamNumber](#careTeamNumber)|This records identifiers associated with this care team that are defined by business processes and/or used to refer to it when a direct URL reference to the resource itself is not appropriate.|<a href="CareTeam.md" target="_blank">HealthcareFoundation/CareTeam</a>|
|[careTeamStatus](#careTeamStatus)|Indicates the current state of the care team.|<a href="CareTeam.md" target="_blank">HealthcareFoundation/CareTeam</a>|
|[careTeamStatus_display](#careTeamStatus_display)||<a href="CareTeam.md" target="_blank">HealthcareFoundation/CareTeam</a>|
|[contextType](#contextType)|The encounter or episode of care that establishes the context for this care team.|<a href="CareTeam.md" target="_blank">HealthcareFoundation/CareTeam</a>|
|[contextType_display](#contextType_display)||<a href="CareTeam.md" target="_blank">HealthcareFoundation/CareTeam</a>|
|[encounterId](#encounterId)|The encounter or episode of care that establishes the context for this care team.|<a href="CareTeam.md" target="_blank">HealthcareFoundation/CareTeam</a>|
|[episodeOfCareId](#episodeOfCareId)|The encounter or episode of care that establishes the context for this care team.|<a href="CareTeam.md" target="_blank">HealthcareFoundation/CareTeam</a>|
|[name](#name)|The name of the custom entity.|<a href="CareTeam.md" target="_blank">HealthcareFoundation/CareTeam</a>|
|[periodEnd](#periodEnd)|Indicates when the team did (or is intended to) come into effect and end.|<a href="CareTeam.md" target="_blank">HealthcareFoundation/CareTeam</a>|
|[periodStart](#periodStart)|Indicates when the team did (or is intended to) come into effect and end.|<a href="CareTeam.md" target="_blank">HealthcareFoundation/CareTeam</a>|
|[subjectGroupId](#subjectGroupId)|Subject is group|<a href="CareTeam.md" target="_blank">HealthcareFoundation/CareTeam</a>|
|[subjectPatientId](#subjectPatientId)|Subject is patient|<a href="CareTeam.md" target="_blank">HealthcareFoundation/CareTeam</a>|
|[subjectType](#subjectType)|Identifies the patient or group whose intended care is handled by the team.|<a href="CareTeam.md" target="_blank">HealthcareFoundation/CareTeam</a>|
|[subjectType_display](#subjectType_display)||<a href="CareTeam.md" target="_blank">HealthcareFoundation/CareTeam</a>|
|[stateCode](#stateCode)|Status of the Care Team|<a href="CareTeam.md" target="_blank">HealthcareFoundation/CareTeam</a>|
|[stateCode_display](#stateCode_display)||<a href="CareTeam.md" target="_blank">HealthcareFoundation/CareTeam</a>|
|[statusCode](#statusCode)|Reason for the status of the Care Team|<a href="CareTeam.md" target="_blank">HealthcareFoundation/CareTeam</a>|
|[statusCode_display](#statusCode_display)||<a href="CareTeam.md" target="_blank">HealthcareFoundation/CareTeam</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: HealthcareFoundation/CareTeam (this entity)  
