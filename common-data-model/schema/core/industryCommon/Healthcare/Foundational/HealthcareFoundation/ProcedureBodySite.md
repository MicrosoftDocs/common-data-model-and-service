---
title: ProcedureBodySite in HealthcareFoundation - Common Data Model | Microsoft Docs
...
# Procedure Body Site in HealthcareFoundation

Detailed and structured anatomical location information. Multiple locations are allowed - e.g. multiple punch biopsies of a lesion.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Foundational/HealthcareFoundation/ProcedureBodySite.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="ProcedureBodySite.md" target="_blank">HealthcareFoundation/ProcedureBodySite</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="ProcedureBodySite.md" target="_blank">HealthcareFoundation/ProcedureBodySite</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="ProcedureBodySite.md" target="_blank">HealthcareFoundation/ProcedureBodySite</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="ProcedureBodySite.md" target="_blank">HealthcareFoundation/ProcedureBodySite</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="ProcedureBodySite.md" target="_blank">HealthcareFoundation/ProcedureBodySite</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="ProcedureBodySite.md" target="_blank">HealthcareFoundation/ProcedureBodySite</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="ProcedureBodySite.md" target="_blank">HealthcareFoundation/ProcedureBodySite</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="ProcedureBodySite.md" target="_blank">HealthcareFoundation/ProcedureBodySite</a>|
|[ownerId](#ownerId)|Owner Id|<a href="ProcedureBodySite.md" target="_blank">HealthcareFoundation/ProcedureBodySite</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="ProcedureBodySite.md" target="_blank">HealthcareFoundation/ProcedureBodySite</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="ProcedureBodySite.md" target="_blank">HealthcareFoundation/ProcedureBodySite</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="ProcedureBodySite.md" target="_blank">HealthcareFoundation/ProcedureBodySite</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="ProcedureBodySite.md" target="_blank">HealthcareFoundation/ProcedureBodySite</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="ProcedureBodySite.md" target="_blank">HealthcareFoundation/ProcedureBodySite</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="ProcedureBodySite.md" target="_blank">HealthcareFoundation/ProcedureBodySite</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="ProcedureBodySite.md" target="_blank">HealthcareFoundation/ProcedureBodySite</a>|
|[bodySiteId](#bodySiteId)|Detailed and structured anatomical location information. Multiple locations are allowed - e.g. multiple punch biopsies of a lesion.|<a href="ProcedureBodySite.md" target="_blank">HealthcareFoundation/ProcedureBodySite</a>|
|[name](#name)|The name of the custom entity.|<a href="ProcedureBodySite.md" target="_blank">HealthcareFoundation/ProcedureBodySite</a>|
|[procedureId](#procedureId)|An action that is or was performed on a patient. This can be a physical intervention like an operation, or less invasive like counseling or hypnotherapy.|<a href="ProcedureBodySite.md" target="_blank">HealthcareFoundation/ProcedureBodySite</a>|
|[procedureBodySiteId](#procedureBodySiteId)|Unique identifier for entity instances|<a href="ProcedureBodySite.md" target="_blank">HealthcareFoundation/ProcedureBodySite</a>|
|[stateCode](#stateCode)|Status of the Procedure Body Site|<a href="ProcedureBodySite.md" target="_blank">HealthcareFoundation/ProcedureBodySite</a>|
|[stateCode_display](#stateCode_display)||<a href="ProcedureBodySite.md" target="_blank">HealthcareFoundation/ProcedureBodySite</a>|
|[statusCode](#statusCode)|Reason for the status of the Procedure Body Site|<a href="ProcedureBodySite.md" target="_blank">HealthcareFoundation/ProcedureBodySite</a>|
|[statusCode_display](#statusCode_display)||<a href="ProcedureBodySite.md" target="_blank">HealthcareFoundation/ProcedureBodySite</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: HealthcareFoundation/ProcedureBodySite (this entity)  
