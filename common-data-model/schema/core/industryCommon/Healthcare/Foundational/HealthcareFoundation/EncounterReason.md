---
title: EncounterReason in HealthcareFoundation - Common Data Model | Microsoft Docs
...
# Encounter Reason in HealthcareFoundation

Reason the encounter takes place, expressed as a code. For admissions, this can be used for a coded admission diagnosis.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Foundational/HealthcareFoundation/EncounterReason.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/Healthcare/Administration<br>/AdministrationEncounter/EncounterReason.cdm.json<br>/EncounterReason/hasAttributes<br>/attributesAddedAtThisScope</td></tr><tr><td>/Healthcare/Foundational/HealthcareFoundation<br>/EncounterReason.cdm.json/EncounterReason<br>/hasAttributes/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="EncounterReason.md" target="_blank">HealthcareFoundation/EncounterReason</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="EncounterReason.md" target="_blank">HealthcareFoundation/EncounterReason</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="EncounterReason.md" target="_blank">HealthcareFoundation/EncounterReason</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="EncounterReason.md" target="_blank">HealthcareFoundation/EncounterReason</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="EncounterReason.md" target="_blank">HealthcareFoundation/EncounterReason</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="EncounterReason.md" target="_blank">HealthcareFoundation/EncounterReason</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="EncounterReason.md" target="_blank">HealthcareFoundation/EncounterReason</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="EncounterReason.md" target="_blank">HealthcareFoundation/EncounterReason</a>|
|[ownerId](#ownerId)|Owner Id|<a href="EncounterReason.md" target="_blank">HealthcareFoundation/EncounterReason</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="EncounterReason.md" target="_blank">HealthcareFoundation/EncounterReason</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="EncounterReason.md" target="_blank">HealthcareFoundation/EncounterReason</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="EncounterReason.md" target="_blank">HealthcareFoundation/EncounterReason</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="EncounterReason.md" target="_blank">HealthcareFoundation/EncounterReason</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="EncounterReason.md" target="_blank">HealthcareFoundation/EncounterReason</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="EncounterReason.md" target="_blank">HealthcareFoundation/EncounterReason</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="EncounterReason.md" target="_blank">HealthcareFoundation/EncounterReason</a>|
|[code](#code)|Reason the encounter takes place, expressed as a code. For admissions, this can be used for a coded admission diagnosis.|<a href="EncounterReason.md" target="_blank">HealthcareFoundation/EncounterReason</a>|
|[display](#display)|The name of the custom entity.|<a href="EncounterReason.md" target="_blank">HealthcareFoundation/EncounterReason</a>|
|[encounterId](#encounterId)|An interaction between a patient and healthcare provider(s) for the purpose of providing healthcare service(s) or assessing the health status of a patient.|<a href="EncounterReason.md" target="_blank">HealthcareFoundation/EncounterReason</a>|
|[encounterReasonCodeId](#encounterReasonCodeId)|Reason the encounter takes place, expressed as a code. For admissions, this can be used for a coded admission diagnosis.|<a href="EncounterReason.md" target="_blank">HealthcareFoundation/EncounterReason</a>|
|[encounterReasonId](#encounterReasonId)|Unique identifier for entity instances|<a href="EncounterReason.md" target="_blank">HealthcareFoundation/EncounterReason</a>|
|[stateCode](#stateCode)|Status of the Encounter Reason|<a href="EncounterReason.md" target="_blank">HealthcareFoundation/EncounterReason</a>|
|[stateCode_display](#stateCode_display)||<a href="EncounterReason.md" target="_blank">HealthcareFoundation/EncounterReason</a>|
|[statusCode](#statusCode)|Reason for the status of the Encounter Reason|<a href="EncounterReason.md" target="_blank">HealthcareFoundation/EncounterReason</a>|
|[statusCode_display](#statusCode_display)||<a href="EncounterReason.md" target="_blank">HealthcareFoundation/EncounterReason</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: HealthcareFoundation/EncounterReason (this entity)  
