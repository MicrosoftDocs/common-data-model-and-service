---
title: CareTeamCategory in HealthcareFoundation - Common Data Model | Microsoft Docs
...
# Care Team Category in HealthcareFoundation

Identifies what kind of team. This is to support differentiation between multiple co-existing teams, such as care plan team, episode of care team, longitudinal care team.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Foundational/HealthcareFoundation/CareTeamCategory.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/Healthcare/Clinical/ClinicalCareTeam<br>/CareTeamCategory.cdm.json/CareTeamCategory<br>/hasAttributes/attributesAddedAtThisScope</td></tr><tr><td>/Healthcare/Foundational/HealthcareFoundation<br>/CareTeamCategory.cdm.json/CareTeamCategory<br>/hasAttributes/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="CareTeamCategory.md" target="_blank">HealthcareFoundation/CareTeamCategory</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="CareTeamCategory.md" target="_blank">HealthcareFoundation/CareTeamCategory</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="CareTeamCategory.md" target="_blank">HealthcareFoundation/CareTeamCategory</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="CareTeamCategory.md" target="_blank">HealthcareFoundation/CareTeamCategory</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="CareTeamCategory.md" target="_blank">HealthcareFoundation/CareTeamCategory</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="CareTeamCategory.md" target="_blank">HealthcareFoundation/CareTeamCategory</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="CareTeamCategory.md" target="_blank">HealthcareFoundation/CareTeamCategory</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="CareTeamCategory.md" target="_blank">HealthcareFoundation/CareTeamCategory</a>|
|[ownerId](#ownerId)|Owner Id|<a href="CareTeamCategory.md" target="_blank">HealthcareFoundation/CareTeamCategory</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="CareTeamCategory.md" target="_blank">HealthcareFoundation/CareTeamCategory</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="CareTeamCategory.md" target="_blank">HealthcareFoundation/CareTeamCategory</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="CareTeamCategory.md" target="_blank">HealthcareFoundation/CareTeamCategory</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="CareTeamCategory.md" target="_blank">HealthcareFoundation/CareTeamCategory</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="CareTeamCategory.md" target="_blank">HealthcareFoundation/CareTeamCategory</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="CareTeamCategory.md" target="_blank">HealthcareFoundation/CareTeamCategory</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="CareTeamCategory.md" target="_blank">HealthcareFoundation/CareTeamCategory</a>|
|[careTeamId](#careTeamId)|This records identifiers associated with this care team that are defined by business processes and/or used to refer to it when a direct URL reference to the resource itself is not appropriate.|<a href="CareTeamCategory.md" target="_blank">HealthcareFoundation/CareTeamCategory</a>|
|[careTeamCategoryId](#careTeamCategoryId)|Unique identifier for entity instances|<a href="CareTeamCategory.md" target="_blank">HealthcareFoundation/CareTeamCategory</a>|
|[categoryId](#categoryId)|Identifies what kind of team. This is to support differentiation between multiple co-existing teams, such as care plan team, episode of care team, longitudinal care team.|<a href="CareTeamCategory.md" target="_blank">HealthcareFoundation/CareTeamCategory</a>|
|[name](#name)|The name of the custom entity.|<a href="CareTeamCategory.md" target="_blank">HealthcareFoundation/CareTeamCategory</a>|
|[stateCode](#stateCode)|Status of the Care Team Category|<a href="CareTeamCategory.md" target="_blank">HealthcareFoundation/CareTeamCategory</a>|
|[stateCode_display](#stateCode_display)||<a href="CareTeamCategory.md" target="_blank">HealthcareFoundation/CareTeamCategory</a>|
|[statusCode](#statusCode)|Reason for the status of the Care Team Category|<a href="CareTeamCategory.md" target="_blank">HealthcareFoundation/CareTeamCategory</a>|
|[statusCode_display](#statusCode_display)||<a href="CareTeamCategory.md" target="_blank">HealthcareFoundation/CareTeamCategory</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: HealthcareFoundation/CareTeamCategory (this entity)  
