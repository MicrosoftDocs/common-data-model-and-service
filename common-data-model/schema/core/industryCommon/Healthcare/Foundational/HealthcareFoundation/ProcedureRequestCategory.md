---
title: ProcedureRequestCategory in HealthcareFoundation - Common Data Model | Microsoft Docs
...
# Procedure Request Category in HealthcareFoundation

A code that classifies the procedure for searching, sorting and display purposes (e.g. "Surgical Procedure").  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Foundational/HealthcareFoundation/ProcedureRequestCategory.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/Healthcare/Clinical/ClinicalProcedure<br>/ProcedureRequestCategory.cdm.json<br>/ProcedureRequestCategory/hasAttributes<br>/attributesAddedAtThisScope</td></tr><tr><td>/Healthcare/Foundational/HealthcareFoundation<br>/ProcedureRequestCategory.cdm.json<br>/ProcedureRequestCategory/hasAttributes<br>/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[ProcedureRequestCategory/(resolvedAttributes)/procedureRequestCategoryId](#procedureRequestCategoryId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[ProcedureRequestCategory/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Procedure Request Category</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_procedurerequestcategory"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="ProcedureRequestCategory.md" target="_blank">HealthcareFoundation/ProcedureRequestCategory</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="ProcedureRequestCategory.md" target="_blank">HealthcareFoundation/ProcedureRequestCategory</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="ProcedureRequestCategory.md" target="_blank">HealthcareFoundation/ProcedureRequestCategory</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="ProcedureRequestCategory.md" target="_blank">HealthcareFoundation/ProcedureRequestCategory</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="ProcedureRequestCategory.md" target="_blank">HealthcareFoundation/ProcedureRequestCategory</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="ProcedureRequestCategory.md" target="_blank">HealthcareFoundation/ProcedureRequestCategory</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="ProcedureRequestCategory.md" target="_blank">HealthcareFoundation/ProcedureRequestCategory</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="ProcedureRequestCategory.md" target="_blank">HealthcareFoundation/ProcedureRequestCategory</a>|
|[ownerId](#ownerId)|Owner Id|<a href="ProcedureRequestCategory.md" target="_blank">HealthcareFoundation/ProcedureRequestCategory</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="ProcedureRequestCategory.md" target="_blank">HealthcareFoundation/ProcedureRequestCategory</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="ProcedureRequestCategory.md" target="_blank">HealthcareFoundation/ProcedureRequestCategory</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="ProcedureRequestCategory.md" target="_blank">HealthcareFoundation/ProcedureRequestCategory</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="ProcedureRequestCategory.md" target="_blank">HealthcareFoundation/ProcedureRequestCategory</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="ProcedureRequestCategory.md" target="_blank">HealthcareFoundation/ProcedureRequestCategory</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="ProcedureRequestCategory.md" target="_blank">HealthcareFoundation/ProcedureRequestCategory</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="ProcedureRequestCategory.md" target="_blank">HealthcareFoundation/ProcedureRequestCategory</a>|
|[categoryId](#categoryId)|A code that classifies the procedure for searching, sorting and display purposes (e.g. ""Surgical Procedure"").|<a href="ProcedureRequestCategory.md" target="_blank">HealthcareFoundation/ProcedureRequestCategory</a>|
|[name](#name)|The name of the custom entity.|<a href="ProcedureRequestCategory.md" target="_blank">HealthcareFoundation/ProcedureRequestCategory</a>|
|[procedureRequestId](#procedureRequestId)|Unique identifier for the Procedure Request.|<a href="ProcedureRequestCategory.md" target="_blank">HealthcareFoundation/ProcedureRequestCategory</a>|
|[procedureRequestCategoryId](#procedureRequestCategoryId)|Unique identifier for entity instances|<a href="ProcedureRequestCategory.md" target="_blank">HealthcareFoundation/ProcedureRequestCategory</a>|
|[stateCode](#stateCode)|Status of the Procedure Request Category|<a href="ProcedureRequestCategory.md" target="_blank">HealthcareFoundation/ProcedureRequestCategory</a>|
|[stateCode_display](#stateCode_display)||<a href="ProcedureRequestCategory.md" target="_blank">HealthcareFoundation/ProcedureRequestCategory</a>|
|[statusCode](#statusCode)|Reason for the status of the Procedure Request Category|<a href="ProcedureRequestCategory.md" target="_blank">HealthcareFoundation/ProcedureRequestCategory</a>|
|[statusCode_display](#statusCode_display)||<a href="ProcedureRequestCategory.md" target="_blank">HealthcareFoundation/ProcedureRequestCategory</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: HealthcareFoundation/ProcedureRequestCategory (this entity)  
...
### <a href=#procedureRequestCategoryId name="procedureRequestCategoryId">procedureRequestCategoryId</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Procedure Request Category</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>sourceName</td><td>msemr_procedurerequestcategoryid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the procedureRequestCategoryId attribute are listed below.</summary>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_procedurerequestcategoryid"</td><td>string</td><td></td></tr></table>
...
Status of the Procedure Request Category  
First included in: HealthcareFoundation/ProcedureRequestCategory (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Procedure Request Category</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the Procedure Request Category</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
Reason for the status of the Procedure Request Category  
First included in: HealthcareFoundation/ProcedureRequestCategory (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Procedure Request Category</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the Procedure Request Category</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
