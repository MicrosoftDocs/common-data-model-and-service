---
title: ConditionCategory in HealthcareFoundation - Common Data Model | Microsoft Docs
...
# Condition Category in HealthcareFoundation

A category assigned to the condition.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Foundational/HealthcareFoundation/ConditionCategory.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/Healthcare/Clinical/ClinicalCore<br>/ConditionCategory.cdm.json/ConditionCategory<br>/hasAttributes/attributesAddedAtThisScope</td></tr><tr><td>/Healthcare/Foundational/HealthcareFoundation<br>/ConditionCategory.cdm.json/ConditionCategory<br>/hasAttributes/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[ConditionCategory/(resolvedAttributes)/conditionCategoryId](#conditionCategoryId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[ConditionCategory/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Condition Category</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>A category assigned to the condition.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_conditioncategory"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="ConditionCategory.md" target="_blank">HealthcareFoundation/ConditionCategory</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="ConditionCategory.md" target="_blank">HealthcareFoundation/ConditionCategory</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="ConditionCategory.md" target="_blank">HealthcareFoundation/ConditionCategory</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="ConditionCategory.md" target="_blank">HealthcareFoundation/ConditionCategory</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="ConditionCategory.md" target="_blank">HealthcareFoundation/ConditionCategory</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="ConditionCategory.md" target="_blank">HealthcareFoundation/ConditionCategory</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="ConditionCategory.md" target="_blank">HealthcareFoundation/ConditionCategory</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="ConditionCategory.md" target="_blank">HealthcareFoundation/ConditionCategory</a>|
|[ownerId](#ownerId)|Owner Id|<a href="ConditionCategory.md" target="_blank">HealthcareFoundation/ConditionCategory</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="ConditionCategory.md" target="_blank">HealthcareFoundation/ConditionCategory</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="ConditionCategory.md" target="_blank">HealthcareFoundation/ConditionCategory</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="ConditionCategory.md" target="_blank">HealthcareFoundation/ConditionCategory</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="ConditionCategory.md" target="_blank">HealthcareFoundation/ConditionCategory</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="ConditionCategory.md" target="_blank">HealthcareFoundation/ConditionCategory</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="ConditionCategory.md" target="_blank">HealthcareFoundation/ConditionCategory</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="ConditionCategory.md" target="_blank">HealthcareFoundation/ConditionCategory</a>|
|[categoryId](#categoryId)|Categorization of the condition recorded by health care practitioner.|<a href="ConditionCategory.md" target="_blank">HealthcareFoundation/ConditionCategory</a>|
|[conditionId](#conditionId)|Detailed information about conditions, problems or diagnoses|<a href="ConditionCategory.md" target="_blank">HealthcareFoundation/ConditionCategory</a>|
|[conditionCategoryId](#conditionCategoryId)|Unique identifier for entity instances|<a href="ConditionCategory.md" target="_blank">HealthcareFoundation/ConditionCategory</a>|
|[name](#name)|The name of the custom entity.|<a href="ConditionCategory.md" target="_blank">HealthcareFoundation/ConditionCategory</a>|
|[stateCode](#stateCode)|Status of the Condition Category|<a href="ConditionCategory.md" target="_blank">HealthcareFoundation/ConditionCategory</a>|
|[stateCode_display](#stateCode_display)||<a href="ConditionCategory.md" target="_blank">HealthcareFoundation/ConditionCategory</a>|
|[statusCode](#statusCode)|Reason for the status of the Condition Category|<a href="ConditionCategory.md" target="_blank">HealthcareFoundation/ConditionCategory</a>|
|[statusCode_display](#statusCode_display)||<a href="ConditionCategory.md" target="_blank">HealthcareFoundation/ConditionCategory</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: HealthcareFoundation/ConditionCategory (this entity)  
...
### <a href=#conditionCategoryId name="conditionCategoryId">conditionCategoryId</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Condition Category</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>sourceName</td><td>msemr_conditioncategoryid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the conditionCategoryId attribute are listed below.</summary>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_conditioncategoryid"</td><td>string</td><td></td></tr></table>
...
Status of the Condition Category  
First included in: HealthcareFoundation/ConditionCategory (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Condition Category</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the Condition Category</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
Reason for the status of the Condition Category  
First included in: HealthcareFoundation/ConditionCategory (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Condition Category</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the Condition Category</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
