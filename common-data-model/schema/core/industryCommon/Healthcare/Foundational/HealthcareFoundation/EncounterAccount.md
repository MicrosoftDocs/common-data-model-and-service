---
title: EncounterAccount in HealthcareFoundation - Common Data Model | Microsoft Docs
...
# Encounter Account in HealthcareFoundation

The set of accounts that may be used for billing for this Encounter.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Foundational/HealthcareFoundation/EncounterAccount.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="EncounterAccount.md" target="_blank">HealthcareFoundation/EncounterAccount</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="EncounterAccount.md" target="_blank">HealthcareFoundation/EncounterAccount</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="EncounterAccount.md" target="_blank">HealthcareFoundation/EncounterAccount</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="EncounterAccount.md" target="_blank">HealthcareFoundation/EncounterAccount</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="EncounterAccount.md" target="_blank">HealthcareFoundation/EncounterAccount</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="EncounterAccount.md" target="_blank">HealthcareFoundation/EncounterAccount</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="EncounterAccount.md" target="_blank">HealthcareFoundation/EncounterAccount</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="EncounterAccount.md" target="_blank">HealthcareFoundation/EncounterAccount</a>|
|[ownerId](#ownerId)|Owner Id|<a href="EncounterAccount.md" target="_blank">HealthcareFoundation/EncounterAccount</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="EncounterAccount.md" target="_blank">HealthcareFoundation/EncounterAccount</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="EncounterAccount.md" target="_blank">HealthcareFoundation/EncounterAccount</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="EncounterAccount.md" target="_blank">HealthcareFoundation/EncounterAccount</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="EncounterAccount.md" target="_blank">HealthcareFoundation/EncounterAccount</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="EncounterAccount.md" target="_blank">HealthcareFoundation/EncounterAccount</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="EncounterAccount.md" target="_blank">HealthcareFoundation/EncounterAccount</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="EncounterAccount.md" target="_blank">HealthcareFoundation/EncounterAccount</a>|
|[encounterId](#encounterId)|An interaction between a patient and healthcare provider(s) for the purpose of providing healthcare service(s) or assessing the health status of a patient.|<a href="EncounterAccount.md" target="_blank">HealthcareFoundation/EncounterAccount</a>|
|[encounterAccountId](#encounterAccountId)|Unique identifier for entity instances|<a href="EncounterAccount.md" target="_blank">HealthcareFoundation/EncounterAccount</a>|
|[name](#name)|The name of the custom entity.|<a href="EncounterAccount.md" target="_blank">HealthcareFoundation/EncounterAccount</a>|
|[stateCode](#stateCode)|Status of the Encounter Account|<a href="EncounterAccount.md" target="_blank">HealthcareFoundation/EncounterAccount</a>|
|[stateCode_display](#stateCode_display)||<a href="EncounterAccount.md" target="_blank">HealthcareFoundation/EncounterAccount</a>|
|[statusCode](#statusCode)|Reason for the status of the Encounter Account|<a href="EncounterAccount.md" target="_blank">HealthcareFoundation/EncounterAccount</a>|
|[statusCode_display](#statusCode_display)||<a href="EncounterAccount.md" target="_blank">HealthcareFoundation/EncounterAccount</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: HealthcareFoundation/EncounterAccount (this entity)  
