---
title: Procedure in HealthcareFoundation - Common Data Model | Microsoft Docs
...
# Procedure in HealthcareFoundation

An action that is or was performed on a patient. This can be a physical intervention like an operation, or less invasive like counseling or hypnotherapy.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Foundational/HealthcareFoundation/Procedure.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/Healthcare/Foundational/Commoncore<br>/Procedure.cdm.json/Procedure/hasAttributes<br>/attributesAddedAtThisScope</td></tr><tr><td>/Healthcare/Foundational/HealthcareFoundation<br>/Procedure.cdm.json/Procedure/hasAttributes<br>/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[Procedure/(resolvedAttributes)/procedureId](#procedureId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[Procedure/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="Procedure.md" target="_blank">HealthcareFoundation/Procedure</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="Procedure.md" target="_blank">HealthcareFoundation/Procedure</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="Procedure.md" target="_blank">HealthcareFoundation/Procedure</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="Procedure.md" target="_blank">HealthcareFoundation/Procedure</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="Procedure.md" target="_blank">HealthcareFoundation/Procedure</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="Procedure.md" target="_blank">HealthcareFoundation/Procedure</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="Procedure.md" target="_blank">HealthcareFoundation/Procedure</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="Procedure.md" target="_blank">HealthcareFoundation/Procedure</a>|
|[ownerId](#ownerId)|Owner Id|<a href="Procedure.md" target="_blank">HealthcareFoundation/Procedure</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="Procedure.md" target="_blank">HealthcareFoundation/Procedure</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="Procedure.md" target="_blank">HealthcareFoundation/Procedure</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="Procedure.md" target="_blank">HealthcareFoundation/Procedure</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="Procedure.md" target="_blank">HealthcareFoundation/Procedure</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="Procedure.md" target="_blank">HealthcareFoundation/Procedure</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="Procedure.md" target="_blank">HealthcareFoundation/Procedure</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="Procedure.md" target="_blank">HealthcareFoundation/Procedure</a>|
|[categoryId](#categoryId)|A code that classifies the procedure for searching, sorting and display purposes (e.g. "Surgical Procedure").|<a href="Procedure.md" target="_blank">HealthcareFoundation/Procedure</a>|
|[codeableconceptId](#codeableconceptId)||<a href="Procedure.md" target="_blank">HealthcareFoundation/Procedure</a>|
|[codeNewId](#codeNewId)||<a href="Procedure.md" target="_blank">HealthcareFoundation/Procedure</a>|
|[dateTime](#dateTime)|The date(time)/period over which the procedure was performed.|<a href="Procedure.md" target="_blank">HealthcareFoundation/Procedure</a>|
|[description](#description)|The name of the custom entity.|<a href="Procedure.md" target="_blank">HealthcareFoundation/Procedure</a>|
|[encounterId](#encounterId)|The encounter during which the procedure was performed.|<a href="Procedure.md" target="_blank">HealthcareFoundation/Procedure</a>|
|[episodeOfCareId](#episodeOfCareId)|The encounter during which the procedure was performed.|<a href="Procedure.md" target="_blank">HealthcareFoundation/Procedure</a>|
|[groupId](#groupId)|The person, animal or group on which the procedure was performed.|<a href="Procedure.md" target="_blank">HealthcareFoundation/Procedure</a>|
|[locationId](#locationId)|The location where the procedure actually happened. E.g. a newborn at home, a tracheotomy at a restaurant.|<a href="Procedure.md" target="_blank">HealthcareFoundation/Procedure</a>|
|[notDone](#notDone)|Set this to true if the record is saying that the procedure was NOT performed.|<a href="Procedure.md" target="_blank">HealthcareFoundation/Procedure</a>|
|[notDoneReasonId](#notDoneReasonId)|A code indicating why the procedure was not performed.|<a href="Procedure.md" target="_blank">HealthcareFoundation/Procedure</a>|
|[outcomeId](#outcomeId)|The outcome of the procedure - did it resolve reasons for the procedure being performed?|<a href="Procedure.md" target="_blank">HealthcareFoundation/Procedure</a>|
|[patientId](#patientId)|The person, animal or group on which the procedure was performed.|<a href="Procedure.md" target="_blank">HealthcareFoundation/Procedure</a>|
|[performedEndDate](#performedEndDate)|The period End date over which the procedure was performed. Allows a period to support complex procedures that span more than one date, and also allows for the length of the procedure to be captured|<a href="Procedure.md" target="_blank">HealthcareFoundation/Procedure</a>|
|[performedStartDate](#performedStartDate)|The period start date over which the procedure was performed. Allows a period to support complex procedures that span more than one date, and also allows for the length of the procedure to be captured|<a href="Procedure.md" target="_blank">HealthcareFoundation/Procedure</a>|
|[procedureId](#procedureId)|Unique identifier for entity instances|<a href="Procedure.md" target="_blank">HealthcareFoundation/Procedure</a>|
|[procedureIdentifier](#procedureIdentifier)|This records identifiers associated with this procedure that are defined by business processes and/or used to refer to it when a direct URL reference to the resource itself is not appropriate|<a href="Procedure.md" target="_blank">HealthcareFoundation/Procedure</a>|
|[status](#status)|A code specifying the state of the procedure. Generally this will be in-progress or completed state.|<a href="Procedure.md" target="_blank">HealthcareFoundation/Procedure</a>|
|[status_display](#status_display)||<a href="Procedure.md" target="_blank">HealthcareFoundation/Procedure</a>|
|[subjectType](#subjectType)|Type of Subject on whom procedure is performed|<a href="Procedure.md" target="_blank">HealthcareFoundation/Procedure</a>|
|[subjectType_display](#subjectType_display)||<a href="Procedure.md" target="_blank">HealthcareFoundation/Procedure</a>|
|[stateCode](#stateCode)|Status of the Procedure|<a href="Procedure.md" target="_blank">HealthcareFoundation/Procedure</a>|
|[stateCode_display](#stateCode_display)||<a href="Procedure.md" target="_blank">HealthcareFoundation/Procedure</a>|
|[statusCode](#statusCode)|Reason for the status of the Procedure|<a href="Procedure.md" target="_blank">HealthcareFoundation/Procedure</a>|
|[statusCode_display](#statusCode_display)||<a href="Procedure.md" target="_blank">HealthcareFoundation/Procedure</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: HealthcareFoundation/Procedure (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Code</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_codeableconcept</td></tr></table>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_codeableconcept"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>DEPRECATED Code</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_codenew</td></tr></table>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>DEPRECATED Code</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Date/Time</td></tr><tr><td>description</td><td>The date(time)/period over which the procedure was performed.</td></tr><tr><td>dataFormat</td><td>dateTime</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_datetime</td></tr></table>
...
### <a href=#notDoneReasonId name="notDoneReasonId">notDoneReasonId</a>
...
<details>
<summary>List of traits for the notDoneReasonId attribute are listed below.</summary>
