---
title: ProcedureCode in HealthcareFoundation - Common Data Model | Microsoft Docs
...
# Procedure Code in HealthcareFoundation

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Foundational/HealthcareFoundation/ProcedureCode.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/Healthcare/Clinical/ClinicalProcedure<br>/ProcedureCode.cdm.json/ProcedureCode<br>/hasAttributes/attributesAddedAtThisScope</td></tr><tr><td>/Healthcare/Foundational/HealthcareFoundation<br>/ProcedureCode.cdm.json/ProcedureCode<br>/hasAttributes/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[ProcedureCode/(resolvedAttributes)/procedureCodeId](#procedureCodeId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[ProcedureCode/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="ProcedureCode.md" target="_blank">HealthcareFoundation/ProcedureCode</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="ProcedureCode.md" target="_blank">HealthcareFoundation/ProcedureCode</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="ProcedureCode.md" target="_blank">HealthcareFoundation/ProcedureCode</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="ProcedureCode.md" target="_blank">HealthcareFoundation/ProcedureCode</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="ProcedureCode.md" target="_blank">HealthcareFoundation/ProcedureCode</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="ProcedureCode.md" target="_blank">HealthcareFoundation/ProcedureCode</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="ProcedureCode.md" target="_blank">HealthcareFoundation/ProcedureCode</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="ProcedureCode.md" target="_blank">HealthcareFoundation/ProcedureCode</a>|
|[ownerId](#ownerId)|Owner Id|<a href="ProcedureCode.md" target="_blank">HealthcareFoundation/ProcedureCode</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="ProcedureCode.md" target="_blank">HealthcareFoundation/ProcedureCode</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="ProcedureCode.md" target="_blank">HealthcareFoundation/ProcedureCode</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="ProcedureCode.md" target="_blank">HealthcareFoundation/ProcedureCode</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="ProcedureCode.md" target="_blank">HealthcareFoundation/ProcedureCode</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="ProcedureCode.md" target="_blank">HealthcareFoundation/ProcedureCode</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="ProcedureCode.md" target="_blank">HealthcareFoundation/ProcedureCode</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="ProcedureCode.md" target="_blank">HealthcareFoundation/ProcedureCode</a>|
|[code](#code)||<a href="ProcedureCode.md" target="_blank">HealthcareFoundation/ProcedureCode</a>|
|[display](#display)|The name of the custom entity.|<a href="ProcedureCode.md" target="_blank">HealthcareFoundation/ProcedureCode</a>|
|[procedureCodeId](#procedureCodeId)|Unique identifier for entity instances|<a href="ProcedureCode.md" target="_blank">HealthcareFoundation/ProcedureCode</a>|
|[system](#system)||<a href="ProcedureCode.md" target="_blank">HealthcareFoundation/ProcedureCode</a>|
|[stateCode](#stateCode)|Status of the Procedure Code|<a href="ProcedureCode.md" target="_blank">HealthcareFoundation/ProcedureCode</a>|
|[stateCode_display](#stateCode_display)||<a href="ProcedureCode.md" target="_blank">HealthcareFoundation/ProcedureCode</a>|
|[statusCode](#statusCode)|Reason for the status of the Procedure Code|<a href="ProcedureCode.md" target="_blank">HealthcareFoundation/ProcedureCode</a>|
|[statusCode_display](#statusCode_display)||<a href="ProcedureCode.md" target="_blank">HealthcareFoundation/ProcedureCode</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: HealthcareFoundation/ProcedureCode (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Procedure Code</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>sourceName</td><td>msemr_procedurecodeid</td></tr></table>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_procedurecodeid"</td><td>string</td><td></td></tr></table>
...
Status of the Procedure Code  
First included in: HealthcareFoundation/ProcedureCode (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Procedure Code</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the Procedure Code</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
Reason for the status of the Procedure Code  
First included in: HealthcareFoundation/ProcedureCode (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Procedure Code</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the Procedure Code</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
