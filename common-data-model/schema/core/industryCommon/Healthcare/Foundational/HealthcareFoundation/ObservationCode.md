---
title: ObservationCode in HealthcareFoundation - Common Data Model | Microsoft Docs
...
# Observation Code in HealthcareFoundation

Describes what was observed.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Foundational/HealthcareFoundation/ObservationCode.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/Healthcare/Diagnostics/DiagnosticCore<br>/ObservationCode.cdm.json/ObservationCode<br>/hasAttributes/attributesAddedAtThisScope</td></tr><tr><td>/Healthcare/Foundational/HealthcareFoundation<br>/ObservationCode.cdm.json/ObservationCode<br>/hasAttributes/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="ObservationCode.md" target="_blank">HealthcareFoundation/ObservationCode</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="ObservationCode.md" target="_blank">HealthcareFoundation/ObservationCode</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="ObservationCode.md" target="_blank">HealthcareFoundation/ObservationCode</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="ObservationCode.md" target="_blank">HealthcareFoundation/ObservationCode</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="ObservationCode.md" target="_blank">HealthcareFoundation/ObservationCode</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="ObservationCode.md" target="_blank">HealthcareFoundation/ObservationCode</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="ObservationCode.md" target="_blank">HealthcareFoundation/ObservationCode</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="ObservationCode.md" target="_blank">HealthcareFoundation/ObservationCode</a>|
|[ownerId](#ownerId)|Owner Id|<a href="ObservationCode.md" target="_blank">HealthcareFoundation/ObservationCode</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="ObservationCode.md" target="_blank">HealthcareFoundation/ObservationCode</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="ObservationCode.md" target="_blank">HealthcareFoundation/ObservationCode</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="ObservationCode.md" target="_blank">HealthcareFoundation/ObservationCode</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="ObservationCode.md" target="_blank">HealthcareFoundation/ObservationCode</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="ObservationCode.md" target="_blank">HealthcareFoundation/ObservationCode</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="ObservationCode.md" target="_blank">HealthcareFoundation/ObservationCode</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="ObservationCode.md" target="_blank">HealthcareFoundation/ObservationCode</a>|
|[code](#code)||<a href="ObservationCode.md" target="_blank">HealthcareFoundation/ObservationCode</a>|
|[display](#display)|The name of the custom entity.|<a href="ObservationCode.md" target="_blank">HealthcareFoundation/ObservationCode</a>|
|[observationCodeId](#observationCodeId)|Unique identifier for entity instances|<a href="ObservationCode.md" target="_blank">HealthcareFoundation/ObservationCode</a>|
|[system](#system)||<a href="ObservationCode.md" target="_blank">HealthcareFoundation/ObservationCode</a>|
|[stateCode](#stateCode)|Status of the Observation Code|<a href="ObservationCode.md" target="_blank">HealthcareFoundation/ObservationCode</a>|
|[stateCode_display](#stateCode_display)||<a href="ObservationCode.md" target="_blank">HealthcareFoundation/ObservationCode</a>|
|[statusCode](#statusCode)|Reason for the status of the Observation Code|<a href="ObservationCode.md" target="_blank">HealthcareFoundation/ObservationCode</a>|
|[statusCode_display](#statusCode_display)||<a href="ObservationCode.md" target="_blank">HealthcareFoundation/ObservationCode</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: HealthcareFoundation/ObservationCode (this entity)  
