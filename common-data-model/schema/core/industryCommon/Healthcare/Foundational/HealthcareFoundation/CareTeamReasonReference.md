---
title: CareTeamReasonReference in HealthcareFoundation - Common Data Model | Microsoft Docs
...
# Care Team Reason Reference in HealthcareFoundation

Condition(s) that this care team addresses.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Foundational/HealthcareFoundation/CareTeamReasonReference.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/Healthcare/Clinical/ClinicalCareTeam<br>/CareTeamReasonReference.cdm.json<br>/CareTeamReasonReference/hasAttributes<br>/attributesAddedAtThisScope</td></tr><tr><td>/Healthcare/Foundational/HealthcareFoundation<br>/CareTeamReasonReference.cdm.json<br>/CareTeamReasonReference/hasAttributes<br>/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="CareTeamReasonReference.md" target="_blank">HealthcareFoundation/CareTeamReasonReference</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="CareTeamReasonReference.md" target="_blank">HealthcareFoundation/CareTeamReasonReference</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="CareTeamReasonReference.md" target="_blank">HealthcareFoundation/CareTeamReasonReference</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="CareTeamReasonReference.md" target="_blank">HealthcareFoundation/CareTeamReasonReference</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="CareTeamReasonReference.md" target="_blank">HealthcareFoundation/CareTeamReasonReference</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="CareTeamReasonReference.md" target="_blank">HealthcareFoundation/CareTeamReasonReference</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="CareTeamReasonReference.md" target="_blank">HealthcareFoundation/CareTeamReasonReference</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="CareTeamReasonReference.md" target="_blank">HealthcareFoundation/CareTeamReasonReference</a>|
|[ownerId](#ownerId)|Owner Id|<a href="CareTeamReasonReference.md" target="_blank">HealthcareFoundation/CareTeamReasonReference</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="CareTeamReasonReference.md" target="_blank">HealthcareFoundation/CareTeamReasonReference</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="CareTeamReasonReference.md" target="_blank">HealthcareFoundation/CareTeamReasonReference</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="CareTeamReasonReference.md" target="_blank">HealthcareFoundation/CareTeamReasonReference</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="CareTeamReasonReference.md" target="_blank">HealthcareFoundation/CareTeamReasonReference</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="CareTeamReasonReference.md" target="_blank">HealthcareFoundation/CareTeamReasonReference</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="CareTeamReasonReference.md" target="_blank">HealthcareFoundation/CareTeamReasonReference</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="CareTeamReasonReference.md" target="_blank">HealthcareFoundation/CareTeamReasonReference</a>|
|[careTeamId](#careTeamId)|This records identifiers associated with this care team that are defined by business processes and/or used to refer to it when a direct URL reference to the resource itself is not appropriate.|<a href="CareTeamReasonReference.md" target="_blank">HealthcareFoundation/CareTeamReasonReference</a>|
|[careTeamReasonReferenceId](#careTeamReasonReferenceId)|Unique identifier for entity instances|<a href="CareTeamReasonReference.md" target="_blank">HealthcareFoundation/CareTeamReasonReference</a>|
|[name](#name)|The name of the custom entity.|<a href="CareTeamReasonReference.md" target="_blank">HealthcareFoundation/CareTeamReasonReference</a>|
|[referenceId](#referenceId)|Condition(s) that this care team addresses.|<a href="CareTeamReasonReference.md" target="_blank">HealthcareFoundation/CareTeamReasonReference</a>|
|[stateCode](#stateCode)|Status of the Care Team Reason Reference|<a href="CareTeamReasonReference.md" target="_blank">HealthcareFoundation/CareTeamReasonReference</a>|
|[stateCode_display](#stateCode_display)||<a href="CareTeamReasonReference.md" target="_blank">HealthcareFoundation/CareTeamReasonReference</a>|
|[statusCode](#statusCode)|Reason for the status of the Care Team Reason Reference|<a href="CareTeamReasonReference.md" target="_blank">HealthcareFoundation/CareTeamReasonReference</a>|
|[statusCode_display](#statusCode_display)||<a href="CareTeamReasonReference.md" target="_blank">HealthcareFoundation/CareTeamReasonReference</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: HealthcareFoundation/CareTeamReasonReference (this entity)  
