---
title: ProcedureReport in HealthcareFoundation - Common Data Model | Microsoft Docs
...
# Procedure Report in HealthcareFoundation

Procedure report could represent histology result, pathology report, surgical report, etc.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Foundational/HealthcareFoundation/ProcedureReport.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/Healthcare/Clinical/ClinicalProcedure<br>/ProcedureReport.cdm.json/ProcedureReport<br>/hasAttributes/attributesAddedAtThisScope</td></tr><tr><td>/Healthcare/Foundational/HealthcareFoundation<br>/ProcedureReport.cdm.json/ProcedureReport<br>/hasAttributes/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="ProcedureReport.md" target="_blank">HealthcareFoundation/ProcedureReport</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="ProcedureReport.md" target="_blank">HealthcareFoundation/ProcedureReport</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="ProcedureReport.md" target="_blank">HealthcareFoundation/ProcedureReport</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="ProcedureReport.md" target="_blank">HealthcareFoundation/ProcedureReport</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="ProcedureReport.md" target="_blank">HealthcareFoundation/ProcedureReport</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="ProcedureReport.md" target="_blank">HealthcareFoundation/ProcedureReport</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="ProcedureReport.md" target="_blank">HealthcareFoundation/ProcedureReport</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="ProcedureReport.md" target="_blank">HealthcareFoundation/ProcedureReport</a>|
|[ownerId](#ownerId)|Owner Id|<a href="ProcedureReport.md" target="_blank">HealthcareFoundation/ProcedureReport</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="ProcedureReport.md" target="_blank">HealthcareFoundation/ProcedureReport</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="ProcedureReport.md" target="_blank">HealthcareFoundation/ProcedureReport</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="ProcedureReport.md" target="_blank">HealthcareFoundation/ProcedureReport</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="ProcedureReport.md" target="_blank">HealthcareFoundation/ProcedureReport</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="ProcedureReport.md" target="_blank">HealthcareFoundation/ProcedureReport</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="ProcedureReport.md" target="_blank">HealthcareFoundation/ProcedureReport</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="ProcedureReport.md" target="_blank">HealthcareFoundation/ProcedureReport</a>|
|[name](#name)|The name of the custom entity.|<a href="ProcedureReport.md" target="_blank">HealthcareFoundation/ProcedureReport</a>|
|[procedureId](#procedureId)|An action that is or was performed on a patient. This can be a physical intervention like an operation, or less invasive like counseling or hypnotherapy.|<a href="ProcedureReport.md" target="_blank">HealthcareFoundation/ProcedureReport</a>|
|[procedureReportId](#procedureReportId)|Unique identifier for entity instances|<a href="ProcedureReport.md" target="_blank">HealthcareFoundation/ProcedureReport</a>|
|[reportId](#reportId)|This could be a histology result, pathology report, surgical report, etc..|<a href="ProcedureReport.md" target="_blank">HealthcareFoundation/ProcedureReport</a>|
|[stateCode](#stateCode)|Status of the Procedure Report|<a href="ProcedureReport.md" target="_blank">HealthcareFoundation/ProcedureReport</a>|
|[stateCode_display](#stateCode_display)||<a href="ProcedureReport.md" target="_blank">HealthcareFoundation/ProcedureReport</a>|
|[statusCode](#statusCode)|Reason for the status of the Procedure Report|<a href="ProcedureReport.md" target="_blank">HealthcareFoundation/ProcedureReport</a>|
|[statusCode_display](#statusCode_display)||<a href="ProcedureReport.md" target="_blank">HealthcareFoundation/ProcedureReport</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: HealthcareFoundation/ProcedureReport (this entity)  
