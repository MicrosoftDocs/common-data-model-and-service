---
title: CareTeamReasonCode in HealthcareFoundation - Common Data Model | Microsoft Docs
...
# Care Team Reason Code in HealthcareFoundation

Describes why the care team exists.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Foundational/HealthcareFoundation/CareTeamReasonCode.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/Healthcare/Clinical/ClinicalCareTeam<br>/CareTeamReasonCode.cdm.json/CareTeamReasonCode<br>/hasAttributes/attributesAddedAtThisScope</td></tr><tr><td>/Healthcare/Foundational/HealthcareFoundation<br>/CareTeamReasonCode.cdm.json/CareTeamReasonCode<br>/hasAttributes/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="CareTeamReasonCode.md" target="_blank">HealthcareFoundation/CareTeamReasonCode</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="CareTeamReasonCode.md" target="_blank">HealthcareFoundation/CareTeamReasonCode</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="CareTeamReasonCode.md" target="_blank">HealthcareFoundation/CareTeamReasonCode</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="CareTeamReasonCode.md" target="_blank">HealthcareFoundation/CareTeamReasonCode</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="CareTeamReasonCode.md" target="_blank">HealthcareFoundation/CareTeamReasonCode</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="CareTeamReasonCode.md" target="_blank">HealthcareFoundation/CareTeamReasonCode</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="CareTeamReasonCode.md" target="_blank">HealthcareFoundation/CareTeamReasonCode</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="CareTeamReasonCode.md" target="_blank">HealthcareFoundation/CareTeamReasonCode</a>|
|[ownerId](#ownerId)|Owner Id|<a href="CareTeamReasonCode.md" target="_blank">HealthcareFoundation/CareTeamReasonCode</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="CareTeamReasonCode.md" target="_blank">HealthcareFoundation/CareTeamReasonCode</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="CareTeamReasonCode.md" target="_blank">HealthcareFoundation/CareTeamReasonCode</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="CareTeamReasonCode.md" target="_blank">HealthcareFoundation/CareTeamReasonCode</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="CareTeamReasonCode.md" target="_blank">HealthcareFoundation/CareTeamReasonCode</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="CareTeamReasonCode.md" target="_blank">HealthcareFoundation/CareTeamReasonCode</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="CareTeamReasonCode.md" target="_blank">HealthcareFoundation/CareTeamReasonCode</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="CareTeamReasonCode.md" target="_blank">HealthcareFoundation/CareTeamReasonCode</a>|
|[careTeamId](#careTeamId)|This records identifiers associated with this care team that are defined by business processes and/or used to refer to it when a direct URL reference to the resource itself is not appropriate.|<a href="CareTeamReasonCode.md" target="_blank">HealthcareFoundation/CareTeamReasonCode</a>|
|[careTeamReasonCodeId](#careTeamReasonCodeId)|Unique identifier for entity instances|<a href="CareTeamReasonCode.md" target="_blank">HealthcareFoundation/CareTeamReasonCode</a>|
|[codeId](#codeId)|Describes why the care team exists.|<a href="CareTeamReasonCode.md" target="_blank">HealthcareFoundation/CareTeamReasonCode</a>|
|[name](#name)|The name of the custom entity.|<a href="CareTeamReasonCode.md" target="_blank">HealthcareFoundation/CareTeamReasonCode</a>|
|[stateCode](#stateCode)|Status of the Care Team Reason Code|<a href="CareTeamReasonCode.md" target="_blank">HealthcareFoundation/CareTeamReasonCode</a>|
|[stateCode_display](#stateCode_display)||<a href="CareTeamReasonCode.md" target="_blank">HealthcareFoundation/CareTeamReasonCode</a>|
|[statusCode](#statusCode)|Reason for the status of the Care Team Reason Code|<a href="CareTeamReasonCode.md" target="_blank">HealthcareFoundation/CareTeamReasonCode</a>|
|[statusCode_display](#statusCode_display)||<a href="CareTeamReasonCode.md" target="_blank">HealthcareFoundation/CareTeamReasonCode</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: HealthcareFoundation/CareTeamReasonCode (this entity)  
