---
title: EncounterReferralRequest in HealthcareFoundation - Common Data Model | Microsoft Docs
...
# Encounter Referral Request in HealthcareFoundation

The referral request this encounter satisfies (incoming referral).  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Foundational/HealthcareFoundation/EncounterReferralRequest.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/Healthcare/Administration<br>/AdministrationEncounter<br>/EncounterReferralRequest.cdm.json<br>/EncounterReferralRequest/hasAttributes<br>/attributesAddedAtThisScope</td></tr><tr><td>/Healthcare/Foundational/HealthcareFoundation<br>/EncounterReferralRequest.cdm.json<br>/EncounterReferralRequest/hasAttributes<br>/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="EncounterReferralRequest.md" target="_blank">HealthcareFoundation/EncounterReferralRequest</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="EncounterReferralRequest.md" target="_blank">HealthcareFoundation/EncounterReferralRequest</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="EncounterReferralRequest.md" target="_blank">HealthcareFoundation/EncounterReferralRequest</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="EncounterReferralRequest.md" target="_blank">HealthcareFoundation/EncounterReferralRequest</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="EncounterReferralRequest.md" target="_blank">HealthcareFoundation/EncounterReferralRequest</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="EncounterReferralRequest.md" target="_blank">HealthcareFoundation/EncounterReferralRequest</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="EncounterReferralRequest.md" target="_blank">HealthcareFoundation/EncounterReferralRequest</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="EncounterReferralRequest.md" target="_blank">HealthcareFoundation/EncounterReferralRequest</a>|
|[ownerId](#ownerId)|Owner Id|<a href="EncounterReferralRequest.md" target="_blank">HealthcareFoundation/EncounterReferralRequest</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="EncounterReferralRequest.md" target="_blank">HealthcareFoundation/EncounterReferralRequest</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="EncounterReferralRequest.md" target="_blank">HealthcareFoundation/EncounterReferralRequest</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="EncounterReferralRequest.md" target="_blank">HealthcareFoundation/EncounterReferralRequest</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="EncounterReferralRequest.md" target="_blank">HealthcareFoundation/EncounterReferralRequest</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="EncounterReferralRequest.md" target="_blank">HealthcareFoundation/EncounterReferralRequest</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="EncounterReferralRequest.md" target="_blank">HealthcareFoundation/EncounterReferralRequest</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="EncounterReferralRequest.md" target="_blank">HealthcareFoundation/EncounterReferralRequest</a>|
|[encounterId](#encounterId)|An interaction between a patient and healthcare provider(s) for the purpose of providing healthcare service(s) or assessing the health status of a patient.|<a href="EncounterReferralRequest.md" target="_blank">HealthcareFoundation/EncounterReferralRequest</a>|
|[encounterReferralRequestId](#encounterReferralRequestId)|Unique identifier for entity instances|<a href="EncounterReferralRequest.md" target="_blank">HealthcareFoundation/EncounterReferralRequest</a>|
|[name](#name)|The name of the custom entity.|<a href="EncounterReferralRequest.md" target="_blank">HealthcareFoundation/EncounterReferralRequest</a>|
|[stateCode](#stateCode)|Status of the Encounter Referral Request|<a href="EncounterReferralRequest.md" target="_blank">HealthcareFoundation/EncounterReferralRequest</a>|
|[stateCode_display](#stateCode_display)||<a href="EncounterReferralRequest.md" target="_blank">HealthcareFoundation/EncounterReferralRequest</a>|
|[statusCode](#statusCode)|Reason for the status of the Encounter Referral Request|<a href="EncounterReferralRequest.md" target="_blank">HealthcareFoundation/EncounterReferralRequest</a>|
|[statusCode_display](#statusCode_display)||<a href="EncounterReferralRequest.md" target="_blank">HealthcareFoundation/EncounterReferralRequest</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: HealthcareFoundation/EncounterReferralRequest (this entity)  
