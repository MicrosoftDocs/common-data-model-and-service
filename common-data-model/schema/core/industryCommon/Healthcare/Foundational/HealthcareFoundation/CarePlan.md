---
title: CarePlan in HealthcareFoundation - Common Data Model | Microsoft Docs
...
# Care Plan in HealthcareFoundation
...
Describes the intention of how one or more practitioners intend to deliver care for a particular patient, group or community for a period of time, possibly limited to care for a specific condition  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Foundational/HealthcareFoundation/CarePlan.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/Healthcare/Foundational/Commoncore<br>/CarePlan.cdm.json/CarePlan/hasAttributes<br>/attributesAddedAtThisScope</td></tr><tr><td>/Healthcare/Foundational/HealthcareFoundation<br>/CarePlan.cdm.json/CarePlan/hasAttributes<br>/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[CarePlan/(resolvedAttributes)/carePlanId](#carePlanId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[CarePlan/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="CarePlan.md" target="_blank">HealthcareFoundation/CarePlan</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="CarePlan.md" target="_blank">HealthcareFoundation/CarePlan</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="CarePlan.md" target="_blank">HealthcareFoundation/CarePlan</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="CarePlan.md" target="_blank">HealthcareFoundation/CarePlan</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="CarePlan.md" target="_blank">HealthcareFoundation/CarePlan</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="CarePlan.md" target="_blank">HealthcareFoundation/CarePlan</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="CarePlan.md" target="_blank">HealthcareFoundation/CarePlan</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="CarePlan.md" target="_blank">HealthcareFoundation/CarePlan</a>|
|[ownerId](#ownerId)|Owner Id|<a href="CarePlan.md" target="_blank">HealthcareFoundation/CarePlan</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="CarePlan.md" target="_blank">HealthcareFoundation/CarePlan</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="CarePlan.md" target="_blank">HealthcareFoundation/CarePlan</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="CarePlan.md" target="_blank">HealthcareFoundation/CarePlan</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="CarePlan.md" target="_blank">HealthcareFoundation/CarePlan</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="CarePlan.md" target="_blank">HealthcareFoundation/CarePlan</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="CarePlan.md" target="_blank">HealthcareFoundation/CarePlan</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="CarePlan.md" target="_blank">HealthcareFoundation/CarePlan</a>|
|[carePlanId](#carePlanId)|Unique identifier for entity instances|<a href="CarePlan.md" target="_blank">HealthcareFoundation/CarePlan</a>|
|[carePlanIdentifier](#carePlanIdentifier)|This records identifiers associated with this care plan that are defined by business processes and/or used to refer to it when a direct URL reference to the resource itself is not appropriate.|<a href="CarePlan.md" target="_blank">HealthcareFoundation/CarePlan</a>|
|[contextType](#contextType)|Type of the context care plan is created for|<a href="CarePlan.md" target="_blank">HealthcareFoundation/CarePlan</a>|
|[contextType_display](#contextType_display)||<a href="CarePlan.md" target="_blank">HealthcareFoundation/CarePlan</a>|
|[encounterIdentifierId](#encounterIdentifierId)|Identifies the original context in which this particular CarePlan was created.|<a href="CarePlan.md" target="_blank">HealthcareFoundation/CarePlan</a>|
|[episodeOfCareId](#episodeOfCareId)|Identifies the original context in which this particular CarePlan was created.|<a href="CarePlan.md" target="_blank">HealthcareFoundation/CarePlan</a>|
|[groupIdentifierId](#groupIdentifierId)|Identifies the patient or group whose intended care is described by the plan.|<a href="CarePlan.md" target="_blank">HealthcareFoundation/CarePlan</a>|
|[patientIdentifierId](#patientIdentifierId)|Identifies the patient or group whose intended care is described by the plan.|<a href="CarePlan.md" target="_blank">HealthcareFoundation/CarePlan</a>|
|[planDescription](#planDescription)|A description of the scope and nature of the plan.|<a href="CarePlan.md" target="_blank">HealthcareFoundation/CarePlan</a>|
|[planEndDate](#planEndDate)|Indicates when the plan did (or is intended to) come into effect and end.|<a href="CarePlan.md" target="_blank">HealthcareFoundation/CarePlan</a>|
|[planIntent](#planIntent)|Indicates the level of authority/intentionality associated with the care plan and where the care plan fits into the workflow chain.|<a href="CarePlan.md" target="_blank">HealthcareFoundation/CarePlan</a>|
|[planIntent_display](#planIntent_display)||<a href="CarePlan.md" target="_blank">HealthcareFoundation/CarePlan</a>|
|[planStartDate](#planStartDate)|Indicates when the plan did (or is intended to) come into effect and end.|<a href="CarePlan.md" target="_blank">HealthcareFoundation/CarePlan</a>|
|[planStatus](#planStatus)|Indicates whether the plan is currently being acted upon, represents future intentions or is now a historical record.|<a href="CarePlan.md" target="_blank">HealthcareFoundation/CarePlan</a>|
|[planStatus_display](#planStatus_display)||<a href="CarePlan.md" target="_blank">HealthcareFoundation/CarePlan</a>|
|[subjectType](#subjectType)|Type of subject of the care plan|<a href="CarePlan.md" target="_blank">HealthcareFoundation/CarePlan</a>|
|[subjectType_display](#subjectType_display)||<a href="CarePlan.md" target="_blank">HealthcareFoundation/CarePlan</a>|
|[title](#title)|The name of the custom entity.|<a href="CarePlan.md" target="_blank">HealthcareFoundation/CarePlan</a>|
|[stateCode](#stateCode)|Status of the Care Plan|<a href="CarePlan.md" target="_blank">HealthcareFoundation/CarePlan</a>|
|[stateCode_display](#stateCode_display)||<a href="CarePlan.md" target="_blank">HealthcareFoundation/CarePlan</a>|
|[statusCode](#statusCode)|Reason for the status of the Care Plan|<a href="CarePlan.md" target="_blank">HealthcareFoundation/CarePlan</a>|
|[statusCode_display](#statusCode_display)||<a href="CarePlan.md" target="_blank">HealthcareFoundation/CarePlan</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: HealthcareFoundation/CarePlan (this entity)  
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_careplanid"</td><td>string</td><td></td></tr></table>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_careplanidentifier"</td><td>string</td><td></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Type of the context care plan is created for</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
### <a href=#encounterIdentifierId name="encounterIdentifierId">encounterIdentifierId</a>
...
<details>
<summary>List of traits for the encounterIdentifierId attribute are listed below.</summary>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Identifies the original context in which this particular CarePlan was created.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
### <a href=#groupIdentifierId name="groupIdentifierId">groupIdentifierId</a>
...
<details>
<summary>List of traits for the groupIdentifierId attribute are listed below.</summary>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Identifies the patient or group whose intended care is described by the plan.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
### <a href=#patientIdentifierId name="patientIdentifierId">patientIdentifierId</a>
...
<details>
<summary>List of traits for the patientIdentifierId attribute are listed below.</summary>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_patientidentifier"</td><td>string</td><td></td></tr></table>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_plandescription"</td><td>string</td><td></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>A description of the scope and nature of the plan.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>End Date</td></tr><tr><td>description</td><td>Indicates when the plan did (or is intended to) come into effect and end.</td></tr><tr><td>dataFormat</td><td>dateTime</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_planenddate</td></tr></table>
...
**means.measurement.time**  
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_planenddate"</td><td>string</td><td></td></tr></table>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_planintent"</td><td>string</td><td></td></tr></table>
...
**is.addedInSupportOf**  
<table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>inSupportOf</td><td>"planIntent"</td><td>attributeName</td><td>output parameter naming the attribute that is being supported</td></tr></table>
...
**means.measurement.time**  
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_planstartdate"</td><td>string</td><td></td></tr></table>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_planstatus"</td><td>string</td><td></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Indicates whether the plan is currently being acted upon, represents future intentions or is now a historical record.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.addedInSupportOf**  
<table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>inSupportOf</td><td>"planStatus"</td><td>attributeName</td><td>output parameter naming the attribute that is being supported</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Type of subject of the care plan</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Title</td></tr><tr><td>description</td><td>The name of the custom entity.</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>100</td></tr><tr><td>sourceName</td><td>msemr_title</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the Care Plan</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the Care Plan</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
