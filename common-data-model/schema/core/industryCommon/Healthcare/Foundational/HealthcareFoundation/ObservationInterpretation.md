---
title: ObservationInterpretation in HealthcareFoundation - Common Data Model | Microsoft Docs
...
# Observation Interpretation in HealthcareFoundation

The assessment made based on the result of the observation.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Foundational/HealthcareFoundation/ObservationInterpretation.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/Healthcare/Diagnostics/DiagnosticCore<br>/ObservationInterpretation.cdm.json<br>/ObservationInterpretation/hasAttributes<br>/attributesAddedAtThisScope</td></tr><tr><td>/Healthcare/Foundational/HealthcareFoundation<br>/ObservationInterpretation.cdm.json<br>/ObservationInterpretation/hasAttributes<br>/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="ObservationInterpretation.md" target="_blank">HealthcareFoundation/ObservationInterpretation</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="ObservationInterpretation.md" target="_blank">HealthcareFoundation/ObservationInterpretation</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="ObservationInterpretation.md" target="_blank">HealthcareFoundation/ObservationInterpretation</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="ObservationInterpretation.md" target="_blank">HealthcareFoundation/ObservationInterpretation</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="ObservationInterpretation.md" target="_blank">HealthcareFoundation/ObservationInterpretation</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="ObservationInterpretation.md" target="_blank">HealthcareFoundation/ObservationInterpretation</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="ObservationInterpretation.md" target="_blank">HealthcareFoundation/ObservationInterpretation</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="ObservationInterpretation.md" target="_blank">HealthcareFoundation/ObservationInterpretation</a>|
|[ownerId](#ownerId)|Owner Id|<a href="ObservationInterpretation.md" target="_blank">HealthcareFoundation/ObservationInterpretation</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="ObservationInterpretation.md" target="_blank">HealthcareFoundation/ObservationInterpretation</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="ObservationInterpretation.md" target="_blank">HealthcareFoundation/ObservationInterpretation</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="ObservationInterpretation.md" target="_blank">HealthcareFoundation/ObservationInterpretation</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="ObservationInterpretation.md" target="_blank">HealthcareFoundation/ObservationInterpretation</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="ObservationInterpretation.md" target="_blank">HealthcareFoundation/ObservationInterpretation</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="ObservationInterpretation.md" target="_blank">HealthcareFoundation/ObservationInterpretation</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="ObservationInterpretation.md" target="_blank">HealthcareFoundation/ObservationInterpretation</a>|
|[code](#code)||<a href="ObservationInterpretation.md" target="_blank">HealthcareFoundation/ObservationInterpretation</a>|
|[display](#display)|The name of the custom entity.|<a href="ObservationInterpretation.md" target="_blank">HealthcareFoundation/ObservationInterpretation</a>|
|[observationInterpretationId](#observationInterpretationId)|Unique identifier for entity instances|<a href="ObservationInterpretation.md" target="_blank">HealthcareFoundation/ObservationInterpretation</a>|
|[system](#system)||<a href="ObservationInterpretation.md" target="_blank">HealthcareFoundation/ObservationInterpretation</a>|
|[stateCode](#stateCode)|Status of the Observation Interpretation|<a href="ObservationInterpretation.md" target="_blank">HealthcareFoundation/ObservationInterpretation</a>|
|[stateCode_display](#stateCode_display)||<a href="ObservationInterpretation.md" target="_blank">HealthcareFoundation/ObservationInterpretation</a>|
|[statusCode](#statusCode)|Reason for the status of the Observation Interpretation|<a href="ObservationInterpretation.md" target="_blank">HealthcareFoundation/ObservationInterpretation</a>|
|[statusCode_display](#statusCode_display)||<a href="ObservationInterpretation.md" target="_blank">HealthcareFoundation/ObservationInterpretation</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: HealthcareFoundation/ObservationInterpretation (this entity)  
