---
title: ProcedureReason in HealthcareFoundation - Common Data Model | Microsoft Docs
...
# Procedure Reason in HealthcareFoundation

The coded reason why the procedure was performed. This may be coded entity of some type, or may simply be present as text.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Foundational/HealthcareFoundation/ProcedureReason.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="ProcedureReason.md" target="_blank">HealthcareFoundation/ProcedureReason</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="ProcedureReason.md" target="_blank">HealthcareFoundation/ProcedureReason</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="ProcedureReason.md" target="_blank">HealthcareFoundation/ProcedureReason</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="ProcedureReason.md" target="_blank">HealthcareFoundation/ProcedureReason</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="ProcedureReason.md" target="_blank">HealthcareFoundation/ProcedureReason</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="ProcedureReason.md" target="_blank">HealthcareFoundation/ProcedureReason</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="ProcedureReason.md" target="_blank">HealthcareFoundation/ProcedureReason</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="ProcedureReason.md" target="_blank">HealthcareFoundation/ProcedureReason</a>|
|[ownerId](#ownerId)|Owner Id|<a href="ProcedureReason.md" target="_blank">HealthcareFoundation/ProcedureReason</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="ProcedureReason.md" target="_blank">HealthcareFoundation/ProcedureReason</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="ProcedureReason.md" target="_blank">HealthcareFoundation/ProcedureReason</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="ProcedureReason.md" target="_blank">HealthcareFoundation/ProcedureReason</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="ProcedureReason.md" target="_blank">HealthcareFoundation/ProcedureReason</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="ProcedureReason.md" target="_blank">HealthcareFoundation/ProcedureReason</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="ProcedureReason.md" target="_blank">HealthcareFoundation/ProcedureReason</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="ProcedureReason.md" target="_blank">HealthcareFoundation/ProcedureReason</a>|
|[display](#display)|The name of the custom entity.|<a href="ProcedureReason.md" target="_blank">HealthcareFoundation/ProcedureReason</a>|
|[procedureId](#procedureId)|An action that is or was performed on a patient. This can be a physical intervention like an operation, or less invasive like counseling or hypnotherapy.|<a href="ProcedureReason.md" target="_blank">HealthcareFoundation/ProcedureReason</a>|
|[procedureReasonId](#procedureReasonId)|Unique identifier for entity instances|<a href="ProcedureReason.md" target="_blank">HealthcareFoundation/ProcedureReason</a>|
|[reasonCodeId](#reasonCodeId)|The coded reason why the procedure was performed. This may be coded entity of some type, or may simply be present as text.|<a href="ProcedureReason.md" target="_blank">HealthcareFoundation/ProcedureReason</a>|
|[stateCode](#stateCode)|Status of the Procedure Reason|<a href="ProcedureReason.md" target="_blank">HealthcareFoundation/ProcedureReason</a>|
|[stateCode_display](#stateCode_display)||<a href="ProcedureReason.md" target="_blank">HealthcareFoundation/ProcedureReason</a>|
|[statusCode](#statusCode)|Reason for the status of the Procedure Reason|<a href="ProcedureReason.md" target="_blank">HealthcareFoundation/ProcedureReason</a>|
|[statusCode_display](#statusCode_display)||<a href="ProcedureReason.md" target="_blank">HealthcareFoundation/ProcedureReason</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: HealthcareFoundation/ProcedureReason (this entity)  
