---
title: EncounterHospitalizationDiet in HealthcareFoundation - Common Data Model | Microsoft Docs
...
# Encounter Hospitalization Diet in HealthcareFoundation

Used to track patient's diet restrictions and/or preference.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Foundational/HealthcareFoundation/EncounterHospitalizationDiet.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/Healthcare/Administration<br>/AdministrationEncounter<br>/EncounterHospitalizationDiet.cdm.json<br>/EncounterHospitalizationDiet/hasAttributes<br>/attributesAddedAtThisScope</td></tr><tr><td>/Healthcare/Foundational/HealthcareFoundation<br>/EncounterHospitalizationDiet.cdm.json<br>/EncounterHospitalizationDiet/hasAttributes<br>/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[EncounterHospitalizationDiet/(resolvedAttributes)/encounterHospitalizationDietId](#encounterHospitalizationDietId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[EncounterHospitalizationDiet/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Encounter Hospitalization Diet</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Used to track patient's diet restrictions and/or preference.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_encounterhospitalizationdiet"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="EncounterHospitalizationDiet.md" target="_blank">HealthcareFoundation/EncounterHospitalizationDiet</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="EncounterHospitalizationDiet.md" target="_blank">HealthcareFoundation/EncounterHospitalizationDiet</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="EncounterHospitalizationDiet.md" target="_blank">HealthcareFoundation/EncounterHospitalizationDiet</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="EncounterHospitalizationDiet.md" target="_blank">HealthcareFoundation/EncounterHospitalizationDiet</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="EncounterHospitalizationDiet.md" target="_blank">HealthcareFoundation/EncounterHospitalizationDiet</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="EncounterHospitalizationDiet.md" target="_blank">HealthcareFoundation/EncounterHospitalizationDiet</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="EncounterHospitalizationDiet.md" target="_blank">HealthcareFoundation/EncounterHospitalizationDiet</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="EncounterHospitalizationDiet.md" target="_blank">HealthcareFoundation/EncounterHospitalizationDiet</a>|
|[ownerId](#ownerId)|Owner Id|<a href="EncounterHospitalizationDiet.md" target="_blank">HealthcareFoundation/EncounterHospitalizationDiet</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="EncounterHospitalizationDiet.md" target="_blank">HealthcareFoundation/EncounterHospitalizationDiet</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="EncounterHospitalizationDiet.md" target="_blank">HealthcareFoundation/EncounterHospitalizationDiet</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="EncounterHospitalizationDiet.md" target="_blank">HealthcareFoundation/EncounterHospitalizationDiet</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="EncounterHospitalizationDiet.md" target="_blank">HealthcareFoundation/EncounterHospitalizationDiet</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="EncounterHospitalizationDiet.md" target="_blank">HealthcareFoundation/EncounterHospitalizationDiet</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="EncounterHospitalizationDiet.md" target="_blank">HealthcareFoundation/EncounterHospitalizationDiet</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="EncounterHospitalizationDiet.md" target="_blank">HealthcareFoundation/EncounterHospitalizationDiet</a>|
|[encounterId](#encounterId)|An interaction between a patient and healthcare provider(s) for the purpose of providing healthcare service(s) or assessing the health status of a patient.|<a href="EncounterHospitalizationDiet.md" target="_blank">HealthcareFoundation/EncounterHospitalizationDiet</a>|
|[encounterDietPreferenceId](#encounterDietPreferenceId)|Diet preferences reported by the patient|<a href="EncounterHospitalizationDiet.md" target="_blank">HealthcareFoundation/EncounterHospitalizationDiet</a>|
|[encounterHospitalizationDietId](#encounterHospitalizationDietId)|Unique identifier for entity instances|<a href="EncounterHospitalizationDiet.md" target="_blank">HealthcareFoundation/EncounterHospitalizationDiet</a>|
|[name](#name)|The name of the custom entity.|<a href="EncounterHospitalizationDiet.md" target="_blank">HealthcareFoundation/EncounterHospitalizationDiet</a>|
|[stateCode](#stateCode)|Status of the Encounter Hospitalization Diet|<a href="EncounterHospitalizationDiet.md" target="_blank">HealthcareFoundation/EncounterHospitalizationDiet</a>|
|[stateCode_display](#stateCode_display)||<a href="EncounterHospitalizationDiet.md" target="_blank">HealthcareFoundation/EncounterHospitalizationDiet</a>|
|[statusCode](#statusCode)|Reason for the status of the Encounter Hospitalization Diet|<a href="EncounterHospitalizationDiet.md" target="_blank">HealthcareFoundation/EncounterHospitalizationDiet</a>|
|[statusCode_display](#statusCode_display)||<a href="EncounterHospitalizationDiet.md" target="_blank">HealthcareFoundation/EncounterHospitalizationDiet</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: HealthcareFoundation/EncounterHospitalizationDiet (this entity)  
...
### <a href=#encounterDietPreferenceId name="encounterDietPreferenceId">encounterDietPreferenceId</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Diet Preference</td></tr><tr><td>description</td><td>Diet preferences reported by the patient</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_encounterdietpreference</td></tr></table>

#### Traits

<details>
<summary>List of traits for the encounterDietPreferenceId attribute are listed below.</summary>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Diet Preference</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Diet preferences reported by the patient</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_encounterdietpreference"</td><td>string</td><td></td></tr></table>
...
### <a href=#encounterHospitalizationDietId name="encounterHospitalizationDietId">encounterHospitalizationDietId</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Encounter Hospitalization Diet</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>sourceName</td><td>msemr_encounterhospitalizationdietid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the encounterHospitalizationDietId attribute are listed below.</summary>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_encounterhospitalizationdietid"</td><td>string</td><td></td></tr></table>
...
Status of the Encounter Hospitalization Diet  
First included in: HealthcareFoundation/EncounterHospitalizationDiet (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Encounter Hospitalization Diet</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the Encounter Hospitalization Diet</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
Reason for the status of the Encounter Hospitalization Diet  
First included in: HealthcareFoundation/EncounterHospitalizationDiet (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Encounter Hospitalization Diet</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the Encounter Hospitalization Diet</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
