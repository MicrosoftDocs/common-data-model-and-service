---
title: ObservationMethod in HealthcareFoundation - Common Data Model | Microsoft Docs
...
# Observation Method in HealthcareFoundation

Indicates the mechanism used to perform the observation.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Foundational/HealthcareFoundation/ObservationMethod.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/Healthcare/Diagnostics/DiagnosticCore<br>/ObservationMethod.cdm.json/ObservationMethod<br>/hasAttributes/attributesAddedAtThisScope</td></tr><tr><td>/Healthcare/Foundational/HealthcareFoundation<br>/ObservationMethod.cdm.json/ObservationMethod<br>/hasAttributes/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="ObservationMethod.md" target="_blank">HealthcareFoundation/ObservationMethod</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="ObservationMethod.md" target="_blank">HealthcareFoundation/ObservationMethod</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="ObservationMethod.md" target="_blank">HealthcareFoundation/ObservationMethod</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="ObservationMethod.md" target="_blank">HealthcareFoundation/ObservationMethod</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="ObservationMethod.md" target="_blank">HealthcareFoundation/ObservationMethod</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="ObservationMethod.md" target="_blank">HealthcareFoundation/ObservationMethod</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="ObservationMethod.md" target="_blank">HealthcareFoundation/ObservationMethod</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="ObservationMethod.md" target="_blank">HealthcareFoundation/ObservationMethod</a>|
|[ownerId](#ownerId)|Owner Id|<a href="ObservationMethod.md" target="_blank">HealthcareFoundation/ObservationMethod</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="ObservationMethod.md" target="_blank">HealthcareFoundation/ObservationMethod</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="ObservationMethod.md" target="_blank">HealthcareFoundation/ObservationMethod</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="ObservationMethod.md" target="_blank">HealthcareFoundation/ObservationMethod</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="ObservationMethod.md" target="_blank">HealthcareFoundation/ObservationMethod</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="ObservationMethod.md" target="_blank">HealthcareFoundation/ObservationMethod</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="ObservationMethod.md" target="_blank">HealthcareFoundation/ObservationMethod</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="ObservationMethod.md" target="_blank">HealthcareFoundation/ObservationMethod</a>|
|[code](#code)||<a href="ObservationMethod.md" target="_blank">HealthcareFoundation/ObservationMethod</a>|
|[display](#display)|The name of the custom entity.|<a href="ObservationMethod.md" target="_blank">HealthcareFoundation/ObservationMethod</a>|
|[observationMethodId](#observationMethodId)|Unique identifier for entity instances|<a href="ObservationMethod.md" target="_blank">HealthcareFoundation/ObservationMethod</a>|
|[system](#system)||<a href="ObservationMethod.md" target="_blank">HealthcareFoundation/ObservationMethod</a>|
|[stateCode](#stateCode)|Status of the Observation Method|<a href="ObservationMethod.md" target="_blank">HealthcareFoundation/ObservationMethod</a>|
|[stateCode_display](#stateCode_display)||<a href="ObservationMethod.md" target="_blank">HealthcareFoundation/ObservationMethod</a>|
|[statusCode](#statusCode)|Reason for the status of the Observation Method|<a href="ObservationMethod.md" target="_blank">HealthcareFoundation/ObservationMethod</a>|
|[statusCode_display](#statusCode_display)||<a href="ObservationMethod.md" target="_blank">HealthcareFoundation/ObservationMethod</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: HealthcareFoundation/ObservationMethod (this entity)  
