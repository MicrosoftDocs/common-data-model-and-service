---
title: MedicationRequestEventHistory in HealthcareFoundation - Common Data Model | Microsoft Docs
...
# Medication Request Event History in HealthcareFoundation
...
Links to Provenance records for past versions of this entity that identify key state transitions or updates that are likely to be relevant to user looking at the current version of the entity.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Foundational/HealthcareFoundation/MedicationRequestEventHistory.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="MedicationRequestEventHistory.md" target="_blank">HealthcareFoundation/MedicationRequestEventHistory</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="MedicationRequestEventHistory.md" target="_blank">HealthcareFoundation/MedicationRequestEventHistory</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="MedicationRequestEventHistory.md" target="_blank">HealthcareFoundation/MedicationRequestEventHistory</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="MedicationRequestEventHistory.md" target="_blank">HealthcareFoundation/MedicationRequestEventHistory</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="MedicationRequestEventHistory.md" target="_blank">HealthcareFoundation/MedicationRequestEventHistory</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="MedicationRequestEventHistory.md" target="_blank">HealthcareFoundation/MedicationRequestEventHistory</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="MedicationRequestEventHistory.md" target="_blank">HealthcareFoundation/MedicationRequestEventHistory</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="MedicationRequestEventHistory.md" target="_blank">HealthcareFoundation/MedicationRequestEventHistory</a>|
|[ownerId](#ownerId)|Owner Id|<a href="MedicationRequestEventHistory.md" target="_blank">HealthcareFoundation/MedicationRequestEventHistory</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="MedicationRequestEventHistory.md" target="_blank">HealthcareFoundation/MedicationRequestEventHistory</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="MedicationRequestEventHistory.md" target="_blank">HealthcareFoundation/MedicationRequestEventHistory</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="MedicationRequestEventHistory.md" target="_blank">HealthcareFoundation/MedicationRequestEventHistory</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="MedicationRequestEventHistory.md" target="_blank">HealthcareFoundation/MedicationRequestEventHistory</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="MedicationRequestEventHistory.md" target="_blank">HealthcareFoundation/MedicationRequestEventHistory</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="MedicationRequestEventHistory.md" target="_blank">HealthcareFoundation/MedicationRequestEventHistory</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="MedicationRequestEventHistory.md" target="_blank">HealthcareFoundation/MedicationRequestEventHistory</a>|
|[medicationRequestId](#medicationRequestId)|Business Identifier for Medication Request|<a href="MedicationRequestEventHistory.md" target="_blank">HealthcareFoundation/MedicationRequestEventHistory</a>|
|[medicationRequestEventHistoryId](#medicationRequestEventHistoryId)|Unique identifier for entity instances|<a href="MedicationRequestEventHistory.md" target="_blank">HealthcareFoundation/MedicationRequestEventHistory</a>|
|[name](#name)|The name of the custom entity.|<a href="MedicationRequestEventHistory.md" target="_blank">HealthcareFoundation/MedicationRequestEventHistory</a>|
|[stateCode](#stateCode)|Status of the Medication Request Event History|<a href="MedicationRequestEventHistory.md" target="_blank">HealthcareFoundation/MedicationRequestEventHistory</a>|
|[stateCode_display](#stateCode_display)||<a href="MedicationRequestEventHistory.md" target="_blank">HealthcareFoundation/MedicationRequestEventHistory</a>|
|[statusCode](#statusCode)|Reason for the status of the Medication Request Event History|<a href="MedicationRequestEventHistory.md" target="_blank">HealthcareFoundation/MedicationRequestEventHistory</a>|
|[statusCode_display](#statusCode_display)||<a href="MedicationRequestEventHistory.md" target="_blank">HealthcareFoundation/MedicationRequestEventHistory</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: HealthcareFoundation/MedicationRequestEventHistory (this entity)  
