---
title: ObservationCategory in HealthcareFoundation - Common Data Model | Microsoft Docs
...
# Observation Category in HealthcareFoundation

A code that classifies the general type of observation being made.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Foundational/HealthcareFoundation/ObservationCategory.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/Healthcare/Diagnostics/DiagnosticCore<br>/ObservationCategory.cdm.json/ObservationCategory<br>/hasAttributes/attributesAddedAtThisScope</td></tr><tr><td>/Healthcare/Foundational/HealthcareFoundation<br>/ObservationCategory.cdm.json/ObservationCategory<br>/hasAttributes/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="ObservationCategory.md" target="_blank">HealthcareFoundation/ObservationCategory</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="ObservationCategory.md" target="_blank">HealthcareFoundation/ObservationCategory</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="ObservationCategory.md" target="_blank">HealthcareFoundation/ObservationCategory</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="ObservationCategory.md" target="_blank">HealthcareFoundation/ObservationCategory</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="ObservationCategory.md" target="_blank">HealthcareFoundation/ObservationCategory</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="ObservationCategory.md" target="_blank">HealthcareFoundation/ObservationCategory</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="ObservationCategory.md" target="_blank">HealthcareFoundation/ObservationCategory</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="ObservationCategory.md" target="_blank">HealthcareFoundation/ObservationCategory</a>|
|[ownerId](#ownerId)|Owner Id|<a href="ObservationCategory.md" target="_blank">HealthcareFoundation/ObservationCategory</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="ObservationCategory.md" target="_blank">HealthcareFoundation/ObservationCategory</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="ObservationCategory.md" target="_blank">HealthcareFoundation/ObservationCategory</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="ObservationCategory.md" target="_blank">HealthcareFoundation/ObservationCategory</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="ObservationCategory.md" target="_blank">HealthcareFoundation/ObservationCategory</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="ObservationCategory.md" target="_blank">HealthcareFoundation/ObservationCategory</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="ObservationCategory.md" target="_blank">HealthcareFoundation/ObservationCategory</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="ObservationCategory.md" target="_blank">HealthcareFoundation/ObservationCategory</a>|
|[name](#name)|The name of the custom entity.|<a href="ObservationCategory.md" target="_blank">HealthcareFoundation/ObservationCategory</a>|
|[observationId](#observationId)|Business Identifier for observation|<a href="ObservationCategory.md" target="_blank">HealthcareFoundation/ObservationCategory</a>|
|[observationCategoryId](#observationCategoryId)|Unique identifier for entity instances|<a href="ObservationCategory.md" target="_blank">HealthcareFoundation/ObservationCategory</a>|
|[stateCode](#stateCode)|Status of the Observation Category|<a href="ObservationCategory.md" target="_blank">HealthcareFoundation/ObservationCategory</a>|
|[stateCode_display](#stateCode_display)||<a href="ObservationCategory.md" target="_blank">HealthcareFoundation/ObservationCategory</a>|
|[statusCode](#statusCode)|Reason for the status of the Observation Category|<a href="ObservationCategory.md" target="_blank">HealthcareFoundation/ObservationCategory</a>|
|[statusCode_display](#statusCode_display)||<a href="ObservationCategory.md" target="_blank">HealthcareFoundation/ObservationCategory</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: HealthcareFoundation/ObservationCategory (this entity)  
