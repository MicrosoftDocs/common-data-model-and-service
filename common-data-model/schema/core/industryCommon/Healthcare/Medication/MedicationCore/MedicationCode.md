---
title: MedicationCode in MedicationCore - Common Data Model | Microsoft Docs
...
# Medication Code in MedicationCore

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Medication/MedicationCore/MedicationCode.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="MedicationCode.md" target="_blank">MedicationCore/MedicationCode</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="MedicationCode.md" target="_blank">MedicationCore/MedicationCode</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="MedicationCode.md" target="_blank">MedicationCore/MedicationCode</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="MedicationCode.md" target="_blank">MedicationCore/MedicationCode</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="MedicationCode.md" target="_blank">MedicationCore/MedicationCode</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="MedicationCode.md" target="_blank">MedicationCore/MedicationCode</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="MedicationCode.md" target="_blank">MedicationCore/MedicationCode</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="MedicationCode.md" target="_blank">MedicationCore/MedicationCode</a>|
|[ownerId](#ownerId)|Owner Id|<a href="MedicationCode.md" target="_blank">MedicationCore/MedicationCode</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="MedicationCode.md" target="_blank">MedicationCore/MedicationCode</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="MedicationCode.md" target="_blank">MedicationCore/MedicationCode</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="MedicationCode.md" target="_blank">MedicationCore/MedicationCode</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="MedicationCode.md" target="_blank">MedicationCore/MedicationCode</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="MedicationCode.md" target="_blank">MedicationCore/MedicationCode</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="MedicationCode.md" target="_blank">MedicationCore/MedicationCode</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="MedicationCode.md" target="_blank">MedicationCore/MedicationCode</a>|
|[code](#code)||<a href="MedicationCode.md" target="_blank">MedicationCore/MedicationCode</a>|
|[display](#display)|The name of the custom entity.|<a href="MedicationCode.md" target="_blank">MedicationCore/MedicationCode</a>|
|[medicationCodeId](#medicationCodeId)|Unique identifier for entity instances|<a href="MedicationCode.md" target="_blank">MedicationCore/MedicationCode</a>|
|[system](#system)||<a href="MedicationCode.md" target="_blank">MedicationCore/MedicationCode</a>|
|[stateCode](#stateCode)|Status of the Medication Code|<a href="MedicationCode.md" target="_blank">MedicationCore/MedicationCode</a>|
|[stateCode_display](#stateCode_display)||<a href="MedicationCode.md" target="_blank">MedicationCore/MedicationCode</a>|
|[statusCode](#statusCode)|Reason for the status of the Medication Code|<a href="MedicationCode.md" target="_blank">MedicationCore/MedicationCode</a>|
|[statusCode_display](#statusCode_display)||<a href="MedicationCode.md" target="_blank">MedicationCore/MedicationCode</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: MedicationCore/MedicationCode (this entity)  
