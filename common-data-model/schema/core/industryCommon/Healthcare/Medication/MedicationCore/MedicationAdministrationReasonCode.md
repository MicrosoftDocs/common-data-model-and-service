...
# Medication Administration Reason Code in MedicationCore

A code indicating why the medication was given.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Medication/MedicationCore/MedicationAdministrationReasonCode.cdm.json" target="_blank">GitHub</a>.  
...
- [/HealthcareFoundation/MedicationAdministrationReasonCode](../../Foundational/HealthcareFoundation/MedicationAdministrationReasonCode.md "/Healthcare/Foundational/HealthcareFoundation/MedicationAdministrationReasonCode.cdm.json/MedicationAdministrationReasonCode")  
</details>
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/Healthcare/Medication/MedicationCore<br>/MedicationAdministrationReasonCode.cdm.json<br>/MedicationAdministrationReasonCode/hasAttributes<br>/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[MedicationAdministrationReasonCode/(resolvedAttributes)/medicationAdministrationReasonCodeId](#medicationAdministrationReasonCodeId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[MedicationAdministrationReasonCode/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Medication Administration Reason Code</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>A code indicating why the medication was given.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_medicationadministrationreasoncode"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="MedicationAdministrationReasonCode.md" target="_blank">MedicationCore/MedicationAdministrationReasonCode</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="MedicationAdministrationReasonCode.md" target="_blank">MedicationCore/MedicationAdministrationReasonCode</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="MedicationAdministrationReasonCode.md" target="_blank">MedicationCore/MedicationAdministrationReasonCode</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="MedicationAdministrationReasonCode.md" target="_blank">MedicationCore/MedicationAdministrationReasonCode</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="MedicationAdministrationReasonCode.md" target="_blank">MedicationCore/MedicationAdministrationReasonCode</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="MedicationAdministrationReasonCode.md" target="_blank">MedicationCore/MedicationAdministrationReasonCode</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="MedicationAdministrationReasonCode.md" target="_blank">MedicationCore/MedicationAdministrationReasonCode</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="MedicationAdministrationReasonCode.md" target="_blank">MedicationCore/MedicationAdministrationReasonCode</a>|
|[ownerId](#ownerId)|Owner Id|<a href="MedicationAdministrationReasonCode.md" target="_blank">MedicationCore/MedicationAdministrationReasonCode</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="MedicationAdministrationReasonCode.md" target="_blank">MedicationCore/MedicationAdministrationReasonCode</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="MedicationAdministrationReasonCode.md" target="_blank">MedicationCore/MedicationAdministrationReasonCode</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="MedicationAdministrationReasonCode.md" target="_blank">MedicationCore/MedicationAdministrationReasonCode</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="MedicationAdministrationReasonCode.md" target="_blank">MedicationCore/MedicationAdministrationReasonCode</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="MedicationAdministrationReasonCode.md" target="_blank">MedicationCore/MedicationAdministrationReasonCode</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="MedicationAdministrationReasonCode.md" target="_blank">MedicationCore/MedicationAdministrationReasonCode</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="MedicationAdministrationReasonCode.md" target="_blank">MedicationCore/MedicationAdministrationReasonCode</a>|
|[medicationAdministrationId](#medicationAdministrationId)|Unique ID of Medication Administration.|<a href="MedicationAdministrationReasonCode.md" target="_blank">MedicationCore/MedicationAdministrationReasonCode</a>|
|[medicationAdministrationReasonCodeId](#medicationAdministrationReasonCodeId)|Unique identifier for entity instances|<a href="MedicationAdministrationReasonCode.md" target="_blank">MedicationCore/MedicationAdministrationReasonCode</a>|
|[name](#name)|The name of the custom entity.|<a href="MedicationAdministrationReasonCode.md" target="_blank">MedicationCore/MedicationAdministrationReasonCode</a>|
|[reasonCodeId](#reasonCodeId)|A code indicating why the medication was given.|<a href="MedicationAdministrationReasonCode.md" target="_blank">MedicationCore/MedicationAdministrationReasonCode</a>|
|[stateCode](#stateCode)|Status of the Medication Administration Reason Code|<a href="MedicationAdministrationReasonCode.md" target="_blank">MedicationCore/MedicationAdministrationReasonCode</a>|
|[stateCode_display](#stateCode_display)||<a href="MedicationAdministrationReasonCode.md" target="_blank">MedicationCore/MedicationAdministrationReasonCode</a>|
|[statusCode](#statusCode)|Reason for the status of the Medication Administration Reason Code|<a href="MedicationAdministrationReasonCode.md" target="_blank">MedicationCore/MedicationAdministrationReasonCode</a>|
|[statusCode_display](#statusCode_display)||<a href="MedicationAdministrationReasonCode.md" target="_blank">MedicationCore/MedicationAdministrationReasonCode</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: MedicationCore/MedicationAdministrationReasonCode (this entity)  
...
### <a href=#medicationAdministrationReasonCodeId name="medicationAdministrationReasonCodeId">medicationAdministrationReasonCodeId</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Medication Administration Reason Code</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>sourceName</td><td>msemr_medicationadministrationreasoncodeid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the medicationAdministrationReasonCodeId attribute are listed below.</summary>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_medicationadministrationreasoncodeid"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Reason Code</td></tr><tr><td>description</td><td>A code indicating why the medication was given.</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_reasoncode</td></tr></table>
...
Status of the Medication Administration Reason Code  
First included in: MedicationCore/MedicationAdministrationReasonCode (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Medication Administration Reason Code</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the Medication Administration Reason Code</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
Reason for the status of the Medication Administration Reason Code  
First included in: MedicationCore/MedicationAdministrationReasonCode (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Medication Administration Reason Code</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the Medication Administration Reason Code</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
