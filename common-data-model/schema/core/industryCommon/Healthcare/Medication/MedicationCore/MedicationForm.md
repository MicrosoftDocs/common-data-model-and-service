---
title: MedicationForm in MedicationCore - Common Data Model | Microsoft Docs
...
# Medication Form in MedicationCore

Describes the form of the item. Powder; tablets; capsule.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Medication/MedicationCore/MedicationForm.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="MedicationForm.md" target="_blank">MedicationCore/MedicationForm</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="MedicationForm.md" target="_blank">MedicationCore/MedicationForm</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="MedicationForm.md" target="_blank">MedicationCore/MedicationForm</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="MedicationForm.md" target="_blank">MedicationCore/MedicationForm</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="MedicationForm.md" target="_blank">MedicationCore/MedicationForm</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="MedicationForm.md" target="_blank">MedicationCore/MedicationForm</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="MedicationForm.md" target="_blank">MedicationCore/MedicationForm</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="MedicationForm.md" target="_blank">MedicationCore/MedicationForm</a>|
|[ownerId](#ownerId)|Owner Id|<a href="MedicationForm.md" target="_blank">MedicationCore/MedicationForm</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="MedicationForm.md" target="_blank">MedicationCore/MedicationForm</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="MedicationForm.md" target="_blank">MedicationCore/MedicationForm</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="MedicationForm.md" target="_blank">MedicationCore/MedicationForm</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="MedicationForm.md" target="_blank">MedicationCore/MedicationForm</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="MedicationForm.md" target="_blank">MedicationCore/MedicationForm</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="MedicationForm.md" target="_blank">MedicationCore/MedicationForm</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="MedicationForm.md" target="_blank">MedicationCore/MedicationForm</a>|
|[code](#code)||<a href="MedicationForm.md" target="_blank">MedicationCore/MedicationForm</a>|
|[display](#display)|The name of the custom entity.|<a href="MedicationForm.md" target="_blank">MedicationCore/MedicationForm</a>|
|[medicationFormId](#medicationFormId)|Unique identifier for entity instances|<a href="MedicationForm.md" target="_blank">MedicationCore/MedicationForm</a>|
|[system](#system)||<a href="MedicationForm.md" target="_blank">MedicationCore/MedicationForm</a>|
|[stateCode](#stateCode)|Status of the Medication Form|<a href="MedicationForm.md" target="_blank">MedicationCore/MedicationForm</a>|
|[stateCode_display](#stateCode_display)||<a href="MedicationForm.md" target="_blank">MedicationCore/MedicationForm</a>|
|[statusCode](#statusCode)|Reason for the status of the Medication Form|<a href="MedicationForm.md" target="_blank">MedicationCore/MedicationForm</a>|
|[statusCode_display](#statusCode_display)||<a href="MedicationForm.md" target="_blank">MedicationCore/MedicationForm</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: MedicationCore/MedicationForm (this entity)  
