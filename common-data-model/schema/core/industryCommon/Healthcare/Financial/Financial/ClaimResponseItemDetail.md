...
# Claim Response Item Detail in Financial

The second tier service adjudications for submitted services.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Financial/Financial/ClaimResponseItemDetail.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/Healthcare/Financial/Financial<br>/ClaimResponseItemDetail.cdm.json<br>/ClaimResponseItemDetail/hasAttributes<br>/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[ClaimResponseItemDetail/(resolvedAttributes)/claimResponseItemDetailId](#claimResponseItemDetailId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[ClaimResponseItemDetail/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Claim Response Item Detail</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>The second tier service adjudications for submitted services.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_ClaimResponseItemDetail"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="ClaimResponseItemDetail.md" target="_blank">Financial/ClaimResponseItemDetail</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="ClaimResponseItemDetail.md" target="_blank">Financial/ClaimResponseItemDetail</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="ClaimResponseItemDetail.md" target="_blank">Financial/ClaimResponseItemDetail</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="ClaimResponseItemDetail.md" target="_blank">Financial/ClaimResponseItemDetail</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="ClaimResponseItemDetail.md" target="_blank">Financial/ClaimResponseItemDetail</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="ClaimResponseItemDetail.md" target="_blank">Financial/ClaimResponseItemDetail</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="ClaimResponseItemDetail.md" target="_blank">Financial/ClaimResponseItemDetail</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="ClaimResponseItemDetail.md" target="_blank">Financial/ClaimResponseItemDetail</a>|
|[ownerId](#ownerId)|Owner Id|<a href="ClaimResponseItemDetail.md" target="_blank">Financial/ClaimResponseItemDetail</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="ClaimResponseItemDetail.md" target="_blank">Financial/ClaimResponseItemDetail</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="ClaimResponseItemDetail.md" target="_blank">Financial/ClaimResponseItemDetail</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="ClaimResponseItemDetail.md" target="_blank">Financial/ClaimResponseItemDetail</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="ClaimResponseItemDetail.md" target="_blank">Financial/ClaimResponseItemDetail</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="ClaimResponseItemDetail.md" target="_blank">Financial/ClaimResponseItemDetail</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="ClaimResponseItemDetail.md" target="_blank">Financial/ClaimResponseItemDetail</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="ClaimResponseItemDetail.md" target="_blank">Financial/ClaimResponseItemDetail</a>|
|[claimResponseId](#claimResponseId)||<a href="ClaimResponseItemDetail.md" target="_blank">Financial/ClaimResponseItemDetail</a>|
|[claimResponseItemDetailId](#claimResponseItemDetailId)|Unique identifier for entity instances|<a href="ClaimResponseItemDetail.md" target="_blank">Financial/ClaimResponseItemDetail</a>|
|[claimResponseItemDetailSequence](#claimResponseItemDetailSequence)||<a href="ClaimResponseItemDetail.md" target="_blank">Financial/ClaimResponseItemDetail</a>|
|[name](#name)|Required name field|<a href="ClaimResponseItemDetail.md" target="_blank">Financial/ClaimResponseItemDetail</a>|
|[stateCode](#stateCode)|Status of the Claim Response Item Detail|<a href="ClaimResponseItemDetail.md" target="_blank">Financial/ClaimResponseItemDetail</a>|
|[stateCode_display](#stateCode_display)||<a href="ClaimResponseItemDetail.md" target="_blank">Financial/ClaimResponseItemDetail</a>|
|[statusCode](#statusCode)|Reason for the status of the Claim Response Item Detail|<a href="ClaimResponseItemDetail.md" target="_blank">Financial/ClaimResponseItemDetail</a>|
|[statusCode_display](#statusCode_display)||<a href="ClaimResponseItemDetail.md" target="_blank">Financial/ClaimResponseItemDetail</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: Financial/ClaimResponseItemDetail (this entity)  
...
### <a href=#claimResponseItemDetailId name="claimResponseItemDetailId">claimResponseItemDetailId</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Claim Response Item Detail</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>sourceName</td><td>msemr_claimresponseitemdetailid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the claimResponseItemDetailId attribute are listed below.</summary>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_claimresponseitemdetailid"</td><td>string</td><td></td></tr></table>
...
### <a href=#claimResponseItemDetailSequence name="claimResponseItemDetailSequence">claimResponseItemDetailSequence</a>

First included in: Financial/ClaimResponseItemDetail (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Claim Response Item Detail Sequence</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>maximumValue</td><td>2147483647</td></tr><tr><td>minimumValue</td><td>0</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_claimresponseitemdetailsequence</td></tr></table>

#### Traits

<details>
<summary>List of traits for the claimResponseItemDetailSequence attribute are listed below.</summary>

**is.dataFormat.integer**  
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_claimresponseitemdetailsequence"</td><td>string</td><td></td></tr></table>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Claim Response Item Detail Sequence</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
Status of the Claim Response Item Detail  
First included in: Financial/ClaimResponseItemDetail (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Claim Response Item Detail</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the Claim Response Item Detail</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
Reason for the status of the Claim Response Item Detail  
First included in: Financial/ClaimResponseItemDetail (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Claim Response Item Detail</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the Claim Response Item Detail</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
