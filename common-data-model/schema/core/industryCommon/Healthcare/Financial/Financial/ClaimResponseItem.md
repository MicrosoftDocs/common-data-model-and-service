---
title: ClaimResponseItem in Financial - Common Data Model | Microsoft Docs
...
# Claim Response Item in Financial

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Financial/Financial/ClaimResponseItem.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/Healthcare/Financial/Financial<br>/ClaimResponseItem.cdm.json/ClaimResponseItem<br>/hasAttributes/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[ClaimResponseItem/(resolvedAttributes)/claimResponseItemId](#claimResponseItemId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[ClaimResponseItem/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Claim Response Item</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_ClaimResponseItem"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="ClaimResponseItem.md" target="_blank">Financial/ClaimResponseItem</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="ClaimResponseItem.md" target="_blank">Financial/ClaimResponseItem</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="ClaimResponseItem.md" target="_blank">Financial/ClaimResponseItem</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="ClaimResponseItem.md" target="_blank">Financial/ClaimResponseItem</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="ClaimResponseItem.md" target="_blank">Financial/ClaimResponseItem</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="ClaimResponseItem.md" target="_blank">Financial/ClaimResponseItem</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="ClaimResponseItem.md" target="_blank">Financial/ClaimResponseItem</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="ClaimResponseItem.md" target="_blank">Financial/ClaimResponseItem</a>|
|[ownerId](#ownerId)|Owner Id|<a href="ClaimResponseItem.md" target="_blank">Financial/ClaimResponseItem</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="ClaimResponseItem.md" target="_blank">Financial/ClaimResponseItem</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="ClaimResponseItem.md" target="_blank">Financial/ClaimResponseItem</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="ClaimResponseItem.md" target="_blank">Financial/ClaimResponseItem</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="ClaimResponseItem.md" target="_blank">Financial/ClaimResponseItem</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="ClaimResponseItem.md" target="_blank">Financial/ClaimResponseItem</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="ClaimResponseItem.md" target="_blank">Financial/ClaimResponseItem</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="ClaimResponseItem.md" target="_blank">Financial/ClaimResponseItem</a>|
|[claimItemSequence](#claimItemSequence)|A service line number.|<a href="ClaimResponseItem.md" target="_blank">Financial/ClaimResponseItem</a>|
|[claimResponseId](#claimResponseId)||<a href="ClaimResponseItem.md" target="_blank">Financial/ClaimResponseItem</a>|
|[claimResponseItemId](#claimResponseItemId)|Unique identifier for entity instances|<a href="ClaimResponseItem.md" target="_blank">Financial/ClaimResponseItem</a>|
|[name](#name)|Required name field|<a href="ClaimResponseItem.md" target="_blank">Financial/ClaimResponseItem</a>|
|[stateCode](#stateCode)|Status of the Claim Response Item|<a href="ClaimResponseItem.md" target="_blank">Financial/ClaimResponseItem</a>|
|[stateCode_display](#stateCode_display)||<a href="ClaimResponseItem.md" target="_blank">Financial/ClaimResponseItem</a>|
|[statusCode](#statusCode)|Reason for the status of the Claim Response Item|<a href="ClaimResponseItem.md" target="_blank">Financial/ClaimResponseItem</a>|
|[statusCode_display](#statusCode_display)||<a href="ClaimResponseItem.md" target="_blank">Financial/ClaimResponseItem</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: Financial/ClaimResponseItem (this entity)  
...
### <a href=#claimItemSequence name="claimItemSequence">claimItemSequence</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Claim Item Sequence</td></tr><tr><td>description</td><td>A service line number.</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>maximumValue</td><td>2147483647</td></tr><tr><td>minimumValue</td><td>0</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_claimitemsequence</td></tr></table>

#### Traits

<details>
<summary>List of traits for the claimItemSequence attribute are listed below.</summary>

**is.dataFormat.integer**  
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_claimitemsequence"</td><td>string</td><td></td></tr></table>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Claim Item Sequence</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>A service line number.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
### <a href=#claimResponseItemId name="claimResponseItemId">claimResponseItemId</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Claim Response Item</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>sourceName</td><td>msemr_claimresponseitemid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the claimResponseItemId attribute are listed below.</summary>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_claimresponseitemid"</td><td>string</td><td></td></tr></table>
...
Status of the Claim Response Item  
First included in: Financial/ClaimResponseItem (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Claim Response Item</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the Claim Response Item</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
Reason for the status of the Claim Response Item  
First included in: Financial/ClaimResponseItem (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Claim Response Item</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the Claim Response Item</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
