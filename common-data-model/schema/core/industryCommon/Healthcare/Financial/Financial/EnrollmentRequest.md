...
# Enrollment Request in Financial

This resource provides the insurance enrollment details to the insurer regarding a specified coverage  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Financial/Financial/EnrollmentRequest.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/Healthcare/Financial/Financial<br>/EnrollmentRequest.cdm.json/EnrollmentRequest<br>/hasAttributes/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[EnrollmentRequest/(resolvedAttributes)/enrollmentRequestId](#enrollmentRequestId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[EnrollmentRequest/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Enrollment Request</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>This resource provides the insurance enrollment details to the insurer regarding a specified coverage</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_EnrollmentRequest"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="EnrollmentRequest.md" target="_blank">Financial/EnrollmentRequest</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="EnrollmentRequest.md" target="_blank">Financial/EnrollmentRequest</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="EnrollmentRequest.md" target="_blank">Financial/EnrollmentRequest</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="EnrollmentRequest.md" target="_blank">Financial/EnrollmentRequest</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="EnrollmentRequest.md" target="_blank">Financial/EnrollmentRequest</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="EnrollmentRequest.md" target="_blank">Financial/EnrollmentRequest</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="EnrollmentRequest.md" target="_blank">Financial/EnrollmentRequest</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="EnrollmentRequest.md" target="_blank">Financial/EnrollmentRequest</a>|
|[ownerId](#ownerId)|Owner Id|<a href="EnrollmentRequest.md" target="_blank">Financial/EnrollmentRequest</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="EnrollmentRequest.md" target="_blank">Financial/EnrollmentRequest</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="EnrollmentRequest.md" target="_blank">Financial/EnrollmentRequest</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="EnrollmentRequest.md" target="_blank">Financial/EnrollmentRequest</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="EnrollmentRequest.md" target="_blank">Financial/EnrollmentRequest</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="EnrollmentRequest.md" target="_blank">Financial/EnrollmentRequest</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="EnrollmentRequest.md" target="_blank">Financial/EnrollmentRequest</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="EnrollmentRequest.md" target="_blank">Financial/EnrollmentRequest</a>|
|[coverageId](#coverageId)|Reference to the program or plan identification, underwriter or payor.|<a href="EnrollmentRequest.md" target="_blank">Financial/EnrollmentRequest</a>|
|[enrollmentRequestId](#enrollmentRequestId)|Unique identifier for entity instances|<a href="EnrollmentRequest.md" target="_blank">Financial/EnrollmentRequest</a>|
|[insurerOrganizationId](#insurerOrganizationId)||<a href="EnrollmentRequest.md" target="_blank">Financial/EnrollmentRequest</a>|
|[name](#name)|Required name field|<a href="EnrollmentRequest.md" target="_blank">Financial/EnrollmentRequest</a>|
|[organizationId](#organizationId)|The organization which is responsible for the services rendered to the patient.|<a href="EnrollmentRequest.md" target="_blank">Financial/EnrollmentRequest</a>|
|[providerPractitionerId](#providerPractitionerId)|The practitioner who is responsible for the services rendered to the patient.|<a href="EnrollmentRequest.md" target="_blank">Financial/EnrollmentRequest</a>|
|[subjectPatientId](#subjectPatientId)|Patient Resource.|<a href="EnrollmentRequest.md" target="_blank">Financial/EnrollmentRequest</a>|
|[stateCode](#stateCode)|Status of the Enrollment Request|<a href="EnrollmentRequest.md" target="_blank">Financial/EnrollmentRequest</a>|
|[stateCode_display](#stateCode_display)||<a href="EnrollmentRequest.md" target="_blank">Financial/EnrollmentRequest</a>|
|[statusCode](#statusCode)|Reason for the status of the Enrollment Request|<a href="EnrollmentRequest.md" target="_blank">Financial/EnrollmentRequest</a>|
|[statusCode_display](#statusCode_display)||<a href="EnrollmentRequest.md" target="_blank">Financial/EnrollmentRequest</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: Financial/EnrollmentRequest (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Coverage</td></tr><tr><td>description</td><td>Reference to the program or plan identification, underwriter or payor.</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_coverage</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reference to the program or plan identification, underwriter or payor.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
### <a href=#enrollmentRequestId name="enrollmentRequestId">enrollmentRequestId</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Enrollment Request</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>sourceName</td><td>msemr_enrollmentrequestid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the enrollmentRequestId attribute are listed below.</summary>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_enrollmentrequestid"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Insurer (Organization)</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_insurerorganization</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Subject (Patient)</td></tr><tr><td>description</td><td>Patient Resource.</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_subjectpatient</td></tr></table>
...
Reason for the status of the Enrollment Request  
First included in: Financial/EnrollmentRequest (this entity)  
