---
title: ClaimsProcedure in Financial - Common Data Model | Microsoft Docs
...
# Claims Procedure in Financial

Ordered list of patient procedures performed to support the adjudication.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Financial/Financial/ClaimsProcedure.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/Healthcare/Financial/Financial<br>/ClaimsProcedure.cdm.json/ClaimsProcedure<br>/hasAttributes/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[ClaimsProcedure/(resolvedAttributes)/claimsProcedureId](#claimsProcedureId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[ClaimsProcedure/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Claims Procedure</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Ordered list of patient procedures performed to support the adjudication.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_ClaimsProcedure"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="ClaimsProcedure.md" target="_blank">Financial/ClaimsProcedure</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="ClaimsProcedure.md" target="_blank">Financial/ClaimsProcedure</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="ClaimsProcedure.md" target="_blank">Financial/ClaimsProcedure</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="ClaimsProcedure.md" target="_blank">Financial/ClaimsProcedure</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="ClaimsProcedure.md" target="_blank">Financial/ClaimsProcedure</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="ClaimsProcedure.md" target="_blank">Financial/ClaimsProcedure</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="ClaimsProcedure.md" target="_blank">Financial/ClaimsProcedure</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="ClaimsProcedure.md" target="_blank">Financial/ClaimsProcedure</a>|
|[ownerId](#ownerId)|Owner Id|<a href="ClaimsProcedure.md" target="_blank">Financial/ClaimsProcedure</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="ClaimsProcedure.md" target="_blank">Financial/ClaimsProcedure</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="ClaimsProcedure.md" target="_blank">Financial/ClaimsProcedure</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="ClaimsProcedure.md" target="_blank">Financial/ClaimsProcedure</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="ClaimsProcedure.md" target="_blank">Financial/ClaimsProcedure</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="ClaimsProcedure.md" target="_blank">Financial/ClaimsProcedure</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="ClaimsProcedure.md" target="_blank">Financial/ClaimsProcedure</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="ClaimsProcedure.md" target="_blank">Financial/ClaimsProcedure</a>|
|[claimsProcedureId](#claimsProcedureId)|Unique identifier for entity instances|<a href="ClaimsProcedure.md" target="_blank">Financial/ClaimsProcedure</a>|
|[name](#name)|Required name field|<a href="ClaimsProcedure.md" target="_blank">Financial/ClaimsProcedure</a>|
|[procedureCodeId](#procedureCodeId)|The procedure code|<a href="ClaimsProcedure.md" target="_blank">Financial/ClaimsProcedure</a>|
|[procedureDate](#procedureDate)|Date and optionally time the procedure was performed.|<a href="ClaimsProcedure.md" target="_blank">Financial/ClaimsProcedure</a>|
|[sequence](#sequence)|Sequence of procedures which serves to order and provide a link.|<a href="ClaimsProcedure.md" target="_blank">Financial/ClaimsProcedure</a>|
|[stateCode](#stateCode)|Status of the Claims Procedure|<a href="ClaimsProcedure.md" target="_blank">Financial/ClaimsProcedure</a>|
|[stateCode_display](#stateCode_display)||<a href="ClaimsProcedure.md" target="_blank">Financial/ClaimsProcedure</a>|
|[statusCode](#statusCode)|Reason for the status of the Claims Procedure|<a href="ClaimsProcedure.md" target="_blank">Financial/ClaimsProcedure</a>|
|[statusCode_display](#statusCode_display)||<a href="ClaimsProcedure.md" target="_blank">Financial/ClaimsProcedure</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: Financial/ClaimsProcedure (this entity)  
...
### <a href=#claimsProcedureId name="claimsProcedureId">claimsProcedureId</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Claims Procedure</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>sourceName</td><td>msemr_claimsprocedureid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the claimsProcedureId attribute are listed below.</summary>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_claimsprocedureid"</td><td>string</td><td></td></tr></table>
...
### <a href=#procedureCodeId name="procedureCodeId">procedureCodeId</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Procedure Code</td></tr><tr><td>description</td><td>The procedure code</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_procedurecode</td></tr></table>

#### Traits

<details>
<summary>List of traits for the procedureCodeId attribute are listed below.</summary>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>The procedure code</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_procedurecode"</td><td>string</td><td></td></tr></table>
...
### <a href=#procedureDate name="procedureDate">procedureDate</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Procedure Date</td></tr><tr><td>description</td><td>Date and optionally time the procedure was performed.</td></tr><tr><td>dataFormat</td><td>dateTime</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_proceduredate</td></tr></table>

#### Traits

<details>
<summary>List of traits for the procedureDate attribute are listed below.</summary>
...
**means.measurement.time**  
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_proceduredate"</td><td>string</td><td></td></tr></table>

**is.requiredAtLevel**  
The requirement level for setting values into this attribute in CDS for Applications or for including this attribute in entities created in CDS for Analytics  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>level</td><td>"none"</td><td>string</td><td>values can be: 'systemrequired', 'required', 'recommended', 'none'</td></tr></table>

**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Procedure Date</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Date and optionally time the procedure was performed.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Sequence of procedures which serves to order and provide a link.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Claims Procedure</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the Claims Procedure</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
Reason for the status of the Claims Procedure  
First included in: Financial/ClaimsProcedure (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Claims Procedure</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the Claims Procedure</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
