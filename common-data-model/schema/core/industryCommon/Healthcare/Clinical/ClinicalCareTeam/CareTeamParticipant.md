...
# Care Team Participant in ClinicalCareTeam

Identifies all people and organizations who are expected to be involved in the care team.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Clinical/ClinicalCareTeam/CareTeamParticipant.cdm.json" target="_blank">GitHub</a>.  
...
- [/SyncAgentCDMUpdates/CareTeamParticipant](../../AzureAPIforFHIRsupport/SyncAgentCDMUpdates/CareTeamParticipant.md "/Healthcare/AzureAPIforFHIRsupport/SyncAgentCDMUpdates/CareTeamParticipant.cdm.json/CareTeamParticipant")  
- [/HealthcareFoundation/CareTeamParticipant](../../Foundational/HealthcareFoundation/CareTeamParticipant.md "/Healthcare/Foundational/HealthcareFoundation/CareTeamParticipant.cdm.json/CareTeamParticipant")  
</details>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="CareTeamParticipant.md" target="_blank">ClinicalCareTeam/CareTeamParticipant</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="CareTeamParticipant.md" target="_blank">ClinicalCareTeam/CareTeamParticipant</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="CareTeamParticipant.md" target="_blank">ClinicalCareTeam/CareTeamParticipant</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="CareTeamParticipant.md" target="_blank">ClinicalCareTeam/CareTeamParticipant</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="CareTeamParticipant.md" target="_blank">ClinicalCareTeam/CareTeamParticipant</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="CareTeamParticipant.md" target="_blank">ClinicalCareTeam/CareTeamParticipant</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="CareTeamParticipant.md" target="_blank">ClinicalCareTeam/CareTeamParticipant</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="CareTeamParticipant.md" target="_blank">ClinicalCareTeam/CareTeamParticipant</a>|
|[ownerId](#ownerId)|Owner Id|<a href="CareTeamParticipant.md" target="_blank">ClinicalCareTeam/CareTeamParticipant</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="CareTeamParticipant.md" target="_blank">ClinicalCareTeam/CareTeamParticipant</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="CareTeamParticipant.md" target="_blank">ClinicalCareTeam/CareTeamParticipant</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="CareTeamParticipant.md" target="_blank">ClinicalCareTeam/CareTeamParticipant</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="CareTeamParticipant.md" target="_blank">ClinicalCareTeam/CareTeamParticipant</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="CareTeamParticipant.md" target="_blank">ClinicalCareTeam/CareTeamParticipant</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="CareTeamParticipant.md" target="_blank">ClinicalCareTeam/CareTeamParticipant</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="CareTeamParticipant.md" target="_blank">ClinicalCareTeam/CareTeamParticipant</a>|
|[entityImage](#entityImage)|Entity Image|<a href="CareTeamParticipant.md" target="_blank">ClinicalCareTeam/CareTeamParticipant</a>|
|[careTeamId](#careTeamId)|This records identifiers associated with this care team that are defined by business processes and/or used to refer to it when a direct URL reference to the resource itself is not appropriate.|<a href="CareTeamParticipant.md" target="_blank">ClinicalCareTeam/CareTeamParticipant</a>|
|[careTeamParticipantId](#careTeamParticipantId)|Unique identifier for entity instances|<a href="CareTeamParticipant.md" target="_blank">ClinicalCareTeam/CareTeamParticipant</a>|
|[description](#description)|The name of the custom entity.|<a href="CareTeamParticipant.md" target="_blank">ClinicalCareTeam/CareTeamParticipant</a>|
|[memberCareTeamId](#memberCareTeamId)|Member is care team|<a href="CareTeamParticipant.md" target="_blank">ClinicalCareTeam/CareTeamParticipant</a>|
|[memberOrganizationId](#memberOrganizationId)|Member is organization|<a href="CareTeamParticipant.md" target="_blank">ClinicalCareTeam/CareTeamParticipant</a>|
|[memberPatientId](#memberPatientId)|Member is patient|<a href="CareTeamParticipant.md" target="_blank">ClinicalCareTeam/CareTeamParticipant</a>|
|[memberPractionerId](#memberPractionerId)|Member is practitioner|<a href="CareTeamParticipant.md" target="_blank">ClinicalCareTeam/CareTeamParticipant</a>|
|[memberRelatedPersonId](#memberRelatedPersonId)|Member is person related to patient|<a href="CareTeamParticipant.md" target="_blank">ClinicalCareTeam/CareTeamParticipant</a>|
|[memberType](#memberType)|Type of member.|<a href="CareTeamParticipant.md" target="_blank">ClinicalCareTeam/CareTeamParticipant</a>|
|[memberType_display](#memberType_display)||<a href="CareTeamParticipant.md" target="_blank">ClinicalCareTeam/CareTeamParticipant</a>|
|[onBehalfOfId](#onBehalfOfId)|The organization of the practitioner.|<a href="CareTeamParticipant.md" target="_blank">ClinicalCareTeam/CareTeamParticipant</a>|
|[periodEnd](#periodEnd)|Indicates when the specific member or organization did (or is intended to) come into effect and end.|<a href="CareTeamParticipant.md" target="_blank">ClinicalCareTeam/CareTeamParticipant</a>|
|[periodStart](#periodStart)|Indicates when the specific member or organization did (or is intended to) come into effect and end.|<a href="CareTeamParticipant.md" target="_blank">ClinicalCareTeam/CareTeamParticipant</a>|
|[roleId](#roleId)|Indicates specific responsibility of an individual within the care team, such as "Primary care physician", "Trained social worker counselor", "Caregiver", etc.|<a href="CareTeamParticipant.md" target="_blank">ClinicalCareTeam/CareTeamParticipant</a>|
|[stateCode](#stateCode)|Status of the Care Team Participant|<a href="CareTeamParticipant.md" target="_blank">ClinicalCareTeam/CareTeamParticipant</a>|
|[stateCode_display](#stateCode_display)||<a href="CareTeamParticipant.md" target="_blank">ClinicalCareTeam/CareTeamParticipant</a>|
|[statusCode](#statusCode)|Reason for the status of the Care Team Participant|<a href="CareTeamParticipant.md" target="_blank">ClinicalCareTeam/CareTeamParticipant</a>|
|[statusCode_display](#statusCode_display)||<a href="CareTeamParticipant.md" target="_blank">ClinicalCareTeam/CareTeamParticipant</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: ClinicalCareTeam/CareTeamParticipant (this entity)  
