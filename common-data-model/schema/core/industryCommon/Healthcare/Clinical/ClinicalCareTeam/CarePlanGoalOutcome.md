---
title: CarePlanGoalOutcome in ClinicalCareTeam - Common Data Model | Microsoft Docs
...
# Care Plan Goal Outcome in ClinicalCareTeam

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Clinical/ClinicalCareTeam/CarePlanGoalOutcome.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="CarePlanGoalOutcome.md" target="_blank">ClinicalCareTeam/CarePlanGoalOutcome</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="CarePlanGoalOutcome.md" target="_blank">ClinicalCareTeam/CarePlanGoalOutcome</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="CarePlanGoalOutcome.md" target="_blank">ClinicalCareTeam/CarePlanGoalOutcome</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="CarePlanGoalOutcome.md" target="_blank">ClinicalCareTeam/CarePlanGoalOutcome</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="CarePlanGoalOutcome.md" target="_blank">ClinicalCareTeam/CarePlanGoalOutcome</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="CarePlanGoalOutcome.md" target="_blank">ClinicalCareTeam/CarePlanGoalOutcome</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="CarePlanGoalOutcome.md" target="_blank">ClinicalCareTeam/CarePlanGoalOutcome</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="CarePlanGoalOutcome.md" target="_blank">ClinicalCareTeam/CarePlanGoalOutcome</a>|
|[ownerId](#ownerId)|Owner Id|<a href="CarePlanGoalOutcome.md" target="_blank">ClinicalCareTeam/CarePlanGoalOutcome</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="CarePlanGoalOutcome.md" target="_blank">ClinicalCareTeam/CarePlanGoalOutcome</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="CarePlanGoalOutcome.md" target="_blank">ClinicalCareTeam/CarePlanGoalOutcome</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="CarePlanGoalOutcome.md" target="_blank">ClinicalCareTeam/CarePlanGoalOutcome</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="CarePlanGoalOutcome.md" target="_blank">ClinicalCareTeam/CarePlanGoalOutcome</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="CarePlanGoalOutcome.md" target="_blank">ClinicalCareTeam/CarePlanGoalOutcome</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="CarePlanGoalOutcome.md" target="_blank">ClinicalCareTeam/CarePlanGoalOutcome</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="CarePlanGoalOutcome.md" target="_blank">ClinicalCareTeam/CarePlanGoalOutcome</a>|
|[carePlanGoalId](#carePlanGoalId)|Describes the intended objective(s) of carrying out the care plan.|<a href="CarePlanGoalOutcome.md" target="_blank">ClinicalCareTeam/CarePlanGoalOutcome</a>|
|[carePlanGoalOutcomeId](#carePlanGoalOutcomeId)|Unique identifier for entity instances|<a href="CarePlanGoalOutcome.md" target="_blank">ClinicalCareTeam/CarePlanGoalOutcome</a>|
|[code](#code)||<a href="CarePlanGoalOutcome.md" target="_blank">ClinicalCareTeam/CarePlanGoalOutcome</a>|
|[display](#display)|The name of the custom entity.|<a href="CarePlanGoalOutcome.md" target="_blank">ClinicalCareTeam/CarePlanGoalOutcome</a>|
|[system](#system)||<a href="CarePlanGoalOutcome.md" target="_blank">ClinicalCareTeam/CarePlanGoalOutcome</a>|
|[stateCode](#stateCode)|Status of the Care Plan Goal Outcome|<a href="CarePlanGoalOutcome.md" target="_blank">ClinicalCareTeam/CarePlanGoalOutcome</a>|
|[stateCode_display](#stateCode_display)||<a href="CarePlanGoalOutcome.md" target="_blank">ClinicalCareTeam/CarePlanGoalOutcome</a>|
|[statusCode](#statusCode)|Reason for the status of the Care Plan Goal Outcome|<a href="CarePlanGoalOutcome.md" target="_blank">ClinicalCareTeam/CarePlanGoalOutcome</a>|
|[statusCode_display](#statusCode_display)||<a href="CarePlanGoalOutcome.md" target="_blank">ClinicalCareTeam/CarePlanGoalOutcome</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: ClinicalCareTeam/CarePlanGoalOutcome (this entity)  
