---
title: CarePlanCareTeam in ClinicalCareTeam - Common Data Model | Microsoft Docs
...
# Care Plan Care Team in ClinicalCareTeam
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="CarePlanCareTeam.md" target="_blank">ClinicalCareTeam/CarePlanCareTeam</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="CarePlanCareTeam.md" target="_blank">ClinicalCareTeam/CarePlanCareTeam</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="CarePlanCareTeam.md" target="_blank">ClinicalCareTeam/CarePlanCareTeam</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="CarePlanCareTeam.md" target="_blank">ClinicalCareTeam/CarePlanCareTeam</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="CarePlanCareTeam.md" target="_blank">ClinicalCareTeam/CarePlanCareTeam</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="CarePlanCareTeam.md" target="_blank">ClinicalCareTeam/CarePlanCareTeam</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="CarePlanCareTeam.md" target="_blank">ClinicalCareTeam/CarePlanCareTeam</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="CarePlanCareTeam.md" target="_blank">ClinicalCareTeam/CarePlanCareTeam</a>|
|[ownerId](#ownerId)|Owner Id|<a href="CarePlanCareTeam.md" target="_blank">ClinicalCareTeam/CarePlanCareTeam</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="CarePlanCareTeam.md" target="_blank">ClinicalCareTeam/CarePlanCareTeam</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="CarePlanCareTeam.md" target="_blank">ClinicalCareTeam/CarePlanCareTeam</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="CarePlanCareTeam.md" target="_blank">ClinicalCareTeam/CarePlanCareTeam</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="CarePlanCareTeam.md" target="_blank">ClinicalCareTeam/CarePlanCareTeam</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="CarePlanCareTeam.md" target="_blank">ClinicalCareTeam/CarePlanCareTeam</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="CarePlanCareTeam.md" target="_blank">ClinicalCareTeam/CarePlanCareTeam</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="CarePlanCareTeam.md" target="_blank">ClinicalCareTeam/CarePlanCareTeam</a>|
|[carePlanId](#carePlanId)|Describes the intention of how one or more practitioners intend to deliver care for a particular patient, group or community for a period of time, possibly limited to care for a specific condition.|<a href="CarePlanCareTeam.md" target="_blank">ClinicalCareTeam/CarePlanCareTeam</a>|
|[carePlanCareTeamId](#carePlanCareTeamId)|Unique identifier for entity instances|<a href="CarePlanCareTeam.md" target="_blank">ClinicalCareTeam/CarePlanCareTeam</a>|
|[careTeamId](#careTeamId)|Identifies all people and organizations who are expected to be involved in the care envisioned by this plan.|<a href="CarePlanCareTeam.md" target="_blank">ClinicalCareTeam/CarePlanCareTeam</a>|
|[name](#name)|The name of the custom entity.|<a href="CarePlanCareTeam.md" target="_blank">ClinicalCareTeam/CarePlanCareTeam</a>|
|[stateCode](#stateCode)|Status of the Care Plan Care Team|<a href="CarePlanCareTeam.md" target="_blank">ClinicalCareTeam/CarePlanCareTeam</a>|
|[stateCode_display](#stateCode_display)||<a href="CarePlanCareTeam.md" target="_blank">ClinicalCareTeam/CarePlanCareTeam</a>|
|[statusCode](#statusCode)|Reason for the status of the Care Plan Care Team|<a href="CarePlanCareTeam.md" target="_blank">ClinicalCareTeam/CarePlanCareTeam</a>|
|[statusCode_display](#statusCode_display)||<a href="CarePlanCareTeam.md" target="_blank">ClinicalCareTeam/CarePlanCareTeam</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: ClinicalCareTeam/CarePlanCareTeam (this entity)  
