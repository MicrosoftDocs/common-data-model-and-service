---
title: CarePlanGoal in ClinicalCareTeam - Common Data Model | Microsoft Docs
...
# Care Plan Goal in ClinicalCareTeam

Describes the intended objective(s) of carrying out the care plan.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Clinical/ClinicalCareTeam/CarePlanGoal.cdm.json" target="_blank">GitHub</a>.  
...
- [/HealthcareCareManagement/CarePlanGoal](../../Application/HealthcareCareManagement/CarePlanGoal.md "/Healthcare/Application/HealthcareCareManagement/CarePlanGoal.cdm.json/CarePlanGoal")  
- [/HealthcareFoundation/CarePlanGoal](../../Foundational/HealthcareFoundation/CarePlanGoal.md "/Healthcare/Foundational/HealthcareFoundation/CarePlanGoal.cdm.json/CarePlanGoal")  
</details>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="CarePlanGoal.md" target="_blank">ClinicalCareTeam/CarePlanGoal</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="CarePlanGoal.md" target="_blank">ClinicalCareTeam/CarePlanGoal</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="CarePlanGoal.md" target="_blank">ClinicalCareTeam/CarePlanGoal</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="CarePlanGoal.md" target="_blank">ClinicalCareTeam/CarePlanGoal</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="CarePlanGoal.md" target="_blank">ClinicalCareTeam/CarePlanGoal</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="CarePlanGoal.md" target="_blank">ClinicalCareTeam/CarePlanGoal</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="CarePlanGoal.md" target="_blank">ClinicalCareTeam/CarePlanGoal</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="CarePlanGoal.md" target="_blank">ClinicalCareTeam/CarePlanGoal</a>|
|[ownerId](#ownerId)|Owner Id|<a href="CarePlanGoal.md" target="_blank">ClinicalCareTeam/CarePlanGoal</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="CarePlanGoal.md" target="_blank">ClinicalCareTeam/CarePlanGoal</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="CarePlanGoal.md" target="_blank">ClinicalCareTeam/CarePlanGoal</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="CarePlanGoal.md" target="_blank">ClinicalCareTeam/CarePlanGoal</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="CarePlanGoal.md" target="_blank">ClinicalCareTeam/CarePlanGoal</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="CarePlanGoal.md" target="_blank">ClinicalCareTeam/CarePlanGoal</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="CarePlanGoal.md" target="_blank">ClinicalCareTeam/CarePlanGoal</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="CarePlanGoal.md" target="_blank">ClinicalCareTeam/CarePlanGoal</a>|
|[carePlanId](#carePlanId)|Describes the intention of how one or more practitioners intend to deliver care for a particular patient, group or community for a period of time, possibly limited to care for a specific condition.|<a href="CarePlanGoal.md" target="_blank">ClinicalCareTeam/CarePlanGoal</a>|
|[carePlanGoalId](#carePlanGoalId)|Unique identifier for entity instances|<a href="CarePlanGoal.md" target="_blank">ClinicalCareTeam/CarePlanGoal</a>|
|[goalId](#goalId)|Depricated|<a href="CarePlanGoal.md" target="_blank">ClinicalCareTeam/CarePlanGoal</a>|
|[name](#name)|The name of the custom entity.|<a href="CarePlanGoal.md" target="_blank">ClinicalCareTeam/CarePlanGoal</a>|
|[parentGoalId](#parentGoalId)|Describes the intended objective(s) of carrying out the care plan. Goal can be achieving a particular change or merely maintaining a current state or even slowing a decline.|<a href="CarePlanGoal.md" target="_blank">ClinicalCareTeam/CarePlanGoal</a>|
|[stateCode](#stateCode)|Status of the Care Plan Goal|<a href="CarePlanGoal.md" target="_blank">ClinicalCareTeam/CarePlanGoal</a>|
|[stateCode_display](#stateCode_display)||<a href="CarePlanGoal.md" target="_blank">ClinicalCareTeam/CarePlanGoal</a>|
|[statusCode](#statusCode)|Reason for the status of the Care Plan Goal|<a href="CarePlanGoal.md" target="_blank">ClinicalCareTeam/CarePlanGoal</a>|
|[statusCode_display](#statusCode_display)||<a href="CarePlanGoal.md" target="_blank">ClinicalCareTeam/CarePlanGoal</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: ClinicalCareTeam/CarePlanGoal (this entity)  
...
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="CarePlanGoal.md" target="_blank">/Healthcare/Clinical/ClinicalCareTeam/CarePlanGoal.cdm.json/CarePlanGoal</a></td><td><a href="CarePlanGoal.md#carePlanGoalId" target="_blank">carePlanGoalId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
