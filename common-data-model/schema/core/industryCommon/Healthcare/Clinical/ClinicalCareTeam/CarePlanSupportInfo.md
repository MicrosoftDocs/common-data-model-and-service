---
title: CarePlanSupportInfo in ClinicalCareTeam - Common Data Model | Microsoft Docs
...
# Care Plan Support Info in ClinicalCareTeam

Identifies portions of the patient's record that specifically influenced the formation of the plan. These might include co-morbidities, recent procedures, limitations, recent assessments, etc.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Clinical/ClinicalCareTeam/CarePlanSupportInfo.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="CarePlanSupportInfo.md" target="_blank">ClinicalCareTeam/CarePlanSupportInfo</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="CarePlanSupportInfo.md" target="_blank">ClinicalCareTeam/CarePlanSupportInfo</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="CarePlanSupportInfo.md" target="_blank">ClinicalCareTeam/CarePlanSupportInfo</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="CarePlanSupportInfo.md" target="_blank">ClinicalCareTeam/CarePlanSupportInfo</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="CarePlanSupportInfo.md" target="_blank">ClinicalCareTeam/CarePlanSupportInfo</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="CarePlanSupportInfo.md" target="_blank">ClinicalCareTeam/CarePlanSupportInfo</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="CarePlanSupportInfo.md" target="_blank">ClinicalCareTeam/CarePlanSupportInfo</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="CarePlanSupportInfo.md" target="_blank">ClinicalCareTeam/CarePlanSupportInfo</a>|
|[ownerId](#ownerId)|Owner Id|<a href="CarePlanSupportInfo.md" target="_blank">ClinicalCareTeam/CarePlanSupportInfo</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="CarePlanSupportInfo.md" target="_blank">ClinicalCareTeam/CarePlanSupportInfo</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="CarePlanSupportInfo.md" target="_blank">ClinicalCareTeam/CarePlanSupportInfo</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="CarePlanSupportInfo.md" target="_blank">ClinicalCareTeam/CarePlanSupportInfo</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="CarePlanSupportInfo.md" target="_blank">ClinicalCareTeam/CarePlanSupportInfo</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="CarePlanSupportInfo.md" target="_blank">ClinicalCareTeam/CarePlanSupportInfo</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="CarePlanSupportInfo.md" target="_blank">ClinicalCareTeam/CarePlanSupportInfo</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="CarePlanSupportInfo.md" target="_blank">ClinicalCareTeam/CarePlanSupportInfo</a>|
|[carePlanId](#carePlanId)|Describes the intention of how one or more practitioners intend to deliver care for a particular patient, group or community for a period of time, possibly limited to care for a specific condition.|<a href="CarePlanSupportInfo.md" target="_blank">ClinicalCareTeam/CarePlanSupportInfo</a>|
|[carePlanSupportInfoId](#carePlanSupportInfoId)|Unique identifier for entity instances|<a href="CarePlanSupportInfo.md" target="_blank">ClinicalCareTeam/CarePlanSupportInfo</a>|
|[name](#name)|The name of the custom entity.|<a href="CarePlanSupportInfo.md" target="_blank">ClinicalCareTeam/CarePlanSupportInfo</a>|
|[supportingInfo](#supportingInfo)|Identifies portions of the patient's record that specifically influenced the formation of the plan. These might include co-morbidities, recent procedures, limitations, recent assessments, etc.|<a href="CarePlanSupportInfo.md" target="_blank">ClinicalCareTeam/CarePlanSupportInfo</a>|
|[stateCode](#stateCode)|Status of the Care Plan Support Info|<a href="CarePlanSupportInfo.md" target="_blank">ClinicalCareTeam/CarePlanSupportInfo</a>|
|[stateCode_display](#stateCode_display)||<a href="CarePlanSupportInfo.md" target="_blank">ClinicalCareTeam/CarePlanSupportInfo</a>|
|[statusCode](#statusCode)|Reason for the status of the Care Plan Support Info|<a href="CarePlanSupportInfo.md" target="_blank">ClinicalCareTeam/CarePlanSupportInfo</a>|
|[statusCode_display](#statusCode_display)||<a href="CarePlanSupportInfo.md" target="_blank">ClinicalCareTeam/CarePlanSupportInfo</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: ClinicalCareTeam/CarePlanSupportInfo (this entity)  
