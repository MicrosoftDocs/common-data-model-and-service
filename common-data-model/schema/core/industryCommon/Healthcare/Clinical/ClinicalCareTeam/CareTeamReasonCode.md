...
# Care Team Reason Code in ClinicalCareTeam

Describes why the care team exists.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Clinical/ClinicalCareTeam/CareTeamReasonCode.cdm.json" target="_blank">GitHub</a>.  
...
- [/HealthcareFoundation/CareTeamReasonCode](../../Foundational/HealthcareFoundation/CareTeamReasonCode.md "/Healthcare/Foundational/HealthcareFoundation/CareTeamReasonCode.cdm.json/CareTeamReasonCode")  
</details>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="CareTeamReasonCode.md" target="_blank">ClinicalCareTeam/CareTeamReasonCode</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="CareTeamReasonCode.md" target="_blank">ClinicalCareTeam/CareTeamReasonCode</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="CareTeamReasonCode.md" target="_blank">ClinicalCareTeam/CareTeamReasonCode</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="CareTeamReasonCode.md" target="_blank">ClinicalCareTeam/CareTeamReasonCode</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="CareTeamReasonCode.md" target="_blank">ClinicalCareTeam/CareTeamReasonCode</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="CareTeamReasonCode.md" target="_blank">ClinicalCareTeam/CareTeamReasonCode</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="CareTeamReasonCode.md" target="_blank">ClinicalCareTeam/CareTeamReasonCode</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="CareTeamReasonCode.md" target="_blank">ClinicalCareTeam/CareTeamReasonCode</a>|
|[ownerId](#ownerId)|Owner Id|<a href="CareTeamReasonCode.md" target="_blank">ClinicalCareTeam/CareTeamReasonCode</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="CareTeamReasonCode.md" target="_blank">ClinicalCareTeam/CareTeamReasonCode</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="CareTeamReasonCode.md" target="_blank">ClinicalCareTeam/CareTeamReasonCode</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="CareTeamReasonCode.md" target="_blank">ClinicalCareTeam/CareTeamReasonCode</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="CareTeamReasonCode.md" target="_blank">ClinicalCareTeam/CareTeamReasonCode</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="CareTeamReasonCode.md" target="_blank">ClinicalCareTeam/CareTeamReasonCode</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="CareTeamReasonCode.md" target="_blank">ClinicalCareTeam/CareTeamReasonCode</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="CareTeamReasonCode.md" target="_blank">ClinicalCareTeam/CareTeamReasonCode</a>|
|[careTeamId](#careTeamId)|This records identifiers associated with this care team that are defined by business processes and/or used to refer to it when a direct URL reference to the resource itself is not appropriate.|<a href="CareTeamReasonCode.md" target="_blank">ClinicalCareTeam/CareTeamReasonCode</a>|
|[careTeamReasonCodeId](#careTeamReasonCodeId)|Unique identifier for entity instances|<a href="CareTeamReasonCode.md" target="_blank">ClinicalCareTeam/CareTeamReasonCode</a>|
|[codeId](#codeId)|Describes why the care team exists.|<a href="CareTeamReasonCode.md" target="_blank">ClinicalCareTeam/CareTeamReasonCode</a>|
|[name](#name)|The name of the custom entity.|<a href="CareTeamReasonCode.md" target="_blank">ClinicalCareTeam/CareTeamReasonCode</a>|
|[stateCode](#stateCode)|Status of the Care Team Reason Code|<a href="CareTeamReasonCode.md" target="_blank">ClinicalCareTeam/CareTeamReasonCode</a>|
|[stateCode_display](#stateCode_display)||<a href="CareTeamReasonCode.md" target="_blank">ClinicalCareTeam/CareTeamReasonCode</a>|
|[statusCode](#statusCode)|Reason for the status of the Care Team Reason Code|<a href="CareTeamReasonCode.md" target="_blank">ClinicalCareTeam/CareTeamReasonCode</a>|
|[statusCode_display](#statusCode_display)||<a href="CareTeamReasonCode.md" target="_blank">ClinicalCareTeam/CareTeamReasonCode</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: ClinicalCareTeam/CareTeamReasonCode (this entity)  
