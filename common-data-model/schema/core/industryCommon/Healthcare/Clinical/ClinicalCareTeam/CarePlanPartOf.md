...
# Care Plan Part Of in ClinicalCareTeam

A larger care plan of which this particular care plan is a component or step.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Clinical/ClinicalCareTeam/CarePlanPartOf.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="CarePlanPartOf.md" target="_blank">ClinicalCareTeam/CarePlanPartOf</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="CarePlanPartOf.md" target="_blank">ClinicalCareTeam/CarePlanPartOf</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="CarePlanPartOf.md" target="_blank">ClinicalCareTeam/CarePlanPartOf</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="CarePlanPartOf.md" target="_blank">ClinicalCareTeam/CarePlanPartOf</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="CarePlanPartOf.md" target="_blank">ClinicalCareTeam/CarePlanPartOf</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="CarePlanPartOf.md" target="_blank">ClinicalCareTeam/CarePlanPartOf</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="CarePlanPartOf.md" target="_blank">ClinicalCareTeam/CarePlanPartOf</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="CarePlanPartOf.md" target="_blank">ClinicalCareTeam/CarePlanPartOf</a>|
|[ownerId](#ownerId)|Owner Id|<a href="CarePlanPartOf.md" target="_blank">ClinicalCareTeam/CarePlanPartOf</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="CarePlanPartOf.md" target="_blank">ClinicalCareTeam/CarePlanPartOf</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="CarePlanPartOf.md" target="_blank">ClinicalCareTeam/CarePlanPartOf</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="CarePlanPartOf.md" target="_blank">ClinicalCareTeam/CarePlanPartOf</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="CarePlanPartOf.md" target="_blank">ClinicalCareTeam/CarePlanPartOf</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="CarePlanPartOf.md" target="_blank">ClinicalCareTeam/CarePlanPartOf</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="CarePlanPartOf.md" target="_blank">ClinicalCareTeam/CarePlanPartOf</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="CarePlanPartOf.md" target="_blank">ClinicalCareTeam/CarePlanPartOf</a>|
|[carePlanId](#carePlanId)|Describes the intention of how one or more practitioners intend to deliver care for a particular patient, group or community for a period of time, possibly limited to care for a specific condition.|<a href="CarePlanPartOf.md" target="_blank">ClinicalCareTeam/CarePlanPartOf</a>|
|[carePlanPartOfId](#carePlanPartOfId)|Unique identifier for entity instances|<a href="CarePlanPartOf.md" target="_blank">ClinicalCareTeam/CarePlanPartOf</a>|
|[name](#name)|The name of the custom entity.|<a href="CarePlanPartOf.md" target="_blank">ClinicalCareTeam/CarePlanPartOf</a>|
|[partOfId](#partOfId)|A larger care plan of which this particular care plan is a component or step.|<a href="CarePlanPartOf.md" target="_blank">ClinicalCareTeam/CarePlanPartOf</a>|
|[stateCode](#stateCode)|Status of the Care Plan Part Of|<a href="CarePlanPartOf.md" target="_blank">ClinicalCareTeam/CarePlanPartOf</a>|
|[stateCode_display](#stateCode_display)||<a href="CarePlanPartOf.md" target="_blank">ClinicalCareTeam/CarePlanPartOf</a>|
|[statusCode](#statusCode)|Reason for the status of the Care Plan Part Of|<a href="CarePlanPartOf.md" target="_blank">ClinicalCareTeam/CarePlanPartOf</a>|
|[statusCode_display](#statusCode_display)||<a href="CarePlanPartOf.md" target="_blank">ClinicalCareTeam/CarePlanPartOf</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: ClinicalCareTeam/CarePlanPartOf (this entity)  
