---
title: CareTeamParticipantRole in ClinicalCareTeam - Common Data Model | Microsoft Docs
...
# Care Team Participant Role in ClinicalCareTeam

Indicates specific responsibility of an individual within the care team, such as "Primary care physician", "Trained social worker counselor", "Caregiver", etc.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Clinical/ClinicalCareTeam/CareTeamParticipantRole.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/Healthcare/Clinical/ClinicalCareTeam<br>/CareTeamParticipantRole.cdm.json<br>/CareTeamParticipantRole/hasAttributes<br>/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[CareTeamParticipantRole/(resolvedAttributes)/careTeamParticipantRoleId](#careTeamParticipantRoleId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[CareTeamParticipantRole/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Care Team Participant Role</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_careteamparticipantrole"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="CareTeamParticipantRole.md" target="_blank">ClinicalCareTeam/CareTeamParticipantRole</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="CareTeamParticipantRole.md" target="_blank">ClinicalCareTeam/CareTeamParticipantRole</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="CareTeamParticipantRole.md" target="_blank">ClinicalCareTeam/CareTeamParticipantRole</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="CareTeamParticipantRole.md" target="_blank">ClinicalCareTeam/CareTeamParticipantRole</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="CareTeamParticipantRole.md" target="_blank">ClinicalCareTeam/CareTeamParticipantRole</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="CareTeamParticipantRole.md" target="_blank">ClinicalCareTeam/CareTeamParticipantRole</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="CareTeamParticipantRole.md" target="_blank">ClinicalCareTeam/CareTeamParticipantRole</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="CareTeamParticipantRole.md" target="_blank">ClinicalCareTeam/CareTeamParticipantRole</a>|
|[ownerId](#ownerId)|Owner Id|<a href="CareTeamParticipantRole.md" target="_blank">ClinicalCareTeam/CareTeamParticipantRole</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="CareTeamParticipantRole.md" target="_blank">ClinicalCareTeam/CareTeamParticipantRole</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="CareTeamParticipantRole.md" target="_blank">ClinicalCareTeam/CareTeamParticipantRole</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="CareTeamParticipantRole.md" target="_blank">ClinicalCareTeam/CareTeamParticipantRole</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="CareTeamParticipantRole.md" target="_blank">ClinicalCareTeam/CareTeamParticipantRole</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="CareTeamParticipantRole.md" target="_blank">ClinicalCareTeam/CareTeamParticipantRole</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="CareTeamParticipantRole.md" target="_blank">ClinicalCareTeam/CareTeamParticipantRole</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="CareTeamParticipantRole.md" target="_blank">ClinicalCareTeam/CareTeamParticipantRole</a>|
|[careTeamParticipantRoleId](#careTeamParticipantRoleId)|Unique identifier for entity instances|<a href="CareTeamParticipantRole.md" target="_blank">ClinicalCareTeam/CareTeamParticipantRole</a>|
|[code](#code)||<a href="CareTeamParticipantRole.md" target="_blank">ClinicalCareTeam/CareTeamParticipantRole</a>|
|[display](#display)|The name of the custom entity.|<a href="CareTeamParticipantRole.md" target="_blank">ClinicalCareTeam/CareTeamParticipantRole</a>|
|[system](#system)||<a href="CareTeamParticipantRole.md" target="_blank">ClinicalCareTeam/CareTeamParticipantRole</a>|
|[stateCode](#stateCode)|Status of the Care Team Participant Role|<a href="CareTeamParticipantRole.md" target="_blank">ClinicalCareTeam/CareTeamParticipantRole</a>|
|[stateCode_display](#stateCode_display)||<a href="CareTeamParticipantRole.md" target="_blank">ClinicalCareTeam/CareTeamParticipantRole</a>|
|[statusCode](#statusCode)|Reason for the status of the Care Team Participant Role|<a href="CareTeamParticipantRole.md" target="_blank">ClinicalCareTeam/CareTeamParticipantRole</a>|
|[statusCode_display](#statusCode_display)||<a href="CareTeamParticipantRole.md" target="_blank">ClinicalCareTeam/CareTeamParticipantRole</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: ClinicalCareTeam/CareTeamParticipantRole (this entity)  
...
### <a href=#careTeamParticipantRoleId name="careTeamParticipantRoleId">careTeamParticipantRoleId</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Care Team Participant Role</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>sourceName</td><td>msemr_careteamparticipantroleid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the careTeamParticipantRoleId attribute are listed below.</summary>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_careteamparticipantroleid"</td><td>string</td><td></td></tr></table>
...
Status of the Care Team Participant Role  
First included in: ClinicalCareTeam/CareTeamParticipantRole (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Care Team Participant Role</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the Care Team Participant Role</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
Reason for the status of the Care Team Participant Role  
First included in: ClinicalCareTeam/CareTeamParticipantRole (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Care Team Participant Role</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the Care Team Participant Role</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
