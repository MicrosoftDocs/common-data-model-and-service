...
# Goal in ClinicalCareTeam

Target objective for a user or a team for a specified time period.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Clinical/ClinicalCareTeam/Goal.cdm.json" target="_blank">GitHub</a>.  
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Target objective for a user or a team for a specified time period.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[ownerId](#ownerId)|Owner Id|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[goalId](#goalId)|Unique identifier of the goal.|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[stateCode](#stateCode)|Shows whether the goal is open, completed, or canceled. Completed and canceled goals are read-only and can't be edited.|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[stateCode_display](#stateCode_display)||<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[statusCode](#statusCode)|Select the goal's status.|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[statusCode_display](#statusCode_display)||<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[title](#title)|Type a title or name that describes the goal.|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[fiscalPeriod](#fiscalPeriod)|Select the fiscal period for the goal.|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[fiscalPeriod_display](#fiscalPeriod_display)||<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[fiscalYear](#fiscalYear)|Select the fiscal year for the goal that's being tracked.|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[fiscalYear_display](#fiscalYear_display)||<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[goalStartDate](#goalStartDate)|Enter the date and time when the period for tracking the goal begins.|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[goalEndDate](#goalEndDate)|Enter the date when the goal ends.|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[goalOwnerId](#goalOwnerId)|Choose the user or team responsible for meeting the goal.|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[goalOwnerIdType](#goalOwnerIdType)|The name of the entity linked by goalOwnerId|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[parentGoalId](#parentGoalId)|Choose a parent goal if the current goal is a child goal. This sets up a parent-child relationship for reporting and analytics.|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[transactionCurrencyId](#transactionCurrencyId)|Choose the local currency for the record to make sure budgets are reported in the correct currency.|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[exchangeRate](#exchangeRate)|Shows the conversion rate of the record's currency. The exchange rate is used to convert all money fields in the record from the local currency to the system's default currency.|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[metricId](#metricId)|Choose the metric for the goal. This metric determines how the goal is tracked.|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[treeId](#treeId)|Unique identifier of the goal tree.|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[depth](#depth)|Depth of the goal in the tree.|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[stretchTargetMoney](#stretchTargetMoney)|Select stretch target (money) of the goal to define a higher or difficult level of goal than the usual ones.|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[stretchTargetMoneyBase](#stretchTargetMoneyBase)|Shows the stretch target (money) in base currency to indicate a higher or difficult level of goal than the usual ones.|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[stretchTargetDecimal](#stretchTargetDecimal)|Select a stretch target (decimal) of the goal to define a higher or difficult level of goal than the usual ones.|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[stretchTargetInteger](#stretchTargetInteger)|Select the stretch target (integer) of the goal to define a higher or difficult level of goal than the usual ones.|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[targetMoney](#targetMoney)|Select a goal target (money) to track a monetary amount such as revenue from a product.|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[targetMoneyBase](#targetMoneyBase)|Shows the goal target of the money type in base currency.|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[targetDecimal](#targetDecimal)|Select a goal target of the decimal type to use for tracking data that include partial numbers, such as pounds sold of a product sold by weight.|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[targetInteger](#targetInteger)|Select a goal target of the integer type to use for tracking anything countable in whole numbers, such as units sold.|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[actualMoney](#actualMoney)|Shows the actual value (Money type) achieved towards the target as of the last rolled-up date. This field appears when the metric type of the goal is Amount and the amount data type is Money.|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[actualMoneyBase](#actualMoneyBase)|Shows the actual value (money type) in base currency to track goal results against the target.|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[customRollupFieldMoney](#customRollupFieldMoney)|Indicates a placeholder rollup field for a money value to track a third category of results other than actuals and in-progress results.|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[customRollupFieldMoneyBase](#customRollupFieldMoneyBase)|Indicates a placeholder rollup field for a money value in base currency to track a third category of results other than actuals and in-progress results.|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[inProgressMoney](#inProgressMoney)|Shows the in-progress value (money) against the target. This value could contribute to a goal, but is not counted yet as actual.|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[inProgressMoneyBase](#inProgressMoneyBase)|Shows the in-progress value (money) in base currency to track goal results against the target.|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[actualDecimal](#actualDecimal)|Shows the actual value (Decimal type) achieved towards the target as of the last rolled-up date. This field appears when the metric type of the goal is Amount and the amount data type is Decimal.|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[customRollupFieldDecimal](#customRollupFieldDecimal)|Indicates a placeholder rollup field for a decimal value to track a third category of results other than actuals and in-progress results.|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[inProgressDecimal](#inProgressDecimal)|Shows the in-progress value (decimal) against the target. This value could contribute to a goal, but is not counted yet as actual.|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[actualInteger](#actualInteger)|Shows the actual value (integer) achieved towards the target as of the last rolled-up date. This field appears when the metric type of the goal is Amount or Count and the amount data type is Integer.|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[customRollupFieldInteger](#customRollupFieldInteger)|Indicates a placeholder rollup field for an integer value to track a third category of results other than actuals and in-progress results.|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[inProgressInteger](#inProgressInteger)|Shows the in-progress value (integer) against the target. This value could contribute to a goal, but is not counted yet as actual.|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[percentage](#percentage)|Shows the percentage achieved against the target goal.|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[isFiscalPeriodGoal](#isFiscalPeriodGoal)|Select whether the goal period is a fiscal period or custom period.|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[considerOnlyGoalOwnersRecords](#considerOnlyGoalOwnersRecords)|Select whether only the goal owner's records, or all records, should be rolled up for goal results.|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[lastRolledupDate](#lastRolledupDate)|Shows the date and time when the goal was last rolled up. The date and time are displayed in the time zone selected in Microsoft Dynamics 365 options.|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[targetString](#targetString)|Target value of the goal.|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[stretchTargetString](#stretchTargetString)|Stretch target value for all data types.|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[actualString](#actualString)|Actual Value of the goal.|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[customRollupFieldString](#customRollupFieldString)|Placeholder rollup field for the goal.|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[inProgressString](#inProgressString)|In-progress value of the goal.|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[amountDataType](#amountDataType)|Data type of the amount.|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[amountDataType_display](#amountDataType_display)||<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[isAmount](#isAmount)|Indicates whether the metric type is Count or Amount.|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[rollupQueryActualIntegerId](#rollupQueryActualIntegerId)|Choose the query that will be used to calculate the actual data for the goal (integer).|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[rollUpQueryActualMoneyId](#rollUpQueryActualMoneyId)|Choose the query that will be used to calculate the actual data for the goal (money).|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[rollUpQueryActualDecimalId](#rollUpQueryActualDecimalId)|Choose the query that will be used to calculate the actual data for the goal (decimal).|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[rollUpQueryCustomIntegerId](#rollUpQueryCustomIntegerId)|Choose the query that will be used to calculate data for the custom rollup field (integer).|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[rollUpQueryCustomMoneyId](#rollUpQueryCustomMoneyId)|Choose the query that will be used to calculate data for the custom rollup field (money).|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[rollUpQueryCustomDecimalId](#rollUpQueryCustomDecimalId)|Choose the query that will be used to calculate data for the custom rollup field (decimal).|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[rollUpQueryInprogressIntegerId](#rollUpQueryInprogressIntegerId)|Choose the query that will be used to calculate data for the in-progress rollup field (integer).|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[rollUpQueryInprogressMoneyId](#rollUpQueryInprogressMoneyId)|Choose the query that will be used to calculate data for the in-progress rollup field (money).|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[rollUpQueryInprogressDecimalId](#rollUpQueryInprogressDecimalId)|Choose the query that will be used to calculate data for the in-progress rollup field (decimal).|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[rollupOnlyFromChildGoals](#rollupOnlyFromChildGoals)|Select whether the data should be rolled up only from the child goals.|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[goalWithErrorId](#goalWithErrorId)|Unique identifier of the goal that caused an error in the rollup of the goal hierarchy.|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[rollupErrorCode](#rollupErrorCode)|Error code associated with rollup.|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[computedTargetAsOfTodayPercentageAchieved](#computedTargetAsOfTodayPercentageAchieved)|Shows the expected value for percentage achieved against the target goal as of the current date.|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[computedTargetAsOfTodayMoney](#computedTargetAsOfTodayMoney)|Shows the expected amount for actual value (money type) against the target goal as of the current date.|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[computedTargetAsOfTodayMoneyBase](#computedTargetAsOfTodayMoneyBase)|Shows the expected amount in base currency for actual value (money type) against the target goal as of the current date.|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[computedTargetAsOfTodayDecimal](#computedTargetAsOfTodayDecimal)|Shows the expected amount for actual value (decimal type) against the target goal.|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[computedTargetAsOfTodayInteger](#computedTargetAsOfTodayInteger)|Shows the expected amount for actual value (integer type) against the target goal as of the current date.|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[isOverride](#isOverride)|Indicates whether the values of system rollup fields can be updated.|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[isOverridden](#isOverridden)|Select whether the system rollup fields are updated. If set to Yes, the next system rollup will not update the values of the rollup fields with the system calculated values.|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|
|[entityImageId](#entityImageId)|For internal use only.|<a href="Goal.md" target="_blank">ClinicalCareTeam/Goal</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: ClinicalCareTeam/Goal (this entity)  
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Unique identifier of the goal.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"goalid"</td><td>string</td><td></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Shows whether the goal is open, completed, or canceled. Completed and canceled goals are read-only and can't be edited.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Select the goal's status.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Enter the date and time when the period for tracking the goal begins.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.nullable**  
The attribute value may be set to NULL.  

**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"goalstartdate"</td><td>string</td><td></td></tr></table>
...
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="../../../../../core/applicationCommon/Team.md" target="_blank">/core/applicationCommon/Team.cdm.json/Team</a></td><td><a href="../../../../../core/applicationCommon/Team.md#teamId" target="_blank">teamId</a></td></tr><tr><td><a href="../../../../../core/applicationCommon/User.md" target="_blank">/core/applicationCommon/User.cdm.json/User</a></td><td><a href="../../../../../core/applicationCommon/User.md#systemUserId" target="_blank">systemUserId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
...
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="../../../../../core/applicationCommon/Currency.md" target="_blank">/core/applicationCommon/Currency.cdm.json/Currency</a></td><td><a href="../../../../../core/applicationCommon/Currency.md#transactionCurrencyId" target="_blank">transactionCurrencyId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
...
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="../../../core/applicationCommon/GoalMetric.md" target="_blank">/core/applicationCommon/GoalMetric.cdm.json/GoalMetric</a></td><td><a href="../../../core/applicationCommon/GoalMetric.md#metricId" target="_blank">metricId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
