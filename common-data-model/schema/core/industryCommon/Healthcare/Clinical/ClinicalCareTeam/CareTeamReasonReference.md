---
title: CareTeamReasonReference in ClinicalCareTeam - Common Data Model | Microsoft Docs
...
# Care Team Reason Reference in ClinicalCareTeam

Condition(s) that this care team addresses.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Clinical/ClinicalCareTeam/CareTeamReasonReference.cdm.json" target="_blank">GitHub</a>.  
...
- [/HealthcareFoundation/CareTeamReasonReference](../../Foundational/HealthcareFoundation/CareTeamReasonReference.md "/Healthcare/Foundational/HealthcareFoundation/CareTeamReasonReference.cdm.json/CareTeamReasonReference")  
</details>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="CareTeamReasonReference.md" target="_blank">ClinicalCareTeam/CareTeamReasonReference</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="CareTeamReasonReference.md" target="_blank">ClinicalCareTeam/CareTeamReasonReference</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="CareTeamReasonReference.md" target="_blank">ClinicalCareTeam/CareTeamReasonReference</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="CareTeamReasonReference.md" target="_blank">ClinicalCareTeam/CareTeamReasonReference</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="CareTeamReasonReference.md" target="_blank">ClinicalCareTeam/CareTeamReasonReference</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="CareTeamReasonReference.md" target="_blank">ClinicalCareTeam/CareTeamReasonReference</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="CareTeamReasonReference.md" target="_blank">ClinicalCareTeam/CareTeamReasonReference</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="CareTeamReasonReference.md" target="_blank">ClinicalCareTeam/CareTeamReasonReference</a>|
|[ownerId](#ownerId)|Owner Id|<a href="CareTeamReasonReference.md" target="_blank">ClinicalCareTeam/CareTeamReasonReference</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="CareTeamReasonReference.md" target="_blank">ClinicalCareTeam/CareTeamReasonReference</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="CareTeamReasonReference.md" target="_blank">ClinicalCareTeam/CareTeamReasonReference</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="CareTeamReasonReference.md" target="_blank">ClinicalCareTeam/CareTeamReasonReference</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="CareTeamReasonReference.md" target="_blank">ClinicalCareTeam/CareTeamReasonReference</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="CareTeamReasonReference.md" target="_blank">ClinicalCareTeam/CareTeamReasonReference</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="CareTeamReasonReference.md" target="_blank">ClinicalCareTeam/CareTeamReasonReference</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="CareTeamReasonReference.md" target="_blank">ClinicalCareTeam/CareTeamReasonReference</a>|
|[careTeamId](#careTeamId)|This records identifiers associated with this care team that are defined by business processes and/or used to refer to it when a direct URL reference to the resource itself is not appropriate.|<a href="CareTeamReasonReference.md" target="_blank">ClinicalCareTeam/CareTeamReasonReference</a>|
|[careTeamReasonReferenceId](#careTeamReasonReferenceId)|Unique identifier for entity instances|<a href="CareTeamReasonReference.md" target="_blank">ClinicalCareTeam/CareTeamReasonReference</a>|
|[name](#name)|The name of the custom entity.|<a href="CareTeamReasonReference.md" target="_blank">ClinicalCareTeam/CareTeamReasonReference</a>|
|[referenceId](#referenceId)|Condition(s) that this care team addresses.|<a href="CareTeamReasonReference.md" target="_blank">ClinicalCareTeam/CareTeamReasonReference</a>|
|[stateCode](#stateCode)|Status of the Care Team Reason Reference|<a href="CareTeamReasonReference.md" target="_blank">ClinicalCareTeam/CareTeamReasonReference</a>|
|[stateCode_display](#stateCode_display)||<a href="CareTeamReasonReference.md" target="_blank">ClinicalCareTeam/CareTeamReasonReference</a>|
|[statusCode](#statusCode)|Reason for the status of the Care Team Reason Reference|<a href="CareTeamReasonReference.md" target="_blank">ClinicalCareTeam/CareTeamReasonReference</a>|
|[statusCode_display](#statusCode_display)||<a href="CareTeamReasonReference.md" target="_blank">ClinicalCareTeam/CareTeamReasonReference</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: ClinicalCareTeam/CareTeamReasonReference (this entity)  
