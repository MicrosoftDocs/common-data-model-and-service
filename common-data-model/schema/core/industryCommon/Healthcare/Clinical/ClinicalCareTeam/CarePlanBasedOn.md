...
# Care Plan Based On in ClinicalCareTeam

A care plan that is fulfilled in whole or in part by this care plan.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Clinical/ClinicalCareTeam/CarePlanBasedOn.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="CarePlanBasedOn.md" target="_blank">ClinicalCareTeam/CarePlanBasedOn</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="CarePlanBasedOn.md" target="_blank">ClinicalCareTeam/CarePlanBasedOn</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="CarePlanBasedOn.md" target="_blank">ClinicalCareTeam/CarePlanBasedOn</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="CarePlanBasedOn.md" target="_blank">ClinicalCareTeam/CarePlanBasedOn</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="CarePlanBasedOn.md" target="_blank">ClinicalCareTeam/CarePlanBasedOn</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="CarePlanBasedOn.md" target="_blank">ClinicalCareTeam/CarePlanBasedOn</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="CarePlanBasedOn.md" target="_blank">ClinicalCareTeam/CarePlanBasedOn</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="CarePlanBasedOn.md" target="_blank">ClinicalCareTeam/CarePlanBasedOn</a>|
|[ownerId](#ownerId)|Owner Id|<a href="CarePlanBasedOn.md" target="_blank">ClinicalCareTeam/CarePlanBasedOn</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="CarePlanBasedOn.md" target="_blank">ClinicalCareTeam/CarePlanBasedOn</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="CarePlanBasedOn.md" target="_blank">ClinicalCareTeam/CarePlanBasedOn</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="CarePlanBasedOn.md" target="_blank">ClinicalCareTeam/CarePlanBasedOn</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="CarePlanBasedOn.md" target="_blank">ClinicalCareTeam/CarePlanBasedOn</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="CarePlanBasedOn.md" target="_blank">ClinicalCareTeam/CarePlanBasedOn</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="CarePlanBasedOn.md" target="_blank">ClinicalCareTeam/CarePlanBasedOn</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="CarePlanBasedOn.md" target="_blank">ClinicalCareTeam/CarePlanBasedOn</a>|
|[basedOnId](#basedOnId)|A care plan that is fulfilled in whole or in part by this care plan.|<a href="CarePlanBasedOn.md" target="_blank">ClinicalCareTeam/CarePlanBasedOn</a>|
|[carePlanId](#carePlanId)|Describes the intention of how one or more practitioners intend to deliver care for a particular patient, group or community for a period of time, possibly limited to care for a specific condition.|<a href="CarePlanBasedOn.md" target="_blank">ClinicalCareTeam/CarePlanBasedOn</a>|
|[carePlanBasedOnId](#carePlanBasedOnId)|Unique identifier for entity instances|<a href="CarePlanBasedOn.md" target="_blank">ClinicalCareTeam/CarePlanBasedOn</a>|
|[name](#name)|The name of the custom entity.|<a href="CarePlanBasedOn.md" target="_blank">ClinicalCareTeam/CarePlanBasedOn</a>|
|[stateCode](#stateCode)|Status of the Care Plan Based On|<a href="CarePlanBasedOn.md" target="_blank">ClinicalCareTeam/CarePlanBasedOn</a>|
|[stateCode_display](#stateCode_display)||<a href="CarePlanBasedOn.md" target="_blank">ClinicalCareTeam/CarePlanBasedOn</a>|
|[statusCode](#statusCode)|Reason for the status of the Care Plan Based On|<a href="CarePlanBasedOn.md" target="_blank">ClinicalCareTeam/CarePlanBasedOn</a>|
|[statusCode_display](#statusCode_display)||<a href="CarePlanBasedOn.md" target="_blank">ClinicalCareTeam/CarePlanBasedOn</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: ClinicalCareTeam/CarePlanBasedOn (this entity)  
