...
# Care Team Category in ClinicalCareTeam

Identifies what kind of team. This is to support differentiation between multiple co-existing teams, such as care plan team, episode of care team, longitudinal care team.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Clinical/ClinicalCareTeam/CareTeamCategory.cdm.json" target="_blank">GitHub</a>.  
...
- [/HealthcareFoundation/CareTeamCategory](../../Foundational/HealthcareFoundation/CareTeamCategory.md "/Healthcare/Foundational/HealthcareFoundation/CareTeamCategory.cdm.json/CareTeamCategory")  
</details>
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/Healthcare/Clinical/ClinicalCareTeam<br>/CareTeamCategory.cdm.json/CareTeamCategory<br>/hasAttributes/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[CareTeamCategory/(resolvedAttributes)/careTeamCategoryId](#careTeamCategoryId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[CareTeamCategory/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Care Team Category</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Identifies what kind of team. This is to support differentiation between multiple co-existing teams, such as care plan team, episode of care team, longitudinal care team.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_careteamcategory"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="CareTeamCategory.md" target="_blank">ClinicalCareTeam/CareTeamCategory</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="CareTeamCategory.md" target="_blank">ClinicalCareTeam/CareTeamCategory</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="CareTeamCategory.md" target="_blank">ClinicalCareTeam/CareTeamCategory</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="CareTeamCategory.md" target="_blank">ClinicalCareTeam/CareTeamCategory</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="CareTeamCategory.md" target="_blank">ClinicalCareTeam/CareTeamCategory</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="CareTeamCategory.md" target="_blank">ClinicalCareTeam/CareTeamCategory</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="CareTeamCategory.md" target="_blank">ClinicalCareTeam/CareTeamCategory</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="CareTeamCategory.md" target="_blank">ClinicalCareTeam/CareTeamCategory</a>|
|[ownerId](#ownerId)|Owner Id|<a href="CareTeamCategory.md" target="_blank">ClinicalCareTeam/CareTeamCategory</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="CareTeamCategory.md" target="_blank">ClinicalCareTeam/CareTeamCategory</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="CareTeamCategory.md" target="_blank">ClinicalCareTeam/CareTeamCategory</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="CareTeamCategory.md" target="_blank">ClinicalCareTeam/CareTeamCategory</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="CareTeamCategory.md" target="_blank">ClinicalCareTeam/CareTeamCategory</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="CareTeamCategory.md" target="_blank">ClinicalCareTeam/CareTeamCategory</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="CareTeamCategory.md" target="_blank">ClinicalCareTeam/CareTeamCategory</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="CareTeamCategory.md" target="_blank">ClinicalCareTeam/CareTeamCategory</a>|
|[careTeamId](#careTeamId)|This records identifiers associated with this care team that are defined by business processes and/or used to refer to it when a direct URL reference to the resource itself is not appropriate.|<a href="CareTeamCategory.md" target="_blank">ClinicalCareTeam/CareTeamCategory</a>|
|[careTeamCategoryId](#careTeamCategoryId)|Unique identifier for entity instances|<a href="CareTeamCategory.md" target="_blank">ClinicalCareTeam/CareTeamCategory</a>|
|[categoryId](#categoryId)|Identifies what kind of team. This is to support differentiation between multiple co-existing teams, such as care plan team, episode of care team, longitudinal care team.|<a href="CareTeamCategory.md" target="_blank">ClinicalCareTeam/CareTeamCategory</a>|
|[name](#name)|The name of the custom entity.|<a href="CareTeamCategory.md" target="_blank">ClinicalCareTeam/CareTeamCategory</a>|
|[stateCode](#stateCode)|Status of the Care Team Category|<a href="CareTeamCategory.md" target="_blank">ClinicalCareTeam/CareTeamCategory</a>|
|[stateCode_display](#stateCode_display)||<a href="CareTeamCategory.md" target="_blank">ClinicalCareTeam/CareTeamCategory</a>|
|[statusCode](#statusCode)|Reason for the status of the Care Team Category|<a href="CareTeamCategory.md" target="_blank">ClinicalCareTeam/CareTeamCategory</a>|
|[statusCode_display](#statusCode_display)||<a href="CareTeamCategory.md" target="_blank">ClinicalCareTeam/CareTeamCategory</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: ClinicalCareTeam/CareTeamCategory (this entity)  
...
### <a href=#careTeamCategoryId name="careTeamCategoryId">careTeamCategoryId</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Care Team Category</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>sourceName</td><td>msemr_careteamcategoryid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the careTeamCategoryId attribute are listed below.</summary>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_careteamcategoryid"</td><td>string</td><td></td></tr></table>
...
Status of the Care Team Category  
First included in: ClinicalCareTeam/CareTeamCategory (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Care Team Category</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the Care Team Category</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
Reason for the status of the Care Team Category  
First included in: ClinicalCareTeam/CareTeamCategory (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Care Team Category</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the Care Team Category</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
