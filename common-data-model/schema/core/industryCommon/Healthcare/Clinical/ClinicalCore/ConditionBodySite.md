---
title: ConditionBodySite in ClinicalCore - Common Data Model | Microsoft Docs
...
# Condition Body Site in ClinicalCore
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="ConditionBodySite.md" target="_blank">ClinicalCore/ConditionBodySite</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="ConditionBodySite.md" target="_blank">ClinicalCore/ConditionBodySite</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="ConditionBodySite.md" target="_blank">ClinicalCore/ConditionBodySite</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="ConditionBodySite.md" target="_blank">ClinicalCore/ConditionBodySite</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="ConditionBodySite.md" target="_blank">ClinicalCore/ConditionBodySite</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="ConditionBodySite.md" target="_blank">ClinicalCore/ConditionBodySite</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="ConditionBodySite.md" target="_blank">ClinicalCore/ConditionBodySite</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="ConditionBodySite.md" target="_blank">ClinicalCore/ConditionBodySite</a>|
|[ownerId](#ownerId)|Owner Id|<a href="ConditionBodySite.md" target="_blank">ClinicalCore/ConditionBodySite</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="ConditionBodySite.md" target="_blank">ClinicalCore/ConditionBodySite</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="ConditionBodySite.md" target="_blank">ClinicalCore/ConditionBodySite</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="ConditionBodySite.md" target="_blank">ClinicalCore/ConditionBodySite</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="ConditionBodySite.md" target="_blank">ClinicalCore/ConditionBodySite</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="ConditionBodySite.md" target="_blank">ClinicalCore/ConditionBodySite</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="ConditionBodySite.md" target="_blank">ClinicalCore/ConditionBodySite</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="ConditionBodySite.md" target="_blank">ClinicalCore/ConditionBodySite</a>|
|[bodySiteId](#bodySiteId)|List of anatomical locations|<a href="ConditionBodySite.md" target="_blank">ClinicalCore/ConditionBodySite</a>|
|[conditionId](#conditionId)|Detailed information about conditions, problems or diagnoses|<a href="ConditionBodySite.md" target="_blank">ClinicalCore/ConditionBodySite</a>|
|[conditionBodySiteId](#conditionBodySiteId)|Unique identifier for entity instances|<a href="ConditionBodySite.md" target="_blank">ClinicalCore/ConditionBodySite</a>|
|[name](#name)|The name of the custom entity.|<a href="ConditionBodySite.md" target="_blank">ClinicalCore/ConditionBodySite</a>|
|[stateCode](#stateCode)|Status of the ConditionBodySite|<a href="ConditionBodySite.md" target="_blank">ClinicalCore/ConditionBodySite</a>|
|[stateCode_display](#stateCode_display)||<a href="ConditionBodySite.md" target="_blank">ClinicalCore/ConditionBodySite</a>|
|[statusCode](#statusCode)|Reason for the status of the ConditionBodySite|<a href="ConditionBodySite.md" target="_blank">ClinicalCore/ConditionBodySite</a>|
|[statusCode_display](#statusCode_display)||<a href="ConditionBodySite.md" target="_blank">ClinicalCore/ConditionBodySite</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: ClinicalCore/ConditionBodySite (this entity)  
