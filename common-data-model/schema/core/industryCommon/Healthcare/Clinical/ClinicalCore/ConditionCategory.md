---
title: ConditionCategory in ClinicalCore - Common Data Model | Microsoft Docs
...
# Condition Category in ClinicalCore

A category assigned to the condition.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Clinical/ClinicalCore/ConditionCategory.cdm.json" target="_blank">GitHub</a>.  
...
- [/HealthcareFoundation/ConditionCategory](../../Foundational/HealthcareFoundation/ConditionCategory.md "/Healthcare/Foundational/HealthcareFoundation/ConditionCategory.cdm.json/ConditionCategory")  
</details>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="ConditionCategory.md" target="_blank">ClinicalCore/ConditionCategory</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="ConditionCategory.md" target="_blank">ClinicalCore/ConditionCategory</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="ConditionCategory.md" target="_blank">ClinicalCore/ConditionCategory</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="ConditionCategory.md" target="_blank">ClinicalCore/ConditionCategory</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="ConditionCategory.md" target="_blank">ClinicalCore/ConditionCategory</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="ConditionCategory.md" target="_blank">ClinicalCore/ConditionCategory</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="ConditionCategory.md" target="_blank">ClinicalCore/ConditionCategory</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="ConditionCategory.md" target="_blank">ClinicalCore/ConditionCategory</a>|
|[ownerId](#ownerId)|Owner Id|<a href="ConditionCategory.md" target="_blank">ClinicalCore/ConditionCategory</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="ConditionCategory.md" target="_blank">ClinicalCore/ConditionCategory</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="ConditionCategory.md" target="_blank">ClinicalCore/ConditionCategory</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="ConditionCategory.md" target="_blank">ClinicalCore/ConditionCategory</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="ConditionCategory.md" target="_blank">ClinicalCore/ConditionCategory</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="ConditionCategory.md" target="_blank">ClinicalCore/ConditionCategory</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="ConditionCategory.md" target="_blank">ClinicalCore/ConditionCategory</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="ConditionCategory.md" target="_blank">ClinicalCore/ConditionCategory</a>|
|[categoryId](#categoryId)|Categorization of the condition recorded by health care practitioner.|<a href="ConditionCategory.md" target="_blank">ClinicalCore/ConditionCategory</a>|
|[conditionId](#conditionId)|Detailed information about conditions, problems or diagnoses|<a href="ConditionCategory.md" target="_blank">ClinicalCore/ConditionCategory</a>|
|[conditionCategoryId](#conditionCategoryId)|Unique identifier for entity instances|<a href="ConditionCategory.md" target="_blank">ClinicalCore/ConditionCategory</a>|
|[name](#name)|The name of the custom entity.|<a href="ConditionCategory.md" target="_blank">ClinicalCore/ConditionCategory</a>|
|[stateCode](#stateCode)|Status of the Condition Category|<a href="ConditionCategory.md" target="_blank">ClinicalCore/ConditionCategory</a>|
|[stateCode_display](#stateCode_display)||<a href="ConditionCategory.md" target="_blank">ClinicalCore/ConditionCategory</a>|
|[statusCode](#statusCode)|Reason for the status of the Condition Category|<a href="ConditionCategory.md" target="_blank">ClinicalCore/ConditionCategory</a>|
|[statusCode_display](#statusCode_display)||<a href="ConditionCategory.md" target="_blank">ClinicalCore/ConditionCategory</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: ClinicalCore/ConditionCategory (this entity)  
