...
# Risk Assessment in ClinicalCore

An assessment of the likely outcome(s) for a patient or other subject as well as the likelihood of each outcome.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Clinical/ClinicalCore/RiskAssessment.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="RiskAssessment.md" target="_blank">ClinicalCore/RiskAssessment</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="RiskAssessment.md" target="_blank">ClinicalCore/RiskAssessment</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="RiskAssessment.md" target="_blank">ClinicalCore/RiskAssessment</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="RiskAssessment.md" target="_blank">ClinicalCore/RiskAssessment</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="RiskAssessment.md" target="_blank">ClinicalCore/RiskAssessment</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="RiskAssessment.md" target="_blank">ClinicalCore/RiskAssessment</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="RiskAssessment.md" target="_blank">ClinicalCore/RiskAssessment</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="RiskAssessment.md" target="_blank">ClinicalCore/RiskAssessment</a>|
|[ownerId](#ownerId)|Owner Id|<a href="RiskAssessment.md" target="_blank">ClinicalCore/RiskAssessment</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="RiskAssessment.md" target="_blank">ClinicalCore/RiskAssessment</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="RiskAssessment.md" target="_blank">ClinicalCore/RiskAssessment</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="RiskAssessment.md" target="_blank">ClinicalCore/RiskAssessment</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="RiskAssessment.md" target="_blank">ClinicalCore/RiskAssessment</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="RiskAssessment.md" target="_blank">ClinicalCore/RiskAssessment</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="RiskAssessment.md" target="_blank">ClinicalCore/RiskAssessment</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="RiskAssessment.md" target="_blank">ClinicalCore/RiskAssessment</a>|
|[basedOn](#basedOn)|A reference to the request that is fulfilled by this risk assessment.|<a href="RiskAssessment.md" target="_blank">ClinicalCore/RiskAssessment</a>|
|[basis](#basis)|Indicates the source data considered as part of the assessment (Family History, Observations, Procedures, Conditions, etc.).|<a href="RiskAssessment.md" target="_blank">ClinicalCore/RiskAssessment</a>|
|[codeId](#codeId)|The type of the risk assessment performed.|<a href="RiskAssessment.md" target="_blank">ClinicalCore/RiskAssessment</a>|
|[comment](#comment)|Additional comments about the risk assessment.|<a href="RiskAssessment.md" target="_blank">ClinicalCore/RiskAssessment</a>|
|[conditionId](#conditionId)|For assessments or prognosis specific to a particular condition, indicates the condition being assessed.|<a href="RiskAssessment.md" target="_blank">ClinicalCore/RiskAssessment</a>|
|[contextencounterId](#contextencounterId)|The encounter where the assessment was performed.|<a href="RiskAssessment.md" target="_blank">ClinicalCore/RiskAssessment</a>|
|[contextspisodeofcareId](#contextspisodeofcareId)|The Episode of care type of the encounter where the assessment was performed.|<a href="RiskAssessment.md" target="_blank">ClinicalCore/RiskAssessment</a>|
|[contextType](#contextType)|Type of context under which assessment is performed|<a href="RiskAssessment.md" target="_blank">ClinicalCore/RiskAssessment</a>|
|[contextType_display](#contextType_display)||<a href="RiskAssessment.md" target="_blank">ClinicalCore/RiskAssessment</a>|
|[methodId](#methodId)|The algorithm, process or mechanism used to evaluate the risk.|<a href="RiskAssessment.md" target="_blank">ClinicalCore/RiskAssessment</a>|
|[mitigation](#mitigation)|A description of the steps that might be taken to reduce the identified risk(s).|<a href="RiskAssessment.md" target="_blank">ClinicalCore/RiskAssessment</a>|
|[name](#name)|The name of the custom entity.|<a href="RiskAssessment.md" target="_blank">ClinicalCore/RiskAssessment</a>|
|[occurrencedatetime](#occurrencedatetime)|The date (and possibly time) the risk assessment was performed.|<a href="RiskAssessment.md" target="_blank">ClinicalCore/RiskAssessment</a>|
|[occurrenceenddate](#occurrenceenddate)|The date (and possibly time) the risk assessment was performed.|<a href="RiskAssessment.md" target="_blank">ClinicalCore/RiskAssessment</a>|
|[occurrencestartdate](#occurrencestartdate)|The start date of the risk assessment was performed.|<a href="RiskAssessment.md" target="_blank">ClinicalCore/RiskAssessment</a>|
|[occurrenceType](#occurrenceType)|Type of time when assessment occurred|<a href="RiskAssessment.md" target="_blank">ClinicalCore/RiskAssessment</a>|
|[occurrenceType_display](#occurrenceType_display)||<a href="RiskAssessment.md" target="_blank">ClinicalCore/RiskAssessment</a>|
|[parent](#parent)|A reference to a resource that this risk assessment is part of, such as a Procedure.|<a href="RiskAssessment.md" target="_blank">ClinicalCore/RiskAssessment</a>|
|[performerPractitionerId](#performerPractitionerId)|The provider that performed the assessment.|<a href="RiskAssessment.md" target="_blank">ClinicalCore/RiskAssessment</a>|
|[performerType](#performerType)|Type of performer|<a href="RiskAssessment.md" target="_blank">ClinicalCore/RiskAssessment</a>|
|[performerType_display](#performerType_display)||<a href="RiskAssessment.md" target="_blank">ClinicalCore/RiskAssessment</a>|
|[reasonConceptId](#reasonConceptId)|The reason the risk assessment was performed.|<a href="RiskAssessment.md" target="_blank">ClinicalCore/RiskAssessment</a>|
|[reasonentity](#reasonentity)|The reason the risk assessment was performed.|<a href="RiskAssessment.md" target="_blank">ClinicalCore/RiskAssessment</a>|
|[reasonType](#reasonType)|Type of reason why assessment is performed|<a href="RiskAssessment.md" target="_blank">ClinicalCore/RiskAssessment</a>|
|[reasonType_display](#reasonType_display)||<a href="RiskAssessment.md" target="_blank">ClinicalCore/RiskAssessment</a>|
|[riskAssessmentId](#riskAssessmentId)|Unique identifier for entity instances|<a href="RiskAssessment.md" target="_blank">ClinicalCore/RiskAssessment</a>|
|[riskAssessmentNumber](#riskAssessmentNumber)|Business identifier assigned to the risk assessment.|<a href="RiskAssessment.md" target="_blank">ClinicalCore/RiskAssessment</a>|
|[status](#status)|The status of the Risk Assessment, using the same statuses as an Observation.|<a href="RiskAssessment.md" target="_blank">ClinicalCore/RiskAssessment</a>|
|[status_display](#status_display)||<a href="RiskAssessment.md" target="_blank">ClinicalCore/RiskAssessment</a>|
|[subjectgroupId](#subjectgroupId)|The group the risk assessment applies to.|<a href="RiskAssessment.md" target="_blank">ClinicalCore/RiskAssessment</a>|
|[subjectpatientId](#subjectpatientId)|The patient the risk assessment applies to.|<a href="RiskAssessment.md" target="_blank">ClinicalCore/RiskAssessment</a>|
|[subjectType](#subjectType)|The patient or group the risk assessment applies to.|<a href="RiskAssessment.md" target="_blank">ClinicalCore/RiskAssessment</a>|
|[subjectType_display](#subjectType_display)||<a href="RiskAssessment.md" target="_blank">ClinicalCore/RiskAssessment</a>|
|[stateCode](#stateCode)|Status of the Risk Assessment|<a href="RiskAssessment.md" target="_blank">ClinicalCore/RiskAssessment</a>|
|[stateCode_display](#stateCode_display)||<a href="RiskAssessment.md" target="_blank">ClinicalCore/RiskAssessment</a>|
|[statusCode](#statusCode)|Reason for the status of the Risk Assessment|<a href="RiskAssessment.md" target="_blank">ClinicalCore/RiskAssessment</a>|
|[statusCode_display](#statusCode_display)||<a href="RiskAssessment.md" target="_blank">ClinicalCore/RiskAssessment</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: ClinicalCore/RiskAssessment (this entity)  
