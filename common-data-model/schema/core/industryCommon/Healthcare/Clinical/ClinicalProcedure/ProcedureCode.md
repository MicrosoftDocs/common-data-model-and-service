...
# Procedure Code in ClinicalProcedure

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Clinical/ClinicalProcedure/ProcedureCode.cdm.json" target="_blank">GitHub</a>.  
...
- [/HealthcareFoundation/ProcedureCode](../../Foundational/HealthcareFoundation/ProcedureCode.md "/Healthcare/Foundational/HealthcareFoundation/ProcedureCode.cdm.json/ProcedureCode")  
</details>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="ProcedureCode.md" target="_blank">ClinicalProcedure/ProcedureCode</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="ProcedureCode.md" target="_blank">ClinicalProcedure/ProcedureCode</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="ProcedureCode.md" target="_blank">ClinicalProcedure/ProcedureCode</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="ProcedureCode.md" target="_blank">ClinicalProcedure/ProcedureCode</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="ProcedureCode.md" target="_blank">ClinicalProcedure/ProcedureCode</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="ProcedureCode.md" target="_blank">ClinicalProcedure/ProcedureCode</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="ProcedureCode.md" target="_blank">ClinicalProcedure/ProcedureCode</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="ProcedureCode.md" target="_blank">ClinicalProcedure/ProcedureCode</a>|
|[ownerId](#ownerId)|Owner Id|<a href="ProcedureCode.md" target="_blank">ClinicalProcedure/ProcedureCode</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="ProcedureCode.md" target="_blank">ClinicalProcedure/ProcedureCode</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="ProcedureCode.md" target="_blank">ClinicalProcedure/ProcedureCode</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="ProcedureCode.md" target="_blank">ClinicalProcedure/ProcedureCode</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="ProcedureCode.md" target="_blank">ClinicalProcedure/ProcedureCode</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="ProcedureCode.md" target="_blank">ClinicalProcedure/ProcedureCode</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="ProcedureCode.md" target="_blank">ClinicalProcedure/ProcedureCode</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="ProcedureCode.md" target="_blank">ClinicalProcedure/ProcedureCode</a>|
|[code](#code)||<a href="ProcedureCode.md" target="_blank">ClinicalProcedure/ProcedureCode</a>|
|[display](#display)|The name of the custom entity.|<a href="ProcedureCode.md" target="_blank">ClinicalProcedure/ProcedureCode</a>|
|[procedureCodeId](#procedureCodeId)|Unique identifier for entity instances|<a href="ProcedureCode.md" target="_blank">ClinicalProcedure/ProcedureCode</a>|
|[system](#system)||<a href="ProcedureCode.md" target="_blank">ClinicalProcedure/ProcedureCode</a>|
|[stateCode](#stateCode)|Status of the Procedure Code|<a href="ProcedureCode.md" target="_blank">ClinicalProcedure/ProcedureCode</a>|
|[stateCode_display](#stateCode_display)||<a href="ProcedureCode.md" target="_blank">ClinicalProcedure/ProcedureCode</a>|
|[statusCode](#statusCode)|Reason for the status of the Procedure Code|<a href="ProcedureCode.md" target="_blank">ClinicalProcedure/ProcedureCode</a>|
|[statusCode_display](#statusCode_display)||<a href="ProcedureCode.md" target="_blank">ClinicalProcedure/ProcedureCode</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: ClinicalProcedure/ProcedureCode (this entity)  
