...
# Procedure Reason in ClinicalProcedure
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="ProcedureReason.md" target="_blank">ClinicalProcedure/ProcedureReason</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="ProcedureReason.md" target="_blank">ClinicalProcedure/ProcedureReason</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="ProcedureReason.md" target="_blank">ClinicalProcedure/ProcedureReason</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="ProcedureReason.md" target="_blank">ClinicalProcedure/ProcedureReason</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="ProcedureReason.md" target="_blank">ClinicalProcedure/ProcedureReason</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="ProcedureReason.md" target="_blank">ClinicalProcedure/ProcedureReason</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="ProcedureReason.md" target="_blank">ClinicalProcedure/ProcedureReason</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="ProcedureReason.md" target="_blank">ClinicalProcedure/ProcedureReason</a>|
|[ownerId](#ownerId)|Owner Id|<a href="ProcedureReason.md" target="_blank">ClinicalProcedure/ProcedureReason</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="ProcedureReason.md" target="_blank">ClinicalProcedure/ProcedureReason</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="ProcedureReason.md" target="_blank">ClinicalProcedure/ProcedureReason</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="ProcedureReason.md" target="_blank">ClinicalProcedure/ProcedureReason</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="ProcedureReason.md" target="_blank">ClinicalProcedure/ProcedureReason</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="ProcedureReason.md" target="_blank">ClinicalProcedure/ProcedureReason</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="ProcedureReason.md" target="_blank">ClinicalProcedure/ProcedureReason</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="ProcedureReason.md" target="_blank">ClinicalProcedure/ProcedureReason</a>|
|[display](#display)|The name of the custom entity.|<a href="ProcedureReason.md" target="_blank">ClinicalProcedure/ProcedureReason</a>|
|[procedureId](#procedureId)|An action that is or was performed on a patient. This can be a physical intervention like an operation, or less invasive like counseling or hypnotherapy.|<a href="ProcedureReason.md" target="_blank">ClinicalProcedure/ProcedureReason</a>|
|[procedureReasonId](#procedureReasonId)|Unique identifier for entity instances|<a href="ProcedureReason.md" target="_blank">ClinicalProcedure/ProcedureReason</a>|
|[reasonCodeId](#reasonCodeId)|The coded reason why the procedure was performed. This may be coded entity of some type, or may simply be present as text.|<a href="ProcedureReason.md" target="_blank">ClinicalProcedure/ProcedureReason</a>|
|[stateCode](#stateCode)|Status of the Procedure Reason|<a href="ProcedureReason.md" target="_blank">ClinicalProcedure/ProcedureReason</a>|
|[stateCode_display](#stateCode_display)||<a href="ProcedureReason.md" target="_blank">ClinicalProcedure/ProcedureReason</a>|
|[statusCode](#statusCode)|Reason for the status of the Procedure Reason|<a href="ProcedureReason.md" target="_blank">ClinicalProcedure/ProcedureReason</a>|
|[statusCode_display](#statusCode_display)||<a href="ProcedureReason.md" target="_blank">ClinicalProcedure/ProcedureReason</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: ClinicalProcedure/ProcedureReason (this entity)  
