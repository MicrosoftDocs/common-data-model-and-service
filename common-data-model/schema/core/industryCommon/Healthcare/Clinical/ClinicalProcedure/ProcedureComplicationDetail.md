...
# Procedure Complication Detail in ClinicalProcedure

Any complications that occurred during the procedure, or in the immediate post-performance period.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Clinical/ClinicalProcedure/ProcedureComplicationDetail.cdm.json" target="_blank">GitHub</a>.  
...
- [/HealthcareFoundation/ProcedureComplicationDetail](../../Foundational/HealthcareFoundation/ProcedureComplicationDetail.md "/Healthcare/Foundational/HealthcareFoundation/ProcedureComplicationDetail.cdm.json/ProcedureComplicationDetail")  
</details>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="ProcedureComplicationDetail.md" target="_blank">ClinicalProcedure/ProcedureComplicationDetail</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="ProcedureComplicationDetail.md" target="_blank">ClinicalProcedure/ProcedureComplicationDetail</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="ProcedureComplicationDetail.md" target="_blank">ClinicalProcedure/ProcedureComplicationDetail</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="ProcedureComplicationDetail.md" target="_blank">ClinicalProcedure/ProcedureComplicationDetail</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="ProcedureComplicationDetail.md" target="_blank">ClinicalProcedure/ProcedureComplicationDetail</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="ProcedureComplicationDetail.md" target="_blank">ClinicalProcedure/ProcedureComplicationDetail</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="ProcedureComplicationDetail.md" target="_blank">ClinicalProcedure/ProcedureComplicationDetail</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="ProcedureComplicationDetail.md" target="_blank">ClinicalProcedure/ProcedureComplicationDetail</a>|
|[ownerId](#ownerId)|Owner Id|<a href="ProcedureComplicationDetail.md" target="_blank">ClinicalProcedure/ProcedureComplicationDetail</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="ProcedureComplicationDetail.md" target="_blank">ClinicalProcedure/ProcedureComplicationDetail</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="ProcedureComplicationDetail.md" target="_blank">ClinicalProcedure/ProcedureComplicationDetail</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="ProcedureComplicationDetail.md" target="_blank">ClinicalProcedure/ProcedureComplicationDetail</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="ProcedureComplicationDetail.md" target="_blank">ClinicalProcedure/ProcedureComplicationDetail</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="ProcedureComplicationDetail.md" target="_blank">ClinicalProcedure/ProcedureComplicationDetail</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="ProcedureComplicationDetail.md" target="_blank">ClinicalProcedure/ProcedureComplicationDetail</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="ProcedureComplicationDetail.md" target="_blank">ClinicalProcedure/ProcedureComplicationDetail</a>|
|[complicationConditionIdentifierId](#complicationConditionIdentifierId)|Any complications that occurred during the procedure, or in the immediate post-performance period.|<a href="ProcedureComplicationDetail.md" target="_blank">ClinicalProcedure/ProcedureComplicationDetail</a>|
|[name](#name)|The name of the custom entity.|<a href="ProcedureComplicationDetail.md" target="_blank">ClinicalProcedure/ProcedureComplicationDetail</a>|
|[procedureId](#procedureId)|An action that is or was performed on a patient. This can be a physical intervention like an operation, or less invasive like counseling or hypnotherapy.|<a href="ProcedureComplicationDetail.md" target="_blank">ClinicalProcedure/ProcedureComplicationDetail</a>|
|[procedureComplicationDetailId](#procedureComplicationDetailId)|Unique identifier for entity instances|<a href="ProcedureComplicationDetail.md" target="_blank">ClinicalProcedure/ProcedureComplicationDetail</a>|
|[stateCode](#stateCode)|Status of the Procedure Complication Detail|<a href="ProcedureComplicationDetail.md" target="_blank">ClinicalProcedure/ProcedureComplicationDetail</a>|
|[stateCode_display](#stateCode_display)||<a href="ProcedureComplicationDetail.md" target="_blank">ClinicalProcedure/ProcedureComplicationDetail</a>|
|[statusCode](#statusCode)|Reason for the status of the Procedure Complication Detail|<a href="ProcedureComplicationDetail.md" target="_blank">ClinicalProcedure/ProcedureComplicationDetail</a>|
|[statusCode_display](#statusCode_display)||<a href="ProcedureComplicationDetail.md" target="_blank">ClinicalProcedure/ProcedureComplicationDetail</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: ClinicalProcedure/ProcedureComplicationDetail (this entity)  
