...
# Procedure Report in ClinicalProcedure

Procedure report could represent histology result, pathology report, surgical report, etc.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Clinical/ClinicalProcedure/ProcedureReport.cdm.json" target="_blank">GitHub</a>.  
...
- [/HealthcareFoundation/ProcedureReport](../../Foundational/HealthcareFoundation/ProcedureReport.md "/Healthcare/Foundational/HealthcareFoundation/ProcedureReport.cdm.json/ProcedureReport")  
</details>
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/Healthcare/Clinical/ClinicalProcedure<br>/ProcedureReport.cdm.json/ProcedureReport<br>/hasAttributes/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[ProcedureReport/(resolvedAttributes)/procedureReportId](#procedureReportId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[ProcedureReport/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Procedure Report</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Procedure report could represent histology result, pathology report, surgical report, etc.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_procedurereport"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="ProcedureReport.md" target="_blank">ClinicalProcedure/ProcedureReport</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="ProcedureReport.md" target="_blank">ClinicalProcedure/ProcedureReport</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="ProcedureReport.md" target="_blank">ClinicalProcedure/ProcedureReport</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="ProcedureReport.md" target="_blank">ClinicalProcedure/ProcedureReport</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="ProcedureReport.md" target="_blank">ClinicalProcedure/ProcedureReport</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="ProcedureReport.md" target="_blank">ClinicalProcedure/ProcedureReport</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="ProcedureReport.md" target="_blank">ClinicalProcedure/ProcedureReport</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="ProcedureReport.md" target="_blank">ClinicalProcedure/ProcedureReport</a>|
|[ownerId](#ownerId)|Owner Id|<a href="ProcedureReport.md" target="_blank">ClinicalProcedure/ProcedureReport</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="ProcedureReport.md" target="_blank">ClinicalProcedure/ProcedureReport</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="ProcedureReport.md" target="_blank">ClinicalProcedure/ProcedureReport</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="ProcedureReport.md" target="_blank">ClinicalProcedure/ProcedureReport</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="ProcedureReport.md" target="_blank">ClinicalProcedure/ProcedureReport</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="ProcedureReport.md" target="_blank">ClinicalProcedure/ProcedureReport</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="ProcedureReport.md" target="_blank">ClinicalProcedure/ProcedureReport</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="ProcedureReport.md" target="_blank">ClinicalProcedure/ProcedureReport</a>|
|[name](#name)|The name of the custom entity.|<a href="ProcedureReport.md" target="_blank">ClinicalProcedure/ProcedureReport</a>|
|[procedureId](#procedureId)|An action that is or was performed on a patient. This can be a physical intervention like an operation, or less invasive like counseling or hypnotherapy.|<a href="ProcedureReport.md" target="_blank">ClinicalProcedure/ProcedureReport</a>|
|[procedureReportId](#procedureReportId)|Unique identifier for entity instances|<a href="ProcedureReport.md" target="_blank">ClinicalProcedure/ProcedureReport</a>|
|[reportId](#reportId)|This could be a histology result, pathology report, surgical report, etc..|<a href="ProcedureReport.md" target="_blank">ClinicalProcedure/ProcedureReport</a>|
|[stateCode](#stateCode)|Status of the Procedure Report|<a href="ProcedureReport.md" target="_blank">ClinicalProcedure/ProcedureReport</a>|
|[stateCode_display](#stateCode_display)||<a href="ProcedureReport.md" target="_blank">ClinicalProcedure/ProcedureReport</a>|
|[statusCode](#statusCode)|Reason for the status of the Procedure Report|<a href="ProcedureReport.md" target="_blank">ClinicalProcedure/ProcedureReport</a>|
|[statusCode_display](#statusCode_display)||<a href="ProcedureReport.md" target="_blank">ClinicalProcedure/ProcedureReport</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: ClinicalProcedure/ProcedureReport (this entity)  
...
### <a href=#procedureReportId name="procedureReportId">procedureReportId</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Procedure Report</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>sourceName</td><td>msemr_procedurereportid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the procedureReportId attribute are listed below.</summary>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_procedurereportid"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Report</td></tr><tr><td>description</td><td>This could be a histology result, pathology report, surgical report, etc..</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_report</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>This could be a histology result, pathology report, surgical report, etc..</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_report"</td><td>string</td><td></td></tr></table>
...
Status of the Procedure Report  
First included in: ClinicalProcedure/ProcedureReport (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Procedure Report</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the Procedure Report</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
Reason for the status of the Procedure Report  
First included in: ClinicalProcedure/ProcedureReport (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Procedure Report</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the Procedure Report</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
