...
# Procedure Request Category in ClinicalProcedure
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="ProcedureRequestCategory.md" target="_blank">ClinicalProcedure/ProcedureRequestCategory</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="ProcedureRequestCategory.md" target="_blank">ClinicalProcedure/ProcedureRequestCategory</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="ProcedureRequestCategory.md" target="_blank">ClinicalProcedure/ProcedureRequestCategory</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="ProcedureRequestCategory.md" target="_blank">ClinicalProcedure/ProcedureRequestCategory</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="ProcedureRequestCategory.md" target="_blank">ClinicalProcedure/ProcedureRequestCategory</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="ProcedureRequestCategory.md" target="_blank">ClinicalProcedure/ProcedureRequestCategory</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="ProcedureRequestCategory.md" target="_blank">ClinicalProcedure/ProcedureRequestCategory</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="ProcedureRequestCategory.md" target="_blank">ClinicalProcedure/ProcedureRequestCategory</a>|
|[ownerId](#ownerId)|Owner Id|<a href="ProcedureRequestCategory.md" target="_blank">ClinicalProcedure/ProcedureRequestCategory</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="ProcedureRequestCategory.md" target="_blank">ClinicalProcedure/ProcedureRequestCategory</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="ProcedureRequestCategory.md" target="_blank">ClinicalProcedure/ProcedureRequestCategory</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="ProcedureRequestCategory.md" target="_blank">ClinicalProcedure/ProcedureRequestCategory</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="ProcedureRequestCategory.md" target="_blank">ClinicalProcedure/ProcedureRequestCategory</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="ProcedureRequestCategory.md" target="_blank">ClinicalProcedure/ProcedureRequestCategory</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="ProcedureRequestCategory.md" target="_blank">ClinicalProcedure/ProcedureRequestCategory</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="ProcedureRequestCategory.md" target="_blank">ClinicalProcedure/ProcedureRequestCategory</a>|
|[categoryId](#categoryId)|A code that classifies the procedure for searching, sorting and display purposes (e.g. ""Surgical Procedure"").|<a href="ProcedureRequestCategory.md" target="_blank">ClinicalProcedure/ProcedureRequestCategory</a>|
|[name](#name)|The name of the custom entity.|<a href="ProcedureRequestCategory.md" target="_blank">ClinicalProcedure/ProcedureRequestCategory</a>|
|[procedureRequestId](#procedureRequestId)|Unique identifier for the Procedure Request.|<a href="ProcedureRequestCategory.md" target="_blank">ClinicalProcedure/ProcedureRequestCategory</a>|
|[procedureRequestCategoryId](#procedureRequestCategoryId)|Unique identifier for entity instances|<a href="ProcedureRequestCategory.md" target="_blank">ClinicalProcedure/ProcedureRequestCategory</a>|
|[stateCode](#stateCode)|Status of the Procedure Request Category|<a href="ProcedureRequestCategory.md" target="_blank">ClinicalProcedure/ProcedureRequestCategory</a>|
|[stateCode_display](#stateCode_display)||<a href="ProcedureRequestCategory.md" target="_blank">ClinicalProcedure/ProcedureRequestCategory</a>|
|[statusCode](#statusCode)|Reason for the status of the Procedure Request Category|<a href="ProcedureRequestCategory.md" target="_blank">ClinicalProcedure/ProcedureRequestCategory</a>|
|[statusCode_display](#statusCode_display)||<a href="ProcedureRequestCategory.md" target="_blank">ClinicalProcedure/ProcedureRequestCategory</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: ClinicalProcedure/ProcedureRequestCategory (this entity)  
