---
title: ProcedureUsedCode in ClinicalProcedure - Common Data Model | Microsoft Docs
...
# Procedure Used Code in ClinicalProcedure

Identifies coded items that were used as part of the procedure.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Clinical/ClinicalProcedure/ProcedureUsedCode.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="ProcedureUsedCode.md" target="_blank">ClinicalProcedure/ProcedureUsedCode</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="ProcedureUsedCode.md" target="_blank">ClinicalProcedure/ProcedureUsedCode</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="ProcedureUsedCode.md" target="_blank">ClinicalProcedure/ProcedureUsedCode</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="ProcedureUsedCode.md" target="_blank">ClinicalProcedure/ProcedureUsedCode</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="ProcedureUsedCode.md" target="_blank">ClinicalProcedure/ProcedureUsedCode</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="ProcedureUsedCode.md" target="_blank">ClinicalProcedure/ProcedureUsedCode</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="ProcedureUsedCode.md" target="_blank">ClinicalProcedure/ProcedureUsedCode</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="ProcedureUsedCode.md" target="_blank">ClinicalProcedure/ProcedureUsedCode</a>|
|[ownerId](#ownerId)|Owner Id|<a href="ProcedureUsedCode.md" target="_blank">ClinicalProcedure/ProcedureUsedCode</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="ProcedureUsedCode.md" target="_blank">ClinicalProcedure/ProcedureUsedCode</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="ProcedureUsedCode.md" target="_blank">ClinicalProcedure/ProcedureUsedCode</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="ProcedureUsedCode.md" target="_blank">ClinicalProcedure/ProcedureUsedCode</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="ProcedureUsedCode.md" target="_blank">ClinicalProcedure/ProcedureUsedCode</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="ProcedureUsedCode.md" target="_blank">ClinicalProcedure/ProcedureUsedCode</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="ProcedureUsedCode.md" target="_blank">ClinicalProcedure/ProcedureUsedCode</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="ProcedureUsedCode.md" target="_blank">ClinicalProcedure/ProcedureUsedCode</a>|
|[codedItemId](#codedItemId)|Identifies coded items that were used as part of the procedure.|<a href="ProcedureUsedCode.md" target="_blank">ClinicalProcedure/ProcedureUsedCode</a>|
|[name](#name)|The name of the custom entity.|<a href="ProcedureUsedCode.md" target="_blank">ClinicalProcedure/ProcedureUsedCode</a>|
|[procedureId](#procedureId)|An action that is or was performed on a patient. This can be a physical intervention like an operation, or less invasive like counseling or hypnotherapy.|<a href="ProcedureUsedCode.md" target="_blank">ClinicalProcedure/ProcedureUsedCode</a>|
|[procedureUsedCodeId](#procedureUsedCodeId)|Unique identifier for entity instances|<a href="ProcedureUsedCode.md" target="_blank">ClinicalProcedure/ProcedureUsedCode</a>|
|[stateCode](#stateCode)|Status of the Procedure Used Code|<a href="ProcedureUsedCode.md" target="_blank">ClinicalProcedure/ProcedureUsedCode</a>|
|[stateCode_display](#stateCode_display)||<a href="ProcedureUsedCode.md" target="_blank">ClinicalProcedure/ProcedureUsedCode</a>|
|[statusCode](#statusCode)|Reason for the status of the Procedure Used Code|<a href="ProcedureUsedCode.md" target="_blank">ClinicalProcedure/ProcedureUsedCode</a>|
|[statusCode_display](#statusCode_display)||<a href="ProcedureUsedCode.md" target="_blank">ClinicalProcedure/ProcedureUsedCode</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: ClinicalProcedure/ProcedureUsedCode (this entity)  
