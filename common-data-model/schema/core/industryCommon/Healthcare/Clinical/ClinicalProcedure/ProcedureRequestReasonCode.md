...
# Procedure Request Reason Code in ClinicalProcedure
...
An explanation or justification for why this diagnostic investigation is being requested in coded or textual form. This is often for billing purposes. May relate to the resources referred to in supp  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Clinical/ClinicalProcedure/ProcedureRequestReasonCode.cdm.json" target="_blank">GitHub</a>.  
...
- [/HealthcareFoundation/ProcedureRequestReasonCode](../../Foundational/HealthcareFoundation/ProcedureRequestReasonCode.md "/Healthcare/Foundational/HealthcareFoundation/ProcedureRequestReasonCode.cdm.json/ProcedureRequestReasonCode")  
</details>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="ProcedureRequestReasonCode.md" target="_blank">ClinicalProcedure/ProcedureRequestReasonCode</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="ProcedureRequestReasonCode.md" target="_blank">ClinicalProcedure/ProcedureRequestReasonCode</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="ProcedureRequestReasonCode.md" target="_blank">ClinicalProcedure/ProcedureRequestReasonCode</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="ProcedureRequestReasonCode.md" target="_blank">ClinicalProcedure/ProcedureRequestReasonCode</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="ProcedureRequestReasonCode.md" target="_blank">ClinicalProcedure/ProcedureRequestReasonCode</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="ProcedureRequestReasonCode.md" target="_blank">ClinicalProcedure/ProcedureRequestReasonCode</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="ProcedureRequestReasonCode.md" target="_blank">ClinicalProcedure/ProcedureRequestReasonCode</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="ProcedureRequestReasonCode.md" target="_blank">ClinicalProcedure/ProcedureRequestReasonCode</a>|
|[ownerId](#ownerId)|Owner Id|<a href="ProcedureRequestReasonCode.md" target="_blank">ClinicalProcedure/ProcedureRequestReasonCode</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="ProcedureRequestReasonCode.md" target="_blank">ClinicalProcedure/ProcedureRequestReasonCode</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="ProcedureRequestReasonCode.md" target="_blank">ClinicalProcedure/ProcedureRequestReasonCode</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="ProcedureRequestReasonCode.md" target="_blank">ClinicalProcedure/ProcedureRequestReasonCode</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="ProcedureRequestReasonCode.md" target="_blank">ClinicalProcedure/ProcedureRequestReasonCode</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="ProcedureRequestReasonCode.md" target="_blank">ClinicalProcedure/ProcedureRequestReasonCode</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="ProcedureRequestReasonCode.md" target="_blank">ClinicalProcedure/ProcedureRequestReasonCode</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="ProcedureRequestReasonCode.md" target="_blank">ClinicalProcedure/ProcedureRequestReasonCode</a>|
|[name](#name)|The name of the custom entity.|<a href="ProcedureRequestReasonCode.md" target="_blank">ClinicalProcedure/ProcedureRequestReasonCode</a>|
|[procedureRequestId](#procedureRequestId)|Unique identifier for the Procedure Request.|<a href="ProcedureRequestReasonCode.md" target="_blank">ClinicalProcedure/ProcedureRequestReasonCode</a>|
|[procedureRequestReasonCodeId](#procedureRequestReasonCodeId)|Unique identifier for entity instances|<a href="ProcedureRequestReasonCode.md" target="_blank">ClinicalProcedure/ProcedureRequestReasonCode</a>|
|[reasonCodeId](#reasonCodeId)|An explanation or justification for why this diagnostic investigation is being requested in coded or textual form. This is often for billing purposes.|<a href="ProcedureRequestReasonCode.md" target="_blank">ClinicalProcedure/ProcedureRequestReasonCode</a>|
|[stateCode](#stateCode)|Status of the Procedure Request Reason Code|<a href="ProcedureRequestReasonCode.md" target="_blank">ClinicalProcedure/ProcedureRequestReasonCode</a>|
|[stateCode_display](#stateCode_display)||<a href="ProcedureRequestReasonCode.md" target="_blank">ClinicalProcedure/ProcedureRequestReasonCode</a>|
|[statusCode](#statusCode)|Reason for the status of the Procedure Request Reason Code|<a href="ProcedureRequestReasonCode.md" target="_blank">ClinicalProcedure/ProcedureRequestReasonCode</a>|
|[statusCode_display](#statusCode_display)||<a href="ProcedureRequestReasonCode.md" target="_blank">ClinicalProcedure/ProcedureRequestReasonCode</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: ClinicalProcedure/ProcedureRequestReasonCode (this entity)  
