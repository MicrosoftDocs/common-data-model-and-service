...
# Procedure Focal Device in ClinicalProcedure

A device that is implanted, removed or otherwise manipulated (calibration, battery replacement, fitting a prosthesis, attaching a wound-vac, etc.) as a focal portion of the Procedure.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Clinical/ClinicalProcedure/ProcedureFocalDevice.cdm.json" target="_blank">GitHub</a>.  
...
- [/HealthcareFoundation/ProcedureFocalDevice](../../Foundational/HealthcareFoundation/ProcedureFocalDevice.md "/Healthcare/Foundational/HealthcareFoundation/ProcedureFocalDevice.cdm.json/ProcedureFocalDevice")  
</details>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="ProcedureFocalDevice.md" target="_blank">ClinicalProcedure/ProcedureFocalDevice</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="ProcedureFocalDevice.md" target="_blank">ClinicalProcedure/ProcedureFocalDevice</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="ProcedureFocalDevice.md" target="_blank">ClinicalProcedure/ProcedureFocalDevice</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="ProcedureFocalDevice.md" target="_blank">ClinicalProcedure/ProcedureFocalDevice</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="ProcedureFocalDevice.md" target="_blank">ClinicalProcedure/ProcedureFocalDevice</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="ProcedureFocalDevice.md" target="_blank">ClinicalProcedure/ProcedureFocalDevice</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="ProcedureFocalDevice.md" target="_blank">ClinicalProcedure/ProcedureFocalDevice</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="ProcedureFocalDevice.md" target="_blank">ClinicalProcedure/ProcedureFocalDevice</a>|
|[ownerId](#ownerId)|Owner Id|<a href="ProcedureFocalDevice.md" target="_blank">ClinicalProcedure/ProcedureFocalDevice</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="ProcedureFocalDevice.md" target="_blank">ClinicalProcedure/ProcedureFocalDevice</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="ProcedureFocalDevice.md" target="_blank">ClinicalProcedure/ProcedureFocalDevice</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="ProcedureFocalDevice.md" target="_blank">ClinicalProcedure/ProcedureFocalDevice</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="ProcedureFocalDevice.md" target="_blank">ClinicalProcedure/ProcedureFocalDevice</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="ProcedureFocalDevice.md" target="_blank">ClinicalProcedure/ProcedureFocalDevice</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="ProcedureFocalDevice.md" target="_blank">ClinicalProcedure/ProcedureFocalDevice</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="ProcedureFocalDevice.md" target="_blank">ClinicalProcedure/ProcedureFocalDevice</a>|
|[foculDeviceActionId](#foculDeviceActionId)|The kind of change that happened to the device during the procedure.|<a href="ProcedureFocalDevice.md" target="_blank">ClinicalProcedure/ProcedureFocalDevice</a>|
|[name](#name)|The name of the custom entity.|<a href="ProcedureFocalDevice.md" target="_blank">ClinicalProcedure/ProcedureFocalDevice</a>|
|[procedureId](#procedureId)|An action that is or was performed on a patient. This can be a physical intervention like an operation, or less invasive like counseling or hypnotherapy.|<a href="ProcedureFocalDevice.md" target="_blank">ClinicalProcedure/ProcedureFocalDevice</a>|
|[procedureFocalDeviceId](#procedureFocalDeviceId)|Unique identifier for entity instances|<a href="ProcedureFocalDevice.md" target="_blank">ClinicalProcedure/ProcedureFocalDevice</a>|
|[stateCode](#stateCode)|Status of the Procedure Focal Device|<a href="ProcedureFocalDevice.md" target="_blank">ClinicalProcedure/ProcedureFocalDevice</a>|
|[stateCode_display](#stateCode_display)||<a href="ProcedureFocalDevice.md" target="_blank">ClinicalProcedure/ProcedureFocalDevice</a>|
|[statusCode](#statusCode)|Reason for the status of the Procedure Focal Device|<a href="ProcedureFocalDevice.md" target="_blank">ClinicalProcedure/ProcedureFocalDevice</a>|
|[statusCode_display](#statusCode_display)||<a href="ProcedureFocalDevice.md" target="_blank">ClinicalProcedure/ProcedureFocalDevice</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: ClinicalProcedure/ProcedureFocalDevice (this entity)  
