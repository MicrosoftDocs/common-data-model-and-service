---
title: DiagnosticReport in DiagnosticReport - Common Data Model | Microsoft Docs
...
# Diagnostic Report in DiagnosticReport
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="DiagnosticReport.md" target="_blank">DiagnosticReport/DiagnosticReport</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="DiagnosticReport.md" target="_blank">DiagnosticReport/DiagnosticReport</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="DiagnosticReport.md" target="_blank">DiagnosticReport/DiagnosticReport</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="DiagnosticReport.md" target="_blank">DiagnosticReport/DiagnosticReport</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="DiagnosticReport.md" target="_blank">DiagnosticReport/DiagnosticReport</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="DiagnosticReport.md" target="_blank">DiagnosticReport/DiagnosticReport</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="DiagnosticReport.md" target="_blank">DiagnosticReport/DiagnosticReport</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="DiagnosticReport.md" target="_blank">DiagnosticReport/DiagnosticReport</a>|
|[ownerId](#ownerId)|Owner Id|<a href="DiagnosticReport.md" target="_blank">DiagnosticReport/DiagnosticReport</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="DiagnosticReport.md" target="_blank">DiagnosticReport/DiagnosticReport</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="DiagnosticReport.md" target="_blank">DiagnosticReport/DiagnosticReport</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="DiagnosticReport.md" target="_blank">DiagnosticReport/DiagnosticReport</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="DiagnosticReport.md" target="_blank">DiagnosticReport/DiagnosticReport</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="DiagnosticReport.md" target="_blank">DiagnosticReport/DiagnosticReport</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="DiagnosticReport.md" target="_blank">DiagnosticReport/DiagnosticReport</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="DiagnosticReport.md" target="_blank">DiagnosticReport/DiagnosticReport</a>|
|[codeId](#codeId)||<a href="DiagnosticReport.md" target="_blank">DiagnosticReport/DiagnosticReport</a>|
|[conclusion](#conclusion)|Required name field|<a href="DiagnosticReport.md" target="_blank">DiagnosticReport/DiagnosticReport</a>|
|[diagnosticReportId](#diagnosticReportId)|Unique identifier for entity instances|<a href="DiagnosticReport.md" target="_blank">DiagnosticReport/DiagnosticReport</a>|
|[effectiveEndDateTime](#effectiveEndDateTime)||<a href="DiagnosticReport.md" target="_blank">DiagnosticReport/DiagnosticReport</a>|
|[effectiveStartDateTime](#effectiveStartDateTime)||<a href="DiagnosticReport.md" target="_blank">DiagnosticReport/DiagnosticReport</a>|
|[encounterId](#encounterId)||<a href="DiagnosticReport.md" target="_blank">DiagnosticReport/DiagnosticReport</a>|
|[issued](#issued)||<a href="DiagnosticReport.md" target="_blank">DiagnosticReport/DiagnosticReport</a>|
|[status](#status)||<a href="DiagnosticReport.md" target="_blank">DiagnosticReport/DiagnosticReport</a>|
|[status_display](#status_display)||<a href="DiagnosticReport.md" target="_blank">DiagnosticReport/DiagnosticReport</a>|
|[subjectLocationId](#subjectLocationId)||<a href="DiagnosticReport.md" target="_blank">DiagnosticReport/DiagnosticReport</a>|
|[subjectPatientId](#subjectPatientId)||<a href="DiagnosticReport.md" target="_blank">DiagnosticReport/DiagnosticReport</a>|
|[stateCode](#stateCode)|Status of the Diagnostic Report|<a href="DiagnosticReport.md" target="_blank">DiagnosticReport/DiagnosticReport</a>|
|[stateCode_display](#stateCode_display)||<a href="DiagnosticReport.md" target="_blank">DiagnosticReport/DiagnosticReport</a>|
|[statusCode](#statusCode)|Reason for the status of the Diagnostic Report|<a href="DiagnosticReport.md" target="_blank">DiagnosticReport/DiagnosticReport</a>|
|[statusCode_display](#statusCode_display)||<a href="DiagnosticReport.md" target="_blank">DiagnosticReport/DiagnosticReport</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: DiagnosticReport/DiagnosticReport (this entity)  
