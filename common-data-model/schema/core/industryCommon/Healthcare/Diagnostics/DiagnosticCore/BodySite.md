---
title: BodySite in DiagnosticCore - Common Data Model | Microsoft Docs
...
Record details about the anatomical location of a specimen or body part. This entity may be used when a coded concept does not provide the necessary detail needed for the use case.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Diagnostics/DiagnosticCore/BodySite.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="BodySite.md" target="_blank">DiagnosticCore/BodySite</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="BodySite.md" target="_blank">DiagnosticCore/BodySite</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="BodySite.md" target="_blank">DiagnosticCore/BodySite</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="BodySite.md" target="_blank">DiagnosticCore/BodySite</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="BodySite.md" target="_blank">DiagnosticCore/BodySite</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="BodySite.md" target="_blank">DiagnosticCore/BodySite</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="BodySite.md" target="_blank">DiagnosticCore/BodySite</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="BodySite.md" target="_blank">DiagnosticCore/BodySite</a>|
|[ownerId](#ownerId)|Owner Id|<a href="BodySite.md" target="_blank">DiagnosticCore/BodySite</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="BodySite.md" target="_blank">DiagnosticCore/BodySite</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="BodySite.md" target="_blank">DiagnosticCore/BodySite</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="BodySite.md" target="_blank">DiagnosticCore/BodySite</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="BodySite.md" target="_blank">DiagnosticCore/BodySite</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="BodySite.md" target="_blank">DiagnosticCore/BodySite</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="BodySite.md" target="_blank">DiagnosticCore/BodySite</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="BodySite.md" target="_blank">DiagnosticCore/BodySite</a>|
|[bodySiteId](#bodySiteId)|Unique identifier for entity instances|<a href="BodySite.md" target="_blank">DiagnosticCore/BodySite</a>|
|[code](#code)|Named anatomical location - ideally coded where possible.|<a href="BodySite.md" target="_blank">DiagnosticCore/BodySite</a>|
|[conditionId](#conditionId)|A clinical condition, problem, diagnosis, or other event, situation, issue, or clinical concept that has risen to a level of concern.|<a href="BodySite.md" target="_blank">DiagnosticCore/BodySite</a>|
|[display](#display)|The name of the custom entity.|<a href="BodySite.md" target="_blank">DiagnosticCore/BodySite</a>|
|[system](#system)|Identifier for this instance of the anatomical location.|<a href="BodySite.md" target="_blank">DiagnosticCore/BodySite</a>|
|[stateCode](#stateCode)|Status of the Body Site|<a href="BodySite.md" target="_blank">DiagnosticCore/BodySite</a>|
|[stateCode_display](#stateCode_display)||<a href="BodySite.md" target="_blank">DiagnosticCore/BodySite</a>|
|[statusCode](#statusCode)|Reason for the status of the Body Site|<a href="BodySite.md" target="_blank">DiagnosticCore/BodySite</a>|
|[statusCode_display](#statusCode_display)||<a href="BodySite.md" target="_blank">DiagnosticCore/BodySite</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: DiagnosticCore/BodySite (this entity)  
