---
title: ObservationReferenceRangeAppliesTo in DiagnosticCore - Common Data Model | Microsoft Docs
...
# Observation Reference Range Applies To in DiagnosticCore
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="ObservationReferenceRangeAppliesTo.md" target="_blank">DiagnosticCore/ObservationReferenceRangeAppliesTo</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="ObservationReferenceRangeAppliesTo.md" target="_blank">DiagnosticCore/ObservationReferenceRangeAppliesTo</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="ObservationReferenceRangeAppliesTo.md" target="_blank">DiagnosticCore/ObservationReferenceRangeAppliesTo</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="ObservationReferenceRangeAppliesTo.md" target="_blank">DiagnosticCore/ObservationReferenceRangeAppliesTo</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="ObservationReferenceRangeAppliesTo.md" target="_blank">DiagnosticCore/ObservationReferenceRangeAppliesTo</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="ObservationReferenceRangeAppliesTo.md" target="_blank">DiagnosticCore/ObservationReferenceRangeAppliesTo</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="ObservationReferenceRangeAppliesTo.md" target="_blank">DiagnosticCore/ObservationReferenceRangeAppliesTo</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="ObservationReferenceRangeAppliesTo.md" target="_blank">DiagnosticCore/ObservationReferenceRangeAppliesTo</a>|
|[ownerId](#ownerId)|Owner Id|<a href="ObservationReferenceRangeAppliesTo.md" target="_blank">DiagnosticCore/ObservationReferenceRangeAppliesTo</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="ObservationReferenceRangeAppliesTo.md" target="_blank">DiagnosticCore/ObservationReferenceRangeAppliesTo</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="ObservationReferenceRangeAppliesTo.md" target="_blank">DiagnosticCore/ObservationReferenceRangeAppliesTo</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="ObservationReferenceRangeAppliesTo.md" target="_blank">DiagnosticCore/ObservationReferenceRangeAppliesTo</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="ObservationReferenceRangeAppliesTo.md" target="_blank">DiagnosticCore/ObservationReferenceRangeAppliesTo</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="ObservationReferenceRangeAppliesTo.md" target="_blank">DiagnosticCore/ObservationReferenceRangeAppliesTo</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="ObservationReferenceRangeAppliesTo.md" target="_blank">DiagnosticCore/ObservationReferenceRangeAppliesTo</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="ObservationReferenceRangeAppliesTo.md" target="_blank">DiagnosticCore/ObservationReferenceRangeAppliesTo</a>|
|[name](#name)|The name of the custom entity.|<a href="ObservationReferenceRangeAppliesTo.md" target="_blank">DiagnosticCore/ObservationReferenceRangeAppliesTo</a>|
|[observationId](#observationId)|Business Identifier for observation|<a href="ObservationReferenceRangeAppliesTo.md" target="_blank">DiagnosticCore/ObservationReferenceRangeAppliesTo</a>|
|[observationReferenceRangeAppliesToId](#observationReferenceRangeAppliesToId)|Unique identifier for entity instances|<a href="ObservationReferenceRangeAppliesTo.md" target="_blank">DiagnosticCore/ObservationReferenceRangeAppliesTo</a>|
|[obsReferenceRangeAppliesToId](#obsReferenceRangeAppliesToId)|Codes to indicate the target population this reference range applies to. For example, a reference range may be based on the normal population or a particular sex or race.|<a href="ObservationReferenceRangeAppliesTo.md" target="_blank">DiagnosticCore/ObservationReferenceRangeAppliesTo</a>|
|[stateCode](#stateCode)|Status of the Observation Reference Range Applies To|<a href="ObservationReferenceRangeAppliesTo.md" target="_blank">DiagnosticCore/ObservationReferenceRangeAppliesTo</a>|
|[stateCode_display](#stateCode_display)||<a href="ObservationReferenceRangeAppliesTo.md" target="_blank">DiagnosticCore/ObservationReferenceRangeAppliesTo</a>|
|[statusCode](#statusCode)|Reason for the status of the Observation Reference Range Applies To|<a href="ObservationReferenceRangeAppliesTo.md" target="_blank">DiagnosticCore/ObservationReferenceRangeAppliesTo</a>|
|[statusCode_display](#statusCode_display)||<a href="ObservationReferenceRangeAppliesTo.md" target="_blank">DiagnosticCore/ObservationReferenceRangeAppliesTo</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: DiagnosticCore/ObservationReferenceRangeAppliesTo (this entity)  
