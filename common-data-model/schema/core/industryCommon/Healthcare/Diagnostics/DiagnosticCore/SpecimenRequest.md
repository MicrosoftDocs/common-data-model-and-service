...
# Specimen Request in DiagnosticCore

Details concerning a test or procedure request that required a specimen to be collected.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Diagnostics/DiagnosticCore/SpecimenRequest.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="SpecimenRequest.md" target="_blank">DiagnosticCore/SpecimenRequest</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="SpecimenRequest.md" target="_blank">DiagnosticCore/SpecimenRequest</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="SpecimenRequest.md" target="_blank">DiagnosticCore/SpecimenRequest</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="SpecimenRequest.md" target="_blank">DiagnosticCore/SpecimenRequest</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="SpecimenRequest.md" target="_blank">DiagnosticCore/SpecimenRequest</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="SpecimenRequest.md" target="_blank">DiagnosticCore/SpecimenRequest</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="SpecimenRequest.md" target="_blank">DiagnosticCore/SpecimenRequest</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="SpecimenRequest.md" target="_blank">DiagnosticCore/SpecimenRequest</a>|
|[ownerId](#ownerId)|Owner Id|<a href="SpecimenRequest.md" target="_blank">DiagnosticCore/SpecimenRequest</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="SpecimenRequest.md" target="_blank">DiagnosticCore/SpecimenRequest</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="SpecimenRequest.md" target="_blank">DiagnosticCore/SpecimenRequest</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="SpecimenRequest.md" target="_blank">DiagnosticCore/SpecimenRequest</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="SpecimenRequest.md" target="_blank">DiagnosticCore/SpecimenRequest</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="SpecimenRequest.md" target="_blank">DiagnosticCore/SpecimenRequest</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="SpecimenRequest.md" target="_blank">DiagnosticCore/SpecimenRequest</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="SpecimenRequest.md" target="_blank">DiagnosticCore/SpecimenRequest</a>|
|[name](#name)|The name of the custom entity.|<a href="SpecimenRequest.md" target="_blank">DiagnosticCore/SpecimenRequest</a>|
|[requestId](#requestId)|Details concerning a test or procedure request that required a specimen to be collected.|<a href="SpecimenRequest.md" target="_blank">DiagnosticCore/SpecimenRequest</a>|
|[specimenId](#specimenId)|Identifier for Specimen|<a href="SpecimenRequest.md" target="_blank">DiagnosticCore/SpecimenRequest</a>|
|[specimenRequestId](#specimenRequestId)|Unique identifier for entity instances|<a href="SpecimenRequest.md" target="_blank">DiagnosticCore/SpecimenRequest</a>|
|[stateCode](#stateCode)|Status of the Specimen Request|<a href="SpecimenRequest.md" target="_blank">DiagnosticCore/SpecimenRequest</a>|
|[stateCode_display](#stateCode_display)||<a href="SpecimenRequest.md" target="_blank">DiagnosticCore/SpecimenRequest</a>|
|[statusCode](#statusCode)|Reason for the status of the Specimen Request|<a href="SpecimenRequest.md" target="_blank">DiagnosticCore/SpecimenRequest</a>|
|[statusCode_display](#statusCode_display)||<a href="SpecimenRequest.md" target="_blank">DiagnosticCore/SpecimenRequest</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: DiagnosticCore/SpecimenRequest (this entity)  
