---
title: ObservationCategory in DiagnosticCore - Common Data Model | Microsoft Docs
...
# Observation Category in DiagnosticCore

A code that classifies the general type of observation being made.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Diagnostics/DiagnosticCore/ObservationCategory.cdm.json" target="_blank">GitHub</a>.  
...
- [/HealthcareFoundation/ObservationCategory](../../Foundational/HealthcareFoundation/ObservationCategory.md "/Healthcare/Foundational/HealthcareFoundation/ObservationCategory.cdm.json/ObservationCategory")  
</details>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="ObservationCategory.md" target="_blank">DiagnosticCore/ObservationCategory</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="ObservationCategory.md" target="_blank">DiagnosticCore/ObservationCategory</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="ObservationCategory.md" target="_blank">DiagnosticCore/ObservationCategory</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="ObservationCategory.md" target="_blank">DiagnosticCore/ObservationCategory</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="ObservationCategory.md" target="_blank">DiagnosticCore/ObservationCategory</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="ObservationCategory.md" target="_blank">DiagnosticCore/ObservationCategory</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="ObservationCategory.md" target="_blank">DiagnosticCore/ObservationCategory</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="ObservationCategory.md" target="_blank">DiagnosticCore/ObservationCategory</a>|
|[ownerId](#ownerId)|Owner Id|<a href="ObservationCategory.md" target="_blank">DiagnosticCore/ObservationCategory</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="ObservationCategory.md" target="_blank">DiagnosticCore/ObservationCategory</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="ObservationCategory.md" target="_blank">DiagnosticCore/ObservationCategory</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="ObservationCategory.md" target="_blank">DiagnosticCore/ObservationCategory</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="ObservationCategory.md" target="_blank">DiagnosticCore/ObservationCategory</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="ObservationCategory.md" target="_blank">DiagnosticCore/ObservationCategory</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="ObservationCategory.md" target="_blank">DiagnosticCore/ObservationCategory</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="ObservationCategory.md" target="_blank">DiagnosticCore/ObservationCategory</a>|
|[name](#name)|The name of the custom entity.|<a href="ObservationCategory.md" target="_blank">DiagnosticCore/ObservationCategory</a>|
|[observationId](#observationId)|Business Identifier for observation|<a href="ObservationCategory.md" target="_blank">DiagnosticCore/ObservationCategory</a>|
|[observationCategoryId](#observationCategoryId)|Unique identifier for entity instances|<a href="ObservationCategory.md" target="_blank">DiagnosticCore/ObservationCategory</a>|
|[stateCode](#stateCode)|Status of the Observation Category|<a href="ObservationCategory.md" target="_blank">DiagnosticCore/ObservationCategory</a>|
|[stateCode_display](#stateCode_display)||<a href="ObservationCategory.md" target="_blank">DiagnosticCore/ObservationCategory</a>|
|[statusCode](#statusCode)|Reason for the status of the Observation Category|<a href="ObservationCategory.md" target="_blank">DiagnosticCore/ObservationCategory</a>|
|[statusCode_display](#statusCode_display)||<a href="ObservationCategory.md" target="_blank">DiagnosticCore/ObservationCategory</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: DiagnosticCore/ObservationCategory (this entity)  
