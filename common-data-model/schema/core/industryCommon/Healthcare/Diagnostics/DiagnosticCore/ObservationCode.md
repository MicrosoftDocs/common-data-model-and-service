---
title: ObservationCode in DiagnosticCore - Common Data Model | Microsoft Docs
...
# Observation Code in DiagnosticCore

Describes what was observed.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Diagnostics/DiagnosticCore/ObservationCode.cdm.json" target="_blank">GitHub</a>.  
...
- [/HealthcareFoundation/ObservationCode](../../Foundational/HealthcareFoundation/ObservationCode.md "/Healthcare/Foundational/HealthcareFoundation/ObservationCode.cdm.json/ObservationCode")  
</details>
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/Healthcare/Diagnostics/DiagnosticCore<br>/ObservationCode.cdm.json/ObservationCode<br>/hasAttributes/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[ObservationCode/(resolvedAttributes)/observationCodeId](#observationCodeId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[ObservationCode/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Describes what was observed.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_observationcode"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="ObservationCode.md" target="_blank">DiagnosticCore/ObservationCode</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="ObservationCode.md" target="_blank">DiagnosticCore/ObservationCode</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="ObservationCode.md" target="_blank">DiagnosticCore/ObservationCode</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="ObservationCode.md" target="_blank">DiagnosticCore/ObservationCode</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="ObservationCode.md" target="_blank">DiagnosticCore/ObservationCode</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="ObservationCode.md" target="_blank">DiagnosticCore/ObservationCode</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="ObservationCode.md" target="_blank">DiagnosticCore/ObservationCode</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="ObservationCode.md" target="_blank">DiagnosticCore/ObservationCode</a>|
|[ownerId](#ownerId)|Owner Id|<a href="ObservationCode.md" target="_blank">DiagnosticCore/ObservationCode</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="ObservationCode.md" target="_blank">DiagnosticCore/ObservationCode</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="ObservationCode.md" target="_blank">DiagnosticCore/ObservationCode</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="ObservationCode.md" target="_blank">DiagnosticCore/ObservationCode</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="ObservationCode.md" target="_blank">DiagnosticCore/ObservationCode</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="ObservationCode.md" target="_blank">DiagnosticCore/ObservationCode</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="ObservationCode.md" target="_blank">DiagnosticCore/ObservationCode</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="ObservationCode.md" target="_blank">DiagnosticCore/ObservationCode</a>|
|[code](#code)||<a href="ObservationCode.md" target="_blank">DiagnosticCore/ObservationCode</a>|
|[display](#display)|The name of the custom entity.|<a href="ObservationCode.md" target="_blank">DiagnosticCore/ObservationCode</a>|
|[observationCodeId](#observationCodeId)|Unique identifier for entity instances|<a href="ObservationCode.md" target="_blank">DiagnosticCore/ObservationCode</a>|
|[system](#system)||<a href="ObservationCode.md" target="_blank">DiagnosticCore/ObservationCode</a>|
|[stateCode](#stateCode)|Status of the Observation Code|<a href="ObservationCode.md" target="_blank">DiagnosticCore/ObservationCode</a>|
|[stateCode_display](#stateCode_display)||<a href="ObservationCode.md" target="_blank">DiagnosticCore/ObservationCode</a>|
|[statusCode](#statusCode)|Reason for the status of the Observation Code|<a href="ObservationCode.md" target="_blank">DiagnosticCore/ObservationCode</a>|
|[statusCode_display](#statusCode_display)||<a href="ObservationCode.md" target="_blank">DiagnosticCore/ObservationCode</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: DiagnosticCore/ObservationCode (this entity)  
...
### <a href=#observationCodeId name="observationCodeId">observationCodeId</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Observation Code</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>sourceName</td><td>msemr_observationcodeid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the observationCodeId attribute are listed below.</summary>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_observationcodeid"</td><td>string</td><td></td></tr></table>
...
Status of the Observation Code  
First included in: DiagnosticCore/ObservationCode (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Observation Code</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the Observation Code</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
Reason for the status of the Observation Code  
First included in: DiagnosticCore/ObservationCode (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Observation Code</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the Observation Code</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
