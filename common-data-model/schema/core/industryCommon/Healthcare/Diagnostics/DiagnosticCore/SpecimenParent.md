...
# Specimen Parent in DiagnosticCore

Reference to the parent (source) specimen which is used when the specimen was either derived from or a component of another specimen.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Diagnostics/DiagnosticCore/SpecimenParent.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="SpecimenParent.md" target="_blank">DiagnosticCore/SpecimenParent</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="SpecimenParent.md" target="_blank">DiagnosticCore/SpecimenParent</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="SpecimenParent.md" target="_blank">DiagnosticCore/SpecimenParent</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="SpecimenParent.md" target="_blank">DiagnosticCore/SpecimenParent</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="SpecimenParent.md" target="_blank">DiagnosticCore/SpecimenParent</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="SpecimenParent.md" target="_blank">DiagnosticCore/SpecimenParent</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="SpecimenParent.md" target="_blank">DiagnosticCore/SpecimenParent</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="SpecimenParent.md" target="_blank">DiagnosticCore/SpecimenParent</a>|
|[ownerId](#ownerId)|Owner Id|<a href="SpecimenParent.md" target="_blank">DiagnosticCore/SpecimenParent</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="SpecimenParent.md" target="_blank">DiagnosticCore/SpecimenParent</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="SpecimenParent.md" target="_blank">DiagnosticCore/SpecimenParent</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="SpecimenParent.md" target="_blank">DiagnosticCore/SpecimenParent</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="SpecimenParent.md" target="_blank">DiagnosticCore/SpecimenParent</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="SpecimenParent.md" target="_blank">DiagnosticCore/SpecimenParent</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="SpecimenParent.md" target="_blank">DiagnosticCore/SpecimenParent</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="SpecimenParent.md" target="_blank">DiagnosticCore/SpecimenParent</a>|
|[name](#name)|The name of the custom entity.|<a href="SpecimenParent.md" target="_blank">DiagnosticCore/SpecimenParent</a>|
|[parentId](#parentId)|Reference to the parent (source) specimen which is used when the specimen was either derived from or a component of another specimen|<a href="SpecimenParent.md" target="_blank">DiagnosticCore/SpecimenParent</a>|
|[specimenId](#specimenId)|Identifier for Specimen|<a href="SpecimenParent.md" target="_blank">DiagnosticCore/SpecimenParent</a>|
|[specimenParentId](#specimenParentId)|Unique identifier for entity instances|<a href="SpecimenParent.md" target="_blank">DiagnosticCore/SpecimenParent</a>|
|[stateCode](#stateCode)|Status of the Specimen Parent|<a href="SpecimenParent.md" target="_blank">DiagnosticCore/SpecimenParent</a>|
|[stateCode_display](#stateCode_display)||<a href="SpecimenParent.md" target="_blank">DiagnosticCore/SpecimenParent</a>|
|[statusCode](#statusCode)|Reason for the status of the Specimen Parent|<a href="SpecimenParent.md" target="_blank">DiagnosticCore/SpecimenParent</a>|
|[statusCode_display](#statusCode_display)||<a href="SpecimenParent.md" target="_blank">DiagnosticCore/SpecimenParent</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: DiagnosticCore/SpecimenParent (this entity)  
