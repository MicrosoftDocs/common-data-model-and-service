---
title: ObservationInterpretation in DiagnosticCore - Common Data Model | Microsoft Docs
...
# Observation Interpretation in DiagnosticCore
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="ObservationInterpretation.md" target="_blank">DiagnosticCore/ObservationInterpretation</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="ObservationInterpretation.md" target="_blank">DiagnosticCore/ObservationInterpretation</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="ObservationInterpretation.md" target="_blank">DiagnosticCore/ObservationInterpretation</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="ObservationInterpretation.md" target="_blank">DiagnosticCore/ObservationInterpretation</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="ObservationInterpretation.md" target="_blank">DiagnosticCore/ObservationInterpretation</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="ObservationInterpretation.md" target="_blank">DiagnosticCore/ObservationInterpretation</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="ObservationInterpretation.md" target="_blank">DiagnosticCore/ObservationInterpretation</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="ObservationInterpretation.md" target="_blank">DiagnosticCore/ObservationInterpretation</a>|
|[ownerId](#ownerId)|Owner Id|<a href="ObservationInterpretation.md" target="_blank">DiagnosticCore/ObservationInterpretation</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="ObservationInterpretation.md" target="_blank">DiagnosticCore/ObservationInterpretation</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="ObservationInterpretation.md" target="_blank">DiagnosticCore/ObservationInterpretation</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="ObservationInterpretation.md" target="_blank">DiagnosticCore/ObservationInterpretation</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="ObservationInterpretation.md" target="_blank">DiagnosticCore/ObservationInterpretation</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="ObservationInterpretation.md" target="_blank">DiagnosticCore/ObservationInterpretation</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="ObservationInterpretation.md" target="_blank">DiagnosticCore/ObservationInterpretation</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="ObservationInterpretation.md" target="_blank">DiagnosticCore/ObservationInterpretation</a>|
|[code](#code)||<a href="ObservationInterpretation.md" target="_blank">DiagnosticCore/ObservationInterpretation</a>|
|[display](#display)|The name of the custom entity.|<a href="ObservationInterpretation.md" target="_blank">DiagnosticCore/ObservationInterpretation</a>|
|[observationInterpretationId](#observationInterpretationId)|Unique identifier for entity instances|<a href="ObservationInterpretation.md" target="_blank">DiagnosticCore/ObservationInterpretation</a>|
|[system](#system)||<a href="ObservationInterpretation.md" target="_blank">DiagnosticCore/ObservationInterpretation</a>|
|[stateCode](#stateCode)|Status of the Observation Interpretation|<a href="ObservationInterpretation.md" target="_blank">DiagnosticCore/ObservationInterpretation</a>|
|[stateCode_display](#stateCode_display)||<a href="ObservationInterpretation.md" target="_blank">DiagnosticCore/ObservationInterpretation</a>|
|[statusCode](#statusCode)|Reason for the status of the Observation Interpretation|<a href="ObservationInterpretation.md" target="_blank">DiagnosticCore/ObservationInterpretation</a>|
|[statusCode_display](#statusCode_display)||<a href="ObservationInterpretation.md" target="_blank">DiagnosticCore/ObservationInterpretation</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: DiagnosticCore/ObservationInterpretation (this entity)  
