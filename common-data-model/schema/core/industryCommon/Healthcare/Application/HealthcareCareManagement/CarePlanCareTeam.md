---
title: CarePlanCareTeam in HealthcareCareManagement - Common Data Model | Microsoft Docs
...
# Care Plan Care Team in HealthcareCareManagement

Identifies all people and organizations who are expected to be involved in the care envisioned by this plan.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Application/HealthcareCareManagement/CarePlanCareTeam.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/Healthcare/Clinical/ClinicalCareTeam<br>/CarePlanCareTeam.cdm.json/CarePlanCareTeam<br>/hasAttributes/attributesAddedAtThisScope</td></tr><tr><td>/Healthcare/Application/HealthcareCareManagement<br>/CarePlanCareTeam.cdm.json/CarePlanCareTeam<br>/hasAttributes/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[CarePlanCareTeam/(resolvedAttributes)/carePlanCareTeamId](#carePlanCareTeamId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[CarePlanCareTeam/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Care Plan Care Team</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Identifies all people and organizations who are expected to be involved in the care envisioned by this plan.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_careplancareteam"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="CarePlanCareTeam.md" target="_blank">HealthcareCareManagement/CarePlanCareTeam</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="CarePlanCareTeam.md" target="_blank">HealthcareCareManagement/CarePlanCareTeam</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="CarePlanCareTeam.md" target="_blank">HealthcareCareManagement/CarePlanCareTeam</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="CarePlanCareTeam.md" target="_blank">HealthcareCareManagement/CarePlanCareTeam</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="CarePlanCareTeam.md" target="_blank">HealthcareCareManagement/CarePlanCareTeam</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="CarePlanCareTeam.md" target="_blank">HealthcareCareManagement/CarePlanCareTeam</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="CarePlanCareTeam.md" target="_blank">HealthcareCareManagement/CarePlanCareTeam</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="CarePlanCareTeam.md" target="_blank">HealthcareCareManagement/CarePlanCareTeam</a>|
|[ownerId](#ownerId)|Owner Id|<a href="CarePlanCareTeam.md" target="_blank">HealthcareCareManagement/CarePlanCareTeam</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="CarePlanCareTeam.md" target="_blank">HealthcareCareManagement/CarePlanCareTeam</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="CarePlanCareTeam.md" target="_blank">HealthcareCareManagement/CarePlanCareTeam</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="CarePlanCareTeam.md" target="_blank">HealthcareCareManagement/CarePlanCareTeam</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="CarePlanCareTeam.md" target="_blank">HealthcareCareManagement/CarePlanCareTeam</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="CarePlanCareTeam.md" target="_blank">HealthcareCareManagement/CarePlanCareTeam</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="CarePlanCareTeam.md" target="_blank">HealthcareCareManagement/CarePlanCareTeam</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="CarePlanCareTeam.md" target="_blank">HealthcareCareManagement/CarePlanCareTeam</a>|
|[carePlanId](#carePlanId)|Describes the intention of how one or more practitioners intend to deliver care for a particular patient, group or community for a period of time, possibly limited to care for a specific condition.|<a href="CarePlanCareTeam.md" target="_blank">HealthcareCareManagement/CarePlanCareTeam</a>|
|[carePlanCareTeamId](#carePlanCareTeamId)|Unique identifier for entity instances|<a href="CarePlanCareTeam.md" target="_blank">HealthcareCareManagement/CarePlanCareTeam</a>|
|[careTeamId](#careTeamId)|Identifies all people and organizations who are expected to be involved in the care envisioned by this plan.|<a href="CarePlanCareTeam.md" target="_blank">HealthcareCareManagement/CarePlanCareTeam</a>|
|[name](#name)|The name of the custom entity.|<a href="CarePlanCareTeam.md" target="_blank">HealthcareCareManagement/CarePlanCareTeam</a>|
|[stateCode](#stateCode)|Status of the Care Plan Care Team|<a href="CarePlanCareTeam.md" target="_blank">HealthcareCareManagement/CarePlanCareTeam</a>|
|[stateCode_display](#stateCode_display)||<a href="CarePlanCareTeam.md" target="_blank">HealthcareCareManagement/CarePlanCareTeam</a>|
|[statusCode](#statusCode)|Reason for the status of the Care Plan Care Team|<a href="CarePlanCareTeam.md" target="_blank">HealthcareCareManagement/CarePlanCareTeam</a>|
|[statusCode_display](#statusCode_display)||<a href="CarePlanCareTeam.md" target="_blank">HealthcareCareManagement/CarePlanCareTeam</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: HealthcareCareManagement/CarePlanCareTeam (this entity)  
...
### <a href=#carePlanCareTeamId name="carePlanCareTeamId">carePlanCareTeamId</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Care Plan Care Team</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>sourceName</td><td>msemr_careplancareteamid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the carePlanCareTeamId attribute are listed below.</summary>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_careplancareteamid"</td><td>string</td><td></td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Care Team</td></tr><tr><td>description</td><td>Identifies all people and organizations who are expected to be involved in the care envisioned by this plan.</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_careteam</td></tr></table>
...
Status of the Care Plan Care Team  
First included in: HealthcareCareManagement/CarePlanCareTeam (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Care Plan Care Team</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the Care Plan Care Team</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
Reason for the status of the Care Plan Care Team  
First included in: HealthcareCareManagement/CarePlanCareTeam (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Care Plan Care Team</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the Care Plan Care Team</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
