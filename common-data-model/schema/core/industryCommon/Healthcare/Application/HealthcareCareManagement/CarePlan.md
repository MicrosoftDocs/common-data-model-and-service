---
title: CarePlan in HealthcareCareManagement - Common Data Model | Microsoft Docs
...
# Care Plan in HealthcareCareManagement
...
Describes the intention of how one or more practitioners intend to deliver care for a particular patient, group or community for a period of time, possibly limited to care for a specific condition  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Application/HealthcareCareManagement/CarePlan.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="CarePlan.md" target="_blank">HealthcareCareManagement/CarePlan</a>|
|[createdBy](#createdBy)|Shows who created the record.|<a href="CarePlan.md" target="_blank">HealthcareCareManagement/CarePlan</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="CarePlan.md" target="_blank">HealthcareCareManagement/CarePlan</a>|
|[modifiedBy](#modifiedBy)|Shows who last updated the record.|<a href="CarePlan.md" target="_blank">HealthcareCareManagement/CarePlan</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Shows who created the record on behalf of another user.|<a href="CarePlan.md" target="_blank">HealthcareCareManagement/CarePlan</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Shows who last updated the record on behalf of another user.|<a href="CarePlan.md" target="_blank">HealthcareCareManagement/CarePlan</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="CarePlan.md" target="_blank">HealthcareCareManagement/CarePlan</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="CarePlan.md" target="_blank">HealthcareCareManagement/CarePlan</a>|
|[ownerId](#ownerId)|Owner Id|<a href="CarePlan.md" target="_blank">HealthcareCareManagement/CarePlan</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="CarePlan.md" target="_blank">HealthcareCareManagement/CarePlan</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="CarePlan.md" target="_blank">HealthcareCareManagement/CarePlan</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="CarePlan.md" target="_blank">HealthcareCareManagement/CarePlan</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="CarePlan.md" target="_blank">HealthcareCareManagement/CarePlan</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="CarePlan.md" target="_blank">HealthcareCareManagement/CarePlan</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="CarePlan.md" target="_blank">HealthcareCareManagement/CarePlan</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="CarePlan.md" target="_blank">HealthcareCareManagement/CarePlan</a>|
|[carePlanId](#carePlanId)|Unique identifier for entity instances|<a href="CarePlan.md" target="_blank">HealthcareCareManagement/CarePlan</a>|
|[carePlanIdentifier](#carePlanIdentifier)|This records identifiers associated with this care plan that are defined by business processes and/or used to refer to it when a direct URL reference to the resource itself is not appropriate.|<a href="CarePlan.md" target="_blank">HealthcareCareManagement/CarePlan</a>|
|[contextType](#contextType)|Type of the context care plan is created for|<a href="CarePlan.md" target="_blank">HealthcareCareManagement/CarePlan</a>|
|[contextType_display](#contextType_display)||<a href="CarePlan.md" target="_blank">HealthcareCareManagement/CarePlan</a>|
|[encounterIdentifierId](#encounterIdentifierId)|Identifies the original context in which this particular CarePlan was created.|<a href="CarePlan.md" target="_blank">HealthcareCareManagement/CarePlan</a>|
|[episodeOfCareId](#episodeOfCareId)|Identifies the original context in which this particular CarePlan was created.|<a href="CarePlan.md" target="_blank">HealthcareCareManagement/CarePlan</a>|
|[groupIdentifierId](#groupIdentifierId)|Identifies the patient or group whose intended care is described by the plan.|<a href="CarePlan.md" target="_blank">HealthcareCareManagement/CarePlan</a>|
|[patientIdentifierId](#patientIdentifierId)|Identifies the patient or group whose intended care is described by the plan.|<a href="CarePlan.md" target="_blank">HealthcareCareManagement/CarePlan</a>|
|[planDescription](#planDescription)|A description of the scope and nature of the plan.|<a href="CarePlan.md" target="_blank">HealthcareCareManagement/CarePlan</a>|
|[planEndDate](#planEndDate)|Indicates when the plan did (or is intended to) come into effect and end.|<a href="CarePlan.md" target="_blank">HealthcareCareManagement/CarePlan</a>|
|[planIntent](#planIntent)|Indicates the level of authority/intentionality associated with the care plan and where the care plan fits into the workflow chain.|<a href="CarePlan.md" target="_blank">HealthcareCareManagement/CarePlan</a>|
|[planIntent_display](#planIntent_display)||<a href="CarePlan.md" target="_blank">HealthcareCareManagement/CarePlan</a>|
|[planStartDate](#planStartDate)|Indicates when the plan did (or is intended to) come into effect and end.|<a href="CarePlan.md" target="_blank">HealthcareCareManagement/CarePlan</a>|
|[planStatus](#planStatus)|Indicates whether the plan is currently being acted upon, represents future intentions or is now a historical record.|<a href="CarePlan.md" target="_blank">HealthcareCareManagement/CarePlan</a>|
|[planStatus_display](#planStatus_display)||<a href="CarePlan.md" target="_blank">HealthcareCareManagement/CarePlan</a>|
|[subjectType](#subjectType)|Type of subject of the care plan|<a href="CarePlan.md" target="_blank">HealthcareCareManagement/CarePlan</a>|
|[subjectType_display](#subjectType_display)||<a href="CarePlan.md" target="_blank">HealthcareCareManagement/CarePlan</a>|
|[title](#title)|The name of the custom entity.|<a href="CarePlan.md" target="_blank">HealthcareCareManagement/CarePlan</a>|
|[stateCode](#stateCode)|Status of the Care Plan|<a href="CarePlan.md" target="_blank">HealthcareCareManagement/CarePlan</a>|
|[stateCode_display](#stateCode_display)||<a href="CarePlan.md" target="_blank">HealthcareCareManagement/CarePlan</a>|
|[statusCode](#statusCode)|Reason for the status of the Care Plan|<a href="CarePlan.md" target="_blank">HealthcareCareManagement/CarePlan</a>|
|[statusCode_display](#statusCode_display)||<a href="CarePlan.md" target="_blank">HealthcareCareManagement/CarePlan</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: HealthcareCareManagement/CarePlan (this entity)  
