---
title: AzureFHIRResource in SyncAgentCommon - Common Data Model | Microsoft Docs
...
# Azure FHIR Resource in SyncAgentCommon

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/AzureAPIforFHIRsupport/SyncAgentCommon/AzureFHIRResource.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/Healthcare/AzureAPIforFHIRsupport<br>/SyncAgentCommon/AzureFHIRResource.cdm.json<br>/AzureFHIRResource/hasAttributes<br>/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[AzureFHIRResource/(resolvedAttributes)/msindAzureFHIRResourceId](#msindAzureFHIRResourceId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[AzureFHIRResource/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Azure FHIR Resource</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msind_AzureFHIRResource"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="AzureFHIRResource.md" target="_blank">SyncAgentCommon/AzureFHIRResource</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="AzureFHIRResource.md" target="_blank">SyncAgentCommon/AzureFHIRResource</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="AzureFHIRResource.md" target="_blank">SyncAgentCommon/AzureFHIRResource</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="AzureFHIRResource.md" target="_blank">SyncAgentCommon/AzureFHIRResource</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="AzureFHIRResource.md" target="_blank">SyncAgentCommon/AzureFHIRResource</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="AzureFHIRResource.md" target="_blank">SyncAgentCommon/AzureFHIRResource</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="AzureFHIRResource.md" target="_blank">SyncAgentCommon/AzureFHIRResource</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="AzureFHIRResource.md" target="_blank">SyncAgentCommon/AzureFHIRResource</a>|
|[ownerId](#ownerId)|Owner Id|<a href="AzureFHIRResource.md" target="_blank">SyncAgentCommon/AzureFHIRResource</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="AzureFHIRResource.md" target="_blank">SyncAgentCommon/AzureFHIRResource</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="AzureFHIRResource.md" target="_blank">SyncAgentCommon/AzureFHIRResource</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="AzureFHIRResource.md" target="_blank">SyncAgentCommon/AzureFHIRResource</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="AzureFHIRResource.md" target="_blank">SyncAgentCommon/AzureFHIRResource</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="AzureFHIRResource.md" target="_blank">SyncAgentCommon/AzureFHIRResource</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="AzureFHIRResource.md" target="_blank">SyncAgentCommon/AzureFHIRResource</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="AzureFHIRResource.md" target="_blank">SyncAgentCommon/AzureFHIRResource</a>|
|[msindAzureFHIRResourceId](#msindAzureFHIRResourceId)|Unique identifier for entity instances|<a href="AzureFHIRResource.md" target="_blank">SyncAgentCommon/AzureFHIRResource</a>|
|[msindCode](#msindCode)|Required name field|<a href="AzureFHIRResource.md" target="_blank">SyncAgentCommon/AzureFHIRResource</a>|
|[msindDescription](#msindDescription)||<a href="AzureFHIRResource.md" target="_blank">SyncAgentCommon/AzureFHIRResource</a>|
|[stateCode](#stateCode)|Status of the Azure FHIR Resource|<a href="AzureFHIRResource.md" target="_blank">SyncAgentCommon/AzureFHIRResource</a>|
|[stateCode_display](#stateCode_display)||<a href="AzureFHIRResource.md" target="_blank">SyncAgentCommon/AzureFHIRResource</a>|
|[statusCode](#statusCode)|Reason for the status of the Azure FHIR Resource|<a href="AzureFHIRResource.md" target="_blank">SyncAgentCommon/AzureFHIRResource</a>|
|[statusCode_display](#statusCode_display)||<a href="AzureFHIRResource.md" target="_blank">SyncAgentCommon/AzureFHIRResource</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: SyncAgentCommon/AzureFHIRResource (this entity)  
...
### <a href=#msindAzureFHIRResourceId name="msindAzureFHIRResourceId">msindAzureFHIRResourceId</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Azure FHIR Resource</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>sourceName</td><td>msind_azurefhirresourceid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the msindAzureFHIRResourceId attribute are listed below.</summary>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msind_azurefhirresourceid"</td><td>string</td><td></td></tr></table>
...
### <a href=#msindCode name="msindCode">msindCode</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Code</td></tr><tr><td>description</td><td>Required name field</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>100</td></tr><tr><td>sourceName</td><td>msind_code</td></tr></table>

#### Traits

<details>
<summary>List of traits for the msindCode attribute are listed below.</summary>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msind_code"</td><td>string</td><td></td></tr></table>
...
### <a href=#msindDescription name="msindDescription">msindDescription</a>

First included in: SyncAgentCommon/AzureFHIRResource (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Description</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>2000</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msind_description</td></tr></table>

#### Traits

<details>
<summary>List of traits for the msindDescription attribute are listed below.</summary>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msind_description"</td><td>string</td><td></td></tr></table>
...
Status of the Azure FHIR Resource  
First included in: SyncAgentCommon/AzureFHIRResource (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Azure FHIR Resource</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the Azure FHIR Resource</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
Reason for the status of the Azure FHIR Resource  
First included in: SyncAgentCommon/AzureFHIRResource (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Azure FHIR Resource</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the Azure FHIR Resource</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
