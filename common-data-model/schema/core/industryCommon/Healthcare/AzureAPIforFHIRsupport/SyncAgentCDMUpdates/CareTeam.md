---
title: CareTeam in SyncAgentCDMUpdates - Common Data Model | Microsoft Docs
...
# Care Team in SyncAgentCDMUpdates

The Care Team includes all the people and organizations who plan to participate in the coordination and delivery of care for a patient.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/AzureAPIforFHIRsupport/SyncAgentCDMUpdates/CareTeam.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/Healthcare/Foundational/Commoncore<br>/CareTeam.cdm.json/CareTeam/hasAttributes<br>/attributesAddedAtThisScope</td></tr><tr><td>/Healthcare/AzureAPIforFHIRsupport<br>/SyncAgentCDMUpdates/CareTeam.cdm.json/CareTeam<br>/hasAttributes/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[CareTeam/(resolvedAttributes)/careTeamId](#careTeamId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[CareTeam/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="CareTeam.md" target="_blank">SyncAgentCDMUpdates/CareTeam</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="CareTeam.md" target="_blank">SyncAgentCDMUpdates/CareTeam</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="CareTeam.md" target="_blank">SyncAgentCDMUpdates/CareTeam</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="CareTeam.md" target="_blank">SyncAgentCDMUpdates/CareTeam</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="CareTeam.md" target="_blank">SyncAgentCDMUpdates/CareTeam</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="CareTeam.md" target="_blank">SyncAgentCDMUpdates/CareTeam</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="CareTeam.md" target="_blank">SyncAgentCDMUpdates/CareTeam</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="CareTeam.md" target="_blank">SyncAgentCDMUpdates/CareTeam</a>|
|[ownerId](#ownerId)|Owner Id|<a href="CareTeam.md" target="_blank">SyncAgentCDMUpdates/CareTeam</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="CareTeam.md" target="_blank">SyncAgentCDMUpdates/CareTeam</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="CareTeam.md" target="_blank">SyncAgentCDMUpdates/CareTeam</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="CareTeam.md" target="_blank">SyncAgentCDMUpdates/CareTeam</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="CareTeam.md" target="_blank">SyncAgentCDMUpdates/CareTeam</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="CareTeam.md" target="_blank">SyncAgentCDMUpdates/CareTeam</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="CareTeam.md" target="_blank">SyncAgentCDMUpdates/CareTeam</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="CareTeam.md" target="_blank">SyncAgentCDMUpdates/CareTeam</a>|
|[entityImage](#entityImage)|The image of the record|<a href="CareTeam.md" target="_blank">SyncAgentCDMUpdates/CareTeam</a>|
|[careTeamId](#careTeamId)|Unique identifier for entity instances|<a href="CareTeam.md" target="_blank">SyncAgentCDMUpdates/CareTeam</a>|
|[careTeamNumber](#careTeamNumber)|This records identifiers associated with this care team that are defined by business processes and/or used to refer to it when a direct URL reference to the resource itself is not appropriate.|<a href="CareTeam.md" target="_blank">SyncAgentCDMUpdates/CareTeam</a>|
|[careTeamStatus](#careTeamStatus)|Indicates the current state of the care team.|<a href="CareTeam.md" target="_blank">SyncAgentCDMUpdates/CareTeam</a>|
|[careTeamStatus_display](#careTeamStatus_display)||<a href="CareTeam.md" target="_blank">SyncAgentCDMUpdates/CareTeam</a>|
|[contextType](#contextType)|The encounter or episode of care that establishes the context for this care team.|<a href="CareTeam.md" target="_blank">SyncAgentCDMUpdates/CareTeam</a>|
|[contextType_display](#contextType_display)||<a href="CareTeam.md" target="_blank">SyncAgentCDMUpdates/CareTeam</a>|
|[encounterId](#encounterId)|The encounter or episode of care that establishes the context for this care team.|<a href="CareTeam.md" target="_blank">SyncAgentCDMUpdates/CareTeam</a>|
|[episodeOfCareId](#episodeOfCareId)|The encounter or episode of care that establishes the context for this care team.|<a href="CareTeam.md" target="_blank">SyncAgentCDMUpdates/CareTeam</a>|
|[name](#name)|The name of the custom entity.|<a href="CareTeam.md" target="_blank">SyncAgentCDMUpdates/CareTeam</a>|
|[periodEnd](#periodEnd)|Indicates when the team did (or is intended to) come into effect and end.|<a href="CareTeam.md" target="_blank">SyncAgentCDMUpdates/CareTeam</a>|
|[periodStart](#periodStart)|Indicates when the team did (or is intended to) come into effect and end.|<a href="CareTeam.md" target="_blank">SyncAgentCDMUpdates/CareTeam</a>|
|[subjectGroupId](#subjectGroupId)|Subject is group|<a href="CareTeam.md" target="_blank">SyncAgentCDMUpdates/CareTeam</a>|
|[subjectPatientId](#subjectPatientId)|Subject is patient|<a href="CareTeam.md" target="_blank">SyncAgentCDMUpdates/CareTeam</a>|
|[subjectType](#subjectType)|Identifies the patient or group whose intended care is handled by the team.|<a href="CareTeam.md" target="_blank">SyncAgentCDMUpdates/CareTeam</a>|
|[subjectType_display](#subjectType_display)||<a href="CareTeam.md" target="_blank">SyncAgentCDMUpdates/CareTeam</a>|
|[stateCode](#stateCode)|Status of the Care Team|<a href="CareTeam.md" target="_blank">SyncAgentCDMUpdates/CareTeam</a>|
|[stateCode_display](#stateCode_display)||<a href="CareTeam.md" target="_blank">SyncAgentCDMUpdates/CareTeam</a>|
|[statusCode](#statusCode)|Reason for the status of the Care Team|<a href="CareTeam.md" target="_blank">SyncAgentCDMUpdates/CareTeam</a>|
|[statusCode_display](#statusCode_display)||<a href="CareTeam.md" target="_blank">SyncAgentCDMUpdates/CareTeam</a>|
|[azureFHIRID](#azureFHIRID)|Attribute used to store the GUID of the object in Azure FHIR. Used by the Entity Updater Service to ensure data is synched properly.|<a href="CareTeam.md" target="_blank">SyncAgentCDMUpdates/CareTeam</a>|
|[azureFHIRLastUpdatedOn](#azureFHIRLastUpdatedOn)|Attribute used to store the date and time that the object was last synced with Azure FHIR. Used by the Entity Updater Service to ensure data is synched properly.|<a href="CareTeam.md" target="_blank">SyncAgentCDMUpdates/CareTeam</a>|
|[azureFHIRVersion](#azureFHIRVersion)|Attribute used to store the version of the object in Azure FHIR. Used by the Entity Updater Service to ensure data is synched properly.|<a href="CareTeam.md" target="_blank">SyncAgentCDMUpdates/CareTeam</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: SyncAgentCDMUpdates/CareTeam (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Entity Image</td></tr><tr><td>description</td><td>The image of the record</td></tr><tr><td>dataFormat</td><td>binary</td></tr><tr><td>maximumLength</td><td>9437328</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>entityimage</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>The image of the record</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<details>
<summary>List of traits for the episodeOfCareId attribute are listed below.</summary>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Period End</td></tr><tr><td>description</td><td>Indicates when the team did (or is intended to) come into effect and end.</td></tr><tr><td>dataFormat</td><td>dateTime</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_periodend</td></tr></table>
