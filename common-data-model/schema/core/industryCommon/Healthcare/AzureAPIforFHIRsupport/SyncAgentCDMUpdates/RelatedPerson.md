---
title: RelatedPerson in SyncAgentCDMUpdates - Common Data Model | Microsoft Docs
...
# Related Person in SyncAgentCDMUpdates

Information about a person that is involved in the care for a patient, but who is not the target of healthcare, nor has a formal responsibility in the care process.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/AzureAPIforFHIRsupport/SyncAgentCDMUpdates/RelatedPerson.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="RelatedPerson.md" target="_blank">SyncAgentCDMUpdates/RelatedPerson</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="RelatedPerson.md" target="_blank">SyncAgentCDMUpdates/RelatedPerson</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="RelatedPerson.md" target="_blank">SyncAgentCDMUpdates/RelatedPerson</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="RelatedPerson.md" target="_blank">SyncAgentCDMUpdates/RelatedPerson</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="RelatedPerson.md" target="_blank">SyncAgentCDMUpdates/RelatedPerson</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="RelatedPerson.md" target="_blank">SyncAgentCDMUpdates/RelatedPerson</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="RelatedPerson.md" target="_blank">SyncAgentCDMUpdates/RelatedPerson</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="RelatedPerson.md" target="_blank">SyncAgentCDMUpdates/RelatedPerson</a>|
|[ownerId](#ownerId)|Owner Id|<a href="RelatedPerson.md" target="_blank">SyncAgentCDMUpdates/RelatedPerson</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="RelatedPerson.md" target="_blank">SyncAgentCDMUpdates/RelatedPerson</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="RelatedPerson.md" target="_blank">SyncAgentCDMUpdates/RelatedPerson</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="RelatedPerson.md" target="_blank">SyncAgentCDMUpdates/RelatedPerson</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="RelatedPerson.md" target="_blank">SyncAgentCDMUpdates/RelatedPerson</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="RelatedPerson.md" target="_blank">SyncAgentCDMUpdates/RelatedPerson</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="RelatedPerson.md" target="_blank">SyncAgentCDMUpdates/RelatedPerson</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="RelatedPerson.md" target="_blank">SyncAgentCDMUpdates/RelatedPerson</a>|
|[active](#active)|Whether this related person record is in active use.|<a href="RelatedPerson.md" target="_blank">SyncAgentCDMUpdates/RelatedPerson</a>|
|[name](#name)|The name of the custom entity.|<a href="RelatedPerson.md" target="_blank">SyncAgentCDMUpdates/RelatedPerson</a>|
|[patientId](#patientId)|The patient this person is related to.|<a href="RelatedPerson.md" target="_blank">SyncAgentCDMUpdates/RelatedPerson</a>|
|[relatedPersonId](#relatedPersonId)|Unique identifier for entity instances|<a href="RelatedPerson.md" target="_blank">SyncAgentCDMUpdates/RelatedPerson</a>|
|[relatedPersonPeriodEndDate](#relatedPersonPeriodEndDate)|The period of time that this relationship is considered to be valid. If there are no dates defined, then the interval is unknown.|<a href="RelatedPerson.md" target="_blank">SyncAgentCDMUpdates/RelatedPerson</a>|
|[relatedPersonPeriodStartDate](#relatedPersonPeriodStartDate)|The period of time that this relationship is considered to be valid. If there are no dates defined, then the interval is unknown.|<a href="RelatedPerson.md" target="_blank">SyncAgentCDMUpdates/RelatedPerson</a>|
|[relationshipId](#relationshipId)|The nature of the relationship between a patient and the related person.|<a href="RelatedPerson.md" target="_blank">SyncAgentCDMUpdates/RelatedPerson</a>|
|[stateCode](#stateCode)|Status of the Related Person|<a href="RelatedPerson.md" target="_blank">SyncAgentCDMUpdates/RelatedPerson</a>|
|[stateCode_display](#stateCode_display)||<a href="RelatedPerson.md" target="_blank">SyncAgentCDMUpdates/RelatedPerson</a>|
|[statusCode](#statusCode)|Reason for the status of the Related Person|<a href="RelatedPerson.md" target="_blank">SyncAgentCDMUpdates/RelatedPerson</a>|
|[statusCode_display](#statusCode_display)||<a href="RelatedPerson.md" target="_blank">SyncAgentCDMUpdates/RelatedPerson</a>|
|[azureFHIRID](#azureFHIRID)|Attribute used to store the GUID of the object in Azure FHIR. Used by the Entity Updater Service to ensure data is synched properly.|<a href="RelatedPerson.md" target="_blank">SyncAgentCDMUpdates/RelatedPerson</a>|
|[azureFHIRLastUpdatedOn](#azureFHIRLastUpdatedOn)|Attribute used to store the date and time that the object was last synced with Azure FHIR. Used by the Entity Updater Service to ensure data is synched properly.|<a href="RelatedPerson.md" target="_blank">SyncAgentCDMUpdates/RelatedPerson</a>|
|[azureFHIRVersion](#azureFHIRVersion)|Attribute used to store the version of the object in Azure FHIR. Used by the Entity Updater Service to ensure data is synched properly.|<a href="RelatedPerson.md" target="_blank">SyncAgentCDMUpdates/RelatedPerson</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: SyncAgentCDMUpdates/RelatedPerson (this entity)  
