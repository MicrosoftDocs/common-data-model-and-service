---
title: Encounter in SyncAgentCDMUpdates - Common Data Model | Microsoft Docs
...
# Encounter in SyncAgentCDMUpdates

An interaction between a patient and healthcare provider(s) for the purpose of providing healthcare service(s) or assessing the health status of a patient.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/AzureAPIforFHIRsupport/SyncAgentCDMUpdates/Encounter.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="Encounter.md" target="_blank">SyncAgentCDMUpdates/Encounter</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="Encounter.md" target="_blank">SyncAgentCDMUpdates/Encounter</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="Encounter.md" target="_blank">SyncAgentCDMUpdates/Encounter</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="Encounter.md" target="_blank">SyncAgentCDMUpdates/Encounter</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="Encounter.md" target="_blank">SyncAgentCDMUpdates/Encounter</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="Encounter.md" target="_blank">SyncAgentCDMUpdates/Encounter</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="Encounter.md" target="_blank">SyncAgentCDMUpdates/Encounter</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="Encounter.md" target="_blank">SyncAgentCDMUpdates/Encounter</a>|
|[ownerId](#ownerId)|Owner Id|<a href="Encounter.md" target="_blank">SyncAgentCDMUpdates/Encounter</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="Encounter.md" target="_blank">SyncAgentCDMUpdates/Encounter</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="Encounter.md" target="_blank">SyncAgentCDMUpdates/Encounter</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="Encounter.md" target="_blank">SyncAgentCDMUpdates/Encounter</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="Encounter.md" target="_blank">SyncAgentCDMUpdates/Encounter</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="Encounter.md" target="_blank">SyncAgentCDMUpdates/Encounter</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="Encounter.md" target="_blank">SyncAgentCDMUpdates/Encounter</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="Encounter.md" target="_blank">SyncAgentCDMUpdates/Encounter</a>|
|[appointmentEMRId](#appointmentEMRId)|A booking of a healthcare event among patient(s), practitioner(s), related person(s) and/or device(s) for a specific date/time. This may result in one or more Encounter(s).|<a href="Encounter.md" target="_blank">SyncAgentCDMUpdates/Encounter</a>|
|[class](#class)|Type of: inpatient \| outpatient \| ambulatory \| emergency +.|<a href="Encounter.md" target="_blank">SyncAgentCDMUpdates/Encounter</a>|
|[class_display](#class_display)||<a href="Encounter.md" target="_blank">SyncAgentCDMUpdates/Encounter</a>|
|[contextEncounterId](#contextEncounterId)||<a href="Encounter.md" target="_blank">SyncAgentCDMUpdates/Encounter</a>|
|[contextEpisodeOfCareId](#contextEpisodeOfCareId)||<a href="Encounter.md" target="_blank">SyncAgentCDMUpdates/Encounter</a>|
|[duration](#duration)|Quantity of time the encounter lasted. This excludes the time during leaves of absence.|<a href="Encounter.md" target="_blank">SyncAgentCDMUpdates/Encounter</a>|
|[encounterClass](#encounterClass)|Refers to the class of encounter.|<a href="Encounter.md" target="_blank">SyncAgentCDMUpdates/Encounter</a>|
|[encounterClass_display](#encounterClass_display)||<a href="Encounter.md" target="_blank">SyncAgentCDMUpdates/Encounter</a>|
|[encounterEndDate](#encounterEndDate)|The start and end time of the encounter.|<a href="Encounter.md" target="_blank">SyncAgentCDMUpdates/Encounter</a>|
|[encounterGroupIdentifierId](#encounterGroupIdentifierId)|The group present at the encounter|<a href="Encounter.md" target="_blank">SyncAgentCDMUpdates/Encounter</a>|
|[encounterId](#encounterId)|Unique identifier for entity instances|<a href="Encounter.md" target="_blank">SyncAgentCDMUpdates/Encounter</a>|
|[encounterIdentifier](#encounterIdentifier)|Identifier(s) by which this encounter is known.|<a href="Encounter.md" target="_blank">SyncAgentCDMUpdates/Encounter</a>|
|[encounterLength](#encounterLength)|Quantity of time the encounter lasted. This excludes the time during leaves of absence.|<a href="Encounter.md" target="_blank">SyncAgentCDMUpdates/Encounter</a>|
|[encounterParentEncounterIdentifierId](#encounterParentEncounterIdentifierId)|Another Encounter of which this encounter is a part of (administratively or in time).|<a href="Encounter.md" target="_blank">SyncAgentCDMUpdates/Encounter</a>|
|[encounterPatientIdentifierId](#encounterPatientIdentifierId)|The patient present at the encounter.|<a href="Encounter.md" target="_blank">SyncAgentCDMUpdates/Encounter</a>|
|[encounterPriorityId](#encounterPriorityId)|Indicates the urgency of the encounter.|<a href="Encounter.md" target="_blank">SyncAgentCDMUpdates/Encounter</a>|
|[encounterStartDate](#encounterStartDate)|The start and end time of the encounter.|<a href="Encounter.md" target="_blank">SyncAgentCDMUpdates/Encounter</a>|
|[encounterStatus](#encounterStatus)|Refers to the status of encounter.|<a href="Encounter.md" target="_blank">SyncAgentCDMUpdates/Encounter</a>|
|[encounterStatus_display](#encounterStatus_display)||<a href="Encounter.md" target="_blank">SyncAgentCDMUpdates/Encounter</a>|
|[hospitalizationAdmitSourceId](#hospitalizationAdmitSourceId)|From where patient was admitted (physician referral, transfer).|<a href="Encounter.md" target="_blank">SyncAgentCDMUpdates/Encounter</a>|
|[hospitalizationDestinationId](#hospitalizationDestinationId)|Location to which the patient is discharged.|<a href="Encounter.md" target="_blank">SyncAgentCDMUpdates/Encounter</a>|
|[hospitalizationDischargeDispositionId](#hospitalizationDischargeDispositionId)|Category or kind of location after discharge.|<a href="Encounter.md" target="_blank">SyncAgentCDMUpdates/Encounter</a>|
|[hospitalizationOriginId](#hospitalizationOriginId)|The location from which the patient came before admission.|<a href="Encounter.md" target="_blank">SyncAgentCDMUpdates/Encounter</a>|
|[hospitalizationPreAdmissionNumber](#hospitalizationPreAdmissionNumber)|Pre-admission identifier.|<a href="Encounter.md" target="_blank">SyncAgentCDMUpdates/Encounter</a>|
|[hospitalizationReadmissionId](#hospitalizationReadmissionId)|Whether this hospitalization is a readmission and why if known.|<a href="Encounter.md" target="_blank">SyncAgentCDMUpdates/Encounter</a>|
|[name](#name)|The name of the custom entity.|<a href="Encounter.md" target="_blank">SyncAgentCDMUpdates/Encounter</a>|
|[onBehalfOfId](#onBehalfOfId)||<a href="Encounter.md" target="_blank">SyncAgentCDMUpdates/Encounter</a>|
|[periodEnd](#periodEnd)|The start and end time of the encounter.|<a href="Encounter.md" target="_blank">SyncAgentCDMUpdates/Encounter</a>|
|[periodStart](#periodStart)|The start and end time of the encounter.|<a href="Encounter.md" target="_blank">SyncAgentCDMUpdates/Encounter</a>|
|[priority](#priority)|Indicates the urgency of the encounter.|<a href="Encounter.md" target="_blank">SyncAgentCDMUpdates/Encounter</a>|
|[priority_display](#priority_display)||<a href="Encounter.md" target="_blank">SyncAgentCDMUpdates/Encounter</a>|
|[subjectPatientId](#subjectPatientId)|The patient or group present at the encounter.|<a href="Encounter.md" target="_blank">SyncAgentCDMUpdates/Encounter</a>|
|[stateCode](#stateCode)|Status of the Encounter|<a href="Encounter.md" target="_blank">SyncAgentCDMUpdates/Encounter</a>|
|[stateCode_display](#stateCode_display)||<a href="Encounter.md" target="_blank">SyncAgentCDMUpdates/Encounter</a>|
|[statusCode](#statusCode)|Reason for the status of the Encounter|<a href="Encounter.md" target="_blank">SyncAgentCDMUpdates/Encounter</a>|
|[statusCode_display](#statusCode_display)||<a href="Encounter.md" target="_blank">SyncAgentCDMUpdates/Encounter</a>|
|[azureFHIRID](#azureFHIRID)|Attribute used to store the GUID of the object in Azure FHIR. Used by the Entity Updater Service to ensure data is synched properly.|<a href="Encounter.md" target="_blank">SyncAgentCDMUpdates/Encounter</a>|
|[azureFHIRLastUpdatedOn](#azureFHIRLastUpdatedOn)|Attribute used to store the date and time that the object was last synced with Azure FHIR. Used by the Entity Updater Service to ensure data is synched properly.|<a href="Encounter.md" target="_blank">SyncAgentCDMUpdates/Encounter</a>|
|[azureFHIRVersion](#azureFHIRVersion)|Attribute used to store the version of the object in Azure FHIR. Used by the Entity Updater Service to ensure data is synched properly.|<a href="Encounter.md" target="_blank">SyncAgentCDMUpdates/Encounter</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: SyncAgentCDMUpdates/Encounter (this entity)  
