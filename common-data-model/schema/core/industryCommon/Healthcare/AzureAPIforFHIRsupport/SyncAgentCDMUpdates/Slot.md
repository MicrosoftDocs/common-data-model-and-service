---
title: Slot in SyncAgentCDMUpdates - Common Data Model | Microsoft Docs
...
# Slot in SyncAgentCDMUpdates

A slot of time on a schedule that may be available for booking appointments.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/AzureAPIforFHIRsupport/SyncAgentCDMUpdates/Slot.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/Healthcare/Administration<br>/AdministrationAppointmentEMR/Slot.cdm.json/Slot<br>/hasAttributes/attributesAddedAtThisScope</td></tr><tr><td>/Healthcare/AzureAPIforFHIRsupport<br>/SyncAgentCDMUpdates/Slot.cdm.json/Slot<br>/hasAttributes/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="Slot.md" target="_blank">SyncAgentCDMUpdates/Slot</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="Slot.md" target="_blank">SyncAgentCDMUpdates/Slot</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="Slot.md" target="_blank">SyncAgentCDMUpdates/Slot</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="Slot.md" target="_blank">SyncAgentCDMUpdates/Slot</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="Slot.md" target="_blank">SyncAgentCDMUpdates/Slot</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="Slot.md" target="_blank">SyncAgentCDMUpdates/Slot</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="Slot.md" target="_blank">SyncAgentCDMUpdates/Slot</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="Slot.md" target="_blank">SyncAgentCDMUpdates/Slot</a>|
|[ownerId](#ownerId)|Owner Id|<a href="Slot.md" target="_blank">SyncAgentCDMUpdates/Slot</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="Slot.md" target="_blank">SyncAgentCDMUpdates/Slot</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="Slot.md" target="_blank">SyncAgentCDMUpdates/Slot</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="Slot.md" target="_blank">SyncAgentCDMUpdates/Slot</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="Slot.md" target="_blank">SyncAgentCDMUpdates/Slot</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="Slot.md" target="_blank">SyncAgentCDMUpdates/Slot</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="Slot.md" target="_blank">SyncAgentCDMUpdates/Slot</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="Slot.md" target="_blank">SyncAgentCDMUpdates/Slot</a>|
|[appointmentemrId](#appointmentemrId)|A booking of a healthcare event among patient(s), practitioner(s), related person(s) and/or device(s) for a specific date/time. This may result in one or more Encounter(s)|<a href="Slot.md" target="_blank">SyncAgentCDMUpdates/Slot</a>|
|[appointmentTypeNew](#appointmentTypeNew)||<a href="Slot.md" target="_blank">SyncAgentCDMUpdates/Slot</a>|
|[appointmentTypeNew_display](#appointmentTypeNew_display)||<a href="Slot.md" target="_blank">SyncAgentCDMUpdates/Slot</a>|
|[comment](#comment)|Comments on the slot to describe any extended information. Such as custom constraints on the slot|<a href="Slot.md" target="_blank">SyncAgentCDMUpdates/Slot</a>|
|[end](#end)|Date/Time that the slot is to conclude|<a href="Slot.md" target="_blank">SyncAgentCDMUpdates/Slot</a>|
|[name](#name)|The name of the custom entity.|<a href="Slot.md" target="_blank">SyncAgentCDMUpdates/Slot</a>|
|[overbooked](#overbooked)|This slot has already been overbooked, appointments are unlikely to be accepted for this time|<a href="Slot.md" target="_blank">SyncAgentCDMUpdates/Slot</a>|
|[scheduleId](#scheduleId)|The schedule resource that this slot defines an interval of status information.|<a href="Slot.md" target="_blank">SyncAgentCDMUpdates/Slot</a>|
|[serviceCategoryId](#serviceCategoryId)|A broad categorization of the service that is to be performed during this appointment|<a href="Slot.md" target="_blank">SyncAgentCDMUpdates/Slot</a>|
|[serviceTypeNewId](#serviceTypeNewId)||<a href="Slot.md" target="_blank">SyncAgentCDMUpdates/Slot</a>|
|[slotId](#slotId)|Unique identifier for entity instances|<a href="Slot.md" target="_blank">SyncAgentCDMUpdates/Slot</a>|
|[specialtyId](#specialtyId)|The specialty of a practitioner that would be required to perform the service requested in this appointment|<a href="Slot.md" target="_blank">SyncAgentCDMUpdates/Slot</a>|
|[start](#start)|Date/Time that the slot is to begin|<a href="Slot.md" target="_blank">SyncAgentCDMUpdates/Slot</a>|
|[status](#status)|The free/busy status of the slot|<a href="Slot.md" target="_blank">SyncAgentCDMUpdates/Slot</a>|
|[status_display](#status_display)||<a href="Slot.md" target="_blank">SyncAgentCDMUpdates/Slot</a>|
|[stateCode](#stateCode)|Status of the Slot|<a href="Slot.md" target="_blank">SyncAgentCDMUpdates/Slot</a>|
|[stateCode_display](#stateCode_display)||<a href="Slot.md" target="_blank">SyncAgentCDMUpdates/Slot</a>|
|[statusCode](#statusCode)|Reason for the status of the Slot|<a href="Slot.md" target="_blank">SyncAgentCDMUpdates/Slot</a>|
|[statusCode_display](#statusCode_display)||<a href="Slot.md" target="_blank">SyncAgentCDMUpdates/Slot</a>|
|[azureFHIRID](#azureFHIRID)|Attribute used to store the GUID of the object in Azure FHIR. Used by the Entity Updater Service to ensure data is synched properly.|<a href="Slot.md" target="_blank">SyncAgentCDMUpdates/Slot</a>|
|[azureFHIRLastUpdatedOn](#azureFHIRLastUpdatedOn)|Attribute used to store the date and time that the object was last synced with Azure FHIR. Used by the Entity Updater Service to ensure data is synched properly.|<a href="Slot.md" target="_blank">SyncAgentCDMUpdates/Slot</a>|
|[azureFHIRVersion](#azureFHIRVersion)|Attribute used to store the version of the object in Azure FHIR. Used by the Entity Updater Service to ensure data is synched properly.|<a href="Slot.md" target="_blank">SyncAgentCDMUpdates/Slot</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: SyncAgentCDMUpdates/Slot (this entity)  
