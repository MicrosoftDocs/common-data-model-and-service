---
title: Procedure in SyncAgentCDMUpdates - Common Data Model | Microsoft Docs
...
# Procedure in SyncAgentCDMUpdates

An action that is or was performed on a patient. This can be a physical intervention like an operation, or less invasive like counseling or hypnotherapy.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/AzureAPIforFHIRsupport/SyncAgentCDMUpdates/Procedure.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="Procedure.md" target="_blank">SyncAgentCDMUpdates/Procedure</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="Procedure.md" target="_blank">SyncAgentCDMUpdates/Procedure</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="Procedure.md" target="_blank">SyncAgentCDMUpdates/Procedure</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="Procedure.md" target="_blank">SyncAgentCDMUpdates/Procedure</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="Procedure.md" target="_blank">SyncAgentCDMUpdates/Procedure</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="Procedure.md" target="_blank">SyncAgentCDMUpdates/Procedure</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="Procedure.md" target="_blank">SyncAgentCDMUpdates/Procedure</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="Procedure.md" target="_blank">SyncAgentCDMUpdates/Procedure</a>|
|[ownerId](#ownerId)|Owner Id|<a href="Procedure.md" target="_blank">SyncAgentCDMUpdates/Procedure</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="Procedure.md" target="_blank">SyncAgentCDMUpdates/Procedure</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="Procedure.md" target="_blank">SyncAgentCDMUpdates/Procedure</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="Procedure.md" target="_blank">SyncAgentCDMUpdates/Procedure</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="Procedure.md" target="_blank">SyncAgentCDMUpdates/Procedure</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="Procedure.md" target="_blank">SyncAgentCDMUpdates/Procedure</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="Procedure.md" target="_blank">SyncAgentCDMUpdates/Procedure</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="Procedure.md" target="_blank">SyncAgentCDMUpdates/Procedure</a>|
|[categoryId](#categoryId)|A code that classifies the procedure for searching, sorting and display purposes (e.g. "Surgical Procedure").|<a href="Procedure.md" target="_blank">SyncAgentCDMUpdates/Procedure</a>|
|[codeableconceptId](#codeableconceptId)||<a href="Procedure.md" target="_blank">SyncAgentCDMUpdates/Procedure</a>|
|[codeNewId](#codeNewId)||<a href="Procedure.md" target="_blank">SyncAgentCDMUpdates/Procedure</a>|
|[dateTime](#dateTime)|The date(time)/period over which the procedure was performed.|<a href="Procedure.md" target="_blank">SyncAgentCDMUpdates/Procedure</a>|
|[description](#description)|The name of the custom entity.|<a href="Procedure.md" target="_blank">SyncAgentCDMUpdates/Procedure</a>|
|[encounterId](#encounterId)|The encounter during which the procedure was performed.|<a href="Procedure.md" target="_blank">SyncAgentCDMUpdates/Procedure</a>|
|[episodeOfCareId](#episodeOfCareId)|The encounter during which the procedure was performed.|<a href="Procedure.md" target="_blank">SyncAgentCDMUpdates/Procedure</a>|
|[groupId](#groupId)|The person, animal or group on which the procedure was performed.|<a href="Procedure.md" target="_blank">SyncAgentCDMUpdates/Procedure</a>|
|[locationId](#locationId)|The location where the procedure actually happened. E.g. a newborn at home, a tracheotomy at a restaurant.|<a href="Procedure.md" target="_blank">SyncAgentCDMUpdates/Procedure</a>|
|[notDone](#notDone)|Set this to true if the record is saying that the procedure was NOT performed.|<a href="Procedure.md" target="_blank">SyncAgentCDMUpdates/Procedure</a>|
|[notDoneReasonId](#notDoneReasonId)|A code indicating why the procedure was not performed.|<a href="Procedure.md" target="_blank">SyncAgentCDMUpdates/Procedure</a>|
|[outcomeId](#outcomeId)|The outcome of the procedure - did it resolve reasons for the procedure being performed?|<a href="Procedure.md" target="_blank">SyncAgentCDMUpdates/Procedure</a>|
|[patientId](#patientId)|The person, animal or group on which the procedure was performed.|<a href="Procedure.md" target="_blank">SyncAgentCDMUpdates/Procedure</a>|
|[performedEndDate](#performedEndDate)|The period End date over which the procedure was performed. Allows a period to support complex procedures that span more than one date, and also allows for the length of the procedure to be captured|<a href="Procedure.md" target="_blank">SyncAgentCDMUpdates/Procedure</a>|
|[performedStartDate](#performedStartDate)|The period start date over which the procedure was performed. Allows a period to support complex procedures that span more than one date, and also allows for the length of the procedure to be captured|<a href="Procedure.md" target="_blank">SyncAgentCDMUpdates/Procedure</a>|
|[procedureId](#procedureId)|Unique identifier for entity instances|<a href="Procedure.md" target="_blank">SyncAgentCDMUpdates/Procedure</a>|
|[procedureIdentifier](#procedureIdentifier)|This records identifiers associated with this procedure that are defined by business processes and/or used to refer to it when a direct URL reference to the resource itself is not appropriate|<a href="Procedure.md" target="_blank">SyncAgentCDMUpdates/Procedure</a>|
|[status](#status)|A code specifying the state of the procedure. Generally this will be in-progress or completed state.|<a href="Procedure.md" target="_blank">SyncAgentCDMUpdates/Procedure</a>|
|[status_display](#status_display)||<a href="Procedure.md" target="_blank">SyncAgentCDMUpdates/Procedure</a>|
|[subjectType](#subjectType)|Type of Subject on whom procedure is performed|<a href="Procedure.md" target="_blank">SyncAgentCDMUpdates/Procedure</a>|
|[subjectType_display](#subjectType_display)||<a href="Procedure.md" target="_blank">SyncAgentCDMUpdates/Procedure</a>|
|[stateCode](#stateCode)|Status of the Procedure|<a href="Procedure.md" target="_blank">SyncAgentCDMUpdates/Procedure</a>|
|[stateCode_display](#stateCode_display)||<a href="Procedure.md" target="_blank">SyncAgentCDMUpdates/Procedure</a>|
|[statusCode](#statusCode)|Reason for the status of the Procedure|<a href="Procedure.md" target="_blank">SyncAgentCDMUpdates/Procedure</a>|
|[statusCode_display](#statusCode_display)||<a href="Procedure.md" target="_blank">SyncAgentCDMUpdates/Procedure</a>|
|[azureFHIRID](#azureFHIRID)|Attribute used to store the GUID of the object in Azure FHIR. Used by the Entity Updater Service to ensure data is synched properly.|<a href="Procedure.md" target="_blank">SyncAgentCDMUpdates/Procedure</a>|
|[azureFHIRLastUpdatedOn](#azureFHIRLastUpdatedOn)|Attribute used to store the date and time that the object was last synced with Azure FHIR. Used by the Entity Updater Service to ensure data is synched properly.|<a href="Procedure.md" target="_blank">SyncAgentCDMUpdates/Procedure</a>|
|[azureFHIRVersion](#azureFHIRVersion)|Attribute used to store the version of the object in Azure FHIR. Used by the Entity Updater Service to ensure data is synched properly.|<a href="Procedure.md" target="_blank">SyncAgentCDMUpdates/Procedure</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: SyncAgentCDMUpdates/Procedure (this entity)  
