---
title: CareTeamParticipant in SyncAgentCDMUpdates - Common Data Model | Microsoft Docs
...
# Care Team Participant in SyncAgentCDMUpdates

Identifies all people and organizations who are expected to be involved in the care team.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/AzureAPIforFHIRsupport/SyncAgentCDMUpdates/CareTeamParticipant.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/Healthcare/Clinical/ClinicalCareTeam<br>/CareTeamParticipant.cdm.json/CareTeamParticipant<br>/hasAttributes/attributesAddedAtThisScope</td></tr><tr><td>/Healthcare/AzureAPIforFHIRsupport<br>/SyncAgentCDMUpdates/CareTeamParticipant.cdm.json<br>/CareTeamParticipant/hasAttributes<br>/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[CareTeamParticipant/(resolvedAttributes)/careTeamParticipantId](#careTeamParticipantId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[CareTeamParticipant/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Identifies all people and organizations who are expected to be involved in the care team.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_careteamparticipant"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="CareTeamParticipant.md" target="_blank">SyncAgentCDMUpdates/CareTeamParticipant</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="CareTeamParticipant.md" target="_blank">SyncAgentCDMUpdates/CareTeamParticipant</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="CareTeamParticipant.md" target="_blank">SyncAgentCDMUpdates/CareTeamParticipant</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="CareTeamParticipant.md" target="_blank">SyncAgentCDMUpdates/CareTeamParticipant</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="CareTeamParticipant.md" target="_blank">SyncAgentCDMUpdates/CareTeamParticipant</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="CareTeamParticipant.md" target="_blank">SyncAgentCDMUpdates/CareTeamParticipant</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="CareTeamParticipant.md" target="_blank">SyncAgentCDMUpdates/CareTeamParticipant</a>|
|[importSequenceNumber](#importSequenceNumber)|Unique identifier of the data import or data migration that created this record.|<a href="CareTeamParticipant.md" target="_blank">SyncAgentCDMUpdates/CareTeamParticipant</a>|
|[ownerId](#ownerId)|Owner Id|<a href="CareTeamParticipant.md" target="_blank">SyncAgentCDMUpdates/CareTeamParticipant</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="CareTeamParticipant.md" target="_blank">SyncAgentCDMUpdates/CareTeamParticipant</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="CareTeamParticipant.md" target="_blank">SyncAgentCDMUpdates/CareTeamParticipant</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="CareTeamParticipant.md" target="_blank">SyncAgentCDMUpdates/CareTeamParticipant</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="CareTeamParticipant.md" target="_blank">SyncAgentCDMUpdates/CareTeamParticipant</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="CareTeamParticipant.md" target="_blank">SyncAgentCDMUpdates/CareTeamParticipant</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="CareTeamParticipant.md" target="_blank">SyncAgentCDMUpdates/CareTeamParticipant</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="CareTeamParticipant.md" target="_blank">SyncAgentCDMUpdates/CareTeamParticipant</a>|
|[entityImage](#entityImage)|Entity Image|<a href="CareTeamParticipant.md" target="_blank">SyncAgentCDMUpdates/CareTeamParticipant</a>|
|[careTeamId](#careTeamId)|This records identifiers associated with this care team that are defined by business processes and/or used to refer to it when a direct URL reference to the resource itself is not appropriate.|<a href="CareTeamParticipant.md" target="_blank">SyncAgentCDMUpdates/CareTeamParticipant</a>|
|[careTeamParticipantId](#careTeamParticipantId)|Unique identifier for entity instances|<a href="CareTeamParticipant.md" target="_blank">SyncAgentCDMUpdates/CareTeamParticipant</a>|
|[description](#description)|The name of the custom entity.|<a href="CareTeamParticipant.md" target="_blank">SyncAgentCDMUpdates/CareTeamParticipant</a>|
|[memberCareTeamId](#memberCareTeamId)|Member is care team|<a href="CareTeamParticipant.md" target="_blank">SyncAgentCDMUpdates/CareTeamParticipant</a>|
|[memberOrganizationId](#memberOrganizationId)|Member is organization|<a href="CareTeamParticipant.md" target="_blank">SyncAgentCDMUpdates/CareTeamParticipant</a>|
|[memberPatientId](#memberPatientId)|Member is patient|<a href="CareTeamParticipant.md" target="_blank">SyncAgentCDMUpdates/CareTeamParticipant</a>|
|[memberPractionerId](#memberPractionerId)|Member is practitioner|<a href="CareTeamParticipant.md" target="_blank">SyncAgentCDMUpdates/CareTeamParticipant</a>|
|[memberRelatedPersonId](#memberRelatedPersonId)|Member is person related to patient|<a href="CareTeamParticipant.md" target="_blank">SyncAgentCDMUpdates/CareTeamParticipant</a>|
|[memberType](#memberType)|Type of member.|<a href="CareTeamParticipant.md" target="_blank">SyncAgentCDMUpdates/CareTeamParticipant</a>|
|[memberType_display](#memberType_display)||<a href="CareTeamParticipant.md" target="_blank">SyncAgentCDMUpdates/CareTeamParticipant</a>|
|[onBehalfOfId](#onBehalfOfId)|The organization of the practitioner.|<a href="CareTeamParticipant.md" target="_blank">SyncAgentCDMUpdates/CareTeamParticipant</a>|
|[periodEnd](#periodEnd)|Indicates when the specific member or organization did (or is intended to) come into effect and end.|<a href="CareTeamParticipant.md" target="_blank">SyncAgentCDMUpdates/CareTeamParticipant</a>|
|[periodStart](#periodStart)|Indicates when the specific member or organization did (or is intended to) come into effect and end.|<a href="CareTeamParticipant.md" target="_blank">SyncAgentCDMUpdates/CareTeamParticipant</a>|
|[roleId](#roleId)|Indicates specific responsibility of an individual within the care team, such as "Primary care physician", "Trained social worker counselor", "Caregiver", etc.|<a href="CareTeamParticipant.md" target="_blank">SyncAgentCDMUpdates/CareTeamParticipant</a>|
|[stateCode](#stateCode)|Status of the Care Team Participant|<a href="CareTeamParticipant.md" target="_blank">SyncAgentCDMUpdates/CareTeamParticipant</a>|
|[stateCode_display](#stateCode_display)||<a href="CareTeamParticipant.md" target="_blank">SyncAgentCDMUpdates/CareTeamParticipant</a>|
|[statusCode](#statusCode)|Reason for the status of the Care Team Participant|<a href="CareTeamParticipant.md" target="_blank">SyncAgentCDMUpdates/CareTeamParticipant</a>|
|[statusCode_display](#statusCode_display)||<a href="CareTeamParticipant.md" target="_blank">SyncAgentCDMUpdates/CareTeamParticipant</a>|
|[azureFHIRID](#azureFHIRID)|Attribute used to store the GUID of the object in Azure FHIR. Used by the Entity Updater Service to ensure data is synched properly.|<a href="CareTeamParticipant.md" target="_blank">SyncAgentCDMUpdates/CareTeamParticipant</a>|
|[azureFHIRLastUpdatedOn](#azureFHIRLastUpdatedOn)|Attribute used to store the date and time that the object was last synced with Azure FHIR. Used by the Entity Updater Service to ensure data is synched properly.|<a href="CareTeamParticipant.md" target="_blank">SyncAgentCDMUpdates/CareTeamParticipant</a>|
|[azureFHIRVersion](#azureFHIRVersion)|Attribute used to store the version of the object in Azure FHIR. Used by the Entity Updater Service to ensure data is synched properly.|<a href="CareTeamParticipant.md" target="_blank">SyncAgentCDMUpdates/CareTeamParticipant</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: SyncAgentCDMUpdates/CareTeamParticipant (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Entity Image</td></tr><tr><td>description</td><td>Entity Image</td></tr><tr><td>dataFormat</td><td>binary</td></tr><tr><td>maximumLength</td><td>9437328</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>entityimage</td></tr></table>
...
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="CareTeam.md" target="_blank">/Healthcare/AzureAPIforFHIRsupport/SyncAgentCDMUpdates/CareTeam.cdm.json/CareTeam</a></td><td><a href="CareTeam.md#careTeamId" target="_blank">careTeamId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
...
### <a href=#memberCareTeamId name="memberCareTeamId">memberCareTeamId</a>
...
<details>
<summary>List of traits for the memberCareTeamId attribute are listed below.</summary>
...
### <a href=#memberOrganizationId name="memberOrganizationId">memberOrganizationId</a>
...
<details>
<summary>List of traits for the memberOrganizationId attribute are listed below.</summary>
...
### <a href=#memberPatientId name="memberPatientId">memberPatientId</a>
...
<details>
<summary>List of traits for the memberPatientId attribute are listed below.</summary>
...
### <a href=#memberPractionerId name="memberPractionerId">memberPractionerId</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Practitioner</td></tr><tr><td>description</td><td>Member is practitioner</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_memberpractioner</td></tr></table>

#### Traits

<details>
<summary>List of traits for the memberPractionerId attribute are listed below.</summary>
...
### <a href=#memberRelatedPersonId name="memberRelatedPersonId">memberRelatedPersonId</a>
...
<details>
<summary>List of traits for the memberRelatedPersonId attribute are listed below.</summary>
