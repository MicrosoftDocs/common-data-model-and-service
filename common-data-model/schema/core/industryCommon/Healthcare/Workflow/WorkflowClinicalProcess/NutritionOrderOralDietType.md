...
# Nutrition Order Oral Diet Type in WorkflowClinicalProcess

The kind of diet or dietary restriction such as fiber restricted diet or diabetic diet.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Workflow/WorkflowClinicalProcess/NutritionOrderOralDietType.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="NutritionOrderOralDietType.md" target="_blank">WorkflowClinicalProcess/NutritionOrderOralDietType</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="NutritionOrderOralDietType.md" target="_blank">WorkflowClinicalProcess/NutritionOrderOralDietType</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="NutritionOrderOralDietType.md" target="_blank">WorkflowClinicalProcess/NutritionOrderOralDietType</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="NutritionOrderOralDietType.md" target="_blank">WorkflowClinicalProcess/NutritionOrderOralDietType</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="NutritionOrderOralDietType.md" target="_blank">WorkflowClinicalProcess/NutritionOrderOralDietType</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="NutritionOrderOralDietType.md" target="_blank">WorkflowClinicalProcess/NutritionOrderOralDietType</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="NutritionOrderOralDietType.md" target="_blank">WorkflowClinicalProcess/NutritionOrderOralDietType</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="NutritionOrderOralDietType.md" target="_blank">WorkflowClinicalProcess/NutritionOrderOralDietType</a>|
|[ownerId](#ownerId)|Owner Id|<a href="NutritionOrderOralDietType.md" target="_blank">WorkflowClinicalProcess/NutritionOrderOralDietType</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="NutritionOrderOralDietType.md" target="_blank">WorkflowClinicalProcess/NutritionOrderOralDietType</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="NutritionOrderOralDietType.md" target="_blank">WorkflowClinicalProcess/NutritionOrderOralDietType</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="NutritionOrderOralDietType.md" target="_blank">WorkflowClinicalProcess/NutritionOrderOralDietType</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="NutritionOrderOralDietType.md" target="_blank">WorkflowClinicalProcess/NutritionOrderOralDietType</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="NutritionOrderOralDietType.md" target="_blank">WorkflowClinicalProcess/NutritionOrderOralDietType</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="NutritionOrderOralDietType.md" target="_blank">WorkflowClinicalProcess/NutritionOrderOralDietType</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="NutritionOrderOralDietType.md" target="_blank">WorkflowClinicalProcess/NutritionOrderOralDietType</a>|
|[name](#name)|The name of the custom entity.|<a href="NutritionOrderOralDietType.md" target="_blank">WorkflowClinicalProcess/NutritionOrderOralDietType</a>|
|[nutritionOrderId](#nutritionOrderId)|Unique ID for Nutrition Order|<a href="NutritionOrderOralDietType.md" target="_blank">WorkflowClinicalProcess/NutritionOrderOralDietType</a>|
|[nutritionOrderOralDietTypeId](#nutritionOrderOralDietTypeId)|Unique identifier for entity instances|<a href="NutritionOrderOralDietType.md" target="_blank">WorkflowClinicalProcess/NutritionOrderOralDietType</a>|
|[oralDietTypeId](#oralDietTypeId)|The kind of diet or dietary restriction such as fiber restricted diet or diabetic diet.|<a href="NutritionOrderOralDietType.md" target="_blank">WorkflowClinicalProcess/NutritionOrderOralDietType</a>|
|[stateCode](#stateCode)|Status of the Nutrition Order Oral Diet Type|<a href="NutritionOrderOralDietType.md" target="_blank">WorkflowClinicalProcess/NutritionOrderOralDietType</a>|
|[stateCode_display](#stateCode_display)||<a href="NutritionOrderOralDietType.md" target="_blank">WorkflowClinicalProcess/NutritionOrderOralDietType</a>|
|[statusCode](#statusCode)|Reason for the status of the Nutrition Order Oral Diet Type|<a href="NutritionOrderOralDietType.md" target="_blank">WorkflowClinicalProcess/NutritionOrderOralDietType</a>|
|[statusCode_display](#statusCode_display)||<a href="NutritionOrderOralDietType.md" target="_blank">WorkflowClinicalProcess/NutritionOrderOralDietType</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: WorkflowClinicalProcess/NutritionOrderOralDietType (this entity)  
