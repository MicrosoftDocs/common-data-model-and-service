...
# Referral Request Replace in WorkflowReferral

Completed or terminated request(s) whose function is taken by this new request.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Workflow/WorkflowReferral/ReferralRequestReplace.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="ReferralRequestReplace.md" target="_blank">WorkflowReferral/ReferralRequestReplace</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="ReferralRequestReplace.md" target="_blank">WorkflowReferral/ReferralRequestReplace</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="ReferralRequestReplace.md" target="_blank">WorkflowReferral/ReferralRequestReplace</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="ReferralRequestReplace.md" target="_blank">WorkflowReferral/ReferralRequestReplace</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="ReferralRequestReplace.md" target="_blank">WorkflowReferral/ReferralRequestReplace</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="ReferralRequestReplace.md" target="_blank">WorkflowReferral/ReferralRequestReplace</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="ReferralRequestReplace.md" target="_blank">WorkflowReferral/ReferralRequestReplace</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="ReferralRequestReplace.md" target="_blank">WorkflowReferral/ReferralRequestReplace</a>|
|[ownerId](#ownerId)|Owner Id|<a href="ReferralRequestReplace.md" target="_blank">WorkflowReferral/ReferralRequestReplace</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="ReferralRequestReplace.md" target="_blank">WorkflowReferral/ReferralRequestReplace</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="ReferralRequestReplace.md" target="_blank">WorkflowReferral/ReferralRequestReplace</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="ReferralRequestReplace.md" target="_blank">WorkflowReferral/ReferralRequestReplace</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="ReferralRequestReplace.md" target="_blank">WorkflowReferral/ReferralRequestReplace</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="ReferralRequestReplace.md" target="_blank">WorkflowReferral/ReferralRequestReplace</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="ReferralRequestReplace.md" target="_blank">WorkflowReferral/ReferralRequestReplace</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="ReferralRequestReplace.md" target="_blank">WorkflowReferral/ReferralRequestReplace</a>|
|[name](#name)|The name of the custom entity.|<a href="ReferralRequestReplace.md" target="_blank">WorkflowReferral/ReferralRequestReplace</a>|
|[referralRequestId](#referralRequestId)|Unique identifier for the referral request|<a href="ReferralRequestReplace.md" target="_blank">WorkflowReferral/ReferralRequestReplace</a>|
|[referralRequestReplaceId](#referralRequestReplaceId)|Unique identifier for entity instances|<a href="ReferralRequestReplace.md" target="_blank">WorkflowReferral/ReferralRequestReplace</a>|
|[requestId](#requestId)|Used to record and send details about a request for referral service or transfer of a patient to the care of another provider or provider organization.|<a href="ReferralRequestReplace.md" target="_blank">WorkflowReferral/ReferralRequestReplace</a>|
|[stateCode](#stateCode)|Status of the Referral Request Replace|<a href="ReferralRequestReplace.md" target="_blank">WorkflowReferral/ReferralRequestReplace</a>|
|[stateCode_display](#stateCode_display)||<a href="ReferralRequestReplace.md" target="_blank">WorkflowReferral/ReferralRequestReplace</a>|
|[statusCode](#statusCode)|Reason for the status of the Referral Request Replace|<a href="ReferralRequestReplace.md" target="_blank">WorkflowReferral/ReferralRequestReplace</a>|
|[statusCode_display](#statusCode_display)||<a href="ReferralRequestReplace.md" target="_blank">WorkflowReferral/ReferralRequestReplace</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: WorkflowReferral/ReferralRequestReplace (this entity)  
