...
# Task Part Of in WorkflowCore

Task that this particular task is part of.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Workflow/WorkflowCore/TaskPartOf.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/Healthcare/Workflow/WorkflowCore<br>/TaskPartOf.cdm.json/TaskPartOf/hasAttributes<br>/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[TaskPartOf/(resolvedAttributes)/taskPartOfId](#taskPartOfId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[TaskPartOf/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Task Part Of</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Task that this particular task is part of.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_taskpartof"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="TaskPartOf.md" target="_blank">WorkflowCore/TaskPartOf</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="TaskPartOf.md" target="_blank">WorkflowCore/TaskPartOf</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="TaskPartOf.md" target="_blank">WorkflowCore/TaskPartOf</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="TaskPartOf.md" target="_blank">WorkflowCore/TaskPartOf</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="TaskPartOf.md" target="_blank">WorkflowCore/TaskPartOf</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="TaskPartOf.md" target="_blank">WorkflowCore/TaskPartOf</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="TaskPartOf.md" target="_blank">WorkflowCore/TaskPartOf</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="TaskPartOf.md" target="_blank">WorkflowCore/TaskPartOf</a>|
|[ownerId](#ownerId)|Owner Id|<a href="TaskPartOf.md" target="_blank">WorkflowCore/TaskPartOf</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="TaskPartOf.md" target="_blank">WorkflowCore/TaskPartOf</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="TaskPartOf.md" target="_blank">WorkflowCore/TaskPartOf</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="TaskPartOf.md" target="_blank">WorkflowCore/TaskPartOf</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="TaskPartOf.md" target="_blank">WorkflowCore/TaskPartOf</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="TaskPartOf.md" target="_blank">WorkflowCore/TaskPartOf</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="TaskPartOf.md" target="_blank">WorkflowCore/TaskPartOf</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="TaskPartOf.md" target="_blank">WorkflowCore/TaskPartOf</a>|
|[name](#name)|The name of the custom entity.|<a href="TaskPartOf.md" target="_blank">WorkflowCore/TaskPartOf</a>|
|[partOfId](#partOfId)|Task that this particular task is part of.|<a href="TaskPartOf.md" target="_blank">WorkflowCore/TaskPartOf</a>|
|[taskId](#taskId)|Unique identifier for Task|<a href="TaskPartOf.md" target="_blank">WorkflowCore/TaskPartOf</a>|
|[taskPartOfId](#taskPartOfId)|Unique identifier for entity instances|<a href="TaskPartOf.md" target="_blank">WorkflowCore/TaskPartOf</a>|
|[stateCode](#stateCode)|Status of the Task Part Of|<a href="TaskPartOf.md" target="_blank">WorkflowCore/TaskPartOf</a>|
|[stateCode_display](#stateCode_display)||<a href="TaskPartOf.md" target="_blank">WorkflowCore/TaskPartOf</a>|
|[statusCode](#statusCode)|Reason for the status of the Task Part Of|<a href="TaskPartOf.md" target="_blank">WorkflowCore/TaskPartOf</a>|
|[statusCode_display](#statusCode_display)||<a href="TaskPartOf.md" target="_blank">WorkflowCore/TaskPartOf</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: WorkflowCore/TaskPartOf (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Part Of</td></tr><tr><td>description</td><td>Task that this particular task is part of.</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msemr_partof</td></tr></table>
...
### <a href=#taskPartOfId name="taskPartOfId">taskPartOfId</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Task Part Of</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>sourceName</td><td>msemr_taskpartofid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the taskPartOfId attribute are listed below.</summary>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msemr_taskpartofid"</td><td>string</td><td></td></tr></table>
...
Status of the Task Part Of  
First included in: WorkflowCore/TaskPartOf (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Task Part Of</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the Task Part Of</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
Reason for the status of the Task Part Of  
First included in: WorkflowCore/TaskPartOf (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Task Part Of</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the Task Part Of</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
