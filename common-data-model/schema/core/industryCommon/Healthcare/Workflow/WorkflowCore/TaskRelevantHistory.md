...
# Task Relevant History in WorkflowCore

Links to Provenance records for past versions of this Task that identify key state transitions or updates that are likely to be relevant to a user looking at the current version of the task.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Healthcare/Workflow/WorkflowCore/TaskRelevantHistory.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="TaskRelevantHistory.md" target="_blank">WorkflowCore/TaskRelevantHistory</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="TaskRelevantHistory.md" target="_blank">WorkflowCore/TaskRelevantHistory</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="TaskRelevantHistory.md" target="_blank">WorkflowCore/TaskRelevantHistory</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="TaskRelevantHistory.md" target="_blank">WorkflowCore/TaskRelevantHistory</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="TaskRelevantHistory.md" target="_blank">WorkflowCore/TaskRelevantHistory</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="TaskRelevantHistory.md" target="_blank">WorkflowCore/TaskRelevantHistory</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="TaskRelevantHistory.md" target="_blank">WorkflowCore/TaskRelevantHistory</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="TaskRelevantHistory.md" target="_blank">WorkflowCore/TaskRelevantHistory</a>|
|[ownerId](#ownerId)|Owner Id|<a href="TaskRelevantHistory.md" target="_blank">WorkflowCore/TaskRelevantHistory</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="TaskRelevantHistory.md" target="_blank">WorkflowCore/TaskRelevantHistory</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="TaskRelevantHistory.md" target="_blank">WorkflowCore/TaskRelevantHistory</a>|
|[owningUser](#owningUser)|Unique identifier for the user that owns the record.|<a href="TaskRelevantHistory.md" target="_blank">WorkflowCore/TaskRelevantHistory</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="TaskRelevantHistory.md" target="_blank">WorkflowCore/TaskRelevantHistory</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="TaskRelevantHistory.md" target="_blank">WorkflowCore/TaskRelevantHistory</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="TaskRelevantHistory.md" target="_blank">WorkflowCore/TaskRelevantHistory</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="TaskRelevantHistory.md" target="_blank">WorkflowCore/TaskRelevantHistory</a>|
|[name](#name)|The name of the custom entity.|<a href="TaskRelevantHistory.md" target="_blank">WorkflowCore/TaskRelevantHistory</a>|
|[relevantHistoryId](#relevantHistoryId)|Links to Provenance records for past versions of this Task that identify key state transitions or updates that are likely to be relevant to a user looking at the current version of the task..|<a href="TaskRelevantHistory.md" target="_blank">WorkflowCore/TaskRelevantHistory</a>|
|[taskId](#taskId)|Unique identifier for Task.|<a href="TaskRelevantHistory.md" target="_blank">WorkflowCore/TaskRelevantHistory</a>|
|[taskRelevantHistoryId](#taskRelevantHistoryId)|Unique identifier for entity instances|<a href="TaskRelevantHistory.md" target="_blank">WorkflowCore/TaskRelevantHistory</a>|
|[stateCode](#stateCode)|Status of the Task Relevant History|<a href="TaskRelevantHistory.md" target="_blank">WorkflowCore/TaskRelevantHistory</a>|
|[stateCode_display](#stateCode_display)||<a href="TaskRelevantHistory.md" target="_blank">WorkflowCore/TaskRelevantHistory</a>|
|[statusCode](#statusCode)|Reason for the status of the Task Relevant History|<a href="TaskRelevantHistory.md" target="_blank">WorkflowCore/TaskRelevantHistory</a>|
|[statusCode_display](#statusCode_display)||<a href="TaskRelevantHistory.md" target="_blank">WorkflowCore/TaskRelevantHistory</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: WorkflowCore/TaskRelevantHistory (this entity)  
