...
description: Request in StoreOperationsAssistCommon - Common Data Model | Microsoft Docs
...
# Request in StoreOperationsAssistCommon

  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/Retail/StoreOperationsAssistCommon/Request.cdm.json" target="_blank">GitHub</a>.  
...
**is.identifiedBy**  
  names a specific identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[Request/(resolvedAttributes)/activityId](#activityId)</td><td>attribute</td><td></td></tr></table>
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/Retail/StoreOperationsAssistCommon/Request.cdm.json/Request<br>/hasAttributes/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>
...
|---|---|---|
|[actualEnd](#actualEnd)|Actual end time of the activity.|<a href="Request.md" target="_blank">StoreOperationsAssistCommon/Request</a>|
|[activityId](#activityId)|Unique identifier of the activity.|<a href="Request.md" target="_blank">StoreOperationsAssistCommon/Request</a>|
|[isBilled](#isBilled)|Information regarding whether the activity was billed as part of resolving a case.|<a href="Request.md" target="_blank">StoreOperationsAssistCommon/Request</a>|
|[description](#description)|Description of the activity.|<a href="Request.md" target="_blank">StoreOperationsAssistCommon/Request</a>|
|[modifiedOn](#modifiedOn)|Date and time when activity was last modified.|<a href="Request.md" target="_blank">StoreOperationsAssistCommon/Request</a>|
|[activityTypeCode](#activityTypeCode)|Type of activity.|<a href="Request.md" target="_blank">StoreOperationsAssistCommon/Request</a>|
|[stateCode](#stateCode)|Status of the activity.|<a href="Request.md" target="_blank">StoreOperationsAssistCommon/Request</a>|
|[scheduledEnd](#scheduledEnd)|Scheduled end time of the activity.|<a href="Request.md" target="_blank">StoreOperationsAssistCommon/Request</a>|
|[scheduledDurationMinutes](#scheduledDurationMinutes)|Scheduled duration of the activity, specified in minutes.|<a href="Request.md" target="_blank">StoreOperationsAssistCommon/Request</a>|
|[actualDurationMinutes](#actualDurationMinutes)|Actual duration of the activity in minutes.|<a href="Request.md" target="_blank">StoreOperationsAssistCommon/Request</a>|
|[statusCode](#statusCode)|Reason for the status of the activity.|<a href="Request.md" target="_blank">StoreOperationsAssistCommon/Request</a>|
|[actualStart](#actualStart)|Actual start time of the activity.|<a href="Request.md" target="_blank">StoreOperationsAssistCommon/Request</a>|
|[createdOn](#createdOn)|Date and time when the activity was created.|<a href="Request.md" target="_blank">StoreOperationsAssistCommon/Request</a>|
|[priorityCode](#priorityCode)|Priority of the activity.|<a href="Request.md" target="_blank">StoreOperationsAssistCommon/Request</a>|
|[subject](#subject)|Subject / title of the request item |<a href="Request.md" target="_blank">StoreOperationsAssistCommon/Request</a>|
|[isWorkflowCreated](#isWorkflowCreated)|Information regarding whether the activity was created from a workflow rule.|<a href="Request.md" target="_blank">StoreOperationsAssistCommon/Request</a>|
|[scheduledStart](#scheduledStart)|Scheduled start time of the activity.|<a href="Request.md" target="_blank">StoreOperationsAssistCommon/Request</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="Request.md" target="_blank">StoreOperationsAssistCommon/Request</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="Request.md" target="_blank">StoreOperationsAssistCommon/Request</a>|
|[instanceTypeCode](#instanceTypeCode)|Type of instance of a recurring series.|<a href="Request.md" target="_blank">StoreOperationsAssistCommon/Request</a>|
|[seriesId](#seriesId)|Uniqueidentifier specifying the id of recurring series of an instance.|<a href="Request.md" target="_blank">StoreOperationsAssistCommon/Request</a>|
|[isRegularActivity](#isRegularActivity)|Information regarding whether the activity is a regular activity type or event type.|<a href="Request.md" target="_blank">StoreOperationsAssistCommon/Request</a>|
|[leftVoiceMail](#leftVoiceMail)|Left the voice mail|<a href="Request.md" target="_blank">StoreOperationsAssistCommon/Request</a>|
|[community](#community)|Shows how contact about the social activity originated, such as from Twitter or Facebook. This field is read-only.|<a href="Request.md" target="_blank">StoreOperationsAssistCommon/Request</a>|
|[isMapiPrivate](#isMapiPrivate)|For internal use only.|<a href="Request.md" target="_blank">StoreOperationsAssistCommon/Request</a>|
|[exchangeWebLink](#exchangeWebLink)|Shows the web link of Activity of type email.|<a href="Request.md" target="_blank">StoreOperationsAssistCommon/Request</a>|
|[exchangeItemId](#exchangeItemId)|The message id of activity which is returned from Exchange Server.|<a href="Request.md" target="_blank">StoreOperationsAssistCommon/Request</a>|
|[deliveryPriorityCode](#deliveryPriorityCode)|Priority of delivery of the activity to the email server.|<a href="Request.md" target="_blank">StoreOperationsAssistCommon/Request</a>|
|[sentOn](#sentOn)|Date and time when the activity was sent.|<a href="Request.md" target="_blank">StoreOperationsAssistCommon/Request</a>|
|[deliveryLastAttemptedOn](#deliveryLastAttemptedOn)|Date and time when the delivery of the activity was last attempted.|<a href="Request.md" target="_blank">StoreOperationsAssistCommon/Request</a>|
|[postponeActivityProcessingUntil](#postponeActivityProcessingUntil)|For internal use only.|<a href="Request.md" target="_blank">StoreOperationsAssistCommon/Request</a>|
|[activityAdditionalParams](#activityAdditionalParams)|Additional information provided by the external application as JSON. For internal use only.|<a href="Request.md" target="_blank">StoreOperationsAssistCommon/Request</a>|
|[sortDate](#sortDate)|Shows the date and time by which the activities are sorted.|<a href="Request.md" target="_blank">StoreOperationsAssistCommon/Request</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="Request.md" target="_blank">StoreOperationsAssistCommon/Request</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="Request.md" target="_blank">StoreOperationsAssistCommon/Request</a>|
|[hasTeamsApproval](#hasTeamsApproval)||<a href="Request.md" target="_blank">StoreOperationsAssistCommon/Request</a>|
|[outletZone](#outletZone)|Zone / location inside the retail store |<a href="Request.md" target="_blank">StoreOperationsAssistCommon/Request</a>|
|[requestType](#requestType)|Type of request|<a href="Request.md" target="_blank">StoreOperationsAssistCommon/Request</a>|
|[task](#task)|Task associated to this request|<a href="Request.md" target="_blank">StoreOperationsAssistCommon/Request</a>|

### <a href=#actualEnd name="actualEnd">actualEnd</a>

Actual end time of the activity.  
First included in: StoreOperationsAssistCommon/Request (this entity)  
