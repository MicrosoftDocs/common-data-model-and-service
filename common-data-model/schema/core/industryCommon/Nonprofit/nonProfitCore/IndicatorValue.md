...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="IndicatorValue.md" target="_blank">nonProfitCore/IndicatorValue</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="IndicatorValue.md" target="_blank">nonProfitCore/IndicatorValue</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="IndicatorValue.md" target="_blank">nonProfitCore/IndicatorValue</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="IndicatorValue.md" target="_blank">nonProfitCore/IndicatorValue</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="IndicatorValue.md" target="_blank">nonProfitCore/IndicatorValue</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="IndicatorValue.md" target="_blank">nonProfitCore/IndicatorValue</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="IndicatorValue.md" target="_blank">nonProfitCore/IndicatorValue</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="IndicatorValue.md" target="_blank">nonProfitCore/IndicatorValue</a>|
|[ownerId](#ownerId)|Owner Id|<a href="IndicatorValue.md" target="_blank">nonProfitCore/IndicatorValue</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="IndicatorValue.md" target="_blank">nonProfitCore/IndicatorValue</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="IndicatorValue.md" target="_blank">nonProfitCore/IndicatorValue</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="IndicatorValue.md" target="_blank">nonProfitCore/IndicatorValue</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="IndicatorValue.md" target="_blank">nonProfitCore/IndicatorValue</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="IndicatorValue.md" target="_blank">nonProfitCore/IndicatorValue</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="IndicatorValue.md" target="_blank">nonProfitCore/IndicatorValue</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="IndicatorValue.md" target="_blank">nonProfitCore/IndicatorValue</a>|
|[exchangeRate](#exchangeRate)|Exchange rate for the currency associated with the entity with respect to the base currency.|<a href="IndicatorValue.md" target="_blank">nonProfitCore/IndicatorValue</a>|
|[amount](#amount)|Indicates the actual value reported, expressed as a currency.|<a href="IndicatorValue.md" target="_blank">nonProfitCore/IndicatorValue</a>|
|[amountBase](#amountBase)|Value of the Amount in base currency.|<a href="IndicatorValue.md" target="_blank">nonProfitCore/IndicatorValue</a>|
|[baselineValue](#baselineValue)|An IATI string definining the Baseline value for the value being reported.|<a href="IndicatorValue.md" target="_blank">nonProfitCore/IndicatorValue</a>|
|[description](#description)|Description|<a href="IndicatorValue.md" target="_blank">nonProfitCore/IndicatorValue</a>|
|[endDate](#endDate)|End date of the Indicator Value.|<a href="IndicatorValue.md" target="_blank">nonProfitCore/IndicatorValue</a>|
|[indicatorId](#indicatorId)|Indicator|<a href="IndicatorValue.md" target="_blank">nonProfitCore/IndicatorValue</a>|
|[indicatorValueId](#indicatorValueId)|Unique identifier for entity instances|<a href="IndicatorValue.md" target="_blank">nonProfitCore/IndicatorValue</a>|
|[name](#name)|The name of the custom entity.|<a href="IndicatorValue.md" target="_blank">nonProfitCore/IndicatorValue</a>|
|[number](#number)|Indicates the actual value reported, expressed as a whole number.|<a href="IndicatorValue.md" target="_blank">nonProfitCore/IndicatorValue</a>|
|[parentIndicatorValueId](#parentIndicatorValueId)|Parent IndicatorValue|<a href="IndicatorValue.md" target="_blank">nonProfitCore/IndicatorValue</a>|
|[percentage](#percentage)|Indicates the actual value reported, expressed as a decimal.|<a href="IndicatorValue.md" target="_blank">nonProfitCore/IndicatorValue</a>|
|[startDate](#startDate)|Start date of the Indicator Value.|<a href="IndicatorValue.md" target="_blank">nonProfitCore/IndicatorValue</a>|
|[valueType](#valueType)|Defines the Value Type of the Indicator Value|<a href="IndicatorValue.md" target="_blank">nonProfitCore/IndicatorValue</a>|
|[valueType_display](#valueType_display)||<a href="IndicatorValue.md" target="_blank">nonProfitCore/IndicatorValue</a>|
|[stateCode](#stateCode)|Status of the Indicator Value|<a href="IndicatorValue.md" target="_blank">nonProfitCore/IndicatorValue</a>|
|[stateCode_display](#stateCode_display)||<a href="IndicatorValue.md" target="_blank">nonProfitCore/IndicatorValue</a>|
|[statusCode](#statusCode)|Reason for the status of the Indicator Value|<a href="IndicatorValue.md" target="_blank">nonProfitCore/IndicatorValue</a>|
|[statusCode_display](#statusCode_display)||<a href="IndicatorValue.md" target="_blank">nonProfitCore/IndicatorValue</a>|
|[transactionCurrencyId](#transactionCurrencyId)|Unique identifier of the currency associated with the entity.|<a href="IndicatorValue.md" target="_blank">nonProfitCore/IndicatorValue</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: nonProfitCore/IndicatorValue (this entity)  
