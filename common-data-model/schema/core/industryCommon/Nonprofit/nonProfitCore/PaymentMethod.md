---
title: PaymentMethod in Microsoft for Nonprofit core data model - Common Data Model | Microsoft Docs
...
# Payment Method in Microsoft for Nonprofit core data model
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="PaymentMethod.md" target="_blank">nonProfitCore/PaymentMethod</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="PaymentMethod.md" target="_blank">nonProfitCore/PaymentMethod</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="PaymentMethod.md" target="_blank">nonProfitCore/PaymentMethod</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="PaymentMethod.md" target="_blank">nonProfitCore/PaymentMethod</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="PaymentMethod.md" target="_blank">nonProfitCore/PaymentMethod</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="PaymentMethod.md" target="_blank">nonProfitCore/PaymentMethod</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="PaymentMethod.md" target="_blank">nonProfitCore/PaymentMethod</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="PaymentMethod.md" target="_blank">nonProfitCore/PaymentMethod</a>|
|[ownerId](#ownerId)|Owner Id|<a href="PaymentMethod.md" target="_blank">nonProfitCore/PaymentMethod</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="PaymentMethod.md" target="_blank">nonProfitCore/PaymentMethod</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="PaymentMethod.md" target="_blank">nonProfitCore/PaymentMethod</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="PaymentMethod.md" target="_blank">nonProfitCore/PaymentMethod</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="PaymentMethod.md" target="_blank">nonProfitCore/PaymentMethod</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="PaymentMethod.md" target="_blank">nonProfitCore/PaymentMethod</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="PaymentMethod.md" target="_blank">nonProfitCore/PaymentMethod</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="PaymentMethod.md" target="_blank">nonProfitCore/PaymentMethod</a>|
|[comments](#comments)||<a href="PaymentMethod.md" target="_blank">nonProfitCore/PaymentMethod</a>|
|[contactId](#contactId)|Unique identifier for Contact associated with Payment Method.|<a href="PaymentMethod.md" target="_blank">nonProfitCore/PaymentMethod</a>|
|[isDefault](#isDefault)||<a href="PaymentMethod.md" target="_blank">nonProfitCore/PaymentMethod</a>|
|[lastAuthenticationStatus](#lastAuthenticationStatus)||<a href="PaymentMethod.md" target="_blank">nonProfitCore/PaymentMethod</a>|
|[lastAuthenticationStatus_display](#lastAuthenticationStatus_display)||<a href="PaymentMethod.md" target="_blank">nonProfitCore/PaymentMethod</a>|
|[lastAuthenticationStatusDate](#lastAuthenticationStatusDate)||<a href="PaymentMethod.md" target="_blank">nonProfitCore/PaymentMethod</a>|
|[lastAuthenticationStatusDetail](#lastAuthenticationStatusDetail)||<a href="PaymentMethod.md" target="_blank">nonProfitCore/PaymentMethod</a>|
|[lastAuthenticationStatusTechnicalDetail](#lastAuthenticationStatusTechnicalDetail)||<a href="PaymentMethod.md" target="_blank">nonProfitCore/PaymentMethod</a>|
|[name](#name)||<a href="PaymentMethod.md" target="_blank">nonProfitCore/PaymentMethod</a>|
|[paymentMethodId](#paymentMethodId)|Unique identifier for entity instances|<a href="PaymentMethod.md" target="_blank">nonProfitCore/PaymentMethod</a>|
|[paymentScheduleId](#paymentScheduleId)|Unique identifier for Payment Schedule associated with Payment Method.|<a href="PaymentMethod.md" target="_blank">nonProfitCore/PaymentMethod</a>|
|[payorId](#payorId)|Payor Account|<a href="PaymentMethod.md" target="_blank">nonProfitCore/PaymentMethod</a>|
|[transactionId](#transactionId)|Unique identifier for Transaction associated with Payment Method.|<a href="PaymentMethod.md" target="_blank">nonProfitCore/PaymentMethod</a>|
|[type](#type)||<a href="PaymentMethod.md" target="_blank">nonProfitCore/PaymentMethod</a>|
|[type_display](#type_display)||<a href="PaymentMethod.md" target="_blank">nonProfitCore/PaymentMethod</a>|
|[stateCode](#stateCode)|Status of the Payment Method|<a href="PaymentMethod.md" target="_blank">nonProfitCore/PaymentMethod</a>|
|[stateCode_display](#stateCode_display)||<a href="PaymentMethod.md" target="_blank">nonProfitCore/PaymentMethod</a>|
|[statusCode](#statusCode)|Reason for the status of the Payment Method|<a href="PaymentMethod.md" target="_blank">nonProfitCore/PaymentMethod</a>|
|[statusCode_display](#statusCode_display)||<a href="PaymentMethod.md" target="_blank">nonProfitCore/PaymentMethod</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: nonProfitCore/PaymentMethod (this entity)  
