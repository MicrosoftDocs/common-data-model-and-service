---
title: ResourceCatalog in Microsoft for Nonprofit core data model - Common Data Model | Microsoft Docs
...
# Resource Catalog in Microsoft for Nonprofit core data model

Catalog that contains beneficiaries that are not contacts/accounts.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/nonProfit/nonProfitCore/ResourceCatalog.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/core/applicationCommon/foundationCommon<br>/crmCommon/accelerators/nonProfit/nonProfitCore<br>/ResourceCatalog.cdm.json/ResourceCatalog<br>/hasAttributes/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[ResourceCatalog/(resolvedAttributes)/resourceCatalogId](#resourceCatalogId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[ResourceCatalog/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Resource Catalog</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Catalog that contains beneficiaries that are not contacts/accounts.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msnfp_resourcecatalog"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="ResourceCatalog.md" target="_blank">nonProfitCore/ResourceCatalog</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="ResourceCatalog.md" target="_blank">nonProfitCore/ResourceCatalog</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="ResourceCatalog.md" target="_blank">nonProfitCore/ResourceCatalog</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="ResourceCatalog.md" target="_blank">nonProfitCore/ResourceCatalog</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="ResourceCatalog.md" target="_blank">nonProfitCore/ResourceCatalog</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="ResourceCatalog.md" target="_blank">nonProfitCore/ResourceCatalog</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="ResourceCatalog.md" target="_blank">nonProfitCore/ResourceCatalog</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="ResourceCatalog.md" target="_blank">nonProfitCore/ResourceCatalog</a>|
|[ownerId](#ownerId)|Owner Id|<a href="ResourceCatalog.md" target="_blank">nonProfitCore/ResourceCatalog</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="ResourceCatalog.md" target="_blank">nonProfitCore/ResourceCatalog</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="ResourceCatalog.md" target="_blank">nonProfitCore/ResourceCatalog</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="ResourceCatalog.md" target="_blank">nonProfitCore/ResourceCatalog</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="ResourceCatalog.md" target="_blank">nonProfitCore/ResourceCatalog</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="ResourceCatalog.md" target="_blank">nonProfitCore/ResourceCatalog</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="ResourceCatalog.md" target="_blank">nonProfitCore/ResourceCatalog</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="ResourceCatalog.md" target="_blank">nonProfitCore/ResourceCatalog</a>|
|[description](#description)|Description of the resource.|<a href="ResourceCatalog.md" target="_blank">nonProfitCore/ResourceCatalog</a>|
|[name](#name)|The name of the custom entity.|<a href="ResourceCatalog.md" target="_blank">nonProfitCore/ResourceCatalog</a>|
|[resourceCatalogId](#resourceCatalogId)|Unique identifier for entity instances|<a href="ResourceCatalog.md" target="_blank">nonProfitCore/ResourceCatalog</a>|
|[resourceCatalogType](#resourceCatalogType)|Type of  resource catalog i.e. Animal, Object, Other|<a href="ResourceCatalog.md" target="_blank">nonProfitCore/ResourceCatalog</a>|
|[resourceCatalogType_display](#resourceCatalogType_display)||<a href="ResourceCatalog.md" target="_blank">nonProfitCore/ResourceCatalog</a>|
|[stateCode](#stateCode)|Status of the Resource Catalog|<a href="ResourceCatalog.md" target="_blank">nonProfitCore/ResourceCatalog</a>|
|[stateCode_display](#stateCode_display)||<a href="ResourceCatalog.md" target="_blank">nonProfitCore/ResourceCatalog</a>|
|[statusCode](#statusCode)|Reason for the status of the Resource Catalog|<a href="ResourceCatalog.md" target="_blank">nonProfitCore/ResourceCatalog</a>|
|[statusCode_display](#statusCode_display)||<a href="ResourceCatalog.md" target="_blank">nonProfitCore/ResourceCatalog</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: nonProfitCore/ResourceCatalog (this entity)  
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Description</td></tr><tr><td>description</td><td>Description of the resource.</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>2000</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msnfp_description</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Description of the resource.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
### <a href=#resourceCatalogId name="resourceCatalogId">resourceCatalogId</a>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Resource Catalog</td></tr><tr><td>description</td><td>Unique identifier for entity instances</td></tr><tr><td>isPrimaryKey</td><td>true</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>sourceName</td><td>msnfp_resourcecatalogid</td></tr></table>

#### Traits

<details>
<summary>List of traits for the resourceCatalogId attribute are listed below.</summary>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msnfp_resourcecatalogid"</td><td>string</td><td></td></tr></table>
...
### <a href=#resourceCatalogType name="resourceCatalogType">resourceCatalogType</a>

Type of  resource catalog i.e. Animal, Object, Other  
First included in: nonProfitCore/ResourceCatalog (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Resource Catalog Type</td></tr><tr><td>description</td><td>Type of  resource catalog i.e. Animal, Object, Other</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msnfp_resourcecatalogtype</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Animal</td><td>844060000</td></tr><tr><td>en</td><td>Object</td><td>844060001</td></tr><tr><td>en</td><td>Other</td><td>844060002</td></tr></table></td></tr></table>

#### Traits

<details>
<summary>List of traits for the resourceCatalogType attribute are listed below.</summary>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msnfp_resourcecatalogtype"</td><td>string</td><td></td></tr></table>

**is.requiredAtLevel**  
The requirement level for setting values into this attribute in CDS for Applications or for including this attribute in entities created in CDS for Analytics  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>level</td><td>"none"</td><td>string</td><td>values can be: 'systemrequired', 'required', 'recommended', 'none'</td></tr></table>

**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Resource Catalog Type</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Type of  resource catalog i.e. Animal, Object, Other</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
### <a href=#resourceCatalogType_display name="resourceCatalogType_display">resourceCatalogType_display</a>
...
<details>
<summary>List of traits for the resourceCatalogType_display attribute are listed below.</summary>
...
**is.readOnly**  
**is.addedInSupportOf**  
<table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>inSupportOf</td><td>"resourceCatalogType"</td><td>attributeName</td><td>output parameter naming the attribute that is being supported</td></tr></table>
...
Status of the Resource Catalog  
First included in: nonProfitCore/ResourceCatalog (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status</td></tr><tr><td>description</td><td>Status of the Resource Catalog</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>sourceName</td><td>statecode</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Active</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the Resource Catalog</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
Reason for the status of the Resource Catalog  
First included in: nonProfitCore/ResourceCatalog (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Status Reason</td></tr><tr><td>description</td><td>Reason for the status of the Resource Catalog</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>statuscode</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th><th>correlatedValue</th></tr><tr><td>en</td><td>Active</td><td>1</td><td>0</td></tr><tr><td>en</td><td>Inactive</td><td>2</td><td>1</td></tr></table></td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the Resource Catalog</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
