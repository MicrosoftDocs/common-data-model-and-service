...
A Disbursement represents an Award disbursement to an individual or organizational awardee.  A Disbursement is related to a specific Award and Budget.  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/nonProfit/nonProfitCore/Disbursement.cdm.json" target="_blank">GitHub</a>.  
...
- [/foundationCommon/crmCommon/accelerators/nonProfit/nonProfitIati/Disbursement](../nonProfitIati/Disbursement.md "/core/applicationCommon/foundationCommon/crmCommon/accelerators/nonProfit/nonProfitIati/Disbursement.cdm.json/Disbursement")  
</details>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="Disbursement.md" target="_blank">nonProfitCore/Disbursement</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="Disbursement.md" target="_blank">nonProfitCore/Disbursement</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="Disbursement.md" target="_blank">nonProfitCore/Disbursement</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="Disbursement.md" target="_blank">nonProfitCore/Disbursement</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="Disbursement.md" target="_blank">nonProfitCore/Disbursement</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="Disbursement.md" target="_blank">nonProfitCore/Disbursement</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="Disbursement.md" target="_blank">nonProfitCore/Disbursement</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="Disbursement.md" target="_blank">nonProfitCore/Disbursement</a>|
|[ownerId](#ownerId)|Owner Id|<a href="Disbursement.md" target="_blank">nonProfitCore/Disbursement</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="Disbursement.md" target="_blank">nonProfitCore/Disbursement</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="Disbursement.md" target="_blank">nonProfitCore/Disbursement</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="Disbursement.md" target="_blank">nonProfitCore/Disbursement</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="Disbursement.md" target="_blank">nonProfitCore/Disbursement</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="Disbursement.md" target="_blank">nonProfitCore/Disbursement</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="Disbursement.md" target="_blank">nonProfitCore/Disbursement</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="Disbursement.md" target="_blank">nonProfitCore/Disbursement</a>|
|[exchangeRate](#exchangeRate)|Exchange rate for the currency associated with the entity with respect to the base currency.|<a href="Disbursement.md" target="_blank">nonProfitCore/Disbursement</a>|
|[adjustmentComment](#adjustmentComment)|Any notes or details about the adjustment that the user may have optionally entered.|<a href="Disbursement.md" target="_blank">nonProfitCore/Disbursement</a>|
|[adjustmentReason](#adjustmentReason)||<a href="Disbursement.md" target="_blank">nonProfitCore/Disbursement</a>|
|[adjustmentReason_display](#adjustmentReason_display)||<a href="Disbursement.md" target="_blank">nonProfitCore/Disbursement</a>|
|[adjustmentType](#adjustmentType)||<a href="Disbursement.md" target="_blank">nonProfitCore/Disbursement</a>|
|[adjustmentType_display](#adjustmentType_display)||<a href="Disbursement.md" target="_blank">nonProfitCore/Disbursement</a>|
|[adjustsOriginalTransactionId](#adjustsOriginalTransactionId)|Adjusts Original Transaction|<a href="Disbursement.md" target="_blank">nonProfitCore/Disbursement</a>|
|[amount](#amount)||<a href="Disbursement.md" target="_blank">nonProfitCore/Disbursement</a>|
|[amountBase](#amountBase)|Value of the amount in base currency.|<a href="Disbursement.md" target="_blank">nonProfitCore/Disbursement</a>|
|[amouont](#amouont)|The amount of the Disbursement.|<a href="Disbursement.md" target="_blank">nonProfitCore/Disbursement</a>|
|[amouontBase](#amouontBase)|Value of the Amount in base currency.|<a href="Disbursement.md" target="_blank">nonProfitCore/Disbursement</a>|
|[awardId](#awardId)|Award|<a href="Disbursement.md" target="_blank">nonProfitCore/Disbursement</a>|
|[bookDate](#bookDate)|Book Date|<a href="Disbursement.md" target="_blank">nonProfitCore/Disbursement</a>|
|[comment](#comment)|Comments about the Disbursement.|<a href="Disbursement.md" target="_blank">nonProfitCore/Disbursement</a>|
|[description](#description)|Description of the Disbursement.|<a href="Disbursement.md" target="_blank">nonProfitCore/Disbursement</a>|
|[disbursementId](#disbursementId)|Unique identifier for entity instances|<a href="Disbursement.md" target="_blank">nonProfitCore/Disbursement</a>|
|[isAdjusted](#isAdjusted)|Is Adjusted|<a href="Disbursement.md" target="_blank">nonProfitCore/Disbursement</a>|
|[name](#name)|The name of the custom entity.|<a href="Disbursement.md" target="_blank">nonProfitCore/Disbursement</a>|
|[postedDate](#postedDate)|The date the Disbursement was posted to the GL|<a href="Disbursement.md" target="_blank">nonProfitCore/Disbursement</a>|
|[recipientAccountId](#recipientAccountId)|Recipient Account|<a href="Disbursement.md" target="_blank">nonProfitCore/Disbursement</a>|
|[recipientContactId](#recipientContactId)|Recipient Contact|<a href="Disbursement.md" target="_blank">nonProfitCore/Disbursement</a>|
|[requestDate](#requestDate)|The date the Disbursement was requested.|<a href="Disbursement.md" target="_blank">nonProfitCore/Disbursement</a>|
|[scheduledDisbursementDate](#scheduledDisbursementDate)|The date the Disbursement is scheduled to be sent.|<a href="Disbursement.md" target="_blank">nonProfitCore/Disbursement</a>|
|[sentDate](#sentDate)|The date the Disbursement was sent.|<a href="Disbursement.md" target="_blank">nonProfitCore/Disbursement</a>|
|[status](#status)|Status of the Disbursement.|<a href="Disbursement.md" target="_blank">nonProfitCore/Disbursement</a>|
|[status_display](#status_display)||<a href="Disbursement.md" target="_blank">nonProfitCore/Disbursement</a>|
|[type](#type)|The type of Disbursement.|<a href="Disbursement.md" target="_blank">nonProfitCore/Disbursement</a>|
|[type_display](#type_display)||<a href="Disbursement.md" target="_blank">nonProfitCore/Disbursement</a>|
|[stateCode](#stateCode)|Status of the Disbursement|<a href="Disbursement.md" target="_blank">nonProfitCore/Disbursement</a>|
|[stateCode_display](#stateCode_display)||<a href="Disbursement.md" target="_blank">nonProfitCore/Disbursement</a>|
|[statusCode](#statusCode)|Reason for the status of the Disbursement|<a href="Disbursement.md" target="_blank">nonProfitCore/Disbursement</a>|
|[statusCode_display](#statusCode_display)||<a href="Disbursement.md" target="_blank">nonProfitCore/Disbursement</a>|
|[transactionCurrencyId](#transactionCurrencyId)|Unique identifier of the currency associated with the entity.|<a href="Disbursement.md" target="_blank">nonProfitCore/Disbursement</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: nonProfitCore/Disbursement (this entity)  
...
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="DisbursementDistribution.md" target="_blank">/core/industrycommon/nonprofit/nonprofitcore/DisbursementDistribution.cdm.json/DisbursementDistribution</a></td><td><a href="DisbursementDistribution.md#disbursementDistributionId" target="_blank">disbursementDistributionId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>
