---
title: CreditPlanRecipient in Microsoft for Nonprofit core data model - Common Data Model | Microsoft Docs
...
# Credit Plan Recipient in Microsoft for Nonprofit core data model

The contact, donor or constituent who receives "credit" for the hard or soft cleared payment.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon/foundationCommon/crmCommon/accelerators/nonProfit/nonProfitCore/CreditPlanRecipient.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsCreationModificationDatesAndIds</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsOwnershipInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsTimeZoneInfo</td></tr><tr><td>/core/wellKnownCDSAttributeGroups.cdm.json<br>/cdsVersionTracking</td></tr><tr><td>/core/applicationCommon/foundationCommon<br>/crmCommon/accelerators/nonProfit/nonProfitCore<br>/CreditPlanRecipient.cdm.json/CreditPlanRecipient<br>/hasAttributes/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.identifiedBy**  
  names a specifc identity attribute to use with an entity  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[CreditPlanRecipient/(resolvedAttributes)/creditRecipientId](#creditRecipientId)</td><td>attribute</td><td></td></tr></table>

**means.entityState**  
  the attribute represents the current state of the entity.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>attribute</td><td>[CreditPlanRecipient/(resolvedAttributes)/stateCode](#stateCode)</td><td>attribute</td><td></td></tr></table>

**is.localized.displayedAs**  
  Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Credit Plan Recipient</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>The contact, donor or constituent who receives "credit" for the hard or soft cleared payment.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>

**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msnfp_CreditRecipient"</td><td>string</td><td></td></tr></table>
...
|---|---|---|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="CreditPlanRecipient.md" target="_blank">nonProfitCore/CreditPlanRecipient</a>|
|[createdBy](#createdBy)|Unique identifier of the user who created the record.|<a href="CreditPlanRecipient.md" target="_blank">nonProfitCore/CreditPlanRecipient</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="CreditPlanRecipient.md" target="_blank">nonProfitCore/CreditPlanRecipient</a>|
|[modifiedBy](#modifiedBy)|Unique identifier of the user who modified the record.|<a href="CreditPlanRecipient.md" target="_blank">nonProfitCore/CreditPlanRecipient</a>|
|[createdOnBehalfBy](#createdOnBehalfBy)|Unique identifier of the delegate user who created the record.|<a href="CreditPlanRecipient.md" target="_blank">nonProfitCore/CreditPlanRecipient</a>|
|[modifiedOnBehalfBy](#modifiedOnBehalfBy)|Unique identifier of the delegate user who modified the record.|<a href="CreditPlanRecipient.md" target="_blank">nonProfitCore/CreditPlanRecipient</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="CreditPlanRecipient.md" target="_blank">nonProfitCore/CreditPlanRecipient</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="CreditPlanRecipient.md" target="_blank">nonProfitCore/CreditPlanRecipient</a>|
|[ownerId](#ownerId)|Owner Id|<a href="CreditPlanRecipient.md" target="_blank">nonProfitCore/CreditPlanRecipient</a>|
|[ownerIdType](#ownerIdType)|The type of owner, either User or Team.|<a href="CreditPlanRecipient.md" target="_blank">nonProfitCore/CreditPlanRecipient</a>|
|[owningBusinessUnit](#owningBusinessUnit)|Unique identifier for the business unit that owns the record|<a href="CreditPlanRecipient.md" target="_blank">nonProfitCore/CreditPlanRecipient</a>|
|[owningUser](#owningUser)|Unique identifier of the user that owns the activity.|<a href="CreditPlanRecipient.md" target="_blank">nonProfitCore/CreditPlanRecipient</a>|
|[owningTeam](#owningTeam)|Unique identifier for the team that owns the record.|<a href="CreditPlanRecipient.md" target="_blank">nonProfitCore/CreditPlanRecipient</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="CreditPlanRecipient.md" target="_blank">nonProfitCore/CreditPlanRecipient</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="CreditPlanRecipient.md" target="_blank">nonProfitCore/CreditPlanRecipient</a>|
|[versionNumber](#versionNumber)|Version Number|<a href="CreditPlanRecipient.md" target="_blank">nonProfitCore/CreditPlanRecipient</a>|
|[creditPlanRecipientCustomerId](#creditPlanRecipientCustomerId)|Unique identifier of the creditplanrecipientcustomer for the item.|<a href="CreditPlanRecipient.md" target="_blank">nonProfitCore/CreditPlanRecipient</a>|
|[type](#type)||<a href="CreditPlanRecipient.md" target="_blank">nonProfitCore/CreditPlanRecipient</a>|
|[creditRecipientCreditPlanId](#creditRecipientCreditPlanId)|Credit Plan|<a href="CreditPlanRecipient.md" target="_blank">nonProfitCore/CreditPlanRecipient</a>|
|[creditRecipientId](#creditRecipientId)|Unique identifier for entity instances|<a href="CreditPlanRecipient.md" target="_blank">nonProfitCore/CreditPlanRecipient</a>|
|[name](#name)||<a href="CreditPlanRecipient.md" target="_blank">nonProfitCore/CreditPlanRecipient</a>|
|[percentageOfPayment](#percentageOfPayment)||<a href="CreditPlanRecipient.md" target="_blank">nonProfitCore/CreditPlanRecipient</a>|
|[softCreditReason](#softCreditReason)||<a href="CreditPlanRecipient.md" target="_blank">nonProfitCore/CreditPlanRecipient</a>|
|[softCreditReason_display](#softCreditReason_display)||<a href="CreditPlanRecipient.md" target="_blank">nonProfitCore/CreditPlanRecipient</a>|
|[stateCode](#stateCode)|Status of the Credit Plan Recipient|<a href="CreditPlanRecipient.md" target="_blank">nonProfitCore/CreditPlanRecipient</a>|
|[stateCode_display](#stateCode_display)||<a href="CreditPlanRecipient.md" target="_blank">nonProfitCore/CreditPlanRecipient</a>|
|[statusCode](#statusCode)|Reason for the status of the Credit Plan Recipient|<a href="CreditPlanRecipient.md" target="_blank">nonProfitCore/CreditPlanRecipient</a>|
|[statusCode_display](#statusCode_display)||<a href="CreditPlanRecipient.md" target="_blank">nonProfitCore/CreditPlanRecipient</a>|

### <a href=#createdOn name="createdOn">createdOn</a>

Date and time when the record was created.  
First included in: nonProfitCore/CreditPlanRecipient (this entity)  
...
### <a href=#creditPlanRecipientCustomerId name="creditPlanRecipientCustomerId">creditPlanRecipientCustomerId</a>

Unique identifier of the creditplanrecipientcustomer for the item.  
First included in: nonProfitCore/CreditPlanRecipient (this entity)  

#### Properties

<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Customer</td></tr><tr><td>description</td><td>Unique identifier of the creditplanrecipientcustomer for the item.</td></tr><tr><td>dataFormat</td><td>guid</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msnfp_creditplanrecipient_customer</td></tr></table>

#### Traits

<details>
<summary>List of traits for the creditPlanRecipientCustomerId attribute are listed below.</summary>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Unique identifier of the creditplanrecipientcustomer for the item.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msnfp_creditplanrecipient_customer"</td><td>string</td><td></td></tr></table>
...
<details>
<summary>List of traits for the creditRecipientCreditPlanId attribute are listed below.</summary>
...
**is.linkedEntity.identifier**  
Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th></tr><tr><td><a href="CreditPlan.md" target="_blank">/core/industrycommon/nonprofit/nonprofitcore/CreditPlan.cdm.json/CreditPlan</a></td><td><a href="CreditPlan.md#creditPlanId" target="_blank">creditPlanId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>

**is.nullable**  
The attribute value may be set to NULL.  

**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msnfp_creditrecipient_creditplanid"</td><td>string</td><td></td></tr></table>
...
<details>
<summary>List of traits for the creditRecipientId attribute are listed below.</summary>
...
**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msnfp_creditrecipientid"</td><td>string</td><td></td></tr></table>
...
<details>
<summary>List of traits for the percentageOfPayment attribute are listed below.</summary>

**is.dataFormat.numeric.shaped**  
for setting the exact precision and scale of numeric values  

**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msnfp_percentageofpayment"</td><td>string</td><td></td></tr></table>
...
**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Percentage of Payment</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<details>
<summary>List of traits for the softCreditReason attribute are listed below.</summary>

**is.dataFormat.integer**  
**does.haveDefault**  
An attribute has a default value  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>default</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>SoftCreditReason</td><td>100000000</td></tr></table></td><td>any</td><td></td></tr></table>

**is.constrainedList**  
the values of an attribute are taken from or looked up from a fixed list of possibilities  

**is.CDS.sourceNamed**  
the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msnfp_softcreditreason"</td><td>string</td><td></td></tr></table>

**is.requiredAtLevel**  
The requirement level for setting values into this attribute in CDS for Applications or for including this attribute in entities created in CDS for Analytics  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>level</td><td>"none"</td><td>string</td><td>values can be: 'systemrequired', 'required', 'recommended', 'none'</td></tr></table>

**is.localized.displayedAs**  
Holds the list of language specific display text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Soft Credit Reason</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<details>
<summary>List of traits for the softCreditReason_display attribute are listed below.</summary>
...
**is.readOnly**  
**is.addedInSupportOf**  
<table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>inSupportOf</td><td>"softCreditReason"</td><td>attributeName</td><td>output parameter naming the attribute that is being supported</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Status of the Credit Plan Recipient</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
**is.localized.describedAs**  
Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reason for the status of the Credit Plan Recipient</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
