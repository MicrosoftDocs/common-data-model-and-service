---
title: RelatedPartyContract in PropertyandCasualtyDataModel - Common Data Model | Microsoft Docs
description: A related party having an agreement with an insurance party on a contract.&#xA;1. Party&#58an insurance entity (Insurer, Agent...)&#xA;2. Related party&#58either a 1st party (a law office being insured), or a 3rd party (a law office handling a claim).&#xA;3. Contract part - Policy, claim...
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/FinancialServices/PropertyandCasualtyDataModel<br>/RelatedPartyContract.cdm.json<br>/RelatedPartyContract/hasAttributes<br>/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>

**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>A related party having an agreement with an insurance party on a contract.&#xA;1. Party:an insurance entity (Insurer, Agent...)&#xA;2. Related party:either a 1st party (a law office being insured), or a 3rd party (a law office handling a claim).&#xA;3. Contract part - Policy, claim...</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
|---|---|---|
|[relatedpartycontractId](#relatedpartycontractId)|Unique identifier for entity instances.|<a href="RelatedPartyContract.md" target="_blank">PropertyandCasualtyDataModel/RelatedPartyContract</a>|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="RelatedPartyContract.md" target="_blank">PropertyandCasualtyDataModel/RelatedPartyContract</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="RelatedPartyContract.md" target="_blank">PropertyandCasualtyDataModel/RelatedPartyContract</a>|
|[statecode](#statecode)|Status of the Ins entity service provider|<a href="RelatedPartyContract.md" target="_blank">PropertyandCasualtyDataModel/RelatedPartyContract</a>|
|[statuscode](#statuscode)|Reason for the status of the Ins entity service provider|<a href="RelatedPartyContract.md" target="_blank">PropertyandCasualtyDataModel/RelatedPartyContract</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="RelatedPartyContract.md" target="_blank">PropertyandCasualtyDataModel/RelatedPartyContract</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="RelatedPartyContract.md" target="_blank">PropertyandCasualtyDataModel/RelatedPartyContract</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="RelatedPartyContract.md" target="_blank">PropertyandCasualtyDataModel/RelatedPartyContract</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="RelatedPartyContract.md" target="_blank">PropertyandCasualtyDataModel/RelatedPartyContract</a>|
|[name](#name)|Required name field.|<a href="RelatedPartyContract.md" target="_blank">PropertyandCasualtyDataModel/RelatedPartyContract</a>|
|[contractpart](#contractpart)|The contract part the relationship is about.|<a href="RelatedPartyContract.md" target="_blank">PropertyandCasualtyDataModel/RelatedPartyContract</a>|
|[contractpartType](#contractpartType)|The contract part the relationship is about.|<a href="RelatedPartyContract.md" target="_blank">PropertyandCasualtyDataModel/RelatedPartyContract</a>|
|[party](#party)|The party the relationship relates to, e.g., Insurer, Agency, Agent.|<a href="RelatedPartyContract.md" target="_blank">PropertyandCasualtyDataModel/RelatedPartyContract</a>|
|[partyType](#partyType)|The party the relationship relates to, e.g., Insurer, Agency, Agent.|<a href="RelatedPartyContract.md" target="_blank">PropertyandCasualtyDataModel/RelatedPartyContract</a>|
|[relatedparty](#relatedparty)|Reference to a related party, e.g., 1st party such as insured contact or account, or a 3rd party such as a tow company that towed a damaged car.|<a href="RelatedPartyContract.md" target="_blank">PropertyandCasualtyDataModel/RelatedPartyContract</a>|
|[relatedpartyType](#relatedpartyType)|Reference to a related party, e.g., 1st party such as insured contact or account, or a 3rd party such as a tow company that towed a damaged car.|<a href="RelatedPartyContract.md" target="_blank">PropertyandCasualtyDataModel/RelatedPartyContract</a>|
|[relatedpartyrole](#relatedpartyrole)|The role the related party plays in the current relationship context.|<a href="RelatedPartyContract.md" target="_blank">PropertyandCasualtyDataModel/RelatedPartyContract</a>|
|[relatedpartytype](#relatedpartytype)|Tells whether the party is 1st party or 3rd party.|<a href="RelatedPartyContract.md" target="_blank">PropertyandCasualtyDataModel/RelatedPartyContract</a>|
|[validfrom](#validfrom)|Validity start date for related party/contract.|<a href="RelatedPartyContract.md" target="_blank">PropertyandCasualtyDataModel/RelatedPartyContract</a>|
|[validto](#validto)|Expiry date of related party/contract.|<a href="RelatedPartyContract.md" target="_blank">PropertyandCasualtyDataModel/RelatedPartyContract</a>|
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Party</td></tr><tr><td>description</td><td>The party the relationship relates to, e.g., Insurer, Agency, Agent.</td></tr><tr><td>dataFormat</td><td>guid</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Party</td></tr><tr><td>description</td><td>The party the relationship relates to, e.g., Insurer, Agency, Agent.</td></tr><tr><td>dataFormat</td><td>string</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Related party</td></tr><tr><td>description</td><td>Reference to a related party, e.g., 1st party such as insured contact or account, or a 3rd party such as a tow company that towed a damaged car.</td></tr><tr><td>dataFormat</td><td>guid</td></tr></table>
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Reference to a related party, e.g., 1st party such as insured contact or account, or a 3rd party such as a tow company that towed a damaged car.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Related party</td></tr><tr><td>description</td><td>Reference to a related party, e.g., 1st party such as insured contact or account, or a 3rd party such as a tow company that towed a damaged car.</td></tr><tr><td>dataFormat</td><td>string</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Related party role</td></tr><tr><td>description</td><td>The role the related party plays in the current relationship context.</td></tr><tr><td>dataFormat</td><td>int32</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msfsi_relatedpartyrole</td></tr><tr><td>valueConstrainedToList</td><td>true</td></tr><tr><td>defaultValue</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Primary beneficiary</td><td>104800000</td></tr></table></td></tr></table>

#### Traits

<details>
<summary>List of traits for the relatedpartyrole attribute are listed below.</summary>
...
**is.dataFormat.numeric**  
  **does.haveDefault**  
  An attribute has a default value  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>default</td><td><table><tr><th>languageTag</th><th>displayText</th><th>attributeValue</th></tr><tr><td>en</td><td>Primary beneficiary</td><td>104800000</td></tr></table></td><td>any</td><td></td></tr></table>
...
**is.CDS.sourceNamed**  
  the unique name that identifies this object in CDS for Applications.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>name</td><td>"msfsi_relatedpartyrole"</td><td>string</td><td></td></tr></table>
...
**is.localized.describedAs**  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Tells whether the party is 1st party or 3rd party.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
