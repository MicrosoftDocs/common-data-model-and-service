...
# Branch in Retail Banking Core Data Model

The branch of the main bank, when borrower applies for a loan at a branch.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/FinancialServices/RetailBankingCoreDataModel/Branch.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[branchId](#branchId)|Unique identifier for entity instances.|<a href="Branch.md" target="_blank">RetailBankingCoreDataModel/Branch</a>|
