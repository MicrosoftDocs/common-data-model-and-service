---
title: FHAccount in BankingCoreDataModel - Common Data Model | Microsoft Docs
...
# FH account in BankingCoreDataModel(FHAccount)
...
A deposit account holding that allows the holder to make deposits and withdrawals through financial holding instruments\. An account can be interest bearing  
 ...
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/FinancialServices/BankingCoreDataModel/FHAccount.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/FinancialServices/BankingCoreDataModel<br>/FHAccount.cdm.json/FHAccount/hasAttributes<br>/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>
...
|---|---|---|
|[FH_AccountId](#FH_AccountId)|Unique identifier for entity instances\.|<a href="FHAccount.md" target="_blank">BankingCoreDataModel/FHAccount</a>|
|[createdOn](#createdOn)|Date and time when the record was created\.|<a href="FHAccount.md" target="_blank">BankingCoreDataModel/FHAccount</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified\.|<a href="FHAccount.md" target="_blank">BankingCoreDataModel/FHAccount</a>|
|[statecode](#statecode)|Status of the FH Account\.|<a href="FHAccount.md" target="_blank">BankingCoreDataModel/FHAccount</a>|
|[statuscode](#statuscode)|Reason for the status of the FH Account\.|<a href="FHAccount.md" target="_blank">BankingCoreDataModel/FHAccount</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record\.|<a href="FHAccount.md" target="_blank">BankingCoreDataModel/FHAccount</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated\.|<a href="FHAccount.md" target="_blank">BankingCoreDataModel/FHAccount</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only\.|<a href="FHAccount.md" target="_blank">BankingCoreDataModel/FHAccount</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created\.|<a href="FHAccount.md" target="_blank">BankingCoreDataModel/FHAccount</a>|
|[name](#name)|Required name field\.|<a href="FHAccount.md" target="_blank">BankingCoreDataModel/FHAccount</a>|
|[accountingClassification](#accountingClassification)|Indicates whether the financial holding is an asset or a liability\.|<a href="FHAccount.md" target="_blank">BankingCoreDataModel/FHAccount</a>|
|[availableBalance](#availableBalance)|Available balance on the account\.|<a href="FHAccount.md" target="_blank">BankingCoreDataModel/FHAccount</a>|
|[availablebalance_Base](#availablebalance_Base)|Value of the available balance in base currency\.|<a href="FHAccount.md" target="_blank">BankingCoreDataModel/FHAccount</a>|
|[availableBalance_default](#availableBalance_default)|Available balance converted to default currency of the system\.|<a href="FHAccount.md" target="_blank">BankingCoreDataModel/FHAccount</a>|
|[averageBalance](#averageBalance)|The average balance in the account calculated over a chosen period of time by the bank\.|<a href="FHAccount.md" target="_blank">BankingCoreDataModel/FHAccount</a>|
|[averagebalance_Base](#averagebalance_Base)|Value of the average balance in base currency\.|<a href="FHAccount.md" target="_blank">BankingCoreDataModel/FHAccount</a>|
|[averageBalance_default](#averageBalance_default)|Average balance converted to default currency of the system\.|<a href="FHAccount.md" target="_blank">BankingCoreDataModel/FHAccount</a>|
...
|[numberoftransactions](#numberoftransactions)|Number of transactions that occurred in the last month\.|<a href="FHAccount.md" target="_blank">BankingCoreDataModel/FHAccount</a>|
|[unclearedBalance](#unclearedBalance)|The amount of money in pending transactions which have not yet been credited to the account, such as deposited checks that have not yet cleared\.|<a href="FHAccount.md" target="_blank">BankingCoreDataModel/FHAccount</a>|
