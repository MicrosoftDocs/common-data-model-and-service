---
title: FinancialHolding in BankingCoreDataModel - Common Data Model | Microsoft Docs
...
# Financial holding in BankingCoreDataModel(FinancialHolding)

Accounts, loans, investments, credit lines and savings accounts held by a customer.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/FinancialServices/BankingCoreDataModel/FinancialHolding.cdm.json" target="_blank">GitHub</a>.  
...
**is.CDM.attributeGroup**  
  identifies standard groups of attributes in CDM entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>groupList</td><td><table><tr><th>attributeGroupReference</th></tr><tr><td>/FinancialServices/BankingCoreDataModel<br>/FinancialHolding.cdm.json/FinancialHolding<br>/hasAttributes/attributesAddedAtThisScope</td></tr></table></td><td>entity</td><td></td></tr></table>
...
|---|---|---|
|[financialholdingId](#financialholdingId)|The identifier of the financial holding in the core system.|<a href="FinancialHolding.md" target="_blank">BankingCoreDataModel/FinancialHolding</a>|
|[createdOn](#createdOn)|Date and time when the record was created.|<a href="FinancialHolding.md" target="_blank">BankingCoreDataModel/FinancialHolding</a>|
|[modifiedOn](#modifiedOn)|Date and time when the record was modified.|<a href="FinancialHolding.md" target="_blank">BankingCoreDataModel/FinancialHolding</a>|
|[statecode](#statecode)|Status of the Financial Holding.|<a href="FinancialHolding.md" target="_blank">BankingCoreDataModel/FinancialHolding</a>|
|[statuscode](#statuscode)|Reason for the status of the Financial Holding.|<a href="FinancialHolding.md" target="_blank">BankingCoreDataModel/FinancialHolding</a>|
|[importSequenceNumber](#importSequenceNumber)|Sequence number of the import that created this record.|<a href="FinancialHolding.md" target="_blank">BankingCoreDataModel/FinancialHolding</a>|
|[overriddenCreatedOn](#overriddenCreatedOn)|Date and time that the record was migrated.|<a href="FinancialHolding.md" target="_blank">BankingCoreDataModel/FinancialHolding</a>|
|[timeZoneRuleVersionNumber](#timeZoneRuleVersionNumber)|For internal use only.|<a href="FinancialHolding.md" target="_blank">BankingCoreDataModel/FinancialHolding</a>|
|[UTCConversionTimeZoneCode](#UTCConversionTimeZoneCode)|Time zone code that was in use when the record was created.|<a href="FinancialHolding.md" target="_blank">BankingCoreDataModel/FinancialHolding</a>|
|[name](#name)|The name of the custom entity.|<a href="FinancialHolding.md" target="_blank">BankingCoreDataModel/FinancialHolding</a>|
|[accountingClassification](#accountingClassification)|Indicates whether the financial holding is an asset or a liability.|<a href="FinancialHolding.md" target="_blank">BankingCoreDataModel/FinancialHolding</a>|
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Description</td></tr><tr><td>description</td><td>Description of the financial holding associated with a customer.</td></tr><tr><td>dataFormat</td><td>string</td></tr><tr><td>maximumLength</td><td>300</td></tr><tr><td>isNullable</td><td>true</td></tr><tr><td>sourceName</td><td>msfsi_description</td></tr></table>
...
\*\*is.localized.describedAs\*\*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Description of the financial holding associated with a customer.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Details</td></tr><tr><td>description</td><td>Lookup to detailed table for financial holding.</td></tr><tr><td>dataFormat</td><td>guid</td></tr></table>
...
\*\*is.dataFormat.guid\*\*  
  ...
  Marks the attribute(s) that hold foreign key references to a linked (used as an attribute) entity. This attribute is added to the resolved entity to enumerate the referenced entities.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>entityReferences</td><td><table><tr><th>entityReference</th><th>attributeReference</th><th>relationshipName</th></tr><tr><td><a href="FHAccount.md" target="_blank">FHAccount.cdm.json/FHAccount</a></td><td><a href="FHAccount.md#FH_AccountId" target="_blank">FH_AccountId</a></td></tr><tr><td><a href="FHLineOfCredit.md" target="_blank">FHLineOfCredit.cdm.json/FHLineOfCredit</a></td><td><a href="FHLineOfCredit.md#FH_CreditlineId" target="_blank">FH_CreditlineId</a></td></tr><tr><td><a href="FHInvestment.md" target="_blank">FHInvestment.cdm.json/FHInvestment</a></td><td><a href="FHInvestment.md#FH_InvestmentId" target="_blank">FH_InvestmentId</a></td></tr><tr><td><a href="FHLoan.md" target="_blank">FHLoan.cdm.json/FHLoan</a></td><td><a href="FHLoan.md#FH_LoanId" target="_blank">FH_LoanId</a></td></tr><tr><td><a href="FHSaving.md" target="_blank">FHSaving.cdm.json/FHSaving</a></td><td><a href="FHSaving.md#FH_SavingId" target="_blank">FH_SavingId</a></td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of entity references</td></tr></table>

\*\*is.localized.describedAs\*\*  
  Holds the list of language specific descriptive text for an object.  <table><tr><th>Parameter</th><th>Value</th><th>Data type</th><th>Explanation</th></tr><tr><td>localizedDisplayText</td><td><table><tr><th>languageTag</th><th>displayText</th></tr><tr><td>en</td><td>Lookup to detailed table for financial holding.</td></tr></table></td><td>entity</td><td>a reference to the constant entity holding the list of localized text</td></tr></table>
...
<table><tr><th>Name</th><th>Value</th></tr><tr><td>displayName</td><td>Details</td></tr><tr><td>description</td><td>Lookup to detailed table for financial holding.</td></tr><tr><td>dataFormat</td><td>string</td></tr></table>
