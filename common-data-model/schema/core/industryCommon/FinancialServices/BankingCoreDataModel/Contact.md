---
title: Contact in BankingCoreDataModel - Common Data Model | Microsoft Docs
...
# Contact in BankingCoreDataModel

Person with whom a business unit has a relationship, such as customer, supplier, and colleague\.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/FinancialServices/BankingCoreDataModel/Contact.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[contactId](#contactId)|Unique identifier of the contact\.|<a href="Contact.md" target="_blank">BankingCoreDataModel/Contact</a>|
