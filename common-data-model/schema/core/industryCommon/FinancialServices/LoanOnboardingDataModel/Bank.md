---
title: Bank in Loan Onboarding Data Model - Common Data Model | Microsoft Docs
...
# Bank in Loan Onboarding Data Model

The bank that the branch is associated with.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/FinancialServices/LoanOnboardingDataModel/Bank.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[bankId](#bankId)|Unique identifier for entity instances.|<a href="Bank.md" target="_blank">LoanOnboardingDataModel/Bank</a>|
