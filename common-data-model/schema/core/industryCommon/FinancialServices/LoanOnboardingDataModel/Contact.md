---
title: Contact in Loan Onboarding Data Model - Common Data Model | Microsoft Docs
...
# Contact in Loan Onboarding Data Model

Person with whom a business unit has a relationship, such as customer, supplier, and colleague.  
  
 Latest version of the JSON entity definition is available on <a href="https://github.com/Microsoft/CDM/tree/master/schemaDocuments/FinancialServices/LoanOnboardingDataModel/Contact.cdm.json" target="_blank">GitHub</a>.  
...
|---|---|---|
|[contactId](#contactId)|Unique identifier of the contact.|<a href="Contact.md" target="_blank">LoanOnboardingDataModel/Contact</a>|

### <a href=#contactId name="contactId">contactId</a>

Unique identifier of the contact.  
First included in: LoanOnboardingDataModel/Contact (this entity)  
