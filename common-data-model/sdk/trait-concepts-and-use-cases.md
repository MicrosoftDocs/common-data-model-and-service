...
For reference, the current form for representing Common Data Model metadata is called the *manifest* format. The Common Data Model manifest format encompasses several critical enhancements over the more limited *model.json* format. For more information, see [Common Data Model Manifest object](cdm-manifest.md).

For detailed information about the model.json document format, see [Metadata file for the Common Data Model](../model-json).
