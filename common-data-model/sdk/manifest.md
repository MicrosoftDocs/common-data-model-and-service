...
| incrementalPartitions          | The **dataPartitions** objects in this collection each describe the location, format, and perhaps specific details about one file that contains increme records for the local entity.                                                                                                                                                                                                                                 |1.6|
...
| IsIncremental     | Boolean. Set to **True** if the partition object contains the *is.partition.incremental* trait.                                                                                                                                                                                                                                                                                                                    |1.6|
...
| Trait / parameter            | Description                                                                                                                                                                                                                                          |foundations.4.5.cdm.json|
|------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------|
...
| is.partition.incremental     | The base trait for describing incremental partitions and incremental partition patterns.                                                                                                                                                             |4.5                     |
...
| IsIncremental     | Boolean. Set to **True** if the partition pattern object contains the *is.partition.incremental* trait.                                                                                                                                                                                                                                                                                                                              |1.6|
