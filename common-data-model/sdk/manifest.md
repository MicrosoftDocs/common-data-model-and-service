...
| IsIncremental     | Boolean. Set to **True** if the partition object contains the *[is.partition.incremental](./list-of-traits.md#a-id"is-partition-incremental"bispartitionincrementalba)* trait.                                                                                                                                                                                                                                |1.6|
...
| [is.partition.incremental](./list-of-traits.md#a-id"is-partition-incremental"bispartitionincrementalba)| The base trait for describing incremental partitions and incremental partition patterns.                                                                                                                                                             |4.5                     |
...
| IsIncremental     | Boolean. Set to **True** if the partition pattern object contains the *[is.partition.incremental](./list-of-traits.md#a-id"is-partition-incremental"bispartitionincrementalba)* trait.                                                                                                                                                                                                                                              |1.6|
