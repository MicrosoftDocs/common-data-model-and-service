...
|**Insert(int, [CdmTraitReference](traitreference.md))**<br/>*index*: The index to insert the trait at.<br/>*trait*: The trait to add to the collection.<br/><br/>*add(...) in Java.*|Inserts the trait into the collection at the specified index.|void|
