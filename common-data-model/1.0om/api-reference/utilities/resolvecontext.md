...
|FeatureFlags|Dictionary of <string, dynamic><br/>*featureFlagName [optional]*: The name for feature flag.<br/>*value [optional]*: A dynamic object that can be used to set the value of the flag.|Optional set of FeatureFlags in the given context.
