...
The Common Data Model schema [definitions](https://docs.microsoft.com/en-us/common-data-model/sdk/logical-definitions#definition-documents) include a wide variety of semantic information, such as metadata related to geolocation, demographics, measurements, and calendar/dates, in addition to standard data types. You can see examples of these types within the published Common Data Model [standard entities](https://docs.microsoft.com/common-data-model/schema/core/applicationcommon/overview).

<a name="how-are-schemas-and-other-artifacts-versioned"></a>

### How are schemas and other artifacts versioned?

The standard entity [definitions](https://docs.microsoft.com/en-us/common-data-model/sdk/logical-definitions#definition-documents), and the schema format itself, use a major/minor versioning system. Learn more about [versions](https://github.com/microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon) for [standard entities](https://docs.microsoft.com/en-us/common-data-model/schema/core/overview).
...
Dataverse implements the Common Data Model [standard entities](https://docs.microsoft.com/en-us/common-data-model/schema/core/overview), such as [Account](https://docs.microsoft.com/en-us/common-data-model/schema/core/applicationcommon/account) and [Contact](https://docs.microsoft.com/en-us/common-data-model/schema/core/applicationcommon/contact).
...
Some [standard entities](https://docs.microsoft.com/en-us/common-data-model/schema/core/overview) in the Common Data Model are built in to each Dataverse database. Other [standard entities](https://docs.microsoft.com/en-us/common-data-model/schema/core/overview) are installed as part of a solution, including first-party applications (such as Dynamics 365 Field Service) or [industry solution accelerators](industry-accelerators.md) (such as the [Dynamics 365 Automotive Accelerator](https://docs.microsoft.com/en-us/common-data-model/automotive-accelerator)).
