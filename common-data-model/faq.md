...
The standard entity [definitions](https://docs.microsoft.com/common-data-model/sdk/logical-definitions#definition-documents), and the schema format itself, use a major/minor versioning system. Learn more about [versions](https://github.com/microsoft/CDM/tree/master/schemaDocuments/core/applicationCommon) for [standard entities](https://docs.microsoft.com/common-data-model/schema/core/overview).
...
Some [standard entities](https://docs.microsoft.com/common-data-model/schema/core/overview) in the Common Data Model are built in to each Dataverse database. Other [standard entities](https://docs.microsoft.com/common-data-model/schema/core/overview) are installed as part of a solution, including first-party applications (such as Dynamics 365 Field Service) or [industry solution accelerators](industry-accelerators.md) (such as the [Dynamics 365 Automotive Accelerator](https://docs.microsoft.com/common-data-model/automotive-accelerator)).
